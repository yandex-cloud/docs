[Документация Yandex Cloud](../../index.md) > [Cloud Apps](../index.md) > [Практические руководства](index.md) > Создание сайта на WordPress High Availability с помощью Cloud Apps
