[Документация Yandex Cloud](../../index.md) > [Cloud Apps](../index.md) > [Практические руководства](index.md) > Создание сайта на WordPress с помощью Cloud Apps

# Установка WordPress с помощью Cloud Apps

С помощью этого руководства вы установите и настроите [WordPress](https://wordpress.org/) — систему управления контентом, подходящую как для личных блогов, так и для крупных медиа и коммерческих проектов. Приложение [Cloud Apps](../index.md) будет развернуто на виртуальной машине с автоматической настройкой всех необходимых ресурсов, включая веб-сервер и интеграцию с сервисом [Yandex Cloud Postbox](../../postbox/index.md).
