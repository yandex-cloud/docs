[Документация Yandex Cloud](../../index.md) > [Yandex Key Management Service](../index.md) > [Пошаговые инструкции](index.md) > Асимметричное шифрование > Ключевая пара шифрования
...
- CLI {#cli}
  ...
  1. Получите идентификатор нужной ключевой пары шифрования, указав идентификатор каталога:
