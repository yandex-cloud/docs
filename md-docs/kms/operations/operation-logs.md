[Документация Yandex Cloud](../../index.md) > [Yandex Key Management Service](../index.md) > [Пошаговые инструкции](index.md) > Посмотреть операции с ресурсами сервиса

# Посмотреть операции с ресурсами сервиса Key Management Service
...
- Консоль управления {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором находится симметричный ключ.
  ...
  1. Перейдите на панель **Операции** для выбранного ключа.
