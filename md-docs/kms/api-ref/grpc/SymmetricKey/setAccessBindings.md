[Документация Yandex Cloud](../../../../index.md) > [Yandex Key Management Service](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [SymmetricKey](index.md) > SetAccessBindings

# Key Management Service API, gRPC: SymmetricKeyService.SetAccessBindings
