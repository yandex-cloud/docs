[Документация Yandex Cloud](../../../index.md) > [Yandex Key Management Service](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [SymmetricKey](index.md) > ScheduleVersionDestruction
...
Scheduled destruction can be cancelled with the [SymmetricKeyService.CancelVersionDestruction](cancelVersionDestruction.md#CancelVersionDestruction) method.
