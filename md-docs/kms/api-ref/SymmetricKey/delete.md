...
The key and its versions appear absent in [SymmetricKeyService.Get](get.md#Get) and [SymmetricKeyService.List](list.md#List)
...
Can be set to INACTIVE using the [SymmetricKeyService.Update](update.md#Update) method.
- `INACTIVE`: The key is inactive and unusable.
Can be set to ACTIVE using the [SymmetricKeyService.Update](update.md#Update) method. ||
