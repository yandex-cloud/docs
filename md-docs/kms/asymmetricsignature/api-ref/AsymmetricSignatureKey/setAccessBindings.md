[Документация Yandex Cloud](../../../../index.md) > [Yandex Key Management Service](../../../index.md) > Справочник API > REST (англ.) > [Asymmetric signature API](../index.md) > [AsymmetricSignatureKey](index.md) > SetAccessBindings
...
```
POST https://kms.api.cloud.yandex.net/kms/v1/asymmetricSignatureKeys/{resourceId}:setAccessBindings
```
