...
Изменения, вызванные [eventually consistent операциями](../../concepts/consistency.md), становятся применимыми для шифрования и расшифрования с задержкой до трех часов.
