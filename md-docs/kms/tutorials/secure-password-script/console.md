[Документация Yandex Cloud](../../../index.md) > [Yandex Key Management Service](../../index.md) > [Практические руководства](../index.md) > [Безопасная передача пароля в скрипт инициализации](index.md) > Консоль управления, CLI, API
...
* [Удалите](../../operations/key.md#delete) ключ.
