...
Криптоматериал, содержащийся в версиях ключей, недоступен в открытом виде вне сервиса {{ kms-short-name }}. Шифрование и расшифрование в {{ kms-short-name }} выполняются с помощью криптографических операций [encrypt](../api-ref/SymmetricCrypto/encrypt.md) и [decrypt](../api-ref/SymmetricCrypto/decrypt.md).
