[Документация Yandex Cloud](../../../../index.md) > [Yandex Key Management Service](../../../index.md) > [Справочник CLI (англ.)](../../index.md) > [v0](../index.md) > [asymmetric-signature-key](index.md) > add-access-binding

# yc kms v0 asymmetric-signature-key add-access-binding

Add access binding for the specified asymmetric signature key

#### Command Usage

Syntax:

`yc kms asymmetric-signature-key add-access-binding <ASYMMETRIC-SIGNATURE-KEY> [Flags...] [Global Flags...]`
