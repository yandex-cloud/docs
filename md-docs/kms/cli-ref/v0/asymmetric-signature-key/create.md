[Документация Yandex Cloud](../../../../index.md) > [Yandex Key Management Service](../../../index.md) > [Справочник CLI (англ.)](../../index.md) > [v0](../index.md) > [asymmetric-signature-key](index.md) > create

# yc kms v0 asymmetric-signature-key create
...
Name of a asymmetric signature key. ||
|| `--description` | `string`

Description of an asymmetric signature key. ||
