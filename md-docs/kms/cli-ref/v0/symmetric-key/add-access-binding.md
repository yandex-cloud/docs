[Документация Yandex Cloud](../../../../index.md) > [Yandex Key Management Service](../../../index.md) > [Справочник CLI (англ.)](../../index.md) > [v0](../index.md) > [symmetric-key](index.md) > add-access-binding
...
`yc kms symmetric-key add-access-binding <SYMMETRIC-KEY> [Flags...] [Global Flags...]`
