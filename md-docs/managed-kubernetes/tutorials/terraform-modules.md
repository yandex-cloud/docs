...
* Плата за [высокодоступный мастер Managed Service for Kubernetes](../concepts/index.md#master) (см. [тарифы Managed Service for Kubernetes](../pricing.md)).
* Плата за постоянно запущенные [виртуальные машины](../../compute/concepts/vm.md) в [группе узлов Managed Service for Kubernetes](../concepts/index.md#node-group) (см. [тарифы Yandex Compute Cloud](../../compute/pricing.md)).
