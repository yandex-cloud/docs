...
С помощью инструмента [External Secrets Operator](https://external-secrets.io/latest/provider/yandex-lockbox/) вы можете настроить синхронизацию [секретов](../../lockbox/concepts/secret.md) [{{ lockbox-name }}](../../lockbox/index.md) с [секретами](../concepts/encryption.md) [кластера {{ managed-k8s-full-name }}](../concepts/index.md#kubernetes-cluster).
...
* Плата за [вычислительные ресурсы](../../compute/concepts/vm-platforms.md) и [диски](../../compute/concepts/disk.md) [группы узлов {{ managed-k8s-name }}](../concepts/index.md#node-group) (см. [тарифы {{ compute-full-name }}](../../compute/pricing.md)).
...
1. Установите [External Secrets Operator](https://yandex.cloud/ru/marketplace/products/yc/external-secrets) согласно [инструкции](../operations/applications/external-secrets-operator.md).
...
1. Создайте [пространство имен](../concepts/index.md#namespace) `ns`, в котором будут размещены объекты External Secrets Operator:
