...
* Плата за использование [мастера Managed Service for Kubernetes](../concepts/index.md#master) ([тарифы Managed Service for Kubernetes](../pricing.md)).
...
- Вручную {#manual}
  ...
  1. [Создайте сервисные аккаунты](../../iam/operations/sa/create.md):
     ...
     * Для узлов с ролями [container-registry.images.puller](../../container-registry/security/index.md#container-registry-images-puller), [container-registry.images.pusher](../../container-registry/security/index.md#container-registry-images-pusher) и [container-registry.images.scanner](../../container-registry/security/index.md#container-registry-images-scanner) на каталог с [реестром](../../container-registry/concepts/registry.md) [Docker-образов](../../container-registry/concepts/docker-image.md). От его имени узлы Managed Service for Kubernetes будут загружать в реестр собранные в GitLab Docker-образы, а также скачивать их для запуска [подов](../concepts/index.md#pod).
