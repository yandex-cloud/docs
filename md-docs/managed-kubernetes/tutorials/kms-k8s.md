...
Используйте [ключ](../../kms/concepts/key.md) Yandex Key Management Service для шифрования [секретов](../../lockbox/concepts/secret.md) — конфиденциальной информации, такой как пароли и [SSH-ключи](../../glossary/ssh-keygen.md), в [Yandex Managed Service for Kubernetes](../index.md). Для этого при создании [кластера Managed Service for Kubernetes](../concepts/index.md#kubernetes-cluster) укажите ключ Key Management Service, который будет использоваться при шифровании и расшифровании.
