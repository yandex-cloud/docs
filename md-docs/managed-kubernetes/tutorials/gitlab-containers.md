...
* Развертывание приложения из контейнера в [кластере Yandex Managed Service for Kubernetes](../concepts/index.md#kubernetes-cluster) через GitLab с помощью инструментов Yandex Cloud.
...
* Использование [мастера Managed Service for Kubernetes](../concepts/index.md#master) (см. [тарифы Managed Service for Kubernetes](../pricing.md)).
