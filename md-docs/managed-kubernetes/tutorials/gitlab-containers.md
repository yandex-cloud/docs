...
* Развертывание приложения из контейнера в [кластере {{ managed-k8s-full-name }}](../concepts/index.md#kubernetes-cluster) через {{ GL }} с помощью инструментов {{ yandex-cloud }}.
...
* Использование [мастера {{ managed-k8s-name }}](../concepts/index.md#master) (см. [тарифы {{ managed-k8s-name }}](../pricing.md)).
