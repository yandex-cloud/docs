[Документация Yandex Cloud](../../../../../index.md) > [Yandex Managed Service for Kubernetes](../../../../index.md) > Справочник API > [Managed Service for Kubernetes gRPC (англ.)](../index.md) > [NodeGroup](index.md) > ListNodes
...
the service returns a [ListNodeGroupsResponse.next_page_token](list.md#yandex.cloud.k8s.v1.ListNodeGroupsResponse)
