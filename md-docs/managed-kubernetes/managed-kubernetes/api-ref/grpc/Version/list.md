[Документация Yandex Cloud](../../../../../index.md) > [Yandex Managed Service for Kubernetes](../../../../index.md) > Справочник API > [Managed Service for Kubernetes gRPC (англ.)](../index.md) > [Version](index.md) > List
...
Release channel: `RAPID`, `REGULAR` or `STABLE`. For more details see [documentation](../../../../concepts/release-channels-and-updates.md).
