[Документация Yandex Cloud](../../../../../index.md) > [Yandex Managed Service for Kubernetes](../../../../index.md) > Справочник API > [Managed Service for Kubernetes gRPC (англ.)](../index.md) > [Cluster](index.md) > List

# Managed Services for Kubernetes API, gRPC: ClusterService.List

Retrieves the list of Kubernetes cluster in the specified folder.

## gRPC request

**rpc List ([ListClustersRequest](#yandex.cloud.k8s.v1.ListClustersRequest)) returns ([ListClustersResponse](#yandex.cloud.k8s.v1.ListClustersResponse))**

## ListClustersRequest {#yandex.cloud.k8s.v1.ListClustersRequest}
...
the service returns a [ListClustersResponse.next_page_token](#yandex.cloud.k8s.v1.ListClustersResponse)
...
[ListClustersResponse.next_page_token](#yandex.cloud.k8s.v1.ListClustersResponse) returned by a previous list request.
...
## ListClustersResponse {#yandex.cloud.k8s.v1.ListClustersResponse}
...
is larger than [ListClustersRequest.page_size](#yandex.cloud.k8s.v1.ListClustersRequest), use
the `next_page_token` as the value
for the [ListClustersRequest.page_token](#yandex.cloud.k8s.v1.ListClustersRequest) query parameter
