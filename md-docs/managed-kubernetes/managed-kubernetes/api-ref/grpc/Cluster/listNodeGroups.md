[Документация Yandex Cloud](../../../../../index.md) > [Yandex Managed Service for Kubernetes](../../../../index.md) > Справочник API > [Managed Service for Kubernetes gRPC (англ.)](../index.md) > [Cluster](index.md) > ListNodeGroups
...
Currently you can use filtering only on [Cluster.name](get.md#yandex.cloud.k8s.v1.Cluster) field.
...
**The `nodeTaints` field is not supported for the [yandex.cloud.k8s.v1.NodeGroupService.Update](../NodeGroup/update.md#Update) request.** ||
