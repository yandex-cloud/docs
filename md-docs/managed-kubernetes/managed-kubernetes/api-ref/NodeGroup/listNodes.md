[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for Kubernetes](../../../index.md) > Справочник API > [Managed Service for Kubernetes REST (англ.)](../index.md) > [NodeGroup](index.md) > ListNodes
...
the service returns a [ListNodeGroupsResponse.nextPageToken](list.md#yandex.cloud.k8s.v1.ListNodeGroupsResponse)
