...
Подробнее см. в [пошаговой инструкции по созданию кластера Managed Service for Kubernetes](operations/kubernetes-cluster/kubernetes-cluster-create.md).
...
Подробнее см. в [пошаговой инструкции по созданию группы узлов Managed Service for Kubernetes](operations/node-group/node-group-create.md).
