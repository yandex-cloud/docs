[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for Kubernetes](../../index.md) > [Пошаговые инструкции](../index.md) > Работа с постоянными томами > Управление классами хранилищ
...
Стоимость использования хранилища зависит от типа его [диска](../../../compute/concepts/disk.md). Ознакомьтесь с [ценами на диски Yandex Compute Cloud](../../../compute/concepts/disk.md#disks-types) перед созданием хранилища.

{% endnote %}

В Managed Service for Kubernetes доступны следующие классы хранилищ, которые отличаются [типом создаваемого диска](../../../compute/concepts/disk.md#disks-types):
