...
1. Создайте под:
    ...
    После создания пода в [консоли управления](https://console.yandex.cloud) в сервисе **Compute Cloud** в разделе **Диски и хранилища** появится новый зашифрованный диск с префиксом `k8s-csi` в имени.
