...
Автоматическое масштабирование мастера работает на кластерах во всех [релизных каналах](../concepts/release-channels-and-updates.md), где мастер развернут в [высокодоступной конфигурации](../concepts/index.md#master).
