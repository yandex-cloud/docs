...
1. В разделе **Доступные для установки приложения** выберите [Kubernetes Node Remediation](https://yandex.cloud/ru/marketplace/products/yc/kubernetes-node-remediation) и нажмите кнопку **Перейти к установке**.
