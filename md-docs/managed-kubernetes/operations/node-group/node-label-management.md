...
1. Создайте группу узлов с Kubernetes-метками:
   ...
   - Консоль управления {#console}
     ...
     1. Выберите кластер Managed Service for Kubernetes, для которого нужно создать группу узлов.
     1. Перейдите на вкладку **Управление кластером** и выберите раздел **Группы узлов**. Нажмите кнопку **Создать группу узлов**. Если открылось меню выбора типа группы, выберите ![cloud](../../../_assets/console-icons/cloud.svg) **Облачную**.
     ...
     1. В блоке **Настройки окна обновлений**:
        * В поле **Частота обновлений / Отключение** выберите окно для [обновлений](../../concepts/release-channels-and-updates.md#updates):
          ...
          * `В выбранные дни` — укажите день, начало и длительность интервала времени в UTC, в течение которого запустится обновление. Параметр не связан с длительностью самого обновления и временем его окончания.
...
1. Посмотрите информацию о созданной группе узлов с Kubernetes-метками:
   ...
   - Консоль управления {#console}
     ...
     1. Перейдите на вкладку **Управление узлами**, затем **Узлы**.
     1. Выберите один из узлов Managed Service for Kubernetes.
     1. На вкладке **Метки** перечислены системные и пользовательские Kubernetes-метки узла.
