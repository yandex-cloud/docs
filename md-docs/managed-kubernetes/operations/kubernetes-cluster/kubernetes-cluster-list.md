...
- Консоль управления {#console}
  ...
  Чтобы получить список кластеров Kubernetes, в [консоли управления](https://console.yandex.cloud) выберите каталог и [перейдите](../../../console/operations/select-service.md#select-service) в сервис **Managed Service for&nbsp;Kubernetes**.
