...
- CLI {#cli}
  ...
  1. Выполните команду, передав список изменяемых настроек (в примере приведены не все настройки):
     ...
     * Управление окном обновлений:
       ...
       * `--weekly-maintenance-window` — задать день, начало и длительность интервала времени в UTC, в течение которого запустится обновление.

         Параметры не связаны с длительностью самого обновления и временем его окончания.
