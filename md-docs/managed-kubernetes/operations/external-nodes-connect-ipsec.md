[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for Kubernetes](../index.md) > [Пошаговые инструкции](index.md) > Работа с внешними узлами > Настройка IPSec-шлюзов для подключения внешних узлов к кластеру
...
1. В основной сети [создайте](../../vpc/operations/security-group-create.md) группу безопасности и назначьте ее `VM-1`. [Добавьте](../../vpc/operations/security-group-add-rule.md) в группу правила:
    ...
    - Исходящий трафик {#outgoing}
      ...
      Описание | Диапазон портов | Протокол | Назначение | IPv4 CIDR
      --- | --- | --- | --- | ---
      `any` | `0-65535` | `Любой` | `Диапазон адресов` | `0.0.0.0/0`

    - Входящий трафик {#incoming}
      
      Описание | Диапазон портов | Протокол | Источник | IPv4 CIDR
      --- | --- | --- | --- | ---
      `icmp` | `0-65535` | `ICMP` | `Диапазон адресов` | `0.0.0.0/0`
      `ssh` | `22` | `TCP`  | `Диапазон адресов` | `0.0.0.0/0`
      `ipsec-udp-500` | `500` | `UDP` | `Диапазон адресов` | `<публичный_адрес_VM-2>/32`
      `ipsec-udp-4500` | `4500` | `UDP` | `Диапазон адресов` | `<публичный_адрес_VM-2>/32`
      `VM-2-subnet` | `0-65535` | `Любой` | `Диапазон адресов` | `<CIDR_подсети_VM-2>`
...
1. В дополнительной сети [создайте](../../vpc/operations/security-group-create.md) группу безопасности и назначьте ее `VM-2`. [Добавьте](../../vpc/operations/security-group-add-rule.md) в группу правила:
    ...
    - Входящий трафик {#incoming}
      ...
      `icmp` | `0-65535` | `ICMP` | `Диапазон адресов` | `0.0.0.0/0`
      `ssh` | `22`   | `TCP` | `Диапазон адресов` | `0.0.0.0/0`
      `ipsec-udp-500` | `500` | `UDP` | `Диапазон адресов` | `<публичный_адрес_VM-1>/32`
      `ipsec-udp-4500` | `4500` | `UDP` | `Диапазон адресов` | `<публичный_адрес_VM-1>/32`
      `k8s-VM-1-subnets` | `0-65535` | `Любой` | `Диапазон адресов` | `<CIDR_основной_подсети1>`, `<CIDR_основной_подсети2>`, `<CIDR_основной_подсети3>`
      `cluster&services` | `0-65535` | `Любой` | `Диапазон адресов` | `<CIDR_кластера>`, `<CIDR_сервисов>`
