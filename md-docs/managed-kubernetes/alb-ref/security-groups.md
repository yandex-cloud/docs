...
* Группа безопасности группы узлов для служебного трафика:
  ...
  - Входящий трафик {#incoming}
    ...
    Диапазон портов | Протокол | Источник | CIDR блоки | Описание
    --- | --- | --- | --- | ---
    `0-65535` | `Любой` (`Any`) | `CIDR` | `10.96.0.0/16`[^\[К\]^](#example)<br>`10.112.0.0/16`[^\[С\]^](#example) | Для трафика между [подами](../concepts/index.md#pod) и [сервисами](../concepts/index.md#service)
...
* Группа безопасности кластера для служебного трафика:
  ...
  - Исходящий трафик {#outgoing}
    ...
    Диапазон портов | Протокол | Назначение | CIDR блоки | Описание
    --- | --- | --- | --- | ---
    `4443` | `TCP` | `CIDR` | `10.96.0.0/16`[^\[К\]^](#example) | Для трафика между мастером и [подами](../concepts/index.md#pod) `metric-server`
...
Подробнее о группах безопасности для кластера и групп узлов смотрите в разделе [Настройка групп безопасности](../operations/connect/security-groups.md).
