...
* `rules` (`[]HTTPRouteRule`)
  ...
  * `backendRefs` (`[]HTTPBackendRef`)
    ...
    Список [сервисов Kubernetes](../concepts/index.md#service), которые должны обрабатывать запрос в качестве бэкенда.
...
* `requestRedirect` (`HTTPRequestRedirectFilter`)
    ...
    [Установите](../operations/applications/gateway-api.md) актуальную версию Gateway API, если нужна поддержка этих настроек.
