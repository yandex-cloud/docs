...
Подробнее об использовании зашифрованных дисков см. на странице [Использование зашифрованных дисков для постоянных томов](../operations/volumes/encrypted-disks.md).
