...
* Вы можете расселить необходимые узлы автомасштабируемой группы узлов вручную. Для этого перед уменьшением ее размера воспользуйтесь командой `kubectl drain`.
