[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for Kubernetes](../../index.md) > [Концепции](../index.md) > Группа узлов > Автоматическое масштабирование группы узлов
...
* Размещение автомасштабируемой группы узлов возможно только в одной [зоне доступности](../../../overview/concepts/geo-scope.md).
