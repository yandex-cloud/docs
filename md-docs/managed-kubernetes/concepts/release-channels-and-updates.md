[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for Kubernetes](../index.md) > [Концепции](index.md) > Релизные каналы и обновления
...
_Информацию о поддерживаемых версиях Kubernetes в каналах смотрите на странице [Поддержка версий Kubernetes в Yandex Managed Service for Kubernetes](k8s-supported-versions.md)._
...
Обновление выполняется в рамках текущей минорной версии кластера Managed Service for Kubernetes. Например, с 1.28.9 до 1.28.10.

В автоматическое обновление входят новые возможности, улучшения или исправления сервиса Managed Service for Kubernetes, а также исправления компонентов Kubernetes.
...
Подробнее в разделе [Настроить политику развертывания](../operations/node-group/node-group-update.md#configure-deploy-policy).
...
Подробнее об обновлении сертификатов читайте в [документации Kubernetes](https://kubernetes.io/docs/tasks/tls/certificate-rotation/).
