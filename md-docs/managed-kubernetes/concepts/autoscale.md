...
Автоматическое масштабирование мастера работает на кластерах во всех [релизных каналах](release-channels-and-updates.md), где мастер развернут в [высокодоступной конфигурации](index.md#master).
