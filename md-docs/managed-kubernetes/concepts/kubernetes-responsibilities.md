...
В [кластере без предустановленного CNI](cluster-without-cni.md) Yandex Cloud управляет мастером и группами узлов. За сетевой плагин отвечает [пользователь](#responsibility).
