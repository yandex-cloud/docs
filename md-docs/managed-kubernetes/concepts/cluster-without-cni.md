...
В кластере без предустановленного CNI Managed Service for Kubernetes управляет мастером и группами узлов. Вы отвечаете за выбор, установку, настройку и обновление сетевого плагина, а также за его работоспособность и совместимость с конфигурацией кластера.
