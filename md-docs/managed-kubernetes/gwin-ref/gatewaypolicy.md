...
| Field | Description |
|-------|-------------|
| subnets | **[]string** <br> [Subnets](../../vpc/concepts/network.md#subnet) of the zones where load balancer will be instantiated. <br> Example: `["subnet-id-1", "subnet-id-2"]` |
| securityGroups | **[]string** <br> [Security groups](../../vpc/concepts/security-groups.md) of load balancer. <br> Example: `["sg-id-1", "sg-id-2"]` |
| logs | **[LogOptions](#logoptions)** <br> [Cloud Logging](../../logging/index.md) settings of the application load balancer. |
| autoScale | **[AutoScalePolicy](#autoscalepolicy)** <br> [Autoscaling](../../application-load-balancer/concepts/application-load-balancer.md#lcu-scaling) settings of the application load balancer. |
...
| Field | Description |
|-------|-------------|
| minZoneSize | **int** <br> Lower limit for the number of [resource units](../../application-load-balancer/concepts/application-load-balancer.md#lcu-scaling) in each [availability zone](../../overview/concepts/geo-scope.md). The minimum value is 2. <br> Example: `2` |
| maxSize | **int** <br> Upper limit for the total number of [resource units](../../application-load-balancer/concepts/application-load-balancer.md#lcu-scaling) across all availability zones. If the value is 0, there is no upper limit. <br> Example: `10` |
...
| Field | Description |
|-------|-------------|
| receiveTraffic | **bool** <br> Enables the load balancer node in the specified [availability zone](../../overview/concepts/geo-scope.md). <br> Example: `true` |
...
| Field | Description |
|-------|-------------|
| logGroupID | **string** <br> [Cloud Logging](../../logging/index.md) log group ID to store [access logs](../../application-load-balancer/logs-ref.md). If not set then logs will be stored in default log group for the folder where load balancer located. <br> Example: `log-group-id-1` |
| disable | **bool** <br> Do not send logs to [Cloud Logging](../../logging/index.md) log group. <br> Example: `false` |
