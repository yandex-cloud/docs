[Документация Yandex Cloud](../../../../index.md) > [Yandex SmartCaptcha](../../../index.md) > [Справочник CLI (англ.)](../../index.md) > [v1](../index.md) > captcha > Overview
...
- [yc smartcaptcha v1 captcha create](create.md) — Creates a captcha in the specified folder using the data specified in the request.

- [yc smartcaptcha v1 captcha delete](delete.md) — Deletes the specified captcha.
...
- [yc smartcaptcha v1 captcha update](update.md) — Updates the specified captcha.
