...
- API {#api}
  ...
  Подробнее о методах в справочнике REST API: [Captcha.Create](../api-ref/Captcha/create.md) и [Captcha.Update](../api-ref/Captcha/update.md) для ресурса [Captcha](../api-ref/Captcha/index.md).
