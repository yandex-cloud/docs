...
> (50 000 - 10 000) / 1 000 × 109,8 ₽ = {% calc [currency=RUB] (50000 - 10000) / 1000 × 109.8 %}

Если в месяц была 101 000 корректных запросов, стоимость за месяц составит:

> (100 000 - 10 000) / 1 000 × 109,8 ₽ + (101 000 - 100 000) / 1 000 × 76,86 ₽ = {% calc [currency=RUB] (100000 - 10000) / 1000 × 109.8 + (101 000 - 100 000) / 1 000 × 76.86 %}