[Документация Yandex Cloud](../../../index.md) > [Yandex SmartCaptcha](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Operation](index.md) > Cancel

# SmartCaptcha API, REST: Operation.Cancel
