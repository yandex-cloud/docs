[Документация Yandex Cloud](../../index.md) > [Yandex SmartCaptcha](../index.md) > Концепции > Валидация домена
...
Чтобы отключить проверку, при [создании](../operations/create-captcha.md) или редактировании капчи включите опцию **Отключить проверку домена**.
