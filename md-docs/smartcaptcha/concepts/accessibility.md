[Документация Yandex Cloud](../../index.md) > [Yandex SmartCaptcha](../index.md) > Концепции > Доступность капчи
...
Вы можете самостоятельно протестировать доступность капчи с помощью инструмента [Lighthouse](https://developer.chrome.com/docs/lighthouse/overview?page&hl=ru).