[Документация Yandex Cloud](../../../../index.md) > [Yandex MetaData Hub](../../../index.md) > Data Catalog > Справочник API > [REST (англ.)](../index.md) > [Catalog](index.md) > CreateCatalog

# Datacatalog API, REST: Catalog.CreateCatalog
...
```
POST https://datacatalog.api.cloud.yandex.net/v1/catalogs
```

## Body parameters {#yandex.cloud.datacatalog.v1.CreateCatalogRequest}
