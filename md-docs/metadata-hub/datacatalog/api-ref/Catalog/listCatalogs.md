[Документация Yandex Cloud](../../../../index.md) > [Yandex MetaData Hub](../../../index.md) > Data Catalog > Справочник API > [REST (англ.)](../index.md) > [Catalog](index.md) > ListCatalogs
...
```
GET https://datacatalog.api.cloud.yandex.net/v1/catalogs
```
