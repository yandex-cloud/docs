...
Вы также можете использовать это решение для сохранения совместимости JSON-схем при поставке данных в [{{ mkf-full-name }}](../../managed-kafka/index.md) через [{{ yds-full-name }}](../../data-streams/index.md) [{{ data-transfer-full-name }}](../../data-transfer/index.md). Подробнее о требуемых настройках эндпоинта {{ data-transfer-name }} — [инструкции](../../data-transfer/operations/endpoint/target/kafka.md#serializer).
