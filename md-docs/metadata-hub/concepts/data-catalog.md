[Документация Yandex Cloud](../../index.md) > [Yandex MetaData Hub](../index.md) > Data Catalog > Концепции > Каталог метаданных
...
Data Catalog также интегрирован с сервисами:

  * [Yandex WebSQL](../../websql/index.md) — позволяет отправлять SQL-запросы к базам данных в кластерах, которые являются источниками данных для Data Catalog.
  * [DataLens](../../datalens/index.md) — позволяет настраивать загрузку аналитических данных и просматривать связи между датасетами.

Основная сущность, которой оперирует сервис Data Catalog — _каталог метаданных_. Каталог одновременно является:
...
* [Создание термина](../operations/data-catalog/create-term.md) в глоссарии.
...
* [Создание тега](../operations/data-catalog/create-tag.md) в классификации.
* [Изменение классификации](../operations/data-catalog/update-classification.md).
* [Изменение тега](../operations/data-catalog/update-tag.md) в классификации.