...
{{ data-catalog-name }} также интегрирован с сервисами:

  * [{{ websql-full-name }}](../../websql/index.md) — позволяет отправлять SQL-запросы к базам данных в кластерах, которые являются источниками данных для {{ data-catalog-name }}.
  * [{{ datalens-name }}](../../datalens/index.md) — позволяет настраивать загрузку аналитических данных и просматривать связи между датасетами.
