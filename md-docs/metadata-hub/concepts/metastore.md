[Документация Yandex Cloud](../../index.md) > [Yandex MetaData Hub](../index.md) > Apache Hive™ Metastore > Концепции > Кластеры Apache Hive™ Metastore
...
|| 3.1 | Подключение осуществляется по протоколу Thrift на порте 9083. ||
|| 4.0 | Подключение осуществляется по протоколу Thrift на порте 9083. ||
...
* **Thrift** — протокол на порте 9083. Доступен во всех версиях Apache Hive™ Metastore.
* **REST** — протокол на порте 9001. Доступен с версии 4.2.0. Это HTTP API для работы с Iceberg-таблицами.
