[Документация Yandex Cloud](../../../../index.md) > [Yandex MetaData Hub](../../../index.md) > Apache Hive™ Metastore > Справочник API > [gRPC (англ.)](../index.md) > [Cluster](index.md) > SetAccessBindings

# Managed Service for Hive Metastore™ API, gRPC: ClusterService.SetAccessBindings
