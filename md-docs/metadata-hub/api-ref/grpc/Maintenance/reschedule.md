[Документация Yandex Cloud](../../../../index.md) > [Yandex MetaData Hub](../../../index.md) > Apache Hive™ Metastore > Справочник API > [gRPC (англ.)](../index.md) > [Maintenance](index.md) > Reschedule

# Managed Service for Hive Metastore™ API, gRPC: MaintenanceService.Reschedule
