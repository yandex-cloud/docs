[Документация Yandex Cloud](../../../index.md) > [Yandex MetaData Hub](../../index.md) > Apache Hive™ Metastore > Справочник API > [REST (англ.)](../index.md) > [Maintenance](index.md) > Reschedule

# Managed Service for Hive Metastore™ API, REST: Maintenance.Reschedule
...
```
POST https://metastore.api.cloud.yandex.net/managed-metastore/v1/maintenances/{maintenanceId}:reschedule
```
