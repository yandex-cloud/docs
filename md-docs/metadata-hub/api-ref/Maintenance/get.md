[Документация Yandex Cloud](../../../index.md) > [Yandex MetaData Hub](../../index.md) > Apache Hive™ Metastore > Справочник API > [REST (англ.)](../index.md) > [Maintenance](index.md) > Get
...
```
GET https://metastore.api.cloud.yandex.net/managed-metastore/v1/maintenances/{maintenanceId}
```
