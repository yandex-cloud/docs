[Документация Yandex Cloud](../../../index.md) > [Yandex MetaData Hub](../../index.md) > Apache Hive™ Metastore > Справочник API > [REST (англ.)](../index.md) > [Cluster](index.md) > ListOperations
...
is larger than [ListClusterOperationsRequest.pageSize](#yandex.cloud.metastore.v1.ListClusterOperationsRequest), use the `nextPageToken` as the value
for the [ListClusterOperationsRequest.pageToken](#yandex.cloud.metastore.v1.ListClusterOperationsRequest) query parameter in the next list request.
