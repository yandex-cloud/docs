...
- Консоль управления {#console}
  ...
  1. В блоке **Логирование** включите или отключите запись логов. Если логирование включено:
  ...
  1. В блоке **Дополнительные настройки**:
      ...
      1. Включите или отключите защиту кластера от удаления. 
          
          Включенная защита кластера от удаления не помешает подключиться к нему вручную и удалить данные.

      1. Измените время [технического обслуживания](../../concepts/metastore-maintenance.md) кластера:
