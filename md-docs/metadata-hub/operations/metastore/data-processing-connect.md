[Документация Yandex Cloud](../../../index.md) > [Yandex MetaData Hub](../../index.md) > Apache Hive™ Metastore > Пошаговые инструкции > Подключение Yandex Data Processing к Apache Hive™ Metastore
...
Пример использования Yandex Data Processing с подключенным кластером Apache Hive™ Metastore — в практическом руководстве [Совместная работа с таблицами Yandex Data Processing с использованием Apache Hive™ Metastore](../../tutorials/sharing-tables.md).
