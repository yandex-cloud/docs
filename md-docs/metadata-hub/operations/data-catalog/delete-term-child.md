[Документация Yandex Cloud](../../../index.md) > [Yandex MetaData Hub](../../index.md) > Data Catalog > Пошаговые инструкции > Термины > Удаление дочернего термина
...
- Консоль управления {#console}
  ...
  1. Нажмите на значок ![image](../../../_assets/console-icons/ellipsis.svg) в строке с нужным дочерним термином и выберите **Удалить**.
