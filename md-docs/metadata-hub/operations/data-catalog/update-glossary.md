[Документация Yandex Cloud](../../../index.md) > [Yandex MetaData Hub](../../index.md) > Data Catalog > Пошаговые инструкции > Глоссарии > Изменение глоссария
...
- Консоль управления {#console}
  ...
  1. В списке глоссариев нажмите на значок ![image](../../../_assets/console-icons/ellipsis.svg) в строке с нужным глоссарием и выберите **Редактировать**.
  1. Измените параметры глоссария:

      * В поле **Имя** задайте новое уникальное имя глоссария.
