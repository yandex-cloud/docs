[Документация Yandex Cloud](../../../index.md) > [Yandex MetaData Hub](../../index.md) > Data Catalog > Пошаговые инструкции > Домены > Удаление домена
...
- Консоль управления {#console}
  ...
  1. В списке доменов нажмите кнопку ![image](../../../_assets/console-icons/ellipsis.svg) в строке с нужным доменом и выберите **Удалить**.
