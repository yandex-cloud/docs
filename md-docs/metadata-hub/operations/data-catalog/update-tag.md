[Документация Yandex Cloud](../../../index.md) > [Yandex MetaData Hub](../../index.md) > Data Catalog > Пошаговые инструкции > Теги > Изменение тега
...
- Консоль управления {#console}
  ...
  1. На панели слева выберите ![image](../../../_assets/console-icons/tag.svg) **Теги и классификации** и выберите классификацию, в которой вы хотите изменить тег.
  1. В списке тегов нажмите на значок ![image](../../../_assets/console-icons/ellipsis.svg) в строке с нужным тегом и выберите **Редактировать**.
  1. Измените параметры тега:

      * В поле **Имя** задайте новое уникальное имя тега.
