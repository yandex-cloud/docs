...
# Yandex MetaData Hub
 ...
 - [О сервисе Yandex MetaData Hub](concepts/index.md)
...
### Пошаговые инструкции
 ...
 - [Подключение Yandex Data Processing к Apache Hive™ Metastore](operations/metastore/data-processing-connect.md)
...
### Практические руководства
 ...
 - [Работа с таблицей в Object Storage из PySpark-задания](tutorials/spark-simple-rw-job.md)

 - [Интеграция Yandex Managed Service for Apache Spark™ и Apache Hive™ Metastore](tutorials/metastore-and-spark.md)
...
##### cluster
 ...
 - [Справочник Terraform](metastore-tf-ref.md)
...
### Практические руководства
 ...
 - [Поставка данных в формате Debezium CDC из Apache Kafka®](tutorials/schema-registry-cdc-debezium-kafka.md)
...
#### Работа с данными
 ...
 - [Запросы к наборам данных с помощью Yandex WebSQL](operations/data-catalog/web-sql-query.md)
...
### Практические руководства
 ...
 - [Интеграция AI-аналитика данных с Data Catalog](tutorials/ai-studio-data-catalog-integration.md)
