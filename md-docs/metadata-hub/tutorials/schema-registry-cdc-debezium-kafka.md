...
- Консоль управления {#console}
  ...
  1. Укажите [настройки пространства имен](../operations/create-name-space.md). После сохранения пространства имен, вы сможете использовать его идентификатор для получения URL {{ schema-registry-name }}: `{namespace_id}.{{ schema-registry-endpoint }}`.
