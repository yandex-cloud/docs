[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Logging](../index.md) > [Практические руководства](index.md) > Репликация логов в Object Storage с помощью Data Streams
...
1. В [лог-группу](../concepts/log-group.md) Cloud Logging поступают логи, например с [виртуальной машины](../../compute/concepts/vm.md).
