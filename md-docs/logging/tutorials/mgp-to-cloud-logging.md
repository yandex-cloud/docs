...
Вы можете настроить регулярный сбор логов о работе кластера Greenplum®. Логи поставляются в [лог-группу](../concepts/log-group.md) в сервисе Cloud Logging. Можно выбрать лог-группу одного из двух типов:
...
1. [Создайте лог-группу](../operations/create-group.md) `greenplum-log-group`.
1. Создайте кластер Greenplum® с включенными настройками логирования и [созданным ранее](#before-you-begin) сервисным аккаунтом:
