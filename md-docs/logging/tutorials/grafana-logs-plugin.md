...
В стоимость ресурсов входит плата за запись и хранение логов в лог-группе ([тарифы Yandex Cloud Logging](../pricing.md)).
...
- Консоль управления {#console}
  ...
  1. В открывшемся окне введите **Имя** сервисного аккаунта: `grafana-plugin`.
...
- API {#api}
  ...
  Чтобы создать лог-группу, воспользуйтесь методом REST API [create](../api-ref/LogGroup/create.md) для ресурса [LogGroup](../api-ref/LogGroup/index.md) или вызовом gRPC API [LogGroupService/Create](../api-ref/grpc/LogGroup/create.md).
...
1. В редакторе запросов для источника:
   ...
   1. В поле **Filter query** введите запрос на [языке фильтрующих выражений](../concepts/filter.md).
...
Чтобы перестать платить за созданные ресурсы, [удалите лог-группу](../operations/delete-group.md).