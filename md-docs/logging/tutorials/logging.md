...
Для логирования работы балансировщика будет создана [лог-группа](../concepts/log-group.md) в Cloud Logging. Поставка логов из этой лог-группы в БД будет настроена с помощью ресурсов сервиса Yandex Cloud Functions — [триггера](../../functions/concepts/trigger/cloud-logging-trigger.md) и вызываемой им [функции](../../functions/concepts/function.md).
...
* Логи Cloud Logging: объем записываемых данных и время их хранения ([тарифы Cloud Logging](../pricing.md)).
...
1. [Удалите](../operations/delete-group.md) лог-группу `alb-logging-group`.