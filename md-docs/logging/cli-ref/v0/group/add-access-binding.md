[Документация Yandex Cloud](../../../../index.md) > [Yandex Cloud Logging](../../../index.md) > [Справочник CLI (англ.)](../../index.md) > [v0](../index.md) > [group](index.md) > add-access-binding
...
`yc logging v0 group add-access-binding <LOG-GROUP-NAME>|<LOG-GROUP-ID> [Flags...] [Global Flags...]`
