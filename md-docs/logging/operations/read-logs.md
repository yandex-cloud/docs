[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Logging](../index.md) > [Пошаговые инструкции](index.md) > Чтение записей

# Чтение записей

Время в журнале указано по [UTC](https://ru.wikipedia.org/wiki/Всемирное_координированное_время). Записи можно отфильтровать с помощью [языка фильтрующих выражений](../concepts/filter.md).
...
- Консоль управления {#console}
  ...
  1. На открывшейся странице на вкладке **Логи** отобразятся записи.
...
- CLI {#cli}
  ...
  * [RFC-3339](https://www.ietf.org/rfc/rfc3339.txt). Например: `2006-01-02T15:04:05Z`, `2h`, `3h30m ago`.
  ...
  Для обращения к лог-группе используйте ее имя или уникальный идентификатор. Чтобы узнать их, [получите](list.md) список лог-групп в каталоге. Если имя или идентификатор не указаны, выводятся записи из [лог-группы по умолчанию](../concepts/log-group.md) текущего каталога. Параметры `--group-name` и `--group-id` можно опустить и указать сразу имя или идентификатор группы.
...
- API {#api}
  ...
  Чтобы посмотреть записи [в лог-группе](../concepts/log-group.md), воспользуйтесь вызовом gRPC API [LogReadingService/Read](../api-ref/grpc/LogReading/read.md).
