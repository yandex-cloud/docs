[Документация Yandex Cloud](../../../../index.md) > [Yandex Cloud Logging](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [LogGroup](index.md) > ListAccessBindings

# Cloud Logging Service, gRPC: LogGroupService.ListAccessBindings
