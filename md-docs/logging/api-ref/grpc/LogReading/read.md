[Документация Yandex Cloud](../../../../index.md) > [Yandex Cloud Logging](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [LogReading](index.md) > Read
...
To get a log group ID make a [LogGroupService.List](../LogGroup/list.md#List) request.
...
Filter expression. For details about filtering, see [documentation](../../../concepts/filter.md).
...
Entry ingestion time observed by [LogIngestionService](../LogIngestion/index.md). ||
...
Entry severity.
See [LogLevel.Level](../Export/get.md#yandex.cloud.logging.v1.LogLevel.Level) for details.
