[Документация Yandex Cloud](../../index.md) > [Yandex Network Load Balancer](../index.md) > Справочник API > REST (англ.) > Overview
...
**Service URL**: `https://load-balancer.api.cloud.yandex.net`
