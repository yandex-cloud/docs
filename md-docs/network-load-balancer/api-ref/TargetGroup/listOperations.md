[Документация Yandex Cloud](../../../index.md) > [Yandex Network Load Balancer](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [TargetGroup](index.md) > ListOperations
...
is larger than [ListTargetGroupOperationsRequest.pageSize](#yandex.cloud.loadbalancer.v1.ListTargetGroupOperationsRequest), use the `nextPageToken` as the value
for the [ListTargetGroupOperationsRequest.pageToken](#yandex.cloud.loadbalancer.v1.ListTargetGroupOperationsRequest) query parameter in the next list request.
