...
- Консоль управления {#console}
  ...
  1. В блоке **Обработчики** нажмите ![image](../../_assets/console-icons/ellipsis.svg) в строке обработчика, который нужно удалить.
  1. В открывшемся меню нажмите ![trash-bin](../../_assets/console-icons/trash-bin.svg) **Удалить обработчик**.
