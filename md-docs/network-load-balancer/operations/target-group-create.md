[Документация Yandex Cloud](../../index.md) > [Yandex Network Load Balancer](../index.md) > [Пошаговые инструкции](index.md) > Целевые группы > Создать целевую группу
...
- Terraform {#tf}
  ...
  1. Опишите в конфигурационном файле параметры ресурса целевой группы.
     ...
     * `target` — описание целевого ресурса:
     ...
     Подробнее о параметрах ресурса `yandex_lb_target_group` в Terraform в [документации провайдера](../../terraform/resources/lb_target_group.md).
