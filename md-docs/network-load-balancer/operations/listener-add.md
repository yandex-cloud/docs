...
- Консоль управления {#console}
  ...
  1. В строке балансировщика, к которому нужно добавить обработчик, нажмите ![image](../../_assets/console-icons/ellipsis.svg) и выберите ![antenna-signal](../../_assets/console-icons/antenna-signal.svg) **Создать обработчик**.
