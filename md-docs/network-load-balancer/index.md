...
### Отказоустойчивый сайт с балансировкой нагрузки через {{ network-load-balancer-name }}
 ...
 - [{{ TF }}](tutorials/load-balancer-website/terraform.md)
...
### Работа с группой ВМ с автоматическим масштабированием
 ...
 - [Интеграция {{ dns-name }} и корпоративного сервиса DNS](tutorials/dns-integration.md)
...
## Справочник инструментов для {{ managed-k8s-name }}
