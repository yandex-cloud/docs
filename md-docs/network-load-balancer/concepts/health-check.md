[Документация Yandex Cloud](../../index.md) > [Yandex Network Load Balancer](../index.md) > [Концепции](index.md) > Проверка доступности ресурсов

# Проверка доступности ресурсов

*Проверка доступности ресурсов* используется сетевым балансировщиком для получения сведений о состоянии ресурсов в подключенных целевых группах. Элементы модуля проверки доступности расположены в каждой [зоне доступности](../../overview/concepts/geo-scope.md). В ответ на запрос о состоянии ресурсы сообщают, что они готовы принимать трафик или вышли из строя. Если ресурс не отвечает на запрос о состоянии в течение заданного промежутка времени, ресурс также считается вышедшим из строя. Проверка проводится по протоколу TCP или HTTP через указанные в конфигурации промежутки времени. 
