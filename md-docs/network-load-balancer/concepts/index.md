[Документация Yandex Cloud](../../index.md) > [Yandex Network Load Balancer](../index.md) > Концепции > Обзор
...
* [Группы виртуальных машин (Instance Groups)](scenarios.md#nlb-ig). Группа виртуальных машин сама отслеживает количество ВМ в группе и изменяет состав целевой группы балансировщика при необходимости.
* [Кластеры (Managed Service for Kubernetes)](scenarios.md#nlb-mk8s). Мастер кластера Kubernetes отслеживает количество ВМ в группах узлов кластера и изменяет состав целевой группы балансировщика при необходимости.

На рисунке ниже показан пример использования сетевого балансировщика совместно с набором виртуальных машин:
...
Чтобы предотвратить непреднамеренное удаление сетевого балансировщика, включите для него защиту от удаления. Вы можете включить защиту от удаления для уже [созданного балансировщика](../operations/deletion-protection.md#enable-deletion-protection) или при создании нового [внешнего](../operations/load-balancer-create.md) или [внутреннего](../operations/internal-lb-create.md) балансировщика.

## Инструменты развертывания {#tools}

Сетевой балансировщик можно развернуть в Yandex Cloud с помощью следующих инструментов:
* [Облачная консоль](https://console.yandex.cloud)
* [CLI](../../cli/quickstart.md)
* [Terraform](../../terraform/resources/lb_network_load_balancer.md)