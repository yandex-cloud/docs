[Документация Yandex Cloud](../../../../index.md) > [Yandex Network Load Balancer](../../../index.md) > [Практические руководства](../../index.md) > [Миграция сервисов с балансировщика NLB на L7-балансировщик ALB для подключения защиты Smart Web Security](../index.md) > [Балансировщик NLB с целевыми ресурсами из виртуальных машин](index.md) > Консоль управления
...
1. Перейдите в созданный L7-балансировщик и откройте вкладку **Проверки состояния**. Убедитесь, что все проверки показывают состояние `HEALTHY`.
