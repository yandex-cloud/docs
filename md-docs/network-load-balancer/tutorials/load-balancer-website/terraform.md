[Документация Yandex Cloud](../../../index.md) > [Yandex Network Load Balancer](../../index.md) > [Практические руководства](../index.md) > [Отказоустойчивый сайт с балансировкой нагрузки через Network Load Balancer](index.md) > Terraform
...
1. Подготовьте файлы с описанием инфраструктуры:
    ...
    * [Сетевой балансировщик нагрузки](../../concepts/index.md) — [yandex_lb_network_load_balancer](../../../terraform/resources/lb_network_load_balancer.md)
