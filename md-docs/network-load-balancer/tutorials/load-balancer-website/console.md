[Документация Yandex Cloud](../../../index.md) > [Yandex Network Load Balancer](../../index.md) > [Практические руководства](../index.md) > [Отказоустойчивый сайт с балансировкой нагрузки через Network Load Balancer](index.md) > Консоль управления
...
- Консоль управления {#console}
  ...
  1. В блоке **Распределение** выберите [зоны доступности](../../../overview/concepts/geo-scope.md) `ru-central1-a` и `ru-central1-b`, чтобы обеспечить отказоустойчивость хостинга.
...
- Консоль управления {#console}
  ...
  1. [Перейдите](https://console.yandex.cloud/link/network-load-balancer) в сервис **Network Load Balancer** и нажмите кнопку **Создать сетевой балансировщик**.
