[Документация Yandex Cloud](../../index.md) > [Yandex Network Load Balancer](../index.md) > [Практические руководства](index.md) > Подключение к Container Registry из Virtual Private Cloud
...
* `cr.yandex.` и ресурсная запись типа A, сопоставляющая доменное имя `cr.yandex` сервиса Container Registry с IP-адресом [внутреннего сетевого балансировщика](../concepts/nlb-types.md) `cr-nlb`. 
...
* плата за использование Network Load Balancer ([тарифы Yandex Network Load Balancer](../pricing.md));
...
* Выбирая количество ВМ с NAT, учитывайте [локальность при обработке трафика внутренним балансировщиком](../concepts/specifics.md#nlb-int-locality);
