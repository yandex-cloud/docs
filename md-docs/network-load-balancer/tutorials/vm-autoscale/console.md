[Документация Yandex Cloud](../../../index.md) > [Yandex Network Load Balancer](../../index.md) > [Практические руководства](../index.md) > [Работа с группой ВМ с автоматическим масштабированием](index.md) > Консоль управления
...
* плата за [сетевые балансировщики](../../concepts/index.md) и балансировку трафика ([тарифы Network Load Balancer](../../pricing.md)).
