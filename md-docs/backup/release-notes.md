...
* Улучшена функциональность создания виртуальной машины с подключением к {{ backup-name }} в [консоли управления]({{ link-console-main }}).
* Добавлена роль [backup.auditor](security/index.md#backup-auditor).

## IV квартал 2025 {#q4-2025}

* Реализована возможность в консоли управления [создать](operations/create-vm.md) ВМ с подключением к {{ backup-name }} без привязки сервисного аккаунта.
...
* Добавлена [квота](concepts/limits.md) на количество серверов {{ baremetal-name }}, подключенных к {{ backup-name }}, в одном облаке.
