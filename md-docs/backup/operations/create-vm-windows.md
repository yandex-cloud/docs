[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Backup](../index.md) > [Пошаговые инструкции](index.md) > Compute Cloud в Cloud Backup > Создать и подключить ВМ на Windows
...
- Консоль управления {#console}
  ...
  1. В блоке **Образ загрузочного диска** выберите [операционную систему, поддерживаемую в Cloud Backup](../concepts/vm-connection/compute.md#windows).
...
- CLI {#cli}
  ...
  1. Создайте ВМ:
      ...
      * `image-id` — [идентификатор образа](../../compute/concepts/image.md) операционной системы. [Список поддерживаемых ОС на базе Windows](../concepts/vm-connection/compute.md#windows).
