...
Информацию о том, как подключить сервер BareMetal к Cloud Backup при его заказе, смотрите в инструкции [Арендовать сервер Yandex BareMetal с подключением к Cloud Backup](lease-server-with-backup.md).
...
Чтобы избежать ошибок при восстановлении из резервной копии, перед восстановлением рекомендуется сопоставить параметры дисков и разделов резервной копии с параметрами дисков и разделов [ВМ](../../../compute/concepts/vm.md) или [сервера](../../../baremetal/concepts/servers.md) Yandex BareMetal. Подробнее в разделе [Посмотреть параметры дисков и разделов в резервной копии](../backup-vm/view-disk-layout.md).
...
1. [Удалите](../backup-vm/delete.md) резервную копию в Cloud Backup с помощью CLI.

#### Полезные ссылки {#see-also}

* [Арендовать сервер Yandex BareMetal с подключением к Cloud Backup](lease-server-with-backup.md)