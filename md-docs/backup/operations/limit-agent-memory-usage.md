[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Backup](../index.md) > [Пошаговые инструкции](index.md) > Ограничить использование оперативной памяти агентом Cloud Backup

# Ограничить использование агентом Cloud Backup оперативной памяти защищаемого ресурса
...
- Linux {#linux}
  ...
  1. [Подключитесь](../../compute/operations/vm-connect/ssh.md) к виртуальной машине Compute Cloud или серверу BareMetal по SSH. Если вы подключаетесь к [внешнему ресурсу](../concepts/vm-connection/external-resources.md), используйте удобный вам способ подключения.
...
- Windows {#windows}
  ...
  1. Подключитесь к виртуальной машине Compute Cloud [по RDP](../../compute/operations/vm-connect/rdp.md) или к серверу BareMetal [с помощью KVM-консоли](../../baremetal/operations/servers/server-kvm.md). Если вы подключаетесь к [внешнему ресурсу](../concepts/vm-connection/external-resources.md), используйте удобный вам способ подключения.
