...
Вы можете [настроить](../../monium/operations/alert/create-alert.md) алерт на любую из метрик [{{ backup-full-name }}](../index.md). Рекомендуется создать алерты на следующие события:
