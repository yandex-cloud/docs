...
- Консоль управления {#console}
  ...
  1. Перейдите в сервис [Monium](https://monium.yandex.cloud).
  ...
  1. Справа сверху нажмите кнопку **Создать** ![chevron-down](../../_assets/console-icons/chevron-down.svg) и выберите `Пользовательский`.
