...
- Консоль управления {#console}
  ...
  1. В зависимости от того, какой ресурс вы хотите отвязать от политики резервного копирования, в блоке **Привязанные ресурсы** перейдите на вкладку:
  ...
  1. В строке с ресурсом, который нужно отвязать от политики, нажмите значок ![options](../../../_assets/console-icons/ellipsis.svg) и выберите соответственно **Отвязать ВМ от политики**, **Отвязать сервер от политики** или **Отвязать ресурс**.
