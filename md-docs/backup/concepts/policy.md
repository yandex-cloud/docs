...
Резервные копии ресурсов Yandex Cloud создаются в Cloud Backup автоматически в соответствии с _политиками резервного копирования_.
...
По умолчанию ВМ и серверы Yandex BareMetal в Cloud Backup не связаны ни с одной политикой резервного копирования. Чтобы начать создавать резервные копии, привяжите [виртуальную машину](../operations/policy-vm/attach-and-detach-vm.md) или [сервер BareMetal](../operations/backup-baremetal/backup-baremetal.md#agent-install) к одной или нескольким политикам.
...
Если вы вносите изменения в правила хранения резервных копий, то по умолчанию они вступят в силу после создания очередной резервной копии. Подробное описание параметров настройки правил хранения резервных копий — в следующем разделе.
...
| `runLater` | Если во время запланированного резервного копирования ВМ была в статусе `Stopped`, все пропущенные задания резервного копирования выполнятся после запуска ВМ. | <ul><li>`true` — включено;</li><li>`false` — выключено.</li></ul> |
...
* [Привязать виртуальную машину или сервер Yandex BareMetal к политике резервного копирования](../operations/policy-vm/attach-and-detach-vm.md)
* [Отвязать виртуальную машину или сервер Yandex BareMetal от политики резервного копирования](../operations/policy-vm/detach-vm.md)
