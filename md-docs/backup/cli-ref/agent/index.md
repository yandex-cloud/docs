[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Backup](../../index.md) > [Справочник CLI (англ.)](../index.md) > agent > Overview
...
- [yc backup agent install-external](install-external.md) — Generates a command to install backup agent on an external instance.
