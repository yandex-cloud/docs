 ...
 * [Установите агент Cloud Backup](../../operations/connect-vm-oslogin-linux.md#cli_5)
 * [Переподключить виртуальную машину на Linux с OS Login к Cloud Backup](../../operations/refresh-connection-oslogin-linux.md#cli_1)