[Документация Yandex Cloud](../../../../index.md) > [Yandex Cloud Backup](../../../index.md) > [Справочник CLI (англ.)](../../index.md) > [v0](../index.md) > [agent](index.md) > install-external
...
`yc backup v0 agent install-external <vm | server> [Flags...] [Global Flags...]`
