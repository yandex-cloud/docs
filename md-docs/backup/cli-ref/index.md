 ...
 * [Запустите создание резервной копии](../operations/backup-baremetal/backup-baremetal.md#cli_4)
 * [Переподключить сервер Yandex BareMetal к Cloud Backup](../operations/backup-baremetal/refresh-connection.md#cli_1)