[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Backup](../../index.md) > [Практические руководства](../index.md) > [Автоматическая привязка политики резервного копирования к ВМ](index.md) > Terraform
