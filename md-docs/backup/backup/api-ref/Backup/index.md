[Документация Yandex Cloud](../../../../index.md) > [Yandex Cloud Backup](../../../index.md) > Справочник API > [REST (англ.)](../index.md) > Backup > Overview

# Cloud Backup API, REST: Backup

A set of methods for managing [backups](../../../concepts/backup.md).
