[Документация Yandex Cloud](../../../../../index.md) > [Yandex Cloud Backup](../../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > Policy > Overview

# Cloud Backup API, gRPC: PolicyService

A set of methods for managing [policies](../../../../concepts/policy.md).

## Methods

#|
||Method | Description ||
|| [List](list.md) | List [policies](../../../../concepts/policy.md) of specified folder. ||
