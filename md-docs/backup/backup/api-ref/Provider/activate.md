[Документация Yandex Cloud](../../../../index.md) > [Yandex Cloud Backup](../../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Provider](index.md) > Activate
...
```
POST https://backup.api.cloud.yandex.net/backup/v1/providers/{name}:activate
```
...
For more information, please see [activate-provider](../../../quickstart/index.md#activate-provider) ||
|#
