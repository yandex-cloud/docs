[Документация Yandex Cloud](../../../../index.md) > [Yandex Cloud Backup](../../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Policy](index.md) > Create

# Cloud Backup API, REST: Policy.Create

Create a new policy.

For detailed information, please see [Creating a backup policy](../../../operations/policy-vm/create.md).
