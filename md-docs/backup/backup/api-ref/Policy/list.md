[Документация Yandex Cloud](../../../../index.md) > [Yandex Cloud Backup](../../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Policy](index.md) > List

# Cloud Backup API, REST: Policy.List

List [policies](../../../concepts/policy.md) of specified folder.

## HTTP request

```
GET https://backup.api.cloud.yandex.net/backup/v1/policies
```
