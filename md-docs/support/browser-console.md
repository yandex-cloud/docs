[Документация Yandex Cloud](../index.md) > [Описание технической поддержки](index.md) > Копирование ошибок из консоли браузера

# Копирование ошибок из консоли браузера

Если при работе со страницами и интерактивными элементами [консоли управления](https://console.yandex.cloud) Yandex Cloud возникла проблема, причину поломки поможет определить информация из консоли браузера. Скопируйте сообщение из консоли ошибок и передайте его в [техническую поддержку](https://center.yandex.cloud/support).
...
- Яндекс Браузер {#yandex}
  ...
  1. Приложите лог ошибок или скриншоты к сообщению в [техническую поддержку](https://center.yandex.cloud/support).
