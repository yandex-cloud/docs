...
1. В блоке **Способы уведомления** настройте каналы уведомления.

    Вы можете получать уведомления по электронной почте, в SMS или через Telegram-бота.
1. В блоке **Настройки уведомлений** выберите типы отправляемых уведомлений и каналы получения для каждого типа:
...
1. В блоке **Способы уведомления** в секции **Добавить URL вебхука** нажмите **Добавить**.
...
После подтверждения URL и указанное имя вебхука отобразятся в секции **Способы уведомления**.
