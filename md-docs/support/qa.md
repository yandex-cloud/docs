...
Если вы успешно аутентифицировались с аккаунтом Яндекса, но не можете подключиться к консоли управления Yandex Cloud, обратитесь в службу технической поддержки по электронной почте [support@yandex.cloud](mailto:support@yandex.cloud).
