...
- Цены в рублях {#prices-rub}
  ...
  Стоимость поддержки начисляется на тот же платежный аккаунт, к которому прикреплен платно потребленный ресурс. Счет за предыдущий отчетный период (календарный месяц) выставляется в начале следующего отчетного периода. Процесс оплаты для физических и юридических лиц отличаются. Подробная информация в разделах [Цикл оплаты для физических лиц](../billing/payment/billing-cycle-individual.md) и [Цикл оплаты для организаций и ИП](../billing/payment/billing-cycle-business.md) документации сервиса Yandex Cloud Billing.
...
При расчете тарифа поддержки в 5% от стоимости потребляемых ресурсов включаются корректировки, подписки и зарезервированное потребление ресурсов платежного аккаунта, привязанного к организации и оплачивающего поддержку. Из расчета тарифа поддержки в 5% от стоимости потребляемых ресурсов исключается стоимость продуктов Cloud Marketplace, как показано в [примере расчета](#business-example-one-ba-cvos).
