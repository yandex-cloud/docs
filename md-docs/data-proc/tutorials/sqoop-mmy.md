[Документация Yandex Cloud](../../index.md) > [Yandex Data Processing](../index.md) > [Практические руководства](index.md) > Интеграция Yandex Data Processing с другими сервисами > Импорт данных из кластера Managed Service for MySQL® с помощью Sqoop
...
* Вручную {#manual}
    ...
    1. Если вы создавали бакет Yandex Object Storage, [удалите его](../../storage/operations/buckets/delete.md).
