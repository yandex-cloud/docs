[Документация Yandex Cloud](../../index.md) > [Yandex Data Processing](../index.md) > [Практические руководства](index.md) > Сетевые настройки и обслуживание кластера > Настройка сети для Yandex Data Processing
...
- Вручную {#manual}
    ...
    1. В сети `data-proc-network` [создайте группу безопасности](../../vpc/operations/security-group-create.md) с именем `data-proc-security-group` и следующими правилами:
        ...
        * Правило, разрешающее доступ к NTP-серверам для синхронизации времени:
        ...
        Вы можете добавить [дополнительные правила в группу безопасности](../operations/security-groups.md), чтобы подключиться к хостам кластера.
