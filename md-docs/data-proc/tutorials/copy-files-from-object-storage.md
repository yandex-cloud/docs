...
Подробнее об используемых версиях компонентов см. в разделе [Среда исполнения](../concepts/environment.md).
...
Подробнее см. на странице [Настройки Spark для работы с Yandex Object Storage](../concepts/settings-list.md#spark-settings).