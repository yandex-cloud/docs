[Документация Yandex Cloud](../../index.md) > [Yandex Data Processing](../index.md) > [Практические руководства](index.md) > Сетевые настройки и обслуживание кластера > Миграция кластера с HDFS в другую зону доступности
...
1. [Подключитесь по SSH](../operations/connect-ssh.md) к хосту-мастеру первоначального кластера.
...
1. Добавьте в него список директорий, предназначенных для переноса:
   ...
   В команде укажите FQDN хоста-мастера первоначального кластера. О том, как получить FQDN, читайте в [инструкции](../operations/fqdn.md).
...
О том, как это сделать, читайте в [инструкции](../operations/cluster-delete.md).