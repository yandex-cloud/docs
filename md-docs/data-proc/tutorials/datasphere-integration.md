...
После этого файл появится в бакете. Чтобы просматривать содержимое бакета в интерфейсе JupyterLab, создайте и активируйте в проекте [коннектор S3](../../datasphere/operations/data/s3-connectors.md).
...
* [кластер](../operations/cluster-delete.md);
