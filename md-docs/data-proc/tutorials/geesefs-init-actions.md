[Документация Yandex Cloud](../../index.md) > [Yandex Data Processing](../index.md) > [Практические руководства](index.md) > Интеграция Yandex Data Processing с другими сервисами > Object Storage > Монтирование бакетов к файловой системе хостов Yandex Data Processing
