[Документация Yandex Cloud](../../index.md) > [Yandex Data Processing](../index.md) > [Практические руководства](index.md) > Работа с заданиями > Работа с заданиями Hive
...
1. [Создайте задание Hive](../operations/jobs-hive.md#create) с параметрами:
...
1. [Откройте логи задания](../operations/jobs-hive.md#get-logs) и просмотрите результаты обработки:
