...
1. [Создайте задание PySpark](../operations/jobs-pyspark.md#create) для записи сообщения в топик Apache Kafka®. В поле **Main python файл** укажите путь до скрипта `s3a://dataproc-bucket/kafka-write.py`.
