...
Вы можете выключить передачу логов кластера в сервис Yandex Cloud Logging. Подробнее в разделе [Работа с логами](logging.md#disable-logs).
...
- Консоль управления {#console}
    ...
    1. Выберите нужный кластер и нажмите ![image](../../_assets/console-icons/pencil.svg) **Редактировать** на панели сверху.
    ...
    1. Измените настройки кластера:
        ...
        * **Группы безопасности** — [группы безопасности](../concepts/network.md#security-groups), которые будут использоваться кластером.
            ...
            Некорректные настройки групп безопасности могут препятствовать работе кластера Yandex Data Processing. Подробнее о настройке групп безопасности в разделе [Настройка групп безопасности](security-groups.md).
        ...
        * **Лог-группа** — [лог-группа](../../logging/concepts/log-group.md) Yandex Cloud Logging, в которую кластер будет отправлять логи.
            ...
            Чтобы кластер мог отправлять логи, [назначьте](../../iam/operations/roles/grant.md) сервисному аккаунту кластера роль `logging.writer`. Подробнее в [документации Yandex Cloud Logging](../../logging/security/index.md).
