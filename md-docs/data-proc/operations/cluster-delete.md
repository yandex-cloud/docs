...
Для удаления кластера {{ dataproc-name }} пользователю должна быть [назначена](../../iam/operations/roles/grant.md) роль `dataproc.editor`. Подробнее в [описании ролей](../security/index.md#roles-list).
