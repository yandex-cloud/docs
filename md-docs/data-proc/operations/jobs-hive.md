[Документация Yandex Cloud](../../index.md) > [Yandex Data Processing](../index.md) > [Пошаговые инструкции](index.md) > Задания (jobs) > Задания Hive
...
- Консоль управления {#console}
    ...
    1. Выберите нужный кластер и перейдите на вкладку **Задания**.
    1. Нажмите **Создать задание**.
    1. (Опционально) Укажите имя задания.
    1. В поле **Тип задания** выберите `Hive`.
    1. (Опционально) В поле **Настройки** укажите [свойства компонентов](../concepts/settings-list.md) в виде пары `ключ-значение`.
...
- Консоль управления {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) выберите каталог.
  1. [Перейдите](https://console.yandex.cloud/link/data-proc) в сервис **Yandex Data Processing**.
  1. Выберите нужный кластер и перейдите в раздел **Задания**.
