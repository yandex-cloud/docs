...
- Консоль управления {#console}
    ...
    1. Выберите нужный кластер и перейдите на вкладку **Подкластеры**.
    1. В строке с нужным подкластером нажмите ![image](../../_assets/console-icons/ellipsis.svg) и выберите ![image](../../_assets/console-icons/pencil.svg) **Редактировать**.
...
- Консоль управления {#console}
    ...
    1. В [консоли управления](https://console.yandex.cloud) выберите каталог.
    1. [Перейдите](https://console.yandex.cloud/link/data-proc) в сервис **Yandex Data Processing**.
    1. Выберите нужный кластер и перейдите на вкладку **Хосты**.
    1. Нажмите на имя нужного хоста.
    1. В блоке **Сеть** нажмите на значок ![image](../../_assets/console-icons/ellipsis.svg) и выберите ![image](../../_assets/console-icons/pencil.svg) **Изменить**.
