[Документация Yandex Cloud](../../index.md) > [Yandex Data Processing](../index.md) > [Пошаговые инструкции](index.md) > Задания (jobs) > Запуск заданий

# Запуск заданий

Задание можно запустить несколькими способами:

* [Создайте задания в Yandex Data Processing](jobs.md). После этого они запустятся автоматически.
