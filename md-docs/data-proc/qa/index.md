...
Чтобы ее исправить, [добавьте свойство](../operations/cluster-update.md) `spark:spark.sql.hive.metastore.sharedPrefixes` со значением `com.amazonaws,ru.yandex.cloud` в кластер {{ dataproc-name }}.
...
Чтобы ее исправить, [добавьте](../operations/cluster-update.md) в кластер {{ dataproc-name }} свойства:
...
Подробнее о режимах размещения драйвера и потреблении вычислительной мощности в разделе [{#T}](../concepts/spark-sql.md#resource-management).
...
* [Создайте задания в {{ dataproc-name }}](../operations/jobs.md). После этого они запустятся автоматически.
