...
1. При необходимости [настройте группы безопасности](../operations/cluster-create.md#change-security-groups). Если вы не используете группы безопасности, то настраивать их не нужно.
