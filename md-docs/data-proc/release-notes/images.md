...
* Добавлена возможность использования [Apache Spark Thrift Server](https://spark.apache.org/docs/latest/sql-distributed-sql-engine.html). Подробнее в разделе [Использование Apache Spark Thrift Server](../concepts/settings-list.md#spark-thrift-server).
