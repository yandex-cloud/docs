[Документация Yandex Cloud](../index.md) > [Yandex Data Processing](index.md) > Начало работы
...
1. Задайте параметры кластера и нажмите **Создать кластер**. Процесс подробно рассмотрен в разделе [Создание кластера](operations/cluster-create.md).
