[Документация Yandex Cloud](../../index.md) > [Yandex Data Processing](../index.md) > [Концепции](index.md) > Классы хостов > Действующие классы хостов
...
Подробнее о режимах размещения драйвера и потреблении вычислительной мощности в разделе [Распределение ресурсов](spark-sql.md#resource-management).
