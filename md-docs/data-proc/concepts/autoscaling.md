...
{{ dataproc-full-name }} поддерживает автоматическое масштабирование [подкластеров для обработки данных](index.md) на основе метрик, которые поставляются в сервис [{{ monitoring-full-name }}](../../monitoring/concepts/index.md):
