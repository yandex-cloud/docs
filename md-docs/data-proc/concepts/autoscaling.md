[Документация Yandex Cloud](../../index.md) > [Yandex Data Processing](../index.md) > [Концепции](index.md) > Автоматическое масштабирование

# Автоматическое масштабирование подкластеров

{% note info %}

Автоматическое масштабирование подкластеров поддерживается в кластерах Yandex Data Processing версии 1.4 и выше.

{% endnote %}


Yandex Data Processing поддерживает автоматическое масштабирование [подкластеров для обработки данных](index.md) на основе метрик, которые поставляются в сервис [Yandex Monitoring](../../monitoring/concepts/index.md):
...
Подробнее о механизмах автоматического масштабирования читайте в [документации Instance Groups](../../compute/concepts/instance-groups/scale.md#auto-scale).
...
* **Целевой уровень загрузки CPU, %** — масштабирование на основе метрики загрузки vCPU. Подробнее о масштабировании на ее основе читайте в [документации Instance Groups](../../compute/concepts/instance-groups/scale.md#cpu-utilization).
