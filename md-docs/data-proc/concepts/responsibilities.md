...
* **Кластерные операции**. Обеспечение работоспособности кластерных операций, описанных в [документации {{ dataproc-name }}](../index.md) и доступных через [консоль управления](../../console/index.md), [API](../../api-design-guide/index.md), [CLI](../../cli/index.md) или [Terraform](../../terraform/index.md). За исключением случаев вмешательства клиента напрямую в объекты операций минуя интерфейсы {{ dataproc-name }}, например, удаление или изменение виртуальных машин, сетей, групп безопасности, используемых в операциях {{ dataproc-name }}.
