[Документация Yandex Cloud](../../index.md) > [Yandex Data Processing](../index.md) > [Концепции](index.md) > Декомиссия подкластеров и хостов

# Декомиссия подкластеров и хостов Yandex Data Processing

Декомиссия — процедура уменьшения мощности кластера (числа хостов и их класса) без его остановки и прерывания рабочей нагрузки. Декомиссия поддерживается для кластеров Yandex Data Processing версии 1.2 и выше.

В Yandex Data Processing декомиссия реализована на основе [YARN](https://hadoop.apache.org/docs/current/hadoop-yarn/hadoop-yarn-site/YARN.html) и [HDFS](https://hadoop.apache.org/docs/current/hadoop-project-dist/hadoop-hdfs/HdfsDesign.html). При выполнении декомиссии уже запущенные пользовательские задания не будут прерваны, а данные не будут потеряны.
