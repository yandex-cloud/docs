...
* На _выделенных хостах_ Yandex Cloud.
    ...
    Подробнее о выделенных хостах см. в [документации Yandex Compute Cloud](../../compute/concepts/dedicated-host.md).

О сетевой конфигурации и сетевом доступе к кластеру см. раздел [Сеть в Yandex Data Processing](network.md).
