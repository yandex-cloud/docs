[Документация Yandex Cloud](../index.md) > [Yandex Data Processing](index.md) > Правила тарификации
...
| ------------------------------------------------------------------------------------ | -------- | --------------- | -------------- | ------------ |
| Yandex Data Processing. Вычислительные ресурсы хостов, AMD Zen 4, 100% vCPU          | 0,1383 ₽ | vCPU × час      | 30 апреля 2026 | —            |
| Yandex Data Processing. Вычислительные ресурсы хостов, AMD Zen 4, RAM                | 0,0345 ₽ | ГБ × час        | 30 апреля 2026 | —            |
| Yandex Data Processing. Вычислительные ресурсы хостов, Intel Broadwell, 100% vCPU    | 0,1209 ₽ | vCPU × час      | 30 апреля 2026 | —            |
| Yandex Data Processing. Вычислительные ресурсы хостов, Intel Broadwell, 20% vCPU     | 0,0219 ₽ | vCPU × час      | 30 апреля 2026 | —            |
| Yandex Data Processing. Вычислительные ресурсы хостов, Intel Broadwell, RAM          | 0,0329 ₽ | ГБ × час        | 30 апреля 2026 | —            |
| Yandex Data Processing. Вычислительные ресурсы хостов, Intel Cascade Lake, 100% vCPU | 0,1383 ₽ | vCPU × час      | 30 апреля 2026 | —            |
| Yandex Data Processing. Вычислительные ресурсы хостов, Intel Cascade Lake, 20% vCPU  | 0,023 ₽  | vCPU × час      | 30 апреля 2026 | —            |
| Yandex Data Processing. Вычислительные ресурсы хостов, Intel Cascade Lake, 50% vCPU  | 0,0691 ₽ | vCPU × час      | 30 апреля 2026 | —            |
| Yandex Data Processing. Вычислительные ресурсы хостов, Intel Cascade Lake, RAM       | 0,0345 ₽ | ГБ × час        | 30 апреля 2026 | —            |
| Yandex Data Processing. Вычислительные ресурсы хостов, Intel Ice Lake, 100% vCPU     | 0,1383 ₽ | vCPU × час      | 30 апреля 2026 | —            |
| Yandex Data Processing. Вычислительные ресурсы хостов, Intel Ice Lake, 50% vCPU      | 0,0691 ₽ | vCPU × час      | 30 апреля 2026 | —            |
| Yandex Data Processing. Вычислительные ресурсы хостов, Intel Ice Lake, RAM           | 0,0345 ₽ | ГБ × час        | 30 апреля 2026 | —            |
