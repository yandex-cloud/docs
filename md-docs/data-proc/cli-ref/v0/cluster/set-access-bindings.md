[Документация Yandex Cloud](../../../../index.md) > [Yandex Data Processing](../../../index.md) > [Справочник CLI (англ.)](../../index.md) > [v0](../index.md) > [cluster](index.md) > set-access-bindings

# yc dataproc v0 cluster set-access-bindings

Set access bindings for the specified cluster and delete all existing access bindings if there were any

#### Command Usage

Syntax:

`yc dataproc cluster set-access-bindings <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
