[Документация Yandex Cloud](../../index.md) > [Обзор платформы](../index.md) > Платформа Yandex Cloud > Регионы
...
* [Инструкция для региона Россия](../../getting-started/index.md)
* [Инструкция для региона Казахстан](../../getting-started/index.md)
