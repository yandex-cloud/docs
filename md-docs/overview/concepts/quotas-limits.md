...
|| Количество [экземпляров SpeechSense](../../speechsense/quickstart.md), привязанных к одному платежному аккаунту 
...
^1^ Чтобы увеличить [квоты](https://console.yandex.cloud/cloud?section=quotas) на файловые хранилища, оптимизированные для развертывания образы, выделенные хосты или пулы резервов ВМ, обратитесь в [техническую поддержку](https://center.yandex.cloud/support).
...
Максимальное количество [словарей](../../speechsense/concepts/dictionaries.md) в пространстве | 100
