[Документация Yandex Cloud](../../index.md) > [Обзор платформы](../index.md) > Сервисы Yandex Cloud > Квоты и лимиты
...
^2^ Лимит `Максимальное количество приемников у триггера` — общий для сервисов API Gateway, Cloud Functions и Serverless Containers.
...
**Рабочие процессы** |
Максимальное количество [рабочих процессов](https://aistudio.yandex.ru/docs/ru/ai-studio/concepts/workflows/workflow) в облаке | 30
Максимальное количество активных [запусков рабочих процессов](https://aistudio.yandex.ru/docs/ru/ai-studio/concepts/workflows/execution) в облаке | 100
Максимальное время выполнения запуска | 48 часов
**Translate** {#translate-quotas}
Вызовов одного метода API в секунду | 20
Символов, отправленных на перевод или определение языка, в час | 1 млн
**Vision OCR** {#vision-quotas} |
...
**Генерация текста** |
Максимальное количество токенов в ответе в [Playground](https://aistudio.yandex.ru/platform/link/models) | 1 000
**Классификация текста** |
...
**Текстовые агенты**|
Максимальное количество сохраненных конфигураций Responses API | 1 000
Количество агентов в каталоге | 100
Количество опубликованных каналов у одного агента | 10
Количество одновременно выполняемых операций в облаке | 10
Количество сообщений в минуту в одном диалоге | 40
Количество сообщений в минуту через веб-виджет или интерфейс тестирования | 1 200
**Поиск по файлам**
...
|| Количество правил в политиках аутентификации в организации
`organization-manager.authenticationPolicyRules.count` | 10 ||
|| Количество SAML-сертификатов для федераций
`organization-manager.federationCertificates.count` | 100 ||
|| Количество пользователей во всех федерациях в организации
...
|| Общий объем RAM виртуальных машин в одном облаке^1^
`compute.instanceMemory.size` | 128 ГБ ||
|| Количество [групп виртуальных машин](../../compute/concepts/instance-groups/index.md) в одном облаке
`compute.instanceGroups.count` | 10 ||
|| Количество [групп размещения](../../compute/concepts/placement-groups.md) в одном облаке
...
#|
|| Вид ограничения | Значение ||
|| Количество [vCPU](../../compute/concepts/performance-levels.md) виртуальных машин в одном облаке^1^
`compute.instanceCores.count` | 32 ||
|| Количество vCPU виртуальных машин на платформах Compute Optimized в одном облаке^1^
...
#|
|| Вид ограничения | Значение ||
|| Количество [GPU](../../compute/concepts/gpus.md) NVIDIA® Tesla® V100 в одном облаке^1^
`compute.instanceGpus.count` | 0 ||
|| Количество GPU NVIDIA® Ampere® A100 в одном облаке^1^
`compute.instanceA100Gpus.count` | 0 ||
|| Количество GPU на платформе AMD EPYC™ 9474F with Gen2 в одном облаке^1^
`compute.instanceV3IGpus.count` | 0 ||
|| Количество GPU NVIDIA® Tesla® T4 в одном облаке^1^
`compute.instanceT4Gpus.count` | 0 ||
|| Количество GPU NVIDIA® Tesla® T4 в одном облаке в зоне доступности `ru-central1-d`^1^
`compute.instanceT4Gpus.count.ru-central1-d` | 0 ||
|| Количество GPU на платформе Intel Ice Lake with T4i в одном облаке^1^
...
#|
|| Вид ограничения | Значение ||
|| Количество [дисков](../../compute/concepts/disk.md) в одном облаке
`compute.disks.count` | 32 ||
|| Общий объем [HDD-дисков](../../compute/concepts/disk.md#disks-types) в одном облаке
`compute.hddDisks.size` | 500 ГБ ||
|| Общий объем SSD-дисков в одном облаке
`compute.ssdDisks.size` | 200 ГБ ||
|| Общий объем нереплицируемых SSD-дисков в одном облаке
`compute.ssdNonReplicatedDisks.size` | 558 ГБ ||
|| Общий объем высокопроизводительных SSD-дисков в одном облаке
`compute.ssdIOM3Disks.size` | 186 ГБ ||
|| Количество [групп размещения дисков](../../compute/concepts/disk-placement-group.md) в одном облаке
...
#|
|| Вид ограничения | Значение ||
|| Количество [сетевых файловых хранилищ](../../compute/concepts/filesystem.md) в одном облаке
`compute.filesystems.count` | 100 ||
|| Общий объем сетевых файловых HDD-хранилищ в одном облаке
`compute.hddFilesystems.size` | 512 ГБ ||
|| Общий объем сетевых файловых SSD-хранилищ в одном облаке
...
|| Количество [образов, оптимизированных для развертывания](../../compute/concepts/image.md#images-optimized-for-deployment), в одном облаке^2^
...
#|
|| Вид ограничения | Значение ||
|| Количество [снимков дисков](../../compute/concepts/snapshot.md) в одном облаке
`compute.snapshots.count` | 32 ||
|| Общий объем снимков дисков в одном облаке
...
#|
|| Вид ограничения | Значение ||
|| Количество [выделенных хостов](../../compute/concepts/dedicated-host.md) в одном облаке^2^
...
|| Количество [пулов резервов виртуальных машин](../../compute/concepts/reserved-pools.md) в одном облаке^2^
`compute.reservedInstancePools.count` | 1 ||
|#

^1^ Квота включает в себя ресурсы свободных слотов в [пулах резервов ВМ](../../compute/concepts/reserved-pools.md).

^2^ Чтобы увеличить [квоты](https://console.yandex.cloud/cloud?section=quotas) на оптимизированные для развертывания образы, выделенные хосты или пулы резервов ВМ, обратитесь в [техническую поддержку](https://center.yandex.cloud/support).
...
- Intel Broadwell {#broadwell}
  ...
  || Максимальное количество дисков и файловых хранилищ, подключенных к одной ВМ^3^ | [Топология шины](../../compute/concepts/hardware-generations.md#configurations) `PCI_TOPOLOGY_V1` | Кол-во vCPU <= 18 | 8 ||
  || ^ | ^ | Кол-во vCPU > 18 | 16^4^ ||
...
- Intel Cascade Lake {#cascade}
  ...
  || Максимальное количество дисков и файловых хранилищ, подключенных к одной ВМ^3^ | [Топология шины](../../compute/concepts/hardware-generations.md#configurations) `PCI_TOPOLOGY_V1` | Кол-во vCPU <= 20 | 8 ||
  || ^ | ^ | Кол-во vCPU > 20 | 16^4^ ||
  || ^ | Топология шины `PCI_TOPOLOGY_V2` | Кол-во vCPU <= 4 | 62 ||
  || ^ | ^ | Кол-во vCPU >= 6 | 80 ||
  || Максимальное количество [сетевых интерфейсов](../../compute/concepts/network.md), подключенных к одной ВМ | Топология шины
...
- Intel Ice Lake {#ice}
  ...
  || Максимальное количество дисков и файловых хранилищ, подключенных к одной ВМ^3^ | [Топология шины](../../compute/concepts/hardware-generations.md#configurations) `PCI_TOPOLOGY_V1` | Кол-во vCPU <= 32 | 8 ||
  || ^ | ^ | Кол-во vCPU > 32 | 16^4^ ||
  || ^ | Топология шины `PCI_TOPOLOGY_V2` | Кол-во vCPU <= 4 | 62 ||
  || ^ | ^ | Кол-во vCPU >= 6 | 80 ||
  || Максимальное количество [сетевых интерфейсов](../../compute/concepts/network.md), подключенных к одной ВМ | Топология шины
...
^3^ Включая загрузочный диск.

^4^ На старте к ВМ может быть подключено не более 14 устройств, включая загрузочный диск и сетевую карту. Остальные устройства требуется подключать к уже запущенной ВМ. Обратите внимание, если вы перезапустите ВМ, к которой подключено более 14 устройств, она не сможет загрузиться.
...
- Сетевой SSD-диск {#net-ssd}
  ...
  Вид ограничения | Значение
  --- | ---
  Максимальный^5^ [IOPS](../../compute/concepts/storage-read-write.md) на каждый vCPU ВМ | 3 500
  Максимальная^6^ [пропускная способность](../../compute/concepts/storage-read-write.md) на каждый vCPU ВМ | 45 МБ/с
...
- Нереплицируемый SSD-диск {#non-replicated-ssd}
  ...
  Максимальный^5^ [IOPS](../../compute/concepts/storage-read-write.md) на каждый vCPU ВМ | 10 000
  Максимальный^5^ IOPS для одной ВМ | 100 000
  Максимальная^6^ [пропускная способность](../../compute/concepts/storage-read-write.md) на каждый vCPU ВМ | 100 МБ/с
  Максимальная^6^ пропускная способность для одной ВМ | 1 ГБ/с
...
- Сетевой SSD-диск {#net-ssd}
  ...
  Максимальный^5^ IOPS на запись, на 1 диск | 40 000
  Максимальный^5^ IOPS на запись, на блок размещения | 1 000
  Максимальная^6^ пропускная способность на запись, на 1 диск | 450 МБ/с
  Максимальная^6^ пропускная способность на запись, на блок размещения | 15 МБ/с
  Максимальный^5^ IOPS на чтение, на 1 диск | 20 000
  Максимальный^5^ IOPS на чтение, на блок размещения | 1 000
  Максимальная^6^ пропускная способность на чтение, на 1 диск | 450 МБ/с
  Максимальная^6^ пропускная способность на чтение, на блок размещения | 15 МБ/с
...
- Сетевой HDD-диск {#net-hdd}
  ...
  Максимальный^5^ IOPS на запись, на 1 диск | 11 000
  Максимальный^5^ IOPS на запись, на блок размещения | 300
  Максимальная^6^ пропускная способность на запись, на 1 диск | 240 МБ/с
  Максимальная^6^ пропускная способность на запись, на блок размещения | 30 МБ/с
  Максимальный^5^ IOPS на чтение, на 1 диск | 2 000
  Максимальный^5^ IOPS на чтение, на блок размещения | 300
  Максимальная^6^ пропускная способность на чтение, на 1 диск | 240 МБ/с
  Максимальная^6^ пропускная способность на чтение, на блок размещения | 30 МБ/с
...
- Нереплицируемый SSD-диск {#non-replicated-ssd}
  ...
  Максимальный^5^ IOPS на запись, на 1 диск | 75 000
  Максимальный^5^ IOPS на запись, на блок размещения | 5 600
  Максимальная^6^ пропускная способность на запись, на 1 диск | 1 ГБ/с
  Максимальная^6^ пропускная способность на запись, на блок размещения | 82 МБ/с
  Максимальный^5^ IOPS на чтение, на 1 диск | 75 000
  Максимальный^5^ IOPS на чтение, на блок размещения | 28 000
  Максимальная^6^ пропускная способность на чтение, на 1 диск | 1 ГБ/с
  Максимальная^6^ пропускная способность на чтение, на блок размещения | 110 МБ/с
...
^5^ Для получения максимального значения IOPS рекомендуется делать операции чтения и записи, по объему близкие к размеру блока диска (по умолчанию — 4 КБ).

^6^ Для получения максимального значения пропускной способности рекомендуется делать чтения и записи размером 4 МБ.
...
Вид ограничения | Значение
--- | ---
Время на завершение процессов при остановке ВМ^7^ | 30 секунд

^7^ При остановке ВМ [гипервизор](../../glossary/virtualization.md) посылает операционной системе ВМ сигнал о завершении работы. В течение 30 секунд ОС должна мягко завершить текущие процессы, чтобы избежать потери данных. По истечении этого времени процесс ВМ принудительно останавливается.
...
#|
|| Вид ограничения | Значение ||
|| Суммарное количество [привязок](../../iam/concepts/access-control/index.md#access-bindings) прав доступа в облаке^1^
`iam.accessBindings.count` | 1 000 ||
|| Суммарное количество [привязок](../../iam/concepts/access-control/index.md#access-bindings) прав доступа в организации^1^
`iam.accessBindings.count` | 2 000 ||
|| Количество назначенных [политик авторизации](../../iam/concepts/access-control/access-policies.md) в облаке
`iam.accessPolicyBindings.count` | 100 ||
|| Количество назначенных [политик авторизации](../../iam/concepts/access-control/access-policies.md) в организации
...
|| Количество пользовательских окружений в одном облаке
...
|| Объем данных на хосте при использовании хранилища на локальных SSD-дисках (для платформы Intel Cascade Lake) | в 2 раза больше выбранного объема RAM, но не менее 100 ГБ | 1 536 ГБ ||
...
В пределах одной [зоны доступности](geo-scope.md) в целевую группу могут входить ресурсы, подключенные к одной подсети.
