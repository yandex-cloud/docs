...
1. Проверьте, имеет ли команда Bash одноименную команду в вашем терминале. Например, в PowerShell выполните:
   ...
   Полный список псевдонимов приведен в выводе команды `alias`.
