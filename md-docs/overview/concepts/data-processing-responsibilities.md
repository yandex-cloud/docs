[Документация Yandex Cloud](../../index.md) > [Обзор платформы](../index.md) > Сервисы Yandex Cloud > Разграничение зон контроля > Разграничение зон контроля в Yandex Data Processing
...
* **Кластерные операции**. Обеспечение работоспособности кластерных операций, описанных в [документации Yandex Data Processing](../../data-proc/index.md) и доступных через [консоль управления](../../console/index.md), [API](../../api-design-guide/index.md), [CLI](../../cli/index.md) или [Terraform](../../terraform/index.md). За исключением случаев вмешательства клиента напрямую в объекты операций минуя интерфейсы Yandex Data Processing, например, удаление или изменение виртуальных машин, сетей, групп безопасности, используемых в операциях Yandex Data Processing.
