[Документация Yandex Cloud](../../index.md) > [Обзор платформы](../index.md) > Платформа Yandex Cloud > Разграничение зон контроля в Managed Service for Apache Airflow™
...
Каждый [кластер Apache Airflow™](../../managed-airflow/concepts/index.md#cluster) запускается в отдельной группе узлов Yandex Managed Service for Kubernetes, которая изолирована от других кластеров средствами виртуальных сетей и самого Kubernetes. Группы узлов управляются общим Kubernetes-мастером под управлением Yandex Cloud.
...
* **Компоненты Apache Airflow™ под управлением Yandex Cloud**. Обеспечение работоспособности основных [компонентов Apache Airflow™](../../managed-airflow/concepts/index.md#components):
...
* **Обновление версий**. Подготовка к обновлению версии Apache Airflow™ после получения оповещения или ознакомления с [политикой работы с версиями Apache Airflow™](../../managed-airflow/concepts/update-policy.md): анализ истории изменений, проверка совместимости DAG, операторов и зависимостей с целевой версией.
