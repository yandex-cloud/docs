...
* [{{ ml-sdk-full-name }}]({{ link-docs-ai }}ai-studio/sdk/index) — для сервисов [{{ ai-studio-full-name }}](https://yandex.cloud/ru/ai-studio).
* [Python SDK {{ speechkit-name }}](https://pypi.org/project/yandex-speechkit/)
* [SDK видеоплеера](../../video/sdk/index.md) — для [{{ video-full-name }}](../../video/index.md).
* [YDB SDK](https://ydb.tech/docs/ru/reference/ydb-sdk/) — для [{{ ydb-full-name }}](../../ydb/index.md) и [{{ yq-full-name }}](../../query/index.md).
...
* [{{ console-full-name }}](../../console/index.md)
