[Документация Yandex Cloud](../../../index.md) > [Обзор платформы](../../index.md) > [Сопоставление с другими платформами](../index.md) > [Сопоставление с VMware](index.md) > Ресурсно-ролевая модель
...
Организации изолированы друг от друга. Ресурсы одной организации не могут взаимодействовать с ресурсами другой средствами Yandex Cloud. Сервис [Yandex Identity Hub](../../../organization/index.md) управляет организациями.
...
| В Yandex Cloud за аналогичный функционал отвечает сервис Virtual Private Cloud, который располагается в каталогах.

Ключевым отличием Yandex Cloud VPC от Organization Networks в VMware является реализация сценария multi-folder, при котором сеть VPC может быть доступна в пределах одного облака. ||
|#
...
| Роли бывают двух типов:
  ...
  * _Сервисные_ — содержат разрешения только для определенного типа ресурсов в указанном сервисе. Например, роль `compute.images.user` позволяет использовать образы в сервисе Yandex Compute Cloud.
...
Подробное описание примитивных и сервисных ролей, а также их иерархии — в документации [IAM](../../../iam/concepts/access-control/roles.md) и [Resource Manager](../../../resource-manager/concepts/resources-hierarchy.md). ||
