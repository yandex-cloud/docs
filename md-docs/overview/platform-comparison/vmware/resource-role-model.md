...
Организации изолированы друг от друга. Ресурсы одной организации не могут взаимодействовать с ресурсами другой средствами {{ yandex-cloud }}. Сервис [{{ org-full-name }}](../../../organization/index.md) управляет организациями.
