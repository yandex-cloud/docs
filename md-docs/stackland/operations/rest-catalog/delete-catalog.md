[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Stackland](../../index.md) > [Пошаговые инструкции](../index.md) > Базы данных > Iceberg REST Catalog > Удалить каталог

# Удалить каталог

Если у вас есть каталог [Iceberg REST Catalog](../../concepts/components/rest-catalog.md) в [проекте](../projects/create-project.md), вы можете удалить его.
