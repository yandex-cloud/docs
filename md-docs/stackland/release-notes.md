...
В версии 26.1.0 {{ stackland-name }} переходит в стадию [General Availabilty](../overview/concepts/launch-stages.md). Представлены новые возможности и улучшения, которые повышают удобство работы с платформой и расширяют ее функциональность.
