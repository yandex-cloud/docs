...
В консоль управления Stackland добавлена поддержка управления компонентами [Iceberg REST Catalog](concepts/components/overview.md#rest-catalog) и [Managed Service for Trino](concepts/components/overview.md#trino).
...
* Расширен сбор диагностической информации через [`sladm diag`](operations/troubleshooting.md).
