...
В версии 26.1.0 Stackland переходит в стадию [General Availability](../overview/concepts/launch-stages.md). Представлены новые возможности и улучшения, которые повышают удобство работы с платформой и расширяют ее функциональность.
