[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Stackland](../../index.md) > Концепции > [Компоненты](overview.md) > Дисковая подсистема
...
Алерты дисковой подсистемы дополняют [мониторинг оборудования](../hardware-monitoring.md), который отслеживает физическое состояние дисков (SMART, ошибки I/O, температуру).
