...
* Локальные пользователи — создание пользователей и управление ими происходят непосредственно в Identity and Access Management. Подходит для небольших команд или тестовых окружений.
