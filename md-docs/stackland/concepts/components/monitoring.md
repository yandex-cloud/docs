...
Помимо готовых дашбордов, вы можете создать собственные и добавить на них метрики ваших приложений. Про создание дашбордов читайте в разделе [Создать дашборд](../../operations/monitoring/dashboard-create.md).
