...
Secrets Injector готов к работе сразу после развертывания кластера и не требует дополнительной настройки. Secrets Injector использует хранилище OpenBao в Stackland. При необходимости можно настроить использование собственного хранилища секретов в кастомном ресурсе в [параметре](#secretsInjector-settings) `secretsAddr`.
