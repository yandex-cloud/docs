...
В образах PostgreSQL до Stackland 26.2.0 была обнаружена ошибка: образы, помеченные как версии 15 и 16, фактически содержали PostgreSQL 17. Из-за этого кластеры, созданные с указанием `spec.version: "15"` или `spec.version: "16"`, уже работали на PostgreSQL 17.

После исправления в Stackland 26.2.0 образы правильно отображают версию 17. Кластеры, ранее созданные с указанием `spec.version: "15"` или `spec.version: "16"`, отображаются как PostgreSQL 17 — это соответствует действительно развернутой версии.
