[Документация Yandex Cloud](../index.md) > Облачная терминология > Облачная терминология
...
## Базы данных
 ...
 - [Колоночные базы данных](columnar-databases.md)

## Аналитика

 - [Аналитика данных](data-analytics.md)

 - [Бизнес-аналитика](business-analytics.md)

 - [Сквозная аналитика](end-to-end-analytics.md)
...
## Искусственный интеллект
 ...
 - [Большая языковая модель](llm.md)
...
## Сети и доставка контента
 ...
 - [Виртуальная частная сеть (VPN)](vpn.md)
