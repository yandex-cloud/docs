[Документация Yandex Cloud](../index.md) > [Облачная терминология](index.md) > Управление проектами и задачами > Kanban-доска
...
Помимо системы Kanban, широкое применение имеет методика управления проектами [Scrum](https://yandex.cloud/ru/blog/posts/2023/02/scrum-or-kanban). Оба метода являются вариантами реализации принципов [Agile](https://yandex.cloud/ru/blog/posts/2022/10/agile-and-project-management). Agile — это модель управления проектами, основанная на адаптивном планировании, эволюционном развитии и непрерывном улучшении.
...
## Примеры использования Kanban-доски в Яндекс Трекер {#examples}

[Яндекс Трекер](https://yandex.ru/support/tracker/ru/) — это сервис для управления проектами и процессами. Трекер подходит для организации любой работы — программной разработки, проведения рекламной кампании, взаимодействия с пользователями, согласования документов.

В январе 2019 года, всего за месяц, в Трекер перевели документооборот SkillFactory — отечественная платформа обучения работе с данными.
В работе используется практически весь инструментарий Трекер — канбан-доски, дашборды, триггеры, автодействия. В Трекер реализованы многие бизнес-процессы.

Например, так в Трекер устроен процесс поиска и сопровождения сотрудника:

1.	С помощью инструмента [Яндекс Формы](https://yandex.ru/support/forms/ru) заводится заявка на поиск сотрудника.
1.	В Трекер происходит подробное описание вакансии и согласование с руководителем. Здесь же можно контролировать все действия с вакансией.
1.	После определения кандидата через Hunt Flow в Трекер формируется предложение о работе на основе шаблона. На почту кандидату приходит предложение с ссылкой на заполнение анкеты в Forms. После заполнения и отправки формы в Трекер автоматически создается задача на прием для команды кадров. Автоматически формируется связь с задачей на вакансию, а последняя закрывается.
1.	Также через Трекер происходит выдача доступов и ЭЦП новому сотруднику.
...
Подробнее о Трекер в [документации](https://yandex.ru/support/tracker/ru/).
