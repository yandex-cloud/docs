...
Подробнее о {{ tracker-name }} в [документации]({{ link-tracker-cloudless }}).
...
* [Scrum или Kanban: что выбрать и как с ними работать в {{ tracker-full-name }}](https://yandex.cloud/ru/blog/posts/2023/02/scrum-or-kanban).
