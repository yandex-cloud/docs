[Документация Yandex Cloud](../index.md) > [Облачная терминология](index.md) > Управление проектами и задачами > Спринт

# Спринт

Спринт — это основной элемент [Scrum-методологии](https://yandex.cloud/ru/blog/posts/2023/02/scrum-or-kanban#chto-takoe-scrum) для управления проектами. Использование этого метода предполагает фокусирование на коротких итерациях и частых выпусках инкремента продукта — работоспособной части продукта, готовой для тестирования.
...
Внедрить спринт в работу очень просто с помощью [Яндекс Трекер](https://tracker.yandex.ru/). Благодаря этому сервису использовать спринт будет просто и удобно. Воспользуйтесь [пошаговой инструкцией](https://yandex.ru/support/tracker/ru/manager/create-agile-sprint), чтобы создать и настроить спринт.