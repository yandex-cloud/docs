[Документация Yandex Cloud](../index.md) > [Облачная терминология](index.md) > Сети и доставка контента > Вебхук
...
* Данные могут потеряться. Сбой на сервере или проблемы на стороне клиента — и данные просто не дойдут.
...
* [Yandex Managed Service for GitLab](https://yandex.cloud/ru/services/managed-gitlab/) — сервис для управления платформой разработки GitLab в инфраструктуре Yandex Cloud. Подробнее в [документации](../managed-gitlab/index.md).
* [SourceCraft](https://sourcecraft.dev) — платформа от Яндекса для разработки IT-продуктов в режиме непрерывной интеграции. Подробнее в [документации](https://sourcecraft.dev/portal/docs/ru).
