[Документация Yandex Cloud](../index.md) > [Облачная терминология](index.md) > Базы данных > Кластер
...
* [Yandex Managed Service for MySQL®](https://yandex.cloud/ru/services/managed-mysql/) — для управления кластерами самой популярной реляционной СУБД MySQL®. [Документация Managed Service for MySQL®](../managed-mysql/index.md).

* [Yandex Managed Service for PostgreSQL](https://yandex.cloud/ru/services/managed-postgresql/) — для управления кластерами объектно-реляционной СУБД PostgreSQL. [Документация Managed Service for PostgreSQL](../managed-postgresql/index.md).

* [Yandex Managed Service for ClickHouse®](https://yandex.cloud/ru/services/managed-clickhouse/) — для управления кластерами высокопроизводительной колоночной СУБД ClickHouse®. [Документация Managed Service for ClickHouse®](../managed-clickhouse/index.md).

Подробнее обо всех сервисах Yandex Cloud вы можете прочитать в [документации](../index.md).

## Полезные ссылки {#links}

* [Пошаговые инструкции для Managed Service for Kubernetes®](../managed-kubernetes/operations/index.md)
* [Управление доступом в Managed Service for Kubernetes®](../managed-kubernetes/security/index.md)
* [Вопросы и ответы про Managed Service for Kubernetes®](../managed-kubernetes/qa/all.md)
* [Документация Managed Service for YDB](../ydb/index.md)
