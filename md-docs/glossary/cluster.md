...
* [{{ mmy-full-name }}](https://yandex.cloud/ru/services/managed-mysql/) — для управления кластерами самой популярной реляционной СУБД MySQL®. [Документация {{ mmy-name }}](../managed-mysql/index.md).

* [{{ mpg-full-name }}](https://yandex.cloud/ru/services/managed-postgresql/) — для управления кластерами объектно-реляционной СУБД PostgreSQL. [Документация {{ mpg-name }}](../managed-postgresql/index.md).

* [{{ mch-full-name }}](https://yandex.cloud/ru/services/managed-clickhouse/) — для управления кластерами высокопроизводительной колоночной СУБД ClickHouse®. [Документация {{ mch-name }}](../managed-clickhouse/index.md).
...
* [Документация {{ ydb-name }}](../ydb/index.md)
