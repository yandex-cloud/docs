[Документация Yandex Cloud](../index.md) > [Облачная терминология](index.md) > Речевые технологии > Транскрибация
...
## Транскрибация от Yandex SpeechKit {#transcription-from-Yandex-SpeechKit}

В сервисе [Yandex SpeechKit](https://yandex.cloud/ru/services/speechkit/) используется технология транскрибации, которая позволяет преобразовать аудиоинформацию в текст.
...
Сервис [SpeechKit](https://aistudio.yandex.ru/docs/ru/speechkit/overview) предоставляет доступ к потоковому, синхронному и асинхронному [распознаванию речи](https://aistudio.yandex.ru/docs/ru/speechkit/stt/index) высокой точности.
...
[Зарегистрируйтесь](https://console.yandex.cloud/) в Yandex Cloud и начните пользоваться возможностями платформы уже сегодня.

## Полезные материалы {#useful-materials}

* [Документация SpeechKit](https://aistudio.yandex.ru/docs/ru/speechkit/overview)
* Блог:
