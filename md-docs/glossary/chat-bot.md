...
Все это помогает автоматизировать процессы, сэкономить бюджет и время сотрудников, а также дать клиенту быстрый ответ. Например, сервис [HR Messenger](https://hrmessenger.com/) обрабатывает отклики от 160 кандидатов в минуту. На это понадобилось бы как минимум девять сотрудников. Облачная платформа Yandex Cloud позволяет чат-боту работать без сбоев, [экономя 70% бюджета](https://yandex.cloud/ru/cases/hrmessenger) на подбор персонала.
...
* [Создание навыка Алисы](../functions/tutorials/alice-skill.md) на основе [Yandex Cloud Functions](https://yandex.cloud/ru/services/functions/).
