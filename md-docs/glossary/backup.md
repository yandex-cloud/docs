...
В {{ yandex-cloud }} вы можете создать резервные копии виртуальных машин при помощи сервиса [{{ backup-full-name }}](https://yandex.cloud/ru/services/backup).
...
* [Сравнение {{ backup-full-name }} и снимков дисков в {{ compute-full-name }}](../backup/concepts/index.md#snapshot-comparison)