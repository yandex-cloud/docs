[Документация Yandex Cloud](../index.md) > [Облачная терминология](index.md) > Управление проектами и задачами > Бэклог
...
Разработка бэклога в контексте Agile-проекта делится на две популярные [методологии — _Scrum_ и _Kanban_](https://yandex.cloud/ru/blog/posts/2023/02/scrum-or-kanban). У каждой из них есть свои особенности, поэтому при выборе нужно учитывать потребности проекта и предпочтения команды.
...
Вы можете использовать [Яндекс Трекер](https://tracker.yandex.ru/) — сервис для управления проектами и создания бэклога любой сложности.

[Документация](https://yandex.ru/support/tracker/ru/) по работе с **Яндекс Трекер**.

[Блог](https://yandex.cloud/ru/blog/posts/2023/02/scrum-or-kanban) с советами по выбору между Scrum и Kanban и инструкцией по работе с ними в **Яндекс Трекер**.