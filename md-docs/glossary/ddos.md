...
* [Yandex DDoS Protection](https://yandex.cloud/ru/services/ddos-protection) — сервис для защиты приложений.
...
* [Yandex Virtual Private Cloud](../vpc/ddos-protection/index.md) — сервис для управления облачными сетями с возможностью защиты от DDoS-атак. Подробнее см. в [документации](../vpc/index.md).
