...
* [{{ ddos-protection-full-name }}](https://yandex.cloud/ru/services/ddos-protection) — сервис для защиты приложений.

* [Создание](../application-load-balancer/tutorials/alb-with-ddos-protection/index.md) L7-балансировщика [{{ alb-full-name }}](https://yandex.cloud/ru/services/application-load-balancer) с защитой от DDoS-атак.

* [{{ vpc-full-name }}](../vpc/ddos-protection/index.md) — сервис для управления облачными сетями с возможностью защиты от DDoS-атак. Подробнее в [документации](../vpc/index.md).

* Файрволы веб-приложений:

   * [SolidWall WAF](https://yandex.cloud/ru/marketplace/products/solidsoft/solidwall-waf)
