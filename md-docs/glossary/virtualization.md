[Документация Yandex Cloud](../index.md) > [Облачная терминология](index.md) > Облачные вычисления и сервера > Виртуализация
...
[Зарегистрируйтесь](https://console.yandex.cloud/) на платформе Yandex Cloud и начните пользоваться ее возможностями уже сегодня.

Полезные ресурсы Yandex Cloud:
* [Обзор платформы](../overview/index.md)
