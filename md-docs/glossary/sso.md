...
* Поставщик удостоверений (Identity Provider) — Yandex Identity Hub предоставляет доступ к внешним сервисам через [SAML-приложения](../organization/concepts/applications.md#saml) и [OIDC-приложения](../organization/concepts/applications.md#oidc).

Подробнее см. в [документации Yandex Identity Hub](../organization/concepts/add-federation.md).