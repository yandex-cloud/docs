[Документация Yandex Cloud](../index.md) > [Облачная терминология](index.md) > Безопасность > Технология единого входа (SSO)
...
Сервис [Yandex Identity Hub](../organization/index.md) с помощью технологии единого входа может выступать в двух ролях:
...
* Поставщик удостоверений (Identity Provider) — Yandex Identity Hub предоставляет доступ к внешним сервисам через [SAML-приложения](../organization/concepts/applications/saml.md) и [OIDC-приложения](../organization/concepts/applications/oidc.md).

Подробнее в [документации Yandex Identity Hub](../organization/concepts/add-federation.md).
