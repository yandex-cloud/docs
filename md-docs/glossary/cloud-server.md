[Документация Yandex Cloud](../index.md) > [Облачная терминология](index.md) > Облачные вычисления и сервера > Облачный сервер
...
Облачные услуги в основном предоставляются по трем моделям: программное обеспечение как услуга ([_SaaS_](https://yandex.cloud/ru/blog/posts/2023/03/saas), _Software-as-a-Service_), платформа как услуга ([_PaaS_](https://yandex.cloud/ru/blog/posts/2023/03/paas), _Platform-as-a-Service_) и инфраструктура как услуга ([_IaaS_](https://yandex.cloud/ru/blog/posts/2022/01/iaas), _Infrastructure-as-a-Service_).
...
Сервис [Yandex Compute Cloud](https://yandex.cloud/ru/services/compute/) предоставляет доступ к масштабируемым вычислительным мощностям, на базе которых создаются единичные виртуальные машины или их отказоустойчивые группы. К этим машинам можно подключать диски, которые автоматически реплицируются для сохранности данных. Функция съемки дисков позволяет быстро переносить данные с одного диска на другой. [Широкий выбор других сервисов](https://yandex.cloud/ru/services#_all) позволяет формировать различные комбинации услуг, чтобы подобрать решение специально под ваши задачи.
...
[Обсудите пилотный проект](https://yandex.cloud/ru/for-business#contact-form) с нашим специалистом, чтобы получить представление обо всех условиях партнерства.

### Полезные материалы

* [Документация Yandex Compute Cloud](../compute/index.md)
* [Блог](https://yandex.cloud/ru/blog)
* Истории успеха:
    * [Как обрабатывать 160+ кандидатов в минуту: кейс HR Messenger и Yandex Cloud](https://yandex.cloud/ru/cases/hrmessenger)
    * [Личные данные для корпоративного пользования: ЕАЕ-Консалт провел миграцию системы SAP HCM в Yandex Cloud](https://yandex.cloud/ru/cases/eae-consult)
* Видео по теме:
    * [Настройка Yandex Cloud — виртуальная машина с пробным периодом](https://www.youtube.com/watch?v=9bIyY_UYg94)
    * [Compute Cloud: автоматизированный рендеринг в облаке. Опыт ТурбоРендер](https://www.youtube.com/watch?v=ZSIhTCMA4MA)