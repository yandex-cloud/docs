[Документация Yandex Cloud](../index.md) > [Облачная терминология](index.md) > Сети и доставка контента > Cookie
...
Платформа Yandex Cloud использует cookie `yc_session` для аутентификации пользователя. Для консоли управления каждого сервиса используется независимые друг от друга cookie, но все они привязаны к единой логической сессии.

Чтобы узнать подробнее о системе защиты персональных данных Yandex Cloud, смотрите страницу [Соответствие требованиям](../security/conform.md).