[Документация Yandex Cloud](../index.md) > [Облачная терминология](index.md) > Хранение и обработка данных > Снапшот
...
В Yandex Cloud для резервного копирования и восстановления ресурсов и данных на них используется сервис [Yandex Cloud Backup](../backup/concepts/index.md).
...
## Снапшоты в Yandex Compute Cloud {#snapshot-in-cloud}

[Yandex Compute Cloud](https://yandex.cloud/ru/services/compute/) — это сервис масштабируемых вычислительных мощностей для размещения, тестирования и прототипирования проектов. Он позволяет создавать виртуальные машины и подключать к ним диски. А там, где есть диски с данными, должна поддерживаться и [технология снапшотов](../compute/concepts/snapshot.md).

Снапшоты в сервисе Compute Cloud могут применяться в следующих целях:
...
Работа со снимками подробно описана в [документации Yandex Compute Cloud](../compute/index.md), поэтому вы сможете быстро внедрить эту технологию в свою повседневную практику.

#### Видео по теме {#see-also}

* [Compute Cloud: анонсы](https://www.youtube.com/watch?v=HAH1ylEusvQ).
* [Возможности Yandex Cloud](https://www.youtube.com/watch?v=79IZ97Hj4jw).
* [Разбор Compute Cloud](https://www.youtube.com/watch?v=W1r7bBoDtZ8).
