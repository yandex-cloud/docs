...
В {{ yandex-cloud }} доступен сервис [{{ iam-full-name }}](../iam/index.md), который обеспечивает централизованное управление ресурсами с помощью разных методов. Рассмотрим основные методы аутентификации с использованием JWT:
