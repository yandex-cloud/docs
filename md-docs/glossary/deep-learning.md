[Документация Yandex Cloud](../index.md) > [Облачная терминология](index.md) > Искусственный интеллект > Глубокое обучение (Deep Learning)
...
* [Yandex AI Studio](https://aistudio.yandex.ru/docs/ru/) — платформа для создания и внедрения ИИ-решений. Включает:
  * Model Gallery — коллекция готовых предобученных моделей для задач компьютерного зрения, NLP и генерации контента. Подробнее в [документации](https://aistudio.yandex.ru/docs/ru/ai-studio/concepts/).
  * Agent Atelier — среда для создания ИИ-агентов на базе моделей глубокого обучения. Подробнее в [документации](https://aistudio.yandex.ru/docs/ru/ai-studio/concepts/agents/).
...
* [Руководство по машинному обучению](https://yandex.cloud/ru/blog/machine-learning-guide/)
* [Компьютерное зрение: как это работает](https://yandex.cloud/ru/blog/computer-vision-guide/)
* [MLOps: как выстроить процессы разработки ML-моделей](https://yandex.cloud/ru/blog/posts/2025/02/mlops/)
* [Файн-тюнинг: как дообучить языковую модель под свои задачи](https://yandex.cloud/ru/blog/posts/2025/03/fine-tuning/)