[Документация Yandex Cloud](../index.md) > [Облачная терминология](index.md) > Облачные вычисления и сервера > Графический процессор (GPU)
...
Центральный процессор и интегрированный графический процессор работают на одной линии питания.
...
Чтобы решать задачи искусственного интеллекта, обработки Big Data, задачи машинного обучения, визуализации, рендеринга, работы с виртуальными приложениями, не нужно приобретать графические процессоры, достаточно взять GPU напрокат у [Yandex Compute Cloud](https://yandex.cloud/ru/services/compute/). Срок аренды можно определить самостоятельно.
...
Чтобы начать работу с Yandex Cloud, обратитесь к разделу [Начало работы](../getting-started/index.md).