...
* Со стеками все чаще используют такие технологии контейнеризации, как Docker и [Kubernetes](../managed-kubernetes/index.md).
...
* [Публичный образ](https://yandex.cloud/ru/marketplace/products/yc/lamp) с набором предустановленных программных компонентов LAMP.
* [Публичный образ](https://yandex.cloud/ru/marketplace/products/yc/lemp) с набором предустановленных программных компонентов LEMP.
