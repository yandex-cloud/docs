...
С помощью технологий Yandex Cloud вы можете создать онлайн-сервис для сокращения URL. Сервис будет принимать запросы пользователей в виде URL и возвращать их сокращенные версии. Подробнее см. в руководстве [Сокращатель ссылок](../tutorials/serverless/serverless-url-shortener/index.md).