[Документация Yandex Cloud](../index.md) > [Облачная терминология](index.md) > Облачные вычисления и сервера > Виртуальная машина
...
Примером подобной хост-системы является сервис [Yandex Compute Cloud](https://yandex.cloud/ru/services/compute) — облачная платформа, использующая инфраструктуру и уникальные технологии Яндекса.
...
Виртуальные машины Compute Cloud поддерживают работу со снимками дисков пользователя для быстрого развертывания системы. Кроме того, в [Yandex Cloud Marketplace](https://yandex.cloud/ru/marketplace?categories=os) доступны для приобретения диски с образами самых распространенных OC семейства Linux.

Работа сервиса регулируется [соглашением об уровне обслуживания](https://yandex.ru/legal/cloud_sla/).

Подключитесь к сервису и [познакомьтесь](../compute/index.md) с его основными возможностями и тарифами.