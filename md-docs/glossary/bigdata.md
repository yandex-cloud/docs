...
* **Хранение**
    ...
    * [Data Warehouse](https://yandex.cloud/ru/blog/posts/2022/06/data-warehouse) — единое корпоративное хранилище с обработанной и структурированной информацией. Хранилище упрощает анализ полученных данных, но требует структурированности.
...
-----------|--------|---------------------
Обработка транзакций | [Managed Service for PostgreSQL](https://yandex.cloud/ru/services/managed-postgresql/)<br>[Yandex StoreDoc](https://yandex.cloud/ru/services/storedoc/)<br>[Managed Service for MySQL®](https://yandex.cloud/ru/services/managed-mysql/) | [Документация Managed Service for PostgreSQL](../managed-postgresql/index.md)<br>[Документация Yandex StoreDoc](../storedoc/index.md)<br>[Документация Managed Service for MySQL®](../managed-mysql/index.md)
Запросы и отчеты | [Yandex Data Processing](https://yandex.cloud/ru/services/data-proc)<br>[Yandex MPP Analytics for PostgreSQL](https://yandex.cloud/ru/services/managed-greenplum/)<br>[Managed Service for ClickHouse®](https://yandex.cloud/ru/services/managed-clickhouse/) | [Документация Yandex Data Processing](../data-proc/index.md)<br>[Документация Yandex MPP Analytics for PostgreSQL](../managed-greenplum/index.md)<br>[Документация Managed Service for ClickHouse®](../managed-clickhouse/index.md)
New SQL | [Managed Service for YDB](https://yandex.cloud/ru/services/ydb/) | [Документация Managed Service for YDB](../ydb/index.md)
Документоориентированная СУБД | [Yandex StoreDoc](https://yandex.cloud/ru/services/storedoc/) | [Документация Yandex StoreDoc](../storedoc/index.md)
Резидентная СУБД | [Yandex Managed Service for Valkey™](https://yandex.cloud/ru/services/managed-redis/) | [Документация Yandex Managed Service for Valkey™](../managed-valkey/index.md)
БД «ключ — значение» | [Yandex Data Processing](https://yandex.cloud/ru/services/data-proc)<br>[Yandex MPP Analytics for PostgreSQL](https://yandex.cloud/ru/services/managed-greenplum/)<br>[Yandex StoreDoc](https://yandex.cloud/ru/services/storedoc/) | [Документация Yandex Data Processing](../data-proc/index.md)<br>[Документация Yandex MPP Analytics for PostgreSQL](../managed-greenplum/index.md)<br>[Документация Yandex StoreDoc](../storedoc/index.md)
БД временных рядов | [Managed Service for ClickHouse®](https://yandex.cloud/ru/services/managed-clickhouse/) | [Документация Managed Service for ClickHouse®](../managed-clickhouse/index.md)
Потоковая обработка | [Yandex Data Processing](https://yandex.cloud/ru/services/data-proc)<br>[Managed Service for Apache Kafka®](https://yandex.cloud/ru/services/managed-kafka/) | [Документация Yandex Data Processing](../data-proc/index.md)<br>[Документация Managed Service for Apache Kafka®](../managed-kafka/index.md)
Полнотекстовый поиск | [Managed Service for OpenSearch](https://yandex.cloud/ru/services/managed-opensearch/) | [Документация Managed Service for OpenSearch](../managed-opensearch/index.md)
Очередь сообщений | [Message Queue](https://yandex.cloud/ru/services/message-queue/) | [Документация Message Queue](../message-queue/index.md)

### Полезные материалы {#see-also}

* [Бизнес-аналитика и визуализация данных в облаке](https://yandex.cloud/ru/solutions/data-analysis)
* [Рекомендательная система для ритейла и e‑commerce](https://yandex.cloud/ru/solutions/recommendation-system)
* [Data Science в облаке](https://yandex.cloud/ru/solutions/data-science)
* [Корпоративное хранилище данных](https://yandex.cloud/ru/solutions/data-warehouse)
* [Автоматизация колл‑центров в облаке](https://yandex.cloud/ru/solutions/call-center)
