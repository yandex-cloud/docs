...
-----------|--------|---------------------
Обработка транзакций | [{{ mpg-name }}](https://yandex.cloud/ru/services/managed-postgresql/)<br>[{{ mmg-name }}](https://yandex.cloud/ru/services/storedoc/)<br>[{{ mmy-name }}](https://yandex.cloud/ru/services/managed-mysql/) | [Документация {{ mpg-name }}](../managed-postgresql/index.md)<br>[Документация {{ mmg-name }}](../storedoc/index.md)<br>[Документация {{ mmy-name }}](../managed-mysql/index.md)
Запросы и отчеты | [{{ dataproc-name }}](https://yandex.cloud/ru/services/data-proc)<br>[{{ mgp-name }}](https://yandex.cloud/ru/services/managed-greenplum/)<br>[{{ mch-name }}](https://yandex.cloud/ru/services/managed-clickhouse/) | [Документация {{ dataproc-name }}](../data-proc/index.md)<br>[Документация {{ mgp-name }}](../managed-greenplum/index.md)<br>[Документация {{ mch-name }}](../managed-clickhouse/index.md)
New SQL | [{{ ydb-name }}](https://yandex.cloud/ru/services/ydb/) | [Документация {{ ydb-name }}](../ydb/index.md)
Документоориентированная СУБД | [{{ mmg-name }}](https://yandex.cloud/ru/services/storedoc/) | [Документация {{ mmg-name }}](../storedoc/index.md)
Резидентная СУБД | [{{ mrd-name }}](https://yandex.cloud/ru/services/managed-redis/) | [Документация {{ mrd-name }}](../managed-valkey/index.md)
БД «ключ — значение» | [{{ dataproc-name }}](https://yandex.cloud/ru/services/data-proc)<br>[{{ mgp-name }}](https://yandex.cloud/ru/services/managed-greenplum/)<br>[{{ mmg-name }}](https://yandex.cloud/ru/services/storedoc/) | [Документация {{ dataproc-name }}](../data-proc/index.md)<br>[Документация {{ mgp-name }}](../managed-greenplum/index.md)<br>[Документация {{ mmg-name }}](../storedoc/index.md)
БД временных рядов | [{{ mch-name }}](https://yandex.cloud/ru/services/managed-clickhouse/) | [Документация {{ mch-name }}](../managed-clickhouse/index.md)
Потоковая обработка | [{{ dataproc-name }}](https://yandex.cloud/ru/services/data-proc)<br>[{{ mkf-name }}](https://yandex.cloud/ru/services/managed-kafka/) | [Документация {{ dataproc-name }}](../data-proc/index.md)<br>[Документация {{ mkf-name }}](../managed-kafka/index.md)
Полнотекстовый поиск | [{{ mos-name }}](https://yandex.cloud/ru/services/managed-opensearch/) | [Документация {{ mos-name }}](../managed-opensearch/index.md)
Очередь сообщений | [{{ message-queue-name }}](https://yandex.cloud/ru/services/message-queue/) | [Документация {{ message-queue-name }}](../message-queue/index.md)
