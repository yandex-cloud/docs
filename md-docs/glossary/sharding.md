[Документация Yandex Cloud](../index.md) > [Облачная терминология](index.md) > Хранение и обработка данных > Шардирование
...
1. [Managed Service for YDB](https://yandex.cloud/ru/services/ydb/) — распределенная отказоустойчивая СУБД, поддерживающая автоматическое шардирование. Подробнее в [документации](../ydb/index.md).

1. Сервисы для работы с кластерами серверов разных СУБД со встроенным шардированием.

   * [Yandex StoreDoc](https://yandex.cloud/ru/services/storedoc/). Подробнее в [документации](../storedoc/index.md).

   * [Yandex Managed Service for Valkey™](https://yandex.cloud/ru/services/managed-redis/). Подробнее в [документации](../managed-valkey/index.md).

   * [Managed Service for ClickHouse®](https://yandex.cloud/ru/services/managed-clickhouse/). Подробнее в [документации](../managed-clickhouse/index.md).

   * [Managed Service for Sharded PostgreSQL](https://yandex.cloud/ru/services/managed-spqr/). Подробнее в [документации](../managed-spqr/index.md).

   * [Yandex MPP Analytics for PostgreSQL](https://yandex.cloud/ru/services/managed-greenplum/). Подробнее в [документации](../managed-greenplum/index.md).
