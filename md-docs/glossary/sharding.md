...
1. [{{ ydb-name }}](https://yandex.cloud/ru/services/ydb/) — распределенная отказоустойчивая СУБД, поддерживающая автоматическое шардирование. Подробнее в [документации](../ydb/index.md).

1. Сервисы для работы с кластерами серверов разных СУБД со встроенным шардированием.

   * [{{ mmg-name }}](https://yandex.cloud/ru/services/storedoc/). Подробнее в [документации](../storedoc/index.md).

   * [{{ mrd-name }}](https://yandex.cloud/ru/services/managed-redis/). Подробнее в [документации](../managed-valkey/index.md).

   * [{{ mch-name }}](https://yandex.cloud/ru/services/managed-clickhouse/). Подробнее в [документации](../managed-clickhouse/index.md).

   * [{{ mspqr-name }}](https://yandex.cloud/ru/services/managed-spqr/). Подробнее в [документации](../managed-spqr/index.md).

   * [{{ mgp-name }}](https://yandex.cloud/ru/services/managed-greenplum/). Подробнее в [документации](../managed-greenplum/index.md).
