...
[{{ iot-short-name }}](https://yandex.cloud/ru/services/iot-core) — это сервис интернета вещей для двустороннего обмена сообщениями между устройствами по протоколу MQTT.
...
[Подробная документация](../iot-core/index.md) и [доступные тарифы](../iot-core/pricing.md) помогают быстро приступить к работе. [Создайте свой первый реестр]({{ link-console-main }}/link/iot-core/) и протестируйте сервис {{ iot-short-name }} уже сейчас.
