[Документация Yandex Cloud](../index.md) > [Облачная терминология](index.md) > Интернет вещей > MQTT-сервер
...
Протокол MQTT применяется в следующих сферах:
  ...
  * оплата услуг мобильных операторов и провайдеров;
...
[Yandex IoT Core](https://yandex.cloud/ru/services/iot-core) — это сервис интернета вещей для двустороннего обмена сообщениями между устройствами по протоколу MQTT.
...
С Yandex IoT Core можно автоматически балансировать и масштабировать сеть. Данные защищены по всем точкам подключения, и обмен сообщениями MQTT происходит только после аутентификации. Поддерживается два уровня качества обслуживания: QoS 0 и QoS 1.

[Подробная документация](../iot-core/index.md) и [доступные тарифы](../iot-core/pricing.md) помогают быстро приступить к работе. [Создайте свой первый реестр](https://console.yandex.cloud/link/iot-core/) и протестируйте сервис Yandex IoT Core уже сейчас.


### Статьи и видео по теме {#see-also}

  * [История успеха FESCOM](https://yandex.cloud/ru/cases/fescom)
  * [Статья про интернет вещей](https://yandex.cloud/ru/blog/posts/2019/11/iot-core-scale) в блоге Yandex Cloud
