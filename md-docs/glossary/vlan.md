...
* [{{ vpc-full-name }}](https://yandex.cloud/ru/services/vpc) — сервис для управления облачными сетями и связи облачных ресурсов между собой и с интернетом. Позволяет создавать изолированные подсети внутри одной сети. Подробнее в [документации](../vpc/index.md).
* [{{ alb-full-name }}](https://yandex.cloud/ru/services/application-load-balancer) — сервис для распределения входящего трафика между разными компонентами ваших веб‑приложений. Подробнее в [документации](../application-load-balancer/index.md).
* [{{ interconnect-full-name }}](https://yandex.cloud/ru/services/interconnect) — сервис для создания приватных выделенных сетевых соединений между локальной инфраструктурой и {{ yandex-cloud }}. Подробнее в [документации](../interconnect/index.md).
