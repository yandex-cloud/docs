...
Полноценная API-платформа | <ul><li>[{{ api-gw-full-name }}](https://yandex.cloud/ru/services/api-gateway)</li><li>[Stoplight](https://stoplight.io/)</li></ul>
...
{{ yandex-cloud }} предлагает [{{ api-gw-full-name }}](https://yandex.cloud/ru/services/api-gateway) — полностью управляемый сервис для разработки, развертывания, управления и обеспечения безопасности API-шлюзов. Среди основных возможностей сервиса:
...
* [Создание интерактивного приложения с использованием {{ api-gw-full-name }} и протокола WebSocket](https://yandex.cloud/ru/blog/posts/2023/04/yandex-api-gateway-and-websocket)
* [Распределение нагрузки с помощью {{ api-gw-full-name }} и других инструментов балансировки](https://yandex.cloud/ru/blog/posts/2024/04/api-gateway-or-yandex-alb)
* [Разграничение доступа к API с помощью {{ api-gw-full-name }}](https://yandex.cloud/ru/blog/posts/2023/07/yandex-api-gateway-and-jwt-authorizer)