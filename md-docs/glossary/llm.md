...
* [Yandex DataSphere](https://yandex.cloud/ru/services/datasphere/) — сервис, позволяющий создавать новые модели, а также дообучать фундаментальные, чтобы они точнее отвечали на ваши запросы. Подробнее см. в [документации](../datasphere/index.md).
* [Yandex SpeechSense](https://yandex.cloud/ru/services/speechsense/) — сервис для организации аналитики контактных центров, использующий технологии SpeechKit и YandexGPT. Подробнее см. в [документации](../speechsense/index.md).
