...
Чтобы подробнее ознакомиться с примерами использования LLM, см. [Библиотека промптов YandexGPT](https://aistudio.yandex.ru/docs/ru/ai-studio/concepts/generation/index#yandex).
