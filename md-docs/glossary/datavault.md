...
* универсальное масштабируемое облачное объектное хранилище [{{ objstorage-full-name }}](https://yandex.cloud/ru/services/storage/);
* управляемые сервисы баз данных [{{ mch-full-name }}](https://yandex.cloud/ru/services/managed-clickhouse/) и [{{ mgp-full-name }}](https://yandex.cloud/ru/services/managed-greenplum/);
* сервис визуализации и анализа данных [{{ datalens-full-name }}](https://yandex.cloud/ru/services/datalens/).
...
* [{{ mch-name }}](../managed-clickhouse/index.md)
* [{{ mgp-name }}](../managed-greenplum/index.md)
* [{{ datalens-name }}](../datalens/index.md)
