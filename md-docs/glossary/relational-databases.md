...
* Новость в блоге [Распределенная СУБД {{ ydb-short-name }} выходит в open source](https://yandex.cloud/ru/blog/posts/2022/04/ydb-available-in-open-source)