[Документация Yandex Cloud](../index.md) > [Облачная терминология](index.md) > Базы данных > Реляционные базы данных
...
Чтобы начать пользоваться YDB, выберите подходящий режим и [создайте свою базу данных](https://console.yandex.cloud/link/ydb/).

Подробнее о сервисе в [документации](../ydb/index.md).


## Интересное по теме {#interesting}

* Записи вебинаров:
    * [Когда и как мигрировать на YDB](https://yandex.cloud/ru/events/767)
    * [Управляемый сервис YDB: настройка, применение, мониторинг](https://yandex.cloud/ru/events/597)
* История успеха [Как Авто.ру провел экзамен по ПДД с помощью serverless-технологий](https://yandex.cloud/ru/cases/autoru)
* Новость в блоге [Распределенная СУБД YDB выходит в open source](https://yandex.cloud/ru/blog/posts/2022/04/ydb-available-in-open-source)