...
Для версий 2.X принята стратегия поддержки LTS согласно [официальной политике поддержки версий Apache Airflow™](https://airflow.apache.org/docs/apache-airflow/stable/installation/supported-versions.html):
