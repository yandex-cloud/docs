...
* Добавлена возможность хранить подключения, переменные и конфигурационные данные, которые используются в DAG-файлах, в Yandex Lockbox. Подробнее см. в инструкции [Хранение подключений в Yandex Lockbox](operations/lockbox-secrets-in-maf-cluster.md).
