[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for Apache Airflow™](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Cluster](index.md) > SetAccessBindings

# Managed Service for Apache Airflow™ API, REST: Cluster.SetAccessBindings
...
```
POST https://airflow.api.cloud.yandex.net/managed-airflow/v1/clusters/{resourceId}:setAccessBindings
```
