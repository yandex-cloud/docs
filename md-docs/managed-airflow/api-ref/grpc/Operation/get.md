[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for Apache Airflow™](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Operation](index.md) > Get

# Managed Service for Apache Airflow™ API, gRPC: OperationService.Get
