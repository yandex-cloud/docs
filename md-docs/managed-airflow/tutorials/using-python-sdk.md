...
Ниже рассматривается [направленный ациклический граф (DAG)](../concepts/index.md#about-the-service), отправляющий запрос к API {{ yandex-cloud }}. Запрос возвращает список виртуальных машин в каталоге, в котором создан кластер {{ AF }}.
...
1. [Создайте кластер {{ maf-name }}](../operations/cluster-create.md#create-cluster) с параметрами:
...
1. [Кластер {{ maf-name }}](../operations/cluster-delete.md#delete).
