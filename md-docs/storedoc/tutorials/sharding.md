...
При [шардировании](../../glossary/sharding.md) кластера {{ mmg-name }} автоматически создаются служебные хосты, которые [тарифицируются](../pricing.md) отдельно от основных хостов СУБД:
...
Оплачивается использование кластера {{ mmg-name }}: выделенные хостам вычислительные ресурсы, включая ресурсы дополнительных служебных хостов, а также объем хранилища и резервных копий (см. [тарифы {{ mmg-name }}](../pricing.md)).
