...
При [шардировании](../../glossary/sharding.md) кластера Yandex StoreDoc автоматически создаются служебные хосты, которые [тарифицируются](../../storedoc/pricing.md) отдельно от основных хостов СУБД:
...
Оплачивается использование кластера Yandex StoreDoc: выделенные хостам вычислительные ресурсы, включая ресурсы дополнительных служебных хостов, а также объем хранилища и резервных копий ([тарифы Yandex StoreDoc](../../storedoc/pricing.md)).
