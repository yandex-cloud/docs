...
1. Подготовьте инфраструктуру поставки данных:
    ...
    - Вручную {#manual}
        ...
        1. [Создайте кластер-приемник {{ mmg-name }}](../operations/cluster-create.md) любой подходящей конфигурации со следующими настройками:
        ...
        1. Для подключения к кластерам с локальной машины пользователя настройте группы безопасности:
            ...
            * [{{ mmg-name }}](../operations/connect/index.md#configuring-security-groups).
...
1. Проверьте, что коллекция `sensors` кластера {{ mmg-name }} содержит отправленные данные:
    ...
    1. [Подключитесь к кластеру {{ mmg-name }}](../operations/connect/index.md).
...
1. Остальные ресурсы удалите в зависимости от способа их создания:
   ...
   - Вручную {#manual}
       ...
       1. [Удалите кластер {{ mmg-name }}](../operations/cluster-delete.md).
