...
1. Подготовьте инфраструктуру поставки данных:
    ...
    - Вручную {#manual}
        ...
        1. [Создайте кластер-приемник Yandex StoreDoc](../operations/cluster-create.md) любой подходящей конфигурации со следующими настройками:
...
1. Проверьте, что коллекция `sensors` кластера Yandex StoreDoc содержит отправленные данные:
    ...
    1. [Подключитесь к кластеру Yandex StoreDoc](../operations/connect/index.md).
