[Документация Yandex Cloud](../../index.md) > [Yandex StoreDoc](../index.md) > [Пошаговые инструкции](index.md) > Базы данных > Управление базами данных
...
- CLI {#cli}
  ...
  ```bash
  yc managed-mongodb database update <имя_БД> \
     --cluster-name <имя_кластера> \
     --deletion-protection=<защитить_БД_от_удаления>
  ```
