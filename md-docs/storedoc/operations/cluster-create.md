[Документация Yandex Cloud](../../index.md) > [Yandex StoreDoc](../index.md) > [Пошаговые инструкции](index.md) > Кластеры > Создание кластера
...
Для создания кластера Yandex StoreDoc и работы с ним вашему аккаунту в Yandex Cloud нужны роли:
  ...
  1. Задайте конфигурацию вычислительных ресурсов:
     ...
     1. (Опционально) В блоке **Автоматическое увеличение размера хранилища** укажите желаемые настройки:
         ...
         * В поле **Максимальный размер хранилища** укажите максимальный размер хранилища, который может быть установлен при автоматическом увеличении размера хранилища.
         ...
         Если вы включили увеличение хранилища в окно обслуживания, в блоке **Дополнительные настройки** задайте время технического обслуживания.
  ...
  1. В блоке **База данных** укажите атрибуты БД:
      ...
      * Пароль пользователя:
        ...
        * **Сгенерировать** — выберите, чтобы сгенерировать пароль с помощью сервиса Connection Manager.
            ...
            Чтобы увидеть сгенерированный пароль, после создания кластера выберите вкладку **Пользователи** и нажмите **Посмотреть пароль** в строке нужного пользователя. Откроется страница секрета Yandex Lockbox, в котором хранится пароль. Для просмотра паролей требуется роль `lockbox.payloadViewer`.
...
- Terraform {#tf}
  ...
  1. Опишите в конфигурационном файле параметры ресурсов, которые необходимо создать:
     ...
     * `hour` — порядковый номер часового интервала по UTC для типа `WEEKLY`: от `1` до `24`.
     ...
     Более подробную информацию о ресурсах, которые вы можете создать с помощью Terraform, читайте в [документации провайдера](../../terraform/resources/mdb_mongodb_cluster.md).
...
Кластер Yandex StoreDoc можно создать со [стандартным](#std-sharding) или [расширенным](#adv-sharding) шардированием. Подробнее о видах шардирования читайте в разделе [Особенности управления шардированием](../concepts/sharding.md#shard-management).
