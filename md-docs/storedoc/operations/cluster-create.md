...
Для создания кластера Yandex StoreDoc нужна роль [vpc.user](../../vpc/security/index.md#vpc-user) и роль [managed-mongodb.editor или выше](../security/index.md#roles-list). Инструкция по назначению роли приведена в [документации Identity and Access Management](../../iam/operations/roles/grant.md).
