...
- Консоль управления {#console}
  ...
  1. Если в восстанавливаемом кластере включено автомасштабирование, задайте в настройке **Окно обслуживания** время [технического обслуживания](../concepts/maintenance.md) (день недели и час дня по UTC).
...
- Terraform {#tf}
    ...
    1. Откройте актуальный конфигурационный файл Terraform с планом инфраструктуры.
        ...
        Полный список доступных для изменения полей конфигурации кластера Yandex StoreDoc см. в [документации провайдера Terraform](../../terraform/resources/mdb_mongodb_cluster.md).
