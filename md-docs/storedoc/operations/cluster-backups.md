...
- Консоль управления {#console}
  ...
  1. (Опционально) В блоке **Дополнительные настройки** включите опцию **Перепаковка**, чтобы автоматически выполнять перепаковку для освобождения дискового пространства.
