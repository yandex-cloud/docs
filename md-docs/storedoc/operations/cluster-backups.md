...
- Консоль управления {#console}
  ...
  1. Если в восстанавливаемом кластере включено автомасштабирование, задайте в настройке **{{ ui-key.yacloud.mdb.forms.maintenance-window-type }}** время [технического обслуживания](../concepts/maintenance.md) (день недели и час дня по UTC).
