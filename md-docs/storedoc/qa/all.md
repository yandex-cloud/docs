[Документация Yandex Cloud](../../index.md) > [Yandex StoreDoc](../index.md) > Вопросы и ответы > Все вопросы на одной странице
...
Если кластер содержит хотя бы два хоста, при потере одного из них кластер продолжит работу.
