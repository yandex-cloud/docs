[Документация Yandex Cloud](../../../index.md) > [Yandex StoreDoc](../../index.md) > [Справочник CLI (англ.)](../index.md) > database > Overview
...
- [yc managed-mongodb database update](update.md) — Modify attributes of a MongoDB database.
