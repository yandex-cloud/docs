[Документация Yandex Cloud](../../../../index.md) > [Yandex StoreDoc](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Database](index.md) > Update
...
**rpc Update ([UpdateDatabaseRequest](#yandex.cloud.mdb.mongodb.v1.UpdateDatabaseRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## UpdateDatabaseRequest {#yandex.cloud.mdb.mongodb.v1.UpdateDatabaseRequest}
