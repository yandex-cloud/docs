...
is larger than [ListBackupRetentionPoliciesRequest.page_size](list.md#yandex.cloud.mdb.mongodb.v1.ListBackupRetentionPoliciesRequest), use the `next_page_token` as the value
for the [ListBackupRetentionPoliciesRequest.page_token](list.md#yandex.cloud.mdb.mongodb.v1.ListBackupRetentionPoliciesRequest) query parameter in the next list request.
