[Документация Yandex Cloud](../../../../index.md) > [Yandex StoreDoc](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [BackupRetentionPolicy](index.md) > Create
...
**rpc Create ([CreateBackupRetentionPolicyRequest](#yandex.cloud.mdb.mongodb.v1.CreateBackupRetentionPolicyRequest)) returns ([CreateBackupRetentionPolicyResponse](#yandex.cloud.mdb.mongodb.v1.CreateBackupRetentionPolicyResponse))**
...
## CreateBackupRetentionPolicyResponse {#yandex.cloud.mdb.mongodb.v1.CreateBackupRetentionPolicyResponse}
