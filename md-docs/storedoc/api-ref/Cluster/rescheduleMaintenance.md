# Managed Service for MongoDB API, REST: Cluster.RescheduleMaintenance
...
```
POST https://mdb.api.cloud.yandex.net/managed-mongodb/v1/clusters/{clusterId}:rescheduleMaintenance
```
...
## Body parameters {#yandex.cloud.mdb.mongodb.v1.RescheduleMaintenanceRequest}
...
|| metadata | **[RescheduleMaintenanceMetadata](#yandex.cloud.mdb.mongodb.v1.RescheduleMaintenanceMetadata)**
...
## RescheduleMaintenanceMetadata {#yandex.cloud.mdb.mongodb.v1.RescheduleMaintenanceMetadata}
