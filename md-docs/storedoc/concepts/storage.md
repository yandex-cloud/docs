...
* Если хост до перевода в режим «только чтение» был [мастером](replication.md), то эта роль будет автоматически назначена другому хосту кластера, т. к. роль мастера требует возможности записи на диск.
