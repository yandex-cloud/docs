...
- За управление шардированием в {{ mmg-name }} отвечают хосты с ролями `MONGOS` (маршрутизация запросов пользователей) и `MONGOCFG` (хранение конфигурации шардов). Подробнее см. в разделе [Типы хостов](host-roles.md).
