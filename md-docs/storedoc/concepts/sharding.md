...
- За управление шардированием в Yandex StoreDoc отвечают хосты с ролями `MONGOS` (маршрутизация запросов пользователей) и `MONGOCFG` (хранение конфигурации шардов). Подробнее см. в разделе [Типы хостов](host-roles.md).
...
Подробнее см. в разделе [Типы хостов](host-roles.md).
