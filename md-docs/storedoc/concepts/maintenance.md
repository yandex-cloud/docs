...
Изменение мажорной версии СУБД не включено в техническое обслуживание. Подробнее о переходе между версиями см. в разделе [Обновление версии Yandex StoreDoc](../operations/cluster-version-update.md).
