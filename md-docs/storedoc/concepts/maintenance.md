[Документация Yandex Cloud](../../index.md) > [Yandex StoreDoc](../index.md) > [Концепции](index.md) > Техническое обслуживание
...
Изменение мажорной версии СУБД не включено в техническое обслуживание. Подробнее о переходе между версиями читайте в разделе [Обновление версии Yandex StoreDoc](../operations/cluster-version-update.md).
...
Порядок технического обслуживания кластеров Yandex StoreDoc определяется количеством хостов и наличием [шардов](sharding.md).
