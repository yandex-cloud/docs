...
Чтобы дополнительно обезопасить себя от потери данных, [настройте](../operations/backup-baremetal.md) на вашем сервере резервное копирование с помощью сервиса [{{ backup-full-name }}](../../backup/index.md).
