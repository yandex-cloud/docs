...
* `6` — Domain Server. Адреса серверов DNS: `77.88.8.8`, `77.88.8.1` для публичных подсетей и [настроенный список DNS-серверов](dns.md#dns-servers) для приватных подсетей.
* `15` — Domain Name. Доменное имя, если оно задано в DNS-настройках приватной подсети.
...
* `119` — Domain Search. Поисковый домен, если он задан в DNS-настройках приватной подсети.
...
* При настройке DHCP-сервиса для подсети можно указать диапазон IP-адресов, [DNS-серверы и доменное имя](dns.md). DNS-настройки можно задать при создании подсети или [изменить позднее](../operations/configure-dns.md).
