...
* IP-адрес шлюза указан в поле **{{ ui-key.yacloud.baremetal.field_gateway_t7LLk }}** в блоке **{{ ui-key.yacloud.baremetal.title_section-network-interfaces }}** на странице с информацией о сервере.
...
Информация о диапазоне доступных в публичной подсети IP-адресов и шлюзе по умолчанию указана в блоке **{{ ui-key.yacloud.baremetal.title_section-network-interfaces }}** на странице с информацией о сервере, а также на странице с информацией о публичной подсети.
