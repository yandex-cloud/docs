...
* невозможность остановить, запустить или перезапустить сервер через [консоль управления]({{ link-console-main }}), {{ yandex-cloud }} [CLI](../../cli/cli-ref/baremetal/cli-ref/index.md) или [API](../../api-design-guide/index.md);
