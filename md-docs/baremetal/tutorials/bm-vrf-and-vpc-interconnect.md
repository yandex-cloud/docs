...
В этом руководстве вы организуете сетевую связность между [сервером](../concepts/servers.md) {{ baremetal-name }}, расположенным в [приватной подсети](../concepts/private-network.md) {{ baremetal-full-name }}, и [виртуальной машиной](../../compute/concepts/vm.md) {{ compute-full-name }}, расположенной в подсети [облачной сети](../../vpc/concepts/network.md#network) {{ vpc-full-name }}.
