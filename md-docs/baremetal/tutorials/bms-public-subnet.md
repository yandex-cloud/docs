[Документация Yandex Cloud](../../index.md) > [Yandex BareMetal](../index.md) > [Практические руководства](index.md) > Назначение публичного IP-адреса серверу BareMetal вручную
...
- Консоль управления {#console}
  ...
  1. [Перейдите](https://console.yandex.cloud/link/baremetal) в сервис **BareMetal**.
  1. Нажмите кнопку **Заказать сервер** и в открывшемся окне выберите вариант `Выбрать из готовых` и подходящую [конфигурацию](../concepts/server-configurations.md) сервера BareMetal в пуле серверов `ru-central1-m3`.
