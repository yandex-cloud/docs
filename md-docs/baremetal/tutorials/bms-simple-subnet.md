...
Подробнее об устройстве сетей в сервисе Yandex BareMetal см. в разделе [Сеть](../concepts/network.md).
...
В стоимость предлагаемого решения входит плата за аренду серверов BareMetal (см. [тарифы Yandex BareMetal](../pricing.md)).
