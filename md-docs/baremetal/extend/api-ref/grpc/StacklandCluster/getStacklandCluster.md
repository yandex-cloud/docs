[Документация Yandex Cloud](../../../../../index.md) > [Yandex BareMetal](../../../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > gRPC (англ.) > [Extend API](../index.md) > [StacklandCluster](index.md) > GetStacklandCluster

# Extend API, gRPC: StacklandClusterService.GetStacklandCluster
...
**rpc GetStacklandCluster ([GetStacklandClusterRequest](#yandex.cloud.baremetal.v2.extend.GetStacklandClusterRequest)) returns ([StacklandCluster](#yandex.cloud.baremetal.v2.extend.StacklandCluster))**

## GetStacklandClusterRequest {#yandex.cloud.baremetal.v2.extend.GetStacklandClusterRequest}
