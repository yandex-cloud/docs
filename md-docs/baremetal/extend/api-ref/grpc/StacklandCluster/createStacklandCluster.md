[Документация Yandex Cloud](../../../../../index.md) > [Yandex BareMetal](../../../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > gRPC (англ.) > [Extend API](../index.md) > [StacklandCluster](index.md) > CreateStacklandCluster

# Extend API, gRPC: StacklandClusterService.CreateStacklandCluster
...
**rpc CreateStacklandCluster ([CreateStacklandClusterRequest](#yandex.cloud.baremetal.v2.extend.CreateStacklandClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## CreateStacklandClusterRequest {#yandex.cloud.baremetal.v2.extend.CreateStacklandClusterRequest}
