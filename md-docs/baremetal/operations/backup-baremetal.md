[Документация Yandex Cloud](../../index.md) > [Yandex BareMetal](../index.md) > [Пошаговые инструкции](index.md) > Серверы > Подключить существующий сервер BareMetal к Cloud Backup
...
Подробнее о работе с серверами BareMetal смотрите в разделе [Пошаговые инструкции для сервиса Yandex BareMetal](index.md).
...
Подробнее об аренде сервера смотрите в [документации BareMetal](servers/server-lease.md).
