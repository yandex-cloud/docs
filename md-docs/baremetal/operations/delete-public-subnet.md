[Документация Yandex Cloud](../../index.md) > [Yandex BareMetal](../index.md) > [Пошаговые инструкции](index.md) > Сеть > Удалить выделенную публичную подсеть
...
Удаление выделенной публичной подсети необратимо. После удаления IP-адреса подсети вернутся в общий пул адресов сервиса Yandex BareMetal и могут быть переназначены другим пользователям.
