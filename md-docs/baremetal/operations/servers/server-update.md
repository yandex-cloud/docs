...
- Консоль управления {#console}
  ...
  1. Внесите изменения в конфигурацию сервера:
      ...
      * (Опционально) В блоке **Сетевые интерфейсы** измените [сетевые настройки](../../concepts/network.md) сервера.

          Чтобы привязать к серверу [дополнительную приватную подсеть](../../concepts/private-network.md#tagged-vlan-subnet), в блоке **Сетевые интерфейсы** нажмите кнопку **Добавить дополнительную подсеть** и в появившемся поле выберите дополнительную подсеть или создайте новую.
          ...
          Чтобы отвязать дополнительную подсеть от сервера, в блоке **Сетевые интерфейсы** нажмите значок ![trash-bin](../../../_assets/console-icons/trash-bin.svg) в строке с соответствующей дополнительной приватной подсетью.
