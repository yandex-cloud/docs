[Документация Yandex Cloud](../../../index.md) > [Yandex BareMetal](../../index.md) > [Пошаговые инструкции](../index.md) > Серверы > Проанализировать состояние сервера с помощью HWCheck
...
Чтобы сформировать отчет о состоянии системы с помощью утилиты [HWCheck](../../concepts/smart-disk-analysis.md#hwcheck):
