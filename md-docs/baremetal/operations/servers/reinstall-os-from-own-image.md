...
1. [Загрузите](../image-upload.md#upload-file) ISO-образ в [Yandex Object Storage](../../../storage/index.md) и получите ссылку на загруженный объект:
   ...
   1. Загрузите скачанный файл с образом в созданный бакет:
       ...
       - Консоль управления {#console}
         ...
         1. В [консоли управления](https://console.yandex.cloud) [перейдите](../../../console/operations/select-service.md#select-service) в сервис **Object Storage** и перейдите в бакет, в который нужно загрузить образ.
   ...
   1. Получите ссылку на загруженный в бакет образ:
       ...
       - Консоль управления {#console}
         ...
         1. [Перейдите](../../../console/operations/select-service.md#select-service) в сервис **Object Storage** и выберите нужный бакет.
