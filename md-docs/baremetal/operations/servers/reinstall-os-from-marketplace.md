[Документация Yandex Cloud](../../../index.md) > [Yandex BareMetal](../../index.md) > [Пошаговые инструкции](../index.md) > Серверы > Переустановить ОС сервера > Переустановить ОС из образа Marketplace
