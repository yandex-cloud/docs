[Документация Yandex Cloud](../index.md) > [Yandex BareMetal](index.md) > Начало работы > Арендовать сервер готовой конфигурации
...
- Консоль управления {#console}
  ...
  1. Нажмите кнопку **Заказать сервер** и в открывшемся окне выберите вариант `Выбрать из готовых` и подходящую [конфигурацию](concepts/server-configurations.md) сервера BareMetal. Например: `BA-i103-S-10G`.
