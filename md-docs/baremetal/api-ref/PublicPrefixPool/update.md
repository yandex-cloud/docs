...
```
PATCH https://baremetal.api.cloud.yandex.net/baremetal/v1alpha/publicPrefixPools/{publicPrefixPoolId}
```
...
Required field. ID of the public prefix pool to update.
...
## Body parameters {#yandex.cloud.baremetal.v1alpha.UpdatePublicPrefixPoolRequest}
