[Документация Yandex Cloud](../../../index.md) > [Yandex BareMetal](../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [REST (англ.)](../index.md) > [PublicPrefixPool](index.md) > UpdatePublicPrefixPool

# BareMetal API, REST: PublicPrefixPool.UpdatePublicPrefixPool
...
```
PATCH https://baremetal.api.cloud.yandex.net/baremetal/v2/clouds/{public_prefix_pool.cloud_id}/folders/{public_prefix_pool.folder_id}/publicPrefixPools/{public_prefix_pool.public_prefix_pool_id}
```

## Body parameters {#yandex.cloud.baremetal.v2.UpdatePublicPrefixPoolRequest}
...
#|
||Field | Description ||
|| publicPrefixPool | **[PublicPrefixPool](#yandex.cloud.baremetal.v2.PublicPrefixPool)**
