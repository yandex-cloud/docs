[Документация Yandex Cloud](../../../index.md) > [Yandex BareMetal](../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [REST (англ.)](../index.md) > [Image](index.md) > ListImages
...
```
GET https://baremetal.api.cloud.yandex.net/baremetal/v2/folders/{folderId}/images
```
