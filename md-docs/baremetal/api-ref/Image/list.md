[Документация Yandex Cloud](../../../index.md) > [Yandex BareMetal](../../index.md) > Концепции > Настройка и управление > Справочник API > API v1alpha > [REST (англ.)](../index.md) > [Image](index.md) > List
...
## Query parameters {#yandex.cloud.baremetal.v1alpha.ListImagesRequest}
...
## Response {#yandex.cloud.baremetal.v1alpha.ListImagesResponse}
...
[ListImagesRequest.pageSize](#yandex.cloud.baremetal.v1alpha.ListImagesRequest), use `next_page_token` as the value
for the [ListImagesRequest.pageToken](#yandex.cloud.baremetal.v1alpha.ListImagesRequest) parameter in the next list request.
