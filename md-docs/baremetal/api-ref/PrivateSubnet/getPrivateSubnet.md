[Документация Yandex Cloud](../../../index.md) > [Yandex BareMetal](../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [REST (англ.)](../index.md) > [PrivateSubnet](index.md) > GetPrivateSubnet

# BareMetal API, REST: PrivateSubnet.GetPrivateSubnet
...
```
GET https://baremetal.api.cloud.yandex.net/baremetal/v2/clouds/{cloudId}/folders/{folderId}/privateSubnets/{privateSubnetId}
```
...
## Response {#yandex.cloud.baremetal.v2.PrivateSubnet}
