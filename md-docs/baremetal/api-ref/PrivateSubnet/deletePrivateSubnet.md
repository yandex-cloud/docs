[Документация Yandex Cloud](../../../index.md) > [Yandex BareMetal](../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [REST (англ.)](../index.md) > [PrivateSubnet](index.md) > DeletePrivateSubnet

# BareMetal API, REST: PrivateSubnet.DeletePrivateSubnet
...
```
DELETE https://baremetal.api.cloud.yandex.net/baremetal/v2/clouds/{cloudId}/folders/{folderId}/privateSubnets/{privateSubnetId}
```
...
Required field. ID of the private subnet to delete.
