[Документация Yandex Cloud](../../../index.md) > [Yandex BareMetal](../../index.md) > Концепции > Настройка и управление > Справочник API > API v1alpha > [REST (англ.)](../index.md) > [PrivateSubnet](index.md) > ListOperations
...
the service returns a [ListImageOperationsResponse.nextPageToken](../Image/listOperations.md#yandex.cloud.baremetal.v1alpha.ListImageOperationsResponse)
...
[ListImageOperationsRequest.pageSize](../Image/listOperations.md#yandex.cloud.baremetal.v1alpha.ListImageOperationsRequest), use `next_page_token` as the value
for the [ListImageOperationsRequest.pageToken](../Image/listOperations.md#yandex.cloud.baremetal.v1alpha.ListImageOperationsRequest) parameter in the next list request.
