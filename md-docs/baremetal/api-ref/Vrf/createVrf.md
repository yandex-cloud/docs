[Документация Yandex Cloud](../../../index.md) > [Yandex BareMetal](../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [REST (англ.)](../index.md) > [Vrf](index.md) > CreateVrf

# BareMetal API, REST: Vrf.CreateVrf
...
```
POST https://baremetal.api.cloud.yandex.net/baremetal/v2/clouds/{cloudId}/folders/{folderId}/vrfs
```
...
## Body parameters {#yandex.cloud.baremetal.v2.CreateVrfRequest}
