[Документация Yandex Cloud](../../../index.md) > [Yandex BareMetal](../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [REST (англ.)](../index.md) > [Vrf](index.md) > UpdateVrf
...
```
PATCH https://baremetal.api.cloud.yandex.net/baremetal/v2/clouds/{vrf.cloud_id}/folders/{vrf.folder_id}/vrfs/{vrf.vrf_id}
```
