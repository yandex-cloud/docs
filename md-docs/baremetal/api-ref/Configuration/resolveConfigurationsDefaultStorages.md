[Документация Yandex Cloud](../../../index.md) > [Yandex BareMetal](../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [REST (англ.)](../index.md) > [Configuration](index.md) > ResolveConfigurationsDefaultStorages
...
```
GET https://baremetal.api.cloud.yandex.net/baremetal/v2/configurations:resolveDefaultStorages
```
