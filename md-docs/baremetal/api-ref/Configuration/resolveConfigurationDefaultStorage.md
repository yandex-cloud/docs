[Документация Yandex Cloud](../../../index.md) > [Yandex BareMetal](../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [REST (англ.)](../index.md) > [Configuration](index.md) > ResolveConfigurationDefaultStorage

# BareMetal API, REST: Configuration.ResolveConfigurationDefaultStorage
...
```
GET https://baremetal.api.cloud.yandex.net/baremetal/v2/configurations/{configurationId}:resolveDefaultStorage
```
...
## Response {#yandex.cloud.baremetal.v2.DefaultStorage}
