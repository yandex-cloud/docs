[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [gRPC (англ.)](../index.md) > [PrivateCloudConnection](index.md) > UpdatePrivateCloudConnection

# BareMetal API, gRPC: PrivateCloudConnectionService.UpdatePrivateCloudConnection
...
**rpc UpdatePrivateCloudConnection ([UpdatePrivateCloudConnectionRequest](#yandex.cloud.baremetal.v2.UpdatePrivateCloudConnectionRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## UpdatePrivateCloudConnectionRequest {#yandex.cloud.baremetal.v2.UpdatePrivateCloudConnectionRequest}
