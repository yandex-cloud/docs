[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [gRPC (англ.)](../index.md) > [PrivateCloudConnection](index.md) > CreatePrivateCloudConnection

# BareMetal API, gRPC: PrivateCloudConnectionService.CreatePrivateCloudConnection
...
**rpc CreatePrivateCloudConnection ([CreatePrivateCloudConnectionRequest](#yandex.cloud.baremetal.v2.CreatePrivateCloudConnectionRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## CreatePrivateCloudConnectionRequest {#yandex.cloud.baremetal.v2.CreatePrivateCloudConnectionRequest}
...
|| private_cloud_connection | **[PrivateCloudConnection](#yandex.cloud.baremetal.v2.PrivateCloudConnection)**
