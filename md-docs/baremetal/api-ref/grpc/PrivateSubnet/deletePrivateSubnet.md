[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [gRPC (англ.)](../index.md) > [PrivateSubnet](index.md) > DeletePrivateSubnet

# BareMetal API, gRPC: PrivateSubnetService.DeletePrivateSubnet
...
**rpc DeletePrivateSubnet ([DeletePrivateSubnetRequest](#yandex.cloud.baremetal.v2.DeletePrivateSubnetRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## DeletePrivateSubnetRequest {#yandex.cloud.baremetal.v2.DeletePrivateSubnetRequest}
