[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [gRPC (англ.)](../index.md) > [PrivateSubnet](index.md) > CreatePrivateSubnet

# BareMetal API, gRPC: PrivateSubnetService.CreatePrivateSubnet
...
**rpc CreatePrivateSubnet ([CreatePrivateSubnetRequest](#yandex.cloud.baremetal.v2.CreatePrivateSubnetRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## CreatePrivateSubnetRequest {#yandex.cloud.baremetal.v2.CreatePrivateSubnetRequest}
