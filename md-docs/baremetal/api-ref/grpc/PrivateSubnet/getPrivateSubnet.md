[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [gRPC (англ.)](../index.md) > [PrivateSubnet](index.md) > GetPrivateSubnet

# BareMetal API, gRPC: PrivateSubnetService.GetPrivateSubnet
...
**rpc GetPrivateSubnet ([GetPrivateSubnetRequest](#yandex.cloud.baremetal.v2.GetPrivateSubnetRequest)) returns ([PrivateSubnet](#yandex.cloud.baremetal.v2.PrivateSubnet))**

## GetPrivateSubnetRequest {#yandex.cloud.baremetal.v2.GetPrivateSubnetRequest}
