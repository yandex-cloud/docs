[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > Справочник API > API v1alpha > [gRPC (англ.)](../index.md) > [PrivateSubnet](index.md) > ListOperations
...
the service returns a [ListImageOperationsResponse.next_page_token](../Image/listOperations.md#yandex.cloud.baremetal.v1alpha.ListImageOperationsResponse)
...
[ListImageOperationsRequest.page_size](../Image/listOperations.md#yandex.cloud.baremetal.v1alpha.ListImageOperationsRequest), use `next_page_token` as the value
for the [ListImageOperationsRequest.page_token](../Image/listOperations.md#yandex.cloud.baremetal.v1alpha.ListImageOperationsRequest) parameter in the next list request.
