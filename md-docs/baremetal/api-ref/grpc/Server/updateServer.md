[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [gRPC (англ.)](../index.md) > [Server](index.md) > UpdateServer

# BareMetal API, gRPC: ServerService.UpdateServer
...
**rpc UpdateServer ([UpdateServerRequest](#yandex.cloud.baremetal.v2.UpdateServerRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## UpdateServerRequest {#yandex.cloud.baremetal.v2.UpdateServerRequest}
