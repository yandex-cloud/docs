[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [gRPC (англ.)](../index.md) > [Server](index.md) > RebootServer

# BareMetal API, gRPC: ServerService.RebootServer
...
**rpc RebootServer ([RebootServerRequest](#yandex.cloud.baremetal.v2.RebootServerRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## RebootServerRequest {#yandex.cloud.baremetal.v2.RebootServerRequest}
