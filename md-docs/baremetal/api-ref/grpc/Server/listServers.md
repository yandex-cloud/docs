[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [gRPC (англ.)](../index.md) > [Server](index.md) > ListServers

# BareMetal API, gRPC: ServerService.ListServers
...
**rpc ListServers ([ListServersRequest](#yandex.cloud.baremetal.v2.ListServersRequest)) returns ([ListServersResponse](#yandex.cloud.baremetal.v2.ListServersResponse))**

## ListServersRequest {#yandex.cloud.baremetal.v2.ListServersRequest}
...
## ListServersResponse {#yandex.cloud.baremetal.v2.ListServersResponse}
