[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [gRPC (англ.)](../index.md) > [Server](index.md) > PowerOffServer

# BareMetal API, gRPC: ServerService.PowerOffServer
...
**rpc PowerOffServer ([PowerOffServerRequest](#yandex.cloud.baremetal.v2.PowerOffServerRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## PowerOffServerRequest {#yandex.cloud.baremetal.v2.PowerOffServerRequest}
