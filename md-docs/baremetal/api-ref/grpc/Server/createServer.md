[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [gRPC (англ.)](../index.md) > [Server](index.md) > CreateServer

# BareMetal API, gRPC: ServerService.CreateServer
...
**rpc CreateServer ([CreateServerRequest](#yandex.cloud.baremetal.v2.CreateServerRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**
