[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > Справочник API > API v1alpha > [gRPC (англ.)](../index.md) > [Image](index.md) > Create
...
**rpc Create ([CreateImageRequest](#yandex.cloud.baremetal.v1alpha.CreateImageRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## CreateImageRequest {#yandex.cloud.baremetal.v1alpha.CreateImageRequest}
