[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [gRPC (англ.)](../index.md) > [PublicSubnet](index.md) > CreatePublicSubnet

# BareMetal API, gRPC: PublicSubnetService.CreatePublicSubnet
...
**rpc CreatePublicSubnet ([CreatePublicSubnetRequest](#yandex.cloud.baremetal.v2.CreatePublicSubnetRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## CreatePublicSubnetRequest {#yandex.cloud.baremetal.v2.CreatePublicSubnetRequest}
