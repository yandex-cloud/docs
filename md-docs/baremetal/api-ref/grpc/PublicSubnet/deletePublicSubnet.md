[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [gRPC (англ.)](../index.md) > [PublicSubnet](index.md) > DeletePublicSubnet

# BareMetal API, gRPC: PublicSubnetService.DeletePublicSubnet
...
**rpc DeletePublicSubnet ([DeletePublicSubnetRequest](#yandex.cloud.baremetal.v2.DeletePublicSubnetRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## DeletePublicSubnetRequest {#yandex.cloud.baremetal.v2.DeletePublicSubnetRequest}
