[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [gRPC (англ.)](../index.md) > [BootImage](index.md) > CreateBootImage

# BareMetal API, gRPC: BootImageService.CreateBootImage
...
**rpc CreateBootImage ([CreateBootImageRequest](#yandex.cloud.baremetal.v2.CreateBootImageRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## CreateBootImageRequest {#yandex.cloud.baremetal.v2.CreateBootImageRequest}
