[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [gRPC (англ.)](../index.md) > [BootImage](index.md) > DeleteBootImage

# BareMetal API, gRPC: BootImageService.DeleteBootImage
...
**rpc DeleteBootImage ([DeleteBootImageRequest](#yandex.cloud.baremetal.v2.DeleteBootImageRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## DeleteBootImageRequest {#yandex.cloud.baremetal.v2.DeleteBootImageRequest}
