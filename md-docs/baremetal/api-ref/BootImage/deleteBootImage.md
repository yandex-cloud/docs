[Документация Yandex Cloud](../../../index.md) > [Yandex BareMetal](../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [REST (англ.)](../index.md) > [BootImage](index.md) > DeleteBootImage

# BareMetal API, REST: BootImage.DeleteBootImage
...
```
DELETE https://baremetal.api.cloud.yandex.net/baremetal/v2/clouds/{cloudId}/folders/{folderId}/bootImages/{bootImageId}
```
...
Required field. ID of the boot image to delete.
