[Документация Yandex Cloud](../../../index.md) > [Yandex BareMetal](../../index.md) > Концепции > Настройка и управление > Справочник API > API v1alpha > [REST (англ.)](../index.md) > [PrivateCloudConnection](index.md) > Get

# BareMetal API, REST: PrivateCloudConnection.Get

Returns the specific Private cloud connection resource.
To get the list of available Private cloud connection resources, make a [List](list.md#List) request.
...
To get the server ID, use a [PrivateCloudConnectionService.List](list.md#List) request.
