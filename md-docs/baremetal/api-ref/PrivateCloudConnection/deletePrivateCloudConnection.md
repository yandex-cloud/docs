[Документация Yandex Cloud](../../../index.md) > [Yandex BareMetal](../../index.md) > Концепции > Настройка и управление > Справочник API > API v2 > [REST (англ.)](../index.md) > [PrivateCloudConnection](index.md) > DeletePrivateCloudConnection

# BareMetal API, REST: PrivateCloudConnection.DeletePrivateCloudConnection
...
```
DELETE https://baremetal.api.cloud.yandex.net/baremetal/v2/clouds/{cloudId}/folders/{folderId}/privateCloudConnections/{privateCloudConnectionId}
```
