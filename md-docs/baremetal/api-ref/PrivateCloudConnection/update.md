[Документация Yandex Cloud](../../../index.md) > [Yandex BareMetal](../../index.md) > Концепции > Настройка и управление > Справочник API > API v1alpha > [REST (англ.)](../index.md) > [PrivateCloudConnection](index.md) > Update
...
To get the private cloud connection ID, use a [PrivateCloudConnectionService.List](list.md#List) request.
