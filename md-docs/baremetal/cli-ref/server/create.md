[Документация Yandex Cloud](../../../index.md) > [Yandex BareMetal](../../index.md) > Концепции > Настройка и управление > [Справочник CLI (англ.)](../index.md) > [server](index.md) > create
...
`yc baremetal server create <FOLDER-ID>`
...
1. Generate template:
yc baremetal server create --example-json > request.json
or
yc baremetal server create --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal server create -r request.json
or
yc baremetal server create -r request.yaml ||
|#
