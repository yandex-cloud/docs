[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > [Справочник CLI (англ.)](../../index.md) > [v2](../index.md) > [server](index.md) > batch-create

# yc baremetal v2 server batch-create
...
`yc baremetal v2 server batch-create <CLOUD-ID>`
...
ID of the parent folder shared by all servers being created. To get the folder ID, use a [yandex.cloud.resourcemanager.v1.FolderService.List] request. If this is set, the folder_id field in the [BatchCreateServersRequest.requests] messages must either be empty or match this field. ||
|| `--requests` | `shorthand/json`
...
1. Generate template:
yc baremetal v2 server batch-create --example-json > request.json
or
yc baremetal v2 server batch-create --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal v2 server batch-create -r request.json
or
yc baremetal v2 server batch-create -r request.yaml ||
|#
