[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > [Справочник CLI (англ.)](../../index.md) > [v2](../index.md) > server > Overview

# yc baremetal v2 server
...
`yc baremetal v2 server <command>`

#### Command Tree

- [yc baremetal v2 server batch-create](batch-create.md) — Creates multiple servers in the specified folder.

- [yc baremetal v2 server create](create.md) — Creates a server in the specified folder.

- [yc baremetal v2 server get](get.md) — Returns the specific Server resource.
...
- [yc baremetal v2 server reboot](reboot.md) — Reboots the specified server.
