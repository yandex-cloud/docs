[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > [Справочник CLI (англ.)](../../index.md) > [v2](../index.md) > image > Overview
...
`yc baremetal v2 image <command>`

#### Command Tree

- [yc baremetal v2 image get](get.md) — Returns the specific Image resource.
