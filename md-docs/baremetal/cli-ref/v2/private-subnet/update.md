[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > [Справочник CLI (англ.)](../../index.md) > [v2](../index.md) > [private-subnet](index.md) > update

# yc baremetal v2 private-subnet update
...
`yc baremetal v2 private-subnet update <PRIVATE-SUBNET-ID>`
...
1. Generate template:
yc baremetal v2 private-subnet update --example-json > request.json
or
yc baremetal v2 private-subnet update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal v2 private-subnet update -r request.json
or
yc baremetal v2 private-subnet update -r request.yaml ||
|#
