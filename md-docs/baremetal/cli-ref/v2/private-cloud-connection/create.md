[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > [Справочник CLI (англ.)](../../index.md) > [v2](../index.md) > [private-cloud-connection](index.md) > create

# yc baremetal v2 private-cloud-connection create
...
`yc baremetal v2 private-cloud-connection create <CLOUD-ID>`
...
1. Generate template:
yc baremetal v2 private-cloud-connection create --example-json > request.json
or
yc baremetal v2 private-cloud-connection create --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal v2 private-cloud-connection create -r request.json
or
yc baremetal v2 private-cloud-connection create -r request.yaml ||
|#
