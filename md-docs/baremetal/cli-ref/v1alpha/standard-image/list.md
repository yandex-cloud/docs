[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > [Справочник CLI (англ.)](../../index.md) > [v1alpha](../index.md) > [standard-image](index.md) > list

# yc baremetal v1alpha standard-image list
...
`yc baremetal v1alpha standard-image list <FOLDER-ID>`
