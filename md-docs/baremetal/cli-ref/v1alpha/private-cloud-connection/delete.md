[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > [Справочник CLI (англ.)](../../index.md) > [v1alpha](../index.md) > [private-cloud-connection](index.md) > delete
...
`yc baremetal v1alpha private-cloud-connection delete <PRIVATE-CLOUD-CONNECTION-ID>`
