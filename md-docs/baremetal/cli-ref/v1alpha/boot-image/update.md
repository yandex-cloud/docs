[Документация Yandex Cloud](../../../../index.md) > [Yandex BareMetal](../../../index.md) > Концепции > Настройка и управление > [Справочник CLI (англ.)](../../index.md) > [v1alpha](../index.md) > [boot-image](index.md) > update
...
`yc baremetal v1alpha boot-image update <IMAGE-ID>`
...
1. Generate template:
yc baremetal v1alpha boot-image update --example-json > request.json
or
yc baremetal v1alpha boot-image update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal v1alpha boot-image update -r request.json
or
yc baremetal v1alpha boot-image update -r request.yaml ||
|#
