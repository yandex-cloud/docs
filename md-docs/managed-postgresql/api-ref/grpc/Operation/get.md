[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for PostgreSQL](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Operation](index.md) > Get

# Managed Service for PostgreSQL API, gRPC: OperationService.Get
