[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for PostgreSQL](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Cluster](index.md) > AddHosts
...
The ID of the network is set in the field [Cluster.network_id](get.md#yandex.cloud.mdb.postgresql.v1.Cluster).
