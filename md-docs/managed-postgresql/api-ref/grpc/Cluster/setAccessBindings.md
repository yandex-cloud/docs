[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for PostgreSQL](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Cluster](index.md) > SetAccessBindings

# Managed Service for PostgreSQL API, gRPC: ClusterService.SetAccessBindings
