[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for PostgreSQL](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [BackupRetentionPolicy](index.md) > Get
...
**rpc Get ([GetBackupRetentionPolicyRequest](#yandex.cloud.mdb.postgresql.v1.GetBackupRetentionPolicyRequest)) returns ([yandex.cloud.mdb.v1.BackupRetentionPolicy](#yandex.cloud.mdb.v1.BackupRetentionPolicy))**

## GetBackupRetentionPolicyRequest {#yandex.cloud.mdb.postgresql.v1.GetBackupRetentionPolicyRequest}
