[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for PostgreSQL](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [ChangeFreeze](index.md) > GetLimits
...
```
GET https://mdb.api.cloud.yandex.net/managed-postgresql/v1/changeFreezeLimits
```
