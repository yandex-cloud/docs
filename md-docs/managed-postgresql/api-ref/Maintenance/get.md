[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for PostgreSQL](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Maintenance](index.md) > Get

# Managed Service for PostgreSQL API, REST: Maintenance.Get
...
```
GET https://mdb.api.cloud.yandex.net/managed-postgresql/v1/maintenances/{maintenanceId}
```
