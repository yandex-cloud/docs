[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for PostgreSQL](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Maintenance](index.md) > Reschedule

# Managed Service for PostgreSQL API, REST: Maintenance.Reschedule
...
```
POST https://mdb.api.cloud.yandex.net/managed-postgresql/v1/maintenances/{maintenanceId}:reschedule
```
