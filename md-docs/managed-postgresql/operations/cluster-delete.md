[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for PostgreSQL](../index.md) > [Пошаговые инструкции](index.md) > Кластеры > Удаление кластера

# Удаление кластера PostgreSQL
...
- Консоль управления {#console}
  ...
  1. Нажмите значок ![image](../../_assets/console-icons/ellipsis.svg) для нужного кластера, выберите пункт **Удалить** и подтвердите удаление.
...
- CLI {#cli}
  ...
  ```bash
  yc managed-postgresql cluster delete <имя_или_идентификатор_кластера>
  ```
