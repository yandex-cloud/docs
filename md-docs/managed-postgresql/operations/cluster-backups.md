[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for PostgreSQL](../index.md) > [Пошаговые инструкции](index.md) > Кластеры > Управление резервными копиями
...
- Консоль управления {#console}
  ...
  **Чтобы восстановить из резервной копии удаленный ранее кластер:**
  ...
  1. [Перейдите](https://console.yandex.cloud/link/managed-postgresql) в сервис **Managed Service for&nbsp;PostgreSQL**.
  1. Выберите ![chevron-down](../../_assets/console-icons/chevron-down.svg) **Другое** → **Резервные копии**.
...
- Консоль управления {#console}
    ...
    1. Перейдите на ![chevron-down](../../_assets/console-icons/chevron-down.svg) **Другое** → **Резервные копии**.
