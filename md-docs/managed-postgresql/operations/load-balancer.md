[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for PostgreSQL](../index.md) > [Пошаговые инструкции](index.md) > Кластеры > Управление балансировщиком нагрузки DB Proxy

# Управление балансировщиком нагрузки DB Proxy

В Managed Service for PostgreSQL доступен [балансировщик нагрузки DB Proxy](../concepts/load-balancer.md), который автоматически распределяет запросы по хостам БД в зависимости от их роли и доступности.
