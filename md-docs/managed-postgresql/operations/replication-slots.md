...
* Физические слоты создаются сервисом автоматически на базе хостов-реплик и используются для [репликации данных](../concepts/replication.md) в рамках самого кластера Managed Service for PostgreSQL.
...
Подробности [в документации PostgreSQL](https://www.postgresql.org/docs/current/logicaldecoding.html).
...
1. Выполните SQL-запрос:
    ...
    * `<имя_плагина>` — имя плагина из списка поддерживаемых выходных плагинов. Список находится в разделе [Репликация](../concepts/replication.md#logical-decoding). Обязательный параметр.
