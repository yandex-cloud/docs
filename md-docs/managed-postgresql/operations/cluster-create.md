...
Для создания кластера Managed Service for PostgreSQL нужна роль [vpc.user](../../vpc/security/index.md#vpc-user) и роль [managed-postgresql.editor или выше](../security/index.md#roles-list). О том, как назначить роль, см. [документацию Identity and Access Management](../../iam/operations/roles/grant.md).
...
- CLI {#cli}
  ...
  1. Укажите параметры кластера в команде создания (в примере приведены не все доступные параметры):
     ...
     * `--performance-diagnostics` — настройки [сбора статистики](performance-diagnostics.md#activate-stats-collector):
     ...
     Чтобы разрешить доступ к кластеру из сервиса [Yandex Cloud Functions](../../functions/index.md), передайте параметр `--serverless-access`. Подробнее о настройке доступа см. в документации [Cloud Functions](../../functions/operations/database-connection.md).
