[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for PostgreSQL](../index.md) > [Пошаговые инструкции](index.md) > Пользователи PostgreSQL > Управление пользователями БД
...
- REST API {#api}
  ...
  1. Воспользуйтесь методом [User.Update](../api-ref/User/update.md) и выполните запрос, например, с помощью [cURL](https://curl.se/):
     ...
     * `settings` — новые настройки. Доступный набор настроек в [описании метода](../api-ref/User/update.md#yandex.cloud.mdb.postgresql.v1.UpdateUserRequest) и в разделе [Настройки на уровне пользователя](../concepts/settings-list.md#dbms-user-settings).
...
- gRPC API {#grpc-api}
  ...
  1. Воспользуйтесь вызовом [UserService.Update](../api-ref/grpc/User/update.md) и выполните запрос, например, с помощью [gRPCurl](https://github.com/fullstorydev/grpcurl):
     ...
     * `settings` — новые настройки. Доступный набор настроек в [описании метода](../api-ref/grpc/User/get.md#yandex.cloud.mdb.postgresql.v1.UserSettings) и в разделе [Настройки на уровне пользователя](../concepts/settings-list.md#dbms-user-settings).
