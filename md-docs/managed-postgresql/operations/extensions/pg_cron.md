...
## Установить расширение pg_cron в кластер PostgreSQL {#pg_cron-install}
...
1. [Добавьте расширение](cluster-extensions.md#update-extensions) `pg_cron` к одной из баз данных. Подключить расширение к двум базам данных нельзя.
    ...
    Установка расширения `pg_cron` приведет к последовательной перезагрузке PostgreSQL на всех хостах кластера.
