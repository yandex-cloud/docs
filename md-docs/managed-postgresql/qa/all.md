...
Для подключения из Looker Studio необходимо сгенерировать и указать в настройках подключения файл сертификата клиента и приватный ключ. Инструкцию читайте в разделе [Подключение из Looker Studio](../operations/connect/clients.md#connection-google-looker).
