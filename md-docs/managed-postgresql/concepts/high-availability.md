...
* Если для хоста настроен публичный доступ, то для реплик он также должен быть включен, иначе при переключении мастера кластер может стать недоступным.
