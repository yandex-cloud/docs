...
В процессе [технического обслуживания](maintenance.md) кластер с двумя и более хостами может быть недоступен для записи до автоматического переключения мастера. Кластер из одного хоста полностью недоступен на время технического обслуживания. Поэтому рекомендуется выбирать предпочтительный [день недели и время обслуживания](maintenance.md#maintenance-window) с учетом предполагаемой нагрузки на кластер.

При [обновлении версии PostgreSQL](../operations/cluster-version-update.md) кластер с тремя и более хостами недоступен на запись, но минимум одна реплика доступна для чтения. Кластер, содержащий один или два хоста, полностью недоступен на время обновления версии PostgreSQL. Рекомендуется выбирать момент обновления кластера с учетом предполагаемой нагрузки на него.
