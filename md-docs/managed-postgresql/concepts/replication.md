...
Высокая доступность кластера основывается на стандартной потоковой репликации PostgreSQL и собственном оркестраторе. В стандартном PostgreSQL полностью бесшовное переключение мастера невозможно, так как контекст активных транзакций и соединений не может быть перенесен между хостами. Однако оркестратор обеспечивает согласованность данных и предотвращает появление двух мастер-хостов в кластере.
