[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for PostgreSQL](../index.md) > [Практические руководства](index.md) > Репликация и миграция > Миграция базы данных из Greenplum® в PostgreSQL
...
* Кластер Managed Service for PostgreSQL: использование выделенных хостам вычислительных ресурсов, объем хранилища и резервных копий ([тарифы Yandex Managed Service for PostgreSQL](../pricing.md)).
...
- Вручную {#manual}
    ...
    1. [Создайте кластер-источник Greenplum®](../../managed-greenplum/operations/cluster-create.md#create-cluster) любой подходящей конфигурации с именем пользователя-администратора `gp-user` и хостами в публичном доступе.

    1. [Создайте кластер-приемник Yandex Managed Service for PostgreSQL](../operations/cluster-create.md#create-cluster) любой подходящей конфигурации с хостами в публичном доступе. При создании кластера укажите:
...
1. [Подключитесь к кластеру Greenplum®](../../managed-greenplum/operations/connect/index.md).
