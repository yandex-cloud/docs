...
В примере используются минимальные значения параметров [хоста](../concepts/instance-types.md). Для реальных задач рекомендуется выбирать хосты с гарантированной долей vCPU 100%.
...
1. [Удалите](../operations/cluster-delete.md) кластер в сервисе Managed Service for PostgreSQL.
