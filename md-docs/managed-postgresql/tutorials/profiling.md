[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for PostgreSQL](../index.md) > [Практические руководства](index.md) > Анализ производительности и оптимизация
...
Чтобы обнаружить возможные проблемы в кластере, [используйте инструменты](performance-problems.md) для анализа состояния кластера комплексно.

## Перед началом работы {#before-start}

1. Выберите базы данных для диагностики.
1. [Включите в кластере опцию](../operations/update.md#change-additional-settings) **Доступ из консоли управления**.
...
* [Автоматически логировать план выполнения запросов](../operations/performance-diagnostics.md#auto-explain-enable) с помощью [модуля `auto_explain`](https://www.postgresql.org/docs/current/auto-explain.html).
