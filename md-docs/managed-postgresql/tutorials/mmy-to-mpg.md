# Миграция данных из {{ mmy-full-name }} в {{ mpg-name }} с помощью {{ data-transfer-full-name }}
...
- Вручную {#manual}
    ...
    1. В той же зоне доступности [создайте кластер-приемник {{ mpg-name }}](../operations/cluster-create.md#create-cluster) любой подходящей конфигурации с хостами в публичном доступе и следующими настройками:
...
1. [Подключитесь к базе данных в кластере-приемнике {{ mpg-name }}](../operations/connect/index.md).
1. Выполните запрос:
