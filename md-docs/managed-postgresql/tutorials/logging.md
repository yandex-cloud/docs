...
БД будет создана с помощью сервиса [{{ mpg-full-name }}](../index.md).
...
Логи, полученные от балансировщика, будут записываться в базу данных, которая входит в состав [кластера](../concepts/index.md) {{ mpg-name }}.
