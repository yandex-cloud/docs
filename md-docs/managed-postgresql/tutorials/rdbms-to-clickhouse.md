...
- Вручную {#manual}
  ...
  1. [Выдайте роль](../operations/grant.md#grant-privilege) `mdb_replication` пользователю `pg-user` в кластере {{ mpg-name }}.
...
1. [Подключитесь к кластеру {{ mpg-name }}](../operations/connect/index.md).
