[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for PostgreSQL](../index.md) > [Практические руководства](index.md) > Репликация и миграция > Миграция кластера Managed Service for PostgreSQL на другую версию
...
1. Создайте кластер-приемник Managed Service for PostgreSQL:
    ...
    - Вручную {#manual}
        ...
        [Создайте кластер-приемник Managed Service for PostgreSQL](../operations/cluster-create.md) с конфигурацией, идентичной кластеру-источнику, и со следующими настройками:
...
1. [Подключитесь к базе данных](../operations/connect/index.md) `db1` в кластере-приемнике Managed Service for PostgreSQL.
...
- Вручную {#manual}
    ...
    1. [Удалите кластер Managed Service for PostgreSQL](../operations/cluster-delete.md) версии `17`.
