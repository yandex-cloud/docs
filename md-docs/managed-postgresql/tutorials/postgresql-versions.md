...
1. Создайте кластер-приемник {{ mpg-name }}:
    ...
    - Вручную {#manual}
        ...
        [Создайте кластер-приемник {{ mpg-name }}](../operations/cluster-create.md) с конфигурацией, идентичной кластеру-источнику, и со следующими настройками:
...
1. [Подключитесь к базе данных](../operations/connect/index.md) `db1` в кластере-приемнике {{ mpg-name }}.
...
- Вручную {#manual}
    ...
    1. [Удалите кластер {{ mpg-name }}](../operations/cluster-delete.md) версии `17`.
