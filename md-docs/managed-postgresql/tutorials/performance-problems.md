...
1. На странице кластера выберите ![image](../../_assets/console-icons/heart-pulse.svg) **Диагностика производительности** на панели слева.
...
1. На странице кластера Managed Service for PostgreSQL выберите ![image](../../_assets/console-icons/receipt.svg) **Логи** на панели слева.
