...
- Вручную {#manual}
    ...
    1. [Создайте кластер-источник {{ mpg-name }}](../operations/cluster-create.md#create-cluster) в любой [зоне доступности](../../overview/concepts/geo-scope.md), с хостами любой подходящей конфигурации в публичном доступе, и следующими настройками:
...
1. [Подключитесь к базе данных в кластере-источнике {{ mpg-name }}](../operations/connect/index.md).
