[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for PostgreSQL](../index.md) > [Практические руководства](index.md) > Репликация и миграция > Миграция базы данных из Yandex Managed Service for PostgreSQL в Yandex Object Storage
...
- Вручную {#manual}
    ...
    1. Если вы используете [группы безопасности](../operations/connect/index.md#configuring-security-groups) в кластере, убедитесь, что они настроены правильно и допускают подключение к нему.
...
1. [Подключитесь к кластеру Managed Service for PostgreSQL](../operations/connect/index.md), удалите строку с идентификатором `41` и измените строку с идентификатором `42` в таблице `x_tab`:
