...
- Консоль управления {#console}
  ...
  1. В блоке **{{ ui-key.yacloud.mdb.forms.section_resource }}** выберите подходящий вам класс [хоста](../../concepts/instance-types.md).
...
1. [Удалите](../../operations/cluster-delete.md) кластер {{ mpg-name }} `joomla-pg-cluster`.
