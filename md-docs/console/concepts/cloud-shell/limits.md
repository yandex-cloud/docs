...
При использовании терминала {{ cloud-shell-name }} для пользовательского аккаунта действуют _лимиты_ — технические ограничения, обусловленные особенностями архитектуры {{ yandex-cloud }}. Изменить лимиты невозможно.
