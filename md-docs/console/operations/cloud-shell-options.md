[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Console](../index.md) > Пошаговые инструкции > Управление Cloud Shell
...
## Запустить Cloud Shell {#init}

Чтобы запустить терминал Cloud Shell:
...
1. В меню слева нажмите кнопку ![Cloud Shell](../../_assets/console-icons/cloud-shell.svg) **Cloud Shell**.
...
Скрытие терминала или перезагрузка страницы не влияет на состояние сессии. Виртуальная машина Cloud Shell будет продолжать работать в фоне, но по прошествии 15 минут будет автоматически остановлена и удалена. Любые системные изменения, включая установленные приложения и пакеты, будут сброшены.