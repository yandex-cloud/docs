[Документация Yandex Cloud](../../../../index.md) > [Yandex Resource Manager](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Folder](index.md) > List
...
To get the cloud ID, use a [yandex.cloud.resourcemanager.v1.CloudService.List](../Cloud/list.md#List) request.
