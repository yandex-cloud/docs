[Документация Yandex Cloud](../../../../index.md) > [Yandex Resource Manager](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Folder](index.md) > UpdateAccessPolicyBindingParameters

# Resource Manager API, gRPC: FolderService.UpdateAccessPolicyBindingParameters
