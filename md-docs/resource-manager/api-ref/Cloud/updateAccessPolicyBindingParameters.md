[Документация Yandex Cloud](../../../index.md) > [Yandex Resource Manager](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Cloud](index.md) > UpdateAccessPolicyBindingParameters

# Resource Manager API, REST: Cloud.UpdateAccessPolicyBindingParameters
...
```
PATCH https://resource-manager.api.cloud.yandex.net/resource-manager/v1/clouds/{resourceId}:updateAccessPolicyBindingParameters
```
