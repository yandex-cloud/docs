[Документация Yandex Cloud](../../index.md) > [Yandex Resource Manager](../index.md) > [Пошаговые инструкции](index.md) > Посмотреть операции с ресурсами сервиса

# Посмотреть операции с ресурсами сервиса Resource Manager

Все действия с ресурсами сервиса Resource Manager сохраняются в виде списка операций. Каждой операции присваивается уникальный идентификатор.
...
- Консоль управления {#console}
  ...
  1. В верхней части экрана перейдите на вкладку **Операции**.
...
- CLI {#cli}
  ...
  Чтобы получить список операций для ресурса сервиса Resource Manager, воспользуйтесь командой:
