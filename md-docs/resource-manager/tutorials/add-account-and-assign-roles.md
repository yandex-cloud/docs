...
Для приглашения пользователей с аккаунтом на Яндексе смотрите инструкции [Добавить пользователя](../../organization/operations/add-account.md). Инструкции для федеративных и локальных пользователей смотрите в разделе [Управление аккаунтом пользователя](../../organization/operations/user-account/index.md).
...
- Интерфейс Cloud Center {#cloud-center}
    ...
    1. Для отправки приглашения нажмите кнопку **Далее**. Откроется окно для назначения ролей и добавления пользователей в группу.
...
Чтобы назначить дополнительные роли или отозвать уже выданные, используйте инструкции  [Настройка прав доступа к облаку](../operations/cloud/set-access-bindings.md) и [Настройка прав доступа к каталогу](../operations/folder/set-access-bindings.md).
