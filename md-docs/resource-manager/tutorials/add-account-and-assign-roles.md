...
Для приглашения пользователей с аккаунтом на Яндексе см. инструкции [Добавить пользователя](../../organization/operations/add-account.md). Инструкции для федеративных и локальных пользователей см. в разделе [Управление аккаунтом пользователя](../../organization/operations/user-account/index.md).
...
В стоимость поддержки инфраструктуры входит плата за вычислительные ресурсы, операционную систему, хранилище, объем исходящего трафика и публичный IP-адрес ВМ (см. [тарифы Yandex Compute Cloud](../../compute/pricing.md)).
...
- Консоль управления {#console}
    ...
    1. В открывшемся окне выберите раздел **Приглашенные аккаунты**.
    1. Выберите пользователя из списка или воспользуйтесь поиском по пользователям.
    1. Нажмите кнопку ![image](../../_assets/console-icons/plus.svg) **Добавить роль** и выберите роль `compute.editor`.

       {% note tip %}

       Вы можете назначить пользователю другие роли в зависимости от того, какие действия с ресурсами каталога вы хотите разрешить. Полный перечень ролей см. в документации [Yandex Identity and Access Management](../../iam/roles-reference.md).
...
Подробные инструкции для пользователей по первому входу и работе с аккаунтом см. в разделе [Управление аккаунтом пользователя](../../organization/operations/user-account/index.md).
...
Подробнее о первом входе для разных типов пользователей см. в инструкции [Первый вход в консоль](../../organization/operations/user-account/first-login.md).
