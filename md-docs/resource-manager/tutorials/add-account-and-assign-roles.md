...
Для приглашения пользователей с аккаунтом на Яндексе см. инструкции [{#T}](../../organization/operations/add-account.md). Инструкции для федеративных и локальных пользователей см. в разделе [{#T}](../../organization/operations/user-account/index.md).
...
- Консоль управления {#console}
    ...
    1. В [консоли управления]({{ link-console-main }}) [выберите](../operations/cloud/switch-cloud.md) облако `testing`.
...
Подробные инструкции для пользователей по первому входу и работе с аккаунтом см. в разделе [{#T}](../../organization/operations/user-account/index.md).
...
Подробнее о первом входе для разных типов пользователей см. в инструкции [{#T}](../../organization/operations/user-account/first-login.md).
