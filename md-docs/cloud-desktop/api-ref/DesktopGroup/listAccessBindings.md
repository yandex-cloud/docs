[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Desktop](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [DesktopGroup](index.md) > ListAccessBindings
...
```
GET https://clouddesktops.api.cloud.yandex.net/cloud-desktop/v1/desktopGroups/{resourceId}:listAccessBindings
```
