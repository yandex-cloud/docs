[Документация Yandex Cloud](../../../../index.md) > [Yandex Cloud Desktop](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Desktop](index.md) > ListOperations
...
1. The field name. Currently you can use filtering only on [Desktop.name](../DesktopGroup/listDesktops.md#yandex.cloud.clouddesktop.v1.api.Desktop) field.
