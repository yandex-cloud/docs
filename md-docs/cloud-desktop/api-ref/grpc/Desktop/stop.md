[Документация Yandex Cloud](../../../../index.md) > [Yandex Cloud Desktop](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Desktop](index.md) > Stop

# Cloud Desktop API, gRPC: DesktopService.Stop

Stop the specified desktop.

## gRPC request

**rpc Stop ([StopRequest](#yandex.cloud.clouddesktop.v1.api.StopRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## StopRequest {#yandex.cloud.clouddesktop.v1.api.StopRequest}
