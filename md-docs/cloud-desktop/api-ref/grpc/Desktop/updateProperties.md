[Документация Yandex Cloud](../../../../index.md) > [Yandex Cloud Desktop](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Desktop](index.md) > UpdateProperties

# Cloud Desktop API, gRPC: DesktopService.UpdateProperties

Updates desktop properties.

## gRPC request

**rpc UpdateProperties ([UpdatePropertiesRequest](#yandex.cloud.clouddesktop.v1.api.UpdatePropertiesRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## UpdatePropertiesRequest {#yandex.cloud.clouddesktop.v1.api.UpdatePropertiesRequest}
...
Required field. To get the desktop ID use a [DesktopService.List](list.md#List) request.
