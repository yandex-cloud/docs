[Документация Yandex Cloud](../index.md) > [Yandex Cloud Desktop](index.md) > История изменений

# История изменений в Cloud Desktop
...
* Реализовано добавление образа Windows для развертывания рабочих столов. Образ Windows создается на базе вашего образа Windows с вашей лицензией.
   ...
   Подробнее в разделе [Создать образ на основе Windows](operations/images/create-from-windows.md).
...
* Реализовано добавление вашего образа Linux для развертывания рабочих столов. Образ можно настроить и установить для него дополнительные пакеты.
   ...
   Подробнее в разделе [Создать образ на основе ВМ Linux Compute Cloud](operations/images/create-from-compute-linux.md).
...
* Добавлены готовые конфигурации рабочих столов для разных задач. Конфигурации помогут выбрать подходящее рабочее место, не задавая характеристики для каждой группы. Если готовая конфигурация не подойдет, можно настроить рабочий стол индивидуально.
   ...
   Подробнее в разделе [Создать группу рабочих столов](operations/desktop-groups/create.md).

* Поддержано управление доступом к рабочим столам с помощью Yandex Identity and Access Management. Вы можете предоставить доступ к группе рабочих столов: 
...
* Сервис начал тарифицироваться. Актуальные цены добавлены на страницу [Правила тарификации для Yandex Cloud Desktop](pricing.md).