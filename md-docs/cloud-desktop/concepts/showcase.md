...
_[Витрина пользовательских рабочих столов]({{ link-cloud-desktop-showcase }})_ — веб-страница вне [консоли управления](../../console/index.md) {{ yandex-cloud }}, на которой пользователю доступны основные действия с его рабочими столами и краткая инструкция.
