[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Desktop](../index.md) > Концепции > Диски
...
В Cloud Desktop поддерживаются сетевые SSD- и HDD-диски.
...
Подробнее про диски в [документации Compute Cloud](../../compute/concepts/disk.md).
