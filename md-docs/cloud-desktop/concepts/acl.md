...
ACL Cloud Desktop — список разрешений для конкретной [группы рабочих столов](desktops-and-groups.md).
...
* [Группа пользователей Yandex Identity Hub](../../organization/concepts/groups.md)
