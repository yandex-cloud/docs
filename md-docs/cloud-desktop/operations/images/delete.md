[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Desktop](../../index.md) > [Пошаговые инструкции](../index.md) > Образы > Удалить пользовательский образ

# Удалить пользовательский образ

{% note info %}

[Системные образы](../../concepts/images.md#system-images) Cloud Desktop нельзя удалить.
