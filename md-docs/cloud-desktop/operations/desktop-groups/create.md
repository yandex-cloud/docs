...
- Yandex Cloud CLI {#cli}
  ...
  1. Выберите [образ](../../concepts/images.md) для создания загрузочного [диска](../../concepts/disks.md) рабочего стола. Идентификатор образа можно посмотреть в [консоли управления](https://console.yandex.cloud).
