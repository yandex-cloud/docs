...
- Консоль управления {#console}
  ...
  1. В блоке **{{ ui-key.yacloud.compute.instances.create.section_platform }}**:
     ...
     * Чтобы задать свою конфигурацию рабочих столов, на вкладке **{{ ui-key.yacloud.component.compute.resources.label_tab-custom }}** укажите:
       ...
       * Объем RAM.
  1. Выберите предустановленный или пользовательский [образ](../../concepts/images.md) операционной системы.
  1. В блоке **{{ ui-key.yacloud.vdi.section_disks }}**:
      * Выберите [типы](../../../compute/concepts/disk.md#disks-types) загрузочного и рабочего [дисков](../../concepts/disks.md).
  ...
  1. В блоке **Пользователи рабочих столов** нажмите **Добавить пользователей** и укажите:
     ...
     * Почтовый адрес любого пользователя — ему будет отправлено приглашение в вашу организацию и назначена роль для доступа к рабочим столам.
      ...
      Пользователи из списка будут видеть рабочие столы этой группы на своей [витрине](../../concepts/showcase.md). Чтобы у пользователей была возможность подключаться к рабочим столам, им надо [назначить роль](../../../iam/operations/roles/grant.md) `vdi.desktopGroups.user` или `vdi.desktopGroups.maintainer`.
...
- {{ yandex-cloud }} CLI {#cli}
  ...
  1. Посмотрите описание команды [CLI](../../../cli/index.md) для создания [группы рабочих столов](../../concepts/desktops-and-groups.md):
  ...
  1. Выберите [образ](../../concepts/images.md) для создания загрузочного [диска](../../concepts/disks.md) рабочего стола. Идентификатор образа можно посмотреть в [консоли управления]({{ link-console-main }}).
...
- API {#api}
  ...
  Воспользуйтесь методом REST API [create](../../api-ref/DesktopGroup/create.md) для ресурса [DesktopGroup](../../api-ref/DesktopGroup/index.md) или вызовом gRPC API [DesktopGroupService/Create](../../api-ref/grpc/DesktopGroup/create.md).
