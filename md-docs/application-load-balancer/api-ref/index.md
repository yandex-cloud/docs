[Документация Yandex Cloud](../../index.md) > [Yandex Application Load Balancer](../index.md) > Справочник API > REST (англ.) > Overview
...
**Service URL**: `https://alb.api.cloud.yandex.net`
