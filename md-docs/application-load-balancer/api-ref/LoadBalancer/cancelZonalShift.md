[Документация Yandex Cloud](../../../index.md) > [Yandex Application Load Balancer](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [LoadBalancer](index.md) > CancelZonalShift
...
## Body parameters {#yandex.cloud.apploadbalancer.v1.CancelZonalShiftRequest}
...
|| metadata | **[CancelZonalShiftMetadata](#yandex.cloud.apploadbalancer.v1.CancelZonalShiftMetadata)**
...
## CancelZonalShiftMetadata {#yandex.cloud.apploadbalancer.v1.CancelZonalShiftMetadata}
