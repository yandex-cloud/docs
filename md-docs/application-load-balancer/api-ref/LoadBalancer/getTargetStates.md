[Документация Yandex Cloud](../../../index.md) > [Yandex Application Load Balancer](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [LoadBalancer](index.md) > GetTargetStates
...
(the number depends on the [HealthCheck.healthyThreshold](../BackendGroup/get.md#yandex.cloud.apploadbalancer.v1.HealthCheck) setting) and the target is ready to receive traffic.
...
(the number depends on the [HealthCheck.unhealthyThreshold](../BackendGroup/get.md#yandex.cloud.apploadbalancer.v1.HealthCheck) setting).
