[Документация Yandex Cloud](../../../index.md) > [Yandex Application Load Balancer](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [LoadBalancer](index.md) > Start
...
```
POST https://alb.api.cloud.yandex.net/apploadbalancer/v1/loadBalancers/{loadBalancerId}:start
```
...
|| metadata | **[StartLoadBalancerMetadata](#yandex.cloud.apploadbalancer.v1.StartLoadBalancerMetadata)**
...
## StartLoadBalancerMetadata {#yandex.cloud.apploadbalancer.v1.StartLoadBalancerMetadata}
