[Документация Yandex Cloud](../../../index.md) > [Yandex Application Load Balancer](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [LoadBalancer](index.md) > DisableZones
...
```
POST https://alb.api.cloud.yandex.net/apploadbalancer/v1/loadBalancers/{loadBalancerId}:disableZones
```
...
## Body parameters {#yandex.cloud.apploadbalancer.v1.DisableZonesRequest}
