[Документация Yandex Cloud](../../../index.md) > [Yandex Application Load Balancer](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [BackendGroup](index.md) > RemoveBackend
...
To get the backend name, make a [BackendGroupService.Get](get.md#Get) request. ||
|#
