[Документация Yandex Cloud](../../../index.md) > [Yandex Application Load Balancer](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [HttpRouter](index.md) > Get
...
## Response {#yandex.cloud.apploadbalancer.v1.HttpRouter}
