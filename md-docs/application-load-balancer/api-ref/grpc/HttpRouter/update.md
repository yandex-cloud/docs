...
**rpc Update ([UpdateHttpRouterRequest](#yandex.cloud.apploadbalancer.v1.UpdateHttpRouterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## UpdateHttpRouterRequest {#yandex.cloud.apploadbalancer.v1.UpdateHttpRouterRequest}
...
1. Get the current set of labels with a [HttpRouterService.Get](get.md#Get) request.
...
a virtual host, make a [VirtualHostService.Create](../VirtualHost/create.md#Create) request or a [VirtualHostService.Delete](../VirtualHost/delete.md#Delete) request. ||
...
For details about the concept, see [documentation](../../../concepts/http-router.md).
...
For details about the concept, see [documentation](../../../../overview/concepts/services.md#labels). ||
|| virtual_hosts[] | **[VirtualHost](#yandex.cloud.apploadbalancer.v1.VirtualHost2)**
...
Whether set to 'true' disables security profile for the route. ||
|| client_certificate_forward | **[ClientCertificateForward](#yandex.cloud.apploadbalancer.v1.ClientCertificateForward2)**
