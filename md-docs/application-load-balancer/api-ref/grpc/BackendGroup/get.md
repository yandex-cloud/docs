[Документация Yandex Cloud](../../../../index.md) > [Yandex Application Load Balancer](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [BackendGroup](index.md) > Get

# Application Load Balancer API, gRPC: BackendGroupService.Get

Returns the specified backend group.

To get the list of all available backend groups, make a [List](list.md#List) request.
...
[HttpBackend.backend_weight](#yandex.cloud.apploadbalancer.v1.HttpBackend)), its [HttpBackend.backend_type](get.md#yandex.cloud.apploadbalancer.v1.HttpBackend.backend_type) should be [TargetGroupsBackend](#yandex.cloud.apploadbalancer.v1.TargetGroupsBackend), and its
