[Документация Yandex Cloud](../../../../index.md) > [Yandex Application Load Balancer](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [LoadBalancer](index.md) > DisableZones

# Application Load Balancer API, gRPC: LoadBalancerService.DisableZones

Disable L7 traffic routing in zones for the specified load balancer.

## gRPC request

**rpc DisableZones ([DisableZonesRequest](#yandex.cloud.apploadbalancer.v1.DisableZonesRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## DisableZonesRequest {#yandex.cloud.apploadbalancer.v1.DisableZonesRequest}
...
|| metadata | **[DisableZonesMetadata](#yandex.cloud.apploadbalancer.v1.DisableZonesMetadata)**
...
## DisableZonesMetadata {#yandex.cloud.apploadbalancer.v1.DisableZonesMetadata}
