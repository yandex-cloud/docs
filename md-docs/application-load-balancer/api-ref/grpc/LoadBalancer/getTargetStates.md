[Документация Yandex Cloud](../../../../index.md) > [Yandex Application Load Balancer](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [LoadBalancer](index.md) > GetTargetStates
...
- `HEALTHY`: All of the health checks specified in [HttpBackend.healthchecks](../BackendGroup/get.md#yandex.cloud.apploadbalancer.v1.HttpBackend) or [GrpcBackend.healthchecks](../BackendGroup/get.md#yandex.cloud.apploadbalancer.v1.GrpcBackend) are passed
(the number depends on the [HealthCheck.healthy_threshold](../BackendGroup/get.md#yandex.cloud.apploadbalancer.v1.HealthCheck) setting) and the target is ready to receive traffic.
- `PARTIALLY_HEALTHY`: Some of the health checks specified in [HttpBackend.healthchecks](../BackendGroup/get.md#yandex.cloud.apploadbalancer.v1.HttpBackend) or [GrpcBackend.healthchecks](../BackendGroup/get.md#yandex.cloud.apploadbalancer.v1.GrpcBackend) failed
(the number depends on the [HealthCheck.unhealthy_threshold](../BackendGroup/get.md#yandex.cloud.apploadbalancer.v1.HealthCheck) setting).
...
(the number depends on the [HealthCheck.unhealthy_threshold](../BackendGroup/get.md#yandex.cloud.apploadbalancer.v1.HealthCheck) setting) and the target is not receiving traffic.
...
which determine target statuses as configured in [HttpBackend.healthchecks](../BackendGroup/get.md#yandex.cloud.apploadbalancer.v1.HttpBackend) or [GrpcBackend.healthchecks](../BackendGroup/get.md#yandex.cloud.apploadbalancer.v1.GrpcBackend).
