...
Required field. ID of the application load balancer to remove the listener from. ||
|| name | **string**

Required field. Name of the listener to remove from the application load balancer. ||
|#
...
|| metadata | **[RemoveListenerMetadata](#yandex.cloud.apploadbalancer.v1.RemoveListenerMetadata)**
...
## RemoveListenerMetadata {#yandex.cloud.apploadbalancer.v1.RemoveListenerMetadata}
