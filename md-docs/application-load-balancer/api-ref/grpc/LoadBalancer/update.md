[Документация Yandex Cloud](../../../../index.md) > [Yandex Application Load Balancer](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [LoadBalancer](index.md) > Update

# Application Load Balancer API, gRPC: LoadBalancerService.Update
...
1. Get the current set of labels with a [LoadBalancerService.Get](get.md#Get) request.
...
or remove a listener, make a [LoadBalancerService.AddListener](addListener.md#AddListener) request,
a [LoadBalancerService.UpdateListener](updateListener.md#UpdateListener) request, or a [LoadBalancerService.RemoveListener](removeListener.md#RemoveListener) request. ||
...
1. Get the current settings with a [LoadBalancerService.Get](get.md#Get) request.
...
so if you just want to add or remove an allocation policy:
1. Get the current set of security groups with a [LoadBalancerService.Get](get.md#Get) request.
