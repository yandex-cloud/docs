[Документация Yandex Cloud](../../../../index.md) > [Yandex Application Load Balancer](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [LoadBalancer](index.md) > Stop

# Application Load Balancer API, gRPC: LoadBalancerService.Stop
...
Required field. ID of the application load balancer to stop.

The application load balancer must have an `ACTIVE` status ([LoadBalancer.status](#yandex.cloud.apploadbalancer.v1.LoadBalancer)).
...
|| metadata | **[StopLoadBalancerMetadata](#yandex.cloud.apploadbalancer.v1.StopLoadBalancerMetadata)**
...
## StopLoadBalancerMetadata {#yandex.cloud.apploadbalancer.v1.StopLoadBalancerMetadata}
