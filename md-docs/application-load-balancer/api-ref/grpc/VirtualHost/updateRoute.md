[Документация Yandex Cloud](../../../../index.md) > [Yandex Application Load Balancer](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [VirtualHost](index.md) > UpdateRoute
...
**rpc UpdateRoute ([UpdateRouteRequest](#yandex.cloud.apploadbalancer.v1.UpdateRouteRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**
...
To get the route name, make a [VirtualHostService.Get](get.md#Get) request. ||
