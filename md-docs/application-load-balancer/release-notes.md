...
* В [консоли управления]({{ link-console-main }}) добавлена возможность [заблокировать](operations/manage-zone/start-and-cancel-shift.md) одну или несколько зон доступности, а также задать время автоматического отключения блокировки.
...
* Реализована интеграция с сервисом [{{ sws-full-name }}](../smartwebsecurity/index.md):
  ...
  * отправка метрик {{ sws-name }} в [{{ monitoring-full-name }}](../monitoring/index.md).
