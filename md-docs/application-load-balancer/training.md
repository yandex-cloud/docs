[Документация Yandex Cloud](../index.md) > [Yandex Application Load Balancer](index.md) > Обучающие курсы

# Обучающие курсы по Yandex Application Load Balancer
...
Подробнее узнать об использовании сервиса Yandex Application Load Balancer можно в следующих курсах:
