...
* [Логирование](../../concepts/monitoring.md#logging) и настройка правил отбрасывания логов.
* [Автомасштабирование](../../concepts/application-load-balancer.md#lcu-scaling) с контролем ресурсных единиц.
* [Зональное управление трафиком](../../concepts/application-load-balancer.md#lb-location) для обеспечения высокой доступности сервисов.
* Гибкие настройки балансировки, включающие [локализацию трафика](../../concepts/backend-group.md#locality) и [режим паники](../../concepts/backend-group.md#panic-mode).
