...
К [Ingress-контроллеру Application Load Balancer для Managed Service for Kubernetes](index.md) относятся два [пода](../../../managed-kubernetes/concepts/index.md#pod):
...
* Группы бэкендов, обрабатывающие полученный трафик, могут создаваться:
  ...
  * По сервисам Kubernetes, указанным в [правилах](../../k8s-ref/ingress.md#rule) `Ingress` напрямую. Этот способ полезен, если к маршруту нужно привязать простую группу бэкендов, состоящую из одного сервиса.
...
- Консоль управления {#console}
  ...
  1. На странице кластера Managed Service for Kubernetes нажмите на вкладку **Другое** ![chevron-down](../../../_assets/console-icons/chevron-down.svg) и выберите **Пользовательские ресурсы**.
