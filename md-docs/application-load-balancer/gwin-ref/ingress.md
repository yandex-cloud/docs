...
| `gwin.yandex.cloud/logs.disable` <br> _(boolean)_ <br> Disable sending logs to [Cloud Logging](../../logging/index.md). <br> Example: `false` |
...
| `gwin.yandex.cloud/rules.backends.balancing.panicThreshold` <br> _(number)_ <br> [Panic mode](../concepts/backend-group.md#panic-mode) threshold percentage for load balancing. <br> Example: `50` |
