[Документация Yandex Cloud](../../index.md) > [Yandex Application Load Balancer](../index.md) > Справочник аудитных логов > CancelZonalShift

# Application Load Balancer Audit Trails Events: CancelZonalShift

## Event JSON schema {#yandex.cloud.audit.apploadbalancer.CancelZonalShift2-schema}
...
## Field description {#yandex.cloud.audit.apploadbalancer.CancelZonalShift2}
...
|| details | **[EventDetails](#yandex.cloud.audit.apploadbalancer.CancelZonalShift.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.apploadbalancer.CancelZonalShift.EventDetails}
