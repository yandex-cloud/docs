[Документация Yandex Cloud](../../index.md) > [Yandex Application Load Balancer](../index.md) > Справочник аудитных логов > CreateHttpRouter
...
## Field description {#yandex.cloud.audit.apploadbalancer.CreateHttpRouter2}
...
|| details | **[EventDetails](#yandex.cloud.audit.apploadbalancer.CreateHttpRouter.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.apploadbalancer.CreateHttpRouter.EventDetails}
