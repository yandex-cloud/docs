...
- Консоль управления {#console}
  ...
  1. Выберите ресурсы, для которых хотите посмотреть статистику:
     ...
     * **Backend** — бэкенд.
     * **Zone** — зона доступности, в которой расположены узлы балансировщика. Подробнее см. в разделе [Расположение балансировщика и его внутренние IP-адреса](../concepts/application-load-balancer.md#lb-location).
