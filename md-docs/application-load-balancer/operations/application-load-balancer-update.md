[Документация Yandex Cloud](../../index.md) > [Yandex Application Load Balancer](../index.md) > [Пошаговые инструкции](index.md) > L7-балансировщики > Изменить L7-балансировщик
      ...
      1. В блоке **Настройки логов**:
          ...
          1. Измените [правила отбрасывания логов](../concepts/application-load-balancer.md#discard-logs-rules):
              ...
              * **Доля отбрасываемых логов** — измените процент отбрасываемых логов.
              ...
              Чтобы добавить еще одно правило, нажмите кнопку **Добавить правило**.
