[Документация Yandex Cloud](../../../index.md) > [Yandex Application Load Balancer](../../index.md) > [Пошаговые инструкции](../index.md) > L7-балансировщики > Управление зоной доступности > Разрешить и запретить отключение зоны доступности
