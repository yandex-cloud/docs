...
* просматривать информацию о [квотах](../concepts/limits.md#quotas) сервиса Application Load Balancer.
...
* просматривать информацию о квотах сервисов [Application Load Balancer](../concepts/limits.md#quotas), [Network Load Balancer](../../network-load-balancer/concepts/limits.md#load-balancer-quotas) и [Virtual Private Cloud](../../vpc/concepts/limits.md#vpc-quotas).
