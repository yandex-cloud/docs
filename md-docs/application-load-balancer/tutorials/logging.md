...
* Логи Cloud Logging: объем записываемых данных и время их хранения (см. [тарифы Cloud Logging](../../logging/pricing.md)).
* Балансировщики Application Load Balancer: использование вычислительных ресурсов каждого активного балансировщика (см. [тарифы Application Load Balancer](../pricing.md)).
...
В качестве веб-серверов для сайта будет выступать [группа виртуальных машин](../../compute/concepts/instance-groups/index.md) Compute Cloud. Серверы будут реализованы на LEMP-стеке (Linux, nginx, MySQL, PHP; подробнее см. [Сайт на LAMP- или LEMP-стеке](../../tutorials/web/lamp-lemp/index.md)).
