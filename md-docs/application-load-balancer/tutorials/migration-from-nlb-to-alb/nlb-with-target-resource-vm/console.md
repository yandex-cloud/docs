...
1. [Создайте целевую группу](../../../operations/target-group-create.md) L7-балансировщика. В блоке **Целевые ресурсы** выберите виртуальные машины из целевой группы вашего сетевого балансировщика нагрузки.
...
1. [Создайте L7-балансировщик](../../../operations/application-load-balancer-create.md), выбрав способ создания **Вручную**:
    ...
    1. В блоке **Настройки автомасштабирования** укажите [минимальное количество ресурсных единиц](../../../concepts/application-load-balancer.md#lcu-scaling-settings) в каждой зоне в соответствии с ожидаемой нагрузкой на ваш сервис.
