...
* Плата за использование вычислительных ресурсов каждого L7-балансировщика (см. [тарифы Application Load Balancer](../pricing.md)).
...
- Вручную {#manual}
    ...
    1. [Создайте сервисные аккаунты](../../iam/operations/sa/create.md) для кластера Managed Service for Kubernetes:
        ...
        * Сервисный аккаунт для работы Ingress-контроллера Application Load Balancer с ролями:
            ...
            * [alb.editor](../security/index.md#alb-editor) — для создания необходимых ресурсов.
            ...
            * [compute.viewer](../../compute/security/index.md#compute-viewer) — для использования узлов кластера Managed Service for Kubernetes в [целевых группах](../concepts/target-group.md) балансировщика.
