...
В этом руководстве в качестве [бэкенда](../../concepts/backend-group.md#types) L7-балансировщика {{ alb-full-name }} используется [бакет](../../../storage/concepts/bucket.md) {{ objstorage-full-name }}. Запросы пользователей передаются [балансировщику](../../concepts/application-load-balancer.md) через [сеть распространения контента](../../../cdn/concepts/points-of-presence.md) {{ cdn-full-name }}, чтобы сократить время доставки контента.
