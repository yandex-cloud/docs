[Документация Yandex Cloud](../../../index.md) > [Yandex Application Load Balancer](../../index.md) > [Практические руководства](../index.md) > [Создание L7-балансировщика Application Load Balancer с профилем безопасности Smart Web Security](index.md) > Terraform
...
1. Подготовьте файлы с описанием инфраструктуры:
   ...
   * [Профиль безопасности](../../../smartwebsecurity/concepts/profiles.md) — [yandex_sws_security_profile](../../../terraform/resources/sws_security_profile.md).
...
1. [Получите IP-адрес](../../operations/application-load-balancer-get.md) L7-балансировщика — он потребуется далее, чтобы [проверить работу профиля безопасности](#test).
...
* [Создание L7-балансировщика Application Load Balancer с профилем безопасности Yandex Smart Web Security с помощью консоли управления](console.md)