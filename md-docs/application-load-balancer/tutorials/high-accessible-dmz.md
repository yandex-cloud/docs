...
* Каталог **public** содержит [Application Load Balancer](../index.md) для организации публичного доступа из сети интернет к опубликованным в DMZ приложениям.
...
* плата за использование Application Load Balancer (см. [тарифы Yandex Application Load Balancer](../pricing.md));
