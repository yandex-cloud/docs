[Документация Yandex Cloud](../../../../index.md) > [Yandex Application Load Balancer](../../../index.md) > [Справочник CLI (англ.)](../../index.md) > [v0](../index.md) > [virtual-host](index.md) > prepend-grpc-route

# yc application-load-balancer v0 virtual-host prepend-grpc-route
...
`yc application-load-balancer v0 virtual-host prepend-grpc-route <ROUTE-NAME> [Flags...] [Global Flags...]`
