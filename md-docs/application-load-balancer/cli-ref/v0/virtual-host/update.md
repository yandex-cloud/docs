[Документация Yandex Cloud](../../../../index.md) > [Yandex Application Load Balancer](../../../index.md) > [Справочник CLI (англ.)](../../index.md) > [v0](../index.md) > [virtual-host](index.md) > update
...
`yc application-load-balancer v0 virtual-host update <VIRTUAL-HOST-NAME> [Flags...] [Global Flags...]`
