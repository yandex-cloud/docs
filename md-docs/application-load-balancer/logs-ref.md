...
`backend_ip` | Внутренний IP-адрес эндпоинта [бэкенда](concepts/backend-group.md) — виртуальной машины из [целевой группы](concepts/target-group.md) или [бакета Object Storage](../storage/concepts/bucket.md).
