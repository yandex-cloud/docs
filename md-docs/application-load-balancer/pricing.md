[Документация Yandex Cloud](../index.md) > [Yandex Application Load Balancer](index.md) > Правила тарификации
...
- Расчет в рублях {#prices-rub}
  ...
  > 8 × 2,63 ₽ = 21,04 ₽
  >
  > Итого: 21,04 ₽ — стоимость часа использования балансировщика.
...
- Расчет в тенге {#prices-kzt}
  ...
  > 8 × 13,15 ₸ = 105,2 ₸
  >
  > Итого: 105,2 ₸ — стоимость часа использования балансировщика.
...
- Расчет в рублях {#prices-rub}
  ...
  > 21,04 ₽ × 720 = 15 148,8 ₽
  >
  > Итого: 15 148,8 ₽ — стоимость использования балансировщика за месяц.
  
  Где:
  
  * 21,04 ₽ — стоимость часа использования балансировщика.
...
- Расчет в тенге {#prices-kzt}
  ...
  > 105,2 ₸ × 720 = 75 744 ₸
  >
  > Итого: 75 744 ₸ — стоимость использования балансировщика за месяц.
  
  Где:
  
  * 105,2 ₸ — стоимость часа использования балансировщика.
  * 720 — количество часов в месяц, зафиксированное для удобства расчетов.
...
| ------------------------------------------------- | ------- | ----------------------- | --------------- | ------------ |
| Application Load Balancer - large                 | 10,25 ₽ | Ресурсная единица × час | 31 декабря 2025 | —            |
| Application Load Balancer - xlarge                | 13,54 ₽ | Ресурсная единица × час | 31 декабря 2025 | —            |
| Application Load Balancer - xxlarge               | 16,84 ₽ | Ресурсная единица × час | 31 декабря 2025 | —            |
| Application Load Balancer. Одна ресурсная единица | 2,63 ₽  | Ресурсная единица × час | 30 апреля 2026  | —            |