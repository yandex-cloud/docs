...
* **[Envoy](https://www.envoyproxy.io/docs)** — сервер маршрутизации, который получает входящие gRPC-запросы и определяет, какие компоненты SpeechKit Hybrid ответственны за их обработку.
...
## Взаимосвязь компонентов SpeechKit Hybrid {#components-interaction}
