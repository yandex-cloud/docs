...
SpeechKit Hybrid собирает и хранит метрики в формате [Prometheus](https://prometheus.io). Подробнее о типах метрик см. в [документации Prometheus](https://prometheus.io/docs/concepts/metric_types/).
...
## Общие метрики SpeechKit Hybrid {#metrics}
...
| Метрика             | Тип       | Описание                                                                                               |
|:--------------------|:----------|:-------------------------------------------------------------------------------------------------------|
| `synthesis_sps`     | GAUGE     | Количество секунд синтезированного текста, которое генерируется за секунду работы SpeechKit Hybrid |
...
| `recognize_sps`      | GAUGE     | Количество миллисекунд распознанной речи, которое было обработано за секунду работы SpeechKit Hybrid                                                                                |
