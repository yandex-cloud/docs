[Документация Yandex Cloud](../../../../index.md) > [Yandex Cloud Billing](../../../index.md) > Справочник API > gRPC (англ.) > [Billing](../index.md) > [Budget](index.md) > Create
...
To get the billing account ID, use [yandex.cloud.billing.v1.BillingAccountService.List](../BillingAccount/list.md#List) request.
...
ID of the [yandex.cloud.resourcemanager.v1.Cloud](../../../../resource-manager/api-ref/grpc/Cloud/get.md#yandex.cloud.resourcemanager.v1.Cloud).
Only consumption within specified cloud is used for the budget calculation. ||
|| folder_ids[] | **string**

IDs of the [yandex.cloud.resourcemanager.v1.Folder](../../../../resource-manager/api-ref/grpc/Folder/get.md#yandex.cloud.resourcemanager.v1.Folder).
