[Документация Yandex Cloud](../../../../../index.md) > [Yandex Cloud Billing](../../../../index.md) > Справочник API > gRPC (англ.) > [Billing usage](../index.md) > [ConsumptionCore](index.md) > GetCloudUsageReport
...
**rpc GetCloudUsageReport ([UsageReportRequest](#yandex.cloud.billing.usage_records.v1.UsageReportRequest)) returns ([CloudUsageReportResponse](#yandex.cloud.billing.usage_records.v1.CloudUsageReportResponse))**
...
## CloudUsageReportResponse {#yandex.cloud.billing.usage_records.v1.CloudUsageReportResponse}
...
|| entities_data[] | **[CloudUsageReportEntityData](#yandex.cloud.billing.usage_records.v1.CloudUsageReportEntityData)**
...
## CloudUsageReportEntityData {#yandex.cloud.billing.usage_records.v1.CloudUsageReportEntityData}
