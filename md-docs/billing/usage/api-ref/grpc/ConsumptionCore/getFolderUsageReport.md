[Документация Yandex Cloud](../../../../../index.md) > [Yandex Cloud Billing](../../../../index.md) > Справочник API > gRPC (англ.) > [Billing usage](../index.md) > [ConsumptionCore](index.md) > GetFolderUsageReport

# Billing Usage API, gRPC: ConsumptionCoreService.GetFolderUsageReport
...
**rpc GetFolderUsageReport ([UsageReportRequest](#yandex.cloud.billing.usage_records.v1.UsageReportRequest)) returns ([FolderUsageReportResponse](#yandex.cloud.billing.usage_records.v1.FolderUsageReportResponse))**
...
## FolderUsageReportResponse {#yandex.cloud.billing.usage_records.v1.FolderUsageReportResponse}
...
|| entities_data[] | **[FolderUsageReportEntityData](#yandex.cloud.billing.usage_records.v1.FolderUsageReportEntityData)**
...
## FolderUsageReportEntityData {#yandex.cloud.billing.usage_records.v1.FolderUsageReportEntityData}
...
|| folder | **[Folder](#yandex.cloud.billing.usage_records.v1.Folder)**
