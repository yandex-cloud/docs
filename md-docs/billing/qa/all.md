...
1. Платеж поступил на лицевой счет — проверьте [историю платежей](../operations/check-bill-history.md). 
   
   {% note info %}

   Оплата с карты или через СБП поступает на счет [в течение 15 минут](../operations/pay-the-bill.md#individuals). Сроки поступления оплаты со счета юридического лица [зависят от банка, проводящего платеж](../payment/payment-methods-business.md#limits).

   {% endnote %}

1. Платежный аккаунт [находится в статусе](../concepts/billing-account-statuses.md#list) `ACTIVE`.
