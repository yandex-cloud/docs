...
Информация о размере порога оплаты представлена в [сервисе {{ billing-name }}]({{ link-console-billing }}) на странице ![image](../../_assets/console-icons/flag.svg) **{{ ui-key.yacloud_org.billing.account.switch_overview }}** в правом верхнем блоке вместе с информацией о текущем балансе.
...
- Физические лица {#individuals}
  ...
  Отслеживать состояние [баланса лицевого счета](personal-account.md#balance) можно в [сервисе {{ billing-name }}]({{ link-console-billing }}) на странице ![image](../../_assets/console-icons/flag.svg) **{{ ui-key.yacloud_org.billing.account.switch_overview }}**:
