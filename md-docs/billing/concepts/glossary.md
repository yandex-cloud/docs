...
См. документацию [Yandex Identity Hub](../../organization/index.md).
...
Подробные условия начисления пени см. в [Оферте на заключение договора на использование Сервисов Платформы «Yandex Cloud»](https://yandex.ru/legal/cloud_oferta/?lang=ru) (п.6, подпункт 6.15).
