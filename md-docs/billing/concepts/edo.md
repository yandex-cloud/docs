[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Billing](../index.md) > Оплата ресурсов > Организациям и ИП > Отчетные документы > Электронный документооборот
...
1. На странице аккаунта в блоке **Информация о договоре**:
     * Указан оператор ЭДО, если ЭДО подключен.
     * Доступна кнопка **Подключить ЭДО**, если ЭДО не подключен.

#### Полезные ссылки {#see-also}

[Подключиться к электронному документообороту](../operations/edo.md)