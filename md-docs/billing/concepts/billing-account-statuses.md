[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Billing](../index.md) > [Концепции](index.md) > Платежный аккаунт > Статусы
...
- Интерфейс Yandex Cloud Billing {#billing}
  ...
  1. Статус платежного аккаунта отображается в блоке **Платёжные аккаунты** в столбце **Статус**.
