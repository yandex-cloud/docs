[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Billing](../index.md) > [Пошаговые инструкции](index.md) > Управление платежным аккаунтом > Привязать облако к платежному аккаунту
...
- Интерфейс Yandex Cloud Billing {#billing}
   ...
   1. Перейдите к привязке облака или сервиса одним из способов:
       ...
       * В блоке **Привязанные облака и сервисы** раздела ![image](../../_assets/console-icons/flag.svg) **Аккаунт** нажмите кнопку ![alt text](../../_assets/console-icons/link.svg) **Привязать**.
       ...
       * На панели слева выберите ![image](../../_assets/console-icons/cloud.svg) **Облака и сервисы**. В верхнем правом углу страницы нажмите ![image](../../_assets/console-icons/link.svg) **Привязать**.
...
- Terraform {#tf}
  ...
  1. Опишите в конфигурационном файле параметры ресурсов, которые необходимо создать:
     ...
     * `cloud_id` — идентификатор облака, которое вы хотите привязать к платежному аккаунту.
     ...
     Подробнее о параметрах ресурса `yandex_billing_cloud_binding` в Terraform в [документации провайдера](../../terraform/resources/billing_cloud_binding.md).
  1. Создайте ресурсы:
...
Проверить привязку облака или сервиса к платежному аккаунту можно двумя способами:
  ...
  - Через Аккаунт
    ...
    1. Выберите платежный аккаунт, к которому привязали новое облако или сервис.
        ...
        В блоке **Привязанные облака и сервисы** отображаются тип и количество привязанных ресурсов.

    1. Для получения более подробной информации о привязанных ресурсах нажмите на ресурс или ![alt text](../../_assets/console-icons/chevron-right.svg) **Показать все**.
