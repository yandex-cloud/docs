...
- По периодам {#periods}
  ...
  Для получения детализации в указанный период по определенным облакам и каталогам, в списке **Все облака и каталоги** отметьте необходимые пространства, по определенным продуктам и меткам — нажмите **Все продукты** или **Все метки**, укажите необходимые значения и нажмите **Применить**.
