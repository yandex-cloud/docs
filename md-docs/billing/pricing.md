...
Валюта, которой можно оплачивать ресурсы, зависит от юридического лица, с которым пользователь заключил договор. Подробнее о регистрации аккаунта см. [{#T}](quickstart/index.md).
...
* [{{ ai-studio-full-name }}]({{ link-docs-ai }}ai-studio/pricing)
    * [Генерация текста в {{ gpt-lite }} или {{ gpt-pro }}]({{ link-docs-ai }}ai-studio/pricing#pricing-generating)
    * [Векторизация текста в {{ ai-studio-full-name }}]({{ link-docs-ai }}ai-studio/pricing#pricing-embedding)
    * [Генерация изображений c помощью {{ yandexart-name }}]({{ link-docs-ai }}ai-studio/pricing#pricing-image-generation)
