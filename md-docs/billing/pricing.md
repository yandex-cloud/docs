...
Валюта, которой можно оплачивать ресурсы, зависит от юридического лица, с которым пользователь заключил договор. Подробнее о регистрации аккаунта см. [Регистрация аккаунта в Yandex Cloud](quickstart/index.md).
...
Чтобы рассчитать стоимость использования сервисов, воспользуйтесь [калькулятором](https://yandex.cloud/ru/prices#calculator) на сайте Yandex Cloud или ознакомьтесь с [тарифами отдельных сервисов](#billable).

{% endnote %}


Цены на продукты сервисов также доступны в [Прайс-листе](https://yandex.cloud/ru/price-list?installationCode=ru).
...
* <code><b><small>Preview</small></b></code> [Yandex Cloud Notification Service](../notifications/pricing.md)
...
* [Yandex AI Studio](https://aistudio.yandex.ru/docs/ru/ai-studio/pricing)
    * [Генерация текста в YandexGPT Lite или YandexGPT Pro](https://aistudio.yandex.ru/docs/ru/ai-studio/pricing#pricing-generating)
    * [Векторизация текста в Yandex AI Studio](https://aistudio.yandex.ru/docs/ru/ai-studio/pricing#pricing-embedding)
    * [Генерация изображений c помощью YandexART](https://aistudio.yandex.ru/docs/ru/ai-studio/pricing#pricing-image-generation)
...
* [Yandex SpeechSense](../speechsense/pricing.md)
...
* <code><b><small>Preview</small></b></code> [Yandex Neurosupport](../neurosupport/pricing.md)
