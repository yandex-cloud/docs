...
- Резиденты Российской Федерации {#russia}
  ...
  * [скачивать документы в сервисе {{ billing-name }}](../operations/download-reporting-docs.md). 
  ...
  Акты сверки [формируются по запросу](../operations/download-reporting-docs.md), который можно оставить в сервисе {{ billing-name }}. После выполнения запроса документ будет доступен для скачивания.
