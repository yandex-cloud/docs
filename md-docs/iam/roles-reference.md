[Документация Yandex Cloud](../index.md) > [Yandex Identity and Access Management](index.md) > Справочник ролей
...
Роль `backup.viewer` позволяет просматривать информацию о защищаемых ресурсах, подключенных к сервису Cloud Backup, о политиках резервного копирования и резервных копиях, а также о квотах сервиса, облаке и каталоге.
...
Роль `backup.editor` позволяет управлять подключением защищаемых ресурсов к сервису Cloud Backup, управлять политиками резервного копирования, выполнять резервное копирование и восстанавливать защищаемые ресурсы из резервных копий.
...
* просматривать информацию о назначенных [правах доступа](concepts/access-control/index.md) к политикам резервного копирования;
* просматривать информацию о [подключенных](../backup/concepts/vm-connection/index.md) к Cloud Backup ресурсах, а также подключать и отключать ресурсы от сервиса;
...
Роль `backup.admin` позволяет управлять политиками резервного копирования и доступом к ним, управлять подключением защищаемых ресурсов к сервису Cloud Backup, выполнять резервное копирование и восстанавливать защищаемые ресурсы из резервных копий.
...
* просматривать информацию об инстансах [Yandex SIEM](../siem/concepts/index.md) и [YCDR](../ycdr/concepts/index.md).
...
Роль `cloud-registry.editor` позволяет управлять артефактами, реестрами и политиками жизненного цикла, а также просматривать информацию о назначенных правах доступа к реестрам и о квотах сервиса Cloud Registry.
...
Пользователи с этой ролью могут:
* просматривать информацию о назначенных [правах доступа](concepts/access-control/index.md) к [реестрам](../cloud-registry/concepts/registry.md), папкам внутри реестров и [артефактам](../cloud-registry/concepts/artifacts/index.md), а также изменять такие права доступа;
...
Роль `cloud-registry.artifacts.puller` позволяет скачивать [артефакты](../cloud-registry/concepts/artifacts/index.md), а также получать информацию об артефактах и [реестрах](../cloud-registry/concepts/registry.md) Cloud Registry.

#### cloud-registry.artifacts.pusher {#cloud-registry-artifacts-pusher}

Роль `cloud-registry.artifacts.pusher` позволяет управлять артефактами, а также просматривать информацию о реестрах Cloud Registry и управлять папками в них.
...
* просматривать логи, регистрируемые в инфраструктуре клиента, с помощью сервиса [Yandex Audit Trails](../audit-trails/index.md) для [модуля TD](../security-deck/concepts/threat-detector.md).

Роль выдается [сервисному аккаунту](concepts/users/service-accounts.md), от имени которого будет выполняться [сканирование](../security-deck/concepts/dspm.md#scanning) DSPM, проверка KSPM, CSPM или TD. Роль назначается на организацию, облако, каталог или (при использовании [модуля DSPM](../security-deck/concepts/dspm.md)) бакет.
...
* просматривать информацию о проверках инфраструктуры на соответствие [стандартам безопасности](../security-deck/concepts/cspm.md#standards), а также о заданиях таких проверок, указанных в настройках [модуля CSPM](../security-deck/concepts/cspm.md);
...
* просматривать результаты сканирования [модуля VM](../security-deck/concepts/vulnerability-management.md);
...
* просматривать информацию о заданиях сканирования [модуля VM](../security-deck/concepts/vulnerability-management.md) и результаты сканирования в рамках этих заданий;
* просматривать информацию о правилах контроля безопасности [модуля TD](../security-deck/concepts/threat-detector.md) и назначенных правах доступа к нему.
...
* просматривать информацию о проверках инфраструктуры на соответствие [стандартам безопасности](../security-deck/concepts/cspm.md#standards), заданным в настройках [модуля CSPM](../security-deck/concepts/cspm.md), а также удалять проверки;
...
* просматривать информацию о заданиях [сканирования](../security-deck/concepts/vulnerability-management.md#scanning) модуля Управление уязвимостями, а также редактировать такие задания;
* запускать задания сканирования [модуля Управление уязвимостями](../security-deck/concepts/vulnerability-management.md) и просматривать их результаты;
* просматривать информацию о правилах контроля безопасности [модуля TD](../security-deck/concepts/threat-detector.md), а также создавать исключения из правил контроля безопасности;
...
Роль `dspm.editor` позволяет использовать профили DSPM, управлять источниками данных и сканированием на наличие чувствительной информации. Роль не позволяет просматривать замаскированные и необработанные данные.
...
Роль `dspm.admin` позволяет использовать профили DSPM, управлять источниками данных и сканированием на наличие чувствительной информации, в том числе просматривать замаскированные и необработанные данные в результатах сканирования.
...
Роль `cspm.auditor` позволяет просматривать информацию о проверках инфраструктуры на соответствие [стандартам безопасности](../security-deck/concepts/cspm.md#standards), а также о заданиях таких проверок, указанных в настройках [модуля CSPM](../security-deck/concepts/cspm.md).
...
### Сервисные роли для модуля Обнаружение угроз (TD) {#td-roles}
...
Подробнее в [Управление доступом в TD](../security-deck/security/td-roles.md).

### Сервисные роли для модуля Управление уязвимостями (VM) {#vm-roles}
...
Подробнее в [Управление доступом в VM](../security-deck/security/vm-roles.md).
...
Подробнее в [Управление доступом в Yandex SIEM](../siem/security/index.md).
