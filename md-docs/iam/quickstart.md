...
- Консоль управления {#console}
    ...
    1. Чтобы отправить приглашения, нажмите **Далее**. Откроется окно для назначения ролей и добавления пользователей в группу.
    ...
    1. Чтобы назначить роли на ресурсы:
       ...
       1. Чтобы назначить роли на еще один ресурс, нажмите ![plus](../_assets/console-icons/plus.svg) **Добавить ресурс и роль** и повторите предыдущие шаги.
        ...
        Например, чтобы у пользователей был доступ к просмотру ресурсов облака в консоли управления, при назначении ролей выберите в поле **Ресурс** нужное облако и укажите роль `resource-manager.viewer`.

        Для управления каталогом, при назначении ролей выберите нужный каталог в поле **Ресурс** и укажите роль `resource-manager.editor`.
