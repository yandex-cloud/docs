...
* Запрос к API {{ yandex-cloud }} из [CI/CD](https://yandex.cloud/ru/blog/posts/2022/10/ci-cd) системы, такой как {{ GL }} или [{{ src-name }}]({{ link-src-docs }}/), для развертывания облачных сервисов с помощью [{{ TF }}](../../tutorials/infrastructure-management/terraform-quickstart.md).
