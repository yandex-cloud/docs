...
IAM-токены используются для аутентификации в сервисах Yandex Cloud и клиентов [Docker](../../../container-registry/operations/authentication.md) и [Helm](../../../container-registry/operations/helm-chart/helm-chart-push.md) в Yandex Container Registry.
...
Для работы с Terraform [добавьте IAM-токен в переменные окружения](../../../terraform/authentication.md) или укажите его в [конфигурационном файле с настройками провайдера](../../../tutorials/infrastructure-management/terraform-quickstart.md#configure-provider):
