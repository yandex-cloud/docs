...
* `yc.speech-sense.use` — для работы с [ресурсами](../../../speechsense/concepts/resources-hierarchy.md) SpeechSense через [API Yandex SpeechSense](../../../speechsense/api-ref/authentication.md).
...
* [Yandex SpeechSense](../../../speechsense/api-ref/authentication.md)
