[Документация Yandex Cloud](../../../index.md) > [Yandex Identity and Access Management](../../index.md) > [Концепции](../index.md) > Аутентификация > Как выбрать правильный способ аутентификации
