[Документация Yandex Cloud](../../../index.md) > [Yandex Identity and Access Management](../../index.md) > [Концепции](../index.md) > [Аутентификация](index.md) > OAuth-токен
...
Чтобы выбрать другой способ аутентификации, смотрите [Как выбрать подходящий способ аутентификации](index.md).
