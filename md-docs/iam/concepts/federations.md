...
С помощью [{{ org-full-name }}](../../organization/index.md) вы можете настроить Single Sign-On аутентификацию в {{ yandex-cloud }} через ваш Identity Provider, например Active Directory или Google Workspace. 
