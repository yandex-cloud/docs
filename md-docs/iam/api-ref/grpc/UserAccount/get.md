[Документация Yandex Cloud](../../../../index.md) > [Yandex Identity and Access Management](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [UserAccount](index.md) > Get
...
Currently represents only [Yandex account](../../../concepts/users/accounts.md#passport).
...
A YandexPassportUserAccount resource.
For more information, see [Yandex account](../../../concepts/users/accounts.md#passport).
...
A SAML federated user.
For more information, see [federations](../../../concepts/federations.md).
