[Документация Yandex Cloud](../../../../index.md) > [Yandex Identity and Access Management](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [OAuthClientSecret](index.md) > Create
...
To get the oauth client ID, use a [yandex.cloud.iam.v1.OAuthClientService.List](../OAuthClient/list.md#List) request.
