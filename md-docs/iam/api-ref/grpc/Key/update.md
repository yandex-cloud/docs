[Документация Yandex Cloud](../../../../index.md) > [Yandex Identity and Access Management](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Key](index.md) > Update
...
To get key pair ID, use a [KeyService.List](list.md#List) request.
