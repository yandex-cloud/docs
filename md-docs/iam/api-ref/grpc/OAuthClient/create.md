[Документация Yandex Cloud](../../../../index.md) > [Yandex Identity and Access Management](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [OAuthClient](index.md) > Create
...
**rpc Create ([CreateOAuthClientRequest](#yandex.cloud.iam.v1.CreateOAuthClientRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## CreateOAuthClientRequest {#yandex.cloud.iam.v1.CreateOAuthClientRequest}
