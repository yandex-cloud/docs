[Документация Yandex Cloud](../../../../index.md) > [Yandex Identity and Access Management](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [SubjectDetails](index.md) > BatchGet
...
**rpc BatchGet ([BatchGetSubjectsRequest](#yandex.cloud.iam.v1.BatchGetSubjectsRequest)) returns ([BatchGetSubjectsResponse](#yandex.cloud.iam.v1.BatchGetSubjectsResponse))**

## BatchGetSubjectsRequest {#yandex.cloud.iam.v1.BatchGetSubjectsRequest}
...
## BatchGetSubjectsResponse {#yandex.cloud.iam.v1.BatchGetSubjectsResponse}
