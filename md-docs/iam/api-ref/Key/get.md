[Документация Yandex Cloud](../../../index.md) > [Yandex Identity and Access Management](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Key](index.md) > Get
...
To get the ID use a [KeyService.List](list.md#List) request.
