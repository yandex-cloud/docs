[Документация Yandex Cloud](../../../index.md) > [Yandex Identity and Access Management](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [ApiKey](index.md) > ListScopes
...
```
GET https://iam.api.cloud.yandex.net/iam/v1/apiKeyScopes
```
