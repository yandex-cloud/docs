[Документация Yandex Cloud](../../../index.md) > [Yandex Identity and Access Management](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [ServiceAccount](index.md) > SetAccessBindings
...
Access bindings to be set. For more information, see [Access Bindings](../../concepts/access-control/index.md#access-bindings).
...
Required field. ID of the [yandex.cloud.iam.v1.Role](../Role/get.md#yandex.cloud.iam.v1.Role) that is assigned to the `subject`.
...
* `userAccount`: An account on Yandex ID. This type represents the [yandex.cloud.iam.v1.UserAccount](../UserAccount/get.md#yandex.cloud.iam.v1.UserAccount) resource.
* `serviceAccount`: A service account. This type represents the [yandex.cloud.iam.v1.ServiceAccount](get.md#yandex.cloud.iam.v1.ServiceAccount) resource.
