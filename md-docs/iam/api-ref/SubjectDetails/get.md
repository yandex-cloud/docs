[Документация Yandex Cloud](../../../index.md) > [Yandex Identity and Access Management](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [SubjectDetails](index.md) > Get

# Identity and Access Management API, REST: SubjectDetails.Get
...
```
GET https://iam.api.cloud.yandex.net/iam/v1/subjects/{subjectId}
```
...
## Query parameters {#yandex.cloud.iam.v1.GetSubjectRequest}
...
## Response {#yandex.cloud.iam.v1.GetSubjectResponse}
