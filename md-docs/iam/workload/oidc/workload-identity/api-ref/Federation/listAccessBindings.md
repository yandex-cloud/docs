[Документация Yandex Cloud](../../../../../../index.md) > [Yandex Identity and Access Management](../../../../../index.md) > Справочник API > REST (англ.) > Workload Identity > [Federation](../index.md) > [Federation](index.md) > ListAccessBindings

# Federation, REST: Federation.ListAccessBindings
...
```
GET https://iam.api.cloud.yandex.net/iam/v1/workload/oidc/federations/{resourceId}:listAccessBindings
```
