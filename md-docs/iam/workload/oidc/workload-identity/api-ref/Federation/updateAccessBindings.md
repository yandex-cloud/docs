[Документация Yandex Cloud](../../../../../../index.md) > [Yandex Identity and Access Management](../../../../../index.md) > Справочник API > REST (англ.) > Workload Identity > [Federation](../index.md) > [Federation](index.md) > UpdateAccessBindings
...
```
POST https://iam.api.cloud.yandex.net/iam/v1/workload/oidc/federations/{resourceId}:updateAccessBindings
```
...
Required field. Access binding. For more information, see [Access Bindings](../../../../../concepts/access-control/index.md#access-bindings). ||
|#
...
Required field. ID of the [yandex.cloud.iam.v1.Role](../../../../../api-ref/Role/get.md#yandex.cloud.iam.v1.Role) that is assigned to the `subject`.
...
* `group`: A group of users. This type represents the [yandex.cloud.organizationmanager.v1.Group](../../../../../../organization/api-ref/Group/get.md#yandex.cloud.organizationmanager.v1.Group) resource.
* `userAccount`: An account on Yandex ID. This type represents the [yandex.cloud.iam.v1.UserAccount](../../../../../api-ref/UserAccount/get.md#yandex.cloud.iam.v1.UserAccount) resource.
* `serviceAccount`: A service account. This type represents the [yandex.cloud.iam.v1.ServiceAccount](../../../../../api-ref/ServiceAccount/get.md#yandex.cloud.iam.v1.ServiceAccount) resource.
* `system`: System group. This type represents several accounts with a common system identifier.
For more information, see [Subject to which the role is assigned](../../../../../concepts/access-control/index.md#subject).
