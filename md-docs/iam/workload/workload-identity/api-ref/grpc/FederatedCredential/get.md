[Документация Yandex Cloud](../../../../../../index.md) > [Yandex Identity and Access Management](../../../../../index.md) > Справочник API > gRPC (англ.) > [Workload Identity](../index.md) > [FederatedCredential](index.md) > Get
