...
* Создавайте отдельные сервисные аккаунты для выполнения разных задач. Так вы сможете назначить им только те роли, которые необходимы. В любой момент вы сможете отозвать роли у сервисного аккаунта, [заблокировать](../operations/sa/suspend-reactivate.md#suspend) его или удалить, не затронув другие аккаунты.
