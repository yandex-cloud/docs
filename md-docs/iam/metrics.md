...
В этом разделе описаны метрики сервиса {{ iam-name }}, поставляемые в [{{ monitoring-name }}](../monitoring/index.md).
...
| key_id | Идентификатор [ключа](concepts/index.md#keys) |
| service_account | Идентификатор [сервисного аккаунта](concepts/users/service-accounts.md) |
