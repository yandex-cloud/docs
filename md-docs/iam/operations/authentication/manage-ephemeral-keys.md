[Документация Yandex Cloud](../../../index.md) > [Yandex Identity and Access Management](../../index.md) > [Пошаговые инструкции](../index.md) > [Аутентификация](index.md) > Управление эфемерными ключами доступа
...
- AWS CLI {#cli}
  ...
  Вы можете сохранить эфемерный ключ в файл с учетными данными AWS сразу после выпуска ключа. Подробнее в руководстве [Создайте эфемерный ключ доступа](../../../tutorials/security/ephemeral-key-storage.md#prepare-script).      
