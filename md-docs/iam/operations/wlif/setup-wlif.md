[Документация Yandex Cloud](../../../index.md) > [Yandex Identity and Access Management](../../index.md) > [Пошаговые инструкции](../index.md) > [Федерации сервисных аккаунтов](index.md) > Настройка федерации сервисных аккаунтов
