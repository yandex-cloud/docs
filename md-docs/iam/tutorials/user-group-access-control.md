...
В рамках настоящего руководства вы назначите группам пользователей несколько [ролей](../concepts/access-control/roles.md), соответствующих профилям деятельности сотрудников, которые будут входить в эти группы.
...
Сразу после того, как пользователи примут приглашения по ссылке из письма, они станут [участниками организации](../../organization/concepts/membership.md) и будут отображаться в разделе ![icon-users](../../_assets/console-icons/person.svg) **Пользователи** сервиса [Yandex Identity Hub](https://center.yandex.cloud/organization/users).
...
Обратите внимание, что виртуальные машины, кластеры, реестры, ключи, секреты и многие другие ресурсы, создаваемые в каталогах, тарифицируются. Подробнее о тарификации облачных ресурсов смотрите в [документации соответствующих сервисов](../../billing/pricing.md#billable).
...
Управлять созданной инфраструктурой рекомендуется от имени [сервисных аккаунтов](../concepts/users/service-accounts.md), которые могут использоваться для аутентификации программ. Сервисные аккаунты создаются в каталогах. Сервисные аккаунты также можно добавлять в группы пользователей.

При необходимости вы можете в любое время [назначить](../operations/roles/grant.md) дополнительные роли отдельным пользователям или сервисным аккаунтам как на всю организацию, так и на отдельные облака, каталоги или ресурсы.
