...
В этом руководстве вы настроите CI/CD между Cloud Functions и GitHub с помощью федерации сервисных аккаунтов [Yandex Identity and Access Management](../index.md) и развернете функции Cloud Functions через запуск [рабочих процессов](https://docs.github.com/ru/actions/concepts/workflows-and-actions/workflows) GitHub Actions.
...
От имени [сервисного аккаунта](../concepts/users/service-accounts.md) с [ролью](../../functions/security/index.md#functions-admin) `functions.admin` GitHub будет создавать функцию и ее версии.
