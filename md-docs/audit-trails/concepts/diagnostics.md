[Документация Yandex Cloud](../../index.md) > [Yandex Audit Trails](../index.md) > [Концепции](index.md) > Лог диагностики
...
* была изменена конфигурация [объекта назначения](trail.md#target), куда загружаются аудитные логи Audit Trails (удален бакет в Object Storage, лог группа Cloud Logging);
...
Всплески событий в аудитных логах могут быть связаны с временным прекращением записи. Например, при исчерпании [квот](limits.md) или ограничении пропускной способности события могут накапливаться в буфере Audit Trails. После устранения причин накопленные события доставляются в объект назначения, что может выглядеть как резкий всплеск активности.
