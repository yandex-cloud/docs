[Документация Yandex Cloud](../../../index.md) > [Yandex Audit Trails](../../index.md) > [Практические руководства](../index.md) > [Поиск событий в аудитных логах](index.md) > Примеры запросов для поиска событий
