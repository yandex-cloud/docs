[Документация Yandex Cloud](../../../index.md) > [Yandex Audit Trails](../../index.md) > [Практические руководства](../index.md) > [Поиск событий в аудитных логах](index.md) > Настройка работы с Yandex Query
...
Чтобы подключить бакет с [аудитными логами](../../concepts/events.md) к Yandex Query и выполнить запросы на языке [YQL](../../../query/yql-tutorials/index.md):
