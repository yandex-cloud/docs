[Документация Yandex Cloud](../../../index.md) > [Yandex Audit Trails](../../index.md) > [Практические руководства](../index.md) > Экспорт аудитных логов в SIEM > [Загрузка аудитных логов в SIEM KUMA](index.md) > Terraform
