...
В данном руководстве вы создадите [трейл](../../concepts/trail.md) {{ at-short-name }}, который будет передавать аудитные логи в коллектор [KUMA](https://www.kaspersky.ru/enterprise-security/unified-monitoring-and-analysis-platform).
