...
Создайте трейл, который будет загружать [аудитные логи](../concepts/format.md) ресурсов Yandex Cloud в поток данных [Yandex Data Streams](../../data-streams/index.md). Затем настройте непрерывную доставку логов в кластер Yandex Managed Service for OpenSearch с помощью Yandex Data Transfer.
