[Документация Yandex Cloud](../../index.md) > [Yandex Audit Trails](../index.md) > [Практические руководства](index.md) > Обработка аудитных логов Audit Trails
...
В этом сценарии вы создадите [трейлы](../concepts/trail.md), которые будут загружать аудитные логи всех ресурсов [каталога](../../resource-manager/concepts/resources-hierarchy.md#folder) в [бакет](../../storage/concepts/bucket.md) Object Storage, а также отправлять их в [поток](../../data-streams/concepts/glossary.md#stream-concepts) Data Streams. Далее вы выполните аналитический и потоковый запросы к данным логов с помощью Query.
...
[Создайте два трейла](../operations/create-trail.md):
...
1. Выберите созданный ранее трейл для загрузки аудитных логов облака в бакет и нажмите кнопку ![cube](../../_assets/console-icons/cube.svg) **Обработать в YQ**.
