...
- Интерфейс {{ cloud-center }} {#console}
  ...
  1. Нажмите кнопку ![plus](../../../_assets/console-icons/plus.svg) **{{ ui-key.yacloud_components.acl.action.add-role }}** и выберите [роль](../../security/index.md#at-viewer) `audit-trails.viewer`.
...
Подробнее о создании трейла см. в разделе [{#T}](../../operations/create-trail.md).
