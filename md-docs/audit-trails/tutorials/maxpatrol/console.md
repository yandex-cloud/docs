...
* использование потока данных (см. [тарифы Data Streams](../../../data-streams/pricing.md)).
...
Подробнее о создании трейла см. в разделе [Создание трейла для загрузки аудитных логов](../../operations/create-trail.md).
