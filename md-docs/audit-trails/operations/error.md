...
Ограничение скорости со стороны базы данных {{ ydb-short-name }}, что приводит к задержкам или сбоям при отправке данных по событиям. Ошибка может быть связана с недостаточным количеством партиций, исчерпанием квот и другими обстоятельствами. Причину ошибки исследуйте на стороне [базы данных](../../ydb/operations/monitoring.md). 
