[Документация Yandex Cloud](../../index.md) > [Yandex Audit Trails](../index.md) > [Пошаговые инструкции](index.md) > Просмотр операций с ресурсами сервиса

# Посмотреть операции с ресурсами сервиса Yandex Audit Trails

Все действия с ресурсами сервиса Audit Trails сохраняются в виде списка операций. Каждой операции присваивается уникальный идентификатор.
...
- Консоль управления {#console}
  ...
  1. Перейдите на вкладку **Операции** для выбранного трейла.
