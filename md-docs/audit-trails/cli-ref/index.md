[Документация Yandex Cloud](../../index.md) > [Yandex Audit Trails](../index.md) > Справочник CLI (англ.) > Overview

# yc audit-trails

Manage Audit Trails resources

Command tree v0 is the default. Run `yc audit-trails <command>` or `yc audit-trails v0 <command>`.
