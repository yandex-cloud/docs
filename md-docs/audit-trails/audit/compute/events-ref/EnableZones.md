[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > compute > EnableZones

# Compute Audit Trails Events: EnableZones

## Event JSON schema {#yandex.cloud.audit.compute.instancegroup.EnableZones2-schema}
...
## Field description {#yandex.cloud.audit.compute.instancegroup.EnableZones2}
...
|| details | **[EventDetails](#yandex.cloud.audit.compute.instancegroup.EnableZones.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.compute.instancegroup.EnableZones.EventDetails}
