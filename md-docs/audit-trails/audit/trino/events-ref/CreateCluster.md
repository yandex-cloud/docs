[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > trino > CreateCluster

# Managed Service for Trino Audit Trails Events: CreateCluster

## Event JSON schema {#yandex.cloud.audit.trino.CreateCluster2-schema}
...
## Field description {#yandex.cloud.audit.trino.CreateCluster2}
...
|| details | **[CreateClusterEventDetails](#yandex.cloud.audit.trino.CreateCluster.CreateClusterEventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## CreateClusterEventDetails {#yandex.cloud.audit.trino.CreateCluster.CreateClusterEventDetails}
