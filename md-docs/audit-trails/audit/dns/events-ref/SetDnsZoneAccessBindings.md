...
```json
{
  ...
  "details": {
    // Includes only one of the fields `dnsZoneId`
    "dnsZoneId": "string",
    // end of the list of possible fields
...
## Field description {#yandex.cloud.audit.dns.SetDnsZoneAccessBindings2}
...
|| details | **[EventDetails](#yandex.cloud.audit.dns.SetDnsZoneAccessBindings.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.dns.SetDnsZoneAccessBindings.EventDetails}
