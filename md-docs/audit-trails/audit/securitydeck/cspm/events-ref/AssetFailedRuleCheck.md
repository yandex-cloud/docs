[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > securitydeck.cspm > AssetFailedRuleCheck

# Security Deck CSPM Audit Trails Events: AssetFailedRuleCheck

## Event JSON schema {#yandex.cloud.audit.securitydeck.cspm.AssetFailedRuleCheck2-schema}
...
## Field description {#yandex.cloud.audit.securitydeck.cspm.AssetFailedRuleCheck2}
...
- `ERROR`
- `DONE` ||
|| details | **[AssetFailedRuleCheckEventDetails](#yandex.cloud.audit.securitydeck.cspm.AssetFailedRuleCheckEventDetails)** ||
|#
...
## AssetFailedRuleCheckEventDetails {#yandex.cloud.audit.securitydeck.cspm.AssetFailedRuleCheckEventDetails}
