[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > containerregistry > CreateScanPolicy

# Container Registry Audit Trails Events: CreateScanPolicy

## Event JSON schema {#yandex.cloud.audit.containerregistry.CreateScanPolicy2-schema}
...
## Field description {#yandex.cloud.audit.containerregistry.CreateScanPolicy2}
...
|| details | **[EventDetails](#yandex.cloud.audit.containerregistry.CreateScanPolicy.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.containerregistry.CreateScanPolicy.EventDetails}
