[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.clickhouse > DeleteClusterShards

# Managed Service for ClickHouse Audit Trails Events: DeleteClusterShards

## Event JSON schema {#yandex.cloud.audit.mdb.clickhouse.DeleteClusterShards2-schema}
...
## Field description {#yandex.cloud.audit.mdb.clickhouse.DeleteClusterShards2}
...
|| details | **[ShardsEventDetails](#yandex.cloud.audit.mdb.clickhouse.ShardsEventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## ShardsEventDetails {#yandex.cloud.audit.mdb.clickhouse.ShardsEventDetails}

#|
||Field | Description ||
|| clusterId | **string** ||
|| shardNames[] | **string** ||
|| shards | **[Shards](#yandex.cloud.mdb.clickhouse.v1.Shards)** ||
|| clusterName | **string** ||
|#
