[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.clickhouse > UpdateCluster

# Managed Service for ClickHouse Audit Trails Events: UpdateCluster

## Event JSON schema {#yandex.cloud.audit.mdb.clickhouse.UpdateCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.clickhouse.UpdateCluster2}
