[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.clickhouse > UpdateClusterShard

# Managed Service for ClickHouse Audit Trails Events: UpdateClusterShard

## Event JSON schema {#yandex.cloud.audit.mdb.clickhouse.UpdateClusterShard2-schema}
...
## Field description {#yandex.cloud.audit.mdb.clickhouse.UpdateClusterShard2}
