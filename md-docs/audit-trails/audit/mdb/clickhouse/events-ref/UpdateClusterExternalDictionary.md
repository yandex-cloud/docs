[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.clickhouse > UpdateClusterExternalDictionary

# Managed Service for ClickHouse Audit Trails Events: UpdateClusterExternalDictionary

## Event JSON schema {#yandex.cloud.audit.mdb.clickhouse.UpdateClusterExternalDictionary2-schema}
...
## Field description {#yandex.cloud.audit.mdb.clickhouse.UpdateClusterExternalDictionary2}
