[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.clickhouse > RestoreCluster

# Managed Service for ClickHouse Audit Trails Events: RestoreCluster

## Event JSON schema {#yandex.cloud.audit.mdb.clickhouse.RestoreCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.clickhouse.RestoreCluster2}
...
|| details | **[ClusterBackupEventDetails](#yandex.cloud.audit.mdb.clickhouse.ClusterBackupEventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## ClusterBackupEventDetails {#yandex.cloud.audit.mdb.clickhouse.ClusterBackupEventDetails}
...
|| backup | **[Backup](#yandex.cloud.mdb.clickhouse.v1.Backup)** ||
|#
