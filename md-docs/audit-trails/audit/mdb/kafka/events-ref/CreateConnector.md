[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.kafka > CreateConnector

# Managed Service for Apache Kafka® Audit Trails Events: CreateConnector

## Event JSON schema {#yandex.cloud.audit.mdb.kafka.CreateConnector2-schema}
...
## Field description {#yandex.cloud.audit.mdb.kafka.CreateConnector2}
