[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.kafka > RescheduleMaintenance

# Managed Service for Apache Kafka® Audit Trails Events: RescheduleMaintenance

## Event JSON schema {#yandex.cloud.audit.mdb.kafka.RescheduleMaintenance2-schema}
...
## Field description {#yandex.cloud.audit.mdb.kafka.RescheduleMaintenance2}
