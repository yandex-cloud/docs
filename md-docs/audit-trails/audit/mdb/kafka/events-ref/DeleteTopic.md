[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.kafka > DeleteTopic

# Managed Service for Apache Kafka® Audit Trails Events: DeleteTopic

## Event JSON schema {#yandex.cloud.audit.mdb.kafka.DeleteTopic2-schema}
...
## Field description {#yandex.cloud.audit.mdb.kafka.DeleteTopic2}
