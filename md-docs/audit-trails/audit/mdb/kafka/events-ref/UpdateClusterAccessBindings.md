[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.kafka > UpdateClusterAccessBindings

# Managed Service for Apache Kafka® Audit Trails Events: UpdateClusterAccessBindings

## Event JSON schema {#yandex.cloud.audit.mdb.kafka.UpdateClusterAccessBindings2-schema}
...
## Field description {#yandex.cloud.audit.mdb.kafka.UpdateClusterAccessBindings2}
