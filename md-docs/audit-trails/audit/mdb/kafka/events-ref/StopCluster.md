[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.kafka > StopCluster

# Managed Service for Apache Kafka® Audit Trails Events: StopCluster

## Event JSON schema {#yandex.cloud.audit.mdb.kafka.StopCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.kafka.StopCluster2}
