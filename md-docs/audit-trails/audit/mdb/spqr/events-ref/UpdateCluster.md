[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.spqr > UpdateCluster

# Managed Service for SPQR Audit Trails Events: UpdateCluster

## Event JSON schema {#yandex.cloud.audit.mdb.spqr.UpdateCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.spqr.UpdateCluster2}
