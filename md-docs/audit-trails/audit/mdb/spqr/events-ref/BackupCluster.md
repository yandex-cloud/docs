[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.spqr > BackupCluster

# Managed Service for SPQR Audit Trails Events: BackupCluster

## Event JSON schema {#yandex.cloud.audit.mdb.spqr.BackupCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.spqr.BackupCluster2}
...
|| details | **[ClusterBackupEventDetails](#yandex.cloud.audit.mdb.spqr.ClusterBackupEventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## ClusterBackupEventDetails {#yandex.cloud.audit.mdb.spqr.ClusterBackupEventDetails}
...
|| backupId | **string** ||
|| backup | **[Backup](#yandex.cloud.mdb.spqr.v1.Backup)** ||
|| description | **string** ||
