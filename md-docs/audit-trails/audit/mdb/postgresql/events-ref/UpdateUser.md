[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.postgresql > UpdateUser

# Managed Service for PostgreSQL Audit Trails Events: UpdateUser

## Event JSON schema {#yandex.cloud.audit.mdb.postgresql.UpdateUser2-schema}
...
## Field description {#yandex.cloud.audit.mdb.postgresql.UpdateUser2}
