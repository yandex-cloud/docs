[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.postgresql > RevokeUserPermission

# Managed Service for PostgreSQL Audit Trails Events: RevokeUserPermission

## Event JSON schema {#yandex.cloud.audit.mdb.postgresql.RevokeUserPermission2-schema}
...
## Field description {#yandex.cloud.audit.mdb.postgresql.RevokeUserPermission2}
...
|| details | **[UserEventDetails](#yandex.cloud.audit.mdb.postgresql.UserEventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## UserEventDetails {#yandex.cloud.audit.mdb.postgresql.UserEventDetails}
...
|| userName | **string** ||
|| clusterName | **string** ||
|| user | **[User](#yandex.cloud.mdb.postgresql.v1.User)** ||
|#
