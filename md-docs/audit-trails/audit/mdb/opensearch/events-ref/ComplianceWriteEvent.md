...
```json
{
  ...
  "details": {
    ...
    "auditComplianceDocVersion": "string",
    "auditComplianceOperation": "string",
    "auditComplianceDiffIsNoop": "boolean",
    "auditComplianceDiffContent": "string"
  },
...
## Field description {#yandex.cloud.audit.mdb.opensearch.ComplianceWriteEvent2}
...
|| details | **[ComplianceWriteEventDetails](#yandex.cloud.audit.mdb.opensearch.ComplianceWriteEventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## ComplianceWriteEventDetails {#yandex.cloud.audit.mdb.opensearch.ComplianceWriteEventDetails}
...
|| auditComplianceDocVersion | **string** (int64) ||
|| auditComplianceOperation | **string** ||
|| auditComplianceDiffIsNoop | **boolean** ||
|| auditComplianceDiffContent | **string** ||
|#