[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.opensearch > CreateCluster

# Managed Service for OpenSearch Audit Trails Events: CreateCluster

## Event JSON schema {#yandex.cloud.audit.mdb.opensearch.CreateCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.opensearch.CreateCluster2}
...
|| details | **[ClusterCreateEventDetails](#yandex.cloud.audit.mdb.opensearch.ClusterCreateEventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## ClusterCreateEventDetails {#yandex.cloud.audit.mdb.opensearch.ClusterCreateEventDetails}
...
|| hosts[] | **[HostDetails](#yandex.cloud.audit.mdb.opensearch.HostDetails)** ||
|#
