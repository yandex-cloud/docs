[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.opensearch > MoveCluster

# Managed Service for OpenSearch Audit Trails Events: MoveCluster

## Event JSON schema {#yandex.cloud.audit.mdb.opensearch.MoveCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.opensearch.MoveCluster2}
