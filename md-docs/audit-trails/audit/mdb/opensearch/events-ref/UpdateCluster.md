[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.opensearch > UpdateCluster

# Managed Service for OpenSearch Audit Trails Events: UpdateCluster

## Event JSON schema {#yandex.cloud.audit.mdb.opensearch.UpdateCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.opensearch.UpdateCluster2}
...
|| details | **[ClusterEventDetails](#yandex.cloud.audit.mdb.opensearch.ClusterEventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## ClusterEventDetails {#yandex.cloud.audit.mdb.opensearch.ClusterEventDetails}
