[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.opensearch > FailedLoginRestEvent

# Managed Service for OpenSearch Audit Trails Events: FailedLoginRestEvent

## Event JSON schema {#yandex.cloud.audit.mdb.opensearch.FailedLoginRestEvent2-schema}
...
## Field description {#yandex.cloud.audit.mdb.opensearch.FailedLoginRestEvent2}
