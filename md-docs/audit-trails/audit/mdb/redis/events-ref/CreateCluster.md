[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.redis > CreateCluster

# Managed Service for ValKey Audit Trails Events: CreateCluster

## Event JSON schema {#yandex.cloud.audit.mdb.redis.CreateCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.redis.CreateCluster2}
...
|| details | **[ClusterCreateEventDetails](#yandex.cloud.audit.mdb.redis.ClusterCreateEventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## ClusterCreateEventDetails {#yandex.cloud.audit.mdb.redis.ClusterCreateEventDetails}
...
## HostDetails {#yandex.cloud.audit.mdb.redis.HostDetails}
