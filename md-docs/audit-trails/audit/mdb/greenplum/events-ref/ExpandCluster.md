[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.greenplum > ExpandCluster

# Managed Service for Greenplum® Audit Trails Events: ExpandCluster

## Event JSON schema {#yandex.cloud.audit.mdb.greenplum.ExpandCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.greenplum.ExpandCluster2}
