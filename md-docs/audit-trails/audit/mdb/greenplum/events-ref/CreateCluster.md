[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.greenplum > CreateCluster

# Managed Service for Greenplum® Audit Trails Events: CreateCluster

## Event JSON schema {#yandex.cloud.audit.mdb.greenplum.CreateCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.greenplum.CreateCluster2}
...
|| details | **[ClusterCreateEventDetails](#yandex.cloud.audit.mdb.greenplum.ClusterCreateEventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## ClusterCreateEventDetails {#yandex.cloud.audit.mdb.greenplum.ClusterCreateEventDetails}
...
|| hosts[] | **[HostDetails](#yandex.cloud.audit.mdb.greenplum.HostDetails)** ||
|#
...
## HostDetails {#yandex.cloud.audit.mdb.greenplum.HostDetails}
