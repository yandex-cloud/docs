[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > mdb.mysql > StartCluster

# Managed Service for MySQL Audit Trails Events: StartCluster

## Event JSON schema {#yandex.cloud.audit.mdb.mysql.StartCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.mysql.StartCluster2}
