[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > serverless > UpdateTrigger

# Cloud Functions Audit Trails Events: UpdateTrigger

## Event JSON schema {#yandex.cloud.audit.serverless.triggers.UpdateTrigger2-schema}
...
## Field description {#yandex.cloud.audit.serverless.triggers.UpdateTrigger2}
