...
# Cloud Functions Audit Trails Events: SetWorkflowAccessBindings

## Event JSON schema {#yandex.cloud.audit.serverless.workflows.SetWorkflowAccessBindings2-schema}
...
## Field description {#yandex.cloud.audit.serverless.workflows.SetWorkflowAccessBindings2}
...
|| details | **[EventDetails](#yandex.cloud.audit.serverless.workflows.SetWorkflowAccessBindings.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.serverless.workflows.SetWorkflowAccessBindings.EventDetails}
