[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > metastore > StopCluster

# Managed Service for Hive Metastore™ Audit Trails Events: StopCluster

## Event JSON schema {#yandex.cloud.audit.metastore.StopCluster2-schema}
...
## Field description {#yandex.cloud.audit.metastore.StopCluster2}
