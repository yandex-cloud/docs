[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > metastore > CreateCluster

# Managed Service for Hive Metastore™ Audit Trails Events: CreateCluster

## Event JSON schema {#yandex.cloud.audit.metastore.CreateCluster2-schema}
...
## Field description {#yandex.cloud.audit.metastore.CreateCluster2}
