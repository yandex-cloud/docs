[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > apploadbalancer > DeleteHttpRouter
...
## Field description {#yandex.cloud.audit.apploadbalancer.DeleteHttpRouter2}
...
|| details | **[EventDetails](#yandex.cloud.audit.apploadbalancer.DeleteHttpRouter.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.apploadbalancer.DeleteHttpRouter.EventDetails}
