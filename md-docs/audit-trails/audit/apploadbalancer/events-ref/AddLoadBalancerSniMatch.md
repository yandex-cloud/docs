[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > apploadbalancer > AddLoadBalancerSniMatch

# Application Load Balancer Audit Trails Events: AddLoadBalancerSniMatch

## Event JSON schema {#yandex.cloud.audit.apploadbalancer.AddLoadBalancerSniMatch2-schema}
...
## Field description {#yandex.cloud.audit.apploadbalancer.AddLoadBalancerSniMatch2}
...
|| details | **[EventDetails](#yandex.cloud.audit.apploadbalancer.AddLoadBalancerSniMatch.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.apploadbalancer.AddLoadBalancerSniMatch.EventDetails}
