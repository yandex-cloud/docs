[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > apploadbalancer > AddBackendGroupBackend
...
## Field description {#yandex.cloud.audit.apploadbalancer.AddBackendGroupBackend2}
...
|| details | **[EventDetails](#yandex.cloud.audit.apploadbalancer.AddBackendGroupBackend.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.apploadbalancer.AddBackendGroupBackend.EventDetails}
