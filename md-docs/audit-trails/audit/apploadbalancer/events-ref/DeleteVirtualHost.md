[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > apploadbalancer > DeleteVirtualHost
...
## Field description {#yandex.cloud.audit.apploadbalancer.DeleteVirtualHost2}
...
|| details | **[EventDetails](#yandex.cloud.audit.apploadbalancer.DeleteVirtualHost.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.apploadbalancer.DeleteVirtualHost.EventDetails}
