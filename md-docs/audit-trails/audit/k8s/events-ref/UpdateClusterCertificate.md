[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > k8s > UpdateClusterCertificate

# Managed Services for Kubernetes Audit Trails Events: UpdateClusterCertificate

## Event JSON schema {#yandex.cloud.audit.k8s.UpdateClusterCertificate2-schema}
...
## Field description {#yandex.cloud.audit.k8s.UpdateClusterCertificate2}
