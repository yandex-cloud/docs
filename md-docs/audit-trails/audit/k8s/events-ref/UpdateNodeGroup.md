[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > k8s > UpdateNodeGroup

# Managed Services for Kubernetes Audit Trails Events: UpdateNodeGroup

## Event JSON schema {#yandex.cloud.audit.k8s.UpdateNodeGroup2-schema}
...
## Field description {#yandex.cloud.audit.k8s.UpdateNodeGroup2}
