[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > k8s > ScaleMaster

# Managed Services for Kubernetes Audit Trails Events: ScaleMaster

## Event JSON schema {#yandex.cloud.audit.k8s.ScaleMaster2-schema}
...
## Field description {#yandex.cloud.audit.k8s.ScaleMaster2}
