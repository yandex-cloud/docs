[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > k8s > ApiServerUpdate

# Managed Services for Kubernetes Audit Trails Events: ApiServerUpdate

## Event JSON schema {#yandex.cloud.audit.k8s.apiserver.ApiServerUpdate2-schema}
...
## Field description {#yandex.cloud.audit.k8s.apiserver.ApiServerUpdate2}
