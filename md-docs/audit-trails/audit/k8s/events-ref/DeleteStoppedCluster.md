[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > k8s > DeleteStoppedCluster

# Managed Services for Kubernetes Audit Trails Events: DeleteStoppedCluster

## Event JSON schema {#yandex.cloud.audit.k8s.DeleteStoppedCluster2-schema}
...
## Field description {#yandex.cloud.audit.k8s.DeleteStoppedCluster2}
