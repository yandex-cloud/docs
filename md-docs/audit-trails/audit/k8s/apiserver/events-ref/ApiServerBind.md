[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > k8s > apiserver.ApiServerBind

# Managed Services for Kubernetes Audit Trails Events: ApiServerBind

## Event JSON schema {#yandex.cloud.audit.k8s.apiserver.ApiServerBind2-schema}
...
## Field description {#yandex.cloud.audit.k8s.apiserver.ApiServerBind2}
