[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > k8s > apiserver.ApiServerApprove

# Managed Services for Kubernetes Audit Trails Events: ApiServerApprove

## Event JSON schema {#yandex.cloud.audit.k8s.apiserver.ApiServerApprove2-schema}
...
## Field description {#yandex.cloud.audit.k8s.apiserver.ApiServerApprove2}
