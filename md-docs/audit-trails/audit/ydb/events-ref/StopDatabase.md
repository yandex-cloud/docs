[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > ydb > StopDatabase

# Managed Service for YDB Audit Trails Events: StopDatabase

## Event JSON schema {#yandex.cloud.audit.ydb.StopDatabase2-schema}
...
## Field description {#yandex.cloud.audit.ydb.StopDatabase2}
...
|| details | **[EventDetails](#yandex.cloud.audit.ydb.StopDatabase.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.ydb.StopDatabase.EventDetails}
