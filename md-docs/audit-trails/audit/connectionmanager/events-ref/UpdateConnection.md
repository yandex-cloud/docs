[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > connectionmanager > UpdateConnection

# Connection Manager Audit Trails Events: UpdateConnection

## Event JSON schema {#yandex.cloud.audit.connectionmanager.UpdateConnection2-schema}
...
## Field description {#yandex.cloud.audit.connectionmanager.UpdateConnection2}
