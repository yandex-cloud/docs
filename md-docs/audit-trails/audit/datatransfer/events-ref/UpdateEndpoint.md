[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > datatransfer > UpdateEndpoint

# Data Transfer Audit Trails Events: UpdateEndpoint

## Event JSON schema {#yandex.cloud.audit.datatransfer.UpdateEndpoint2-schema}
...
## Field description {#yandex.cloud.audit.datatransfer.UpdateEndpoint2}
...
|| details | **[EndpointEventDetails](#yandex.cloud.audit.datatransfer.EndpointEventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EndpointEventDetails {#yandex.cloud.audit.datatransfer.EndpointEventDetails}
...
|| endpointName | **string** ||
|| endpoint | **[Endpoint](#yandex.cloud.datatransfer.v1.Endpoint)** ||
|#
