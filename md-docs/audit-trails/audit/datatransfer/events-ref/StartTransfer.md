[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > datatransfer > StartTransfer

# Data Transfer Audit Trails Events: StartTransfer

## Event JSON schema {#yandex.cloud.audit.datatransfer.StartTransfer2-schema}
...
## Field description {#yandex.cloud.audit.datatransfer.StartTransfer2}
