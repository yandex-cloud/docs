[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > datatransfer > RemoveTablesFromTransfer

# Data Transfer Audit Trails Events: RemoveTablesFromTransfer

## Event JSON schema {#yandex.cloud.audit.datatransfer.RemoveTablesFromTransfer2-schema}
...
## Field description {#yandex.cloud.audit.datatransfer.RemoveTablesFromTransfer2}
