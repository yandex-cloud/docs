[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > dataproc > UpdateSubcluster

# Yandex Data Processing Audit Trails Events: UpdateSubcluster

## Event JSON schema {#yandex.cloud.audit.dataproc.UpdateSubcluster2-schema}
...
## Field description {#yandex.cloud.audit.dataproc.UpdateSubcluster2}
...
|| details | **[SubclusterDetails](#yandex.cloud.audit.dataproc.SubclusterDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## SubclusterDetails {#yandex.cloud.audit.dataproc.SubclusterDetails}

#|
||Field | Description ||
|| subclusterId | **string** ||
|| clusterId | **string** ||
|| subcluster | **[Subcluster](#yandex.cloud.dataproc.v1.Subcluster)** ||
|#
