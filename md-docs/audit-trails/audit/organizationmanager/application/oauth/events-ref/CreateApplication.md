[Документация Yandex Cloud](../../../../../../index.md) > [Yandex Audit Trails](../../../../../index.md) > Справочник аудитных логов (англ.) > organizationmanager > application.oauth.CreateApplication

# Identity Hub Audit Trails Events: CreateApplication

## Event JSON schema {#yandex.cloud.audit.organizationmanager.application.oauth.CreateApplication2-schema}
...
## Field description {#yandex.cloud.audit.organizationmanager.application.oauth.CreateApplication2}
