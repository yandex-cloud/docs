[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > organizationmanager > idp.DeleteUserpool

# Identity Hub Audit Trails Events: DeleteUserpool

## Event JSON schema {#yandex.cloud.audit.organizationmanager.idp.DeleteUserpool2-schema}
...
## Field description {#yandex.cloud.audit.organizationmanager.idp.DeleteUserpool2}
