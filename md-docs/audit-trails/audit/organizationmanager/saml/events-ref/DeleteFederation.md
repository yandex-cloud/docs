[Документация Yandex Cloud](../../../../../index.md) > [Yandex Audit Trails](../../../../index.md) > Справочник аудитных логов (англ.) > organizationmanager > saml.DeleteFederation
...
## Field description {#yandex.cloud.audit.organizationmanager.saml.DeleteFederation2}
...
|| details | **[EventDetails](#yandex.cloud.audit.organizationmanager.saml.DeleteFederation.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.organizationmanager.saml.DeleteFederation.EventDetails}
