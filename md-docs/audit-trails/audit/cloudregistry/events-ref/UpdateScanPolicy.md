[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > cloudregistry > UpdateScanPolicy

# Yandex Cloud Registry Audit Trails Events: UpdateScanPolicy

## Event JSON schema {#yandex.cloud.audit.cloudregistry.UpdateScanPolicy2-schema}
...
## Field description {#yandex.cloud.audit.cloudregistry.UpdateScanPolicy2}
...
|| details | **[EventDetails](#yandex.cloud.audit.cloudregistry.UpdateScanPolicy.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.cloudregistry.UpdateScanPolicy.EventDetails}
