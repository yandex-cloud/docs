[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > cloudregistry > CreateLifecyclePolicy

# Yandex Cloud Registry Audit Trails Events: CreateLifecyclePolicy

## Event JSON schema {#yandex.cloud.audit.cloudregistry.CreateLifecyclePolicy2-schema}
...
## Field description {#yandex.cloud.audit.cloudregistry.CreateLifecyclePolicy2}
...
|| details | **[EventDetails](#yandex.cloud.audit.cloudregistry.CreateLifecyclePolicy.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.cloudregistry.CreateLifecyclePolicy.EventDetails}
