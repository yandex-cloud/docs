[Документация Yandex Cloud](../../../../index.md) > [Yandex Audit Trails](../../../index.md) > Справочник аудитных логов (англ.) > cloudregistry > DeleteLifecyclePolicy

# Yandex Cloud Registry Audit Trails Events: DeleteLifecyclePolicy

## Event JSON schema {#yandex.cloud.audit.cloudregistry.DeleteLifecyclePolicy2-schema}
...
## Field description {#yandex.cloud.audit.cloudregistry.DeleteLifecyclePolicy2}
...
|| details | **[EventDetails](#yandex.cloud.audit.cloudregistry.DeleteLifecyclePolicy.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.cloudregistry.DeleteLifecyclePolicy.EventDetails}
