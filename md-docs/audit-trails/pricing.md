[Документация Yandex Cloud](../index.md) > [Yandex Audit Trails](index.md) > Правила тарификации
...
| -------------------------------------------------- | ----------------- | ---------------- | -------------- | ------------ |
| Audit Trails. Доставка событий уровня конфигурации | Не тарифицируется | 100 тыс. событий | 13 июля 2023   | —            |
| Audit Trails. Доставка событий уровня сервисов     | 39,52 ₽           | 100 тыс. событий | 30 апреля 2026 | —            |
