[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for MySQL®](../index.md) > [Пошаговые инструкции](index.md) > Кластеры > Миграция хостов в другую зону доступности

# Миграция хостов кластера MySQL® в другую зону доступности


Хосты кластера Managed Service for MySQL® располагаются в [зонах доступности](../../overview/concepts/geo-scope.md) Yandex Cloud.  Чтобы перенести хосты из одной зоны в другую:
