[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for MySQL®](../index.md) > [Пошаговые инструкции](index.md) > Логи и мониторинг > Диагностика производительности
...
1. Нажмите на имя нужного кластера и выберите вкладку ![chevron-down](../../_assets/console-icons/chevron-down.svg) **Другое** → **Диагностика производительности** → **Сессии**.
...
1. [Перейдите](https://console.yandex.cloud/link/managed-mysql) в сервис **Managed Service for&nbsp;MySQL**.
1. Нажмите на имя нужного кластера и выберите вкладку ![chevron-down](../../_assets/console-icons/chevron-down.svg) **Другое** → **Диагностика производительности** → **Запросы**.
...
Подробнее про отображаемые сведения смотрите в [документации MySQL®](https://dev.mysql.com/doc/refman/8.0/en/performance-schema-events-statements-current-table.html).