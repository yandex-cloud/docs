...
- {{ TF }} {#tf}
  ...
  1. Опишите в конфигурационном файле параметры ресурсов, которые необходимо создать:
     ...
     * Чтобы разрешить [доступ из {{ datalens-name }}](datalens-connect.md) и [выполнение SQL-запросов из консоли управления](web-sql-query.md) с помощью {{ websql-full-name }}, добавьте к описанию кластера блок `access`:
