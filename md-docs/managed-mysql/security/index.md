...
Роль `managed-mysql.clusters.connector` позволяет [пользователям](../../iam/concepts/users/accounts.md) {{ yandex-cloud }} подключаться к базам данных в [кластерах {{ MY }}](../concepts/index.md) с помощью механизмов сервиса [{{ iam-full-name }}](../../iam/index.md).

#### managed-mysql.auditor {#managed-mysql-auditor}

Роль `managed-mysql.auditor` позволяет просматривать информацию о [кластерах {{ MY }}](../concepts/index.md) и назначенных [правах доступа](../../iam/concepts/access-control/index.md) к ним, о [хостах](../concepts/instance-types.md) и [резервных копиях](../concepts/backup.md) кластеров, а также о [квотах](../concepts/limits.md#mmy-quotas) и операциях с ресурсами сервиса {{ mmy-name }}.
...
* просматривать информацию о [кластерах](../concepts/index.md) {{ MY }} и назначенных [правах доступа](../../iam/concepts/access-control/index.md) к ним;
* просматривать информацию о заданиях на [техническое обслуживание](../concepts/maintenance.md) кластеров {{ MY }};
* просматривать информацию о [хостах](../concepts/instance-types.md) кластеров {{ MY }};
* просматривать информацию о базах данных {{ MY }};
* просматривать информацию о [пользователях](../concepts/user-rights.md) {{ MY }};
* просматривать информацию о [резервных копиях](../concepts/backup.md) кластеров {{ MY }};
...
* просматривать информацию о [квотах](../concepts/limits.md#mmy-quotas) сервиса {{ mmy-name }};
...
Пользователи с этой ролью могут:
* просматривать информацию о резервных копиях [кластеров](../concepts/index.md) {{ MY }} и восстанавливать кластеры из [резервных копий](../concepts/backup.md);
...
Роль `managed-mysql.user` позволяет использовать [кластеры {{ MY }}](../concepts/index.md).
...
Пользователи с этой ролью могут:
* переназначать хост-мастер в [кластерах {{ MY }}](../concepts/index.md);
* просматривать информацию о кластерах {{ MY }} и назначенных [правах доступа](../../iam/concepts/access-control/index.md) к ним;
* просматривать информацию о заданиях на [техническое обслуживание](../concepts/maintenance.md) кластеров {{ MY }};
* просматривать информацию о [хостах](../concepts/instance-types.md) кластеров {{ MY }};
* просматривать информацию о базах данных {{ MY }};
...
Пользователи с этой ролью могут:
* просматривать информацию о [кластерах](../concepts/index.md) {{ MY }}, а также создавать, использовать, изменять, удалять, запускать и останавливать их;
* просматривать информацию о назначенных [правах доступа](../../iam/concepts/access-control/index.md) к кластерам {{ MY }};
* просматривать информацию о заданиях на [техническое обслуживание](../concepts/maintenance.md) кластеров {{ MY }} и изменять такие задания;
* просматривать информацию о [хостах](../concepts/instance-types.md) кластеров {{ MY }}, а также создавать, изменять и удалять их;
...
* просматривать информацию о [пользователях](../concepts/user-rights.md) {{ MY }}, а также создавать, изменять и удалять их;
* просматривать информацию о [резервных копиях](../concepts/backup.md) кластеров {{ MY }}, создавать и удалять резервные копии, а также восстанавливать кластеры из резервных копий;
...
Пользователи с этой ролью могут:
* просматривать информацию о назначенных [правах доступа](../../iam/concepts/access-control/index.md) к [кластерам {{ MY }}](../concepts/index.md) и изменять такие права доступа;
...
Роль `managed-mysql.maintenanceTask.viewer` позволяет просматривать информацию о заданиях на [техническое обслуживание](../concepts/maintenance.md) кластеров {{ MY }}, а также о таких [кластерах](../concepts/index.md) и назначенных [правах доступа](../../iam/concepts/access-control/index.md) к ним, о [хостах](../concepts/instance-types.md) и [резервных копиях](../concepts/backup.md) кластеров, о [квотах](../concepts/limits.md#mmy-quotas) и операциях с ресурсами сервиса {{ mmy-name }}.
...
Роль `managed-mysql.maintenanceTask.editor` позволяет просматривать информацию о заданиях на [техническое обслуживание](../concepts/maintenance.md) кластеров {{ MY }} и изменять такие задания, просматривать информацию о [кластерах {{ MY }}](../concepts/index.md) и назначенных [правах доступа](../../iam/concepts/access-control/index.md) к ним, о [хостах](../concepts/instance-types.md) и [резервных копиях](../concepts/backup.md) кластеров, а также о [квотах](../concepts/limits.md#mmy-quotas) и операциях с ресурсами сервиса {{ mmy-name }}.
