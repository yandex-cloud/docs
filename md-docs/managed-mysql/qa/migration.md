...
Воспользуйтесь инструкцией в разделе [{#T}](../tutorials/data-migration/index.md).
...
* В другое облако — воспользуйтесь инструкцией в разделе [{#T}](../tutorials/data-migration/index.md).
