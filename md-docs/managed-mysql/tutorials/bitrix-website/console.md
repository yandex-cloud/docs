[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for MySQL®](../../index.md) > [Практические руководства](../index.md) > [Создание сайта на базе «1С-Битрикс»](index.md) > Консоль управления
...
- Консоль управления {#console}
  ...
  1. В сети `network-1` [создайте группы безопасности](../../../vpc/operations/security-group-create.md):
     ...
     1. С именем `bitrix-sg` для кластера баз данных MySQL®. [Задайте правила](../../../vpc/operations/security-group-add-rule.md) для этой группы безопасности в соответствии с таблицей:
        ...
        --- | --- | --- | --- | --- | ---
        Исходящий | `ANY` | `Весь` | `Любой` | `Префикс` | `0.0.0.0/0`
        Входящий | `EXT-HTTPS` | `3306` | `TCP` | `Префикс` | `0.0.0.0/0`
...
- Консоль управления {#console}
  ...
  1. В блоке **Диски и файловые хранилища** выберите [тип диска](../../../compute/concepts/disk.md#disks-types) `SSD` и задайте размер `24 ГБ`.
