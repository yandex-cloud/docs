[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for MySQL®](../index.md) > [Практические руководства](index.md) > Выгрузка базы данных в Yandex Data Processing
...
1. [Создайте кластер Managed Service for MySQL®](../operations/cluster-create.md) любой подходящей вам [конфигурации](../concepts/instance-types.md) со следующими настройками:
...
1. Если вы используете группы безопасности для кластеров и виртуальной машины, настройте их так, чтобы разрешить подключение:
    ...
    * [к кластеру Managed Service for MySQL®](../operations/connect/index.md#configure-security-groups).
...
1. [Подключитесь к базе данных](../operations/connect/index.md) `db1` кластера Yandex Managed Service for MySQL® от имени пользователя `user1`.
