[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for MySQL®](../../index.md) > [Практические руководства](../index.md) > [Интернет-магазин на платформе OpenCart](index.md) > Консоль управления
...
* Кластер Managed Service for MySQL®, если он создан для поддержки и обслуживания СУБД: выделенные хостам вычислительные ресурсы, объем хранилища и резервных копий ([тарифы Managed Service for MySQL®](../../pricing.md)).
...
- Консоль управления
  ...
  1. В блоке **Диски и файловые хранилища** настройте загрузочный [диск](../../../compute/concepts/disk.md):
      ...
      * Выберите [тип диска](../../../compute/concepts/disk.md#disks-types) `SSD`.
