...
1. Перейдите в сервис **{{ ui-key.yacloud.iam.folder.dashboard.label_managed-mysql }}** и нажмите **Создать кластер**.
...
Подробнее о создании кластера см. раздел [Как начать работать с {{ mmy-short-name }}](../quickstart.md#cluster-create.md).
...
1. Перейдите в сервис **{{ ui-key.yacloud.iam.folder.dashboard.label_data-transfer }}** и нажмите **Создать эндпоинт**.
