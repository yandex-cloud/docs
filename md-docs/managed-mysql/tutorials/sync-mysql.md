[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for MySQL®](../index.md) > [Практические руководства](index.md) > Синхронизация данных из стороннего кластера MySQL® в Yandex Managed Service for MySQL® с помощью Yandex Data Transfer
...
1. [Перейдите](https://console.yandex.cloud/link/managed-mysql) в сервис **Managed Service for&nbsp;MySQL** и нажмите **Создать кластер**.
...
1. В блоке **Хосты** выберите параметры хостов БД, создаваемых вместе с кластером:
   ...
   * [Зона доступности](../../overview/concepts/geo-scope.md) — `ru-central1-d`.
   * Подсеть — `default-ru-central1-d`.

1. Нажмите кнопку **Создать кластер**.
Подробнее о создании кластера смотрите в разделе [Как начать работать с Managed Service for MySQL®](../quickstart.md#cluster-create).
...
1. [Перейдите](https://console.yandex.cloud/link/data-transfer) в сервис **Data Transfer** и нажмите **Создать эндпоинт**.
