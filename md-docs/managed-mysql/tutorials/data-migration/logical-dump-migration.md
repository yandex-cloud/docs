[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for MySQL®](../../index.md) > [Практические руководства](../index.md) > [Миграция базы данных из стороннего кластера MySQL®](index.md) > Перенос данных с помощью логического дампа
...
- Вручную {#manual}
    ...
    1. Если вы используете группы безопасности для промежуточной виртуальной машины и кластера Managed Service for MySQL®, [настройте их](../../operations/connect/index.md#configure-security-groups).
...
* С использованием утилиты mysql
    ...
    1. Запустите восстановление базы из дампа:
        ...
        * Если вы восстанавливаете дамп с хоста, подключающегося к Yandex Cloud из интернета, [получите SSL-сертификат](../../operations/connect/index.md#get-ssl-cert) и передайте параметры `--ssl-ca` и `--ssl-mode` в команде восстановления:
...
- Вручную {#manual}
    ...
    * [Удалите кластер Managed Service for MySQL®](../../operations/cluster-delete.md).
