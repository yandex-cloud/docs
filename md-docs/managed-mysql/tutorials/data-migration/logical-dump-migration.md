# Перенос данных из стороннего кластера {{ MY }} через создание и восстановление логического дампа
...
- Вручную {#manual}
    ...
    1. Если вы используете группы безопасности для промежуточной виртуальной машины и кластера {{ mmy-name }}, [настройте их](../../operations/connect/index.md#configure-security-groups).
...
- Вручную {#manual}
    ...
    * [Удалите кластер {{ mmy-name }}](../../operations/cluster-delete.md).
