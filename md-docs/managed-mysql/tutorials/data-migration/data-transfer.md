# Перенос данных из стороннего кластера {{ MY }} с использованием сервиса {{ data-transfer-name }}
...
1. Подготовьте инфраструктуру и запустите перенос данных:
    ...
    - Вручную {#manual}
        ...
        1. [Создайте кластер-приемник {{ mmy-name }}](../../operations/cluster-create.md) любой подходящей конфигурации. При этом:
