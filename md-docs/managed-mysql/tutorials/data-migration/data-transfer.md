[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for MySQL®](../../index.md) > [Практические руководства](../index.md) > [Миграция базы данных из стороннего кластера MySQL®](index.md) > Перенос данных с использованием сервиса Data Transfer

# Перенос данных из стороннего кластера MySQL® с использованием сервиса Data Transfer
...
1. Подготовьте инфраструктуру и запустите перенос данных:
    ...
    - Вручную {#manual}
        ...
        1. [Создайте кластер-приемник Managed Service for MySQL®](../../operations/cluster-create.md) любой подходящей конфигурации. При этом:
            ...
            * [Режим SQL](../../concepts/settings-list.md#setting-sql-mode) должен быть таким же, как и в кластере-источнике.
    ...
    - Terraform {#tf}
        ...
        1. Укажите в файле `data-transfer-mysql-mmy.tf`:
            ...
            * параметры кластера-приемника, которые используются и как [параметры эндпоинта-приемника](../../../data-transfer/operations/endpoint/target/mysql.md#managed-service):
                ...
                * `target_sql_mode` — [режим SQL](../../concepts/settings-list.md#setting-sql-mode), он должен быть таким же, как и в кластере-источнике;
