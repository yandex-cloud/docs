[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for MySQL®](../index.md) > [Практические руководства](index.md) > Миграция данных из Managed Service for MySQL® в Yandex Managed Service for PostgreSQL с помощью Yandex Data Transfer
...
- Вручную {#manual}
    ...
    1. [Выдайте административные привилегии](../operations/grant.md#grant-privilege) `REPLICATION CLIENT` и `REPLICATION SLAVE` пользователю `mmy_user`.
        ...
        Подробнее об административных привилегиях смотрите в [описании настроек](../concepts/settings-list.md#setting-administrative-privileges).
...
1. [Подключитесь к базе данных в кластере-источнике Managed Service for MySQL®](../operations/connect/index.md).
