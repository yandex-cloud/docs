...
- Вручную {#manual}
    ...
    1. [Создайте кластер-источник {{ mmy-name }}](../operations/cluster-create.md) любой подходящей конфигурации.
...
1. [Подключитесь к кластеру-источнику {{ mmy-name }}](../operations/connect/index.md) и добавьте данные в таблицу `measurements`:
