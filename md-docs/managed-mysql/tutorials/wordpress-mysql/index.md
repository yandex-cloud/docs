...
С помощью этой инструкции вы научитесь разворачивать сайт на базе CMS WordPress с [кластером баз данных](../../concepts/index.md) под управлением СУБД {{ MY }} в инфраструктуре {{ yandex-cloud }}.
