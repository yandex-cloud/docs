...
- Вручную {#manual}
    ...
    1. [Создайте кластер-источник {{ mmy-name }}](../operations/cluster-create.md) любой подходящей [конфигурации](../concepts/instance-types.md) с хостами в публичном доступе и следующими настройками:
...
1. [Подключитесь к кластеру {{ mmy-name }}](../operations/connect/index.md), создайте в базе данных `db1` таблицу `measurements` и заполните ее данными:
