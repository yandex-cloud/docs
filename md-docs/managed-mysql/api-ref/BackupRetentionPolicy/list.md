[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for MySQL®](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [BackupRetentionPolicy](index.md) > List

# Managed Service for MySQL API, REST: BackupRetentionPolicy.List
...
```
GET https://mdb.api.cloud.yandex.net/managed-mysql/v1/clusters/{clusterId}/retention_policies
```
...
## Query parameters {#yandex.cloud.mdb.mysql.v1.ListBackupRetentionPoliciesRequest}
...
is larger than [ListBackupRetentionPoliciesRequest.pageSize](#yandex.cloud.mdb.mysql.v1.ListBackupRetentionPoliciesRequest), use the `nextPageToken` as the value
for the [ListBackupRetentionPoliciesRequest.pageToken](#yandex.cloud.mdb.mysql.v1.ListBackupRetentionPoliciesRequest) query parameter in the next list request.
