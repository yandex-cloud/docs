[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for MySQL®](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Maintenance](index.md) > Get

# Managed Service for MySQL API, REST: Maintenance.Get
...
```
GET https://mdb.api.cloud.yandex.net/managed-mysql/v1/maintenances/{maintenanceId}
```
