[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for MySQL®](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Backup](index.md) > Get
...
To get this ID, make a [BackupService.List](list.md#List) request (lists all backups in a folder) or a [ClusterService.ListBackups](../Cluster/listBackups.md#ListBackups) request (lists all backups for an existing cluster). ||
|#
