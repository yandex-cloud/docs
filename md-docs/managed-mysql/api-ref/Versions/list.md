...
```
GET https://mdb.api.cloud.yandex.net/managed-mysql/v1/versions
```

## Query parameters {#yandex.cloud.mdb.mysql.v1.ListVersionsRequest}
...
## Response {#yandex.cloud.mdb.mysql.v1.ListVersionsResponse}
