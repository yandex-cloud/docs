[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for MySQL®](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Cluster](index.md) > UpdateHosts
...
To get the MySQL cluster ID, use a [ClusterService.List](list.md#List) request.
...
To get a MySQL host name, use a [ClusterService.ListHosts](listHosts.md#ListHosts) request. ||
|| replicationSource | **string**
