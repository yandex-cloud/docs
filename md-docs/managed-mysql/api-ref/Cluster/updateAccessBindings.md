[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for MySQL®](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Cluster](index.md) > UpdateAccessBindings
...
```
PATCH https://mdb.api.cloud.yandex.net/managed-mysql/v1/clusters/{resourceId}:updateAccessBindings
```
