[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for MySQL®](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [BackupRetentionPolicy](index.md) > Delete
...
**rpc Delete ([DeleteBackupRetentionPolicyRequest](#yandex.cloud.mdb.mysql.v1.DeleteBackupRetentionPolicyRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**
