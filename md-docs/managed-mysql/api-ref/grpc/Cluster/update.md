[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for MySQL®](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Cluster](index.md) > Update
...
To add a label, request the current label set with the [ClusterService.Get](get.md#Get) request, then send an [ClusterService.Update](#Update) request with the new label added to the current set.
