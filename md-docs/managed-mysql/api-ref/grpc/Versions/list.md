[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for MySQL®](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Versions](index.md) > List

# Managed Service for MySQL API, gRPC: VersionsService.List

Returns list of available MySQL versions.

## gRPC request

**rpc List ([ListVersionsRequest](#yandex.cloud.mdb.mysql.v1.ListVersionsRequest)) returns ([ListVersionsResponse](#yandex.cloud.mdb.mysql.v1.ListVersionsResponse))**

## ListVersionsRequest {#yandex.cloud.mdb.mysql.v1.ListVersionsRequest}
...
## ListVersionsResponse {#yandex.cloud.mdb.mysql.v1.ListVersionsResponse}
