[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for MySQL®](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [ChangeFreeze](index.md) > Get

# Managed Service for MySQL API, REST: ChangeFreeze.Get
...
```
GET https://mdb.api.cloud.yandex.net/managed-mysql/v1/changeFreezes/{changeFreezeId}
```
