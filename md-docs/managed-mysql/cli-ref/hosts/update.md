...
Priority of the host as a backup source. ||
|| `--priority` | `int`
 ...
 * [Задать приоритет использования хостов при создании резервных копий](../../operations/cluster-backups.md#cli_7)
 * [Изменить хост](../../operations/hosts.md#cli_3)