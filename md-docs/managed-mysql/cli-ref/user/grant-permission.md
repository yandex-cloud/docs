 ...
 * [Создать пользователя с правами только на чтение](../../operations/cluster-users.md#cli_6)
 * [Создать пользователя с правами только на чтение](../../operations/grant.md#cli_2)
 * [Создание кластера с одним хостом](../../operations/cluster-create.md#cli_2)
 * [Изменить привилегии пользователя](../../operations/grant.md#cli_1)