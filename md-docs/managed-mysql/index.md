...
Managed Service for MySQL<sup>®</sup> помогает разворачивать и поддерживать кластеры серверов MySQL в инфраструктуре Yandex Cloud. Сервис поддерживает MySQL 5.7 и MySQL 8.0.
...
### Сайт на WordPress с БД MySQL®
 ...
 - [Обзор](tutorials/wordpress-mysql.md)

 - [Консоль управления](tutorials/console.md)

 - [Terraform](tutorials/terraform.md)
