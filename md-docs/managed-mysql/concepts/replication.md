...
В кластере Managed Service for MySQL® используется механизм автоматического выбора и переключения на новый мастер. При выходе из строя хоста-мастера одна из реплик становится новым мастером.
...
* [Миграция базы данных из Managed Service for MySQL® в сторонний кластер MySQL®](../tutorials/mmy-to-mysql-migration.md)
