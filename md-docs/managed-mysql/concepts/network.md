[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for MySQL®](../index.md) > [Концепции](index.md) > Сеть в Managed Service for MySQL
...
Вы можете создать кластер, не задавая подсети для хостов, если выбранная для каждого хоста [зона доступности](../../overview/concepts/geo-scope.md) содержит ровно одну подсеть сети кластера.
