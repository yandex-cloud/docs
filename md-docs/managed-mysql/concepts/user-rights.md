...
_Привилегия_ — это разрешение выполнять определенные операции в кластере. В MySQL® есть три уровня привилегий пользователя:

* Административные привилегии — позволяют выполнять операции на уровне кластера. Они задаются в [настройках MySQL® на уровне пользователя](settings-list.md#setting-administrative-privileges) и действуют на всех хостах кластера.
...
## Привилегии пользователей на уровне БД в Managed Service for MySQL® {#db-privileges}
...
Подробнее об управлении привилегиями пользователей смотрите в [документации MySQL®](https://dev.mysql.com/doc/refman/8.0/en/privileges-provided.html).