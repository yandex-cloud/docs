...
1. Мастер проходит техническое обслуживание и получает обновления. Если во время технического обслуживания потребуется перезагрузка мастера и он станет недоступным, его роль возьмет на себя одна из реплик. После завершения обновления мастером станет хост с наибольшим [приоритетом мастера](replication.md#master-failover). Если в кластере есть несколько хостов с максимальным приоритетом, выбирается хост с наименьшим отставанием от мастера.
    ...
    Если вы используете для доступа к кластеру [FQDN хоста-мастера](../operations/connect/fqdn.md), такой кластер может стать недоступным. Если запрос на запись завершился ошибкой, повторите его позднее.
