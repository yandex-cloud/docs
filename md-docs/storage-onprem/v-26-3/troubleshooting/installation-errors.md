[Документация Yandex Cloud](../../../index.md) > [On-premises Yandex Object Storage](../../index.md) > Версия 26.3 > Поиск и устранение неисправностей > Устранение неисправностей при установке
