[Документация Yandex Cloud](../../../index.md) > [On-premises Yandex Object Storage](../../index.md) > Версия 26.3 > [Установка и настройка](index.md) > Подготовка окружения

# Подготовка окружения

Здесь и далее рассматривается пример установки On-premises Yandex Object Storage на стенде с названием `my-onprem` со следующими параметрами:
...
Плейбуки не создают `topolvm`: наличие группы проверяется перед установкой компонентов On-premises Yandex Object Storage. Подготовка HDD для данных выполняется отдельно. Перед ее запуском [проверьте план подготовки дисков](installation-steps.md#disk-plan) и убедитесь, что разделы для метаданных не будут отформатированы.
