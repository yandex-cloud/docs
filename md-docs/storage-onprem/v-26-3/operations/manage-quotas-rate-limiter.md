[Документация Yandex Cloud](../../../index.md) > [On-premises Yandex Object Storage](../../index.md) > Версия 26.3 > [Сценарии обслуживания](index.md) > Управление квотами rate-лимитера
