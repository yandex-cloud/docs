[Документация Yandex Cloud](../../../../index.md) > [On-premises Yandex Object Storage](../../../index.md) > Версия 26.3 > [Концепции](../../index.md) > [Архитектура продукта](index.md) > Примеры балансировки > Размещение в датацентрах с L2-балансировщиком
