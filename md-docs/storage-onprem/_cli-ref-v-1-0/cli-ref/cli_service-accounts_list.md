[Документация Yandex Cloud](../../../index.md) > [storage-onprem/_cli-ref-v-1-0](../index.md) > service-accounts > list

# cli service-accounts list

List service accounts

```
cli service-accounts list [flags]
```
