[Документация Yandex Cloud](../../../index.md) > [storage-onprem/_cli-ref-v-1-0](../index.md) > settings > Overview
...
* [cli settings login](cli_settings_login.md)	 — Show login settings and issues