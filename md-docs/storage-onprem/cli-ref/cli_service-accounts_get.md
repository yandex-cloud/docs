[Документация Yandex Cloud](../../index.md) > [On-premises Yandex Object Storage](../index.md) > Версия 26.3 > Справочник CLI (англ.) > service-accounts > get

# cli service-accounts get

Get service account

```
cli service-accounts get <service_account_id> [flags]
```
