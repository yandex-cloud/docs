[Документация Yandex Cloud](../../index.md) > [On-premises Yandex Object Storage](../index.md) > Версия 26.3 > Справочник CLI (англ.) > service-accounts > delete

# cli service-accounts delete

Delete service account

```
cli service-accounts delete <service_account_id> [flags]
```
