[Документация Yandex Cloud](../../index.md) > [On-premises Yandex Object Storage](../index.md) > Версия 26.3 > Справочник CLI (англ.) > tenants > activate

# cli tenants activate

Activate tenant

```
cli tenants activate <tenant_id> [flags]
```
