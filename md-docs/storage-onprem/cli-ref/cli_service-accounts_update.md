[Документация Yandex Cloud](../../index.md) > [On-premises Yandex Object Storage](../index.md) > Версия 26.3 > Справочник CLI (англ.) > service-accounts > update

# cli service-accounts update

Update service account name

```
cli service-accounts update <service_account_id> <new_name> [flags]
```
