[Документация Yandex Cloud](../../index.md) > [On-premises Yandex Object Storage](../index.md) > Версия 26.3 > Справочник CLI (англ.) > ops > Overview
...
* [cli ops tasks](cli_ops_tasks.md)	 — Manage maintenance tasks
