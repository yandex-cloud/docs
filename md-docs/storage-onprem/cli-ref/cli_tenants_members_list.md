[Документация Yandex Cloud](../../index.md) > [On-premises Yandex Object Storage](../index.md) > Версия 26.3 > Справочник CLI (англ.) > tenants > members > list

# cli tenants members list

list tenant members

```
cli tenants members list <tenant_id> [flags]
```
