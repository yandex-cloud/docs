[Документация Yandex Cloud](../../index.md) > [On-premises Yandex Object Storage](../index.md) > Версия 26.3 > Справочник CLI (англ.) > service-accounts > activate

# cli service-accounts activate

Activate service account

```
cli service-accounts activate <service_account_id> [flags]
```
