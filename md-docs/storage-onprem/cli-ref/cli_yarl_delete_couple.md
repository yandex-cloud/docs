[Документация Yandex Cloud](../../index.md) > [On-premises Yandex Object Storage](../index.md) > Версия 26.3 > Справочник CLI (англ.) > yarl > delete > couple

# cli yarl delete couple

Delete a bucket couple quota

```
cli yarl delete couple <bucket> [flags]
```
