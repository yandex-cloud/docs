[Документация Yandex Cloud](../../index.md) > [On-premises Yandex Object Storage](../index.md) > Версия 26.3 > Справочник CLI (англ.) > service-accounts > create
...
```
cli service-accounts create <name> [flags]
```
...
```
  ...
  -r, --role string     Service account role (viewer, editor, admin) (default "viewer")
