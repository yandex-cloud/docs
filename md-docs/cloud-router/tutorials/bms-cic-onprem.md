[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Router](../index.md) > Практические руководства > Организация сетевой связности между приватной подсетью BareMetal и on-premise-ресурсами
...
Для организации сетевой связности между подсетями BareMetal и on-premise-подсетями необходимо [создать виртуальный маршрутизатор](../operations/ri-create.md).
...
1. Если у вас уже есть виртуальный маршрутизатор, вы можете пропустить следующий шаг и [перейти](#create-private-connection) к созданию приватного соединения.
    ...
    Если у вас нет виртуального маршрутизатора или вы хотите построить дополнительную обособленную сетевую связность, [создайте новый](../operations/ri-create.md).
