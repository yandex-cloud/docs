...
Для организации сетевой связности между подсетями BareMetal, подсетями Virtual Private Cloud и/или подсетями on-prem необходимо [создать виртуальный маршрутизатор](../operations/ri-create.md).
