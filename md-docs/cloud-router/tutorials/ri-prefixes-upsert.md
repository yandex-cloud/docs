[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Router](../index.md) > Практические руководства > Изменение набора IP-префиксов VPC в виртуальном маршрутизаторе

# Изменить набор IP-префиксов VPC в виртуальном маршрутизаторе

## Изменение набора IP-префиксов VPC в виртуальном маршрутизаторе {#ri-ip-change}
...
Чтобы изменить набор IP-префиксов в приватном соединении, создайте [новое обращение в поддержку](https://center.yandex.cloud/support).
...
* `vpc_net_id` — идентификатор виртуальной сети Yandex Virtual Private Cloud в которую вносятся изменения. Для каждой виртуальной сети указывается список IPv4-префиксов подсетей, сгруппированных по [зонам доступности](../../overview/concepts/geo-scope.md) Yandex Cloud.
