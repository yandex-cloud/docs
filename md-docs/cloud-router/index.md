...
#### routing-instance
 ...
 - [Overview](cli-ref/v1/routing-instance/index.md)

 - [add-labels](cli-ref/v1/routing-instance/add-labels.md)

 - [add-private-connection](cli-ref/v1/routing-instance/add-private-connection.md)

 - [create](cli-ref/v1/routing-instance/create.md)

 - [delete](cli-ref/v1/routing-instance/delete.md)

 - [get](cli-ref/v1/routing-instance/get.md)

 - [get-by-cic-private-connection-id](cli-ref/v1/routing-instance/get-by-cic-private-connection-id.md)

 - [get-by-vpc-network-id](cli-ref/v1/routing-instance/get-by-vpc-network-id.md)

 - [list](cli-ref/v1/routing-instance/list.md)

 - [list-operations](cli-ref/v1/routing-instance/list-operations.md)

 - [move](cli-ref/v1/routing-instance/move.md)

 - [move-prefix](cli-ref/v1/routing-instance/move-prefix.md)

 - [remove-labels](cli-ref/v1/routing-instance/remove-labels.md)

 - [remove-prefixes](cli-ref/v1/routing-instance/remove-prefixes.md)

 - [remove-private-connection](cli-ref/v1/routing-instance/remove-private-connection.md)

 - [update](cli-ref/v1/routing-instance/update.md)

 - [update-networks](cli-ref/v1/routing-instance/update-networks.md)

 - [update-prefix-mask](cli-ref/v1/routing-instance/update-prefix-mask.md)

 - [upsert-prefixes](cli-ref/v1/routing-instance/upsert-prefixes.md)
...
#### RoutingInstance
 ...
 - [Move](api-ref/grpc/RoutingInstance/move.md)
...
#### RoutingInstance
 ...
 - [GetByVpcNetworkId](api-ref/RoutingInstance/getByVpcNetworkId.md)

 - [GetByCicPrivateConnectionId](api-ref/RoutingInstance/getByCicPrivateConnectionId.md)
 ...
 - [UpdateNetworks](api-ref/RoutingInstance/updateNetworks.md)

 - [Delete](api-ref/RoutingInstance/delete.md)

 - [Move](api-ref/RoutingInstance/move.md)
