...
- CLI {#cli}
  ...
  С помощью CLI вы можете изменить следующие параметры виртуального маршрутизатора:
  ...
  * метки — параметр `--labels`.
  ...
  Для изменения анонсируемых IP-префиксов и добавления или удаления приватных соединений используйте [отдельные команды](cr-cic-ops.md#ri).
