[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Router](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [RoutingInstance](index.md) > Move

# Cloud Router API, REST: RoutingInstance.Move
...
Required field. ID of the RoutingInstance resource to move.
To get the routingInstance ID use a [RoutingInstanceService.List](list.md#List) request.

The maximum string length in characters is 50. ||
|#

## Body parameters {#yandex.cloud.cloudrouter.v1.MoveRoutingInstanceRequest}
...
Required field. ID of the folder to which routingInstance will be moved.
