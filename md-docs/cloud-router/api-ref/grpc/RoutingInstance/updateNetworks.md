[Документация Yandex Cloud](../../../../index.md) > [Yandex Cloud Router](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [RoutingInstance](index.md) > UpdateNetworks

# Cloud Router API, gRPC: RoutingInstanceService.UpdateNetworks
...
**rpc UpdateNetworks ([UpdateNetworksRequest](#yandex.cloud.cloudrouter.v1.UpdateNetworksRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## UpdateNetworksRequest {#yandex.cloud.cloudrouter.v1.UpdateNetworksRequest}
...
## VpcInfo {#yandex.cloud.cloudrouter.v1.VpcInfo}
...
The maximum string length in characters is 50. ||
|| vpc_az_info_prefixes[] | **[VpcAzInfoPrefixes](#yandex.cloud.cloudrouter.v1.VpcAzInfoPrefixes)**
