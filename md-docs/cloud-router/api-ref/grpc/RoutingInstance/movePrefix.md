...
Required field. ID of the source VpcNetwork.

The maximum string length in characters is 50. ||
|| src_az_id | **string**

Required field. ID of the AZ in the source VpcNetwork.

The maximum string length in characters is 50. ||
|| dst_vpc_network_id | **string**

Required field. ID of the destination VpcNetwork.

The maximum string length in characters is 50. ||
|| dst_az_id | **string**

Required field. ID of the AZ in the destination VpcNetwork.

The maximum string length in characters is 50. ||
|| prefix | **string**

Required field. Prefix to move.
