[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Router](../index.md) > [Сценарии использования](index.md) > Резервирование подключения on-premises через VPN-шлюз (PRC)
...
Резервное подключение из Yandex Cloud в инфраструктуру клиента организуется с помощью развертывания VPN-шлюза с поддержкой технологии IPsec в [зоне доступности](../../overview/concepts/geo-scope.md) `ru-central1-b` и настройкой статической маршрутизации в облачной сети (VPC).
