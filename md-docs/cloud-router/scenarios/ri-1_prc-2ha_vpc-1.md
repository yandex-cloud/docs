[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Router](../index.md) > [Сценарии использования](index.md) > On-premises с резервированием и одна облачная сеть
...
Для приоритезации трафика между [приватными соединениями](../../interconnect/concepts/priv-con.md) нужно использовать соответствующие [инструменты маршрутизации](prc-ha-with-active-standby.md) Cloud Interconnect.
