[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Router](../../index.md) > [Справочник CLI (англ.)](../index.md) > [routing-instance](index.md) > get-by-cic-private-connection-id
...
`yc cloudrouter routing-instance get-by-cic-private-connection-id <CIC-PRIVATE-CONNECTION-ID>`
