...
Если к Routing Instance подключена виртуальная сеть, в которой используются балансировщики нагрузки [{{ network-load-balancer-short-name }}](../../network-load-balancer/index.md) или [{{ alb-name }}](../../application-load-balancer/index.md), адреса их обработчиков анонсируются в виде IPv4-префиксов с длиной `/32`, независимо от диапазонов анонсируемых IP-префиксов подсетей этой сети.
