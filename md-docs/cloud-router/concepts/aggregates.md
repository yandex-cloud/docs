[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Router](../index.md) > [Концепции](index.md) > Агрегированные префиксы
...
> Например, при настройке виртуального маршрутизатора можно указать анонсы агрегированных IPv4-префиксов вида:
>
> ```
