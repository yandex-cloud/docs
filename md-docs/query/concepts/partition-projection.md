[Документация Yandex Cloud](../../index.md) > [Yandex Query](../index.md) > [Концепции](index.md) > Аналитическая обработка данных > Расширенное партицирование

# Расширенное партицирование

[Партицирование](partitioning.md) позволяет подсказать для Yandex Query правила размещения данных в Yandex Object Storage.
...
Данные в бакетах Yandex Object Storage могут быть размещены в каталогах с произвольными названиями. С помощью настройки `storage.location.template` можно указать правила именования каталогов, где хранятся данные.
