...
## Федеративные запросы в Yandex Query {#shorts2}
...
## Обработка данных в Yandex Object Storage с помощью Yandex Query {#shorts1}
