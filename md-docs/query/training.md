[Документация Yandex Cloud](../index.md) > [Yandex Query](index.md) > Обучающие курсы

# Обучающие курсы по Yandex Query
...
Подробнее узнать об использовании сервиса Yandex Query можно в следующих курсах:
