[Документация Yandex Cloud](../../index.md) > [Yandex Query](../index.md) > [Практические руководства](index.md) > Обработка аудитных логов Audit Trails
...
1. На панели **Audit trails** интерфейса Query выберите тип анализа данных **Аналитический**, а в списке [привязок к данным](../concepts/glossary.md#binding) выберите `audit-trails-test-object_storage`.
...
* [сохранить в бакет](../sources-and-sinks/object-storage-write.md) Object Storage;
* получить и обработать через [Query HTTP API](../api/index.md).
...
1. В разделе **Audit trails** в интерфейсе **Yandex Query** выберите нужный тип анализа данных: **Потоковый**, а в списке [привязок к данным](../concepts/glossary.md#binding) выберите нужную.
1. Выберите нужный запрос к данным из Object Storage из списка и нажмите кнопку **Выполнить**.

Результаты потокового запроса можно:

* [отправить в Yandex Monitoring](../sources-and-sinks/monitoring.md) в виде метрик;
* [отправить в выходной поток Data Streams](../sources-and-sinks/data-streams-write.md) в виде данных, а далее обработать с помощью [триггеров Yandex Cloud Functions](../../functions/operations/trigger/data-streams-trigger-create.md).
