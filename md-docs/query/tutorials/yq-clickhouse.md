[Документация Yandex Cloud](../../index.md) > [Yandex Query](../index.md) > [Практические руководства](index.md) > Работа с данными в Managed Service for ClickHouse®
...
Чтобы создать [подключение](../concepts/glossary.md#connection) Query:
