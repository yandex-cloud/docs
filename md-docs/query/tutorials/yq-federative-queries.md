[Документация Yandex Cloud](../../index.md) > [Yandex Query](../index.md) > [Практические руководства](index.md) > Федеративные запросы к данным
...
* Сервис Query: объем считанных данных при исполнении запросов ([тарифы Query](../pricing.md)).
...
Для работы с данными Object Storage вам понадобится бакет с таблицей, [подключение](../concepts/glossary.md#connection) Query и [привязка](../concepts/glossary.md#binding) к данным.
...
- Консоль управления {#console}
  ...
  1. Перейдите в созданный бакет и на панели сверху нажмите кнопку ![arrow-up-from-line](../../_assets/console-icons/arrow-up-from-line.svg) **Загрузить**.
...
- Консоль управления {#console}
  ...
  1. Перейдите на вкладку **Соединения**.
...
- Консоль управления {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) выберите каталог `data-folder`.
  1. [Перейдите](https://yq.yandex.cloud) в сервис **Yandex Query**.
  1. Перейдите на вкладку **Привязки**.
  1. Нажмите кнопку ![info](../../_assets/console-icons/plus.svg) **Создать**.
  ...
  1. В блоке **Параметры привязки к данным**:
     ...
     1. В поле **Путь** укажите [путь к таблице](../sources-and-sinks/object-storage.md#path-format) в бакете — `/visits.csv`.
