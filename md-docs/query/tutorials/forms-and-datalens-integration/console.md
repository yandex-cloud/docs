...
* плата за объем считанных из источников данных при исполнении запросов Query (см. [тарифы Query](../../pricing.md));
...
1. [Привязку Query](../../operations/binding.md#delete).
1. [Соединение Query](../../operations/connection.md#delete).
