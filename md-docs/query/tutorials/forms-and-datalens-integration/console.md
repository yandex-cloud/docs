...
* плата за объем считанных из источников данных при исполнении запросов {{ yq-name }} (см. [тарифы {{ yq-name }}](../../pricing.md));
...
1. [Привязку {{ yq-name }}](../../operations/binding.md#delete).
1. [Соединение {{ yq-name }}](../../operations/connection.md#delete).
