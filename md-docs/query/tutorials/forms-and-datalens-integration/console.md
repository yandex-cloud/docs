[Документация Yandex Cloud](../../../index.md) > [Yandex Query](../../index.md) > [Практические руководства](../index.md) > [Поставка данных из Яндекс Формы в Yandex DataLens с использованием Yandex Cloud Functions и Yandex Query](index.md) > Консоль управления
