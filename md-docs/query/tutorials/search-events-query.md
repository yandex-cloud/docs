[Документация Yandex Cloud](../../index.md) > [Yandex Query](../index.md) > [Практические руководства](index.md) > Поиск событий Yandex Cloud в Query
...
В [Yandex Query](../index.md) интегрирована поддержка Audit Trails. Вы можете анализировать события ресурсов Yandex Cloud, выполняя [аналитические](../concepts/batch-processing.md) и [потоковые](../concepts/stream-processing.md) запросы на языке YQL.
...
Чтобы подключить бакет с [аудитными логами](../../audit-trails/concepts/events.md) к Yandex Query и выполнить запросы на языке [YQL](../yql-tutorials/index.md):
