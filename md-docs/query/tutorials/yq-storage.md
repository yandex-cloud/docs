[Документация Yandex Cloud](../../index.md) > [Yandex Query](../index.md) > [Практические руководства](index.md) > Работа с данными в Object Storage
...
- Консоль управления {#console}
  ...
  1. В блоке **Параметры привязки к данным**:
     ...
     1. В поле **Путь** укажите [путь к данным](../sources-and-sinks/object-storage.md#path-format) — `nyc_taxi_sample/data/`.
