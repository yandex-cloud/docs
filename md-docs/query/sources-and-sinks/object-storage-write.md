...
Запись данных с помощью соединений удобно использовать для прототипирования и первоначальной настройки. Для записи данных в бакет создайте [соединение](object-storage.md#create-connection) с Object Storage и используйте SQL-выражение:
...
Пример запроса для записи данных в Object Storage с помощью привязки к данным:
