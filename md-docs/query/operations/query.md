[Документация Yandex Cloud](../../index.md) > [Yandex Query](../index.md) > Пошаговые инструкции > Управление запросами
...
1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором нужно создать запрос.
...
Yandex Query сохраняет [историю запусков](../concepts/glossary.md#jobs) для каждого запроса.

1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором нужно посмотреть историю выполнения запроса.
1. Перейдите в сервис **Yandex Query**.
1. На панели слева выберите **Запросы**.
...
1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором нужно переименовать запрос.
1. Перейдите в сервис **Yandex Query**.
1. На панели слева выберите **Запросы**.
...
1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором нужно клонировать запрос.
1. Перейдите в сервис **Yandex Query**.
1. На панели слева выберите **Запросы**.
1. Выберите запрос и нажмите кнопку **Клонировать**. Чтобы клонировать запрос с другим типом, нажмите кнопку ![option](../../_assets/console-icons/chevron-down.svg) и выберите **Клонировать как…**.

## Удалить запрос {#delete}

1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором нужно удалить запрос.
1. Перейдите в сервис **Yandex Query**.
1. На панели слева выберите **Запросы**.
