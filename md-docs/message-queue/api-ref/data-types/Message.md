[Документация Yandex Cloud](../../../index.md) > [Yandex Message Queue](../../index.md) > [Справочник API](../index.md) > Типы данных > Message
...
`MD5OfBody` | **string** | Нет | MD5-хеш тела сообщения.
`MD5OfMessageAttributes` | **string** | Нет | MD5-хеш атрибутов сообщения.
`MessageAttribute` | **array** | Нет | Массив [MessageAttributeValue](MessageAttributeValue.md), содержащий пользовательские атрибуты сообщения: имя, тип и значение.
