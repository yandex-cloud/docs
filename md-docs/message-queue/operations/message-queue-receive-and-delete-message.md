[Документация Yandex Cloud](../../index.md) > [Yandex Message Queue](../index.md) > [Пошаговые инструкции](index.md) > Прием и удаление сообщений
...
- Консоль управления {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором создана очередь сообщений.
  1. [Перейдите](https://console.yandex.cloud/link/message-queue) в сервис **Message Queue**.
  1. Текущее количество сообщений в нужной очереди указано в колонке **Сообщений в очереди**.
