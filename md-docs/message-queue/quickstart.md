...
1. Создайте очередь с именем `sample-queue`:
   ...
   - Консоль управления {#console}
     ...
     1. На вкладке **Обзор** в блоке **Общая информация** скопируйте значения поля **URL** — оно понадобится позднее.
...
1. Удалите очередь:
   ...
   - Консоль управления {#console}
     ...
     1. В открывшемся окне нажмите кнопку ![image](../_assets/console-icons/trash-bin.svg) **Удалить**.
