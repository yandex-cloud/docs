...
| ----------------------------------------------------------------------- | ----------------- | --------------- | -------------- | ------------ |
| Другие запросы, от 0 до 0.1 единицы тарификации в месяц                 | Не тарифицируется | 1 млн запросов  | 30 апреля 2026 | —            |
| Другие запросы, от 0.1 единицы тарификации в месяц                      | 57,82 ₽           | 1 млн запросов  | 30 апреля 2026 | —            |
| Запросы к очередям FIFO, от 0 до 0.1 единицы тарификации в месяц        | Не тарифицируется | 1 млн запросов  | 30 апреля 2026 | —            |
| Запросы к очередям FIFO, от 0.1 единицы тарификации в месяц             | 72,51 ₽           | 1 млн запросов  | 30 апреля 2026 | —            |
| Запросы к стандартным очередям, от 0 до 0.1 единицы тарификации в месяц | Не тарифицируется | 1 млн запросов  | 30 апреля 2026 | —            |
| Запросы к стандартным очередям, от 0.1 единицы тарификации в месяц      | 57,82 ₽           | 1 млн запросов  | 30 апреля 2026 | —            |
