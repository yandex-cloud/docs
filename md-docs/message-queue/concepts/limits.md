[Документация Yandex Cloud](../../index.md) > [Yandex Message Queue](../index.md) > [Концепции](index.md) > Квоты и лимиты
...
Максимальное [время ожидания](long-polling.md) клиентом сообщения в пустой очереди. (параметр `WaitTimeSeconds`) | 20 секунд |