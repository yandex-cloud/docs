[Документация Yandex Cloud](../../../index.md) > [Yandex Message Queue](../../index.md) > [Практические руководства](../index.md) > [Хранение статического ключа доступа в секрете Yandex Lockbox](index.md) > Terraform
