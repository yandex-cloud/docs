[Документация Yandex Cloud](../../../index.md) > [Yandex Message Queue](../../index.md) > [Практические руководства](../index.md) > Конвертация видео в GIF на Python > Обзор

# Конвертация видео в GIF на Python



Вы создадите видеоконвертер с использованием утилиты [FFmpeg](https://ffmpeg.org/) и сервиса [Yandex Message Queue](../../index.md). Руководство предназначено для пользователей Linux и macOS.
