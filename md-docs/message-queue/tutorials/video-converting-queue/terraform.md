...
1. Подготовьте файлы с описанием инфраструктуры:
   ...
   * [Очередь сообщений](../../concepts/queue.md) — [yandex_message_queue]({{ tf-provider-resources-link }}/message_queue)
   * [База данных YDB](../../concepts/queue.md) — [yandex_ydb_database_serverless]({{ tf-provider-resources-link }}/ydb_database_serverless)
