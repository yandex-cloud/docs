[Документация Yandex Cloud](../index.md) > [Yandex Message Queue](index.md) > Обучающие курсы

# Обучающие курсы по Yandex Message Queue
...
Подробнее узнать об использовании сервиса Yandex Message Queue можно в следующих курсах:
