[Документация Yandex Cloud](../../../../../index.md) > [Yandex Data Transfer](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [v0](../../index.md) > [endpoint](../index.md) > [update](index.md) > clickhouse-source

# yc datatransfer v0 endpoint update clickhouse-source
...
|| `--include-table` | `value[,value]`

Do not transfer tables other than these ||
|| `--exclude-table` | `value[,value]`
