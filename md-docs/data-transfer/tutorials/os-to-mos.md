[Документация Yandex Cloud](../../index.md) > [Yandex Data Transfer](../index.md) > [Практические руководства](index.md) > Миграция > Кластер OpenSearch
...
1. [Обеспечьте доступ к кластеру-источнику OpenSearch из Yandex Cloud](../concepts/network.md#source-external).
...
1. Создайте кластер-приемник Managed Service for OpenSearch:
    ...
    - Вручную {#manual}
        ...
        [Создайте кластер-приемник](../../managed-opensearch/operations/cluster-create.md) Managed Service for OpenSearch любой подходящей конфигурации с хостами в публичном доступе.
...
1. [Создайте эндпоинт](../operations/endpoint/index.md#create) для [кластера-источника OpenSearch](../operations/endpoint/source/opensearch.md#on-premise).

1. [Создайте эндпоинт](../operations/endpoint/index.md#create) для [кластера-приемника Managed Service for OpenSearch](../operations/endpoint/target/opensearch.md).
