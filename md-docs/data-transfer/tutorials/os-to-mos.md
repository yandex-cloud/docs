...
1. [Обеспечьте доступ к кластеру-источнику {{ OS }} из {{ yandex-cloud }}](../concepts/network.md#source-external).
...
1. [Создайте эндпоинт](../operations/endpoint/index.md#create) для [кластера-источника {{ OS }}](../operations/endpoint/source/opensearch.md#on-premise).

1. [Создайте эндпоинт](../operations/endpoint/index.md#create) для [кластера-приемника {{ mos-name }}](../operations/endpoint/target/opensearch.md).
