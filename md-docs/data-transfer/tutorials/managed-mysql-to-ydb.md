[Документация Yandex Cloud](../../index.md) > [Yandex Data Transfer](../index.md) > [Практические руководства](index.md) > Миграция со сменой типа хранения данных > MySQL® в YDB

# Миграция данных из MySQL® в YDB
...
- Terraform {#tf}
    ...
    1. Укажите в файле `data-transfer-mmy-ydb.tf`:
        ...
        * параметры кластера-источника Managed Service for MySQL®, которые будут использоваться как [параметры эндпоинта-источника](../operations/endpoint/target/mysql.md#managed-service):
...
1. Если создавали инфраструктуру вручную, [подготовьте кластер-источник](../operations/prepare.md#source-my).
