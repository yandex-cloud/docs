...
1. [Создайте эндпоинт для источника {{ yds-name }}](../operations/endpoint/index.md#create).
...
1. [Создайте эндпоинт для приемника {{ mkf-name }}](../operations/endpoint/index.md#create).
