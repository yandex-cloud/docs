...
1. Подготовьтесь к выполнению SQL-запросов в базе данных источника Managed Service for YDB:
    ...
    - YDB CLI {#cli}
        ...
        1. Убедитесь, что можете выполнять запросы с помощью YDB CLI с выбранным режимом аутентификации. Например, для [OAuth-токена](../../iam/concepts/authorization/oauth-token.md):
