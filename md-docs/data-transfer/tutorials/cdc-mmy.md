[Документация Yandex Cloud](../../index.md) > [Yandex Data Transfer](../index.md) > [Практические руководства](index.md) > Захват изменений данных и поставка в очередь > MySQL® в Apache Kafka®
...
Вы можете отслеживать изменения данных в _кластере-источнике_ Yandex Managed Service for MySQL® и отправлять их в _кластер-приемник_ Yandex Managed Service for Apache Kafka® с помощью технологии [Change Data Capture](../concepts/cdc.md) (CDC).
...
1. [Создайте эндпоинт](../operations/endpoint/index.md#create) для источника MySQL® с [настройками](../operations/endpoint/source/mysql.md):
...
1. [Создайте эндпоинт](../operations/endpoint/index.md#create) для приемника Apache Kafka® с [настройками](../operations/endpoint/source/kafka.md):
...
1. [Создайте трансфер](../operations/transfer.md#create) типа **_Репликация_** с созданными эндпоинтами для источника и приемника.
