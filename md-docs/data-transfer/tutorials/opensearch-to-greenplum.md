...
- Вручную {#manual}
    ...
    1. [Создайте кластер-источник Managed Service for OpenSearch](../../managed-opensearch/operations/cluster-create.md#create-cluster) любой подходящей конфигурации с хостами в публичном доступе.
    ...
    1. Убедитесь, что группы безопасности кластеров [Managed Service for OpenSearch](../../managed-opensearch/operations/connect/index.md#security-groups) и [Greenplum®](../../managed-greenplum/operations/connect/index.md#configuring-security-groups) разрешают подключение через интернет.
...
1. [Создайте эндпоинт-источник](../operations/endpoint/index.md#create) для [созданного ранее](#before-you-begin) кластера Managed Service for OpenSearch с настройками:
...
1. [Создайте эндпоинт-приемник](../operations/endpoint/index.md#create) для [созданного ранее](#before-you-begin) кластера Greenplum® с настройками:

    * **Тип базы данных** — `Greenplum`.
    * **Параметры эндпоинта**:
        * **Тип подключения** — выберите `Кластер Managed Service for Greenplum`.
        * **Кластер Managed Service for Greenplum** — выберите кластер Greenplum® из списка.
