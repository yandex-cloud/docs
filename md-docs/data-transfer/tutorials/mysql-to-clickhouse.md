...
- {{ TF }} {#tf}
    ...
    1. Укажите в файле `data-transfer-mmy-mch.tf`:
        ...
        * параметры кластера-источника {{ mmy-name }}, которые будут использоваться как [параметры эндпоинта-источника](../operations/endpoint/target/mysql.md#managed-service):
