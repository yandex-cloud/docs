[Документация Yandex Cloud](../../index.md) > [Yandex Data Transfer](../index.md) > [Практические руководства](index.md) > Поставка данных из очередей > Apache Kafka® в ClickHouse®
...
- Terraform {#tf}
    ...
    1. Укажите в файле `data-transfer-mkf-mch.tf`:
        ...
        * Параметры кластера-приемника Managed Service for ClickHouse®, которые будут использоваться как [параметры эндпоинта-приемника](../operations/endpoint/target/clickhouse.md#managed-service):
