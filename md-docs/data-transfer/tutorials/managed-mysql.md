...
1. Подготовьте инфраструктуру и запустите перенос данных:
    ...
    - Вручную {#manual}
        ...
        1. [Активируйте](../operations/transfer.md#activate) его.
            ...
            Избегайте любых изменений в схеме данных в кластере-источнике и кластере-приемнике во время работы трансфера. Подробнее см. в разделе [Работа с базами данных во время трансфера](../operations/db-actions.md).
...
Реальный пример миграции базы данных MySQL® с помощью сервиса Data Transfer см. в разделе [Синхронизация данных из MySQL с помощью Yandex Data Transfer](../../tutorials/dataplatform/sync-mysql.md).
