[Документация Yandex Cloud](../../index.md) > [Yandex Data Transfer](../index.md) > [Практические руководства](index.md) > Захват изменений данных и поставка в очередь > PostgreSQL в YDS

# Захват изменений из PostgreSQL и поставка в Yandex Data Streams

Вы можете отслеживать изменения данных в _кластере-источнике_ Managed Service for PostgreSQL и отправлять их в _кластер-приемник_ Data Streams с помощью технологии [Change Data Capture](../concepts/cdc.md) (CDC).
...
1. [Создайте эндпоинт-приемник](../operations/endpoint/target/data-streams.md) типа `Data Streams` со следующими настройками:
...
1. [Активируйте трансфер](../operations/transfer.md#activate) и дождитесь его перехода в статус **_Реплицируется_**.
