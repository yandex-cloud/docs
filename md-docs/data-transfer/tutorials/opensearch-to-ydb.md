...
1. [Создайте эндпоинт-источник](../operations/endpoint/source/opensearch.md#endpoint-settings) типа `{{ OS }}` со следующими настройками:
...
1. Создайте эндпоинт-приемник и трансфер:
    ...
    * Вручную {#manual}
        ...
        1. [Создайте эндпоинт-приемник](../operations/endpoint/target/yandex-database.md#endpoint-settings) типа `{{ ydb-short-name }}` со следующими настройками:
