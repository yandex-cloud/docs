...
1. В рабочем каталоге настроен [трансфер](../concepts/index.md#transfer) Data Transfer, который забирает данные из потока и сохраняет в [бакет](../../storage/concepts/bucket.md) Object Storage.
