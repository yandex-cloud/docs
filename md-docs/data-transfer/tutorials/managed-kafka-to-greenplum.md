...
1. [Создайте эндпоинт-приемник](../operations/endpoint/target/greenplum.md) типа `Greenplum®`, укажите имя пользователя `user`.
1. Создайте и активируйте трансфер:
    ...
    - Вручную {#manual}
        ...
        1. [Создайте трансфер](../operations/transfer.md#create) типа _**Репликация**_, использующий созданные эндпоинты.
