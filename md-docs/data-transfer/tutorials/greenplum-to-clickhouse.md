...
- Вручную {#manual}
    ...
    1. [Создайте кластер-источник Greenplum® в сервисе Yandex MPP Analytics for PostgreSQL](../../managed-greenplum/operations/cluster-create.md#create-cluster) любой подходящей конфигурации.
    ...
    1. [Создайте эндпоинт-приемник](../operations/endpoint/target/clickhouse.md) типа `ClickHouse®`. В [параметрах](../operations/endpoint/target/clickhouse.md#additional-settings) эндпоинта укажите политику очистки `Drop` или `Truncate`, чтобы данные на приемнике не дублировались при копировании.
...
1. [Создайте эндпоинт-источник](../operations/endpoint/source/greenplum.md) типа `Greenplum®` и укажите в нем параметры подключения к кластеру.

1. [Создайте трансфер](../operations/transfer.md#create) типа [Копирование](../concepts/index.md#transfer-type), использующий эндпоинты для источника и приемника.
...
1. [Подключитесь к кластеру Greenplum®](../../managed-greenplum/operations/connect/index.md), создайте в нем таблицу `x_tab` и заполните ее данными:
...
1. [Подключитесь к кластеру Greenplum®](../../managed-greenplum/operations/connect/index.md), удалите одну строку и измените другую в таблице `x_tab`:
...
1. Повторно [активируйте трансфер](../operations/transfer.md#activate) и дождитесь его перехода в статус **Завершен**.
...
1. Убедитесь, что трансфер находится в статусе **Завершен** и [удалите](../operations/transfer.md#delete) его.
