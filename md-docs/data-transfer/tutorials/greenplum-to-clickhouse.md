...
* Кластер {{ mch-full-name }}: использование выделенных хостам вычислительных ресурсов, объем хранилища и резервных копий (см. [тарифы {{ mch-name }}](../../managed-clickhouse/pricing.md)).
...
- Вручную {#manual}
    ...
    1. [Создайте эндпоинт-приемник](../operations/endpoint/target/clickhouse.md) типа `{{ CH }}`. В [параметрах](../operations/endpoint/target/clickhouse.md#additional-settings) эндпоинта укажите политику очистки `Drop` или `Truncate`, чтобы данные на приемнике не дублировались при копировании.
...
1. [Создайте эндпоинт-источник](../operations/endpoint/source/greenplum.md) типа `{{ GP }}` и укажите в нем параметры подключения к кластеру.

1. [Создайте трансфер](../operations/transfer.md#create) типа [{{ ui-key.yc-data-transfer.data-transfer.console.form.transfer.console.form.transfer.TransferType.snapshot.title }}](../concepts/index.md#transfer-type), использующий эндпоинты для источника и приемника.
...
1. [Активируйте трансфер](../operations/transfer.md#activate) и дождитесь его перехода в статус **{{ ui-key.yacloud.data-transfer.label_connector-status-DONE }}**.
...
1. Повторно [активируйте трансфер](../operations/transfer.md#activate) и дождитесь его перехода в статус **{{ ui-key.yacloud.data-transfer.label_connector-status-DONE }}**.
...
1. Убедитесь, что трансфер находится в статусе **{{ ui-key.yacloud.data-transfer.label_connector-status-DONE }}** и [удалите](../operations/transfer.md#delete) его.
1. [Удалите](../operations/endpoint/index.md#delete) эндпоинт-источник.
