...
1. [Создайте эндпоинт для источника](../operations/endpoint/index.md#create) со следующими настройками:
...
1. Создайте эндпоинт для приемника и трансфер:
    ...
    - Вручную {#manual}
        ...
        1. [Создайте эндпоинт для приемника](../operations/endpoint/target/postgresql.md):
