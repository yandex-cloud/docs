[Документация Yandex Cloud](../../index.md) > [Yandex Data Transfer](../index.md) > [Практические руководства](index.md) > Загрузка данных в витрины > OpenSearch в ClickHouse®
...
- Вручную {#manual}
    ...
    1. Убедитесь, что группы безопасности кластеров [Managed Service for OpenSearch](../../managed-opensearch/operations/connect/index.md#security-groups) и [Managed Service for ClickHouse®](../../managed-clickhouse/operations/connect/index.md#configuring-security-groups) разрешают подключение через интернет.
...
1. Создайте эндпоинт-приемник и трансфер:
    ...
    - Вручную {#manual}
        ...
        1. [Создайте эндпоинт-приемник](../operations/endpoint/index.md#create):
