...
1. Создайте трансфер:
    ...
    - Вручную {#manual}
        ...
        1. [Создайте трансфер](../operations/transfer.md#create) типа [**{{ ui-key.yc-data-transfer.data-transfer.console.form.transfer.console.form.transfer.TransferType.snapshot_and_increment.title }}**](../concepts/index.md#transfer-type), использующий созданные эндпоинты, и [активируйте](../operations/transfer.md#activate) его.
