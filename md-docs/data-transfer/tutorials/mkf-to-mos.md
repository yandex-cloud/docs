...
1. [Создайте эндпоинт](../operations/endpoint/index.md#create) для [источника `{{ KF }}`](../operations/endpoint/source/kafka.md):
...
1. [Создайте эндпоинт](../operations/endpoint/index.md#create) для [приемника `{{ OS }}`](../operations/endpoint/target/opensearch.md):
