...
Сервис {{ data-transfer-name }} позволяет протестировать работу с сервисами [{{ mmg-full-name }}](../../storedoc/index.md), [{{ mmy-full-name }}](../../managed-mysql/index.md) и [{{ mpg-full-name }}](../../managed-postgresql/index.md) на реальных данных.
