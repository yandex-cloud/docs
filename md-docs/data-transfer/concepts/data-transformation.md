[Документация Yandex Cloud](../../index.md) > [Yandex Data Transfer](../index.md) > [Концепции](index.md) > Трансформация данных
...
Трансформация данных доступна, только если источник и приемник имеют разные [типы](index.md#connectivity-matrix).
...
* [Переименование таблиц](data-transformation.md#rename-tables)
* [Фильтр колонок](data-transformation.md#columns-filter)
* [Маскирование данных](data-transformation.md#data-mask)
* [Разделение на подтаблицы](data-transformation.md#subtable-splitting)
* [Замена первичных ключей](data-transformation.md#replace-primary-key)
* [Преобразование значений колонок в строки](data-transformation.md#convert-to-string)
* [Шардирование](data-transformation.md#shard)
* [Фильтр строк для APPEND-ONLY источников](data-transformation.md#append-only-sources)
...
Фильтрация колонок применяется на завершающем этапе обработки данных, уже после того, как строка была полностью прочитана из источника и прошла первичные преобразования (например, маппинг типов или изменение значений).
