...
* с помощью [{{ interconnect-full-name }}](../../interconnect/index.md);
* с помощью [VPN](../../glossary/vpn.md).

Если вам нужно перенести данные между вашим облаком {{ yandex-cloud }} и другим облаком (в том числе другим облаком {{ yandex-cloud }}) или между вашим облаком {{ yandex-cloud }} и кластером пользовательской инсталляции на вашей площадке, разрешите подключения к базе данных в стороннем облаке или на вашей площадке из интернета с [IP-адресов, используемых сервисом {{ data-transfer-name }}](../../overview/concepts/public-ips.md#virtual-private-cloud).

Если вы используете для подключения [сервис {{ interconnect-name }}](../../interconnect/concepts/index.md) или [VPN](../../glossary/vpn.md), отдельные настройки стороннего облака не требуются. Чтобы обеспечить сетевую связность, укажите в настройках эндпоинта подсеть, из которой можно подключиться к внешнему ресурсу.
