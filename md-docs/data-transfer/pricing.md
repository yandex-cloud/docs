...
- Расчет в рублях {#prices-rub}
  ...
  > 24 * 2 * 1,51 ₽ = {% calc [currency=RUB] 24 * 2 * 1.51 %}
  
  Стоимость RAM:
  
  > 24 * 4 * 0,4035 ₽ = {% calc [currency=RUB] 24 * 4 * 0.4035 %}
  
  Стоимость передачи данных:
  
  > (500 - 100) * 3,11 ₽ = {% calc [currency=RUB] (500 - 100) * 3.11 %}
  
  **Общая стоимость**:
  
  > {% calc [currency=RUB] 24 * 2 * 1.51 %} + {% calc [currency=RUB] 24 * 4 * 0.4035 %} + {% calc [currency=RUB] (500 - 100) * 3.11 %} = {% calc [currency=RUB] (24 * 2 * 1.51) + (24 * 4 * 0.4035) + ((500 - 100) * 3.11) %}

- Расчет в тенге {#prices-kzt}

  Стоимость CPU:
  
  > 24 * 2 * 7,55 ₸ = {% calc [currency=KZT] 24 * 2 * 7.55 %}
  
  Стоимость RAM:
  
  > 24 * 4 * 2,0175 ₸ = {% calc [currency=KZT] 24 * 4 * 2.0175 %}
  
  Стоимость передачи данных:
  
  > (500 - 100) * 15,55 ₸ = {% calc [currency=KZT] (500 - 100) * 15.55 %}
  
  **Общая стоимость**:
  
  > {% calc [currency=KZT] 24 * 2 * 7.55 %} + {% calc [currency=KZT] 24 * 4 * 2.0175 %} + {% calc [currency=KZT] (500 - 100) * 15.55 %} = {% calc [currency=KZT] (24 * 2 * 7.55) + (24 * 4 * 2.0175) + ((500 - 100) * 15.55) %}
...
- Расчет в рублях {#prices-rub}
  ...
  > 30 * 24 * 12 * 1,51 ₽ = {% calc [currency=RUB] 30 * 24 * 12 * 1.51 %}
  
  Стоимость RAM:
  
  > 30 * 24 * 24 * 0,4035 ₽ = {% calc [currency=RUB] 30 * 24 * 24 * 0.4035 %}
  ...
  **Общая стоимость**:
  ...
  > {% calc [currency=RUB] 30 * 24 * 12 * 1.51 %} + {% calc [currency=RUB] 30 * 24 * 24 * 0.4035 %} = {% calc [currency=RUB] (30 * 24 * 12 * 1.51) + (30 * 24 * 24 * 0.4035) %}

- Расчет в тенге {#prices-kzt}

  Стоимость CPU:
  
  > 30 * 24 * 12 * 7,55 ₸ = {% calc [currency=KZT] 30 * 24 * 12 * 7.55 %}
  
  Стоимость RAM:
  
  > 30 * 24 * 24 * 2,0175 ₸ = {% calc [currency=KZT] 30 * 24 * 24 * 2.0175 %}
  ...
  **Общая стоимость**:
  ...
  > {% calc [currency=KZT] 30 * 24 * 12 * 7.55 %} + {% calc [currency=KZT] 30 * 24 * 24 * 2.0175 %} = {% calc [currency=KZT] (30 * 24 * 12 * 7.55) + (30 * 24 * 24 * 2.0175) %}
