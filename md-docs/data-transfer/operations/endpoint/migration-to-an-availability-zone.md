[Документация Yandex Cloud](../../../index.md) > [Yandex Data Transfer](../../index.md) > [Пошаговые инструкции](../index.md) > [Настройка эндпоинтов](index.md) > Миграция эндпоинтов в другую зону доступности
