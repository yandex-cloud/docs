[Документация Yandex Cloud](../../../../index.md) > [Yandex Data Transfer](../../../index.md) > [Пошаговые инструкции](../../index.md) > [Настройка эндпоинтов](../index.md) > MongoDB/Yandex StoreDoc > Приемник

# Передача данных в эндпоинт-приемник MongoDB/Yandex StoreDoc (Managed Service for MongoDB)


С помощью сервиса Yandex Data Transfer вы можете переносить данные в базу MongoDB/Yandex StoreDoc (Managed Service for MongoDB) и реализовывать различные сценарии переноса, обработки и трансформации данных. Для реализации трансфера:

1. [Ознакомьтесь с возможными сценариями передачи данных](#scenarios).
1. [Настройте один из поддерживаемых источников данных](#supported-sources).
1. [Подготовьте базу данных MongoDB/Yandex StoreDoc (Managed Service for MongoDB)](#prepare) к трансферу.
...
## Сценарии передачи данных в MongoDB/Yandex StoreDoc (Managed Service for MongoDB) {#scenarios}
...
1. Поставка данных — процесс доставки произвольных данных в целевые хранилища. Процесс поставки включает извлечение данных из очереди и их десериализацию с последующей трансформацией данных в формат целевого хранилища.
    ...
    * [Поставка данных из Apache Kafka® в Yandex StoreDoc (Managed Service for MongoDB)](../../../tutorials/mkf-to-mmg.md).
...
## Настройка эндпоинта-приемника MongoDB/Yandex StoreDoc (Managed Service for MongoDB) {#endpoint-settings}
...
**Решение:** [исключите](../source/mongodb.md) из трансфера коллекции, превышающие лимиты MongoDB, после чего [активируйте](../../transfer.md#activate) трансфер повторно.
