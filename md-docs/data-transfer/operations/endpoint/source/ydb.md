[Документация Yandex Cloud](../../../../index.md) > [Yandex Data Transfer](../../../index.md) > [Пошаговые инструкции](../../index.md) > [Настройка эндпоинтов](../index.md) > YDB > Источник
...
- Консоль управления {#console}
  ...
  * **Список включенных путей** — добавьте пути к таблицам или директориям Managed Service for YDB, которые необходимо перенести.
      ...
      Имена таблиц и директорий должны соответствовать правилам именования идентификаторов в YDB. Экранирование двойных кавычек не требуется. В пути в качестве разделителя используется символ `/`. Подробнее в [документации YDB](https://ydb.tech/docs/ru//concepts/connect#database).
