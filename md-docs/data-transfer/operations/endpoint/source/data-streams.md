...
- Консоль управления {#console}
    ...
    * Выберите тип подключения **Настроить вручную** или **База Managed Service for YDB**.
      
      Для настройки подключения вручную укажите:
    
        * **База данных** — укажите базу данных [Managed Service for YDB](../../../../ydb/index.md).
    
        * **Поток** — укажите имя потока, ассоциированного с базой данных.
    
        * **Эндпоинт YDB** — хост и порт инстанса Managed Service for YDB.
        ...
        * **Сертификат CA** — загрузите файл с PEM-cертификатом центра сертификации X.509, используемый  для аутентификации подключений к базе данных YDB. Если указан, то при подключении используется TLS.
        
        * **Идентификатор подсети** — укажите идентификатор подсети (или создайте новую подсеть) для выделенного (Dedicated) режима базы данных Managed Service for YDB. В этом режиме БД разворачивается на собственных вычислительных узлах, которым требуются сетевые ресурсы
          Yandex Cloud.
      ...
      Для настройки подключения к Yandex Managed Service for YDB:
