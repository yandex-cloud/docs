[Документация Yandex Cloud](../../../index.md) > [Yandex Data Transfer](../../index.md) > [Пошаговые инструкции](../index.md) > Настройка эндпоинтов > Управление эндпоинтами
...
- API {#api}
  ...
  * Параметры эндпоинта в параметре `settings`.
   ...
   Параметры эндпоинта читайте в разделе настроек для нужного источника или приемника данных.
