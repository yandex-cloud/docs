...
Активация необходима каждому новому трансферу. Исключение: трансфер типа `INCREMENT_ONLY` или `SNAPSHOT_AND_INCREMENT`, [созданный](transfer.md#create) с помощью Terraform.
