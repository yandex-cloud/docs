[Документация Yandex Cloud](../../index.md) > [Monium](../index.md) > [Поставка данных](index.md) > Otel Collector > Пример мониторинга ансамбля микросервисов в Kubernetes
...
- Интерфейс Monium {#console}
  ...
  1. На главной странице [Monium](https://monium.yandex.cloud) слева выберите ![alt](../../_assets/console-icons/box.svg) **Поставка и хранение** → ![alt](../../_assets/console-icons/layers.svg) **Шарды**.
  ...
  1. Чтобы посмотреть отдельный тип данных, слева наведите указатель на ![alt](../../_assets/console-icons/compass.svg) **Обзор** и выберите раздел с нужным типом данных:
