[Документация Yandex Cloud](../../../index.md) > [Monium](../../index.md) > Поставка данных > Fluent Bit > Обработка логов
...
В заголовке `x-monium-project: [ProjectID]` укажите идентификатор проекта Monium — `folder__<идентификатор_каталога>`.
