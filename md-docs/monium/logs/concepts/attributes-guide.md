[Документация Yandex Cloud](../../../index.md) > [Monium](../../index.md) > Логи > Концепции > Рекомендации по разметке логов
...
Дополнительно про имена ключей в [документации OpenTelemetry](https://opentelemetry.io/docs/specs/semconv/general/attribute-naming/).
