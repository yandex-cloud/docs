[Документация Yandex Cloud](../../index.md) > [Monium](../index.md) > Логи > Начало работы с логами приложений
...
Сведения о ресурсах Yandex Cloud приведены в разделе [Начало работы с логами ресурсов Yandex Cloud](quickstart-resources.md).
...
### Параметры Cloud Logging {#main-parameters}
