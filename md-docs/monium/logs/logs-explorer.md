...
* Для ресурсов Yandex Cloud включите логирование. Обычно логирование можно настроить при создании или изменении ресурса. Подробнее в документации нужного сервиса.
  ...
  Список сервисов, которые поддерживают автоматический сбор логов, приведен в разделе [Observability-инструменты мониторинга и логирования](../../overview/concepts/monitoring-logging-tools.md).
