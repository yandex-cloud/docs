[Документация Yandex Cloud](../../index.md) > [Monium](../index.md) > [Метрики](overview.md) > Начало работы с метриками ресурсов Yandex Cloud
...
- Интерфейс Monium {#console}
  ...
  1. Вернитесь на страницу редактирования дашборда: вверху нажмите на заголовок дашборда, который указали ранее.
