[Документация Yandex Cloud](../../../index.md) > [Monium](../../index.md) > Справочник API > Метрики > [REST](../index.md) > [MetricsData](index.md) > read
...
Поле | Описание
--- | ---
query | **string**<br><p>Обязательное поле. Текст запроса. Синтаксис описан в разделе [Язык запросов в Monium](../../concepts/querying.md).</p>
