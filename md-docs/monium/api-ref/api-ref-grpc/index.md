...
Методы справочника API сгруппированы по ресурсам. Чтобы выполнить операцию над ресурсом, сделайте RPC-вызов. Подробнее см. в документации [Концепции API Yandex Cloud](../../../api-design-guide/index.md).
