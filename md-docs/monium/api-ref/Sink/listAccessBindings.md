[Документация Yandex Cloud](../../../index.md) > [Monium](../../index.md) > Справочник API > Логи > [REST (англ.)](../index.md) > [Sink](index.md) > ListAccessBindings
...
```
GET https://logging.api.cloud.yandex.net/logging/v1/sinks/{resourceId}:listAccessBindings
```
