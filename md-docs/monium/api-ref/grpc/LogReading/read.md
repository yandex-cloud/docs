[Документация Yandex Cloud](../../../../index.md) > [Monium](../../../index.md) > Справочник API > Логи > [gRPC (англ.)](../index.md) > [LogReading](index.md) > Read
...
Filter expression. For details about filtering, see [documentation](../../../../logging/concepts/filter.md).
...
Entry ingestion time observed by [LogIngestionService](../../../../logging/api-ref/grpc/LogIngestion/index.md). ||
