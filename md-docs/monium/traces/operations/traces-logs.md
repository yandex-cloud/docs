[Документация Yandex Cloud](../../../index.md) > [Monium](../../index.md) > [Трейсы](../index.md) > Работа с трейсами > Связь трейсов с логами
...
1. Откройте страницу с логами и найдите нужную запись. Подробнее о просмотре логов в разделе [Поиск и анализ логов](../../logs/logs-explorer.md).
...
Откроется [Поиск и анализ логов](../../logs/logs-explorer.md) с уже подставленным фильтром по `trace_id` или по `trace_id` и `span_id`.