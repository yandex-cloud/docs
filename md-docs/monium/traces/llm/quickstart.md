...
Подробнее про автоматическую инструментацию LLM-приложений читайте в разделе [Автоматическая инструментация LLM-приложений](auto_instrumentation.md).
...
Подробнее про ручную инструментацию LLM-приложений читайте в разделе [Ручная инструментация LLM-приложений](manual_instrumentation.md).