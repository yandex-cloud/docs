[Документация Yandex Cloud](../../../index.md) > [Monium](../../index.md) > [Трейсы](../index.md) > LLM-мониторинг > Просмотр и анализ LLM-трейсов
...
Синтаксис и полный список поддерживаемых ключей приведены в разделе [Язык запросов](../operations/query-language.md).