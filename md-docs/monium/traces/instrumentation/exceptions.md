[Документация Yandex Cloud](../../../index.md) > [Monium](../../index.md) > [Трейсы](../index.md) > Инструментация приложений > Обработка ошибок
...
Базовый паттерн обработки ошибок описан в разделе [Статусы и ошибки](manual.md#status). Эта страница описывает атрибуты события `exception` согласно [спецификации OpenTelemetry](https://opentelemetry.io/docs/specs/semconv/exceptions/exceptions-spans/).
