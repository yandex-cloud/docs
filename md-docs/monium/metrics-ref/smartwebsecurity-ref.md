[Документация Yandex Cloud](../../index.md) > [Monium](../index.md) > [Метрики](../metrics/overview.md) > [Справочник метрик](index.md) > Smart Web Security

# Метрики Yandex Smart Web Security


В этом разделе описаны метрики сервиса [Smart Web Security](../../smartwebsecurity/index.md), поставляемые в Monium Metrics сервисом [Yandex Application Load Balancer](../../application-load-balancer/index.md).
