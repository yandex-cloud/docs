[Документация Yandex Cloud](../../index.md) > [Monium](../index.md) > [Метрики](../metrics/overview.md) > [Справочник метрик](index.md) > Cloud CDN
...
При просмотре метрик в [интерфейсе Monium Metrics](https://monium.yandex.cloud) временные значения метрик соответствуют реальным.
