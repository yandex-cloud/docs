...
В этом разделе описаны метрики сервиса [{{ mrd-name }}](../../managed-valkey/index.md), поставляемые в {{ monitoring-name }}.
