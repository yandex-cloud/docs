[Документация Yandex Cloud](../../../index.md) > [Monium](../../index.md) > Концепции > Строка запроса

# Строка запроса в Monium

Строка запроса позволяет указать параметры для построения графиков или выборки нужных данных. Описание [языка запросов](../querying.md), модели данных и объектов конфигурации — в разделах [Модель данных в Monium](../data-model.md) и [Конфигурация объектов Monium](../configuration-model.md).

Введите запрос в режиме токенов ![chart](../../../_assets/monitoring/chart.svg) или в текстовом режиме ![code](../../../_assets/console-icons/code.svg).

## Запрос токенами {#query-token}

Этот режим активен по умолчанию. Внешний вид строки в режиме токенов:

![Строка запроса в режиме токенов](../../../_assets/monium/query_string_tokens_2026.png "Строка запроса в режиме токенов")
...
* **Cmd/Ctrl + Delete** — удалить текущий токен.
* **Cmd/Ctrl + Z** — отменить действие.
* **Cmd + Shift + Z** или **Ctrl + Y** — повторить действие.
* **Shift + Space** — перейти к значению метки.
* **Cmd/Ctrl + I** — открыть меню подсказок.
...
![Строка запроса в текстовом режиме](../../../_assets/monium/query_string_text_2026.png "Строка запроса в текстовом режиме")

В текстовом режиме запросы записываются как функции. Аргументами функций выступают токены, результаты выполнения других функций или другие запросы. Поддерживается подсветка синтаксиса: имена функций, ключевые слова и значения меток выделяются разными цветами.
