...
Строка запроса позволяет указать параметры для построения графиков или выборки нужных данных.
...
![Строка запроса в токенизированном режиме](../../../_assets/monium/query_string_tokens_2026.png "Строка запроса в токенизированном режиме")
