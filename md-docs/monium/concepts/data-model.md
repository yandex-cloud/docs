...
В сервисе Monium действует единая модель данных для работы с телеметрией (метриками, логами и трейсами) и универсальные правила поиска данных с помощью языка запросов.

В этом разделе описана организация данных и особенности каждого вида данных. Поиск по данным см. в разделе [Язык запросов в Monium](querying.md).
...
Подробнее о выборе меток или метаинформации для логов см. в разделе [Рекомендации по разметке логов](../logs/concepts/attributes-guide.md).
