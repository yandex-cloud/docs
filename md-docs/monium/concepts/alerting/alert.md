...
Уровень критичности алерта. Помогает расставить приоритеты при реагировании: по уровню видно, какие алерты требуют немедленного вмешательства, а какие носят информационный характер. Уровень удобно использовать для фильтрации и маршрутизации уведомлений.

Уровень | Описание
----- | -----
`Unspecified` | Уровень не задан.
`Disaster` | Критический сбой, который требует немедленного реагирования.
`Critical` | Серьезная проблема, которая влияет на работу сервиса.
`Info` | Информационное уведомление. Значение по умолчанию.
