...
1. На главной странице сервиса выберите раздел **{{ ui-key.yacloud_monitoring.aside-navigation.menu-item.dashboards.title }}** и откройте дашборд или [создайте](create.md) дашборд. 
