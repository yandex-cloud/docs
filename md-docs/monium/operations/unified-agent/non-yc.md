...
1. [Установите и настройте Unified Agent](../../concepts/data-collection/unified-agent/installation.md) для сбора и отправки метрик.
...
Поставка системных метрик возможна только с хостов Linux на платформе AMD. Поддержка Windows и macOS запланирована в будущих релизах Unified Agent.

{% endnote %}

## Поставка метрик с использованием авторизованного ключа {#example}

1. Настройте сервисный аккаунт, от имени которого будут записываться метрики в Monium Metrics и создайте авторизованный ключ.
...
1. [Установите и настройте на хосте Unified Agent](../../concepts/data-collection/unified-agent/installation.md):
