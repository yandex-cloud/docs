[Документация Yandex Cloud](../../../index.md) > [Monium](../../index.md) > [Yandex Managed Service for Prometheus®](index.md) > Правила алертинга
...
* Каналы уведомлений из файла конфигурации сопоставляются с [каналами уведомлений](../../concepts/alerting/notification-channel.md) в Monium Metrics, которые заданы в каталоге воркспейса.
