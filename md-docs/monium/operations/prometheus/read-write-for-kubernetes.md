[Документация Yandex Cloud](../../../index.md) > [Monium](../../index.md) > [Yandex Managed Service for Prometheus®](index.md) > Чтение и запись метрик кластера Kubernetes
...
1. Если у вас еще нет воркспейса Prometheus, создайте его:
   ...
   - Консоль управления {#console}
      ...
      1. Откройте [главную страницу сервиса](https://monium.yandex.cloud) Monium Metrics.
...
- Консоль управления {#console}
   ...
   1. В разделе **Доступные для установки приложения** выберите [Prometheus Operator с поддержкой Monium Metrics](https://yandex.cloud/ru/marketplace/products/yc/prometheus-operator) и нажмите кнопку **Перейти к установке**.
