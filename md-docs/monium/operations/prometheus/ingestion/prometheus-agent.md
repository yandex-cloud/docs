[Документация Yandex Cloud](../../../../index.md) > [Monium](../../../index.md) > [Yandex Managed Service for Prometheus®](../index.md) > [Запись метрик](index.md) > Агент сбора метрик
...
1. Настройте авторизацию агента в Monium Metrics API. Для этого [привяжите созданный сервисный аккаунт](../../../../compute/operations/vm-connect/auth-inside-vm.md#link-sa-with-instance) к виртуальной машине. В этом случае агент будет автоматически получать IAM-токен сервисного аккаунта из сервиса метаданных.
...
- Консоль управления {#console}
  ...
  1. [Перейдите](https://monium.yandex.cloud) в сервис **Monium Metrics**.
