[Документация Yandex Cloud](../../../../index.md) > [Monium](../../../index.md) > [Yandex Managed Service for Prometheus®](../index.md) > [Запись метрик](index.md) > Remote Write
...
1. В [консоли управления](https://console.yandex.cloud) перейдите в каталог, в котором хотите хранить данные.
1. [Создайте сервисный аккаунт](../../../../iam/operations/sa/create.md) с ролью `monitoring.editor` на выбранный каталог.
