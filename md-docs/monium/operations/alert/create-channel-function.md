...
- Консоль управления {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором находятся ресурсы, наблюдаемые в Monium Metrics.
  ...
  1. [Перейдите](https://monium.yandex.cloud) в **Monium** и слева выберите раздел **Способы уведомления**.
