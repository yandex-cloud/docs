[Документация Yandex Cloud](../../../index.md) > [Monium](../../index.md) > Алерты > Пошаговые инструкции > Создание webhook с вызовом внешнего API
...
- Консоль управления {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) выберите каталог с ресурсами, которые надо отслеживать в Monium Metrics.
...
- Интерфейс Monium {#console}
  ...
  1. На главной странице [Monium](https://monium.yandex.cloud) слева выберите ![alt](../../../_assets/console-icons/shield-exclamation.svg) **Алерты и SLO** → ![alt](../../../_assets/console-icons/bell.svg) **Способы уведомления**.
