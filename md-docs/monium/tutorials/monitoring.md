...
* плата за запись пользовательских [метрик](../../monitoring/concepts/data-model.md#metric) через API сервиса [Monium Metrics](../../monitoring/index.md) (см. [тарифы Monium Metrics](../../monitoring/pricing.md)).
  ...
  1. Создайте версию функции:
      ...
      1. В блоке **Параметры** укажите:
          ...
          * **Переменные окружения**:
              ...
              `METRICS_FOLDER_ID` | Идентификатор каталога, в котором развернуты сервисы и для которого вы создадите дашборд в сервисе Monium Metrics. | См. в [консоли управления](https://console.yandex.cloud).
