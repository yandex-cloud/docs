[Документация Yandex Cloud](../../../../../index.md) > [Yandex MPP Analytics for PostgreSQL](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [v0](../../index.md) > [pxf-datasource](../index.md) > [create](index.md) > jdbc
