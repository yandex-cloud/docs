...
На графике **Hybrid Storage** можно отслеживать количество файлов в холодном хранилище и их суммарный размер. Количество и общий размер файлов могут уменьшаться со временем благодаря процедуре очистки гибридного хранилища. Подробнее в разделе [{#T}](../concepts/hybrid-storage.md)
