...
### Кластеры и хосты Greenplum® {#toc-cluster-hosts}
...
* [Почему возникает ошибка о минимальном объеме памяти для процессов Greenplum®?](#memory-limit)
...
## Кластеры и хосты Greenplum® {#cluster-hosts}
...
Ошибка возникает, если при количестве соединений, достигающем значения настройки [max_connections](../concepts/settings-list.md#setting-max-connections), объем памяти на каждый процесс Greenplum® составляет меньше 20 МБ. Минимальный объем памяти на каждый процесс кластера рассчитывается по формуле:
