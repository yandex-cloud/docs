...
* В Командном центре для кластеров на ядре Apache Cloudberry™ 2 теперь доступно управление ресурсными группами.
...
* Доступна новая версия Greenplum® 6.25. В ней по умолчанию доступны инструменты [интеграции с гибридным хранилищем](tutorials/yezzey.md) и [командный центр](concepts/command-center.md).
