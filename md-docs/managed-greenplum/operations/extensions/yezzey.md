...
Подробнее о типах хранилищ и расширении Yezzey см. в разделе [Гибридное хранилище](../../concepts/hybrid-storage.md).

## Установить расширение Yezzey в кластер Greenplum® {#install-extension}
...
1. Выполните один из запросов, чтобы узнать, где размещена таблица:
    ...
    * С указанием схемы, где расположена таблица, и имени таблицы:
    ...
    Будет выведена информация о каждом сегменте кластера Greenplum®, в котором размещены данные таблицы.
...
Пример использования расширения для работы с гибридным хранилищем см. в разделе [Выгрузка данных Greenplum® в холодное хранилище Yandex Object Storage](../../tutorials/yezzey.md).
