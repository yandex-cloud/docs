...
Подробнее о типах хранилищ и расширении Yezzey читайте в разделе [Гибридное хранилище](../../concepts/hybrid-storage.md).

## Установить расширение Yezzey в кластер Yandex MPP Analytics for PostgreSQL {#install-extension}
...
Пример использования расширения для работы с гибридным хранилищем описан в разделе [Выгрузка данных Greenplum® в гибридное хранилище Yandex Object Storage](../../tutorials/yezzey.md).
