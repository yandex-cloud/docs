...
- Консоль управления {#console}
    ...
    1. Нажмите на имя нужного кластера и перейдите на вкладку **Командный центр**.
...
- Консоль управления {#console}
    ...
    1. Перейдите на [страницу каталога](https://console.yandex.cloud).
    1. [Перейдите](https://console.yandex.cloud/link/managed-greenplum) в сервис **Yandex MPP Analytics for&nbsp;PostgreSQL**.
    1. Нажмите на имя нужного кластера и перейдите на вкладку **Командный центр** → **История потребления**.
...
- Консоль управления {#console}
    ...
    1. Перейдите на [страницу каталога](https://console.yandex.cloud).
    1. [Перейдите](https://console.yandex.cloud/link/managed-greenplum) в сервис **Yandex MPP Analytics for&nbsp;PostgreSQL**.
    1. Нажмите на имя нужного кластера и перейдите на вкладку **Командный центр** → **Текущее состояние**.
...
- Консоль управления {#console}
    ...
    1. Узнайте, когда было зафиксировано высокое потребление CPU:
        ...
        1. Перейдите на [страницу каталога](https://console.yandex.cloud).
        1. [Перейдите](https://console.yandex.cloud/link/managed-greenplum) в сервис **Yandex MPP Analytics for&nbsp;PostgreSQL**.
        1. Нажмите на имя нужного кластера и перейдите на вкладку **Командный центр** → **История состояний**.
