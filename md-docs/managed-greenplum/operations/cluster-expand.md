[Документация Yandex Cloud](../../index.md) > [Yandex MPP Analytics for PostgreSQL](../index.md) > [Пошаговые инструкции](index.md) > Кластеры > Расширение кластера
...
- Консоль управления {#console}
    ...
    1. Выберите кластер и откройте вкладку **Хосты**.
