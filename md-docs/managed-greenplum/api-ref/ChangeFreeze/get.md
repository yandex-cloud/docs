[Документация Yandex Cloud](../../../index.md) > [Yandex MPP Analytics for PostgreSQL](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [ChangeFreeze](index.md) > Get

# Managed Service for Greenplum® API, REST: ChangeFreeze.Get
...
```
GET https://mdb.api.cloud.yandex.net/managed-greenplum/v1/changeFreezes/{changeFreezeId}
```
