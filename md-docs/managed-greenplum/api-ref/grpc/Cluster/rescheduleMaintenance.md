[Документация Yandex Cloud](../../../../index.md) > [Yandex MPP Analytics for PostgreSQL](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Cluster](index.md) > RescheduleMaintenance

# Managed Service for Greenplum® API, gRPC: ClusterService.RescheduleMaintenance

Reschedule planned maintenance operation.

## gRPC request

**rpc RescheduleMaintenance ([RescheduleMaintenanceRequest](#yandex.cloud.mdb.greenplum.v1.RescheduleMaintenanceRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## RescheduleMaintenanceRequest {#yandex.cloud.mdb.greenplum.v1.RescheduleMaintenanceRequest}
...
|| metadata | **[RescheduleMaintenanceMetadata](#yandex.cloud.mdb.greenplum.v1.RescheduleMaintenanceMetadata)**
...
## RescheduleMaintenanceMetadata {#yandex.cloud.mdb.greenplum.v1.RescheduleMaintenanceMetadata}

#|
||Field | Description ||
|| cluster_id | **string**

Required field. Required. ID of the Greenplum cluster. ||
|| delayed_until | **[google.protobuf.Timestamp](https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#timestamp)**

Required field. Required. New time of the planned maintenance. Can be in the past for rescheduled to "IMMEDIATE". ||
|#
...
- `HEALTH_UNKNOWN`: Health of the cluster is unknown ([Host.health](listMasterHosts.md#yandex.cloud.mdb.greenplum.v1.Host) for every host in the cluster is UNKNOWN).
- `ALIVE`: Cluster is working normally ([Host.health](listMasterHosts.md#yandex.cloud.mdb.greenplum.v1.Host) for every host in the cluster is ALIVE).
- `DEAD`: Cluster is inoperable ([Host.health](listMasterHosts.md#yandex.cloud.mdb.greenplum.v1.Host) for every host in the cluster is DEAD).
- `DEGRADED`: Cluster is working below capacity ([Host.health](listMasterHosts.md#yandex.cloud.mdb.greenplum.v1.Host) for at least one host in the cluster is not ALIVE).
- `UNBALANCED`: Cluster is working below capacity ([Host.health](listMasterHosts.md#yandex.cloud.mdb.greenplum.v1.Host) for at least one host in the cluster is UNBALANCED). ||
|| status | enum **Status**
