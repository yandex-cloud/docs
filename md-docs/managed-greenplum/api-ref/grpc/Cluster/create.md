...
The string length in characters must be 1-32. ||
|| user_password | **string**
...
This subnet should be a part of the cloud network the cluster belongs to (see [Cluster.network_id](get.md#yandex.cloud.mdb.greenplum.v1.Cluster)).
