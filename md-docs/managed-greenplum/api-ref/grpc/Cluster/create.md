[Документация Yandex Cloud](../../../../index.md) > [Yandex MPP Analytics for PostgreSQL](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Cluster](index.md) > Create
...
**rpc Create ([CreateClusterRequest](#yandex.cloud.mdb.greenplum.v1.CreateClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## CreateClusterRequest {#yandex.cloud.mdb.greenplum.v1.CreateClusterRequest}
...
|| dbms_config | **[DBMSConfig](#yandex.cloud.mdb.greenplum.v1.DBMSConfig)**
...
#|
||Field | Description ||
|| effective_config | **[DBMSConfig](#yandex.cloud.mdb.greenplum.v1.DBMSConfig2)**

Required field. Effective settings for a Greenplum/Cloudberry (a combination of settings defined
in `user_config` and `default_config`). ||
|| user_config | **[DBMSConfig](#yandex.cloud.mdb.greenplum.v1.DBMSConfig2)**

User-defined settings for a Greenplum/Cloudberry. ||
|| default_config | **[DBMSConfig](#yandex.cloud.mdb.greenplum.v1.DBMSConfig2)**

Default configuration for a Greenplum/Cloudberry. ||
|#

## DBMSConfig {#yandex.cloud.mdb.greenplum.v1.DBMSConfig2}
