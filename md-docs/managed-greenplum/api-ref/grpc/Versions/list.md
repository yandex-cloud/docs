[Документация Yandex Cloud](../../../../index.md) > [Yandex MPP Analytics for PostgreSQL](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Versions](index.md) > List

# Managed Service for Greenplum® API, gRPC: VersionsService.List

Returns list of available Greenplum versions.

## gRPC request

**rpc List ([ListVersionsRequest](#yandex.cloud.mdb.greenplum.v1.ListVersionsRequest)) returns ([ListVersionsResponse](#yandex.cloud.mdb.greenplum.v1.ListVersionsResponse))**

## ListVersionsRequest {#yandex.cloud.mdb.greenplum.v1.ListVersionsRequest}
...
## ListVersionsResponse {#yandex.cloud.mdb.greenplum.v1.ListVersionsResponse}
