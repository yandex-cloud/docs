[Документация Yandex Cloud](../../../index.md) > [Yandex MPP Analytics for PostgreSQL](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Backup](index.md) > Delete
...
|| metadata | **[DeleteBackupMetadata](#yandex.cloud.mdb.greenplum.v1.DeleteBackupMetadata)**
...
## DeleteBackupMetadata {#yandex.cloud.mdb.greenplum.v1.DeleteBackupMetadata}
