[Документация Yandex Cloud](../../../index.md) > [Yandex MPP Analytics for PostgreSQL](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Versions](index.md) > List
...
```
GET https://mdb.api.cloud.yandex.net/managed-greenplum/v1/versions
```
