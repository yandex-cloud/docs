[Документация Yandex Cloud](../../../index.md) > [Yandex MPP Analytics for PostgreSQL](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Cluster](index.md) > Update
...
## Body parameters {#yandex.cloud.mdb.greenplum.v1.UpdateClusterRequest}
...
|| dbmsConfig | **[DBMSConfig](#yandex.cloud.mdb.greenplum.v1.DBMSConfig)**
...
#|
||Field | Description ||
|| effectiveConfig | **[DBMSConfig](#yandex.cloud.mdb.greenplum.v1.DBMSConfig2)**

Required field. Effective settings for a Greenplum/Cloudberry (a combination of settings defined
in `userConfig` and `defaultConfig`). ||
|| userConfig | **[DBMSConfig](#yandex.cloud.mdb.greenplum.v1.DBMSConfig2)**

User-defined settings for a Greenplum/Cloudberry. ||
|| defaultConfig | **[DBMSConfig](#yandex.cloud.mdb.greenplum.v1.DBMSConfig2)**
