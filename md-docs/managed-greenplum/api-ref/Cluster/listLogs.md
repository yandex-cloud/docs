...
This value is interchangeable with the [StreamLogRecord.nextRecordToken](streamLogs.md#yandex.cloud.mdb.greenplum.v1.StreamLogRecord) from [StreamLogs](streamLogs.md#StreamLogs) method. ||
|#
