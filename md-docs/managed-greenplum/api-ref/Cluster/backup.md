[Документация Yandex Cloud](../../../index.md) > [Yandex MPP Analytics for PostgreSQL](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Cluster](index.md) > Backup
...
|| metadata | **[BackupClusterMetadata](#yandex.cloud.mdb.greenplum.v1.BackupClusterMetadata)**
...
## BackupClusterMetadata {#yandex.cloud.mdb.greenplum.v1.BackupClusterMetadata}
