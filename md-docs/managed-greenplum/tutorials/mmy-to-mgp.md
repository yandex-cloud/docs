...
* Вручную {#manual}
    ...
    1. В той же зоне доступности [создайте кластер-приемник {{ GP }}](../operations/cluster-create.md#create-cluster) любой подходящей конфигурации с хостами в публичном доступе и следующими настройками:
...
1. [Подключитесь к служебной базе данных](../operations/connect/index.md) `postgres` в кластере-приемнике {{ GP }} от имени пользователя `mgp_user`.
...
1. [Подключитесь к базе данных](../operations/connect/index.md) `mgp_db` в кластере-приемнике {{ GP }}.
