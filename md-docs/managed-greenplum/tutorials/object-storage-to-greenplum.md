[Документация Yandex Cloud](../../index.md) > [Yandex MPP Analytics for PostgreSQL](../index.md) > [Практические руководства](index.md) > Загрузка данных из Object Storage в Yandex MPP Analytics for PostgreSQL с помощью Data Transfer
...
1. Подготовьте инфраструктуру:
    ...
    - Вручную {#manual}
        ...
        1. [Создайте кластер-приемник Greenplum®](../operations/cluster-create.md) любой подходящей конфигурации с хостами в публичном доступе и следующими настройками:
...
1. В кластере-приемнике [включите опцию](../operations/update.md#change-additional-settings) **Доступ из Data Transfer**.
...
1. [Подключитесь к служебной базе данных](../operations/connect/index.md) `postgres` в кластере-приемнике Greenplum® от имени пользователя `user1`.
...
1. [Подключитесь к базе данных](../operations/connect/index.md) `db1` в кластере-приемнике Greenplum®.
