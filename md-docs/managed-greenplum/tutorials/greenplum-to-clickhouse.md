...
- Вручную {#manual}
    ...
    1. [Создайте кластер-источник {{ GP }} в сервисе {{ mgp-name }}](../operations/cluster-create.md#create-cluster) любой подходящей конфигурации.
...
1. [Подключитесь к кластеру {{ GP }}](../operations/connect/index.md), удалите одну строку и измените другую в таблице `x_tab`:
