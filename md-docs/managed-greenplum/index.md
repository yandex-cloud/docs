...
Подробнее о Greenplum<sup>®</sup>, Apache Cloudberry<sup>™</sup> и Yandex MPP Analytics for PostgreSQL смотрите в разделе <a href="concepts/overview.md">Обзор</a>.
...
### Кластеры
 ...
 - [Обновление версии в Yandex MPP Analytics for PostgreSQL](operations/cluster-version-update.md)
...
## Концепции
 ...
 - [Обзор СУБД Greenplum® и Apache Cloudberry™ в сервисе Yandex MPP Analytics for PostgreSQL](concepts/overview.md)
