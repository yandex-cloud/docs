...
Сервис Yandex MPP Analytics for PostgreSQL помогает разворачивать и поддерживать кластеры Greenplum<sup>®</sup> версии 6 в инфраструктуре Yandex Cloud.
...
В Yandex MPP Analytics for PostgreSQL также доступна СУБД <a href="https://cloudberry.apache.org">Apache Cloudberry<sup>™</sup></a>. Она основана на Greenplum<sup>®</sup> версии 7 и будет базовым дистрибутивом для новых мажорных версий ядра сервиса.

Подробнее о Greenplum<sup>®</sup> и Yandex MPP Analytics for PostgreSQL см. в разделе <a href="concepts/overview.md">Обзор</a>.

Для сервиса действует <a href="https://yandex.ru/legal/cloud_sla/ru">соглашение об уровне обслуживания</a>. Уровень обслуживания сервиса определен в документе <a href="https://yandex.ru/legal/cloud_sla_greenplum/ru">Уровень обслуживания Сервиса Управления для Greenplum<sup>®</sup></a>.
...
### Логи и мониторинг
 ...
 - [Передача логов кластера в Yandex Cloud Logging](operations/mgp-to-cloud-logging.md)
...
## Практические руководства
 ...
 - [Миграция базы данных в Yandex MPP Analytics for PostgreSQL](tutorials/data-migration.md)

 - [Создание внешней таблицы на базе таблицы из бакета Object Storage с помощью конфигурационного файла](tutorials/config-server-for-s3.md)
 ...
 - [Копирование данных из Managed Service for OpenSearch в Yandex MPP Analytics for PostgreSQL с помощью Yandex Data Transfer](tutorials/opensearch-to-greenplum.md)
...
## Концепции
 ...
 - [Обзор СУБД Greenplum® и сервиса Yandex MPP Analytics for PostgreSQL](concepts/overview.md)
 ...
 - [Сеть в Yandex MPP Analytics for PostgreSQL](concepts/network.md)

### Хранилище в Yandex MPP Analytics for PostgreSQL
 ...
 - [Настройки Greenplum®](concepts/settings-list.md)
...
## Вопросы и ответы
 ...
 - [Кластер и хосты Greenplum®](qa/cluster-hosts.md)
