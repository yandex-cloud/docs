...
В Yandex MPP Analytics for PostgreSQL шифрование доступно только для локальных SSD-дисков (`local-ssd`). Чтобы включить шифрование, выберите этот тип диска как для хостов-мастеров, так и для хостов-сегментов. Если хотя бы для одного из этих типов хостов выбраны сетевые диски, включить шифрование нельзя.
