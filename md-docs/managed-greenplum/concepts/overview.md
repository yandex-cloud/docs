...
Кластеры {{ mgp-name }} можно интегрировать с другими сервисами {{ yandex-cloud }}, например с [{{ data-transfer-full-name }}](../../data-transfer/index.md) для переноса БД или с [{{ datalens-full-name }}](../../datalens/index.md) для визуализации данных.
