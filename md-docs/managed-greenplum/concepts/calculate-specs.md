...
Объем данных, который предполагается хранить в холодном хранилище, используя модуль [Yezzey](../operations/extensions/yezzey.md), не следует учитывать при расчете размера хранилища Yandex MPP Analytics for PostgreSQL.
