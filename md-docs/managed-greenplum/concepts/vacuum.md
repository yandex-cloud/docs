...
В Greenplum® по умолчанию используются [heap-таблицы](tables.md) — стандартный тип таблиц PostgreSQL. Для них команды `VACUUM` и `VACUUM FULL` работают следующим образом:
...
[Yezzey](../operations/extensions/yezzey.md) — это расширение Greenplum®, которое позволяет хранить таблицы AO и AOCO в [гибридном хранилище](hybrid-storage.md).
