...
* Больше 10 минут — по запросу сохранена вся информация. Например, когда запрос выполнялся, кто его выполнял, сколько ресурсов потреблялось на каждом из сегментов БД.
* Меньше 10 минут — информация сохранена в агрегированном виде. Можно узнать только суммарное потребление ресурсов в выбранный момент времени.
