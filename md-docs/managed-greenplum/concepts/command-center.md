...
_Командный центр Greenplum®_ — это инструмент, с помощью которого можно:
...
Параметры сессий и запросов описаны в разделе [Параметры командного центра Greenplum®](command-center-parameters.md).
...
Подробнее о том, как работать в командном центре, читайте в разделе [Работа с командным центром Greenplum®](../operations/command-center.md).
...
* `timestamp` — время старта сегмента Greenplum®.
