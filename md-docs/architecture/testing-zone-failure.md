[Документация Yandex Cloud](../index.md) > [Архитектурные решения](index.md) > Отказоустойчивость > Тестирование отказоустойчивости в Yandex Cloud > Тестирование инфраструктуры на основе Network Load Balancer
