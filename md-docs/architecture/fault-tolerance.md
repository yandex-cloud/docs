...
* Балансировщики нагрузки: 
   * [Сетевой балансировщик нагрузки ({{ network-load-balancer-name }})](../network-load-balancer/concepts/index.md);
   * [Балансировщик нагрузки уровня приложения ({{ alb-name }})](../application-load-balancer/concepts/index.md);

* Платформенные сервисы: 
   * управляемые базы данных (MDB);
   * [{{ managed-k8s-name }}](../managed-kubernetes/index.md) в отказоустойчивой конфигурации;

* Нативно отказоустойчивые облачные сервисы: 
   * [{{ objstorage-name }}](../storage/index.md);
