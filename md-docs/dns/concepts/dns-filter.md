[Документация Yandex Cloud](../../index.md) > [Yandex Cloud DNS](../index.md) > [Концепции](index.md) > Фильтры DNS
...
В каждом списке одного DNS-фильтра можно указать не более 255 FQDN. Подробнее в разделе [Лимиты](limits.md#cloud-dns-limits).
...
1. При создании фильтра можно сразу указать список облачных ресурсов, на уровне которых этот фильтр будет применяться. Один DNS-фильтр можно подключить не более чем к 100 ресурсам. Подробнее в разделе [Лимиты](limits.md#cloud-dns-limits).
