[Документация Yandex Cloud](../../index.md) > [Yandex Cloud DNS](../index.md) > [Практические руководства](index.md) > Настройка Cloud DNS для доступа к кластерам управляемых баз данных из других облачных сетей
...
* Публичные DNS-запросы и зоны DNS ([тарифы Cloud DNS](../pricing.md)).
...
1. Создайте зону DNS:
    ...
    - Вручную
        ...
        Создайте внутреннюю зону DNS с адресом `mdb.yandexcloud.net.` [по инструкции](../operations/zone-create-private.md). В списке сетей укажите сети `mch-net` и `another-net`.
...
- Вручную
    ...
    1. [Зону DNS](../operations/zone-delete.md).
