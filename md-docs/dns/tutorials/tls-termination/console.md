...
* плата за публичные [DNS-запросы](../../../glossary/dns.md) и [зоны DNS](../../concepts/dns-zone.md), если вы используете [Yandex Cloud DNS](../../index.md) (см. [тарифы Cloud DNS](../../pricing.md)).
