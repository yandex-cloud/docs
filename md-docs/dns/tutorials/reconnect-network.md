...
- Вручную {#manual}
    ...
    1. [Измените DNS-запись](../operations/resource-record-update.md), созданную [ранее](#dns-record), и укажите в параметре **Значение** FQDN хоста-мастера вновь созданного кластера.
