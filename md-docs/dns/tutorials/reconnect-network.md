...
- Вручную {#manual}
    ...
    1. [Создайте внутреннюю зону DNS](../operations/zone-create-private.md) с настройками:
    ...
    1. [Создайте DNS-запись](../operations/resource-record-create.md) с типом CNAME и настройками:
...
- Вручную {#manual}
    ...
    1. [Измените DNS-запись](../operations/resource-record-update.md), созданную [ранее](#dns-record), и укажите в параметре **{{ ui-key.yacloud.dns.label_records }}** FQDN хоста-мастера вновь созданного кластера.
...
- Вручную {#manual}
    ...
    1. [Удалите DNS-зону](../operations/zone-delete.md).
