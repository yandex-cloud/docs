[Документация Yandex Cloud](../../index.md) > [Yandex Cloud DNS](../index.md) > [Практические руководства](index.md) > Интеграция Managed Service for Kubernetes с корпоративной зоной DNS
...
Чтобы интегрировать [кластер Managed Service for Kubernetes](../../managed-kubernetes/concepts/index.md#kubernetes-cluster) с приватной корпоративной [зоной](../concepts/dns-zone.md) [DNS](../../glossary/dns.md):
...
* Публичные DNS-запросы и зона DNS ([тарифы Yandex Cloud DNS](../pricing.md)).
