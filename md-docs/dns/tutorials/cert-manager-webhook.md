[Документация Yandex Cloud](../../index.md) > [Yandex Cloud DNS](../index.md) > [Практические руководства](index.md) > Создание веб-хука резолвера ACME для ответов на DNS01-проверки
...
1. [Создайте сервисные аккаунты](../../iam/operations/sa/create.md):
   ...
   * `sa-dns-editor` с ролью `dns.editor` на каталог с [публичной зоной](../concepts/dns-zone.md#public-zones). От его имени будут создаваться [ресурсные записи](../concepts/resource-record.md) DNS.
