...
1. Подготовьте файл с описанием инфраструктуры:
    ...
    * [DNS-зона](../../concepts/dns-zone.md) — [yandex_dns_zone](../../../terraform/resources/dns_zone.md)
    * [Ресурсная запись DNS](../../concepts/resource-record.md) — [yandex_dns_recordset](../../../terraform/resources/dns_recordset.md)
