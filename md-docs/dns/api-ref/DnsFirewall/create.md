[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud DNS](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [DnsFirewall](index.md) > Create

# Cloud DNS API, REST: DnsFirewall.Create
...
```
POST https://dns.api.cloud.yandex.net/dns/v1/firewalls
```

## Body parameters {#yandex.cloud.dns.v1.CreateDnsFirewallRequest}
...
Required field. ID of the folder to create DNS firewalls in.
