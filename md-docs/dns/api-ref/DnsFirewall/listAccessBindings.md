[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud DNS](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [DnsFirewall](index.md) > ListAccessBindings
...
```
GET https://dns.api.cloud.yandex.net/dns/v1/firewalls/{resourceId}:listAccessBindings
```
