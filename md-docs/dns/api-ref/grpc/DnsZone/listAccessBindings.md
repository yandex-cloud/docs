[Документация Yandex Cloud](../../../../index.md) > [Yandex Cloud DNS](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [DnsZone](index.md) > ListAccessBindings

# Cloud DNS API, gRPC: DnsZoneService.ListAccessBindings
