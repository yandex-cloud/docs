[Документация Yandex Cloud](../../../../index.md) > [Yandex Cloud DNS](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [DnsZone](index.md) > Update
...
To get the DNS zone ID, make a [DnsZoneService.List](list.md#List) request.
...
1. Get the current set of labels with a [DnsZoneService.Get](get.md#Get) request.
