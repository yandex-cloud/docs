[Документация Yandex Cloud](../index.md) > [Yandex Cloud DNS](index.md) > Начало работы
...
- Консоль управления {#console}
  ...
  1. Задайте настройки зоны:
     1. **Зона**: `testing.`. Название зоны должно заканчиваться точкой.
     1. **Тип**: `Внутренняя`.
...
- Консоль управления {#console}
  ...
  1. Задайте параметры записи:
     1. **Имя**: `test-vm-1`.
     1. **Тип**: `А`.
     1. **Значение**: [внутренний IP-адрес](../vpc/concepts/address.md#internal-addresses) ВМ `test-vm-1`.
     1. **TTL (в секундах)**: `600`.
  1. Нажмите кнопку **Создать**.
  1. Нажмите кнопку **Создать запись** еще раз. Задайте параметры еще одной записи:
     1. **Имя**: `test-vm-2`.
     1. **Тип**: `А`.
     1. **Значение**: внутренний IP-адрес ВМ `test-vm-2`.
     1. **TTL (в секундах)**: `600`.
  1. Нажмите кнопку **Создать**.
...
- Консоль управления {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) выберите каталог, где требуется создать публичную доменную зону.
  1. [Перейдите](../console/operations/select-service.md#select-service) в сервис **Cloud DNS**.
  1. Нажмите **Зоны**.
  1. Нажмите кнопку **Создать зону**.
  1. Задайте настройки зоны:
