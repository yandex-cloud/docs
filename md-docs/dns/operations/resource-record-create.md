...
- Консоль управления {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) выберите каталог с зоной DNS, в которой требуется создать запись.
  ...
  1. Задайте параметры записи:
     ...
     1. В поле **Имя** выберите один из вариантов:

        * **Создать поддомен** — укажите доменное имя записи.
        * **Совпадает с именем зоны (@)** — используйте, если хотите, чтобы имя совпадало с именем зоны.
