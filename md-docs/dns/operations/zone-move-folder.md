[Документация Yandex Cloud](../../index.md) > [Yandex Cloud DNS](../index.md) > [Пошаговые инструкции](index.md) > Зоны > Перенести зону DNS в другой каталог
...
При переносе зоны DNS метрики в [Yandex Monitoring](../../monitoring/index.md) не переносятся. Те, что были в предыдущем каталоге, останутся в нем, а новые метрики будут создаваться уже в новом каталоге.
