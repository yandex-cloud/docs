[Документация Yandex Cloud](../../index.md) > [Yandex Cloud DNS](../index.md) > [Пошаговые инструкции](index.md) > Зоны > Посмотреть операции с зонами DNS

# Посмотреть операции с зонами

Все действия с зонами Cloud DNS сохраняются в виде списка операций. Каждой операции присваивается уникальный идентификатор.
