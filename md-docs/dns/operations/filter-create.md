[Документация Yandex Cloud](../../index.md) > [Yandex Cloud DNS](../index.md) > [Пошаговые инструкции](index.md) > Фильтры > Создать фильтр
...
- CLI {#cli}
  ...
  1. Посмотрите описание команды CLI для создания фильтра:
