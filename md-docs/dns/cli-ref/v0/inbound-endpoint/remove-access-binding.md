...
Remove access binding from the specified dns inbound endpoint

#### Command Usage

Syntax:

`yc dns inbound-endpoint remove-access-binding <DNS-INBOUND-ENDPOINT-NAME>|<DNS-INBOUND-ENDPOINT-ID> [Flags...] [Global Flags...]`
