[Документация Yandex Cloud](../index.md) > [Yandex Cloud DNS](index.md) > Правила тарификации
...
| ---------------------------------------------------------------------------------------------------------- | ----------------- | --------------- | -------------- | ------------ |
| Cloud DNS. DNS-зона                                                                                        | 0,0592 ₽          | DNS-зона × час  | 30 апреля 2026 | —            |
| Cloud DNS. DNS-подключения. Входящее DNS-подключение                                                       | 0,84 ₽            | час             | 23 июля 2026   | —            |
| Cloud DNS. DNS-подключения. Входящие DNS-запросы                                                           | 37,94 ₽           | 1 млн запросов  | 23 июля 2026   | —            |
| Cloud DNS. Внутренние DNS-запросы                                                                          | Не тарифицируется | 1 млн запросов  | 30 июня 2021   | —            |
| Cloud DNS. Публичные DNS-запросы — авторитетные запросы                                                    | 37,94 ₽           | 1 млн запросов  | 30 апреля 2026 | —            |
| Cloud DNS. Публичные DNS-запросы — рекурсивные запросы внешних имен, от 0 до 1 единицы тарификации в месяц | Не тарифицируется | 1 млн запросов  | 30 апреля 2026 | —            |
| Cloud DNS. Публичные DNS-запросы — рекурсивные запросы внешних имен, от 1 единицы тарификации в месяц      | 37,94 ₽           | 1 млн запросов  | 30 апреля 2026 | —            |
...
* [Входящее DNS-подключение](concepts/dns-connection.md) — ресурс, позволяющий отправлять DNS-запросы из внешней сети на DNS-резолвер Yandex Cloud. Плата взимается за время существования подключения. Тарификация посекундная.

* Входящие DNS-запросы — запросы, поступающие из внешней сети через входящее DNS-подключение. Стоимость рассчитывается пропорционально количеству обработанных запросов.
...
- Расчет в рублях {#prices-rub}
  ...
  > (50&nbsp;000 / 1&nbsp;000&nbsp;000) × 37,94 ₽ = 0,05 × 37,94 ₽ = 1,897 ₽
  > 
  > Итого: 1,897 ₽
...
- Расчет в тенге {#prices-kzt}
  ...
  > (50&nbsp;000 / 1&nbsp;000&nbsp;000) × 189,7 ₸ = 0,05 × 189,7 ₸ = 9,485 ₸
  > 
  > Итого: 9,485 ₸
