[Документация Yandex Cloud](../../index.md) > [Yandex Cloud DNS](../index.md) > Вопросы и ответы
...
#### Почему длинная TXT-запись разбивается на несколько блоков? {#dns-txt-splitting}

При создании TXT-записи Cloud DNS автоматически разбивает текстовые блоки длиннее 255 символов на части по 255 символов. Это связано с ограничением формата DNS. Порядок данных сохраняется, все части остаются в одной TXT-записи.

Подробнее в разделе [Автоматическое разбиение длинных TXT-записей](../concepts/resource-record.md#txt-splitting).