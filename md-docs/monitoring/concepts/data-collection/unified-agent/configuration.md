[Документация Yandex Cloud](../../../../index.md) > [Yandex Monitoring](../../../index.md) > [Агент сбора метрик](index.md) > Конфигурирование > Обзор

# Конфигурирование

Раздел описывает настройку Yandex Unified Agent. Предварительно познакомьтесь с [основными понятиями](index.md), которые используются в конфигурации агента.
...
Примеры конфигураций приведены в разделе [Работа с метриками](../../../operations/index.md#working-with-metrics).