[Документация Yandex Cloud](../../../../index.md) > [Yandex Monitoring](../../../index.md) > [Агент сбора метрик](index.md) > Рекомендации по использованию агента
...
Читайте также [Вход agent_metrics](inputs.md#agent_metrics_input).

## Использование хранилища {#storage}

Для надежной доставки метрик в Yandex Monitoring при помощи Unified Agent используйте хранилище. Оно позволит временно хранить сообщения, проходящие по [цепочке преобразований](index.md#pipes), перед отправкой их на выход канала.
...
Читайте также [Хранилища](storage.md).
...
1. [Установите и запустите](installation.md) Unified Agent.
1. Откройте нужный дашборд или [создайте](../../../operations/dashboard/create.md) новый.
1. В правом верхнем углу нажмите значок ![square-plus](../../../../_assets/console-icons/square-plus.svg) и выберите ![chart-column](../../../../_assets/console-icons/chart-column.svg) **График**, чтобы добавить на дашборд новый виджет.
1. В добавляемом виджете создайте в текстовом режиме (значок ![code](../../../../_assets/console-icons/code.svg)) три запроса:
    ...
    1. Запрос `CpuUsagePercent`:
        ...
        ```
1. Нажмите кнопку **Выполнить запрос** и убедитесь, что график загрузки процессора построен.
