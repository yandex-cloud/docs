[Документация Yandex Cloud](../../../../index.md) > [Yandex Monitoring](../../../index.md) > Агент сбора метрик > Обзор
...
Примеры использования агента приведены в разделе [Работа с метриками](../../../operations/index.md#working-with-metrics). Подробнее про способы установки Unified Agent читайте в разделе [Установка и обновление Yandex Unified Agent](installation.md). Синтаксис файла конфигурации агента описан в разделе [Конфигурирование](configuration.md).
...
Для правильной агрегации данных в мониторинге [целочисленные метрики](../../data-model.md#metric-types) `COUNTER` при загрузке в Monitoring переводятся в `DGAUGE`.
