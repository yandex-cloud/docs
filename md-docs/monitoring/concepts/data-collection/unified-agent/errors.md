...
При возникновении любой ошибки убедитесь, что у вас установлена актуальная версия {{ unified-agent-short-name }}. Чтобы установить последнюю версию агента, воспользуйтесь [инструкцией](installation.md#setup).
