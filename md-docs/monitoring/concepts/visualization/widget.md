...
* **По имени линии** — в этом случае для каждой линии будет рассчитано уникальное значение (хеш), на основе которого будет сгенерирован цвет. Линии с одинаковым названием почти всегда будут отображаться одинаково.
