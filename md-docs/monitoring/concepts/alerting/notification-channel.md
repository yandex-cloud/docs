[Документация Yandex Cloud](../../../index.md) > [Yandex Monitoring](../../index.md) > [Концепции](../index.md) > Алертинг > Канал уведомлений
...
* **Повторная отправка**. Выберите время, через которое Monitoring будет отправлять повторные уведомления о статусе алерта. Не действует для статуса `OK`.
