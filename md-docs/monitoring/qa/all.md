...
Вы можете самостоятельно настроить сбор пользовательских метрик [через API](../operations/metric/add.md), а для Linux-совместимых ОС — с помощью [агента для поставки системных метрик](../operations/unified-agent/linux_metrics.md).
...
Важные метрики выведены на сервисные дашборды каждого сервиса. Полный список метрик для каждого сервиса доступен в разделе **Метрики**. Выгрузить полный список метрик можно по [инструкции](../operations/metric/list.md).
...
Описание функций приведено в [Справочнике](../concepts/querying.md#functions).
