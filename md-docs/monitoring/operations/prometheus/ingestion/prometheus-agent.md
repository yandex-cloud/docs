...
В этом разделе описана установка агента при создании виртуальной машины. Другие способы установки — в разделе [Установка и обновление Yandex Unified Agent](../../../concepts/data-collection/unified-agent/installation.md).
...
- Консоль управления {#console}
  ...
  1. Откройте вкладку **Метрики** и введите **Запрос на языке PromQL** для просмотра:
     ...
     * Системных метрик Linux — `{job="linux_metrics", instance="<имя_ВМ>", __name__="<имя_метрики>"}`.
        ...
        Список метрик, которые передает агент Prometheus, приведен в разделе [Метрики Yandex Unified Agent](../../../metrics-ref/unifiedagent-ref.md).
