[Документация Yandex Cloud](../../../index.md) > [Yandex Monitoring](../../index.md) > [Пошаговые инструкции](../index.md) > Работа с метриками > Поставка метрик HAProxy и других сторонних приложений
...
Для примера рассмотрим поставку в Yandex Monitoring метрик [HAProxy](https://www.haproxy.org).
