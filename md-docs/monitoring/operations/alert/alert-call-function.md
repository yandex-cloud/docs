[Документация Yandex Cloud](../../../index.md) > [Yandex Monitoring](../../index.md) > [Пошаговые инструкции](../index.md) > Работа с алертами > Создание webhook с вызовом внешнего API
...
- Консоль управления {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) перейдите в каталог с ресурсами, которые надо отслеживать в Monitoring.
...
- Консоль управления {#console}
  ...
  1. В блоке **Дополнительные настройки**:
      ...
      Для асинхронного вызова функции выбранный сервисный аккаунт должен иметь роли `functions.functionInvoker` и `functions.viewer`. Без этих ролей вызов будет выполнен от имени анонимного пользователя и завершится ошибкой авторизации.
...
- Консоль управления {#console}
  ...
  1. Нажмите кнопку **Создать** ![image](../../../_assets/console-icons/chevron-down.svg) → **Пользовательский**.
  1. Введите **Название** алерта, например `alert-function`.
