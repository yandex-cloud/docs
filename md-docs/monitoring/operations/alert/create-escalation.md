[Документация Yandex Cloud](../../../index.md) > [Yandex Monitoring](../../index.md) > [Пошаговые инструкции](../index.md) > Работа с алертами > Создание политики эскалаций
...
1. На странице сервиса Monitoring на панели слева выберите **Политики эскалаций**.
...
1. На странице сервиса [Monitoring](https://monitoring.yandex.cloud) на панели слева выберите **Алерты**.
...
Когда алерт перейдет в статус **Alarm**, эскалация запустится. У всех получателей в интерфейсе сервиса Monitoring появится всплывающее окно, а также начнут приходить уведомления согласно настроенной политике. Если алерт перейдет в любой другой статус, эскалация остановится.
