[Документация Yandex Cloud](../../../index.md) > [Yandex Monitoring](../../index.md) > [Пошаговые инструкции](../index.md) > Работа с алертами > Создание канала уведомлений с вызовом функции
...
Пример вызова функции описан в разделе [Webhook с использованием Cloud Functions](alert-call-function.md).