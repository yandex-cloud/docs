[Документация Yandex Cloud](../../index.md) > [Yandex Monitoring](../index.md) > [Практические руководства](index.md) > Мониторинг показаний датчиков и уведомления о событиях
...
* плата за запись пользовательских [метрик](../concepts/data-model.md#metric) через API сервиса [Monitoring](../index.md) ([тарифы Yandex Monitoring](../pricing.md)).
...
Эмулятор отправляет данные с датчиков устройства и обрабатывает данные для мониторинга и [алертов](../concepts/alerting/alert.md).
...
Для наблюдения за показаниями датчиков используется дашборд в сервисе [Yandex Monitoring](../index.md). Показания датчиков поступают с контроллера на сервер раз в минуту по [MQTT-протоколу](../../glossary/mqtt-server.md#mqtt-protocol). Когда показания датчиков достигают заданных значений, Monitoring отправляет уведомления пользователям.
...
Настройте мониторинг показаний датчиков: создайте [графики](../concepts/visualization/widget.md#chart) на [дашборде](../concepts/visualization/dashboard.md), [канал уведомлений](../concepts/alerting/notification-channel.md) и [алерт](../concepts/alerting/alert.md)
...
* [Удалите дашборд в сервисе Monitoring](../operations/dashboard/delete-dashboard.md)
* [Удалите алерт в сервисе Monitoring](../operations/alert/delete-alert.md)
* Удалите [канал уведомлений](../concepts/alerting/notification-channel.md) в сервисе Monitoring.