...
Метрики кластера будут собираться с помощью свободно распространяемой утилиты [Prometheus 1C Exporter](https://github.com/LazarenkoA/prometheus_1C_exporter), передаваться в [Yandex Unified Agent](../concepts/data-collection/unified-agent/index.md) и затем в Monitoring.
...
1. [Проверьте, что метрики передаются в Monitoring](#check-metrics)
...
1. Установите Unified Agent из deb-пакета, указав его версию:
   ...
   Другие способы установки описаны в разделе [Установка и обновление Yandex Unified Agent](../concepts/data-collection/unified-agent/installation.md). 
...
## Проверьте, что метрики передаются в Monitoring {#check-metrics}

{% list tabs group=instructions %}

- Консоль управления {#console}

    1. На [главной странице](https://monitoring.yandex.cloud) сервиса Monitoring на панели слева выберите **Метрики**.
...
- Консоль управления {#console}
    ...
    1. На [главной странице](https://monitoring.yandex.cloud) сервиса Monitoring нажмите **Создать дашборд**.
...
* [Остановите Unified Agent](../concepts/data-collection/unified-agent/run-and-stop.md#stop).
* В [файле конфигурации](../concepts/data-collection/unified-agent/configuration.md) Unified Agent удалите настройки сбора и передачи метрик.
* [Удалите Unified Agent](../concepts/data-collection/unified-agent/delete.md).