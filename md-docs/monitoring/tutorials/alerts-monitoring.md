...
Более подробная информация о порядке [создания алерта](../operations/alert/create-alert.md) и о [параметрах алерта](../concepts/alerting.md#alert-parameters) приведена в документации Yandex Monitoring.
