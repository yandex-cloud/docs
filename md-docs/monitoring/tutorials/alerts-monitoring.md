...
Из руководства вы узнаете, как отслеживать состояние [трейлов](../../audit-trails/concepts/trail.md) с помощью [дашбордов](../concepts/visualization/dashboard.md) и [алертов](../concepts/alerting.md#alert) [{{ monitoring-full-name }}](../index.md).
...
Более подробная информация о порядке [создания алерта](../operations/alert/create-alert.md) и о [параметрах алерта](../concepts/alerting.md#alert-parameters) приведена в документации {{ monitoring-full-name }}.
...
* [Удалите алерты](../operations/alert/delete-alert.md)
* [Удалите дашборд](../operations/dashboard/delete-dashboard.md)