[Документация Yandex Cloud](../../index.md) > [Yandex Monitoring](../index.md) > [Справочник метрик](index.md) > AI Studio

# Метрики Yandex AI Studio


В этом разделе описаны метрики сервиса [AI Studio](https://aistudio.yandex.ru/docs/ru/), поставляемые в Monitoring.

Имя метрики записывается в метку `name`.

## Метрики MCP Hub {#mcp-hub}
