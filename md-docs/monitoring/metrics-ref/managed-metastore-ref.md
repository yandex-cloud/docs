[Документация Yandex Cloud](../../index.md) > [Yandex Monitoring](../index.md) > [Справочник метрик](index.md) > Apache Hive™ Metastore

# Метрики Apache Hive™ Metastore

В этом разделе описаны метрики сервиса [Apache Hive™ Metastore](../../metadata-hub/concepts/metastore.md), поставляемые в Monitoring.
