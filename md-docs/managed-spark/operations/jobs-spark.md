...
- gRPC API {#grpc-api}
    ...
    1. Воспользуйтесь вызовом [JobService.Cancel](../api-ref/grpc/Job/cancel.md) и выполните запрос, например, с помощью {{ api-examples.grpc.tool }}:
...
- gRPC API {#grpc-api}
    ...
    1. Воспользуйтесь вызовом [JobService.List](../api-ref/grpc/Job/list.md) и выполните запрос, например, с помощью {{ api-examples.grpc.tool }}:
...
- gRPC API {#grpc-api}
    ...
    1. Воспользуйтесь вызовом [JobService.Get](../api-ref/grpc/Job/get.md) и выполните запрос, например, с помощью {{ api-examples.grpc.tool }}:
...
- gRPC API {#grpc-api}
    ...
    1. Воспользуйтесь вызовом [JobService.ListLog](../api-ref/grpc/Job/listLog.md) и выполните запрос, например, с помощью {{ api-examples.grpc.tool }}:
