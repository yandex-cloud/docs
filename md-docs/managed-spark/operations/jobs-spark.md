[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for Apache Spark™](../index.md) > [Пошаговые инструкции](index.md) > Задания (jobs) > Задания Spark
...
- Консоль управления {#console}
    ...
    1. Нажмите на имя нужного кластера и перейдите в раздел **Задания**.
    ...
    1. Выберите окружение, в котором будет выполнено задание. Доступные варианты:
       * **Как у кластера** — используется окружение, указанное в параметрах кластера.
       * **Базовые окружения** — одно из нескольких базовых окружений с предустановленными версиями Apache Spark™ и Python.
       * **Пользовательские окружения** — одно из [созданных пользовательских окружений](environment-create.md).
    ...
    1. В поле **Основной JAR файл** укажите путь к основному JAR-файлу приложения в формате:
        ...
        Сервисному аккаунту кластера необходим доступ на чтение ко всем файлам в бакете. Пошаговые инструкции по настройке доступа к Object Storage приведены в разделе [Редактировать ACL бакета](../../storage/operations/buckets/edit-acl.md).
...
- Консоль управления {#console}
    ...
    1. В правом верхнем углу страницы нажмите **Отменить**.
