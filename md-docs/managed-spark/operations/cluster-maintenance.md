...
- Консоль управления {#console}
  ...
  1. Нажмите на имя нужного кластера и перейдите в раздел **Обслуживание**.

  Чтобы просмотреть обслуживания с определенным статусом, нажмите **Статус** над списком обслуживаний и в выпадающем меню выберите нужный статус. Чтобы найти конкретное обслуживание, введите его идентификатор или имя задания в поле над списком обслуживаний.
...
Обслуживание в статусе **Запланировано** назначено на определенную дату и время, которые указаны в столбце **Дата начала**. При необходимости такое обслуживание можно перенести на новую дату и время.
...
- Консоль управления {#console}
  ...
  1. [Перейдите](https://console.yandex.cloud/link/managed-spark) в сервис **Managed Service for Apache Spark**.
  1. Нажмите на имя нужного кластера и перейдите в раздел **Обслуживание**.
  1. Нажмите ![image](../../_assets/console-icons/ellipsis.svg) в строке обслуживания со статусом **Запланировано**.
...
- Консоль управления {#console}
  ...
  1. [Перейдите](https://console.yandex.cloud/link/managed-spark) в сервис **Managed Service for Apache Spark**.
  1. Нажмите на имя нужного кластера и перейдите в раздел **Обслуживание**.
  1. Нажмите ![image](../../_assets/console-icons/calendar.svg) **Настроить окно обслуживания**.
  1. В открывшемся окне:
     * Чтобы разрешить проведение технического обслуживания в любое время, выберите **В любое время** (по умолчанию).
     * Чтобы разрешить проведение технического обслуживания раз в неделю в определенное время суток, выберите **По расписанию** и укажите день недели и часовой интервал по UTC.
...
- Terraform {#tf}
  ...
  1. Откройте актуальный конфигурационный файл Terraform с планом инфраструктуры.
      ...
      Полный список доступных для изменения полей конфигурации кластера Apache Spark™ описан в [документации провайдера Terraform](../../terraform/resources/spark_cluster.md).
