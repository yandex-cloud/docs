...
- Консоль управления {#console}
  ...
  1. В открывшемся окне:
     ...
     * Чтобы разрешить проведение технического обслуживания раз в неделю в определенное время суток, выберите пункт **По расписанию** и укажите день недели и часовой интервал по UTC.
