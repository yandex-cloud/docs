...
- Консоль управления {#console}
    ...
    1. Выберите кластер и нажмите на панели сверху ![image](../../_assets/console-icons/pencil.svg) **Редактировать**. Откроется страница редактирования кластера.
...
- Консоль управления {#console}
    ...
    1. В [консоли управления](https://console.yandex.cloud) выберите каталог.
    1. [Перейдите](https://console.yandex.cloud/link/managed-spark) в сервис **Managed Service for Apache Spark**.
    1. Выберите кластер и нажмите на панели сверху ![image](../../_assets/console-icons/pencil.svg) **Редактировать**.
...
- Консоль управления {#console}
    ...
    1. [Перейдите](https://console.yandex.cloud/link/managed-spark) в сервис **Managed Service for Apache Spark**.
    1. Выберите кластер и нажмите на панели сверху **Редактировать**.
