...
- Консоль управления {#console}
    ...
    1. В блоке **Сетевые настройки** выберите [группу безопасности](../../vpc/concepts/security-groups.md) для сетевого трафика кластера.
    ...
    1. В блоке **Дополнительные настройки**:
        ...
        1. В настройке **Обслуживание** измените время [технического обслуживания](../concepts/maintenance.md) кластера:
        ...
        1. Выберите кластер [Apache Hive™ Metastore](../../metadata-hub/concepts/metastore.md) для подключения в качестве хранилища метаданных.
        1. Установите или снимите защиту от удаления кластера.
        1. Включите или выключите **History Server**. Опция позволяет использовать сервис для мониторинга приложений [Spark History Server](https://spark.apache.org/docs/latest/monitoring.html).
        1. Включите или выключите **Запись логов**. Опция включает логирование Spark-приложений в кластере:
...
- CLI {#cli}
    ...
    2. Передайте список настроек, которые хотите изменить, в команде изменения кластера:
        ...
        * Конфигурация хостов для запуска драйверов Apache Spark™:
        ...
        * Конфигурация хостов для запуска исполнителей Apache Spark™:
