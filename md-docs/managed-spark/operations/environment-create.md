...
- Консоль управления {#console}
  ...
  1. Нажмите кнопку **Создать окружение**.
...
- Консоль управления {#console}
  ...
  1. Выберите в списке необходимое окружение, перейдите в него и нажмите кнопку ![image](../../_assets/console-icons/copy-plus.svg) **Создать копию окружения** на панели сверху.
