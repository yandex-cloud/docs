[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for Apache Spark™](../index.md) > [Практические руководства](index.md) > Запуск PySpark-задания с помощью Yandex Managed Service for Apache Airflow™
...
1. В [веб-интерфейсе Apache Airflow™](../../managed-airflow/operations/af-interfaces.md#web-gui) нажмите на название DAG `example_spark` и отслеживайте выполнение задач.
