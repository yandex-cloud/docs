...
Включить и выключить автоматическое масштабирование каждого из двух пулов хостов можно при [создании](../operations/cluster-create.md) и [изменении](../operations/cluster-update.md) кластера Apache Spark™.
