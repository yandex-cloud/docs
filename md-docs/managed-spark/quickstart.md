[Документация Yandex Cloud](../index.md) > [Yandex Managed Service for Apache Spark™](index.md) > Начало работы
...
1. Предоставьте сервисному аккаунту доступ к бакету Object Storage, в котором будут храниться код и данные для заданий на кластере:
   ...
   1. [Перейдите](https://console.yandex.cloud/link/storage) в сервис **Object Storage**.
      ...
      1. Нажмите ![image](../_assets/console-icons/ellipsis.svg) и выберите **Настроить ACL**.
