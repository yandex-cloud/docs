[Документация Yandex Cloud](../../../../../index.md) > [Yandex Managed Service for Apache Spark™](../../../../index.md) > Справочник API > gRPC (англ.) > [Managed Spark Environment API](../index.md) > [Environment](index.md) > ListBase
...
**rpc ListBase ([ListEnvironmentsRequest](#yandex.cloud.spark.v1.environment.ListEnvironmentsRequest)) returns ([ListBaseEnvironmentsResponse](#yandex.cloud.spark.v1.environment.ListBaseEnvironmentsResponse))**
...
## ListBaseEnvironmentsResponse {#yandex.cloud.spark.v1.environment.ListBaseEnvironmentsResponse}
...
#|
||Field | Description ||
|| environments[] | **[BaseEnvironment](#yandex.cloud.spark.v1.environment.BaseEnvironment)**
