[Документация Yandex Cloud](../../../../../index.md) > [Yandex Managed Service for Apache Spark™](../../../../index.md) > Справочник API > gRPC (англ.) > [Managed Spark Environment API](../index.md) > [Environment](index.md) > GetBase
