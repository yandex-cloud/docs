...
- Расчет в рублях {#prices-rub}
  ...
  > 720 × (24 × 1,57 ₽ + 96 × 0,4146 ₽) = {% calc [currency=RUB] 720 × (24 × 1.57 + 96 × 0.4146) %}
  >
  > Итого: {% calc [currency=RUB] 720 × (24 × 1.57 + 96 × 0.4146) %} — стоимость использования кластера в течение 30 дней.
...
- Расчет в тенге {#prices-kzt}
  ...
  > 720 × (24 × 7,85 ₸ + 96 × 2,073 ₸) = {% calc [currency=KZT] 720 × (24 × 7.85 + 96 × 2.073) %}
  >
  > Итого: {% calc [currency=KZT] 720 × (24 × 7.85 + 96 × 2.073) %} — стоимость использования кластера в течение 30 дней.
...
| ------------------------------------------------------------------------ | -------- | --------------- | ----------- | ------------ |
| Managed Service for Apache Spark™. Вычислительные ресурсы кластера, RAM  | 0,4146 ₽ | ГБ × час        | 1 мая 2026  | —            |
| Managed Service for Apache Spark™. Вычислительные ресурсы кластера, vCPU | 1,57 ₽   | vCPU × час      | 1 мая 2026  | —            |
