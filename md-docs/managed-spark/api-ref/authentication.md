[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for Apache Spark™](../index.md) > Справочник API > Аутентификация в API

# Аутентификация в API Yandex Managed Service for Apache Spark™
