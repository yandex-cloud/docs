...
**rpc Update ([UpdateClusterRequest](#yandex.cloud.spark.v1.UpdateClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## UpdateClusterRequest {#yandex.cloud.spark.v1.UpdateClusterRequest}
...
## UpdateClusterConfigSpec {#yandex.cloud.spark.v1.UpdateClusterConfigSpec}
...
|| metadata | **[UpdateClusterMetadata](#yandex.cloud.spark.v1.UpdateClusterMetadata)**
...
## UpdateClusterMetadata {#yandex.cloud.spark.v1.UpdateClusterMetadata}
...
UI URLs ||
|| maintenance_window | **[MaintenanceWindow](#yandex.cloud.spark.v1.MaintenanceWindow2)**
...
Configuration for HistoryServer ||
|| dependencies | **[Dependencies](#yandex.cloud.spark.v1.Dependencies2)**
...
#|
||Field | Description ||
|| fixed_scale | **[FixedScale](#yandex.cloud.spark.v1.ScalePolicy.FixedScale2)**

Includes only one of the fields `fixed_scale`, `auto_scale`. ||
|| auto_scale | **[AutoScale](#yandex.cloud.spark.v1.ScalePolicy.AutoScale2)**

Includes only one of the fields `fixed_scale`, `auto_scale`. ||
|#

## FixedScale {#yandex.cloud.spark.v1.ScalePolicy.FixedScale2}
...
## Dependencies {#yandex.cloud.spark.v1.Dependencies2}
...
## Metastore {#yandex.cloud.spark.v1.Metastore2}
...
## LoggingConfig {#yandex.cloud.spark.v1.LoggingConfig2}
...
## MaintenanceWindow {#yandex.cloud.spark.v1.MaintenanceWindow2}

#|
||Field | Description ||
|| anytime | **[AnytimeMaintenanceWindow](#yandex.cloud.spark.v1.AnytimeMaintenanceWindow2)**

Includes only one of the fields `anytime`, `weekly_maintenance_window`. ||
|| weekly_maintenance_window | **[WeeklyMaintenanceWindow](#yandex.cloud.spark.v1.WeeklyMaintenanceWindow2)**

Includes only one of the fields `anytime`, `weekly_maintenance_window`. ||
|#

## AnytimeMaintenanceWindow {#yandex.cloud.spark.v1.AnytimeMaintenanceWindow2}
...
## WeeklyMaintenanceWindow {#yandex.cloud.spark.v1.WeeklyMaintenanceWindow2}
