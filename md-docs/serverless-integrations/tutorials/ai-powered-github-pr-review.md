[Документация Yandex Cloud](../../index.md) > [Yandex Serverless Integrations](../index.md) > [Практические руководства](index.md) > ИИ-ревью пул-реквестов на GitHub с помощью Workflows и GitHub Actions
...
1. Создайте файл `yawl-spec.yaml` со следующей [YaWL-спецификацией](../concepts/workflows/yawl/index.md) рабочего процесса:
...
1. Создайте рабочий процесс:
    ...
    - API {#api}
      ...
      Чтобы создать рабочий процесс, воспользуйтесь методом REST API [Create](../workflows/api-ref/Workflow/create.md) для ресурса [Workflows](../workflows/api-ref/Workflow/index.md) или вызовом gRPC API [WorkflowService/Create](../workflows/api-ref/grpc/Workflow/create.md).
