[Документация Yandex Cloud](../../../../../index.md) > [Yandex Serverless Integrations](../../../../index.md) > Справочник API EventRouter > [gRPC (англ.)](../index.md) > [Bus](index.md) > ListOperations
...
[ListBusesResponse.next_page_token](list.md#yandex.cloud.serverless.eventrouter.v1.ListBusesResponse) returned by a previous list request.
