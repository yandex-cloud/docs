[Документация Yandex Cloud](../../../../index.md) > [Yandex Serverless Integrations](../../../index.md) > [Пошаговые инструкции](../../index.md) > EventRouter > Управление коннектором > Управлять метками > Удалить метку

# Удалить метку коннектора
...
- CLI {#cli}
  ...
  Чтобы удалить метку [коннектора](../../../concepts/eventrouter/connector.md), обновите набор его меток, удалив ненужные. Выполните команду:
  ...
  Чтобы удалить все метки коннектора, задайте пустое значение:
...
- Terraform {#tf}
  ...
  Чтобы удалить метку [коннектора](../../../concepts/eventrouter/connector.md):
...
- API {#api}
  ...
  Чтобы удалить метку [коннектора](../../../concepts/eventrouter/connector.md), воспользуйтесь методом REST API [Update](../../../eventrouter/api-ref/Connector/update.md) для ресурса [Connector](../../../eventrouter/api-ref/Connector/index.md) или вызовом gRPC API [Connector/Update](../../../eventrouter/api-ref/grpc/Connector/update.md).
