[Документация Yandex Cloud](../../../../index.md) > [Yandex Serverless Integrations](../../../index.md) > [Пошаговые инструкции](../../index.md) > EventRouter > Управление коннектором > Управлять метками > Добавить метку
...
- Консоль управления {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) перейдите в каталог, в котором хотите добавить метку [коннектору](../../../concepts/eventrouter/connector.md).
...
- Terraform {#tf}
  ...
  1. Откройте конфигурационный файл Terraform и в блоке `labels` перечислите метки в формате `ключ = "значение"`.
...
- API {#api}
  ...
  Чтобы добавить метку [коннектору](../../../concepts/eventrouter/connector.md), воспользуйтесь методом REST API [Update](../../../eventrouter/api-ref/Connector/update.md) для ресурса [Connector](../../../eventrouter/api-ref/Connector/index.md) или вызовом gRPC API [Connector/Update](../../../eventrouter/api-ref/grpc/Connector/update.md).
