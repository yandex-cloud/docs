[Документация Yandex Cloud](../../../../index.md) > [Yandex Serverless Integrations](../../../index.md) > [Пошаговые инструкции](../../index.md) > EventRouter > Получение информации о коннекторе > Получить список коннекторов
...
- Консоль управления {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) перейдите в каталог, в котором хотите посмотреть список [коннекторов](../../../concepts/eventrouter/connector.md).
  ...
  1. На панели слева нажмите ![image](../../../../_assets/console-icons/broadcast-signal.svg) **Коннекторы**. На странице **Коннекторы** отобразится список коннекторов.
