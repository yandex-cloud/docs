[Документация Yandex Cloud](../../../../index.md) > [Yandex Serverless Integrations](../../../index.md) > [Пошаговые инструкции](../../index.md) > EventRouter > Управление правами доступа к ресурсам > Назначить роли на ресурс
...
- API {#api}
  ...
  Например, для [шины](../../../concepts/eventrouter/bus.md) воспользуйтесь методом REST API [setAccessBinding](../../../eventrouter/api-ref/Bus/setAccessBindings.md) для ресурса [Bus](../../../eventrouter/api-ref/Bus/index.md) или вызовом gRPC API [BusService/SetAccessBinding](../../../eventrouter/api-ref/grpc/Bus/setAccessBindings.md). В теле запроса в свойстве `action` укажите `ADD`, а в свойстве `subject` — тип и идентификатор [субъекта](../../../../iam/concepts/access-control/index.md#subject).
