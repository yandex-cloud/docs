...
- API {#api}
  ...
  Например, для [шины](../../../concepts/eventrouter/bus.md) воспользуйтесь методом REST API [setAccessBinding](../../../eventrouter/api-ref/Bus/setAccessBindings.md) для ресурса [Bus](../../../eventrouter/api-ref/Bus/index.md) или вызовом gRPC API [BusService/SetAccessBinding](../../../eventrouter/api-ref/grpc/Bus/setAccessBindings.md).
