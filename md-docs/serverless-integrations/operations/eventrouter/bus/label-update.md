[Документация Yandex Cloud](../../../../index.md) > [Yandex Serverless Integrations](../../../index.md) > [Пошаговые инструкции](../../index.md) > EventRouter > Управление шиной > Управлять метками > Изменить метку
...
- API {#api}
  ...
  Чтобы изменить метку [шины](../../../concepts/eventrouter/bus.md), воспользуйтесь методом REST API [Update](../../../eventrouter/api-ref/Bus/update.md) для ресурса [Bus](../../../eventrouter/api-ref/Bus/index.md) или вызовом gRPC API [Bus/Update](../../../eventrouter/api-ref/grpc/Bus/update.md).
