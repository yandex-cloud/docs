...
- CLI {#cli}
  ...
  Чтобы добавить метку [правилу](../../../concepts/eventrouter/rule.md), выполните команду:
...
- {{ TF }} {#tf}
  ...
  Чтобы добавить метку [правилу](../../../concepts/eventrouter/rule.md):
...
- API {#api}
  ...
  Чтобы добавить метку [правилу](../../../concepts/eventrouter/rule.md), воспользуйтесь методом REST API [Update](../../../eventrouter/api-ref/Rule/update.md) для ресурса [Rule](../../../eventrouter/api-ref/Rule/index.md) или вызовом gRPC API [Rule/Update](../../../eventrouter/api-ref/grpc/Rule/update.md).
