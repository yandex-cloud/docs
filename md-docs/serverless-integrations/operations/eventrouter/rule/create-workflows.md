[Документация Yandex Cloud](../../../../index.md) > [Yandex Serverless Integrations](../../../index.md) > [Пошаговые инструкции](../../index.md) > EventRouter > Управление правилом > Создать правило > Workflows

# Создать правило с приемником Yandex Workflows
...
- Консоль управления {#console}
  ...
  1. В блоке **Приёмники** нажмите **Добавить** и настройте приемник:
      ...
      1. Укажите тип приемника `Yandex Workflows`.
      1. Выберите [рабочий процесс](https://aistudio.yandex.ru/docs/ru/ai-studio/concepts/workflows/workflow), на вход которого будут отправляться сообщения, соответствующие правилу.
...
- CLI {#cli}
  ...
  1. Создайте правило с приемником Yandex Workflows:
      ...
      * `--workflow-target` — параметр для настройки приемника с типом `Yandex Workflows` и его свойства:

          * `workflow-id` — идентификатор [рабочего процесса](https://aistudio.yandex.ru/docs/ru/ai-studio/concepts/workflows/workflow), на вход которого будут отправляться сообщения, соответствующие правилу.
...
- Terraform {#tf}
  ...
  Чтобы создать [правило](../../../concepts/eventrouter/rule.md) с приемником Yandex Workflows:
  ...
  1. Опишите в конфигурационном файле параметры ресурсов, которые необходимо создать:
      ...
      * `workflow` — блок для настройки приемника с типом `Yandex Workflows` и его параметры:

          * `workflow_id` — идентификатор [рабочего процесса](https://aistudio.yandex.ru/docs/ru/ai-studio/concepts/workflows/workflow), в которую будут отправляться сообщения, соответствующие правилу.
...
- API {#api}
  ...
  Чтобы создать [правило](../../../concepts/eventrouter/rule.md) с приемником Yandex Workflows, воспользуйтесь методом REST API [Create](../../../eventrouter/api-ref/Rule/create.md) для ресурса [rule](../../../eventrouter/api-ref/Rule/index.md) или вызовом gRPC API [rule/Create](../../../eventrouter/api-ref/grpc/Rule/create.md).
