...
- Консоль управления {#console}
  ...
  1. В блоке **Приёмники** нажмите **Добавить** и настройте приемник:
      ...
      1. Укажите тип приемника `Yandex Message Queue`.
...
- CLI {#cli}
  ...
  1. Создайте правило с приемником Yandex Message Queue:
      ...
      * `--ymq-target` — параметр для настройки приемника с типом `Yandex Message Queue` и его свойства:
...
- Terraform {#tf}
  ...
  Чтобы создать [правило](../../../concepts/eventrouter/rule.md) с приемником Yandex Message Queue:
  ...
  1. Опишите в конфигурационном файле параметры ресурсов, которые необходимо создать:
      ...
      * `ymq` — блок для настройки приемника с типом `Yandex Message Queue` и его параметры:
...
- API {#api}
  ...
  Чтобы создать [правило](../../../concepts/eventrouter/rule.md) с приемником Yandex Message Queue, воспользуйтесь методом REST API [Create](../../../eventrouter/api-ref/Rule/create.md) для ресурса [rule](../../../eventrouter/api-ref/Rule/index.md) или вызовом gRPC API [rule/Create](../../../eventrouter/api-ref/grpc/Rule/create.md).
