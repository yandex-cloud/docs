[Документация Yandex Cloud](../../../../index.md) > [Yandex Serverless Integrations](../../../index.md) > [Пошаговые инструкции](../../index.md) > EventRouter > Управление правилом > Создать правило > API Gateway

# Создать правило с приемником Yandex API Gateway
...
- Консоль управления {#console}
  ...
  1. В блоке **Приёмники** нажмите **Добавить** и настройте приемник:
      ...
      1. Укажите тип приемника `Yandex API Gateway`.
...
- CLI {#cli}
  ...
  1. Создайте правило с приемником Yandex API Gateway:
      ...
      * `--gateway-websocket-broadcast-target` — параметр для настройки приемника с типом `Yandex API Gateway` и его свойства:
...
- Terraform {#tf}
  ...
  Чтобы создать [правило](../../../concepts/eventrouter/rule.md) с приемником Yandex API Gateway:
  ...
  1. Опишите в конфигурационном файле параметры ресурсов, которые необходимо создать:
      ...
      * `gateway_websocket_broadcast` — блок для настройки приемника с типом `Yandex API Gateway` и его параметры:
...
- API {#api}
  ...
  Чтобы создать [правило](../../../concepts/eventrouter/rule.md) с приемником Yandex API Gateway, воспользуйтесь методом REST API [Create](../../../eventrouter/api-ref/Rule/create.md) для ресурса [rule](../../../eventrouter/api-ref/Rule/index.md) или вызовом gRPC API [rule/Create](../../../eventrouter/api-ref/grpc/Rule/create.md).
