[Документация Yandex Cloud](../../../../index.md) > [Yandex Serverless Integrations](../../../index.md) > [Пошаговые инструкции](../../index.md) > EventRouter > Управление правилом > Управлять приемниками > Удалить приемник
...
- Консоль управления {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) перейдите в каталог, из которого хотите удалить [приемник](../../../concepts/eventrouter/rule.md#target).
  ...
  1. Напротив названия приемника, который вы хотите удалить, нажмите ![image](../../../../_assets/console-icons/ellipsis.svg) и выберите **Удалить**.
  1. Нажмите **Сохранить**.
...
- Terraform {#tf}
  ...
  1. Откройте конфигурационный файл Terraform и удалите блоки с описанием ненужных приемников.
