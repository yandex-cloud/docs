[Документация Yandex Cloud](../../../../index.md) > [Yandex Serverless Integrations](../../../index.md) > [Пошаговые инструкции](../../index.md) > EventRouter > Управление правилом > Управлять приемниками > Изменить приемник
...
- Terraform {#tf}
  ...
  1. Откройте конфигурационный файл Terraform и отредактируйте блоки с описанием нужных приемников.
...
- API {#api}
  ...
  Чтобы изменить [приемник](../../../concepts/eventrouter/rule.md#target) в [правиле](../../../concepts/eventrouter/rule.md), воспользуйтесь методом REST API [Update](../../../eventrouter/api-ref/Rule/update.md) для ресурса [Rule](../../../eventrouter/api-ref/Rule/index.md) или вызовом gRPC API [Rule/Update](../../../eventrouter/api-ref/grpc/Rule/update.md).
