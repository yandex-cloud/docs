...
- Консоль управления {#console}
  ...
  1. Из секции **Интеграционные шаги** в левой части экрана перетащите элемент ![yds-icon](../../../../_assets/yds-icon.svg) **Data Streams** в нужное место рабочего процесса в окне конструктора.
  ...
  1. В окне со схемой рабочего процесса нажмите на добавленный блок **Data Streams**, чтобы выбрать его.
  1. В правой части окна на вкладке **Настройки**:

      1. В поле **Имя шага** задайте имя шага рабочего процесса.
      1. В поле **База данных** выберите бессерверную [базу данных YDB](../../../../ydb/concepts/resources.md#serverless).
