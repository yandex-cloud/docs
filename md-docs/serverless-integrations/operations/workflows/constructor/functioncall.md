...
- Консоль управления {#console}
  ...
  1. Из секции **Интеграционные шаги** в левой части экрана перетащите элемент ![CurlyBracketsFunction](../../../../_assets/console-icons/curly-brackets-function.svg) **{{ sf-short-name }}** в нужное место рабочего процесса в окне конструктора.
