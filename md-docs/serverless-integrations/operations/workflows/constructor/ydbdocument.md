  ...
  1. В правой части окна на вкладке **Настройки**:
      ...
      1. В блоке **Действие** выберите:
          ...
          * `Update`, чтобы изменить данные в таблице, и настройте параметры обновления:
              ...
              1. В поле **Выражение для обновления** задайте выражение, описывающее обновления атрибутов элемента в базе данных. Подробнее см. информацию о параметре `UpdateExpression` в [документации Yandex Managed Service for YDB](../../../../ydb/docapi/api-ref/actions/updateItem.md#parametry).
              1. В поле **Значения атрибутов** задайте значения атрибутов, используемых в выражении выше. Подробнее см. информацию о параметре `ExpressionAttributeValues` в [документации Yandex Managed Service for YDB](../../../../ydb/docapi/api-ref/actions/updateItem.md#parametry).
