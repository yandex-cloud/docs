...
- Консоль управления {#console}
  ...
  1. В правой части окна на вкладке **Настройки**:
      ...
      1. Выберите [AI-модель](https://aistudio.yandex.ru/docs/ru/ai-studio/concepts/generation/index):
          ...
          1. В поле **Идентификатор модели** введите идентификатор дообученной модели. Подробнее см. в разделе [Модели классификаторов на базе YandexGPT](https://aistudio.yandex.ru/docs/ru/ai-studio/concepts/classifier/models).
