...
- Консоль управления {#console}
  ...
  1. В правой части окна на вкладке **Настройки**:
      ...
      1. В блоке **Письмо** задайте содержимое отправляемого сообщения. Выберите:
          ...
          * `Шаблон`, чтобы задать содержимое письма в виде шаблона. Подробнее см. в [документации Yandex Cloud Postbox](../../../../postbox/aws-compatible-api/api-ref/send-email.md).
