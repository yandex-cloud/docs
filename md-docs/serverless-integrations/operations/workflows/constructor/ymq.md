...
- Консоль управления {#console}
  ...
  1. Из секции **Интеграционные шаги** в левой части экрана перетащите элемент ![ymq-icon](../../../../_assets/ymq-icon.svg) **{{ ui-key.yc-serverless-workflows.dynamic-forms.ymq_integration_title }}** в нужное место рабочего процесса в окне конструктора.
