[Документация Yandex Cloud](../../../../index.md) > [Yandex Serverless Integrations](../../../index.md) > [Пошаговые инструкции](../../index.md) > Workflows > Управление рабочим процессом > Указать облачную сеть
...
- Консоль управления {#console}
  ...
  1. Раскройте блок **Дополнительные параметры** и в поле **Сеть** укажите нужную сеть.
  1. Нажмите **Сохранить**.
...
- API {#api}
  ...
  Чтобы указать облачную сеть, воспользуйтесь методом REST API [Update](../../../workflows/api-ref/Workflow/update.md) для ресурса [Workflows](../../../workflows/api-ref/Workflow/index.md) или вызовом gRPC API [workflow/Update](../../../workflows/api-ref/grpc/Workflow/update.md).
