[Документация Yandex Cloud](../../../../index.md) > [Yandex Serverless Integrations](../../../index.md) > [Пошаговые инструкции](../../index.md) > Workflows > Управление рабочим процессом > Управлять логами > Записать логи
...
- Консоль управления {#console}
  ...
  1. Раскройте блок **Дополнительные параметры** и найдите блок **Логирование**:
