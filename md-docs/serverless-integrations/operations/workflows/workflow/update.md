...
- Консоль управления {#console}
  ...
  1. Измените параметры рабочего процесса в YaML-спецификации или с помощью конструктора. Подробнее о настройке шагов с помощью конструктора см. раздел [Обзор конструктора шагов рабочего процесса Workflows](../constructor/index.md).
  1. Нажмите **Сохранить**.
