[Документация Yandex Cloud](../../../../index.md) > [Yandex Serverless Integrations](../../../index.md) > [Концепции](../../index.md) > Workflows > Спецификация YaWL > Обзор
...
--- | --- | --- | ---
`yawl` | `string` | Да | Версия языка спецификации. Возможные значения: `0.1`.
...
--- | --- | --- | --- | --- | ---
`errorList` | `WorkflowError[]` | Да | `[]` | — | Список ошибок, для которых будут сделаны повторные попытки выполнения шага. Подробнее в [Возможные коды ошибок](../execution.md#errors).
...
Имя поля | Тип | Обязательное | Значение по умолчанию | Предельное значение | Описание
--- | --- | --- | --- |---| ---
`errorList` | `WorkflowError[]` | Да | `[]` | — | Список ошибок, для которых применяется правило перехода. Подробнее в разделе [Возможные коды ошибок](../execution.md#errors).
