...
`dataLoggingEnabled` | `boolean` | Нет | `true` | Нет | Включение логирования запросов. Если `false`, логирование отключено. Подробнее в [документации AI Studio](https://aistudio.yandex.ru/docs/ru/ai-studio/operations/disable-logging).
