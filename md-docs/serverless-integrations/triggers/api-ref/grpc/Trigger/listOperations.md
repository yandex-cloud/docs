[Документация Yandex Cloud](../../../../../index.md) > [Yandex Serverless Integrations](../../../../index.md) > Справочник API Triggers > [gRPC (англ.)](../index.md) > [Trigger](index.md) > ListOperations
...
1. The field name. Currently filtering can only be applied to the [Trigger.name](../../../../../functions/triggers/api-ref/grpc/Trigger/get.md#yandex.cloud.serverless.triggers.v1.Trigger) field.
2. An `=` operator.
