 ...
 * [Подключение группы источников при создании ресурса](../../operations/origin-groups/bind-group-to-resource.md#cli_1)
 * [Создать ресурс с пользовательским именем сервера для SNI](../../operations/resources/configure-server-name.md#cli_1)
 * [Создание ресурса](../../operations/resources/create-resource.md#cli_1)