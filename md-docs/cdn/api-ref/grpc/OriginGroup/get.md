[Документация Yandex Cloud](../../../../index.md) > [Yandex Cloud CDN](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [OriginGroup](index.md) > Get
...
To get a origin group ID, make a [OriginGroupService.List](list.md#List) request.
...
Origin group parameters. For details about the concept, see [documentation](../../../concepts/origins.md#groups).
