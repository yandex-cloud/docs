[Документация Yandex Cloud](../../index.md) > [Yandex Cloud CDN](../index.md) > [Практические руководства](index.md) > Сине-зеленое и канареечное развертывание версий сервиса
...
- API {#api}
  ...
  Используйте вызов gRPC API [ResourceService/Create](../api-ref/grpc/Resource/create.md) или метод REST API [create](../api-ref/Resource/create.md).
...
1. Удалите из кеша CDN-ресурса файл `index.html`:
   ...
   - API {#api}
     ...
     1. Получите идентификатор созданного CDN-ресурса с помощью вызова gRPC API [ResourceService/List](../api-ref/grpc/Resource/list.md) или метода REST API [list](../api-ref/Resource/list.md).
     1. Удалите файл `index.html` из кеша с помощью вызова gRPC API [CacheService/Purge](../api-ref/grpc/Cache/purge.md) или метода [purge](../api-ref/Cache/purge.md). 
...
1. Отключите кеширование CDN-ресурса и удалите из кеша файл `index.html`:
   ...
   - API {#api}
     ...
     1. Получите идентификатор созданного CDN-ресурса с помощью вызова gRPC API [ResourceService/List](../api-ref/grpc/Resource/list.md) или метода REST API [list](../api-ref/Resource/list.md).
     1. Отключите кеширование с помощью вызова gRPC API [ResourceService/Update](../api-ref/grpc/Resource/update.md) или метода REST API [list](../api-ref/Resource/update.md). 
...
1. Снова включите кеширование:
   ...
   - API {#api}
     ...
     1. Получите идентификатор созданного CDN-ресурса с помощью вызова gRPC API [ResourceService/List](../api-ref/grpc/Resource/list.md) или метода REST API [list](../api-ref/Resource/list.md).
     1. Включите кеширование с помощью вызова gRPC API [ResourceService/Update](../api-ref/grpc/Resource/update.md) или метода REST API [list](../api-ref/Resource/update.md).
...
1. [Удалите](../operations/resources/delete-resource.md) CDN-ресурс с основным доменным именем `cdn.yandexcloud.example`.
