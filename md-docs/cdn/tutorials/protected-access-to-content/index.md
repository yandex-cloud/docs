[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud CDN](../../index.md) > [Практические руководства](../index.md) > Организация защищенного доступа к контенту > Обзор

# Организация защищенного доступа к контенту в Cloud CDN


В этом руководстве вы создадите сайт, который будет генерировать [подписанные ссылки](../../concepts/secure-tokens.md#protected-link) с [защищенным токеном](../../concepts/secure-tokens.md) на CDN-ресурс Cloud CDN. Доступ к контенту по такой ссылке будет разрешен только в течение пяти минут с момента получения ссылки и только тому пользователю, для которого ссылка была сгенерирована.
