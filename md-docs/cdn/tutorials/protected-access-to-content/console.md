[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud CDN](../../index.md) > [Практические руководства](../index.md) > [Организация защищенного доступа к контенту](index.md) > Консоль управления, CLI, API
...
1. [Удалите](../../operations/resources/delete-resource.md) CDN-ресурс, затем [удалите](../../operations/origin-groups/delete-group.md) группу источников.
