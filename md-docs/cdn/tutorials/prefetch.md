...
- Консоль управления {#console}
  ...
  1. В разделе **Кеширование** в блоке **CDN** включите опцию **Кеширование в CDN**.
      ...
      [Подробнее о кешировании](../concepts/caching.md)
...
- API {#api}
  ...
  Используйте вызов gRPC API [ResourceService/Create](../api-ref/grpc/Resource/create.md) или метод REST API [create](../api-ref/Resource/create.md). Чтобы включить [кеширование](../concepts/caching.md) на CDN-серверах, добавьте в тело запроса поле `edge_cache_settings`.
...
- API {#api}
  ...
  Используйте вызов gRPC API [CacheService/Prefetch](../api-ref/grpc/Cache/prefetch.md) или метод REST API [prefetch](../api-ref/Cache/prefetch.md).
