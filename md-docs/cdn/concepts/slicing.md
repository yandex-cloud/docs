[Документация Yandex Cloud](../../index.md) > [Yandex Cloud CDN](../index.md) > [Концепции](index.md) > Обмен данными между CDN и источниками > Сегментация контента
...
* [Инструкция по включению сегментации](../operations/resources/enable-segmentation.md).