[Документация Yandex Cloud](../../index.md) > [Yandex Cloud CDN](../index.md) > [Концепции](index.md) > Обмен данными между клиентами и CDN > Сжатие контента
...
[Включение сжатия контента](../operations/resources/enable-compression.md) также помогает избежать ситуации, когда сжатые файлы получают пользователи, которые не запрашивали сжатый контент. Подробнее в разделе [Решение проблем в Cloud CDN](../troubleshooting.md#compressed-files).
