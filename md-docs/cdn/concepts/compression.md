...
[Включение сжатия контента](../operations/resources/enable-compression.md) также помогает избежать ситуации, когда сжатые файлы получают пользователи, которые не запрашивали сжатый контент. Подробнее см. в разделе [Решение проблем в Cloud CDN](../troubleshooting.md#compressed-files).
