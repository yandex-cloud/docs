[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud CDN](../../index.md) > [Пошаговые инструкции](../index.md) > Группы источников > Создать группу источников
...
- Консоль управления {#console}
  ...
  1. Настройте **Источники**:
     * Укажите **Тип источника**: `Сервер`, `Бакет` или `L7-балансировщик`. Подробнее о типах в разделе [Источники и их группы](../../concepts/origins.md).
     * Укажите источник.
     * Выберите **Приоритет**: `Основной` или `Резервный`. Подробнее о приоритетах в разделе [Группы источников](../../concepts/origins.md#groups).
...
- CLI {#cli}
  ...
  1. Создайте группу источников в [каталоге](../../../resource-manager/concepts/resources-hierarchy.md#folder) по умолчанию:
     ...
     * `backup` — флаг, указывающий, является ли источник резервным. Подробнее о приоритетах в разделе [Группы источников](../../concepts/origins.md#groups).
