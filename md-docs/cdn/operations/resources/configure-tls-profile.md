[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud CDN](../../index.md) > [Пошаговые инструкции](../index.md) > Ресурсы > Настройка профиля безопасности TLS
...
- Консоль управления {#console}
  ...
  1. В поле **Профиль безопасности TLS** выберите необходимый профиль:

      * `Безопасный (TLSv1.2+)`.
      * `Устаревший (TLSv1.0+)`.
      * `Защищённый (TLSv1.2+ с поддержкой PFS и AEAD)`.
      * `Усиленный (TLSv1.3)`.
