[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud CDN](../../index.md) > [Пошаговые инструкции](../index.md) > Ресурсы > Настроить заголовки запросов и ответов

# Настройка HTTP-заголовков запросов и ответов

{% note info %}

Заголовок `Access-Control-Allow-Origin` для конфигурации CORS настраивается в блоке **CORS при ответе клиенту**. Подробнее читайте в разделе [Настройка CORS при ответах клиентам](configure-cors.md).
...
- Консоль управления {#console}
  ...
  1. Перейдите на вкладку ![image](../../../_assets/console-icons/arrow-up-to-line.svg) **HTTP-заголовки и методы**.
...
* [Настройки обмена данными между CDN-серверами и источниками](../../concepts/servers-to-origins.md)
* [Настройка скрытия заголовков от источника](hiding-headers.md)