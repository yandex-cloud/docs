[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud CDN](../../index.md) > [Пошаговые инструкции](../index.md) > Ресурсы > Настроить скрытие заголовков от источника
...
- Консоль управления {#console}
  ...
  1. В блоке **Заголовки ответа клиенту** в поле **Скрытие заголовков источника** выберите `Скрывать все, кроме указанных`.
