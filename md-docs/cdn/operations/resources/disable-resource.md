[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud CDN](../../index.md) > [Пошаговые инструкции](../index.md) > Ресурсы > Приостановить и возобновить работу ресурса
...
- Консоль управления {#console}
  ...
  1. В блоке **Дополнительно** выключите опцию **Доступ к контенту**.
...
- Консоль управления {#console}
  ...
  1. В блоке **Дополнительно** включите опцию **Доступ к контенту**.
...
- Terraform {#tf}
  ...
  1. Откройте файл конфигурации Terraform и добавьте или измените блок ресурса `yandex_cdn_resource` на `active = true`.
