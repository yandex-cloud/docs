...
Настройки кеширования влияют на долю запросов, которые CDN-серверы могут обработать из кеша (Cache Hit). Cloud CDN не гарантирует определенную долю таких запросов. Если CDN-сервер не может ответить из кеша, он запрашивает контент из источника. Учитывайте возможное увеличение трафика при оценке допустимой нагрузки на источник и расходов на его работу.
