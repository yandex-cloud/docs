# Managed Service for OpenSearch API, gRPC: ClusterService.Create

Creates an OpenSearch cluster in the specified folder.

## gRPC request

**rpc Create ([CreateClusterRequest](#yandex.cloud.mdb.opensearch.v1.CreateClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## CreateClusterRequest {#yandex.cloud.mdb.opensearch.v1.CreateClusterRequest}
