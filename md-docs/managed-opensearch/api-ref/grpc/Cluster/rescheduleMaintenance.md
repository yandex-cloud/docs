[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for OpenSearch](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Cluster](index.md) > RescheduleMaintenance
...
The value can also point to a moment in the past if [reschedule_type.IMMEDIATE](rescheduleMaintenance.md#yandex.cloud.mdb.opensearch.v1.RescheduleMaintenanceRequest.RescheduleType) reschedule type is selected. ||
|#
