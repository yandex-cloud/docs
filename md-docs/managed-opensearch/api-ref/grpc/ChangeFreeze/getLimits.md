[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for OpenSearch](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [ChangeFreeze](index.md) > GetLimits

# Managed Service for OpenSearch API, gRPC: ChangeFreezeService.GetLimits
