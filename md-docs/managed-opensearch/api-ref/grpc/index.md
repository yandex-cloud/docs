[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for OpenSearch](../../index.md) > Справочник API > gRPC (англ.) > Overview
...
|| [User](User/index.md) | A set of methods for retrieving OpenSearch users. ||
