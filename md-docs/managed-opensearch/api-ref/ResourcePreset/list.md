[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for OpenSearch](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [ResourcePreset](index.md) > List
...
```
GET https://mdb.api.cloud.yandex.net/managed-opensearch/v1/resourcePresets
```
