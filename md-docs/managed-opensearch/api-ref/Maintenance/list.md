[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for OpenSearch](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Maintenance](index.md) > List

# Managed Service for OpenSearch API, REST: Maintenance.List
...
```
GET https://mdb.api.cloud.yandex.net/managed-opensearch/v1/maintenances
```
