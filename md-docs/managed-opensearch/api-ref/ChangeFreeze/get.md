[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for OpenSearch](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [ChangeFreeze](index.md) > Get

# Managed Service for OpenSearch API, REST: ChangeFreeze.Get
...
```
GET https://mdb.api.cloud.yandex.net/managed-opensearch/v1/changeFreezes/{changeFreezeId}
```
