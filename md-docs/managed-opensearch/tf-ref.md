...
| [yandex_mdb_opensearch_cluster_iam_binding]({{ tf-provider-resources-link }}/mdb_opensearch_cluster_iam_binding) | [Настройка](../iam/concepts/access-control/index.md#access-bindings) прав доступа к кластеру |
