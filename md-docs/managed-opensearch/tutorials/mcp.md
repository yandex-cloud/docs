...
1. Подготовьте инфраструктуру:
    ...
    - Вручную {#manual}
        ...
        1. [Создайте кластер Managed Service for OpenSearch](../operations/cluster-create.md#create-cluster) нужной вам конфигурации с публичным доступом к любой группе хостов.
...
1. Создайте отдельного пользователя для MCP-клиента.
    ...
    - OpenSearch Dashboards {#dashboards}
        ...
        1. [Подключитесь](../operations/connect/clients.md#dashboards) к OpenSearch Dashboards от имени `admin`.
