...
1. [Создайте кластер {{ mos-name }}](../operations/cluster-create.md) любой подходящей конфигурации.
...
- {{ OS }} Dashboards {#opensearch}
  ...
  1. Подключитесь к кластеру {{ mos-name }} с помощью [{{ OS }} Dashboards](../operations/connect/clients.md#dashboards).
