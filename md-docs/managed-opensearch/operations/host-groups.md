...
Если вы добавите в кластер группу хостов с ролью `MANAGER`, где эта роль назначена хостам с ролью `DATA`, такую группу будет невозможно удалить. Вернуть прежнюю конфигурацию хостов можно только [восстановив кластер из резервной копии](cluster-backups.md#restore).
