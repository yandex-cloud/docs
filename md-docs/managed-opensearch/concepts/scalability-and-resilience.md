...
Чтобы кластер обеспечивал [высокую доступность](high-availability.md), у каждого индекса должна быть хотя бы одна реплика. В кластерах, где действует [расширенная защита](high-availability.md#advanced-protection), запросы, которые задают нулевое число реплик — напрямую, через шаблон индекса или через [политику индекса](index-policy.md), — отклоняются с ошибкой.

Подробнее о требованиях к репликации в разделе [Высокая доступность кластера](high-availability.md#replication-settings).
