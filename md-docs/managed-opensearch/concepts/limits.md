[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for OpenSearch](../index.md) > [Концепции](index.md) > Квоты и лимиты

# Квоты и лимиты в Managed Service for OpenSearch


В сервисе Managed Service for OpenSearch действуют следующие ограничения:
