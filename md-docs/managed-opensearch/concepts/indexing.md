...
Подробнее об устройстве индексов см. в [документации OpenSearch](https://opensearch.org/docs/latest/opensearch/index-data/).
...
_Кодеки_ индексов определяют способ сжатия и хранения полей индекса на диске. Список поддерживаемых кодеков для OpenSearch см. в [документации OpenSearch](https://opensearch.org/docs/latest/im-plugin/index-codecs/#supported-codecs).
