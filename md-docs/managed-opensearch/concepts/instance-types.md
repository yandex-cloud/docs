...
Хосты в кластерах Managed Service for OpenSearch разворачиваются на базе виртуальных машин Yandex Compute Cloud. Эти виртуальные машины могут быть созданы на любой из стандартных платформ, которые поддерживает Compute Cloud. Подробное описание платформ приведено в разделе [Платформы](../../compute/concepts/vm-platforms.md).
