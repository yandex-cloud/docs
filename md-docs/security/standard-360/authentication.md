...
* Для остальных пользователей с административными задачами используйте роли с ограниченными правами. Подробнее в [документации](https://yandex.ru/support/yandex-360/business/admin/ru/accounts).
