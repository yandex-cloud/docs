...
## IaaS {#iaas}
Провайдер отвечает за физическую безопасность и [отказоустойчивость](../architecture/fault-tolerance.md) самой платформы, защищает сеть, собирает и анализирует события безопасности гипервизоров и других компонентов инфраструктуры.
