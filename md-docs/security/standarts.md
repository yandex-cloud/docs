[Документация Yandex Cloud](../index.md) > [Безопасность в Yandex Cloud](index.md) > Меры безопасности на стороне Yandex Cloud
...
Отчет о тестировании на проникновение Yandex Cloud доступен по [запросу](https://yandex.cloud/ru/security/compliance-portal#security-compliance-pentest-form).
