[Документация Yandex Cloud](../index.md) > [Безопасность в Yandex Cloud](index.md) > Соответствие требованиям
...
Дополнительную информацию о соответствии Yandex Cloud требованиям закона «О персональных данных» № 152-ФЗ смотрите на странице [Выполнение требований ФЗ-152](https://yandex.cloud/ru/security/standards/152-fz).

Для сервиса [Yandex BareMetal](../baremetal/index.md) действуют отдельные аттестат соответствия и заключение о соответствии. Вы можете найти их в соответствующем разделе на странице [Выполнение требований ФЗ-152](https://yandex.cloud/ru/security/standards/152-fz).
...
Дополнительную информацию о полученных Yandex Cloud сертификатах ISO 27001/27018, ISO 27017 и ISO 27701 смотрите на странице [Стандарты ISO](https://yandex.cloud/ru/security/standards/iso-standards).
...
Дополнительную информацию о полученных Yandex Cloud сертификатах PCI DSS и PCI DSS AOC смотрите на странице [Стандарты безопасности PCI](https://yandex.cloud/ru/security/standards/pci).
...
Дополнительную информацию о полученных Yandex Cloud сертификатах PCI PIN Security смотрите на странице [Стандарты безопасности PCI](https://yandex.cloud/ru/security/standards/pci).
...
Дополнительную информацию о полученных Yandex Cloud сертификатах PCI 3DS смотрите на странице [Стандарты безопасности PCI](https://yandex.cloud/ru/security/standards/pci).
...
Дополнительную информацию о полученных Yandex Cloud сертификатах ГОСТ Р 57580.1-2017 смотрите на странице [ГОСТ Р 57580](https://yandex.cloud/ru/security/standards/gost-p-57580).
...
Дополнительную информацию о включении Yandex Cloud в реестры программного обеспечения и провайдеров хостинга смотрите на странице [Государственные реестры РФ](https://yandex.cloud/ru/security/standards/software-registry).