...
Для сервиса [{{ baremetal-full-name }}](../baremetal/index.md) действуют отдельные аттестат соответствия и заключение о соответствии. Вы можете найти их в соответствующем разделе на странице [Выполнение требований ФЗ-152](https://yandex.cloud/ru/security/standards/152-fz).
