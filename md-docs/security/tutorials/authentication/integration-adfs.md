[Документация Yandex Cloud](../../../index.md) > [Безопасность в Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > Аутентификация и управление доступом > Аутентификация с помощью Active Directory
...
- Интерфейс Cloud Center {#cloud-center}
  ...
  1. В поле **Issuer / IdP EntityID** укажите ссылку в формате `http://<FQDN_фермы_AD_FS>/adfs/services/trust`.
  ...
  1. В поле **Метод SSO** выберите **POST**.

  1. В поле **Login URL** укажите ссылку в формате `https://<FQDN_фермы_AD_FS>/adfs/ls/`.
