[Документация Yandex Cloud](../../../index.md) > [Безопасность в Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > Защита приложений > Управление источниками трафика
...
- Консоль управления {#console}
  ...
  1. Включите тестовый режим для правила Smart Protection `sp-rule-1`:
     ...
     1. Напротив правила `sp-rule-1` нажмите ![image](../../../_assets/console-icons/ellipsis.svg) → ![pencil](../../../_assets/console-icons/pencil.svg) **Редактировать**.
...
- Консоль управления {#console}
  ...
  1. Нажмите ![image](../../../_assets/console-icons/plus.svg) **Добавить правило**.
...
- Консоль управления {#console}
  ...
  1. В профиле безопасности нажмите ![image](../../../_assets/console-icons/plus.svg) **Добавить правило**.
