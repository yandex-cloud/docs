[Документация Yandex Cloud](../../../index.md) > [Безопасность в Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > Настройка SSO > OpenVPN > Настройка единого входа в OpenVPN Access Server по стандарту SAML
