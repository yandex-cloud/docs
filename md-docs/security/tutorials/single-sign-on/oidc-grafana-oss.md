[Документация Yandex Cloud](../../../index.md) > [Безопасность в Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > Настройка SSO > Grafana > Настройка единого входа в Grafana OSS по стандарту OIDC
