[Документация Yandex Cloud](../../../index.md) > [Безопасность в Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > Настройка SSO > Cloud.ru > Настройка единого входа в Cloud.ru по стандарту OIDC
