...
- Консоль управления {#console}
  ...
  1. Создайте группу безопасности для балансировщика:
      ...
      1. В поле **Назначение** или **Источник** выберите назначение правила:
         * `Диапазон адресов` — правило будет применено к диапазону IP-адресов. В поле **IPv4 CIDR** укажите CIDR и маски [подсетей](../../../../vpc/concepts/network.md#subnet), в которые или из которых будет поступать трафик. Чтобы добавить несколько CIDR, нажимайте кнопку **Добавить CIDR**.
