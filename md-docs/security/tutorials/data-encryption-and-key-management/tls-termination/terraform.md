[Документация Yandex Cloud](../../../../index.md) > [Безопасность в Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > Шифрование данных и управление ключами > [Терминирование TLS-соединений](index.md) > Терминирование TLS-соединений с помощью Terraform
...
1. Подготовьте файлы с описанием инфраструктуры:
   ...
   * [TLS-сертификат](../../../../certificate-manager/concepts/imported-certificate.md) — [yandex_cm_certificate](../../../../terraform/resources/cm_certificate.md).
