...
В руководстве представлен пример интеграции пользовательской инсталляции Kubernetes с федерацией сервисных аккаунтов. Руководство по интеграции Managed Service for Kubernetes смотрите на странице [Доступ к API Yandex Cloud из кластера Managed Service for Kubernetes с помощью федерации сервисных аккаунтов Identity and Access Management](../../../tutorials/security/wlif-managed-k8s-integration.md).
...
* [Доступ к API Yandex Cloud из кластера Managed Service for Kubernetes с помощью федерации сервисных аккаунтов Identity and Access Management](../../../tutorials/security/wlif-managed-k8s-integration.md)
* [Получение значения секрета Yandex Lockbox на стороне GitLab](../../../tutorials/security/wlif-gitlab-integration.md)
