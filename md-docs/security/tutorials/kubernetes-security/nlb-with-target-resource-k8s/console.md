[Документация Yandex Cloud](../../../../index.md) > [Безопасность в Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > Безопасность Kubernetes > [Миграция сервисов с балансировщика NLB с целевыми ресурсами из кластера Managed Service for Kubernetes на L7-балансировщик ALB](index.md) > Консоль управления
