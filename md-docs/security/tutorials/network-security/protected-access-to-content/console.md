[Документация Yandex Cloud](../../../../index.md) > [Безопасность в Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > Сетевая безопасность > [Организация защищенного доступа к контенту в Cloud CDN](index.md) > Организация защищенного доступа к контенту в Cloud CDN с помощью консоли управления, CLI или API

# Организация защищенного доступа к контенту в Yandex Cloud CDN с помощью консоли управления, CLI или API
...
* [Организация защищенного доступа к контенту в Yandex Cloud CDN с помощью Terraform](terraform.md)