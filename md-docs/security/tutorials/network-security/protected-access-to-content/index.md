[Документация Yandex Cloud](../../../../index.md) > [Безопасность в Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > Сетевая безопасность > Организация защищенного доступа к контенту в Cloud CDN > Обзор
