...
* Плата за публичный IP-адрес и исходящий трафик (см. [тарифы Yandex Virtual Private Cloud](../../../vpc/pricing.md)).
...
- Консоль управления {#console}
    ...
    1. [Перейдите](../../../console/operations/select-service.md#select-service) в сервис **Compute Cloud** и выберите ВМ `vipnet-va`.
