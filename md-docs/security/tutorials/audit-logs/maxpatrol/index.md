[Документация Yandex Cloud](../../../../index.md) > [Безопасность в Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > Сбор, мониторинг и анализ аудитных логов > Загрузка аудитных логов в MaxPatrol SIEM > Обзор
