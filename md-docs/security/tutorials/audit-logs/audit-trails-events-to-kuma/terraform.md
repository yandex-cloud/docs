[Документация Yandex Cloud](../../../../index.md) > [Безопасность в Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > Сбор, мониторинг и анализ аудитных логов > [Загрузка аудитных логов Audit Trails в SIEM KUMA](index.md) > Загрузка аудитных логов в SIEM KUMA с помощью Terraform
