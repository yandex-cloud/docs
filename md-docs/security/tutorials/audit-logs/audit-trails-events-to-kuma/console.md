[Документация Yandex Cloud](../../../../index.md) > [Безопасность в Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > Сбор, мониторинг и анализ аудитных логов > [Загрузка аудитных логов Audit Trails в SIEM KUMA](index.md) > Загрузка аудитных логов в SIEM KUMA с помощью консоли управления, CLI или API
...
- Консоль управления {#console}
  ...
  1. Чтобы установить ограничение, включите опцию **Установить максимальный размер бакета** и в появившихся полях задайте нужный размер.
...
- Консоль управления {#console}
  ...
  1. В блоке **Назначение** задайте параметры объекта назначения:
      ...
      1. **Бакет** — созданный ранее бакет, например `my-audit-logs-for-kuma`.
