...
Используйте черные и белые списки IP-адресов для фильтрации трафика. Подробнее см. в разделе [Управление списками](../../smartwebsecurity/operations/list-create.md).