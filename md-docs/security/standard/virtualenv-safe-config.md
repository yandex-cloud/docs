[Документация Yandex Cloud](../../index.md) > [Безопасность в Yandex Cloud](../index.md) > [Стандарт по защите облачной инфраструктуры, версия 1.4.2](index.md) > Безопасная конфигурация виртуальной среды
...
- Ручная проверка {#manual}
  ...
  Вручную проверьте версию протокола TLS и актуальность сертификата TLS-соединения.
