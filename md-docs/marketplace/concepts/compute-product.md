...
* Терминал `ttyS0` (порт COM1) настроен в качестве [серийной консоли](../../compute/concepts/serial-console.md). См. [инструкцию](../../compute/operations/image-create/custom-image.md#serial-console).
