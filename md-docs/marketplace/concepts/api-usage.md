[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Marketplace](../index.md) > Партнерам > Концепции > Тарификация продуктов на основе метрик издателя
...
Спецификация API выставления счетов по тарифу приведена в разделе [Marketplace Metering API: REST reference](../metering/api-ref/index.md).
...
* Перед публикацией продукта рекомендуем тестировать интеграцию с API с помощью ID и SKU демонстрационного продукта: `productId: f2e4tmlj4qqciunhr7e6`, `skuId: dn272e8979uvek5cnuhk`. Примеры работы с API приведены в разделе [Как начать работать с Marketplace Metering API](../api-ref/quickstart.md).
