[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Marketplace](../index.md) > Партнерам > Пошаговые инструкции > Регистрация
...
1. Чтобы создать ваш первый платежный аккаунт, на вкладке ![image](../../_assets/console-icons/flag.svg) **Аккаунт** нажмите кнопку ![plus](../../_assets/console-icons/plus.svg) **Создать аккаунт**.
   ...
   1. Если к вашему Яндекс ID привязана контактная информация, она добавится в аккаунт автоматически. Если этого не произошло, укажите актуальный адрес электронной почты и актуальный номер телефона. Контактные данные нужны не только для связи с вами, но и для выставления счетов и финансовых документов.
