...
1. [Станьте партнером](../../quickstart.md#send-application) Marketplace и [зарегистрируйте](../../operations/registration.md) аккаунт юридического лица.
1. В [кабинете партнера](https://partners.yandex.cloud/) создайте [продукт](../../operations/create-product.md) и [тариф](../../operations/create-tariff.md) с типом [Subscription](../../concepts/subscription.md).
1. [Создайте](../../../iam/operations/sa/create.md) сервисный аккаунт, от имени которого вы будете аутентифицироваться в API.
1. [Назначьте](../../../iam/operations/sa/assign-role-for-sa.md#binding-role-organization) сервисному аккаунту роль `license-manager.saasSubscriptionSupervisor` на [профиль партнера](../../concepts/publisher.md) и на ваш [продукт](../../concepts/product.md).
