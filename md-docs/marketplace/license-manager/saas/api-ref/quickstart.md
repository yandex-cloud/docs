...
Чтобы воспользоваться примерами, установите утилиты [cURL](https://curl.haxx.se) и [gRPCurl](https://github.com/fullstorydev/grpcurl) (при использовании [gRPC API](grpc/index.md)).
...
1. Организуйте периодическую проверку того, что привязка подписки активна. Используйте для этого идентификатор привязки (`lock_id`), полученный на предыдущем шаге.
    ...
    * метода REST API [get](Lock/get.md) для ресурса [Lock](Lock/index.md) или вызова gRPC API [LockService/Get](grpc/Lock/get.md).
    ...
    * метода REST API [getByResourceID](Lock/getByResourceID.md) для ресурса [Lock](Lock/index.md) или вызова gRPC API [LockService/Get](grpc/Lock/getByResourceID.md).
...
Чтобы получить информацию о привязке, воспользуйтесь методом REST API [Get](Lock/get.md) для ресурса [Lock](Lock/index.md) или вызовом gRPC API [LockService/get](grpc/Lock/get.md):
...
Чтобы получить данные об экземпляре подписки, воспользуйтесь методом REST API [Get](Instance/get.md) для ресурса [Instance](Instance/index.md) или вызовом gRPC API [InstanceService/Get](grpc/Instance/get.md):
