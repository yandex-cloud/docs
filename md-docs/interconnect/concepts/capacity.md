[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Interconnect](../index.md) > [Концепции](index.md) > Объемы данных и емкости подключений

# Объемы данных и емкости подключений

Объем данных — это единица тарификации Cloud Interconnect, которая равна объему трафика, передаваемому в течение месяца.
...
* Стоимость объемов данных в [Правилах тарификации](../pricing.md).
