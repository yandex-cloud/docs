...
* Со стороны виртуальной сети Yandex Cloud [добавить набор IP-префиксов подсетей](../../cloud-router/operations/ri-prefixes-upsert.md) из определенной виртуальной сети в `Routing Instance`, которые с помощью протокола BGP будут анонсированы в направлении оборудования клиента.
