...
- Через поддержку {#support}
  ...
  Создайте [обращение в поддержку](https://center.yandex.cloud/support) для резервирования порта на оборудовании Yandex Cloud и создания транкового подключения.
...
1. Создайте [обращение в поддержку](https://center.yandex.cloud/support), укажите идентификатор транкового подключения и приложите заполненный шаблон. В обращении запросите недостающие сведения о размещении оборудования и подписание согласительного письма со стороны Yandex Cloud.
...
- Через поддержку {#support}
  ...
  Создайте [обращение в поддержку](https://center.yandex.cloud/support) для организации транкового подключения через партнера.
...
Метрики транковых подключений через партнера не предоставляются. Метрики созданных в них приватных и публичных соединений доступны в [Yandex Monitoring](../concepts/monitoring.md#private-metrics).
...
- Через поддержку {#support}
  ...
  Создайте [обращение в поддержку](https://center.yandex.cloud/support) для резервирования портов на оборудовании Yandex Cloud и создания LAG-транка.
