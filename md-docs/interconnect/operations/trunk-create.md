...
- Консоль управления {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором нужно создать подключение.
  ...
  1. Нажмите кнопку **Создать обращение в поддержку**.

      Если в каталоге уже есть транковые подключения, нажмите ссылку **обратитесь** в информационном блоке над списком подключений.

      Откроется форма **Новое обращение**. В ней автоматически выбраны сервис **Cloud Interconnect** и тема **[CIC] Создание транкового подключения**.
