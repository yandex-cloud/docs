[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Interconnect](../index.md) > [Практические руководства](index.md) > Изменить емкость транкового подключения
...
* [прямое транковое подключение](../concepts/trunk.md)

* [транкового подключения через партнера](../concepts/trunk.md#partner-link) 
...
* `capacity` — актуальная [емкость транкового подключения](../concepts/capacity.md) для данного транкового подключения.
