[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Interconnect](../index.md) > [Практические руководства](index.md) > Создать прямое транковое подключение и приватное соединение в нем
...
Чтобы организовать новое приватное соединение в уже созданном транке, создайте [новое обращение в поддержку](https://center.yandex.cloud/support).
...
* `vpc_net_id` — идентификатор сети Yandex Virtual Private Cloud в которую будет подключаться приватное соединение.
