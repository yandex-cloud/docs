...
* Выберите тип [оптического трансивера](../concepts/transceivers.md) для подключения кроссировки в оборудование Yandex Cloud в [точке присутствия](../concepts/pops.md). На стороне оборудования Yandex Cloud за вами будет зарезервирован порт с выбранным типом. Для установки в свое оборудование вам необходимо приобрести трансивер выбранного типа самостоятельно.
