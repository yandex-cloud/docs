[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Interconnect](../index.md) > [Практические руководства](index.md) > Организация сетевой связности между приватной подсетью BareMetal и ресурсами в on-premises
...
* плата за использование Cloud Interconnect ([тарифы Cloud Interconnect](../pricing.md)).
...
Для настройки понадобятся приватная маршрутизируемая [подсеть](../../baremetal/concepts/private-network.md#private-subnet) и [VRF](../../baremetal/concepts/private-network.md#vrf-segment) в BareMetal, сервер BareMetal, действующее приватное соединение Cloud Interconnect и виртуальный маршрутизатор Cloud Router.
