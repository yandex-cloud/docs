[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Interconnect](../../index.md) > [Справочник CLI (англ.)](../index.md) > [private-connection](index.md) > get
...
`yc cic private-connection get <PRIVATE-CONNECTION-ID>`
