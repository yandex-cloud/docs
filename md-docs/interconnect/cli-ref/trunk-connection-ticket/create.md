[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Interconnect](../../index.md) > [Справочник CLI (англ.)](../index.md) > [trunk-connection-ticket](index.md) > create

# yc cic trunk-connection-ticket create
...
`yc cic trunk-connection-ticket create <FOLDER-ID>`
...
1. Generate template:
yc cic trunk-connection-ticket create --example-json > request.json
or
yc cic trunk-connection-ticket create --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc cic trunk-connection-ticket create -r request.json
or
yc cic trunk-connection-ticket create -r request.yaml ||
|#
