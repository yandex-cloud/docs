...
**rpc ListOperations ([ListTrunkConnectionOperationsRequest](#yandex.cloud.cic.v1.ListTrunkConnectionOperationsRequest)) returns ([ListTrunkConnectionOperationsResponse](#yandex.cloud.cic.v1.ListTrunkConnectionOperationsResponse))**

## ListTrunkConnectionOperationsRequest {#yandex.cloud.cic.v1.ListTrunkConnectionOperationsRequest}
...
is larger than [ListTrunkConnectionOperationsRequest.page_size](#yandex.cloud.cic.v1.ListTrunkConnectionOperationsRequest), use
the `next_page_token` as the value
for the [ListTrunkConnectionOperationsRequest.page_token](#yandex.cloud.cic.v1.ListTrunkConnectionOperationsRequest) query parameter
