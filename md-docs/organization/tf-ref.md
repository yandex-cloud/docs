[Документация Yandex Cloud](../index.md) > [Yandex Identity Hub](index.md) > Справочник Terraform
...
| --- | --- |
| [yandex_organization_manager_organization_iam_policy_binding](../terraform/resources/organization_manager_organization_iam_policy_binding.md) | Назначение [политики авторизации](operations/manage-access-policies.md) на организацию |
...
| [yandex_organizationmanager_idp_application_oauth_application_assignment](../terraform/resources/organizationmanager_idp_application_oauth_application_assignment.md) | Назначение пользователя или группы пользователей [OIDC-приложению](concepts/applications/oidc.md) |
...
| [yandex_organizationmanager_idp_application_saml_application_assignment](../terraform/resources/organizationmanager_idp_application_saml_application_assignment.md) | Назначение пользователя или группы пользователей [SAML-приложению](concepts/applications/saml.md) |
| [yandex_organizationmanager_idp_application_saml_signature_certificate](../terraform/resources/organizationmanager_idp_application_saml_signature_certificate.md) | [Сертификат ключа проверки электронной подписи](concepts/applications/saml.md#saml-certificate) SAML-приложения |
...
| [yandex_organizationmanager_idp_userpool_domain](../terraform/resources/organizationmanager_idp_userpool_domain.md) | [Домен](operations/user-pools/add-domain.md) пула пользователей |
...
| [yandex_organizationmanager_mfa_enforcement_excluded_audience](../terraform/resources/organizationmanager_mfa_enforcement_excluded_audience.md) | Пользователь или группа пользователей, [исключенные из политики MFA](operations/mfa/excluded-audience.md) |
...
| [yandex_organizationmanager_idp_application_saml_signature_certificate](../terraform/data-sources/organizationmanager_idp_application_saml_signature_certificate.md) | Информация о [сертификате ключа проверки электронной подписи](concepts/applications/saml.md#saml-certificate) SAML-приложения |
