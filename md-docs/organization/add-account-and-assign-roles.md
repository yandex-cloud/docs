[Документация Yandex Cloud](../index.md) > [Yandex Identity Hub](index.md) > Начало работы > Пригласить нового пользователя и назначить роли
...
Для приглашения пользователей с аккаунтом на Яндексе смотрите инструкции [Добавить пользователя](operations/add-account.md). Инструкции для федеративных и локальных пользователей смотрите в разделе [Управление аккаунтом пользователя](operations/user-account/index.md).
...
- Консоль управления {#console}
    ...
    1. В [консоли управления](https://console.yandex.cloud) [выберите](../resource-manager/operations/cloud/switch-cloud.md) облако `testing`.
...
Чтобы назначить дополнительные роли или отозвать уже выданные, используйте инструкции  [Настройка прав доступа к облаку](../resource-manager/operations/cloud/set-access-bindings.md) и [Настройка прав доступа к каталогу](../resource-manager/operations/folder/set-access-bindings.md).
