...
Для приглашения пользователей с аккаунтом на Яндексе см. инструкции [Добавить пользователя](operations/add-account.md). Инструкции для федеративных и локальных пользователей см. в разделе [Управление аккаунтом пользователя](operations/user-account/index.md).
...
Подробные инструкции для пользователей по первому входу и работе с аккаунтом см. в разделе [Управление аккаунтом пользователя](operations/user-account/index.md).
...
Подробнее о первом входе для разных типов пользователей см. в инструкции [Первый вход в консоль](operations/user-account/first-login.md).
