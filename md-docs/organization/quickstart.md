...
Подробнее о пользователях см. в разделе [Членство в организации](concepts/membership.md).
...
Более того, Yandex Identity Hub может выступать в качестве поставщика удостоверений, которого вы можете использовать для аутентификации ваших пользователей в сторонних системах и сервисах с помощью [приложений](concepts/applications.md).
...
Подробнее см. в разделе [OS Login](concepts/os-login.md).
