...
Управлять настройками безопасности можно только в OIDC-приложениях [типа](*oidc_app_type) `Web Application`.
...
Управлять секретами можно только в OIDC-приложениях [типа](*oidc_app_type) `Web Application`.
