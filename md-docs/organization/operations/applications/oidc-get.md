[Документация Yandex Cloud](../../../index.md) > [Yandex Identity Hub](../../index.md) > [Пошаговые инструкции](../index.md) > Управление приложениями (SSO) > OIDC-приложения > Получить информацию о приложении
...
- Интерфейс Cloud Center {#cloud-center}
  ...
  1. Нажмите на строку с [OIDC-приложением](../../concepts/applications/oidc.md), о котором вы хотите получить информацию.
...
- CLI {#cli}
  ...
  1. Посмотрите описание команды CLI для получения информации об [OIDC-приложении](../../concepts/applications/oidc.md):
...
- Terraform {#tf}
  ...
  1. Добавьте в конфигурационный файл Terraform блоки `data` и `output`:
     ...
     * `output` — выходные переменные, которые содержат информацию о приложении:
     ...
     Вместо указанных параметров вы можете выбрать любые другие для получения информации. Подробнее о параметрах источника данных `yandex_organizationmanager_idp_application_oauth_application` читайте в [документации провайдера](../../../terraform/data-sources/organizationmanager_idp_application_oauth_application.md).
