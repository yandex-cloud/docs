[Документация Yandex Cloud](../../index.md) > [Yandex Identity Hub](../index.md) > [Пошаговые инструкции](index.md) > Управление пользователями > Добавить пользователя
...
- Интерфейс Cloud Center {#cloud-center}
  ...
  1. Чтобы назначить роли на ресурсы:
     ...
     1. Чтобы назначить роли на еще один ресурс, нажмите ![plus](../../_assets/console-icons/plus.svg) **Добавить ресурс и роль** и повторите предыдущие шаги.
      ...
      Назначать роли можно на [организацию](../concepts/organization.md), [облако](../../resource-manager/concepts/resources-hierarchy.md#cloud) и [каталог](../../resource-manager/concepts/resources-hierarchy.md#folder). Роли, назначенные на организацию, облако или каталог, действуют и на вложенные ресурсы.
...
- Консоль управления {#console}
    ...
    1. Нажмите **Далее**. Откроется окно для назначения ролей и добавления пользователей в группу.
