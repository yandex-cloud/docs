[Документация Yandex Cloud](../../../index.md) > [Yandex Identity Hub](../../index.md) > [Пошаговые инструкции](../index.md) > Управление пользователями > Активировать пользователя
...
- Интерфейс Cloud Center {#cloud-center}
  ...
  Если локальный пользователь был деактивирован автоматически при наступлении указанной даты деактивации, вы можете разблокировать его, изменив или удалив эту дату.
