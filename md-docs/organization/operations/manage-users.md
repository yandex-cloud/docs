[Документация Yandex Cloud](../../index.md) > [Yandex Identity Hub](../index.md) > Пошаговые инструкции > Пользователи

# Управление аккаунтами пользователей

С помощью Yandex Identity Hub вы можете централизованно управлять учетными записями пользователей и доступом к корпоративным приложениям по протоколам SAML и OpenID Connect (Identity Provider).
...
* [Посмотрите группы, в которые входит пользователь](get-users-groups.md).
