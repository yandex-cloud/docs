...
С помощью {{ org-full-name }} вы можете централизованно управлять учетными записями пользователей и доступом к корпоративным приложениям по протоколам SAML и OpenID Connect (Identity Provider).
