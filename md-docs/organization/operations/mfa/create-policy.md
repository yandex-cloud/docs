...
- Интерфейс Cloud Center {#cloud-center}
  ...
  1. В правом верхнем углу страницы нажмите ![plus](../../../_assets/console-icons/plus.svg) **Создать политику** и в открывшемся окне:
      ...
      1. (Опционально) В блоке **Самостоятельный сброс пароля** задайте параметры [самостоятельного сброса](../../concepts/sspr.md) пользователями своих паролей.
         
         Подробнее читайте в разделе [Настроить самостоятельный сброс пароля пользователями в Yandex Identity Hub](../manage-sspr.md).
