[Документация Yandex Cloud](../../index.md) > [Yandex Identity Hub](../index.md) > [Пошаговые инструкции](index.md) > Подписать пользователя на уведомления
...
Пользователи, которых вы подписали на уведомления, будут получать технические уведомления организации. Настроить типы и каналы получения уведомлений каждый подписанный пользователь может самостоятельно. Подробнее читайте в разделе [Способы получения уведомлений](../../resource-manager/concepts/notify.md#notification-settings).