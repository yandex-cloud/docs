...
Создать профиль {{ oslogin }} сервисного аккаунта можно только с помощью [{{ yandex-cloud }} CLI](../cli-ref/oslogin/profile/create.md) или [API](../api-ref/OsLogin/createProfile.md).
