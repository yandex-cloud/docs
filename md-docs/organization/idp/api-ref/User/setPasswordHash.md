[Документация Yandex Cloud](../../../../index.md) > [Yandex Identity Hub](../../../index.md) > Справочник API > REST (англ.) > [Identity Provider API](../index.md) > [User](index.md) > SetPasswordHash
...
This value is ignored if [CreateUserRequest.passwordChangeRequired](create.md#yandex.cloud.organizationmanager.v1.idp.CreateUserRequest) or [SetPasswordHashRequest.needChange](#yandex.cloud.organizationmanager.v1.idp.SetPasswordHashRequest) is true.
