[Документация Yandex Cloud](../../../../index.md) > [Yandex Identity Hub](../../../index.md) > Справочник API > REST (англ.) > [Identity Provider API](../index.md) > [Userpool](index.md) > Update
...
```
PATCH https://organization-manager.api.cloud.yandex.net/organization-manager/v1/idp/userpools/{userpoolId}
```
...
To get the userpool ID, make a [UserpoolService.List](list.md#List) request.
