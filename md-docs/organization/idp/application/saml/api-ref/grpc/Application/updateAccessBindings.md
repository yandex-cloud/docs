[Документация Yandex Cloud](../../../../../../../index.md) > [Yandex Identity Hub](../../../../../../index.md) > Справочник API > gRPC (англ.) > Identity Provider API > [SAML Application API](../index.md) > [Application](index.md) > UpdateAccessBindings

# SAML Application API, gRPC: ApplicationService.UpdateAccessBindings
...
* `group`: A group of users. This type represents the [yandex.cloud.organizationmanager.v1.Group](../../../../../../api-ref/grpc/Group/get.md#yandex.cloud.organizationmanager.v1.Group) resource.
