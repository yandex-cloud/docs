[Документация Yandex Cloud](../../../../../../../index.md) > [Yandex Identity Hub](../../../../../../index.md) > Справочник API > gRPC (англ.) > Identity Provider API > [OAUTH Application API](../index.md) > [Application](index.md) > Create
...
```json
{
  ...
  "group_claims_settings": {
    ...
    "group_claim_value": "GroupClaimValue"
  },
  "client_grant": {
    "client_id": "string",
    "authorized_scopes": [
...
|| group_claim_value | enum **GroupClaimValue**
