[Документация Yandex Cloud](../../../../../../index.md) > [Yandex Identity Hub](../../../../../index.md) > Справочник API > REST (англ.) > Identity Provider API > [OAUTH Application API](../index.md) > [Application](index.md) > UpdateAccessBindings
...
```
PATCH https://organization-manager.api.cloud.yandex.net/organization-manager/v1/idp/application/oauth/applications/{resourceId}:updateAccessBindings
```
