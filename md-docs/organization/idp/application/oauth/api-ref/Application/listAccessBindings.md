[Документация Yandex Cloud](../../../../../../index.md) > [Yandex Identity Hub](../../../../../index.md) > Справочник API > REST (англ.) > Identity Provider API > [OAUTH Application API](../index.md) > [Application](index.md) > ListAccessBindings

# OAUTH Application API, REST: Application.ListAccessBindings
...
```
GET https://organization-manager.api.cloud.yandex.net/organization-manager/v1/idp/application/oauth/applications/{resourceId}:listAccessBindings
```
...
* `group`: A group of users. This type represents the [yandex.cloud.organizationmanager.v1.Group](../../../../../api-ref/Group/get.md#yandex.cloud.organizationmanager.v1.Group) resource.
