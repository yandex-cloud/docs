...
`yc organization-manager organization add-access-binding <ORGANIZATION-NAME>|<ORGANIZATION-ID> [Flags...] [Global Flags...]`
 ...
 * [Назначить пользователя администратором организации](../../operations/add-org-admin.md#cli_1)
