[Документация Yandex Cloud](../../../../../index.md) > [Yandex Identity Hub](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [v0](../../index.md) > [oslogin](../index.md) > [user-ssh-key](index.md) > list

# yc organization-manager v0 oslogin user-ssh-key list
