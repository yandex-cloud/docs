...
Политики аутентификации позволяют запрещать или разрешать аутентификацию пользователя, если событие аутентификации соответствует заданным в политике [условиям](#conditions).
