...
Аутентификация агента синхронизации на стороне Active Directory может осуществляться по имени и паролю пользователя домена или с использованием протокола Kerberos версии 5.
...
Конфигурация агента синхронизации зависит от типа аутентификации, используемого агентом на стороне Active Directory, и задается в [YAML](https://yaml.org/)-файле в следующем формате:
