[Документация Yandex Cloud](../index.md) > [Yandex Identity Hub](index.md) > Диагностика ошибок > Ошибки в федерациях, работающих по протоколу SAML 2.0
...
Новый пользователь попытался присоединиться к федерации с отключенной опцией автоматического создания пользователей. [Добавьте пользователя вручную](operations/add-account.md#add-user-sso) или включите опцию **Автоматически создавать пользователей** в настройках федерации.
...
Данный тип федераций больше не поддерживается, обратитесь в [службу поддержки](https://center.yandex.cloud/support).
...
- Консоль управления {#console}
  ...
  В поле **Login URL** указан некорректный протокол URL. Допускаются только протоколы HTTP и HTTPS.
...
- Консоль управления {#console}
  ...
  В поле **Login URL** указана некорректная ссылка. Проверьте ссылку.
