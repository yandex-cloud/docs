[Документация Yandex Cloud](../../../../index.md) > [Yandex Identity Hub](../../../index.md) > Справочник API > REST (англ.) > [SAML Federation API](../index.md) > [Operation](index.md) > Cancel

# SAML Federation API, REST: Operation.Cancel
