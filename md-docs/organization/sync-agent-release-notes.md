...
### Версия 0.48.0 (13.08.26) {#version0.48.0}

#### Изменения в Yandex Identity Hub Sync Agent {#changes-version0.48.0}

* Добавлена поддержка аутентификации в AD через Windows identity (gMSA/sMSA) — параметр `use_windows_identity` для LDAP/DRSR.
* Добавлена опциональная проверка прав доступа к файлам конфигурации и статических учетных данных; установщики Linux и Windows теперь ограничивают доступ к конфигурации.
* Добавлена поддержка синхронизации из произвольных LDAP-каталогов.
* Добавлена обратная синхронизация изменений паролей из Identity Hub в Active Directory и LDAP-каталоги (`password writeback`).
...
#### Изменения в Yandex Identity Hub Sync Agent {#changes-version0.47.0}
