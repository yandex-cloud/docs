[Документация Yandex Cloud](../../../index.md) > [Yandex Identity Hub](../../index.md) > [Практические руководства](../index.md) > Настройка единого входа в приложения (SSO) > Обзор

#  Настройка единого входа в приложения (SSO)

* [1С:Предприятие](oidc-1c-enterprise.md)
* Cloud.ru
    * [SAML](cloud-ru/saml-cloud-ru.md)
    * [OpenID Connect](cloud-ru/oidc-cloud-ru.md)
* Grafana Cloud
    * [SAML](grafana/saml-grafana.md)
    * [OpenID Connect](grafana/oidc-grafana.md)
* [Grafana OSS](oidc-grafana-oss.md)
* [Harbor](oidc-harbor.md)
* Jenkins
