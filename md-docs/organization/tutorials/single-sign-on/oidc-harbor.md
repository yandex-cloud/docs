...
Чтобы пользователи вашей [организации](../../concepts/organization.md) входили в Harbor с помощью OpenID Connect, создайте [OIDC-приложение](../../concepts/applications.md#oidc) в {{ org-full-name }} и настройте интеграцию на стороне {{ org-full-name }} и Harbor.
...
Чтобы пользователи организации входили в Harbor через OIDC-приложение {{ org-full-name }}, явно добавьте в приложение нужных пользователей и/или [группы пользователей](../../concepts/groups.md).
