[Документация Yandex Cloud](../../../../index.md) > [Yandex Identity Hub](../../../index.md) > [Практические руководства](../../index.md) > [Настройка единого входа в приложения (SSO)](../index.md) > VK Cloud > SAML
...
Чтобы пользователи вашей [организации](../../../concepts/organization.md) могли аутентифицироваться в VK Cloud с помощью технологии единого входа по стандарту SAML, создайте [SAML-приложение](../../../concepts/applications/saml.md) в Yandex Identity Hub и настройте его на стороне Yandex Cloud и на стороне VK Cloud.
...
1. Создайте федерацию удостоверений в VK Cloud, используя метаданные Yandex Identity Hub:
    ...
    1. Откройте раздел **Федерация удостоверений** и выберите вкладку **Федерации**.
    1. Нажмите **Создать**.
...
1. Перейдите в [аккаунт VK Cloud](https://cloud.vk.com/account).
1. Откройте раздел **Федерация удостоверений** и выберите вкладку **Группы**.
