[Документация Yandex Cloud](../../../../index.md) > [Yandex Identity Hub](../../../index.md) > [Практические руководства](../../index.md) > [Управление федерациями удостоверений](../index.md) > Сопоставление групп пользователей > Сопоставление групп пользователей в Microsoft Entra ID
...
Чтобы настроить сопоставление (mapping) групп пользователей в Entra ID и групп пользователей в [федерации удостоверений](../../../concepts/add-federation.md):
...
- Интерфейс Cloud Center {#cloud-center}
  ...
  1. В правом верхнем углу страницы нажмите кнопку ![Circles3Plus](../../../../_assets/console-icons/circles-3-plus.svg) **Создать федерацию**. В открывшемся окне:
      ...
      1. В поле **Issuer / IdP EntityID** вставьте идентификатор Microsoft Entra, [полученный в ходе настройки приложения Azure](#azure-settings-begin).

      1. В поле **Login URL** вставьте URL-адрес входа, полученный в ходе настройки приложения Azure.
