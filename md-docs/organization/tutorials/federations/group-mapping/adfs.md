[Документация Yandex Cloud](../../../../index.md) > [Yandex Identity Hub](../../../index.md) > [Практические руководства](../../index.md) > [Управление федерациями удостоверений](../index.md) > Сопоставление групп пользователей > Сопоставление групп пользователей в Active Directory Federation Services
