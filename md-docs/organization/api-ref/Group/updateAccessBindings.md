[Документация Yandex Cloud](../../../index.md) > [Yandex Identity Hub](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Group](index.md) > UpdateAccessBindings
...
```
POST https://organization-manager.api.cloud.yandex.net/organization-manager/v1/groups/{resourceId}:updateAccessBindings
```
...
* `group`: A group of users. This type represents the [yandex.cloud.organizationmanager.v1.Group](get.md#yandex.cloud.organizationmanager.v1.Group) resource.
