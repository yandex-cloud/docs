[Документация Yandex Cloud](../../../index.md) > [Yandex Identity Hub](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Organization](index.md) > SetAccessBindings
...
```
POST https://organization-manager.api.cloud.yandex.net/organization-manager/v1/organizations/{resourceId}:setAccessBindings
```
...
* `group`: A group of users. This type represents the [yandex.cloud.organizationmanager.v1.Group](../Group/get.md#yandex.cloud.organizationmanager.v1.Group) resource.
