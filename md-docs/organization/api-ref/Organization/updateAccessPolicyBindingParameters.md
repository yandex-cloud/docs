[Документация Yandex Cloud](../../../index.md) > [Yandex Identity Hub](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Organization](index.md) > UpdateAccessPolicyBindingParameters
...
```
PATCH https://organization-manager.api.cloud.yandex.net/organization-manager/v1/organizations/{resourceId}:updateAccessPolicyBindingParameters
```
