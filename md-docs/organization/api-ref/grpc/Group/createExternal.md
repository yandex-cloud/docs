[Документация Yandex Cloud](../../../../index.md) > [Yandex Identity Hub](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Group](index.md) > CreateExternal
...
To get the organization ID, use a [yandex.cloud.organizationmanager.v1.OrganizationService.List](../Organization/list.md#List) request.
