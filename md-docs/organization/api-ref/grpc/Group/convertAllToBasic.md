# Identity Hub API, gRPC: GroupService.ConvertAllToBasic

Converts all groups that belongs to subject container from external to basic (not external).

## gRPC request

**rpc ConvertAllToBasic ([ConvertAllToBasicGroupsRequest](#yandex.cloud.organizationmanager.v1.ConvertAllToBasicGroupsRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## ConvertAllToBasicGroupsRequest {#yandex.cloud.organizationmanager.v1.ConvertAllToBasicGroupsRequest}
...
|| metadata | **[ConvertAllToBasicGroupsMetadata](#yandex.cloud.organizationmanager.v1.ConvertAllToBasicGroupsMetadata)**
...
## ConvertAllToBasicGroupsMetadata {#yandex.cloud.organizationmanager.v1.ConvertAllToBasicGroupsMetadata}
