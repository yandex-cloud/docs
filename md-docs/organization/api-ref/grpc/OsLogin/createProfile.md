[Документация Yandex Cloud](../../../../index.md) > [Yandex Identity Hub](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [OsLogin](index.md) > CreateProfile

# Identity Hub API, gRPC: OsLoginService.CreateProfile
