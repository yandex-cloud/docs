[Документация Yandex Cloud](../../../../index.md) > [Yandex Identity Hub](../../../index.md) > Справочник API > REST (англ.) > [Organization Policy API](../index.md) > [AuthenticationPolicyRule](index.md) > Create
...
```
POST https://organization-manager.api.cloud.yandex.net/organization-manager/v1/policy/authenticationPolicyRules
```
