[Документация Yandex Cloud](../../../../../index.md) > [Yandex Identity Hub](../../../../index.md) > Справочник API > gRPC (англ.) > [Organization Policy API](../index.md) > [Operation](index.md) > Cancel

# Organization Policy API, gRPC: OperationService.Cancel
