[Документация Yandex Cloud](../../../../../index.md) > [Yandex Identity Hub](../../../../index.md) > Справочник API > gRPC (англ.) > [Organization Policy API](../index.md) > [AuthenticationPolicyRule](index.md) > Update

# Organization Policy API, gRPC: AuthenticationPolicyRuleService.Update

Updates the specified authentication policy rule.

## gRPC request

**rpc Update ([UpdateRuleRequest](#yandex.cloud.organizationmanager.v1.policy.UpdateRuleRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## UpdateRuleRequest {#yandex.cloud.organizationmanager.v1.policy.UpdateRuleRequest}
...
Required field. ID of authentication policy rule to update.
