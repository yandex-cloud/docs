...
#### SAML-приложения
 ...
 - [Настроить доступ пользователям приложения](operations/applications/saml-set-access-bindings.md)
...
#### OIDC-приложения
 ...
 - [Настроить доступ пользователям приложения](operations/applications/oidc-set-access-bindings.md)
...
### Управление федерациями удостоверений
 ...
 - [Аутентификация с помощью Microsoft Entra ID](tutorials/federations/integration-azure.md)

 - [Аутентификация с помощью Keycloak](tutorials/federations/integration-keycloak.md)

#### Сопоставление групп пользователей

 - [Сопоставление групп пользователей в Active Directory Federation Services](tutorials/federations/group-mapping/adfs.md)
...
#### Grafana Cloud
 ...
 - [Яндекс 360](tutorials/single-sign-on/saml-yandex-360.md)
...
#### Cloud.ru
 ...
 - [VK Cloud](tutorials/single-sign-on/vk-cloud/saml-vk-cloud.md)
...
##### Operation
 ...
 - [История изменений Yandex Identity Hub Sync Agent](sync-agent-release-notes.md)
