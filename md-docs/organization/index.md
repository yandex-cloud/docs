[Документация Yandex Cloud](../index.md) > Yandex Identity Hub > Identity Hub
...
#### Loop
 ...
 - [NetBird](tutorials/single-sign-on/oidc-netbird.md)
...
## Концепции
 ...
 - [Политики аутентификации](concepts/authentication-policy.md)
...
### Приложения (SSO)
 ...
 - [Обзор](concepts/applications/index.md)
