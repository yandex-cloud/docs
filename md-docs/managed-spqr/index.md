...
Сервис {{ mspqr-name }} помогает разворачивать кластеры шардированного {{ PG }} (<a href="https://pg-sharding.tech/">SPQR</a>) в инфраструктуре {{ yandex-cloud }}.

SPQR (Stateless Postgres Query Router) — это система горизонтального масштабирования {{ PG }} через шардирование, основанная на технологиях <a href="https://opensource.yandex/projects/">Yandex Open Source</a>.
...
## Концепции
 ...
 - [Хранилище в {{ SPQR }}](concepts/storage.md)

 - [Резервные копии](concepts/backup.md)

 - [Квоты и лимиты](concepts/limits.md)

 - [Настройки {{ SPQR }}](concepts/settings-list.md)

 - [Политика поддержки версий {{ SPQR }}](concepts/update-policy.md)
