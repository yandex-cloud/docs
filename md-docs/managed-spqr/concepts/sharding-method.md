...
* Выносите аналитику в специализированные хранилища (ClickHouse® или Greenplum®) с помощью [Yandex Data Transfer](../../data-transfer/index.md).
...
1. [Добавление нового шарда](../operations/shards.md#create-shard) в кластер Managed Service for Sharded PostgreSQL.
