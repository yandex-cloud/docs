...
[Кластер](../../glossary/cluster.md) Managed Service for Sharded PostgreSQL состоит из _шардов_, _роутера_ и _координатора_ (опционально). Роутеры и координаторы запускаются на _хостах_ — виртуальных машинах с выделенными вычислительными ресурсами и зарезервированным объемом хранилища данных.
