...
Платформа AMD Zen 4 доступна в ограниченном количестве для закрытого тестирования. Чтобы запросить доступ к платформе, обратитесь к вашему аккаунт-менеджеру.

Платформа Intel Broadwell недоступна для кластеров, хосты которых располагаются в [зоне доступности](../../overview/concepts/geo-scope.md) `ru-central1-d`.
