...
- Консоль управления {#console}
  ...
  [Перейдите](https://console.yandex.cloud/link/managed-spqr) в сервис **Yandex Managed Service for Sharded&nbsp;PostgreSQL**.
...
- CLI {#cli}
    ...
    Идентификатор операции можно получить со [списком операций](cluster-list.md#get-operations) для кластера.
