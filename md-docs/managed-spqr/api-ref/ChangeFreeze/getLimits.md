[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for Sharded PostgreSQL](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [ChangeFreeze](index.md) > GetLimits

# Managed Service for SPQR API, REST: ChangeFreeze.GetLimits
...
```
GET https://mdb.api.cloud.yandex.net/managed-spqr/v1/changeFreezeLimits
```
