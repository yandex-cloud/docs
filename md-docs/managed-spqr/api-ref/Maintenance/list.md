[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for Sharded PostgreSQL](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Maintenance](index.md) > List

# Managed Service for SPQR API, REST: Maintenance.List
...
```
GET https://mdb.api.cloud.yandex.net/managed-spqr/v1/maintenances
```
