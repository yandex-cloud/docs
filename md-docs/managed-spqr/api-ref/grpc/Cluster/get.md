[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for Sharded PostgreSQL](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Cluster](index.md) > Get

# Managed Service for SPQR API, gRPC: ClusterService.Get

Returns the specified SPQR Cluster resource.
To get the list of available SPQR Cluster resources, make a [List](list.md#List) request.

## gRPC request

**rpc Get ([GetClusterRequest](#yandex.cloud.mdb.spqr.v1.GetClusterRequest)) returns ([Cluster](#yandex.cloud.mdb.spqr.v1.Cluster))**

## GetClusterRequest {#yandex.cloud.mdb.spqr.v1.GetClusterRequest}
