[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for Sharded PostgreSQL](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Cluster](index.md) > AddSubcluster
...
The network ID is set in the [Cluster.network_id](get.md#yandex.cloud.mdb.spqr.v1.Cluster) field.
