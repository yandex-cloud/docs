[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for Sharded PostgreSQL](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Operation](index.md) > Get

# Managed Service for SPQR API, gRPC: OperationService.Get
