[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for Sharded PostgreSQL](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Cluster](index.md) > UpdateHosts
...
```
POST https://mdb.api.cloud.yandex.net/managed-spqr/v1/clusters/{clusterId}/hosts:batchUpdate
```
...
To get the SPQR host name, use a [ClusterService.ListHosts](listHosts.md#ListHosts) request. ||
