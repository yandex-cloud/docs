[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for Sharded PostgreSQL](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Cluster](index.md) > DeleteHosts
...
```
POST https://mdb.api.cloud.yandex.net/managed-spqr/v1/clusters/{clusterId}/hosts:batchDelete
```
