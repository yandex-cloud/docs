[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for Sharded PostgreSQL](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Database](index.md) > List
...
```
GET https://mdb.api.cloud.yandex.net/managed-spqr/v1/clusters/{clusterId}/databases
```
