[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for Sharded PostgreSQL](../index.md) > Справочник API > Аутентификация в API

# Аутентификация в API Managed Service for Sharded PostgreSQL
