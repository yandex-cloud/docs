...
Роль `managed-spqr.auditor` позволяет просматривать информацию о [хостах](concepts/instance-types.md) и [кластерах](concepts/index.md) {{ SPQR }}, назначенных [правах доступа](../iam/concepts/access-control/index.md) к кластерам, а также о [квотах](concepts/limits.md#mspqr-quotas) и операциях с ресурсами сервиса {{ mspqr-name }}.
...
* просматривать информацию о [кластерах](concepts/index.md) {{ SPQR }} и назначенных [правах доступа](../iam/concepts/access-control/index.md) к ним;
* просматривать информацию о заданиях на техническое обслуживание кластеров {{ SPQR }};
* просматривать информацию о [хостах](concepts/instance-types.md) кластеров {{ SPQR }};
...
* просматривать информацию о [квотах](concepts/limits.md#mspqr-quotas) сервиса {{ mspqr-name }};
...
Пользователи с этой ролью могут:
* просматривать информацию о резервных копиях [кластеров](concepts/index.md) {{ SPQR }}, а также восстанавливать кластеры из резервных копий;
...
* просматривать информацию о [хостах](concepts/instance-types.md) кластеров {{ SPQR }}, а также создавать, изменять и удалять такие хосты;
...
Пользователи с этой ролью могут:
* просматривать информацию о назначенных [правах доступа](../iam/concepts/access-control/index.md) к [кластерам {{ SPQR }}](concepts/index.md) и изменять такие права доступа;
...
Роль `managed-spqr.maintenanceTask.viewer` позволяет просматривать информацию о заданиях на техническое обслуживание кластеров {{ SPQR }}, а также о таких [кластерах](concepts/index.md) и назначенных [правах доступа](../iam/concepts/access-control/index.md) к ним, о [хостах](concepts/instance-types.md) кластеров, [квотах](concepts/limits.md#mspqr-quotas) и операциях с ресурсами сервиса {{ mspqr-name }}.
...
Роль `managed-spqr.maintenanceTask.editor` позволяет просматривать информацию о заданиях на техническое обслуживание [кластеров {{ SPQR }}](concepts/index.md) и изменять такие задания, просматривать информацию о кластерах {{ SPQR }} и назначенных [правах доступа](../iam/concepts/access-control/index.md) к ним, а также о [хостах](concepts/instance-types.md) кластеров, [квотах](concepts/limits.md#mspqr-quotas) и операциях с ресурсами сервиса {{ mspqr-name }}.
