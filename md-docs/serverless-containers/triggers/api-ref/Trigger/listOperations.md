[Документация Yandex Cloud](../../../../index.md) > [Yandex Serverless Containers](../../../index.md) > Справочник API Triggers > [REST (англ.)](../index.md) > [Trigger](index.md) > ListOperations
...
## Query parameters {#yandex.cloud.serverless.triggers.v1.ListTriggerOperationsRequest}
...
1. The field name. Currently filtering can only be applied to the [Trigger.name](../../../../functions/triggers/api-ref/Trigger/get.md#yandex.cloud.serverless.triggers.v1.Trigger) field.
2. An `=` operator.
