[Документация Yandex Cloud](../../index.md) > [Yandex Serverless Containers](../index.md) > [Пошаговые инструкции](index.md) > Управление контейнером > Задать количество одновременных вызовов экземпляра контейнера

# Задать количество одновременных вызовов экземпляра контейнера

Количество одновременных вызовов экземпляра контейнера (`concurrency`) не может превышать [квоты](../concepts/limits.md#serverless-containers-quotas).
...
- Консоль управления {#console}
    ...
    1. В блоке **Настройки** задайте количество одновременных вызовов экземпляра контейнера.
...
- Terraform {#tf}
    ...
    1. Чтобы задать количество одновременных вызовов одного экземпляра контейнера, опишите в конфигурационном файле параметр `concurrency`.
