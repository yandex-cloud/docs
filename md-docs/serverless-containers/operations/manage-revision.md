[Документация Yandex Cloud](../../index.md) > [Yandex Serverless Containers](../index.md) > [Пошаговые инструкции](index.md) > Создание контейнера > Создать ревизию контейнера
...
- Консоль управления {#console}
  ...
  1. В разделе **Настройки** выберите сервисный аккаунт, у которого есть права на скачивание Docker-образа.
