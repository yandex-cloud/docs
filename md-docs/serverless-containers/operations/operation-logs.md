[Документация Yandex Cloud](../../index.md) > [Yandex Serverless Containers](../index.md) > [Пошаговые инструкции](index.md) > Просмотр операций с ресурсами сервиса

# Просмотр операций с ресурсами сервиса Serverless Containers
...
- Консоль управления {#console}
  ...
  1. Перейдите на вкладку **Операции** для выбранного контейнера.
