...
Чтобы перенести [подсети](../../vpc/concepts/network.md#subnet) для [функций](../../functions/concepts/function.md) {{ sf-name }}, [контейнеров](../concepts/container.md) {{ serverless-containers-name }} или [API-шлюзов](../../api-gateway/concepts/index.md) {{ api-gw-name }} в другую зону, выполните следующие действия:
