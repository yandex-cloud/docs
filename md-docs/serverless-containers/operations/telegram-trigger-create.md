[Документация Yandex Cloud](../../index.md) > [Yandex Serverless Containers](../index.md) > [Пошаговые инструкции](index.md) > Создание триггера > Создать триггер для Telegram

# Создать триггер для Telegram, который вызывает контейнер Serverless Containers

Создайте [триггер для Telegram](../concepts/trigger/telegram-trigger.md), который будет вызывать [контейнер](../concepts/container.md) Serverless Containers, когда Telegram-бот получает новое обновление.
...
* [Создать триггер для Telegram, который вызывает функцию Cloud Functions](../../functions/operations/trigger/telegram-trigger-create.md)
