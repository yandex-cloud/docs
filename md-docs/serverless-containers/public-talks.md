[Документация Yandex Cloud](../index.md) > [Yandex Serverless Containers](index.md) > Публичные материалы
...
# Публичные материалы о Serverless в Yandex Cloud
  ...
  * Безопасное использование секретов Yandex Lockbox в бессерверных средах, 2023 — [Статья](https://yandex.cloud/ru/blog/posts/2023/06/serverless-and-secrets).
  ...
  * Различия систем обмена сообщениями и обмена потоковыми данными, или Чем отличаются Yandex Message Queue и Yandex Data Streams, 2021 — [Статья](https://yandex.cloud/ru/blog/posts/2021/12/ymq-yds).
...
## Yandex API Gateway {#api-gateway}
  ...
  * Распределяем нагрузку: Yandex API Gateway и другие инструменты балансировки, 2024 — [Статья](https://yandex.cloud/ru/blog/posts/2024/04/api-gateway-or-yandex-alb).
  * Разграничение доступа к API с помощью Yandex API Gateway, 2023 — [Статья](https://yandex.cloud/ru/blog/posts/2023/07/yandex-api-gateway-and-jwt-authorizer).
  * Создание интерактивного приложения с использованием Yandex API Gateway и протокола WebSocket, 2023 — [Статья](https://yandex.cloud/ru/blog/posts/2023/04/yandex-api-gateway-and-websocket).
  ...
  * <code><b><small>Внешний ресурс</small></b></code> Spectral Ruleset для Yandex API Gateway, 2022 — [Статья](https://nikolaymatrosov.ru/2022-04-27-Spectral-Ruleset-for-Yandex-Cloud-API-Gateway).

## Yandex Cloud Functions {#cloud-functions}

  * Как настроить CI/CD для Cloud Functions из SourceCraft, 2025 — [Статья](https://yandex.cloud/ru/blog/ci-cd-for-cloud-functions-sourcecraft).
  * Как настроить CI/CD для Cloud Functions из GitHub, 2025 — [Статья](https://yandex.cloud/ru/blog/posts/2023/04/telegram-chat-analytics).
  ...
  * <code><b><small>Внешний ресурс</small></b></code> Работа с Redis из функций Cloud Functions, 2024 — [Статья](https://nikolaymatrosov.ru/2024-11-17-Call-Redis-from-Serverless-functions).
  * <code><b><small>Внешний ресурс</small></b></code> Логирование в функциях Cloud Functions, 2024 — [Статья](https://nikolaymatrosov.ru/2024-01-09-Logs-in-Functions).
  * <code><b><small>Внешний ресурс</small></b></code> Ресурсы функции Cloud Functions, 2024 — [Статья](https://nikolaymatrosov.ru/2024-04-11-Too-many-open-files).
  * <code><b><small>Внешний ресурс</small></b></code> FastAPI в функциях Cloud Functions, 2024 — [Статья](https://nikolaymatrosov.ru/2024-09-21-FastAPI-in-Serverless-Function).
  * Как собрать статистику Telegram‑чатов с помощью Yandex Cloud Functions, 2023 — [Статья](https://yandex.cloud/ru/blog/posts/2023/04/telegram-chat-analytics).

## Yandex Cloud Postbox {#postbox}

  * <code><b><small>Внешний ресурс</small></b></code> Отправка писем с помощью Yandex Cloud Postbox из Yandex Managed Service for Apache Airflow™, 2025 — [Статья](https://nikolaymatrosov.ru/2025-04-22-Send-emails-from-Managed-Apache-Airflow-with-Postbox).
  * <code><b><small>Внешний ресурс</small></b></code> Как сделать форму подписки с помощью Yandex Cloud Postbox и SmartCaptcha, 2025 — [Статья](https://nikolaymatrosov.ru/2025-02-23-Building-email-signup-form-with-Yandex-Cloud-Postbox-and-SmartCaptcha).
  * <code><b><small>Внешний ресурс</small></b></code> Как настроить Sendmail или Postfix для работы с Yandex Cloud Postbox, 2025 — [Статья](https://nikolaymatrosov.ru/2025-01-29-Configure-Sendmail-to-work-with-Postbox).
  * <code><b><small>Внешний ресурс</small></b></code> Как настроить отправку почты через Yandex Cloud Postbox для пользовательского (self-hosted) GitLab, 2025 — [Статья](https://nikolaymatrosov.ru/2025-01-25-Postbox-as-mail-relay-for-Self-hosted-GitLab).
...
## Yandex Data Streams {#yds} 
  ...
  * Стриминг данных с Yandex Data Streams: больше, чем Kafka, 2024 — Видео на [Rutube](https://rutube.ru/video/5a4065b77ee694f6c0c6092329d64f32/).
  * Data Transfer и Data Streams: все про потоки данных в Yandex Cloud, 2022 — Видео на [YouTube](https://www.youtube.com/watch?v=1tjrAPSLb_s) и [Rutube](https://rutube.ru/video/c6be33ad5753c41e5e1d37844cc54150/).
  * Kafka API для работы с потоками данных Yandex Data Streams — топиками YDB, 2021 — [Статья](https://habr.com/ru/companies/yandex_cloud_and_infra/articles/873478/).
...
{% endnote %}
  ...
  * Обработка и анализ данных в Yandex IoT Core, 2024 — Видео на [YouTube](https://youtu.be/bw5Sp4FQlFw) и [Яндекс](https://runtime.strm.yandex.ru/player/video/vplvsgxrh6zclsub733q), [Статья](https://yandex.cloud/ru/blog/posts/2024/07/data-processing-in-yandex-iot-core).
...
## Yandex Message Queue {#ymq}
  ...
  * <code><b><small>Внешний ресурс</small></b></code> Конвертируй это — с Yandex Message Queue, 2021 — [Статья](https://habr.com/ru/articles/595069/).
  ...
  * Yandex Message Queue, 2019 — Видео на [YouTube](https://www.youtube.com/watch?v=hWHjOwuj-9A) и [Rutube](https://rutube.ru/video/eb0f7d8f0e17b8b46ba907e8476d1c7d/).

## Yandex Managed Service for YDB {#ydb}

  * <code><b><small>Внешний ресурс</small></b></code> Terraform: Основы. Бэкенды для хранения состояния, 2025 — [Статья](https://ru.hexlet.io/courses/terraform-basics/lessons/remote-state/theory_unit).
  * Serverless YDB Internals, 2023 — Видео на [YouTube](https://www.youtube.com/watch?v=aL9NHR0i0Xs) и [Rutube](https://rutube.ru/video/cd00829cf8c814c94d4c422b030df1ec/).
...
## Yandex Serverless Containers {#serverless-containers}
  ...
  * Запускаем контейнерные приложения в Yandex Serverless Containers, 2023 — Видео на [YouTube](https://youtu.be/OVFAjzGDU5w) и [Яндекс](https://runtime.strm.yandex.ru/player/video/vplvb2sbdl54xhhbrmkw), [Статья](https://yandex.cloud/ru/blog/posts/2023/09/applications-in-serverless-containers).
  * <code><b><small>Внешний ресурс</small></b></code> Запуск контейнера Serverless Containers по триггеру, 2022 — [Статья](https://nikolaymatrosov.ru/2022-07-24-Use-Trigger-with-Serverless-Container).
...
## Практикум {#practicum}
  ...
  * Собираем и анализируем статистику Telegram-чатов с Serverless и DataLens, 2024 — Видео на [YouTube](https://youtu.be/IhfHNGVqTxI) и [Яндекс](https://runtime.strm.yandex.ru/player/video/vplvab7hi47pjptkze2v).
