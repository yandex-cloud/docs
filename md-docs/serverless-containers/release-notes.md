[Документация Yandex Cloud](../index.md) > [Yandex Serverless Containers](index.md) > История изменений
...
* Добавлена передача параметров сервиса метаданных контейнера в аудитные логи Audit Trails.
