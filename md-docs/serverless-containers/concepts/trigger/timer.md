...
О том, как создать таймер, читайте в инструкции [Создать таймер, который вызывает контейнер Serverless Containers](../../operations/timer-create.md).
...
* [Таймер, который вызывает функцию Cloud Functions](../../../functions/concepts/trigger/timer.md)
* [Таймер, который отправляет сообщения в WebSocket-соединения](../../../api-gateway/concepts/trigger/timer.md)