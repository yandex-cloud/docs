...
[Terraform](https://www.terraform.io/) позволяет создавать ресурсы Serverless Containers и управлять ими с помощью файлов конфигураций.

* [Справочник Terraform](tf-ref.md)
* [Документация провайдера](../terraform/resources/serverless_container.md)
