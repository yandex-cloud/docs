...
- API {#api}
  ...
  Воспользуйтесь методом REST API [listRevisions](../containers/api-ref/Container/listRevisions.md) для ресурса [Container](../containers/api-ref/Container/index.md) или вызовом gRPC API [RegistryService/CreateRegistryRequest](../containers/api-ref/grpc/Container/listRevisions.md).
