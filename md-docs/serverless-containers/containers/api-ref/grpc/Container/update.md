[Документация Yandex Cloud](../../../../../index.md) > [Yandex Serverless Containers](../../../../index.md) > Справочник API Containers > [gRPC (англ.)](../index.md) > [Container](index.md) > Update
...
to add or remove a label, request the current set of labels with a [ContainerService.Get](get.md#Get) request.
