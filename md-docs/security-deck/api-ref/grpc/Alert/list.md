[Документация Yandex Cloud](../../../../index.md) > [Yandex Security Deck](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Alert](index.md) > List
...
**rpc List ([ListAlertsRequest](#yandex.cloud.securitydeck.alerts.v1.ListAlertsRequest)) returns ([ListAlertsResponse](#yandex.cloud.securitydeck.alerts.v1.ListAlertsResponse))**

## ListAlertsRequest {#yandex.cloud.securitydeck.alerts.v1.ListAlertsRequest}
...
## ListAlertsResponse {#yandex.cloud.securitydeck.alerts.v1.ListAlertsResponse}
