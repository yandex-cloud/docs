...
- Интерфейс Security Deck {#cloud-sd}
  ...
  1. На открывшейся странице **Правила контроля безопасности** перейдите на вкладку **Исключения**.
      ...
      * **Тип исключения** — вариант действия для создаваемого исключения:
          ...
          * `Ресурс проверен` — при соответствии заданным в исключении условиям ресурс будет генерировать сигналы о соответствии правилу.
          * `Не проверять ресурс` — при соответствии заданным в исключении условиям ресурс не будет генерировать сигналы о соответствии проверяемых ресурсов правилу.
...
- Интерфейс Security Deck {#cloud-sd}
  ...
  1. В правом верхнем углу экрана нажмите кнопку **Создать исключение** ![chevron-down](../../../_assets/console-icons/chevron-down.svg) и выберите `Обнаружение угроз`. В открывшемся окне:
      ...
      1. В блоке **Исключённые правила** выберите правила модуля Обнаружение угроз, для которых не должны проводиться проверки выбранных ресурсов:
      ...
      1. В блоке **Область действия контроля** укажите ресурсы, которые требуется исключить при проверке правил модуля Обнаружение угроз:
