[Документация Yandex Cloud](../../../index.md) > [Yandex Security Deck](../../index.md) > [Пошаговые инструкции](../index.md) > [Контроль конфигурации (CSPM)](index.md) > Управлять исключениями из правил контроля
...
- Интерфейс Security Deck {#cloud-sd}
  ...
  1. На открывшейся странице **Правила контроля безопасности** перейдите на вкладку **Исключения**.
      ...
      * **Ресурс** — ресурс, для которого проверка исключена.
      * **Причина исключения** — вариант действия для создаваемого исключения:
