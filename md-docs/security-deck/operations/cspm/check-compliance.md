[Документация Yandex Cloud](../../../index.md) > [Yandex Security Deck](../../index.md) > [Пошаговые инструкции](../index.md) > [Контроль конфигурации (CSPM)](index.md) > Проверить соответствие стандартам безопасности
...
Воспользуйтесь [пользовательскими правилами](../../concepts/custom-rules.md), чтобы адаптировать стандартные правила безопасности модулей под внутренние требования вашей компании.
