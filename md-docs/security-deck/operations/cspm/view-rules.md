[Документация Yandex Cloud](../../../index.md) > [Yandex Security Deck](../../index.md) > [Пошаговые инструкции](../index.md) > [Контроль конфигурации (CSPM)](index.md) > Посмотреть правила контроля и нарушения
...
- Интерфейс Security Deck {#cloud-sd}
  ...
  1. На открывшейся странице **Правила контроля безопасности** перейдите на вкладку **Конфигурация**. Открывшийся раздел содержит список правил контроля, которые входят в состав заданных для текущего окружения [стандартов безопасности](../../concepts/workspace.md#standards).
      ...
      1. Для настройки видимости столбцов, в правой части шапки таблицы нажмите значок ![gear](../../../_assets/console-icons/gear.svg). Выберите необходимые значения и нажмите **Применить**.
