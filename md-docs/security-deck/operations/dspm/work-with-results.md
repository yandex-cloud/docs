[Документация Yandex Cloud](../../../index.md) > [Yandex Security Deck](../../index.md) > [Пошаговые инструкции](../index.md) > [Контроль данных (DSPM)](index.md) > Управлять результатами сканирования

# Управлять результатами регулярного сканирования в DSPM
...
- Интерфейс v1.0 {#cloud-sd-v1}
  ...
  1. На странице модуля **Контроль данных** выберите `Интерфейс: v1.0` и перейдите на вкладку **История сканирований**.
