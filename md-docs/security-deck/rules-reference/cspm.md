...
Подробнее см. в разделе [Модуль диагностики доступов (CIEM)](../concepts/ciem.md).
...
* Подробнее о режимах работы см. в разделе Режимы работы Serverless и Dedicated документации [Managed Service for YDB](../../ydb/concepts/serverless-and-dedicated.md)
* При настройке доступа к БД следует использовать принцип минимальных привилегий.
