...
Окружение Security Deck может находиться в одном из двух статусов:
...
Чтобы посмотреть статус всех окружений, перейдите на страницу ![sliders](../../_assets/console-icons/sliders.svg) **Параметры Security Deck** и откройте вкладку **Окружения**.
