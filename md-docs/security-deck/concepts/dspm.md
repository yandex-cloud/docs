...
Источник данных Яндекс 360 поддерживает ограничение сканирования файлов по уровню доступа. Доступно сканирование всех файлов или файлов только с [общим доступом](https://yandex.ru/support/yandex-360/business/disk/web/ru/share/personal-and-public-access#vidy-dostupa).
