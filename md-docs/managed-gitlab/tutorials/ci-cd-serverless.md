[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for GitLab](../index.md) > [Практические руководства](index.md) > Построение пайплайна CI/CD с использованием serverless-продуктов
...
1. [Настройте группу безопасности](../operations/configure-security-group.md) для работы [инстанса Yandex Managed Service for GitLab](../concepts/index.md#instance).
