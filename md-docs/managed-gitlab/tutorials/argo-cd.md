...
* Плата за инстанс {{ GL }}. Она зависит от способа создания инстанса:
   ...
   * {{ mgl-name }}: оплачиваются ресурсы ВМ, хранение данных и резервных копий, объем исходящего трафика (см. [тарифы {{ mgl-name }}](../pricing.md)).
