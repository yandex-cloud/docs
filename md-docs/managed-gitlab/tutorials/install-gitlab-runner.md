[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for GitLab](../index.md) > [Практические руководства](index.md) > Развертывание GitLab Runner на виртуальной машине Yandex Compute Cloud
...
Для Yandex Managed Service for GitLab вы также можете воспользоваться ручной установкой GitLab Runner или автоматически развернуть [раннер](../concepts/index.md#runners) в [консоли управления](https://console.yandex.cloud), который будет обеспечивать нужное количество воркеров, запущенных в Compute Cloud.
...
1. [Создайте и активируйте инстанс](../operations/instance/instance-create.md) Managed Service for GitLab.
...
* [инстанс GitLab](../operations/instance/instance-delete.md);
