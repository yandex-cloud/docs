...
Для {{ mgl-full-name }} вы также можете воспользоваться ручной установкой {{ GLR }} или автоматически развернуть [раннер](../concepts/index.md#runners) в [консоли управления]({{ link-console-main }}), который будет обеспечивать нужное количество воркеров, запущенных в {{ compute-name }}.
...
1. [Создайте и активируйте инстанс](../operations/instance/instance-create.md) {{ mgl-name }}.
...
* [инстанс {{ GL }}](../operations/instance/instance-delete.md);
