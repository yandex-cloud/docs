...
* В консоли управления добавлено уведомление о приближении общего объема диска инстанса к [допустимому лимиту](concepts/limits.md#limits).
  ...
  Чтобы снизить риск переполнения диска, подключите [хранение данных GitLab в Object Storage](operations/objstorage-integration.md).

  {% endnote %}

* GitLab обновлен до версии [18.11.11](https://docs.gitlab.com/releases/patches/patch-release-gitlab-19-2-4-released/).
