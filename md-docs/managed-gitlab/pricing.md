[Документация Yandex Cloud](../index.md) > [Yandex Managed Service for GitLab](index.md) > Правила тарификации
...
- Расчет в рублях {#prices-rub}
  ...
  > 5 939,136 ₽ + 780,768 ₽ = 6 719,904 ₽
  
    Где 6 719,904 ₽ — стоимость использования инстанса в течение 30 дней.

- Расчет в тенге {#prices-kzt}

  > 29 695,68 ₸ + 3 903,84 ₸ = 33 599,52 ₸
  
    Где 33 599,52 ₸ — стоимость использования инстанса в течение 30 дней.
...
| ---------------------------------------------------------------------------------------- | ----------------- | --------------- | -------------- | ---------------- |
| Managed Gitlab. Хранение данных в Object Storage                                         | Не тарифицируется | ГБ × час        | —              | 10 сентября 2026 |
