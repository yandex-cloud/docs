[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for GitLab](../index.md) > [Пошаговые инструкции](index.md) > Создание и добавление пользователей в проект

# Создание и добавление пользователей в проект

Вы можете создать пользователей в инстансе GitLab и пригласить их в проект. Так вы предоставите команде доступ к репозиторию.

Используйте разную электронную почту для каждого аккаунта. Она не должна быть привязана к основному аккаунту, созданному вместе с инстансом GitLab.
...
1. В открывшемся окне укажите логин или электронную почту пользователя и выберите для него [роль в проекте](https://docs.gitlab.com/ee/user/permissions.html).
