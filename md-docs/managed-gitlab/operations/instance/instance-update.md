[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for GitLab](../../index.md) > [Пошаговые инструкции](../index.md) > Изменение настроек инстанса
...
- Консоль управления {#console}
  ...
  1. Выберите инстанс и нажмите кнопку ![image](../../../_assets/console-icons/pencil.svg) **Редактировать**. В открывшемся окне:
      ...
      1. (Опционально) В блоке **Интеграция с SourceCraft** включите или отключите опцию **Включить интеграцию с SourceCraft**. Подробнее об [интеграции с SourceCraft Security](../../concepts/sourcecraft-security.md) и ее [настройке](../sourcecraft-security.md).

          {% note warning %}
          
          Перед включением интеграции [подключите платное дополнение SourceCraft Security](../sourcecraft-security.md#enable-security) к организации Yandex Cloud, в которой находится или будет создан инстанс. Все репозитории инстанса, независимо от настроек видимости, будут зеркалироваться в приватные репозитории SourceCraft в этой организации. Включая интеграцию, вы подтверждаете передачу исходного кода в SourceCraft.
