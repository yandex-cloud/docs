...
При создании инстанса в консоли управления вы можете включить [интеграцию с SourceCraft Security](../sourcecraft-security.md), чтобы автоматически проверять безопасность кода в репозиториях.
