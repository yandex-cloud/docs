[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for GitLab](../index.md) > [Пошаговые инструкции](index.md) > Работа с управляемым раннером
...
- Консоль управления {#console}
  ...
  1. Измените [тип](../../compute/concepts/disk.md#disks-types) и размер загрузочного диска.
