...
Узнайте стоимость использования сервиса в разделе [{#T}](../../compute/pricing.md). Вы также можете воспользоваться [нашим калькулятором](https://yandex.cloud/ru/prices#calculator).
