...
- Оцените, сколько потребуется вычислительных ресурсов для вашего сервиса, и посмотрите примеры расчетов и [правила тарификации](../pricing.md) для {{ compute-full-name }}.
...
Можно. Для этого в секции метаданных шаблона создаваемой виртуальной машины задайте пользовательский скрипт с командами для установки необходимого программного обеспечения. Подробнее читайте в разделе [{#T}](../operations/vm-create/create-with-cloud-init-scripts.md).