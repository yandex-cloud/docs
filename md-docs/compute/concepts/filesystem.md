[Документация Yandex Cloud](../../index.md) > [Yandex Compute Cloud](../index.md) > [Концепции](index.md) > Диски и файловые хранилища > Файловые хранилища

# Файловые хранилища


_Файловое хранилище_ — это виртуальная файловая система, которую можно подключать к нескольким [виртуальным машинам](vm.md) Compute Cloud из одной зоны доступности. С файлами в хранилище можно работать совместно, с нескольких ВМ.
...
Для файловых хранилищ действуют [технические ограничения на операции чтения и записи](storage-read-write.md), а также [квоты](limits.md#compute-quotas) и [лимиты](limits.md#compute-limits-disks) Compute Cloud. По умолчанию для файловых хранилищ установлены нулевые квоты. Чтобы повысить [квоты](https://console.yandex.cloud/cloud?section=quotas), обратитесь в [техническую поддержку](../../support/overview.md).
...
Место, занимаемое хранилищем, оплачивается в зависимости от его размера. Подробнее в разделе [Правила тарификации для Compute Cloud](../pricing.md). Максимальный размер хранилища — 8192 ГБ.
...
Подключение файловых хранилищ к ВМ Compute Cloud под управлением ОС Windows сейчас не поддерживается.
...
* [Резервное копирование в Yandex Object Storage с помощью Bacula](../tutorials/backup-with-bacula.md)

**Смотрите также**

* [Создать файловое хранилище](../operations/filesystem/create.md)
* [Подключить файловое хранилище к виртуальной машине](../operations/filesystem/attach-to-vm.md)
* [Отключить файловое хранилище от виртуальной машины](../operations/filesystem/detach-from-vm.md)