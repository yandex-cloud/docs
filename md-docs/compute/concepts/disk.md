...
Примеры изменения настройки автоудаления для каждого из интерфейсов см. в инструкции [Создать виртуальную машину из публичного образа Linux](../operations/vm-create/create-linux-vm.md).
