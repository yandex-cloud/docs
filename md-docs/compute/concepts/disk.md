...
- Консоль управления {#console}
  ...
  * **Загрузочный диск**
    ...
    * При подключении существующего диска к ВМ автоудаление _выключено_.
    ...
    В [консоли управления](https://console.yandex.cloud) не поддерживается изменение настроек автоудаления загрузочного диска. Используйте инструменты Yandex Cloud CLI, Terraform или API. См. примеры на странице [Создать виртуальную машину из публичного образа Linux](../operations/vm-create/create-linux-vm.md).
