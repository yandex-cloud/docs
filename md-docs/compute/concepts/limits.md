...
- Сетевой SSD-диск {#net-ssd}
  ...
  Вид ограничения | Значение
  --- | ---
  Максимальный^4^ [IOPS](storage-read-write.md) для 1 vCPU | 3 500
  Максимальная^5^ [пропускная способность](storage-read-write.md) для 1 vCPU | 45 МБ/с
...
- Нереплицируемый SSD-диск {#non-replicated-ssd}
  ...
  Максимальный^4^ [IOPS](storage-read-write.md) для 1 vCPU | 10 000
  Максимальный^4^ IOPS для одной ВМ | 100 000
  Максимальная^5^ [пропускная способность](storage-read-write.md) для 1 vCPU | 100 МБ/с
