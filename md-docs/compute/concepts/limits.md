...
|| Суммарный объем виртуальной памяти для всех ВМ и свободных слотов в [пулах резервов ВМ](reserved-pools.md) в одном облаке 
`compute.instanceMemory.size` | 128 ГБ ||
|| Количество [групп ВМ](instance-groups/index.md) в одном облаке 
`compute.instanceGroups.count` | 10 ||
|| Максимальное количество [групп размещения ВМ](placement-groups.md) в одном облаке 
...
#|
|| Вид ограничения | Значение ||
|| Суммарное количество [vCPU](performance-levels.md) для всех ВМ и свободных слотов в пулах резервов ВМ в одном облаке 
...
#|
|| Вид ограничения | Значение ||
|| Суммарное количество [GPU](gpus.md) NVIDIA® Tesla® V100 для всех ВМ и свободных слотов в пулах резервов ВМ в одном облаке 
...
#|
|| Вид ограничения | Значение ||
|| Суммарное количество [дисков](disk.md) в одном облаке 
`compute.disks.count` | 32 ||
|| Суммарный объем [HDD-дисков](disk.md#disks-types) в одном облаке 
...
|| Количество [групп размещения нереплицируемых дисков](disk-placement-group.md) в одном облаке 
...
#|
|| Вид ограничения | Значение ||
|| Суммарное количество [файловых хранилищ](filesystem.md) в одном облаке 
`compute.filesystems.count` | 100 ||
|| Суммарный объем файловых хранилищ на [HDD-накопителях](filesystem.md#types) в одном облаке 
...
|| Количество [оптимизированных для развертывания образов](image.md#images-optimized-for-deployment) в одном облаке^1^ 
...
#|
|| Вид ограничения | Значение ||
|| Суммарное количество [снимков дисков](snapshot.md) в одном облаке 
...
#|
|| Вид ограничения | Значение ||
|| Количество [выделенных хостов](dedicated-host.md) в одной группе выделенных хостов^1^ 
...
|| Количество [пулов резервов ВМ](reserved-pools.md) в одном облаке^1^
...
- Intel Broadwell {#broadwell}
  ...
  || Максимальное количество дисков и файловых хранилищ, подключенных к одной ВМ^2^ | [Топология шины](hardware-generations.md#configurations) `PCI_TOPOLOGY_V1` | Кол-во vCPU <= 18 | 8 ||
  || ^ | ^ | Кол-во vCPU > 18 | 16^3^ ||
...
- Intel Cascade Lake {#cascade}
  ...
  || Максимальное количество дисков и файловых хранилищ, подключенных к одной ВМ^2^ | [Топология шины](hardware-generations.md#configurations) `PCI_TOPOLOGY_V1` | Кол-во vCPU <= 20 | 8 ||
  || ^ | ^ | Кол-во vCPU > 20 | 16^3^ ||
  || ^ | Топология шины `PCI_TOPOLOGY_V2` | Кол-во vCPU <= 4 | 62 ||
  || ^ | ^ | Кол-во vCPU >= 6 | 80 ||
  || Максимальное количество [сетевых интерфейсов](network.md), подключенных к одной ВМ | Топология шины
...
- Intel Ice Lake {#ice}
  ...
  || Максимальное количество дисков и файловых хранилищ, подключенных к одной ВМ^2^ | [Топология шины](hardware-generations.md#configurations) `PCI_TOPOLOGY_V1` | Кол-во vCPU <= 32 | 8 ||
  || ^ | ^ | Кол-во vCPU > 32 | 16^3^ ||
  || ^ | Топология шины `PCI_TOPOLOGY_V2` | Кол-во vCPU <= 4 | 62 ||
  || ^ | ^ | Кол-во vCPU >= 6 | 80 ||
  || Максимальное количество [сетевых интерфейсов](network.md), подключенных к одной ВМ | Топология шины
...
- Сетевой SSD-диск {#net-ssd}
  ...
  Вид ограничения | Значение
  --- | ---
  Максимальный^4^ [IOPS](storage-read-write.md) на каждый vCPU ВМ | 3 500
  Максимальная^5^ [пропускная способность](storage-read-write.md) на каждый vCPU ВМ | 45 МБ/с
...
- Нереплицируемый SSD-диск {#non-replicated-ssd}
  ...
  Максимальный^4^ [IOPS](storage-read-write.md) на каждый vCPU ВМ | 10 000
  Максимальный^4^ IOPS для одной ВМ | 100 000
  Максимальная^5^ [пропускная способность](storage-read-write.md) на каждый vCPU ВМ | 100 МБ/с
