...
#|
|| Вид ограничения | Значение ||
|| Суммарное количество [файловых хранилищ](filesystem.md) в одном облаке^1^ 
`compute.filesystems.count` | 100 ||
|| Суммарный объем файловых хранилищ на [HDD-накопителях](filesystem.md#types) в одном облаке^1^ 
