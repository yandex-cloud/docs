[Документация Yandex Cloud](../../index.md) > [Yandex Compute Cloud](../index.md) > [Концепции](index.md) > Виртуальные машины > Уровни производительности vCPU
...
## Особенности и ограничения {#features-and-restrictions}

* Реально наблюдаемая производительность может быть выше гарантированного уровня. 

* В зависимости от выбранной [платформы](vm-platforms.md) доступные конфигурации вычислительных ресурсов для разных уровней могут меняться.

* Доступный объем диска не зависит от уровня производительности ВМ.
...
Другие ограничения приведены в разделе [Квоты и лимиты в Compute Cloud](limits.md).
...
Вариант с одновременной максимальной конфигурацией всех вычислительных ресурсов доступен не для всех платформ. Подробнее в разделе [Доступные конфигурации](#available-configurations).
