[Документация Yandex Cloud](../../index.md) > [Yandex Compute Cloud](../index.md) > [Концепции](index.md) > Образы
...
Использование определенных образов для создания виртуальных машин может быть запрещено на уровне [каталога](*folders), [облака](*clouds) или [организации](*organizations) с помощью политики авторизации `compute.restrictImage`. Подробнее читайте в разделе [Политики авторизации](../security/index.md#access-policies).
