[Документация Yandex Cloud](../../index.md) > [Yandex Compute Cloud](../index.md) > [Концепции](index.md) > Виртуальные машины > Серийная консоль
...
Управление доступом к серийной консоли виртуальных машин может быть запрещено на уровне [каталога](*folders), [облака](*clouds) или [организации](*organizations) с помощью политики авторизации `compute.denySerialPortEnabling`. Подробнее читайте в разделе [Политики авторизации](../security/index.md#access-policies).
