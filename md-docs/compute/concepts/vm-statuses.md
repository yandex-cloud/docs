...
### Статусы подключения ВМ к Cloud Backup {#statuses}
...
- `ERROR` — произошла фатальная ошибка и виртуальная машина не может быть восстановлена.
    ...
    Чтобы исправить ошибку, попробуйте [остановить](../operations/vm-control/vm-stop-and-start.md#stop) и повторно [запустить](../operations/vm-control/vm-stop-and-start.md#start) виртуальную машину.

    Если статус `ERROR` сохраняется или виртуальная машина постоянно переходит в статус `CRASHED`, обратитесь в [техническую поддержку](../../support/overview.md) или создайте новую виртуальную машину.