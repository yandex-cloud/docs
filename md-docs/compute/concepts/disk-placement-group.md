[Документация Yandex Cloud](../../index.md) > [Yandex Compute Cloud](../index.md) > [Концепции](index.md) > Диски и файловые хранилища > Группы размещения нереплицируемых дисков
...
Об организационных и технических ограничениях групп размещения читайте в разделе [Квоты и лимиты в Compute Cloud](limits.md).
