...
Подробнее о том, как получить идентификационный документ, см. в инструкции [Получить идентификационный документ виртуальной машины](../../operations/vm-metadata/get-identity-document.md).
...
Подробнее о том, как проверить целостность и подлинность идентификационного документа, см. в инструкции [Проверить подпись идентификационного документа](../../operations/vm-metadata/get-identity-document.md#check-id-signature).
