...
Использование расписаний не тарифицируется. Вы платите только за хранение снимков. Подробнее см. в разделе [Правила тарификации для Compute Cloud](../pricing.md).
