[Документация Yandex Cloud](../../index.md) > [Yandex Compute Cloud](../index.md) > [Концепции](index.md) > Графические ускорители GPU
...
* [Запуск языковой модели DeepSeek-R1 в кластере GPU Yandex Compute Cloud](../tutorials/gpu-cluster-deepseek.md)
* [Запуск библиотеки vLLM с языковой моделью Gemma 3 на виртуальной машине с GPU в Yandex Compute Cloud](../tutorials/vllm-gemma-gpu.md)
* [Вопросы и ответы про графические ускорители GPU в Compute Cloud](../qa/gpu.md)