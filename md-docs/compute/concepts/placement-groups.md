...
Об ограничениях на количество ВМ в группе с распределенным размещением читайте в подразделе [{#T}](limits.md#compute-limits-vm).

Управление группами ВМ со стратегией распределенного размещения доступно с помощью [консоли управления](../../console/index.md), [CLI](../../cli/quickstart.md), [{{ TF }}](../../tutorials/infrastructure-management/terraform-quickstart.md) или [API](../api-ref/index.md).
