...
Зональный инцидент влияет на функциональность группы ВМ в проблемной зоне. Большинство функций в других зонах продолжает работать штатно. Подробнее см. на странице [Мультизональная группа ВМ Yandex Compute Cloud с ВМ в зоне инцидента](multi-zonal.md).
