[Документация Yandex Cloud](../../../../index.md) > [Yandex Compute Cloud](../../../index.md) > [Концепции](../../index.md) > [Группы виртуальных машин](../index.md) > [Группы ВМ при зональном инциденте](overview.md) > Мультизональная группа с ВМ в зоне инцидента
...
* ВМ, считающиеся неработоспособными по [статусу в Compute Cloud](../autohealing.md#auto-healthcheck), по-прежнему будут восстанавливаться вне какой-либо квоты.
...
* [Группы виртуальных машин Yandex Compute Cloud при зональном инциденте](overview.md)
