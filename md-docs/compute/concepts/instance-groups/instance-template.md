...
У [сервисного аккаунта](../../../iam/concepts/users/service-accounts.md), от имени которого выполняются операции в Instance Groups, должна быть [роль](../../../vpc/security/index.md) для доступа к сети и подсетям, в которых размещается группа ВМ. Подробнее см. на странице [Доступ](access.md).
...
`secondary_disk_specs.name` | (опционально) Имя дополнительного диска. В одной спецификации имена должны быть либо присвоены всем дополнительным дискам, либо не присвоены ни одному. Подробнее см. в разделе [Изменение дополнительных дисков в шаблоне виртуальной машины](deploy/secondary-disk.md).
...
`metadata` | (опционально) Метаданные для шаблонной ВМ. Подробнее см. раздел [Метаданные виртуальной машины](../vm-metadata.md).
