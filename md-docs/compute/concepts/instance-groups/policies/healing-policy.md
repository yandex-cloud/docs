[Документация Yandex Cloud](../../../../index.md) > [Yandex Compute Cloud](../../../index.md) > [Концепции](../../index.md) > [Группы виртуальных машин](../index.md) > [Политики](index.md) > Политика восстановления

# Политика восстановления

При создании группы виртуальных машин можно выбрать, каким образом будут восстанавливаться ВМ, не прошедшие проверку [работоспособности](../autohealing.md#auto-healthcheck) или [состояния приложений](../autohealing.md#functional-healthcheck).
...
Если вы не определили политику восстановления, ВМ будут [автоматически восстанавливаться](../autohealing.md#healthcheck-cases) в зависимости от настроек [политики развертывания](deploy-policy.md).
