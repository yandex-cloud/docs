...
> 
> Также полезно временно отключить зону для группы ВМ при зональном инциденте. Таким образом вы сможете контролируемо ввести ВМ из пораженной зоны в эксплуатацию при выходе из инцидента. Подробнее см. [Поведение группы ВМ при временном отключении зоны и инциденте в этой же зоне](disable-enable-zone.md#zonal-inc-shift).
