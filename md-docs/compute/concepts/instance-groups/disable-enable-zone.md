[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Концепции](../index.md) > [Группы виртуальных машин](index.md) > Временное отключение зон доступности

# Временное отключение зон доступности для групп ВМ Yandex Compute Cloud

В Compute Cloud вы можете временно отключать одну или несколько [зон доступности](../../../overview/concepts/geo-scope.md) для [групп виртуальных машин](index.md). Это может быть полезно для сохранения работоспособности ваших сервисов, когда в зоне доступности проводится тестирование, обслуживание, наблюдаются неполадки или [инцидент](zonal-inc/overview.md).
...
> 
> Также полезно временно отключить зону для группы ВМ при зональном инциденте. Таким образом вы сможете контролируемо ввести ВМ из пораженной зоны в эксплуатацию при выходе из инцидента. Подробнее смотрите [Поведение группы ВМ при временном отключении зоны и инциденте в этой же зоне](disable-enable-zone.md#zonal-inc-shift).
...
Подробнее на странице [Отключить и включить зоны доступности для группы ВМ Yandex Compute Cloud](../../operations/instance-groups/disable-enable-zone.md).
...
Чтобы сохранить работоспособность сервиса, вы можете удалять ВМ в отключенной зоне с помощью метода REST API [DeleteInstances](../../instancegroup/api-ref/InstanceGroup/deleteInstances.md) для ресурса [InstanceGroup](../../instancegroup/api-ref/InstanceGroup/index.md) или вызова gRPC API [InstanceGroupService/DeleteInstances](../../instancegroup/api-ref/grpc/InstanceGroup/deleteInstances.md). 

Также вы можете останавливать ВМ в отключенной зоне с помощью метода REST API [StopInstances](../../instancegroup/api-ref/InstanceGroup/stopInstances.md) для ресурса [InstanceGroup](../../instancegroup/api-ref/InstanceGroup/index.md) или вызова gRPC API [InstanceGroupService/StopInstances](../../instancegroup/api-ref/grpc/InstanceGroup/stopInstances.md). 
...
* [Отключить и включить зоны доступности для группы ВМ Yandex Compute Cloud](../../operations/instance-groups/disable-enable-zone.md)
