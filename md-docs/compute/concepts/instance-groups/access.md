...
Сервисный аккаунт — это специальная учетная запись, которая может использоваться службами и приложениями для взаимодействия с другими [API](../../../glossary/rest-api.md) {{ yandex-cloud }} от вашего имени. Подробнее про сервисные аккаунты и управление доступом в {{ yandex-cloud }} читайте в документации сервиса [{{ iam-full-name }}](../../../iam/index.md).
