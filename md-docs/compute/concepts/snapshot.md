...
Для снимков с локальных дисков на [выделенных хостах](dedicated-host.md) используйте сервис [{{ backup-full-name }}](../../backup/index.md) (поддерживает ОС Ubuntu, CentOS, CentOS Stream и Windows Server).
...
Для защиты критичных данных в {{ compute-name }} рекомендуется использовать шифрование снимков с помощью ключей [{{ kms-full-name }}](../../kms/index.md).
