[Документация Yandex Cloud](../../index.md) > [Yandex Compute Cloud](../index.md) > [Концепции](index.md) > Пулы резервов ВМ

# Пулы резервов виртуальных машин в Compute Cloud
...
Управлять пулами резервов ВМ и привязкой к ним виртуальных машин вы можете с помощью [консоли управления](https://console.yandex.cloud), [Yandex Cloud CLI](../cli-ref/reserved-instance-pool/index.md) и [API](../api-ref/ReservedInstancePool/index.md).
...
Пулы резервов ВМ несовместимы с [выделенными хостами](dedicated-host.md), [прерываемыми ВМ](preemptible-vm.md) и виртуальными машинами с [уровнем производительности vCPU](performance-levels.md) менее 100%. Кроме того, в настоящее время пулы резервов ВМ не поддерживают [группы размещения](placement-groups.md).
...
* [Создание пула резервов виртуальных машин](../operations/reserved-pools/create-reserved-pool.md)
* [Создать группу с виртуальными машинами из пула резервов Yandex Compute Cloud](../operations/instance-groups/create-group-with-pool.md)
* [Изменение пула резервов виртуальных машин](../operations/reserved-pools/update-reserved-pool.md)
* [Удаление пула резервов виртуальных машин](../operations/reserved-pools/delete-reserved-pool.md)
* [Управление виртуальными машинами пула резервов ВМ](../operations/reserved-pools/manage-pool-vms.md)
* [Пулы резервов виртуальных машин для групп узлов Yandex Managed Service for Kubernetes](../../managed-kubernetes/concepts/node-group/reserved-pools.md)