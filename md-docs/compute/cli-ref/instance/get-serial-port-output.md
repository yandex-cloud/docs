[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Справочник CLI (англ.)](../index.md) > [instance](index.md) > get-serial-port-output
...
Specifies which serial port to retrieve data from. ||
|#
