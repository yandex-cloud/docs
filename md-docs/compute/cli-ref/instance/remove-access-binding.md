[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Справочник CLI (англ.)](../index.md) > [instance](index.md) > remove-access-binding

# yc compute instance remove-access-binding

Remove access binding for the specified instance

#### Command Usage

Syntax:

`yc compute instance remove-access-binding <INSTANCE-NAME>|<INSTANCE-ID> [Flags...] [Global Flags...]`
