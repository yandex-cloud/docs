 ...
 * [Создать образ из снимка диска](../../operations/image-create/create-from-snapshot.md#cli_1)
 * [Создайте образ в Compute Cloud](../../operations/image-create/upload.md#cli_1)
 * [Перенести виртуальную машину в другое облако](../../operations/vm-control/vm-change-cloud.md#cli_3)
 * [Создайте в Compute Cloud образ с закреплением поколения оборудования Gen 2](../../operations/vm-create/create-gen2-vm.md#cli_1)