[Документация Yandex Cloud](../../../../index.md) > [Yandex Compute Cloud](../../../index.md) > [Справочник CLI (англ.)](../../index.md) > [v0](../index.md) > [snapshot](index.md) > add-access-binding

# yc compute v0 snapshot add-access-binding
...
`yc compute snapshot add-access-binding <SNAPSHOT-NAME>|<SNAPSHOT-ID> [Flags...] [Global Flags...]`
