[Документация Yandex Cloud](../../../../index.md) > [Yandex Compute Cloud](../../../index.md) > [Справочник CLI (англ.)](../../index.md) > [v0](../index.md) > [image](index.md) > add-access-binding

# yc compute v0 image add-access-binding

Add access binding for the specified image

#### Command Usage

Syntax:

`yc compute image add-access-binding <IMAGE-NAME>|<IMAGE-ID> [Flags...] [Global Flags...]`
