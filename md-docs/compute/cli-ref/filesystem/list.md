...
`yc compute filesystem list [Flags...] [Global Flags...]`
 ...
 * [Удалить файловое хранилище](../../operations/filesystem/delete.md#cli_1)
 * [Отключить файловое хранилище от виртуальной машины](../../operations/filesystem/detach-from-vm.md#cli_1)
 * [Назначить роль](../../operations/filesystem/filesystem-access.md#cli_1)
 * [Изменить файловое хранилище](../../operations/filesystem/update.md#cli_1)
