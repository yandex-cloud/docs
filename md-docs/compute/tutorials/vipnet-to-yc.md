[Документация Yandex Cloud](../../index.md) > [Yandex Compute Cloud](../index.md) > [Практические руководства](index.md) > ViPNet Coordinator в Yandex Cloud
...
* Плата за вычислительные ресурсы, диски и образы ВМ ([тарифы Yandex Compute Cloud](../pricing.md)).
...
* [Удалите](../operations/vm-control/vm-delete.md) ВМ с ViPNet Coordinator VA.
* [Удалите](../operations/image-control/delete.md) образы дисков.
