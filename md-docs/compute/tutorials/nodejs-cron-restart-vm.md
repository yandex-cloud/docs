...
В этом руководстве вы создадите [функцию](../../functions/concepts/function.md) [{{ sf-full-name }}](../../functions/index.md) на языке [Node.js](../../functions/lang/nodejs/index.md), которая будет вызываться по расписанию и запускать [прерываемую ВМ](../concepts/preemptible-vm.md) {{ compute-full-name }}, если ВМ остановлена.
