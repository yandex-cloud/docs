...
В этом руководстве вы развернете инфраструктуру для защиты бэкендов приложения от DDoS-атак в {{ yandex-cloud }}. Для этого вы создадите облачную сеть, настроите группы безопасности [{{ vpc-full-name }}](../../../vpc/index.md), создадите группу ВМ [{{ compute-full-name }}](../../index.md) в качестве бэкендов и свяжете ее с инфраструктурой L7-балансировщика [{{ alb-full-name }}](../../../application-load-balancer/index.md) с защищенным от DDoS-атак публичным IP-адресом.
