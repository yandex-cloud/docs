...
* плата за вычислительные ресурсы и диски ВМ (см. [тарифы {{ compute-full-name }}](../pricing.md)).
...
[Виртуальная машина](../concepts/vm.md) — это аналог сервера в облачной инфраструктуре. В {{ yandex-cloud }} вы можете создавать
виртуальные машины с самыми разными аппаратными характеристиками по [производительности](../concepts/performance-levels.md), объему оперативной памяти и [дискового пространства](../concepts/disk.md#maximum-disk-size), а также под управлением разных [операционных систем](../concepts/image.md#public).
...
1. Создайте виртуальную машину:
    ...
    Перед тем как приступать к созданию виртуальной машины, [подготовьте](../operations/vm-connect/ssh.md#creating-ssh-keys) пару ключей (открытый и закрытый) для доступа к ВМ по SSH.
...
1. Создайте и активируйте виртуальное окружение.
    ...
    1. [Подключитесь](../operations/vm-connect/ssh.md) к виртуальной машине `mywebserver`.
...
1. [Подключитесь](../operations/vm-connect/ssh.md) к ВМ.
...
Чтобы перестать платить за развернутый веб-сервер, [удалите виртуальную машину](../operations/vm-control/vm-delete.md).
