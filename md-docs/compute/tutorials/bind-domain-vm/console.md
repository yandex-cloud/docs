[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Практические руководства](../index.md) > [Привязка доменного имени к ВМ с веб-сервером](index.md) > Консоль управления, CLI и API
...
Перед тем как приступать к созданию виртуальной машины, подготовьте [пару ключей](../../operations/vm-connect/ssh.md#creating-ssh-keys) (открытый и закрытый) для доступа к ВМ по SSH.
...
- Консоль управления {#console}
  ...
  1. В блоке **Доступ** укажите данные для доступа к ВМ:
      ...
      * В поле **SSH-ключ** вставьте содержимое созданного ранее [публичного ключа](../../operations/vm-connect/ssh.md#creating-ssh-keys).
