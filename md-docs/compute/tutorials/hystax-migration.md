...
1. Если миграция производится с VMware ESXi, Microsoft Hyper-V или иного гипервизора, отличного от KVM, то перед миграцией [установите virtio-драйверы](../operations/image-create/custom-image.md#virtio) на виртуальную машину.
