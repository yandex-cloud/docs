...
* плата за постоянно запущенную [ВМ](../../concepts/vm.md) (см. [тарифы {{ compute-full-name }}](../../pricing.md));
...
- Консоль управления {#console}
  ...
  1. Добавьте дополнительный [диск](../../concepts/disk.md) для хранения данных:
  ...
  1. В блоке **{{ ui-key.yacloud.compute.instances.create.section_platform }}** перейдите на вкладку **{{ ui-key.yacloud.component.compute.resources.label_tab-custom }}**, выберите [платформу](../../concepts/vm-platforms.md) и укажите рекомендуемые параметры для файлового сервера:
...
1. [Удалите ВМ](../../operations/vm-control/vm-delete.md).
