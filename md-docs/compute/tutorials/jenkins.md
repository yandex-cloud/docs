...
* Плата за постоянно запущенные ВМ (см. [тарифы Compute Cloud](../pricing.md)).
* Плата за хранение созданных образов (см. [тарифы Compute Cloud](../pricing.md#prices-storage)).
...
* [Установите](https://www.terraform.io/downloads) Terraform. См. также раздел [Начало работы с Terraform](../../tutorials/infrastructure-management/terraform-quickstart.md).
...
1. В блоке **Диски и файловые хранилища** задайте размер загрузочного [диска](../concepts/disk.md) `15 ГБ`.
