[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Практические руководства](../index.md) > Развертывание Nextcloud в интеграции с Object Storage > Обзор

# Развертывание Nextcloud в Yandex Cloud

[Nextcloud](https://nextcloud.com/) — это программное решение с открытым исходным кодом, позволяющее организовывать совместную работу в команде, проводить аудио- и видеоконференции, а также удобно, гибко и безопасно управлять файлами, обмениваться ими и совместно работать над документами. При этом Nextcloud позволяет как создавать собственные облачные хранилища, так и интегрировать готовые решения, например, [Yandex Object Storage](../../../storage/index.md). В качестве пользовательского интерфейса Nextcloud предоставляет приложения для рабочего стола, мобильные приложения и веб-интерфейс.
...
* [Развертывание Nextcloud на виртуальной машине Compute Cloud с помощью образа Container Optimized Image](coi-based.md) — способ быстро развернуть базовую функциональность Nextcloud в инфраструктуре Yandex Cloud.
