[Документация Yandex Cloud](../../index.md) > [Yandex Compute Cloud](../index.md) > [Практические руководства](index.md) > Container Optimized Image > Создать группу ВМ с Container Optimized Image
...
1. Опишите в YAML-файле `specification.yaml`, который вы создали:
   ...
   * [Шаблон ВМ](../concepts/instance-groups/instance-template.md):
     ...
     * `primary_v4_address_spec` — спецификация версии интернет протокола IPv4. На данный момент доступен только протокол IPv4. Вы можете [предоставить публичный доступ к ВМ группы](../concepts/instance-groups/instance-template.md#instance-template), указав версию IP для публичного IP-адреса.
