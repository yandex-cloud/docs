[Документация Yandex Cloud](../../index.md) > [Yandex Compute Cloud](../index.md) > [Практические руководства](index.md) > Настройка сетевой связности между подсетями BareMetal и Virtual Private Cloud
...
В этом руководстве вы организуете сетевую связность между [сервером](../../baremetal/concepts/servers.md) BareMetal, расположенным в [приватной подсети](../../baremetal/concepts/private-network.md) Yandex BareMetal, и [виртуальной машиной](../concepts/vm.md) Yandex Compute Cloud, расположенной в подсети [облачной сети](../../vpc/concepts/network.md#network) Yandex Virtual Private Cloud.
