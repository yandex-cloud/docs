[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Практические руководства](../index.md) > Продукты Microsoft в Yandex Cloud > [Безопасная передача пароля в скрипт инициализации](index.md) > Terraform
...
1. В файле `yc-secured-password.auto.tfvars` задайте пользовательские параметры:
   ...
   * `image_family` — семейство одного из [образов](../../concepts/image.md) ВМ с нужной версией ОС.
