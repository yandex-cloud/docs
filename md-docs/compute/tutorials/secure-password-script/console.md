...
* плата за использование [ключа](../../../kms/concepts/key.md) {{ kms-short-name }} (см. [тарифы {{ kms-short-name }}](../../../kms/pricing.md));
...
1. Создайте ВМ:
   ...
   - Консоль управления {#console}
     ...
     1. В блоке **{{ ui-key.yacloud.compute.instances.create.section_image }}** выберите [образ](../../concepts/image.md) с ОС Windows.
