[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Практические руководства](../index.md) > Продукты Microsoft в Yandex Cloud > [Безопасная передача пароля в скрипт инициализации](index.md) > Консоль управления, CLI, API
...
1. Назначьте сервисному аккаунту `win-secret-sa` [роль](../../../iam/concepts/access-control/roles.md) `kms.keys.encrypterDecrypter`:
   ...
   - Консоль управления {#console}
     ...
     1. В списке в строке с сервисным аккаунтом `win-secret-sa` нажмите значок ![ellipsis](../../../_assets/console-icons/ellipsis.svg) и выберите **Назначить роли**.
...
1. Назначьте сервисному аккаунту `win-secret-sa` [роль](../../../iam/concepts/access-control/roles.md) `lockbox.payloadViewer`:
   ...
   - Консоль управления {#console}
     ...
     1. На странице секрета откройте вкладку **Права доступа**.
     1. В списке в строке с сервисным аккаунтом `win-secret-sa` нажмите значок ![ellipsis](../../../_assets/console-icons/ellipsis.svg) и выберите **Назначить роли**.
...
1. Создайте ВМ:
   ...
   - Консоль управления {#console}
     ...
     1. В блоке **Образ загрузочного диска** выберите [образ](../../concepts/image.md) с ОС Windows.
     ...
     1. В блоке **Дополнительно** укажите данные для доступа на ВМ:
         ...
         * Разрешите доступ к [серийной консоли](../../concepts/serial-console.md).
