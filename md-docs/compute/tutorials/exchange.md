...
1. Подключитесь к ВМ `fsw-vm` [с помощью RDP](../operations/vm-connect/rdp.md). Используйте логин `Administrator` и ваш пароль.
...
1. Создайте ВМ `vm-exchange-a`:
   ...
   - Консоль управления {#console}
     ...
     1. В блоке **Диски и файловые хранилища**:
         ...
         * Задайте размер загрузочного [диска](../concepts/disk.md) `100 ГБ`.
...
Чтобы перестать платить за развернутые серверы, достаточно удалить все созданные [виртуальные машины](../operations/vm-control/vm-delete.md) и [балансировщик](../../network-load-balancer/operations/load-balancer-delete.md):
