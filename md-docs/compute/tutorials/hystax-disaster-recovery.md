...
Входящий | `https` | `4443` | `TCP` | `Диапазон адресов` | `0.0.0.0/0`
Входящий | `vmware` | `902` | `TCP` | `Диапазон адресов` | `0.0.0.0/0`
Входящий | `vmware` | `902` | `UDP` | `Диапазон адресов` | `0.0.0.0/0`
Входящий | `iSCSI` | `3260` | `TCP` | `Диапазон адресов` | `0.0.0.0/0`
Входящий | `udp` | `12201` | `UDP` | `Диапазон адресов` | `0.0.0.0/0`
Входящий | `tcp` | `15000` | `TCP` | `Диапазон адресов` | `0.0.0.0/0`
Исходящий | `http` | `80` | `TCP` | `Диапазон адресов` | `0.0.0.0/0`
Исходящий | `https` | `443` | `TCP` | `Диапазон адресов` | `0.0.0.0/0`
Исходящий | `vmware` | `902` | `TCP` | `Диапазон адресов` | `0.0.0.0/0`
Исходящий | `vmware` | `902` | `UDP` | `Диапазон адресов` | `0.0.0.0/0`
Исходящий | `iSCSI` | `3260` | `TCP` | `Диапазон адресов` | `0.0.0.0/0`
Исходящий | `udp` | `12201` | `UDP` | `Диапазон адресов` | `0.0.0.0/0`
