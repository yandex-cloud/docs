[Документация Yandex Cloud](../../index.md) > [Yandex Compute Cloud](../index.md) > [Практические руководства](index.md) > Container Optimized Image > Создать ВМ с Container Optimized Image
...
- CLI с помощью параметров {#cli}
  ...
  1. Выполните команду:
    ...
    После создания ВМ появится в списке ВМ в разделе **Compute Cloud** в [консоли управления](https://console.yandex.cloud). Подробнее о работе с ВМ читайте в [пошаговых инструкциях](../operations/index.md).
