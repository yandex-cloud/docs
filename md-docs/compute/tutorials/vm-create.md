...
Создайте виртуальную машину из образа [{{ coi }}](../../cos/concepts/index.md) и запустите на ней [Docker-контейнер](https://yandex.cloud/ru/blog/posts/2022/03/docker-containers).
...
- Консоль управления {#console}
  ...
  1. Настройте остальные параметры ВМ по [инструкции](../operations/vm-create/create-linux-vm.md).
...
- CLI с помощью параметров {#cli}
  ...
  1. Выполните команду:
     ...
     * `--ssh-key` — содержимое файла [открытого ключа](../operations/vm-connect/ssh.md#creating-ssh-keys).
    ...
    После создания ВМ появится в списке ВМ в разделе **{{ ui-key.yacloud.iam.folder.dashboard.label_compute }}** в [консоли управления]({{ link-console-main }}). Подробнее о работе с ВМ читайте в [пошаговых инструкциях](../operations/index.md).
