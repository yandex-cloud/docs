[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Практические руководства](../index.md) > Масштабирование группы виртуальных машин по расписанию > Обзор

# Масштабирование группы виртуальных машин по расписанию


В этом руководстве вы создадите [группу ВМ](../../concepts/instance-groups/index.md) с помощью сервиса [Yandex Compute Cloud](../../index.md) и настроите для нее [масштабирование](../../concepts/instance-groups/scale.md) по расписанию. Размером группы ВМ будет управлять [функция](../../../functions/concepts/function.md) [Yandex Cloud Functions](../../../functions/index.md), запускаемая по [таймеру](../../../functions/concepts/trigger/timer.md).
