[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [ReservedInstancePool](index.md) > ListOperations

# Compute Cloud API, REST: ReservedInstancePool.ListOperations
...
is larger than [ListReservedInstancePoolOperationsRequest.pageSize](#yandex.cloud.compute.v1.ListReservedInstancePoolOperationsRequest), use the `nextPageToken` as the value
for the [ListReservedInstancePoolOperationsRequest.pageToken](#yandex.cloud.compute.v1.ListReservedInstancePoolOperationsRequest) query parameter in the next list request.
