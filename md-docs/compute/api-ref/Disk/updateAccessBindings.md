[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Disk](index.md) > UpdateAccessBindings
...
```
POST https://compute.api.cloud.yandex.net/compute/v1/disks/{resourceId}:updateAccessBindings
```
