[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Disk](index.md) > Get

# Compute Cloud API, REST: Disk.Get

Returns the specified Disk resource.
To get the list of available Disk resources, make a [List](list.md#List) request.
