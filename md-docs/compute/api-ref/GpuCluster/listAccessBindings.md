[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [GpuCluster](index.md) > ListAccessBindings
...
```
GET https://compute.api.cloud.yandex.net/compute/v1/gpuClusters/{resourceId}:listAccessBindings
```
