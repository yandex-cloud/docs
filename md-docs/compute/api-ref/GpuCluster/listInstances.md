[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [GpuCluster](index.md) > ListInstances
...
Required field. ID of the GPU cluster to list instances in.
To get a GPU cluster ID, make a [GpuClusterService.List](list.md#List) request. ||
|#

## Query parameters {#yandex.cloud.compute.v1.ListGpuClusterInstancesRequest}
...
## Response {#yandex.cloud.compute.v1.ListGpuClusterInstancesResponse}
