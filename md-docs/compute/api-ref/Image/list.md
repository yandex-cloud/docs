[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Image](index.md) > List
...
is larger than [ListSnapshotsRequest.pageSize](../Snapshot/list.md#yandex.cloud.compute.v1.ListSnapshotsRequest), use
the `nextPageToken` as the value
for the [ListSnapshotsRequest.pageToken](../Snapshot/list.md#yandex.cloud.compute.v1.ListSnapshotsRequest) query parameter
