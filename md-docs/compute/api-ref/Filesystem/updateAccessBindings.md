[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Filesystem](index.md) > UpdateAccessBindings

# Compute Cloud API, REST: Filesystem.UpdateAccessBindings
...
```
POST https://compute.api.cloud.yandex.net/compute/v1/filesystems/{resourceId}:updateAccessBindings
```
...
Required field. Access binding. For more information, see [Access Bindings](../../../iam/concepts/access-control/index.md#access-bindings). ||
|#
...
* `userAccount`: An account on Yandex ID. This type represents the [yandex.cloud.iam.v1.UserAccount](../../../iam/api-ref/UserAccount/get.md#yandex.cloud.iam.v1.UserAccount) resource.
