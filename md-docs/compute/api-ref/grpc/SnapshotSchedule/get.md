[Документация Yandex Cloud](../../../../index.md) > [Yandex Compute Cloud](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [SnapshotSchedule](index.md) > Get
...
(if [SnapshotSchedule.retention_policy](../Disk/listSnapshotSchedules.md#yandex.cloud.compute.v1.SnapshotSchedule.retention_policy) is specified).
