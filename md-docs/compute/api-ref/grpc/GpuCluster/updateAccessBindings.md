[Документация Yandex Cloud](../../../../index.md) > [Yandex Compute Cloud](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [GpuCluster](index.md) > UpdateAccessBindings

# Compute Cloud API, gRPC: GpuClusterService.UpdateAccessBindings
