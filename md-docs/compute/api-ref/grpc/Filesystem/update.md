[Документация Yandex Cloud](../../../../index.md) > [Yandex Compute Cloud](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Filesystem](index.md) > Update
...
1. Get the current set of labels with a [FilesystemService.Get](get.md#Get) request.
