[Документация Yandex Cloud](../../../../index.md) > [Yandex Compute Cloud](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Instance](index.md) > Relocate
...
**rpc Relocate ([RelocateInstanceRequest](#yandex.cloud.compute.v1.RelocateInstanceRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## RelocateInstanceRequest {#yandex.cloud.compute.v1.RelocateInstanceRequest}
