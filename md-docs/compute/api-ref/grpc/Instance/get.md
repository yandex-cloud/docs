[Документация Yandex Cloud](../../../../index.md) > [Yandex Compute Cloud](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Instance](index.md) > Get

# Compute Cloud API, gRPC: InstanceService.Get

Returns the specified Instance resource.
To get the list of available Instance resources, make a [List](list.md#List) request.

## gRPC request

**rpc Get ([GetInstanceRequest](#yandex.cloud.compute.v1.GetInstanceRequest)) returns ([Instance](#yandex.cloud.compute.v1.Instance))**

## GetInstanceRequest {#yandex.cloud.compute.v1.GetInstanceRequest}
...
**The `metadata` field is currently omitted from response for the [yandex.cloud.compute.v1.InstanceService.List](list.md#List) request.** ||
