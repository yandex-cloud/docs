[Документация Yandex Cloud](../../../../index.md) > [Yandex Compute Cloud](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Disk](index.md) > SetAccessBindings

# Compute Cloud API, gRPC: DiskService.SetAccessBindings
