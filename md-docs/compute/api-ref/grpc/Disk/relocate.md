[Документация Yandex Cloud](../../../../index.md) > [Yandex Compute Cloud](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Disk](index.md) > Relocate
...
disk use [InstanceService.Relocate](../Instance/relocate.md#Relocate) request.
...
To get the disk ID, make a [DiskService.List](list.md#List) request.
