[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Instance](index.md) > List
...
- `status`: [status](../../concepts/vm-statuses.md) of the instance.
- `zone_id`: ID of the [availability zone](../../../overview/concepts/geo-scope.md) where the instance resides.
- `platform_id`: ID of the hardware [platform configuration](../../concepts/vm-platforms.md) the instance is created on.
- `host_id`: ID of the [dedicated host](../../concepts/dedicated-host.md) that the instance belongs to.
...
## Response {#yandex.cloud.compute.v1.ListInstancesResponse}
...
An Instance resource. For more information, see [Instances](../../concepts/vm.md).
...
**The `metadata` field is currently omitted from response for the [yandex.cloud.compute.v1.InstanceService.List](#List) request.** ||
