...
results is larger than `pageSize`, the service returns a [ListSnapshotScheduleOperationsResponse.nextPageToken](listOperations.md#yandex.cloud.compute.v1.ListSnapshotScheduleOperationsResponse)
...
[ListSnapshotScheduleOperationsResponse.nextPageToken](listOperations.md#yandex.cloud.compute.v1.ListSnapshotScheduleOperationsResponse) returned by a previous list request. ||
|#
