[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [SnapshotSchedule](index.md) > Enable

# Compute Cloud API, REST: SnapshotSchedule.Enable

Enables the specified snapshot schedule.
The [SnapshotSchedule.status](get.md#yandex.cloud.compute.v1.SnapshotSchedule) is changed to `ACTIVE`: new disk snapshots will be created, old ones deleted
