...
The [SnapshotSchedule.status](get.md#yandex.cloud.compute.v1.SnapshotSchedule) is changed to `INACTIVE`: the schedule is interrupted, snapshots won't be created
or deleted.
