# Compute Cloud Instance Groups API, gRPC: InstanceGroupService.DisableZones

Disable zones for the specified instance group.

## gRPC request

**rpc DisableZones ([DisableZonesRequest](#yandex.cloud.compute.v1.instancegroup.DisableZonesRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## DisableZonesRequest {#yandex.cloud.compute.v1.instancegroup.DisableZonesRequest}
...
Required field. ID of the instance group to disable zones.
...
|| metadata | **[DisableZonesMetadata](#yandex.cloud.compute.v1.instancegroup.DisableZonesMetadata)**
...
## DisableZonesMetadata {#yandex.cloud.compute.v1.instancegroup.DisableZonesMetadata}
