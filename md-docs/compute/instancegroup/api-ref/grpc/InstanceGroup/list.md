[Документация Yandex Cloud](../../../../../index.md) > [Yandex Compute Cloud](../../../../index.md) > Справочник API > gRPC (англ.) > [Compute Cloud Instance Groups API](../index.md) > [InstanceGroup](index.md) > List
...
**rpc List ([ListInstanceGroupsRequest](#yandex.cloud.compute.v1.instancegroup.ListInstanceGroupsRequest)) returns ([ListInstanceGroupsResponse](#yandex.cloud.compute.v1.instancegroup.ListInstanceGroupsResponse))**

## ListInstanceGroupsRequest {#yandex.cloud.compute.v1.instancegroup.ListInstanceGroupsRequest}
...
Currently you can use filtering only on the [InstanceGroup.name](#yandex.cloud.compute.v1.instancegroup.InstanceGroup) field.
The length must be less than or equal to 1000. ||
...
## ListInstanceGroupsResponse {#yandex.cloud.compute.v1.instancegroup.ListInstanceGroupsResponse}
