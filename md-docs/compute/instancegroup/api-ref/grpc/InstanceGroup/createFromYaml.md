[Документация Yandex Cloud](../../../../../index.md) > [Yandex Compute Cloud](../../../../index.md) > Справочник API > gRPC (англ.) > [Compute Cloud Instance Groups API](../index.md) > [InstanceGroup](index.md) > CreateFromYaml
...
Required field. [InstanceGroupService.Create](create.md#Create) request in YAML format.
