...
**rpc ResumeProcesses ([ResumeInstanceGroupProcessesRequest](#yandex.cloud.compute.v1.instancegroup.ResumeInstanceGroupProcessesRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## ResumeInstanceGroupProcessesRequest {#yandex.cloud.compute.v1.instancegroup.ResumeInstanceGroupProcessesRequest}
...
The instance group must have a `PAUSED` status ([InstanceGroup.status](#yandex.cloud.compute.v1.instancegroup.InstanceGroup)).

To get the instance group ID, make a [InstanceGroupService.List](list.md#List) request.
...
|| metadata | **[ResumeInstanceGroupProcessMetadata](#yandex.cloud.compute.v1.instancegroup.ResumeInstanceGroupProcessMetadata)**
...
## ResumeInstanceGroupProcessMetadata {#yandex.cloud.compute.v1.instancegroup.ResumeInstanceGroupProcessMetadata}
...
call [yandex.cloud.compute.v1.instancegroup.InstanceGroupService.ResumeProcesses](#ResumeProcesses).
...
|| disable_zone_statuses[] | **[DisableZoneStatus](#yandex.cloud.compute.v1.instancegroup.DisableZoneStatus)**
