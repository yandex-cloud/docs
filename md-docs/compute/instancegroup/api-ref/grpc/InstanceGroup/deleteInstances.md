[Документация Yandex Cloud](../../../../../index.md) > [Yandex Compute Cloud](../../../../index.md) > Справочник API > gRPC (англ.) > [Compute Cloud Instance Groups API](../index.md) > [InstanceGroup](index.md) > DeleteInstances
...
To get the ID of the instance group, use the [InstanceGroupService.List](list.md#List) request.
