[Документация Yandex Cloud](../../../../../index.md) > [Yandex Compute Cloud](../../../../index.md) > Справочник API > gRPC (англ.) > [Compute Cloud Instance Groups API](../index.md) > [InstanceGroup](index.md) > UpdateAccessBindings

# Compute Cloud Instance Groups API, gRPC: InstanceGroupService.UpdateAccessBindings
