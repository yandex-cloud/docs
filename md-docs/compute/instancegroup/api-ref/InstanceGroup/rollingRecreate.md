[Документация Yandex Cloud](../../../../index.md) > [Yandex Compute Cloud](../../../index.md) > Справочник API > REST (англ.) > [Compute Cloud Instance Groups API](../index.md) > [InstanceGroup](index.md) > RollingRecreate
...
## Body parameters {#yandex.cloud.compute.v1.instancegroup.RollingRecreateRequest}
