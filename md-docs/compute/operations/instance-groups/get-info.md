[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Пошаговые инструкции](../index.md) > Получение информации о группе виртуальных машин > Получить информацию о группе ВМ
