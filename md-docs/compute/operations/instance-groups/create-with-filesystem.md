[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Пошаговые инструкции](../index.md) > Создание группы виртуальных машин > Создать группу ВМ с подключением к файловому хранилищу
    ...
    - CLI {#cli}
      ...
      1. Подготовьте файл с [YAML-спецификацией](../../concepts/instance-groups/specification.md) группы ВМ с произвольным именем, например `specification.yaml`.
          ...
          * В поле `instance_template` — вложенное поле `filesystem_specs` с описанием файлового хранилища:
              ...
              * `filesystem_id` — идентификатор файлового хранилища. Посмотреть идентификатор можно в [консоли управления](https://console.yandex.cloud) или с помощью команды CLI `yc compute filesystem list`.
