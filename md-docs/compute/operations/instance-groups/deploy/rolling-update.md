[Документация Yandex Cloud](../../../../index.md) > [Yandex Compute Cloud](../../../index.md) > [Пошаговые инструкции](../../index.md) > Управление группой виртуальных машин > Обновить группу > Постепенное обновление
...
1. Запустите [операцию обновления](../update.md) группы.
