[Документация Yandex Cloud](../../../../index.md) > [Yandex Compute Cloud](../../../index.md) > [Пошаговые инструкции](../../index.md) > Группы виртуальных машин > Управление > Обновить группу > Обновление без простоя
