[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Пошаговые инструкции](../index.md) > Группы виртуальных машин > Создание > Создать группу ВМ фиксированного размера с L7-балансировщиком
  ...
  1. Опишите в созданном файле:
     ...
     * [Шаблон ВМ](../../concepts/instance-groups/instance-template.md), например:
       ...
       instance_template:
         ...
         * `type_id` — [тип диска](../../concepts/disk.md#disks-types).
         * `size` — размер диска.
