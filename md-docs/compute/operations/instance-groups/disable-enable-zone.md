...
Подробнее о режиме работы при отключении зоны см. на странице [Временное отключение зон доступности для групп ВМ Yandex Compute Cloud](../../concepts/instance-groups/disable-enable-zone.md).
