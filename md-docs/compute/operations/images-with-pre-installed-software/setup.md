...
Для ВМ с системами, требующими развертывания, например, [Drupal](https://yandex.cloud/ru/marketplace/products/yc/drupal-8), [{{ GL }}](https://yandex.cloud/ru/marketplace/products/yc/gitlab), [Joomla](https://yandex.cloud/ru/marketplace/products/yc/joomla) и [WordPress](https://yandex.cloud/ru/marketplace/products/yc/wordpress), для первоначальной настройки используйте [веб-установщик](#web-setup).
