[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Пошаговые инструкции](../index.md) > Группы размещения > Диски > Добавить диск в группу размещения
...
- Консоль управления {#console}
  ...
  1. Перейдите на вкладку **Диски** и нажмите кнопку **Добавить диск**.
