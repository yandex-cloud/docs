[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Пошаговые инструкции](../index.md) > Группы размещения > Диски > Создать группу размещения дисков
...
- Консоль управления {#console}
  ...
  1. Нажмите кнопку **Создать** и выберите **Группу размещения нереплицируемых дисков**.
