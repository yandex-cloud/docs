[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Пошаговые инструкции](../index.md) > Группы размещения > ВМ > Получить информацию о группе размещения
...
- Консоль управления {#console}
  ...
  1. На вкладке **Обзор** отобразится подробная информация о группе размещения ВМ.
