[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Пошаговые инструкции](../index.md) > Виртуальные машины > Получение информации > Получить вывод последовательного порта
...
Для доступа к выводимым данным необходима [роль](../../security/index.md) `compute.operator` или `viewer`.
