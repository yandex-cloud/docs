[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Пошаговые инструкции](../index.md) > Пулы резервов ВМ > Изменить пул резервов ВМ
...
- Консоль управления {#console}
  ...
  1. Измените параметры ВМ:
       ...
       * Тип пула.
       * Размер пула.
       * Если нужно расширить пул, даже когда свободных ресурсов в зоне доступности недостаточно, включите опцию **При отсутствии ресурсов**. Подробнее в разделе [Опция ожидания ресурсов](../../concepts/reserved-pools.md#pending-slots).
