...
К серийной консоли виртуальной машины под управлением операционной системы Windows вы можете подключиться с помощью [консоли управления]({{ link-console-main }}) или [{{ yandex-cloud }} CLI](../../../cli/index.md), запустив командную оболочку в Windows SAC:
