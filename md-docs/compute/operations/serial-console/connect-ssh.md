[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Пошаговые инструкции](../index.md) > [Серийная консоль](index.md) > Подключиться к серийной консоли ВМ с ОС Linux
