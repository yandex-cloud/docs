...
Для платформы `gpu-standard-v3i` поддерживается только образ с драйвером [NVIDIA 535 и поддержкой secure-boot](https://yandex.cloud/ru/marketplace/products/yc/ubuntu-2004-lts-secureboot-cuda-12-2). Обновление видеодрайвера на этой платформе невозможно; допустимо обновлять только библиотеку CUDA.
