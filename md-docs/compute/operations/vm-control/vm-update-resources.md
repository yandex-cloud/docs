[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Пошаговые инструкции](../index.md) > Виртуальные машины > Управление > Изменить вычислительные ресурсы ВМ
...
- Консоль управления {#console}
  ...
  1. Нажмите значок ![image](../../../_assets/console-icons/ellipsis.svg), выберите **Остановить** и в открывшемся окне подтвердите остановку ВМ.
  1. В открывшемся окне нажмите кнопку **Остановить**.
  1. Подождите, пока ВМ перейдет в статус `Stopped`, и нажмите кнопку ![image](../../../_assets/console-icons/pencil.svg) **Редактировать**.
  ...
  1. Нажмите кнопку **Запустить** и в открывшемся окне подтвердите запуск ВМ.
...
- Консоль управления {#console}
  ...
  1. Выберите нужную ВМ в списке.
  1. Нажмите значок ![image](../../../_assets/console-icons/ellipsis.svg), выберите **Остановить** и в открывшемся окне подтвердите остановку ВМ.
  1. Подождите, пока ВМ перейдет в статус `Stopped`, и нажмите кнопку ![pencil](../../../_assets/console-icons/pencil.svg) **Редактировать**.
...
- Консоль управления {#console}
  ...
  1. [Перейдите](https://console.yandex.cloud/link/compute) в сервис **Compute Cloud**.
  1. Выберите нужную ВМ в списке.
  1. Нажмите значок ![ellipsis](../../../_assets/console-icons/ellipsis.svg), выберите **Остановить** и в открывшемся окне подтвердите остановку ВМ.
  1. Подождите, пока ВМ перейдет в статус `Stopped`, и нажмите кнопку ![pencil](../../../_assets/console-icons/pencil.svg) **Редактировать**.
  1. В блоке **Вычислительные ресурсы**:
