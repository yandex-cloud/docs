...
- Другие ОС {#other}
  ...
  1. Остановите виртуальную машину (см. раздел [Остановить](vm-stop-and-start.md#stop)).
...
- Консоль управления {#console}
  ...
  1. В блоке **Дополнительно**:
     ...
     * (Опционально) Разрешите доступ к [серийной консоли](../serial-console/index.md).
