[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Пошаговые инструкции](../index.md) > Управление виртуальной машиной > Подключить сервисный аккаунт к ВМ
...
- Terraform {#tf}
  ...
  1. Откройте конфигурационный файл Terraform, в котором описана ВМ, к которой вы хотите подключить сервисный аккаунт. Смотрите [пример конфигурационного файла ВМ](../vm-create/create-linux-vm.md#tf_1).
