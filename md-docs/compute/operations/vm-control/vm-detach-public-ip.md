...
Статический IP-адрес остается в зарезервированных IP-адресах в [{{ vpc-short-name }}](../../../vpc/index.md), и его можно использовать для доступа к облачным ресурсам позднее.
