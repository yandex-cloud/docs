[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Пошаговые инструкции](../index.md) > GPU > Кластеры GPU > Запустить параллельные задачи в кластере GPU

# Запустить параллельные задачи в кластере GPU


1. [Подключитесь](../vm-connect/ssh.md) к каждой ВМ в кластере по SSH.
