[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Пошаговые инструкции](../index.md) > Управление диском > Перенести диск в другой каталог
...
- CLI {#cli}
  ...
  1. Перенесите диск в другой каталог со следующими параметрами:
      ...
      * `--destination-folder-id` – идентификатор целевого каталога, например `b1gd129pp9ha********`.
      ...
      Подробнее о команде `yc compute disk move` читайте в [справочнике CLI](../../../cli/cli-ref/compute/cli-ref/disk/move.md).
