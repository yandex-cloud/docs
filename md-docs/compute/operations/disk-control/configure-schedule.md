[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Пошаговые инструкции](../index.md) > Диски > Управление > Настроить создание снимков диска по расписаниям
...
- Консоль управления {#console}
  ...
  1. На панели слева выберите ![image](../../../_assets/console-icons/hard-drive.svg) **Диски и хранилища** и выберите нужный диск.
  1. В блоке **Расписания снимков** нажмите кнопку **Настроить расписания снимков**.
