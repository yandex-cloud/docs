...
- {{ TF }} {#tf}
  ...
  1. Откройте конфигурационный файл {{ TF }}, в котором описана ВМ, к которой вы хотите подключить сервисный аккаунт. См. [пример конфигурационного файла ВМ](../vm-create/create-linux-vm.md#tf_1).
