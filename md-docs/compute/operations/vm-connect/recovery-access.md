[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Пошаговые инструкции](../index.md) > Виртуальные машины > Работа > Восстановить доступ к ВМ
...
1. [Измените метаданные](../vm-metadata/update-vm-metadata.md) через консоль управления, CLI, Terraform или API. Используйте конфигурацию:
...
1. Подключитесь к ВМ по [SSH](ssh.md) или с помощью [серийной консоли](../serial-console/connect-ssh.md), используя новый пароль.
...
1. После успешного подключения [очистите метаданные](../vm-metadata/update-vm-metadata.md), чтобы после перезапуска ВМ пароль не сбрасывался.
