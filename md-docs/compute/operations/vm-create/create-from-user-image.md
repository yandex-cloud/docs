[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Пошаговые инструкции](../index.md) > Создание виртуальной машины > Создать ВМ из пользовательского образа
...
[Подготовьте и загрузите](../image-create/upload.md) [образ](../../concepts/image.md) в Compute Cloud, из которого будет создаваться ВМ.
