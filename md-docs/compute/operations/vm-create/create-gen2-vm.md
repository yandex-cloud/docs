...
* Терминал `ttyS0` (порт COM1) настроен в качестве [серийной консоли](../../concepts/serial-console.md). См. [инструкцию](../image-create/custom-image.md#serial-console).
...
Чтобы создать новый образ по ссылке, полученной в [{{ objstorage-name }}](../../../storage/index.md):
