[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Пошаговые инструкции](../index.md) > Виртуальные машины > Создание > Создать ВМ с дисками из снимков

# Создать виртуальную машину с дисками из снимков


Вы можете создать виртуальную машину с дисками, восстановленными из имеющихся в каталоге снимков. Как создать снимок диска, описано в разделе [Создать снимок диска](../disk-control/create-snapshot.md).
