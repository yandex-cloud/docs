...
* [Начало работы с серийной консолью](serial-console/index.md)
* [Подключение к серийной консоли виртуальной машины по SSH](serial-console/connect-ssh.md)
* [Подключение к серийной консоли виртуальной машины с помощью CLI](serial-console/connect-cli.md)
* [Запустить командную оболочку в Windows SAC](serial-console/windows-sac.md)
* [Отключить доступ к серийной консоли](serial-console/disable.md)
