[Документация Yandex Cloud](../../index.md) > [Yandex Compute Cloud](../index.md) > Пошаговые инструкции > Все инструкции
...
* [Управление политикой обслуживания](vm-control/vm-update-policies.md)
...
* [Обмен файлами с виртуальной машиной Linux](vm-connect/scp-sftp.md)
...
* [Изменить внутренний IP-адрес виртуальной машины](vm-control/internal-ip-update.md)
...
* [Создать группу с виртуальными машинами из пула резервов Yandex Compute Cloud](instance-groups/create-group-with-pool.md)
* [Создать группу виртуальных машин в группе размещения](placement-groups/create-ig-in-pg.md)
