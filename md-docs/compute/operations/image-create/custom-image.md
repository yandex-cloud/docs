...
[Серийная консоль](../../concepts/serial-console.md) — это способ получить доступ к ВМ вне зависимости от состояния [сети](../../../vpc/concepts/network.md#network) или ОС. Используйте серийную консоль, например, для устранения неисправностей ВМ или при возникновении проблем с доступом через [SSH](../../../glossary/ssh-keygen.md). Подробнее см. в разделе [Серийная консоль виртуальной машины](../../concepts/serial-console.md).
