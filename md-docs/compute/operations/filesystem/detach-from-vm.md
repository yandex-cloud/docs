...
1. Отключите файловое хранилище от ВМ в Compute Cloud:
   ...
   - Terraform {#tf}
     ...
     Проверить отсоединение хранилища от ВМ можно в [консоли управления](https://console.yandex.cloud) или с помощью команды [CLI](../../../cli/index.md):
