[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Пошаговые инструкции](../index.md) > Файловые хранилища > Удалить файловое хранилище
...
1. Удалите [файловое хранилище](../../concepts/filesystem.md) в Compute Cloud:
   ...
   - Terraform {#tf}
     ...
     1. Откройте файл конфигурации Terraform и удалите фрагмент с описанием хранилища:
        ...
        {% cut "Пример описания хранилища в конфигурации Terraform" %}
     ...
     Проверить удаление хранилища можно в [консоли управления](https://console.yandex.cloud) или с помощью команды [CLI](../../../cli/index.md):
