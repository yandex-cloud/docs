[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Пошаговые инструкции](../index.md) > Создание диска > Создать пустой диск с блоком большого размера
...
- Консоль управления {#console}
  ...
  Смотрите раздел [Создать пустой диск](empty.md).
