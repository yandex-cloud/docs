[Документация Yandex Cloud](../../../index.md) > [Yandex Compute Cloud](../../index.md) > [Пошаговые инструкции](../index.md) > Создание диска > Восстановить диск с помощью образа
...
- Консоль управления {#console}
  ...
  1. В поле **Наполнение** выберите `Образ` и в появившемся списке выберите нужный образ. При необходимости воспользуйтесь фильтром.
...
- CLI {#cli}
  ...
  1. Создайте диск из выбранного образа:
      ...
      * `--kms-key-id` — идентификатор [симметричного ключа шифрования](../../../kms/concepts/key.md) Yandex Key Management Service для создания зашифрованного диска. Необязательный параметр.
