[Документация Yandex Cloud](../../../index.md) > [Yandex Certificate Manager](../../index.md) > [Пошаговые инструкции](../index.md) > Пользовательский сертификат > Удаление сертификата
...
- Консоль управления {#console}
  ...
  1. В открывшемся окне введите имя сертификата для подтверждения и нажмите кнопку **Удалить**.
