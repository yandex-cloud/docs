...
Чтобы не хранить приватный ключ пользовательского сертификата в открытом виде в конфигурационном файле {{ TF }}, запишите его в [{{ lockbox-name }}](../../../lockbox/index.md):
...
- {{ TF }} {#tf}
  ...
  После этого в указанный [каталог](../../../resource-manager/concepts/resources-hierarchy.md#folder) будет добавлен сертификат. Проверить появление сертификата и его настройки можно в [консоли управления]({{ link-console-main }}) или с помощью команды [CLI](../../../cli/index.md):
