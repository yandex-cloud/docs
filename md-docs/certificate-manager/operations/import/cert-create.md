[Документация Yandex Cloud](../../../index.md) > [Yandex Certificate Manager](../../index.md) > [Пошаговые инструкции](../index.md) > Пользовательский сертификат > Добавление сертификата
...
- Консоль управления {#console}
  ...
  1. (Опционально) Включите опцию **Защита от удаления**.
