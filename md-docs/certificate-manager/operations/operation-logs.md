[Документация Yandex Cloud](../../index.md) > [Yandex Certificate Manager](../index.md) > [Пошаговые инструкции](index.md) > Посмотреть операции с сертификатом

# Посмотреть операции с сертификатом

Все действия с ресурсами сервиса Certificate Manager сохраняются в виде списка операций. Каждой операции присваивается уникальный идентификатор.
