...
[ListCertificatesResponse.nextPageToken](list.md#yandex.cloud.certificatemanager.v1.ListCertificatesResponse) returned by a previous list request.
...
of results is greater than the specified [ListCertificatesRequest.pageSize](list.md#yandex.cloud.certificatemanager.v1.ListCertificatesRequest), use
the `next_page_token` as the value for the [ListCertificatesRequest.pageToken](list.md#yandex.cloud.certificatemanager.v1.ListCertificatesRequest) query parameter
