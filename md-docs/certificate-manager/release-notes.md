...
* Добавлено событие `GetCertificateContent`, чтобы в [Audit Trails](../audit-trails/concepts/events-data-plane.md#certificate-manager) собирать аудитные логи по событию «Получение содержимого SSL-сертификата».