[Документация Yandex Cloud](../../../../index.md) > [Yandex Certificate Manager](../../../index.md) > Справочник API > REST (англ.) > [Certificate Manager Private CA API](../index.md) > [PrivateCaCertificate](index.md) > UpdateAccessBindings
...
```
PATCH https://private-ca.certificate-manager.api.cloud.yandex.net/privateca/v1/privateCertificates/{resourceId}:updateAccessBindings
```
