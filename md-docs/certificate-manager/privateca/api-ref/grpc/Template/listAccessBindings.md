[Документация Yandex Cloud](../../../../../index.md) > [Yandex Certificate Manager](../../../../index.md) > Справочник API > gRPC (англ.) > [Certificate Manager Private CA API](../index.md) > [Template](index.md) > ListAccessBindings

# Certificate Manager Private CA API, gRPC: TemplateService.ListAccessBindings
