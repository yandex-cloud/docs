[Документация Yandex Cloud](../../../../index.md) > [Yandex Certificate Manager](../../../index.md) > Справочник API > gRPC (англ.) > Certificate Manager Private CA API > Overview
...
**Service URL**: `https://private-ca.certificate-manager.api.cloud.yandex.net`
