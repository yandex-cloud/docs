[Документация Yandex Cloud](../../index.md) > [Yandex Certificate Manager](../index.md) > [Практические руководства](index.md) > Хостинг статического сайта на фреймворке Gatsby в Object Storage

# Хостинг статического сайта на фреймворке Gatsby в Yandex Object Storage

С помощью этого руководства вы разместите свой статический сайт, созданный на фреймворке [Gatsby](https://www.gatsbyjs.com/docs), в сервисе [Object Storage](../../storage/index.md) и настроите доступ к нему по протоколу HTTPS с помощью сервиса [Yandex Certificate Manager](../index.md).
...
- Консоль управления {#console}
  ...
  1. Добавьте в сервис Certificate Manager [сертификат](../concepts/managed-certificate.md) от Let's Encrypt® для вашего домена, который будет использоваться сайтом:
      ...
      1. Выберите [тип проверки прав на домен](../concepts/challenges.md) `DNS`.
      1. Нажмите **Создать**.
