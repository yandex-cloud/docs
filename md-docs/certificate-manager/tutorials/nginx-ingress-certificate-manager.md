...
Управляйте [TLS-сертификатом](../concepts/index.md) для Ingress-контроллера NGINX через [{{ certificate-manager-full-name }}](../index.md).
...
1. Выпустите и [добавьте](../operations/managed/cert-create.md) в {{ certificate-manager-name }} сертификат Let's Encrypt® или [загрузите](../operations/import/cert-create.md) собственный сертификат.
1. Для сертификата Let's Encrypt® пройдите [проверку прав](../operations/managed/cert-validate.md) на домен, который указан в сертификате.
...
Сертификат от Let's Encrypt® должен обновляться автоматически вслед за [обновлением сертификата](../operations/managed/cert-update.md) в {{ certificate-manager-name }}.
...
1. [Удалите](../operations/managed/cert-delete.md) сертификат.
