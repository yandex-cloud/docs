[Документация Yandex Cloud](../../index.md) > [Yandex Certificate Manager](../index.md) > Справочник аудитных логов > GetCertificateContent
...
## Field description {#yandex.cloud.audit.certificatemanager.GetCertificateContent2}
...
|| details | **[EventDetails](#yandex.cloud.audit.certificatemanager.GetCertificateContent.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.certificatemanager.GetCertificateContent.EventDetails}
