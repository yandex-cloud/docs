[Документация Yandex Cloud](../../index.md) > [Yandex Certificate Manager](../index.md) > Начало работы
...
- Консоль управления {#console}
    ...
    1. [Настройте](../../storage/operations/hosting/setup.md) хостинг в бакете:
        ...
        1. Выберите режим `Хостинг` и укажите главную страницу сайта.
...
- Консоль управления {#console}
  ...
  1. [Перейдите](https://console.yandex.cloud/link/storage) в сервис **Object Storage**.
  1. На вкладке ![box](../../_assets/console-icons/box.svg) **Бакеты** нажмите на бакет с именем домена.
  1. Нажмите ![folder](../../_assets/console-icons/folder.svg) **Создать папку** и создайте папку `.well-known`.
  ...
  1. Дождитесь изменения статуса сертификата на `Issued`.
     ...
     Подробнее о статусе можно посмотреть на странице сертификата. Для этого напротив поля **Validation** нажмите ![receipt](../../_assets/console-icons/receipt.svg) **Показать логи**.
