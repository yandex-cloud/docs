[Документация Yandex Cloud](../../index.md) > [Начало работы в Yandex Cloud](../index.md) > [Физическим лицам](index.md) > Шаг 4. Создание виртуальной машины и подключение к ней
...
1. В открывшемся окне задайте следующие параметры:
   ...
   1. **Протокол** — `TCP`.
   1. **Источник** — `Диапазон адресов`.
   1. **IPv4 CIDR** — `0.0.0.0/0`
