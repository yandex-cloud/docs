[Документация Yandex Cloud](../../../index.md) > [Начало работы в Yandex Cloud](../../index.md) > Пробный период > Ограничения пробного периода
...
Во время пробного периода использование платных продуктов Yandex Cloud Marketplace недоступно, но после перехода в платное потребление вы сможете использовать остаток стартового гранта для их оплаты.
