...
Платформа {{ yandex-cloud }} имеет несколько пользовательских интерфейсов: [консоль управления]({{ link-console-main }}), [интерфейс командной строки](../../cli/index.md), {{ TF }}, REST API, gRPC API. Все действия в этом руководстве будут осуществляться через консоль управления.
