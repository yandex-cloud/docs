[Документация Yandex Cloud](../../index.md) > [Начало работы в Yandex Cloud](../index.md) > Юридическим лицам > Начало работы для юридических лиц
...
Платформа Yandex Cloud имеет несколько пользовательских интерфейсов: [консоль управления](https://console.yandex.cloud), [интерфейс командной строки](../../cli/index.md), Terraform, REST API, gRPC API. Все действия в этом руководстве будут осуществляться через консоль управления.
