...
Однако если срок действия [гранта](../usage-grant.md) истек, доступ к вашим ресурсам будет приостановлен на 60 дней или до момента перехода на платное потребление. Подробнее о завершении пробного периода см. на странице [Завершение пробного периода](../free-trial/concepts/trial-ending.md).
...
Платформа Yandex Cloud соответствует требованиям PCI DSS, поэтому использовать облачные сервисы для обработки платежей безопасно. Подробнее о сертификации PCI DSS см. в разделе [PCI DSS](../../security/conform.md#pci-dss).
...
Счет-фактура физически также не предоставляется, вы можете самостоятельно сгенерировать его в консоли и распечатать. Подробнее см. [Посмотреть историю расходов и скачать отчетные документы в сервисе Yandex Cloud Billing](../../billing/operations/download-reporting-docs.md).
