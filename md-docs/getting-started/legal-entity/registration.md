...
В {{ yandex-cloud }} все услуги предоставляются по договору. Заключение договора осуществляется путем принятия [оферты]({{ billing-oferta-url }}) при создании [платежного аккаунта](../../billing/concepts/billing-account.md) или напрямую с двусторонним подписанием.
