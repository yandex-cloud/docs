[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [Compute Cloud](../index.md) > Устранение проблем с созданием снимков дисков
...
Проверьте текущие значения квот **Количество снимков дисков**, **Общий объем снимков дисков** и **Количество расписаний для снимков дисков** – операции создания новых снимков будут завершаться с ошибкой при превышении связанных с ними квот.

Вы можете [создать запрос на увеличение квот](https://console.yandex.cloud/cloud?section=quotas) из [Консоли управления](https://console.yandex.cloud).
