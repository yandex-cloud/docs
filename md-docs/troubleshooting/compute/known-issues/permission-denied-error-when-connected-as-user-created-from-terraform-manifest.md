[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [Compute Cloud](../index.md) > Устранение ошибки `Permission denied` при подключении к виртуальной машине после ее создания средствами Terraform
