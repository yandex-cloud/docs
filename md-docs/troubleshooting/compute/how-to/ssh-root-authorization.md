[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [Compute Cloud](../index.md) > Как подключиться по SSH от root с x или ключом
...
- Подключение с паролем
  ...
  1. Файл `/root/.ssh/authorized_keys` должен быть пустым либо содержать только ключ. Если ключ не подходит, то система запросит пароль.
