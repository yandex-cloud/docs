[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [Compute Cloud](../index.md) > Как настроить GUI и графическое окружение на виртуальных машинах с Linux
...
Есть несколько вариантов, позволяющих использовать графическое окружение рабочего стола на ВМ с Linux.
...
- Проброс X-сессии
  ...
  Вы можете пробросить на локальный компьютер графический интерфейс приложения, запущенного внутри Xorg-сессии на ВМ. О том, как это сделать, также есть множество статей в сети. Для ОС Microsoft Windows® можно использовать сервер [Xming](https://sourceforge.net/projects/xming/):
...
- Terraform
  ...
  Вы можете использовать Terraform для создания ВМ с заранее установленным графическим окружением. Возможный пример плана Terraform, который можно использовать в качестве основы, размещен [по этой ссылке](https://nikolaymatrosov.medium.com/rdp-%D0%BD%D0%B0-ubuntu-%D0%B2-yandex-cloud-c9d7870a47cc).

- Docker

  1. [Установите Docker](https://yandex.cloud/ru/container-registry/operations/configure-docker).
