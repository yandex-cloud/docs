[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [Compute Cloud](../index.md) > Как уменьшить объем диска виртуальной машины
...
Необходимо уменьшить объем ранее созданного диска, снимка или образа ВМ Compute Cloud.
