[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [Compute Cloud](../index.md) > Как узнать о потреблении оперативной памяти виртуальными машинами в Compute Cloud
...
* Необходимо получать информацию по использованию оперативной памяти виртуальной машиной Compute Cloud;
* Необходимо поставлять метрики использования оперативной памяти виртуальных машин в Yandex Monitoring.
