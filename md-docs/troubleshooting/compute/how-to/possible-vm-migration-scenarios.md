[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [Compute Cloud](../index.md) > Варианты миграции образа виртуальной машины в Yandex Cloud
...
Перенести виртуальную машину можно, подготовив из ее загрузочного диска образ [по нашим рекомендациям](../../../compute/operations/image-create/create-from-image.md), либо с помощью стороннего решения на основе Хайстекс Акура.
...
* В случае размещения ВМ у стороннего облачного провайдера, более простым способом миграции будет [использование решения от Хайстекс Акура](../../../tutorials/infrastructure-management/hystax-migration.md);
