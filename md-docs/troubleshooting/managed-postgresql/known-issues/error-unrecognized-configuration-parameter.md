...
Если кластер Managed Service for PostgreSQL продолжает работать неправильно, [создайте запрос в техническую поддержку](https://center.yandex.cloud/support). При создании запроса укажите идентификатор проблемного кластера и кратко опишите проблему.