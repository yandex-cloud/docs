...
Чтобы увеличить длительность сессии, измените значение параметра `Session duration timeout` в настройках кластера — подробнее об этом параметре описано [в документации](../../../managed-postgresql/concepts/settings-list.md#setting-session-duration-timeout). Время для настройки указывается в миллисекундах.
