[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [DataLens](../index.md) > Устранение ошибки `ERR.DS_API.FORMULA.VALIDATION.AGG.INCONSISTENT - Inconsistent aggregation among operands`
...
Yandex DataLens не позволяет использовать в одном выражении агрегированные и неагрегированные значения – не получится использовать в одном выражении показатели и измерения. Показатели отображаются в датасете и в визарде синим цветом, а измерения — зеленым.
