...
Если таблица Google Sheets, к которой вы пытаетесь настроить подключение, попадает под один или несколько указанных критериев, создайте копию этой таблицы и отредактируйте ее с учетом лимитов и особенностей сервиса DataLens.
