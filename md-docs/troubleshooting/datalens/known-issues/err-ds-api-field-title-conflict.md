...
Возможно, поле с таким названием было ранее добавлено в чарт, а затем было добавлено в датасет, по которому был построен чарт. В этой ситуации следует переименовать поле, добавленное в чарте.
