[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [DataLens](../index.md) > С каких IP-адресов происходит подключение к внешним источникам данных
...
Необходимо узнать, с каких IP-адресов происходит подключение к внешним источникам данных из Yandex DataLens.

## Решение {#case-resolution}

Yandex DataLens обращается к внешним базам данных с указанного диапазона IP-адресов.
