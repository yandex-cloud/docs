[Документация Yandex Cloud](../index.md) > Все решения > Готовые решения для известных сценариев
...
## Yandex Cloud Billing
 ...
 - [На привязанную к платежному аккаунту почту неожиданно пришел чек на сумму, отсутствующую в истории платежей](billing/known-issues/unexpected-cheque-received-to-email.md)

 - [Устранение ошибки `INVALID_PERSON_TYPE` при регистрации платежного аккаунта](billing/known-issues/invalid-person-type.md)

 - [Устранение проблем с оплатой](billing/known-issues/payment-problems.md)

 - [Устранение проблем со списанием средств с банковской карты](billing/known-issues/unable-to-charge-funds-from-linked-card.md)

 - [Устранение проблем с привязкой банковской карты к платежному аккаунту](billing/known-issues/couldnt-link-card.md)

 - [Устранение проблем с привязкой номера телефона для SMS-уведомлений к платежному аккаунту](billing/known-issues/sms-alerts-are-not-arriving.md)

 - [Устранение ошибки `ILLEGAL_REQUEST_CONTRACT` при формировании счета на оплату](billing/known-issues/illegal-request-contract.md)

 - [В консоли недоступны закрывающие документы](billing/known-issues/closing-documents-unavailable.md)

 - [С баланса платежного аккаунта списываются средства за неиспользуемые ресурсы](billing/known-issues/billing-account-is-charged-by-unused-resources.md)

 - [Деньги долго не приходят на баланс после платежа переводом с расчетного счета для юридических лиц](billing/known-issues/recover-lost-payment.md)

 - [Устранение ошибки `Приглашение не найдено` при подключении к партнерской программе](billing/known-issues/cannot-access-partner-programme.md)

 - [Могут ли ресурсы удалиться при неоплате](billing/known-issues/cloud-and-files-removal.md)

 - [Устранение ошибки `balance.WRONG.ACCOUNT`](billing/known-issues/balance-wrong-account-issue.md)

 - [Платежный аккаунт находится в статусе `PAYMENT_NOT_CONFIRMED`](billing/known-issues/payment-not-confirmed-issue.md)

 - [Облако зависло в статусе `CREATING` или долго не создается](billing/known-issues/cloud-stuck-in-creating-status.md)

 - [Документы перестали поступать в систему ЭДО](billing/known-issues/no-new-incoming-documents-in-edi.md)

 - [Устранение ошибки `PROHIBITED_BILLING_ACCOUNT_USAGE_STATUS`](billing/known-issues/error-prohibited-user-account-usage-status.md)
 ...
 - [Как сформировать счет на оплату](billing/how-to/generating-invoice.md)

 - [Как вернуть деньги](billing/how-to/getting-refund.md)
 ...
 - [Как изменить форму и данные в выставляемых счетах на оплату](billing/how-to/edit-invoice-template-or-content.md)
 ...
 - [Как получить акт сверки](billing/how-to/getting-reconcillation-report.md)

 - [Как получить закрывающие документы](billing/how-to/getting-reporting-docs.md)

 - [Как изменить адрес электронной почты](billing/how-to/change-email.md)

 - [Какой формат закрывающих документов в ЭДО](billing/how-to/closing-documents-format.md)

 - [Какой лимит отрицательного баланса при оплате банковским переводом](billing/how-to/overdraft-while-transferring.md)

 - [До какой даты вносить оплату](billing/how-to/deadline-for-paymens.md)

 - [Как получать чеки при совершении платежа с банковской карты](billing/how-to/getting-invoices-when-paying-by-card.md)

 - [Как привязать облако к другому платежному аккаунту](billing/how-to/move-cloud-between-billing-accounts.md)

 - [Как получить оригинал договора](billing/how-to/getting-contract-originals.md)

 - [Как отвязать банковскую карту от платежного аккаунта](billing/how-to/unpin-card.md)
...
## Compute Cloud
 ...
 - [Устранение ошибки `Not enough resources` при запуске виртуальной машины](compute/known-issues/not-enough-resources.md)

 - [Восстановление доступа к виртуальной машине с утерянным SSH-ключом](compute/known-issues/restore-access-to-vm.md)

 - [Устранение проблем с созданием снимков дисков](compute/known-issues/snapshots-creation-issue.md)

 - [Не увеличился размер загрузочного диска](compute/known-issues/disk-volume-did-not-increase.md)

 - [Виртуальная машина выключается операцией `Instance guest stop processing`](compute/known-issues/instance-guest-stop-processing.md)

 - [Устранение ошибки `WARNING REMOTE HOST IDENTIFICATION HAS CHANGED`](compute/known-issues/warning-remote-host-identification-has-changed.md)

 - [Устранение поломки нереплицируемого диска](compute/known-issues/non-replicated-disk-broke-down.md)

 - [Устранение проблем при подключении к Kosmos VM](compute/known-issues/kosmos-vm-connection-issues.md)

 - [Устранение проблем со сбросом пароля для виртуальной машины на базе образа Kosmos](compute/known-issues/kosmos-vm-password-reseting-issue.md)

 - [Устранение ошибки `The limit on maximum number of cores has exceeded`](compute/known-issues/the-limit-on-maximum-number-of-cores-has-exceeded.md)

 - [Недоступна CUDA на платформе GPU](compute/known-issues/cuda-unavailable.md)

 - [Устранение проблем с производительностью дискового и сетевого ввода-вывода на виртуальной машине](compute/known-issues/throttling-and-vm-perfomance-issues.md)

 - [Устранение ошибки `FAILED_PRECONDITION Relocation to zone `ru-central1-a/b/c` is disabled`](compute/known-issues/failed-precondition-relocation-to-zone-is-disabled.md)
 ...
 - [Как настроить GUI и графическое окружение на виртуальных машинах с Linux](compute/how-to/access-gui-and-xorg-on-linux-vm.md)

 - [Как использовать ISO-образ для развертывания виртуальных машин](compute/how-to/using-iso-to-deploy-vm-is-not-supported.md)
 ...
 - [Как подключиться по SSH от root с x или ключом](compute/how-to/ssh-root-authorization.md)

 - [Как отслеживать объем потребляемой памяти](compute/how-to/ram-monitoring.md)

 - [Как читать график `Connections quota utilization`](compute/how-to/connections-quota-utilization.md)

 - [Как узнать скорость доступа к дискам виртуальной машины](compute/how-to/disk-access-speed.md)

 - [Как создать виртуальную машину с доступом по паролю](compute/how-to/create-password-protected-vm.md)
...
## DataLens
 ...
 - [Как восстановить сломанный датасет](datalens/how-to/restoring-dataset.md)

 - [Как восстановить удаленные объекты](datalens/how-to/restoring-deleted-objects.md)

 - [С каких IP-адресов происходит подключение к внешним источникам данных](datalens/how-to/ip-address-range.md)
 ...
 - [Устранение ошибки `ERR.DS_API.REQUEST_TIMEOUT`](datalens/known-issues/err-ds-api-request-timeout.md)
 ...
 - [Устранение ошибки `ERR.DS_API.FORMULA.TRANSLATION.DATA_TYPE`](datalens/known-issues/err-ds-api-formula-translation-data-type.md)

 - [Устранение проблем с доступом к дашборду со статистикой подкастов в Яндекс Музыке](datalens/known-issues/yandex-music-stats-dashboard-issue.md)

 - [Устранение ошибки `ERR.DS_API.FORMULA.VALIDATION.AGG.INCONSISTENT`](datalens/known-issues/error-ds-api-formula-validation-agg-inconsistent.md)
 ...
 - [Устранение ошибки `ERR.DS_API.FORMULA.VALIDATION.AGG.INCONSISTENT - Inconsistent aggregation among operands`](datalens/known-issues/err-ds-api-formula-validation-agg-inconsistent.md)
...
## Managed Service for Kubernetes
 ...
 - [Кластер слишком долго находится в состоянии `STARTING`](managed-kubernetes/known-issues/cluster-stuck-in-starting-state.md)
...
## Legal
 ...
 - [Все решения для Legal](legal/index.md)

 - [Решения для известных проблем Legal](legal/known-issues/index.md)
...
## Object Storage
 ...
 - [Устранение ошибок доступа к бакету с назначенной политикой безопасности](storage/known-issues/unable-to-access-bucket-with-assigned-policy.md)

 - [Устранение ошибки `The request signature we calculated does not match the signature you provided.`](storage/known-issues/the-request-signature-we-calculated-does-not-match.md)
 ...
 - [Устранение ошибки сертификата](storage/known-issues/wrong-certificate.md)
 ...
 - [Как изменить класс хранения](storage/how-to/change-storage-class.md)
...
## VPC
 ...
 - [Устранение ошибок при установке TLS-соединений на ВМ](vpc/known-issues/resolving-tls-traffic-issues.md)

 - [Не удаляется группа безопасности](vpc/known-issues/security-group-cannot-be-deleted.md)

 - [Устранение проблем с отправкой писем по SMTP со внешних IP-адресов](vpc/known-issues/issues-with-outgoing-emails-on-external-ips.md)
 ...
 - [Перенос внешнего статического IP-адреса в другое облако](vpc/how-to/move-external-ip-between-cloud.md)

 - [Как получить входящий или исходящий трафик ВМ](vpc/how-to/incoming-and-outcoming-traffic-logs.md)

 - [Как изменить сеть или подсеть для MDB-кластера](vpc/how-to/changing-net-or-subnet.md)

 - [Как читать график `Connections quota utilization`](vpc/how-to/connections-quota-utilization.md)

 - [Как привязать фиксированный IP-адрес к NAT-шлюзу](vpc/how-to/link-ip-address-to-nat-gateway.md)
 ...
 - [Как использовать отказоустойчивый VPN или NGWF](vpc/how-to/using-failsafe-vpn.md)

 - [Как вернуть IP-адрес](vpc/how-to/restore-ip-address.md)

 - [В чем различие между NAT-шлюзом и NAT-инстансом](vpc/how-to/difference-nat-gateway-and-nat-instance.md)

 - [Как перенести IP в другую зону доступности](vpc/how-to/transferring-ip-to-a-different-zone.md)
...
## Partner
 ...
 - [Все решения для Partner](partner/index.md)

 - [Решения для известных проблем c Partner](partner/known-issues/index.md)

 - [Устранение ошибки `Приглашение не найдено` при подключении к партнерской программе](partner/known-issues/cannot-access-partner-programme.md)

 - [Примеры конфигураций и сценариев Partner](partner/how-to/index.md)