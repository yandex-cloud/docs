...
Ошибка может возникать из-за неподдерживаемого кодека файла, отправленного на распознание. Для формата медиаконтейнера OGG сервис поддерживает только [кодек Opus]({{ link-docs-ai }}/speechkit/formats).
