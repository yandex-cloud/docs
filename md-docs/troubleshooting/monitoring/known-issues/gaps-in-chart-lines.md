[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [Monitoring](../index.md) > Графики мониторинга имеют разрывы и пустоты при нормальной работе облачных ресурсов
...
Вы можете отключить прореживание при просмотре графика в сервисе Monitoring. Для этого выполните следующие действия:

1. Перейдите в раздел **Мониторинг** со страницы интересующего вас облачного ресурса.

1. Нажмите на кнопку **Открыть в Мониторинге** в правом верхнем углу страницы:
...
1. Перейдите на вкладку **Прореживание** и выберите для поля **Метод** значение **Без прореживания**:
