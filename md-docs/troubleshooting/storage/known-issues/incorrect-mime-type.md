[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [Object Storage](../index.md) > Устранение проблем с некорректным MIME-типов объектов при их загрузке в Object Storage
...
* Возникают ошибки при обращении к объектам, загруженным в Object Storage, например, не отображаются картинки, не работают скрипты;
* В JavaScript-консоли браузера отображаются ошибки о некорректных MIME-типах объектов, загружаемых из бакета.

## Решение {#issue-resolution}

Object Storage сообщает для загруженных в бакеты объектов тот `Content-Type`, который был указан при их загрузке.
...
1. Идентификатор бакета в Object Storage.
