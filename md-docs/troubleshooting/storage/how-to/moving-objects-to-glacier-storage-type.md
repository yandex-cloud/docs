[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [Object Storage](../index.md) > Как перенести данные из бакета Object Storage в ледяное хранилище
...
- Установка жизненного цикла утилитой AWS CLI
    ...
    1. Создайте жизненный циклю с типом `transition` из веб-интерфейса [Консоли управления](https://console.yandex.cloud).
