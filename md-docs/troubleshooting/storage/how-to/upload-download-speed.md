[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [Object Storage](../index.md) > Как узнать скорость загрузки и скачивания данных
...
Object Storage имеет внутренние [Соглашения об уровне обслуживания](../../../glossary/sla.md) (*SLA*) на обеспечение скорости отправки данных клиенту, которые, в том числе, зависят от класса хранения.

Время ответа Object Storage зависит от следующих факторов:
