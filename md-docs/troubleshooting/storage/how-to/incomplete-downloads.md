[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [Object Storage](../index.md) > Как просматривать и удалять незавершенные загрузки
...
* В [Консоли управления](https://console.yandex.cloud) отображается незавершенная загрузка;
