[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [Object Storage](../index.md) > Примеры конфигураций и сценариев Object Storage
...
* [Как настроить заголовки кеширования `Cache-Control` для объектов в бакете при HTTP-запросах](configure-cache-headings-with-http-queries.md)
