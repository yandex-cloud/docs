# Решения для {{ objstorage-name }}

## Примеры конфигураций и сценариев {{ objstorage-name }} {#configuration-examples}
...
* [Как перенести данные из бакета {{ objstorage-name }} в ледяное хранилище](how-to/moving-objects-to-glacier-storage-type.md)
...
* [Как работать напрямую с API {{ objstorage-name }} без использования SDK](how-to/curl-api-request-example.md)
...
* [Устранение ошибки доступа к бакетам S3 из кластера {{ dataproc-name }} 1.4](known-issues/cannot-access-buckets.md)
...
* [Устранение проблем с некорректным MIME-типов объектов при их загрузке в {{ objstorage-name }}](known-issues/incorrect-mime-type.md)
