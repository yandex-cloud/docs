[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [Certificate Manager](../index.md) > Устранение проблем с получением и обновлением сертификатов от Let's Encrypt
...
* При попытке выпуска нового или обновления существующего сертификата от Let's Encrypt в интерфейсе Certificate Manager сертификат переходит в один из статусов:
