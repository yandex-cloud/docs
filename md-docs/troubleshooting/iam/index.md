...
* [Устранение ошибок при назначении роли `resource-manager.clouds.owner` пользователю облака](known-issues/resource-manager-clouds-owner-is-only-applicable-to-resources-of-type-resource-manager-cloud.md)
...
* [Пользователь не видит приглашение в организацию или роль `admin`](known-issues/invitation-or-admin-role-not-seen.md)
