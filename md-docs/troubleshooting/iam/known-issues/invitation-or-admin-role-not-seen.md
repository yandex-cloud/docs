...
Например, можно [назначить](../../../iam/operations/roles/grant.md#access-to-user) пользователю роль `{{ roles-cloud-member }}` на облако, а на каталог выдать `{{ roles-admin }}`. Если нужен доступ на просмотр всех облаков, то можно [выдать одну роль](../../../iam/security/index.md#cloud-member) `{{ roles-cloud-member }}` на уровне организации и последующий гранулярный доступ в нужных облаках или каталогах.
