[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [Identity and Access Management](../index.md) > Устранение ошибок при работе с приглашениями в облачную организацию
...
Подробнее о порядке действий по удалению и созданию нового приглашения мы пишем в разделе [**Пользователи с аккаунтом на Яндексе**](../../../organization/operations/add-account.md#useraccount) в документации сервиса Yandex Identity Hub.
