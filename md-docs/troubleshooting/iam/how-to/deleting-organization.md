[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [Identity and Access Management](../index.md) > Как удалить организацию
...
Перед удалением организации проверьте список облаков в организации, перейдя на страницу [по этой ссылке](https://org.yandex.cloud/). 
...
В этом материале идет речь об удалении организаций Yandex Cloud. Если вас интересует удаление организации Яндекс 360, воспользуйтесь инструкцией [по этой ссылке](https://yandex.ru/support/business/delete-organisation.html).
...
1. В правом верхнем углу страницы нажмите кнопку **Удалить**.

   ![screen01](../../../_assets/troubleshooting/iam/how-to/deleting-organization/screen01.png)

1. В открывшемся окне выберите срок удаления организации. По умолчанию удаление организации происходит через 7 суток с нажатия кнопки **Удалить**.
