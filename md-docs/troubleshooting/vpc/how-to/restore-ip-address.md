[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [VPC](../index.md) > Как вернуть IP-адрес

# Как воcстановить случайно удаленный внешний IP-адрес для ВМ или балансировщика
