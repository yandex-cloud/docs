[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [VPC](../index.md) > Как осуществить маршрутизацию трафика между двумя облачными сетями

# Как осуществить маршрутизацию трафика между двумя облачными сетями
