[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [VPC](../index.md) > Перенос внешнего статического IP-адреса в другое облако
...
Для того, чтобы выполнить непосредственно перенос адреса, понадобится [создать два запроса в техническую поддержку](https://center.yandex.cloud/support): один из облака-источника, откуда будет переноситься адрес, второй из облака-приемника — куда будет переноситься адрес.
