[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [VPC](../index.md) > Как заблокировать IP-адрес
...
Запретить один конкретный IP-адрес со стороны Yandex Cloud не получится. Сервис групп безопасности использует политику «запрещено все, что не разрешено явно». Это происходит потому, что в конце списка правил группы безопасности всегда неявно присутствует правило «запретить все».
