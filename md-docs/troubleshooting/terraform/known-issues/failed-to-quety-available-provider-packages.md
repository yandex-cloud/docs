...
1. [Сконфигурировать Terraform по следующей инструкции](../../../tutorials/infrastructure-management/terraform-quickstart.md#configure-provider).
1. Перейти в каталог с кодом Terraform-манифестов.
