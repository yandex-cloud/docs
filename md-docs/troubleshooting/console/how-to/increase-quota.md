[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [Cloud Console](../index.md) > Как увеличить квоты
...
* [Запросите увеличение квот](https://console.yandex.cloud/cloud?section=quotas) из [Консоли управления](https://console.yandex.cloud);
* [Создайте запрос в техническую поддержку](https://center.yandex.cloud/support) и уточните, какие потребляемые квоты нужно увеличить и на сколько, а также опишите планируемый сценарий использования.
