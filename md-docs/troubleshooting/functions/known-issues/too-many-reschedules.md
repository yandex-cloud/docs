...
При вызове функции Cloud Functions код функции не выполняется, а в логе функции появляется сообщение:
...
Оптимальным решением проблемы будет переработать код функции для соответствия требованиям среды выполнения Cloud Functions.
