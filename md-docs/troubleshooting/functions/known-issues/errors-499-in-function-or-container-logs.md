...
- [логирование выполнения функций на Python](../../../functions/lang/python/logging.md),
- [запись логов в журнал выполнения функции](../../../functions/operations/function/logs-write.md).
...
1. Идентификатор облачной функции или контейнера Serverless Containers.
1. Содержимое журнала работы облачной функции или контейнера. Журналы работы функции доступны в разделе **Логи** на странице функции в [Консоли управления](https://console.yandex.cloud).