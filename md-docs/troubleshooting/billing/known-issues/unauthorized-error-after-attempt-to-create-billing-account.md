...
Чтобы создать платежный аккаунт, необходима роль владельца организации `organization-manager.organizations.owner`.

Вы можете попросить владельца также [выдать вам роль](../../../iam/operations/roles/grant.md) `organization-manager.organizations.owner` либо [создать новую организацию](../../../organization/operations/enable-org.md), [перейти в нее](../../../organization/operations/manage-organizations.md#switch-to-another-org) и [создать в ней платежный аккаунт](../../../billing/operations/create-new-account.md).
