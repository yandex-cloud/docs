[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [Yandex Cloud Billing](../index.md) > Устранение проблем с привязкой банковской карты к платежному аккаунту
...
* Не получается привязать карту в [Консоли управления](https://console.yandex.cloud/settings);
...
- Мобильное приложение
    ...
    Добавьте карту в [Консоли управления Yandex Cloud](https://console.yandex.cloud), после чего совершите оплату через мобильное приложение.
...
1. Идентификатор платежного аккаунта, к которому не получается привязать банковскую карту. Он имеет вид `d2n*****************`. Этот идентификатор можно найти [на странице с данными по платежному аккаунту](https://center.yandex.cloud/billing/accounts).
