[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [Yandex Cloud Billing](../index.md) > Какой формат закрывающих документов в ЭДО
...
Подробнее пишем по [ссылке](../../../billing/concepts/edo.md).