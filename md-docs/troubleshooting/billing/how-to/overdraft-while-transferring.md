[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [Yandex Cloud Billing](../index.md) > Какой лимит отрицательного баланса при оплате банковским переводом
...
При оплате через банковский перевод не устанавливается лимит отрицательного баланса. Приостановка сервисов производится только в том случае, если долг [не был погашен в установленные договором сроки](https://yandex.ru/legal/cloud_oferta/?lang=ru):
...
Порядок расчетов описан в разделе 6 [Оферты](https://yandex.ru/legal/cloud_oferta/?lang=ru) и в нашей [документации](../../../billing/payment/billing-cycle-business.md).