[Документация Yandex Cloud](../../../index.md) > [Все решения](../../index.md) > [Yandex Cloud Billing](../index.md) > Как сменить владельца аккаунта для юридических лиц
...
- Если есть доступ к аккаунту
    ...
    1. Запросить у [технической поддержки](https://center.yandex.cloud/support) шаблон документа, подписать его, поставить печать и прислать скан-копию в ответном письме.
