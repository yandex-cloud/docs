[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Detection and Response](../../index.md) > [Пошаговые инструкции](../index.md) > [Расследования](index.md) > Управление расследованиями
