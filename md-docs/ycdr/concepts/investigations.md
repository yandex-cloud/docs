[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Detection and Response](../index.md) > [Концепции](index.md) > Расследования
...
_Расследование_ — это основная сущность для анализа событий безопасности в Yandex Cloud Detection and Response. Расследование объединяет один или несколько запросов, которые позволяют искать и анализировать события за последние 90 дней.
...
## Связь с инстансом YCDR {#instance-binding}

Расследования привязаны к [инстансу](index.md) YCDR. Каждый инстанс содержит собственный набор расследований, шаблонов и датасетов. Расследования могут быть доступны:
...
Доступ к расследованиям определяется ролями. Подробнее в разделе [Управление доступом в YCDR](../security/index.md).
...
* [Управление доступом в YCDR](../security/index.md).