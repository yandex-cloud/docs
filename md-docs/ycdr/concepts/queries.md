[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Detection and Response](../index.md) > [Концепции](index.md) > Запросы
...
Для поиска событий в Yandex Cloud Detection and Response используется подмножество языка запросов [KQL (Kusto Query Language)](../kql-reference.md). KQL позволяет фильтровать, агрегировать и анализировать события безопасности за последние 90 дней.
...
* [Как начать работать с расследованиями](../quickstart.md).
