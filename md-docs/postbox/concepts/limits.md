...
|| Максимальная частота вызовов метода [SendBulkEmail](../operations/send-bulk-email.md) в одном облаке
...
Для метода [SendBulkEmail](../operations/send-bulk-email.md) действуют следующие лимиты:
