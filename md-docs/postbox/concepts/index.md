...
Yandex Cloud Postbox — это сервис электронной почты, который предоставляет простой и экономичный способ отправки писем с пользовательских [адресов](glossary.md#address) и позволяет гибко настроить [уведомления](notification.md) о доставке писем.
...
* Проверять обработку разных результатов доставки писем с помощью [симулятора доставки](mail-simulator.md).
