...
- Консоль управления {#console}
  ...
  1. Чтобы открыть корневую директорию БД, перейдите на вкладку **Навигация**.
...
1. Создайте адрес Yandex Cloud Postbox:
    ...
    - Консоль управления {#console}
      ...
      1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором вы создаете инфраструктуру.
      1. [Перейдите](https://console.yandex.cloud/link/postbox) в сервис **Cloud Postbox** и нажмите кнопку **Создать адрес**.
      ...
      1. В поле **Настройка подписи писем (DKIM)** выберите `Расширенная`.
...
* Значение — содержимое поля **Значение** из блока **Настройка подписи писем (DKIM)** на странице адреса в Yandex Cloud Postbox.

Если вы делегировали домен Yandex Cloud DNS:
