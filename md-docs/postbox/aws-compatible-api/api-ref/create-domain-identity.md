[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Postbox](../../index.md) > [Справочник API](../index.md) > [REST](index.md) > Адреса > Метод CreateDomainIdentity
...
Необязательное поле. Длина ключа RSA, который Yandex Cloud Postbox сгенерирует при простой настройке DKIM-подписи (Easy DKIM). Возможные значения:
