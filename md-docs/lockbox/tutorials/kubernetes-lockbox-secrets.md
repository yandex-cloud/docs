...
* Секрет Yandex Lockbox: количество хранимых версий секрета и запросы к ним ([тарифы Yandex Lockbox](../pricing.md)).
...
- Вручную {#manual}
  ...
  1. [Создайте секрет](../operations/secret-create.md) Yandex Lockbox со следующими параметрами:
     * **Имя** — `lockbox-secret`.
