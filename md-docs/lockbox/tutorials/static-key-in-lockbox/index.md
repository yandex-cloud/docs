[Документация Yandex Cloud](../../../index.md) > [Yandex Lockbox](../../index.md) > [Практические руководства](../index.md) > Хранение статического ключа доступа в секрете Yandex Lockbox > Обзор
...
В данном руководстве рассматривается сценарий, при котором в качестве хранилища для статического ключа доступа используется [секрет](../../concepts/secret.md) Yandex Lockbox. При этом значение ключа доступа не только не хранится локально на компьютере пользователя, но и не выводится на экран.
