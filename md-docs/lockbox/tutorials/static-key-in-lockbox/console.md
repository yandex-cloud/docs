[Документация Yandex Cloud](../../../index.md) > [Yandex Lockbox](../../index.md) > [Практические руководства](../index.md) > [Хранение статического ключа доступа в секрете Yandex Lockbox](index.md) > CLI
...
- Yandex Cloud CLI {#cli}
  ...
  1. Аналогичным способом назначьте сервисному аккаунту [роль](../../security/index.md#lockbox-payloadViewer) `lockbox.payloadViewer` на каталог:
...
1. [Удалите](../../operations/secret-delete.md) секрет.
