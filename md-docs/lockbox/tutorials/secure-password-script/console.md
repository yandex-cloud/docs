[Документация Yandex Cloud](../../../index.md) > [Yandex Lockbox](../../index.md) > [Практические руководства](../index.md) > [Безопасная передача пароля в скрипт инициализации](index.md) > Консоль управления, CLI, API
