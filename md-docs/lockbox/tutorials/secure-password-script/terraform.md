...
* плата за использование [секрета](../../concepts/secret.md) (см. [тарифы {{ lockbox-name }}](../../pricing.md)).
...
1. Подготовьте файлы с описанием инфраструктуры:
   ...
   * [Версия секрета](../../concepts/secret.md#version) — [yandex_lockbox_secret_version_hashed]({{ tf-provider-resources-link }}/lockbox_secret_version_hashed).
