...
* [секреты](../concepts/secret.md) {{ lockbox-name }} для безопасного хранения и доставки чувствительных данных в приложение;
...
* плата за хранение секрета (см. [тарифы {{ lockbox-full-name }}](../pricing.md));
...
1. [Удалите](../operations/secret-delete.md) секрет {{ lockbox-name }}.
