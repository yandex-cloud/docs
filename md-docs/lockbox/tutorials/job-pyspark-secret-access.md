[Документация Yandex Cloud](../../index.md) > [Yandex Lockbox](../index.md) > [Практические руководства](index.md) > Использование секрета в PySpark-задании для подключения к Yandex Managed Service for PostgreSQL
...
* Кластер Managed Service for Apache Spark™: выделенные хостам вычислительные ресурсы ([тарифы Managed Service for Apache Spark™](../../managed-spark/pricing.md)).
...
- Консоль управления {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором создана необходимая инфраструктура.
  1. [Перейдите](https://console.yandex.cloud/link/managed-postgresql) в сервис **Managed Service for&nbsp;PostgreSQL**.
  1. Нажмите на имя нужного кластера, затем выберите ![chevron-down](../../_assets/console-icons/chevron-down.svg) **Другое** → **Пользователи**.
