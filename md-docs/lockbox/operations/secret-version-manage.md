...
- Консоль управления {#console}
    ...
    1. (Опционально) Чтобы изменить другие параметры, нажмите **Редактировать секрет** и укажите:
...
- Консоль управления {#console}
    ...
    1. Нажмите на имя нужного секрета.
    1. В разделе **Версии**, напротив нужной версии нажмите ![image](../../_assets/console-icons/ellipsis.svg).
    1. Выберите пункт **Сделать текущей версией**.
    1. Нажмите кнопку **Сделать текущей версией**.
