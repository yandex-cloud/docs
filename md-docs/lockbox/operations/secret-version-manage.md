...
- {{ TF }} {#tf}
    ...
    Проверить появление секрета и его содержимое можно в [консоли управления]({{ link-console-main }}) или с помощью команды [CLI](../../cli/index.md):
...
- Консоль управления {#console}
    ...
    1. Нажмите кнопку **{{ ui-key.yacloud.lockbox.ScheduleDestructionFormDialog.button_schedule-destruction }}**.
