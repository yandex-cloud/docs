[Документация Yandex Cloud](../../../../index.md) > [Yandex Lockbox](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Secret](index.md) > ListAccessBindings

# Lockbox API, gRPC: SecretService.ListAccessBindings
