[Документация Yandex Cloud](../../../../index.md) > [Yandex Lockbox](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Secret](index.md) > UpdateAccessBindings

# Lockbox API, gRPC: SecretService.UpdateAccessBindings
