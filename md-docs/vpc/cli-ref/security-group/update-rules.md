...
|| `--delete-rule-id` | `value[,value]`

List of rules IDs to delete ||
|| `--add-rule` | `PROPERTY=VALUE[,PROPERTY=VALUE...]`
 ...
 * [Добавить новое правило в группу безопасности](../../operations/security-group-add-rule.md#cli_1)
 * [Удалить правило из группы безопасности](../../operations/security-group-delete-rule.md#cli_1)