...
To get folder ID use a [yandex.cloud.resourcemanager.v1.FolderService.List](../../../../resource-manager/api-ref/grpc/Folder/list.md#List) request. ||
|| name | **string**
...
A Subnet resource. For more information, see [Subnets](../../../concepts/network.md#subnet).
