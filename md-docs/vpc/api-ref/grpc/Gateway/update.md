[Документация Yandex Cloud](../../../../index.md) > [Yandex Virtual Private Cloud](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Gateway](index.md) > Update
...
To get the gateway ID make a [GatewayService.List](list.md#List) request.
...
1. Get the current set of labels with a [GatewayService.Get](get.md#Get) request.
