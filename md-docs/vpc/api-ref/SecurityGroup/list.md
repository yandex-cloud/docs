[Документация Yandex Cloud](../../../index.md) > [Yandex Virtual Private Cloud](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [SecurityGroup](index.md) > List
...
is larger than [ListNetworksRequest.pageSize](../Network/list.md#yandex.cloud.vpc.v1.ListNetworksRequest), use
the `nextPageToken` as the value
for the [ListNetworksRequest.pageToken](../Network/list.md#yandex.cloud.vpc.v1.ListNetworksRequest) query parameter
