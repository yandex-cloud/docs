[Документация Yandex Cloud](../../../index.md) > [Yandex Virtual Private Cloud](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Subnet](index.md) > Update
...
## Body parameters {#yandex.cloud.vpc.v1.UpdateSubnetRequest}
