[Документация Yandex Cloud](../../index.md) > [Yandex Virtual Private Cloud](../index.md) > Рекомендации > Использование публичных IP-адресов
...
Подробнее:
* [Настроить хостинг](../../storage/operations/hosting/setup.md).
