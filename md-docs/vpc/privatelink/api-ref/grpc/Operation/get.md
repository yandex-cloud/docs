[Документация Yandex Cloud](../../../../../index.md) > [Yandex Virtual Private Cloud](../../../../index.md) > Справочник API > gRPC (англ.) > [Virtual Private Cloud API](../index.md) > [Operation](index.md) > Get
