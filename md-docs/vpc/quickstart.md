...
Зарезервированный статический публичный IP-адрес оплачивается, даже если он не привязан к ВМ. Подробнее см. в разделе [Правила тарификации для Virtual Private Cloud](pricing.md).
