[Документация Yandex Cloud](../../index.md) > [Yandex Virtual Private Cloud](../index.md) > [Пошаговые инструкции](index.md) > Подсеть > Перенести подсеть между каталогами
...
- Консоль управления {#console}
  ...
  1. Нажмите значок ![image](../../_assets/console-icons/ellipsis.svg) в строке нужной подсети и выберите **Переместить**.
...
- CLI {#cli}
  ...
  1. Переместите подсеть, указав имя или идентификатор подсети и каталога назначения:
     ...
     ```text
      ...
      dhcp_options: {}
     ```
     Подробнее о команде `yc vpc subnet move` в [справочнике CLI](../../cli/cli-ref/vpc/cli-ref/subnet/move.md).
