[Документация Yandex Cloud](../../index.md) > [Yandex Virtual Private Cloud](../index.md) > [Пошаговые инструкции](index.md) > Статическая маршрутизация > Создать статический маршрут
...
- Консоль управления {#console}
  ...
  1. Укажите **Next hop** — IP-адрес из [разрешенных диапазонов](../concepts/network.md#subnet) или выберите **Шлюз** из списка.
  ...
  1. В строке нужной подсети нажмите значок ![image](../../_assets/console-icons/ellipsis.svg) и выберите пункт **Привязать таблицу маршрутизации**.
