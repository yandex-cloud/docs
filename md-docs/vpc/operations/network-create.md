...
- Terraform {#tf}
  ...
  1. Опишите в конфигурационном файле параметры [облачной сети](../concepts/network.md):
     ...
     * `labels` — [метки](../../resource-manager/concepts/labels.md) для облачной сети. Укажите пару ключ-значение.
     ...
     Более подробную информацию о параметрах ресурса `vpc_network` в Terraform см. в [документации провайдера](../../terraform/resources/vpc_network.md).
...
- Terraform {#tf}
  ...
  1. Опишите в конфигурационном файле параметры создаваемой облачной сети:
     ...
     Более подробную информацию о параметрах ресурсов в Terraform см. в [документации провайдера](../../terraform/resources/vpc_network.md).
