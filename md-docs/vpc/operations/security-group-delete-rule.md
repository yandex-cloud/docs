[Документация Yandex Cloud](../../index.md) > [Yandex Virtual Private Cloud](../index.md) > [Пошаговые инструкции](index.md) > Группы безопасности > Удалить правило
...
- Консоль управления {#console}
  ...
  1. В блоке **Правила для входящего трафика** или **Правила для исходящего трафика** нажмите значок ![image](../../_assets/console-icons/ellipsis.svg) в строке правила, которое требуется удалить.
