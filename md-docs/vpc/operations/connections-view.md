...
- Консоль управления {#console}
  ...
  1. [Перейдите](../../console/operations/select-service.md#select-service) в нужный сервис, например, **Compute Cloud** для виртуальной машины или **Yandex Data Processing** для кластера.
