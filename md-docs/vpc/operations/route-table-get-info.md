[Документация Yandex Cloud](../../index.md) > [Yandex Virtual Private Cloud](../index.md) > [Пошаговые инструкции](index.md) > Статическая маршрутизация > Получить информацию о таблице маршрутизации
...
- CLI {#cli}
  ...
  1. Получите информацию о таблице маршрутизации, указав ее имя или идентификатор:
     ...
     Где `<имя_таблицы_маршрутизации>` — имя или идентификатор таблицы маршрутизации.
...
- Terraform {#tf}
  ...
  1. Примените конфигурацию:
     ...
     Terraform отобразит значения выходных переменных в терминале. Чтобы проверить результат, выполните команду:
