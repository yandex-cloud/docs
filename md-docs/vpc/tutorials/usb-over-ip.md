...
Создайте [группу безопасности](../concepts/security-groups.md) `vpn-sg` для виртуальной машины – сервера VPN.
...
Чтобы VPN-соединение не перестало работать в случае остановки и повторного запуска VPN-сервера, [сделайте](../operations/set-static-ip.md) IP-адрес вашего VPN-сервера статическим.
