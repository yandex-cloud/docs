...
Создайте [облачную сеть](../../concepts/network.md), в которой будет размещена ВМ.
...
- API {#api}
  ...
  Чтобы создать облачную сеть, воспользуйтесь методом REST API [create](../../api-ref/Network/create.md) для ресурса [Network](../../api-ref/Network/index.md) или вызовом gRPC API [NetworkService/Create](../../api-ref/grpc/Network/create.md).
...
Зарезервируйте статический [публичный IP-адрес](../../concepts/address.md#public-addresses) для ВМ, на которой будет установлено приложение.
...
* [IP-адрес](../../concepts/address.md#public-addresses);
* [таблица маршрутизации](../../concepts/routing.md#rt-vm);
* [группа безопасности](../../concepts/security-groups.md);
...
* [Удалите](../../operations/delete-route-table.md) таблицу маршрутизации.
* [Удалите](../../../iam/operations/sa/delete.md) сервисный аккаунт.
* [Удалите](../../operations/address-delete.md) статический публичный IP-адрес.
* [Удалите](../../operations/network-delete.md) облачную сеть.