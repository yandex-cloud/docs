...
В этом примере вы создадите защищенный туннель по протоколу GRE поверх IPsec между двумя виртуальными маршрутизаторами [Cisco CSR 1000v](https://yandex.cloud/ru/marketplace/products/yc/cisco-csr), расположенными в Yandex Cloud в разных [виртуальных сетях](../concepts/network.md) и [зонах доступности](../../overview/concepts/geo-scope.md). 
...
* плата за использование внешнего IP-адреса (см. [тарифы Yandex Virtual Private Cloud](../pricing.md#prices-public-ip)).
