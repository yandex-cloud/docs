...
На этой странице рассказано, как подключить модули и использовать их для создания тестовой инфраструктуры: [облачной сети](../concepts/network.md#network) с тремя [подсетями](../concepts/network.md#subnet) [{{ vpc-full-name }}](../index.md) и [кластера {{ managed-k8s-full-name }}](../../managed-kubernetes/concepts/index.md#kubernetes-cluster).
...
* Плата за использование динамических [публичных IP-адресов](../concepts/address.md#public-addresses) (см. [тарифы {{ vpc-name }}](../pricing.md#prices-public-ip)).
...
1. Подтвердите создание ресурсов: введите в терминал слово `yes` и нажмите **Enter**.
   ...
   {{ TF }} создаст все требуемые ресурсы, а в терминале будут указаны [IP-адреса](../concepts/address.md) созданных [виртуальных машин](../../compute/concepts/vm.md). Проверить появление ресурсов и их настройки можно в [консоли управления]({{ link-console-main }}).
...
1. Выполните команду:
   ...
   {{ TF }} удалит все ресурсы, созданные в текущей конфигурации: кластеры, [сети](../concepts/network.md#network), [подсети](../concepts/network.md#subnet), [виртуальные машины](../../compute/concepts/vm.md) и т. д.
