...
* Плата за использование динамических [публичных IP-адресов](../concepts/address.md#public-addresses) (см. [тарифы Virtual Private Cloud](../pricing.md#prices-public-ip)).
