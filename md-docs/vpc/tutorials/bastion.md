...
Создайте [группу безопасности](../concepts/security-groups.md) и настройте правила для входящего трафика на бастионном хосте, чтобы обеспечить к нему доступ из интернета:
...
Для работы бастионному хосту потребуется статический [публичный IP-адрес](../concepts/address.md#public-addresses).
