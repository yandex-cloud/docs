[Документация Yandex Cloud](../../../index.md) > [Yandex Virtual Private Cloud](../../index.md) > [Практические руководства](../index.md) > Настройка сетевых ресурсов и взаимодействие между ними > [Маршрутизация через NAT-инстанс](index.md) > Консоль управления
