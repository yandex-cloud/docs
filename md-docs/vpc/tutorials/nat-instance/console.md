...
1. [Создайте облачную сеть](../../operations/network-create.md), например `my-vpc`.
1. В облачной [сети](../../concepts/network.md#network) [создайте подсети](../../operations/subnet-create.md), например:
