[Документация Yandex Cloud](../../index.md) > [Yandex Virtual Private Cloud](../index.md) > [Практические руководства](index.md) > Подключение к сервисам > Синхронизация топиков Apache Kafka® в Object Storage без использования интернета
...
1. Подготовьте инфраструктуру:
    ...
    - Вручную {#manual}
        ...
        1. [Создайте подсеть](../operations/subnet-create.md) в любой [зоне доступности](../../overview/concepts/geo-scope.md).
