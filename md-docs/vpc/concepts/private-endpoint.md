[Документация Yandex Cloud](../../index.md) > [Yandex Virtual Private Cloud](../index.md) > [Концепции](index.md) > Сервисные подключения
...
| [AI Studio Apps](https://aistudio.yandex.ru/docs/ru/ai-studio/concepts/) | yandex.cloud.ai-studio.apps | Нет | [CLI, Terraform](../operations/private-endpoint-create.md) | `apps.ai.pe.api.cloud.yandex.net` | `apps.ai.api.cloud.yandex.net` |
...
| [Cloud Functions](../../functions/index.md) | yandex.cloud.serverless-functions | Нет | [CLI, Terraform](../operations/private-endpoint-create.md) | `functions.pe.yandexcloud.net` | `functions.yandexcloud.net` |
| Public API Gateway | yandex.cloud.api | Нет | [CLI, Terraform](../operations/private-endpoint-create.md) | `-` | `*.api.cloud.yandex.net` |
