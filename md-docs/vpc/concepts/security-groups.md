...
|-----------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
| [{{ compute-short-name }}](../../compute/index.md)          | [интерфейс ВМ](../../compute/concepts/network.md), [шаблон групп ВМ](../../compute/concepts/instance-groups/instance-template.md#network)       |
| [{{ managed-k8s-name }}](../../managed-kubernetes/index.md) | [кластер](../../managed-kubernetes/concepts/index.md#kubernetes-cluster), [группа узлов](../../managed-kubernetes/concepts/index.md#node-group) |
| [{{ alb-name }}](../../application-load-balancer/index.md)  | [балансировщик](../../application-load-balancer/concepts/application-load-balancer.md#security-groups)                                          |
| [{{ mpg-name }}](../../managed-postgresql/index.md)         | [кластер](../../managed-postgresql/concepts/network.md#security-groups)                                                                         |
| [{{ mch-name }}](../../managed-clickhouse/index.md)         | [кластер](../../managed-clickhouse/concepts/network.md#security-groups)                                                                         |
| [{{ mgp-name }}](../../managed-greenplum/index.md)          | [кластер](../../managed-greenplum/concepts/network.md#security-groups)                                                                          |
| [{{ mmy-name }}](../../managed-mysql/index.md)              | [кластер](../../managed-mysql/concepts/network.md#security-groups)                                                                              |
| [{{ mrd-name }}](../../managed-valkey/index.md)             | [кластер](../../managed-valkey/concepts/network.md#security-groups)                                                                             |
| [{{ mmg-name }}](../../storedoc/index.md)                    | [кластер](../../storedoc/concepts/network.md#security-groups)                                                                                   |
| [{{ mkf-name }}](../../managed-kafka/index.md)              | [кластер](../../managed-kafka/concepts/network.md#security-groups)                                                                              |
| [{{ mos-name }}](../../managed-opensearch/index.md)         | [кластер](../../managed-opensearch/concepts/network.md#security-groups)                                                                         |
| [{{ mtr-name }}](../../managed-trino/index.md)              | [кластер](../../managed-trino/concepts/network.md#security-groups)                                                                              |
| [{{ dataproc-name }}](../../data-proc/index.md)             | [кластер](../../data-proc/concepts/network.md#security-groups)                                                                                  |
| [{{ data-transfer-name }}](../../data-transfer/index.md)    | [эндпоинт](../../data-transfer/concepts/network.md#security-groups)                                                                             |
| [{{ load-testing-name }}](../../load-testing/index.md)      | [агент тестирования](../../load-testing/concepts/agent.md)                                                                                      |
| [{{ mgl-name }}](../../managed-gitlab/index.md)             | [инстанс](../../managed-gitlab/operations/configure-security-group.md)                                                                          |
...
* кластера [{{ mpg-name }}](../../managed-postgresql/index.md).
