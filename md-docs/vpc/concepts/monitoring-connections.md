...
Для обеспечения работы [сетевого балансировщика](../../network-load-balancer/index.md) и [групп безопасности](security-groups.md) {{ vpc-short-name }} использует мониторинг сетевых соединений.
