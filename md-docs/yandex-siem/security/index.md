# Управление доступом в Yandex SIEM
...
* просматривать информацию об [инстансах](../concepts/index.md) Yandex SIEM.
...
* просматривать информацию об [инстансах](../concepts/index.md) Yandex SIEM и версии их компонентов.
