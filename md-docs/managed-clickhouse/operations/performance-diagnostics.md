[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for ClickHouse®](../index.md) > [Пошаговые инструкции](index.md) > Логи и мониторинг > Диагностика производительности

# Диагностика производительности в Managed Service for ClickHouse®
...
Managed Service for ClickHouse® позволяет собирать метрики производительности запросов в кластере. Функциональность доступна с версии ClickHouse® 25.3 и выше.
...
- Консоль управления {#console}
  ...
  Чтобы включить сбор статистики, выберите опцию **Сбор статистики** при [создании](cluster-create.md#create-cluster) или [изменении](update.md) кластера. По умолчанию опция отключена.
