...
Для создания кластера Managed Service for ClickHouse® нужна роль [vpc.user](../../vpc/security/index.md#vpc-user) и роль [managed-clickhouse.editor](../security.md#managed-clickhouse-editor) или выше.
