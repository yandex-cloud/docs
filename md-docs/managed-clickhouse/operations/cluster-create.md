...
- Консоль управления {#console}
  ...
  1. В блоке **Ресурсы**:
      ...
      * Выберите [тип диска](../concepts/storage.md).
        ...
        * Нереплицируемые SSD-диски и сверхбыстрые сетевые SSD-диски с тремя репликами — с шагом 93 ГБ.
  ...
  1. В блоке **Хосты**:
      ...
      * Выберите [сервис координации](../concepts/coordination-system.md) **ClickHouse Keeper (на отдельных хостах)** или **ClickHouse Keeper (встроенный)**.
      ...
      В Production-окружении для кластеров с двумя и более хостами поддерживается только **ClickHouse Keeper (на отдельных хостах)**. Это обеспечивает [высокую доступность](../concepts/high-availability.md) кластера. В Prestable-окружении кластер с **ClickHouse Keeper (встроенный)** может содержать либо один, либо три и более хостов.
