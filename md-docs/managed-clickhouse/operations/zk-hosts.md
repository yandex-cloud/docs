...
* [перенести хосты ZooKeeper в другую зону доступности](host-migration.md#zookeeper-hosts);
...
- CLI {#cli}
  ...
  1. В команде изменения кластера передайте новый класса хоста ZooKeeper, тип диска и размер хранилища:
