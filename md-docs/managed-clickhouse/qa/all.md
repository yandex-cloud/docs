...
В [консоли управления](https://console.yandex.cloud) перейдите на страницу каталога, выберите сервис **Managed Service for&nbsp;ClickHouse** и нажмите на нужный кластер. В правой части экрана вы увидите стоимость использования кластера за месяц. Подробнее в [Правилах тарификации](../../managed-clickhouse/pricing.md).
