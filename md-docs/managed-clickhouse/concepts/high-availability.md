...
В соответствии с [Соглашением об уровне обслуживания (SLA)](https://yandex.ru/legal/cloud_sla_mdb/ru/#klastera-servisa-upravlyaemogo-clickhouse-/-yandex-managed-service-for-clickhouse,-popadayushie-pod-dejstvie-urovnya-obsluzhivaniya), высокодоступным считается кластер с конфигурацией из двух или более хостов ClickHouse®, расположенных в разных [зонах доступности](../../overview/concepts/geo-scope.md).
