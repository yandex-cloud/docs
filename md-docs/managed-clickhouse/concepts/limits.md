...
Все ограничения реализованы на основе [серверных настроек ClickHouse®](https://clickhouse.com/docs/operations/server-configuration-parameters/settings), изменить их нельзя.
