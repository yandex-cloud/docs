...
* Для кластеров с неподдерживаемой версией {{ CH }} создание новых хостов и восстановление из резервных копий недоступно.
* Кластеры с неподдерживаемой версией {{ CH }} будут автоматически обновлены в соответствии с [политикой обновления](#update-policy).
