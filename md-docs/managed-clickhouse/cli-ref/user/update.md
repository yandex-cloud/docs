 ...
 * [Задать настройки ClickHouse® через интерфейсы Yandex Cloud](../../operations/change-query-level-settings.md#cli_1)
 * [Изменить пароль](../../operations/cluster-users.md#cli_3)