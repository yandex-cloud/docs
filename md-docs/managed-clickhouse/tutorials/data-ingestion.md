[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for ClickHouse®](../index.md) > [Практические руководства](index.md) > Ввод данных в системы хранения
...
В этом сценарии [API-шлюз](../../api-gateway/concepts/index.md) принимает входящие данные и отправляет их в [поток данных](../../data-streams/concepts/index.md). В потоке данные буферизируются и передаются с помощью [трансфера](../../data-transfer/concepts/index.md) в кластер баз данных [ClickHouse®](../concepts/index.md).
...
1. Укажите настройки кластера ClickHouse®:
    ...
    1. В блоке **Хосты** нажмите значок ![pencil](../../_assets/pencil.svg). Включите опцию **Публичный доступ** и нажмите кнопку **Сохранить**.
        ...
        {% endnote %}
    1. Задайте остальные параметры кластера по [инструкции](../operations/cluster-create.md).
1. Нажмите кнопку **Создать кластер**.
...
1. [Удалите кластер ClickHouse®](../operations/cluster-delete.md).
