[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for ClickHouse®](../index.md) > [Практические руководства](index.md) > Работа с данными с помощью Query

# Работа с данными в Managed Service for ClickHouse®

Yandex Query — это интерактивный сервис для бессерверного анализа данных. С его помощью можно обрабатывать информацию из различных хранилищ без необходимости создания выделенного кластера. Поддерживается работа с хранилищами данных [Yandex Object Storage](../../storage/index.md), [Yandex Managed Service for PostgreSQL](../../managed-postgresql/index.md), [Yandex Managed Service for ClickHouse®](../index.md).
...
* плата за запущенный [кластер Managed Service for ClickHouse®](../pricing.md);
...
* [удалите кластер](../operations/cluster-delete.md) базы данных;
