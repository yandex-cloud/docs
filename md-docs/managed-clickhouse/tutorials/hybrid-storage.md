...
1. [Настройте clickhouse-client](../operations/connect/clients.md#clickhouse-client) и подключитесь с его помощью к базе данных.
...
1. [Подключитесь к базе данных](../operations/connect/clients.md#clickhouse-client).
