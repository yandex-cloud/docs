...
1. [Создайте кластер-приемник {{ mch-name }}](../operations/cluster-create.md#create-cluster).
...
1. [Подключитесь к кластеру {{ mch-name }}](../operations/connect/clients.md#clickhouse-client), на который вы хотите перенести данные, и создайте на нем новую таблицу из полученного ранее текста запроса.
...
1. [Создайте кластер-приемник {{ mch-name }}](../operations/cluster-create.md#create-cluster) с включенным [управлением пользователями через SQL](../operations/cluster-users.md#sql-user-management).
