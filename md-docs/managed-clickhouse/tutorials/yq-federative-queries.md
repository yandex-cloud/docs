[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for ClickHouse®](../index.md) > [Практические руководства](index.md) > Федеративные запросы к данным с помощью Query
...
- Консоль управления {#console}
  ...
  1. В блоке **Параметры привязки к данным**:
     ...
     1. В поле **Путь** укажите [путь к таблице](../../query/sources-and-sinks/object-storage.md#path-format) в бакете — `/visits.csv`.
...
* [удалите кластер](../operations/cluster-delete.md) Managed Service for ClickHouse®;
