...
* [Выгрузите](../../datalens/qa/connections.md#uploading-data-logs-api) данные в кластер [{{ mch-short-name }}](../index.md) и используйте подключение к БД {{ CH }} в качестве источника. С тарифами сервиса {{ mch-short-name }} можно ознакомиться в разделе [Правила тарификации](../pricing.md).
