...
* Постоянно запущенный кластер Managed Service for ClickHouse® (см. [тарифы Managed Service for ClickHouse®](../pricing.md));
...
1. Укажите параметры кластера:
    ...
    * Сервисные настройки:
    ...
    Полный список настроек см. в разделе [Настройки Managed Service for ClickHouse®](../concepts/settings-list.md).
