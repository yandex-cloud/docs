...
* Функция Cloud Functions: количество вызовов функции, время простоя подготовленных экземпляров и выделенные для выполнения функции вычислительные ресурсы ([тарифы Cloud Functions](../../functions/pricing.md)).
...
1. Укажите параметры кластера:
    ...
    * Сервисные настройки:
    ...
    Полный список настроек смотрите в разделе [Настройки Managed Service for ClickHouse®](../concepts/settings-list.md).
...
1. Сохраните дашборд:
   ...
   Подробнее о настройке дашбордов смотрите в разделе [Дашборд Yandex DataLens](../../datalens/concepts/dashboard.md).
...
* [Удалите ClickHouse®-кластер](../operations/cluster-delete.md);
