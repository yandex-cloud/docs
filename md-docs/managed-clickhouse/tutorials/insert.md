...
Список поддерживаемых форматов данных приведен в [документации ClickHouse®](https://clickhouse.com/docs/ru/interfaces/formats). Настройка схем форматов данных Cap'n Proto и Protobuf описана в разделе [Управление схемами формата данных](../operations/format-schemas.md).
...
В стоимость инфраструктуры для вставки данных в базу данных входит плата за кластер Managed Service for ClickHouse®: выделенные хостам вычислительные ресурсы, объем хранилища и резервных копий ([тарифы Managed Service for ClickHouse®](../pricing.md)).
