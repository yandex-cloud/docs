[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for ClickHouse®](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [ChangeFreeze](index.md) > Get
...
```
GET https://mdb.api.cloud.yandex.net/managed-clickhouse/v1/changeFreezes/{changeFreezeId}
```
