[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for ClickHouse®](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Cluster](index.md) > RestartHosts
...
## RestartClusterHostsRequest {#yandex.cloud.mdb.clickhouse.v1.RestartClusterHostsRequest}
