...
**rpc DeleteExternalDictionary ([DeleteClusterExternalDictionaryRequest](#yandex.cloud.mdb.clickhouse.v1.DeleteClusterExternalDictionaryRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## DeleteClusterExternalDictionaryRequest {#yandex.cloud.mdb.clickhouse.v1.DeleteClusterExternalDictionaryRequest}
...
Required field. ID of the ClickHouse cluster to delete the external dictionary from.
...
|| metadata | **[DeleteClusterExternalDictionaryMetadata](#yandex.cloud.mdb.clickhouse.v1.DeleteClusterExternalDictionaryMetadata)**
...
## DeleteClusterExternalDictionaryMetadata {#yandex.cloud.mdb.clickhouse.v1.DeleteClusterExternalDictionaryMetadata}
