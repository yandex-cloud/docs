[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for ClickHouse®](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Cluster](index.md) > MigrateToKeeper

# Managed Service for ClickHouse API, gRPC: ClusterService.MigrateToKeeper
...
**rpc MigrateToKeeper ([MigrateClusterToKeeperRequest](#yandex.cloud.mdb.clickhouse.v1.MigrateClusterToKeeperRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## MigrateClusterToKeeperRequest {#yandex.cloud.mdb.clickhouse.v1.MigrateClusterToKeeperRequest}
...
```json
{
  ...
  "allow_degradation_to_read_only": "bool"
}
```
...
Required field. ID of the ClickHouse cluster to migrate.
