...
**rpc Start ([StartClusterRequest](#yandex.cloud.mdb.clickhouse.v1.StartClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## StartClusterRequest {#yandex.cloud.mdb.clickhouse.v1.StartClusterRequest}
...
Required field. ID of the ClickHouse cluster to start.
...
|| metadata | **[StartClusterMetadata](#yandex.cloud.mdb.clickhouse.v1.StartClusterMetadata)**
...
## StartClusterMetadata {#yandex.cloud.mdb.clickhouse.v1.StartClusterMetadata}
