[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for ClickHouse®](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Maintenance](index.md) > Get

# Managed Service for ClickHouse API, REST: Maintenance.Get
...
```
GET https://mdb.api.cloud.yandex.net/managed-clickhouse/v1/maintenances/{maintenanceId}
```
