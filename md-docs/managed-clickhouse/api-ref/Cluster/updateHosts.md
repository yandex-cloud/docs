[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for ClickHouse®](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Cluster](index.md) > UpdateHosts
...
To get the ClickHouse host name, use a [ClusterService.ListHosts](listHosts.md#ListHosts) request. ||
