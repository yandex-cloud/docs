...
- AWS CLI {#aws-cli}
  ...
  Подробнее в документе [Загрузить объект](../operations/objects/upload.md).
...
- AWS CLI {#aws-cli}
  ...
  Подробнее в документе [Получить подписанную ссылку (pre-signed URL) на скачивание объекта](../operations/objects/link-for-download.md).
