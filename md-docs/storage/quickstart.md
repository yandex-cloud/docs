...
1. Чтобы загрузить объекты в бакет, перетащите файлы на экран с бакетом или нажмите кнопку ![bucket](../_assets/storage/upload.svg) **Загрузить** и подтвердите загрузку файлов.
