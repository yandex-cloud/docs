[Документация Yandex Cloud](../../../../index.md) > [Yandex Object Storage](../../../index.md) > Справочник API > [AWS S3 REST](../../index.md) > [REST](../index.md) > ACL > GetBucketAcl
...
|| **Параметр** | **Описание** ||
|| `bucket` | Имя бакета. ||
|| `key` | [Ключ](../../../concepts/object.md#key) объекта. Идентификатор, под которым объект хранится в Object Storage. ||
|#
