...
Заголовок | Описание
----- | -----
`X-Amz-Storage-Class` | [Класс хранилища](../../../concepts/storage-class.md) объекта.<br/><br/>Может иметь значения:<ul><li>`STANDARD` — стандартное хранилище.</li><li>`COLD` — холодное хранилище.</li><li>`ICE` — ледяное хранилище.</li><li>`INTELLIGENT_TIERING` — умное хранилище.</li></ul>
