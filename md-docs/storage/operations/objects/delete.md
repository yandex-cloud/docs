...
По умолчанию операция удаления необратима. [Восстановить](restore-object-version.md) можно только те объекты, которые были загружены при включенном [версионировании](../../concepts/versioning.md).
...
- Консоль управления {#console}
  ...
  1. Выберите бакет, в котором хранится удаляемый объект, и перейдите на вкладку **Объекты**.
  1. Чтобы видеть все версии объектов в списке, справа от поля поиска объекта в бакете включите опцию **Показать версии**.
  1. Чтобы удалить один объект, в строке с этим объектом нажмите значок ![ellipsis](../../../_assets/console-icons/ellipsis.svg) и выберите ![trash-bin](../../../_assets/console-icons/trash-bin.svg) **Удалить**.
  ...
  Работать одновременно с несколькими объектами удобнее с помощью файловых браузеров [CyberDuck](../../tools/cyberduck.md) и [WinSCP](../../tools/winscp.md) или с помощью [AWS CLI](../../tools/aws-cli.md).
