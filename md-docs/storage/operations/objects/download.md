[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > [Пошаговые инструкции](../index.md) > Объекты > Скачивание объекта
...
- AWS CLI {#aws-cli}
  ...
  **Скачать папку (все объекты с определенным префиксом)**
  ...
  Подробнее о папках в Object Storage в разделе [Папка](../../concepts/object.md#folder).
