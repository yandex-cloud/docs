[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > [Пошаговые инструкции](../index.md) > Объекты > Загрузить объект составной (multipart) загрузкой

# Загрузить объект составной (multipart) загрузкой
