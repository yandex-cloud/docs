[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > [Пошаговые инструкции](../index.md) > Объекты > Блокировать версии объекта
...
- Консоль управления {#console}
  ...
  1. Выберите бакет, для объектов которого хотите настроить блокировку, и перейдите на вкладку **Объекты**.
  1. Чтобы видеть все версии объектов в списке, справа от поля поиска объекта в бакете включите опцию **Показать версии**.
  1. В списке объектов в строке с нужным объектом нажмите значок ![ellipsis](../../../_assets/console-icons/ellipsis.svg) и выберите ![lock](../../../_assets/console-icons/lock.svg) **Блокировка**.
