[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > [Пошаговые инструкции](../index.md) > Объекты > Восстановить версию объекта
...
- Консоль управления {#console}
  ...
  1. На панели сверху нажмите ![ellipsis](../../../_assets/console-icons/ellipsis.svg) и выберите ![clock](../../../_assets/console-icons/clock.svg) **История версий**.
  1. В списке версий в строке с нужной версией нажмите ![clock-arrow-rotate-left](../../../_assets/console-icons/clock-arrow-rotate-left.svg) **Восстановить**. Выбранная версия будет восстановлена и отображена как текущая.
