[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > [Пошаговые инструкции](../index.md) > Объекты > Загрузить объект по подписанной ссылке (pre-signed URL)

# Получить подписанную ссылку (pre-signed URL) на загрузку объекта
...
[Получить подписанную ссылку (pre-signed URL) на скачивание объекта](link-for-download.md)