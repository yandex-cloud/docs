[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > [Пошаговые инструкции](../index.md) > Объекты > Управлять метками объекта
...
- Консоль управления {#console}
  ...
  1. Выберите нужный бакет из списка и перейдите на вкладку **Объекты**.
  1. Нажмите на имя нужного объекта.
  1. В поле **Метки** нажмите крестик рядом с меткой, которую вы хотите удалить.
