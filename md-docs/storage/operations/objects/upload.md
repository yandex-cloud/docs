[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > [Пошаговые инструкции](../index.md) > Объекты > Загрузить объект
...
- Yandex Cloud CLI {#cli}
  ...
  1. Вычислите MD5-хеш файла и закодируйте его по схеме [Base64](https://ru.wikipedia.org/wiki/Base64):
