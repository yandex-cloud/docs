...
- Консоль управления {#console}
  ...
  1. Выберите бакет, в который нужно загрузить объект, и перейдите на вкладку **Объекты**.
  1. Если вы хотите загрузить объект в бакет впервые, нажмите **Загрузить объекты**.
  1. Если вы хотите загрузить объект в конкретную папку, перейдите в нее, нажав на имя. Если вам нужно создать новую папку, на панели сверху нажмите **Создать папку**.
  1. Оказавшись в нужной папке, на панели сверху нажмите ![image](../../../_assets/console-icons/arrow-up-from-line.svg) **Загрузить**.
