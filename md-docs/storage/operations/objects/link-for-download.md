[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > [Пошаговые инструкции](../index.md) > Объекты > Скачать объект по подписанной ссылке (pre-signed URL)

# Получить подписанную ссылку (pre-signed URL) на скачивание объекта
...
- Консоль управления {#console}
  ...
  1. Выберите нужный бакет в списке.
  1. Выберите объект, ссылку на скачивание которого вы хотите получить, и на панели сверху нажмите кнопку ![link](../../../_assets/console-icons/link.svg) **Получить ссылку**.
  1. Для бакета с ограниченным доступом укажите **Время жизни** ссылки в часах или днях (максимум 30 дней) и нажмите **Получить ссылку**.
...
[Получить подписанную ссылку (pre-signed URL) на загрузку объекта](link-for-upload.md)