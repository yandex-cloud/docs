[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > [Пошаговые инструкции](../index.md) > Хостинг статических сайтов > Настроить хостинг
...
- Консоль управления {#console}
  ...
  1. Выберите режим `Хостинг` и укажите:
...
- Terraform {#tf}
  ...
  Кроме статических ключей доступа для аутентификации в Object Storage можно использовать IAM-токен. Подробнее смотрите в разделе [Создать бакет](../buckets/create.md) и в [документации провайдера](../../../terraform/resources/storage_object.md). 
...
- Консоль управления {#console}
  ...
  1. Выберите вариант `Переадресация` и укажите:
...
- Консоль управления {#console}
  ...
  1. Перейдите на вкладку **Настройки**, затем на вкладку **Веб-сайт**.
  1. Выберите режим `Хостинг` и в блоке **Переадресация** нажмите кнопку **Добавить правило переадресации**.
...
* [Настроить HTTPS](certificate.md)
