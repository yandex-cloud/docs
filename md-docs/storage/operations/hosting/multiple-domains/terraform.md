[Документация Yandex Cloud](../../../../index.md) > [Yandex Object Storage](../../../index.md) > [Пошаговые инструкции](../../index.md) > Хостинг статических сайтов > [Поддержать несколько доменных имен](index.md) > Terraform

# Поддержать несколько доменных имен с помощью Terraform
