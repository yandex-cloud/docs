[Документация Yandex Cloud](../../../../index.md) > [Yandex Object Storage](../../../index.md) > [Пошаговые инструкции](../../index.md) > Хостинг статических сайтов > [Поддержка нескольких доменных имен](index.md) > Консоль управления, CLI и API
