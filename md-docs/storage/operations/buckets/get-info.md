[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > [Пошаговые инструкции](../index.md) > Бакеты > Получить информацию о бакете и его статистику
...
- Консоль управления {#console}
  ...
  1. На панели сверху выберите нужную вкладку с информацией о бакете:
     * **Объекты** — список объектов, хранящихся в бакете.
     * **Настройки** — основные параметры бакета, информация о хостинге сайта в бакете, версионировании, логировании, жизненном цикле объектов в бакете.
     * **Безопасность** — описание прав и политики доступа в бакете, сведения о конфигурации HTTPS и CORS, блокировке и шифровании объектов в бакете.
