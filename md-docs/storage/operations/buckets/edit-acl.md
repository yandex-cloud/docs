[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > [Пошаговые инструкции](../index.md) > Бакеты > Редактирование ACL бакета
...
- Консоль управления {#console}
  ...
  1. В строке с нужным бакетом нажмите значок ![image](../../../_assets/console-icons/ellipsis.svg) и выберите **Настроить ACL**.
      ...
      Также можно нажать на имя бакета, на открывшейся странице на панели сверху нажать ![image](../../../_assets/console-icons/ellipsis.svg) и выбрать **Настроить ACL**.
  ...
  1. Выполните команду:
      ...
      * `permission` — тип разрешения ACL. Возможные значения:
        ...
        * `permission-full-control` — полный доступ к бакету и объектам в нем.
        ...
        Подробнее о разрешениях в разделе [Виды разрешений](../../concepts/acl.md#permissions-types).
  ...
  **yandex_storage_bucket_grant** {#tf-storage-bucket-grant}
  ...
  1. Опишите в конфигурационном файле параметры ресурсов, которые необходимо создать:
     ...
     * `grant` — настройки [ACL](../../concepts/acl.md). Чтобы управлять этим параметром, у сервисного аккаунта, на который получены статические ключи доступа, должна быть [роль](../../security/index.md#roles-list) `storage.admin` на бакет или каталог.
     ...
     Более подробная информация о параметрах ресурса `yandex_storage_bucket_grant` приведена в [документации провайдера](../../../terraform/resources/storage_bucket_grant.md).
