...
- Консоль управления {#console}
  ...
  1. Перейдите на вкладку **Безопасность**, затем на вкладку **Поиск чувствительных данных**.
...
- Консоль управления {#console}
  ...
  1. Нажмите на имя нужного бакета.
  1. Перейдите на вкладку **Безопасность**, затем на вкладку **Поиск чувствительных данных**.
  1. Нажмите кнопку **Еще** ![chevron-down](../../../_assets/console-icons/chevron-down.svg) и выберите ![arrow-down-to-line](../../../_assets/console-icons/arrow-down-to-line.svg) **Скачать результаты**.
...
- Консоль управления {#console}
  ...
  1. Нажмите на имя нужного бакета.
  1. Перейдите на вкладку **Безопасность**, затем на вкладку **Поиск чувствительных данных**.
  1. Нажмите кнопку **Еще** ![chevron-down](../../../_assets/console-icons/chevron-down.svg) и выберите ![folder-arrow-up-in](../../../_assets/console-icons/folder-arrow-up-in.svg) **Экспортировать в бакет**.
...
- Консоль управления {#console}
  ...
  1. Перейдите в сервис **Object Storage**.
  1. Нажмите на имя нужного бакета.
  1. Перейдите на вкладку **Безопасность**, затем на вкладку **Поиск чувствительных данных**, затем — **Сообщения и ошибки**.
