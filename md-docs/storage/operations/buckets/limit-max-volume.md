[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > [Пошаговые инструкции](../index.md) > Бакеты > Ограничение максимального размера бакета
...
- Terraform {#tf}
  ...
  1. Откройте файл конфигурации Terraform и добавьте параметр `max_size` в описании бакета:
     ...
     * `max_size` — максимальный размер бакета в байтах.
     ...
     Более подробная информация о параметрах ресурса `yandex_storage_bucket` в Terraform приведена в [документации провайдера](../../../terraform/resources/storage_bucket.md#bucket-max-size).
