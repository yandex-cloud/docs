[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > [Пошаговые инструкции](../index.md) > Бакеты > Включить и выключить блокировку версий объектов (object lock)
...
- Консоль управления {#console}
  ...
  1. Перейдите на вкладку **Безопасность**, затем на вкладку **Блокировки объектов**.
...
- Terraform {#tf}
  ...
  1. Откройте файл конфигурации Terraform и добавьте к описанию бакета блок `object_lock_configuration`:
      ...
      * `object_lock_configuration` — настройки блокировки версий объектов:
      ...
      Более подробная информация о параметрах бакета, которые вы можете задать с помощью Terraform, приведена в [документации провайдера](../../../terraform/resources/storage_bucket.md).
