[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > [Пошаговые инструкции](../index.md) > Бакеты > Настроить и отключить шифрование по умолчанию
...
После отключения новые объекты не будут автоматически шифроваться ключом из настроек бакета. Уже зашифрованные объекты останутся зашифрованными: сохраните ключ KMS, чтобы иметь возможность их расшифровать.

{% list tabs group=instructions %}

- Консоль управления {#console}

  Чтобы отключить шифрование по умолчанию, уберите выбор ключа KMS в настройках бакета:
  1. В [консоли управления](https://console.yandex.cloud) выберите каталог.
  1. [Перейдите](https://console.yandex.cloud/link/storage) в сервис **Object Storage**.
