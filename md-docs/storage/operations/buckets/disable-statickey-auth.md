[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > [Пошаговые инструкции](../index.md) > Бакеты > Запретить доступ со статическими ключами
...
Минимально необходимая роль для запрета доступа с помощью статических ключей — `storage.admin`. Смотрите [описание роли](../../security/index.md#storage-admin).
