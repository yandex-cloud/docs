[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > [Пошаговые инструкции](../index.md) > Бакеты > Управлять политикой доступа
...
- Консоль управления {#console}
  ...
  1. Выберите нужный бакет из списка.
  1. Перейдите на вкладку **Безопасность**, затем на вкладку **Политика доступа**.
  1. Нажмите кнопку ![trash-bin](../../../_assets/console-icons/trash-bin.svg) **Удалить политику доступа**.
