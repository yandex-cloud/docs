[Документация Yandex Cloud](../../index.md) > [Yandex Object Storage](../index.md) > [Концепции](index.md) > Блокировка версии объекта (object lock)
...
: Пользователь, управляющий Object Storage (роль `storage.admin`), может только продлить блокировку. 
...
Если для бакета настроены блокировки по умолчанию, для каждой загружаемой версии объекта нужно вычислить [MD5-хеш](https://ru.wikipedia.org/wiki/MD5), закодировать его по схеме [Base64](https://ru.wikipedia.org/wiki/Base64) и указать получившееся значение в запросе: например, при запросе через REST API — в заголовке `Content-MD5`.
...
1. [Включите версионирование бакета](../operations/buckets/versioning.md).
1. [Включите возможность блокировок](../operations/buckets/configure-object-lock.md#enable) в бакете.
1. [Заблокируйте существующую версию объекта](../operations/objects/edit-object-lock.md) или [загрузите версию объекта с блокировкой](../operations/objects/upload.md#w-object-lock).

Смотрите также:
* [Управление блокировками версий объектов (object lock) в бакете](../operations/buckets/configure-object-lock.md).
* [Блокировать версии объекта (object lock)](../operations/objects/edit-object-lock.md).
* [Удалить версию объекта с блокировкой (object lock)](../operations/objects/delete.md#w-object-lock).
