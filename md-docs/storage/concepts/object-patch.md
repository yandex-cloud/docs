...
Также вы можете напрямую [отправлять запросы](../s3/index.md) patch к {{ objstorage-name }} API, либо расширить набор методов [AWS SDK](../tools/index.md), воспользовавшись [спецификацией](#specification) метода patch.
