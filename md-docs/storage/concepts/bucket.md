...
Подробнее о начале работы с бакетами см. в статье [Как начать работать с Yandex Object Storage](../quickstart.md).
...
Подробнее о настройке доступа см. на странице [Доступ в бакет с помощью сервисного подключения из Yandex Virtual Private Cloud](../operations/buckets/access-via-vpc.md).
