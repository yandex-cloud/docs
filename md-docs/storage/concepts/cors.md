...
При управлении конфигурацией CORS с помощью HTTP API, совместимого с Amazon S3, задайте [ее в формате XML](../s3/api-ref/cors/xml-config.md). Различные инструменты могут требовать другие форматы конфигурации, смотрите пример для AWS CLI в разделе [Настроить CORS](../operations/buckets/cors.md).