...
Понятие | Описание
--------|----------
[Бакет](bucket.md) | Выделенная часть хранилища Object Storage для пользовательских данных.
...
[Выгрузка метаданных объектов](s3-inventory.md) | Получение метаданных всех объектов бакета для дальнейшего анализа и каталогизации.
...
[Поиск чувствительных данных](sensitive-data-search.md) | Инструмент для обнаружения чувствительной информации в бакетах.
...
[Резервное копирование](backup.md) | Организация резервного копирования информации, хранящейся в Object Storage.
