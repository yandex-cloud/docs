...
Изменение класса хранилища для уже загруженных объектов тарифицируется как операция `TRANSITION`. Подробнее см. [Цены на операции с данными](../pricing.md#prices-operations) в правилах тарификации Object Storage.
...
* Задать условия для изменения класса хранилища на более <q>холодный</q> с помощью [жизненных циклов объектов](lifecycles.md). Подробнее о формате правил для жизненных циклов см. в разделе [Конфигурация жизненных циклов объектов в бакете](../s3/api-ref/lifecycles/xml-config.md).
