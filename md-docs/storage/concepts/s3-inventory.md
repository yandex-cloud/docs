...
С 20 апреля 2026 года функциональность выгрузки метаданных объектов (S3 Inventory) тарифицируется.
...
Подробнее в разделе [Правила тарификации для Object Storage](../pricing.md).
