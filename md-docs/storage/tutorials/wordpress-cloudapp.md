[Документация Yandex Cloud](../../index.md) > [Yandex Object Storage](../index.md) > [Практические руководства](index.md) > Хостинг сайтов и веб-приложений > Установка WordPress с помощью Cloud Apps
