# Импорт данных из {{ objstorage-name }}, обработка и экспорт в {{ mch-full-name }}
...
* Плата за бакеты {{ objstorage-name }}: хранение данных и выполнение операций с ними (см. [тарифы {{ objstorage-name }}](../pricing.md)).
