...
Аудитные логи могут загружаться в бакет [{{ objstorage-full-name }}](../../index.md), лог-группу [{{ cloud-logging-full-name }}](../../../logging/index.md), поток данных [{{ yds-full-name }}](../../../data-streams/index.md).
