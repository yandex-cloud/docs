[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > [Практические руководства](../index.md) > Сбор и анализ логов > [Поиск событий в аудитных логах](index.md) > Примеры запросов для поиска событий
