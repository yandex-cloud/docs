[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > [Практические руководства](../index.md) > Хостинг сайтов и веб-приложений > [Интеграция L7-балансировщика с CDN и Object Storage](index.md) > Terraform
...
Прежде чем удалять инфраструктуру, [удалите](../../operations/objects/delete.md) все объекты в созданном бакете.
