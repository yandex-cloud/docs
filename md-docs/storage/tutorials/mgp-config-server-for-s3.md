...
- Вручную {#manual}
    ...
    1. [Создайте бакет в {{ objstorage-name }}](../operations/buckets/create.md) с ограниченным доступом. [Загрузите](../operations/objects/upload.md) в него файл `example.csv`, содержащий тестовую таблицу:
...
- Вручную {#manual}
    ...
    1. [Удалите бакет в {{ objstorage-name }}](../operations/buckets/delete.md).
