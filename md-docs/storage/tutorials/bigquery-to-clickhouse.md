...
* Плата за бакет Object Storage: хранение данных и выполнение операций с ними (см. [тарифы Object Storage](../pricing.md)).
* Плата за использование сервиса Yandex DataLens (см. [тарифы DataLens](../../datalens/pricing.md)).
