...
* Плата за бакет {{ objstorage-name }}: хранение данных и выполнение операций с ними (см. [тарифы {{ objstorage-name }}](../pricing.md)).
...
1. [Создайте бакет {{ objstorage-name }}](../operations/buckets/create.md). При создании [включите публичный доступ](../operations/buckets/bucket-availability.md) на чтение объектов и к списку объектов в бакете.
...
1. [Удалите все объекты бакета {{ objstorage-name }}](../operations/objects/delete-all.md) и затем [удалите сам бакет](../operations/buckets/delete.md).
