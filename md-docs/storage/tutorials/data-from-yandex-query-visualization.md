[Документация Yandex Cloud](../../index.md) > [Yandex Object Storage](../index.md) > [Практические руководства](index.md) > Обработка и анализ данных > Визуализация данных Yandex Query
...
Для создания в DataLens подключения к Yandex Query требуется [сервисный аккаунт](../../iam/concepts/users/service-accounts.md) с [ролью](../../iam/operations/sa/assign-role-for-sa.md) `editor` на каталог, в котором будет [создано соединение](#create_connection) с [бакетом](../concepts/bucket.md) Object Storage.
...
1. Укажите параметры подключения:
   ...
   * **Уровень доступа SQL-запросов**. Выберите вариант **SQL на чтение**.
