...
1. Загрузите объекты в бакет Object Storage:
   ...
   - Консоль управления {#console}
     ...
     1. На панели сверху нажмите кнопку ![arrow-up-from-line](../../_assets/console-icons/arrow-up-from-line.svg) **Загрузить** и выберите [сгенерированные ранее](#project-prepare) объекты в папке `build`.
...
1. Настройте хостинг статического сайта:
   ...
   - Консоль управления {#console}
     ...
     1. Перейдите на вкладку **Настройки**, затем на вкладку **Веб-сайт**. На открывшейся странице:
        * Выберите режим `Хостинг`.
