...
Из этого руководства вы узнаете, как получить статистику запросов к объектам [{{ objstorage-full-name }}](../index.md) с использованием [{{ yq-full-name }}](../../query/index.md). Вы создадите бакет и настроите логирование в {{ objstorage-name }}, создадите соединение в {{ yq-name }} и получите статистику с помощью SQL-запросов.
...
- Консоль управления {#console}
  ...
  1. На панели слева выберите ![image](../../_assets/console-icons/folder-tree.svg) **{{ ui-key.yacloud.storage.bucket.switch_files }}** и [загрузите](../operations/objects/upload.md) объекты. Например, пару простых текстовых файлов.
