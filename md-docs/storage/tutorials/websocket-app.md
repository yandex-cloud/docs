...
* [бакет](../concepts/bucket.md) {{ objstorage-name }} для хранения статических ресурсов игры;
...
* плата за хранение данных и операции с данными (см. [тарифы {{ objstorage-full-name }}](../pricing.md));
...
1. [Удалите](../operations/objects/delete.md) все объекты из бакета {{ objstorage-name }}.
1. [Удалите](../operations/buckets/delete.md) пустой бакет {{ objstorage-name }}.
