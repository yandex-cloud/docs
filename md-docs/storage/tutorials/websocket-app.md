...
* [бакет](../concepts/bucket.md) Object Storage для хранения статических ресурсов игры;
...
* плата за хранение данных и операции с данными (см. [тарифы Yandex Object Storage](../pricing.md));
...
1. [Удалите](../operations/objects/delete.md) все объекты из бакета Object Storage.
1. [Удалите](../operations/buckets/delete.md) пустой бакет Object Storage.
