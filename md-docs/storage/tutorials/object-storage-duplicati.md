...
* плата за хранение данных (см. [тарифы Yandex Object Storage](../pricing.md#prices-storage));
* плата за операции с данными (см. [тарифы Yandex Object Storage](../pricing.md#prices-operations));
* стоимость исходящего трафика из Yandex Cloud в интернет (см. [тарифы Yandex Object Storage](../pricing.md#prices-traffic)).
