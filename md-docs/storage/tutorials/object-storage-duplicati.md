[Документация Yandex Cloud](../../index.md) > [Yandex Object Storage](../index.md) > [Практические руководства](index.md) > Резервное копирование > Резервное копирование в Object Storage с помощью Duplicati
...
* плата за хранение данных ([тарифы Yandex Object Storage](../pricing.md#prices-storage));
* плата за операции с данными ([тарифы Yandex Object Storage](../pricing.md#prices-operations));
* стоимость исходящего трафика из Yandex Cloud в интернет ([тарифы Yandex Object Storage](../pricing.md#prices-traffic)).
