...
- Вручную {#manual}
    ...
    1. В {{ objstorage-short-name }} [создайте бакеты](../operations/buckets/create.md) и [настройте доступ](../operations/buckets/edit-acl.md) к ним:
...
1. Подготовьте файл скрипта:
    ...
    1. Создайте в бакете для входных данных папку `scripts` и [загрузите](../operations/objects/upload.md#simple) в нее файл `ch-to-dataproc.py`.
...
1. Подготовьте файл скрипта:
    ...
    1. Создайте в бакете для входных данных папку `scripts` и [загрузите](../operations/objects/upload.md#simple) в нее файл `dataproc-to-ch.py`.
...
1. [Удалите объекты](../operations/objects/delete.md) из бакетов. Остальные ресурсы удалите в зависимости от способа их создания:
    ...
    - Вручную {#manual}
        ...
        1. [Бакеты {{ objstorage-name }}](../operations/buckets/delete.md).
