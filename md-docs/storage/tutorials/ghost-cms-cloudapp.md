...
* Плата за использование [бакета](../concepts/bucket.md) для хранения медиафайлов (см. [тарифы {{ objstorage-full-name }}](../pricing.md)).
...
1. [Удалите](../operations/objects/delete-all.md) все объекты из бакета {{ objstorage-name }}, созданного при установке приложения.
