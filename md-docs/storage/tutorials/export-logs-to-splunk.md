...
- Консоль управления {#console}
  ...
  1. В блоке **Назначение** задайте параметры объекта назначения:
     ...
     1. **Бакет** — имя [бакета](../operations/buckets/create.md), в который будут загружаться аудитные логи.
     ...
     {% endnote %}
      ...
      1. **Ключ шифрования** — укажите ключ шифрования, которым [зашифрован](../concepts/encryption.md) бакет.
