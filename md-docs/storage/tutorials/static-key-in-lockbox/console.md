[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > [Практические руководства](../index.md) > Безопасность и управление доступом > [Хранение статического ключа доступа в секрете Yandex Lockbox](index.md) > CLI
...
- Yandex Cloud CLI {#cli}
  ...
  1. Назначьте созданному сервисному аккаунту [роль](../../security/index.md#storage-editor) `storage.editor` на каталог:
