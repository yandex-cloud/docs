[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > [Практические руководства](../index.md) > Безопасность и управление доступом > Хранение статического ключа доступа в секрете Yandex Lockbox > Обзор
