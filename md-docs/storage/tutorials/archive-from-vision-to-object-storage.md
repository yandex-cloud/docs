...
С помощью сервисов [{{ vision-name }}]({{ link-docs-ai }}vision/concepts/ocr) и [{{ objstorage-full-name }}](../index.md) можно организовать распознавание текста на изображениях и хранение архива исходных изображений и результатов распознавания.
...
* Плата за хранение данных в [бакете](../concepts/bucket.md) и [операции](../operations/index.md) с ними (см. [тарифы {{ objstorage-name }}](../pricing.md)).
...
1. [Загрузите](../operations/objects/upload.md) изображения с текстом в бакет.
...
1. [Удалите](../operations/objects/delete-all.md) все объекты в бакете.
