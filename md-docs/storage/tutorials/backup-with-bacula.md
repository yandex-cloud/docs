...
* плата за хранение данных в бакете и операции с ними (см. [тарифы Yandex Object Storage](../pricing.md));
...
- Консоль управления {#console}
  ...
  1. Задайте параметры [публичного доступа](../security/public-access.md) на чтение [объектов](../concepts/object.md) в бакете, получение списка объектов и чтение настроек бакета — `С авторизацией`.
...
1. [Удалите](../operations/objects/delete-all.md) все объекты из бакета Object Storage.
