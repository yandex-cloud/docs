...
- Консоль управления {#console}
  ...
  1. В поле **Имя** введите имя бакета. После настройки бакет будет доступен по двум адресам:
     ...
     * Имя не должно иметь вид IP-адреса (например `10.1.3.9`).
     ...
     Если вы планируете использовать собственный домен для сайта, имя бакета должно в точности совпадать с именем вашего домена, а домен должен быть второго и более уровня. Подробнее в разделе [Собственный домен](../../operations/hosting/own-domain.md).
...
Имя бакета должно в точности совпадать с именем вашего домена, а домен должен быть второго и более уровня. Подробнее в разделе [Собственный домен](../../operations/hosting/own-domain.md).
