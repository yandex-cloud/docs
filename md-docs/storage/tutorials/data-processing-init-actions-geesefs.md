...
С их помощью можно автоматизировать установку и настройку программы [GeeseFS](../tools/geesefs.md), позволяющей хостам кластера Yandex Data Processing монтировать бакеты Yandex Object Storage через [FUSE](https://ru.wikipedia.org/wiki/FUSE_(модуль_ядра)).
...
- Вручную {#manual}
  ...
  1. [Создайте бакет](../operations/buckets/create.md) Object Storage.
...
1. [Загрузите](../operations/objects/upload.md) файл `geesefs_mount.sh` в созданный ранее бакет Object Storage.
