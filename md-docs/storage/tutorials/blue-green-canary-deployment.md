[Документация Yandex Cloud](../../index.md) > [Yandex Object Storage](../index.md) > [Практические руководства](index.md) > Разработка и развертывание приложений > Сине-зеленое и канареечное развертывание версий сервиса
...
Бо́льшую часть шагов можно выполнить с помощью любого из стандартных инструментов: [консоли управления](https://console.yandex.cloud), интерфейсов командной строки (CLI) [Yandex Cloud](../../cli/index.md) и [AWS](../tools/aws-cli.md), Terraform и [API Yandex Cloud](../../api-design-guide/index.md). В каждом шаге перечислены поддерживаемые для него инструменты.
...
1. Загрузите файлы в бакеты:
   ...
   - API {#api}
     ...
     Используйте метод REST API [upload](../s3/api-ref/object/upload.md).
...
1. [Удалите](../operations/objects/delete.md) все объекты из «синего» и «зеленого» бакетов.
1. [Удалите](../operations/buckets/delete.md) «синий» и «зеленый» бакеты.
