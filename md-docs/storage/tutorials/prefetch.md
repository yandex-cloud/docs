...
Предполагается, что патч состоит из одного файла с именем `ycgame-update-v1.1.exe`. Он будет загружен в [бакет](../concepts/bucket.md) [Yandex Object Storage](../index.md).
  ...
  1. Задайте основные настройки CDN-ресурса:
      * В блоке **Контент**:
        ...
        * В поле **Тип источника** выберите `Бакет`.
          ...
          Если в качестве источника используется бакет Object Storage, рекомендуем [включить для него хостинг статического сайта](../operations/hosting/setup.md).
...
- Консоль управления {#console}
  ...
  1. Нажмите кнопку **Еще** и выберите ![image](../../_assets/console-icons/arrow-up-from-line.svg) **Предзагрузить контент**.
