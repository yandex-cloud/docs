[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > [Практические руководства](../index.md) > Разработка и развертывание приложений > Разработка Telegram-бота > Обзор
...
Для хранения статических ресурсов используется [Yandex Object Storage](../../index.md). [Yandex API Gateway](../../../api-gateway/index.md) принимает запросы пользователей и перенаправляет их для обработки в [Yandex Cloud Functions](../../../functions/index.md).
