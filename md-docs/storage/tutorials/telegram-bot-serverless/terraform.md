...
* плата за [хранение данных](../../concepts/bucket.md) в {{ objstorage-name }}, [операции](../../operations/index.md) с ними и исходящий трафик (см. [тарифы {{ objstorage-name }}](../../pricing.md));
