 ...
 * [Настройте политику доступа для бакета](../../operations/buckets/access-via-vpc.md#cli_2)
 ...
 * [Применить или изменить политику](../../operations/buckets/policy.md#cli_1)
 * [Добавить или изменить метки](../../operations/buckets/tagging.md#cli_1)
 * [Управление версионированием бакета](../../operations/buckets/versioning.md#cli_1)
 * [Выбор сертификата из Certificate Manager](../../operations/hosting/certificate.md#cli_1)
 * [Настройте статический сайт для основного домена](../../operations/hosting/multiple-domains/console.md#cli_2)
 * [Хостинг статического сайта](../../operations/hosting/setup.md#cli_1)