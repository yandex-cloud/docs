[Документация Yandex Cloud](../../../../index.md) > [Yandex Object Storage](../../../index.md) > Справочник API > [Yandex Cloud gRPC (англ.)](../index.md) > [Bucket](index.md) > ListAccessBindings

# Object Storage API, gRPC: BucketService.ListAccessBindings
