[Документация Yandex Cloud](../../../../index.md) > [Yandex Object Storage](../../../index.md) > Справочник API > [Yandex Cloud gRPC (англ.)](../index.md) > [Bucket](index.md) > SetHTTPSConfig
...
[yandex.cloud.certificatemanager.v1.CertificateService.Create](../../../../certificate-manager/api-ref/grpc/Certificate/create.md#Create) request.
...
To get the list of all available certificates, make a [yandex.cloud.certificatemanager.v1.CertificateService.List](../../../../certificate-manager/api-ref/grpc/Certificate/list.md#List)
request. ||
|#
