[Документация Yandex Cloud](../../../index.md) > [Yandex Object Storage](../../index.md) > Справочник API > [Yandex Cloud REST (англ.)](../index.md) > [Bucket](index.md) > Get

# Object Storage API, REST: Bucket.Get

Returns the specified bucket.
To get the list of all available buckets, make a [List](list.md#List) request.
...
Access to scopes is managed via [Identity and Access Management roles](../../security/index.md),
bucket [ACL](../../concepts/acl.md) and [policies](../../concepts/policy.md).
...
## Response {#yandex.cloud.storage.v1.Bucket}
