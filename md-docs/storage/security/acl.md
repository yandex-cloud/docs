[Документация Yandex Cloud](../../index.md) > [Yandex Object Storage](../index.md) > [Управление доступом](overview.md) > Список управления доступом (ACL)
...
* Пользователь Yandex Cloud
  ...
  * В разделе [IAM](https://console.yandex.cloud/iam) консоли управления.
...
* [Группа пользователей](../../organization/concepts/groups.md)
  ...
  Для получения идентификатора перейдите на вкладку [**Группы**](https://center.yandex.cloud/organization/groups) в интерфейсе Cloud Center.
