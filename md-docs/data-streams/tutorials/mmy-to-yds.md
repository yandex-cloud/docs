[Документация Yandex Cloud](../../index.md) > [Yandex Data Streams](../index.md) > [Практические руководства](index.md) > Захват изменений MySQL® и поставка в YDS
...
1. [Создайте поток данных Data Streams](../operations/aws-cli/create.md) с именем `mpg-stream`.
