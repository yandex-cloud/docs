...
Аудитные логи могут загружаться в бакет [{{ objstorage-full-name }}](../../../storage/index.md), лог-группу [{{ cloud-logging-full-name }}](../../../logging/index.md), поток данных [{{ yds-full-name }}](../../index.md).
...
Сервис [{{ yq-name }}](../../../query/index.md) применяется для работы с логами, которые загружаются в бакет или поток данных:
...
Сервис [{{ cloud-logging-name }}](../../../logging/index.md) применяется для работы с логами, которые загружаются в лог-группу.
