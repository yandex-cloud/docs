[Документация Yandex Cloud](../../index.md) > [Yandex Data Streams](../index.md) > [Практические руководства](index.md) > Интеграция Yandex Cloud Postbox с внешними системами через вебхуки

# Интеграция Yandex Cloud Postbox с внешними системами с помощью вебхуков


В этом руководстве вы настроите передачу событий [Yandex Cloud Postbox](../../postbox/index.md) в [Yandex Data Streams](../index.md) и вызов [вебхуков](https://ru.wikipedia.org/wiki/Webhook) во внешних системах. Для обработки и хранения данных будут использоваться сервисы [Yandex Cloud Functions](../../functions/index.md) и [Yandex Managed Service for YDB](../../ydb/index.md).
...
* плата за хранение данных Data Streams ([тарифы Yandex Data Streams](../pricing.md));
...
* `yds-functions` — от его имени будет вызываться [функция](../../functions/concepts/function.md) Cloud Functions и будут записываться события в [поток данных](../concepts/glossary.md#stream-concepts) Data Streams;
...
Создайте [поток данных](../concepts/glossary.md#stream-concepts), в котором будут регистрироваться события Yandex Cloud Postbox:
...
- Консоль управления {#console}
  ...
  1. В блоке **Подписки** нажмите кнопку **Добавить** и в появившейся форме:
      ...
      1. В поле **Поток данных** выберите [поток данных](../concepts/glossary.md#stream-concepts) `postbox-events-stream`.
...
1. [Удалите](../operations/manage-streams.md#delete-data-stream) поток данных Data Streams.
