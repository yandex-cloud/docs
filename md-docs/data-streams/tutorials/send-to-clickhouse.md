...
С помощью сервиса {{ data-transfer-name }} вы можете поставлять данные из [потока {{ yds-name }}](../concepts/glossary.md#stream-concepts) в сервис {{ mch-name }}.
...
1. [Отправьте в поток](../operations/aws-cli/send.md) {{ yds-name }} новое сообщение:
