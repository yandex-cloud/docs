[Документация Yandex Cloud](../../index.md) > [Yandex Data Streams](../index.md) > [Практические руководства](index.md) > Сохранение данных в ClickHouse®

# Сохранение данных в Yandex Managed Service for ClickHouse®

# Сохранение потока данных Yandex Data Streams в Yandex Managed Service for ClickHouse®


С помощью сервиса Data Transfer вы можете поставлять данные из [потока Data Streams](../concepts/glossary.md#stream-concepts) в сервис Managed Service for ClickHouse®.
...
1. [Создайте поток данных Data Streams](../operations/aws-cli/create.md).
1. [Отправьте в поток](../operations/aws-cli/send.md) тестовые данные. В качестве сообщения используйте данные от сенсоров автомобиля в формате JSON:
...
1. [Отправьте в поток](../operations/aws-cli/send.md) Data Streams новое сообщение:
