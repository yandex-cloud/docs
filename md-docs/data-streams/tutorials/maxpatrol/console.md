[Документация Yandex Cloud](../../../index.md) > [Yandex Data Streams](../../index.md) > [Практические руководства](../index.md) > [Загрузка аудитных логов в MaxPatrol SIEM](index.md) > Консоль управления

# Загрузка аудитных логов в MaxPatrol SIEM с помощью консоли управления или Yandex Cloud CLI


[MaxPatrol SIEM](https://www.ptsecurity.com/ru-ru/products/mpsiem/) позволяет читать [аудитные логи](../../../audit-trails/concepts/events.md) Yandex Cloud из потока данных [Yandex Data Streams](../../index.md). Для полного прохождения руководства у вас должен быть доступ к экземпляру MaxPatrol SIEM.
...
- Консоль управления {#console}
  ...
  1. В поле **Роли в каталоге** нажмите кнопку ![plus](../../../_assets/console-icons/plus.svg) **Добавить роль** и выберите [роль](../../security/index.md#yds-writer) `yds.writer` на каталог.
  1. Нажмите кнопку **Создать**.

  Аналогичным образом создайте сервисный аккаунт `maxpatrol-reader-sa` и назначьте ему [роль](../../security/index.md#yds-viewer) `yds.viewer` на каталог.
...
- CLI {#cli}
  ...
  1. Назначьте сервисному аккаунту `maxpatrol-sa` [роль](../../security/index.md#yds-writer) `yds.writer` на каталог `example-folder`:
  ...
  1. Аналогичным образом назначьте [роль](../../security/index.md#yds-viewer) `yds.viewer` на каталог `example-folder` сервисному аккаунту `maxpatrol-reader-sa`.
...
Чтобы просмотреть логи, откройте страницу просмотра событий:
...
* [удалите](../../operations/manage-streams.md#delete-data-stream) поток данных `maxpatrol-stream`;
