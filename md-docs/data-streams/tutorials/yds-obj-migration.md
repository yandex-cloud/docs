[Документация Yandex Cloud](../../index.md) > [Yandex Data Streams](../index.md) > [Практические руководства](index.md) > Миграция данных в Yandex Object Storage с помощью Yandex Data Transfer

# Миграция данных в Yandex Object Storage с помощью Yandex Data Transfer

С помощью сервиса Data Transfer вы можете перенести данные из [потока Data Streams](../concepts/glossary.md#stream-concepts) в бакет Yandex Object Storage:
...
1. [Отправьте в поток Data Streams](../operations/aws-cli/send.md) новое сообщение:
