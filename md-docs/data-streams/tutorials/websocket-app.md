...
* [поток](../concepts/glossary.md#stream-concepts) Data Streams для передачи данных;
...
* плата за использование потока данных (см. [тарифы Yandex Data Streams](../pricing.md));
