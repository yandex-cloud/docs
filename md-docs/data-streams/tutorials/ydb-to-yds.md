[Документация Yandex Cloud](../../index.md) > [Yandex Data Streams](../index.md) > [Практические руководства](index.md) > Захват изменений YDB и поставка в YDS

# Захват изменений Yandex Managed Service for YDB и поставка в YDS
...
[Создайте поток данных приемника Data Streams](../operations/manage-streams.md#create-data-stream).
