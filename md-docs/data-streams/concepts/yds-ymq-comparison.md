...
В {{ yandex-cloud }} для обмена данными используются сервисы {{ yds-full-name }} и {{ message-queue-full-name }}.
...
Поддерживаемый протокол | [Amazon SQS API](../../message-queue/api-ref/index.md) | [Amazon Kinesis Data Streams API](../kinesisapi/api-ref.md)
С какими сервисами {{ yandex-cloud }} есть интеграция | [{{ sf-full-name }}](../../functions/index.md), [{{ api-gw-full-name }}](../../api-gateway/index.md) | [{{ sf-full-name }}](../../functions/index.md), [{{ api-gw-full-name }}](../../api-gateway/index.md), [{{ data-transfer-full-name }}](../../data-transfer/index.md)
