...
Возможна настройка потока данных таким образом, что количество сегментов будет увеличиваться при росте скорости записи в этот поток данных. Подробнее см. [автопартиционирование в документации YDB](https://ydb.tech/docs/ru//concepts/topic#partitioning).
