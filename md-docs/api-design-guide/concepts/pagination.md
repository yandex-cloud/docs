[Документация Yandex Cloud](../../index.md) > [Концепции API Yandex Cloud](../index.md) > Методы API > Пагинация
...
- `page_token` — токен страницы с результатами. Токен следующей страницы можно получить в поле `next_page_token` при получении списка ресурсов (пример ниже).
