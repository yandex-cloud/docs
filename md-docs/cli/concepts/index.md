[Документация Yandex Cloud](../../index.md) > [Интерфейс командной строки](../index.md) > Концепции > Запуск команд
...
Используйте актуальную версию CLI и дерево команд, которое сервис назначил основным. Если команды CLI вызываются из скриптов, CI/CD или других автоматизированных процессов, при переходе на новую версию CLI сначала проверьте совместимость команд. Пока прежняя версия команд доступна, вы можете [явно указывать ее в конкретных командах](../operations/command-versioning.md#use-version) или [назначить ее версией по умолчанию](../operations/command-versioning.md#default-version).

{% endnote %}

Подробнее на странице [Работа с версиями команд Yandex Cloud CLI](../operations/command-versioning.md).
