[Документация Yandex Cloud](../../index.md) > [Интерфейс командной строки](../index.md) > [Концепции](index.md) > Конфигурация CLI
...
| — | `services.<название_сервиса>.version` | Версия дерева команд сервиса, используемая по умолчанию. Подробнее в разделе [Работа с версиями команд CLI](../operations/command-versioning.md). |
