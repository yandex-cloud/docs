[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник (англ.)](../../../../index.md) > [desktops](../../index.md) > [v0](../index.md) > [group](index.md) > add-access-bindings
...
`yc desktops v0 group add-access-bindings <DESKTOP-GROUP-NAME>|<DESKTOP-GROUP-ID> [Flags...] [Global Flags...]`
