[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник (англ.)](../../../index.md) > [baremetal](../index.md) > [configuration](index.md) > get
...
`yc baremetal configuration get <CONFIGURATION-ID>`
