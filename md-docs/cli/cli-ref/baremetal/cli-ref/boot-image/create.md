[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [baremetal](../index.md) > [boot-image](index.md) > create
...
`yc baremetal boot-image create <FOLDER-ID>`
...
1. Generate template:
yc baremetal boot-image create --example-json > request.json
or
yc baremetal boot-image create --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal boot-image create -r request.json
or
yc baremetal boot-image create -r request.yaml ||
|#
