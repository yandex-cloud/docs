[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [baremetal](../../index.md) > [v1alpha](../index.md) > [private-subnet](index.md) > create

# yc baremetal v1alpha private-subnet create
...
`yc baremetal v1alpha private-subnet create <HARDWARE-POOL-ID>`
...
1. Generate template:
yc baremetal v1alpha private-subnet create --example-json > request.json
or
yc baremetal v1alpha private-subnet create --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal v1alpha private-subnet create -r request.json
or
yc baremetal v1alpha private-subnet create -r request.yaml ||
|#
