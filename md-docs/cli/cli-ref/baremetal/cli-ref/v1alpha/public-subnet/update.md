[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [baremetal](../../index.md) > [v1alpha](../index.md) > [public-subnet](index.md) > update

# yc baremetal v1alpha public-subnet update
...
`yc baremetal v1alpha public-subnet update <PUBLIC-SUBNET-ID>`
...
1. Generate template:
yc baremetal v1alpha public-subnet update --example-json > request.json
or
yc baremetal v1alpha public-subnet update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal v1alpha public-subnet update -r request.json
or
yc baremetal v1alpha public-subnet update -r request.yaml ||
|#
