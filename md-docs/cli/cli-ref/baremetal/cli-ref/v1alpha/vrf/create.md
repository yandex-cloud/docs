[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник (англ.)](../../../../index.md) > [baremetal](../../index.md) > [v1alpha](../index.md) > [vrf](index.md) > create
...
`yc baremetal v1alpha vrf create <FOLDER-ID>`
...
1. Generate template:
yc baremetal v1alpha vrf create --example-json > request.json
or
yc baremetal v1alpha vrf create --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal v1alpha vrf create -r request.json
or
yc baremetal v1alpha vrf create -r request.yaml ||
|#
