[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [baremetal](../../index.md) > [v1alpha](../index.md) > [vrf](index.md) > update

# yc baremetal v1alpha vrf update
...
`yc baremetal v1alpha vrf update <VRF-ID>`
...
1. Generate template:
yc baremetal v1alpha vrf update --example-json > request.json
or
yc baremetal v1alpha vrf update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal v1alpha vrf update -r request.json
or
yc baremetal v1alpha vrf update -r request.yaml ||
|#
