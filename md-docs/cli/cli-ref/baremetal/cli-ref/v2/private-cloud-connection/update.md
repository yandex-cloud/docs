[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник (англ.)](../../../../index.md) > [baremetal](../../index.md) > [v2](../index.md) > [private-cloud-connection](index.md) > update

# yc baremetal v2 private-cloud-connection update
...
`yc baremetal v2 private-cloud-connection update <PRIVATE-CLOUD-CONNECTION-ID>`
...
|| `--private-cloud-connection` | `shorthand/json`
...
1. Generate template:
yc baremetal v2 private-cloud-connection update --example-json > request.json
or
yc baremetal v2 private-cloud-connection update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal v2 private-cloud-connection update -r request.json
or
yc baremetal v2 private-cloud-connection update -r request.yaml ||
|#
