[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [baremetal](../../index.md) > [v2](../index.md) > [server](index.md) > create

# yc baremetal v2 server create
...
`yc baremetal v2 server create <CLOUD-ID>`
...
1. Generate template:
yc baremetal v2 server create --example-json > request.json
or
yc baremetal v2 server create --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal v2 server create -r request.json
or
yc baremetal v2 server create -r request.yaml ||
|#
