[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [baremetal](../../index.md) > [v2](../index.md) > [public-prefix-pool](index.md) > update

# yc baremetal v2 public-prefix-pool update
...
`yc baremetal v2 public-prefix-pool update <PUBLIC-PREFIX-POOL-ID>`
...
|| `--public-prefix-pool` | `shorthand/json`
...
1. Generate template:
yc baremetal v2 public-prefix-pool update --example-json > request.json
or
yc baremetal v2 public-prefix-pool update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal v2 public-prefix-pool update -r request.json
or
yc baremetal v2 public-prefix-pool update -r request.yaml ||
|#
