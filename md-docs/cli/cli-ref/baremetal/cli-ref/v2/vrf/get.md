[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [baremetal](../../index.md) > [v2](../index.md) > [vrf](index.md) > get

# yc baremetal v2 vrf get
...
`yc baremetal v2 vrf get <VRF-ID>`
...
ID of the VRF to return. To get the VRF ID, use a [VrfService.List] request. ||
|#
