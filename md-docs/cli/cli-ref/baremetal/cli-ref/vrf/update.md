[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник (англ.)](../../../index.md) > [baremetal](../index.md) > [vrf](index.md) > update
...
`yc baremetal vrf update <VRF-ID>`
...
ID of the VRF to update. To get the VRF ID, use a [VrfService.List] request. ||
|| `--name` | `string`
...
1. Generate template:
yc baremetal vrf update --example-json > request.json
or
yc baremetal vrf update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal vrf update -r request.json
or
yc baremetal vrf update -r request.yaml ||
|#
