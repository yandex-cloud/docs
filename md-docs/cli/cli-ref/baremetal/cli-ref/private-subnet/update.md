[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [baremetal](../index.md) > [private-subnet](index.md) > update
...
`yc baremetal private-subnet update <PRIVATE-SUBNET-ID>`
...
1. Generate template:
yc baremetal private-subnet update --example-json > request.json
or
yc baremetal private-subnet update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal private-subnet update -r request.json
or
yc baremetal private-subnet update -r request.yaml ||
|#
