[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник (англ.)](../../../index.md) > [baremetal](../index.md) > [public-subnet](index.md) > create
...
`yc baremetal public-subnet create <FOLDER-ID>`
...
1. Generate template:
yc baremetal public-subnet create --example-json > request.json
or
yc baremetal public-subnet create --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal public-subnet create -r request.json
or
yc baremetal public-subnet create -r request.yaml ||
|#
