[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [baremetal](../index.md) > [public-subnet](index.md) > update
...
`yc baremetal public-subnet update <PUBLIC-SUBNET-ID>`
...
Type of the public subnet. Possible Values: 'dedicated', 'ephemeral' ||
...
1. Generate template:
yc baremetal public-subnet update --example-json > request.json
or
yc baremetal public-subnet update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal public-subnet update -r request.json
or
yc baremetal public-subnet update -r request.yaml ||
|#
