[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник (англ.)](../../../../index.md) > [application-load-balancer](../../index.md) > [v0](../index.md) > [load-balancer](index.md) > update-listener
...
`yc application-load-balancer v0 load-balancer update-listener <LOAD-BALANCER-NAME>|<LOAD-BALANCER-ID> [Flags...] [Global Flags...]`
