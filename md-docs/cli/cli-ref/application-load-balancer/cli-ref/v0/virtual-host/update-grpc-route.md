[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник (англ.)](../../../../index.md) > [application-load-balancer](../../index.md) > [v0](../index.md) > [virtual-host](index.md) > update-grpc-route
...
`yc application-load-balancer v0 virtual-host update-grpc-route <ROUTE-NAME> [Flags...] [Global Flags...]`
