 ...
 * [Удалить бэкенд из группы](../../../../application-load-balancer/operations/backend-group-update.md#cli_4)
 * [Получить список операций](../../../../application-load-balancer/operations/operation-logs.md#cli_1)