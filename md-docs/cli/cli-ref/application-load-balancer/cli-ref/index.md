[Документация Yandex Cloud](../../../../index.md) > [Интерфейс командной строки](../../../index.md) > [Справочник (англ.)](../../index.md) > application-load-balancer > Overview

# yc application-load-balancer

Manage Yandex Application Load Balancer resources

Command tree v0 is the default. Run `yc application-load-balancer <command>` or `yc application-load-balancer v0 <command>`.
