 ...
 * [Создать HTTP-роутер для gRPC-трафика](../../../../../application-load-balancer/operations/http-router-create-grpc.md#cli_1)
 * [Создать HTTP-роутер для HTTP-трафика](../../../../../application-load-balancer/operations/http-router-create.md#cli_1)
 * [Создать виртуальный хост](../../../../../application-load-balancer/operations/manage-virtual-hosts.md#cli_1)