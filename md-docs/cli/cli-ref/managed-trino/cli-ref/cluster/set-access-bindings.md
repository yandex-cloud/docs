[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [managed-trino](../index.md) > [cluster](index.md) > set-access-bindings

# yc managed-trino cluster set-access-bindings

Set access bindings for the specified Trino cluster and delete all existing access bindings if there were any

#### Command Usage

Syntax:

`yc managed-trino cluster set-access-bindings <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
