[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [cloud-registry](../index.md) > [artifact](index.md) > list

# yc cloud-registry artifact list
...
1. Generate template:
yc cloud-registry artifact list --example-json > request.json
or
yc cloud-registry artifact list --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc cloud-registry artifact list -r request.json
or
yc cloud-registry artifact list -r request.yaml ||
|#
