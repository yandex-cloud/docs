[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [cloud-registry](../index.md) > [artifact](index.md) > remove-access-binding
...
`yc cloud-registry artifact remove-access-binding <ARTIFACT-ID>`
...
1. Generate template:
yc cloud-registry artifact remove-access-binding --example-json > request.json
or
yc cloud-registry artifact remove-access-binding --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc cloud-registry artifact remove-access-binding -r request.json
or
yc cloud-registry artifact remove-access-binding -r request.yaml ||
|#
