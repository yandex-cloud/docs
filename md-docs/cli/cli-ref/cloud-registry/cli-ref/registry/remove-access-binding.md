[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [cloud-registry](../index.md) > [registry](index.md) > remove-access-binding
...
`yc cloud-registry registry remove-access-binding <REGISTRY-NAME>|<REGISTRY-ID>`
...
1. Generate template:
yc cloud-registry registry remove-access-binding --example-json > request.json
or
yc cloud-registry registry remove-access-binding --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc cloud-registry registry remove-access-binding -r request.json
or
yc cloud-registry registry remove-access-binding -r request.yaml ||
|#
