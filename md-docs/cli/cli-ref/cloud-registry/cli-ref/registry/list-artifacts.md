[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник (англ.)](../../../index.md) > [cloud-registry](../index.md) > [registry](index.md) > list-artifacts
...
`yc cloud-registry registry list-artifacts <REGISTRY-ID>`
