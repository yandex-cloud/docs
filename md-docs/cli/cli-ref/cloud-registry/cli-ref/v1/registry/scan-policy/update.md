[Документация Yandex Cloud](../../../../../../../index.md) > [Интерфейс командной строки](../../../../../../index.md) > [Справочник (англ.)](../../../../../index.md) > [cloud-registry](../../../index.md) > [v1](../../index.md) > [registry](../index.md) > [scan-policy](index.md) > update

# yc cloud-registry v1 registry scan-policy update

Update the specified scan policy.

#### Command Usage

Syntax:

`yc cloud-registry v1 registry scan-policy update <SCAN-POLICY-ID>`
...
1. Generate template:
yc cloud-registry v1 registry scan-policy update --example-json > request.json
or
yc cloud-registry v1 registry scan-policy update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc cloud-registry v1 registry scan-policy update -r request.json
or
yc cloud-registry v1 registry scan-policy update -r request.yaml ||
|#
