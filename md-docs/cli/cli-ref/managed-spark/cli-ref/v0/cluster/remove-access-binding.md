[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [managed-spark](../../index.md) > [v0](../index.md) > [cluster](index.md) > remove-access-binding

# yc managed-spark v0 cluster remove-access-binding

Remove access binding for the specified Spark cluster

#### Command Usage

Syntax:

`yc managed-spark cluster remove-access-binding <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
