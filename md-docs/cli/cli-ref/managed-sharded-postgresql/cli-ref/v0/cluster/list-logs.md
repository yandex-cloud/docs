[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [managed-sharded-postgresql](../../index.md) > [v0](../index.md) > [cluster](index.md) > list-logs

# yc managed-sharded-postgresql v0 cluster list-logs
...
Type of the service to request logs about. Values: 'postgresql', 'router', 'coordinator', 'infra' ||
|| `--columns` | `value[,value]`
