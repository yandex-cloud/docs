[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [managed-kubernetes](../../index.md) > [v0](../index.md) > [cluster](index.md) > set-access-bindings

# yc managed-kubernetes v0 cluster set-access-bindings

Set access bindings for the specified Kubernetes cluster and delete all existing access bindings if there were any

#### Command Usage

Syntax:

`yc managed-kubernetes cluster set-access-bindings <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
