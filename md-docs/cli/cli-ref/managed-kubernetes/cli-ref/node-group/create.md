 ...
 * [Настройка автоматического масштабирования кластера](../../../../../managed-kubernetes/operations/autoscale.md#cli_1)
 * [Группы безопасности для кластера Managed Service for Kubernetes](../../../../../managed-kubernetes/operations/connect/security-groups.md#cli_1)
 * [Создайте группу узлов и добавьте публичный ключ](../../../../../managed-kubernetes/operations/node-connect-ssh.md#cli_1)
 * [Создать группу узлов в трех зонах доступности с узлами из пулов резервов ВМ в каждой зоне](../../../../../managed-kubernetes/operations/node-group/node-group-create-in-instance-pool.md#cli_2)
 * [Создание группы узлов](../../../../../managed-kubernetes/operations/node-group/node-group-create.md#cli_1)
 * [Назначить Kubernetes-метки при создании группы узлов](../../../../../managed-kubernetes/operations/node-group/node-label-management.md#cli_1)