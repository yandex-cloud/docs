[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [kms](../index.md) > [asymmetric-encryption-key](index.md) > add-access-binding

# yc kms asymmetric-encryption-key add-access-binding

Add access binding for the specified asymmetric encryption key

#### Command Usage

Syntax:

`yc kms asymmetric-encryption-key add-access-binding <ASYMMETRIC-ENCRYPTION-KEY> [Flags...] [Global Flags...]`
