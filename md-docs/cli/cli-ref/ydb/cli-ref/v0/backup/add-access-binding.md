[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [ydb](../../index.md) > [v0](../index.md) > [backup](index.md) > add-access-binding

# yc ydb v0 backup add-access-binding

Add access binding for the specified YDB backup.

#### Command Usage

Syntax:

`yc ydb backup add-access-binding <BACKUP-ID> [Flags...] [Global Flags...]`
