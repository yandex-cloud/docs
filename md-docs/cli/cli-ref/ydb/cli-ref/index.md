[Документация Yandex Cloud](../../../../index.md) > [Интерфейс командной строки](../../../index.md) > [Справочник (англ.)](../../index.md) > ydb > Overview

# yc ydb

Manage YDB databases

Command tree v0 is the default. Run `yc ydb <command>` or `yc ydb v0 <command>`.
