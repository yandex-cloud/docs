 ...
 * [Изменить параметры Serverless базы данных](../../../../../ydb/operations/manage-databases.md#cli_2)
 * [Миграция базы данных YDB в другую зону доступности](../../../../../ydb/operations/migration-to-an-availability-zone.md#cli_1)