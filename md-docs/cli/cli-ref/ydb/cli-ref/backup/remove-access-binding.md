[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [ydb](../index.md) > [backup](index.md) > remove-access-binding
...
`yc ydb backup remove-access-binding <BACKUP-ID> [Flags...] [Global Flags...]`
