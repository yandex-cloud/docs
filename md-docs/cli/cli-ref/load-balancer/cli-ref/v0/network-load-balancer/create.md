[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник (англ.)](../../../../index.md) > [load-balancer](../../index.md) > [v0](../index.md) > [network-load-balancer](index.md) > create
...
`yc load-balancer v0 network-load-balancer create <LOAD-BALANCER-NAME> [Flags...] [Global Flags...]`
