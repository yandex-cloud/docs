 ...
 * [Включить защиту от удаления](../../../../../network-load-balancer/operations/deletion-protection.md#cli_1)
 * [Изменить имя и описание балансировщика](../../../../../network-load-balancer/operations/load-balancer-update.md#cli_1)
 * [Разрешить перенос трафика](../../../../../network-load-balancer/operations/manage-zone/allow-and-deny-shift.md#cli_1)