[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [smartwebsecurity](../../index.md) > [match-list](../index.md) > [match-list](index.md) > update

# yc smartwebsecurity match-list match-list update
...
`yc smartwebsecurity match-list match-list update <LIST-ID>`
...
1. Generate template:
yc smartwebsecurity match-list match-list update --example-json > request.json
or
yc smartwebsecurity match-list match-list update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc smartwebsecurity match-list match-list update -r request.json
or
yc smartwebsecurity match-list match-list update -r request.yaml ||
|#
