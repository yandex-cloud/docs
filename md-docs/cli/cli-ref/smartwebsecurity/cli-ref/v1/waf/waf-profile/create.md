[Документация Yandex Cloud](../../../../../../../index.md) > [Интерфейс командной строки](../../../../../../index.md) > [Справочник CLI (англ.)](../../../../../index.md) > [smartwebsecurity](../../../index.md) > [v1](../../index.md) > [waf](../index.md) > [waf-profile](index.md) > create

# yc smartwebsecurity v1 waf waf-profile create
...
`yc smartwebsecurity v1 waf waf-profile create <FOLDER-ID>`
...
1. Generate template:
yc smartwebsecurity v1 waf waf-profile create --example-json > request.json
or
yc smartwebsecurity v1 waf waf-profile create --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc smartwebsecurity v1 waf waf-profile create -r request.json
or
yc smartwebsecurity v1 waf waf-profile create -r request.yaml ||
|#
