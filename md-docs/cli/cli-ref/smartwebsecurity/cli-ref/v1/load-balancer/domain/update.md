[Документация Yandex Cloud](../../../../../../../index.md) > [Интерфейс командной строки](../../../../../../index.md) > [Справочник (англ.)](../../../../../index.md) > [smartwebsecurity](../../../index.md) > [v1](../../index.md) > [load-balancer](../index.md) > [domain](index.md) > update

# yc smartwebsecurity v1 load-balancer domain update
...
`yc smartwebsecurity v1 load-balancer domain update <LOAD-BALANCER-ID>`
...
1. Generate template:
yc smartwebsecurity v1 load-balancer domain update --example-json > request.json
or
yc smartwebsecurity v1 load-balancer domain update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc smartwebsecurity v1 load-balancer domain update -r request.json
or
yc smartwebsecurity v1 load-balancer domain update -r request.yaml ||
|#
