[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник (англ.)](../../../../index.md) > [smartwebsecurity](../../index.md) > [load-balancer](../index.md) > [load-balancer](index.md) > update

# yc smartwebsecurity load-balancer load-balancer update
...
`yc smartwebsecurity load-balancer load-balancer update <LOAD-BALANCER-ID>`
...
1. Generate template:
yc smartwebsecurity load-balancer load-balancer update --example-json > request.json
or
yc smartwebsecurity load-balancer load-balancer update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc smartwebsecurity load-balancer load-balancer update -r request.json
or
yc smartwebsecurity load-balancer load-balancer update -r request.yaml ||
|#
