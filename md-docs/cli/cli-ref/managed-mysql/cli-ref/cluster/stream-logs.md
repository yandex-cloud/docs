[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [managed-mysql](../index.md) > [cluster](index.md) > stream-logs

# yc managed-mysql cluster stream-logs

Stream logs for the specified MySQL cluster

#### Command Usage

Syntax:

`yc managed-mysql cluster stream-logs <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
