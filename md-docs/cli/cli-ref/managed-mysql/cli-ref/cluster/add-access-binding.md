[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [managed-mysql](../index.md) > [cluster](index.md) > add-access-binding

# yc managed-mysql cluster add-access-binding

Add access binding for the specified MySQL cluster

#### Command Usage

Syntax:

`yc managed-mysql cluster add-access-binding <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
