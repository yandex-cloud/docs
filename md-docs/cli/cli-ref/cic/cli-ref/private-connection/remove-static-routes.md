[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник (англ.)](../../../index.md) > [cic](../index.md) > [private-connection](index.md) > remove-static-routes
...
`yc cic private-connection remove-static-routes <PRIVATE-CONNECTION-NAME>|<PRIVATE-CONNECTION-ID>`
