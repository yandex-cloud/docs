[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник (англ.)](../../../../index.md) > [cic](../../index.md) > [v1](../index.md) > [private-connection](index.md) > move
...
`yc cic v1 private-connection move <PRIVATE-CONNECTION-ID>`
...
1. Generate template:
yc cic v1 private-connection move --example-json > request.json
or
yc cic v1 private-connection move --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc cic v1 private-connection move -r request.json
or
yc cic v1 private-connection move -r request.yaml ||
|#
