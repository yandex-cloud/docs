[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник (англ.)](../../../../index.md) > [managed-redis](../../index.md) > [v0](../index.md) > [cluster](index.md) > update-config

# yc managed-redis v0 cluster update-config
...
Service for Valkey [host class](../../../../../../managed-valkey/concepts/instance-types.md).
...
- `repl_backlog_size_percent`: Replication backlog size as a percentage of the host RAM.
...
- `aof_max_size_percent`: AOF maximum size as a percentage of the host disk size.
