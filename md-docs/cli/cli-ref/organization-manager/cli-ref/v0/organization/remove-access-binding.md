[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [organization-manager](../../index.md) > [v0](../index.md) > [organization](index.md) > remove-access-binding

# yc organization-manager v0 organization remove-access-binding
...
`yc organization-manager organization remove-access-binding <ORGANIZATION-NAME>|<ORGANIZATION-ID> [Flags...] [Global Flags...]`
