[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [organization-manager](../../index.md) > [v0](../index.md) > [organization](index.md) > set-access-bindings
...
`yc organization-manager organization set-access-bindings <ORGANIZATION-NAME>|<ORGANIZATION-ID> [Flags...] [Global Flags...]`
