[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [organization-manager](../../index.md) > [v0](../index.md) > [group](index.md) > set-access-bindings

# yc organization-manager v0 group set-access-bindings
...
`yc organization-manager group set-access-bindings <GROUP-NAME>|<GROUP-ID> [Flags...] [Global Flags...]`
