[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [container](../index.md) > [repository](index.md) > add-access-binding

# yc container repository add-access-binding

Add access binding for the specified repository

#### Command Usage

Syntax:

`yc container repository add-access-binding <REPOSITORY-NAME>|<REPOSITORY-ID> [Flags...] [Global Flags...]`
