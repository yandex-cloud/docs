[Документация Yandex Cloud](../../../../index.md) > [Интерфейс командной строки](../../../index.md) > [Справочник (англ.)](../../index.md) > managed-postgresql > Overview
...
- [yc managed-postgresql cluster](cluster/index.md) — Manage PostgreSQL clusters
  ...
  - [yc managed-postgresql cluster stream-logs](cluster/stream-logs.md) — Stream logs for the specified PostgreSQL cluster
