[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [managed-postgresql](../../index.md) > [v0](../index.md) > [cluster](index.md) > remove-access-binding

# yc managed-postgresql v0 cluster remove-access-binding

Remove access binding for the specified PostgreSQL cluster

#### Command Usage

Syntax:

`yc managed-postgresql cluster remove-access-binding <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
