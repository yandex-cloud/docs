[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [config](../index.md) > v0 > Overview
...
`yc config v0 <group|command>`

#### Command Tree

- [yc config v0 get](get.md) — Get value for the specified configuration property

- [yc config v0 list](list.md) — List configuration values

- [yc config v0 set](set.md) — Set value for the specified configuration property

- [yc config v0 unset](unset.md) — Unset value for the specified configuration property

- [yc config v0 profile](profile/index.md) — Manage configuration profiles

  - [yc config v0 profile activate](profile/activate.md) — Activate the specified configuration profile

  - [yc config v0 profile create](profile/create.md) — Create a configuration profile

  - [yc config v0 profile delete](profile/delete.md) — Delete the specified configuration profile

  - [yc config v0 profile get](profile/get.md) — List values for the specified configuration profile

  - [yc config v0 profile list](profile/list.md) — List configuration profiles
