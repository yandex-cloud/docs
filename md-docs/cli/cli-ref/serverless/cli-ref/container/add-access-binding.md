[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [serverless](../index.md) > [container](index.md) > add-access-binding
...
`yc serverless container add-access-binding <CONTAINER-NAME>|<CONTAINER-ID> [Flags...] [Global Flags...]`
