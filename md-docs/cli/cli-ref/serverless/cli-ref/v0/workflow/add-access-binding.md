[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [serverless](../../index.md) > [v0](../index.md) > [workflow](index.md) > add-access-binding

# yc serverless v0 workflow add-access-binding

Add access binding for the specified Workflow

#### Command Usage

Syntax:

`yc serverless workflow add-access-binding <WORKFLOW-NAME>|<WORKFLOW-ID> [Flags...] [Global Flags...]`
