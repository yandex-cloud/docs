[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [serverless](../../index.md) > [v0](../index.md) > [workflow](index.md) > remove-access-binding

# yc serverless v0 workflow remove-access-binding
...
`yc serverless workflow remove-access-binding <WORKFLOW-NAME>|<WORKFLOW-ID> [Flags...] [Global Flags...]`
