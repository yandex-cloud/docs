[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [serverless](../../index.md) > [v0](../index.md) > [mcp-gateway](index.md) > add-access-binding

# yc serverless v0 mcp-gateway add-access-binding

Add access binding for the specified MCP Gateway

#### Command Usage

Syntax:

`yc serverless mcp-gateway add-access-binding <MCP-GATEWAY-NAME>|<MCP-GATEWAY-ID> [Flags...] [Global Flags...]`
