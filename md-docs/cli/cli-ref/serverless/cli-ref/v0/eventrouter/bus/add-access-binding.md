[Документация Yandex Cloud](../../../../../../../index.md) > [Интерфейс командной строки](../../../../../../index.md) > [Справочник CLI (англ.)](../../../../../index.md) > [serverless](../../../index.md) > [v0](../../index.md) > [eventrouter](../index.md) > [bus](index.md) > add-access-binding

# yc serverless v0 eventrouter bus add-access-binding

Add access binding for the specified bus

#### Command Usage

Syntax:

`yc serverless eventrouter bus add-access-binding <BUS-NAME>|<BUS-ID> [Flags...] [Global Flags...]`
