[Документация Yandex Cloud](../../../../../../../index.md) > [Интерфейс командной строки](../../../../../../index.md) > [Справочник CLI (англ.)](../../../../../index.md) > [serverless](../../../index.md) > [v0](../../index.md) > [eventrouter](../index.md) > [rule](index.md) > add-access-binding

# yc serverless v0 eventrouter rule add-access-binding

Add access binding for the specified rule

#### Command Usage

Syntax:

`yc serverless eventrouter rule add-access-binding <RULE-NAME>|<RULE-ID> [Flags...] [Global Flags...]`
