[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [serverless](../../index.md) > [v0](../index.md) > [function](index.md) > add-access-binding

# yc serverless v0 function add-access-binding

Add access binding for the specified function

#### Command Usage

Syntax:

`yc serverless function add-access-binding <FUNCTION-NAME>|<FUNCTION-ID> [Flags...] [Global Flags...]`
