[Документация Yandex Cloud](../../../../../../../index.md) > [Интерфейс командной строки](../../../../../../index.md) > [Справочник CLI (англ.)](../../../../../index.md) > [serverless](../../../index.md) > [v0](../../index.md) > [trigger](../index.md) > [update](index.md) > yds

# yc serverless v0 trigger update yds
...
Data Stream name. ||
|| `--new-stream-service-account-id` | `string`

Service account to be used by the worker to access the Data Stream. ||
|| `--new-stream-service-account-name` | `string`

Service account to be used by the worker to access the Data Stream. ||
|| `--new-batch-size` | `byteSize`
...
Gateway to which worker will broadcast the data from Data Stream. ||
