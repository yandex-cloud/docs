[Документация Yandex Cloud](../../../../../../../../index.md) > [Интерфейс командной строки](../../../../../../../index.md) > [Справочник (англ.)](../../../../../../index.md) > [serverless](../../../../index.md) > [v0](../../../index.md) > [trigger](../../index.md) > [v1](../index.md) > [update](index.md) > logging

# yc serverless v0 trigger v1 update logging
...
`yc serverless trigger v1 update logging <TRIGGER-NAME> [Flags...] [Global Flags...]`
...
Gateway to which worker will broadcast the data from Logging ||
...
Workflow to be started on the Logging event. ||
