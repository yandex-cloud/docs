[Документация Yandex Cloud](../../../../../../../../index.md) > [Интерфейс командной строки](../../../../../../../index.md) > [Справочник (англ.)](../../../../../../index.md) > [serverless](../../../../index.md) > [v0](../../../index.md) > [trigger](../../index.md) > [v1](../index.md) > [create](index.md) > billing-budget

# yc serverless v0 trigger v1 create billing-budget
...
`yc serverless trigger v1 create billing-budget <TRIGGER-NAME> [Flags...] [Global Flags...]`
...
Gateway to which worker will broadcast on the data from Billing. ||
|| `--gateway-name` | `string`
