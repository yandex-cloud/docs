[Документация Yandex Cloud](../../../../../../../../index.md) > [Интерфейс командной строки](../../../../../../../index.md) > [Справочник (англ.)](../../../../../../index.md) > [serverless](../../../../index.md) > [v0](../../../index.md) > [trigger](../../index.md) > [v1](../index.md) > [create](index.md) > object-storage

# yc serverless v0 trigger v1 create object-storage
...
`yc serverless trigger v1 create object-storage <TRIGGER-NAME> [Flags...] [Global Flags...]`
...
Gateway to be broadcasted to by worker on the data from Object Storage. ||
|| `--gateway-name` | `string`
...
Workflow to be started by worker on Object Storage events. ||
