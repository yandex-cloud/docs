[Документация Yandex Cloud](../../../../../../../../index.md) > [Интерфейс командной строки](../../../../../../../index.md) > [Справочник (англ.)](../../../../../../index.md) > [serverless](../../../../index.md) > [v0](../../../index.md) > [trigger](../../index.md) > [v1](../index.md) > [update](index.md) > container-registry

# yc serverless v0 trigger v1 update container-registry
...
`yc serverless trigger v1 update container-registry <TRIGGER-NAME> [Flags...] [Global Flags...]`
...
Gateway to which worker will broadcast the data from Container Registry. ||
...
Workflow to be started on the Container Registry event. ||
