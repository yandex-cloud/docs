[Документация Yandex Cloud](../../../../../../../../index.md) > [Интерфейс командной строки](../../../../../../../index.md) > [Справочник (англ.)](../../../../../../index.md) > [serverless](../../../../index.md) > [v0](../../../index.md) > [trigger](../../index.md) > [v1](../index.md) > [create](index.md) > timer

# yc serverless v0 trigger v1 create timer
...
`yc serverless trigger v1 create timer <TRIGGER-NAME> [Flags...] [Global Flags...]`
...
Timer cron expression. Example: '0/1 * * * ? *'. ||
|| `--payload` | `string`

Payload that will be passed with the timer event. ||
|| `--invoke-function-id` | `string`

Function to be invoked by worker on each Timer event. ||
...
Container to be invoked by worker on each Timer event. ||
...
Gateway to which worker will broadcast on each Timer event. ||
|| `--gateway-name` | `string`
...
Workflow to be started by worker on each Timer event. ||
