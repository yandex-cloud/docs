[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [serverless](../../index.md) > [v0](../index.md) > [api-gateway](index.md) > set-access-bindings

# yc serverless v0 api-gateway set-access-bindings
...
`yc serverless api-gateway set-access-bindings <API-GATEWAY-NAME>|<API-GATEWAY-ID> [Flags...] [Global Flags...]`
