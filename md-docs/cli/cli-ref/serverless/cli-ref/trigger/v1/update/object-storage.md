[Документация Yandex Cloud](../../../../../../../index.md) > [Интерфейс командной строки](../../../../../../index.md) > [Справочник (англ.)](../../../../../index.md) > [serverless](../../../index.md) > [trigger](../../index.md) > [v1](../index.md) > [update](index.md) > object-storage

# yc serverless trigger v1 update object-storage
...
`yc serverless trigger v1 update object-storage <TRIGGER-NAME> [Flags...] [Global Flags...]`
...
|| `--new-events` | `value[,value]`

List of object storage events to subscribe. A list can be specified by listing events separated by commas as well as passing this flag multiple times.
Available events are: 'create-object' , 'delete-object', 'update-object'. ||
|| `--new-batch-size` | `int`
...
Function to be invoked by worker on the data from Object Storage. ||
...
Container to be invoked by worker on the data from Object Storage. ||
...
Gateway to which worker will broadcast the data from Object Storage. ||
...
Workflow to be started on the Object Storage event. ||
