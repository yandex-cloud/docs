[Документация Yandex Cloud](../../../../../../../index.md) > [Интерфейс командной строки](../../../../../../index.md) > [Справочник (англ.)](../../../../../index.md) > [serverless](../../../index.md) > [trigger](../../index.md) > [v1](../index.md) > [update](index.md) > billing-budget

# yc serverless trigger v1 update billing-budget
...
`yc serverless trigger v1 update billing-budget <TRIGGER-NAME> [Flags...] [Global Flags...]`
...
|| `--new-billing-account-id` | `string`

Billing account ID to subscribe. ||
|| `--new-budget-id` | `string`
...
Gateway to which worker will broadcast the data from billing. ||
...
Workflow to be started on the Billing event. ||
