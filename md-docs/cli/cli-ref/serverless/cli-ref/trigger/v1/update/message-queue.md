[Документация Yandex Cloud](../../../../../../../index.md) > [Интерфейс командной строки](../../../../../../index.md) > [Справочник (англ.)](../../../../../index.md) > [serverless](../../../index.md) > [trigger](../../index.md) > [v1](../index.md) > [update](index.md) > message-queue

# yc serverless trigger v1 update message-queue
...
`yc serverless trigger v1 update message-queue <TRIGGER-NAME> [Flags...] [Global Flags...]`
...
|| `--new-queue-service-account-id` | `string`

Service account to be used by the worker to access the Message Queue. ||
|| `--new-queue-service-account-name` | `string`
...
Batch cutoff. 0 - 20s. Default: 10s. ||
|| `--new-invoke-function-id` | `string`

Function to be invoked by worker on each YMQ Message. ||
...
Container to be invoked by worker on each YMQ Message. ||
...
Gateway to which worker will broadcast on each YMQ Message. ||
