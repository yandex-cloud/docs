[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [serverless](../../index.md) > [eventrouter](../index.md) > [bus](index.md) > set-access-bindings

# yc serverless eventrouter bus set-access-bindings

Set access bindings for the specified bus and delete all existing access bindings if there were any

#### Command Usage

Syntax:

`yc serverless eventrouter bus set-access-bindings <BUS-NAME>|<BUS-ID> [Flags...] [Global Flags...]`
