[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [serverless](../index.md) > [mcp-gateway](index.md) > remove-access-binding

# yc serverless mcp-gateway remove-access-binding

Remove access binding for the specified MCP Gateway

#### Command Usage

Syntax:

`yc serverless mcp-gateway remove-access-binding <MCP-GATEWAY-NAME>|<MCP-GATEWAY-ID> [Flags...] [Global Flags...]`
