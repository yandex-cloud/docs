[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [serverless](../index.md) > [function](index.md) > remove-access-binding

# yc serverless function remove-access-binding

Remove access binding for the specified function

#### Command Usage

Syntax:

`yc serverless function remove-access-binding <FUNCTION-NAME>|<FUNCTION-ID> [Flags...] [Global Flags...]`
