[Документация Yandex Cloud](../../../../index.md) > [Интерфейс командной строки](../../../index.md) > [Справочник (англ.)](../../index.md) > quota-manager > Overview

# yc quota-manager

Manage Yandex Quota Manager resources

Command tree v0 is the default. Run `yc quota-manager <command>` or `yc quota-manager v0 <command>`.
