[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник (англ.)](../../../../index.md) > [managed-zonalshift](../../index.md) > [v0](../index.md) > [config](index.md) > create

# yc managed-zonalshift v0 config create

Create a zonal shift configuration.

#### Command Usage

Syntax:

`yc managed-zonalshift config create [Flags...] [Global Flags...]`
