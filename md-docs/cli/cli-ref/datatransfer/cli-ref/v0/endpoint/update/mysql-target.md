[Документация Yandex Cloud](../../../../../../../index.md) > [Интерфейс командной строки](../../../../../../index.md) > [Справочник CLI (англ.)](../../../../../index.md) > [datatransfer](../../../index.md) > [v0](../../index.md) > [endpoint](../index.md) > [update](index.md) > mysql-target

# yc datatransfer v0 endpoint update mysql-target
...
For parsing timestamps for saving source timezones. Accepts values from IANA timezone database. Default: local timezone ||
