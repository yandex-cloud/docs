[Документация Yandex Cloud](../../../../../../../index.md) > [Интерфейс командной строки](../../../../../../index.md) > [Справочник CLI (англ.)](../../../../../index.md) > [datatransfer](../../../index.md) > [v0](../../index.md) > [endpoint](../index.md) > [create](index.md) > postgres-target
...
Yandex Managed PostgreSQL cluster ID ||
|| `--host` | `value[,value]`
