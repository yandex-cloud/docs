[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [managed-kafka](../index.md) > [cluster](index.md) > add-access-binding

# yc managed-kafka cluster add-access-binding

Add access binding for the specified Kafka cluster

#### Command Usage

Syntax:

`yc managed-kafka cluster add-access-binding <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
