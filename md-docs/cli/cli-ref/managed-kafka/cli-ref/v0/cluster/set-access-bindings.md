[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [managed-kafka](../../index.md) > [v0](../index.md) > [cluster](index.md) > set-access-bindings

# yc managed-kafka v0 cluster set-access-bindings

Set access bindings for the specified Kafka cluster and delete all existing access bindings if there were any

#### Command Usage

Syntax:

`yc managed-kafka cluster set-access-bindings <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
