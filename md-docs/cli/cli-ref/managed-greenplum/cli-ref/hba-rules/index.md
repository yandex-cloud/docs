[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник (англ.)](../../../index.md) > [managed-greenplum](../index.md) > hba-rules > Overview
...
- [yc managed-greenplum hba-rules batch-update](batch-update.md) — Replace all hba-rules for specified Greenplum cluster
