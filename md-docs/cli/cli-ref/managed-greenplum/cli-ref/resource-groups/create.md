[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [managed-greenplum](../index.md) > [resource-groups](index.md) > create
...
`yc managed-greenplum resource-groups create <RESOURCE-GROUP-NAME> [Flags...]`
