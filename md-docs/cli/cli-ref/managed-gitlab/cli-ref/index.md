[Документация Yandex Cloud](../../../../index.md) > [Интерфейс командной строки](../../../index.md) > [Справочник (англ.)](../../index.md) > managed-gitlab > Overview

# yc managed-gitlab

Manage Gitlab resources.

Command tree v0 is the default. Run `yc managed-gitlab <command>` or `yc managed-gitlab v0 <command>`.
