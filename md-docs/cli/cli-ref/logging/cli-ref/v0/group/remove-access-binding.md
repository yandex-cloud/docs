[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник (англ.)](../../../../index.md) > [logging](../../index.md) > [v0](../index.md) > [group](index.md) > remove-access-binding
...
`yc logging v0 group remove-access-binding <LOG-GROUP-NAME>|<LOG-GROUP-ID> [Flags...] [Global Flags...]`
