[Документация Yandex Cloud](../../../../index.md) > [Интерфейс командной строки](../../../index.md) > [Справочник (англ.)](../../index.md) > backup > Overview

# yc backup

Manage Yandex Cloud Backup resources

Command tree v0 is the default. Run `yc backup <command>` or `yc backup v0 <command>`.
