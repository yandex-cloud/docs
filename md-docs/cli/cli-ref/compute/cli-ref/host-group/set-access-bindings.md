[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [compute](../index.md) > [host-group](index.md) > set-access-bindings

# yc compute host-group set-access-bindings
...
`yc compute host-group set-access-bindings <HOST-GROUP-NAME>|<HOST-GROUP-ID> [Flags...] [Global Flags...]`
