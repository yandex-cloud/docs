[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [compute](../index.md) > [gpu-cluster](index.md) > add-access-binding

# yc compute gpu-cluster add-access-binding

Add access binding for the specified GPU cluster

#### Command Usage

Syntax:

`yc compute gpu-cluster add-access-binding <GPU-CLUSTER-NAME>|<GPU-CLUSTER-ID> [Flags...] [Global Flags...]`
