[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [compute](../index.md) > [placement-group](index.md) > remove-access-binding

# yc compute placement-group remove-access-binding

Remove access binding for the specified placement group

#### Command Usage

Syntax:

`yc compute placement-group remove-access-binding <PLACEMENT-GROUP-NAME>|<PLACEMENT-GROUP-ID> [Flags...] [Global Flags...]`
