 ...
 * [Создать группу виртуальных машин по спецификации в формате YAML](../../../../../compute/operations/instance-groups/create-from-yaml.md#cli_1)
 * [Создать группу в одной зоне доступности с ВМ из пула резервов этой зоны](../../../../../compute/operations/instance-groups/create-group-with-pool.md#cli_1)
 ...
 * [Создать группу ВМ с Container Optimized Image](../../../../../compute/operations/instance-groups/create-with-coi.md#cli_1)
