[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [compute](../../index.md) > [v0](../index.md) > [filesystem](index.md) > remove-access-binding

# yc compute v0 filesystem remove-access-binding

Remove access binding for the specified filesystem

#### Command Usage

Syntax:

`yc compute filesystem remove-access-binding <FILESYSTEM-NAME>|<FILESYSTEM-ID> [Flags...] [Global Flags...]`
