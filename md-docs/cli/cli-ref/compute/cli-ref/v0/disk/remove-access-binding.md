[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [compute](../../index.md) > [v0](../index.md) > [disk](index.md) > remove-access-binding

# yc compute v0 disk remove-access-binding

Remove access binding for the specified disk

#### Command Usage

Syntax:

`yc compute disk remove-access-binding <DISK-NAME>|<DISK-ID> [Flags...] [Global Flags...]`
