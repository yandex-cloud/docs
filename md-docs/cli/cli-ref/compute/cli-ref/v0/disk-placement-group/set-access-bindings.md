[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [compute](../../index.md) > [v0](../index.md) > [disk-placement-group](index.md) > set-access-bindings

# yc compute v0 disk-placement-group set-access-bindings

Set access bindings for the specified disk placement group and delete all existing access bindings if there were any

#### Command Usage

Syntax:

`yc compute disk-placement-group set-access-bindings <DISK-PLACEMENT-GROUP-NAME>|<DISK-PLACEMENT-GROUP-ID> [Flags...] [Global Flags...]`
