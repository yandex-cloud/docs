[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [compute](../../index.md) > [v0](../index.md) > [disk-placement-group](index.md) > add-access-binding

# yc compute v0 disk-placement-group add-access-binding

Add access binding for the specified disk placement group

#### Command Usage

Syntax:

`yc compute disk-placement-group add-access-binding <DISK-PLACEMENT-GROUP-NAME>|<DISK-PLACEMENT-GROUP-ID> [Flags...] [Global Flags...]`
