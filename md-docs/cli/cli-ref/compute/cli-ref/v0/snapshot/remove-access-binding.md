[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [compute](../../index.md) > [v0](../index.md) > [snapshot](index.md) > remove-access-binding

# yc compute v0 snapshot remove-access-binding

Remove access binding for the specified snapshot

#### Command Usage

Syntax:

`yc compute snapshot remove-access-binding <SNAPSHOT-NAME>|<SNAPSHOT-ID> [Flags...] [Global Flags...]`
