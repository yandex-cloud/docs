[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [compute](../../index.md) > [v0](../index.md) > [instance](index.md) > attach-disk

# yc compute v0 instance attach-disk
...
The disk to attach to the instance. ||
|| `--disk-id` | `string`

An ID of the disk to attach to the instance. ||
|| `--device-name` | `string`
