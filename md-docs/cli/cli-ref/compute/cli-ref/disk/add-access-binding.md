[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [compute](../index.md) > [disk](index.md) > add-access-binding

# yc compute disk add-access-binding

Add access binding for the specified disk

#### Command Usage

Syntax:

`yc compute disk add-access-binding <DISK-NAME>|<DISK-ID> [Flags...] [Global Flags...]`
