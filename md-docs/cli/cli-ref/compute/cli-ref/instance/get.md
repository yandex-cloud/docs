 ...
 * [Подключить файловое хранилище к виртуальной машине](../../../../../compute/operations/filesystem/attach-to-vm.md#tf_1)
 * [Отключить файловое хранилище от виртуальной машины](../../../../../compute/operations/filesystem/detach-from-vm.md#tf_1)
 * [Добавить виртуальную машину в кластер GPU](../../../../../compute/operations/gpu-cluster/gpu-add-to-cluster.md#tf_1)
 * [Создайте пароль для пользователя Linux](../../../../../compute/operations/serial-console/index.md)
 * [Добавление SSH-ключей для других пользователей](../../../../../compute/operations/vm-connect/ssh.md)
 ...
 * [Перенести ВМ в зону ru-central1-d с помощью специальной команды](../../../../../compute/operations/vm-control/vm-change-zone.md#cli_4)
 ...
 * [Проверьте обработку событий обслуживания](../../../../../compute/operations/vm-control/vm-update-policies.md)
 ...
 * [Создать виртуальную машину с метаданными из переменных окружения](../../../../../compute/operations/vm-create/create-with-env-variables.md)
 ...
 * [Настроить параметры сервиса метаданных ВМ](../../../../../compute/operations/vm-metadata/setup-metadata-service.md#tf_1)