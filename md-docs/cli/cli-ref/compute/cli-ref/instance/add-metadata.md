 ...
 * [Изменить метаданные](../../../../../compute/operations/vm-control/vm-update.md)
 * [Изменить метаданные виртуальной машины](../../../../../compute/operations/vm-metadata/update-vm-metadata.md)