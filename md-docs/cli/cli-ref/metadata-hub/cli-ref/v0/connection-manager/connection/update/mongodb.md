[Документация Yandex Cloud](../../../../../../../../index.md) > [Интерфейс командной строки](../../../../../../../index.md) > [Справочник CLI (англ.)](../../../../../../index.md) > [metadata-hub](../../../../index.md) > [v0](../../../index.md) > [connection-manager](../../index.md) > [connection](../index.md) > [update](index.md) > mongodb

# yc metadata-hub v0 connection-manager connection update mongodb
...
`yc metadata-hub connection-manager connection update mongodb [<CONNECTION-ID>] [Flags...] [Global Flags...]`
...
If this field is left blank, the database from the connection will be used as the authentication source. ||
|| `--hosts` | `value[,value]`

List of MongoDB hosts in format 'host:port'. ||
|| `--tls-disabled` | Disable TLS for MongoDB connection. ||
