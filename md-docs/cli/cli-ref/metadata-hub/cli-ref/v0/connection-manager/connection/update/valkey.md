[Документация Yandex Cloud](../../../../../../../../index.md) > [Интерфейс командной строки](../../../../../../../index.md) > [Справочник CLI (англ.)](../../../../../../index.md) > [metadata-hub](../../../../index.md) > [v0](../../../index.md) > [connection-manager](../../index.md) > [connection](../index.md) > [update](index.md) > valkey

# yc metadata-hub v0 connection-manager connection update valkey

Update Valkey connection

#### Command Usage

Syntax:

`yc metadata-hub connection-manager connection update valkey [<CONNECTION-ID>] [Flags...] [Global Flags...]`
...
List of Valkey hosts in format 'host:port'. ||
