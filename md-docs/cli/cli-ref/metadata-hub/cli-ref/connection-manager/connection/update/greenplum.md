[Документация Yandex Cloud](../../../../../../../index.md) > [Интерфейс командной строки](../../../../../../index.md) > [Справочник CLI (англ.)](../../../../../index.md) > [metadata-hub](../../../index.md) > [connection-manager](../../index.md) > [connection](../index.md) > [update](index.md) > greenplum

# yc metadata-hub connection-manager connection update greenplum
...
`yc metadata-hub connection-manager connection update greenplum [<CONNECTION-ID>] [Flags...] [Global Flags...]`
...
List of Greenplum hosts in format 'host:port'. ||
|| `--tls-disabled` | Disable TLS for Greenplum connection. ||
