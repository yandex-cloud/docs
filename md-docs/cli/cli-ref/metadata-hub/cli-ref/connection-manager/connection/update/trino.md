[Документация Yandex Cloud](../../../../../../../index.md) > [Интерфейс командной строки](../../../../../../index.md) > [Справочник CLI (англ.)](../../../../../index.md) > [metadata-hub](../../../index.md) > [connection-manager](../../index.md) > [connection](../index.md) > [update](index.md) > trino

# yc metadata-hub connection-manager connection update trino
...
`yc metadata-hub connection-manager connection update trino [<CONNECTION-ID>] [Flags...] [Global Flags...]`
...
Trino coordinator parameters in format 'host:port' ||
|| `--tls-disabled` | Disable TLS for Trino connection. ||
