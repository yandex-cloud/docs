[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник (англ.)](../../../../index.md) > [certificate-manager](../../index.md) > [v0](../index.md) > [certificate](index.md) > update
...
`yc certificate-manager v0 certificate update <CERTIFICATE> [Flags...] [Global Flags...]`
