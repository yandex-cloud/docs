[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [lockbox](../../index.md) > [v0](../index.md) > [secret](index.md) > add-access-binding
...
`yc lockbox secret add-access-binding <SECRET-NAME>|<SECRET-ID> [Flags...] [Global Flags...]`
