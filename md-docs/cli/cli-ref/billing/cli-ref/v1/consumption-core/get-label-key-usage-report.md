[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник (англ.)](../../../../index.md) > [billing](../../index.md) > [v1](../index.md) > [consumption-core](index.md) > get-label-key-usage-report

# yc billing v1 consumption-core get-label-key-usage-report
...
`yc billing v1 consumption-core get-label-key-usage-report <BILLING-ACCOUNT-ID>`
