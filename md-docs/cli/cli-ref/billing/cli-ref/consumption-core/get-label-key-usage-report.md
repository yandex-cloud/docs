[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник (англ.)](../../../index.md) > [billing](../index.md) > [consumption-core](index.md) > get-label-key-usage-report
...
`yc billing consumption-core get-label-key-usage-report <BILLING-ACCOUNT-ID>`
