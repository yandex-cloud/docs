[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник (англ.)](../../../index.md) > [billing](../index.md) > [consumption-core](index.md) > get-cloud-usage-report
...
`yc billing consumption-core get-cloud-usage-report <BILLING-ACCOUNT-ID>`
