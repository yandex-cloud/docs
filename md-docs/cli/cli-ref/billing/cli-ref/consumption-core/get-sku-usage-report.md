[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник (англ.)](../../../index.md) > [billing](../index.md) > [consumption-core](index.md) > get-sku-usage-report
...
`yc billing consumption-core get-sku-usage-report <BILLING-ACCOUNT-ID>`
