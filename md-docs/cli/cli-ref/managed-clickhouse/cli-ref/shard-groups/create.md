[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник (англ.)](../../../index.md) > [managed-clickhouse](../index.md) > [shard-groups](index.md) > create
...
External shard configuration. Each flag invocation adds one external shard (identified by name=...).
