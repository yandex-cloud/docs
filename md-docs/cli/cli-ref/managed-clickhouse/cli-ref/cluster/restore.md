[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник (англ.)](../../../index.md) > [managed-clickhouse](../index.md) > [cluster](index.md) > restore
...
Settings that are applied to all users of the ClickHouse cluster being restored by default. Acceptable keys:
