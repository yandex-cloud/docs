[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник CLI (англ.)](../../../../index.md) > [resource-manager](../../index.md) > [v0](../index.md) > [cloud](index.md) > set-access-bindings
...
`yc resource-manager cloud set-access-bindings <CLOUD-NAME>|<CLOUD-ID> [Flags...] [Global Flags...]`
