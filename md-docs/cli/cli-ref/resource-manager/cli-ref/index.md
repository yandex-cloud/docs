[Документация Yandex Cloud](../../../../index.md) > [Интерфейс командной строки](../../../index.md) > [Справочник (англ.)](../../index.md) > resource-manager > Overview

# yc resource-manager

Manage Yandex Cloud Resource Manager resources

Command tree v0 is the default. Run `yc resource-manager <command>` or `yc resource-manager v0 <command>`.
...
- [yc resource-manager v0](v0/index.md) — Manage Yandex Cloud Resource Manager resources
