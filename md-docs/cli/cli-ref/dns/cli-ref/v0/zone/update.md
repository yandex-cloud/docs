[Документация Yandex Cloud](../../../../../../index.md) > [Интерфейс командной строки](../../../../../index.md) > [Справочник (англ.)](../../../../index.md) > [dns](../../index.md) > [v0](../index.md) > [zone](index.md) > update
...
`yc dns v0 zone update <DNS-ZONE-NAME>|<DNS-ZONE-ID> [Flags...] [Global Flags...]`
