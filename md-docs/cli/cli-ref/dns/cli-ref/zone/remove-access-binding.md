[Документация Yandex Cloud](../../../../../index.md) > [Интерфейс командной строки](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [dns](../index.md) > [zone](index.md) > remove-access-binding
...
`yc dns zone remove-access-binding <DNS-ZONE-NAME>|<DNS-ZONE-ID> [Flags...] [Global Flags...]`
