[Документация Yandex Cloud](../../../index.md) > [Интерфейс командной строки](../../index.md) > [Пошаговые инструкции](../index.md) > Управление профилем > Получение информации

# Получение информации о профиле Yandex Cloud CLI
