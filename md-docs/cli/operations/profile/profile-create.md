...
Предпочтительным способом работы с CLI на сервере без графического интерфейса является [использование сервисного аккаунта](../authentication/service-account.md).
