[Документация Yandex Cloud](../../index.md) > [Интерфейс командной строки](../index.md) > [Пошаговые инструкции](index.md) > Удаление

# Удаление Yandex Cloud CLI

Чтобы полностью удалить [CLI](../../glossary/cli.md), удалите установочную директорию, пользовательские настройки и переменные среды.
...
- Linux/MacOS {#linux-macos}
  ...
  1. Удалите CLI:
      ...
      ```bash
      rm -rf <путь_к_установочной_директории>
      ```

      По умолчанию путь к установочной директории — `~/yandex-cloud`:
