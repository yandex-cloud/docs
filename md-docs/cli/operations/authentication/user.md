[Документация Yandex Cloud](../../../index.md) > [Интерфейс командной строки](../../index.md) > [Пошаговые инструкции](../index.md) > Аутентификация > Аккаунт на Яндексе

# Аутентификация в Yandex Cloud CLI с аккаунтом на Яндексе
