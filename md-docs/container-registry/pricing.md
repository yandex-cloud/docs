...
| ------------------------------------------------------------------------------------------------------------------------ | ----------------- | -------------------------- | ------------- | ------------ |
| Container Registry. Первичное сканирование Docker-образа на наличие уязвимостей, от 0 до 6 единицы тарификации в месяц   | Не тарифицируется | Сканирование Docker-образа | 1 января 2026 | —            |
| Container Registry. Первичное сканирование Docker-образа на наличие уязвимостей, от 6 единицы тарификации в месяц        | 14,4936 ₽         | Сканирование Docker-образа | 1 января 2026 | —            |
| Container Registry. Последующее сканирование Docker-образа на наличие уязвимостей, от 0 до 6 единицы тарификации в месяц | Не тарифицируется | Сканирование Docker-образа | 1 января 2026 | —            |
| Container Registry. Последующее сканирование Docker-образа на наличие уязвимостей, от 6 единицы тарификации в месяц      | 7,9056 ₽          | Сканирование Docker-образа | 1 января 2026 | —            |
