[Документация Yandex Cloud](../../index.md) > [Yandex Container Registry](../index.md) > [Практические руководства](index.md) > Запуск контейнерного приложения в Yandex Serverless Containers
...
* плата за хранение Docker-образа ([тарифы Yandex Container Registry](../pricing.md));
...
- Консоль управления {#console}
  ...
  1. Нажмите **Добавить правило** и создайте правило по таблице:
      ...
      | --- | --- | --- | --- | --- | --- |
      | `Входящий` | `any` | `27017` | `Любой` | `Диапазон адресов` | `0.0.0.0/0` |
...
- API {#api}
  ...
  Чтобы создать реестр, воспользуйтесь методом REST API [create](../api-ref/Registry/create.md) для ресурса [Registry](../api-ref/Registry/index.md) или вызовом gRPC API [RegistryService/CreateRegistryRequest](../api-ref/grpc/Registry/create.md).
...
1. [Загрузите](../operations/docker-image/docker-image-push.md) Docker-образ в реестр:
...
- Консоль управления {#console}
  ...
  1. Перейдите на вкладку **Редактор**.
      ...
      1. В блоке **Параметры образа**:
          ...
          1. В блоке **Секреты Lockbox** укажите секреты:
...
1. [Удалите](../operations/docker-image/docker-image-delete.md) образ из реестра `app-registry`.
1. [Удалите](../operations/registry/registry-delete.md) реестр `app-registry`.
