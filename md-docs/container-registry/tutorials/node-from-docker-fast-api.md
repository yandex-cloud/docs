[Документация Yandex Cloud](../../index.md) > [Yandex Container Registry](../index.md) > [Практические руководства](index.md) > Развертывание сервиса в DataSphere на основе Docker-образа с FastAPI
...
1. [Удалите Docker-образ](../operations/docker-image/docker-image-delete.md).
1. [Удалите реестр](../operations/registry/registry-delete.md) Container Registry.