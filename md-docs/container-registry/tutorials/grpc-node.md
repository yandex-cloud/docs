...
* объем хранилища, занятый данными {{ container-registry-full-name }} (см. [тарифы {{ container-registry-name }}](../pricing.md)).
...
{{ ml-platform-name }} может создать ноду из Docker-образа, который хранится в [{{ container-registry-full-name }}](../index.md). Чтобы загрузить образ, создайте реестр:
...
Чтобы сервисный аккаунт мог [аутентифицироваться в {{ container-registry-full-name }}](../operations/authentication.md), создайте авторизованный ключ.
...
- CLI {#cli}
   ...
   1. [Аутентифицируйтесь в {{ container-registry-name }}](../index.md).
...
1. [Удалите](../operations/registry/registry-delete.md) реестр {{ container-registry-name }}.