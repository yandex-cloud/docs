[Документация Yandex Cloud](../../../index.md) > [Yandex Container Registry](../../index.md) > [Практические руководства](../index.md) > [Автоматическое сканирование Docker-образа при загрузке](index.md) > Консоль управления, CLI и API
...
1. Просмотрите логи функции `scan-on-push` и убедитесь, что она выполнилась.
   ...
   - Консоль управления {#console}
     ...
     1. [Перейдите](https://console.yandex.cloud/link/functions) в сервис **Cloud Functions** и выберите функцию `scan-on-push`.
