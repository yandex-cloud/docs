[Документация Yandex Cloud](../../../index.md) > [Yandex Container Registry](../../index.md) > [Практические руководства](../index.md) > Автоматическое сканирование Docker-образа при загрузке > Обзор
