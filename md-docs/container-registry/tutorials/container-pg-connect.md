...
* Реестр {{ container-registry-name }}: хранение созданных Docker-образов и использование сканера уязвимостей (см. [тарифы {{ container-registry-name }}](../pricing.md)).
...
1. [Создайте реестр](../operations/registry/registry-create.md) в сервисе {{ container-registry-full-name }}.
...
1. Аутентифицируйтесь в реестре:
    ...
    Другие способы см. в разделе [{#T}](../operations/authentication.md).
