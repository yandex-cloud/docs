...
* [Развертывание сервиса в Yandex DataSphere на основе Docker-образа с FastAPI](node-from-docker-fast-api.md)
...
* [Интеграция с Yandex Managed Service for Kubernetes](container-registry.md)