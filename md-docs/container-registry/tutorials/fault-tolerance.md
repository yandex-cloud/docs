...
* Приложение упаковано в [Docker-образ](../concepts/docker-image.md) и загружено в {{ container-registry-full-name }}.
...
1. [Аутентифицируйтесь](../operations/authentication.md) в {{ container-registry-name }}:
...
1. [Загрузите Docker-образы](../operations/docker-image/docker-image-push.md) в {{ container-registry-name }}:
