[Документация Yandex Cloud](../../index.md) > [Yandex Container Registry](../index.md) > [Практические руководства](index.md) > Настройка отказоустойчивой архитектуры в Yandex Cloud
...
* Приложение упаковано в [Docker-образ](../concepts/docker-image.md) и загружено в Yandex Container Registry.
...
1. [Аутентифицируйтесь](../operations/authentication.md) в Container Registry:
...
1. [Создайте Docker-образ](../operations/docker-image/docker-image-create.md) с тегом `v1`:
...
1. [Загрузите Docker-образы](../operations/docker-image/docker-image-push.md) в Container Registry:
