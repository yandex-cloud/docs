[Документация Yandex Cloud](../../index.md) > [Yandex Container Registry](../index.md) > [Практические руководства](index.md) > Сканирование уязвимостей при непрерывном развертывании приложений Managed Service for Kubernetes с помощью GitLab
...
Вы можете [сканировать уязвимости](../concepts/vulnerability-scanner.md) [Docker-образов](../concepts/docker-image.md) в [Yandex Container Registry](../index.md) при непрерывном развертывании приложений [Yandex Managed Service for Kubernetes](../../managed-kubernetes/index.md) через GitLab.
...
* Плата за хранение созданных Docker-образов и сканер уязвимостей ([тарифы Container Registry](../pricing.md)).
...
1. Создайте [переменные окружения GitLab](https://docs.gitlab.com/ee/ci/variables/):
   ...
   1. Добавьте переменные окружения в зависимости от способа аутентификации Managed Service for Kubernetes в GitLab:
      ...
      * `CI_REGISTRY` — адрес созданного ранее [реестра](../concepts/registry.md) в формате `cr.yandex/<идентификатор_реестра>`.
...
1. [Удалите все Docker-образы](../operations/docker-image/docker-image-delete.md) из [реестра](../concepts/registry.md) Container Registry.
