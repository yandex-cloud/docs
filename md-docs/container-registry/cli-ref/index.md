 ...
 * [Просмотреть роли на ресурс](../operations/roles/get-assigned-roles.md#cli_1)
 * [Назначить роль на ресурс](../operations/roles/grant.md#cli_1)
 * [Отозвать роль на ресурс](../operations/roles/revoke.md#cli_1)