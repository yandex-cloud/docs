[Документация Yandex Cloud](../../../index.md) > [Yandex Container Registry](../../index.md) > [Справочник CLI (англ.)](../index.md) > [cluster](index.md) > set-access-bindings

# yc container cluster set-access-bindings
...
`yc container cluster set-access-bindings <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
