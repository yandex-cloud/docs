[Документация Yandex Cloud](../../../../index.md) > [Yandex Container Registry](../../../index.md) > [Справочник CLI (англ.)](../../index.md) > [v0](../index.md) > [registry](index.md) > set-access-bindings

# yc container v0 registry set-access-bindings
...
`yc container registry set-access-bindings <REGISTRY-NAME>|<REGISTRY-ID> [Flags...] [Global Flags...]`
