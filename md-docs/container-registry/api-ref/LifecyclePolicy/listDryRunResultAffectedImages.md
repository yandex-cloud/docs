[Документация Yandex Cloud](../../../index.md) > [Yandex Container Registry](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [LifecyclePolicy](index.md) > ListDryRunResultAffectedImages
...
Sorting the list by [LifecyclePolicy.name](get.md#yandex.cloud.containerregistry.v1.LifecyclePolicy) and [LifecyclePolicy.createdAt](get.md#yandex.cloud.containerregistry.v1.LifecyclePolicy) fields.
