[Документация Yandex Cloud](../../../../index.md) > [Yandex Container Registry](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [Scanner](index.md) > List
...
the service returns a [ListRegistriesResponse.next_page_token](../Registry/list.md#yandex.cloud.containerregistry.v1.ListRegistriesResponse)
...
[ListRegistriesResponse.next_page_token](../Registry/list.md#yandex.cloud.containerregistry.v1.ListRegistriesResponse) returned by a previous list request.
...
is larger than [ListImagesRequest.page_size](../Image/list.md#yandex.cloud.containerregistry.v1.ListImagesRequest), use
the `next_page_token` as the value
for the [ListImagesRequest.page_token](../Image/list.md#yandex.cloud.containerregistry.v1.ListImagesRequest) query parameter
