[Документация Yandex Cloud](../../../index.md) > [Yandex Container Registry](../../index.md) > [Пошаговые инструкции](../index.md) > Управление политиками автоматического удаления Docker-образов > Сделать тестовый запуск политики удаления
...
- Консоль управления {#console}
  ...
  1. В правом верхнем углу нажмите кнопку ![image](../../../_assets/console-icons/play-fill.svg) **Проверить**. После завершения проверки в разделе **Проверки жизненного цикла** появится строка с результатами тестового запуска политики.
