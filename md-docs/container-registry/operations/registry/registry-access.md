[Документация Yandex Cloud](../../../index.md) > [Yandex Container Registry](../../index.md) > [Пошаговые инструкции](../index.md) > Управление реестром > Настроить доступ к реестру
...
- Консоль управления {#console}
  ...
  1. На панели слева нажмите ![IP-access](../../../_assets/console-icons/shield.svg) **Доступ  для IP-адресов**.
  1. Нажмите **Настроить**.
...
- Terraform {#tf}
  ...
  1. Опишите в конфигурационном файле Terraform настройки доступа к реестру.
     ...
     Где:
     * `my_registry` — идентификатор реестра. Если в конфигурации уже есть ресурс [yandex_container_registry](../../../terraform/resources/container_registry.md), вы можете указать на него, например `yandex_container_registry.my_registry.id`.
