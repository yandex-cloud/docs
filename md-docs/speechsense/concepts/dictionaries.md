...
_Словарь_ — это набор ключевых фраз для [словарных тегов](tags.md#dictionary-tags). Если диалог в SpeechSense содержит фразу из словаря, на такой диалог назначается тег со соответствующим словарем.
...
В SpeechSense действуют три набора словарей:
...
Системные словари видят все пользователи, однако посмотреть содержимое системного словаря нельзя. Словари пространства и проекта отображаются только тем, у кого есть роль `Viewer` или выше в пространстве или проекте.
