# Ассистенты в SpeechSense

**Ассистент** — это AI-ассистент, созданный в сервисе SpeechSense. Он предназначен для автоматического анализа диалогов и выполнения различных задач на основе заданных инструкций. Ассистенты интегрированы в иерархию ресурсов SpeechSense и создаются на уровне проектов.
...
SpeechSense позволяет загружать файлы для базы знаний в формате PDF. Ограничения:
...
* [ИИ‑ассистенты в SpeechSense помогут проверить качество обслуживания в контакт‑центрах](https://yandex.cloud/ru/blog/speechsense-ai-assistants)