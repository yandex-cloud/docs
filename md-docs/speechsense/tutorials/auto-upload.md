...
Вы можете настроить автоматическую загрузку файлов с диалогами и их метаданными из бакета Object Storage в [пространство SpeechSense](../concepts/resources-hierarchy.md#space). Поддерживаемые форматы:
...
Настроить автоматическую загрузку данных можно сразу для нескольких [подключений SpeechSense](../concepts/resources-hierarchy.md#connection).
...
- Интерфейс SpeechSense {#speechsense}
  ...
  1. Выберите сервисный аккаунт `speechsense-sa` и укажите роль [Data editor](../security/index.md#speechsense-data-editor). Эта роль позволит сервисному аккаунту `speechsense-sa` загружать данные в SpeechSense.
