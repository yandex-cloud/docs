...
Создайте [словарь](../../concepts/dictionaries.md), чтобы поддерживать набор фраз-триггеров в одном месте и переиспользовать этот набор в нескольких [словарных тегах](../../concepts/tags.md#dictionary-tags). Если в SpeechSense были загружены диалоги с фразами-триггерами из словаря, тег с таким словарем будет назначен на диалог.

Для создания словаря нужна роль `Admin` или `Editor` в [пространстве](../../concepts/resources-hierarchy.md#space) или [проекте](../../concepts/resources-hierarchy.md#project) — зависит от того, где вы создаете словарь.
