...
1. На вкладке **Диалоги** [найдите](manage-dialogs.md#search-dialogs) нужный диалог.
1. Перейдите к связанным диалогам одним из способов:

    * В списке диалогов [отобразите колонку](manage-dialogs.md#set-columns) с [номерами задач](../../concepts/dialogs.md#related-dialogs). Затем нажмите на номер задачи в строке с нужным диалогом.
...
1. Чтобы посмотреть смысловой анализ диалога, перейдите на вкладку **Анализ от YandexGPT**.

## Перейти к просмотру отдельного диалога

Чтобы со страницы задачи перейти к просмотру отдельного диалога, нажмите кнопку ![image](../../../_assets/console-icons/arrow-up-right-from-square.svg) для нужного диалога на вкладках **Диалоги** или **Анализ от YandexGPT**.