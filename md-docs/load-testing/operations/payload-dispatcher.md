...
1. Запустите `dispatcher` с нужными флагами:
   ...
   * Файл `uri.payload` содержит запросы типа [URI](../concepts/payloads/uri.md);
   * Файл `uripost.payload` содержит запросы типа [URIPOST](../concepts/payloads/uripost.md);
   * Файл `raw.payload` содержит запросы типа [RAW](../concepts/payloads/raw.md);
   * Файл `httpjson.payload` содержит запросы типа [HTTP_JSON](../concepts/payloads/http-json.md).