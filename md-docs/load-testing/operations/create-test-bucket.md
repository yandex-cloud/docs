...
В {{ load-testing-name }} тестовые данные можно загрузить из [бакета](../../storage/concepts/bucket.md) [{{ objstorage-full-name }}](../../storage/index.md). Этот способ позволяет:
...
- Консоль управления {#console}
  ...
  1. В зависимости от выбранного способа настройки задайте параметры в блоке **{{ ui-key.yacloud.load-testing.label_test-settings }}**:
      ...
      - Форма
        ...
        1. В поле **{{ ui-key.yacloud.load-testing.field_settings-type }}** выберите тип [тестовых данных](../concepts/payload.md) **Прикрепленный файл**.
        ...
        1. (Опционально) Включите опцию **Мониторинг агента**. Подробнее см. в разделе [{#T}](../concepts/monitoring.md).
