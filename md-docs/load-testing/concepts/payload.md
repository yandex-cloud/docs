...
Для хранения тестовых данных можно использовать [{{ objstorage-full-name }}](../../storage/index.md). В этом случае файл с данными загружается в [бакет](../../storage/concepts/bucket.md) и не покидает облако пользователя.
