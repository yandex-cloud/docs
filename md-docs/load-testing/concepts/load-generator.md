...
_Генератор нагрузки_ — это инструмент, который позволяет по заданной конфигурации эмулировать нагрузку на сервис. Инструмент для тестирования, используемый в Load Testing, использует генераторы Pandora и Phantom.
