...
**rpc Update ([UpdateAgentRequest](#yandex.cloud.loadtesting.api.v1.UpdateAgentRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## UpdateAgentRequest {#yandex.cloud.loadtesting.api.v1.UpdateAgentRequest}
...
To get a list of available values, see [Levels of core performance](../../../../../compute/concepts/performance-levels.md). ||
...
For more information, see [Metadata](../../../../../compute/concepts/vm-metadata.md). ||
...
ID of the service account to use for [authentication inside the instance](../../../../../compute/operations/vm-connect/auth-inside-vm.md).
...
ID of the [Compute VM platform](../../../../../compute/concepts/vm-platforms.md) on which the agent will be created.
...
For more information, see [Levels of core performance](../../../../../compute/concepts/performance-levels.md). ||
|| gpus | **int64**
...
ID of the disk type.
To get a list of available disk types, use the [yandex.cloud.compute.v1.DiskTypeService.List](../../../../../compute/api-ref/grpc/DiskType/list.md#List) request. ||
|| size | **int64**
