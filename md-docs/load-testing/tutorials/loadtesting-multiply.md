...
Load Testing можно использовать для тестирования сервиса с помощью нескольких [агентов тестирования](../concepts/agent.md).
...
* [Настройка групп безопасности агента тестирования](../operations/security-groups-agent.md).
* [Настройка групп безопасности цели тестирования](../operations/security-groups-target.md).
...
1. Создайте первый агент:
   ...
   - Консоль управления {#console}
     ...
     1. Дождитесь завершения процесса создания ВМ. Статус агента должен смениться на `Ready for test`.
        ...
        * У агента есть [доступ](../operations/security-groups-agent.md) к `loadtesting.api.cloud.yandex.net:443` и [публичный IP-адрес](../../vpc/concepts/address.md).
