...
Запуск и просмотр результатов нагрузочного тестирования с внешнего агента идентичны работе с [агентом](../concepts/agent.md) Load Testing. Подробнее см. [Как начать работать с Yandex Load Testing](../quickstart.md).
