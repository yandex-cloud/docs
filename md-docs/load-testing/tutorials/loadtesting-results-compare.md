...
В сценарии используется [генератор нагрузки](../concepts/load-generator.md) [Pandora](../concepts/load-generator.md#pandora) и простейший веб-сервис в качестве цели тестирования.
