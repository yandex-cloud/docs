...
{{ load-testing-name }} можно использовать для нагрузочного тестирования сервиса по протоколу [gRPC](https://grpc.io/docs/) с помощью [генератора нагрузки](../concepts/load-generator.md) [Pandora](../concepts/load-generator.md#pandora).
...
1. Сформируйте тестовые данные в формате [GRPC_JSON](../concepts/payloads/grpc-json.md):
