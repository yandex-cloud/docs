...
В этом руководстве вы развернете [Docker-образ](../concepts/artifacts/docker.md) из [реестра](../concepts/registry.md) {{ cloud-registry-full-name }} и запустите контейнер на [виртуальной машине](../../compute/concepts/vm.md) {{ compute-full-name }}.
...
* Плата за хранение созданных образов (см. [тарифы {{ cloud-registry-full-name }}](../pricing.md)).
...
* [Работа с {{ cloud-registry-name }}](../operations/index.md)
