[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Registry](../index.md) > Практические руководства > Настройка политик жизненного цикла
...
* [Реестр в Yandex Cloud Registry](../concepts/registry.md)
