[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Registry](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Registry](index.md) > SetAccessBindings
...
```
POST https://registry.api.cloud.yandex.net/cloud-registry/v1/registries/{resourceId}:setAccessBindings
```
