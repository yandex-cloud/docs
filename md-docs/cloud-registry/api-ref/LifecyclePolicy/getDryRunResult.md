[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Registry](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [LifecyclePolicy](index.md) > GetDryRunResult

# Yandex Cloud Registry API, REST: LifecyclePolicy.GetDryRunResult
...
```
GET https://registry.api.cloud.yandex.net/cloud-registry/v1/lifecyclePolicyDryRunResults/{dryRunId}
```
...
## Response {#yandex.cloud.cloudregistry.v1.DryRunLifecyclePolicyResponse}
...
```json
{
  "policyId": "string",
  "runAt": "string",
  "artifactsToHardDeleteCount": "string",
  "artifactsToSoftDeleteCount": "string",
  "dryRunId": "string",
  "policySnapshot": [
    {
...
|| artifactsToHardDeleteCount | **string** (int64)

Count of artifacts to be hard deleted. ||
|| artifactsToSoftDeleteCount | **string** (int64)

Count of artifacts to be soft deleted. ||
|| dryRunId | **string**

ID of this dry run. Use it to get this result again later. ||
|| policySnapshot[] | **[LifecycleRule](#yandex.cloud.cloudregistry.v1.LifecycleRule)**
