[Документация Yandex Cloud](../../../../index.md) > [Yandex Cloud Registry](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [LifecyclePolicy](index.md) > Get
...
**rpc Get ([GetLifecyclePolicyRequest](#yandex.cloud.cloudregistry.v1.GetLifecyclePolicyRequest)) returns ([LifecyclePolicy](#yandex.cloud.cloudregistry.v1.LifecyclePolicy))**

## GetLifecyclePolicyRequest {#yandex.cloud.cloudregistry.v1.GetLifecyclePolicyRequest}
