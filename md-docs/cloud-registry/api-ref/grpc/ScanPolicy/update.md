[Документация Yandex Cloud](../../../../index.md) > [Yandex Cloud Registry](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [ScanPolicy](index.md) > Update
...
**rpc Update ([UpdateScanPolicyRequest](#yandex.cloud.cloudregistry.v1.UpdateScanPolicyRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## UpdateScanPolicyRequest {#yandex.cloud.cloudregistry.v1.UpdateScanPolicyRequest}
