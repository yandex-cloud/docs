[Документация Yandex Cloud](../../../../index.md) > [Yandex Cloud Registry](../../../index.md) > [Справочник CLI (англ.)](../../index.md) > [v1](../index.md) > [registry](index.md) > add-access-binding

# yc cloud-registry v1 registry add-access-binding
...
`yc cloud-registry v1 registry add-access-binding <REGISTRY-NAME>|<REGISTRY-ID>`
...
1. Generate template:
yc cloud-registry v1 registry add-access-binding --example-json > request.json
or
yc cloud-registry v1 registry add-access-binding --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc cloud-registry v1 registry add-access-binding -r request.json
or
yc cloud-registry v1 registry add-access-binding -r request.yaml ||
|#
