[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Registry](../index.md) > Справочник CLI (англ.) > Overview

# yc cloud-registry

Manage Cloud Registry resources

Command tree v1 (new CLI interface) is the default. Run `yc cloud-registry v1 <command>`.
Legacy command tree v0 is also available: `yc cloud-registry v0 <command>`.
Set `services.cloud-registry.version: v0` or `services.cloud-registry.version: v1` in your profile to change the default.
...
- [yc cloud-registry artifact](artifact/index.md) — A set of methods for managing Artifacts.
  ...
  - [yc cloud-registry artifact delete](artifact/delete.md) — Deletes the specified artifact.

  - [yc cloud-registry artifact get](artifact/get.md) — Returns the specified artifact resource.

  - [yc cloud-registry artifact get-by-path](artifact/get-by-path.md) — Returns the specified artifact resource by path within the registry.

  - [yc cloud-registry artifact list](artifact/list.md) — List artifacts with filtering by kind, registry kind/type, node path

  - [yc cloud-registry artifact list-access-bindings](artifact/list-access-bindings.md) — access bindings
  ...
  - [yc cloud-registry artifact set-access-bindings](artifact/set-access-bindings.md) — Sets access bindings for the specified artifact (folder, package, artifact, etc).
...
- [yc cloud-registry registry](registry/index.md) — A set of methods for managing Registry resources.
  ...
  - [yc cloud-registry registry force-delete](registry/force-delete.md) — Forcefully deletes the specified registry along with all its repositories and data.

  - [yc cloud-registry registry get](registry/get.md) — Returns the specified Registry resource.

  - [yc cloud-registry registry list](registry/list.md) — Retrieves the list of Registry resources in the specified folder.
  ...
  - [yc cloud-registry registry set-access-bindings](registry/set-access-bindings.md) — Sets access bindings for the specified registry.

  - [yc cloud-registry registry set-ip-permissions](registry/set-ip-permissions.md) — Set ip permissions for the specified registry.
