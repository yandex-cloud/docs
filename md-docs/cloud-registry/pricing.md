...
| ------------------------------------------------------------------ | ----------------- | --------------- | -------------- | ------------ |
| Cloud Registry. Хранилище, от 0 до 720 единицы тарификации в месяц | Не тарифицируется | ГБ × час        | 30 апреля 2026 | —            |
| Cloud Registry. Хранилище, от 720 единицы тарификации в месяц      | 0,007 ₽           | ГБ × час        | 30 апреля 2026 | —            |
