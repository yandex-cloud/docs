...
- CLI {#cli}
  ...
  ```bash
  helm repo remove registry.yandexcloud.net/<идентификатор_реестра>/<имя_Helm-чарта>:<версия>
  ```
...
- CLI {#cli}
  ...
  Чтобы удалить Helm-чарт, загруженный в Cloud Registry, выполните команду для удаления Docker-образов:
