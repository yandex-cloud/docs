[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > Чарты > [Справочник визуализаций](index.md) > Столбчатая диаграмма

# Столбчатая диаграмма ![](../../_assets/datalens/column.svg) в Yandex DataLens
