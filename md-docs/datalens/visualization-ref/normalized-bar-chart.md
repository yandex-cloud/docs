[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > Чарты > [Справочник визуализаций](index.md) > Нормированная линейчатая диаграмма

# Нормированная линейчатая диаграмма ![](../../_assets/datalens/normalized-horizontal-bar.svg) в Yandex DataLens
