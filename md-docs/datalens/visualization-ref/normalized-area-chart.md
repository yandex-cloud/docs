[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > Чарты > [Справочник визуализаций](index.md) > Нормированная диаграмма с областями

# Нормированная диаграмма с областями ![](../../_assets/datalens/normalized-area.svg) в Yandex DataLens
