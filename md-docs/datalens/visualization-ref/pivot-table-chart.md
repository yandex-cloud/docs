...
Таблицы подходят для детальной [аналитики](../../glossary/data-analytics.md) (глубокого погружения в цифры), помогают найти проблемы.
...
1. Укажите **Тип заливки**:
   ...
   * Заливка не поддерживается для столбцов и строк **Итого**.
...
#### Настроить выравнивание столбцов  {#set-column-align}
...
#### Настроить сортировку по строкам {#rows-sorting}

1. В верхней части экрана напротив типа чарта нажмите значок ![image](../../_assets/console-icons/gear.svg).
1. Включите или отключите опцию **Сортировка по строкам** и нажмите кнопку **Применить**.

Если опция включена (по умолчанию), вы можете сортировать данные в строках, соответствующих измерению в секции **Строки**. Для этого нажмите на значение измерения в строке. Значения показателей в столбцах отсортируются по возрастанию. Нажмите еще раз — данные отсортируются по убыванию. Чтобы убрать сортировку, нажмите еще раз.

Если в секции **Строки** добавлено несколько измерений, сортировка по строкам доступна только для последнего из них.

{% cut "Сортировка по строкам" %}
