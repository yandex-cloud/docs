[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > Чарты > [Справочник визуализаций](index.md) > Круговая диаграмма

# Круговая диаграмма ![](../../_assets/datalens/pie.svg) в Yandex DataLens
