[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > Чарты > [Справочник визуализаций](index.md) > Карта > Полилинейная карта

# Полилинейная карта ![](../../_assets/datalens/polyline-map.svg) в Yandex DataLens
