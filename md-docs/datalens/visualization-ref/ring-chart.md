[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > Чарты > [Справочник визуализаций](index.md) > Кольцевая диаграмма

# Кольцевая диаграмма ![](../../_assets/datalens/ring.svg) в Yandex DataLens
