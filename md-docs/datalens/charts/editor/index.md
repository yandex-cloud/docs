[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > Чарты > Чарты в Editor > Обзор
...
1. Если Editor открыт с указанием параметров в URL, под панелью контролов появится панель с переопределенными параметрами (2 на скриншоте).
1. Панель редактора кода **CodeEditor** — для просмотра и изменения содержимого вкладок чарта. Подробнее о работе вкладок (3.1 на скриншоте) в разделе [Вкладки](tabs.md).
...
* [Быстрый старт в Editor](quickstart/index.md)