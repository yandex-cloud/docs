[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > DataLens Public API > [DataLens API (англ.)](index.md) > updateEmbed

# DataLens API: Update embed

Updates the specified embedding.

## HTTP request

```
POST https://api.datalens.tech/rpc/updateEmbed
```
