[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > Вычисляемые поля > Справочник функций > Агрегатные функции > ARG_MIN
...
`ClickHouse 21.8`, `Файлы`, `Google Sheets`, `Trino`, `Яндекс Документы`, `YDB`.