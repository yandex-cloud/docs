[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > Вычисляемые поля > Справочник функций > Строковые функции > SPLIT
...
`ClickHouse 21.8`, `Файлы`, `Google Sheets`, `MySQL 5.7`, `PostgreSQL 9.3`, `Trino`, `Яндекс Документы`, `YDB`.