[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > Публикация и встраивание > Публичное встраивание
...
* `_bg_color` — задает фон чарта и дашборда в шестнадцатеричном формате, только если значение параметра `_embedded` равно `1`. Например, `_bg_color=D7F7F7&_embedded=1`
* `_widgets_bg_color` — задает фон виджетов на дашборде в шестнадцатеричном формате, только если значение параметра `_embedded` равно `1`. Например, `_widgets_bg_color=B7F7F7&_embedded=1`.
