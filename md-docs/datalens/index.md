...
### Работа с геоданными
 ...
 - [Анализ продаж и локаций пиццерий на данных из БД {{ CH }} и Галереи {{ datalens-short-name }}](tutorials/data-from-ch-to-geolayers-visualization.md)
...
### Аналитика сервисов
 ...
 - [Анализ логов {{ objstorage-name }} при помощи {{ datalens-name }}](tutorials/storage-logs-analysis.md)
 ...
 - [Визуализация данных {{ monitoring-full-name }}](tutorials/data-from-monitoring-visualization.md)

 - [Визуализация данных из {{ ytsaurus-name }} CHYT](tutorials/data-from-ch-over-yt.md)
...
### Базы данных
 ...
 - [Создание подключения к {{ CH }}](operations/connection/create-clickhouse.md)

 - [Создание подключения к {{ PG }}](operations/connection/create-postgresql.md)

 - [Создание подключения к {{ MY }}](operations/connection/create-mysql.md)

 - [Создание подключения к {{ ydb-short-name }}](operations/connection/create-ydb.md)
...
#### Создание подключения к {{ ytsaurus-name }} CHYT
 ...
 - [Создание подключения к {{ GP }}](operations/connection/create-greenplum.md)

 - [Создание подключения к {{ MS }}](operations/connection/create-mssql-server.md)

 - [Создание подключения к Oracle Database](operations/connection/create-oracle.md)

 - [Создание подключения к {{ SR }}](operations/connection/create-starrocks.md)

 - [Создание подключения к {{ prometheus-name }}](operations/connection/create-prometheus.md)

 - [Создание подключения к Snowflake](operations/connection/create-snowflake.md)

 - [Создание подключения к {{ TR }}](operations/connection/create-trino.md)
...
### Файлы и сервисы
 ...
 - [Создание подключения к {{ yq-full-name }}](operations/connection/create-yandex-query.md)
 ...
 - [Создание подключения к {{ billing-name }}](operations/connection/create-cloud-billing.md)

 - [Создание подключения к {{ monitoring-full-name }}](operations/connection/create-monitoring.md)
...
#### Создание подключения к {{ datalens-short-name }} Usage Analytics
 ...
 - [Создание подключения к {{ speechsense-name }}](operations/connection/create-speechsense.md)
...
#### Виджеты на дашборде
 ...
 - [Добавление Нейроаналитика на дашборд](operations/dashboard/add-ai.md)
...
#### Настройки дашборда
 ...
 - [Добавление рассылки для дашборда](operations/dashboard/add-maillists.md)
...
## Встраивание объектов
 ...
 - [Непубличное встраивание](security/private-embedded-objects.md)

## Управление доступом

 - [Обзор](security/index.md)

 - [Роли в {{ datalens-short-name }}](security/roles.md)

### Организации в {{ datalens-name }}

 - [Обзор](concepts/organizations.md)

 - [Переключение между экземплярами {{ datalens-name }}](operations/organizations/change-organization.md)
...
### Доступ к объектам в папках
 ...
 - [Публичный доступ](concepts/datalens-public.md)
...
## Решение проблем
 ...
 - [Ошибки {{ datalens-name }}](troubleshooting/errors/all.md)
