[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > [Воркбуки и коллекции](index.md) > Миграция объектов в воркбуки из папок
...
1. На [странице навигации](https://datalens.ru/navigation) найдите объект, который хотите перенести или скопировать в воркбук.
...
Во время переноса DataLens находит связанные объекты рекурсивно по всем связям. Поэтому миграцию можно начать с любого объекта. Например, с дашборда. DataLens найдет все связанные чарты, датасеты и подключения. Затем для найденных объектов также выполнит поиск связей. В итоге DataLens предложит сложить все найденные объекты в один воркбук.
...
Найденные объекты DataLens предложит сложить в один воркбук.
