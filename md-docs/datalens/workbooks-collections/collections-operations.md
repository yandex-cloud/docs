[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > [Воркбуки и коллекции](index.md) > Работа с коллекцией
...
Администратор (пользователь с ролью `datalens.admin`) может просмотреть список удаленных объектов (подключений, датасетов, чартов, дашбордов, отчетов и HTML-страниц) и воркбуков в [настройках сервиса](../settings/deleted-objects.md) и восстановить их.
