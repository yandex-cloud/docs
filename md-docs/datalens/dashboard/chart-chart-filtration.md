[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > Дашборды > Фильтрация чартов чартами

# Фильтрация чартов чартами в Yandex DataLens

DataLens позволяет [настроить фильтрацию чартов другими чартами](../operations/dashboard/add-filtration.md) на дашборде. В этом случае чартом, для которого настроена фильтрация, можно пользоваться как селектором для других чартов.
...
* В чарте **Сводная таблица** фильтрация чартов чартами работает только для показателей.
