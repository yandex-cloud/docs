[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > Дашборды > Тренды и сглаживания в чартах на дашборде

# Тренды и сглаживания в чартах Yandex DataLens

В DataLens вы можете применить сглаживание или добавить линию тренда для чартов на дашборде:
