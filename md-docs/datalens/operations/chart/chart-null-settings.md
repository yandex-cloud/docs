[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > Чарты > Чарты в визарде > Пошаговые инструкции > Настройка отображения пустых (null) значений

# Настройка отображения пустых (null) значений в чарте Yandex DataLens
...
1. В настройках секции чарта с соответствующим показателем для опции **Пустые значения (null)** выберите значение **Отображать как 0**.
