...
1. Нажмите кнопку **Создать чарт** → **QL-чарт**.
1. В открывшемся окне выберите **Тип чарта**:
   ...
   - SQL
     ...
     1. Выберите из списка подключение БД, к которому у вас есть доступ. Убедитесь, что в подключении активирована настройка **Уровень доступа SQL-запросов** → **SQL на чтение**.
     1. Нажмите **Создать**.
...
1. Убедитесь, что в подключении активирована настройка **Уровень доступа SQL-запросов** → **SQL на чтение**.
...
1. Установите значения по умолчанию. Например, `2017-01-01 — 2019-12-31`.
