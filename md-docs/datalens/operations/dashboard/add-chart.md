[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > Дашборды > Пошаговые инструкции > Виджеты на дашборде > Добавление чарта на дашборд

# Добавление чарта на дашборд в Yandex DataLens
...
1. Укажите настройки виджета. Обратите внимание на следующие поля:
   ...
   * **Чарт**. Задает добавляемый виджет. Выберите чарт: 
     ...
     - По ссылке
       ...
       Нажмите кнопку **Указать ссылку**. В поле ввода вставьте ссылку на нужный чарт. Справа нажмите **OK**.
