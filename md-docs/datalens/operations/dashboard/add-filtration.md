[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > Дашборды > Пошаговые инструкции > Настройка фильтрации чартами

# Настройка фильтрации чартами в Yandex DataLens
