[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > Дашборды > Пошаговые инструкции > Настройки дашборда > Изменение настроек дашборда

# Изменение настроек дашборда Yandex DataLens
