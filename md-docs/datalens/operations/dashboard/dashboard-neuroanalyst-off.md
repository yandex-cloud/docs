[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > Дашборды > Пошаговые инструкции > Настройки дашборда > Запрет Нейроаналитика на дашборде

# Запретить использование Нейроаналитика на дашборде в Yandex DataLens

Чтобы запретить использование Нейроаналитика на дашборде:
