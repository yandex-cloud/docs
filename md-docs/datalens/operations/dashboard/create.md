[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > Дашборды > Пошаговые инструкции > Создание дашборда
...
Также вы можете создать черновик дашборда — в режиме редактирования дашборда в правом верхнем углу нажмите значок ![image](../../../_assets/console-icons/chevron-down.svg) → **Сохранить как черновик**. Все изменения в текущей версии будут сохранены в черновике дашборда. Подробнее в разделе [Версионирование в Yandex DataLens](../../dashboard/versioning.md).

#### Что дальше {#what-is-next}

* [Добавление чарта на дашборд в Yandex DataLens](add-chart.md)