...
Также вы можете создать черновик дашборда — в режиме редактирования дашборда в правом верхнем углу нажмите значок ![image](../../../_assets/console-icons/chevron-down.svg) → **Сохранить как черновик**. Все изменения в текущей версии будут сохранены в черновике дашборда. Подробнее см. в разделе [Версионирование в Yandex DataLens](../../dashboard/versioning.md).
