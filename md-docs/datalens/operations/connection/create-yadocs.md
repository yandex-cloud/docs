[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > Подключения > Файлы и сервисы > Создание подключения к Яндекс Документам
...
1. Добавьте файлы с учетом доступа:
   ...
   - Публичный
     ...
     1. Полученную ссылку вставьте в DataLens в поле `Ссылка на файл в Яндекс Документах` и нажмите кнопку **Добавить**.
   ...
   - Приватный
     ...
     1. В DataLens на странице подключения нажмите кнопку **Добавить файл** и перейдите на вкладку `Приватный`.
     1. На вкладке вы увидите сообщение об авторизации в Яндекс Документах. Если вы авторизованы, переходите к следующему шагу инструкции. Если нет, выполните авторизацию:
         ...
         1. Предоставьте приложению **DataLens** права доступа к вашему аккаунту на Яндексе. Нажмите кнопку **Продолжить**.
