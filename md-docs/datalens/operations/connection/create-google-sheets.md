...
1. Добавьте файлы с учетом доступа:
   ...
   - Таблица с ограниченным доступом
     ...
     1. Выберите аккаунт для перехода в приложение **DataLens**.
     1. Предоставьте приложению **DataLens** права доступа к вашему аккаунту Google. Нажмите **Продолжить**.
...
Если в таблице Google Sheets присутствуют пустые ячейки, в DataLens могут некорректно отображаться названия столбцов и пропадать несколько первых строк.
