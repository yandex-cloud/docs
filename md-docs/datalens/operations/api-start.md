...
Для работы с API требуется [IAM-токен](../../iam/operations/iam-token/create.md) и [идентификатор организации](../settings/index.md#service-settings).
...
[MCP-сервер](https://www.npmjs.com/package/@datalens-tech/mcp) DataLens предоставляет доступ агентам LLM к публичному API.
