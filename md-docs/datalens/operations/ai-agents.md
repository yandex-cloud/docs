[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > AI-агенты > Использование DataLens с AI-агентами

# Использование Yandex DataLens с AI-агентами

Вы можете использовать AI-агенты для работы с DataLens. Например, [Claude Code](https://claude.com/claude-code), [Codex](https://developers.openai.com/codex), [OpenCode](https://opencode.ai) и другие. Для этого нужно подключить DataLens к AI-агенту с помощью [MCP-сервера](../concepts/ai-agents.md#mcp) или [Python SDK](../concepts/ai-agents.md#sdk) и установить [навыки](../concepts/ai-agents.md#skills).


## Перед началом работы {#before-you-begin}

* Убедитесь, что у вас есть доступ к [Yandex Cloud](https://console.yandex.cloud) и [DataLens](https://datalens.ru).
* Подготовьте объект в DataLens, с которым будет работать AI-агент: создайте новый [воркбук](../workbooks-collections/index.md) или выберите существующий. Для проверки сценария создания [чарта](../concepts/chart/index.md) в воркбуке должен быть доступный [датасет](../dataset/index.md).
...
## Подключите DataLens к AI-агенту {#connect-agent}

Чтобы подключить DataLens к AI-агенту, добавьте MCP-сервер в AI-агент или установите [datalens-sdk](https://pypi.org/project/datalens-sdk/) — типизированный Python SDK для API DataLens.
...
* **AI-отчет**
    ...
    ```text
    Собери HTML-отчет по итогам квартала и опубликуй его в DataLens.
    ```
...
* [AI-агенты в Yandex DataLens](../concepts/ai-agents.md)
* [Работа с Public API в Yandex DataLens](api-start.md)
