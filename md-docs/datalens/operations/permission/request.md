[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > Управление доступом > Доступ к объектам в папках > Запрос прав доступа

# Запрос прав доступа

{% note info %}

Посмотреть права доступа для дашборда, в котором настроено [сообщение при ошибке доступа](../../dashboard/settings.md#message-settings), могут только пользователи с правами [Редактирование](../../security/manage-access.md#permission-write) или [Администрирование](../../security/manage-access.md#permission-admin) на этот дашборд.
...
- Запрос прав доступа
  ...
  1. На [странице навигации](https://datalens.ru/navigation) найдите папку или объект и нажмите на него.
...
- Изменение прав доступа
  ...
  1. На [странице навигации](https://datalens.ru/navigation) найдите папку или объект.
