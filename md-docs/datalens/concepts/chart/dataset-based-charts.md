...
​Чтобы посмотреть текст SQL-запроса из чарта в источник, в правом верхнем углу чарта нажмите значок ![image](../../../_assets/console-icons/ellipsis.svg) и выберите **Инспектор**. Текст запроса отображается в разделе **Источники данных** → **Запрос в источник данных**. Подробнее читайте в разделе [{#T}](inspector.md).
