[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > [Чарты](index.md) > Чарты в визарде > Мультидатасетные чарты

# Мультидатасетные чарты

{% note info %}

Рекомендуем с осторожностью использовать мультидатасетные чарты. В будущем они станут недоступными, и в DataLens появится альтернативное решение.
