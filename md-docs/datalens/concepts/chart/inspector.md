[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > [Чарты](index.md) > Инспектор чартов

# Инспектор чартов в Yandex DataLens
...
* **Выполнение** — время обработки в DataLens данных, полученных из источника. Старайтесь максимально перенести обработку данных из DataLens на сторону источника.
...
* [Рекомендации по оптимизации в Yandex DataLens](../optimization_recommendations.md)