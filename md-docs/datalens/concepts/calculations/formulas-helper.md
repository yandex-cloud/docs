[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > [Вычисляемые поля](index.md) > Нейроаналитик для создания вычисляемых полей

# Нейроаналитик для создания вычисляемых полей

Нейроаналитик ускоряет и упрощает создание и редактирование формул для вычисляемых полей. Доступен в конструкторе вычисляемых полей на уровне чарта и датасета. С его помощью можно:

* написать новую формулу;
