[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > [Подключения](index.md) > Версионирование
...
Новая версия автоматически создается после нажатия кнопки **Сохранить** в режиме редактирования подключения. Любые изменения конфигурации подключения, доступные в интерфейсе редактирования, приводят к созданию новой версии.
