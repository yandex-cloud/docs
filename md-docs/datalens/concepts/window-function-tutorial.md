...
Показатели можно добавлять как на уровне датасета, так и на уровне чарта. Подробнее см. [Способы создания показателей](aggregation-tutorial.md#create-measure).
