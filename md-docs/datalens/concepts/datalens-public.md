[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > Публикация и встраивание > Публикация объектов

# Публикация объектов

Если предоставить публичный доступ к созданным чартам и дашбордам, любой пользователь сможет пройти по ссылке и посмотреть опубликованный объект без авторизации.
...
Для дашбордов, которые расположены в воркбуке, вы также можете создать [временную ссылку](datalens-temporary-link.md) для публичного доступа, ограниченного по времени.
