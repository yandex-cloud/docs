[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > Решение проблем > Filtration by any of indexed columns required.

# [Yandex DataLens] Filtration by any of indexed columns required
