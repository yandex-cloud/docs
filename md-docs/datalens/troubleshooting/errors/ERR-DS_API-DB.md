[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > Решение проблем > Ошибка выполнения запроса в источнике данных

# [Yandex DataLens] Ошибка выполнения запроса в источнике данных
