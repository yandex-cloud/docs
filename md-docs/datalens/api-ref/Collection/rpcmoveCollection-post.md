[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > DataLens Public API > [DataLens API (англ.)](../index.md) > [Collection](index.md) > Move collection
...
Moves the specified collection to a new location.
...
```text translate=no
https://api.datalens.tech/rpc/moveCollection
```
...
ID of the parent collection to move the collection to.
