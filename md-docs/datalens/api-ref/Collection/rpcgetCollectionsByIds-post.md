[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > DataLens Public API > [DataLens API (англ.)](../index.md) > [Collection](index.md) > Get collections list by ids

<div class="openapi">

# Get collections list by ids

<!-- markdownlint-disable-file -->

Returns collections by their IDs.
...
```text translate=no
https://api.datalens.tech/rpc/getCollectionsByIds
```
