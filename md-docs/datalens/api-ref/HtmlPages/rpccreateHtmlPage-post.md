[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > DataLens Public API > [DataLens API (англ.)](../index.md) > [HtmlPages](index.md) > Create HTML page
...
- {% cut "**Type**: object" %}
  ...
  **Type**: string
  ...
  _Max length:_{.json-schema-reset .json-schema-assertion} `10485760`
...
Warning codes generated while processing the HTML content.
