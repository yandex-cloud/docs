[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > DataLens Public API > [DataLens API (англ.)](../index.md) > [Dashboard](index.md) > Update dashboard
...
```text translate=no
https://api.datalens.tech/rpc/updateDashboard
```
