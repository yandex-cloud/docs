[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > DataLens Public API > [DataLens API (англ.)](../index.md) > [Workbook](index.md) > Move workbooks
...
Moves the specified workbooks to a new collection.
...
```text translate=no
https://api.datalens.tech/rpc/moveWorkbooks
```
...
ID of the collection to move the workbooks to.
