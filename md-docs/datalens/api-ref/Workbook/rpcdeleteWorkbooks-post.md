[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > DataLens Public API > [DataLens API (англ.)](../index.md) > [Workbook](index.md) > Delete workbooks
...
```text translate=no
https://api.datalens.tech/rpc/deleteWorkbooks
```
...
_workbookIds_{.json-schema-reset .json-schema-property .json-schema-required}
{.table-cell}|
**Type**: string[]

IDs of the workbooks to delete.
