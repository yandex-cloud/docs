[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > DataLens Public API > [DataLens API (англ.)](../index.md) > [Workbook](index.md) > Delete workbook
...
```text translate=no
https://api.datalens.tech/rpc/deleteWorkbook
```
