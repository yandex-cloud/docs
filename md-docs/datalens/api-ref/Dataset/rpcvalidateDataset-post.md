[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > DataLens Public API > [DataLens API (англ.)](../index.md) > [Dataset](index.md) > Validate dataset
...
```text translate=no
https://api.datalens.tech/rpc/validateDataset
```
...
{.table-cell}|
**Type**: [DatasetValidate](#entity-DatasetValidate)
...
{% cut "**One of 16 types**" %}{.json-schema-combinators data-marker=or}
...
- **Type**: [datetimetz](#entity-datetimetz)
...
- **Type**: [genericdatetime](#entity-genericdatetime)
...
- **Type**: [array_str](#entity-array_str)
...
- **Type**: [array_int](#entity-array_int)
...
- **Type**: [array_float](#entity-array_float)
...
_calc_mode_{.json-schema-reset .json-schema-property}
{.table-cell}|
**Type**: string

_Enum:_{.json-schema-reset .json-schema-value} `direct`, `formula`, `parameter`
{.table-cell}
||
||
...
_new_id_{.json-schema-reset .json-schema-property}
{.table-cell}|
**Type**: string &#124; null
...
_strict_{.json-schema-reset .json-schema-property}
{.table-cell}|
**Type**: boolean
...
_Const:_{.json-schema-reset .json-schema-value} `add_field`
...
_order_index_{.json-schema-reset .json-schema-property}
{.table-cell}|
**Type**: integer
...
### UpdateField {#entity-UpdateField}
...
### update_field {#entity-update_field}
...
_Const:_{.json-schema-reset .json-schema-value} `update_field`
...
_field_{.json-schema-reset .json-schema-property}
{.table-cell}|
**Type**: [UpdateField](#entity-UpdateField)
...
### DeleteField {#entity-DeleteField}
...
### delete_field {#entity-delete_field}
...
_Const:_{.json-schema-reset .json-schema-value} `delete_field`
...
{.table-cell}|
**Type**: [DeleteField](#entity-DeleteField)
...
_Enum:_{.json-schema-reset .json-schema-value} `none`, `sum`, `avg`, `min`, `max`, `count`, `countunique`, `null`

_Example:_{.json-schema-reset .json-schema-example} `none`
{.table-cell}
||
||
...
_from_guid_{.json-schema-reset .json-schema-property}
{.table-cell}|
**Type**: string
...
### clone_field {#entity-clone_field}
...
_Const:_{.json-schema-reset .json-schema-value} `clone_field`
...
_field_{.json-schema-reset .json-schema-property .json-schema-required}
{.table-cell}|
**Type**: [CloneField](#entity-CloneField)
...
- **BIGQUERY_TABLE**
  ...
  **Type**: [BIGQUERY_TABLE1](#entity-BIGQUERY_TABLE1)
...
- **BIGQUERY_SUBSELECT**
  ...
  **Type**: [BIGQUERY_SUBSELECT1](#entity-BIGQUERY_SUBSELECT1)
...
- **BITRIX_GDS**
  ...
  **Type**: [BITRIX_GDS1](#entity-BITRIX_GDS1)
...
- **CH_BILLING_ANALYTICS_TABLE**
  ...
  **Type**: [CH_BILLING_ANALYTICS_TABLE1](#entity-CH_BILLING_ANALYTICS_TABLE1)
...
- **CH_YA_MUSIC_PODCAST_STATS_TABLE**
  ...
  **Type**: [CH_YA_MUSIC_PODCAST_STATS_TABLE1](#entity-CH_YA_MUSIC_PODCAST_STATS_TABLE1)
...
- **CHYT_YTSAURUS_TABLE**
  ...
  **Type**: [CHYT_YTSAURUS_TABLE1](#entity-CHYT_YTSAURUS_TABLE1)
...
- **CHYT_YTSAURUS_TABLE_LIST**
  ...
  **Type**: [CHYT_YTSAURUS_TABLE_LIST1](#entity-CHYT_YTSAURUS_TABLE_LIST1)
...
- **CHYT_YTSAURUS_TABLE_RANGE**
  ...
  **Type**: [CHYT_YTSAURUS_TABLE_RANGE1](#entity-CHYT_YTSAURUS_TABLE_RANGE1)
...
- **CHYT_YTSAURUS_SUBSELECT**
  ...
  **Type**: [CHYT_YTSAURUS_SUBSELECT1](#entity-CHYT_YTSAURUS_SUBSELECT1)
...
- **CH_TABLE**
  ...
  **Type**: [CH_TABLE1](#entity-CH_TABLE1)
...
- **CH_SUBSELECT**
  ...
  **Type**: [CH_SUBSELECT1](#entity-CH_SUBSELECT1)
...
- **EQUEO_CH_TABLE**
  ...
  **Type**: [EQUEO_CH_TABLE1](#entity-EQUEO_CH_TABLE1)
...
- **EXTRACTOR_1C_CH_TABLE**
  ...
  **Type**: [EXTRACTOR_1C_CH_TABLE1](#entity-EXTRACTOR_1C_CH_TABLE1)
...
- **GP_TABLE**
  ...
  **Type**: [GP_TABLE1](#entity-GP_TABLE1)
...
- **GP_SUBSELECT**
  ...
  **Type**: [GP_SUBSELECT1](#entity-GP_SUBSELECT1)
...
- **KONTUR_MARKET_CH_TABLE**
  ...
  **Type**: [KONTUR_MARKET_CH_TABLE1](#entity-KONTUR_MARKET_CH_TABLE1)
...
- **MOYSKLAD_CH_TABLE**
  ...
  **Type**: [MOYSKLAD_CH_TABLE1](#entity-MOYSKLAD_CH_TABLE1)
...
- **MSSQL_TABLE**
  ...
  **Type**: [MSSQL_TABLE1](#entity-MSSQL_TABLE1)
...
- **MSSQL_SUBSELECT**
  ...
  **Type**: [MSSQL_SUBSELECT1](#entity-MSSQL_SUBSELECT1)
...
- **MYSQL_TABLE**
  ...
  **Type**: [MYSQL_TABLE1](#entity-MYSQL_TABLE1)
...
- **MYSQL_SUBSELECT**
  ...
  **Type**: [MYSQL_SUBSELECT1](#entity-MYSQL_SUBSELECT1)
...
- **ORACLE_TABLE**
  ...
  **Type**: [ORACLE_TABLE1](#entity-ORACLE_TABLE1)
...
- **ORACLE_SUBSELECT**
  ...
  **Type**: [ORACLE_SUBSELECT1](#entity-ORACLE_SUBSELECT1)
...
- **PG_TABLE**
  ...
  **Type**: [PG_TABLE1](#entity-PG_TABLE1)
...
- **PG_SUBSELECT**
  ...
  **Type**: [PG_SUBSELECT1](#entity-PG_SUBSELECT1)
...
- **CH_SMB_HEATMAPS_TABLE**
  ...
  **Type**: [CH_SMB_HEATMAPS_TABLE1](#entity-CH_SMB_HEATMAPS_TABLE1)
...
- **SNOWFLAKE_TABLE**
  ...
  **Type**: [SNOWFLAKE_TABLE1](#entity-SNOWFLAKE_TABLE1)
...
- **SPEECHSENSE_TABLE**
  ...
  **Type**: [SPEECHSENSE_TABLE1](#entity-SPEECHSENSE_TABLE1)
...
- **TRINO_TABLE**
  ...
  **Type**: [TRINO_TABLE1](#entity-TRINO_TABLE1)
...
- **TRINO_SUBSELECT**
  ...
  **Type**: [TRINO_SUBSELECT1](#entity-TRINO_SUBSELECT1)
...
- **CH_USAGE_TRACKING_TABLE**
  ...
  **Type**: [CH_USAGE_TRACKING_TABLE1](#entity-CH_USAGE_TRACKING_TABLE1)
...
- **CH_USAGE_TRACKING_AGG_TABLE**
  ...
  **Type**: [CH_USAGE_TRACKING_AGG_TABLE1](#entity-CH_USAGE_TRACKING_AGG_TABLE1)
...
- **YDB_TABLE**
  ...
  **Type**: [YDB_TABLE1](#entity-YDB_TABLE1)
...
- **YDB_SUBSELECT**
  ...
  **Type**: [YDB_SUBSELECT1](#entity-YDB_SUBSELECT1)
...
- **YQ_TABLE**
  ...
  **Type**: [YQ_TABLE1](#entity-YQ_TABLE1)
...
- **YQ_SUBSELECT**
  ...
  **Type**: [YQ_SUBSELECT1](#entity-YQ_SUBSELECT1)
...
_Const:_{.json-schema-reset .json-schema-value} `add_source`
...
_source_{.json-schema-reset .json-schema-property .json-schema-required}
{.table-cell}|
**Type**: [DataSource](#entity-DataSource)
...
### update_source {#entity-update_source}
...
_Const:_{.json-schema-reset .json-schema-value} `update_source`
...
### delete_source {#entity-delete_source}
...
_Const:_{.json-schema-reset .json-schema-value} `delete_source`
...
_source_{.json-schema-reset .json-schema-property .json-schema-required}
{.table-cell}|
**Type**: [SourceBase](#entity-SourceBase)
...
### RefreshSource {#entity-RefreshSource}

#|
|| **Name** | **Description** ||
||

_force_update_fields_{.json-schema-reset .json-schema-property}
{.table-cell}|
**Type**: boolean
...
### refresh_source {#entity-refresh_source}
...
_Const:_{.json-schema-reset .json-schema-value} `refresh_source`
...
_source_{.json-schema-reset .json-schema-property .json-schema-required}
{.table-cell}|
**Type**: [RefreshSource](#entity-RefreshSource)
...
### add_source_avatar {#entity-add_source_avatar}
...
_Const:_{.json-schema-reset .json-schema-value} `add_source_avatar`
...
_source_avatar_{.json-schema-reset .json-schema-property .json-schema-required}
{.table-cell}|
**Type**: [SourceAvatar](#entity-SourceAvatar)
...
_disable_fields_update_{.json-schema-reset .json-schema-property}
{.table-cell}|
**Type**: boolean
...
### update_source_avatar {#entity-update_source_avatar}
...
_Const:_{.json-schema-reset .json-schema-value} `update_source_avatar`
...
### delete_source_avatar {#entity-delete_source_avatar}
...
_Const:_{.json-schema-reset .json-schema-value} `delete_source_avatar`
...
_source_avatar_{.json-schema-reset .json-schema-property .json-schema-required}
{.table-cell}|
**Type**: [AvatarBase](#entity-AvatarBase)
...
### add_avatar_relation {#entity-add_avatar_relation}
...
_Const:_{.json-schema-reset .json-schema-value} `add_avatar_relation`
...
_avatar_relation_{.json-schema-reset .json-schema-property .json-schema-required}
{.table-cell}|
**Type**: [AvatarRelation](#entity-AvatarRelation)
...
### update_avatar_relation {#entity-update_avatar_relation}
...
_Const:_{.json-schema-reset .json-schema-value} `update_avatar_relation`
...
### delete_avatar_relation {#entity-delete_avatar_relation}
...
_Const:_{.json-schema-reset .json-schema-value} `delete_avatar_relation`
...
_avatar_relation_{.json-schema-reset .json-schema-property .json-schema-required}
{.table-cell}|
**Type**: [RelationBase](#entity-RelationBase)
...
### ReplaceConnection {#entity-ReplaceConnection}
...
_new_id_{.json-schema-reset .json-schema-property .json-schema-required}
{.table-cell}|
**Type**: string
...
### replace_connection {#entity-replace_connection}
...
_Const:_{.json-schema-reset .json-schema-value} `replace_connection`
...
_connection_{.json-schema-reset .json-schema-property}
{.table-cell}|
**Type**: [ReplaceConnection](#entity-ReplaceConnection)
...
### add_obligatory_filter {#entity-add_obligatory_filter}
...
_Const:_{.json-schema-reset .json-schema-value} `add_obligatory_filter`
...
_obligatory_filter_{.json-schema-reset .json-schema-property .json-schema-required}
{.table-cell}|
**Type**: [ObligatoryFilter](#entity-ObligatoryFilter)
...
### update_obligatory_filter {#entity-update_obligatory_filter}
...
_Const:_{.json-schema-reset .json-schema-value} `update_obligatory_filter`
...
### DeleteObligatoryFilter {#entity-DeleteObligatoryFilter}
...
### delete_obligatory_filter {#entity-delete_obligatory_filter}
...
_Const:_{.json-schema-reset .json-schema-value} `delete_obligatory_filter`
...
_obligatory_filter_{.json-schema-reset .json-schema-property .json-schema-required}
{.table-cell}|
**Type**: [DeleteObligatoryFilter](#entity-DeleteObligatoryFilter)
...
_Enum:_{.json-schema-reset .json-schema-value} `load_preview_by_default`, `template_enabled`, `data_export_forbidden`
{.table-cell}
||
||
...
### update_setting {#entity-update_setting}
...
_Const:_{.json-schema-reset .json-schema-value} `update_setting`
...
_setting_{.json-schema-reset .json-schema-property .json-schema-required}
{.table-cell}|
**Type**: [Setting](#entity-Setting)
...
### update_description {#entity-update_description}
...
_Const:_{.json-schema-reset .json-schema-value} `update_description`
...
### update_cache_invalidation_source {#entity-update_cache_invalidation_source}
...
_Const:_{.json-schema-reset .json-schema-value} `update_cache_invalidation_source`
...
_cache_invalidation_source_{.json-schema-reset .json-schema-property .json-schema-required}
{.table-cell}|
**Type**: [CacheInvalidationSource](#entity-CacheInvalidationSource)
...
{% cut "**One of 21 types**" %}{.json-schema-combinators data-marker=or}

- **add_field**

  **Type**: [add_field](#entity-add_field)
...
- **update_field**
  ...
  **Type**: [update_field](#entity-update_field)
...
- **delete_field**
  ...
  **Type**: [delete_field](#entity-delete_field)
...
- **clone_field**
  ...
  **Type**: [clone_field](#entity-clone_field)
...
- **add_source**
  ...
  **Type**: [add_source](#entity-add_source)
...
- **update_source**
  ...
  **Type**: [update_source](#entity-update_source)
...
- **delete_source**
  ...
  **Type**: [delete_source](#entity-delete_source)
...
- **refresh_source**
  ...
  **Type**: [refresh_source](#entity-refresh_source)
...
- **add_source_avatar**
  ...
  **Type**: [add_source_avatar](#entity-add_source_avatar)
...
- **update_source_avatar**
  ...
  **Type**: [update_source_avatar](#entity-update_source_avatar)
...
- **delete_source_avatar**
  ...
  **Type**: [delete_source_avatar](#entity-delete_source_avatar)
...
- **add_avatar_relation**
  ...
  **Type**: [add_avatar_relation](#entity-add_avatar_relation)
...
- **update_avatar_relation**
  ...
  **Type**: [update_avatar_relation](#entity-update_avatar_relation)
...
- **delete_avatar_relation**
  ...
  **Type**: [delete_avatar_relation](#entity-delete_avatar_relation)
...
- **replace_connection**
  ...
  **Type**: [replace_connection](#entity-replace_connection)
...
- **add_obligatory_filter**
  ...
  **Type**: [add_obligatory_filter](#entity-add_obligatory_filter)
...
- **update_obligatory_filter**
  ...
  **Type**: [update_obligatory_filter](#entity-update_obligatory_filter)
...
- **delete_obligatory_filter**
  ...
  **Type**: [delete_obligatory_filter](#entity-delete_obligatory_filter)
...
- **update_setting**
  ...
  **Type**: [update_setting](#entity-update_setting)
...
- **update_description**
  ...
  **Type**: [update_description](#entity-update_description)
...
- **update_cache_invalidation_source**
  ...
  **Type**: [update_cache_invalidation_source](#entity-update_cache_invalidation_source)
...
### DatasetValidate {#entity-DatasetValidate}

#|
|| **Name** | **Description** ||
||

_dataset_{.json-schema-reset .json-schema-property}
{.table-cell}|
...
_updates_{.json-schema-reset .json-schema-property}
{.table-cell}|
**Type**: [Action](#entity-Action)[]
...
- **Type**: [datetimetz](#entity-datetime)
...
- **Type**: [genericdatetime](#entity-datetime)
...
- **Type**: [array_float](#entity-geopoint)
...
- **Type**: [tree_str](#entity-array_str)
...
_field_{.json-schema-reset .json-schema-property}
{.table-cell}|
**Type**: [AddField](#entity-AddField1)
...
### UpdateField {#entity-UpdateField1}
...
### update_field {#entity-update_field1}
...
_field_{.json-schema-reset .json-schema-property}
{.table-cell}|
**Type**: [UpdateField](#entity-UpdateField1)
...
_source_{.json-schema-reset .json-schema-property .json-schema-required}
{.table-cell}|
**Type**: [DataSource](#entity-DataSource1)
...
### update_source {#entity-update_source1}
...
### SourceAvatar {#entity-SourceAvatar1}
...
### add_source_avatar {#entity-add_source_avatar1}
...
_source_avatar_{.json-schema-reset .json-schema-property .json-schema-required}
{.table-cell}|
**Type**: [SourceAvatar](#entity-SourceAvatar1)
...
### update_source_avatar {#entity-update_source_avatar1}
...
### delete_source_avatar {#entity-delete_source_avatar1}
...
_source_avatar_{.json-schema-reset .json-schema-property .json-schema-required}
{.table-cell}|
**Type**: [AvatarBase](#entity-SourceBase)
...
### add_avatar_relation {#entity-add_avatar_relation1}
...
### update_avatar_relation {#entity-update_avatar_relation1}
...
### delete_avatar_relation {#entity-delete_avatar_relation1}
...
_avatar_relation_{.json-schema-reset .json-schema-property .json-schema-required}
{.table-cell}|
**Type**: [RelationBase](#entity-SourceBase)
...
### update_cache_invalidation_source {#entity-update_cache_invalidation_source1}
...
- **add_field**
  ...
  **Type**: [add_field](#entity-add_field1)
...
- **update_field**
  ...
  **Type**: [update_field](#entity-update_field1)
...
- **add_source**
  ...
  **Type**: [add_source](#entity-add_source1)
...
- **update_source**
  ...
  **Type**: [update_source](#entity-update_source1)
...
- **add_source_avatar**
  ...
  **Type**: [add_source_avatar](#entity-add_source_avatar1)
...
- **update_source_avatar**
  ...
  **Type**: [update_source_avatar](#entity-update_source_avatar1)
...
- **delete_source_avatar**
  ...
  **Type**: [delete_source_avatar](#entity-delete_source_avatar1)
...
- **add_avatar_relation**
  ...
  **Type**: [add_avatar_relation](#entity-add_avatar_relation1)
...
- **update_avatar_relation**
  ...
  **Type**: [update_avatar_relation](#entity-update_avatar_relation1)
...
- **delete_avatar_relation**
  ...
  **Type**: [delete_avatar_relation](#entity-delete_avatar_relation1)
...
- **update_cache_invalidation_source**
  ...
  **Type**: [update_cache_invalidation_source](#entity-update_cache_invalidation_source1)
...
### DatasetValidate {#entity-DatasetValidate1}
