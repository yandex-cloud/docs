[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > DataLens Public API > [DataLens API (англ.)](../index.md) > [Dataset](index.md) > Get dataset
...
```text translate=no
https://api.datalens.tech/rpc/getDataset
```
