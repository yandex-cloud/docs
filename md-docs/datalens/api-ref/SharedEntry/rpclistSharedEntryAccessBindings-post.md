[Документация Yandex Cloud](../../../index.md) > [Yandex DataLens](../../index.md) > DataLens Public API > [DataLens API (англ.)](../index.md) > [SharedEntry](index.md) > List shared entry access bindings
...
ID of the entry whose access bindings are requested.
...
Whether to include inherited access bindings.
{.table-cell}
||
||
...
Maximum number of access bindings to return.
{.table-cell}
||
||
...
Token for the next page of access bindings.
