...
Это оптимизирует работу с данными. Подробнее в разделе [{#T}](types-lookup-table.md).
...
Вы можете определить массив внутри {{ datalens-short-name }} с помощью функции [ARRAY](../function-ref/ARRAY.md).
