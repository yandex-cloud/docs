[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > [Датасеты](index.md) > Модель данных

# Модель данных в Yandex DataLens
...
Подробнее про оптимизацию при использовании оператора `JOIN` в разделе [Оптимизация данных при объединении таблиц](../concepts/data-join.md#join-optimization).
...
Подробнее о вычисляемых полях читайте в разделе [Вычисляемые поля в Yandex DataLens](../concepts/calculations/index.md).
...
Подробнее о типах данных в разделе [Типы данных Yandex DataLens](data-types.md).
