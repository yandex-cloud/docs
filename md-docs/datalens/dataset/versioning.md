# Версионирование в Yandex DataLens
...
Новая версия автоматически создается после нажатия кнопки **Сохранить** в режиме редактирования датасета.
...
* изменения на вкладке **Источники**:
  ...
  * [добавление данных](create-dataset.md#add-data) на рабочую область из таблиц источника или через SQL-запрос;
  * [настройка связей](create-dataset.md#links);
...
* добавление, редактирование, удаление [полей](create-dataset.md#field-operations) на вкладке **Поля**;
* добавление, редактирование, удаление [параметра](create-dataset.md#add-parameters) на вкладке **Параметры**;
* добавление, редактирование, удаление [фильтра](create-dataset.md#add-filters) на вкладке **Фильтрация**.
