[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > [История изменений](index.md) > Архив > Июль 2025

# История изменений в Yandex DataLens в июле 2025
...
* Появились новые работы в [DataLens Gallery](https://datalens.ru/gallery). Подробнее в чате [DataLens](https://t.me/YandexDataLens/28631/136577) в Telegram.
...
* Исправили изменение структуры таблицы при смене типа таблицы на [сводную таблицу](../visualization-ref/pivot-table-chart.md).
