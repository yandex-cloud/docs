[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > [История изменений](index.md) > Архив > Март 2025

# История изменений в Yandex DataLens в марте 2025
...
Добавили [настройку](../concepts/chart/settings.md), позволяющую выбрать тип разметки для строковых полей некоторых визуализаций. Доступные значения: `HTML`, `Markdown` или `Нет`.
...
* Добавили блок с [отчетами](../reports/index.md) на [главную страницу](https://datalens.ru/?skipPromo=true) DataLens.
