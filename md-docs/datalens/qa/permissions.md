[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > Решение проблем > [Вопросы и ответы](index.md) > Пользователи и управление доступом
...
Также вы можете сделать свой дашборд публичным с помощью [Публикация объектов](../concepts/datalens-public.md).
