[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > [Практические руководства](index.md) > Аналитика сервисов > Яндекс Метрика: прямое подключение
...
Стандартный [дашборд](../concepts/dashboard.md) можно настроить под себя: например, удалить, переместить или редактировать чарты.
