[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > [Практические руководства](index.md) > Знакомство с DataLens > Публичный чарт с картой Москвы из CSV-файла
...
Создайте [подключение](../concepts/connection/index.md) к файлу с исходными данными.
...
Создайте [датасет](../dataset/index.md) на базе подключения `Moscow Population 2018`:
...
Для визуализации распределения населения Москвы по районам создайте [чарт](../concepts/chart/index.md) — [тепловую карту](../visualization-ref/choropleth-map-chart.md):
...
* [Создать дашборд](../operations/dashboard/create.md) с картой, столбчатой диаграммой и [селекторами](../operations/dashboard/add-selector.md).
* [Опубликовать дашборд](../concepts/datalens-public.md#how-to-publish).