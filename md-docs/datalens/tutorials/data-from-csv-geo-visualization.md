...
* работать с основными сущностями {{ datalens-short-name }}: [подключения](../concepts/connection/index.md), [датасеты](../dataset/index.md), [чарты](../concepts/chart/index.md), [дашборды](../concepts/dashboard.md);
