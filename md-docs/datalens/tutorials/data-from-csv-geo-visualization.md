[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > [Практические руководства](index.md) > Работа с геоданными > Анализ открытых данных ДТП на дорогах России
...
* работать с основными сущностями DataLens: [подключения](../concepts/connection/index.md), [датасеты](../dataset/index.md), [чарты](../concepts/chart/index.md), [дашборды](../concepts/dashboard.md);
...
Создайте [подключение](../concepts/connection/index.md) к файлам с исходными данными:
...
1. Перейдите на вкладку **Поля**. На этой вкладке можно добавить [поля данных](../dataset/data-model.md#field) и [вычисляемые поля](../concepts/calculations/index.md), изменить тип данных поля, правила агрегации, переименовать поле.
1. Переименуйте поля:
...
Для визуализации плотности распределения ДТП по регионам создайте [тепловую карту](../visualization-ref/heat-map-chart.md):
...
Чтобы проанализировать количество ДТП по регионам, создайте [линейчатую диаграмму](../visualization-ref/bar-chart.md):
...
[Селекторы](../concepts/dashboard.md#selector) позволяют фильтровать данные по значениям.
