...
В этом руководстве вы настроите передачу событий [Yandex Cloud Postbox](../../postbox/index.md) в [Yandex Data Streams](../../data-streams/index.md) и визуализацию этих событий с помощью [Yandex DataLens](../index.md) для последующего анализа. Источник событий — отправка электронных писем.
...
Чтобы наблюдать за отправкой писем, настройте [подключение](../concepts/connection/index.md), создайте [датасет](../dataset/index.md), [чарты](../concepts/chart/index.md) и [дашборд](../concepts/dashboard.md).
...
- Интерфейс DataLens {#console}
  ...
  1. Выберите [тип чарта](../visualization-ref/line-chart.md) **Столбчатая диаграмма**.
...
- Интерфейс DataLens {#console}
  ...
  1. Выберите [тип чарта](../visualization-ref/line-chart.md) **Таблица**.
