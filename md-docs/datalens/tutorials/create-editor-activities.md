[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > [Практические руководства](index.md) > Функциональные > Пример использования вкладки Activities в Editor

# Пример использования вкладки Activities в Editor


[Editor](../charts/editor/index.md) — редактор для создания визуализации данных и селекторов с помощью кода на JavaScript. Editor позволяет загружать данные из одного или нескольких источников, управлять параметрами чартов и настраивать визуализации. В качестве источников данных вы можете использовать датасеты и подключения.
...
1. Введите название [воркбука](../workbooks-collections/index.md) — `Activities в Editor`.
1. Нажмите кнопку **Создать**.
