[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > [Практические руководства](index.md) > Аналитика сервисов > Визуализация данных Yandex Query
...
Для визуализации и исследования используйте [чарт](../concepts/chart/index.md) типа [комбинированная диаграмма](../visualization-ref/combined-chart.md).
...
Аналогичным образом вы можете построить дополнительные [чарты](../operations/chart/create-chart.md) и [дашборды](../operations/dashboard/create.md) и [поделиться результатом](../concepts/datalens-public.md) с коллегами.