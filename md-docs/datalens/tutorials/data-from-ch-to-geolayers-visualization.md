# Анализ продаж и локаций пиццерий на данных из БД {{ CH }} и Галереи {{ datalens-short-name }}
...
В качестве источника используется демонстрационная база данных {{ CH }} и демо-воркбук из работы [Организации: спрос и предложение]({{ link-datalens-main }}/gallery/euma77kb36nc0) в Галерее.
...
1. В Галерее откройте работу с названием [Организации: спрос и предложение]({{ link-datalens-main }}/gallery/euma77kb36nc0).
