[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > [Практические руководства](index.md) > Функциональные > Использование параметров в вычисляемых полях
...
Добавьте [селекторы](../dashboard/selector.md) с ручным вводом, чтобы менять значения параметров в чартах.
