[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > [Практические руководства](index.md) > Функциональные > Параметризация источников
...
1. Введите название [воркбука](../workbooks-collections/index.md) — `Dataset parametrisation`.
1. Нажмите кнопку **Создать**.
...
1. Включите [параметризацию](../dataset/parametrization.md) в настройках датасета. Для этого вверху нажмите ![icon](../../_assets/console-icons/gear.svg) → **Включить параметризацию**.
...
1. Создайте [вычисляемое поле](../concepts/calculations/index.md):
