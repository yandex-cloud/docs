[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > [Отчеты](index.md) > Нейроаналитик в отчетах
...
Вы можете [запретить](report-operations.md#report-neuroanalyst-off) использование Нейроаналитика для отчета.
