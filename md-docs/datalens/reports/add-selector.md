...
Перед добавлением селектора убедитесь, что у вас есть право доступа `Редактирование` или `Администрирование` в отчете. Подробнее в разделе [Права доступа к объектам](../security/manage-access.md).
