[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > [Отчеты](index.md) > Работа с отчетами
...
1. Настройте виджет:
   ...
   - Изображение {#image}
     ...
     * Добавьте ссылку на [изображение](../dashboard/markdown.md#image), размещенное в хранилище [Yandex Object Storage](../../storage/quickstart.md).

       {% note warning %}

       В Yandex Object Storage необходимо задать настройки [CORS](../../storage/operations/buckets/cors.md) для бакета с изображением:
   ...
   - Текст {#text}
     ...
     * Введите текст ссылки, поясняющей надписи и т.д. Виджет поддерживает язык разметки [Markdown](../dashboard/markdown.md).
       ...
       * абсолютную ссылку — для перехода на страницу в интернете.
       ...
       Если вставляете в виджет изображение, размещенное в хранилище Yandex Object Storage, задайте настройки [CORS](../../storage/operations/buckets/cors.md) для бакета с изображением:
...
1. Задайте настройки колонтитула:
   ...
   * **Текст колонтитула** — отображает колонтитул, текст которого задается в поле справа. Если оставить поле пустым, колонтитул не отображается. По умолчанию опция выключена и отображается стандартный колонтитул: `Построено в DataLens`.
...
Подробнее в разделе [Селекторы в отчетах](add-selector.md).
