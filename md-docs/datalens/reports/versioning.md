[Документация Yandex Cloud](../../index.md) > [Yandex DataLens](../index.md) > [Отчеты](index.md) > Версионирование
...
1. **Актуальная**. Последняя сохраненная версия отчета.
   ...
   * при открытии отчета из контекстного меню на редактирование с дашборда.
   ...
   Если у пользователя есть право доступа **Редактирование**, он может сделать актуальной любую версию отчета.
