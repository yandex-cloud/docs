[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for Valkey™](../index.md) > [Практические руководства](index.md) > Миграция базы данных в Yandex Managed Service for Valkey™
    ...
    - Подключение без TLS {#without-tls}
        ...
        **Подключение к шардированному кластеру**
        ...
        1. Запустите скрипт:
            ...
            Во время работы скрипта будут выводиться сообщения об ошибках вставки данных. Это нормальное поведение команды `redis-cli`, связанное с тем, что в шардированном кластере каждый шард хранит только часть данных. Подробнее в разделе [Шардирование в Yandex Managed Service for Valkey™](../concepts/sharding.md).
...
1. [Перейдите](https://console.yandex.cloud/link/managed-redis) в сервис **Yandex Managed Service for&nbsp;Valkey™**.
1. Нажмите на имя нужного кластера и выберите ![chevron-down](../../_assets/console-icons/chevron-down.svg) **Другое** → [Мониторинг](../operations/monitoring.md).
