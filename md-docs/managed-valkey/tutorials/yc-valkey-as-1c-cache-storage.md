[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for Valkey™](../index.md) > [Практические руководства](index.md) > Использование кластера Yandex Managed Service for Valkey™ в качестве хранилища кеша для «1С-Битрикс: Управление сайтом»
...
- Вручную {#manual}
  ...
  1. Укажите, что для кеширования используется Redis, и задайте адрес кластера Yandex Managed Service for Valkey™:
      ...
      Идентификатор кластера можно получить со [списком кластеров](../operations/cluster-list.md#list-clusters) в каталоге.
