...
1. [Назначьте](../iam/operations/roles/grant.md) вашему аккаунту в Yandex Cloud роль [vpc.user](../vpc/security/index.md#vpc-user) и роль [managed-redis.editor или выше](security/index.md#roles-list). Эти роли позволяют создать кластер.
...
Подробнее о создании кластера см. в разделе [Создание кластера Valkey™](operations/cluster-create.md).
