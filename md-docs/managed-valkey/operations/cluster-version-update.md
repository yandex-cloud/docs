...
1. Посмотрите в [истории изменений](https://github.com/valkey-io/valkey/releases) Valkey™, как обновления могут повлиять на работу ваших приложений.
...
- Консоль управления {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) выберите каталог с кластером, который нужно обновить.
