...
Каждая версия Valkey™, поддержка которой была включена в Yandex Managed Service for Valkey™, остается доступной, пока она поддерживается производителем. Как правило, это 24 месяца с даты выпуска версии. Подробнее см. в [документации Valkey™](https://valkey.io/topics/releases/).
