[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for Valkey™](../index.md) > [Пошаговые инструкции](index.md) > Кластеры > Создание кластера
...
Для создания кластера Yandex Managed Service for Valkey™ и работы с ним вашему аккаунту в Yandex Cloud нужны роли:
...
- REST API {#api}
    ...
    1. Создайте файл `body.json` и добавьте в него следующее содержимое:
        ...
        * `configSpec` — настройки кластера:
            ...
            * `redis.auditLog` — включить логирование событий аудита о подключении и авторизации: `true` или `false`. Логирование событий аудита может влиять на производительность кластера.
...
- gRPC API {#grpc-api}
    ...
    1. Создайте файл `body.json` и добавьте в него следующее содержимое:
        ...
        * `config_spec` — настройки кластера:
            ...
            * `redis.password` — пароль пользователя.
            * `redis.audit_log` — включить логирование событий аудита о подключении и авторизации: `true` или `false`. Логирование событий аудита может влиять на производительность кластера.
