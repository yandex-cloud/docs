[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for Valkey™](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [BackupRetentionPolicy](index.md) > Delete
...
**rpc Delete ([DeleteBackupRetentionPolicyRequest](#yandex.cloud.mdb.redis.v1.DeleteBackupRetentionPolicyRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**
