[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for Valkey™](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > [ChangeFreeze](index.md) > List

# Managed Service for Redis API, gRPC: ChangeFreezeService.List
