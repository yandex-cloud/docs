...
```
GET https://mdb.api.cloud.yandex.net/managed-redis/v1/versions
```

## Query parameters {#yandex.cloud.mdb.redis.v1.ListVersionsRequest}
...
## Response {#yandex.cloud.mdb.redis.v1.ListVersionsResponse}
