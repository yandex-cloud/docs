[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for Valkey™](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Cluster](index.md) > AddHosts

# Managed Service for Redis API, REST: Cluster.AddHosts
...
## Body parameters {#yandex.cloud.mdb.redis.v1.AddClusterHostsRequest}
