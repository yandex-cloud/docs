...
set with the [ClusterService.Get](../../../managed-redis/api-ref/Cluster/get#Get) method, then send an [ClusterService.Update](#Update) request with the new label added to the set.
