[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for Valkey™](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Maintenance](index.md) > List

# Managed Service for Redis API, REST: Maintenance.List
...
```
GET https://mdb.api.cloud.yandex.net/managed-redis/v1/maintenances
```
