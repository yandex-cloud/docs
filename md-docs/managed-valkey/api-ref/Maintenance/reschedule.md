[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for Valkey™](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Maintenance](index.md) > Reschedule

# Managed Service for Redis API, REST: Maintenance.Reschedule
...
```
POST https://mdb.api.cloud.yandex.net/managed-redis/v1/maintenances/{maintenanceId}:reschedule
```
