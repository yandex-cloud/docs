[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for Valkey™](../../../index.md) > [Справочник CLI (англ.)](../../index.md) > [v0](../index.md) > [cluster](index.md) > add-access-binding

# yc managed-redis v0 cluster add-access-binding

Add access binding for the specified Redis cluster

#### Command Usage

Syntax:

`yc managed-redis cluster add-access-binding <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
