...
* **Нереплицируемые SSD-диски** (`network-ssd-nonreplicated`) — сетевые SSD-диски с повышенной производительностью, реализованной за счет устранения избыточности.
  ...
  Этот тип дисков недоступен для платформы **Intel Broadwell**. Список классов хостов и соответствующих им платформ описан в разделе [Классы хостов Valkey™](instance-types.md).
