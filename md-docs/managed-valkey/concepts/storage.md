...
1. [Создайте алерт](../../monitoring/operations/alert/create-alert.md) со следующими параметрами:
  ...
  1. **Метрики** — задайте параметры метрики:
      ...
      * Облако.
      * Каталог.
      * Сервис **Yandex Managed Service for&nbsp;Valkey™**.
      * Метка `disk.free_bytes`.
      * Нужный кластер Yandex Managed Service for Valkey™. Имя и идентификатор кластера можно [получить со списком кластеров в каталоге](../operations/cluster-list.md#list-clusters).
