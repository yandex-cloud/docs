...
* **Нереплицируемые SSD-диски** (`network-ssd-nonreplicated`) — сетевые SSD-диски с повышенной производительностью, реализованной за счет устранения избыточности.
  ...
  Этот тип дисков недоступен для платформы **Intel Broadwell**. Список классов хостов и соответствующих им платформ см. в разделе [Классы хостов Valkey™](instance-types.md).
...
* **Локальные SSD-диски** (`local-ssd`) — самые быстрые диски.
  ...
  * для платформ **Intel Ice Lake** и **AMD Zen 4** — только с шагом 368 ГБ.
  ...
  Список классов хостов и соответствующих им платформ см. в разделе [Классы хостов Valkey™](instance-types.md).
