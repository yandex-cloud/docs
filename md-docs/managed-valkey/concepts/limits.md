[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for Valkey™](../index.md) > [Концепции](index.md) > Квоты и лимиты

# Квоты и лимиты в Yandex Managed Service for Valkey™


В сервисе Yandex Managed Service for Valkey™ действуют следующие ограничения:
...
^*^ Эти типы дисков доступны только для определенных платформ, подробнее в разделе [Хранилище в Yandex Managed Service for Valkey™](storage.md).