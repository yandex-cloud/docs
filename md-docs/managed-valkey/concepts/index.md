...
Valkey™ — это высокопроизводительная СУБД для данных типа «ключ-значение», работающая в оперативной памяти. Сервис Yandex Managed Service for Valkey™ позволяет легко создавать [кластеры](../../glossary/cluster.md) хостов Valkey™ с высокой отказоустойчивостью.
