[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for Valkey™](../../index.md) > [Концепции](../index.md) > Классы хостов > Архив > До 20 июня 2023 года

# Классы хостов Redis до 20 июня 2023 года
...
Выделенный для хоста объем памяти также определяет параметр конфигурации `maxmemory` для хостов Redis: максимальный объем данных равен 75% доступной памяти. Подробнее в разделе [Управление памятью](../memory-management.md).
...
Размер доступного хосту хранилища должен как минимум в два раза превышать выбранный объем памяти. Технические и организационные ограничения Yandex Managed Service for Valkey™ приведены в разделе [Квоты и лимиты](../limits.md).
...
* **high-memory** — стандартные конфигурации для Redis.
