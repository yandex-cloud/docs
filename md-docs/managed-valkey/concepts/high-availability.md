...
На высокую доступность кластера Yandex Managed Service for Valkey™ влияют параметры, относящиеся к [SLA](https://yandex.ru/legal/cloud_sla_mdb/ru/#klastera-servisa-upravlyaemogo-valkey-/-yandex-managed-service-for-valkey,-popadayushie-pod-dejstvie-urovnya-obsluzhivaniya), а также некоторые другие настройки.
...
* Включите [автоматическое увеличение размера хранилища](storage.md#auto-rescale).
* Создайте [алерт](storage.md#read-only-monitor) для отслеживания степени заполнения хранилища.
...
На доступность кластера влияет конфигурация хостов. Высокодоступный кластер должен иметь конфигурацию с гарантированной долей vCPU 100%. Тип конфигурации **burstable** с гарантированной долей vCPU 50% не обеспечивает высокой доступности и должен использоваться только для тестовых окружений.
