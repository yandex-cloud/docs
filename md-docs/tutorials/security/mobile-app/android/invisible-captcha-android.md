[Документация Yandex Cloud](../../../../index.md) > [Практические руководства](../../../index.md) > [Безопасность](../../index.md) > Сценарии использования SmartCaptcha > Невидимая капча в приложении Android
...
1. [Разместите HTML-код](../../../../smartcaptcha/tutorials/mobile-app/website.md) для работы [SmartCaptcha](../../../../smartcaptcha/index.md) (или воспользуйтесь готовым `https://smartcaptcha.cloud.yandex.ru/webview`).
