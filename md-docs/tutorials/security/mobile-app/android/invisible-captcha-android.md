...
1. [Разместите HTML-код](../../../../smartcaptcha/tutorials/mobile-app/website.md) для работы [{{ captcha-name }}](../../../../smartcaptcha/index.md) (или воспользуйтесь готовым `{{ captcha-mobile-site }}`).
