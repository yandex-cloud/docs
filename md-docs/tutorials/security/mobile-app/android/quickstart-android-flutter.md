[Документация Yandex Cloud](../../../../index.md) > [Практические руководства](../../../index.md) > [Безопасность](../../index.md) > Сценарии использования SmartCaptcha > Капча в приложении Android на Flutter
