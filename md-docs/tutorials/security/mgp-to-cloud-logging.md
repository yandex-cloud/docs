...
1. Создайте кластер Greenplum® с включенными настройками логирования и [созданным ранее](#before-you-begin) сервисным аккаунтом:
   ...
   * CLI {#cli}
      ...
      * `--log-greenplum-enabled` — передача логов Greenplum®.
          ...
          Вы можете [задать](../../managed-greenplum/operations/update.md#change-gp-settings) уровень логирования Greenplum® в параметре `Log min messages`. Подробнее о [дополнительных настройках](../../managed-greenplum/concepts/settings-list.md#dbms-cluster-settings) Greenplum®.
