[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Безопасность](index.md) > Передача логов кластера Yandex MPP Analytics for PostgreSQL в Yandex Cloud Logging
...
1. Создайте кластер Yandex MPP Analytics for PostgreSQL с включенными настройками логирования и [созданным ранее](#before-you-begin) сервисным аккаунтом:
   ...
   * Консоль управления {#console}
      ...
      1. В блоке **Дополнительные настройки**:
         ...
         * Включите опции **Логи командного центра** и **Логи Yandex MPP Analytics for PostgreSQL**. Уровень логирования можно задать с помощью параметра [Log min messages](../../managed-greenplum/concepts/settings-list.md#setting-log-min-messages) в блоке **Настройки СУБД**.
...
1. Создайте кластер Yandex MPP Analytics for PostgreSQL с включенными настройками логирования и [созданным ранее](#before-you-begin) сервисным аккаунтом:
   ...
   * Консоль управления {#console}
      ...
      1. В блоке **Дополнительные настройки**:
         ...
         * Включите опции **Логи Yandex MPP Analytics for PostgreSQL** и **Логи командного центра**. Уровень логирования можно задать с помощью параметра [Log min messages](../../managed-greenplum/concepts/settings-list.md#setting-log-min-messages) в блоке **Настройки СУБД**.
