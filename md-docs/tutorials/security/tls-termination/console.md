[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > [Безопасность](../index.md) > [Терминирование TLS-соединений](index.md) > Консоль управления
...
- Консоль управления {#console}
  ...
  1. Откройте [консоль управления](https://console.yandex.cloud).
  1. [Перейдите](https://console.yandex.cloud/link/vpc) в сервис **Virtual Private Cloud**.
  1. На панели слева выберите ![map-pin](../../../_assets/console-icons/map-pin.svg) **Публичные IP-адреса**.
...
- Консоль управления {#console}
  ...
  1. Нажмите кнопку **Создать группу безопасности**. В открывшемся окне:
      1. Укажите **Имя** группы безопасности: `mysite-sg-balancer`.
      1. Выберите **Сеть** `mysite-network`.
      1. В блоке **Правила** нажмите кнопку **Добавить правило** и создайте следующие правила по инструкции под таблицей:
  
         Направление<br/>трафика | Описание | Диапазон портов | Протокол | Назначение /<br/>Источник | IPv4 CIDR
         --- | --- | --- | --- | --- | ---
         ...
         1. В поле **IPv4 CIDR** укажите CIDR и маски [подсетей](../../../vpc/concepts/network.md#subnet), в которые или из которых будет поступать трафик. Чтобы добавить несколько CIDR, нажимайте кнопку **Добавить CIDR**.
...
- Консоль управления {#console}
  ...
  1. (Опционально) Если ваш сертификат выпущен сторонним центром сертификации, в поле **Цепочка промежуточных сертификатов** нажмите кнопку **Добавить цепочку**. Загрузите **Файл** с цепочкой сертификатов или укажите его **Содержимое** и нажмите кнопку **Добавить**.
...
- Консоль управления {#console}
  ...
  1. В блоке **Образ загрузочного диска** в поле поиска введите `LEMP` и выберите продукт [LEMP](https://yandex.cloud/ru/marketplace/products/yc/lemp).
