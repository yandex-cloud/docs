...
- Консоль управления {#console}
  ...
  1. [Перейдите](https://console.yandex.cloud/link/smartwebsecurity) в сервис **Smart Web Security**.
  1. Выберите раздел ![display-pulse](../../_assets/console-icons/display-pulse.svg) **Мониторинг**.
...
- Консоль управления {#console}
  ...
  1. Нажмите **Создать профиль ARL**.
  1. Введите имя профиля, например `anti-ddos-arl`.
  1. Нажмите ![plus-sign](../../_assets/console-icons/plus.svg) **Добавить правило** и укажите:
  ...
  1. Нажмите **Создать**.
  1. На панели слева выберите ![shield-check](../../_assets/console-icons/shield-check.svg) **Профили безопасности**.
  1. Напротив профиля `anti-ddos` нажмите ![options](../../_assets/console-icons/ellipsis.svg) → ![pencil](../../_assets/console-icons/pencil.svg) **Редактировать**.
