...
* Ваши сервисы находятся в {{ yandex-cloud }} или подключены к [{{ alb-name }}](../../application-load-balancer/index.md) через [{{ interconnect-name }}](../../interconnect/index.md).
...
Защита от DDoS-атаки состоит в подключении сервиса [{{ sws-name }}](../../smartwebsecurity/index.md) и настройке правил, блокирующих вредоносный трафик.
...
После остановки атаки можно настроить индивидуальную защиту вашего сервиса с помощью [{{ sws-name }}](../../smartwebsecurity/concepts/index.md). Если созданные ресурсы вам больше не нужны, [удалите их](#clear-out).
