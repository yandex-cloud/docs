[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > [Безопасность](../index.md) > Организация защищенного доступа к контенту в Cloud CDN > Обзор
