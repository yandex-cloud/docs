...
Вы можете мигрировать нагрузку с балансировщика [{{ network-load-balancer-full-name }}](../../../../network-load-balancer/index.md) на L7-балансировщик [{{ alb-full-name }}](../../../../application-load-balancer/index.md). В сетевом балансировщике поступающий трафик распределяется по виртуальным машинам, указанным в целевых группах этого балансировщика.
