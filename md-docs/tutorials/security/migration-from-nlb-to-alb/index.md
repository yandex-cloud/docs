[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > [Безопасность](../index.md) > Миграция сервисов с балансировщика NLB на L7-балансировщик ALB для подключения защиты Smart Web Security > Обзор
...
* [выступает как целевой ресурс для Application Load Balancer](nlb-as-target-resource-alb/index.md).