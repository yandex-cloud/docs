[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > [Безопасность](../index.md) > Хранение статического ключа доступа в секрете Yandex Lockbox > Обзор
