[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Безопасность](index.md) > Создание распределенной инфраструктуры с защищенным доступом
...
- Консоль управления {#console}
  ...
  1. В блоке **Правила** создайте следующие правила по инструкции под таблицей:
      ...
      | --- | --- | --- | --- | --- | --- |
      | `Входящий` | `http` | `8000` | `TCP` | `Диапазон адресов` | `10.131.0.0/24`<br/>`10.132.0.0/24`<br/>`10.133.0.0/24` |
      | `Входящий` | `ssh` | `22` | `TCP` | `Диапазон адресов` | `10.133.0.0/24` |
      | `Исходящий` | `any` | `0-65535` | `Любой` | `Диапазон адресов` | `10.131.0.0/24`<br/>`10.132.0.0/24`<br/>`10.133.0.0/24` |
...
- Консоль управления {#console}
  ...
  1. В блоке **Правила** создайте следующие правила по инструкции под таблицей:
      ...
      | `Исходящий` | `http` | `8000` | `Любой` | `Диапазон адресов` | `10.121.0.0/24`<br/>`10.122.0.0/24` |
...
- Консоль управления {#console}
  ...
  1. В блоке **Правила** создайте следующие правила по инструкции под таблицей:
      ...
      | `Исходящий` | `ssh` | `22` | `TCP` | `Диапазон адресов` | `10.121.0.0/24`<br/>`10.122.0.0/24` |
