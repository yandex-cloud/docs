...
- Консоль управления {#console}
  ...
  1. Включите тестовый режим для правила Smart Protection `sp-rule-1`:
     ...
     1. Нажмите **Сохранить изменения**.
      ...
      Трафик, обработанный правилами в режиме **Только логирование**, тарифицируется. Подробнее см. раздел [Правила тарификации для Yandex Smart Web Security](../../smartwebsecurity/pricing.md).
...
Подробнее о приоритете правил см. в разделе [Общие принципы работы правил](../../smartwebsecurity/concepts/rules.md#rules-order).
