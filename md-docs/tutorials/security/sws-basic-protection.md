[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Безопасность](index.md) > Базовая настройка SWS

# Базовая настройка защиты в Smart Web Security

[Smart Web Security](../../smartwebsecurity/concepts/index.md) (SWS) защищает веб-ресурсы от интернет-угроз, фильтруя вредоносный трафик.
...
- L7-балансировщик {#balancer}
  ...
  [Application Load Balancer](../../smartwebsecurity/tutorials/balancer-with-sws-profile/index.md) равномерно распределяет входящий трафик между узлами, что позволяет избежать перегрузки и повысить отказоустойчивость.
...
- Консоль управления {#console}
  ...
  1. Включите тестовый режим для правила Smart Protection `sp-rule-1`:
     ...
     1. Нажмите **Сохранить изменения**.
      ...
      Трафик, обработанный правилами в режиме **Только логирование**, тарифицируется. Подробнее в разделе [Правила тарификации для Yandex Smart Web Security](../../smartwebsecurity/pricing.md).
...
[Списки адресов](../../smartwebsecurity/concepts/lists.md) помогают оптимизировать проверку трафика, разрешая запросы для заведомо надежных (белых) адресов. Небезопасные или сомнительные адреса можно сразу блокировать или отправлять в SmartCaptcha.
...
Подробнее о приоритете правил смотрите в разделе [Общие принципы работы правил](../../smartwebsecurity/concepts/rules.md#rules-order).
...
- Консоль управления {#console}
  ...
  1. Чтобы задать [условия на трафик](../../smartwebsecurity/concepts/conditions.md), в списке **Условия** выберите один или несколько пунктов:
      ...
      * `IP` — IP-адрес, диапазон адресов, регион адресов или [список адресов](../../smartwebsecurity/concepts/lists.md);
...
- Консоль управления {#console}
  ...
  1. В блоке **Условия на трафик** выберите [условия](../../smartwebsecurity/concepts/conditions.md) для срабатывания правила-исключения.
