[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > [Безопасность](../index.md) > [Поиск событий в аудитных логах](index.md) > Примеры запросов для поиска событий
