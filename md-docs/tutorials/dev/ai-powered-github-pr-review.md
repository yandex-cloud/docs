[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Разработка и тестирование](index.md) > ИИ-ревью пул-реквестов на GitHub с помощью Yandex Workflows и GitHub Actions
