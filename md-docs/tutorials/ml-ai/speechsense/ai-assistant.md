[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > [Машинное обучение и искусственный интеллект](../index.md) > Речевая аналитика > Работа с AI-ассистентом в SpeechSense
