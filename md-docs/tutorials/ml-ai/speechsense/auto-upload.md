...
Вы можете настроить автоматическую загрузку файлов с диалогами и их метаданными из бакета Object Storage в [пространство SpeechSense](../../../speechsense/concepts/resources-hierarchy.md#space). Поддерживаемые форматы:
...
Настроить автоматическую загрузку данных можно сразу для нескольких [подключений SpeechSense](../../../speechsense/concepts/resources-hierarchy.md#connection).
...
1. [Создайте модель данных в кластере Managed Service for PostgreSQL](#create-table).
...
* плата за использование кластера (см. [тарифы Yandex Managed Service for PostgreSQL](../../../managed-postgresql/pricing.md));
* плата за вызовы функций (см. [тарифы Yandex Cloud Functions](../../../functions/pricing.md));
...
- Интерфейс SpeechSense {#speechsense}
  ...
  1. Выберите сервисный аккаунт `speechsense-sa` и укажите роль [Data editor](../../../speechsense/security/index.md#speechsense-data-editor). Эта роль позволит сервисному аккаунту `speechsense-sa` загружать данные в SpeechSense.
...
1. Удалите подключениe к базе данных кластера Managed Service for PostgreSQL:
