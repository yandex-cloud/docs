...
- Интерфейс SpeechSense {#speechsense}
  ...
  1. Откройте вкладку **Подключения** и выберите шаблон для создания подключения, либо нажмите кнопку **Создать подключение**:
...
- Интерфейс amoCRM {#amocrm}
  ...
  1. Откройте вкладку **Настройки выгрузки SpeechSense**.
