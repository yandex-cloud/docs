[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > [Машинное обучение и искусственный интеллект](../index.md) > Речевая аналитика > Интеграция SpeechSense с Битрикс24
