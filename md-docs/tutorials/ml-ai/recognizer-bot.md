[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Машинное обучение и искусственный интеллект](index.md) > Распознавание изображений, текста и речи > Разработка Telegram-бота для распознавания текста и аудио
...
Запросы от бота будет принимать [API-шлюз](../../api-gateway/concepts/index.md) Yandex API Gateway и перенаправлять их [функции](../../functions/concepts/function.md) Yandex Cloud Functions для обработки.
