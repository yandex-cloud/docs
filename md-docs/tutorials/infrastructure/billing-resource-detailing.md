[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Базовая инфраструктура](index.md) > Анализ поресурсной детализации расходов с помощью Object Storage
...
В стоимость анализа детализации входит плата за хранение данных в бакете и операции с ними ([тарифы Object Storage](../../storage/pricing.md)).
...
- Консоль управления {#console}
  ...
  1. Справа сверху нажмите кнопку **Ещё** ![chevron-down](../../_assets/console-icons/chevron-down.svg) и выберите **Регулярный экспорт**.
