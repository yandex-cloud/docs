[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Базовая инфраструктура](index.md) > Инструменты > Запуск языковой модели DeepSeek-R1 в кластере GPU Compute Cloud
