[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Базовая инфраструктура](index.md) > Получение сведений для запроса на включение ресурса в белый список Минцифры
...
* [Создание балансировщика с защитой от DDoS](../security/alb-with-ddos-protection/index.md)
* [Создание L7-балансировщика Yandex Application Load Balancer с профилем безопасности Yandex Smart Web Security](../security/balancer-with-sws-profile/index.md)
