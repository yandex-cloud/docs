...
После этого пользователи не смогут регистрироваться самостоятельно. Администратор может создавать учетные записи в разделе **Overview** → **Users**. Подробнее в [документации GitLab](https://docs.gitlab.com/user/profile/account/create_accounts/).
