[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > Разработка и тестирование > Получение статистики запросов к объектам Object Storage с использованием Query
...
- Консоль управления {#console}
  ...
  1. Перейдите на вкладку **Объекты** и [загрузите](../../storage/operations/objects/upload.md) объекты. Например, пару простых текстовых файлов.
