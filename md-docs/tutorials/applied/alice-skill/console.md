[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > [Прикладные решения](../index.md) > Алиса > [Создание навыка Алисы](index.md) > Консоль управления, CLI и API
