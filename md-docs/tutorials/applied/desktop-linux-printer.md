[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Прикладные решения](index.md) > Прочее > Настройка печати с Cloud Desktop на локальный принтер в Linux
