[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > Прикладные решения > Интернет вещей (IoT) > Работа с помощью Mosquitto > Отправить сообщение
