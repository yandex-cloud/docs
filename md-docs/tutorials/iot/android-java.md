[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > Прикладные решения > Интернет вещей (IoT) > Работа с Yandex IoT Core с устройства с Android на языке Java
