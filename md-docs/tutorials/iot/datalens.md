[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > Прикладные решения > Интернет вещей (IoT) > Мониторинг состояния географически распределенных устройств
...
- Консоль управления {#console}
  ...
  1. Создайте версию функции:
      ...
      1. На вкладке **Редактор** выберите среду выполнения `Node.js 22`.
      ...
      1. Нажмите кнопку **Создать файл**:
          ...
          1. Задайте имя файла — `device-emulator.js`.
          1. Нажмите **Создать**.
          1. Добавьте содержимое файла — код функции с [GitHub](https://github.com/yandex-cloud-examples/yc-geo-dist-devices-iot-monitoring/blob/main/device-emulator.js).
      ...
      1. В блоке **Переменные окружения** укажите:
...
- Консоль управления {#console}
  ...
  1. Создайте версию функции:
      1. На вкладке **Редактор** выберите среду выполнения `Python 3.12`.
      1. Отключите опцию **Добавить файлы с примерами кода**.
      1. Нажмите кнопку **Продолжить**.
      1. В поле **Источник кода** выберите `Редактор кода`.
      1. Нажмите кнопку **Создать файл**:

          1. Задайте имя файла — `myfunction.py`.
          1. Нажмите **Создать**.
          1. Добавьте содержимое файла — код функции с [GitHub](https://github.com/yandex-cloud-examples/yc-geo-dist-devices-iot-monitoring/blob/main/myfunction.py).
...
- Консоль управления {#console}
  ...
  1. Перейдите на вкладку **WebSQL** и нажмите **Перейти в WebSQL**.
...
- Интерфейс DataLens {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором вы выполняете руководство.
  1. [Перейдите](https://datalens.ru) в сервис **DataLens**.
  1. В блоке **Подключения** нажмите кнопку **Создать**.
  1. Выберите коннектор **PostgreSQL**.

     При подключении к внешнему источнику данных (который не является ресурсом Yandex Cloud) предоставьте доступ к источнику [для диапазонов IP-адресов сервиса DataLens](../../datalens/concepts/connection/index.md#changing-connection-ranges).
...
- Интерфейс DataLens {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором вы выполняете руководство.
  1. [Перейдите](https://datalens.ru) в сервис **DataLens**.
  1. В блоке **Датасеты** нажмите кнопку **Создать**.
...
- Интерфейс DataLens {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором вы выполняете руководство.
  1. [Перейдите](https://datalens.ru) в сервис **DataLens**.
  1. В блоке **Чарты** нажмите кнопку **Создать**.
...
- Интерфейс DataLens {#console}
  ...
  1. Создайте поле для определения координат устройств:
      1. В меню слева выберите ![image](../../_assets/console-icons/circles-intersection.svg) **Датасеты**.
...
- Интерфейс DataLens {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором вы выполняете руководство.
  1. [Перейдите](https://datalens.ru) в сервис **DataLens**.
  1. В блоке **Дашборды** нажмите кнопку **Создать**.
  1. Добавьте на дашборд чарты `My-pg-dataset — Карта` и `My-pg-dataset — Линейная диаграмма`, которые вы создали ранее:
      1. На нижней панели нажмите ![image](../../_assets/console-icons/chart-column.svg) **Чарт**.
  ...
  1. Настройте селектор:
      1. На нижней панели нажмите ![image](../../_assets/console-icons/sliders.svg) **Селектор**.
