...
* [IngressClass](../../managed-kubernetes/alb-ref/ingress-class.md) — управление несколькими Ingress-контроллерами в кластере Kubernetes.
* [Service](../../managed-kubernetes/alb-ref/service-for-ingress.md) — описание сервисов Kubernetes, используемых в качестве бэкендов.
...
1. [Установите Ingress-контроллер Application Load Balancer](../../managed-kubernetes/operations/applications/alb-ingress-controller.md).
...
1. [Удалите кластер](../../managed-kubernetes/operations/kubernetes-cluster/kubernetes-cluster-delete.md) Managed Service for Kubernetes.
