...
* Реестр Container Registry: хранение созданных Docker-образов и использование сканера уязвимостей (см. [тарифы Container Registry](../../container-registry/pricing.md)).
...
1. [Создайте реестр](../../container-registry/operations/registry/registry-create.md) в сервисе Yandex Container Registry.
...
1. Аутентифицируйтесь в реестре:
    ...
    Другие способы см. в разделе [Аутентифицироваться в Container Registry](../../container-registry/operations/authentication.md).
