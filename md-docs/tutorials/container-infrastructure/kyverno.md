...
1. Создайте [кластер](../../managed-kubernetes/concepts/index.md#kubernetes-cluster) и [группу узлов](../../managed-kubernetes/concepts/index.md#node-group) Managed Service for Kubernetes.
...
Установите приложение [Kyverno & Kyverno Policies](https://yandex.cloud/ru/marketplace/products/yc/kyverno) согласно [инструкции](../../managed-kubernetes/operations/applications/kyverno.md) со следующими настройками:
...
1. Создайте политику, которая будет требовать, чтобы все [поды](../../managed-kubernetes/concepts/index.md#pod) имели [метку](../../resource-manager/concepts/labels.md) `app.kubernetes.io/name`:
