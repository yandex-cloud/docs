...
1. Установите Argo CD согласно [инструкции](../../managed-kubernetes/operations/applications/argo-cd.md).
   ...
   * [Настроить виртуальную машину в качестве NAT-инстанса](../routing/nat-instance/index.md).
