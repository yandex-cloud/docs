[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Контейнерная инфраструктура](index.md) > Managed Service for Kubernetes > Использование Container Registry > Хранение Docker-образов из проектов Managed Service for GitLab
...
- Вручную {#manual}
   ...
   1. Настройте группу безопасности для работы [кластера Managed Service for Kubernetes](../../managed-kubernetes/operations/connect/security-groups.md) и [инстанса Managed Service for GitLab](../../managed-gitlab/operations/configure-security-group.md).
