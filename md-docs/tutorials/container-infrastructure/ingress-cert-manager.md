...
* С помощью [{{ marketplace-full-name }}](../../marketplace/index.md): будет установлен cert-manager, [интегрированный с сервисом {{ dns-name }}](../../managed-kubernetes/operations/applications/cert-manager-cloud-dns.md).
