[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > [Базовая инфраструктура](../../infrastructure/index.md) > Инструменты > Запуск Docker-образа на виртуальной машине > Обзор
...
Из этого руководства вы узнаете, как запустить [Docker-образ](../../../container-registry/concepts/docker-image.md) на [ВМ](../../../compute/concepts/vm.md) [Yandex Compute Cloud](../../../compute/index.md) с использованием реестра [Yandex Container Registry](../../../container-registry/index.md).
