...
1. Замените содержимое файла на конфигурацию ниже. Добавьте идентификатор каталога, в который будут передаваться метрики.
   ...
   Подробнее о настройке Unified Agent смотрите в разделе [Конфигурирование](../../monitoring/concepts/data-collection/unified-agent/configuration.md).
...
Дополнительные настройки дашборда смотрите в разделе [Добавление виджета на дашборд](../../monitoring/operations/dashboard/add-widget.md).
