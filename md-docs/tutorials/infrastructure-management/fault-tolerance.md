[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Базовая инфраструктура](../infrastructure/index.md) > Отказоустойчивость и масштабирование > Настройка отказоустойчивой архитектуры в Yandex Cloud
...
1. [Установите Terraform](terraform-quickstart.md#install-terraform).
