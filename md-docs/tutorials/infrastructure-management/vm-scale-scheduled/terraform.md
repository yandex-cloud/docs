[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > [Базовая инфраструктура](../../infrastructure/index.md) > Отказоустойчивость и масштабирование > [Масштабирование группы виртуальных машин по расписанию](index.md) > Terraform
