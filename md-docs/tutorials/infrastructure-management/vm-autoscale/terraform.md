...
1. [Установите {{ TF }}](../terraform-quickstart.md#install-terraform) и укажите источник для установки провайдера {{ yandex-cloud }} (раздел [{#T}](../terraform-quickstart.md#configure-provider), шаг 1).
