[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > Хранение и восстановление данных > Резервное копирование в Object Storage > Резервное копирование ВМ с помощью Хайстекс Акура
