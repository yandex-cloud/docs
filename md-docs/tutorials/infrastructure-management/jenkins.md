...
* Плата за постоянно запущенные ВМ (см. [тарифы Compute Cloud](../../compute/pricing.md)).
...
* [Установите](https://www.terraform.io/downloads) Terraform. См. также раздел [Начало работы с Terraform](terraform-quickstart.md).
...
1. Заполните поля файла требуемыми значениями. См. также документацию [Terraform](https://www.terraform.io/language#about-the-terraform-language) и [провайдера Yandex Cloud](../../terraform/index.md).
