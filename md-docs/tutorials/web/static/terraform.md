[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > Прикладные решения > Создание сайта > [Статический сайт в Object Storage](index.md) > Terraform
...
1. Подготовьте файлы с описанием инфраструктуры:
    ...
    * [Настройка](../../../storage/operations/buckets/iam-access.md) прав доступа к бакету с помощью Identity and Access Management — [yandex_storage_bucket_iam_binding](../../../terraform/resources/storage_bucket_iam_binding.md).
    ...
    * [Объект](../../../storage/concepts/object.md) в бакете — [yandex_storage_object](../../../terraform/resources/storage_object.md).
