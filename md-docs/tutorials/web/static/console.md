...
1. Загрузите созданные файлы в бакет:
    ...
    - Консоль управления {#console}
      ...
      1. Перейдите в сервис **Object Storage** и в открывшемся окне выберите созданный ранее бакет.
...
- Консоль управления {#console}
  ...
  1. Перейдите в сервис **Cloud DNS** и выберите созданную ранее зону DNS. 
