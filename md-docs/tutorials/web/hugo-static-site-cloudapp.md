[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > Прикладные решения > Создание сайта > Создание сайта на Hugo с помощью Cloud Apps

# Установка Hugo с помощью Cloud Apps


С помощью этого руководства вы установите и настроите статический сайт на [Hugo](https://gohugo.io/) — генераторе статических сайтов — используя сервис [Cloud Apps](../../cloud-apps/index.md). Приложение развернет сайт в [Object Storage](../../storage/index.md) и настроит доступ по домену с автоматическим выпуском SSL-сертификатов.
