...
Автоматическое воспроизведение видео может быть ограничено политикой браузеров. Подробнее см. в [Политика автозапуска браузеров](../../video/autoplay-policy.md)
...
Подробнее о параметрах стилизации см. в разделе [Параметры стилизации](../../video/sdk/iframe/initialization.md#styling).
