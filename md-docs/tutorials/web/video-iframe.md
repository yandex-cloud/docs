[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > Прикладные решения > Создание сайта > Оформление контента из Cloud Video в IFrame
...
1. Загрузите видео в [Yandex Cloud Video](../../video/hosting.md).
1. Сохраните ссылку на видео.
1. Добавьте в код вашей HTML-страницы [код вставки iframe](../../video/sdk/iframe/index.md).
...
- Интерфейс Cloud Video {#console}
  ...
  1. В разделе **Код вставки** на вкладке **html** скопируйте код вставки iframe.
...
Автоматическое воспроизведение видео может быть ограничено политикой браузеров. Подробнее в [Политика автозапуска браузеров](../../video/autoplay-policy.md).
...
1. Загрузите несколько видео в [Yandex Cloud Video](../../video/hosting.md).
...
Подробнее о параметрах стилизации смотрите в разделе [Параметры стилизации](../../video/sdk/iframe/initialization.md#styling).
