...
1. Загрузите видео в [{{ video-full-name }}](../../video/hosting.md).
...
1. Загрузите несколько видео в [{{ video-full-name }}](../../video/hosting.md).
...
Подробнее о параметрах стилизации см. в разделе [{#T}](../../video/sdk/iframe/initialization.md#styling).
