[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > Базовая инфраструктура > Отказоустойчивость и масштабирование > [Интеграция L7-балансировщика с Cloud CDN и Object Storage](index.md) > Консоль управления, CLI и API
