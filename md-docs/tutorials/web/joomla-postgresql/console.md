[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > Прикладные решения > Создание сайта > [Создание сайта на CMS Joomla с базой данных PostgreSQL](index.md) > Консоль управления

# Создание сайта на CMS Joomla с базой данных PostgreSQL с помощью консоли управления

Чтобы создать инфраструктуру для [сайта на CMS Joomla с базой данных PostgreSQL](index.md) c помощью консоли управления Yandex Cloud:
...
- Консоль управления {#console}
  ...
  1. Аналогичным образом создайте группу безопасности `postgresql-sg` для кластера Managed Service for PostgreSQL со следующими правилами для трафика:
      ...
      | Направление<br/>трафика | Описание | Диапазон портов | Протокол | Источник /<br/>Назначение | IPv4 CIDR /<br/>Группа безопасности |
      | --- | --- | --- | --- | --- | --- |
      | Входящий | `port-6432`           | `6432` | `TCP` | `Диапазон адресов` | `192.168.1.0/24` |
...
- Консоль управления {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором вы создаете инфраструктуру.
  1. [Перейдите](https://console.yandex.cloud/link/dns) в сервис **Cloud DNS** и нажмите **Создать зону**.
...
1. Добавьте новый сертификат в сервис Certificate Manager:
    ...
    - Консоль управления {#console}
      ...
      1. В открывшемся окне:
         ...
         1. В поле **Имя** укажите `joomla-cert`.
...
- Консоль управления {#console}
  ...
  1. В блоке **Класс хоста** выберите подходящий вам класс [хоста](../../../managed-postgresql/concepts/instance-types.md).
...
1. [Удалите](../../../managed-postgresql/operations/cluster-delete.md) кластер Managed Service for PostgreSQL `joomla-pg-cluster`.
...
* [Создание сайта на CMS Joomla с базой данных PostgreSQL с помощью Terraform](terraform.md).