[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > Прикладные решения > Создание сайта > [Привязка доменного имени к ВМ с веб-сервером](index.md) > Консоль управления, CLI и API
