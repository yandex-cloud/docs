[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Анализ и визуализация данных](index.md) > DataLens > Аналитика сервисов > Подкасты Яндекс Музыки: статистика
...
Данные в DataLens доступны только пользователям конкретного экземпляра. Если требуется предоставить публичный неограниченный доступ к аналитике подкастов, [опубликуйте](../../datalens/concepts/datalens-public.md) дашборд или отдельный чарт.
