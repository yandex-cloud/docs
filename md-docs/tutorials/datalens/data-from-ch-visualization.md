[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Анализ и визуализация данных](index.md) > DataLens > Знакомство с DataLens > Дашборд сети магазинов из БД ClickHouse®
