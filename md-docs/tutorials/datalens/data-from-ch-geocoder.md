[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Анализ и визуализация данных](index.md) > DataLens > Работа с геоданными > Геокодинг с помощью API Яндекс Карт для визуализации в DataLens
...
В стоимость инфраструктуры для геокодинга и визуализации данных входит плата за сервис DataSphere: использование вычислительных ресурсов ([тарифы DataSphere](../../datasphere/pricing.md)).
