...
Ссылку на дашборд при этом можно будет отправлять из браузера. Подробнее про права доступа к объектам DataLens см. в [документации](../../datalens/security/index.md#permissions).
