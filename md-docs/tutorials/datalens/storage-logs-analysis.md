...
Для создания кластера Managed Service for ClickHouse® нужна роль [vpc.user](../../vpc/security/index.md#vpc-user) и роль [managed-clickhouse.editor или выше](../../managed-clickhouse/security.md#roles-list). О том, как назначить роль, смотрите в [документации Identity and Access Management](../../iam/operations/roles/grant.md).
