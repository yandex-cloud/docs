[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Анализ и визуализация данных](index.md) > DataLens > Знакомство с DataLens > Простой дашборд из CSV-файла
...
В этом руководстве будет продемонстрировано, как DataLens можно использовать для исследования зависимостей, например:
...
1. Примените различные фильтры и исследуйте зависимости цвета глаз и волос от пола и лагеря супергероя.
   ...
   * С голубыми глазами больше хороших, а с красными — плохих.
