[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Анализ и визуализация данных](index.md) > DataLens > Знакомство с DataLens > Публичный чарт с картой Москвы из CSV-файла
...
В DataLens вы можете предоставлять [публичный доступ](../../datalens/concepts/datalens-public.md) к созданным чартам и дашбордам.
