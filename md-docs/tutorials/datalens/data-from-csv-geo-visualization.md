[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Анализ и визуализация данных](index.md) > DataLens > Работа с геоданными > Анализ открытых данных ДТП на дорогах России
...
* работать с основными сущностями DataLens: [подключения](../../datalens/concepts/connection/index.md), [датасеты](../../datalens/dataset/index.md), [чарты](../../datalens/concepts/chart/index.md), [дашборды](../../datalens/concepts/dashboard.md);
