[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > [Бессерверные технологии](../index.md) > Интеграция с сервисами Яндекса и Yandex Cloud > [Создание навыка Алисы](index.md) > Консоль управления, CLI и API
