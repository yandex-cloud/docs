...
1. На вкладке **Настройки**:
    ...
    В списке отображаются функции, которые вы имеете право просматривать. Чтобы прикрепить функцию к навыку, вам необходимо разрешение на запуск функции. Это разрешение входит в роли [functions.functionInvoker](../../functions/security/index.md#serverless-functions-invoker), [editor](../../functions/security/index.md#functions-editor) и выше.
