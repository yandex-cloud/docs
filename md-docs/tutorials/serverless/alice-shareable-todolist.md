...
Данные проекта хранятся в бакете [{{ objstorage-full-name }}](../../storage/index.md) и базе данных [{{ ydb-full-name }}](../../ydb/index.md). Функции [{{ sf-full-name }}](../../functions/index.md) обрабатывают запросы, а [{{ api-gw-full-name }}](../../api-gateway/index.md) обеспечивает взаимодействие сервисов.
...
- Linux {#linux}
  ...
  1. Установите и настройте следующие программы:
     ...
     * [{{ TF }}](../infrastructure-management/terraform-quickstart.md)
...
Используйте {{ TF }} для автоматизации действий. Перед использованием [проинициализируйте его](../infrastructure-management/terraform-quickstart.md#configure-provider).
