...
1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором была создана функция.
1. [Перейдите](https://console.yandex.cloud/link/functions) в сервис **Cloud Functions**.
1. Выберите **Триггеры**.
...
1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором была создана функция.
1. [Перейдите](https://console.yandex.cloud/link/storage) в сервис **Object Storage** и откройте бакет `asr-batch-bucket`.
