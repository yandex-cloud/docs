[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > Анализ и визуализация данных > Аналитика > Визуализация логов в Grafana с помощью плагина Cloud Logging
...
В стоимость ресурсов входит плата за запись и хранение логов в лог-группе ([тарифы Yandex Cloud Logging](../../logging/pricing.md)).
