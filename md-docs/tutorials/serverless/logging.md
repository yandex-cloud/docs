[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Бессерверные технологии](index.md) > ETL на Serverless > Запись логов балансировщика в PostgreSQL
