[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > [Бессерверные технологии](../index.md) > Бэкенд на Serverless > [Сокращатель ссылок](index.md) > Terraform
