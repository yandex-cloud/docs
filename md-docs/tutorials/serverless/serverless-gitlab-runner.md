...
В этом практическом руководстве вы научитесь запускать [{{ GLR }}]({{ gl.docs }}/runner/) в инфраструктуре {{ yandex-cloud }} с использованием [{{ serverless-containers-full-name }}](../../serverless-containers/index.md).
