...
- Linux {#linux}
  ...
  1. [Установите](../infrastructure-management/terraform-quickstart.md#from-yc-mirror) {{ TF }} не ниже версии `1.0.8`.
...
* [{#T}](../infrastructure-management/terraform-quickstart.md).
