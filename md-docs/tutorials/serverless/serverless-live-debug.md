...
1. Создайте [сервисный аккаунт](../../iam/concepts/users/service-accounts.md):
    ...
    - Консоль управления {#console}
      ...
      1. В открывшемся окне введите **Имя** сервисного аккаунта, например `sa-live-debug`. Формат имени:
...
- Консоль управления {#console}
  ...
  1. Справа от каталога нажмите ![image](../../_assets/console-icons/ellipsis.svg) → ![image](../../_assets/console-icons/trash-bin.svg) **Удалить каталог**.
