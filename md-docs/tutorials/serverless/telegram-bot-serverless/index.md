...
Для хранения статических ресурсов используется [{{ objstorage-full-name }}](../../../storage/index.md). [{{ api-gw-full-name }}](../../../api-gateway/index.md) принимает запросы пользователей и перенаправляет их для обработки в [{{ sf-full-name }}](../../../functions/index.md).
