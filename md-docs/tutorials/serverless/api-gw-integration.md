[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Бессерверные технологии](index.md) > Бэкенд на Serverless > Разработка пользовательской интеграции в API Gateway
...
- Linux {#linux}
  ...
  1. [Установите](../infrastructure-management/terraform-quickstart.md#from-yc-mirror) Terraform не ниже версии `1.0.8`.
