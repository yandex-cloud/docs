[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Построение Data Platform](index.md) > MySQL® > Миграция БД из Managed Service for MySQL® в сторонний кластер MySQL®
...
Миграция данных из стороннего кластера MySQL® описана в статье [Миграция базы данных из стороннего кластера MySQL®](../../managed-mysql/tutorials/data-migration/index.md).
...
* Установите на хосты кластера-приемника [серверные SSL-сертификаты Managed Service for MySQL®](../../managed-mysql/operations/connect/index.md#get-ssl-cert). Они требуются для подключения к публично доступному кластеру-источнику.
...
1. Создайте дамп базы кластера-источника:
   ...
   Используйте [особый FQDN](../../managed-mysql/concepts/network.md#fqdn-master), который всегда указывает на текущий хост-мастер в кластерах Managed Service for MySQL®.
