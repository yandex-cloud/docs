[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Построение Data Platform](index.md) > Apache Kafka® > Поставка данных с помощью Data Transfer > Поставка данных из Managed Service for Apache Kafka® в Managed Service for MySQL®
...
В кластер Yandex Managed Service for MySQL® можно в реальном времени поставлять данные из топиков Apache Kafka®.
