[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Построение Data Platform](index.md) > Greenplum® > Получение данных из внешних источников с помощью именованных запросов в Greenplum®
...
В кластере Greenplum® [создайте внешний источник данных](../../managed-greenplum/operations/pxf/create-jdbc-source.md) с параметрами:
...
1. [Подключитесь](../../managed-greenplum/operations/connect/index.md) к Greenplum®.
...
1. Создайте внешнюю таблицу `pxf_named_query`. Она будет ссылаться на данные, которые именованный запрос получает из таблиц `customers` и `orders` в БД PostgreSQL:
   ...
   Подробнее о синтаксисе SQL-запроса для создания внешней таблицы в [соответствующем разделе](../../managed-greenplum/operations/pxf/create-table.md#sql-statement).
...
- Вручную {#manual}
   ...
   1. [Удалите](../../managed-greenplum/operations/cluster-delete.md) кластер Greenplum®.
