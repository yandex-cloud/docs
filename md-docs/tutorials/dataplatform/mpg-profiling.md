...
* [Получить и проанализировать статистику по запросам](../../managed-postgresql/operations/performance-diagnostics.md#get-queries) с помощью встроенного в Managed Service for PostgreSQL инструмента для диагностики.
...
* Проанализировать план запроса (query plan) с помощью команды [`EXPLAIN`](https://www.postgresql.org/docs/current/sql-explain.html).
    ...
    Подробнее в разделе [SQL-запросы в Yandex WebSQL](../../managed-postgresql/operations/web-sql-query.md).
...
* Обновить статистику с помощью команды [`ANALYZE`](https://www.postgresql.org/docs/current/sql-analyze.html).
    ...
    Подробнее про параметр `default_statistics_target` смотрите в [настройках PostgreSQL](../../managed-postgresql/concepts/settings-list.md#setting-default-statistics-target).
...
Рекомендации по устранению проблем приведены в разделе [Управление дисковым пространством](../../managed-postgresql/concepts/storage.md#manage-storage-space).