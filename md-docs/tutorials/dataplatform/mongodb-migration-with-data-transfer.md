[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Построение Data Platform](index.md) > MongoDB/Yandex StoreDoc > Миграция коллекций из стороннего кластера MongoDB в Yandex StoreDoc
...
- Нешардированный кластер-приемник {#non-sharded}
  ...
  1. [Создайте кластер](../../storedoc/operations/cluster-create.md) Yandex StoreDoc любой подходящей конфигурации.
...
- Шардированный кластер-приемник {#sharded}
  ...
  1. [Создайте кластер](../../storedoc/operations/cluster-create.md) Yandex StoreDoc любой подходящей конфигурации. В кластере должно быть не менее двух хостов.
