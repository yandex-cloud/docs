[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Построение Data Platform](index.md) > Apache Kafka® > Поставка данных с помощью Data Transfer > Поставка данных из Managed Service for Apache Kafka® в Data Streams
...
В поток данных Yandex Data Streams можно в реальном времени поставлять данные из топиков Apache Kafka®.
...
* База данных Yandex Managed Service for YDB ([тарифы Managed Service for YDB](../../ydb/pricing/index.md)). Стоимость зависит от режима использования:
...
[Создайте поток данных приемника Data Streams](../../data-streams/operations/aws-cli/create.md) для базы данных Managed Service for YDB.
