[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > [Построение Data Platform](../index.md) > Миграция БД из стороннего кластера MySQL® в кластер Managed Service for MySQL® > Обзор
