[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Построение Data Platform](index.md) > ClickHouse® > Миграция данных в Managed Service for ClickHouse® средствами ClickHouse®
...
Вы также можете перенести базу данных из кластера ClickHouse® в кластер Managed Service for ClickHouse® при помощи Data Transfer. Как это сделать, описано в [практическом руководстве](ch-to-mch-migration.md).
...
1. [Создайте кластер-приемник Managed Service for ClickHouse®](../../managed-clickhouse/operations/cluster-create.md#create-cluster).
...
1. [Подключитесь к кластеру Managed Service for ClickHouse®](../../managed-clickhouse/operations/connect/clients.md#clickhouse-client), на который вы хотите перенести данные, и создайте на нем новую таблицу из полученного ранее текста запроса.
...
1. [Создайте кластер-приемник Managed Service for ClickHouse®](../../managed-clickhouse/operations/cluster-create.md#create-cluster) с включенным [управлением пользователями через SQL](../../managed-clickhouse/operations/cluster-users.md#sql-user-management).
