[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Построение Data Platform](index.md) > YDB > Загрузка данных из Object Storage в Managed Service for YDB с помощью Data Transfer
