...
Оплачивается использование кластера Yandex StoreDoc: выделенные хостам вычислительные ресурсы, включая ресурсы дополнительных служебных хостов, а также объем хранилища и резервных копий (см. [тарифы Yandex StoreDoc](../../storedoc/pricing.md)).
