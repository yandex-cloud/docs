    ...
    - Подключение без TLS {#without-tls}
        ...
        **Подключение к шардированному кластеру**
        ...
        1. Запустите скрипт:
            ...
            Во время работы скрипта будут выводиться сообщения об ошибках вставки данных. Это нормальное поведение команды `redis-cli`, связанное с тем, что в шардированном кластере каждый шард хранит только часть данных. Подробнее см. в разделе [Шардирование в Yandex Managed Service for Valkey™](../../managed-valkey/concepts/sharding.md).
...
1. Нажмите на имя нужного кластера и выберите вкладку [Мониторинг](../../managed-valkey/operations/monitoring.md).
