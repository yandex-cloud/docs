...
* [неэффективное выполнение запросов в MongoDB](#inefficient-queries),
* [блокировки](#locks),
...
Начните диагностику с выяснения характера нагрузки и определения проблемных коллекций. Воспользуйтесь встроенными [утилитами мониторинга MongoDB](../../storedoc/operations/tools.md#monitoring-tools). Далее проанализируйте производительность конкретных запросов с помощью [логов](../../storedoc/operations/tools.md#explore-logs) или [данных профилировщика](../../storedoc/operations/tools.md#explore-profiler).
