...
[Yandex Cloud Billing](../../billing/index.md) позволяет получать информацию об объеме использованных ресурсов, проверять расходы денежных средств и оплачивать потребление ресурсов. Детализацию расходов можно отправлять в [Yandex Object Storage](../../storage/index.md) и далее обрабатывать с помощью [Yandex Query](../../query/index.md).
...
1. При первом переходе из сервиса Yandex Cloud Billing в Yandex Query выполните настройку интеграции:
