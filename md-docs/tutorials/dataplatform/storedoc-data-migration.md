[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Построение Data Platform](index.md) > MongoDB/Yandex StoreDoc > Миграция данных в Yandex StoreDoc
...
[Создайте кластер-приемник Yandex StoreDoc](../../storedoc/operations/cluster-create.md), вычислительная мощность и размер хранилища которого соответствуют среде, в которой развернута мигрируемая база данных.
...
1. [Удалите созданный кластер Yandex StoreDoc](../../storedoc/operations/cluster-delete.md).
