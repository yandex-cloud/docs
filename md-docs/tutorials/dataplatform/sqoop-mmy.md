[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Построение Data Platform](index.md) > Импорт данных из Managed Service for MySQL® в Yandex Data Processing с помощью Sqoop
