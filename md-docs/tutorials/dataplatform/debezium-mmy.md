[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Построение Data Platform](index.md) > Apache Kafka® > Поставка данных с помощью Debezium > Поставка данных из Managed Service for MySQL® в Managed Service for Apache Kafka®
