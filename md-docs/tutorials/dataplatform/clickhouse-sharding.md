...
В [шардированном кластере ClickHouse®](../../managed-clickhouse/concepts/sharding.md#uses) для распределения данных таблицы можно использовать как все шарды кластера, так и их часть — [группу шардов](../../managed-clickhouse/operations/shard-groups.md).
...
* Кластер Managed Service for ClickHouse®: использование вычислительных ресурсов, выделенных хостам (в том числе хостам ZooKeeper), и дискового пространства ([тарифы Managed Service for ClickHouse®](../../managed-clickhouse/pricing.md)).
