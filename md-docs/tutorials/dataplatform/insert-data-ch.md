...
Список поддерживаемых форматов данных приведен в [документации ClickHouse®](https://clickhouse.com/docs/ru/interfaces/formats). О настройке схем форматов данных Cap'n Proto и Protobuf см. в разделе [Управление схемами формата данных](../../managed-clickhouse/operations/format-schemas.md).
...
Подробную информацию об асинхронной вставке данных см. в [документации ClickHouse®](https://clickhouse.com/docs/ru/best-practices/use-materialized-views).
