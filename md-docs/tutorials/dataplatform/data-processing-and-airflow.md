[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Построение Data Platform](index.md) > Yandex Data Processing > Автоматизация работы с Yandex Data Processing с помощью Managed Service for Apache Airflow™
...
В сервисе Yandex Managed Service for Apache Airflow™ можно создать DAG — [направленный ациклический граф задач](../../managed-airflow/concepts/index.md), который позволит автоматизировать работу с [сервисом Yandex Data Processing](../../data-proc/index.md). Ниже рассматривается DAG, который включает в себя несколько задач:
