[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Построение Data Platform](index.md) > Yandex Data Streams > Умная обработка логов
...
1. Настройте агрегатор логов: [fluentd](../../data-streams/quickstart/fluentd.md) или [logstash](../../data-streams/quickstart/logstash.md) или другой агрегатор с поддержкой [Kinesis Data Streams API](../../data-streams/kinesisapi/api-ref.md).
