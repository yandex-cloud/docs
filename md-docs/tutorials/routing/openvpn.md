[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > Базовая инфраструктура > VPNs > Соединение с облачной сетью при помощи OpenVPN
...
- Консоль управления {#console}
  ...
  1. В блоке **Диски и файловые хранилища** задайте размер загрузочного [диска](../../compute/concepts/disk.md#disks-types) `20 ГБ`.
