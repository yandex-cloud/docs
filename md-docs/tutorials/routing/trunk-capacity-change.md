[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Архитектура, сетевое взаимодействие](index.md) > Cloud Interconnect > Изменить емкость транкового подключения
...
Создайте [новое обращение в поддержку](https://center.yandex.cloud/support) для изменения емкости транкового подключения.
...
Изменение емкости транкового подключения сразу же отразится на метриках биллинга Cloud Interconnect.
