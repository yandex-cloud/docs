...
1. Настройте окружение для аутентификации в Terraform (подробнее см. [Начало работы с Terraform](../infrastructure-management/terraform-quickstart.md#get-credentials)):
