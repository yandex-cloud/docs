[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > Базовая инфраструктура > Сеть > Установка виртуального роутера Cisco CSR 1000v
...
- Консоль управления {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) выберите каталог с созданной ВМ.
...
1. Сравните хеш SSH-ключа на роутере с хешем ключа на вашем компьютере:
