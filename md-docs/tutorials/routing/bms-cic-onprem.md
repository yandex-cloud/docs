...
Если в вашем каталоге уже есть настроенная сетевая связность с использованием [Cloud Interconnect](../../interconnect/index.md) (VPC-to-On-Prem), то вы можете как использовать уже существующий виртуальный маршрутизатор, так и создать новый, дополнительный виртуальный маршрутизатор для организации обособленной сетевой связности.
