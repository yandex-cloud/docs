[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > Базовая инфраструктура > VPNs > Создание и настройка шлюза UserGate в режиме прокси-сервера
...
- Консоль управления {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором нужно создать группу.
  ...
  1. В блоке **Правила** создайте правила по инструкции под таблицей:
     ...
     | Входящий | `icmp` | `Весь` | `ICMPv6` | `Диапазон адресов` | `0.0.0.0/0` |
     | Входящий | `rdp` | `3389` | `TCP` | `Диапазон адресов` | `0.0.0.0/0` |
     | Входящий | `ssh` | `22` | `TCP` | `Диапазон адресов` | `0.0.0.0/0` |
     | Входящий | `usergate 8001` | `8001` | `TCP` | `Диапазон адресов` | `0.0.0.0/0` |
     | Входящий | `usergate 8090` | `8090` | `TCP` | `Диапазон адресов` | `0.0.0.0/0` |
