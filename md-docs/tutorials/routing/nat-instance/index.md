...
В этом руководстве вы создадите тестовую ВМ и NAT-инстанс с помощью сервиса [{{ compute-full-name }}](../../../compute/index.md) и настроите маршрутизацию с помощью [{{ vpc-full-name }}](../../../vpc/index.md).
