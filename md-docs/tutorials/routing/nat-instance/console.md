[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > Базовая инфраструктура > Сеть > [Маршрутизация через NAT-инстанс](index.md) > Консоль управления
