[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > Базовая инфраструктура > Сеть > Настройки DHCP для работы с корпоративным DNS-сервером
...
- Консоль управления {#console}
  ...
  1. Выберите облачную сеть `ad-network`.
...
1. Подготовьте ВМ:
    ...
    - Консоль управления {#console}
      ...
      1. В блоке **Образ загрузочного диска** перейдите на вкладку `Пользовательский` и выберите образ **Windows Server**. Как загрузить свой образ для продуктов Microsoft смотрите в разделе [Импортировать нужный образ](../../microsoft/byol.md#how-to-import).
