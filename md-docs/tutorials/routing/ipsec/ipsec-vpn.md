[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > Базовая инфраструктура > VPNs > [Организация сетевой связности с помощью IPsec-шлюзов](index.md) > Самостоятельная реализация средствами Yandex Cloud
...
[Зарезервируйте](../../../vpc/operations/get-static-ip.md) два статических [публичных IP-адреса](../../../vpc/concepts/address.md#public-addresses) в зоне доступности `ru-central1-b`:
...
1. [Создайте сеть](../../../vpc/operations/network-create.md) с именем `cloud-net`. При создании сети отключите опцию **Создать подсети**.
...
1. В группе безопасности `cloud-net-sg` [создайте правила](../../../vpc/operations/security-group-add-rule.md) в соответствии с таблицей:
    ...
    | Входящий | `icmp`           | `Весь` | `ICMP` | `Диапазон адресов` | `0.0.0.0/0` |
    | Входящий | `ssh`            | `22`   | `TCP`  | `Диапазон адресов` | `0.0.0.0/0` |
    | Входящий | `ipsec-udp-500`  | `500`  | `UDP`  | `Диапазон адресов` | `<x2.x2.x2.x2>/32` |
    | Входящий | `ipsec-udp-4500` | `4500` | `UDP`  | `Диапазон адресов` | `<x2.x2.x2.x2>/32` |
    | Входящий | `subnet-d`       | `Весь` | `Любой` | `Диапазон адресов` | `172.16.1.0/24` |
    | Входящий | `subnet-b`       | `Весь` | `Любой` | `Диапазон адресов` | `172.16.2.0/24` |
...
1. [Создайте сеть](../../../vpc/operations/network-create.md) с именем `remote-net`. При создании сети отключите опцию **Создать подсети**.
...
1. В группе безопасности `remote-net-sg` [создайте правила](../../../vpc/operations/security-group-add-rule.md) в соответствии с таблицей:
    ...
    | Входящий | `icmp`           | `Весь` | `ICMP` | `Диапазон адресов` | `0.0.0.0/0` |
    | Входящий | `ssh`            | `22`   | `TCP`  | `Диапазон адресов` | `0.0.0.0/0` |
    | Входящий | `ipsec-udp-500`  | `500`  | `UDP`  | `Диапазон адресов` | `<x1.x1.x1.x1>/32` |
    | Входящий | `ipsec-udp-4500` | `4500` | `UDP`  | `Диапазон адресов` | `<x1.x1.x1.x1>/32` |
    | Входящий | `subnet-1`       | `Весь` | `Любой` | `Диапазон адресов` | `10.10.0.0/16` |
