[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Архитектура, сетевое взаимодействие](index.md) > Организация VPN-подключений > Настройка защищенного туннеля GRE поверх IPsec
...
- Консоль управления {#console}
   ...
   1. Перейдите на вкладку **Серийная консоль** и нажмите кнопку **Подключиться**.
...
- Консоль управления {#console}
   ...
   1. Убедитесь, что ключ добавлен:
      ...
      Сравните хеш SSH-ключа на роутере с хешем ключа на вашем компьютере.
