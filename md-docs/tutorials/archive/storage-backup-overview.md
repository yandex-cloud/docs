# Резервное копирование в {{ objstorage-full-name }}

С помощью [{{ objstorage-full-name }}](../../storage/index.md) вы можете организовать автоматическое [резервное копирование](../../storage/concepts/backup.md) и восстановление данных. Для этого доступны разные сервисы и командные утилиты. Выберите подходящее руководство и следуйте инструкциям.
...
* [Резервное копирование в {{ objstorage-full-name }} с помощью Duplicati](object-storage-duplicati.md)
