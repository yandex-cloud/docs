[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > [Хранение и восстановление данных](../index.md) > [Автоматическая привязка политики резервного копирования Cloud Backup к ВМ](index.md) > Консоль управления, CLI, API
...
Чтобы активировать сервис, у вас должна быть _минимальная_ [роль](../../../backup/security/index.md#backup-user) `backup.user` на [каталог](../../../resource-manager/concepts/resources-hierarchy.md#folder), в котором вы хотите создавать резервные копии [защищаемых ресурсов](../../../backup/concepts/index.md#protected-resources).
...
Чтобы [агент Cloud Backup](../../../backup/concepts/agent.md) мог обмениваться данными с серверами [провайдера резервного копирования](../../../backup/concepts/index.md#providers), группа безопасности должна содержать правила, разрешающие сетевой доступ к IP-адресам ресурсов сервиса Cloud Backup.
...
- Консоль управления {#console}
  ...
  1. Добавьте правило для входящего трафика, которое обеспечит доступ на ВМ по SSH:
      ...
      Диапазон портов | Протокол | Источник | IPv4 CIDR
      --- | --- | --- | ---
      `22` | `Любой` | `Диапазон адресов` | `0.0.0.0/0`
...
- Yandex Cloud CLI {#cli}
  ...
  1. Сохраните идентификатор политики `weekly-backup` в файле `cloudbackup.json`:
      ...
      Подробности о получении идентификатора политики смотрите на странице [Получить информацию о политике резервного копирования](../../../backup/operations/policy-vm/get-info.md).
...
- API {#api}
  ...
  * в поле `cloudbackup`: идентификатор политики резервного копирования. Подробности о получении идентификатора политики смотрите на странице [Получить информацию о политике резервного копирования](../../../backup/operations/policy-vm/get-info.md).
...
1. [Удалите](../../../backup/operations/delete-vm.md) ВМ из Cloud Backup.
