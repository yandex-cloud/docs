[Документация Yandex Cloud](../../../index.md) > [Практические руководства](../../index.md) > [Хранение и восстановление данных](../index.md) > [Автоматическая привязка политики резервного копирования Cloud Backup к ВМ](index.md) > Terraform
...
1. Подготовьте файлы с описанием инфраструктуры:
    ...
    * [Политика резервного копирования](../../../backup/concepts/policy.md) — [yandex_backup_policy](../../../terraform/resources/backup_policy.md). Вы можете создать новую или использовать одну из политик, автоматически созданных при активации сервиса.
    * Привязка политики резервного копирования к ВМ — [yandex_backup_policy_bindings](../../../terraform/resources/backup_policy_bindings.md). Чтобы привязать к ВМ одну из политик, автоматически созданных при активации сервиса, [получите](../../../backup/operations/policy-vm/get-info.md) ее идентификатор.
