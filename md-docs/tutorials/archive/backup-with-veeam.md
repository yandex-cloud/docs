...
* стоимость исходящего трафика из Yandex Cloud в интернет (см. [тарифы Object Storage](../../storage/pricing.md#prices-traffic)).
...
В Object Storage поддерживается резервное копирование с помощью Veeam только в бакеты с [классом хранилища по умолчанию](../../storage/concepts/storage-class.md#default-storage-class) — **Стандартное**.
