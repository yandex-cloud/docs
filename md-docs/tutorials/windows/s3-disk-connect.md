[Документация Yandex Cloud](../../index.md) > [Практические руководства](../index.md) > [Продукты Microsoft в Yandex Cloud](index.md) > Подключение бакета как диска в Windows
