[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Video](../../index.md) > Видеоплеер > [SDK](../index.md) > [IFrame](index.md) > Параметры инициализации плеера

# Параметры инициализации плеера

При создании iframe с [видеоплеером](../../concepts/player.md) Cloud Video Player вы можете передать в URL исходные параметры для настройки воспроизведения и отображения плеера.
...
Если параметр не передан — порог видимости ≈ 0, только в режиме `muted`, без принудительного автозапуска. При значении `true` доля видимости равна `0.5`.
