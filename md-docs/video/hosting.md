...
- Уже использую Yandex Cloud {#already}
  ...
  1. Выберите один из вариантов:
     ...
     * Если у вас уже есть организация, выберите ее в выпадающем меню и нажмите **Открыть Cloud Video**.
       ...
       Для активации экземпляра Cloud Video нужна роль `admin` или `owner`. Подробнее про роли смотрите в разделе [Управление доступом в Yandex Identity Hub](../organization/security/index.md).
...
* Подробнее о каналах смотрите в разделе [Каналы](concepts/index.md#channels).
* Подробнее о том, как настроить показ рекламы, смотрите в разделе [Настроить показ рекламы](operations/channels/settings.md#ad-settings).
...
Подробнее о видео см. в разделе [Видео в сервисе Cloud Video](concepts/videos.md).
