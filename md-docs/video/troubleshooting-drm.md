[Документация Yandex Cloud](../index.md) > [Yandex Cloud Video](index.md) > Видеоплеер > Защищенный контент
...
## Решение проблем с защищенным контентом в Cloud Video

Ниже перечислены возможные проблемы при воспроизведении защищенного контента в Cloud Video и способы их решения.
