...
Автоматическое воспроизведение видео может быть ограничено политикой браузеров. Подробнее см. в [Политика автозапуска браузеров](../autoplay-policy.md)
...
Подробнее о параметрах стилизации см. в разделе [Параметры стилизации](../sdk/iframe/initialization.md#styling).
