[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Video](../index.md) > Практические руководства > Готовые решения по оформлению видео в IFrame

# Готовые решения по оформлению видео в IFrame

Руководство содержит готовые примеры для оформления [видеоплеера](../concepts/player.md) в зависимости от назначения видео. Выберите один из вариантов и при необходимости доработайте его под ваши задачи.

Чтобы воспользоваться примерами для оформления видео в IFrame:

1. Загрузите видео в [Yandex Cloud Video](../hosting.md).
1. Сохраните ссылку на видео.
1. Добавьте в код вашей HTML-страницы [код вставки iframe](../sdk/iframe/index.md).
...
- Интерфейс Cloud Video {#console}
  ...
  1. Задайте [настройки видео](../operations/video/update.md).
...
Автоматическое воспроизведение видео может быть ограничено политикой браузеров. Подробнее в [Политика автозапуска браузеров](../autoplay-policy.md).
...
Чтобы после просмотра видео предложить пользователю другие видео по теме, воспользуйтесь [плейлистом](../concepts/playlists.md):

1. Загрузите несколько видео в [Yandex Cloud Video](../hosting.md).
1. [Создайте плейлист](../operations/playlists/create.md) и добавьте в него загруженные видео.
...
Подробнее о параметрах стилизации смотрите в разделе [Параметры стилизации](../sdk/iframe/initialization.md#styling).
