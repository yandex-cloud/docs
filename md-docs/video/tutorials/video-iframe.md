...
1. Загрузите видео в [{{ video-full-name }}](../hosting.md).
...
Автоматическое воспроизведение видео может быть ограничено политикой браузеров. Подробнее см. в [{#T}](../autoplay-policy.md)
...
1. Загрузите несколько видео в [{{ video-full-name }}](../hosting.md).
...
Подробнее о параметрах стилизации см. в разделе [{#T}](../sdk/iframe/initialization.md#styling).
