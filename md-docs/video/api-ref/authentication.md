[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Video](../index.md) > Справочник API > Аутентификация в API
...
О том, как работать с сервисом с помощью API, описано на странице [Как начать работать с API Yandex Cloud Video](quickstart.md).