[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Video](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Playlist](index.md) > Update
...
```
PATCH https://video.api.cloud.yandex.net/video/v1/playlists/{playlistId}
```
