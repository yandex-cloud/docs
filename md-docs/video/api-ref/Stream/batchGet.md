[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Video](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Stream](index.md) > BatchGet
...
```
POST https://video.api.cloud.yandex.net/video/v1/streams:batchGet
```
