...
- Интерфейс Cloud Video {#console}
  ...
  1. В блоке **Настройки воспроизведения** включите опцию **Сохранять прогресс просмотра**, чтобы плеер продолжал воспроизведение с места, где пользователь остановился при прошлом просмотре.
