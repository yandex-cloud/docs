[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Video](../../index.md) > [Пошаговые инструкции](../index.md) > Трансляции > Рекомендации по настройке OBS Studio
  ...
  1. На вкладке **Трансляция**:
     ...
     1. В блоке **Настройки кодировщика**:
        ...
        * В поле **Битрейт** установите рекомендованное значение в зависимости от разрешения экрана и скорости интернета.
        ...
        Измерение скорости интернета с помощью Яндекс.Интернетометра описано в разделе [Измерить скорость интернета](https://yandex.ru/support2/internet/ru/measure).
   ...
   1. На панели слева выберите **Видео**, в блоке **Общие**:
      ...
      * В поле **Разрешение выхода (масштабное)** укажите разрешение, отправляемое в сервис Cloud Video. Если поставить более низкое, то это уменьшит расход трафика и использование процессора.
