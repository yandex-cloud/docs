  ...
  1. На вкладке **Трансляция**:
     ...
     1. В блоке **Настройки кодировщика**:
        ...
        * В поле **Битрейт** установите рекомендованное значение в зависимости от разрешения экрана и скорости интернета.
        ...
        Подробнее об измерении скорости интернета с помощью Яндекс.Интернетометра смотрите в разделе [Измерить скорость интернета](https://yandex.ru/support2/internet/ru/measure).
