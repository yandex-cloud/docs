...
- Интерфейс Cloud Video {#console}
  ...
  1. Включите или выключите рекламу. Для включения заранее [настройте](https://yandex.cloud/ru/ru/video/operations/channels/settings.md#ad-settings) показ рекламы.
