...
- Интерфейс Cloud Video {#console}
  ...
  1. В разделе **Разрешённые домены** добавьте адреса сайтов, на которых можно показывать видео с этого канала. На других сайтах видео не будут показываться.
...
1. [Добавьте](#add-page-id) `Page ID` в настройки канала Cloud Video.
...
- Интерфейс Cloud Video {#console}
  ...
  1. В разделе **Реклама** укажите:
     ...
     * **PageID**, полученный после создания видеоресурса.
