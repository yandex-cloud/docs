...
Подробнее о трансляциях в разделе [Трансляции](concepts/streams.md#streams).
...
Подробнее в разделе [Рекомендации по настройке OBS Studio](operations/streams/obs-config-help.md).
