...
В подразделе **Подключения Yandex Cloud** автоматически отображаются кластеры PostgreSQL, ClickHouse®, MySQL®, Redis/Valkey™, Yandex StoreDoc, Yandex Managed Service for Trino и Greenplum® из текущего каталога, если у пользователя есть доступ к ним. В строке над разделом **Подключения** вы можете выбрать другой каталог. Список кластеров обновится автоматически.
