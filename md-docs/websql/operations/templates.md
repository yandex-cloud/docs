[Документация Yandex Cloud](../../index.md) > [Yandex WebSQL](../index.md) > [Пошаговые инструкции](index.md) > Работа с сохраненными запросами
...
- Раздел Сохраненные запросы
   ...
   1. Перейдите в сервис [Yandex WebSQL](https://websql.yandex.cloud).
