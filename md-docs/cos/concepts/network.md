...
В {{ coi }} [Docker-контейнеры](https://yandex.cloud/ru/blog/posts/2022/03/docker-containers) запускаются с использованием сетевого интерфейса хоста. Все порты, открытые в Docker-контейнере, будут открыты и на хосте.
