...
- Консоль управления {#console}
  ...
  1. Перейдите в сервис **{{ ui-key.yacloud.iam.folder.dashboard.label_cns }}**.
  1. На панели слева выберите ![route](../_assets/console-icons/route.svg) **{{ ui-key.yacloud.cns.label_channels }}** и выберите канал с [индивидуальным отправителем](concepts/sms.md#individual-sender), в котором вы хотите создать шаблон.
  1. В меню слева выберите ![square-chart-bar](../_assets/console-icons/square-chart-bar.svg) **{{ ui-key.yacloud.cns.local.label_templates_26VqM }}** и нажмите кнопку **{{ ui-key.yacloud.cns.SMSChannel.Templates.action_create-sms-template_e6hBJ }}**. В открывшемся окне:
      ...
      1. В поле **{{ ui-key.yacloud.cns.SMSChannel.TemplateCreateForm.field_text_e8S2V }}** укажите тело шаблона.
          ...
          Подробнее о требованиях к шаблонам читайте в разделе [{#T}](concepts/sms.md#template-contents).
