[Документация Yandex Cloud](../index.md) > [Yandex Cloud Notification Service](index.md) > Начало работы > Начало работы с SMS
...
- Консоль управления {#console}
  ...
  1. Перейдите на вкладку **Шаблоны** и нажмите кнопку **Создать шаблон**. В открывшемся окне:
