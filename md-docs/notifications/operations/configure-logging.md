[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Notification Service](../index.md) > [Пошаговые инструкции](index.md) > Настроить логирование
...
- Консоль управления {#console}
    ...
    1. Чтобы остановить запись логов, отключите **Запись логов**.
