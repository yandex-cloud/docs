...
Полный список исходных данных для каждого канала уведомлений см. в разделе [Создать канал push-уведомлений](../operations/push/channel-create.md). Данные для аутентификации можно получить в консоли разработчика соответствующей мобильной платформы.
