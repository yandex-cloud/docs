[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Notification Service](../index.md) > [Концепции](index.md) > Топики
...
1. В сервисе CNS создайте каналы уведомлений. Для отправки уведомлений в очереди Yandex Message Queue каналы создавать не нужно.
