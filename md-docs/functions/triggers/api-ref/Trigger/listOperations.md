[Документация Yandex Cloud](../../../../index.md) > [Yandex Cloud Functions](../../../index.md) > Справочник API Triggers > [REST (англ.)](../index.md) > [Trigger](index.md) > ListOperations
...
1. The field name. Currently filtering can only be applied to the [Trigger.name](get.md#yandex.cloud.serverless.triggers.v1.Trigger) field.
2. An `=` operator.
