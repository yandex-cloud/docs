...
В окружении доступен [SSL-сертификат](../../../glossary/ssl-certificate.md) для доступа к управляемым базам данных из вашего кода. Сертификат хранится в файле `/usr/local/share/ca-certificates/yandex-internal-ca.crt`.
