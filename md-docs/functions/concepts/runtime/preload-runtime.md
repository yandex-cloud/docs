[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Functions](../../index.md) > [Концепции](../index.md) > [Среда выполнения](index.md) > Предзагружаемая среда выполнения
...
Как правило предзагружаемыми являются среды выполнения с последней мажорной версией. Подробнее в таблице [Среды выполнения](index.md#runtimes). Если в сервис Cloud Functions добавлена новая мажорная версия среды выполнения, как предзагружаемая, предыдущая версия спустя какое-то время перестает быть предзагружаемой. Пользователям, использующим старую версию, придет уведомление и будет дано время, чтобы перейти на новую мажорную версию.
...
Если при создании [версии функции](../function.md#version) выбрана версия среды выполнения с поддержкой предзагружаемости, то она будет автоматически обновляться до последней минорной версии, доступной в сервисе Cloud Functions. Доступная минорная версия среды выполнения обычно отстает от глобальной минорной версии.
