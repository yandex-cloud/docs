...
Когда экземпляр функции обрабатывает одновременно несколько вызовов, в логи записывается идентификатор только последнего из них. Чтобы в логи записывались идентификаторы всех вызовов, которые обрабатывала функция, используйте [структурированные логи](logs.md#structured-logs).
