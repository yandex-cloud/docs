...
Файл больше 3,5 МБ необходимо [загружать через {{ objstorage-short-name }}](../../storage/operations/objects/upload.md). Подробнее об ограничениях читайте в разделе [{#T}](limits.md).
...
Кроме этого, в {{ sf-name }} можно задать следующие настройки масштабирования:
