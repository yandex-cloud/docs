[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Functions](../../index.md) > [Разработка на Node.js](index.md) > Обработка ошибок
...
Также информация об ошибке записывается в [журнал выполнения](logging.md), который можно [просмотреть](../../operations/function/function-logs.md) с помощью [Yandex Cloud CLI](../../../cli/index.md) или [консоли управления](https://console.yandex.cloud).
