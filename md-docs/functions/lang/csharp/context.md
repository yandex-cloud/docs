[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Functions](../../index.md) > [Разработка на .NET Core](index.md) > Контекст вызова
...
* `FunctionFolderId` — возвращает каталог, в котором находится функция;
