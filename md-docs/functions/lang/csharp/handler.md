[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Functions](../../index.md) > [Разработка на .NET Core](index.md) > Обработчик запросов

# Обработчик запросов функции Cloud Functions на .NET Core
