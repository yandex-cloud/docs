[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Functions](../../index.md) > [Разработка на PHP](index.md) > Обработчик запросов
...
1. Контекст вызова (параметр `context`). 
    ...
    Контекст содержит необходимую информацию о версии функции. Структура этого объекта описана в разделе [Контекст вызова функции на PHP](context.md).

Обработчик представляет собой функцию, объявленную в глобальном пространстве имен, которая принимает два аргумента.
