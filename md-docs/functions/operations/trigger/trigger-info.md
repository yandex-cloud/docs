[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Functions](../../index.md) > [Пошаговые инструкции](../index.md) > Получение информации о триггере > Получить информацию о триггере

# Получить информацию о триггере в Cloud Functions
