...
- Консоль управления {#console}
    ...
    1. В [консоли управления](https://console.yandex.cloud) перейдите в каталог, в котором хотите изменить имя [функции](../../concepts/function.md).
...
- CLI {#cli}
    ...
    ```
    yc serverless function update <имя_функции> --new-name <новое_имя_функции>
    ```
...
- Terraform {#tf}
    ...
    Проверить изменение имени функции можно в [консоли управления](https://console.yandex.cloud) или с помощью команды [CLI](../../../cli/quickstart.md):
