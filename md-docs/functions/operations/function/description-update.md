[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Functions](../../index.md) > [Пошаговые инструкции](../index.md) > Управление функцией > Изменить функцию > Изменить описание
...
- Консоль управления {#console}
    ...
    1. В [консоли управления](https://console.yandex.cloud) перейдите в каталог, в котором хотите изменить описание [функции](../../concepts/function.md).
...
- CLI {#cli}
    ...
    ```
    yc serverless function update <имя_функции> --description "<описание_функции>"
    ```
...
- Terraform {#tf}
    ...
    Проверить изменение описания функции можно в [консоли управления](https://console.yandex.cloud) или с помощью команды [CLI](../../../cli/quickstart.md):
