...
Чтобы перенести [подсети](../../../vpc/concepts/network.md#subnet) для [функций](../../concepts/function.md) {{ sf-name }}, [контейнеров](../../../serverless-containers/concepts/container.md) {{ serverless-containers-name }} или [API-шлюзов](../../../api-gateway/concepts/index.md) {{ api-gw-name }} в другую зону, выполните следующие действия:
