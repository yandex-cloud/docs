[Документация Yandex Cloud](../index.md) > [Yandex Cloud Functions](index.md) > Метрики Monitoring

# Справочник метрик Yandex Monitoring

В этом разделе описаны метрики сервиса Cloud Functions, поставляемые в [Monitoring](../monitoring/index.md).
...
Метка | Значение
----|----
resource_id | Идентификатор [функции](concepts/function.md)
version_id | Идентификатор [версии функции](concepts/function.md#version)
...
Общие метки для всех метрик [функций](concepts/function.md):
...
Общие метки для всех метрик [триггеров](concepts/trigger/index.md):
...
Общие метки для всех метрик [подключений к БД](operations/database-connection.md):
