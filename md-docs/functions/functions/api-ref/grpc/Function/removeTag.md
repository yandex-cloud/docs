# Cloud Functions Service, gRPC: FunctionService.RemoveTag
...
To get the a version ID make a [FunctionService.ListVersions](listVersions.md#ListVersions) request. ||
|| tag | **string**
