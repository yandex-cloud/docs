[Документация Yandex Cloud](../../../../../index.md) > [Yandex Cloud Functions](../../../../index.md) > Справочник API Functions > [gRPC (англ.)](../index.md) > [Function](index.md) > GetVersionByTag

# Cloud Functions Service, gRPC: FunctionService.GetVersionByTag

Returns all versions with the specified tag.
To get the list of all available versions, make a [ListVersions](listVersions.md#ListVersions) request.
