[Документация Yandex Cloud](../../../../../index.md) > [Yandex Cloud Functions](../../../../index.md) > Справочник API Functions > [gRPC (англ.)](../index.md) > [Function](index.md) > CreateFunctionVersion

# Cloud Functions Service, gRPC: FunctionService.CreateFunctionVersion

Deprecated. Use [CreateVersion](createVersion.md#CreateVersion).
