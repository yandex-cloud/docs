[Документация Yandex Cloud](../../../../../index.md) > [Yandex Cloud Functions](../../../../index.md) > Справочник API Functions > [gRPC (англ.)](../index.md) > [Function](index.md) > GetFunctionVersion

# Cloud Functions Service, gRPC: FunctionService.GetFunctionVersion

Deprecated. Use [GetVersion](getVersion.md#GetVersion).
...
To get a version ID make a [FunctionService.ListVersions](listVersions.md#ListVersions) request. ||
|#
...
Version of a function. For details about the concept, see [Function versions](../../../../concepts/function.md#version).
...
Supported environments and their identifiers are listed in the [Runtime environments](../../../../concepts/runtime/index.md). ||
|| entrypoint | **string**
...
Version tags. For details, see [Version tag](../../../../concepts/function.md#tag). ||
