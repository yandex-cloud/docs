[Документация Yandex Cloud](../../../../../index.md) > [Yandex Cloud Functions](../../../../index.md) > Справочник API Functions > [gRPC (англ.)](../index.md) > [Function](index.md) > GetFunctionVersionByTag

# Cloud Functions Service, gRPC: FunctionService.GetFunctionVersionByTag

Deprecated. Use [GetVersionByTag](getVersionByTag.md#GetVersionByTag).
...
To get a function ID use a [FunctionService.List](list.md#List) request. ||
|| tag | **string**
