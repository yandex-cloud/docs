[Документация Yandex Cloud](../../../../../index.md) > [Yandex Cloud Functions](../../../../index.md) > Справочник API Functions > [gRPC (англ.)](../index.md) > [Function](index.md) > ListFunctionVersions

# Cloud Functions Service, gRPC: FunctionService.ListFunctionVersions

Deprecated. Use [ListVersions](listVersions.md#ListVersions).
