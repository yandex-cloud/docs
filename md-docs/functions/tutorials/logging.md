[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Functions](../index.md) > [Практические руководства](index.md) > ETL на Serverless > Запись логов балансировщика в PostgreSQL
...
Для логирования работы балансировщика будет создана [лог-группа](../../logging/concepts/log-group.md) в Cloud Logging. Поставка логов из этой лог-группы в БД будет настроена с помощью ресурсов сервиса Yandex Cloud Functions — [триггера](../concepts/trigger/cloud-logging-trigger.md) и вызываемой им [функции](../concepts/function.md).
...
[Функция](../concepts/function.md) будет получать сообщения из лог-группы и записывать их в таблицу, [созданную ранее](#set-up-db-create-table).
...
[Триггер](../concepts/trigger/index.md) будет принимать копии сообщений от балансировщика и передавать их в функцию для обработки.
...
- API {#api}
  ...
  Используйте вызов gRPC API [TriggerService/Create](../triggers/api-ref/grpc/Trigger/create.md) или метод REST API [create](../triggers/api-ref/Trigger/create.md).
...
1. [Удалите](../operations/trigger/trigger-delete.md) триггер `alb-logging-trigger`.
1. [Удалите](../operations/function/function-delete.md) функцию `alb-logging-function`.
