...
1. Подготовьте файлы с описанием инфраструктуры:
    ...
    * [Функция](../../concepts/index.md) — [yandex_function]({{ tf-provider-resources-link }}/function).
    * Назначение [роли на функцию](../../security/index.md) — [yandex_function_iam_binding]({{ tf-provider-resources-link }}/function_iam_binding).
