...
1. Подготовьте файлы с описанием инфраструктуры:
    ...
    * [Функция](../../concepts/index.md) — [yandex_function](../../../terraform/resources/function.md).
    * Назначение [роли на функцию](../../security/index.md) — [yandex_function_iam_binding](../../../terraform/resources/function_iam_binding.md).
