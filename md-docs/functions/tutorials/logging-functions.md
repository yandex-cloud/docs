...
Вы можете использовать сервис [Cloud Functions](../index.md) для настройки автоматического реагирования на события аудитного лога. Например, отправлять сообщения по удобным каналам оповещения или автоматически изменять настройки ресурсов Yandex Cloud в качестве компенсационных мер.
...
3. [Триггер для Yandex Cloud Logging](../concepts/trigger/cloud-logging-trigger.md) — вызывает функцию при добавлении записи в лог-группу.
4. [Функция Cloud Functions](../concepts/function.md) — выполняет логику реагирования.
