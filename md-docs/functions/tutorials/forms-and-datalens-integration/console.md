[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Functions](../../index.md) > [Практические руководства](../index.md) > ETL на Serverless > [Поставка данных из Яндекс Формы в Yandex DataLens с использованием Yandex Cloud Functions и Yandex Query](index.md) > Консоль управления
...
1. [Функцию Cloud Functions](../../operations/function/function-delete.md).
