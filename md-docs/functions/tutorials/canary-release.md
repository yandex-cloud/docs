[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Functions](../index.md) > [Практические руководства](index.md) > Бэкенд на Serverless > Канареечный релиз функции Cloud Functions
...
[Создайте две версии функции](../operations/index.md#create-function):
* версию для текущего релиза;
* версию для канареечного релиза, которая будет тестироваться на некоторой доле запросов.

Вы можете использовать собственную функцию или создать [любую функцию из списка](../quickstart/create-function/index.md).
