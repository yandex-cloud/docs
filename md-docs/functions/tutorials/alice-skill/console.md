[Документация Yandex Cloud](../../../index.md) > [Yandex Cloud Functions](../../index.md) > [Практические руководства](../index.md) > Интеграция с сервисами Яндекса и Yandex Cloud > [Создание навыка Алисы](index.md) > Консоль управления, CLI и API
