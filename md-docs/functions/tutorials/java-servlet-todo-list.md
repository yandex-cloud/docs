[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Functions](../index.md) > [Практические руководства](index.md) > Бэкенд на Serverless > Развертывание веб-приложения
...
Создайте [функцию](../concepts/function.md) для каждого сервлета:
...
- API {#api}
  ...
  Воспользуйтесь API методами [create](../functions/api-ref/Function/create.md), [createVersion](../functions/api-ref/Function/createVersion.md) и [setAccessBindings](../functions/api-ref/Function/setAccessBindings.md) для ресурса [Function](../functions/api-ref/Function/index.md).
