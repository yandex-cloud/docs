...
Чтобы запустить эмулятор, создайте [функцию](../concepts/function.md) эмуляции отправки данных с датчиков устройств и [триггер](../concepts/trigger/index.md) для вызова этой функции с периодичностью один раз в минуту.
...
1. [Удалите](../operations/trigger/trigger-delete.md) триггеры для вызова функций в сервисе Cloud Functions.
1. [Удалите](../operations/function/function-delete.md) функции в сервисе Cloud Functions.
