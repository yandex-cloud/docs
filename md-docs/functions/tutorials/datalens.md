...
1. [Удалите](../operations/trigger/trigger-delete.md) триггеры для вызова функций в сервисе {{ sf-name }}.
1. [Удалите](../operations/function/function-delete.md) функции в сервисе {{ sf-name }}.
