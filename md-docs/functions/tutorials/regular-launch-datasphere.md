[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Functions](../index.md) > [Практические руководства](index.md) > Рабочие процессы и автоматизация на Serverless > Запуск вычислений по расписанию в DataSphere

# Запуск вычислений по расписанию в DataSphere


Организовать сценарии регулярных запусков в [Yandex DataSphere](https://datasphere.yandex.cloud) можно с помощью API, вызывая исполнение ячеек ноутбука в [Yandex Cloud Functions](../index.md).
...
Для запуска функции каждые 15 минут вам понадобится [таймер](../concepts/trigger/timer.md).

{% list tabs group=instructions %}

- Консоль управления {#console}

    1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором хотите создать таймер.
...
* [Удалите](../operations/trigger/trigger-delete.md) триггер;
