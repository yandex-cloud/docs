...
В этом руководстве вы настроите мониторинг и уведомления об изменениях показаний датчиков, подключенных к сервису [{{ iot-name }}](../../iot-core/index.md). Датчики будут эмулированы с помощью сервиса [{{ sf-full-name }}](../index.md). Если у вас есть подключенные датчики, используйте их.
...
* плата за количество вызовов [функции](../concepts/function.md) {{ sf-name }} (см. [тарифы {{ sf-full-name }}](../pricing.md));
...
* [Удалите функции в сервисе {{ sf-name }}](../operations/function/function-delete.md)
* [Удалите триггеры для вызова функций в сервисе {{ sf-name }}](../operations/trigger/trigger-delete.md)
