[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Functions](../index.md) > [Практические руководства](index.md) > Интернет вещей > Мониторинг показаний датчиков и уведомления о событиях
...
В этом руководстве вы настроите мониторинг и уведомления об изменениях показаний датчиков, подключенных к сервису [Yandex IoT Core](../../iot-core/index.md). Датчики будут эмулированы с помощью сервиса [Yandex Cloud Functions](../index.md). Если у вас есть подключенные датчики, используйте их.
...
* [Удалите функции в сервисе Cloud Functions](../operations/function/function-delete.md)
* [Удалите триггеры для вызова функций в сервисе Cloud Functions](../operations/trigger/trigger-delete.md)
