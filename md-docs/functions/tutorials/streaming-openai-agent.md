[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Functions](../index.md) > [Практические руководства](index.md) > Искусственный интеллект > Создание AI-агента со стримингом ответа через веб-сокеты

# Создание агента на OpenAI Agents SDK со стримингом ответа через веб-сокеты на Cloud Functions и Yandex API Gateway

# Создание агента на OpenAI Agents SDK со стримингом ответа через веб-сокеты на Yandex Cloud Functions и API Gateway


В этом руководстве вы создадите агент со стримингом ответа через [веб-сокеты](https://ru.wikipedia.org/wiki/WebSocket) на [Yandex Cloud Functions](../index.md) и [Yandex API Gateway](../../api-gateway/index.md). Функция будет использовать [OpenAI Agents SDK](https://openai.github.io/openai-agents-python/) для работы с моделями [Yandex AI Studio](https://aistudio.yandex.ru/docs/ru/ai-studio/concepts/generation/index#yandex).
...
1. API-шлюз перенаправляет запрос в обработчик [функции](../concepts/function.md).
