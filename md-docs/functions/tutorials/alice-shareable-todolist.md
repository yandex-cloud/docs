[Документация Yandex Cloud](../../index.md) > [Yandex Cloud Functions](../index.md) > [Практические руководства](index.md) > Интеграция с сервисами Яндекса и Yandex Cloud > Разработка навыка Алисы и сайта с авторизацией
...
Данные проекта хранятся в бакете [Yandex Object Storage](../../storage/index.md) и базе данных [Yandex Managed Service for YDB](../../ydb/index.md). Функции [Yandex Cloud Functions](../index.md) обрабатывают запросы, а [Yandex API Gateway](../../api-gateway/index.md) обеспечивает взаимодействие сервисов.
...
* плата за количество вызовов функций, вычислительные ресурсы, выделенные для выполнения функций, и исходящий трафик ([тарифы Yandex Cloud Functions](../pricing.md));
...
* [Удалите](../operations/function/function-delete.md) функции.
