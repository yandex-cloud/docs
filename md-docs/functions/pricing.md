[Документация Yandex Cloud](../index.md) > [Yandex Cloud Functions](index.md) > Правила тарификации
...
| --------------------------------------------------------------------------------- | ----------------- | --------------- | -------------- | ------------ |
| Cloud Functions. Время выполнения функции, от 0 до 10 единицы тарификации в месяц | Не тарифицируется | ГБ × час        | 30 апреля 2026 | —            |
| Cloud Functions. Время выполнения функции, от 10 единицы тарификации в месяц      | 6,48 ₽            | ГБ × час        | 30 апреля 2026 | —            |
| Cloud Functions. Время выполнения функции в подготовленном экземпляре             | 2,72 ₽            | ГБ × час        | 30 апреля 2026 | —            |
| Cloud Functions. Время простоя подготовленного экземпляра                         | 1,42 ₽            | ГБ × час        | 30 апреля 2026 | —            |
| Cloud Functions. Вызов функции, от 0 до 1 единицы тарификации в месяц             | Не тарифицируется | 1 млн вызовов   | 30 апреля 2026 | —            |
| Cloud Functions. Вызов функции, от 1 единицы тарификации в месяц                  | 18,97 ₽           | 1 млн вызовов   | 30 апреля 2026 | —            |
