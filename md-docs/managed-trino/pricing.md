[Документация Yandex Cloud](../index.md) > [Yandex Managed Service for Trino](index.md) > Правила тарификации
...
- Расчет в рублях {#prices-rub}
  ...
  > 720 × (8 × 2,07 ₽ + 32 × 0,554 ₽) = 24 687,36 ₽
  >
  > Итого: 24 687,36 ₽ — стоимость использования кластера в течение 30 дней.
...
- Расчет в тенге {#prices-kzt}
  ...
  > 720 × (8 × 10,35 ₸ + 32 × 2,77 ₸) = 123 436,8 ₸
  >
  > Итого: 123 436,8 ₸ — стоимость использования кластера в течение 30 дней.
...
| ---------------------------------------------------------------- | ------- | --------------- | -------------- | ------------ |
| Managed Service for Trino. Вычислительные ресурсы кластера, RAM  | 0,554 ₽ | ГБ × час        | 30 апреля 2026 | —            |
| Managed Service for Trino. Вычислительные ресурсы кластера, vCPU | 2,07 ₽  | vCPU × час      | 30 апреля 2026 | —            |
