...
Подробнее о ресурсных группах в [документации Trino](https://trino.io/docs/current/admin/resource-groups.html).
...
Подробнее об управлении ресурсными группами и правилами маршрутизации в Managed Service for Trino в [инструкции](../operations/manage-resource-groups.md).
