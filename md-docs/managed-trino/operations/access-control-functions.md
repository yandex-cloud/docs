...
- Консоль управления {#console}
  ...
  1. В открывшемся окне задайте параметры правила:
     ...
     1. (Опционально) В поле **Функции, к которым применяется правило** укажите, на какие функции распространяется правило:
        * **Имя** — выберите имена функций.
        * **Имя (регулярное выражение)** — введите регулярное выражение. Правило распространяется на функции, имена которых соответствуют регулярному выражению.
        * **Не задано** — правило распространяется на все функции.
