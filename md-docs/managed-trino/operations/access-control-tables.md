...
Правила доступа к таблицам определяют, какие действия пользователи могут совершать над таблицами и представлениями (`VIEW`) в кластере Managed Service for Trino. Чтобы правило применялось к представлению, укажите его имя в поле имени таблицы, а также соответствующие каталог и схему.
...
- Консоль управления {#console}
  ...
  1. В открывшемся окне задайте параметры правила:
     ...
     1. (Опционально) В поле **Привилегии** выберите разрешенные действия над таблицами:
        ...
        * `OWNERSHIP` — создание, изменение и удаление таблицы или представления, включая изменение состава столбцов таблицы и добавление комментариев.
        * `GRANT_SELECT` — использование данных таблицы или представления в представлениях с `SECURITY DEFINER`, которые читают другие пользователи.

        Если не выбрано ни одно разрешенное действие, правило запрещает выполнение любых действий над таблицами и представлениями.
        ...
        * Привилегия `SELECT` на все таблицы-источники, из которых представление читает данные, и доступ к их каталогам.
        ...
        Подробнее о режимах проверки прав и ограничении групповых правил в разделе [Доступ к представлениям](../concepts/access-control.md#views).
