[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for Trino](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Catalog](index.md) > List
...
```
GET https://trino.api.cloud.yandex.net/managed-trino/v1/clusters/{clusterId}/catalogs
```
