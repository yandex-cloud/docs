[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for Trino](../../../index.md) > Справочник API > [gRPC (англ.)](../index.md) > Maintenance > Overview

# Managed Service for Trino API, gRPC: MaintenanceService
