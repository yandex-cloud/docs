[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for Trino](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Cluster](index.md) > SetAccessBindings

# Managed Service for Trino API, REST: Cluster.SetAccessBindings
...
```
POST https://trino.api.cloud.yandex.net/managed-trino/v1/clusters/{resourceId}:setAccessBindings
```
