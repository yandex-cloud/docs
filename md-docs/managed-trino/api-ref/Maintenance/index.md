[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for Trino](../../index.md) > Справочник API > [REST (англ.)](../index.md) > Maintenance > Overview

# Managed Service for Trino API, REST: Maintenance
