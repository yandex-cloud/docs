[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for Trino](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Maintenance](index.md) > List

# Managed Service for Trino API, REST: Maintenance.List
...
```
GET https://trino.api.cloud.yandex.net/managed-trino/v1/maintenances
```
