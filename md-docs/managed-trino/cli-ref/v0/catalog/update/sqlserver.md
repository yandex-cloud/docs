[Документация Yandex Cloud](../../../../../index.md) > [Yandex Managed Service for Trino](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [v0](../../index.md) > [catalog](../index.md) > [update](index.md) > sqlserver

# yc managed-trino v0 catalog update sqlserver

Update MS SQL Server catalog

#### Command Usage

Syntax:

`yc managed-trino catalog update sqlserver <CATALOG-NAME> [Flags...] [Global Flags...]`
