[Документация Yandex Cloud](../../../../../index.md) > [Yandex Managed Service for Trino](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [v0](../../index.md) > [catalog](../index.md) > [update](index.md) > mysql

# yc managed-trino v0 catalog update mysql

Update MySQL catalog

#### Command Usage

Syntax:

`yc managed-trino catalog update mysql <CATALOG-NAME> [Flags...] [Global Flags...]`
...
ConnectionManager connection properties. ||
