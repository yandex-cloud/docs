[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for Trino](../../../index.md) > [Справочник CLI (англ.)](../../index.md) > [v0](../index.md) > [cluster](index.md) > create

# yc managed-trino v0 cluster create
...
|| `--resource-groups-from-file` | `string`

YAML file with resource groups configuration. ||
|| `--trusted-certs-from-files` | `value[,value]`

Trusted CA-certificates files. Each file should contain single self-signed CA-certificate or chain of CA-certificates where first certificate is the leaf and last certificate is the self-signed root. ||
