[Документация Yandex Cloud](../../index.md) > [Yandex IoT Core](../index.md) > [Практические руководства](index.md) > Мониторинг состояния географически распределенных устройств
...
Вы также можете использовать авторизацию с помощью сертификатов. Подробнее [об авторизации в Yandex IoT Core](../concepts/authorization.md).
...
1. (Опционально) Чтобы получать подробную информацию с датчиков, [подпишите](../operations/subscribe.md#one-device) реестр на [топик](../concepts/topic/index.md) устройства Yandex IoT Core.
...
1. [Удалите](../operations/device/device-delete.md) устройства в сервисе Yandex IoT Core.
1. [Удалите](../operations/registry/registry-delete.md) реестр в сервисе Yandex IoT Core.
