[Документация Yandex Cloud](../../index.md) > [Yandex IoT Core](../index.md) > [Практические руководства](index.md) > Эмуляция множества IoT-устройств
...
1. [Удалите](../operations/device/device-delete.md) устройства.
