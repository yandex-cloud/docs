[Документация Yandex Cloud](../../index.md) > [Yandex IoT Core](../index.md) > [Практические руководства](index.md) > Работа с Yandex IoT Core с устройства с Android на языке Java
