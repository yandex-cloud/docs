[Документация Yandex Cloud](../../../../../index.md) > [Yandex IoT Core](../../../../index.md) > Справочник API Broker > [gRPC (англ.)](../index.md) > [Operation](index.md) > Cancel

# IoT Core Broker Service, gRPC: OperationService.Cancel
