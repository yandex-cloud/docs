...
- Консоль управления {#console}
  ...
  1. На странице ![image](../../_assets/console-icons/server.svg) **Реестры** отобразится список реестров.
...
- Консоль управления {#console}
   ...
   1. [Перейдите](https://console.yandex.cloud/link/iot-core) в сервис **IoT Core** и выберите реестр.
   1. На вкладке **Обзор** отобразится подробная информация о реестре.
...
- Консоль управления {#console}
   ...
   1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором находится реестр.
   1. [Перейдите](https://console.yandex.cloud/link/iot-core) в сервис **IoT Core** и выберите реестр.
   1. На вкладке **Обзор** перейдите к разделу **Сертификаты**.
...
- Консоль управления {#console}
   ...
   1. [Перейдите](https://console.yandex.cloud/link/iot-core) в сервис **IoT Core** и выберите реестр, в котором находится устройство.
   1. Перейдите на вкладку **Устройства** и выберите устройство.
   1. На вкладке **Обзор** отобразится подробная информация об устройстве.
...
- Консоль управления {#console}
   ...
   1. В [консоли управления](https://console.yandex.cloud) выберите каталог, в котором находится устройство.
   1. [Перейдите](https://console.yandex.cloud/link/iot-core) в сервис **IoT Core** и выберите реестр, в котором находится устройство.
   1. Перейдите на вкладку **Устройства** и выберите устройство, для которого хотите получить список алиасов.
   1. На вкладке **Обзор** перейдите к разделу **Алиасы**.
...
- Консоль управления {#console}
  ...
  1. [Перейдите](https://console.yandex.cloud/link/iot-core) в сервис **IoT Core**.
  1. На панели слева выберите ![image](../../_assets/console-icons/gear-branches.svg) **Брокеры**. На вкладке **Обзор** отобразится список брокеров.
...
- Консоль управления {#console}
   ...
   1. Выберите брокер. Подробная информация о брокере отобразится на вкладке **Обзор**.
...
- Terraform {#tf}
  ...
  1. Добавьте в конфигурационный файл Terraform блоки `data` и `output`:
      ...
      * `output "broker_params"` — выходная переменная, которая содержит информацию о временной метке создания брокера:
      ...
      Вместо `created_at` вы можете выбрать любой другой параметр для получения информации. Подробнее о параметрах источника данных `yandex_iot_core_broker` в [документации провайдера](../../terraform/data-sources/iot_core_broker.md).
  1. Создайте ресурсы:
