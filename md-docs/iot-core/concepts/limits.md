[Документация Yandex Cloud](../../index.md) > [Yandex IoT Core](../index.md) > [Концепции](index.md) > Квоты и лимиты

# Квоты и лимиты в Yandex IoT Core
...
В сервисе Yandex IoT Core действуют следующие ограничения:
...
Максимальная длина имени [сабтопика](topic/subtopic.md) | 1024 символа
Максимальное количество [алиасов](topic/usage.md#aliases) на устройство | 5
