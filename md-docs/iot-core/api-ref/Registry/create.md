[Документация Yandex Cloud](../../../index.md) > [Yandex IoT Core](../../index.md) > Справочник API Devices > [REST (англ.)](../index.md) > [Registry](index.md) > Create
...
## Body parameters {#yandex.cloud.iot.devices.v1.CreateRegistryRequest}
