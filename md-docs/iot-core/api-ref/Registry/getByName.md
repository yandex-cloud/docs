[Документация Yandex Cloud](../../../index.md) > [Yandex IoT Core](../../index.md) > Справочник API Devices > [REST (англ.)](../index.md) > [Registry](index.md) > GetByName
...
## Query parameters {#yandex.cloud.iot.devices.v1.GetByNameRegistryRequest}
...
To get a registry Name make a [RegistryService.List](list.md#List) request.
