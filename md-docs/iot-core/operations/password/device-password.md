...
- Консоль управления {#console}
   ...
   1. [Перейдите](https://console.yandex.cloud/link/iot-core) в сервис **IoT Core** и выберите реестр с нужным устройством.
   1. Перейдите на вкладку **Устройства** и выберите нужное устройство.
   1. В блоке **Пароли** нажмите кнопку **Добавить пароль**.
   1. В поле **Пароль** введите пароль, который вы будете использовать для доступа к устройству.
...
- Консоль управления {#console}
   ...
   1. [Перейдите](https://console.yandex.cloud/link/iot-core) в сервис **IoT Core** и выберите реестр с нужным устройством.
   1. Перейдите на вкладку **Устройства** и выберите нужное устройство.
   1. На вкладке **Обзор** перейдите к разделу **Пароли** — там отобразится список паролей устройства.
