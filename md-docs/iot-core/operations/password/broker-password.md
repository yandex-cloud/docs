...
- Консоль управления {#console}
   ...
   1. В поле **Пароль** введите пароль, который будете использовать для доступа к брокеру.
...
- Консоль управления {#console}
   ...
   1. На панели слева выберите ![image](../../../_assets/console-icons/gear-branches.svg) **Брокеры**.
   1. Выберите нужный брокер из списка.
   1. На вкладке **Обзор** перейдите к разделу **Пароли**.
...
- Консоль управления {#console}
   ...
   1. На панели слева выберите ![image](../../../_assets/console-icons/gear-branches.svg) **Брокеры**.
   1. Выберите нужный брокер из списка.
   1. Справа от удаляемого пароля нажмите ![image](../../../_assets/console-icons/ellipsis.svg) → **Удалить**.
