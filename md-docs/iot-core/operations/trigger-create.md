[Документация Yandex Cloud](../../index.md) > [Yandex IoT Core](../index.md) > [Пошаговые инструкции](index.md) > Создание триггера для топика > Реестр устройств
...
Создайте [триггер](../../functions/concepts/trigger/iot-core-trigger.md) для [топика](../concepts/topic/index.md) [устройства](../concepts/index.md#device) или [реестра](../concepts/index.md#registry) [Yandex IoT Core](../index.md) и обрабатывайте копии сообщений с помощью [функции](../../functions/concepts/function.md) [Yandex Cloud Functions](../../functions/index.md).
...
- API {#api}
  ...
  Чтобы создать триггер для Yandex IoT Core, воспользуйтесь методом REST API [create](../../functions/triggers/api-ref/Trigger/create.md) для ресурса [Trigger](../../functions/triggers/api-ref/Trigger/index.md) или вызовом gRPC API [TriggerService/Create](../../functions/triggers/api-ref/grpc/Trigger/create.md).
