...
Создайте [триггер](../../functions/concepts/trigger/iot-core-trigger.md) для [топика](../concepts/topic/index.md) [устройства](../concepts/index.md#device) или [реестра](../concepts/index.md#registry) [{{ iot-name }}](../index.md) и обрабатывайте копии сообщений с помощью [функции](../../functions/concepts/function.md) [{{ sf-full-name }}](../../functions/index.md).
...
* Реестр или устройство, из топиков которых триггер будет принимать копии сообщений. Если у вас их нет:
  * [Создайте реестр](registry/registry-create.md).
  * [Создайте устройство](device/device-create.md).
...
- CLI {#cli}
  ...
  * `--device-id` — [идентификатор устройства](device/device-list.md). Если вы создаете триггер для топика реестра, этот параметр можно не указывать.
