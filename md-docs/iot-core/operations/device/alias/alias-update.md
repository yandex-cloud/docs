[Документация Yandex Cloud](../../../../index.md) > [Yandex IoT Core](../../../index.md) > [Пошаговые инструкции](../../index.md) > Управление устройствами > Управление алиасами топиков > Изменение алиаса
...
- Консоль управления {#console}
   ...
   1. [Перейдите](https://console.yandex.cloud/link/iot-core) в сервис **IoT Core** и выберите нужный реестр.
   1. Перейдите на вкладку **Устройства**.
   1. Справа от имени нужного устройства нажмите ![image](../../../../_assets/console-icons/ellipsis.svg) → ![image](../../../../_assets/console-icons/pencil.svg) **Редактировать**.
   1. В блоке **Алиасы** измените значения полей нужного алиаса.
   1. Нажмите **Сохранить**.
