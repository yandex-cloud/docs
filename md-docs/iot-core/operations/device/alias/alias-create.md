[Документация Yandex Cloud](../../../../index.md) > [Yandex IoT Core](../../../index.md) > [Пошаговые инструкции](../../index.md) > Управление устройствами > Управление алиасами топиков > Создание алиаса
