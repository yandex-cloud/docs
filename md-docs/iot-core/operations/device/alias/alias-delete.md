[Документация Yandex Cloud](../../../../index.md) > [Yandex IoT Core](../../../index.md) > [Пошаговые инструкции](../../index.md) > Управление устройствами > Управление алиасами топиков > Удаление алиаса
...
- Консоль управления {#console}
   ...
   1. В [консоли управления](https://console.yandex.cloud) выберите каталог, из которого вы хотите удалить алиас.
   ...
   1. В блоке **Алиасы** справа от удаляемого алиаса нажмите ![image](../../../../_assets/console-icons/xmark.svg).
   1. Нажмите **Сохранить**.
