[Документация Yandex Cloud](../../../index.md) > [Yandex IoT Core](../../index.md) > [Пошаговые инструкции](../index.md) > Управление сертификатами > Управление сертификатами брокера
...
- Консоль управления {#console}
   ...
   1. [Перейдите](https://console.yandex.cloud/link/iot-core) в сервис **IoT Core**.
   1. На панели слева выберите ![image](../../../_assets/console-icons/gear-branches.svg) **Брокеры** и затем — нужный брокер.
   1. На вкладке **Обзор** перейдите к разделу **Сертификаты** и нажмите **Добавить сертификат**.
...
- Консоль управления {#console}
   ...
   1. Справа от имени удаляемого сертификата нажмите ![image](../../../_assets/console-icons/ellipsis.svg) → **Удалить**.
