[Документация Yandex Cloud](../../index.md) > [Yandex IoT Core](../index.md) > [Пошаговые инструкции](index.md) > Просмотр журнала подключений
...
- Консоль управления {#console}
    ...
    1. Выберите реестр с нужным устройством.
