[Документация Yandex Cloud](../../../index.md) > [Yandex IoT Core](../../index.md) > [Пошаговые инструкции](../index.md) > Управление брокерами > Создание брокера
...
- Консоль управления {#console}
  ...
  1. В блоке **Общая информация** укажите:
      ...
      * (Опционально) Для присвоения брокеру [метки](../../../resource-manager/concepts/labels.md) заполните поля **Ключ** и **Значение** и нажмите кнопку **Добавить метку**.
...
- Terraform {#tf}
  ...
  1. Опишите в конфигурационном файле параметры ресурса, который необходимо создать:
     ...
     * `yandex_iot_core_broker` — параметры брокера:
      ...
      Подробнее о ресурсах, которые можно создать с помощью Terraform, в [документации провайдера](../../../terraform/resources/iot_core_broker.md).
