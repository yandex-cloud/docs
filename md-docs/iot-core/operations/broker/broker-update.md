[Документация Yandex Cloud](../../../index.md) > [Yandex IoT Core](../../index.md) > [Пошаговые инструкции](../index.md) > Управление брокерами > Изменение брокера
...
- Консоль управления {#console}
   ...
   1. Справа от имени нужного брокера нажмите ![image](../../../_assets/console-icons/ellipsis.svg) → ![image](../../../_assets/console-icons/pencil.svg) **Редактировать**.
   1. Измените поле **Имя**.
