[Документация Yandex Cloud](../../index.md) > [Yandex IoT Core](../index.md) > [Пошаговые инструкции](index.md) > Просмотр операций с ресурсами сервиса

# Просмотр операций с ресурсами сервиса Yandex IoT Core
...
Все действия с ресурсами сервиса Yandex IoT Core сохраняются в виде списка операций. Каждой операции присваивается уникальный идентификатор.
...
- Консоль управления {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) откройте каталог, в котором находится реестр.
  ...
  1. Перейдите на панель ![image](../../_assets/console-icons/list-check.svg) **Операции** для выбранного реестра.
