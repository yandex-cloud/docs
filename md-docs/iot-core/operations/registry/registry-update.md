[Документация Yandex Cloud](../../../index.md) > [Yandex IoT Core](../../index.md) > [Пошаговые инструкции](../index.md) > Управление реестрами > Изменение реестра
...
- Консоль управления {#console}
   ...
   1. Справа от имени нужного реестра нажмите ![image](../../../_assets/console-icons/ellipsis.svg) → ![image](../../../_assets/console-icons/pencil.svg) **Редактировать**.
   1. Измените поле **Имя**.
   1. Нажмите **Сохранить**.
...
- Консоль управления {#console}
   ...
   1. [Перейдите](https://console.yandex.cloud/link/iot-core) в сервис **IoT Core**.
   1. Справа от имени нужного реестра нажмите ![image](../../../_assets/console-icons/ellipsis.svg) → ![image](../../../_assets/console-icons/pencil.svg) **Редактировать**.
   1. В поле **Метки** введите ключ и значение [метки](../../../resource-manager/concepts/labels.md).
   1. Нажмите **Сохранить**.
...
- Консоль управления {#console}
   ...
   1. [Перейдите](https://console.yandex.cloud/link/iot-core) в сервис **IoT Core**.
   1. Справа от имени нужного реестра нажмите ![image](../../../_assets/console-icons/ellipsis.svg) → ![image](../../../_assets/console-icons/pencil.svg) **Редактировать**.
   1. В поле **Метки** измените ключ и значение [метки](../../../resource-manager/concepts/labels.md).
   1. Нажмите **Сохранить**.
