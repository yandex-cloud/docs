[Документация Yandex Cloud](../index.md) > [Yandex IoT Core](index.md) > Правила тарификации
...
| Yandex IoT Core. Сообщения, отправленные через реестр устройств, от 0 до 100000 единицы тарификации в месяц           | Не тарифицируется | Сообщение       | 30 апреля 2026 | —            |
| Yandex IoT Core. Сообщения, отправленные через реестр устройств, от 100000 до 1000000 единицы тарификации в месяц     | 0,00013 ₽         | Сообщение       | 30 апреля 2026 | —            |
| Yandex IoT Core. Сообщения, отправленные через реестр устройств, от 1000000 до 5000000000 единицы тарификации в месяц | 0,00012 ₽         | Сообщение       | 30 апреля 2026 | —            |
| Yandex IoT Core. Сообщения, отправленные через реестр устройств, от 5000000000 единицы тарификации в месяц            | 0,00011 ₽         | Сообщение       | 30 апреля 2026 | —            |