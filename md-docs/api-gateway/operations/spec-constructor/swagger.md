[Документация Yandex Cloud](../../../index.md) > [Yandex API Gateway](../../index.md) > [Пошаговые инструкции](../index.md) > [Конструктор спецификаций](index.md) > Swagger UI
...
- Консоль управления
    ...
    1. В поле **Спецификация** нажмите значок ![swagger](../../../_assets/api-gateway/spec-constructor/swagger.svg). В открывшемся окне:

        1. В поле **Путь** укажите относительный путь к интеграции, который будет добавлен к URL-адресу API Gateway. Переменные указывайте в фигурных скобках, например `/docs/{document_id}`. Подробнее в спецификации [OpenAPI 3.0](https://github.com/OAI/OpenAPI-Specification).
