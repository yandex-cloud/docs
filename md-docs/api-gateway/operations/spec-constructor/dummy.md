[Документация Yandex Cloud](../../../index.md) > [Yandex API Gateway](../../index.md) > [Пошаговые инструкции](../index.md) > [Конструктор спецификаций](index.md) > Статический ответ
...
- Консоль управления
    ...
    1. Укажите в поле:
        ...
        * (Опционально) **HTTP-заголовки** — список заголовков в формате `ключ` : `значение`, которые будут отправлены в ответ.
