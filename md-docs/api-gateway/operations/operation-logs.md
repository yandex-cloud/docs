[Документация Yandex Cloud](../../index.md) > [Yandex API Gateway](../index.md) > [Пошаговые инструкции](index.md) > Просмотр операций с ресурсами сервиса

# Просмотр операций с ресурсами сервиса API Gateway
...
- Консоль управления {#console}
  ...
  1. В [консоли управления](https://console.yandex.cloud) откройте каталог, в котором находится API-шлюз.
  1. Перейдите в сервис **API Gateway**.
  1. На панели слева выберите ![image](../../_assets/console-icons/branches-right.svg) **API-шлюзы**.
  1. Выберите нужный API-шлюз.
  1. Перейдите на вкладку **Операции** для выбранного API-шлюза.
