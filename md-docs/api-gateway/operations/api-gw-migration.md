...
Чтобы перенести [подсети](../../vpc/concepts/network.md#subnet) для [функций](../../functions/concepts/function.md) Cloud Functions, [контейнеров](../../serverless-containers/concepts/container.md) Serverless Containers или [API-шлюзов](../concepts/index.md) API Gateway в другую зону, выполните следующие действия:
