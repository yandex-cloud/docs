...
Чтобы перенести [подсети](../../vpc/concepts/network.md#subnet) для [функций](../../functions/concepts/function.md) {{ sf-name }}, [контейнеров](../../serverless-containers/concepts/container.md) {{ serverless-containers-name }} или [API-шлюзов](../concepts/index.md) {{ api-gw-name }} в другую зону, выполните следующие действия:
