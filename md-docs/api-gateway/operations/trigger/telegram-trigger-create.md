[Документация Yandex Cloud](../../../index.md) > [Yandex API Gateway](../../index.md) > [Пошаговые инструкции](../index.md) > Создание триггера > Создать триггер для Telegram

# Создать триггер для Telegram, который отправляет сообщения в WebSocket-соединения

Создайте [триггер для Telegram](../../concepts/trigger/telegram-trigger.md), который будет отправлять сообщения в [WebSocket-соединения](../../concepts/extensions/websocket.md) Yandex API Gateway, когда Telegram-бот получает новое обновление.
...
- Terraform {#tf}
    ...
    1. Опишите в конфигурационном файле параметры триггера:
       ...
       * `action` — параметры приемника. Блок можно указать несколько раз, чтобы триггер вызывал несколько ресурсов, в том числе разных типов. Максимальное количество ресурсов ограничено [лимитами](../../concepts/limits.md#api-gw-limits).
...
* [Триггер для Telegram, который вызывает функцию Cloud Functions](../../../functions/operations/trigger/telegram-trigger-create.md)
* [Триггер для Telegram, который вызывает контейнер Serverless Containers](../../../serverless-containers/operations/telegram-trigger-create.md)