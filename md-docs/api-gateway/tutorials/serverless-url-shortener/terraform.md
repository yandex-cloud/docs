[Документация Yandex Cloud](../../../index.md) > [Yandex API Gateway](../../index.md) > [Практические руководства](../index.md) > Бэкенд на Serverless > [Сокращатель ссылок](index.md) > Terraform
...
1. Подготовьте файлы с описанием инфраструктуры:
   ...
   * [API-шлюз](../../concepts/index.md) — [yandex_api_gateway](../../../terraform/resources/api_gateway.md).
