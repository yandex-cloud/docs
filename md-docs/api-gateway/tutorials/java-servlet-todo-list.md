[Документация Yandex Cloud](../../index.md) > [Yandex API Gateway](../index.md) > [Практические руководства](index.md) > Бэкенд на Serverless > Развертывание веб-приложения с использованием Java Servlet API
...
[*api_gw]: API-шлюз — это интерфейс взаимодействия с сервисами в интернете или внутри Yandex Cloud, который задается декларативно при помощи спецификации. Подробнее читайте в разделе [Взаимосвязь ресурсов в API Gateway](../concepts/index.md).
