[Документация Yandex Cloud](../../index.md) > [Yandex API Gateway](../index.md) > [Практические руководства](index.md) > Бэкенд на Serverless > Создание интерактивного serverless-приложения с использованием WebSocket
...
* [API-шлюз](../concepts/index.md) API Gateway для приема и перенаправления запросов от пользователей в функции Cloud Functions.
...
1. [Удалите](../operations/api-gw-delete.md) API-шлюз API Gateway.
