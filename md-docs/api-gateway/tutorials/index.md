...
* [Защита API Gateway при помощи интеграции с Smart Web Security](api-gw-sws-integration.md)
...
* [Создание агента на OpenAI Agents SDK со стримингом ответа через веб-сокеты на Yandex Cloud Functions и API Gateway](streaming-openai-agent.md)