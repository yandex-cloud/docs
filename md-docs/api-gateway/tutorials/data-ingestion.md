[Документация Yandex Cloud](../../index.md) > [Yandex API Gateway](../index.md) > [Практические руководства](index.md) > ETL на Serverless > Ввод данных в системы хранения
...
* API-шлюз: количество запросов к шлюзу ([тарифы Yandex API Gateway](../pricing.md)).
