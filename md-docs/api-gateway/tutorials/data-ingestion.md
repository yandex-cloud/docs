...
В этом сценарии [API-шлюз](../concepts/index.md) принимает входящие данные и отправляет их в [поток данных](../../data-streams/concepts/index.md). В потоке данные буферизируются и передаются с помощью [трансфера](../../data-transfer/concepts/index.md) в кластер баз данных [{{ CH }}](../../managed-clickhouse/concepts/index.md).
...
* API-шлюз: количество запросов к шлюзу (см. [тарифы {{ api-gw-full-name }}](../pricing.md)).
