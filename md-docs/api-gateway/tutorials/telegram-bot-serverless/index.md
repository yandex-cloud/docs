...
Для хранения статических ресурсов используется [Yandex Object Storage](../../../storage/index.md). [Yandex API Gateway](../../index.md) принимает запросы пользователей и перенаправляет их для обработки в [Yandex Cloud Functions](../../../functions/index.md).
