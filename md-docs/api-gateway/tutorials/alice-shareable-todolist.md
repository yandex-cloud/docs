...
Данные проекта хранятся в бакете [{{ objstorage-full-name }}](../../storage/index.md) и базе данных [{{ ydb-full-name }}](../../ydb/index.md). Функции [{{ sf-full-name }}](../../functions/index.md) обрабатывают запросы, а [{{ api-gw-full-name }}](../index.md) обеспечивает взаимодействие сервисов.
...
* плата за количество запросов к созданному API-шлюзу и исходящий трафик (см. [тарифы {{ api-gw-full-name }}](../pricing.md));
