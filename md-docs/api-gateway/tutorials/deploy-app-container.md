...
СУБД развернута на виртуальной машине [Yandex Compute Cloud](../../compute/index.md), контейнер с приложением хранится в реестре [Yandex Container Registry](../../container-registry/index.md), чувствительные данные зашифрованы с помощью [Yandex Lockbox](../../lockbox/index.md), а безопасный доступ к приложению реализован через API-шлюз [Yandex API Gateway](../index.md). Вся инфраструктура контейнерного приложения располагается в одном каталоге.
...
* плата за запросы к API-шлюзу (см. [тарифы Yandex API Gateway](../pricing.md));
...
Создайте [API-шлюз](../concepts/index.md) с расширением `x-yc-apigateway-integration:serverless_containers`.
...
1. [Удалите](../operations/api-gw-delete.md) API-шлюз `mongo-express-gw`.
