[Документация Yandex Cloud](../../../../index.md) > [Yandex API Gateway](../../../index.md) > Справочник API Triggers > [REST (англ.)](../index.md) > [Trigger](index.md) > Update
...
to add or remove a label, request the current set of labels with a [TriggerService.Get](../../../../functions/triggers/api-ref/Trigger/get.md#Get) request.
