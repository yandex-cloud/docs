[Документация Yandex Cloud](../../../../../index.md) > [Yandex API Gateway](../../../../index.md) > Справочник API Triggers > [gRPC (англ.)](../index.md) > [Trigger](index.md) > Update
...
To get a trigger ID make a [TriggerService.List](../../../../../functions/triggers/api-ref/grpc/Trigger/list.md#List) request. ||
...
to add or remove a label, request the current set of labels with a [TriggerService.Get](../../../../../functions/triggers/api-ref/grpc/Trigger/get.md#Get) request.
