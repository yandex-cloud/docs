[Документация Yandex Cloud](../../../../../index.md) > [Yandex API Gateway](../../../../index.md) > Справочник API Triggers > [gRPC (англ.)](../index.md) > [Trigger](index.md) > Get

# Cloud Functions Triggers Service, gRPC: TriggerService.Get

Returns the specified trigger.
To get the list of all available triggers, make a [List](../../../../../functions/triggers/api-ref/grpc/Trigger/list.md#List) request.
