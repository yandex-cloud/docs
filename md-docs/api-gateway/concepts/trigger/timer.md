...
О том, как создать таймер, читайте в инструкции [Создать таймер, который отправляет сообщения в WebSocket-соединения](../../operations/trigger/timer-create.md).
...
* [Таймер для запуска контейнера Serverless Containers](../../../serverless-containers/concepts/trigger/timer.md)
* [Таймер для запуска функции Cloud Functions](../../../functions/concepts/trigger/timer.md)