[Документация Yandex Cloud](../../../index.md) > [Yandex API Gateway](../../index.md) > [Концепции](../index.md) > [Расширения спецификации](index.md) > Интеграции > Swagger UI
...
[Авторизация](../index.md#authorization) и все политики доступа будут применены автоматически, так как `/docs` — это полноценный эндпоинт в рамках API Gateway.