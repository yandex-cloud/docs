...
* [Интеграция с {{ sf-name }}](extensions/cloud-functions.md)
* [Интеграция с {{ serverless-containers-name }}](extensions/containers.md)
* [Интеграция с {{ sws-name }}](extensions/sws.md)
* [Интеграция с {{ objstorage-name }}](extensions/object-storage.md)
* [Интеграция с {{ ml-platform-name }}](extensions/datasphere.md)
* [Интеграция с {{ yds-name }}](extensions/datastreams.md)
* [Интеграция с {{ message-queue-short-name }}](extensions/ymq.md)
* [Интеграция с {{ ydb-short-name }}](extensions/ydb.md)
* [Интеграция с Swagger UI](extensions/swagger.md)
* [{#T}](extensions/greedy-parameters.md)
* [Обобщенный HTTP-метод](extensions/any-method.md)
* [Авторизация с помощью функции {{ sf-name }}](extensions/function-authorizer.md)
* [Авторизация с помощью JWT](extensions/jwt-authorizer.md)
* [{#T}](extensions/websocket.md)
* [{#T}](extensions/validator.md)
* [Поддержка CORS](extensions/cors.md)
* [{#T}](extensions/parametrization.md)
* [{#T}](extensions/canary.md)
* [{#T}](extensions/rate-limit.md)
