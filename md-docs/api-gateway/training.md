[Документация Yandex Cloud](../index.md) > [Yandex API Gateway](index.md) > Обучающие курсы

# Обучающие курсы по Yandex API Gateway
...
Подробнее узнать об использовании сервиса Yandex API Gateway можно в следующих курсах:
