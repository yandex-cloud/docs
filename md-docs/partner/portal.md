[Документация Yandex Cloud](../index.md) > [Партнерская программа B2B Tech](index.md) > Партнерский портал > Обзор
...
* `Неактивен` — сабаккаунт удален. Чтобы удалить платежный аккаунт, напишите в [службу технической поддержки](https://center.yandex.cloud/support).
...
* Форма подачи заявки для регистрации сделки партнера на Яндекс Трекер.
* Partner Kit.
...
Раздел содержит детальную информацию о том, как клиенты используют сервисы. Подробнее в [Посмотреть детализацию сабаккаунтов](operations/get-client-stat.md).
