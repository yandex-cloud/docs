[Документация Yandex Cloud](../../index.md) > [Партнерская программа B2B Tech](../index.md) > Партнерские программы > Программа прямого партнерства > [Партнерские статусы Yandex Cloud](index.md) > Условия получения

# Условия получения партнерских статусов с технологической специализацией

Включение и квалификация партнеров в статусную систему проходят 2 раза в год:
