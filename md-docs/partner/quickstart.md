[Документация Yandex Cloud](../index.md) > [Партнерская программа B2B Tech](index.md) > Начало работы
...
1. На [странице партнерской программы](https://yandex.cloud/ru/partners/) нажмите кнопку [**Подать заявку**](https://partners.yandex.cloud/welcome).
...
В [заявке на партнерство](https://partners.yandex.cloud/onboarding-new) необходимо заполнить контактные данные и информацию о вашей компании для первичной проверки.
...
Если вы соответствуете [требованиям](https://yandex.ru/legal/cloud_partnership_requirements/) к партнеру, то после выполнения описанных выше шагов вы станете участником партнерской программы Yandex Cloud и сможете работать на [Партнёрском портале](https://partners.yandex.cloud/).

Подробнее о работе на портале в [Партнерский портал](portal.md).
