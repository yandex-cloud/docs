[Документация Yandex Cloud](../../index.md) > [Партнерская программа B2B Tech](../index.md) > Партнерские программы > Программа прямого партнерства > Инструменты
...
О том, как работать со сделкой в **Партнёрском портале**, читайте в [инструкции](../operations/deals/index.md#deal-create).
...
- Расчеты в рублях {#prices-rub}
  ...
  * Целевое потребление сделки — от 30 000 рублей в месяц.
  * Клиент не был привлечен в рамках [реферальной программы](referral.md).
...
О том, как работать с регламентированной сделкой в **Партнёрском портале**, читайте в [инструкции](../operations/deals/index.md#tender-create).


## Регистрация проекта {#project-reg}

Регистрация проекта — это закрепление за вами нового проекта в существующем клиенте Yandex Cloud, благодаря которому он увеличивает потребление сервисов. В этом случае вы работаете в аккаунте прямого клиента, у которого заключен договор напрямую с Yandex Cloud. За регистрацию проекта вы получите до 15% от роста потребления клиента в зарегистрированном каталоге или сервисе вне каталога в виде [рибейта](../terms.md#rebate), который начисляется ежеквартально в течение 12 месяцев от даты заявки.


### Условия регистрации проекта для региона Россия {#project-reg-conditions}
...
- Расчеты в рублях {#prices-rub}
  ...
  * Целевое потребление проекта — от 30 000 рублей в месяц.
  * Целевое потребление должно быть достигнуто в первом целевом периоде — последние 30 дней из 90 от даты подачи заявки. Если потребление не было достигнуто, заявка аннулируется и рибейт не выплачивается. Партнер имеет право заново зарегистрировать проект по стандартным правилам регистрации.
  * Партнер документально подтвердил наличие проекта путем предоставления копии договора с клиентом и/или иных документов не позднее 60 дней от даты подачи заявки.
  * Проект регистрируется в прямом клиенте Yandex Cloud (не является сабаккаунтом другого партнера).
  * Регистрируемые каталоги или сервисы вне каталога на момент регистрации не являются зарегистрированными в рамках проекта этого или другого партнера.
...
- Расчеты в тенге {#prices-kzt}
  ...
  * Целевое потребление проекта — от 150 000 тенге в месяц.
  * Целевое потребление должно быть достигнуто в первом целевом периоде — последние 30 дней из 90 от даты подачи заявки. Если потребление не было достигнуто, заявка аннулируется и рибейт не выплачивается. Партнер имеет право заново зарегистрировать проект по стандартным правилам регистрации.
  * Партнер документально подтвердил наличие проекта путем предоставления копии договора с клиентом и/или иных документов не позднее 60 дней от даты подачи заявки.
  * Проект регистрируется в прямом клиенте Yandex Cloud (не является сабаккаунтом другого партнера).
  * Регистрируемые каталоги или сервисы вне каталога на момент регистрации не являются зарегистрированными в рамках проекта этого или другого партнера.
...
О том, как работать с проектом в **Партнёрском портале**, читайте в [инструкции](../operations/deals/index.md#project-create).
...
Ко-маркетинг Yandex Cloud — это программа совместных маркетинговых активностей с партнерами, направленная на рост продаж облачных и on-premises решений Yandex Cloud, генерацию спроса и развитие совместных проектов.

### Для кого программа {#co-marketing-for-whom}

Программа доступна партнерам Yandex Cloud, которые:

* имеют статус **Yandex Cloud Expert** или **Yandex Cloud Professional**;
* согласовали с Yandex Cloud sales- и маркетинговую стратегию;
* готовы инвестировать ресурсы в совместное развитие и выполнять KPI;
* работают на увеличение потребления сервисов Yandex Cloud.

### Что включает программа {#co-marketing-inside}

Ко-маркетинг охватывает различные типы активностей (мероприятия, digital-кампании, образовательные инициативы и др.) и предполагает:

* совместное планирование и проведение активностей;
* маркетинговую и экспертную поддержку со стороны Yandex Cloud;
* софинансирование затрат из ко-маркетингового фонда;
* оценку эффективности по бизнес-метрикам (лиды, сделки, выручка, ROMI).

### Как работает ко-маркетинг {#co-marketing-how-it-works}

1. Партнер подает заявку на активность через партнерский портал.
1. Yandex Cloud согласовывает активность и бюджет.
1. Активность реализуется совместно.
1. Партнер предоставляет отчетность по результатам.
1. Yandex Cloud компенсирует согласованную часть затрат.

### Ко-маркетинговый бюджет {#co-marketing-budget}
...
* до 70% стоимости маркетинговых активностей;
* до 100% образовательных инициатив для сотрудников партнера.

### Принципы программы {#co-marketing-principles}

* фокус на измеримый бизнес-результат (pipeline, выручка, ROMI);
* приоритет активностям с вкладом в продажи;
* прозрачный процесс согласования и выплат;
...
[Партнёрский каталог](https://yandex.cloud/ru/partners/catalogue) — это витрина решений и услуг партнеров для решения клиентских задач на платформе Yandex Cloud. В каталог включены компании, которые Yandex Cloud рекомендует для реализации проектов разной сложности под ключ. Каждая из этих компаний имеет опыт реализации проектов на базе облачных технологий, а также штат сертифицированных специалистов.
...
* Есть минимум один технический специалист, прошедший курс [**Инженер облачных сервисов**](https://practicum.yandex.ru/ycloud/).
* Есть минимум два реализованных проекта и/или сабаккаунта в Yandex Cloud.
...
* **Ответы на специфические вопросы**: если вы столкнулись с вопросом, на который нет ответа в [документации](../../index.md) Yandex Cloud, наша команда готова помочь.
...
[Yandex Cloud Marketplace](https://yandex.cloud/ru/marketplace) — это онлайн-магазин, предлагающий широкий ассортимент готовых инструментов для разработки и анализа данных от партнеров Yandex Cloud. На Yandex Cloud Marketplace можно с легкостью приобрести нужные инструменты всего одним нажатием, значительно ускоряя процесс внедрения и интеграции новых технологий в свои проекты.

Преимущества работы с Marketplace:

* Подготовка и реализация собственных образов

  Marketplace дает возможность партнерам и разработчикам подготовить и реализовать собственные образы инструментов и решений. Это позволяет предлагать уникальные продукты большому числу клиентов Yandex Cloud.

* Поддержка ваших клиентов в Yandex Cloud
  
  Благодаря интеграции с Yandex Cloud, Marketplace обеспечивает эффективную поддержку ваших продуктов для всех клиентов платформы. Это включает в себя доступ к обширной базе данных и ресурсам Yandex Cloud, что облегчает поддержку и обновление ваших продуктов.
...
Marketplace поддерживает различные продукты, включая:

* Готовые образы для сервиса [Yandex Compute Cloud](../../compute/index.md) — образы для виртуальных машин, предоставляющие готовую среду для развертывания приложений и сервисов.
* Приложения для [Yandex Managed Service for Kubernetes](../../managed-kubernetes/index.md) — специализированные решения, оптимизированные для работы в управляемых кластерах Kubernetes.
* [Yandex Cloud Apps](../../cloud-apps/index.md) — многокомпонентные приложения, построенные на сервисах Yandex Cloud.
...
* Обучающие вебинары продуктов Cloud Marketplace.
  
  Серия вебинаров, предназначенных для глубокого понимания продуктов, представленных на [Cloud Marketplace](https://yandex.cloud/ru/marketplace). Поможет вам лучше консультировать клиентов и выбирать оптимальные решения.