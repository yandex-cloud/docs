[Документация Yandex Cloud](../../index.md) > [Партнерская программа B2B Tech](../index.md) > Партнерский портал > Пошаговые инструкции > Экспортировать расширенную детализацию
