[Документация Yandex Cloud](../../index.md) > [Партнерская программа B2B Tech](../index.md) > Партнерский портал > Пошаговые инструкции > Управление аккаунтами клиентов > Приостановить оказание услуг клиенту
...
- Партнёрский портал {#partner}
  ...
  1. На вкладке **Обзор** нажмите кнопку **Остановить оказание услуг**.
