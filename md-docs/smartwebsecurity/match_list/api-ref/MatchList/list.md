[Документация Yandex Cloud](../../../../index.md) > [Yandex Smart Web Security](../../../index.md) > Справочник API > REST (англ.) > [SmartWebSecurity MatchList API](../index.md) > [MatchList](index.md) > List
...
## Query parameters {#yandex.cloud.smartwebsecurity.v1.match_list.ListMatchListsRequest}
...
## Response {#yandex.cloud.smartwebsecurity.v1.match_list.ListMatchListsResponse}
