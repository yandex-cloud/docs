[Документация Yandex Cloud](../../../../index.md) > [Yandex Smart Web Security](../../../index.md) > [Справочник CLI (англ.)](../../index.md) > [v1](../index.md) > [security-profile](index.md) > update

# yc smartwebsecurity v1 security-profile update
...
`yc smartwebsecurity v1 security-profile update <SECURITY-PROFILE-ID>`
...
1. Generate template:
yc smartwebsecurity v1 security-profile update --example-json > request.json
or
yc smartwebsecurity v1 security-profile update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc smartwebsecurity v1 security-profile update -r request.json
or
yc smartwebsecurity v1 security-profile update -r request.yaml ||
|#
