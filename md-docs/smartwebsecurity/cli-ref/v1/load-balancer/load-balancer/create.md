[Документация Yandex Cloud](../../../../../index.md) > [Yandex Smart Web Security](../../../../index.md) > [Справочник CLI (англ.)](../../../index.md) > [v1](../../index.md) > [load-balancer](../index.md) > [load-balancer](index.md) > create

# yc smartwebsecurity v1 load-balancer load-balancer create
...
`yc smartwebsecurity v1 load-balancer load-balancer create <FOLDER-ID>`
...
1. Generate template:
yc smartwebsecurity v1 load-balancer load-balancer create --example-json > request.json
or
yc smartwebsecurity v1 load-balancer load-balancer create --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc smartwebsecurity v1 load-balancer load-balancer create -r request.json
or
yc smartwebsecurity v1 load-balancer load-balancer create -r request.yaml ||
|#
