[Документация Yandex Cloud](../../index.md) > [Yandex Smart Web Security](../index.md) > [Пошаговые инструкции](index.md) > Домены > Создать прокси-сервер
...
- Консоль управления {#console}
  ...
  1. Нажмите **Создать прокси-сервер**.
