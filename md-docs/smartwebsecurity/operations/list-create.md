...
- Консоль управления {#console}
  ...
  1. Выберите тип списка:
      ...
      * `Регулярные выражения` — [регулярные выражения](../concepts/conditions.md#regular-expressions), например для анализа заголовка `User-Agent` или для объединения нескольких URL через `|`. Примеры:
      ...
      * `Строковые значения` — текстовые строки, например идентификаторы или URL. Примеры:
