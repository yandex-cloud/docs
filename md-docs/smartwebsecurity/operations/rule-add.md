[Документация Yandex Cloud](../../index.md) > [Yandex Smart Web Security](../index.md) > [Пошаговые инструкции](index.md) > Профили безопасности > Добавить правило
...
- Консоль управления {#console}
  ...
  1. Нажмите ![plus-sign](../../_assets/console-icons/plus.svg) **Добавить правило** и в открывшемся окне:
      ...
      1. (Опционально) Включите **Только логирование (dry run)**, чтобы фиксировать информацию о трафике, который соответствует заданным условиям, но не применять к нему никаких действий.
      1. Выберите тип правила:
          ...
          * [**Smart Protection**](../concepts/rules.md#smart-protection-rules) — правило, которое отправляет трафик на автоматический анализ с помощью алгоритмов машинного обучения и поведенческого анализа. В режиме полной защиты подозрительные запросы отправляются на [дополнительную проверку](../concepts/rules.md#client-checks), которую автоматически выбирает Smart Protection.
          * [**Web Application Firewall**](../concepts/rules.md#waf-rules) — правило, которое подключает набор правил из профиля WAF.
      
              Для правила WAF выберите или [создайте профиль WAF](waf-profile-create.md).
      1. Выберите [режимы защиты](../concepts/profiles.md#protection-mode), в которых будет действовать правило:
      ...
      1. Выберите [действие](../concepts/rules.md#rule-action):
          ...
          * Для правила Smart Protection или WAF:
            ...
            * `Полная защита` — подозрительные запросы отправляются на [дополнительную проверку](../concepts/rules.md#client-checks), которую автоматически выбирает Smart Protection.
...
- Terraform {#tf}
  ...
  1. Откройте файл конфигурации Terraform и измените фрагмент с описанием профиля безопасности `yandex_sws_security_profile`: добавьте блок `security_rule` c правилом безопасности.
...
* [Правило для Yandex SmartCaptcha](captcha-rule.md)