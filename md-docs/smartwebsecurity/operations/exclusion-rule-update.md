...
- Консоль управления {#console}
  ...
  1. В строке с нужным правилом нажмите ![options](../../_assets/console-icons/ellipsis.svg) и выберите **Редактировать**.
  ...
  1. В блоке **Область применения** выберите, для какого трафика надо отключить проверку:
