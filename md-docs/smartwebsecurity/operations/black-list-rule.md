[Документация Yandex Cloud](../../index.md) > [Yandex Smart Web Security](../index.md) > [Пошаговые инструкции](index.md) > Обязательные и рекомендуемые правила > Правило для блокировки черных адресов
...
- Консоль управления {#console}
  ...
  1. На панели слева нажмите ![image](../../_assets/console-icons/shield-check.svg) **Профили безопасности** и выберите нужный профиль.
