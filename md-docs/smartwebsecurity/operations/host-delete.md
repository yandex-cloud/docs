[Документация Yandex Cloud](../../index.md) > [Yandex Smart Web Security](../index.md) > [Пошаговые инструкции](index.md) > Профили безопасности > Отключить профиль от ресурса
...
- Консоль управления {#console}
  ...
  1. Перейдите на вкладку **Подключенные ресурсы**.
...
- Консоль управления {#console}
  ...
  1. Выберите домен.
  1. На панели сверху нажмите ![image](../../_assets/console-icons/pencil.svg) **Редактировать**.
