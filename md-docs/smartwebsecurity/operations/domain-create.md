...
- Консоль управления {#console}
  ...
  1. При использовании HTTPS выберите выпущенный на указанный домен сертификат из [{{ certificate-manager-name }}](../../certificate-manager/index.md) или нажмите кнопку **{{ ui-key.yacloud.common.create }}** и выберите:
