...
Чтобы продолжить работать с WAF, добавьте новое поле в вызовы функций [API](../api-ref/authentication.md) или в манифест [Terraform](../tf-ref.md). В [консоли управления](https://console.yandex.cloud) действий не потребуется, все изменения будут выполнены автоматически.
...
- API REST {#api}
  ...
  Подробнее см. описание метода REST API [update](../waf/api-ref/WafProfile/update.md) для ресурса [WafProfile](../waf/api-ref/WafProfile/index.md).
