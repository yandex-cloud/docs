...
### Обязательные и рекомендуемые правила
 ...
 - [Настроить логи через Smart Web Security](operations/configure-logging.md)

 - [Настроить логи через Application Load Balancer](operations/configure-logging-alb.md)

 - [Миграция на WAF с поддержкой правил Яндекс](operations/waf-migration.md)
...
### Создание L7-балансировщика с профилем безопасности
 ...
 - [Создание L7-балансировщика с профилем безопасности через Ingress-контроллер Application Load Balancer](tutorials/alb-ingress-with-sws-profile.md)
...
### Создание L7-балансировщика с защитой от DDoS на уровне L3-L4 модели OSI
 ...
 - [Экстренная защита сервисов в Application Load Balancer от DDoS на уровне L7](tutorials/sws-protection-ongoing-ddos.md)
