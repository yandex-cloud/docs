...
Подробнее о подключении к профилю безопасности см. в разделе [Создайте и подключите профиль WAF](../quickstart.md#waf).
...
Полный список правил, который входит в каждый набор, доступен в интерфейсе Smart Web Security при [настройке набора правил](../operations/configure-set-rules.md).
...
Полный список и описание правил от Яндекса см. в [консоли управления](https://console.yandex.cloud/link/smartwebsecurity), в разделе [настройки набора правил](../operations/configure-set-rules.md).
...
Настройка WAF требует индивидуального подхода для каждого приложения, нет универсальных конфигураций WAF. На этапе внедрения будут ложные срабатывания — это часть обучения WAF под ваш трафик. Настраивайте правила в режиме **Только логирование** и анализируйте [логи](../operations/configure-logging.md). В среднем процесс настройки занимает неделю, но и после этого рекомендуется регулярно проверять логи и при необходимости корректировать правила.
