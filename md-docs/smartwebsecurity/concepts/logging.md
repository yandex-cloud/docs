...
Сейчас логи Smart Web Security записываются в Cloud Logging. Этот сервис будет закрыт во II квартале 2027 года, работа с логами перейдет в единую Observability-платформу [Monium](../../monium/index.md). Для новых профилей безопасности Cloud Logging станет недоступен, при этом появится возможность настроить запись логов в Monium.
