[Документация Yandex Cloud](../../../../../index.md) > [Yandex Smart Web Security](../../../../index.md) > Справочник API > gRPC (англ.) > [SmartWebSecurity CustomPage API](../index.md) > [Operation](index.md) > Get

# SmartWebSecurity CustomPage API, gRPC: OperationService.Get
