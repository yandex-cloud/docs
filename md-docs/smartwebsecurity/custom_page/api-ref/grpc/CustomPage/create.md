[Документация Yandex Cloud](../../../../../index.md) > [Yandex Smart Web Security](../../../../index.md) > Справочник API > gRPC (англ.) > [SmartWebSecurity CustomPage API](../index.md) > [CustomPage](index.md) > Create

# SmartWebSecurity CustomPage API, gRPC: CustomPageService.Create

Creates a CustomPage resource in the specified folder.

## gRPC request

**rpc Create ([CreateCustomPageRequest](#yandex.cloud.smartwebsecurity.v1.custom_page.CreateCustomPageRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## CreateCustomPageRequest {#yandex.cloud.smartwebsecurity.v1.custom_page.CreateCustomPageRequest}
