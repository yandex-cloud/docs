[Документация Yandex Cloud](../../../../../index.md) > [Yandex Smart Web Security](../../../../index.md) > Справочник API > gRPC (англ.) > [Smart Web Security Load Balancer API](../index.md) > [Domain](index.md) > Get

# Smart Web Security Load Balancer API, gRPC: DomainService.Get

Returns the specified domain.

## gRPC request

**rpc Get ([GetDomainRequest](#yandex.cloud.smartwebsecurity.v1.load_balancer.GetDomainRequest)) returns ([Domain](#yandex.cloud.smartwebsecurity.v1.load_balancer.Domain))**

## GetDomainRequest {#yandex.cloud.smartwebsecurity.v1.load_balancer.GetDomainRequest}
