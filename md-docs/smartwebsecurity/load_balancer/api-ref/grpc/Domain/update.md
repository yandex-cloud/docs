[Документация Yandex Cloud](../../../../../index.md) > [Yandex Smart Web Security](../../../../index.md) > Справочник API > gRPC (англ.) > [Smart Web Security Load Balancer API](../index.md) > [Domain](index.md) > Update
...
**rpc Update ([UpdateDomainRequest](#yandex.cloud.smartwebsecurity.v1.load_balancer.UpdateDomainRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## UpdateDomainRequest {#yandex.cloud.smartwebsecurity.v1.load_balancer.UpdateDomainRequest}
