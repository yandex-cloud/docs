[Документация Yandex Cloud](../../../../../index.md) > [Yandex Smart Web Security](../../../../index.md) > Справочник API > gRPC (англ.) > [Smart Web Security Load Balancer API](../index.md) > [LoadBalancer](index.md) > Create

# Smart Web Security Load Balancer API, gRPC: LoadBalancerService.Create

Creates a load balancer in the specified folder.

## gRPC request

**rpc Create ([CreateLoadBalancerRequest](#yandex.cloud.smartwebsecurity.v1.load_balancer.CreateLoadBalancerRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## CreateLoadBalancerRequest {#yandex.cloud.smartwebsecurity.v1.load_balancer.CreateLoadBalancerRequest}
...
Required field. ID of the folder to create the load balancer in. ||
