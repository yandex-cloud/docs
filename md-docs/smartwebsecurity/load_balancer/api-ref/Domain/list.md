[Документация Yandex Cloud](../../../../index.md) > [Yandex Smart Web Security](../../../index.md) > Справочник API > REST (англ.) > [Smart Web Security Load Balancer API](../index.md) > [Domain](index.md) > List

# Smart Web Security Load Balancer API, REST: Domain.List
...
```
GET https://smartwebsecurity.api.cloud.yandex.net/smartwebsecurity/v1/loadBalancers/{loadBalancerId}/domains
```
...
## Response {#yandex.cloud.smartwebsecurity.v1.load_balancer.ListDomainsResponse}
