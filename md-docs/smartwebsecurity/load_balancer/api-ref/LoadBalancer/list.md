[Документация Yandex Cloud](../../../../index.md) > [Yandex Smart Web Security](../../../index.md) > Справочник API > REST (англ.) > [Smart Web Security Load Balancer API](../index.md) > [LoadBalancer](index.md) > List

# Smart Web Security Load Balancer API, REST: LoadBalancer.List
...
```
GET https://smartwebsecurity.api.cloud.yandex.net/smartwebsecurity/v1/loadBalancers
```

## Query parameters {#yandex.cloud.smartwebsecurity.v1.load_balancer.ListLoadBalancersRequest}
...
## Response {#yandex.cloud.smartwebsecurity.v1.load_balancer.ListLoadBalancersResponse}
...
#|
||Field | Description ||
|| loadBalancers[] | **[LoadBalancer](#yandex.cloud.smartwebsecurity.v1.load_balancer.LoadBalancer)**
