[Документация Yandex Cloud](../../../../index.md) > [Yandex Smart Web Security](../../../index.md) > Справочник API > REST (англ.) > [Smart Web Security Load Balancer API](../index.md) > [LoadBalancer](index.md) > Create

# Smart Web Security Load Balancer API, REST: LoadBalancer.Create
...
```
POST https://smartwebsecurity.api.cloud.yandex.net/smartwebsecurity/v1/loadBalancers
```

## Body parameters {#yandex.cloud.smartwebsecurity.v1.load_balancer.CreateLoadBalancerRequest}
