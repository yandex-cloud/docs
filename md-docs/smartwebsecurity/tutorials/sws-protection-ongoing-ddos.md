...
Защита от DDoS-атаки состоит в подключении сервиса [{{ sws-name }}](../index.md) и настройке правил, блокирующих вредоносный трафик.
...
После остановки атаки можно настроить индивидуальную защиту вашего сервиса с помощью [{{ sws-name }}](../concepts/index.md). Если созданные ресурсы вам больше не нужны, [удалите их](#clear-out).

## Необходимые платные ресурсы {#paid-resources}

В стоимость инфраструктуры для защиты от DDoS входит плата за запросы, обработанные правилами [профиля безопасности](../concepts/profiles.md) (см. [тарифы {{ sws-full-name }}](../pricing.md)).
...
Чтобы ограничить нетипичную нагрузку на ваш сервис, настройте лимит запросов в профиле [ARL (Advanced Rate Limiter)](../concepts/arl.md).
...
[Списки](../concepts/lists.md) ненадежных адресов предустановлены в {{ sws-name }} и регулярно обновляются. Вы можете [составить свои списки](../operations/list-create.md) надежных или ненадежных адресов и добавлять их в условия фильтрации запросов.
...
1. [Отключите профиль безопасности](../operations/host-delete.md) от виртуального хоста.
1. [Удалите профиль безопасности](../operations/profile-delete.md).