...
В стоимость инфраструктуры для защиты от DDoS входит плата за запросы, обработанные правилами [профиля безопасности](../concepts/profiles.md) (см. [тарифы Yandex Smart Web Security](../pricing.md)).
