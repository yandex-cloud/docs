...
- Консоль управления {#console}
  ...
  1. Нажмите кнопку **Создать профиль** и выберите **По преднастроенному шаблону**.
      ...
      * [Правило Smart Protection](../concepts/rules.md#smart-protection-rules) с полной защитой для всего трафика. Это правило является приоритетным по отношению к базовому правилу по умолчанию.
