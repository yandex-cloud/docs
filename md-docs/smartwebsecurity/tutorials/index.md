...
* [Защита Yandex API Gateway при помощи Yandex Smart Web Security](api-gw-sws-integration.md)
...
* [Развертывание веб-приложения на серверах Yandex BareMetal с L7-балансировщиком и защитой Smart Web Security](webapp-on-bms-behind-sws.md)