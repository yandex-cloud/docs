[Документация Yandex Cloud](../../index.md) > [Yandex Smart Web Security](../index.md) > [Практические руководства](index.md) > Базовая настройка SWS
...
* [Плата за количество запросов](../pricing.md) в сервис Smart Web Security.
...
- Домен {#domain}
  ...
  * Действительный приватный ключ и TLS-сертификат для этого домена в [PEM](https://en.wikipedia.org/wiki/Privacy-Enhanced_Mail)-encoded формате. Поддерживаются сертификаты с ключами RSA-2048 и RSA-4096.
  ...
  - Консоль управления {#console}
    ...
    1. Если вы не используете Certificate Manager, нажмите **Создать** → **Пользовательский сертификат**.
  ...
  1. Добавьте ресурсную [А-запись](../../dns/concepts/resource-record.md#a) в публичную DNS-зону вашего домена, указав в ней значения:
     ...
     * **Имя** — адрес вашего домена, заканчивающийся на точку. Например: `example.com.` или `my.first.example.com.`.
...
- Консоль управления {#console}
  ...
  1. Включите тестовый режим для правила Smart Protection `sp-rule-1`:
     ...
     1. Нажмите **Сохранить изменения**.
      ...
      Трафик, обработанный правилами в режиме **Только логирование**, тарифицируется. Подробнее в разделе [Правила тарификации для Yandex Smart Web Security](../pricing.md).
...
- Консоль управления {#console}
  ...
  1. Настройте правило блокировки по спискам IP-адресов.
     1. На панели слева выберите ![shield-check](../../_assets/console-icons/shield-check.svg) **Профили безопасности** и выберите профиль `site-protection`.
     1. Нажмите ![image](../../_assets/console-icons/plus.svg) **Добавить правило**.
  ...
  1. Настройте разрешающее правило, которое будет пропускать все запросы с белых IP-адресов.
     1. В профиле `site-protection` нажмите ![image](../../_assets/console-icons/plus.svg) **Добавить правило**.
...
1. На панели слева нажмите ![image](../../_assets/console-icons/shield-check.svg) **Профили безопасности** и выберите `site-protection`.
1. Нажмите ![image](../../_assets/console-icons/plus.svg) **Добавить правило** и в открывшемся окне:
...
- L7-балансировщик {#balancer}
  ...
  1. Выберите раздел ![receipt](../../_assets/console-icons/receipt.svg) **Логи**:
     ...
     * В строке **Запрос** укажите запрос на [языке фильтрующих выражений](../../logging/concepts/filter.md) и нажмите **Выполнить запрос**.
...
- Консоль управления {#console}
  ...
  1. Включите режим **Только логирование (dry run)**.
...
- Консоль управления {#console}
  ...
  1. В списке **Профиль ARL** выберите `arl-site-protection`.
  1. Нажмите **Сохранить**.
...
- Консоль управления {#console}
  ...
  1. Выберите раздел ![receipt](../../_assets/console-icons/receipt.svg) **Логи**.
  1. В строке **Запрос** укажите запрос для поиска правил ARL и нажмите **Выполнить запрос**.
...
- Консоль управления {#console}
  ...
  1. В блоке **Правила WAF** укажите правила из активных наборов, для которых будет срабатывать исключение. Вы можете выбрать `Все правила` или указать конкретные правила из определенных наборов.
...
- Консоль управления {#console}
  ...
  1. Откройте L7-балансировщик, API-шлюз или прокси-сервер, к которому привязан профиль безопасности.
  1. Выберите раздел ![receipt](../../_assets/console-icons/receipt.svg) **Логи**.
  1. В строке **Запрос** укажите запрос для поиска правил WAF и нажмите **Выполнить запрос**.
