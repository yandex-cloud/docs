[Документация Yandex Cloud](../../../index.md) > [Yandex Smart Web Security](../../index.md) > [Практические руководства](../index.md) > [Создание L7-балансировщика с защитой от DDoS на уровне L3-L4 модели OSI](index.md) > Консоль управления, CLI
