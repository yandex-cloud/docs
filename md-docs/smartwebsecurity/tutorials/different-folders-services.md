...
Частный сценарий этого руководства с развертыванием инфраструктуры с нуля см. в разделе [Создание распределенной инфраструктуры с защищенным доступом](distributed-secured-infrastructure.md).
...
Другие способы создания профиля безопасности см. в разделе [Создать профиль безопасности](../operations/profile-create.md).
