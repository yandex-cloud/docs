...
* Плата за количество запросов в сервис {{ sws-name }} по тарифам из раздела [{#T}](../pricing.md).
* Плата за инфраструктуру защищаемого ресурса в зависимости от его расположения.

Руководство предполагает, что у вас уже есть настроенный веб-ресурс в инфраструктуре {{ yandex-cloud }}. Если веб-ресурс находится в другой инфраструктуре, подключите его к прокси-серверу по руководству [{#T}](sws-basic-protection.md).
...
Подробнее о порядке выполнения правил — [{#T}](../concepts/rules.md#rules-order).
...
Для анализа используйте логи и мониторинг сервиса. Подробнее в разделах [{#T}](../operations/configure-logging.md) и [{#T}](../operations/monitoring.md).
