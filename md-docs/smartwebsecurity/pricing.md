...
| Solidwall WAF Базовый, дополнительное приложение                                                                       | Не тарифицируется | Приложение                    | —                | —            |
| Solidwall WAF Базовый, легитимный трафик, 100 RPS (95-й процентиль)                                                    | Не тарифицируется | Количество запросов в секунду | —                | —            |
| Solidwall WAF Базовый, легитимный трафик, 1000 RPS (95-й процентиль)                                                   | Не тарифицируется | Количество запросов в секунду | —                | —            |
| Solidwall WAF Базовый, легитимный трафик, 300 RPS (95-й процентиль)                                                    | Не тарифицируется | Количество запросов в секунду | —                | —            |
| Solidwall WAF Базовый, легитимный трафик, 500 RPS (95-й процентиль)                                                    | Не тарифицируется | Количество запросов в секунду | —                | —            |
| Solidwall WAF Базовый, легитимный трафик, 700 RPS (95-й процентиль)                                                    | Не тарифицируется | Количество запросов в секунду | —                | —            |
| Solidwall WAF Максимальный, дополнительное приложение                                                                  | Не тарифицируется | Приложение                    | —                | —            |
| Solidwall WAF Максимальный, легитимный трафик, RPS (95-й процентиль)                                                   | Не тарифицируется | Количество запросов в секунду | —                | —            |
| Solidwall WAF Продвинутый, дополнительное приложение                                                                   | Не тарифицируется | Приложение                    | —                | —            |
| Solidwall WAF Продвинутый, легитимный трафик, &gt;10000 RPS (95-й процентиль)                                             | Не тарифицируется | Количество запросов в секунду | —                | —            |
| Solidwall WAF Продвинутый, легитимный трафик, 100 RPS (95-й процентиль)                                                | Не тарифицируется | Количество запросов в секунду | —                | —            |
| Solidwall WAF Продвинутый, легитимный трафик, 1000 RPS (95-й процентиль)                                               | Не тарифицируется | Количество запросов в секунду | —                | —            |
| Solidwall WAF Продвинутый, легитимный трафик, 10000 RPS (95-й процентиль)                                              | Не тарифицируется | Количество запросов в секунду | —                | —            |
| Solidwall WAF Продвинутый, легитимный трафик, 1500 RPS (95-й процентиль)                                               | Не тарифицируется | Количество запросов в секунду | —                | —            |
| Solidwall WAF Продвинутый, легитимный трафик, 2000 RPS (95-й процентиль)                                               | Не тарифицируется | Количество запросов в секунду | —                | —            |
| Solidwall WAF Продвинутый, легитимный трафик, 300 RPS (95-й процентиль)                                                | Не тарифицируется | Количество запросов в секунду | —                | —            |
| Solidwall WAF Продвинутый, легитимный трафик, 3000 RPS (95-й процентиль)                                               | Не тарифицируется | Количество запросов в секунду | —                | —            |
| Solidwall WAF Продвинутый, легитимный трафик, 500 RPS (95-й процентиль)                                                | Не тарифицируется | Количество запросов в секунду | —                | —            |
| Solidwall WAF Продвинутый, легитимный трафик, 5000 RPS (95-й процентиль)                                               | Не тарифицируется | Количество запросов в секунду | —                | —            |
| Solidwall WAF Продвинутый, легитимный трафик, 700 RPS (95-й процентиль)                                                | Не тарифицируется | Количество запросов в секунду | —                | —            |
| Solidwall WAF Продвинутый, легитимный трафик, 7000 RPS (95-й процентиль)                                               | Не тарифицируется | Количество запросов в секунду | —                | —            |
