...
В этом разделе описаны метрики {{ sws-name }}. Все метрики {{ sws-name }} поставляются в [{{ monitoring-name }}](../monitoring/index.md) сервисом [{{ alb-full-name }}](../application-load-balancer/index.md).
