[Документация Yandex Cloud](../../../index.md) > [Yandex Smart Web Security](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Operation](index.md) > Cancel

# SmartWebSecurity API, REST: Operation.Cancel
