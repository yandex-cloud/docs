[Документация Yandex Cloud](../index.md) > [Yandex Smart Web Security](index.md) > Начало работы
...
- Консоль управления {#console}
  ...
  1. В блоке **Правила WAF** укажите правила из базового набора, для которых будет срабатывать исключение. Вы можете выбрать `Все правила` или указать конкретные.
...
- Консоль управления {#console}
  ...
  1. На открывшейся обзорной странице профиля ARL нажмите ![plus](../_assets/console-icons/plus.svg) **Добавить правило**.
