...
## Практические руководства
 ...
 - [Запуск PySpark-задания](tutorials/yt-run-spark-job.md)

## Концепции

 - [Аутентификация](concepts/authentication.md)

 - [Квоты и лимиты](concepts/limits.md)

 - [Конфигурации компонентов кластера](concepts/component-types.md)
...
### cluster
 ...
 - [get-configuration](cli-ref/cluster/get-configuration.md)
...
#### cluster
 ...
 - [get-configuration](cli-ref/v0/cluster/get-configuration.md)
