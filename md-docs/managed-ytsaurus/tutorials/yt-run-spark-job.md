...
* Кластер {{ ytsaurus-name }}: использование вычислительных ресурсов компонентов кластера и объем хранилища (см. [тарифы {{ ytsaurus-name }}](../pricing.md)).
...
- Вручную {#manual}
    ...
    1. [Создайте кластер {{ ytsaurus-name }}](../operations/cluster-create.md) с настройками:
...
- Вручную {#manual}
    ...
    * [Кластер {{ ytsaurus-name }}](../operations/cluster-delete.md).
