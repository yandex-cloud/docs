...
Доступ к ресурсам Managed Service for YTsaurus контролируется сервисом Yandex Identity and Access Management, подробнее см. в разделе [Управление доступом](../security/index.md).
