...
- Расчет в рублях {#prices-rub}
  ...
  > 8 × {% calc [currency=RUB] 1.38 %} + 32 × {% calc [currency=RUB] 0.369 %} = {% calc [currency=RUB] 8 × 1.38 + 32 × 0.369 %}
  >
  > Итого: {% calc [currency=RUB] 8 × 1.38 + 32 × 0.369 %} — стоимость часа работы exec-ноды.
  
  Где:
  * 8 — количество vCPU одной exec-ноды.
  * {% calc [currency=RUB] 1.38 %} — стоимость часа использования 1 vCPU.
  * 32 — объем RAM одной exec-ноды (в гигабайтах).
  * {% calc [currency=RUB] 0.369 %} — стоимость часа использования 1 ГБ RAM.
  
  Расчет стоимости для tablet-ноды:
  
  > 3 × (8 × {% calc [currency=RUB] 1.38 %} + 16 × {% calc [currency=RUB] 0.369 %}) = {% calc [currency=RUB] 3 × (8 × 1.38 + 16 × 0.369) %}
  >
  > Итого: {% calc [currency=RUB] 3 × (8 × 1.38 + 16 × 0.369) %} — стоимость часа работы tablet-нод.
  ...
  * {% calc [currency=RUB] 0.369 %} — стоимость часа использования 1 ГБ RAM.
  ...
  > 3 × 2048 × {% calc [currency=RUB] 3.816 %} + 3 × 465 × {% calc [currency=RUB] 11.592 %} = {% calc [currency=RUB] 3 × 2048 × 3.816 + 3 × 465 × 11.592 %}
  >
  > Итого: {% calc [currency=RUB] 3 × 2048 × 3.816 + 3 × 465 × 11.592 %} — стоимость месяца использования хранилищ на нереплицируемых SSD-дисках и сетевых HDD-дисках.
  
  Где:
  * 3 — количество дисков с типом `HDD`.
  * 2048 — размер одного HDD-диска (в гигабайтах).
  * {% calc [currency=RUB] 3.816 %} — стоимость месяца использования 1 ГБ хранилища на сетевых HDD-дисках.
  * 3 — количество дисков с типом `Нереплицируемый SSD`.
  * 465 — размер одного нереплицируемого SSD-диска (в гигабайтах).
  * {% calc [currency=RUB] 11.592 %} — стоимость месяца использования 1 ГБ хранилища на нереплицируемых SSD-дисках.
  
  #### Служебные компоненты
  
  Расчет стоимости для master-ноды:
  
  > 3 × (4 × {% calc [currency=RUB] 1.38 %} + 12 × {% calc [currency=RUB] 0.369 %}) = {% calc [currency=RUB] 3 × (4 × 1.38 + 12 × 0.369) %}
  >
  > Итого: {% calc [currency=RUB] 3 × (4 × 1.38 + 12 × 0.369) %} — стоимость часа работы master-нод.
  ...
  * {% calc [currency=RUB] 0.369 %} — стоимость часа использования 1 ГБ RAM.
  ...
  > 2 × (24 × {% calc [currency=RUB] 1.38 %} + 64 × {% calc [currency=RUB] 0.369 %}) = {% calc [currency=RUB] 2 × (24 × 1.38 + 64 × 0.369) %}
  >
  > Итого: {% calc [currency=RUB] 2 × (24 × 1.38 + 64 × 0.369) %} — стоимость часа работы system-нод.
  ...
  * {% calc [currency=RUB] 0.369 %} — стоимость часа использования 1 ГБ RAM.
  ...
  > 2 × (4 × {% calc [currency=RUB] 1.38 %} + 8 × {% calc [currency=RUB] 0.369 %}) = {% calc [currency=RUB] 2 × (4 × 1.38 + 8 × 0.369) %}
  >
  > Итого: {% calc [currency=RUB] 2 × (4 × 1.38 + 8 × 0.369) %} — стоимость часа работы proxy-нод.
  ...
  * {% calc [currency=RUB] 0.369 %} — стоимость часа использования 1 ГБ RAM.
  ...
  > 2 × (8 × {% calc [currency=RUB] 1.38 %} + 16 × {% calc [currency=RUB] 0.369 %}) = {% calc [currency=RUB] 2 × (8 × 1.38 + 16 × 0.369) %}
  >
  > Итого: {% calc [currency=RUB] 2 × (8 × 1.38 + 16 × 0.369) %} — стоимость часа работы служебных tablet-нод.
  ...
  * {% calc [currency=RUB] 0.369 %} — стоимость часа использования 1 ГБ RAM.
  ...
  > 93 × 1 × {% calc [currency=RUB] 11.592 %} = {% calc [currency=RUB] 93 × 1 × 11.592 %}
  >
  > Итого: {% calc [currency=RUB] 93 × 1 × 11.592 %} — стоимость месяца использования хранилища на нереплицируемых SSD-дисках для exec-ноды.
  ...
  * {% calc [currency=RUB] 11.592 %} — стоимость месяца использования 1 ГБ хранилища на нереплицируемых SSD-дисках.
  ...
  > 3 × 93 × {% calc [currency=RUB] 11.592 %} = {% calc [currency=RUB] 3 × 93 × 11.592 %}
  >
  > Итого: {% calc [currency=RUB] 3 × 93 × 11.592 %} — стоимость месяца использования хранилища на нереплицируемых SSD-дисках для служебных storage-нод.
  ...
  * {% calc [currency=RUB] 11.592 %} — стоимость месяца использования 1 ГБ хранилища на нереплицируемых SSD-дисках.
  ...
  > 6 × (8 × {% calc [currency=RUB] 1.38 %} + 8 × {% calc [currency=RUB] 0.369 %}) + 3 × (4 × {% calc [currency=RUB] 1.38 %} + 8 × {% calc [currency=RUB] 0.369 %}) = {% calc [currency=RUB] 6 × (8 × 1.38 + 8 × 0.369) + 3 × (4 × 1.38 + 8 × 0.369) %}
  >
  > Итого: {% calc [currency=RUB] 6 × (8 × 1.38 + 8 × 0.369) + 3 × (4 × 1.38 + 8 × 0.369) %} — стоимость часа работы storage-нод.
  ...
  * {% calc [currency=RUB] 0.369 %} — стоимость часа использования 1 ГБ RAM.
  ...
  > 93 × 6 × {% calc [currency=RUB] 11.592 %} = {% calc [currency=RUB] 93 × 6 × 11.592 %}
  >
  > Итого: {% calc [currency=RUB] 93 × 6 × 11.592 %} — стоимость месяца использования хранилища на нереплицируемых SSD-дисках.
  ...
  * {% calc [currency=RUB] 11.592 %} — стоимость месяца использования 1 ГБ хранилища на нереплицируемых SSD-дисках.
  ...
  > 720 × ({% calc [currency=RUB] 8 × 1.38 + 32 × 0.369 %} + {% calc [currency=RUB] 3 × (8 × 1.38 + 16 × 0.369) %} + {% calc [currency=RUB] 3 × (4 × 1.38 + 12 × 0.369) %} + {% calc [currency=RUB] 2 × (24 × 1.38 + 64 × 0.369) %} + {% calc [currency=RUB] 2 × (4 × 1.38 + 8 × 0.369) %} + {% calc [currency=RUB] 2 × (8 × 1.38 + 16 × 0.369) %} + {% calc [currency=RUB] 6 × (8 × 1.38 + 8 × 0.369) + 3 × (4 × 1.38 + 8 × 0.369) %}) + {% calc [currency=RUB] 3 × 2048 × 3.816 + 3 × 465 × 11.592 %} + {% calc [currency=RUB] 93 × 1 × 11.592 %} + {% calc [currency=RUB] 3 × 93 × 11.592 %} + {% calc [currency=RUB] 93 × 6 × 11.592 %}  = {% calc [currency=RUB] 720 × (8 × 1.38 + 32 × 0.369 + 3 × (8 × 1.38 + 16 × 0.369) + 3 × (4 × 1.38 + 12 × 0.369) + 2 × (24 × 1.38 + 64 × 0.369) + 2 × (4 × 1.38 + 8 ×0.369) + 2 × (8 × 1.38 + 16 × 0.369) + 6 × (8 × 1.38 + 8 × 0.369) + 3 × (4 × 1.38 + 8 × 0.369)) + 3 × 2048 × 3.816 + 3 × 465 × 11.592 + 93 × 1 × 11.592 + 3 × 93 × 11.592 + 93 × 6 × 11.592 %}
  >
  > Итого: {% calc [currency=RUB] 720 × (8 × 1.38 + 32 × 0.369 + 3 × (8 × 1.38 + 16 × 0.369) + 3 × (4 × 1.38 + 12 × 0.369) + 2 × (24 × 1.38 + 64 × 0.369) + 2 × (4 × 1.38 + 8 × 0.369) + 2 × (8 × 1.38 + 16 × 0.369) + 6 × (8 × 1.38 + 8 ×0.369) + 3 × (4 × 1.38 + 8 × 0.369)) + 3 × 2048 × 3.816 + 3 × 465 × 11.592 + 93 × 1 × 11.592 + 3 × 93 × 11.592 + 93 × 6 × 11.592 %} — стоимость использования кластера в течение 30 дней.
  
  Где:
  * 720 — количество часов в 30 днях.
  * {% calc [currency=RUB] 8 × 1.38 + 32 × 0.369 %} — стоимость часа работы exec-ноды.
  * {% calc [currency=RUB] 3 × (8 × 1.38 + 16 × 0.369) %} — стоимость часа работы tablet-нод.
  * {% calc [currency=RUB] 3 × (4 × 1.38 + 12 × 0.369) %} — стоимость часа работы master-нод.
  * {% calc [currency=RUB] 2 × (24 × 1.38 + 64 × 0.369) %} — стоимость часа работы system-нод.
  * {% calc [currency=RUB] 2 × (4 × 1.38 + 8 × 0.369) %} — стоимость часа работы proxy-нод.
  * {% calc [currency=RUB] 2 × (8 × 1.38 + 16 × 0.369) %} — стоимость часа работы служебных tablet-нод.
  * {% calc [currency=RUB] 6 × (8 × 1.38 + 8 × 0.369) + 3 × (4 × 1.38 + 8 × 0.369) %} — стоимость часа работы storage-нод.
  * {% calc [currency=RUB] 3 × 2048 × 3.816 + 3 × 465 × 11.592 %} — стоимость месяца использования хранилищ на нереплицируемых SSD-дисках и сетевых HDD-дисках.
  * {% calc [currency=RUB] 93 × 1 × 11.592 %} — стоимость месяца использования хранилища на нереплицируемых SSD-дисках для exec-ноды.
  * {% calc [currency=RUB] 3 × 93 × 11.592 %} — стоимость месяца использования хранилища на нереплицируемых SSD-дисках для служебных storage-нод.
  * {% calc [currency=RUB] 93 × 6 × 11.592 %} — стоимость месяца использования хранилища на нереплицируемых SSD-дисках.
...
- Расчет в тенге {#prices-kzt}
  ...
  > 8 × {% calc [currency=KZT] 6.9 %} + 32 × {% calc [currency=KZT] 1.845 %} = {% calc [currency=KZT] 8 × 6.9 + 32 × 1.845 %}
  >
  > Итого: {% calc [currency=KZT] 8 × 6.9 + 32 × 1.845 %} — стоимость часа работы exec-ноды.
  
  Где:
  * 8 — количество vCPU одной exec-ноды.
  * {% calc [currency=KZT] 6.9 %} — стоимость часа использования 1 vCPU.
  * 32 — объем RAM одной exec-ноды (в гигабайтах).
  * {% calc [currency=KZT] 1.845 %} — стоимость часа использования 1 ГБ RAM.
  
  Расчет стоимости для tablet-ноды:
  
  > 3 × (8 × {% calc [currency=KZT] 6.9 %} + 16 × {% calc [currency=KZT] 1.845 %}) = {% calc [currency=KZT] 3 × (8 × 6.9 + 16 × 1.845) %}
  >
  > Итого: {% calc [currency=KZT] 3 × (8 × 6.9 + 16 × 1.845) %} — стоимость часа работы tablet-нод.
  ...
  * {% calc [currency=KZT] 1.845 %} — стоимость часа использования 1 ГБ RAM.
  ...
  > 3 × 2048 × {% calc [currency=KZT] 19.08 %} + 3 × 465 × {% calc [currency=KZT] 57.96 %} = {% calc [currency=KZT] 3 × 2048 × 19.08 + 3 × 465 × 57.96 %}
  >
  > Итого: {% calc [currency=KZT] 3 × 2048 × 19.08 + 3 × 465 × 57.96 %} — стоимость месяца использования хранилищ на нереплицируемых SSD-дисках и сетевых HDD-дисках.
  
  Где:
  * 3 — количество дисков с типом `HDD`.
  * 2048 — размер одного HDD-диска (в гигабайтах).
  * {% calc [currency=KZT] 19.08 %} — стоимость месяца использования 1 ГБ хранилища на сетевых HDD-дисках.
  * 3 — количество дисков с типом `Нереплицируемый SSD`.
  * 465 — размер одного нереплицируемого SSD-диска (в гигабайтах).
  * {% calc [currency=KZT] 57.96 %} — стоимость месяца использования 1 ГБ хранилища на нереплицируемых SSD-дисках.
  
  #### Служебные компоненты
  
  Расчет стоимости для master-ноды:
  
  > 3 × (4 × {% calc [currency=KZT] 6.9 %} + 12 × {% calc [currency=KZT] 1.845 %}) = {% calc [currency=KZT] 3 × (4 × 6.9 + 12 × 1.845) %}
  >
  > Итого: {% calc [currency=KZT] 3 × (4 × 6.9 + 12 × 1.845) %} — стоимость часа работы master-нод.
  ...
  * {% calc [currency=KZT] 1.845 %} — стоимость часа использования 1 ГБ RAM.
  ...
  > 2 × (24 × {% calc [currency=KZT] 6.9 %} + 64 × {% calc [currency=KZT] 1.845 %}) = {% calc [currency=KZT] 2 × (24 × 6.9 + 64 × 1.845) %}
  >
  > Итого: {% calc [currency=KZT] 2 × (24 × 6.9 + 64 × 1.845) %} — стоимость часа работы system-нод.
  ...
  * {% calc [currency=KZT] 1.845 %} — стоимость часа использования 1 ГБ RAM.
  ...
  > 2 × (4 × {% calc [currency=KZT] 6.9 %} + 8 × {% calc [currency=KZT] 1.845 %}) = {% calc [currency=KZT] 2 × (4 × 6.9 + 8 × 1.845) %}
  >
  > Итого: {% calc [currency=KZT] 2 × (4 × 6.9 + 8 × 1.845) %} — стоимость часа работы proxy-нод.
  ...
  * {% calc [currency=KZT] 1.845 %} — стоимость часа использования 1 ГБ RAM.
  ...
  > 2 × (8 × {% calc [currency=KZT] 6.9 %} + 16 × {% calc [currency=KZT] 1.845 %}) = {% calc [currency=KZT] 2 × (8 × 6.9 + 16 × 1.845) %}
  >
  > Итого: {% calc [currency=KZT] 2 × (8 × 6.9 + 16 × 1.845) %} — стоимость часа работы служебных tablet-нод.
  ...
  * {% calc [currency=KZT] 1.845 %} — стоимость часа использования 1 ГБ RAM.
  ...
  > 93 × 1 × {% calc [currency=KZT] 57.96 %} = {% calc [currency=KZT] 93 × 1 × 57.96 %}
  >
  > Итого: {% calc [currency=KZT] 93 × 1 × 57.96 %} — стоимость месяца использования хранилища на нереплицируемых SSD-дисках для exec-ноды.
  ...
  * {% calc [currency=KZT] 57.96 %} — стоимость месяца использования 1 ГБ хранилища на нереплицируемых SSD-дисках.
  ...
  > 3 × 93 × {% calc [currency=KZT] 57.96 %} = {% calc [currency=KZT] 3 × 93 × 57.96 %}
  >
  > Итого: {% calc [currency=KZT] 3 × 93 × 57.96 %} — стоимость месяца использования хранилища на нереплицируемых SSD-дисках для служебных storage-нод.
  ...
  * {% calc [currency=KZT] 57.96 %} — стоимость месяца использования 1 ГБ хранилища на нереплицируемых SSD-дисках.
  ...
  > 6 × (8 × {% calc [currency=KZT] 6.9 %} + 8 × {% calc [currency=KZT] 1.845 %}) + 3 × (4 × {% calc [currency=KZT] 6.9 %} + 8 × {% calc [currency=KZT] 1.845 %}) = {% calc [currency=KZT] 6 × (8 × 6.9 + 8 × 1.845) + 3 × (4 × 6.9 + 8 × 1.845) %}
  >
  > Итого: {% calc [currency=KZT] 6 × (8 × 6.9 + 8 × 1.845) + 3 × (4 × 6.9 + 8 × 1.845) %} — стоимость часа работы storage-нод.
  ...
  * {% calc [currency=KZT] 1.845 %} — стоимость часа использования 1 ГБ RAM.
  ...
  > 93 × 6 × {% calc [currency=KZT] 57.96 %} = {% calc [currency=KZT] 93 × 6 × 57.96 %}
  >
  > Итого: {% calc [currency=KZT] 93 × 6 × 57.96 %} — стоимость месяца использования хранилища на нереплицируемых SSD-дисках.
  ...
  * {% calc [currency=KZT] 57.96 %} — стоимость месяца использования 1 ГБ хранилища на нереплицируемых SSD-дисках.
  ...
  > 720 × ({% calc [currency=KZT] 8 × 6.9 + 32 × 1.845 %} + {% calc [currency=KZT] 3 × (8 × 6.9 + 16 × 1.845) %} + {% calc [currency=KZT] 3 × (4 × 6.9 + 12 × 1.845) %} + {% calc [currency=KZT] 2 × (24 × 6.9 + 64 × 1.845) %} + {% calc [currency=KZT] 2 × (4 × 6.9 + 8 × 1.845) %} + {% calc [currency=KZT] 2 × (8 × 6.9 + 16 × 1.845) %} + {% calc [currency=KZT] 6 × (8 × 6.9 + 8 × 1.845) + 3 × (4 × 6.9 + 8 × 1.845) %}) + {% calc [currency=KZT] 3 × 2048 × 19.08 + 3 × 465 × 57.96 %} + {% calc [currency=KZT] 93 × 1 × 57.96 %} + {% calc [currency=KZT] 3 × 93 × 57.96 %} + {% calc [currency=KZT] 93 × 6 × 57.96 %}  = {% calc [currency=KZT] 720 × (8 × 6.9 + 32 × 1.845 + 3 × (8 × 6.9 + 16 × 1.845) + 3 × (4 × 6.9 + 12 × 1.845) + 2 × (24 × 6.9 + 64 × 1.845) + 2 × (4 × 6.9 + 8 ×1.845) + 2 × (8 × 6.9 + 16 × 1.845) + 6 × (8 × 6.9 + 8 × 1.845) + 3 × (4 × 6.9 + 8 × 1.845)) + 3 × 2048 × 19.08 + 3 × 465 × 57.96 + 93 × 1 × 57.96 + 3 × 93 × 57.96 + 93 × 6 × 57.96 %}
  >
  > Итого: {% calc [currency=KZT] 720 × (8 × 6.9 + 32 × 1.845 + 3 × (8 × 6.9 + 16 × 1.845) + 3 × (4 × 6.9 + 12 × 1.845) + 2 × (24 × 6.9 + 64 × 1.845) + 2 × (4 × 6.9 + 8 × 1.845) + 2 × (8 × 6.9 + 16 × 1.845) + 6 × (8 × 6.9 + 8 ×1.845) + 3 × (4 × 6.9 + 8 × 1.845)) + 3 × 2048 × 19.08 + 3 × 465 × 57.96 + 93 × 1 × 57.96 + 3 × 93 × 57.96 + 93 × 6 × 57.96 %} — стоимость использования кластера в течение 30 дней.
  
  Где:
  * 720 — количество часов в 30 днях.
  * {% calc [currency=KZT] 8 × 6.9 + 32 × 1.845 %} — стоимость часа работы exec-ноды.
  * {% calc [currency=KZT] 3 × (8 × 6.9 + 16 × 1.845) %} — стоимость часа работы tablet-нод.
  * {% calc [currency=KZT] 3 × (4 × 6.9 + 12 × 1.845) %} — стоимость часа работы master-нод.
  * {% calc [currency=KZT] 2 × (24 × 6.9 + 64 × 1.845) %} — стоимость часа работы system-нод.
  * {% calc [currency=KZT] 2 × (4 × 6.9 + 8 × 1.845) %} — стоимость часа работы proxy-нод.
  * {% calc [currency=KZT] 2 × (8 × 6.9 + 16 × 1.845) %} — стоимость часа работы служебных tablet-нод.
  * {% calc [currency=KZT] 6 × (8 × 6.9 + 8 × 1.845) + 3 × (4 × 6.9 + 8 × 1.845) %} — стоимость часа работы storage-нод.
  * {% calc [currency=KZT] 3 × 2048 × 19.08 + 3 × 465 × 57.96 %} — стоимость месяца использования хранилищ на нереплицируемых SSD-дисках и сетевых HDD-дисках.
  * {% calc [currency=KZT] 93 × 1 × 57.96 %} — стоимость месяца использования хранилища на нереплицируемых SSD-дисках для exec-ноды.
  * {% calc [currency=KZT] 3 × 93 × 57.96 %} — стоимость месяца использования хранилища на нереплицируемых SSD-дисках для служебных storage-нод.
  * {% calc [currency=KZT] 93 × 6 × 57.96 %} — стоимость месяца использования хранилища на нереплицируемых SSD-дисках.
