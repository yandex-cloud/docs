[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for YTsaurus](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Operation](index.md) > Cancel

# Ytsaurus API, REST: Operation.Cancel
