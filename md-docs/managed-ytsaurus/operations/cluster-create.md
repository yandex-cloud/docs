...
Создание кластера YTsaurus занимает от одного часа в зависимости от выбранной конфигурации.
...
- Консоль управления {#console}
    ...
    1. В блоке **Сетевые настройки** выберите:
        ...
        * (Опционально) В поле **Ограничения входящего трафика** укажите разрешенные диапазоны IPv4-адресов в формате CIDR для доступа к кластеру из интернета, например `203.0.113.0/24`.
            ...
            Список можно [изменить](cluster-update.md) после создания кластера.
...
- REST API {#api}
    ...
    1. Воспользуйтесь методом [create](../api-ref/Cluster/create.md) и выполните запрос, например с помощью [cURL](https://curl.se/):
