...
Сервис {{ myt-full-name }} перешел на стадию [General Availability](../overview/concepts/launch-stages.md).

## Октябрь 2025 {#october-2025}

* Добавлена возможность совершать операции над кластером {{ ytsaurus-name }} с помощью [CLI {{ yandex-cloud }}](../cli/cli-ref/managed-ytsaurus/cli-ref/index.md).
