...
1. Нажмите кнопку **Новый SQL-запрос** и введите текст запроса. При составлении запроса вы можете пользоваться шаблонами:
...
Для вставки данных в YDB используются инструкции [REPLACE](https://ydb.tech/docs/ru//yql/reference/syntax/replace_into), [UPSERT](https://ydb.tech/docs/ru//yql/reference/syntax/upsert_into) и [INSERT](https://ydb.tech/docs/ru//yql/reference/syntax/insert_into).
