...
* [Вторичные индексы](https://ydb.tech/docs/ru/concepts/query_execution/secondary_indexes).
...
* [Кластер YDB](https://ydb.tech/docs/ru/concepts/glossary#cluster).
