...
| ------------------------------------------------------------------------------------ | -------- | --------------- | -------------- | ------------ |
| YDB. Временное хранилище (спиллинг)                                                  | 0,0181 ₽ | ГБ × час        | 30 апреля 2026 | —            |
| YDB. Вычислительные ресурсы хостов, Intel Cascade Lake, 100% vCPU                    | 2,15 ₽   | vCPU × час      | 30 апреля 2026 | —            |
| YDB. Вычислительные ресурсы хостов, Intel Cascade Lake, 100% vCPU, CVoS на 1 год     | 1,68 ₽   | vCPU × час      | 30 апреля 2026 | —            |
| YDB. Вычислительные ресурсы хостов, Intel Cascade Lake, 100% vCPU, CVoS на 6 месяцев | 1,83 ₽   | vCPU × час      | 30 апреля 2026 | —            |
| YDB. Вычислительные ресурсы хостов, Intel Cascade Lake, RAM                          | 0,5879 ₽ | ГБ × час        | 30 апреля 2026 | —            |
| YDB. Вычислительные ресурсы хостов, Intel Cascade Lake, RAM, CVoS на 1 год           | 0,4586 ₽ | ГБ × час        | 30 апреля 2026 | —            |
| YDB. Вычислительные ресурсы хостов, Intel Cascade Lake, RAM, CVoS на 6 месяцев       | 0,4997 ₽ | ГБ × час        | 30 апреля 2026 | —            |
| YDB. Хранение данных на группах хранения из SSD-накопителей                          | 0,0358 ₽ | ГБ × час        | 30 апреля 2026 | —            |
