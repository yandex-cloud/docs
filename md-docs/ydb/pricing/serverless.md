[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for YDB](../index.md) > [Правила тарификации](index.md) > Режим Serverless > Правила тарификации для режима Serverless
...
- Расчет в рублях {#prices-rub}
  ...
  * 1 024 × 10 — объем скопированных данных в МБ.
  ...
  > (1 310 720 RU - 1 000 000 RU) / 1 000 000 × 24,64 ₽ = 7,6561408 ₽
  >
  > Итого: 7,6561408 ₽ — стоимость создания резервной копии 10 ГБ данных.
...
- Расчет в тенге {#prices-kzt}
  ...
  * 1 024 × 10 — объем скопированных данных в МБ.
  ...
  > (1 310 720 RU - 1 000 000 RU) / 1 000 000 × 123,2 ₸ = 38,280704 ₸
  >
  > Итого: 38,280704 ₸ — стоимость создания резервной копии 10 ГБ данных.
...
- Расчет в рублях {#prices-rub}
  ...
  * 1 024 × 1 024 × 10 — объем восстанавливаемых данных в КБ.
  ...
  > (5 242 880 RU - 1 000 000 RU) / 1 000 000 × 24,64 ₽ = 104,5445632 ₽
  >
  > Итого: 104,5445632 ₽ — стоимость восстановления из резервной копии 10 ГБ данных.
...
- Расчет в тенге {#prices-kzt}
  ...
  * 1 024 × 1 024 × 10 — объем восстанавливаемых данных в КБ.
  ...
  > (5 242 880 RU - 1 000 000 RU) / 1 000 000 × 123,2 ₸ = 522,722816 ₸
  >
  > Итого: 522,722816 ₸ — стоимость восстановления из резервной копии 10 ГБ данных.
...
| -------------------------------------------------------------------------------------------- | ----------------- | --------------- | -------------- | ------------ |
| YDB Serverless. Выделенная пропускная способность                                            | 0,0184 ₽          | RU/с × час      | 30 апреля 2026 | —            |
| YDB Serverless. Фактическое потребление Request Units, от 0 до 1 единицы тарификации в месяц | Не тарифицируется | 1 млн RU        | 30 апреля 2026 | —            |
| YDB Serverless. Фактическое потребление Request Units, от 1 единицы тарификации в месяц      | 24,64 ₽           | 1 млн RU        | 30 апреля 2026 | —            |
| YDB Serverless. Хранение данных, от 0 до 720 единицы тарификации в месяц                     | Не тарифицируется | ГБ × час        | 30 апреля 2026 | —            |
| YDB Serverless. Хранение данных, от 720 единицы тарификации в месяц                          | 0,0342 ₽          | ГБ × час        | 30 апреля 2026 | —            |
| YDB. Хранение резервных копий по требованию в Yandex Object Storage                          | 0,0032 ₽          | ГБ × час        | 30 апреля 2026 | —            |
