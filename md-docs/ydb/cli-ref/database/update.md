 ...
 * [Изменить параметры Serverless базы данных](../../operations/manage-databases.md#cli_2)
 * [Миграция базы данных YDB в другую зону доступности](../../operations/migration-to-an-availability-zone.md#cli_1)