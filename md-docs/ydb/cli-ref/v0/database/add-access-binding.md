[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for YDB](../../../index.md) > [Справочник CLI (англ.)](../../index.md) > [v0](../index.md) > [database](index.md) > add-access-binding

# yc ydb v0 database add-access-binding
...
`yc ydb v0 database add-access-binding <DATABASE-NAME>|<DATABASE-ID> [Flags...] [Global Flags...]`
