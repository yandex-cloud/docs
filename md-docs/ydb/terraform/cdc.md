...
Имя читателя используется в [SDK](https://ydb.tech/docs/ru/reference/ydb-sdk/topic) или [CLI](https://ydb.tech/docs/ru/reference/ydb-cli/topic-read) для чтения данных из топика.