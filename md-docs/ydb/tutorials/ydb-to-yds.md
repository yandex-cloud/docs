[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for YDB](../index.md) > [Практические руководства](index.md) > Поставка данных из YDB в Yandex Data Streams с помощью Yandex Data Transfer
...
* Базы данных Managed Service for YDB ([тарифы Managed Service for YDB](../pricing/index.md)). Стоимость зависит от режима использования:
...
- Вручную {#manual}
    ...
    1. [Создайте базу данных источника Managed Service for YDB](../operations/manage-databases.md) любой подходящей конфигурации.

    1. Если для источника вы выбрали режим БД Dedicated, [создайте](../../vpc/operations/security-group-create.md) и [настройте](../operations/connection.md#configuring-security-groups) группу безопасности в сети, где находится БД.

    1. [Создайте базу данных Managed Service for YDB](../operations/manage-databases.md) любой подходящей конфигурации для потока данных приемника Data Streams.
...
1. Подготовьтесь к выполнению SQL-запросов в базе данных источника Managed Service for YDB:
    ...
    - YDB CLI {#cli}
        ...
        1. [Настройте подключение к базе данных Managed Service for YDB](../operations/connection.md).
...
1. [Создайте таблицу](../operations/schema.md#create-table) для тестовых данных:
...
1. [Вставьте тестовые данные](../operations/crud.md) в таблицу `test` в базе данных источника Managed Service for YDB:
...
1. Остальные ресурсы удалите в зависимости от способа их создания:
   ...
   - Вручную {#manual}
       ...
       1. [Удалите базу данных источника Managed Service for YDB](../operations/manage-databases.md#delete-db).
       1. [Удалите базу данных Managed Service for YDB](../operations/manage-databases.md#delete-db) для потока данных приемника.
