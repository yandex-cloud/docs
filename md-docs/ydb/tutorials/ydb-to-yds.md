...
* Базы данных {{ ydb-name }} (см. [тарифы {{ ydb-name }}](../pricing/index.md)). Стоимость зависит от режима использования:
...
- Вручную {#manual}
    ...
    1. [Создайте базу данных источника {{ ydb-name }}](../operations/manage-databases.md) любой подходящей конфигурации.

    1. Если для источника вы выбрали режим БД {{ dd }}, [создайте](../../vpc/operations/security-group-create.md) и [настройте](../operations/connection.md#configuring-security-groups) группу безопасности в сети, где находится БД.

    1. [Создайте базу данных {{ ydb-name }}](../operations/manage-databases.md) любой подходящей конфигурации для потока данных приемника {{ yds-name }}.
...
1. Подготовьтесь к выполнению SQL-запросов в базе данных источника {{ ydb-name }}:
    ...
    - {{ ydb-short-name }} CLI {#cli}
        ...
        1. [Настройте подключение к базе данных {{ ydb-name }}](../operations/connection.md).
...
1. [Вставьте тестовые данные](../operations/crud.md) в таблицу `test` в базе данных источника {{ ydb-name }}:
...
1. Остальные ресурсы удалите в зависимости от способа их создания:
   ...
   - Вручную {#manual}
       ...
       1. [Удалите базу данных источника {{ ydb-name }}](../operations/manage-databases.md#delete-db).
       1. [Удалите базу данных {{ ydb-name }}](../operations/manage-databases.md#delete-db) для потока данных приемника.
