[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for YDB](../../index.md) > [Практические руководства](../index.md) > [Загрузка аудитных логов в MaxPatrol SIEM](index.md) > Консоль управления
