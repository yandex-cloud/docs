...
* использование {{ ydb-full-name }} в бессерверном режиме (см. [тарифы {{ ydb-name }}](../../pricing/serverless.md)).
...
1. Подготовьте файлы с описанием инфраструктуры:
    ...
    * [Бессерверная база данных YDB](../../concepts/serverless-and-dedicated.md#serverless) — [yandex_ydb_database_serverless]({{ tf-provider-resources-link }}/ydb_database_serverless).
