[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for YDB](../../index.md) > [Практические руководства](../index.md) > [Загрузка аудитных логов в MaxPatrol SIEM](index.md) > Terraform
...
1. Подготовьте файлы с описанием инфраструктуры:
    ...
    Подробнее о параметрах используемых в Terraform ресурсов смотрите в документации провайдера:
    ...
    * [Бессерверная база данных YDB](../../concepts/serverless-and-dedicated.md#serverless) — [yandex_ydb_database_serverless](../../../terraform/resources/ydb_database_serverless.md).
