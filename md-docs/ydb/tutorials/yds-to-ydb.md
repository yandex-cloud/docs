[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for YDB](../index.md) > [Практические руководства](index.md) > Поставка данных из очереди Data Streams в Managed Service for YDB с помощью Data Transfer
...
- Вручную {#manual}
    ...
    1. [Создайте базу данных Managed Service for YDB](../operations/manage-databases.md) любой подходящей конфигурации для потока Data Streams.

    1. [Создайте базу данных приемника Managed Service for YDB](../operations/manage-databases.md) любой подходящей конфигурации.
...
1. Остальные ресурсы удалите в зависимости от способа их создания:
   ...
   - Вручную {#manual}
       ...
       [Удалите базы данных Managed Service for YDB](../operations/manage-databases.md#delete-db).
