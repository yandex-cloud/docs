...
Начиная с {{ TF }} версии `1.11`, блокировка состояния через [Document API](../docapi/api-ref/index.md) объявлена устаревшей и будет удалена в одной из ближайших минорных  версий. Если вы используете {{ TF }} версии `1.11` и выше, следите за официальными обновлениями в [документации {{ TF }}](https://developer.hashicorp.com/terraform/language/backend/s3).
