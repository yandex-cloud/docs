...
* плата за операции с [базой данных YDB](../../concepts/resources.md#database) и хранение данных (см. [тарифы {{ ydb-name }}](../../pricing/serverless.md));
...
1. Подготовьте файлы с описанием инфраструктуры:
   ...
   * [База данных {{ ydb-name }}](../../concepts/resources.md#database) — [yandex_ydb_database_serverless]({{ tf-provider-resources-link }}/ydb_database_serverless).
   * [Таблица {{ ydb-name }}](../../concepts/dynamodb-tables.md) — [yandex_ydb_table]({{ tf-provider-resources-link }}/ydb_table).
