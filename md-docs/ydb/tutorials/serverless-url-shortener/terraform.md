[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for YDB](../../index.md) > [Практические руководства](../index.md) > [Сокращатель ссылок](index.md) > Terraform
...
1. Подготовьте файлы с описанием инфраструктуры:
   ...
   * [База данных Managed Service for YDB](../../concepts/resources.md#database) — [yandex_ydb_database_serverless](../../../terraform/resources/ydb_database_serverless.md).
   * [Таблица Managed Service for YDB](../../concepts/dynamodb-tables.md) — [yandex_ydb_table](../../../terraform/resources/ydb_table.md).
