[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for YDB](../../index.md) > [Практические руководства](../index.md) > [Сокращатель ссылок](index.md) > Консоль управления
...
1. [Удалите](../../operations/manage-databases.md#delete-db) базу данных YDB `for-serverless-shortener`.
