[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for YDB](../index.md) > [Практические руководства](index.md) > Разработка навыка Алисы и сайта с авторизацией
...
Данные проекта хранятся в бакете [Yandex Object Storage](../../storage/index.md) и базе данных [Yandex Managed Service for YDB](../index.md). Функции [Yandex Cloud Functions](../../functions/index.md) обрабатывают запросы, а [Yandex API Gateway](../../api-gateway/index.md) обеспечивает взаимодействие сервисов.
...
Создайте базу данных YDB в [режиме Serverless](../concepts/serverless-and-dedicated.md#serverless):
...
* [Удалите](../operations/manage-databases.md#delete-db) базу данных.
