...
Вы можете отслеживать изменения данных в _источнике_ Yandex Managed Service for YDB и отправлять их в _кластер-приемник_ Yandex Managed Service for Apache Kafka® с помощью технологии [Change Data Capture](../../data-transfer/concepts/cdc.md) (CDC). Эти данные будут автоматически добавлены в топики Managed Service for Apache Kafka® с именами таблиц Managed Service for YDB.
...
1. Подготовьте инфраструктуру поставки данных:
   ...
   - Вручную {#manual}
       ...
       1. [Создайте базу данных Managed Service for YDB](../operations/manage-databases.md) любой подходящей конфигурации.

       1. Если вы выбрали режим БД Dedicated, [создайте](../../vpc/operations/security-group-create.md) и [настройте](../operations/connection.md#configuring-security-groups) группу безопасности в сети, где находится БД.
...
1. [Подключитесь к базе данных Managed Service for YDB](../operations/connection.md).
1. [Создайте YDB-таблицу](../operations/schema.md#create-table). В качестве примера используется таблица `sensors` с информацией, поступающей от условных датчиков автомобиля.
    ...
    1. [Создайте эндпоинт для источника](../../data-transfer/operations/endpoint/index.md#create):
        ...
        * **Параметры эндпоинта**:
            ...
            * **Настройки подключения**:
                ...
                * **Идентификатор сервисного аккаунта** — выберите [созданный ранее](#before-you-begin) сервисный аккаунт с ролью `editor`.


            * **Список включенных путей** — укажите путь к таблице `sensors` в базе данных Managed Service for YDB.
...
1. [Подключитесь к базе данных Managed Service for YDB](../operations/connection.md) и [добавьте тестовые данные](../operations/crud.md) в таблицу `sensors`:
