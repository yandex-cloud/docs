...
* [базы данных](../concepts/index.md) Managed Service for YDB для хранения данных игры;
...
* [очередь](../../message-queue/concepts/queue.md) Message Queue для передачи сообщений между компонентами приложения;
...
* плата за операции с данными и за объем хранимых данных (см. [тарифы Yandex Managed Service for YDB](../pricing/serverless.md));
...
* плата за запросы к очередям и исходящий трафик (см. [тарифы Yandex Message Queue](../../message-queue/pricing.md));
...
1. [Удалите](../operations/manage-databases.md#delete-db) базы данных Managed Service for YDB.
