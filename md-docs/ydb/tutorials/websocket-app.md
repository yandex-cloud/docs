...
* [базы данных](../concepts/index.md) {{ ydb-name }} для хранения данных игры;
...
* плата за операции с данными и за объем хранимых данных (см. [тарифы {{ ydb-full-name }}](../pricing/serverless.md));
...
1. [Удалите](../operations/manage-databases.md#delete-db) базы данных {{ ydb-name }}.
