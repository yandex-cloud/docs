[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for YDB](../index.md) > [Практические руководства](index.md) > Загрузка данных из YDB в Yandex Object Storage с помощью Yandex Data Transfer
...
1. [Создайте](../operations/crud.md#web-sql) в базе данных Managed Service for YDB таблицу `seasons`:
