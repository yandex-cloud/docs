[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for YDB](../index.md) > [Практические руководства](index.md) > Разработка CRUD API для сервиса фильмов
...
Реализация CRUD API использует [контейнер](../../serverless-containers/concepts/container.md) Yandex Serverless Containers, который предназначен для работы с базой данных фильмов, развернутой в Yandex Managed Service for YDB.
...
Взаимодействие с базой данных через [Document API](../docapi/api-ref/index.md) реализовано с помощью библиотеки [AWS SDK for JavaScript v3](https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/index.html):
...
* [Документная таблица](../operations/schema.md).
* [Расширение x-yc-apigateway-integration](../../api-gateway/concepts/extensions/containers.md).
* [Логи контейнера](../../serverless-containers/concepts/logs.md).
* [Посмотреть графики мониторинга контейнера](../../serverless-containers/operations/monitoring.md).