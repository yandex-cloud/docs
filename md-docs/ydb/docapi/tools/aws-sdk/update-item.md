[Документация Yandex Cloud](../../../../index.md) > [Yandex Managed Service for YDB](../../../index.md) > Document API, совместимый с Amazon DynamoDB > Инструменты > [Работа с AWS SDK](index.md) > Управление записями в таблице > Обновление записи
...
- Java {#java}
  ...
  1. В каталоге `src/main/java/com/mycompany/app/` создайте файл `SeriesItemOps03.java`, например с помощью редактора nano:
