...
Пока таблица находится в состоянии `DELETING`, Managed Service for YDB может продолжать принимать запросы на чтение и запись данных, вроде [GetItem](getItem.md) и [PutItem](putItem.md).
