...
Пока таблица находится в состоянии `DELETING`, {{ ydb-name }} может продолжать принимать запросы на чтение и запись данных, вроде [GetItem](getItem.md) и [PutItem](putItem.md).
