[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for YDB](../index.md) > [Справочник API Yandex Cloud для Managed Service for YDB](overview.md) > Аутентификация в API
