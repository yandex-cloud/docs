...
### Работа с ресурсами
 ...
 - [Работа с шаблонами {{ dataproc-name }}](operations/data-processing-template.md)
...
### Подключение к источникам данных
 ...
 - [Подключение к базе данных {{ CH }}](operations/data/connect-to-clickhouse.md)

 - [Подключение к базе данных {{ PG }}](operations/data/connect-to-postgresql.md)
...
### {{ ds-jobs }}
 ...
 - [Аутентификация в {{ ds-jobs }}](operations/projects/authentication.md)

 - [Запустить задание {{ ml-platform-name }} Jobs](operations/projects/work-with-jobs.md)
...
### Совместный доступ
 ...
 - [Открыть ноутбук в {{ ml-platform-name }}](operations/projects/open-in-datasphere.md)
...
#### Вычисления на кластерах Apache Spark™
 ...
 - [Особенности работы с временными кластерами {{ dataproc-name }}](concepts/temporary-data-processing-clusters.md)
...
### {{ ds-jobs }}
 ...
 - [Интеграция с {{ maf-name }}](concepts/jobs/airflow.md)
...
### Ресурсы
 ...
 - [Шаблоны {{ dataproc-name }}](concepts/data-processing-template.md)
...
## Как организовать работу в {{ ml-platform-name }}
 ...
 - [Интегрировать сервис {{ dataproc-full-name }}](tutorials/data-processing-integration.md)
...
### Разработка
 ...
 - [Обучение модели на данных из {{ objstorage-full-name }}](tutorials/s3-to-datasphere.md)
...
### Аналитика данных
 ...
 - [Использование сервиса {{ msp-full-name }}](tutorials/spark-and-datasphere.md)
