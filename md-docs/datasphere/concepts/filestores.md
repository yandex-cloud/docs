[Документация Yandex Cloud](../../index.md) > [Yandex DataSphere](../index.md) > [Концепции](index.md) > Ресурсы > Файловые хранилища

# Файловые хранилища

_Файловое хранилище_ — это механизм хранения информации, который предоставляет быстрый доступ к большим объемам данных. Файловые хранилища позволяют хранить до 8 ТБ данных и получать к ним доступ из ноутбуков DataSphere. Вы можете загрузить в файловое хранилище наборы данных, результаты дообучения, [модели](models/index.md), логи и любые другие файлы.
