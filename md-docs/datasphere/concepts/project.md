[Документация Yandex Cloud](../../index.md) > [Yandex DataSphere](../index.md) > [Концепции](index.md) > Проект
...
DataSphere предоставляет 10 ГБ бесплатного хранилища каждому проекту. При желании вы можете увеличить размер хранилища. Дополнительное пространство будет оплачиваться отдельно. Стоимость расширения основного хранилища приведена в разделе [Правила тарификации для DataSphere](../pricing.md).
