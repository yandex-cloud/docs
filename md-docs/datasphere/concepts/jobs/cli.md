...
Чтобы установить DataSphere CLI, в [виртуальном окружении Python](https://docs.python.org/3.10/library/venv.html) выполните команду:
...
## Команды DataSphere CLI {#commands}
...
* [просмотр](#version) версии DataSphere CLI;
* [просмотр](#changelog) журнала изменений DataSphere CLI.
...
* `<идентификатор_проекта>` — идентификатор проекта DataSphere, в котором вы будете запускать задание.
* `<файл_конфигурации>` — путь к [файлу конфигурации задания](index.md#config).

Чтобы запускать задания с помощью сервисного аккаунта, [аутентифицируйтесь](../../../cli/operations/authentication/service-account.md) от его имени в Yandex Cloud CLI и [добавьте](../../operations/projects/update.md) его в список участников проекта DataSphere с [ролью](../../security/index.md) `datasphere.community-projects.developer`. Если вы запускаете задание с ВМ [Yandex Compute Cloud](../../../compute/index.md), [привяжите](../../../compute/operations/vm-connect/auth-inside-vm.md#link-sa-with-instance) к ней этот сервисный аккаунт.
...
### Просмотр версии DataSphere CLI {#version}
...
### Посмотреть журнал изменений DataSphere CLI {#changelog}
...
* `log.txt` — общий лог утилиты DataSphere CLI, в который записывается ход выполнения задания.
