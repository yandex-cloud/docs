[Документация Yandex Cloud](../../index.md) > [Yandex DataSphere](../index.md) > [Концепции](index.md) > Конфигурации вычислительных ресурсов
...
Поскольку проекты запускаются на разных платформах Yandex Cloud с разными вычислительными мощностями, DataSphere не гарантирует доступность 100% объема оперативной памяти. Если вам нужна конфигурация с фиксированным объемом RAM, выбирайте платформу, для которой указано точное значение.
