[Документация Yandex Cloud](../../../index.md) > [Yandex DataSphere](../../index.md) > [Концепции](../index.md) > [DataSphere Inference](index.md) > Проверки состояния и мониторинг
...
Ноды поставляют метрики мониторинга в каталог сервиса [Yandex Monitoring](../../../monitoring/index.md), который указан в настройках ноды. По умолчанию платформа собирает следующие метрики:
...
* Формат — текстовый формат [Prometheus](https://prometheus.io/docs/instrumenting/exposition_formats/#text-based-format) или формат сервиса Monitoring.
