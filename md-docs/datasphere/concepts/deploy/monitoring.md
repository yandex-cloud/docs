...
Ноды поставляют метрики мониторинга в каталог сервиса [{{ monitoring-full-name }}](../../../monitoring/index.md), который указан в настройках ноды. По умолчанию платформа собирает следующие метрики:
