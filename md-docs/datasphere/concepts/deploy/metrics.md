...
В этом разделе описаны метрики, поставляемые в [{{ monitoring-name }}](../../../monitoring/index.md). Помимо описанных метрик ноды могут поставлять в {{ monitoring-name }} метрики, указанные пользователем на  этапе создания ноды.
