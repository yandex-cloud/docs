[Документация Yandex Cloud](../../index.md) > [Yandex DataSphere](../index.md) > [Концепции](index.md) > Ресурсы > Docker-образы
...
Подробнее о работе с Docker-образами смотрите на странице [Работа с Docker-образами](../operations/user-images.md).
