[Документация Yandex Cloud](../../../../index.md) > [Yandex DataSphere](../../../index.md) > [Справочник API](../../overview.md) > [gRPC (англ.)](../index.md) > [Project](index.md) > ListAccessBindings

# DataSphere API v2, gRPC: ProjectService.ListAccessBindings
