[Документация Yandex Cloud](../../../../index.md) > [Yandex DataSphere](../../../index.md) > [Справочник API](../../overview.md) > [gRPC (англ.)](../index.md) > [Operation](index.md) > Get

# DataSphere API v2, gRPC: OperationService.Get
