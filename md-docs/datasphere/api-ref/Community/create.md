[Документация Yandex Cloud](../../../index.md) > [Yandex DataSphere](../../index.md) > [Справочник API](../overview.md) > [REST (англ.)](../index.md) > [Community](index.md) > Create
...
```
POST https://datasphere.api.cloud.yandex.net/datasphere/v2/communities
```
