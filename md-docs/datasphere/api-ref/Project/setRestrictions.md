[Документация Yandex Cloud](../../../index.md) > [Yandex DataSphere](../../index.md) > [Справочник API](../overview.md) > [REST (англ.)](../index.md) > [Project](index.md) > SetRestrictions
...
```
POST https://datasphere.api.cloud.yandex.net/datasphere/v2/projects/{projectId}:setRestrictions
```
