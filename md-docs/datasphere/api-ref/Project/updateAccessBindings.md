[Документация Yandex Cloud](../../../index.md) > [Yandex DataSphere](../../index.md) > [Справочник API](../overview.md) > [REST (англ.)](../index.md) > [Project](index.md) > UpdateAccessBindings
...
```
PATCH https://datasphere.api.cloud.yandex.net/datasphere/v2/projects/{resourceId}:updateAccessBindings
```
