...
1. Используйте переменную `SA_TOKEN_FILENAME`, чтобы работать с другими сервисами. Например, так можно получить содержимое секрета [{{ lockbox-full-name }}](../../../lockbox/index.md) с помощью API:
