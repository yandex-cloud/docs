[Документация Yandex Cloud](../../../index.md) > [Yandex DataSphere](../../index.md) > [Пошаговые инструкции](../index.md) > Подключение к источникам данных > Подключение к Яндекс Диску

# Подключение к Яндекс Диску

Вы можете подключиться к сервису хранения файлов [Яндекс Диск](https://disk.yandex.ru) из интерфейса DataSphere. Чтобы загрузить файл или каталог в DataSphere, откройте к нему доступ по ссылке.
...
## Загрузить содержимое из файла на Яндекс Диске в файл проекта DataSphere {#get-file}
...
## Загрузить содержимое из каталога на Яндекс Диске в каталог проекта DataSphere {#get-dir}
