[Документация Yandex Cloud](../../index.md) > [Yandex DataSphere](../index.md) > [Практические руководства](index.md) > Аналитика данных > Работа с данными в Managed Service for PostgreSQL
