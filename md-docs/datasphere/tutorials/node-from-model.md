[Документация Yandex Cloud](../../index.md) > [Yandex DataSphere](../index.md) > [Практические руководства](index.md) > Эксплуатация > Развертывание сервиса на основе модели ONNX

# Развертывание сервиса из модели ONNX

DataSphere позволяет разворачивать и эксплуатировать сервисы на основе обученной в проекте [модели](../concepts/models/index.md).
...
1. [Создайте секреты](../operations/data/secrets.md#create) для проверки работы ноды:
