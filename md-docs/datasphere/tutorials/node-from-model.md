...
{{ ml-platform-name }} позволяет разворачивать и эксплуатировать сервисы на основе обученной в проекте [модели](../concepts/models/index.md).
...
* плата за постоянно запущенные инстансы ноды (см. [тарифы {{ ml-platform-name }}](../pricing.md));
