...
* плата за вычислительные ресурсы кластера и объем хранилища (см. [тарифы Managed Service for ClickHouse®](../../managed-clickhouse/pricing.md));
* плата за время вычислений (см. [тарифы DataSphere](../pricing.md));
