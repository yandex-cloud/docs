...
После этого файл появится в папке `test` бакета. Чтобы просматривать содержимое бакета в интерфейсе JupyterLab, создайте и активируйте в проекте [коннектор S3](../operations/data/s3-connectors.md).
...
Подробнее о запуске вычислений на кластерах Yandex Data Processing в DataSphere смотрите в [концепции](../concepts/data-processing.md#existing-clusters).
...
* [кластер Yandex Data Processing](../../data-proc/operations/cluster-delete.md);
