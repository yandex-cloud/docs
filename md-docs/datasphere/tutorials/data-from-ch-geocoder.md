...
В стоимость инфраструктуры для геокодинга и визуализации данных входит плата за сервис DataSphere: использование вычислительных ресурсов ([тарифы DataSphere](../pricing.md)).
