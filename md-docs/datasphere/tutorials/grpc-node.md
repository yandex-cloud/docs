...
1. [Создайте секрет](../operations/data/secrets.md) `key-for-sa`, хранящий полное содержимое файла с авторизованным ключом для сервисного аккаунта `sa-for-datasphere`.
...
1. [Удалите](../operations/deploy/node-delete.md) ноду.
1. [Удалите](../operations/data/secrets.md#delete) секрет.
