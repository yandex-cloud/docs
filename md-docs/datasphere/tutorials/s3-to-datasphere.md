...
Вы создадите [бакет](../../storage/concepts/bucket.md) в [Object Storage](../../storage/index.md), смонтируете его к файловой системе Windows с помощью [rclone](https://rclone.org) и загрузите туда данные для обучения [модели](../concepts/models/index.md) в [Yandex DataSphere](https://datasphere.yandex.cloud).
...
1. Создайте классификатор `CatBoost` и задайте гиперпараметры:
...
* [Удалите](../operations/projects/delete.md) проект.