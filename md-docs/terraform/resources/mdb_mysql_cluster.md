...
- `performance_diagnostics` [Block]. Cluster performance diagnostics settings. [YC Documentation](../../managed-mysql/api-ref/grpc/cluster_service#PerformanceDiagnostics).
...
- `resources` [Block]. Resources allocated to hosts of the MySQL cluster.
  ...
  - `resource_preset_id` (**Required**)(String). The ID of the preset for computational resources available to a MySQL host (CPU, memory etc.). For more information, see [the official documentation](../../managed-mysql/concepts/instance-types.md).
