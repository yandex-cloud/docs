[Документация Yandex Cloud](../../index.md) > [Terraform в Yandex Cloud](../index.md) > Справочник Terraform > Ресурсы (англ.) > Cloud Desktop > Resources > cloud_desktops_desktop_group
...
- `group_config` [Block]. The group configuration.
  ...
  - `members` [Block]. List of members in this desktop group.
    - `id` (**Required**)(String). The id of the member. More info in [the official documentation](../../cloud-desktop/api-ref/grpc/DesktopGroup/create.md#yandex.cloud.access.Subject).
    - `type` (**Required**)(String). The type of the member. More info in [the official documentation](../../cloud-desktop/api-ref/grpc/DesktopGroup/create.md#yandex.cloud.access.Subject).
