[Документация Yandex Cloud](../../index.md) > [Terraform в Yandex Cloud](../index.md) > Справочник Terraform > Ресурсы (англ.) > Managed Service for Greenplum® > Resources > mdb_greenplum_cluster

# yandex_mdb_greenplum_cluster (Resource)

Manages a Greenplum cluster within the Yandex Cloud. For more information, see [the official documentation](../../managed-greenplum/index.md).

Please read [Pricing for Managed Service for Greenplum](../../managed-greenplum/index.md) before using Greenplum cluster.
...
- `master_subcluster` [Block]. Settings for master subcluster.
  - `resources` [Block]. Resources allocated to hosts for master subcluster of the Greenplum cluster.
    ...
    - `resource_preset_id` (**Required**)(String). The ID of the preset for computational resources available to a host (CPU, memory etc.). For more information, see [the official documentation](../../managed-greenplum/concepts/instance-types.md).
