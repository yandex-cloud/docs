[Документация Yandex Cloud](../../index.md) > [Terraform в Yandex Cloud](../index.md) > Справочник Terraform > Ресурсы (англ.) > Object Storage > Resources > storage_object

# yandex_storage_object (Resource)

Allows management of [Yandex Cloud Storage Object](../../storage/concepts/object.md).
...
- `acl` (String). The [predefined ACL](../../storage/concepts/acl.md#predefined_acls) to apply. Defaults to `private`.
...
- `object_lock_legal_hold_status` (String). Specifies a [legal hold status](../../storage/concepts/object-lock.md#types) of an object. Requires `object_lock_configuration` to be enabled on a bucket.
...
- `tags` (Map Of String). The `tags` object for setting tags (or labels) for bucket. See [Tags](../../storage/concepts/tags.md) for more information.