# yandex_organizationmanager_mfa_enforcement_excluded_audience (Resource)
...
//
// Create a new OrganizationManager MFA Enforcement excluded Audience.
//
resource "yandex_organizationmanager_mfa_enforcement_excluded_audience" "example_mfa_enforcement_excluded_audience" {
