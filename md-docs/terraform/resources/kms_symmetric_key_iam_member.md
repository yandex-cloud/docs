[Документация Yandex Cloud](../../index.md) > [Terraform в Yandex Cloud](../index.md) > Справочник Terraform > Ресурсы (англ.) > Key Management Service > Resources > kms_symmetric_key_iam_member
...
- `role` (**Required**)(String). The role that should be assigned. Only one yandex_kms_symmetric_key_iam_member can be used per role.
