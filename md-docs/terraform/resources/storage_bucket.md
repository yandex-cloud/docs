...
- `default_storage_class` (String). Storage class which is used for storing objects by default. Available values are: "STANDARD", "COLD", "ICE". Default is `"STANDARD"`. See [Storage Class](../../storage/concepts/storage-class.md) for more information.
...
- `id` (String). 
- `max_size` (Number). The size of bucket, in bytes. See [Size Limiting](../../storage/operations/buckets/limit-max-volume.md) for more information.
- `policy` (String). The `policy` object should contain the only field with the text of the policy. See [policy documentation](../../storage/concepts/policy.md) for more information on policy format.
...
- `anonymous_access_flags` [Block]. Provides various access to objects. See [Bucket Availability](../../storage/operations/buckets/bucket-availability.md) for more information.
...
- `cors_rule` [Block]. A rule of [Cross-Origin Resource Sharing](../../storage/concepts/cors.md) (CORS object).
...
- `https` [Block]. Manages https certificates for bucket. See [https](../../storage/operations/hosting/certificate.md) for more information.
  - `certificate_id` (**Required**)(String). Id of the certificate in Certificate Manager, that will be used for bucket.
- `lifecycle_rule` [Block]. A configuration of [object lifecycle management](../../storage/concepts/lifecycles.md).
...
- `object_lock_configuration` [Block]. A configuration of [object lock management](../../storage/concepts/object-lock.md).
...
- `versioning` [Block]. A state of [versioning](../../storage/concepts/versioning.md).
...
- `website` [Block]. A [Website Object](../../storage/concepts/hosting.md)
  ...
  - `routing_rules` (String). A JSON array containing [routing rules](../../storage/s3/api-ref/hosting/upload.md#request-scheme) describing redirect behavior and when redirects are applied.
