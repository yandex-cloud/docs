[Документация Yandex Cloud](../../index.md) > [Terraform в Yandex Cloud](../index.md) > Справочник Terraform > Ресурсы (англ.) > Managed Service for PostgreSQL > Resources > mdb_postgresql_backup_retention_policy

# yandex_mdb_postgresql_backup_retention_policy (Resource)
...
//
resource "yandex_mdb_postgresql_backup_retention_policy" "my_policy" {
...
- `cluster_id` (**Required**)(String). ID of the PostgreSQL cluster.
