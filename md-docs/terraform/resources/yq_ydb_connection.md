[Документация Yandex Cloud](../../index.md) > [Terraform в Yandex Cloud](../index.md) > Справочник Terraform > Ресурсы (англ.) > Yandex Query > Resources > yq_ydb_connection

# yandex_yq_ydb_connection (Resource)

Manages YDB connection in Yandex Query service. For more information, see [the official documentation](../../query/concepts/glossary.md#connection).
