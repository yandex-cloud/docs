[Документация Yandex Cloud](../../index.md) > [Terraform в Yandex Cloud](../index.md) > Справочник Terraform > Ресурсы (англ.) > Cloud CDN > Resources > cdn_resource

# yandex_cdn_resource (Resource)

Allows management of [Yandex Cloud CDN Resource](../../cdn/concepts/resource.md).
