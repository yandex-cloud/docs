[Документация Yandex Cloud](../../index.md) > [Terraform в Yandex Cloud](../index.md) > Справочник Terraform > Ресурсы (англ.) > Unknown > Resources > sws_security_profile_advanced_rate_limiter_profile_attachment
