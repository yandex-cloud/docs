...
- `id` (String). 
- `key_algorithm` (String). The algorithm used to generate the key. `RSA_2048` is the default algorithm. Valid values are listed in the [API reference](../../iam/api-ref/Key/index.md).
