[Документация Yandex Cloud](../../index.md) > [Terraform в Yandex Cloud](../index.md) > Справочник Terraform > Ресурсы (англ.) > Yandex Data Processing > Resources > dataproc_cluster_change_freeze

# yandex_dataproc_cluster_change_freeze (Resource)
...
```terraform
resource "yandex_dataproc_cluster_change_freeze" "example" {
  resource_id = yandex_dataproc_cluster.example.id
...
terraform import yandex_dataproc_cluster_change_freeze.example c9q-resource-id:change-freeze-id
```