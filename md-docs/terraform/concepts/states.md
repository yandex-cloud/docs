[Документация Yandex Cloud](../../index.md) > [Terraform в Yandex Cloud](../index.md) > [Концепции](index.md) > Состояния
...
1. Отслеживание изменений. Состояния позволяют отслеживать изменения в инфраструктуре, которые были выполнены с помощью кода Terraform. Это позволяет обеспечить согласованность между кодом и реальной инфраструктурой и предотвратить конфликты при выполнении операций управления ресурсами.
1. Согласованность. Состояния обеспечивают согласованность между кодом Terraform и реальной инфраструктурой, предотвращая конфликты и ошибки при выполнении операций.
...
1. Безопасность. Состояния помогают обеспечить безопасность инфраструктуры, предоставляя информацию о том, какие ресурсы были созданы или изменены с помощью кода Terraform, и позволяя контролировать доступ к этой информации.
