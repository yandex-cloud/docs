[Документация Yandex Cloud](../../index.md) > [Terraform в Yandex Cloud](../index.md) > Справочник Terraform > Ресурсы (англ.) > Smart Web Security > Data Sources > sws_waf_profile
...
- `core_rule_set` [Block]. The parameter is deprecated. Core rule set settings.
 ...
 See [Rules](../../smartwebsecurity/concepts/waf.md#anomaly) for more details.
 ...
 See [Rules](../../smartwebsecurity/concepts/waf.md#paranoia) for more details.
