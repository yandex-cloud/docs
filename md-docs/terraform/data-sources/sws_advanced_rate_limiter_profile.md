...
Get information about ARL Profile. For more information, see [the official documentation](../../smartwebsecurity/quickstart.md#arl).This data source is used to define [ARL Profile](../../smartwebsecurity/concepts/profiles.md) that can be used by other resources.
