...
- `logging` [Block]. Cloud Logging configuration.
  - `enabled` (*Read-Only*) (Bool). Enables delivery of logs generated by the Airflow components to [Cloud Logging](../../logging/index.md).
...
- `service_account_id` (*Read-Only*) (String). [Service account](../../iam/concepts/users/service-accounts.md) which linked to the resource. For more information, see [documentation](../../managed-airflow/concepts/impersonation.md).
