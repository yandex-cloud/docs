...
- `logging` [Block]. Cloud Logging configuration.
  - `enabled` (*Read-Only*) (Bool). Enables delivery of logs generated by Metastore to [Cloud Logging](../../logging/index.md).
...
- `service_account_id` (*Read-Only*) (String). [Service account](../../iam/concepts/users/service-accounts.md) with role `managed-metastore.integrationProvider`. For more information, see [documentation](../../metadata-hub/concepts/metastore-impersonation.md).
