...
This data source is used to define [Application Load Balancer Backend Groups](../../application-load-balancer/concepts/backend-group.md) that can be used by other resources.
