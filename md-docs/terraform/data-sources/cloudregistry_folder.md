[Документация Yandex Cloud](../../index.md) > [Terraform в Yandex Cloud](../index.md) > Справочник Terraform > Ресурсы (англ.) > Cloud Registry > Data Sources > cloudregistry_folder
...
- `registry_id` (*Read-Only*) (String). Output only. ID of the registry that contains this artifact.
