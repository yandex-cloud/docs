...
* Плата за кластер {{ mkf-name }}: использование выделенных хостам вычислительных ресурсов и дискового пространства (см. [тарифы {{ mkf-name }}](../pricing.md)).
...
1. Подготовьте инфраструктуру:
    ...
    - Вручную {#manual}
        ...
        1. [Создайте кластер {{ mkf-name }}](../operations/cluster-create.md) любой подходящей [конфигурации](../concepts/instance-types.md) со следующими настройками:
...
1. Установите утилиту [kafkacat](https://github.com/edenhill/kcat) для записи данных в топик {{ KF }}.
    ...
    Убедитесь, что можете с ее помощью [подключиться к созданному ранее кластеру {{ mkf-name }} через SSL](../operations/connect/clients.md#bash-zsh).
