[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for Apache Kafka®](../index.md) > [Практические руководства](index.md) > Перемещение данных из Apache Kafka® > Настройка Kafka Connect для работы с Managed Service for Apache Kafka®
