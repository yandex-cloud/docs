...
Оба способа подойдут в том числе для [миграции кластера](../operations/host-migration.md#one-host) Managed Service for Apache Kafka® с одним хостом в другую зону доступности.
