[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for Apache Kafka®](../index.md) > [Практические руководства](index.md) > Отслеживание потери сообщений в топике Apache Kafka®
...
* Плата за кластер Apache Kafka®: использование вычислительных ресурсов, выделенных хостам (в том числе хостам ZooKeeper), и дискового пространства ([тарифы Apache Kafka®](../pricing.md)).
...
1. [Настройте группы безопасности](../operations/connect/index.md#configuring-security-groups).
...
1. Выберите один из хостов кластера с ролью `KAFKA` и получите его [FQDN](../operations/connect/index.md#get-fqdn).
...
[Перейдите](https://monitoring.yandex.cloud) в сервис **Yandex Monitoring** и проанализируйте поведение созданных ранее метрик:
