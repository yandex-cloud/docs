...
- Интерфейсы Yandex Cloud {#yc}
    ...
    1. [Создайте пользователя](../../operations/cluster-accounts.md#create-account) с именем `kafka-user` и ролями `ACCESS_ROLE_CONSUMER` и `ACCESS_ROLE_PRODUCER`, действующими на созданные топики.
