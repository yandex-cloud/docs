[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for Apache Kafka®](../../index.md) > [Практические руководства](../index.md) > Поставка данных другими способами > Поставка из PostgreSQL с помощью Debezium
...
1. [Выдайте пользователю `debezium` права](../../operations/cluster-accounts.md#grant-permission) `ACCESS_ROLE_CONSUMER` и `ACCESS_ROLE_PRODUCER` на созданные топики.
...
`kafkacat` — это устаревший инструмент. Он работает только для кластеров с версией Apache Kafka® ниже 4.0. Если ваш кластер с версией Apache Kafka® 4.0 или выше, используйте утилиту [kafkactl](../../operations/connect/clients.md#kafkactl).
