[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for Apache Kafka®](../../index.md) > [Практические руководства](../index.md) > Поставка данных другими способами > Поставка из MySQL® с помощью Debezium
...
Вы можете отслеживать изменения данных в Yandex Managed Service for MySQL® и отправлять их в Yandex Managed Service for Apache Kafka® с помощью технологии Change Data Capture (CDC).
