...
- Вручную {#manual}
    ...
    1. [Создайте в кластере Managed Service for Apache Kafka® пользователя](../operations/cluster-accounts.md#create-account) с правами доступа `ACCESS_ROLE_PRODUCER` и `ACCESS_ROLE_CONSUMER` к созданному топику.
...
1. Убедитесь, что данные перенеслись в топик `sensors` кластера Managed Service for Apache Kafka®:
    ...
    1. [Установите](../operations/connect/clients.md#kafkactl) утилиту `kafkactl`.
