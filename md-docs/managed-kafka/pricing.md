...
- Расчет в рублях {#prices-rub}
  ...
  > 
  > Итого: {% calc [currency=RUB] 3 × (2 × 1.74 + 8 × 0.46) %} — стоимость часа работы хостов-брокеров Apache Kafka®.
  ...
  * 0,46 ₽ — стоимость часа использования 1 ГБ RAM на 100% vCPU.
  ...
  >
  > Итого: {% calc [currency=RUB] 3 × 100 × 3.744 %} — стоимость хранилища для хостов-брокеров Apache Kafka®.
  ...
  * 15,696 ₽ — стоимость месяца использования 1 ГБ хранилища на сетевых SSD-дисках.
  ...
  > 720 × ({% calc [currency=RUB] 3 × (2 × 1.74 + 8 × 0.46) %} + {% calc [currency=RUB] 3 × (2 × 0.807 + 4 × 0.3228) %}) + {% calc [currency=RUB] 3 × 100 × 3.744 %} + {% calc [currency=RUB] 3 × 10 × 15.696 %} = {% calc [currency=RUB] 720 × ((3 × (2 × 1.74 + 8 × 0.46)) + (3 × (2 × 0.807 + 4 × 0.3228))) + (3 × 100 × 3.744) + (3 × 10 × 15.696) %}
  >
  > Итого: {% calc [currency=RUB] 720 × ((3 × (2 × 1.74 + 8 × 0.46)) + (3 × (2 × 0.807 + 4 × 0.3228))) + (3 × 100 × 3.744) + (3 × 10 × 15.696) %} — стоимость использования кластера в течение 30 дней.
  
  Где:
  * 720 — количество часов в 30 днях.
  * {% calc [currency=RUB] 3 × (2 × 1.74 + 8 × 0.46) %} — стоимость часа работы хостов-брокеров Apache Kafka®.
  * {% calc [currency=RUB] 3 × (2 × 0.807 + 4 × 0.3228) %} — стоимость часа работы хостов ZooKeeper.
  * {% calc [currency=RUB] 3 × 100 × 3.744 %} — стоимость хранилища для хостов-брокеров Apache Kafka®.
...
- Расчет в тенге {#prices-kzt}
  ...
  > 
  > Итого: {% calc [currency=KZT] 3 × (2 × 8.7 + 8 × 2.3) %} — стоимость часа работы хостов-брокеров Apache Kafka®.
  ...
  * 2,3 ₸ — стоимость часа использования 1 ГБ RAM на 100% vCPU.
  ...
  >
  > Итого: {% calc [currency=KZT] 3 × 100 × 18.72 %} — стоимость хранилища для хостов-брокеров Apache Kafka®.
  ...
  * 78,48 ₸ — стоимость месяца использования 1 ГБ хранилища на сетевых SSD-дисках.
  ...
  > 720 × ({% calc [currency=KZT] 3 × (2 × 8.7 + 8 × 2.3) %} + {% calc [currency=KZT] 3 × (2 × 4.035 + 4 × 1.614) %}) + {% calc [currency=KZT] 3 × 100 × 18.72 %} + {% calc [currency=KZT] 3 × 10 × 78.48 %} = {% calc [currency=KZT] 720 × ((3 × (2 × 8.7 + 8 × 2.3)) + (3 × (2 × 4.035 + 4 × 1.614))) + (3 × 100 × 18.72) + (3 × 10 × 78.48) %}
  >
  > Итого: {% calc [currency=KZT] 720 × ((3 × (2 × 8.7 + 8 × 2.3)) + (3 × (2 × 4.035 + 4 × 1.614))) + (3 × 100 × 18.72) + (3 × 10 × 78.48) %} — стоимость использования кластера в течение 30 дней.
  
  Где:
  * 720 — количество часов в 30 днях.
  * {% calc [currency=KZT] 3 × (2 × 8.7 + 8 × 2.3) %} — стоимость часа работы хостов-брокеров Apache Kafka®.
  * {% calc [currency=KZT] 3 × (2 × 4.035 + 4 × 1.614) %} — стоимость часа работы хостов ZooKeeper.
  * {% calc [currency=KZT] 3 × 100 × 18.72 %} — стоимость хранилища для хостов-брокеров Apache Kafka®.
