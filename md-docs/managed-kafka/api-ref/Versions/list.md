[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for Apache Kafka®](../../index.md) > Справочник API > [REST (англ.)](../index.md) > [Versions](index.md) > List

# Managed Service for Apache Kafka® API, REST: Versions.List
...
```
GET https://mdb.api.cloud.yandex.net/managed-kafka/v1/versions
```

## Query parameters {#yandex.cloud.mdb.kafka.v1.ListVersionsRequest}
...
## Response {#yandex.cloud.mdb.kafka.v1.ListVersionsResponse}
