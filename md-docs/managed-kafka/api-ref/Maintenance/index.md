[Документация Yandex Cloud](../../../index.md) > [Yandex Managed Service for Apache Kafka®](../../index.md) > Справочник API > [REST (англ.)](../index.md) > Maintenance > Overview

# Managed Service for Apache Kafka® API, REST: Maintenance
