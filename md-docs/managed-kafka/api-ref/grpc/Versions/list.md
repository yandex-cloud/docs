...
**rpc List ([ListVersionsRequest](#yandex.cloud.mdb.kafka.v1.ListVersionsRequest)) returns ([ListVersionsResponse](#yandex.cloud.mdb.kafka.v1.ListVersionsResponse))**

## ListVersionsRequest {#yandex.cloud.mdb.kafka.v1.ListVersionsRequest}
...
## ListVersionsResponse {#yandex.cloud.mdb.kafka.v1.ListVersionsResponse}
