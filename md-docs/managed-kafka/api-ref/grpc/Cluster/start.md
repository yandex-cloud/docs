...
**rpc Start ([StartClusterRequest](#yandex.cloud.mdb.kafka.v1.StartClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## StartClusterRequest {#yandex.cloud.mdb.kafka.v1.StartClusterRequest}
...
Required field. ID of the Apache Kafka® cluster to start.
...
|| metadata | **[StartClusterMetadata](#yandex.cloud.mdb.kafka.v1.StartClusterMetadata)**
...
## StartClusterMetadata {#yandex.cloud.mdb.kafka.v1.StartClusterMetadata}
