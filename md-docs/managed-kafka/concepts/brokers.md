...
Подробнее о том, как брокеры работают с сообщениями, смотрите [в документации Apache Kafka®](https://kafka.apache.org/42/design/design/#message-delivery-semantics).