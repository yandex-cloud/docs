...
Подробнее о работе в веб-интерфейсе см. [документацию {{ kafka-ui }} для {{ KF }}]({{ kafka-ui-kafbat }}).


Пошаговые инструкции по включению веб-интерфейса {{ kafka-ui }} в разделе [{#T}](../operations/kafka-ui-enable.md).