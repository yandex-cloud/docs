...
Если в кластере присутствуют хосты {{ ZK }}, каждый из трех хостов {{ ZK }} будет использовать свою выделенную зону доступности и выбранную в ней подсеть. Подробнее в разделе [{#T}](index.md).
...
FQDN можно использовать для доступа к хосту в рамках одной облачной сети. Подробнее в [документации сервиса {{ vpc-full-name }}](../../vpc/index.md).
