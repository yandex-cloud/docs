[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for Apache Kafka®](../index.md) > [Концепции](index.md) > Классы хостов

# Классы хостов Apache Kafka®
...
Для хостов кластера, размещенных в [зоне доступности](../../overview/concepts/geo-scope.md) `ru-central1-d`, использование хранилища на локальных SSD-дисках недоступно при выборе платформы Intel Cascade Lake.
