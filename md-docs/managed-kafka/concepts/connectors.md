...
По умолчанию имена топиков в кластере-приемнике имеют вид `<псевдоним_кластера-источника>.<имя_топика>`. Чтобы сохранить исходные имена топиков, создайте коннектор с помощью CLI и [настройте перенос без префиксов](../operations/cluster-connector.md#settings-mm2).
...
Коннектор **Iceberg Sink** используется для передачи данных из топиков Apache Kafka® в таблицы Apache Iceberg™.
