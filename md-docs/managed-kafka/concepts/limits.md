[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for Apache Kafka®](../index.md) > [Концепции](index.md) > Квоты и лимиты

# Квоты и лимиты в Managed Service for Apache Kafka®


В сервисе Managed Service for Apache Kafka® действуют следующие ограничения:
