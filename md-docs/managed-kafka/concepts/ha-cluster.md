...
Высокая доступность кластера {{ mkf-name }} определяется количеством и расположением его хостов, настройками топиков и другими параметрами кластера.
