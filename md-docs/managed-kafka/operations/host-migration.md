...
Хосты кластера Managed Service for Apache Kafka® располагаются в [зонах доступности](../../overview/concepts/geo-scope.md) Yandex Cloud. Хосты Apache Kafka® можно перенести из одной зоны в другую. Процесс переноса различается для кластеров с одним и несколькими хостами.
