[Документация Yandex Cloud](../../index.md) > [Yandex Managed Service for Apache Kafka®](../index.md) > [Пошаговые инструкции](index.md) > Кластеры > Обновление версии Apache Kafka®
...
Со списком поддерживаемых версий можно ознакомиться в разделе [Политика работы с версиями Apache Kafka®](../concepts/update-policy.md).
...
- Консоль управления {#console}
    ...
    В [консоли управления](https://console.yandex.cloud) откройте страницу [создания](cluster-create.md) или [изменения кластера](cluster-update.md) Managed Service for Apache Kafka®. Список доступен в поле **Версия**.
...
- REST API {#api}
    ...
    1. Воспользуйтесь методом [Versions.List](../api-ref/Versions/list.md) и выполните запрос, например, с помощью [cURL](https://curl.se/):
        ...
        curl \
            ...
            --url 'https://mdb.api.cloud.yandex.net/managed-kafka/v1/versions'
        ```
...
- gRPC API {#grpc-api}
    ...
    1. Убедитесь, что запрос был выполнен успешно, изучив [ответ сервера](../api-ref/grpc/Versions/list.md#yandex.cloud.mdb.kafka.v1.ListVersionsResponse).
...
- REST API {#api}
    ...
    1. Воспользуйтесь методом [Cluster.update](../api-ref/Cluster/update.md) и выполните запрос, например, с помощью [cURL](https://curl.se/):
        ...
        * `configSpec.version` — версия Apache Kafka®, до которой нужно обновиться: 3.7, 3.8, 3.9, 4.0, 4.1 или 4.2.
...
- gRPC API {#grpc-api}
    ...
    1. Воспользуйтесь вызовом [ClusterService/Update](../api-ref/grpc/Cluster/update.md) и выполните запрос, например, с помощью [gRPCurl](https://github.com/fullstorydev/grpcurl):
        ...
        * `config_spec.version` — версия Apache Kafka®, до которой нужно обновиться: 3.7, 3.8, 3.9, 4.0, 4.1 или 4.2.
