[Документация Yandex Cloud](../index.md) > [Microsoft в Yandex Cloud](index.md) > Лицензирование > Требования к учетной записи Yandex Cloud
...
1. Обновите данные. Подробнее в [документации Яндекс Баланса](https://yandex.ru/support/balance/operations/change-data.html).
