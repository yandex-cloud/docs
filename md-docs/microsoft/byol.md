[Документация Yandex Cloud](../index.md) > [Microsoft в Yandex Cloud](index.md) > Практические руководства > Использование своей лицензии для продуктов Microsoft
...
Чтобы получить доступ к ВМ, нужно [сбросить пароль администратора](../compute/operations/vm-guest-agent/reset-password.md), установленный по умолчанию, и сгенерировать новый.
