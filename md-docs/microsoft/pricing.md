...
На итоговую стоимость влияют используемые ресурсы. Подробнее о расчете стоимости использования Compute Cloud можно узнать на странице [{#T}](../compute/pricing.md). 
