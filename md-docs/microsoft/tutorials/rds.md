[Документация Yandex Cloud](../../index.md) > [Microsoft в Yandex Cloud](../index.md) > [Практические руководства](index.md) > Развертывание Remote Desktop Services
...
1. Перезапустите ВМ `my-rds-vm`:
   ...
   - API {#api}
     ...
     Воспользуйтесь методом REST API [restart](../../compute/api-ref/Instance/restart.md) для ресурса [Instance](../../compute/api-ref/Instance/index.md) или вызовом gRPC API [InstanceService/Restart](../../compute/api-ref/grpc/Instance/restart.md).
