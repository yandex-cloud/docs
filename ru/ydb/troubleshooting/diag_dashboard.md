---
sourcePath: overlay/troubleshooting/diag_dashboard.md
---
...
Для поиска медленных запросов рекомендуется использовать [системные таблицы](system_views.md).
...
Для поиска медленных запросов рекомуендуется использовать [системные таблицы](system_views.md).
