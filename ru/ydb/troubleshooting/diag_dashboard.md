...
Частые перезапуски процессов, обслуживающих базу, приведут к росту доли [ошибочных ответов](../api/error_handling.md#termination-statuses) `Unavailable`, что в свою очередь приведёт к росту доли ошибок в ответах приложения пользователю или к росту времени выполнения запросов.
