---
sourcePath: core/best_practices/_includes/batch_upload.md
---
# Загрузка больших объёмов данных

В данном разделе предоставлены рекомендации по эффективной загрузке больших объемов данных в YDB.
