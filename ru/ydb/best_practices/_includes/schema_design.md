---
sourcePath: core/best_practices/_includes/schema_design.md
---
# Проектирование схемы

В данном разделе приведены рекомендации по проектированию схемы БД для повышения производительности YDB.
