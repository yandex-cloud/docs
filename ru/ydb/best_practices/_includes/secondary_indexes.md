---
sourcePath: core/best_practices/_includes/secondary_indexes.md
---
# Вторичные индексы
...
Без использования вторичных индексов запрос на выборку записей, которые удовлетворяют заданному предикату по количеству просмотров, будет работать неэффективно, так как для его выполнения YDB просканирует все строки таблицы `series`. В запросе необходимо явно указать, какой индекс использовать.
