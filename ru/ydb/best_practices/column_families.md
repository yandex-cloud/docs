## Настройка групп колонок {#setup-groups-of-columns}
...
#### Основные сущности {#main-entitys}
...
- Способ кэширования (значение из списка)
...
Группа колонок может переопределять тип размещения данных относительно указанного в профиле хранения таблицы. А также определяет способ сжатия и кэшировния данных.
