...
## Основные характеристики KiKiMR
...
## Принципы и идеи, на которых построена платформа KiKiMR
#### Actor Model
...
## Детали внутреннего устройства KikiMR
### Процесс загрузки KikiMR
