...
Подробнее читайте в разделе [Проектирование схемы](../develop/best_practices/schema_design.md).
...
Подробнее читайте в разделе [Проектирование схемы](../develop/best_practices/schema_design.md#balance-shard-load).
