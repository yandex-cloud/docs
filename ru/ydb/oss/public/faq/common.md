...
Подробнее читайте в разделе [{#T}](../develop/best_practices/schema_design.md).
...
Подробнее читайте в разделе [{#T}](../develop/best_practices/schema_design.md#balance-shard-load).
...
Подробнее существующие ограничения описаны в разделе [Ограничения базы данных](../develop/concepts/limits-ydb.md).
...
Подробнее читайте в [документации](../develop/concepts/secondary_indexes.md).
...
Подробнее читайте в разделе [{#T}](../develop/best_practices/paging.md).
...
Подробнее читайте в разделе [{#T}](../develop/best_practices/batch_upload.md).

#### Как удалять устаревшие данные? {#ttl}

Для эффективного удаления устаревших данных рекомендуется использовать [TTL](../develop/concepts/ttl.md).
