...
* Изменить порядок следования компонентов ключа: избегайте использования столбцов с монотонно возрастающими значениями – например, временем события – в качестве первого компонента первичного ключа.
...
Вторичные индексы в {{ ydb-short-name }} — глобальные, и могут быть неуникальными. Подробнее читайте в разделе [{#T}](../concepts/secondary_indexes.md).
