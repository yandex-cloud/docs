...
Подробнее существующие ограничения описаны в разделе [Ограничения базы данных]{% if audience == "external" %}(../oss/public/develop/concepts/limits-ydb.md){% else %}(https://cloud.yandex.ru/docs/ydb/concepts/limits-ydb){% endif %}.
...
Подробнее читайте в [документации](https://cloud.yandex.ru/docs/ydb/oss/public/develop/concepts/secondary_indexes).
...
Для эффективного удаления устаревших данных рекомендуется использовать [TTL](https://cloud.yandex.ru/docs/ydb/oss/public/develop/concepts/ttl).
