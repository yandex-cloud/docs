...
Подробнее существующие ограничения описаны в разделе [Ограничения базы данных]{% if audience == "external" %}(../concepts/limits-ydb.md){% else %}(https://cloud.yandex.ru/docs/ydb/concepts/limits-ydb){% endif %}.
