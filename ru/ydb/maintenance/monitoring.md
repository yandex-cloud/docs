---
sourcePath: overlay/maintenance/monitoring.md
---
# Мониторинг
...
* QueryCommitTx - запрос на явную фиксацию транзакции; в транзакциях YDB [рекомендуется](https://cloud.yandex.ru/docs/ydb/oss/public/develop/concepts/transactions) не отделять `COMMIT` от тела транзакции, по возможности стараться оформлять транзакцию в виде одного YQL-запроса с `COMMIT`.
...
Подробно типы статусов опасны в разделе [Статусы завершения YDB](https://cloud.yandex.ru/docs/ydb/oss/public/reference/ydb-sdk/error_handling#termination-statuses).
