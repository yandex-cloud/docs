...
* С точки зрения пользователя запросы выполняются синхронно, но при получении ответа с большим числом строк, их скачивание на клиент происходит по мере обращения снаружи к соответствующим методам JDBC интерфейса.
