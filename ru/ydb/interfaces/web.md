...
## Работа с исходными данными {#working-with-source-data}
...
## Ссылки на результат операции {#links-to-the-result-of-the-operation}
...
## Управление доступом к сохраненным запросом {#managing-access-to-saved-queries}
...
## Прикладывание файлов к запросам {#attaching-files-to-queries}
...
Сервис YQL оставляет за собой право кэшировать находящиеся за URL файлы на неопределенный срок, по-этому при значимом изменении находящегося за ней содержимого настоятельно рекомендуется модифицировать URL за счет добавления/изменения незначащих параметров.
## Валидация запросов {#request-validation}
...
## Фильтрация сохраненных запросов {#filtering-saved-queries}
...
## Доступ к предыдущим версиям сохраненных запросов {#access-to-previous-versions-of-saved-queries}
...
## Скачивание таблиц {#downloading-tables}
...
## Полнотекстовый поиск {#text-search}
...
## Визуализация гистограмм {#visualization-of-histograms}
...
## Темная тема оформления {#dark-color-theme}
