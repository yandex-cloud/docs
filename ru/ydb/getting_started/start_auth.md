...
В [веб-интерфейсе YDB](https://ydb.yandex-team.ru/) для [аутентификации](../concepts/iam.md#authentication) используются сессионные cookies пользователя в домене yandex-team.ru. Подробнее этот метод аутентификации описан в разделе [Разграничение прав доступа](../concepts/iam.md#session_cookie). Пользователь, прошедший процедуру входа с [Яндекс ID](https://passport.yandex-team.ru/profile), аутентифицируется в веб-интерфейсе YDB автоматически.
...
![Give me my token](../../_assets/ydb/db_ui_give_me_token.png)
