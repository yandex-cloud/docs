...
Подробнее о модели данных и схему YDB написано в разделе [Модель данных и схема](../concepts/datamodel.md).<br>Список типов данных и ссылки на их описание см. в разделе [Типы данных](../concepts/datatypes.md).
