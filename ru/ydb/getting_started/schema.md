...
Первичные индексы строятся по первичному ключу, являются уникальными и создаются [автоматически](../getting_started/schema.md#create-table).
...
### Укажите вторичные индексы {#si-add}
