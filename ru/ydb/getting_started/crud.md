...
## Вставка и изменение данных {#change-data}

Для вставки данных в {{ ydb-short-name }} используются инструкции REPLACE, UPSERT, INSERT.
...
## Чтение данных при помощи SELECT {#select}

Для чтения данных в таблице используется инструкция SELECT. Подробно про синтаксис инструкции SELECT написано в документации по [YQL](../yql/reference/quickstart.md).
