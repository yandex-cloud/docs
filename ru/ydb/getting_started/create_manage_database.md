...
Форма создания базы данных YDB позволяет выбрать между serverless и dedicated режимами. Подробнее особенности режимов описаны в разделе [{#T}](../concepts/serverless_and_dedicated.md).
