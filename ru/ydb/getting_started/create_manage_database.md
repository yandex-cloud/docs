...
В этом разделе описано как создать, просмотреть, изменить и удалить базы данных (БД). Подробно о базах данных написано в разделе [Базы данных](../concepts/internal/databases.md).
