...
1. Настройте параметры базы в диалоговом окне:
    ...
    1. Кластер (cluster). Доступен выбор однодатацетровых (`ydb-vla`, `ydb-sas`, `ydb-man`, `ydb-myt`) и многодатацетровых кластеров (`ydb-ru`, расположенный в датацентрах VLA-SAS-MYT, и `ydb-eu`, расположенный в датацентрах VLA-SAS-MAN).
