...
### Выполняемые роли {#roles-performed}
...
### Категории обрабатываемых запросов {#categories-of-processed-requests}
#### Операции со схемой {#schema-operations}
...
#### MiniKQL транзакции над таблицами {#minikql-table-transactions}
