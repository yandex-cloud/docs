### Существующие метрики {#existing-metrics}
...
### Загрузка таблеток при старте кластера {#tablet-loading-at-cluster-start}
...
### Выбор лучшей ноды для таблетки {#choosing-the-best-node-for-the-pill}
...
### Перебалансировщик и критерий переезда {#rebalancer-and-relocation-criteria}
