### Что это и зачем?
**Data Shard** предназначен для хранения части распределённой [пользовательской таблицы](../concepts/internal/datamodel.md) и выполнения распределённых транзакций над этой таблицей.
