## Необходимые этапы настройки кластера KiKiMR {#necessary-steps-for-configuring-the-cluster-kikmr}
...
### Сбор информации о ресурсах и описание будущего кластера {#collecting-information-about-resources-and-describing-the-future-cluster}
...
### Настройка кластера с использованием инструмента по конфигурации {#configuring-a-cluster-using-the-configuration-tool}

#### Собрать программу kikimr_configure {#build-the-kikimr-configure-program}
...
#### Описать данные кластера в YAML {#describe-cluster-data-in-yaml}
...
#### Создание конфигурации {#creating-a-configuration}
...
### Процесс создания статической конфигурации по описанию кластера {#process-of-creating-a-static-configuration-based-on-the-cluster-description}

#### Создание **names.txt** {#creating-names-txt}
...
```
#### Создание **bs\_format.txt** {#creating-bs-format-txt}
...
#### Создание описания статической группы BlobStorage **bs.txt** {#creating-a-description-of-a-static-blobstorage-bs-group-txt}
...
#### Создание **log.txt** {#creating-log-txt}
...
logs:
  ...
  entries:
    ...
    - name: KQP_WORKER
      level: 7
```
#### Создание **boot.txt** {#creating-boot-txt}
...
#### Создание **ic.txt** {#creating-ic-txt}
...
```
#### Создание **grpc.txt** {#creating-grpc-txt}
...
```
#### Создание DefaultDataShardConfig {#creating-defaultdatashardconfig-txt}
...
```
#### Создание vdisks.txt {#creating-vdisks-txt}
...
```
#### Создание sys.txt {#creating-sys-txt}
...
```
#### Создание memlog.txt {#creating-memlog-txt}

``` python
LogBufferSize: 1073741824
LogGrainSize: 1048576
```
#### Создание feature\_flags.txt {#creating-feature-flags-txt}
...
#### Создание domains.txt {#creating-domains-txt}
