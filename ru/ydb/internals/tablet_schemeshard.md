...
### Что такое Scheme Shard {#what-is-scheme-shard}
...
#### Create/Alter/Drop PQGroup {#create-alter-drop-pqgroup}
...
#### Шаги выполнения операций (**устарело**) {#operation-steps-deprecated}
