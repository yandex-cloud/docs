Хотя пользовательских код таблетки можно писать в терминах сырых записей лог, в целом это - крайне неудобно, ведет к дублирования нетривиального кода и вообще - ересь =).
...
#### Локальная транзакция {#local-transaction}
