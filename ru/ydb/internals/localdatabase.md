Хотя пользовательских код таблетки можно писать в терминах сырых записей лог, в целом это - крайне неудобно, ведёт к дублирования нетривиального кода и вообще - ересь =).
