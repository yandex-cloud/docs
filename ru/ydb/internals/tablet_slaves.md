#### Для чего нужны tablet slaves {#what-are-tablet-slaves-for}
...
#### Реализация на системного уровне {#system-level-organization}
...
#### Реализация на уровне PQ-топиков {#pq-topics-organization}
Не поддерживается.

#### Реализация на уровне таблиц {#table-organization}
