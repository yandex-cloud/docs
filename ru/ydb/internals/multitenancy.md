### Как видим идеальную систему {#as-we-see-the-ideal-system}
...
### Какие вообще есть варианты решения {#what-are-the-possible-solutions}
...
### Как мы хотим решить задачу {#how-do-we-want-to-solve-the-problem}
...
#### Картинка для ориентации {#pictures-for-orientation}
...
### Что и как уже работает {#what-and-how-it-already-works}
...
#### Роли в кластере {#roles-in-the-cluster}
...
#### Как реализовано {#how-implemented}
...
###### создание поддомена {#creating-a-subdomain}
...
###### создание поддомена руками {#creating-a-subdomain-manually}
...
###### создание таблиц в поддомене {#creating-tables-in-a-subdomain}
...
###### операции в поддомене {#operations-in-subdomain}
...
###### запуск таблеток поддомена {#launch-of-tablets-subdomain}
...
##### c++ ut тесты {#c-plus-plus-ut-tests}
...
##### python ut тесты {#python-ut-tests}
