Таблетки, работая в модели с выделенным мастером, зависят от корректности и устойчивости алгоритма выбора мастера. Фактически речь идёт о нескольких требованиях:
