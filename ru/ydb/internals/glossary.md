...
#### Tablet Follower
  **Tablet Follower** или **Hot standby** - копия мастера, проигрывающая принятый мастером лог команд (с некоторым отставанием). Tаблетка может иметь 0 или более фолловеров. Слейвы решают по большей степени две задачи: (1) в случае смерти мастера фолловеры являются предпочтительными кандидатами в мастера, т.к. могут перейти в мастера гораздо быстрее (меньше лога проигрывать); (2) фолловеры могут брать на себя некоторую нагрузку мастера на чтение (отвечая на запросы чтения с некоторым отставанием).
#### Tablet Generation
