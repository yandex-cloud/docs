#### Что такое Distributed Storage Proxy {#what-is-distributed-storage-proxy}
...
#### Жизненный цикл DS-Proxy {#ds-proxy-life-cycle}
...
#### Основные принципы работы DS-Proxy (Контракт) {#basic-principles-of-the-ds-proxy-contract}
