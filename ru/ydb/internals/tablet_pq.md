...
### Назначение PQ-таблетки {#prescribing-pq-tablets}
...
### Организация и формат данных {#organization-and-data-format}
Устройство:
...
### Запрос на запись {#recording-request}
...
### Переполнение партиций {#partition-overflow}
...
### Управление PQ-таблетками {#pq-pill-management}
