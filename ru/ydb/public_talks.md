...
- Тема: Yandex Database — как выжать 10K IOPS из HDD и вставить в таблицу 50K записей на одном ядре.
  ...
  - Описание:
    ...
    1. Рассказ про архитектуру распределенного сетевого хранилища в Yandex Database.
...
- Тема: Yandex Database: newSQL база данных. Рассказ собственно про YDB как базу данных.
