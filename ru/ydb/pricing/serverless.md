...
{{ ydb-name }} Serverless предлагает механизм восстановления базы и/или отдельных таблиц из резервной копии, хранимой в сервисе [{{ objstorage-full-name }}](../../storage/index.yaml). Восстановление данных из резервной копии осуществляется по требованию и тарифицируется исходя из цены восстановления за 1 ГБ. Объем данных округляется до целых ГБ в большую сторону.
