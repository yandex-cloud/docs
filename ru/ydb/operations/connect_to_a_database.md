...
1. {% if deploy != "arc" %} [Создайте виртуальную машину](../../compute/operations/vm-create/create-linux-vm.md) {% else %} Создайте виртуальную машину {% endif %} в {{ yandex-cloud }}.
1. Сохраните публичный IP-адрес виртуальной машины. Для этого перейдите в свойства виртуальной машины или {% if deploy != "arc" %} [воспользуйтесь интерфейсом командной строки](../../compute/operations/vm-info/get-info.md#outside-instance) {% else %} воспользуйтесь интерфейсом командной строки {% endif %}.
