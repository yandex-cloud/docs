...
Работа с несколькими профилями позволяет быстро переключать контекст выполнения команд {{ ydb-short-name }} CLI. Для переключения на нужный профиль [активируйте](activate.md) его.
