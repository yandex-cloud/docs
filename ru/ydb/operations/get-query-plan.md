...
- Консоль управления
  ...
  6. Чтобы получить план запроса в нижней части окна нажмите на кнопку ![image](../../_assets/ydb/ydb_btn_select.png "Кнопка выбора") (рядом с кнопкой Запрос) и выберите пункт **Explain**.
