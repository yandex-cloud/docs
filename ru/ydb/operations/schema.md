...
- Консоль управления
   ...
   **Создать YDB-таблицу**
   ...
   1. При необходимости настройте [вторичные индексы](../oss/public/develop/concepts/secondary_indexes.md):
...
- SQL
   ...
   * Первичные индексы строятся по первичному ключу, являются уникальными и создаются автоматически.
   ...
   Подробнее про модель данных и схему {{ ydb-short-name }} читайте в разделе [Модель данных и схема](../oss/public/develop/concepts/datamodel.md). Про поддерживаемые типы данных читайте в разделе [Типы данных](../oss/public/develop/concepts/datatypes.md).
