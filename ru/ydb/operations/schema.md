...
- {{ ydb-short-name }}-таблица
  ...
  1. При необходимости настройте [вторичные индексы]{% if lang == "ru" %}(https://ydb.tech/ru/docs/concepts/secondary_indexes){% endif %}{% if lang == "en" %}(https://ydb.tech/en/docs/concepts/secondary_indexes){% endif %}:
  ...
  1. Настройте политику [партиционирования]{% if lang == "ru" %}(https://ydb.tech/ru/docs/concepts/datamodel){% endif %}{% if lang == "en" %}(https://ydb.tech/en/docs/concepts/datamodel/){% endif %}:
...
Для изменения {{ ydb-short-name }}-таблиц также предназначена команда [`ALTER TABLE`]{% if lang == "ru" %}(https://ydb.tech/ru/docs/yql/reference/syntax/alter_table){% endif %}{% if lang == "en" %}(https://ydb.tech/en/docs/yql/reference/syntax/alter_table){% endif %} языка запросов [YQL]{% if lang == "ru" %}(https://ydb.tech/ru/docs/yql/reference/){% endif %}{% if lang == "en" %}(https://ydb.tech/en/docs/yql/reference/){% endif %}.
