...
- Консоль управления {#console}
  ...
  Для создания строковых таблиц также можно воспользоваться командой [`CREATE TABLE`](https://ydb.tech/docs/ru/yql/reference/syntax/create_table) языка запросов [YQL](https://ydb.tech/docs/ru/yql/reference/).
...
Для изменения строковых таблиц также предназначена команда [`ALTER TABLE`](https://ydb.tech/docs/ru/yql/reference/syntax/alter_table) языка запросов [YQL](https://ydb.tech/docs/ru/yql/reference/).
...
Для удаления строковых таблиц также предназначена команда [`DROP TABLE`](https://ydb.tech/docs/ru/yql/reference/syntax/drop_table) языка запросов [YQL](https://ydb.tech/docs/ru/yql/reference/).
