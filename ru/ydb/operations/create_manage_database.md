...
- Консоль управления
   ...
   1. В [консоли управления](https://console.cloud.yandex.ru) выберите каталог, в котором нужно изменить настройки базы даных.
   1. В списке сервисов выберите **{{ ydb-name }}**.
   1. Нажмите значок  {% if deploy != "arc" %} ![image](../../_assets/horizontal-ellipsis.svg) {% endif %}  в строке нужной БД и выберите пункт **Изменить**.
   ...
   1. Нажмите кнопку **Измениить базу данных**.

- CLI

   TODO - уточнить консольные команды. Мб стоит разделить аналогично MDB - изменить имя/описание, изменить классы хостов, изменить параметрв БД и т.д.
...
{% endif %}
   ...
   1. Посмотрите описание команды CLI для изменения пармеметров БД:
...
- Консоль управления
   ...
   1. В [консоли управления](https://console.cloud.yandex.ru) выберите каталог, в котором нужно удалить базу даных.
   1. В списке сервисов выберите **{{ ydb-name }}**.
   1. Нажмите значок  {% if deploy != "arc" %} ![image](../../_assets/horizontal-ellipsis.svg) {% endif %}  в строке нужной БД и выберите пункт **Удалить**.
