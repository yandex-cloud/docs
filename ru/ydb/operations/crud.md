...
1. Нажмите кнопку **SQL-запрос** и введите текст запроса. При составлении запроса вы можете пользоваться шаблонами:
   ...
   * Чтобы подставить в шаблон данные определенной таблицы, нажмите на значок {% if deploy != "arc" %} ![image](../../_assets/horizontal-ellipsis.svg) {% endif %} в строке с нужной таблицей и выберите шаблон.
