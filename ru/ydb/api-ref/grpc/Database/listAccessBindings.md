---
editable: false
sourcePath: en/_api-ref-grpc/ydb/v1/api-ref/grpc/Database/listAccessBindings.md
---

# Managed Service for YDB API, gRPC: DatabaseService.ListAccessBindings {#ListAccessBindings}
