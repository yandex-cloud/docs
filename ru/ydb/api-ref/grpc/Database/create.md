---
editable: false
sourcePath: en/_api-ref-grpc/ydb/v1/api-ref/grpc/Database/create.md
---

# Managed Service for YDB API, gRPC: DatabaseService.Create {#Create}

Creates a new database.

## gRPC request

**rpc Create ([CreateDatabaseRequest](#yandex.cloud.ydb.v1.CreateDatabaseRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## CreateDatabaseRequest {#yandex.cloud.ydb.v1.CreateDatabaseRequest}
...
|| metadata | **[CreateDatabaseMetadata](#yandex.cloud.ydb.v1.CreateDatabaseMetadata)**
...
## CreateDatabaseMetadata {#yandex.cloud.ydb.v1.CreateDatabaseMetadata}
