...
1. Если значение показателя `Units consumed` достигло квоты на потребление RU в секунду, [запросите увеличение квоты]({{ link-console-quotas }}).
...
Квоту для каждой базы можно изменить в ее [настройках](operations/manage-databases.md#update-db-serverless). Если вам не хватает квоты на облако, обратитесь в [техническую поддержку]({{ link-console-support }}).
