...
Точнее сказать так: примено 30 сек новые транзакции, затрагивающие таблицу будут реджектится.
...
A: Сессия в SDK однопоточная. Если нужно паралельно использовать несколько запросов, нужно создавать несколько сессий.
