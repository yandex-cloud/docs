# Создание строковых таблиц в базе данных {#row-table-create}
...
Таблица в концепциях Terraform – это тоже ресурс, поэтому таблицы баз данных описываются отдельными блоками (`resource "ycp_ydb_table"`) с указанием внутренней ссылки на созданную ранее базу данных. Создадим тестовую строковую таблицу из 3 колонок в уже созданной базе данных:
```tf
