...
Имя читателя используется в [SDK]({{ ydb.docs }}reference/ydb-sdk/topic) или [CLI]({{ ydb.docs }}reference/ydb-cli/topic-read) для чтения данных из топика.
