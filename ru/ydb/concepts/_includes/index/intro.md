...
Для взаимодействия с YDB доступен [YDB CLI](../../../reference/ydb-cli/index.md), а также [SDK](../../../reference/ydb-sdk/index.md) для {% if oss %}C++,{% endif %}  Java, Python, Node.js, PHP и Go.
