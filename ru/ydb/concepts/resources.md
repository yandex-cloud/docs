...
Подробнее о кластерах {{ ydb-short-name }} читайте в [документации](https://ydb.tech/docs/ru/concepts/databases#cluster).
...
Подробнее о группах хранения {{ ydb-short-name }} читайте в [документации](https://ydb.tech/docs/ru/concepts/databases#storage-groups).
