---
title: Автоматическое масштабирование в {{ ydb-name }}
description: В Dedicated режиме работы базы данных {{ ydb-name }} вы можете использовать автоматическое масштабирование вычислительных ресурсов.
---
