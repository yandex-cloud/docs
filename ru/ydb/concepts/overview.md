...
{{ ydb-short-name }} используется в сервисах Яндекса в качестве высокопроизводительной [OLTP](https://en.wikipedia.org/wiki/Online_transaction_processing) СУБД. В частности, сервисы Яндекс.Облака Yandex Object Storage и Yandex Block Storage используют {{ ydb-short-name }} для хранения данных и базируются на её компонентах.
...
* подержку запросов [YQL](../yql/reference/quickstart.md) (диалект SQL для работы с большими данными);
* автоматическую репликацию данных;
* высокую доступность с автоматической обработкой отказов вычислительных узлов и зон доступности;
* автоматическое перешардирование данных при увеличении их количества.
