...
Для работы с внутренними сервисами Яндекса в домене yandex-team.ru пользователям необходимо войти в [Яндекс.Паспорт](https://passport.yandex-team.ru/profile). В результате браузер сохранит сессионную cookie, по которой большинство внутренних сервисов смогут аутентифицировать пользователя.
