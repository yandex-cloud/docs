...
Для работы с документными таблицами [используйте Document API](../docapi/tools/aws-setup.md). Работа через [YDB API](https://ydb.tech/ru/docs/reference/ydb-sdk/) возможна только в режиме чтения.
