...
Подробнее о поддерживаемых конструкциях YQL можно почитать в {% if audience == "external" %} [документации YQL](../yql/reference/overview.md) {% else %} [документации YQL](https://yql.yandex-team.ru/docs/ydb/) {% endif %} .
...
Подробнее о поддержке YQL в YDB можно прочитать в {% if audience == "external" %} [документации YQL](../yql/reference/overview.md) {% else %} [документации YQL](https://yql.yandex-team.ru/docs/ydb/) {% endif %} .
