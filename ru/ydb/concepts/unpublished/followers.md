...
Внутреннее состояние каждого из фолловеров восстанавливается в точности по состоянию мастера и полностью консистентно.
