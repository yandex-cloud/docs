...
При использовании Serverless базы данных вы отдельно оплачиваете почасовую ставку за объем хранимых данных, если он превышает бесплатный порог. Подробнее смотрите в разделе [{#T}](../pricing/serverless.md).
