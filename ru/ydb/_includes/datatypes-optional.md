...
Опциональные типы данных в {% if audience != "external" %}[текстовом виде](https://yql.yandex-team.ru/docs/ydb/misc/type_string/){% else %}[текстовом виде](../yql/reference/misc/type_string.md){% endif %} обозначаются вопросительным знаком на конце (например, `String?`) или как `Optional<...>`.
