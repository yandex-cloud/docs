...
- Python
  ...
  1. Создайте авторизованный ключ для вашего сервисного аккаунта и сохраните его в файл {% if deploy != "arc" %}[с помощью CLI](../../iam/operations/iam-token/create-for-sa#via-cli){% else %}с помощью CLI{% endif %}:
