...
В разделе ["Начало работы - Примеры YQL-запросов"](../quickstart/yql-api/ydb-ui.md) описано, как можно выполнять запросы к {{ ydb-full-name }} в [консоли {{ yandex-cloud }}](https://console.cloud.yandex.ru/).
