---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/ydb/cli-ref/v0/database/update/
---

# yc ydb v0 database update
...
`yc ydb v0 database update <DATABASE-NAME>|<DATABASE-ID> [Flags...] [Global Flags...]`
