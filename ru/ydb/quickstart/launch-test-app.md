...
1. {% if deploy != "arc" %}[Создайте виртуальную машину](../../compute/operations/vm-create/create-linux-vm){% else %}Создайте виртуальную машину{% endif %} в {{ yandex-cloud }}.
...
Если вашей базе данных присвоен публичный IP-адрес, вы можете пропустить шаги с созданием виртуальной машины и запускать тестовое приложение с удаленного хоста.
