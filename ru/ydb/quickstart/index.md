...
* Document API
    ...
    * {% if deploy != "arc" %}[Использование AWS CLI и AWS SDK](../quickstart/aws-instrument/setup.md){%else%}Использование AWS CLI и AWS SDK{% endif %} — используйте инструменты от AWS в режиме совместимости с AWS DynamoDB.
