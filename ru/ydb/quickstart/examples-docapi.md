...
В этом разделе вы узнаете как работать с Document API, совместимым с AWS DynamoDB. Вы попробуете создать таблицу, сохранить в нее данные, а затем прочитать их. 
