---
sourcePath: core/yql/reference/yql-docs-core-2/syntax/_includes/use.md
sourcePath: yql/reference/yql-docs-core-2/syntax/_includes/use.md
---

# USE

Указать «базу данных». Как правило, в её роли выступает один из кластеров YDB. Это указание будет использоваться по умолчанию для поиска таблиц в тех случаях, где база данных не указана явно.
