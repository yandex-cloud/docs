...
Из этого туториала вы узнаете, как выполнять базовые операции с данными в {{ ydb-short-name }}, и познакомитесь с синтаксисом YQL. [Создайте базу данных](../../operations/create_manage_database#create-db) и последовательно пройдите все шаги в [консоли управления](https://console.cloud.yandex.ru/), копируя YQL-инструкции в поле **Запрос**.
