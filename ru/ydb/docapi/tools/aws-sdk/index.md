...
- Java
  ...
  Подробнее об AWS SDK для Java читайте в [документации AWS]{% if lang == "en" %}(https://aws.amazon.com/sdk-for-java/){% endif %}{% if lang == "ru" %}(https://aws.amazon.com/ru/sdk-for-java/){% endif %}.
...
- PHP
  ...
  Подробнее об AWS SDK for PHP читайте в [документации AWS]{% if lang == "en" %}(https://aws.amazon.com/sdk-for-php/){% endif %}{% if lang == "ru" %}(https://aws.amazon.com/ru/sdk-for-php/){% endif %}.
...
- Node.js
  ...
  Подробнее об AWS SDK для Node.js читайте в [документации]{% if lang == "en" %}(https://aws.amazon.com/sdk-for-node-js/){% endif %}{% if lang == "ru" %}(https://aws.amazon.com/ru/sdk-for-node-js/){% endif %}.

- Ruby

  1. Установите [Ruby]{% if lang == "en" %}(https://www.ruby-lang.org/en/documentation/installation/){% endif %}{% if lang == "ru" %}(https://www.ruby-lang.org/ru/documentation/installation/){% endif %}.
  1. Установите [AWS SDK for Ruby](https://docs.aws.amazon.com/sdk-for-ruby/v3/developer-guide/setup-install.html).

  Подробнее об AWS SDK для Ruby читайте в [документации]{% if lang == "en" %}(https://aws.amazon.com/sdk-for-ruby/){% endif %}{% if lang == "ru" %}(https://aws.amazon.com/ru/sdk-for-ruby/){% endif %}.
