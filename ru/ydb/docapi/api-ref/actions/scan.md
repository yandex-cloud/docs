...
По умолчанию возвращает все элементы, но не более 1 Мб за раз. Если в таблице больше данных, то в параметре `LastEvaluatedKey` вернется последний первичный ключ, на котором остановилась операция сканирования. Его можно использовать для продолжения сканирования.
