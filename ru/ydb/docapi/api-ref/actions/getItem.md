...
`ConsistentRead` | Определение модели согласованносити чтения.<br/>Если `true`, то используется строго согласованное чтение; если `false` (по умолчанию), то используется последовательное чтение.<br/><br/>**Тип**: Boolean<br/>**Обязательно**: Нет
