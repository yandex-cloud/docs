...
На этой странице подробно разбирается код тестового приложения, доступного в составе Java SDK {{ ydb-short-name }}.
...
{% include [step-param-prep-queries-intro.md](example/step-param-prep-queries-intro.md) %}
...
{% include [step-multistep-transactions-intro.md](example/step-multistep-transactions-intro.md) %}
