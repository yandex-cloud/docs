---
sourcePath: core/reference/ydb-sdk/example/archive/example-go-v2.md
---
# Приложение на Go (архивная версия v2)

На этой странице подробно разбирается код [тестового приложения](https://github.com/yandex-cloud/ydb-go-sdk/tree/v2.11.2/example/basic_example_v1), доступного в составе [v2 Go SDK](https://github.com/yandex-cloud/ydb-go-sdk/tree/v2.11.2) YDB.
