---
sourcePath: overlay/reference/ydb-cli/commands/tools/dump.md
---
...
`--avoid-copy` | Не делать копию.<br/>По умолчанию, для уменьшения влияния на пользовательскую нагрузку и гарантии консистентности данных, YDB сначала делает копию таблицы, а затем — дамп копии. В некоторых случаях, например при дампе таблиц с внешними блобами, такой способ не подходит.
