---
sourcePath: overlay/reference/ydb-cli/commands/global-options.md
---
# Глобальные параметры

С помощью глобальных параметров команд YDB CLI вы можете указать эдпоинт, базу данных, подробность вывода, способ авторизации, профиль, а также получить справку {% if audience == "external" %}и информацию о лицензировании{% endif %}.
