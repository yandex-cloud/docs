...
С помощью глобальных параметров команд YDB CLI вы можете указать эдпоинт, базу данных, подробность вывода, способ авторизации, профиль, а также получить справку и информацию о лицензировании.
