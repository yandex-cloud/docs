---
sourcePath: ru/ydb/ydb-docs-core/ru/core/reference/ydb-cli/export_import/_includes/import-file.md
---
# Импорт данных из файла в существующую таблицу

С помощью подкоманды `import file` вы можете импортировать данные из [CSV](https://ru.wikipedia.org/wiki/CSV)- или [TSV](https://ru.wikipedia.org/wiki/TSV)-файлов в существующую таблицу.
