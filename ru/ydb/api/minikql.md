...
#### Ограничения, общая структура программы и параметры {#restrictions-general-program-structure-and-parameters}
...
### Операции, работающие с табличной базой {operations-that-work-with-a-table-base}

#### Чтение строки **SelectRow**(table,key,fields,[target]) {#reading-the-string-SelectRow}
...
#### Чтение диапазона строк **SelectRange**(table,range,fields,options,[target]) {#reading-a-range-of-rows-select-range}
table : Atom - имя таблицы
...
#### Обновление строки **UpdateRow**(table,key,update) {#updating-the-line-updaterow}
...
#### Стирание строки **EraseRow**(table,key) {#blurring-of-the-line-eraserow}
...
### Извлечение результата {#extract-result}
