### Представление MiniKQL в AST YQL {#introducing-minikqlin-ast-yql}

#### Общая структура программы {#general-program-structure}
...
#### Кодирование тегов схемы {#schema-tag-encoding}
...
#### Кодирование типов данных {#data-type-encoding}
...
#### Кодирование операций {#operations-coding}
...
(let z (Append (x y))
```
#### Литералы типов, не Data, а также типы {#type-literals-not-data-as-well-as-types}
...
#### Внешние параметры {#external-parameters}
...
```
### Примеры программ с форме C++ и AST {#examples}
...
```
#### Чтение интервала данных {#reading-data-interval}
``` cpp
auto kDbRoot = pgmBuilder.NewDbKey();
auto k1 = pgmBuilder.AddScalarTag(kDbRoot, 32);
auto k2 = pgmBuilder.AddScalarTag(k1, 33);
