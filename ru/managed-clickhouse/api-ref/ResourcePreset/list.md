    ...
    query:
      ...
      properties:
        pageSize:
          description: |-
            **string** (int64)
            ...
            results is larger than `pageSize`, the service returns a [ListResourcePresetsResponse.nextPageToken](/docs/managed-clickhouse/api-ref/ResourcePreset/list#yandex.cloud.mdb.clickhouse.v1.ListResourcePresetsResponse)
        ...
        pageToken:
          description: |-
            **string**
            Page token. To get the next page of results, Set `pageToken` to the [ListResourcePresetsResponse.nextPageToken](/docs/managed-clickhouse/api-ref/ResourcePreset/list#yandex.cloud.mdb.clickhouse.v1.ListResourcePresetsResponse)
