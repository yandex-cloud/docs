...
**rpc AddZookeeper ([AddClusterZookeeperRequest](#yandex.cloud.mdb.clickhouse.v1.AddClusterZookeeperRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## AddClusterZookeeperRequest {#yandex.cloud.mdb.clickhouse.v1.AddClusterZookeeperRequest}
...
```json
{
  ...
  "convert_tables_to_replicated": "google.protobuf.BoolValue"
}
```
...
Required field. ID of the ClickHouse cluster to modify.
...
|| convert_tables_to_replicated | **[google.protobuf.BoolValue](https://developers.google.com/protocol-buffers/docs/reference/csharp/class/google/protobuf/well-known-types/bool-value)**
...
|| metadata | **[AddClusterZookeeperMetadata](#yandex.cloud.mdb.clickhouse.v1.AddClusterZookeeperMetadata)**
...
## AddClusterZookeeperMetadata {#yandex.cloud.mdb.clickhouse.v1.AddClusterZookeeperMetadata}
