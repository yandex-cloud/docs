---
editable: false
sourcePath: en/_api-ref-grpc/mdb/clickhouse/v1/api-ref/grpc/Cluster/addZookeeper.md
---

# Managed Service for ClickHouse API, gRPC: ClusterService.AddZookeeper {#AddZookeeper}
...
```json
{
  ...
  "convertTablesToReplicated": "google.protobuf.BoolValue"
}
```
...
|| convertTablesToReplicated | **[google.protobuf.BoolValue](https://developers.google.com/protocol-buffers/docs/reference/csharp/class/google/protobuf/well-known-types/bool-value)**
