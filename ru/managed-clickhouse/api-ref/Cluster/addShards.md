...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-clickhouse/v1/clusters/{clusterId}/shards:batchCreate
    method: post
    path:
      type: object
      properties:
        ...
        shardSpecs:
          description: |-
            **[ShardSpec](/docs/managed-clickhouse/api-ref/Cluster/create#yandex.cloud.mdb.clickhouse.v1.ShardSpec)**
            ...
            If [ShardSpec.configSpec](/docs/managed-clickhouse/api-ref/Cluster/create#yandex.cloud.mdb.clickhouse.v1.ShardSpec) is not specified for some shard, for this shard
