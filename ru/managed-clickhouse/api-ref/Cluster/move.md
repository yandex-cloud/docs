---
editable: false
sourcePath: en/_api-ref/mdb/clickhouse/api-ref/Cluster/move.md
---
...
--- | ---
clusterId | <p>Required. ID of the ClickHouse cluster to move.</p> <p>The maximum string length in characters is 50.</p> 
