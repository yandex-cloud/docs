...
# Managed Service for ClickHouse API, REST: Cluster.GetShard {#GetShard}
...
To get the name of the database, use a [ClusterService.List](/docs/managed-clickhouse/api-ref/Cluster/list#List) request. ||
|| shardName | **string**
