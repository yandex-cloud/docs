...
1. Получите ссылку на архив с геобазой.
...
- API
    ...
    Воспользуйтесь методом API [update](../api-ref/Cluster/update.md) и передайте в запросе ссылку на архив с геобазой в {{ objstorage-name }} в параметре `geobaseUri`.
...
- Консоль управления
    ...
    1. Очистите значение параметра в поле **Geobase uri**
...
- {{ TF }}
    ...
    1. Удалите из описания кластера {{ mch-name }} параметр `geobase_uri` с ссылкой на архив с подключаемой геобазой.
...
- API
    ...
    Для очистки ссылки на архив с геобазой в {{ objstorage-name }} воспользуйтесь методом API [update](../api-ref/Cluster/update.md), передав в запросе пустое значение параметра `"geobaseUri": ""`.
