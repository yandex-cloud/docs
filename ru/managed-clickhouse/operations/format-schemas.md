...
- API
    ...
    Воспользуйтесь методом API [create](../api-ref/FormatSchema/create.md) и передайте в запросе:
...
- API
    ...
    Воспользуйтесь методом API [update](../api-ref/FormatSchema/update.md) и передайте в запросе:
...
- API
    ...
    Воспользуйтесь методом API [delete](../api-ref/FormatSchema/delete.md) и передайте в запросе:
...
- API
    ...
    Воспользуйтесь методом API [list](../api-ref/FormatSchema/list.md) и передайте в запросе идентификатор кластера в параметре `clusterId`.
...
- API
    ...
    Воспользуйтесь методом API [get](../api-ref/FormatSchema/get.md) и передайте в запросе:
