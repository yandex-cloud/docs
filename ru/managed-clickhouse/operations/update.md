...
* Консоль управления
    ...
    1. Выберите нужный сервисный аккаунт из списка или создайте новый. Подробнее о настройке сервисного аккаунта см. в разделе [{#T}](s3-access.md).
        ...
        Если кластер уже использует объекты из {{ objstorage-name }}, доступ к которым осуществляется с помощью сервисного аккаунта, то смена текущего сервисного аккаунта на другой может привести к недоступности этих объектов и нарушению работы кластера. Удалите такие объекты перед сменой аккаунтов.
