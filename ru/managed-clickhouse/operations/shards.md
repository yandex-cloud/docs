...
Кластеры Managed Service for ClickHouse создаются с конфигурацией одного шарда. Чтобы начать непосредственно шардирование данных, следуйте инструкциям в разделе [#T](../tutorials/sharding.md).
