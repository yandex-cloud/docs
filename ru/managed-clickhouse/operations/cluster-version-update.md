...
Вы можете изменить версию {{ CH }}, которую использует кластер.
...
Если кластер использует [гибридное хранилище](../concepts/storage.md#hybrid-storage-features), то минимальный номер версии, на который можно изменить версию кластера — 20.6.
