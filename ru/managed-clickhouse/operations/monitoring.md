...
Вы можете отслеживать состояние кластера {{ mch-name }} и отдельных его хостов с помощью инструментов мониторинга в [консоли управления]({{ link-console-main }}). Эти инструменты предоставляют диагностическую информацию в виде графиков.
