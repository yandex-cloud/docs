...
Вы можете управлять базами данных кластера одним из двух способов:
...
## Управление базами данных с помощью SQL {#sql-database-management}

Чтобы управлять базами данных с помощью SQL, [создайте кластер через API](cluster-create.md) с включенной настройкой **sqlDatabaseManagement**. В таком кластере:
- Базами данных можно управлять только с помощью SQL.
...
Подробнее об управлении базами данных с помощью SQL см. в [документации {{ CH }}](https://clickhouse.tech/docs/ru/sql-reference/statements/create/database/).
