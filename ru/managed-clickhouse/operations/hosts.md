...
В кластере с отключенным [сервисом координации](../concepts/coordination-system.md) или встроенным {{ CK }} невозможно создать хост в существующем шарде. Сначала [включите сервис координации](update.md#enable-coordination) {{ CK }} или {{ ZK }} на отдельных хостах.
