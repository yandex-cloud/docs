...
- Консоль управления
  ...
  1. В блоке **Хосты** укажите параметры хостов БД, создаваемых вместе с кластером. Чтобы изменить добавленный хост, наведите курсор на строку хоста и нажмите значок ![image](../../_assets/pencil.svg).
     ...
     - Если вы планируете использовать гибридное хранилище на стадии [Preview](../../overview/concepts/launch-stages.md), то в кластере должен быть только один хост. 
...
- Terraform
  ...
  Чтобы создать кластер:
    ...
    1. Опишите в конфигурационном файле параметры ресурсов, которые необходимо создать:
       ...
       * Кластер базы данных — описание кластера и его хостов. При необходимости здесь же можно задать [настройки СУБД](../concepts/settings-list.md#dbms-cluster-settings).
