---
title: "Остановка и запуск {{ CH }} кластера"
description: "При необходимости вы можете остановить {{ CH }}-кластер БД и запустить его заново. Время простоя кластера не тарифицируется: вы продолжаете платить только за размер хранилища и резервных копий."
---
