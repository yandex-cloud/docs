---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/managed-clickhouse/cli-ref/v0/cluster/add-external-dictionary
editable: false
---

# yc managed-clickhouse v0 cluster add-external-dictionary
