...
Создайте таблицу `tutorial.hits_v1`, которая использует гибридное хранилище. Для этого выполните SQL-запрос, подставив вместо `<схема>` схему таблицы из [документации {{ CH }}](https://{{ ch-domain }}/docs/ru/getting-started/tutorial/#create-tables):
...
Подробнее см. [в документации {{ CH }}](https://{{ ch-domain }}/docs/ru/getting-started/tutorial/#import-data).
