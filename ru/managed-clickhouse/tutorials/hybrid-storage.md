...
1. Познакомьтесь с тестовым набором данных:
   ...
   Таблица `tutorial.hits_v1` будет [настроена при создании](#create-table) таким образом, чтобы все <q>свежие</q> данные в таблице с 21 марта 2014 года и позже попали в сетевое хранилище, а более старые данные (с 17 марта по 20 марта 2014 года) — в объектное хранилище.   
