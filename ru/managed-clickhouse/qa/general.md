...
Managed Service for ClickHouse доступен всем зарегистрированным пользователям Яндекс.Облака.
...
Для хранилища на NVMe-дисках количество хостов ограничено при создании: для ClickHouse-кластеров можно создать не меньше 2 хостов.
...
Managed Service for ClickHouse использует последнюю стабильную версию ClickHouse.
...
Через месяц после того, как версия СУБД становится неподдерживаемой, Managed Service for ClickHouse автоматически оповещает владельцев кластеров БД, созданных с этой версией, по электронной почте.
