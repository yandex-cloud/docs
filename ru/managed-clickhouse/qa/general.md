...
- при использовании сетевого нереплицируемого хранилища (`ssd-network-nonreplicated`) — не менее 3;
- при использовании быстрого локального хранилища (`local-ssd`) — не менее 2;
