...
Включите в настройках кластера опцию [{#T}](../operations/cluster-users.md#sql-user-management) и выдайте пользователю нужные права [с помощью выражения](https://clickhouse.com/docs/ru/sql-reference/statements/grant/) `GRANT`.
