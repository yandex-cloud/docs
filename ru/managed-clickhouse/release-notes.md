...
* Добавлена возможность создания кластера из резервной копии в {{ TF }}.
...
* Доступна новая версия {{ CH }}: [26.5](https://clickhouse.com/blog/clickhouse-release-26-05)
...
* Сервис координации {{ CK }} теперь доступен всем пользователям {{ mch-name }} и используется по умолчанию в новых кластерах. Также добавлена возможность создавать в кластере отдельные хосты с {{ CK }}. Подробнее о {{ CK }} в разделе [Репликация](concepts/replication.md#ck).
