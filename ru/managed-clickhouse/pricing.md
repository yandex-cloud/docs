...
* 1 час использования ядра хоста {{ CH }} с 100% vCPU — 2,28 ₽;
* 1 час использования 1 ГБ RAM хоста {{ CH }} — 0,52 ₽;
* 1 час использования ядра хоста {{ ZK }} с 50% vCPU — 0,78 ₽;
* 1 час использования 1 ГБ RAM хоста {{ ZK }} — 0,32 ₽;
* 1 месяц использования 1 ГБ хранилища на сетевых HDD-дисках (`network-hdd`) — 3,20 ₽.

Стоимость часа работы хостов: `3 × (2 × 2,28 ₽ + 8 × 0,52 ₽) + 3 × (2 × 0,78 ₽ + 4 × 0,32 ₽) = 34,68 ₽`

Общая стоимость кластера в месяц (хосты и хранилище): `720 × 34,68 ₽ + 100 × 3,20 ₽ = 25 289,6 ₽`
