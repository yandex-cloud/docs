...
Вы можете получить гарантированную скидку за потребление ресурсов сервиса, запланированное на год или на три года вперед. Чтобы  увидеть ресурсы, для которых можно получить такую скидку:

1. Перейдите в раздел [Биллинг](https://console.cloud.yandex.ru/billing).
...
- За месяц работы хоста
  ...
  **Intel Cascade Lake** |
  ...
  {{ b2-micro }} | 850 ₽ | − | −
  {{ b2-medium }} | 1 570 ₽ | − | −
  {{ m2-micro }} | 5 540 ₽ | 3 686 ₽ | 2 822 ₽
  {{ m2-small }} | 11 080 ₽ | 7 373 ₽ | 5 645 ₽
  {{ m2-medium }}| 16 620 ₽ | 11 059 ₽ | 8 467 ₽
  {{ m2-large }} | 22 160 ₽ | 14 746 ₽ | 11 290 ₽
  {{ m2-xlarge }} | 33 240 ₽ | 22 118 ₽ | 16 934 ₽
  {{ m2-2xlarge }} | 44 320 ₽ | 29 491 ₽ | 22 579 ₽
  {{ m2-3xlarge }} | 66 479 ₽ | 44 237 ₽ | 33 869 ₽
  {{ m2-4xlarge }} | 88 639 ₽ | 58 982 ₽ | 45 158 ₽
  {{ m2-5xlarge }} | 110 798 ₽ | 73 728 ₽ | 56 448 ₽
  {{ m2-6xlarge }} | 132 958 ₽ | 88 474 ₽ | 67 738 ₽
  {{ m2-7xlarge }} | 154 829 ₽ | 103 219 ₽ | 79 027 ₽
  {{ m2-8xlarge }} | 176 947 ₽ | 117 965 ₽ | 90 317 ₽
  {{ s2-micro }} | 3 629 ₽ | 2 477 ₽ | 1 901 ₽
  {{ s2-small }} | 7 258 ₽ | 4 954 ₽ | 3 802 ₽
  {{ s2-medium }} | 14 515 ₽ | 9 907 ₽ | 7 603 ₽
  {{ s2-large }} | 21 773 ₽ | 14 861 ₽ | 11 405 ₽
  {{ s2-xlarge }} | 29 030 ₽ | 19 814 ₽ | 15 206 ₽
  {{ s2-2xlarge }} | 43 546 ₽ | 29 722 ₽ | 22 810 ₽
  {{ s2-3xlarge }} | 58 061 ₽ | 39 629 ₽ | 30 413 ₽
  {{ s2-4xlarge }} | 72 576 ₽ | 49 536 ₽ | 38 016 ₽
  {{ s2-5xlarge }} | 87 091 ₽ | 59 443 ₽ | 45 619 ₽
  {{ s2-6xlarge }} | 116 122 ₽ | 79 258 ₽ | 60 826 ₽
