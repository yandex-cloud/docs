...
Подробнее о работе с распределенными таблицами см. в [документации {{ CH }}](https://{{ ch-domain }}/docs/ru/engines/table-engines/special/distributed/).
