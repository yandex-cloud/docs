...
- По умолчанию эти хосты создаются с минимальным [классом хостов](instance-types.md). Но вы можете задать нужный класс хостов {{ ZK }} при [создании](../operations/cluster-create.ru) кластера или при [включении отказоустойчивости для кластера](../operations/zk-hosts.md#add-zk).
