---
title: "Классы хостов Managed Service for ClickHouse"
description: "Класс хостов определяет вычислительные мощности, которые выделяются для каждого хоста в кластере ClickHouse. При изменении класса хостов для кластера меняются характеристики всех уже созданных в нем хостов. Доступный объем хранилища не зависит от класса хостов."
---
...
Доступные [типы хранилища](./storage.md) зависят от выбранного класса хостов. Ограничения на объем хранилища приведены в разделе [{#T}](limits.md).
