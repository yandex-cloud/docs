---
title: Управление пользователями и правами доступа в {{ mch-name }}
description: 'В {{ mch-full-name }} возможности управления правами доступа зависят от выбранного способа управления пользователями: через интерфейсы {{ yandex-cloud }} или через SQL.'
---
...
* [Управление через интерфейсы](#yandex-cloud-user-management) {{ yandex-cloud }} ([консоль управления]({{ link-console-main }}), [CLI](../../cli/index.yaml), {{ TF }} и [API](../../glossary/rest-api.md)) — позволяет управлять доступом пользователей к базам данных с использованием возможностей сервиса {{ mch-name }}.
