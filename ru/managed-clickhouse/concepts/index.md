...
* Кластер из одного хоста не обеспечивает отказоустойчивость.
    ...
    В таком кластере можно позднее [включить поддержку отказоустойчивости и репликации](../operations/zk-hosts.md#add-zk). Это позволит добавить в кластер несколько хостов {{ CH }}.
