...
{{ CK }} или хосты {{ ZK }} управляют репликацией и распределением запросов по хостам кластера. Подробнее см. в разделе [{#T}](./replication.md).
