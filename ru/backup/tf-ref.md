# Справочник ресурсов {{ backup-full-name }} провайдера {{ TF }}
...
| --- | --- |
| [yandex_backup_policy]({{ tf-provider-resources-link }}/backup_policy) | [Политики резервного копирования](./concepts/policy.md) |