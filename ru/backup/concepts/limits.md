...
description: В сервисе {{ backup-name }} действуют квоты на количество защищаемых ресурсов и суммарный размер резервных копий. Более подробно об ограничениях в сервисе вы узнаете из данной статьи.
editable: false
---
