...
Резервные копии [защищаемых ресурсов](./index.md#protected-resources) создаются в {{ backup-name }} автоматически в соответствии с _политиками резервного копирования_.
...
По умолчанию защищаемые ресурсы {{ backup-name }} не связаны ни с одной политикой резервного копирования. Чтобы начать создавать резервные копии, [привяжите](./vm-connection/index.md) ваш ресурс к одной или нескольким политикам.

В политике вы указываете:

* Тип создаваемых копий: полные или инкрементальные. Подробнее в разделе [{#T}](backup.md#types).
