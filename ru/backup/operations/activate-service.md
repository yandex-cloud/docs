...
- Консоль управления {#console}
  ...
  1. В [консоли управления]({{ link-console-main }}) выберите каталог, в котором вы хотите создать [защищаемый ресурс](../concepts/index.md#protected-resources) с подключением к {{ backup-name }}.
