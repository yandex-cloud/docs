...
- Консоль управления
  ...
  1. В блоке **Виртуальные машины** нажмите кнопку ![image](../../../_assets/plus-sign.svg) **Привязать ВМ**.
...
- Консоль управления
  ...
  1. В блоке **Виртуальные машины** напротив ВМ, которую нужно отвязать от политики, нажмите ![options](../../../_assets/options.svg) и выберите **Отвязать от политики**.
