...
Сервис находится на [стадии Preview](../overview/concepts/launch-stages.md) и доступен для [виртуальных машин {{ compute-name }}](../compute/concepts/vm.md) с операционными системами Ubuntu (версии 20.04 или ниже) или CentOS, установленными из [{{ marketplace-name }}]({{ link-cloud-marketplace }}).
...
- Консоль управления
    ...
    1. В блоке **Сетевые настройки**:
        * Выберите [облачную сеть](../vpc/concepts/network.md#network) и [подсеть](../vpc/concepts/network.md#subnet), к которым нужно подключить ВМ. Если сети нет, нажмите ![plus-sign](../_assets/plus-sign.svg) **Создать сеть**:
        ...
        * В поле **Публичный адрес** выберите опцию **Автоматически**.
    ...
    1. В блоке **Доступ** укажите данные для доступа на ВМ:
        * Выберите сервисный аккаунт с ролью `backup.editor`.
...
Чтобы добавить ВМ в политику резервного копирования:
