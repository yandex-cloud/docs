...
--- | ---
backupId | <p>Required. Backup ID that will be applied to destination Compute Cloud instance.</p> 
...
Field | Description
--- | ---
computeInstanceId | **string**<br><p>Required. Destination Compute Cloud instance ID to which backup should be applied.</p> <p>The maximum string length in characters is 50.</p> 
