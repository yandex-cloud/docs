...
С 1 апреля 2024 года вводится почасовая тарификация ВМ, подключенных к {{ backup-name }}. Цена за месяц использования останется прежней и будет формироваться из расчета 720 часов в месяц.
