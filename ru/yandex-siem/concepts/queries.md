---
title: Запросы в {{ yandex-siem-full-name }}
description: Запросы в {{ yandex-siem-full-name }} используют язык KQL для поиска и анализа событий безопасности.
---
...
Для поиска событий в {{ yandex-siem-full-name }} используется подмножество языка запросов [KQL (Kusto Query Language)](../kql-reference.md). KQL позволяет фильтровать, агрегировать и анализировать события безопасности за последние 90 дней.
...
Подробнее о синтаксисе используемого подмножества KQL смотрите [{#T}](../kql-reference.md).
