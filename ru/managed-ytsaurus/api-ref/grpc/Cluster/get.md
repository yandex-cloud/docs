...
**rpc Get ([GetClusterRequest](#yandex.cloud.ytsaurus.v1.GetClusterRequest)) returns ([Cluster](#yandex.cloud.ytsaurus.v1.Cluster))**

## GetClusterRequest {#yandex.cloud.ytsaurus.v1.GetClusterRequest}
