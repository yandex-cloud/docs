...
editable: false
apiPlayground:
  - url: https://ytsaurus.{{ api-host }}/ytsaurus/v1/clusters/{clusterId}:stop
    method: post
    path:
      type: object
      properties:
    ...
    body: null
    definitions: null
sourcePath: en/_api-ref/ytsaurus/v1/api-ref/Cluster/stop.md
---

# Ytsaurus API, REST: Cluster.Stop
...
```
POST https://ytsaurus.{{ api-host }}/ytsaurus/v1/clusters/{clusterId}:stop
```
