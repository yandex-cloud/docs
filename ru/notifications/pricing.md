...
### Тарификация пакетов SMS-уведомлений {#prices-sms}

{% note warning %}

С 2 июня 2026 вступят в действие новые цены на обработку событий по отправке SMS-уведомлений.

{% endnote %}

Обработка событий для отправки SMS-уведомлений тарифицируется пакетами. Стоимость зависит от мобильного оператора, типа SMS и размера пакета.
...
- Цены в рублях {#prices-rub}
  ...
  {% include [rub-sms-packages](../_pricing/notifications/rub-sms-packages.md) %}

- Цены в тенге {#prices-kzt}

  {% include [kzt-sms-packages](../_pricing/notifications/kzt-sms-packages.md) %}
