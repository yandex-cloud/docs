...
Полный список исходных данных для каждого канала уведомлений приведен в разделе [{#T}](../operations/push/channel-create.md). Данные для аутентификации можно получить в консоли разработчика соответствующей мобильной платформы.
