---
title: Как начать работать с AWS SDK для Python (boto3) в {{ cns-full-name }}
description: Следуя данной инструкции, вы научитесь работать с AWS SDK для Python (boto3) в {{ cns-full-name }}.
---
