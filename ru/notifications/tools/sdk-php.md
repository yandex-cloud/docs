---
title: Как начать работать с AWS SDK для PHP в {{ cns-full-name }}
description: Следуя данной инструкции, вы научитесь работать с AWS SDK для PHP в {{ cns-full-name }}.
---
