...
--- | ---
clusterId | <p>Required. ID of the Kubernetes cluster to start. To get Kubernetes cluster ID use a <a href="/docs/managed-kubernetes/managed-kubernetes/api-ref/Cluster/list">list</a> request.</p> 
