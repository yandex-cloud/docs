        ...
        pageSize:
          description: |-
            **string** (int64)
            ...
            the service returns a [ListClusterNodesResponse.nextPageToken](/docs/managed-kubernetes/managed-kubernetes/api-ref/Cluster/listNodes#yandex.cloud.k8s.v1.ListClusterNodesResponse)
