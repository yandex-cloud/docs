---
editable: false
sourcePath: en/_api-ref-grpc/k8s/v1/managed-kubernetes/api-ref/grpc/Operation/cancel.md
---

# Managed Services for Kubernetes API, gRPC: OperationService.Cancel {#Cancel}
