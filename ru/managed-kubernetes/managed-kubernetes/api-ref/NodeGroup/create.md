...
Field | Description
--- | ---
clusterId | **string**<br><p>Required. ID of the Kubernetes cluster to create a node group in. To get the Kubernetes cluster ID, use a <a href="/docs/managed-kubernetes/managed-kubernetes/api-ref/Cluster/list">list</a> request.</p> 
