...
--- | ---
nodeGroupId | <p>Required. ID of the node group to delete. To get node group ID use a <a href="/docs/managed-kubernetes/managed-kubernetes/api-ref/NodeGroup/list">list</a> request.</p> 
