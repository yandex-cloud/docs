...
--- | ---
nodeGroupId | <p>Required. ID of the node group to list. To get the node group ID use a <a href="/docs/managed-kubernetes/managed-kubernetes/api-ref/NodeGroup/list">list</a> request.</p> 
...
pageToken | <p>Page token. To get the next page of results, set ``page_token`` to the <a href="/docs/managed-kubernetes/managed-kubernetes/api-ref/NodeGroup/listNodes#responses">nextPageToken</a> returned by a previous list request.</p> <p>The maximum string length in characters is 100.</p> 
