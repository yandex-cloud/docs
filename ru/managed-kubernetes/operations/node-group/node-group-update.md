...
Если вы хотите изменить [зону доступности](../../../overview/concepts/geo-scope.md) для группы узлов, [перенесите группу](../../tutorials/migration-to-an-availability-zone.md) в другую зону.
