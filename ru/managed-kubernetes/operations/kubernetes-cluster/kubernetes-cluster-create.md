...
- Terraform
  ...
  1. Подтвердите создание ресурсов: введите в терминал слово `yes` и нажмите **Enter**:
     ...
     Terraform создаст все требуемые ресурсы. В результате выполнения команды, в консоли отобразится содержимое файла конфигурации `kubeconfig` — его можно использовать с [kubectl]{% if lang == "ru" %}(https://kubernetes.io/ru/docs/tasks/tools/install-kubectl/){% endif %}{% if lang == "en" %}(https://kubernetes.io/docs/tasks/tools/install-kubectl/){% endif %}.
