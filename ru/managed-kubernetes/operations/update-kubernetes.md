  ...
  * Чтобы настроить ежедневные обновления, добавьте блок `dailyMaintenanceWindow`:
    ...
    "dailyMaintenanceWindow": {
      "startTime": {
        ...
        "nanos": "<тысячная_доля_секунды_начала_обновления>"
      },
...
- API
  ...
  * Чтобы настроить обновление в выбранные дни, добавьте блок `weeklyMaintenanceWindow`:
  ...
  ```json
  "deployPolicy": {
    "maxUnavailable": "<максимальное_количество_ВМ,_на_которое_можно_превысить_размер_группы_узлов>",
    "maxExpansion": "<максимальное_количество_ВМ,_на_которое_можно_уменьшить_размер_группы_узлов>"
  }
  ```
