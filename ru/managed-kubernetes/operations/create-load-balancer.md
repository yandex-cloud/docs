...
Когда вы создаете сервис с типом `LoadBalancer`, контроллер Яндекс.Облака создает и настраивает для вас [сетевой балансировщик нагрузки](../../load-balancer/concepts/index.md) в вашем каталоге с публичным IP-адресом. С
