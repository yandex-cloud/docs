...
1. [Создайте базу данных](../../../ydb/operations/manage-database.md#create-db-dedicated) подходящей вам конфигурации с [типом БД](../../../ydb/concepts/serverless-and-dedicated.md) `Dedicated`.
