...
Статические файлы конфигурации позволяют получить доступ к кластеру {{ k8s }} без использования CLI, например из систем непрерываной интеграции.
...
1. Узнайте уникальный идентификатор кластра {{ k8s }}: 
