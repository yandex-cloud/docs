...
В кластере без предустановленного CNI {{ managed-k8s-name }} управляет мастером и группами узлов. Вы отвечаете за выбор, установку, настройку и обновление сетевого плагина, а также за его работоспособность и совместимость с конфигурацией кластера.

Перед запуском приложений установите и настройте CNI. При изменении сетевой конфигурации и обновлении кластера учитывайте требования выбранного плагина.
