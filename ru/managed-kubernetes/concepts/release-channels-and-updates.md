...
`stable`| 1.17, 1.18, 1.19, 1.20, 1.21 | Можно отключить автообновления. | Содержит стабильную версию {{ k8s }}. На канале происходят только обновления, касающиеся исправления ошибок или улучшения безопасности.
...
* Для групп узлов с выключенным автоматическим обновлением:
    * Если версия {{ k8s }} 1.16 или выше, то принудительно за неделю до истечения срока действия сертификата.
    ...
    * Для версий {{ k8s }} ниже чем 1.16 при любом обновлении.
