...
Подробнее в разделе [{#T}](../operations/volumes/volume-expansion.md).
...
Подробнее об использовании зашифрованных дисков смотрите на странице [{#T}](../operations/volumes/encrypted-disks.md).
