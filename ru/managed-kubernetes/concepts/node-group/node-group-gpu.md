...
* Кластер в зонах `{{ region-id }}-a` и `{{ region-id }}-b`.

  ВМ с GPU доступны в этих [зонах](../../../overview/concepts/geo-scope.md). Запрашивая квоту GPU, учитывайте, в каких зонах вы собираетесь запускать кластеры {{ k8s }}.
