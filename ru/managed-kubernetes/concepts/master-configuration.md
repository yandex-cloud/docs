...
#|
|| **Параметры кластера** {.cell-align-top-center} | > | > | **Расчетные требования к мастеру** {.cell-align-top-center} | > | **Рекомендуемая конфигурация мастера** {.cell-align-top-center} | > | > ||
