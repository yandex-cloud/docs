...
1. Создайте кластер {{ k8s }} и группу узлов.
   ...
   Вы можете использовать уже работающий кластер и группу узлов {{ k8s }} или создать новые. {% if product == "cloud-il" %}Убедитесь, что в поле **Версия {{ k8s }}** выбрана версия 1.18 или выше.{% endif %}
