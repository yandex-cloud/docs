...
1. В блоке **Сетевые настройки кластера**:
    ...
    - (опционально) Укажите **Адрес шлюза** — если вы не хотите создавать узлы с публичным IP-адресом, [настройте ВМ в качестве NAT-шлюза](operations/nat-instance.md) и укажите здесь внутренний IP-адрес этой ВМ.
1. Нажмите кнопку **Создать кластер**.
