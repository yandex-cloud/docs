---
title: "Начало работы с управляемым Kubernetes"
description: "В этой инструкции вы создайте кластер Kubernetes и группу узлов, научитесь управлять ими с помощью kubectl — командной оболочки Kubernetes. Для начала создайте кластер Kubernetes, добавьте учетные данные в конфигурационный файл kubectl, создайте группу узлов."
---
...
1. Установите [Kubernetes CLI (kubectl)]{% if region == "int" %}(https://kubernetes.io/docs/tasks/tools/install-kubectl/){% else %}(https://kubernetes.io/ru/docs/tasks/tools/install-kubectl/){% endif %}.
