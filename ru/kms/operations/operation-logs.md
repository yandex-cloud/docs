# Посмотреть операции с ресурсами сервиса {{ kms-name }}
...
- Консоль управления {#console}
  ...
  1. В [консоли управления]({{ link-console-main }}) выберите каталог, в котором находится симметричный ключ.
  ...
  1. Перейдите на панель **{{ ui-key.yacloud.common.operations-key-value }}** для выбранного ключа.
