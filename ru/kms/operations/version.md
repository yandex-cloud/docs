...
Версии ключей можно делать основными (основная версия по умолчанию ключа используется для шифрования и расшифровки) и удалять. Чтобы создать новую версию ключа, [ротируйте](key.md#rotate) его.
