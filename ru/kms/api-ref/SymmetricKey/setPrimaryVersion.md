...
Параметр | Описание
--- | ---
keyId | Обязательное поле. Идентификатор ключа, для которого нужно установить основную версию.  Максимальная длина строки в символах — 50.
...
Поле | Описание
--- | ---
versionId | **string**<br><p>Обязательное поле. Идентификатор версии, которая должна стать основной для указанного ключа.</p> <p>Максимальная длина строки в символах — 50.</p> 
