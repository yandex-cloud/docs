...
Поле | Описание
--- | ---
aadContext | **string** (byte)<br><p>Дополнительные аутентификационные данные (AAD-контекст), должны быть такими же, как они были переданы в соответствующем запросе <code>SymmetricEncryptRequest</code>. Должен быть в кодировке base64.</p> <p>Максимальная длина строки в символах — 8192.</p> 
