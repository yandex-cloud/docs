---
editable: false
sourcePath: en/_api-ref-grpc/kms/v1/api-ref/grpc/SymmetricKey/setAccessBindings.md
---

# Key Management Service API, gRPC: SymmetricKeyService.SetAccessBindings {#SetAccessBindings}
