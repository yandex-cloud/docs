---
editable: false
sourcePath: en/_api-ref-grpc/kms/v1/api-ref/grpc/SymmetricKey/listAccessBindings.md
---

# Key Management Service API, gRPC: SymmetricKeyService.ListAccessBindings
