...
# Key Management Service API, REST: AsymmetricEncryptionKey.UpdateAccessBindings {#UpdateAccessBindings}
...
```
POST https://{{ api-host-kms }}/kms/v1/asymmetricEncryptionKeys/{resourceId}:updateAccessBindings
```
