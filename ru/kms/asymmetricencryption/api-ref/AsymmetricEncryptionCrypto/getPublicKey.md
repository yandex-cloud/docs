...
editable: false
apiPlayground:
  - url: https://{{ api-host-kms-symcrypto }}/kms/v1/asymmetricEncryptionKeys/{keyId}/publicKey
    method: get
    path:
      type: object
      properties:
...
```
GET https://{{ api-host-kms-symcrypto }}/kms/v1/asymmetricEncryptionKeys/{keyId}/publicKey
```
