...
* Идентификатор – уникальный идентификатор ключа в Яндекс.Облаке. Используется для работы с ключами с помощью SDK, API и CLI.
...
* Статус — текущее состояние ключа. Возможные статусы: 
    ...
    * `Active` — ключ может использоваться для шифрования и дешифрования.
