...
Удалить организацию нельзя. Если организация не используется, [удалите аккаунты всех пользователей](edit-account.md) и [выйдите из организации](manage-organizations.md).
