...
- Интерфейс {{ org-name }}
  ...
  1. В строке пользователя нажмите ![icon-context-menu](../_assets/horizontal-ellipsis.svg) и выберите **Назначить роли**.
  
  1. В окне **Настройка прав доступа** нажмите **Добавить роль** и введите название роли или выберите роль в списке.
