---
editable: false
sourcePath: en/_cli-ref/cli-ref/organization-manager/cli-ref/idp/application/saml/application/update.md
---
...
|`--new-name`|<b>`string`</b><br/>A new name of the SAML application.|
