---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/organization-manager/cli-ref/v0/idp/application/saml/application/set-access-bindings
editable: false
---

# yc organization-manager v0 idp application saml application set-access-bindings

Set access bindings for the specified SAML application

#### Command Usage

Syntax:

`yc organization-manager idp application saml application set-access-bindings <SAML-APPLICATION-ID> [Flags...] [Global Flags...]`
