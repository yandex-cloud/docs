...
description: В статье содержатся правила тарификации сервиса {{ org-full-name }}.
---
  ...
  - type: card-layout-block
    ...
    children:
      - type: basic-card
        ...
        url: https://yandex.cloud/ru/prices?state=4e2cc7de21e6#calculator
        size: s
        border: shadow
        centered: true
        indent:
      ...
      - type: basic-card
        ...
        urlTitle: Прайс-лист
        url: https://yandex.cloud/ru/price-list?services=dn2rbtyqhowkmimgqc5u
        size: s
        border: shadow
        centered: true
        indent:
...
[Управлять тарификацией](#pricing-management) сервиса {{ org-full-name }} вы можете через [интерфейс {{ cloud-center }}]({{ link-org-cloud-center }}). Подробнее читайте в разделе [{#T}](./operations/manage-billing.md).
