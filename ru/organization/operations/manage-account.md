...
- Интерфейс {{ cloud-center }} {#cloud-center}
  ...
  Чтобы посмотреть логи всех пользователей [организации](../concepts/organization.md) или [пула](../concepts/user-pools.md), в которых вы являетесь администратором, смотрите страницу [{#T}](./user-pools/user-get-logs.md).
