---
title: Как получить информацию об SAML-приложении в {{ org-full-name }}
description: Следуя данной инструкции, вы получите информацию об SAML-приложении в {{ org-full-name }}.
---

# Получить информацию об SAML-приложении в {{ org-full-name }}
...
- {{ TF }} {#tf}
  ...
  1. Добавьте в конфигурационный файл {{ TF }} блоки `data` и `output`:
     ...
     * `output` — выходные переменные, которые содержат информацию о приложении:
     ...
     Вместо указанных параметров вы можете выбрать любые другие для получения информации. Более подробно о параметрах источника данных `yandex_organizationmanager_idp_application_saml_application` см. в [документации провайдера]({{ tf-provider-datasources-link }}/organizationmanager_idp_application_saml_application).
