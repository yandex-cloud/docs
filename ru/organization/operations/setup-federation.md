...
Чтобы пользователи могли авторизоваться в облаке с использованием созданной федерации:

* [Передайте сертификат IdP-сервера в федерацию](#add-certificate-fed).
* [Передайте сертификат федерации на IdP-сервер](#add-certificate-idp).
* [Настройте SAML на стороне IdP-сервера](#configure-sso).
* [Настройте сопоставление атрибутов пользователей](#claims-mapping).
* [Добавьте пользователей в организацию](./add-account.md#user-sso).
