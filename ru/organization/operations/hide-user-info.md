...
По умолчанию все пользователи организации {{ org-full-name }} могут просматривать информацию о всех остальных пользователях этой же организации. Вы можете ограничить эту возможность, разрешив просмотр информации только отдельным пользователям. Ограничение видимости пользователей будет работать только внутри {{ yandex-cloud }}. Во внешних сервисах это ограничение действовать не будет.
