...
# Identity Provider API, gRPC: UserService.SetOthersPassword

Sets the password for another user.

## gRPC request

**rpc SetOthersPassword ([SetOthersPasswordRequest](#yandex.cloud.organizationmanager.v1.idp.SetOthersPasswordRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## SetOthersPasswordRequest {#yandex.cloud.organizationmanager.v1.idp.SetOthersPasswordRequest}
...
|| response | **[SetOthersPasswordResponse](#yandex.cloud.organizationmanager.v1.idp.SetOthersPasswordResponse)**
...
## SetOthersPasswordResponse {#yandex.cloud.organizationmanager.v1.idp.SetOthersPasswordResponse}

Response for the [UserService.SetOthersPassword](#SetOthersPassword) operation.
