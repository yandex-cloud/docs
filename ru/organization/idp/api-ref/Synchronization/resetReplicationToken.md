...
editable: false
apiPlayground:
  - url: https://organization-manager.{{ api-host }}/organization-manager/v1/idp/synchronization-settings:resetReplicationToken
    method: post
    path: null
    query: null
    body:
...
|| metadata | **[ResetReplicationTokenMetadata](#yandex.cloud.organizationmanager.v1.idp.ResetReplicationTokenMetadata)**
...
## ResetReplicationTokenMetadata {#yandex.cloud.organizationmanager.v1.idp.ResetReplicationTokenMetadata}

Metadata for the [SynchronizationService.ResetReplicationToken](#ResetReplicationToken) operation.
