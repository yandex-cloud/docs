...
editable: false
apiPlayground:
  - url: https://organization-manager.{{ api-host }}/organization-manager/v1/idp/application/saml/applications/{applicationId}:reactivate
    method: post
    path:
      type: object
      properties:
    ...
    body: null
    definitions: null
sourcePath: en/_api-ref/organizationmanager/v1/idp/application/saml/api-ref/Application/reactivate.md
---

# SAML Application API, REST: Application.Reactivate
