...
editable: false
apiPlayground:
  - url: https://organization-manager.{{ api-host }}/organization-manager/v1/idp/application/saml/applications/{resourceId}:updateAccessBindings
    method: patch
    path:
      type: object
      properties:
...
```
PATCH https://organization-manager.{{ api-host }}/organization-manager/v1/idp/application/saml/applications/{resourceId}:updateAccessBindings
```
