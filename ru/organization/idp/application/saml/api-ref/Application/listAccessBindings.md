...
editable: false
apiPlayground:
  - url: https://organization-manager.{{ api-host }}/organization-manager/v1/idp/application/saml/applications/{resourceId}:listAccessBindings
    method: get
    path:
      type: object
      properties:
...
# SAML Application API, REST: Application.ListAccessBindings
...
```
GET https://organization-manager.{{ api-host }}/organization-manager/v1/idp/application/saml/applications/{resourceId}:listAccessBindings
```
