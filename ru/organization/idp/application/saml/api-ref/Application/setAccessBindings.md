...
editable: false
apiPlayground:
  - url: https://organization-manager.{{ api-host }}/organization-manager/v1/idp/application/saml/applications/{resourceId}:setAccessBindings
    method: post
    path:
      type: object
      properties:
        ...
        properties:
          id:
            description: |-
              ...
              * `<cloud generated id>`: An identifier that represents a subject.
              It can be used only if the [type](#yandex.cloud.access.Subject) is `group`, `invitee`, `serviceAccount` or `userAccount`.
          ...
          type:
            description: |-
              ...
              * `group`: A group of users. This type represents the [yandex.cloud.organizationmanager.v1.Group](/docs/organization/api-ref/Group/get#yandex.cloud.organizationmanager.v1.Group) resource.
              * `userAccount`: An account on Yandex ID. This type represents the [yandex.cloud.iam.v1.UserAccount](/docs/iam/api-ref/UserAccount/get#yandex.cloud.iam.v1.UserAccount) resource.
...
```
POST https://organization-manager.{{ api-host }}/organization-manager/v1/idp/application/saml/applications/{resourceId}:setAccessBindings
```
