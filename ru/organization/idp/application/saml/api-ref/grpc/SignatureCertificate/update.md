---
editable: false
sourcePath: en/_api-ref-grpc/organizationmanager/v1/idp/application/saml/api-ref/grpc/SignatureCertificate/update.md
---

# SAML Application API, gRPC: SignatureCertificateService.Update

Updates the specified signature certificate.

## gRPC request

**rpc Update ([UpdateSignatureCertificateRequest](#yandex.cloud.organizationmanager.v1.idp.application.saml.UpdateSignatureCertificateRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## UpdateSignatureCertificateRequest {#yandex.cloud.organizationmanager.v1.idp.application.saml.UpdateSignatureCertificateRequest}
