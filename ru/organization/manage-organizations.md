...
В {{ org-full-name }} любой пользователь Яндекса может создать и управлять неограниченным количеством организаций.
...
1. На панели слева нажмите ![plus](../_assets/plus.svg) **Создать организацию**.
...
1. В открывшемся списке выберите нужную организацию. Доступные организации помечены значком ![case](../_assets/organization/case.svg).
