---
editable: false
sourcePath: en/_api-ref-grpc/organizationmanager/v1/api-ref/grpc/Group/convertToExternal.md
---

# Identity Hub API, gRPC: GroupService.ConvertToExternal

Converts single basic (not external) group to external. Precondition: group must be basic.

## gRPC request

**rpc ConvertToExternal ([ConvertToExternalGroupRequest](#yandex.cloud.organizationmanager.v1.ConvertToExternalGroupRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## ConvertToExternalGroupRequest {#yandex.cloud.organizationmanager.v1.ConvertToExternalGroupRequest}
