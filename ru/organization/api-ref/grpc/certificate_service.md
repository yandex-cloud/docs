---
editable: false
sourcePath: en/_api-ref-grpc/organization-manager/api-ref/grpc/certificate_service.md
---
...
Field | Description
--- | ---
federation_id | **string**<br>ID of the federation to add new certificate. To get the federation ID make a [yandex.cloud.organizationmanager.v1.saml.FederationService.List](/docs/organization-manager/api-ref/grpc/federation_service#List) request. The maximum string length in characters is 50.
