...
editable: false
apiPlayground:
  - url: https://organization-manager.{{ api-host }}/organization-manager/v1/organizations/{resourceId}:updateAccessPolicyBindingParameters
    method: patch
    path:
      type: object
      properties:
...
# Identity Hub API, REST: Organization.UpdateAccessPolicyBindingParameters
...
```
PATCH https://organization-manager.{{ api-host }}/organization-manager/v1/organizations/{resourceId}:updateAccessPolicyBindingParameters
```
