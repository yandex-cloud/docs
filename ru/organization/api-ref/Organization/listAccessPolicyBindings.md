...
editable: false
apiPlayground:
  - url: https://organization-manager.{{ api-host }}/organization-manager/v1/organizations/{resourceId}:listAccessPolicyBindings
    method: get
    path:
      type: object
      properties:
    ...
    body: null
    definitions: null
sourcePath: en/_api-ref/organizationmanager/v1/api-ref/Organization/listAccessPolicyBindings.md
---
