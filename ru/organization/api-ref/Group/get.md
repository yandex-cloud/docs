...
--- | ---
groupId | Required. ID of the Group resource to return. To get the group ID, use a [list](/docs/organization/api-ref/Group/list) request.  The maximum string length in characters is 50.
