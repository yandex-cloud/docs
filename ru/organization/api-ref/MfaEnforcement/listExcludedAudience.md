...
editable: false
apiPlayground:
  - url: https://organization-manager.{{ api-host }}/organization-manager/v1/mfaEnforcements/{mfaEnforcementId}:listExcludedAudience
    method: get
    path:
      type: object
      properties:
...
## Query parameters {#yandex.cloud.organizationmanager.v1.ListExcludedAudienceRequest}
...
## Response {#yandex.cloud.organizationmanager.v1.ListExcludedAudienceResponse}
