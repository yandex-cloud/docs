...
Кроме указанных требований, политика MFA также включает в себя настройки [самостоятельного сброса пароля](./sspr.md) пользователями. При этом опция самостоятельного сброса пароля для политик MFA по умолчанию отключена.
