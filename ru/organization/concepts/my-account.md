---
title: Портал Мой аккаунт в {{ org-full-name }}
description: '[_Мой аккаунт_]({{ link-my-account }}) — это личное пространство пользователя, в котором он может управлять своей учетной записью в {{ org-full-name }}.'
---

# Портал Мой аккаунт

[_Мой аккаунт_]({{ link-my-account }}) — это личное пространство пользователя, в котором он может управлять своей учетной записью. Сейчас пользователям доступны следующие разделы:
...
* ![alt](../../_assets/console-icons/shield.svg) **{{ ui-key.yacloud_org.center-layout.MyAccountLayout.security_7zQ3g }}** — управление паролем, [способами подтверждения входа](./mfa.md) и [refresh-токенами](../../iam/concepts/authorization/refresh-token.md).
