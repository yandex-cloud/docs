...
* **{{ ui-key.yacloud_org.organization.userpools.password_check_gP9tG }}** — если пользователь попытается задать такой пароль, система его отклонит. Подобные пароли легко подбираются злоумышленниками.
