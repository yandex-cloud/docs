...
* Для [SAML-приложений](concepts/applications/saml.md#saml-attributes) добавлен новый тип трансформации значений атрибутов — Replace, заменяющий указанную подстроку в значении атрибута на другую строку.

## Июль 2026 {#july-2026}

* Добавлена возможность задавать дату деактивации [локальных пользователей](concepts/user-pools.md): при наступлении этой даты учетная запись автоматически блокируется.
...
* Добавлена [обратная запись паролей](concepts/ad-sync/index.md#password-writeback) пользователей в {{ microsoft-idp.ad-short }} при синхронизации с {{ org-full-name }}.
...
* В редакторе для [брендирования](operations/manage-branding.md) добавлена возможность обрезки и масштабирования изображений перед загрузкой.
