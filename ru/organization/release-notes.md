...
* Добавлена поддержка проверки подписи SAML-запросов от поставщика услуг и шифрования SAML-ответов в [SAML-приложениях](concepts/applications.md#saml). {{ tag-con }}
