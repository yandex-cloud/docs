...
1. Нажмите кнопку **Создать кластер**. Процесc подробно рассмотрен в разделе [{#T}](operations/cluster-create.md).
...
1. Исследуйте данные с помошью Kibana и {{ ES }}, нажав кнопку **View data** для интересующего набора данных.
