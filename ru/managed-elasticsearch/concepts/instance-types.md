...
Класс хостов определяет вычислительные мощности, которые выделяются для каждого хоста с определенной ролью в кластере. При изменении класса хостов для роли в кластере меняются характеристики всех уже созданных в нем хостов с этой ролью. Подробнее о ролях см. в разделе [Взаимосвязь ресурсов сервиса](./index.md).
