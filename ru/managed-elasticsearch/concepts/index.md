...
{{ ES }} — это специализированная распределенная система хранения документов, с возможностью поиска и анализа информации, содержащейся в этих документах.
...
Хосты кластера могут находиться в разных зонах доступности. [Подробнее о географии {{ yandex-cloud }}](../../overview/concepts/geo-scope.md).
