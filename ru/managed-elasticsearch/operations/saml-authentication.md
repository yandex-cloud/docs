...
Подробнее о SAML и SSO см. в [документации OASIS](https://wiki.oasis-open.org/security).

{{ mes-name }} поддерживает всех SAML 2.0-совместимых провайдеров идентификации.

{% note warning %}

Использование SSO поддерживается для кластеров {{ mes-name }} редакции **Platinum** с включенным публичным доступом для всех хостов с ролью _Data node_.
...
* Консоль управления
    ...
    1. Настройте провайдера идентификации:
        * **Тип провайдера** — `SAML`.
...
1. Перейдите на страницу **Kibana**.
