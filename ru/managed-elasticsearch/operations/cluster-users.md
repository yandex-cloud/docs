...
- [Kibana](https://www.elastic.co/guide/en/kibana/current/xpack-security.html#_users_2). Подробнее о подключении к Kibana см. в разделе [Подключение к кластеру](cluster-connect.md).
