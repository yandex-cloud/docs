---
editable: false
sourcePath: en/_api-ref-grpc/mdb/elasticsearch/v1/api-ref/grpc/Cluster/start.md
---

# Managed Service for Elasticsearch API, gRPC: ClusterService.Start {#Start}

Starts the specified Elasticsearch cluster.

## gRPC request

**rpc Start ([StartClusterRequest](#yandex.cloud.mdb.elasticsearch.v1.StartClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## StartClusterRequest {#yandex.cloud.mdb.elasticsearch.v1.StartClusterRequest}
...
Required field. ID of the Elasticsearch cluster to start.
...
|| metadata | **[StartClusterMetadata](#yandex.cloud.mdb.elasticsearch.v1.StartClusterMetadata)**
...
## StartClusterMetadata {#yandex.cloud.mdb.elasticsearch.v1.StartClusterMetadata}
