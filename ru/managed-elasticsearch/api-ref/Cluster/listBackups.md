...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-elasticsearch/v1/clusters/{clusterId}/backups
    method: get
    path:
      type: object
      properties:
    ...
    body: null
    definitions: null
sourcePath: en/_api-ref/mdb/elasticsearch/v1/api-ref/Cluster/listBackups.md
---
...
## Query parameters {#yandex.cloud.mdb.elasticsearch.v1.ListClusterBackupsRequest}
...
## Response {#yandex.cloud.mdb.elasticsearch.v1.ListClusterBackupsResponse}
