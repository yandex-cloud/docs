---
editable: false
sourcePath: en/_api-ref/mdb/elasticsearch/api-ref/Cluster/listBackups.md
---
...
```
GET https://mdb.{{ api-host }}/managed-elasticsearch/v1/clusters/{clusterId}/backups
```
...
pageToken | Page token. Set `page_token` to the `next_page_token` returned by a previous ListClusterBackups request to get the next page of results.  The maximum string length in characters is 100.
