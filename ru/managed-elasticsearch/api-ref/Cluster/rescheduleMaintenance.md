...
```
POST https://{{ api-host-mdb }}/managed-elasticsearch/v1/clusters/{clusterId}:rescheduleMaintenance
```
...
## Body parameters {#yandex.cloud.mdb.elasticsearch.v1.RescheduleMaintenanceRequest}
