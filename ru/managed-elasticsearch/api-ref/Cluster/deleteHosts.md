...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-elasticsearch/v1/clusters/{clusterId}/hosts:batchDelete
    method: post
    path:
      type: object
      properties:
...
## Body parameters {#yandex.cloud.mdb.elasticsearch.v1.DeleteClusterHostsRequest}
