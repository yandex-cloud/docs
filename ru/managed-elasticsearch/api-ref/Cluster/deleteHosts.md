---
editable: false
sourcePath: en/_api-ref/mdb/elasticsearch/api-ref/Cluster/deleteHosts.md
---
...
```
POST https://mdb.api.cloud.yandex.net/managed-elasticsearch/v1/clusters/{clusterId}/hosts:batchDelete
```
