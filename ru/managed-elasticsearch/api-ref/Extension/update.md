---
editable: false
sourcePath: en/_api-ref/mdb/elasticsearch/api-ref/Extension/update.md
---

# Managed Service for Elasticsearch API, REST: Extension.update
...
extensionId | <p>Required. ID of the extension to update.</p> 
