---
editable: false
sourcePath: en/_api-ref/mdb/opensearch/api-ref/Cluster/updateDashboardsNodeGroup.md
---

# Method updateDashboardsNodeGroup
...
--- | ---
clusterId | <p>Required. ID of the OpenSearch cluster to update the Dashboards type host group in.</p> <p>The maximum string length in characters is 50.</p> 
name | <p>Required. Name of the Dashboards type host group to be updated.</p> <p>The maximum string length in characters is 63. Value must match the regular expression ``[a-zA-Z0-9_-]*``.</p> 
