---
editable: false
sourcePath: en/_api-ref/mdb/opensearch/api-ref/Cluster/get.md
---
...
--- | ---
clusterId | <p>Required. ID of the OpenSearch cluster to return.</p> <p>To get the cluster ID, use a <a href="/docs/managed-opensearch/api-ref/Cluster/list">list</a> request.</p> <p>The maximum string length in characters is 50.</p> 
