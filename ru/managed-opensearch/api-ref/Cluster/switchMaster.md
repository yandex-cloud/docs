...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-opensearch/v1/clusters/{clusterId}:switch_master
    method: post
    path:
      type: object
      properties:
...
```
POST https://{{ api-host-mdb }}/managed-opensearch/v1/clusters/{clusterId}:switch_master
```
