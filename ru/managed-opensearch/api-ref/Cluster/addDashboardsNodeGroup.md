---
editable: false
sourcePath: en/_api-ref/mdb/opensearch/api-ref/Cluster/addDashboardsNodeGroup.md
---

# Method addDashboardsNodeGroup
...
--- | ---
clusterId | <p>Required. ID of the OpenSearch cluster to create the Dashboards type host group in.</p> <p>To get the ID, use a <a href="/docs/managed-opensearch/api-ref/Cluster/list">list</a> request.</p> <p>The maximum string length in characters is 50.</p> 
...
Field | Description
--- | ---
nodeGroupSpec | **object**<br><p>Configuration of the new host group.</p> 
