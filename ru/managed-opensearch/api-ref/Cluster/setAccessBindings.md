...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-opensearch/v1/clusters/{resourceId}:setAccessBindings
    method: post
    path:
      type: object
      properties:
...
```
POST https://{{ api-host-mdb }}/managed-opensearch/v1/clusters/{resourceId}:setAccessBindings
```
