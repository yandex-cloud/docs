---
editable: false
sourcePath: en/_api-ref/mdb/opensearch/api-ref/Cluster/move.md
---
...
--- | ---
clusterId | <p>Required. ID of the OpenSearch cluster to move.</p> <p>The maximum string length in characters is 50.</p> 
