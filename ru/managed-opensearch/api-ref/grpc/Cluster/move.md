---
editable: false
sourcePath: en/_api-ref-grpc/mdb/opensearch/v1/api-ref/grpc/Cluster/move.md
---

# Managed Service for OpenSearch API, gRPC: ClusterService.Move {#Move}

Moves the specified OpenSearch cluster to the specified folder.

## gRPC request

**rpc Move ([MoveClusterRequest](#yandex.cloud.mdb.opensearch.v1.MoveClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## MoveClusterRequest {#yandex.cloud.mdb.opensearch.v1.MoveClusterRequest}
