...
# Managed Service for OpenSearch API, gRPC: ClusterService.RescheduleMaintenance {#RescheduleMaintenance}
...
The value can also point to a moment in the past if [rescheduleType.IMMEDIATE](/docs/managed-opensearch/api-ref/grpc/Cluster/rescheduleMaintenance#yandex.cloud.mdb.opensearch.v1.RescheduleMaintenanceRequest.RescheduleType) reschedule type is selected. ||
|#
