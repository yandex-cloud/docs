...
# Managed Service for OpenSearch API, REST: Versions.List
...
```
GET https://{{ api-host-mdb }}/managed-opensearch/v1/versions
```

## Query parameters {#yandex.cloud.mdb.opensearch.v1.ListVersionsRequest}
...
## Response {#yandex.cloud.mdb.opensearch.v1.ListVersionsResponse}
