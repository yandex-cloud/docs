...
|`--name`|<b>`string`</b><br/>Extension name.|
|`--uri`|<b>`string`</b><br/>Extension file URI (supports Yandex Object Storage links).|
|`--disabled`|Whether the extension is disabled.|
|`--type`|<b>`string`</b><br/>Extension type: 'synonyms' or 'stopwords'.|
