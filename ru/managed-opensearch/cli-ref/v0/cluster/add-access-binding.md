---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/managed-opensearch/cli-ref/v0/cluster/add-access-binding/
---

# yc managed-opensearch v0 cluster add-access-binding
