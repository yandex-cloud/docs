---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/managed-opensearch/cli-ref/v0/cluster/
---
...
- [yc managed-opensearch v0 cluster move](move.md) — Move a managed OpenSearch cluster into a new folder
