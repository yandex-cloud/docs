---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/managed-opensearch/cli-ref/cluster/set-access-bindings
editable: false
---

# yc managed-opensearch cluster set-access-bindings

Set access bindings for the specified OpenSearch cluster and delete all existing access bindings if there were any

#### Command Usage

Syntax:

`yc managed-opensearch cluster set-access-bindings <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
