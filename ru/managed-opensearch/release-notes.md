...
* В {{ TF }} добавлена возможность задать размер хранилища в гигабайтах через параметр `disk_size_gb`.
...
* Доступны новые версии {{ OS }}: [3.6.0 и 3.7.0](https://docs.opensearch.org/latest/version-history/).
