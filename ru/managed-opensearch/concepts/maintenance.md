...
Техническое обслуживание включает изменения в рамках одной версии {{ OS }}. {% if audience == "draft" %}О том, как происходит переход между версиями см. в разделе [{#T}](../operations/cluster-version-update.md){% endif %}.
