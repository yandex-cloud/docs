...
{{ OS }} выступает как инструмент для поиска и {% if lang == "ru" and audience != "internal" %}[анализа данных](../../glossary/data-analytics.md){% else %}анализа данных{% endif %} в документах с помощью:
