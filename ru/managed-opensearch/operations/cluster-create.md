...
- Консоль управления
    ...
    1. В блоке **Ресурсы** задайте конфигурацию хостов с [ролью](../concepts/host-roles.md#data) `DATA`, выбрав вкладку **Data node**:
        ...
        Изменить конфигурацию хостов после создания кластера можно только с помощью {% if lang == "ru" and audience != "internal" %}[API](../../glossary/rest-api.md){% else %}API{% endif %}, однако при необходимости вы сможете создать новую группу хостов с другой конфигурацией.
