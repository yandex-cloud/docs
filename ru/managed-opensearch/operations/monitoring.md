---
title: "Мониторинг состояния {{ OS }}-кластера и хостов"
description: "Данные о состоянии кластера и его хостов доступны в консоли управления. Их можно посмотреть на вкладке Мониторинг страницы управления кластером или в сервисе {{ monitoring-full-name }}. Диагностическая информация о состоянии кластера представлена в виде графиков."
---
