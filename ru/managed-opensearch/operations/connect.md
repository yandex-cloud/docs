...
* Через интернет по [особому FQDN](#special-fqdns), если вы настроили публичный доступ для группы хостов с [ролью](../concepts/host-roles.md#dashboards) `DASHBOARDS`.
