...
Создавать и удалять ресурсы {{ yandex-cloud }}, а также управлять их настройками вы можете с помощью [AI-ассистента]({{ link-docs-ai }}ai-studio/concepts/assistant/index), интегрированного в консоль управления. AI-ассистент позволяет управлять облачными ресурсами в свободной текстовой форме в формате чата с генеративной моделью.
