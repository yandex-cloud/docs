...
Создавать и удалять ресурсы {{ yandex-cloud }}, а также управлять их настройками вы можете с помощью [AI-ассистента]({{ link-docs-ai }}ai-studio/concepts/agents/index), интегрированного в консоль управления. AI-ассистент позволяет управлять облачными ресурсами в свободной текстовой форме в формате чата с генеративной моделью.
...
- Консоль управления {#console}
  ...
  1. В [консоли управления]({{ link-console-main }}) выберите [каталог](../../resource-manager/concepts/resources-hierarchy.md#folder), в котором вы будете выполнять операции с ресурсами {{ yandex-cloud }}.
  1. Нажмите ![ai-chat-console](../../_assets/ai-chat-console.svg) **{{ ui-key.yacloud.ai-assistant.label_ai-assistant-open }}** или ![ai-chat-console](../../_assets/ai-chat-console.svg) **{{ ui-key.yacloud.ui.components.button_open-ai-assistant }}**.
...
- Консоль управления {#console}
  ...
  1. В [консоли управления]({{ link-console-main }}) выберите каталог, в котором вы будете управлять ресурсами.
  1. Нажмите ![ai-chat-console](../../_assets/ai-chat-console.svg) **{{ ui-key.yacloud.ai-assistant.label_ai-assistant-open }}** или ![ai-chat-console](../../_assets/ai-chat-console.svg) **{{ ui-key.yacloud.ui.components.button_open-ai-assistant }}**.
