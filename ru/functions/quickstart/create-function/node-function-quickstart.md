...
- Консоль управления
    ...
    1. Введите имя функции — `nodejs_function`.
...
- CLI
    ...
    ```
    yc serverless function create --name=nodejs_function
    ```
...
- Консоль управления
    ...
    1. Выберите функцию `nodejs_function`.
