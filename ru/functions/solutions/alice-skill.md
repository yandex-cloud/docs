...
Для вызова функции необходимо назначить пользователю соответствующие права доступа. Права доступа назначаются на функцию. Узнайте как это сделать в разделе [{#T}](../operations/function-public.md).
...
1. В [консоли управления]({{ link-console-main }}) откройте **{{ sf-name }}** в каталоге, где была создана функция для навыка.
