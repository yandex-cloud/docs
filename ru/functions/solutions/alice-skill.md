...
Функции можно использовать для навыков Алисы, а также для приватных навыков Умного дома.
...
1. [Сделайте функцию публичной](#public).
...
## 4. Сделайте функцию публичной {#public}

Для корректного вызова функции необходимо сделать ее публичной:

1. В консоли управления откройте раздел **{{ sf-name }}** в каталоге с функцией, которую хотите сделать публичной.
