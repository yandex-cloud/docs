...
description: "Вы можете посмотреть график мониторинга в Yandex Cloud Functions с помощтю консоли управления. Для этого выберите сервис Cloud Functions, нажмите на функцию, журнал выполнения которой вы хотите посмотреть. В открывшемся окне перейдите в раздел Логи и укажите период. По умолчанию задан период за 1 час. Логи выполнения функции хранятся 3 дня. Время в журнале указано по UTC."
---
