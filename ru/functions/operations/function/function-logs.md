---
title: "Просмотр журнала выполнения в Yandex Cloud Functions"
...
Логи выполнения функции хранятся 3 дня. Время в журнале указано по [UTC]{% if lang == "ru" %}(https://ru.wikipedia.org/wiki/Всемирное_координированное_время){% endif %}{% if lang == "en" %}(https://en.wikipedia.org/wiki/Coordinated_Universal_Time){% endif %}.
