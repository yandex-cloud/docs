...
Также вы можете изменить код функции с помощью [редактора кода](function-editor.md).
...
- Консоль управления
    ...
    1. Откройте **{{ sf-name }}** в каталоге с функцией, для которой требуется получить список версий.
