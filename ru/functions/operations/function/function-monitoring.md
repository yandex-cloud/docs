---
title: "Просмотр графиков мониторинга функции в Yandex Cloud Functions"
description: "Вы можете посмотреть график мониторинга в Yandex Cloud Functions с помощью консоли управления, для этого выберите сервис Cloud Functions, нажмите на функцию, графики мониторинга которой вы хотите посмотреть."
---
...
1. На странице появятся следующие графики:
	* **Invocations** — количество вызовов функции.
	* **Durations** — среднее время выполнения функции.
