---
editable: false
sourcePath: en/_api-ref-grpc/serverless/functions/v1/functions/api-ref/grpc/Operation/cancel.md
---

# Cloud Functions Service, gRPC: OperationService.Cancel {#Cancel}
