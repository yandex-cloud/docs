---
editable: false
sourcePath: en/_api-ref-grpc/serverless/functions/v1/functions/api-ref/grpc/Function/getVersion.md
---

# Cloud Functions Service, gRPC: FunctionService.GetVersion

Returns the specified version of a function.

To get the list of available version, make a [ListVersions](/docs/functions/functions/api-ref/grpc/Function/listVersions#ListVersions) request.

## gRPC request

**rpc GetVersion ([GetFunctionVersionRequest](#yandex.cloud.serverless.functions.v1.GetFunctionVersionRequest)) returns ([Version](#yandex.cloud.serverless.functions.v1.Version))**
