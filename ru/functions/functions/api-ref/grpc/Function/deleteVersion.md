...
**rpc DeleteVersion ([DeleteFunctionVersionRequest](#yandex.cloud.serverless.functions.v1.DeleteFunctionVersionRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## DeleteFunctionVersionRequest {#yandex.cloud.serverless.functions.v1.DeleteFunctionVersionRequest}
