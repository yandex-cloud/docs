---
editable: false
sourcePath: en/_api-ref-grpc/serverless/functions/v1/functions/api-ref/grpc/Function/createFunctionVersion.md
---

# Cloud Functions Service, gRPC: FunctionService.CreateFunctionVersion {#CreateFunctionVersion}

Deprecated. Use [CreateVersion](/docs/functions/functions/api-ref/grpc/Function/createVersion#CreateVersion).

## gRPC request

**rpc CreateFunctionVersion ([CreateFunctionVersionRequest](#yandex.cloud.serverless.functions.v1.CreateFunctionVersionRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**
...
#|
||Field | Description ||
|| emptyTarget | **[EmptyTarget](#yandex.cloud.serverless.functions.v1.EmptyTarget2)**
