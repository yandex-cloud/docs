...
--- | ---
functionVersionId | <p>Required. ID of the function's version to delete.</p> 
 
## Query parameters {#query_params}
 
Parameter | Description
--- | ---
force | <p>Forces deletion of the version tags.</p> <p>If the value equals false and the function has tags with the selected version then request returns an error.</p> 
