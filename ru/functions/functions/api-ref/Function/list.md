...
functions[].<br>labels | **object**<br><p>Метки функций в виде пар <code>key:value</code> .</p> <p>Не более 64 на ресурс.</p> 
