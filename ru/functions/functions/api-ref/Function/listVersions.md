...
versions[].<br>entrypoint | **string**<br><p>Точка входа для функции: имя функции, вызываемой в качестве обработчика.</p> <p>Указывается в формате <code>&lt;function file name&gt;.&lt;handler name&gt;</code>, например, <code>index.myFunction</code>.</p> 
