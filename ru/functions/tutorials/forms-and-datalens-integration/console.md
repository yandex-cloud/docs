...
description: Настройка интеграции {{ forms-name }} и {{ datalens-name }} через консоль управления с использованием {{ sf-name }} и {{ yq-name }} для автоматической обработки данных.
