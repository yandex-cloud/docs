...
description: "С помощью сервиса {{ sf-name }} вы можете запускать приложения написанные на языке программирования PHP. Сервис предоставляет среды выполнения с версией PHP 7.4.3 и операционной системой Ubuntu 18.04 LTS."
---
...
|----|----|----|----|
| php74 | 7.4.28 | Ubuntu 18.04 LTS | нет |
| php8 | 8.0.25 | Ubuntu 18.04 LTS | нет |
