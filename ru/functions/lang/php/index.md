---
title: Разработка на PHP в Yandex Cloud Functions. Обзор
description: 'С помощью сервиса Cloud Functions вы можете запускать приложения написанные на языке программирования PHP. Сервис предоставляет среды выполнения с версией PHP 7.4.3 и операционной системой Ubuntu 18.04 LTS.'
