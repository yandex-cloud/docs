...
С помощью сервиса {{ sf-name }} вы можете запускать приложения написанные на языке программирования [PHP](https://www.php.net/). Сервис предоставляет [среды выполнения](../../concepts/function-invoke.md) со следующими версиями:
