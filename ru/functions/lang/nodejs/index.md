...
С помощью сервиса {{ sf-name }} вы можете запускать приложения написанные на [Node.js](https://nodejs.org/en/docs/). Сервис предоставляет несколько [сред выполнения](../../concepts/function-invoke.md) с различными версиями:

| Название | Версия Node.js | Версия SDK <br>Яндекс.Облака | Операционная <br>система |
|----|----|----|----|
