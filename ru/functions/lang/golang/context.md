...
__Контекст вызова__ — это объект, который опционально принимается [обработчиком запросов](handler.md). Он представляет собой объект типа `context.Context` и предоставляет интерфейс для получения дополнительной информации о свойствах версии функции:
