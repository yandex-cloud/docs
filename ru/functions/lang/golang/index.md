...
Сервис предоставляет [среду выполнения](../../concepts/runtime/index.md) с различными версиями:

| Название | Версия Go | Операционная <br>система | Предзагружаемая
| ---- | ---- | ---- | ----
| golang116 | 1.16.15 | Ubuntu 18.04 | нет
| golang117 | 1.17.8 | Ubuntu 18.04 | нет
| golang118 | 1.18.5 | Ubuntu 18.04 | нет
| golang119 | 1.19.3 | Ubuntu 18.04 | нет
| golang121 | 1.21.0 | Ubuntu 22.04 LTS | нет
