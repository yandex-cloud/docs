...
С помощью сервиса {{ sf-name }} вы можете запускать приложения, написанные на [Go](https://golang.org/doc/). Сервис предоставляет [среду выполнения](../../concepts/runtime/index.md) с версией языка 1.16 и операционной системой Ubuntu 18.04 LTS.
