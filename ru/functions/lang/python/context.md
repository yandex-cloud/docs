...
* `deadline_ms' - Unix-время (Epoch time) таймаута вызова в миллисекундах, те момент времени до которого ведёт обратный отсчёт функция `get_remaining_time_in_millis()`
...
* `expires_in` — время жизни токена в секундах от момента начала обработки вызова;
