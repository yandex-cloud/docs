...
Во время создания новой [версии функции](../../operations/function/version-manage.md#func-version-create) сервис {{ sf-name }} позволяет установить зависимости, необходимые для работы функции. Для этого требуется загрузить в корень проект файл `packages.R` с описанием процесса установки пакетов.
...
Пример уставки пакета через  `packages.R`:
