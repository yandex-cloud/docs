...
description: С помощью сервиса {{ sf-name }} вы можете запускать приложения, написанные на R. Сервис предоставляет среду выполнения с версией языка 4.3.1 и операционной системой Ubuntu 22.04 LTS.
---
