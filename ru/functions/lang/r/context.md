...
_Контекст вызова_ — это объект, который опционально принимается [обработчиком запросов](handler.md), если в списке параметров присутствует ycFunctionContext. Он представляет собой объект типа список с дополнительной информации о свойствах версии функции:
