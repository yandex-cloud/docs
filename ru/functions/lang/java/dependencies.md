...
Сервис {{ sf-name }} поддерживает два способа управления зависимостями — автоматическую установку через `maven` и ручную поставку зависимостей вместе с исходным кодом.
