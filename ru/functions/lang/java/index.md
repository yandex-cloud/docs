---
title: Разработка на Java в Yandex Cloud Functions. Обзор
description: 'С помощью сервиса Cloud Functions вы можете запускать приложения, написанные на Java. Сервис предоставляет среду выполнения с версией языка 11 и операционной системой Ubuntu 18.04 LTS.'
