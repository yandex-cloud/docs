...
Вне зависимости от выбранной модели обработчиком может быть [async-метод](https://docs.microsoft.com/ru-ru/dotnet/csharp/programming-guide/concepts/async/), возвращающий `Task` или `Task<T>`. Для варианта с независимым классом дополнительно доступен вариант возвращаемого значения `async void`.
