...
В некоторых случаях сервис может принудительно остановить [экземпляр функции](./function.md#function-instance). При этом в пользовательский код функции поступает _уведомление о предстоящем принудительном завершении работы_. 
