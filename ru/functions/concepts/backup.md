---
title: "Резервное копирование в Yandex Cloud Functions"
description: "Данные в сервисе Cloud Functions надежно хранятся и реплицируются в инфраструктуре Yandex.Cloud. Вы можете получить списки функций, списки версий функций, информацию о версиях функций, списки триггеров, информацию о триггерах."
