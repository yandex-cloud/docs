...
Когда интерпретатор запускается, [пользовательские переменные окружения](../../operations/function/version-manage.md#version-env) неизвестны предзагружаемой среде выполнения. Они выставляются программно перед инициализацией кода функции.
