...
[Триггер](index.md) для {{ cloud-logs-name }} запускает функцию, когда в [лог-группу](../../../functions/concepts/log-group.md) поступают сообщения. Триггер должен находиться в одном каталоге с лог-группами, на которые он подписан.
