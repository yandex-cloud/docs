...
_Долгоживущая функция_ — это функция, в настройках [версии](./function.md#version) которой задан таймаут, превышающий десять минут. Максимально возможное значение таймаута указано в разделе [{#T}](./limits.md#functions-limits).
