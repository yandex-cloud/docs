...
Функция запускается в [среде выполнения](runtime/index.md), которая соответствует ее языку программирования. Среды выполнения доступны для Node.js и Python.
