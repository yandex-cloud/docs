...
## Из чего складывается стоимость использования {{ sf-name }}
...
### Тарификация функции в случае возникнования ошибок {#error}

{{ sf-name }} возвращает результат выполнения функции с кодом состояния. Тарифицируются следующие коды состояния: 
...
Вызов функции, при котором результат выполнения был с [другим кодом состояния](concepts/function-invoke.md#http-state), не тарифицируется. Подробнее о вызове функции и кодах состояния читайте в разделе [{#T}](concepts/function-invoke.md).
