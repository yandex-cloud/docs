...
* просматривать информацию о назначенных правах доступа к ресурсам сервиса {{ sf-name }} и изменять права доступа;
...
* просматривать информацию о квотах сервиса {{ sf-name }};
