Роль `certificate-manager.editor` позволяет управлять сертификатами и доменами, просматривать информацию о них, о привязках прав доступа к ним и о квотах сервиса Certificate Manager.
