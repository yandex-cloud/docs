...
* просматривать информацию о назначенных [правах доступа](../../iam/concepts/access-control/index.md) к [каналам](../../video/concepts/index.md#channels) {{ video-name }} и изменять такие права доступа;
