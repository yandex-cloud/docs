...
* просматривать информацию о назначенных [правах доступа](../../iam/concepts/access-control/index.md) к ресурсам сервиса {{ cloud-logging-name }} и изменять такие права доступа;
...
* просматривать информацию о [квотах](../../logging/concepts/limits.md#logging-quotas) сервиса {{ cloud-logging-name }}.
