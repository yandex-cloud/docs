...
* просматривать информацию о назначенных [правах доступа](../../iam/concepts/access-control/index.md) к [кластерам](../../managed-valkey/concepts/index.md) Valkey™ и изменять такие права доступа;
