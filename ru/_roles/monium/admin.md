Роль `monium.admin` позволяет управлять ресурсами платформы {{ monium-name }}, просматривать и записывать все виды телеметрии, а также управлять проектами и доступом к ним.
