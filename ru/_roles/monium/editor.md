Роль `monium.editor` позволяет управлять ресурсами платформы {{ monium-name }}, просматривать и записывать все виды телеметрии.
...
* читать и записывать все виды телеметрии платформы {{ monium-name }}: [метрики](../../monium/metrics/quickstart.md), [логи](../../monium/logs/quickstart.md) и [распределенные трассировки](../../monium/traces/index.md);
...
* просматривать информацию о [правилах](../../monium/operations/prometheus/recording-rules.md) {{ managed-prometheus-full-name }}, а также создавать, изменять и удалять такие правила;
