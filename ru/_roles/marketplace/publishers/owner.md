...
Роль `marketplace.publishers.owner` позволяет управлять доступом к профилю партнера, управлять продуктами {{ marketplace-short-name }} и доступом к ним, их версиями, тарифами, пробными периодами, формами и заявками на модерацию, а также просматривать отчеты по продуктам {{ marketplace-short-name }} в профиле партнера.
...
* просматривать отчеты по продуктам {{ marketplace-short-name }} в профиле партнера;
