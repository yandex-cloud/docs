...
Роль `marketplace.publishers.viewer` позволяет просматривать информацию о профиле партнера и продуктах {{ marketplace-short-name }} в нем, а также обращаться в техническую поддержку.
