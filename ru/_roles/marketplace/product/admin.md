...
Роль `marketplace.product.admin` позволяет управлять продуктами {{ marketplace-short-name }} и доступом к ним, а также их версиями, тарифами, пробными периодами, формами и заявками на модерацию.
