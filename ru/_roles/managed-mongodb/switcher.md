...
Роль `managed-mongodb.switcher` позволяет переназначать первичную реплику в кластерах {{ SD }}, просматривать информацию о кластерах, хостах, шардах, базах данных и пользователях {{ SD }}, логи работы кластеров, а также данные о квотах и операциях с ресурсами сервиса.

Пользователи с этой ролью могут:
* переназначать первичную реплику в [кластерах {{ SD }}](../../storedoc/concepts/index.md);
