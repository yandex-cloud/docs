...
* просматривать информацию о [кластерах Yandex StoreDoc](../../storedoc/concepts/index.md) и назначенных [правах доступа](../../iam/concepts/access-control/index.md) к ним;
