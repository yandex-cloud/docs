...
* просматривать информацию о назначенных [правах доступа](../../iam/concepts/access-control/index.md) к [кластерам Yandex StoreDoc](../../storedoc/concepts/index.md) и изменять такие права доступа;
