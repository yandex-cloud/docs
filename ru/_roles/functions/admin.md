...
* просматривать информацию о назначенных [правах доступа](../../iam/concepts/access-control/index.md) к ресурсам сервиса {{ sf-name }} и изменять права доступа;
...
* просматривать информацию о [квотах](../../functions/concepts/limits.md#functions-quotas) сервиса {{ sf-name }};
