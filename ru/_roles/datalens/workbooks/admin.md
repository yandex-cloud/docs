...
* просматривать информацию о назначенных [правах доступа]({{ link-docs }}/iam/concepts/access-control/) к [воркбуку](../../../datalens/workbooks-collections/index.md) и изменять такие права доступа;
