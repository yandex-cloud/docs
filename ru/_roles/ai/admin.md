...
* использовать [языковые модели](../../foundation-models/concepts/yandexgpt/index.md) генерации, модели генерации изображений YandexART, а также AI-ассистентов в сервисе Yandex Foundation Models;
