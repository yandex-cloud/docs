Роль `postbox.admin` позволяет управлять адресами {{ postbox-name }}, отправлять письма, а также просматривать информацию об отправленных письмах и статистику по ним.
