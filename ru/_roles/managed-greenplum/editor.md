Роль `managed-greenplum.editor` позволяет управлять кластерами Greenplum® в сервисе Yandex MPP Analytics for PostgreSQL и просматривать логи их работы, а также получать информацию о квотах и операциях с ресурсами сервиса.
