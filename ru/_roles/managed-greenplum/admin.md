...
* просматривать информацию о назначенных [правах доступа](../../iam/concepts/access-control/index.md) к [кластерам Greenplum®](../../managed-greenplum/concepts/index.md) и изменять такие права доступа;
