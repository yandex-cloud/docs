...
В сервисе {{ billing-name }} пользователи с этой ролью могут [выполнять API-запросы](../../../billing/operations/get-charges-via-api.md) для получения детализации расходов.
