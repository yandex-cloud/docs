Роль `billing.accounts.piiPartnerEditor` назначается на платежный аккаунт и позволяет управлять выводом рибейта партнера, а также управлять сабаккаунтами и просматривать данные партнеров, включая персональные данные.
