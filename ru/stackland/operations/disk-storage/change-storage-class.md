...
Для нового кластера задайте класс хранилища в [конфигурации компонента перед установкой](../../quickstart.md#component-configuration), чтобы компонент сразу создал PVC с нужными настройками.
