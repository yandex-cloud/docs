...
* Локальные пользователи — создание пользователей и управление ими происходят непосредственно в {{ iam-name }}. Подходит для небольших команд или тестовых окружений.
