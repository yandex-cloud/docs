...
* `PostgresqlRole` — роль PostgreSQL и ее права. Подробнее см. в разделах [{#T}](../../operations/postgresql/create-user.md), [{#T}](../../operations/postgresql/edit-user.md), [{#T}](../../operations/postgresql/delete-user.md).
* `PostgresqlDatabase` — база данных и ее схемы. Подробнее см. в разделах [{#T}](../../operations/postgresql/create-database.md), [{#T}](../../operations/postgresql/edit-database.md), [{#T}](../../operations/postgresql/delete-database.md).
...
### Некорректное отображение версии PostgreSQL в образах {#pg-image-version}

В образах {{ PG }} до {{ stackland-name }} 26.2.0 была обнаружена ошибка: образы, помеченные как версии 15 и 16, фактически содержали PostgreSQL 17. Из-за этого кластеры, созданные с указанием `spec.version: "15"` или `spec.version: "16"`, уже работали на PostgreSQL 17.

После исправления в {{ stackland-name }} 26.2.0 образы правильно отображают версию 17. Кластеры, ранее созданные с указанием `spec.version: "15"` или `spec.version: "16"`, отображаются как PostgreSQL 17 — это соответствует действительно развернутой версии.

Требуемое действие: если в ваших манифестах `PostgresqlCluster` в поле `spec.version` указано `"15"` или `"16"`, обновите значение на `"17"`.
