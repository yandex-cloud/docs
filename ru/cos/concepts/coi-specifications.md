...
Для описания конфигурации запуска {% if lang == "ru" %}[Docker-контейнера](/blog/posts/2022/03/docker-containers){% else %}Docker-контейнера{% endif %} существует два способа:
