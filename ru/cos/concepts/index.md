...
_{{ coi }}_ — [образ](../../compute/concepts/image.md) виртуальной машины, оптимизированный для запуска {% if lang == "ru" %}[Docker-контейнеров](/blog/posts/2022/03/docker-containers){% else %}Docker-контейнеров{% endif %}. Образ включает в себя: Ubuntu LTS, Docker и демона для запуска Docker-контейнеров.
