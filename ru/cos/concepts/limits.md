...
При работе с образом {{ coi }} учитываются ограничения [{{ compute-name }}](../../compute/concepts/limits.md) и [{{ container-registry-name }}](../../container-registry/concepts/limits.md).