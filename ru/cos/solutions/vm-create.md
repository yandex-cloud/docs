...
- CLI
    ...
    При создании ВМ параметры Docker-контейнера можно задать через YC CLI или c помощью [файла спецификации](../concepts/index.md#coi-specification).
    
    {% cut "Как задать параметры Docker-контейнера с помощью флагов команды YC CLI" %}
    ...
    {% cut "Как задать параметры Docker-контейнера, используя файл спецификации" %}
