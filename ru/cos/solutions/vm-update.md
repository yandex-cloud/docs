...
Измените параметры Docker-контейнера на виртуальной машине, созданной из образа [{{ coi }}](../concepts/index.md).
...
- CLI
    ...
    1. Обновите виртуальную машину.
        ...
        * Обновите ВМ, указав спецификацию нескольких Docker-контейнеров:
            ...
            Где: 
            - `--docker-compose-file` — путь к файлу со спецификацией Docker-контейнеров.
