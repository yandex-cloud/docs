...
- Если использовать COI в стандартном варианте — один [контейнер](../solutions/vm-create.md), настраиваемый параметрами, то все порты, которые открыты в Docker-контейнере, будут открыты и на хосте. 
- Если нужны другие настройки сети для контейнеров, то можно сделать это, используя COI с [Docker Compose спецификацией](../solutions/docker-compose.md#docker-compose). 
