...
**Как исправить:** проверьте доступ к {{ container-registry-name }} командой: `nc -vz cr.yandex 443`. Если доступа нет, [настройте NAT-инстанс](../../solutions/routing/nat-instance.md) или назначьте публичный IP-адрес на ВМ с {{ coi }}. Также можно включить egress NAT для подсети, в которой создаются виртуальные машины.
