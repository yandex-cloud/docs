...
* Стандартные хосты
    ...
    * с 3 автоматически созданными хостами {{ ZK }} класса `b2.medium` (Intel Cascade Lake, 2 vCPU, 50% vCPU, 4 ГБ RAM).
    * c 100 ГБ хранилища на сетевых HDD-дисках.

    Стоимость часа работы хостов: `3 × (2 × 1,68 ₽ + 8 × 0,45 ₽) + 3 × (2 × 0,78 ₽ + 4 × 0,32 ₽) = 29,4 ₽`

    Общая стоимость кластера в месяц (хосты и хранилище): `720 × 29,4 ₽ + 100 × 3,2 ₽ = 21 488 ₽`
