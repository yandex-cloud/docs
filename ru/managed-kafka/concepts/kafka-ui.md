---
title: Веб-интерфейс {{ kafka-ui }} для {{ mkf-name }}
...
Подробнее о работе в веб-интерфейсе смотрите [документацию {{ kafka-ui }} для {{ KF }}]({{ kafka-ui-kafbat }}).
...
* Руководство по развертыванию веб-интерфейса {{ kafka-ui }} для кластера {{ mkf-name }} в разделе [{#T}](../tutorials/deploy-kafka-ui.md).
