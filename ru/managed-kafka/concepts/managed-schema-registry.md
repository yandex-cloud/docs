...
1. Если в кластере используются управляемые топики, то:
    ...
    * Кроме того, необходимо соблюдать правила именования _субъектов:_ Если у пользователя есть роль producer для топика topic1, то он может управлять _субъектами_ вида topic1*. По факту kafka библиотеки сохраняют/читают схемы из _субъектов_ topic1-key и topic1-value
