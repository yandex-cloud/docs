...
Добавлена поддержка новой версии {{ KF }} 4.0. Эта версия доступна в окружении `PRODUCTION`. Подробнее об изменениях см. в [документации {{ KF }}](https://kafka.apache.org/documentation.html).
