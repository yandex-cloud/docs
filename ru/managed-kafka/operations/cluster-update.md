...
* В кластере используется версия {{ KF }} 3.5 или ниже. В кластерах с версией {{ KF }} 3.6 или выше используется [протокол {{ kraft-name }}](../concepts/kraft.md), из-за чего количество хостов в таких кластерах фиксированное.
