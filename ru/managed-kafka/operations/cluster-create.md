...
Количество хостов-брокеров, которые можно создать вместе с кластером {{ KF }}, зависит от выбранного [типа хранилища](../concepts/storage.md){% if audience != "internal" %}:
...
* При использовании хранилища на **сетевых HDD-дисках** или **сетевых SSD-дисках** вы можете добавить любое количество хостов-брокеров в пределах [текущей квоты](../concepts/limits.md){% endif %}.
