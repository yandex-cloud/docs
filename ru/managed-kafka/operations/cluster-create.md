...
- Консоль управления
  ...
  1. В блоке **Хосты** укажите количество хостов-брокеров {{ KF }} для размещения в каждой выбранной зоне доступности.
     ...
     - Репликация работает по умолчанию в любом кластере из более чем одного хоста при настройке фактора репликации более `1`. Фактор репликации [настраивается после создания кластера](cluster-topic.md#create-topic).
