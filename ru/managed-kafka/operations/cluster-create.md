...
* Количество хостов-брокеров, которые можно создать вместе с кластером {{ KF }}, зависит от выбранного {% if audience != "internal" %}[типа диска](../concepts/storage.md#storage-type-selection){% else %}[типа диска](../concepts/storage.md){% endif %} и [класса хостов](../concepts/instance-types.md#available-flavors).
        ...
        resource "yandex_mdb_kafka_cluster" "<имя кластера>" {
          ...
          config {
            ...
            kafka {
              resources {
                disk_size          = <размер хранилища в гигабайтах>
                disk_type_id       = "<тип диска: network-ssd, network-hdd, network-ssd-nonreplicated или local-ssd>"
                resource_preset_id = "<класс хоста>"
              }
            }
