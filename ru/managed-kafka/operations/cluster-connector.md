...
* Консоль управления
  ...
  * (Опционально) **Максимальное количество записей на файл** — максимальное количество записей, которое может быть записано в один файл, размещенный в {% if lang == "ru" and audience != "internal" %}[S3-совместимом хранилище](../../glossary/s3.md){% else %}S3-совместимом хранилище{% endif %}.
