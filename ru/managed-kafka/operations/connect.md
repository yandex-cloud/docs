...
1. Подключите клиенты к кластеру одним из способов:
   * С помощью [Kafka Producer API](https://kafka.apache.org/documentation/#producerapi) — для подключения производителей данных.
   * С помощью [Kafka Consumer API](https://kafka.apache.org/documentation/#consumerapi) — для подключения потребителей данных.
...
- Shell
   ...
   * Пример команды для отправки сообщения в топик:
...
- Go
   ...
   * Общий код для использования SRAM:
