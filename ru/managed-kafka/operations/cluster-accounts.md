...
- API
  ...
  - Список прав, которые нужно изменить, в параметре `updateMask` (одной строкой через запятую). Если не задать этот параметр, метод API удалит все права, которые не были явно указаны в параметре `topicSpec`.
...
- Консоль управления
  ...
  1. Найдите нужный топик в списке топиков. 
  1. Удалите роль, которая больше не нужна, нажав значок ![image](../../_assets/cross.svg) рядом с именем роли.
  1. Если нужно отозвать все права на доступ к топику, удалите его из списка: наведите курсор на имя топика и нажмите значок ![image](../../_assets/cross.svg) в конце строки.
