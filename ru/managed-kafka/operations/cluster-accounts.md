...
Если в кластере {{ mkf-name }} включена настройка **Управление топиками через API**, то для создания пользователя-администратора воспользуйтесь интерфейсами командной строки, [API](../../glossary/rest-api.md) или {{ TF }}.
