...
- Консоль управления
  ...
  1. Перейдите на страницу каталога и выберите сервис **{{ mkf-name }}**.
  1. Нажмите на имя нужного кластера и выберите вкладку **Пользователи**.
  1. Нажмите значок ![image](../../_assets/vertical-ellipsis.svg) для нужной учетной записи и выберите пункт **Изменить пароль**.
...
- Консоль управления
  ...
  1. Перейдите на страницу каталога и выберите сервис **{{ mkf-name }}**.
  1. Нажмите на имя нужного кластера и выберите вкладку **Пользователи**.
  1. Нажмите значок ![image](../../_assets/vertical-ellipsis.svg) для нужной учетной записи и выберите пункт **Настроить**.
...
- Консоль управления
  ...
  1. Найдите нужный топик в списке топиков. 
     ...
     1. Выберите нужный топик из выпадающего списка.
      ...
      Если нопка **Добавить топик** отсутствует или среди доступных для добавления топиков нет нужного — [создайте новый топик](cluster-topics.md#create-topic) и добавьте его.
...
- Консоль управления
  ...
  1. Перейдите на страницу каталога и выберите сервис **{{ mkf-name }}**.
  1. Нажмите на имя нужного кластера и выберите вкладку **Пользователи**.
  1. Нажмите значок ![image](../../_assets/vertical-ellipsis.svg) для нужной учетной записи и выберите пункт **Удалить**.
