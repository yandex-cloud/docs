...
- Консоль управления {#console}
  ...
  * **Offline partitions** — показывает значения параметров:
      ...
      * `Under min ISR partitions` — количество разделов, у которых число синхронизированных реплик меньше минимально допустимого значения, указанного в [настройках](../concepts/settings-list.md).
