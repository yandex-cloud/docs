...
Обновление доступно только на следующую версию относительно текущей, например, с версии 2.6 на 2.8. Обновление до более поздних версий производится поэтапно. Например, обновление версии {{ KF }} с 2.6 до 3.0 выполняется в такой последовательности: 2.6 → 2.8 → 3.0.
...
Перед обновлением кластера убедитесь, что это не нарушит работу ваших приложений. Посмотрите [историю изменений](https://kafka.apache.org/downloads) {{ KF }} и проверьте, какие из обновлений могут влиять на работу приложений.
