...
Со списком поддерживаемых версий можно ознакомиться в разделе [Политика работы с версиями {{ KF }}](../concepts/update-policy.md).

Об обновлениях в рамках одной версии и обслуживании хостов в разделе [{#T}](../concepts/maintenance.md).
...
- Консоль управления {#console}
    ...
    В [консоли управления]({{ link-console-main }}) откройте страницу [создания](cluster-create.md) или [изменения кластера](cluster-update.md) {{ mkf-name }}. Список доступен в поле **{{ ui-key.yacloud.mdb.forms.base_field_version }}**.
...
Убедитесь, что это не нарушит работу ваших приложений — изучите [историю изменений](https://kafka.apache.org/community/downloads/) {{ KF }}.
