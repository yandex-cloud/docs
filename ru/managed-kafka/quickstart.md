...
[Топик](./concepts/topics.md) — центральная сущность в {{ KF }}: [производители](./concepts/producers-consumers.md) пишут сообщения в топик, а [потребители](./concepts/producers-consumers.md), в свою очередь, читают сообщения из топика.
