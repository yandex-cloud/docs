...
```
GET https://mdb.{{ api-host }}/managed-kafka/v1/clusters
```
...
clusters[].<br>config.<br>kafka.<br>kafkaConfig_2_1 | **object** <br>`clusters[].config.kafka` includes only one of the fields `kafkaConfig_2_1`, `kafkaConfig_2_6`, `kafkaConfig_2_8`<br><br><p>Kafka version 2.1 broker configuration.</p> 
