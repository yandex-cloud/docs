...
clusters[].<br>config.<br>kafka.<br>kafkaConfig_2_8 | **object** <br>`clusters[].config.kafka` includes only one of the fields `kafkaConfig_2_8`, `kafkaConfig_3`<br><br><p>Kafka version 2.8 broker configuration.</p> 
...
clusters[].<br>config.<br>kafka.<br>kafkaConfig_3 | **object** <br>`clusters[].config.kafka` includes only one of the fields `kafkaConfig_2_8`, `kafkaConfig_3`<br><br><p>Kafka version 3.x broker configuration.</p> 
