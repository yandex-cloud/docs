...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-kafka/v1/maintenances/{maintenanceId}
    method: get
    path:
      type: object
      properties:
...
# Managed Service for Apache Kafka® API, REST: Maintenance.Get
...
```
GET https://{{ api-host-mdb }}/managed-kafka/v1/maintenances/{maintenanceId}
```
