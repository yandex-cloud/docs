...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-kafka/v1/maintenances/{maintenanceId}:reschedule
    method: post
    path:
      type: object
      properties:
...
# Managed Service for Apache Kafka® API, REST: Maintenance.Reschedule
...
```
POST https://{{ api-host-mdb }}/managed-kafka/v1/maintenances/{maintenanceId}:reschedule
```
