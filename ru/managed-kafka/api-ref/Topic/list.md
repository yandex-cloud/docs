...
topics[].<br>topicConfig_2_8 | **object** <br>`topics[]` includes only one of the fields `topicConfig_2_8`, `topicConfig_3`<br><br><p>A topic settings for 2.8</p> 
...
topics[].<br>topicConfig_3 | **object** <br>`topics[]` includes only one of the fields `topicConfig_2_8`, `topicConfig_3`<br><br><p>A topic settings for 3.x</p> 
