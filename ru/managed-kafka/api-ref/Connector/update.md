...
--- | ---
clusterId | Required. ID of the Apache Kafka® cluster to update the connector in.  To get this ID, make a [list](/docs/managed-kafka/api-ref/Cluster/list) request.  The maximum string length in characters is 50.
connectorName | Required. Name of the connector to update.  To get this name, make a [list](/docs/managed-kafka/api-ref/Connector/list) request.  The maximum string length in characters is 256. Value must match the regular expression `` [a-zA-Z0-9_-]* ``.
...
connectorSpec.<br>connectorConfigMirrormaker | **object**<br>Configuration of the MirrorMaker connector.<br>
