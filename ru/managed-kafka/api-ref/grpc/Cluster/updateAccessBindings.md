---
editable: false
sourcePath: en/_api-ref-grpc/mdb/kafka/v1/api-ref/grpc/Cluster/updateAccessBindings.md
---

# Managed Service for Apache Kafka® API, gRPC: ClusterService.UpdateAccessBindings
