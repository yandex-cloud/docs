...
**rpc Delete ([DeleteConnectorRequest](#DeleteConnectorRequest)) returns ([operation.Operation](#Operation1))**
...
**rpc Resume ([ResumeConnectorRequest](#ResumeConnectorRequest)) returns ([operation.Operation](#Operation2))**
...
**rpc Pause ([PauseConnectorRequest](#PauseConnectorRequest)) returns ([operation.Operation](#Operation3))**
