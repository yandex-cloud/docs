...
Подробнее в разделе [Резервные копии в {{ mrd-name }}](concepts/backup.md).
...
- Расчет в рублях {#prices-rub}
  ...
  {% include [rub-valkey-host](../_pricing_examples/managed-valkey/rub-host.md) %}

- Расчет в тенге {#prices-kzt}

  {% include [kzt-valkey-host](../_pricing_examples/managed-valkey/kzt-host.md) %}
...
- Расчет в рублях {#prices-rub}
  ...
  {% include [rub-valkey-storage](../_pricing_examples/managed-valkey/rub-storage.md) %}

- Расчет в тенге {#prices-kzt}

  {% include [kzt-valkey-storage](../_pricing_examples/managed-valkey/kzt-storage.md) %}
