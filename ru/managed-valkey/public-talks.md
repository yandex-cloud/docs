---
title: Публичные материалы о {{ mrd-full-name }}
description: Видеозаписи конференций и вебинаров, посвященных {{ mrd-full-name }}.
---
...
* Как использовать {{ VLK }}: три практических сценария для приложений и ИИ. 

  * [Текст статьи](https://yandex.cloud/ru/blog/valkey-cache-locks-rag).

* {{ VLK }} и {{ RD }}® два года спустя — за кем будущее. 
