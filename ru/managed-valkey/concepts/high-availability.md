...
На высокую доступность кластера {{ mrd-name }} влияют параметры, относящиеся к [SLA](https://yandex.ru/legal/cloud_sla_mdb/ru/#klastera-servisa-upravlyaemogo-valkey-/-yandex-managed-service-for-valkey,-popadayushie-pod-dejstvie-urovnya-obsluzhivaniya), а также некоторые другие настройки.
