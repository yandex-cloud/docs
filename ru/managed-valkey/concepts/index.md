...
{{ VLK }} — это высокопроизводительная СУБД для данных типа «ключ-значение», работающая в оперативной памяти. Сервис {{ mrd-name }} позволяет легко создавать [кластеры](../../glossary/cluster.md) хостов {{ VLK }} с высокой отказоустойчивостью.
