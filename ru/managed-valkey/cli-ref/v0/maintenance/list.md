---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/managed-redis/cli-ref/v0/maintenance/list/
---

# yc managed-redis v0 maintenance list
...
`yc managed-redis maintenance list [Flags...] [Global Flags...]`
