...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-redis/v1/folders/{folderId}/retention_policies
    method: get
    path:
      type: object
      properties:
...
is larger than [ListBackupRetentionPoliciesRequest.pageSize](/docs/managed-redis/api-ref/BackupRetentionPolicy/list#yandex.cloud.mdb.redis.v1.ListBackupRetentionPoliciesRequest), use the `nextPageToken` as the value
for the [ListBackupRetentionPoliciesRequest.pageToken](/docs/managed-redis/api-ref/BackupRetentionPolicy/list#yandex.cloud.mdb.redis.v1.ListBackupRetentionPoliciesRequest) query parameter in the next list request.
