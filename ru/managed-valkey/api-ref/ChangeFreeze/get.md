...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-redis/v1/changeFreezes/{changeFreezeId}
    method: get
    path:
      type: object
      properties:
...
# Managed Service for Redis API, REST: ChangeFreeze.Get
...
```
GET https://{{ api-host-mdb }}/managed-redis/v1/changeFreezes/{changeFreezeId}
```
