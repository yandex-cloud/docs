---
title: Карта сервисов в трейсах
description: Узнайте, как использовать карту сервисов в {{ traces-name }} для анализа связей между сервисами, поиска источников ошибок и исследования распределенных запросов.
---
