...
Примеры в этом разделе приведены на Python. Для других языков API аналогичен — подробнее в [документации OpenTelemetry SDK](https://opentelemetry.io/docs/languages/).
