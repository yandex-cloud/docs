...
- Интерфейс {{ monium-name }} {#console}
  ...
  * Перейдите в раздел ![alt](../../../_assets/console-icons/shield-exclamation.svg) **Алерты и SLO** → ![alt](../../../_assets/console-icons/triangle-thunderbolt.svg) **{{ ui-key.yacloud_monitoring.aside-navigation.menu-item.notification-feed.title }}**.
