...
editable: false
apiPlayground:
  - url: https://logging.{{ api-host }}/logging/v1/sinks/{resourceId}:listAccessBindings
    method: get
    path:
      type: object
      properties:
...
# Cloud Logging Service, REST: Sink.ListAccessBindings
...
```
GET https://logging.{{ api-host }}/logging/v1/sinks/{resourceId}:listAccessBindings
```
