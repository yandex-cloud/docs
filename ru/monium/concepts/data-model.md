...
В этом разделе описана организация данных и особенности каждого вида данных. Поиск по данным — в разделе [{#T}](querying.md).
...
Выбор меток или метаинформации для логов описан в разделе [{#T}](../logs/concepts/attributes-guide.md).
