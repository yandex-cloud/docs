...
Как настроить передачу логов для ресурсов {{ yandex-cloud }}, описано в документации нужного ресурса. Например, настроить логирование кластера {{ AF }} можно при [создании](../../managed-airflow/operations/cluster-create.md) или [изменении](../../managed-airflow/operations/cluster-update.md) кластера.
...
Работа с логами описана в разделе [{#T}](logs-explorer.md).
