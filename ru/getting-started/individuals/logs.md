---
title: Инструкции для физических лиц по настройке записи логов и анализиру производительности
description: Из статьи вы узнаете, как настроить работу с логами для физических лиц и проанализировать производительность.
---
