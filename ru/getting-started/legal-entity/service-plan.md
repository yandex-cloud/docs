---
title: Настройте тарифный план поддержки для юридического лица
description: Из статьи вы узнаете про настройку тарифного плана поддержки для юридического лица.
---
