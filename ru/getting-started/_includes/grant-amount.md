...
* При [создании платежного аккаунта](../../billing/operations/create-new-account.md) привязали банковскую карту (вы не сможете получить грант, если привяжете карту _после_ создания аккаунта).
