...
Однако если срок действия [гранта](../usage-grant.md) истек, доступ к вашим ресурсам будет приостановлен на 60 дней или до момента перехода на платное потребление. Подробнее о завершении пробного периода на странице [{#T}](../free-trial/concepts/trial-ending.md).
...
Платформа {{ yandex-cloud }} соответствует требованиям PCI DSS, поэтому использовать облачные сервисы для обработки платежей безопасно. Подробнее о сертификации PCI DSS в разделе [{#T}](../../security/conform.md#pci-dss).
...
Счет-фактура физически также не предоставляется, вы можете самостоятельно сгенерировать его в консоли и распечатать. Подробнее в [{#T}](../../billing/operations/download-reporting-docs.md).
