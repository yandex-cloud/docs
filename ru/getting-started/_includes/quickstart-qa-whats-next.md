...
Однако если срок действия [гранта](../usage-grant.md) истек, доступ к вашим ресурсам будет приостановлен на 60 дней или до момента перехода на платное потребление. Подробнее о завершении пробного периода см. на странице [{#T}](../free-trial/concepts/trial-ending.md).
