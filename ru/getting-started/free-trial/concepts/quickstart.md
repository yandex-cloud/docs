...
Включение пробного периода происходит только на этапе [создания первого платежного аккаунта](../../../billing/quickstart/index.md) в консоли управления {{ yandex-cloud }}.
