...
* _Первая часть_ — 6 000 ₸ от общего размера гранта. Может использоваться для оплаты услуг сервиса [{{ compute-full-name }}](/services/compute), инструментов [{{ marketplace-full-name }}](/marketplace) и услуг [технической поддержки](../support).
