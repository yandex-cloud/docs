...
Условия использования стартового гранта различаются для личных и бизнес-аккаунтов. Подробнее о грантах в документации [{{ billing-name }}](../billing/concepts/bonus-account.md).
