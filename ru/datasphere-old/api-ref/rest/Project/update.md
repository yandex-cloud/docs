...
# DataSphere API v1, REST: Project.update
...
--- | ---
projectId | <p>Required. ID of the Project resource to update. To get the project ID use a <a href="/docs/datasphere/api-ref/v1/Project/list">list</a> request.</p> <p>The maximum string length in characters is 200.</p> 
