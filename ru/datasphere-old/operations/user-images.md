...
Чтобы {% if lang == "ru" %}[Docker-образ](/blog/posts/2022/03/docker-containers){% else %}Docker-образ{% endif %} запускался и корректно работал в {{ ml-platform-name }}, он должен содержать:
