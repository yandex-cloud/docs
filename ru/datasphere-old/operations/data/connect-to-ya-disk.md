...
## Загрузите содержимое из файла на Яндекс Диске в файл проекта {{ ml-platform-name }} {#get-file}
...
## Загрузите содержимое из каталога на Яндекс Диске в каталог проекта {{ ml-platform-name }} {#get-dir}
...
## Загрузите содержимое из файла проекта {{ ml-platform-name }} в файл на Яндекс Диске {#put-file}
...
## Загрузите содержимое из каталога проекта {{ ml-platform-name }} в каталог на Яндекс Диске {#put-dir}
...
* [Как исправить ошибку <q>The following variables cannot be serialized</q>?](../../qa/index.md#error-variables)