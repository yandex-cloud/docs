...
- Консоль управления
    ...
    1. Вставьте в поле **Публичный ключ** публичную часть вашего {% if lang == "ru" and audience != "internal" %}[SSH-ключа](../../glossary/vpn.md){% else %}SSH-ключа{% endif %}. Как сгенерировать и использовать SSH-ключи, читайте в [документации {{ compute-full-name }}](../../compute/operations/vm-connect/ssh.md).
