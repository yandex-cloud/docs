...
Специальные фоновые операции доступны только в [режиме раннего доступа](../early-access/index.md).
...
В отличие от [фонового запуска одной операции](async.md), для специальных фоновых операций нужно указать желаемое количество запусков, периодичность сохранения промежуточных результатов и правило выбора конечного результата.
