...
Модели развертываются на _инстансах_ — {% if lang == "ru" and audience != "internal" %}[виртуальных машинах](../../../glossary/vm.md){% else %}виртуальных машинах{% endif %}, на которых будет зафиксировано состояние интерпретатора и код модели.
