...
1. Откройте главную страницу [{{ datalens-short-name }}]({{ link-datalens-main }}/) и нажмите **Создать дашборд**.
...
1. Перейдите на созданный дашборд (можно со страницы [дашбордов]({{ link-datalens-main }}/dashboards)).
