...
На [трейл](../concepts/trail.md) роль можно назначить через {{ yandex-cloud }} [CLI](../../cli/cli-ref/managed-services/audit-trails/trail/add-access-binding.md) или [API](../api-ref/authentication.md).
