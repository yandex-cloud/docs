...
editable: false
apiPlayground:
  - url: https://audittrails.{{ api-host }}/audit-trails/v1/trails/{resourceId}:updateAccessBindings
    method: post
    path:
      type: object
      properties:
...
```
POST https://audittrails.{{ api-host }}/audit-trails/v1/trails/{resourceId}:updateAccessBindings
```
