...
# Application Load Balancer Audit Trails Events: StopLoadBalancer

## Event JSON schema {#yandex.cloud.audit.apploadbalancer.StopLoadBalancer2-schema}
...
## Field description {#yandex.cloud.audit.apploadbalancer.StopLoadBalancer2}
...
|| details | **[EventDetails](#yandex.cloud.audit.apploadbalancer.StopLoadBalancer.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.apploadbalancer.StopLoadBalancer.EventDetails}
