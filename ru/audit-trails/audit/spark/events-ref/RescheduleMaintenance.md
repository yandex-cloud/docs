...
# Managed Spark Audit Trails Events: RescheduleMaintenance

## Event JSON schema {#yandex.cloud.audit.spark.RescheduleMaintenance2-schema}
...
## Field description {#yandex.cloud.audit.spark.RescheduleMaintenance2}
