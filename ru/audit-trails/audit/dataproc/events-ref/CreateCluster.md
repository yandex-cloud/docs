...
# Yandex Data Processing Audit Trails Events: CreateCluster

## Event JSON schema {#yandex.cloud.audit.dataproc.CreateCluster2-schema}
...
## Field description {#yandex.cloud.audit.dataproc.CreateCluster2}
