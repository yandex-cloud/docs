...
## Event JSON schema {#yandex.cloud.audit.connectionmanager.DeleteConnection2-schema}
...
## Field description {#yandex.cloud.audit.connectionmanager.DeleteConnection2}
