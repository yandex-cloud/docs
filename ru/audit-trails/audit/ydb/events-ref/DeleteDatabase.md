...
# Managed Service for YDB Audit Trails Events: DeleteDatabase

## Event JSON schema {#yandex.cloud.audit.ydb.DeleteDatabase2-schema}
...
## Field description {#yandex.cloud.audit.ydb.DeleteDatabase2}
...
|| details | **[EventDetails](#yandex.cloud.audit.ydb.DeleteDatabase.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.ydb.DeleteDatabase.EventDetails}
