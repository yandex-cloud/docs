...
# Compute Audit Trails Events: ResumeInstanceGroup

## Event JSON schema {#yandex.cloud.audit.compute.instancegroup.ResumeInstanceGroup2-schema}
...
## Field description {#yandex.cloud.audit.compute.instancegroup.ResumeInstanceGroup2}
...
|| details | **[EventDetails](#yandex.cloud.audit.compute.instancegroup.ResumeInstanceGroup.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.compute.instancegroup.ResumeInstanceGroup.EventDetails}
