...
# Security Deck CSPM Audit Trails Events: UpdateScanJob

## Event JSON schema {#yandex.cloud.audit.securitydeck.cspm.UpdateScanJob2-schema}
...
## Field description {#yandex.cloud.audit.securitydeck.cspm.UpdateScanJob2}
