...
# Security Deck Audit Trails Events: DeleteException

## Event JSON schema {#yandex.cloud.audit.securitydeck.kspm.DeleteException2-schema}
...
## Field description {#yandex.cloud.audit.securitydeck.kspm.DeleteException2}
