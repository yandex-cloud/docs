...
# Virtual Private Cloud Audit Trails Events: CreateSecurityGroup

## Event JSON schema {#yandex.cloud.audit.network.CreateSecurityGroup2-schema}
...
## Field description {#yandex.cloud.audit.network.CreateSecurityGroup2}
...
|| details | **[EventDetails](#yandex.cloud.audit.network.CreateSecurityGroup.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.network.CreateSecurityGroup.EventDetails}
