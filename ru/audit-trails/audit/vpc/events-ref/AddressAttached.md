...
# Virtual Private Cloud Audit Trails Events: AddressAttached

## Event JSON schema {#yandex.cloud.audit.network.AddressAttached2-schema}
...
## Field description {#yandex.cloud.audit.network.AddressAttached2}
...
|| details | **[EventDetails](#yandex.cloud.audit.network.AddressAttached.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.network.AddressAttached.EventDetails}
