...
# Managed Services for Kubernetes Audit Trails Events: UpdateCluster

## Event JSON schema {#yandex.cloud.audit.k8s.UpdateCluster2-schema}
...
## Field description {#yandex.cloud.audit.k8s.UpdateCluster2}
