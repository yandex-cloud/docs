...
# Managed Services for Kubernetes Audit Trails Events: ApiServerEscalate

## Event JSON schema {#yandex.cloud.audit.k8s.apiserver.ApiServerEscalate2-schema}
...
## Field description {#yandex.cloud.audit.k8s.apiserver.ApiServerEscalate2}
