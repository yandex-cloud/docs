...
# Managed Service for PostgreSQL Audit Trails Events: CreateUser

## Event JSON schema {#yandex.cloud.audit.mdb.postgresql.CreateUser2-schema}
...
## Field description {#yandex.cloud.audit.mdb.postgresql.CreateUser2}
