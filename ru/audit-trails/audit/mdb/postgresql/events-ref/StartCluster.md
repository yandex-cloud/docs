...
# Managed Service for PostgreSQL Audit Trails Events: StartCluster

## Event JSON schema {#yandex.cloud.audit.mdb.postgresql.StartCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.postgresql.StartCluster2}
