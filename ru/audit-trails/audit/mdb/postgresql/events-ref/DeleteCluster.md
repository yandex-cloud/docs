...
# Managed Service for PostgreSQL Audit Trails Events: DeleteCluster

## Event JSON schema {#yandex.cloud.audit.mdb.postgresql.DeleteCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.postgresql.DeleteCluster2}
