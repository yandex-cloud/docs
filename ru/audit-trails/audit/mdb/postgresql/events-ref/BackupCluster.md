...
# Managed Service for PostgreSQL Audit Trails Events: BackupCluster

## Event JSON schema {#yandex.cloud.audit.mdb.postgresql.BackupCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.postgresql.BackupCluster2}
...
|| details | **[ClusterBackupEventDetails](#yandex.cloud.audit.mdb.postgresql.ClusterBackupEventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## ClusterBackupEventDetails {#yandex.cloud.audit.mdb.postgresql.ClusterBackupEventDetails}
