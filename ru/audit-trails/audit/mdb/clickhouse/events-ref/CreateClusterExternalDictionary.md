...
## Event JSON schema {#yandex.cloud.audit.mdb.clickhouse.CreateClusterExternalDictionary2-schema}
...
## Field description {#yandex.cloud.audit.mdb.clickhouse.CreateClusterExternalDictionary2}
