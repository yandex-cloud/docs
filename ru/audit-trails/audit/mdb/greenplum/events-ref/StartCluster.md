...
# Managed Service for Greenplum® Audit Trails Events: StartCluster

## Event JSON schema {#yandex.cloud.audit.mdb.greenplum.StartCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.greenplum.StartCluster2}
