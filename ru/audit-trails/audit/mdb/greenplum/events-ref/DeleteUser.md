...
# Managed Service for Greenplum® Audit Trails Events: DeleteUser

## Event JSON schema {#yandex.cloud.audit.mdb.greenplum.DeleteUser2-schema}
...
## Field description {#yandex.cloud.audit.mdb.greenplum.DeleteUser2}
