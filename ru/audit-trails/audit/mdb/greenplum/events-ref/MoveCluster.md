...
# Managed Service for Greenplum® Audit Trails Events: MoveCluster

## Event JSON schema {#yandex.cloud.audit.mdb.greenplum.MoveCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.greenplum.MoveCluster2}
