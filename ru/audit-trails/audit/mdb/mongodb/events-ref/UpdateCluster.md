...
# Managed Service for MongoDB Audit Trails Events: UpdateCluster

## Event JSON schema {#yandex.cloud.audit.mdb.mongodb.UpdateCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.mongodb.UpdateCluster2}
