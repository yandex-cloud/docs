...
# Managed Service for OpenSearch Audit Trails Events: StartCluster

## Event JSON schema {#yandex.cloud.audit.mdb.opensearch.StartCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.opensearch.StartCluster2}
