...
# Managed Service for Apache Kafka® Audit Trails Events: CreateCluster

## Event JSON schema {#yandex.cloud.audit.mdb.kafka.CreateCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.kafka.CreateCluster2}
...
|| details | **[ClusterCreateEventDetails](#yandex.cloud.audit.mdb.kafka.ClusterCreateEventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## ClusterCreateEventDetails {#yandex.cloud.audit.mdb.kafka.ClusterCreateEventDetails}
...
|| hosts[] | **[HostDetails](#yandex.cloud.audit.mdb.kafka.HostDetails)** ||
...
## HostDetails {#yandex.cloud.audit.mdb.kafka.HostDetails}
