...
# Managed Service for Apache Kafka® Audit Trails Events: PauseConnector

## Event JSON schema {#yandex.cloud.audit.mdb.kafka.PauseConnector2-schema}
...
## Field description {#yandex.cloud.audit.mdb.kafka.PauseConnector2}
