...
# Managed Service for ValKey Audit Trails Events: StopCluster

## Event JSON schema {#yandex.cloud.audit.mdb.redis.StopCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.redis.StopCluster2}
