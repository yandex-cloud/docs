...
# Managed Service for ValKey Audit Trails Events: StartClusterFailover

## Event JSON schema {#yandex.cloud.audit.mdb.redis.StartClusterFailover2-schema}
...
## Field description {#yandex.cloud.audit.mdb.redis.StartClusterFailover2}
