...
# Managed Service for ValKey Audit Trails Events: MoveCluster

## Event JSON schema {#yandex.cloud.audit.mdb.redis.MoveCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.redis.MoveCluster2}
