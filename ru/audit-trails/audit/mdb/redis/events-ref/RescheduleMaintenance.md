...
# Managed Service for ValKey Audit Trails Events: RescheduleMaintenance

## Event JSON schema {#yandex.cloud.audit.mdb.redis.RescheduleMaintenance2-schema}
...
## Field description {#yandex.cloud.audit.mdb.redis.RescheduleMaintenance2}
