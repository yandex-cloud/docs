---
title: Загрузка аудитных логов облака в {{ yds-full-name }}
description: Следуя данной инструкции, вы сможете загрузить аудитные логи облака в {{ yds-name }}.
---
...
1. Назначьте роли сервисному аккаунту:
    ...
    - CLI {#cli}
      ...
      * [`ydb.viewer`](../../logging/security/index.md#roles-list) на каталог, в котором будет находиться трейл:
