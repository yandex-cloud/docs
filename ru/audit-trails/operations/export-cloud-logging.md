...
- Консоль управления
  ...
  1. Нажмите кнопку **Создать трейл** и укажите:
      ...
      * **Сервисный аккаунт** – выберите сервисный аккаунт, от имени которого трейл будет загружать аудитные логи в лог-группу.
      * **Назначение**:
          * **Назначение** – {{ cloud-logging-name }}.
          * **Лог-группа** – имя лог-группы. Вы можете создать новую лог-группу. Для этого нажмите кнопку **Создать новую** и укажите:
