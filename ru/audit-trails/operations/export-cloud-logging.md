...
По этой инструкции вы создадите новый трейл, который будет загружать аудитные логи ресурсов облака в лог-группу {{ cloud-logging-name }}.
...
1. Создайте сервисный аккаунт и назначьте ему роли: 
    ...
    * `logging.writer` на лог-группу или каталог.
