---
title: Загрузка аудитных логов каталога в {{ yds-full-name }}
description: Следуя данной инструкции, вы сможете загрузить аудитные логи каталога в {{ yds-name }}.
---

# Загрузка аудитных логов каталога в {{ yds-name }}


По этой инструкции вы создадите новый [трейл](../concepts/trail.md), который будет загружать аудитные логи уровня конфигурации всех ресурсов и (опционально) аудитные логи уровня сервисов выбранных сервисов отдельного каталога в поток данных {{ yds-name }}.
