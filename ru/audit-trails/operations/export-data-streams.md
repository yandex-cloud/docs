# Загрузка аудитных логов в {{ yds-name }}

Создайте новый [трейл](../concepts/trail.md), который будет загружать аудитные логи ресурсов отдельного облака или всех ресурсов организации в поток данных {{ yds-name }}.
