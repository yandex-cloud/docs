...
Всплески событий в аудитных логах могут быть связаны с временным прекращением записи. Например, при исчерпании [квот](limits.md) или ограничении пропускной способности события могут накапливаться в буфере {{ at-name }}. После устранения причин накопленные события доставляются в объект назначения, что может выглядеть как резкий всплеск активности.
