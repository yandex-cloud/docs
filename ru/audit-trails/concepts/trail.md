...
* **Сервисный аккаунт** — от имени которого будет выполняться загрузка аудитных логов в бакетили лог-группу; для определения доступной области сбора аудитных логов проверяются права этого аккаунта.
* **Назначение**:
