...
2. [Лог-группа](../../logging/operations/write-logs.md) — выступает промежуточным звеном между трейлом и триггером {{ sf-name }}.
3. Триггер {{ sf-name }} — вызывает функцию при добавлении записи в лог-группу.
4. Функция {{ sf-name }} — выполняет логику реагирования.  
