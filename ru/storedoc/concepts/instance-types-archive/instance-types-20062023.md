...
description: Класс хостов определяет вычислительные мощности, которые выделяются для каждого хоста в кластере {{ SD }}. Классы хостов {{ mmg-name }} до 20 июня 2023 года.
---

# Классы хостов {{ SD }} до 20 июня 2023 года
