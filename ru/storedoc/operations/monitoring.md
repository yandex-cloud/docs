...
- Консоль управления {#console}
  ...
  * **Open cursors total** — количество открытых курсоров на хостах шарда. При этом отображаются отдельно:
  ...
  * **Disk space usage per host** — процент использования дискового пространства на каждом хосте шарда.
  ...
  * **Asserts total** — прирост срабатывания ассертов на шарде.
