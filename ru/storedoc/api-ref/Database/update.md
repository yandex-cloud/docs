...
```
PATCH https://{{ api-host-mdb }}/managed-mongodb/v1/clusters/{clusterId}/databases/{databaseName}
```
...
## Body parameters {#yandex.cloud.mdb.mongodb.v1.UpdateDatabaseRequest}
