...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-mongodb/v1/clusters/{clusterId}:move
    method: post
    path:
      type: object
      properties:
...
```
POST https://{{ api-host-mdb }}/managed-mongodb/v1/clusters/{clusterId}:move
```
...
## Body parameters {#yandex.cloud.mdb.mongodb.v1.MoveClusterRequest}
