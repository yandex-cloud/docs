...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-mongodb/v1/clusters/{clusterId}:stop
    method: post
    path:
      type: object
      properties:
    ...
    body: null
    definitions: null
sourcePath: en/_api-ref/mdb/mongodb/v1/api-ref/Cluster/stop.md
---
...
```
POST https://{{ api-host-mdb }}/managed-mongodb/v1/clusters/{clusterId}:stop
```
