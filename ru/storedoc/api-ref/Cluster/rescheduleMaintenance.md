...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-mongodb/v1/clusters/{clusterId}:rescheduleMaintenance
    method: post
    path:
      type: object
      properties:
    ...
    body:
      ...
      additionalProperties: false
    definitions: null
sourcePath: en/_api-ref/mdb/mongodb/v1/api-ref/Cluster/rescheduleMaintenance.md
---
