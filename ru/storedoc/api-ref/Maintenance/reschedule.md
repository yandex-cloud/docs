...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-mongodb/v1/maintenances/{maintenanceId}:reschedule
    method: post
    path:
      type: object
      properties:
...
```
POST https://{{ api-host-mdb }}/managed-mongodb/v1/maintenances/{maintenanceId}:reschedule
```
