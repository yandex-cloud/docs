  ...
  - type: card-layout-block
    ...
    children:
      - type: basic-card
        ...
        url: https://yandex.cloud/ru/prices?state=2f482b8c4f24#calculator
        size: s
        border: shadow
        centered: true
        indent:
      ...
      - type: basic-card
        ...
        urlTitle: Прайс-лист
        url: https://yandex.cloud/ru/price-list?installationCode=ru&currency=RUB&services=dn2b0fi02sdmf46ijdl5
        size: s
        border: shadow
        centered: true
        indent:
...
* Размер хранилища, выделенный для кластеров БД.
    ...
    * Хранилище на локальных SSD-дисках (`local-ssd`) можно заказывать только для кластеров с тремя хостами и более:
    ...
    Подробнее об ограничениях хранилища, связанных с платформой, читайте в разделе [{#T}](./concepts/storage.md).
...
- Расчет в рублях {#prices-rub}
  ...
  {% include [rub-mongodb-host](../_pricing_examples/storedoc/rub-host.md) %}

- Расчет в тенге {#prices-kzt}

  {% include [kzt-mongodb-host](../_pricing_examples/storedoc/kzt-host.md) %}
...
- Расчет в рублях {#prices-rub}
  ...
  {% include [rub-mongodb-storage](../_pricing_examples/storedoc/rub-storage.md) %}

- Расчет в тенге {#prices-kzt}

  {% include [kzt-mongodb-storage](../_pricing_examples/storedoc/kzt-storage.md) %}
