...
[Кластер](../../glossary/cluster.md) {{ mspqr-name }} состоит из _шардов_, _роутера_ и _координатора_. Роутеры и координаторы запускаются на _хостах_ — виртуальных машинах с выделенными вычислительными ресурсами и зарезервированным объемом хранилища данных.
