...
_Ключ шардирования_ — это один или несколько столбцов таблицы, по которым система определяет, в какой шард будет помещена строка. Если ключ состоит из нескольких столбцов, он называется [составным](#composite-keys).
