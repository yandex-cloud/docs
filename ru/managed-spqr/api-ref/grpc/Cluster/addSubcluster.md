...
# Managed Service for SPQR API, gRPC: ClusterService.AddSubcluster

## gRPC request

**rpc AddSubcluster ([AddSubclusterRequest](#yandex.cloud.mdb.spqr.v1.AddSubclusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## AddSubclusterRequest {#yandex.cloud.mdb.spqr.v1.AddSubclusterRequest}
