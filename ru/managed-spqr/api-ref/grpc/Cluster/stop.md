---
editable: false
sourcePath: en/_api-ref-grpc/mdb/spqr/v1/api-ref/grpc/Cluster/stop.md
---

# Managed Service for SPQR API, gRPC: ClusterService.Stop

Stop the specified SPQR cluster.

## gRPC request

**rpc Stop ([StopClusterRequest](#yandex.cloud.mdb.spqr.v1.StopClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## StopClusterRequest {#yandex.cloud.mdb.spqr.v1.StopClusterRequest}
...
|| metadata | **[StopClusterMetadata](#yandex.cloud.mdb.spqr.v1.StopClusterMetadata)**
...
## StopClusterMetadata {#yandex.cloud.mdb.spqr.v1.StopClusterMetadata}
