...
Если у вас уже есть [промокод](../concepts/promo-code.md) для входа в консоль управления Яндекс.Облака, перейдите к шагу **Активировать промокод**. Если промокода еще нет, вы можете оставить заявку на его получение:
