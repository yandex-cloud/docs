...
5. Заполните анкету: 
    ...
    **[!TAB Бизнес-аккаунт]**
    ...
    <br/>Если вы выбрали способ **Банковская карта**, привяжите корпоративную банковскую карту:
    - Нажмите кнопку **Добавить карту**.
    - Укажите данные карты: 16-значный номер, срок действия, код CVV (с обратной стороны карты).
    - Нажмите кнопку **Сохранить**.
   ...
   [!INCLUDE [yandex-account](../_includes/payment-card-validation.md)]
    ...
    <br/>Если вы выбрали способ **Банковский перевод**, нажмите кнопку **Отправить запрос на создание платежного аккаунта**. На электронную почту, указанную в вашем аккаунте Яндекс.Паспорта или Яндекс.Коннекта, будет отправлено письмо с описанием дальнейших действий. 
