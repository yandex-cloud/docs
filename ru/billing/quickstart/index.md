...
Если у вас уже есть [промокод](../concepts/promo-code.md) для входа в консоль управления Яндекс.Облака, перейдите к шагу **2**. Если промокода еще нет, вы можете оставить заявку на его получение:
...
### **2. Активируйте промокод** {#activate_promocode}
...
### **3. Создайте платежный аккаунт** {#create_billing_account}
