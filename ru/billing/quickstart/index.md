...
5. Заполните анкету: 
    ...
    **[!TAB Бизнес-аккаунт]**
    ...
    > [!NOTE]
    >
    > Привязка банковской карты необходима только для создания платежного аккаунта. Средства с привязанной карты могут быть списаны только после [активации платной версии](../operations/activate-commercial.md) и использования сервисов Яндекс.Облака. После активации платной версии вы можете [изменить способ оплаты](../payment/payment-methods-business.md). 
    >
