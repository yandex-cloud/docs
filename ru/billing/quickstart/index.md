...
1. Авторизуйтесь на Яндексе: 
    ...
    - Если вы не авторизованы на Яндексе или в Яндекс.Коннекте, нажмите кнопку **Войти**. Затем введите логин и пароль и нажмите кнопку **Войти**. <br/>Откроется страница **Список аккаунтов** в консоли управления.
