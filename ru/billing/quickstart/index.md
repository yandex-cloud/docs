...
1. Заполните анкету: 
    ...
    **[!TAB Бизнес-аккаунт]**
    ...
    - **Банковская карта**
      ...
      > [!NOTE]
      >
      > Привязка банковской карты необходима только для создания платежного аккаунта. Средства с привязанной карты могут быть списаны только после [активации платной версии](../operations/activate-commercial.md) и использования сервисов Яндекс.Облака. Вы можете [отвязать карту](../operations/pin-card.md) в любой момент после создания платежного аккаунта. 
      >
