...
Доступ к сервису Биллинг предоставляется пользователям с зарегистрированным аккаунтом в Яндекс.Паспорте. К аккаунту обязательно должен быть привязан ваш номер телефона. Если у вас еще нет аккаунта, [создайте его](https://passport.yandex.ru/registration). См. [подробную инструкцию](https://passport.yandex.ru/registration) в Помощи Яндекс.Паспорта.
...
1. Получите [промокод](../concepts/promo-code.md) для входа в консоль управления Яндекс.Облака: 
    ...
    - Если промокода еще нет, вы можете оставить заявку на его получение:
       ...
       **[!TAB Юридические лица]**
        ...
        2.7. Выберите области, в которых вы планируете использовать сервисы Яндекс.Облака.
        
        2.8. Ознакомьтесь и подтвердите согласие с [Политикой конфиденциальности](https://yandex.ru/legal/confidential/) и [Пользовательским соглашением](https://yandex.ru/legal/rules/).  
        
        2.9. Нажмите кнопку **Отправить**. 
...
6. Создайте [платежный аккаунт](../concepts/billing-account.md): 
    ...
    6.1. Нажмите кнопку **Создать аккаунт**.
...
7. Выберите сервис и приступите к работе: 
    - [Yandex Compute Cloud](../../compute/)
    - [Yandex Managed Databases](../../mdb/)
