...
5. Заполните анкету: 
    ...
    **[!TAB Бизнес-аккаунт]**
    ...
    Выберите способ оплаты: перевод с расчетного счета (через банк) или перевод с банковской карты.
      
    Если вы выбрали перевод с расчетного счета, введите данные вашей организации: 
    ...
    Если вы выбрали перевод с банковской карты: 
     - Нажмите кнопку **Добавить карту**.
     - Укажите данные карты: 16-значный номер, срок действия, код CVV (с обратной стороны карты).
     - Нажмите кнопку **Сохранить**.
