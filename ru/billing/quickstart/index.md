...
Новые клиенты, являющиеся физическими лицами, начинают работу с {{ yandex-cloud }} в платном потреблении. Пробный период для них недоступен.

Для новых клиентов, являющихся юридическими лицами, условия зависят от способа оплаты:

* **Банковская карта** — платежный аккаунт создается сразу в платном потреблении. Пробный период не предусмотрен.
* **Банковский перевод** — доступен [_пробный период_](../concepts/trial-period.md), который позволяет бесплатно исследовать возможности облачной инфраструктуры с некоторыми ограничениями. Чтобы продолжить пользоваться ресурсами после завершения пробного периода, необходимо перейти на платную версию.
