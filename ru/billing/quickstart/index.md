...
1. Заполните анкету: 
    ...
    **[!TAB Бизнес-аккаунт]**
    ...
    Укажите юридическую информацию о вашей организации и привяжите корпоративную банковскую карту:
      ...
      > [!NOTE]
      >
      > Привязка банковской карты необходима только для создания платежного аккаунта. Средства с привязанной карты могут быть списаны только после [активации платной версии](../operations/activate-commercial.md) и использования сервисов Яндекс.Облака. <br/>Если вы хотите оплачивать ресурсы с помощью банковского перевода, отправьте запрос на [изменение способа оплаты](../operations/change-payment-method.md). Ваш запрос будет рассмотрен в течение трех рабочих дней. В случае положительного решения будет создан платежный аккаунт с типом **Бизнес-аккаунт** и способом оплаты **Банковский перевод**. 
      >
