...
После создания платежного аккаунта вы получите [_стартовый грант_](../concepts/bonus-account.md#start), который можно использовать для оплаты ресурсов.

Для новых клиентов, являющихся юридическими лицами, доступен [_пробный период_](../concepts/trial-period.md). Пробный период позволяет бесплатно исследовать возможности облачной инфраструктуры с некоторыми ограничениями. Чтобы продолжить пользоваться ресурсами после завершения пробного периода, необходимо перейти на платную версию.
