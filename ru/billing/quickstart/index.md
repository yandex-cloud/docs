...
description: Чтобы пользоваться сервисами облака {{ yandex-cloud1 }}, зарегистрируйте: и создайте платежный аккаунт. Аккаунт необходим, даже если вы планируете пользоваться только бесплатными сервисами.
keywords:
