...
1. Введите {% if product == "yandex-cloud" %}Яндекс ID или логин Яндекс 360{% endif %}{% if product == "cloud-il" %}логин от Google-аккаунта пользователя{% endif %}. В выпадающем списке отобразятся пользователи, удовлетворяющие поиску. Выберите нужного.
