...
description: "Доступ к Биллингу предоставляется пользователям с зарегистрированным аккаунтом на Яндексе или в Яндекс.Коннекте. Доступ к платежному аккаунту предоставляется через сервис Биллинг. Операции, которые пользователь может выполнять над платежным аккаунтом, определяются назначенной ему ролью."
---
...
1. В [консоли управления](https://console.cloud.yandex.ru/billing), в левом верхнем углу страницы, нажмите на ![image](../../_assets/ugly-sandwich.svg) и перейдите в раздел **Биллинг**.
...
1. Введите Яндекс ID или логин Яндекс.Коннекта. В выпадающем списке отобразятся пользователи, удовлетворяющие поиску. Выберите нужного.
