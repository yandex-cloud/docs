...
costBudgetSpec | **object**<br>Cost budget specification. <br> includes only one of the fields `costBudgetSpec`, `expenseBudgetSpec`, `balanceBudgetSpec`<br><br><p>Cost budget specification describes budget that can be used to control cost of cloud resources usage.</p> 
...
costBudgetSpec.<br>thresholdRules[] | **object**<br><p>Rules that define intermediate cost thresholds of the budget.</p> 
...
costBudgetSpec.<br>filter | **object**<br>Filter that can be used for specific resources selection. Only consumption expense of selected resources are used for the budget calculation.<br><p>Filter that can be used for specific resources selection.</p> 
...
costBudgetSpec.<br>filter.<br>cloudFoldersFilters[] | **object**<br><p>Filter that can be used for specific cloud and its folders selection.</p> 
...
expenseBudgetSpec | **object**<br>Expense budget specification. <br> includes only one of the fields `costBudgetSpec`, `expenseBudgetSpec`, `balanceBudgetSpec`<br><br><p>Expense budget specification describes budget that can be used to control expense of cloud resources usage.</p> 
...
expenseBudgetSpec.<br>thresholdRules[] | **object**<br><p>Rules that define intermediate cost thresholds of the budget.</p> 
...
expenseBudgetSpec.<br>filter | **object**<br>Filter that can be used for specific resources selection. Only consumption cost of selected resources are used for the budget calculation.<br><p>Filter that can be used for specific resources selection.</p> 
...
expenseBudgetSpec.<br>filter.<br>cloudFoldersFilters[] | **object**<br><p>Filter that can be used for specific cloud and its folders selection.</p> 
...
balanceBudgetSpec | **object**<br>Balance budget specification. <br> includes only one of the fields `costBudgetSpec`, `expenseBudgetSpec`, `balanceBudgetSpec`<br><br><p>Balance budget specification describes budget that can be used to control <a href="/docs/billing/api-ref/BillingAccount#representation">BillingAccount.balance</a>.</p> 
...
balanceBudgetSpec.<br>thresholdRules[] | **object**<br><p>Rules that define intermediate cost thresholds of the budget.</p> 
