...
<br/>Чтобы получить бумажные оригиналы документов со всеми подписями и печатями, [отправьте запрос](../qa/common.md) в службу поддержки Яндекс.Облака через консоль управления. В запросе обязательно укажите номер договора (указан в акте) и период, за который необходимо предоставить документы. 
