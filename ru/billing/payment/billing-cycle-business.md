...
1. В течение всего расчетного периода проверяется баланс вашего лицевого счета:  <br/>

  ---  
                                                                                      
  **[!TAB Баланс положительный]**  
    
   Возвращаемся к шагу 2.<br/>Если наступил конец расчетного периода и в течение этого периода были использованы средства с лицевого счета, то формируются [акт](../concepts/act.md) и [счет-фактура](../concepts/invoice.md). Копии этих документов отправляются на электронную почту владельца платежного аккаунта. 
 
    
  **[!TAB Баланс отрицательный]** 
  
   Если кредитный лимит не исчерпан и конец расчетного периода еще не наступил, возвращаемся к шагу 2.
   Если кредитный лимит исчерпан и конец расчетного периода еще не наступил, формируются [счет на оплату](../concepts/bill.md), акт об оказанных услугах и счет-фактура. Копии этих документов отправляются на электронную почту владельца платежного аккаунта. <br/>Оплатить счет необходимо в сроки, предусмотренные [договором](../concepts/contract.md).
   Если кредитный лимит не исчерпан и наступил конец расчетного периода наступил, формируются [счет на оплату](../concepts/bill.md), акт об оказанных услугах и счет-фактура. Копии этих документов отправляются на электронную почту владельца платежного аккаунта. <br/>Оплатить счет необходимо в сроки, предусмотренные [договором](../concepts/contract.md).
