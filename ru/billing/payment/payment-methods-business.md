...
* сумма платежа;
* банковские реквизиты ООО «Яндекс.Облако» для Российской Федерации (РФ) и Республики Беларусь (РБ), ТОО «Яндекс.Облако Казахстан» для Республики Казахстан (РК), Iron Hive doo Beograd (Serbia) (для нерезидентов РФ и РК);
