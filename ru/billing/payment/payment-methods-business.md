...
* сумма платежа;
* банковские реквизиты ООО «Яндекс.Облако» для Российской Федерации (РФ), ТОО «Яндекс.Облако Казахстан» для Республики Казахстан (РК), Intertech Services AG (для нерезидентов РФ и РК);
