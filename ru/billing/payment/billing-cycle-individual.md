...
1. Проверяется остаток кредитных средств: 
     ...
     <br/>4.2. Если наступил конец расчетного периода и/или кредитный лимит исчерпан, [рассчитывается](payment-methods-individual.md#payment-amount) итоговая сумма к оплате и инициируется списание средств с привязанной банковской карты. Перейдите к шагу 5. 
