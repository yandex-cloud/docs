...
В начале следующего расчетного месяца с банковской карты, привязанной к платежному аккаунту, автоматически списываются средства за потребленные в прошлом месяце ресурсы (но только если итоговая сумма списания больше нуля). 
