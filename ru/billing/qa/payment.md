...
[Кредитный лимит](../concepts/credit-limit.md) может быть вам предоставлен автоматически после [активации платной версии](../operations/activate-commercial.md).
Если кредитный лимит не подключился автоматически, [отправьте заявку](../operations/enable-credit.md) на его подключение.