...
Способ оплаты можно изменить только в платежном аккаунте c типом **Бизнес-аккаунт**: вы можете [привязать корпоративную банковскую карту](../operations/pin-card.md).
