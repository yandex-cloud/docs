Счет выставляется, если в платежном аккаунте выбран способ оплаты **Перевод с расчетного счета (через банк)**. Выставление счета зависит от использования [кредитного лимита](../concepts/credit-limit.md) и итоговой суммы счета.
