Счет выставляется, если в качестве способа оплаты вы используете перевод с расчетного счета (через банк). Выставление счета также зависит от использования [кредитного лимита](../concepts/credit-limit.md) и итоговой суммы счета.
