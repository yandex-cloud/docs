Для заключения договора необходимо отправить заявку через форму **Задать вопрос** на странице [Свяжитесь с нами](https://cloud.yandex.ru/support). Если по вашей заявке будет принято положительное решение, {{ yandex-cloud }} подготовит договор и отправит вам его электронную версию на подпись. Как только вы получите копию:
