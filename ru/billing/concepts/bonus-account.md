...
Дополнительные гранты могут быть предоставлены по решению менеджера {{ yandex-cloud }} или в рамках [контент-программы](../../../content-program), [реферальной программы](../../../referral-program) и [программы Yandex Cloud Boost](../../../cloud-boost). Размер дополнительных грантов и срок их действия отображается в консоли управления.
