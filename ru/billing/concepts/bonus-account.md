...
Одному физическому лицу, ИП или организации может быть выдан только один стартовый грант. Грант может быть отозван по усмотрению {{ yandex-cloud }} без объяснения причин.
