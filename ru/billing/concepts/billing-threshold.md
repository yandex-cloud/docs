...
- Физические лица {#individuals}
  ...
  Отслеживать состояние [баланса лицевого счета](../concepts/personal-account.md#balance) можно в [сервисе {{ billing-name }}]({{ link-console-billing }}) на странице ![image](../../_assets/console-icons/flag.svg) **{{ ui-key.yacloud_org.billing.account.switch_overview }}**:
