...
1. В начале следующего отчетного периода проверяется баланс лицевого счета и оплата использованных сервисов: в зависимости от [типа платежного аккаунта](../concepts/billing-account.md#ba-types) вам может быть выставлен счет на оплату или могут быть списаны средства с привязанной банковской карты. Подробная информация в разделах [Цикл оплаты для физических лиц](../../billing/payment/billing-cycle-individual.md) и [Цикл оплаты для организаций и ИП](../../billing/payment/billing-cycle-business.md).
