...
Счет — документ на оплату потребленных ресурсов. Счет выставляется на основании [договора](../concepts/contract.md) в рамках [платежного аккаунта](billing-account.md) и содержит агрегированные данные по всем используемым сервисам в рамках одного облака.
...
Выставление счета также зависит от нескольких факторов: 
