...
- Предназначен для резидентов РФ.
- Для оплаты потребленных ресурсов используется перевод с расчетного счета (через банк) или перевод с корпоративной банковской карты. Подробнее см. раздел [Цикл оплаты для юридических лиц](../payment/payment-methods.md) и [Способы оплаты](../payment/payment-methods.md).
