...
{% list tabs %}
 ...
 - Бизнес-аккаунт
   ...
   * Для оплаты потребленных ресурсов используется банковский перевод с [расчетного счета организации](../payment/payment-methods-business.md) и перевод с [корпоративной банковской карты](../payment/payment-methods-card-business.md).
