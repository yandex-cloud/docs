...
{% list tabs %}
 ...
 - Бизнес-аккаунт
   ...
   - Акт на оказанные услуги и счет-фактура (только для резидентов РФ или РК) высылаются на электронную почту в начале следующего расчетного периода. Подробнее см. раздел [Финансовые документы](../payment/documents.md).
