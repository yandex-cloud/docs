...
- `PAY_OR_BIND` — платежный аккаунт создан, но к нему не привязана банковская карта.
...
`PAY_OR_BIND` | Отсутствует | Использование сервисов {{ yandex-cloud }} возможно с ограничениями: доступны бесплатные ресурсы и создание облаков. <br/>Для использования других сервисов необходимо [привязать](../operations/pin-card.md) банковскую карту к аккаунту или [пополнить](../operations/pay-the-bill.md) баланс вручную. <br/>Статус сохраняется до тех пор, пока вы не привяжете банковскую карту.
