...
Физические лица, организации и ИП могут просматривать историю расходов. Организации и ИП, которые являются резидентами РФ и РК, могут скачивать отчетные документы в консоли управления {{ yandex-cloud }}.
...
- Физическим лицам
  ...
  Физические лица, которые являются резидентами РФ и РК, могут просматривать историю расходов помесячно в консоли управления {{ yandex-cloud }}.
...
- Организациям и ИП
  ...
  **Юридическим лицам РФ**
    ...
    1. Когда статус запроса изменится на **{{ ui-key.yacloud.billing.account.reconciliation-reports.value_completed }}**, в столбце **Действие** появится кнопка для скачивания. Выберите **{{ ui-key.yacloud.billing.account.reconciliation-reports.action_download-with-facsimile }}** или **Скачать без подписи**.
