...
- {{ billing-interface }} {#billing}
  ...
  1. Справа вверху нажмите ![image](../../_assets/console-icons/arrow-up-right-from-square.svg) **{{ ui-key.yacloud_billing_account.billing-account-detail.button_move-to-datalens }}**.
