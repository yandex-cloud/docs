...
Если способ оплаты вашего платежного аккаунта — **Банковская карта**, вы можете самостоятельно отвязать банковскую карту в [Яндекс.Паспорте]{% if lang == "ru" %}(https://passport.yandex.ru/profile){% endif %}{% if lang == "en" %}(https://passport.yandex.com/profile){% endif %}. Тогда она автоматически отвяжется от всех сервисов Яндекса, включая {{ yandex-cloud }}.
