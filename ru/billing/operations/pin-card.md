...
Отвязать банковскую карту можно только в платежном аккаунте c типом **Бизнес-аккаунт**. Для этого напишите запрос в [службу поддержки](../qa/common.md), прикрепив к нему следующие документы: 
