...
Отвязать банковскую карту можно только в платежном аккаунте c типом **Бизнес-аккаунт**. Для этого напишите запрос в [службу поддержки](../qa/common.md). К запросу прикрепите следующие документы: 
