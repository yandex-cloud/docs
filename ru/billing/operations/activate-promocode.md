...
Если вы получили [промокод](../concepts/promo-code.md) в рамках маркетинговой акции от {% if product == "yandex-cloud" %}Яндекса{% endif %}{% if product == "cloud-il" %}{{ yandex-cloud }}{% endif %}, активируйте его:
