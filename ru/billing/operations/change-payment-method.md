...
Чтобы изменить способ, отправьте запрос на электронную почту [cloud_docs@support.yandex.ru](mailto:cloud_docs@support.yandex.ru), указав полное название организации и идентификатор облака (cloud id). К запросу также прикрепите документы: 
