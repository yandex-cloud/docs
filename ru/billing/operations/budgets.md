...
{% if product == "yandex-cloud" %}* _Остаток средств_ — уведомление отправляется, когда баланс лицевого счета становится меньше установленного порога.{% endif %}
...
1. Перейдите на страницу **Бюджеты** и нажмите **Создать бюджет**.
   ...
   1. Задайте **Сумму бюджета**: {% if product == "cloud-il" %}укажите сумму расходов на потребление.{% endif %}
      {% if product == "yandex-cloud" %}
