...
После [активации платной версии](../operations/activate-commercial.md) и завершения первого расчетного периода вам может быть предоставлен кредит на использование сервисов Яндекс.Облака:
