...
После [активации платной версии](../operations/activate-commercial.md) и завершения первого расчетного периода вам может быть предоставлен [кредит](../concepts/credit-limit.md) на использование сервисов Яндекс.Облака:
...
1. Нажмите кнопку **Подключить кредитный лимит** на странице **Обзор**. Откроется форма заявки. 
