...
После [активации платной версии](../operations/activate-commercial.md) и завершения первого расчетного периода вам может быть предоставлен [кредитный лимит](../concepts/credit-limit.md) на использование сервисов {{ yandex-cloud }}:
...
Вашу заявку рассмотрят в течение трех рабочих дней. Как только решение будет принято, с вами свяжется менеджер {{ yandex-cloud }}. В случае положительного решения вся информация о кредитном лимите будет доступна  в [консоли управления]({{ link-console-billing }}).
