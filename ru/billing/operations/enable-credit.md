...
После [активации платной версии](../operations/activate-commercial.md) и завершения первого расчетного периода вам может быть предоставлен [порог оплаты](../concepts/credit-limit.md) на использование сервисов {{ yandex-cloud }}:
