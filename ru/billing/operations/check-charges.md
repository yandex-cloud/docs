...
Вы можете посмотреть сведения по использованию сервисов Яндекс.Облака в виде графиков и таблицы. Для этого: 
...
4. Выберите [облака](#clouds) и [период](#period), [настройте группировку](#grouping) данных по сервисам и продуктам.
...
----- | -----
![image](../_assets/graph-icon.png) |- Дата, для которой действительно значение в текущей точке.<br/>- Стоимость потребленных услуг в рамках облака/продукта/сервиса. <br/>- Название продукта/облака/сервиса. 
![image](../_assets/gistogram-icon.png) |- Дата, для которой действительно значение в текущей точке.<br/>- Стоимость потребленных услуг в рамках облака/продукта/сервиса.<br/>- Название продукта/облака/сервиса.<br/>- Общая стоимость потребленных услуг.
![image](../_assets/norm-gistogram-icon.png) |- Дата, для которой действительно значение в текущей точке.<br/>- Доля потребленных услуг в рамках облака/продукта/сервиса от общего объема (в процентах).<br/>- Стоимость потребленных услуг в рамках облака/продукта/сервиса. <br/>- Название продукта/облака/сервиса.<br/>- Общая стоимость потребленных услуг.
![image](../_assets/diagram-icon.png) |- Дата, для которой действительно значение в текущей точке.<br/>- Стоимость потребленных услуг в рамках облака/продукта/сервиса.<br/>- Название продукта/облака/сервиса.<br/>- Общая стоимость потребленных услуг.   
![image](../_assets/norm-diagram-icon.png) |- Дата, для которой действительно значение в текущей точке.<br/>- Доля потребленных услуг в рамках облака/продукта/сервиса от общего объема (в процентах).<br/>- Стоимость потребленных услуг в рамках облака/продукта/сервиса.<br/>- Название продукта/облака/сервиса.<br/>- Общая стоимость потребленных услуг.  
