...
{{ yandex-cloud }} не предоставляет техническую поддержку продуктов {{ marketplace-short-name }}, размещенных сторонними издателями. Стоимость продуктов {{ marketplace-short-name }} не включается в расчет тарифа платной поддержки. Смотрите [пример расчета](../../../support/pricing.md#business-example-one-ba-cvos).
