...
description: Следуя данной инструкции, вы сможете привязать купленную подписку к ресурсу, приложению или сервису.
---
...
- {{ compute-name }} {#compute}
  ...
  1. В строке с нужной подпиской нажмите ![image](../../../_assets/console-icons/ellipsis.svg) и выберите **{{ ui-key.yacloud.marketplace-v2.action_specify-vm }}**.
...
- SaaS {#saas}
  ...
  1. В верхней части экрана нажмите ![image](../../../_assets/console-icons/shopping-cart.svg) **{{ ui-key.yacloud.marketplace-v2.label_service-name }}**.
  1. На панели слева выберите ![image](../../../_assets/console-icons/file-ruble.svg) **{{ ui-key.yacloud.marketplace-v2.label_licenses }}**.
  1. В строке с нужной подпиской нажмите ![image](../../../_assets/console-icons/ellipsis.svg) и выберите **{{ ui-key.yacloud.marketplace-v2.action_goto-partner-url }}**.
