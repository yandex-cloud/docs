...
description: Следуя данной инструкции, вы сможете отвязать купленную подписку от ресурса, приложения или сервиса.
---
...
- Консоль управления {#console}
  ...
  1. В строке с нужной подпиской нажмите ![image](../../../_assets/console-icons/ellipsis.svg) и выберите **{{ ui-key.yacloud.marketplace-v2.action_detach-subscription }}**.
