...
usageRecords[].<br>skuId | **string**<br><p>Обязательное поле. Marketplace SaaS Sku ID потребления, связанный с `UsageRecord.product_id`.</p> <p>Максимальная длина строки — 50 символов.</p> 
