...
Откройте страницу [Marketplace](https://cloud.yandex.ru/marketplace) и заполните заявку на добавление вашего продукта в Marketplace. После того, как Яндекс.Облако подтвердит заявку, вы получите по почте форму для договора, которую нужно заполнить, подписать и отправить в Яндекс.Облако. После этого вы получите доступ в кабинет партнера Marketplace.

## Создайте тариф {#create-tariff}

{% note warning %}

Яндекс.Облако взимает 20% комиссии от стоимости использования образов.
...
Чтобы создать продукт, нужно [загрузить образ ВМ в Яндекс.Облако](../compute/operations/image-create/upload.md). 
...
Первая версия продукта отправится на модерацию в Яндекс.Облако. После проверки вы получите письмо с подтверждением того, что ваш продукт доступен пользователям в публичном каталоге Marketplace.
