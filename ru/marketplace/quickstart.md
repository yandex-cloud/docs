...
---
# Начало работы с кабинетом партнера {{ marketplace-name }}
...
Образы продуктов для загрузки в Marketplace могут быть созданы на базе ОС Linux или Windows Server. Требования к образам и рекомендации по созданию образов описаны в инструкциях:
