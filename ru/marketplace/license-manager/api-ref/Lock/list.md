...
1. The field name. Currently you can use filtering only on [Lock.productId](/docs/marketplace/license-manager/api-ref/Instance/get#yandex.cloud.marketplace.licensemanager.v1.Template) field.
