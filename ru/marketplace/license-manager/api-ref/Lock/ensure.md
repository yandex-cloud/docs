...
editable: false
apiPlayground:
  - url: https://marketplace.{{ api-host }}/marketplace/license-manager/v1/locks/{instanceId}:ensure
    method: post
    path:
      type: object
      properties:
...
## Body parameters {#yandex.cloud.marketplace.licensemanager.v1.EnsureLockRequest}
