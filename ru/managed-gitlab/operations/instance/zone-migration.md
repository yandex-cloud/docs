...
1. Измените зону доступности у инстанса:
    ...
    * Консоль управления {#console}
        ...
        1. Проверьте работоспособность инстанса: выберите вкладку **{{ ui-key.yacloud.common.overview }}** и перейдите по ссылке в поле **{{ ui-key.yacloud.gitlab.field_domain }}**.
