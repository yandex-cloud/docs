...
# Правила ревью кода в {{ mgl-full-name }}
...
Настройка правил ревью кода осуществляется с помощью _[токена {{ GL }}]({{ gl.docs }}/ee/user/profile/personal_access_tokens.html)_. Токен запрашивается для авторизации при взаимодействии с репозиторием — так происходит обращение к API {{ GL }}.
