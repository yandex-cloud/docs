...
|| **Qwen3 235B** </br>`gpt://<идентификатор каталога>/qwen3-235b-a22b-fp8/latest` | — | 256 000 | Только [{{ openai }} API](../openai-compatibility.md) ||
|| **gpt-oss-120b** </br>`gpt://<идентификатор каталога>/gpt-oss-120b/latest` | — | 128 000 | Только [{{ openai }} API](../openai-compatibility.md) ||
|| **gpt-oss-20b** </br>`gpt://<идентификатор каталога>/gpt-oss-20b/latest` | — | 128 000 | Только [{{ openai }} API](../openai-compatibility.md) ||  
