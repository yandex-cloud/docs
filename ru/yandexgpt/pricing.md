...
Работа моделей краткого пересказа и моделей, дообученных в {{ ml-platform-full-name }}, тарифицируется по правилам {{ yagpt-name }} Lite.
...
> 4038,0 × (1,00&nbsp;₽ / 1000) = 4,038&nbsp;₽
>
> Итого, округляя до копеек: 4,04&nbsp;₽.
...
* 1,00&nbsp;₽ — стоимость за 1000 токенов.
* 1,00&nbsp;₽ / 1000 — стоимость за один токен.
