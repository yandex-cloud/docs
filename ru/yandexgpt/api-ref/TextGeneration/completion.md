---
editable: false
sourcePath: en/_api-ref/ai/foundation_models/v1/api-ref/TextGeneration/completion.md
---

# Foundation Models API, REST: TextGeneration.completion
...
alternatives[].<br>message.<br>role | **string**<br><p>Identifier of the message sender. Supported roles: TBD.</p> 
