...
Чтобы сгенерировать текст в [промт-режиме](../concepts/index.md#working-mode), отправьте запрос к модели с помощью метода [completion](../api-ref/v1/TextGeneration/completion.md).
