...
* **large, 8vCPU 8Gb RAM 60 HD** — генерирует до 40 000 запросов в секунду. Использовать агенты типа **large** нужно в долгих тестах с большим количеством параллельных соединений.
