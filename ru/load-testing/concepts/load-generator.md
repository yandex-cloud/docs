...
_Генератор нагрузки_ — это инструмент, который позволяет по заданной конфигурации эмулировать нагрузку на сервис. Яндекс.Танк, используемый в {{ load-testing-name }}, использует генераторы Pandora и Phantom.
