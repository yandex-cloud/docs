...
Яндекс.Танк использует генераторы нагрузки Phantom и Pandora. Доступные для использования типы данных зависят от поддержанных в выбранном генераторе форматов.
