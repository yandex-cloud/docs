...
Основные параметры теста задает конфигурация Яндекс.Танка — это время подачи нагрузки, ее объем, рост, вспомогательные функции. В простом случае {{ load-testing-name }} даёт возможность сконфигурировать тест из интерфейса. Для тонкой настройки можно загрузить свой файл конфигурации в формате YAML и редактировать его в интерфейсе.
