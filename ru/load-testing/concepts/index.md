...
* агент — ВМ с утилитой [Яндекс.Танк](tank.md) и [генераторами нагрузки](load-generator.md); 
* конфигурация теста;
* нагрузка.
...
Основные параметры теста задает конфигурация Яндекс.Танка — это время подачи нагрузки, ее объем, рост, вспомогательные функции. В простом случае {{ load-testing-name }} дает возможность сконфигурировать тест из интерфейса. Для тонкой настройки можно загрузить свой файл конфигурации в формате YAML и редактировать его в интерфейсе.
