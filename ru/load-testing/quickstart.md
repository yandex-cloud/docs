...
1. Агенту потребуется доступ в подсеть, в которой находится цель тестирования. Чтобы агент мог подключиться к сервису {{ load-testing-name }}, [создайте и настройте NAT-шлюз](../vpc/operations/create-nat-gateway.md).
