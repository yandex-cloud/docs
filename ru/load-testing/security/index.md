...
* Сервисные роли:
    ...
    * `loadtesting.editor` — разрешает просмотр и удаление отчетов, создание, удаление или редактирование [ВМ](../../glossary/vm.md) с агентами, разрешает запуск нагрузочных тестов, остановку теста, загрузку тестовых данных, удаление отчетов, загрузку результатов в хранилище.
