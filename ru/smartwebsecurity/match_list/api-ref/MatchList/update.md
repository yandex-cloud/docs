...
editable: false
apiPlayground:
  - url: https://smartwebsecurity.{{ api-host }}/smartwebsecurity/v1/matchLists/{listId}
    method: patch
    path:
      type: object
      properties:
        listId:
          description: |-
            **string**
            Required field. ID of the match list to update.
          type: string
      required:
        - listId
...
# SmartWebSecurity MatchList API, REST: MatchList.Update
...
```
PATCH https://smartwebsecurity.{{ api-host }}/smartwebsecurity/v1/matchLists/{listId}
```
...
## Body parameters {#yandex.cloud.smartwebsecurity.v1.match_list.UpdateMatchListRequest}
