...
# SmartWebSecurity CustomPage API, REST: CustomPage.List
...
```
GET https://smartwebsecurity.{{ api-host }}/smartwebsecurity/v1/customPages
```

## Query parameters {#yandex.cloud.smartwebsecurity.v1.custom_page.ListCustomPagesRequest}
...
## Response {#yandex.cloud.smartwebsecurity.v1.custom_page.ListCustomPagesResponse}
...
#|
||Field | Description ||
|| customPages[] | **[CustomPage](#yandex.cloud.smartwebsecurity.v1.custom_page.CustomPage)**
