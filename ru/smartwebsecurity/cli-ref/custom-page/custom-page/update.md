---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/smartwebsecurity/cli-ref/custom-page/custom-page/update/
---

# yc smartwebsecurity custom-page custom-page update
...
`yc smartwebsecurity custom-page custom-page update <CUSTOM-PAGE-ID>`
...
1. Generate template:
yc smartwebsecurity custom-page custom-page update --example-json > request.json
or
yc smartwebsecurity custom-page custom-page update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc smartwebsecurity custom-page custom-page update -r request.json
or
yc smartwebsecurity custom-page custom-page update -r request.yaml ||
|#
