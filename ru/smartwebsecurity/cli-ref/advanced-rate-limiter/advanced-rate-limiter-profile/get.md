---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/smartwebsecurity/cli-ref/advanced-rate-limiter/advanced-rate-limiter-profile/get/
---
...
`yc smartwebsecurity advanced-rate-limiter advanced-rate-limiter-profile get <ADVANCED-RATE-LIMITER-PROFILE-ID>`
