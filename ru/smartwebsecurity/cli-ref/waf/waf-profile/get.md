---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/smartwebsecurity/cli-ref/waf/waf-profile/get
editable: false
---

# yc smartwebsecurity waf waf-profile get
...
`yc smartwebsecurity waf waf-profile get <WAF-PROFILE-ID>`
