...
securityRules[].<br>ruleCondition | **object** <br>`securityRules[]` includes only one of the fields `ruleCondition`, `smartProtection`<br><br><p>RuleCondition object.</p> 
...
securityRules[].<br>smartProtection | **object** <br>`securityRules[]` includes only one of the fields `ruleCondition`, `smartProtection`<br><br><p>SmartProtection object.</p> 
