...
securityRules[].<br>ruleCondition | **object** <br>`securityRules[]` includes only one of the fields `ruleCondition`, `smartProtection`, `waf`<br><br><p>RuleCondition object.</p> 
...
securityRules[].<br>smartProtection | **object** <br>`securityRules[]` includes only one of the fields `ruleCondition`, `smartProtection`, `waf`<br><br><p>SmartProtection object.</p> 
...
securityRules[].<br>waf | **object** <br>`securityRules[]` includes only one of the fields `ruleCondition`, `smartProtection`, `waf`<br><br><p>Waf object.</p> 
