...
- Консоль управления {#console}
  ...
  1. Перейдите на вкладку **{{ ui-key.yacloud.smart-web-security.label_domain-protection-domains }}** и нажмите **{{ ui-key.yacloud.smart-web-security.ProxyServer.Domains.createDomain_49MGX }}**.
  ...
  1. При использовании HTTPS выберите выпущенный на указанный домен сертификат из [{{ certificate-manager-name }}](../../certificate-manager/index.yaml) или нажмите **{{ ui-key.yacloud.common.create }}** и выберите:
      ...
      * `{{ ui-key.yacloud.certificate-manager.CertificateField.userCertificate_bChXn }}` — если у вашего веб-приложения уже есть TLS-сертификат.
          ...
          1. Нажмите **{{ ui-key.yacloud.certificate-manager.CertificateImportDialog.createCertificate_x7Ww3 }}**.
  ...
  1. В блоке **{{ ui-key.yacloud.smart-web-security.DomainForm.TargetResourcesSection.targetResources_hqBQm }}** задайте настройки целевых ресурсов:
      ...
      1. (Опционально) Нажмите **{{ ui-key.yacloud.smart-web-security.DomainForm.TargetResourcesSection.addResource_qyJWd }}**, чтобы добавить подключения к дополнительным целевым ресурсам.
  ...
  1. Нажмите **{{ ui-key.yacloud.smart-web-security.CreateDomain.createDomain_b2Ykj }}**.
