---
title: Мониторинг и корректировка защиты ML WAF
description: Как отслеживать изменения в работе ML WAF после обновления модели и корректировать настройки защиты.
---
...
[Настройте логирование](configure-logging.md) через {{ sws-name }} и включите запись:
...
1. Временно повысьте порог аномальности проблемной группы или верните правило в режим **{{ ui-key.yacloud.smart-web-security.overview.column_dry-run-rule }}**.
...
Обратитесь в [службу поддержки]({{ link-console-support }}) {{ yandex-cloud }} в следующих ситуациях:
