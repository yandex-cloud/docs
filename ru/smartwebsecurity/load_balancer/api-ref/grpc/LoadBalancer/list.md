...
**rpc List ([ListLoadBalancersRequest](#yandex.cloud.smartwebsecurity.v1.load_balancer.ListLoadBalancersRequest)) returns ([ListLoadBalancersResponse](#yandex.cloud.smartwebsecurity.v1.load_balancer.ListLoadBalancersResponse))**

## ListLoadBalancersRequest {#yandex.cloud.smartwebsecurity.v1.load_balancer.ListLoadBalancersRequest}
...
Required field. ID of the folder to list load balancers in. ||
|#

## ListLoadBalancersResponse {#yandex.cloud.smartwebsecurity.v1.load_balancer.ListLoadBalancersResponse}
...
#|
||Field | Description ||
|| load_balancers[] | **[LoadBalancer](#yandex.cloud.smartwebsecurity.v1.load_balancer.LoadBalancer)**
