...
* `IP` — IP-адрес, диапазон или регион адресов клиентов, список адресов или [ASN](https://en.wikipedia.org/wiki/Autonomous_system_(Internet)), для которых будет применяться правило.
