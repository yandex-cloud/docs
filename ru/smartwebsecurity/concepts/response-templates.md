---
title: Шаблоны страниц ответов
description: Шаблоны страниц ответов помогают настроить текст и внешний вид сообщений, которые пользователь видит при срабатывании правил.
---
