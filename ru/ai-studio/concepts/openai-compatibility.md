...
API сервиса {{ foundation-models-name }} совместим с {{ openai }} API: полностью поддержаны Responses API, Realtime API и Vector Store API. Частично поддержана совместимость с Completions API.
