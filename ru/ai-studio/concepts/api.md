...
| [Chat Completions API](../chat/index.md) | REST | Генерация текста по промту без управления диалогом |
...
| Tuning API  | [gRPC](../mcp-gateway/api-ref/grpc/index.md) | Дообучение моделей под предметную область  |
