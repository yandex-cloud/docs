...
* [{{ code-interpreter }}](../../concepts/agents/tools/code-interpreter.md) — позволяет агенту писать, воспроизводить и отлаживать Python-код в виртуальной тестовой среде. Поддерживает сохранение состояния при выполнении и работу с файлами и визуализацией. Подходит для задач, где важно проверять и преобразовывать данные, а не ограничиваться текстовыми рассуждениями.
