...
* Воркшоп «Как создать мультиагентную систему в {{ ai-studio-full-name }}». [Видео](https://www.youtube.com/watch?v=Iyf17k0Hf2M).
* How to {{ ai-studio-full-name }}:
...
* От небольшой мастерской к ML-фабрике: как мы {{ ai-studio-full-name }} пересобирали. [Статья](https://habr.com/ru/companies/yandex/articles/949884/).
