...
1. Добавлена возможность генерации изображений по текстовому описанию. Модель {{ yandexart-name }} работает в асинхронном режиме и доступна в консоли управления в [{{ foundation-models-name }} Playground]({{ link-console-main }}/link/foundation-models) и через [API](../image-generation/api-ref/index.md). 
