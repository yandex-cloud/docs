---
title: Практические руководства {{ foundation-models-full-name }}
description: Различные сценарии использования {{ foundation-models-full-name }}.
---

# Практические руководства {{ foundation-models-full-name }}
