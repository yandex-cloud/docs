...
5. Нажмите **Добавить роль**.
    Если вы уже закрыли окно добавления сервисного аккаунта, вы можете открыть его снова. Нажмите на ![](../_assets/dots.png) напротив сервисного аккаунта и нажмите **Редактировать сервисный аккаунт**.
