...
pageToken | Токен страницы. Установите значение [pageToken](/docs/iam/api-ref/Role/list#query_params) равным значению поля [nextPageToken](/docs/iam/api-ref/Role/list#responses) прошлого запроса, чтобы получить следующую страницу результатов.  Максимальная длина строки в символах — 100.
...
Поле | Описание
--- | ---
roles | **object**<br><p>Ресурс Role. Подробнее см. <a href="/docs/iam/concepts/access-control/roles">Роли</a>.</p> 
