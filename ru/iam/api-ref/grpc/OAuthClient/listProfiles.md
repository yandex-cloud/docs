...
(see [CreateOAuthClientRequest.profile_id](/docs/iam/api-ref/grpc/OAuthClient/create#yandex.cloud.iam.v1.CreateOAuthClientRequest)).
...
If true, the [OAuthClient.pkce_required](/docs/iam/api-ref/grpc/OAuthClient/get#yandex.cloud.iam.v1.OAuthClient) flag cannot be changed and is fixed
to `pkce_required_default_value`. ||
|| pkce_required_default_value | **bool**

Default value of the [OAuthClient.pkce_required](/docs/iam/api-ref/grpc/OAuthClient/get#yandex.cloud.iam.v1.OAuthClient) flag for oauth clients bound to this profile. ||
|#