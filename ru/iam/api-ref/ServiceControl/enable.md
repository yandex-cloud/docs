...
Field | Description
--- | ---
resource | **object**<br><p>Required. Resource container to enable a service in.</p> <p>It is supported only resource-manager.cloud resource container now.</p> <p>A Resource. For more information, see <a href="/docs/iam/concepts/access-control/resources-with-access-control">Resource</a>.</p> 
