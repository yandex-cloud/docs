...
serviceAccounts.<br>id | **string**<br><p>Только для вывода. Идентификатор сервисного аккаунта.</p> 
serviceAccounts.<br>folderId | **string**<br><p>Идентификатор каталога, которому принадлежит сервисный аккаунт.</p> 
serviceAccounts.<br>createdAt | **string** (date-time)<br><p>Только для вывода. Время создания ресурса в формате в <a href="https://www.ietf.org/rfc/rfc3339.txt">RFC3339</a>.</p> 
