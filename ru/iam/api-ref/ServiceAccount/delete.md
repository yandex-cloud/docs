...
## HTTP-запрос
`DELETE /iam/v1/serviceAccounts/{serviceAccountId}`
 
## Path-параметры {#path_params}
 
Name | Description
--- | ---
serviceAccountId | Обязательное поле. Идентификатор удаляемого сервисного аккаунта. Чтобы получить идентификатор сервисного аккаунта, используйте запрос [list](/docs/iam/api-ref/ServiceAccount/list).  Максимальная длина — 50 символов.
