...
Параметр | Описание
--- | ---
apiKeyId | Обязательное поле. Идентификатор обновляемого ресурса ApiKey. Чтобы получить идентификатор API-ключа, используйте запрос [list](/docs/iam/api-ref/ApiKey/list).  Максимальная длина строки в символах — 50.
