...
**rpc Delete ([DeleteKeyRequest](#DeleteKeyRequest)) returns ([operation.Operation](#Operation))**
...
Поле | Описание
--- | ---
operations[] | **[operation.Operation](#Operation1)**<br>Список операций для указанного ресурса Key. 
