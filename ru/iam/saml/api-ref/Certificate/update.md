---
editable: false
sourcePath: en/_api-ref/iam/v1/saml/api-ref/Certificate/update.md
---

# Identity and Access Management SAML API, REST: Certificate.Update {#Update}
...
## Body parameters {#yandex.cloud.iam.v1.saml.UpdateCertificateRequest}
