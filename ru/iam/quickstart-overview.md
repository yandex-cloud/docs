...
Сервисы {{ iam-short-name }} и [{{ org-full-name }}](../organization/) тесно связаны, так как {{ org-full-name }} тоже предоставляет возможности управления доступом, но на уровне организации. Например, с помощью {{ org-full-name }} можно централизованно [управлять пользователями](../organization/operations/manage-users.md), в том числе приглашать новых.
...
[Управление группами пользователей](../organization/operations/manage-groups.md) тоже проходит в {{ org-full-name }}. Например, с помощью сервиса вы можете выдать права доступа группе. Чтобы использовать другие интерфейсы {{ yandex-cloud }} для настройки прав доступа группы, сначала создайте ее и добавьте в нее участников в {{ org-full-name }}. После этого вы сможете, например, выдать группе права на каталог в консоли управления.

## Что дальше {#whats-next}

* Узнайте, [как начать работать с {{ org-full-name }}](../organization/quickstart.md).
