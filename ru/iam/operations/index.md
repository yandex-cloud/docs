...
Инструкции по управлению пользователями читайте в [документации {{ org-full-name }}](../../organization/operations/manage-users.md).

## Группы пользователей {#users-groups}

Инструкции по управлению группами пользователей читайте в [документации {{ org-full-name }}](../../organization/operations/manage-groups.md).
...
- [{#T}](iam-token/revoke-iam-token.md)
