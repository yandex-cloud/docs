---
title: "Инструкция по удалению авторизованных ключей в {{ iam-full-name }}"
description: "Из статьи вы узнаете, как удалить авторизованные ключи в {{ iam-full-name }}."
---
...
- Консоль управления
  ...
  1. В блоке **Авторизованные ключи** напротив ключа, который нужно удалить, нажмите значок ![image](../../../_assets/options.svg) и выберите пункт **Удалить**.
...
- API
  ...
  Чтобы удалить авторизованный ключ, воспользуйтесь методом [delete](../../api-ref/Key/delete.md) для ресурса [Key](../../api-ref/Key/index.md).
