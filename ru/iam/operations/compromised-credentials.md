...
{{ yandex-cloud }} автоматически ищет секреты в открытом доступе. Узнайте больше о поиске секретов и принимаемых мерах в статье [{#T}](../../security/operations/search-secrets.md).
...
1. Проверьте, не появились ли в {{ yandex-cloud }} ресурсы, которые вы не создавали, например [виртуальные машины](../../glossary/vm.md), хранилища данных, базы данных, функции, API-шлюзы и т.д.
