...
### Предоставить доступ сервисному аккаунту к другому сервисному аккаунту {#access-to-sa}
...
### Предоставить доступ к ресурсу любому пользователю Яндекс.Облака {#access-to-all}
