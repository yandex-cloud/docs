...
- CLI {#cli}
  ...
  1. Чтобы посмотреть список refresh-токенов, выполните команду:
      ...
      * `--subject-id` — [идентификатор](../../../organization/operations/users-get.md) [федеративного](../../concepts/users/accounts.md#saml-federation) или [локального](../../concepts/users/accounts.md#local) пользователя, список refresh-токенов которого вы хотите получить. Необязательный параметр. Если параметр не задан, будет выведен список refresh-токенов пользователя, аутентифицированного в данный момент в {{ yandex-cloud }} CLI.
