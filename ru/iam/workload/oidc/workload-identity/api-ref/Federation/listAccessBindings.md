...
editable: false
apiPlayground:
  - url: https://iam.{{ api-host }}/iam/v1/workload/oidc/federations/{resourceId}:listAccessBindings
    method: get
    path:
      type: object
      properties:
    ...
    body: null
    definitions: null
sourcePath: en/_api-ref/iam/v1/workload/oidc/workload-identity/api-ref/Federation/listAccessBindings.md
---
