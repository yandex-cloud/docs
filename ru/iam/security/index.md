...
_Сервисные роли_ — роли, созданные для определенного сервиса. При проверке прав доступа к ресурсам [!KEYREF iam-short-name] учитываются роли сервиса [!KEYREF resmgr-name].
