...
### Сервисные роли для модуля {{ td-full-name }} ({{ td-name }}) {#td-roles}
...
Подробнее в [Управление доступом в {{ td-name }}](../security-deck/security/td-roles.md).

### Сервисные роли для модуля {{ vuln-man-name }} ({{ vuln-man-short-name }}) {#vm-roles}
...
Подробнее в [Управление доступом в {{ vuln-man-short-name }}](../security-deck/security/vm-roles.md).
