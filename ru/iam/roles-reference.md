...
Подробнее см. [Управление доступом в {{ api-gw-name }}](../api-gateway/security/index.md).
...
Подробнее см. [Управление доступом в {{ alb-name }}](../application-load-balancer/security/index.md).
...
Подробнее см. [Управление доступом в {{ yds-name }}](../data-streams/security/index.md).
