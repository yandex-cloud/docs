...
* Сервисный аккаунт можно привязывать к [виртуальным машинам](../../../compute/operations/vm-connect/auth-inside-vm.md){% if product == "yandex-cloud" %} и [функциям](../../../functions/operations/function-sa.md){% endif %}, в которых запускается ваша программа.
