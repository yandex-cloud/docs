...
_Авторизованные ключи_ (ресурс `Key`) — это открытый и закрытый ключи, которые используются при создании [JSON Web Token](https://tools.ietf.org/html/rfc7519). JSON Web Token необходим при запросе IAM-токена для сервисного аккаунта.
