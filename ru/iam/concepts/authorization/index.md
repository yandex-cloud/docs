...
## Аутентификация в Яндекс.Облаке {#authentication}
...
- CLI
  ...
  Чтобы настроить аутентификацию в CLI, укажите ваш [OAuth-токен](oauth-token.md) при [создании профиля](../../../cli/operations/profile/profile-create.md). Токен будет сохранен в конфигурации профиля и аутентификация будет происходить автоматически.
...
- CLI
  ...
  Чтобы выполнять операции от имени сервисного аккаунта, пройдите аутентификацию в CLI по [инструкции](../../../cli/operations/authentication/service-account.md).
