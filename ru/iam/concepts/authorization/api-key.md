...
* `yc.serverless.workflows.execute` — для запуска [рабочих процессов](../../../serverless-integrations/concepts/workflows/execution.md) через [API {{ sw-name }}](../../../serverless-integrations/concepts/index.md#workflows).
