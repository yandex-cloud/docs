...
_Статические ключи доступа_ — секретный ключ и идентификатор ключа, используемые для аутентификации в сервисах с AWS-совместимым API, например в [!KEYREF objstorage-name] и [!KEYREF message-queue-name]. Ключи доступа используются только для [сервисного аккаунта](../users/service-accounts.md).
...
* [[!KEYREF objstorage-name]](/docs/storage/)
* [[!KEYREF message-queue-name]](/docs/message-queue/)
