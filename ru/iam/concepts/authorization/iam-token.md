...
* вы прошли [аутентификацию с помощью федерации](../../../cli/operations/authentication/federated-user.md) в CLI. Тогда время жизни IAM-токена будет дополнительно ограничено временем жизни cookie у [федерации](../users/identity-federations.md).
