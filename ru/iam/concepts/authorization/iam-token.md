...
>[!NOTE]
>Срок жизни IAM-токена ограничен. На данный момент IAM-токен действует 12 часов. После того, как срок действия IAM-токена истек, необходимо запросить новый.
