...
> [!NOTE]
>
> Для доступа к ресурсу может требоваться иметь несколько ролей одновременно. Например, для аккаунта на Яндексе необходимо дополнительно иметь роль `[!KEYREF roles-cloud-member]`.
