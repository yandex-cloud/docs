...
Политика запрещает отправку запросов [Responses API]({{ link-docs-ai }}ai-studio/api/Responses/) в {{ ai-studio-full-name }} и управление ими с любых адресов, за исключением заданных явно IP-адресов или [облачных сетей](../../../vpc/concepts/network.md#network) {{ vpc-full-name }}.
