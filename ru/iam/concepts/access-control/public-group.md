...
description: Из статьи вы узнаете, что такое публичные группы и каких типов они бывают.
---
...
Публичная группа `All users` — включает всех пользователей, аутентификация не требуется.
