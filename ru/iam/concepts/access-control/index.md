...
Изменение прав доступа и активация учетных данных может занимать до одной минуты. В течение этого времени операция может завершиться ошибкой авторизации, даже если роль уже назначена, а учетные данные созданы. Если операция не выполнилась, попробуйте повторить ее позже.
