...
Роли назначаются субъектам{% if product == "yandex-cloud" %}. Есть четыре типа субъектов:{% endif %}{% if product == "cloud-il" %}:{% endif %}
...
* Пользователям с {% if product == "yandex-cloud" %}аккаунтом на Яндексе и{% endif %} федеративным аккаунтом можно назначать роли только на облако или каталог.
