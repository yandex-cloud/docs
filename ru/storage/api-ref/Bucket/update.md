          ...
          redirectAllRequests:
            description: |-
              **[Scheme](#yandex.cloud.storage.v1.WebsiteSettings.Scheme)**
              ...
              If [redirectAllRequests](#yandex.cloud.storage.v1.WebsiteSettings) is specified, it must be the only field in [Bucket.websiteSettings](/docs/storage/api-ref/Bucket/list#yandex.cloud.storage.v1.Bucket).
...
If `redirectAllRequests` is specified, it must be the only field in [Bucket.websiteSettings](/docs/storage/api-ref/Bucket/list#yandex.cloud.storage.v1.Bucket). ||
