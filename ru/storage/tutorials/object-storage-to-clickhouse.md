---
title: Загрузка данных из {{ objstorage-name }} в {{ mch-name }} с помощью {{ data-transfer-name }}
description: Как загрузить данные из {{ objstorage-name }} в {{ mch-name }} с помощью {{ data-transfer-name }}.
