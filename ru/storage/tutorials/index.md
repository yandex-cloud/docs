...
В этом разделе собраны практические руководства по использованию {{ objstorage-name }} для хостинга сайтов, резервного копирования, работы с данными и других задач. {#other}
...
* [{#T}](./server-logs.md)
* [{#T}](./user-agent-statistics.md)


* [{#T}](./search-events-audit-logs/index.md)


* [{#T}](./storage-logs-analysis.md)
...
* [{#T}](./data-from-yandex-query-visualization.md)
...
## Управление инфраструктурой с {{ TF }} {#infrastructure}
