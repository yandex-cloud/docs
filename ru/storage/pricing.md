...
> [!NOTE]
>
> С 1 декабря изменяются правила тарификаций для операций с данными. Добавляется тарификация для операций POST и для операций с данными, в ходе выполнения которых произошла ошибка.
>
