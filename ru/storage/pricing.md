...
С 5 марта 2024 года вводится тарификация операций LIST:
* Стандартное хранилище:
  * Первые 10 000 операций в месяц не тарифицируются;
  * 1000 операций — 0,4800 ₽, вкл. НДС.
* Холодное хранилище: 1000 операций — 1,1800 ₽, вкл. НДС.
* Ледяное хранилище: 1000 операций — 2,3600 ₽, вкл. НДС.
