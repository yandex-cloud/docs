...
1. `Access Key` — введите идентификатор ключа, который вы получили при генерации {% if audience != "internal" %}[статического ключа](../../iam/concepts/authorization/access-key.md){% else %}статического ключа{% endif %}.
1. `Secret Key` — введите секретный ключ, который вы получили при генерации {% if audience != "internal" %}[статического ключа](../../iam/concepts/authorization/access-key.md){% else %}статического ключа{% endif %}.
