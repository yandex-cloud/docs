...
----- | -----
`X-Amz-Meta-*` | Пользовательские метаданные объекта.
`X-Amz-Storage-Class` | [Класс хранилища](../../../concepts/storage-class.md) объекта.<br/>Имеет значение `COLD`, если объект находится в холодном хранилище.<br/><br/>Если объект сохранен в стандартном хранилище, то заголовка не будет.
