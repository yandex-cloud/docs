---
title: "Коды ответов и ошибок. Object Storage API (S3)"
description: "Описаны коды ответов и ошибок в Object Storage API (S3). Успешный ответ – при отсутствии ошибок Object Storage отвечает HTTP-кодами 2xx. Код и тело ответа зависят от запроса и рассматриваются в описаниях запросов. Ответ с ошибкой – при возникновении ошибки Object Storage отвечает сообщением с соответствующим HTTP-кодом и дополнительным описанием в формате XML. Подробно описаны коды ошибок и их расшифровка."
