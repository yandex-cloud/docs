...
`x-amz-storage-class` | Класс хранилища объекта.<br/><br/>Может иметь любое из значений:<br/>- `STANDARD` для загрузки объекта в Стандартное хранилище.<br/>- `COLD`, `STANDARD_IA` и `NEARLINE` для загрузки объекта в Холодное хранилище.<br/><br/>Если заголовок не указан, то объект сохраняется в хранилище с классом по умолчанию, установленным в настройках бакета.
