...
`x-amz-storage-class` | Класс хранения объекта.<br/><br/>Может иметь значения:<br/><br/>- `COLD` для загрузки объекта в Холодное хранилище.<br/>- `STANDARD` для загрузки объекта в Стандартное хранилище.<br/><br/><br/>Если заголовок не указан, то объект сохраняется в Стандартном хранилище.
