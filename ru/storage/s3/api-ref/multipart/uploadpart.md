---
title: "Метод uploadPart. Object Storage API (S3)"
description: "Метод uploadPart в Object Storage API (S3) сохраняет часть объекта. Пользователь самостоятельно нумерует части объекта и передает номера {{ objstorage-name }}. Номер однозначно идентифицирует часть и определяет ее порядок в общей последовательности. Номер — это целое число в промежутке от 1 до 10000 включительно."
---
