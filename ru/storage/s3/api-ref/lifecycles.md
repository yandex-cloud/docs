---
title: Методы работы c сервисом Lifecycles в Object Storage HTTP API (S3) 
description: "Сервис Lifecycles в Object Storage HTTP API (S3) управляет конфигурациям жизненных циклов для объектов в бакетах. В разделе описаны методы работы с сервисом (upload, get, delete)."
---
