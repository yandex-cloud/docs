...
Загружает конфигурацию CORS для корзины. Если конфигурация существует, то заменяет ее.
...
Конфигурация CORS передается в виде XML-документа. Описание схемы смотрите в разделе [[!TITLE]](../../../cors/configuration.md)
