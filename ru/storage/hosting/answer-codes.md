...
`403 Forbidden` | Возвращается, если для корзины, к которой направлен запрос, не настроен публичный доступ.<br/><br/>[[!TITLE ../operations/buckets/bucket-availability.md]](../operations/buckets/bucket-availability.md).
