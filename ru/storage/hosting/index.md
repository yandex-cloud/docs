...
- Необходимо настроить алиас для корзины у своего провайдера DNS или на собственном DNS сервере.
    ...
    Используйте запись именно в таком виде, поскольку запись в другой форме может на первый взгляд выглядеть работающей, но в дальнейшем привести к неожиданным последствиям. 