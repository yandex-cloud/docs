...
Создайте соединение со следующими параметрами:
  ...
  - Сервер и порт: `storage.yandexcloud.net:443`.
...
CyberDuck работает с Object Storage как с иерархической файловой системой. Это значит, что ключи для загруженных через CyberDuck объектов будут иметь вид пути к файлу. Например, `prefix/subprefix/picture.jpg`.
