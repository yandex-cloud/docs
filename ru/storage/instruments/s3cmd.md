...
Программа попытается установить соединение с [!KEYREF objstorage-name] и получить список корзин. Если вы не ошиблись с вводом параметров, то программа выведет `Success. Your access key and secret key worked fine :-)`.
...
При необходимости эти настройки можно заменить напрямую в файле или при запуске программы с помощью соответствующих параметров.

Для нормального функционирования команд, управляющих хостингом статических сайтов, в конфигурационный файл необходимо вручную добавить параметр 
