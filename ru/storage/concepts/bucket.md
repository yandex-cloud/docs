...
Вы можете [ограничить максимальный размер корзины](../operations/buckets/limit-max-volume.md). [!KEYREF objstorage-name] не позволит загрузить объект, если при его добавлении размер корзины превысит максимальное значение.
