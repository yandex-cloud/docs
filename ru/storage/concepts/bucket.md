...
Можно настроить максимальный объем, занимаемый корзиной. [!KEYREF objstorage-name] не позволит загрузить объект, если при его добавлении объем корзины превысит максимальное значение.

## Именование корзин {#naming}

Название корзины используется как часть URL для доступа к данным и его будут видеть ваши пользователи. Например, `https://storage.api.cloud.yandex.net/bucket-name`.
