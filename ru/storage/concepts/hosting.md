...
* Для условной переадресации запросов.
  ...
  Используя правила маршрутизации, можно перенаправлять запросы в соответствии с префиксами имен объектов или HTTP-кодами ответов. Вы можете перенаправить на другую веб-страницу запрос к удаленному объекту или перенаправить запросы, возвращающие ошибку. В сервисе действуют [лимиты](./limits.md#storage-limits) на максимальное количество правил для условной переадресации запросов.
