...
Чтобы расшифровывать объекты, у пользователя, кроме роли `storage.editor`, должна быть роль на [чтение ключа шифрования](../../kms/security/index.md#service) — `kms.keys.decrypter`.
