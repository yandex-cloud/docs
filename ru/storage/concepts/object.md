...
В [!KEYREF objstorage-name] нет папок, однако графические файловые менеджеры, например, [CyberDuck](../instruments/cyberduck.md) или интерфейс к [!KEYREF objstorage-name] в консоли управления Яндекс.Облака имитируют папки. В роли папок выступают объекты с нулевым размером, ключ которого имеет вид префикса.
