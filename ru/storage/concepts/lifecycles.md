...
* Префикс ключа объекта. Нельзя использовать совместно с фильтром по метке. 
...
* [Метка](./tags.md#object-tags) объекта — с помощью [S3 API](../s3/index.md) или [инструментов](../tools/index.md) с его поддержкой. Нельзя использовать совместно с фильтром по префиксу ключа.
