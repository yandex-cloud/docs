...
Стандартное и холодное хранилища имеют различную стоимость хранения объектов и доступа к ним.{% if audience != "internal" %} Подробнее смотрите в разделе [{#T}](../pricing.md).{% endif %}
