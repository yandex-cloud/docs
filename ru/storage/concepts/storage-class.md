...
* Переместить или скопировать объект с указанием нового класса хранилища. Пошаговые инструкции приведены в разделе [{#T}](../operations/objects/change-storage-class.md).
