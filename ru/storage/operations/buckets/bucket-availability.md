---
title: "Настройка публичного доступа к операциям с бакетом {{ objstorage-full-name }}"
description: "Следуя данной инструкции, вы сможете настроить публичный доступ к бакету." 
---
...
При закрытии публичного доступа к бакету убедитесь, что [системной группе](../../../iam/concepts/access-control/system-group.md) `AllUsers` не назначены [роли](../../security/index.md#service-roles) `viewer` или `storage.viewer` и выше на каталог или бакет. В противном случае публичный доступ к бакету сохранится.