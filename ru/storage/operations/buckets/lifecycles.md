...
- {{ TF }}
  ...
  1. Опишите в конфигурационном файле параметры ресурсов, которые необходимо создать:
     ...
     * `transition` — срок действия объекта для изменения класса хранилища. Необязательный параметр.
     * `noncurrent_version_expiration` — правило для удаления неактивных версий объекта. Необязательный параметр.
     * `noncurrent_version_transition` — правило для изменения класса хранилища неактивных версий объекта. Необязательный параметр.
