...
- {{ yandex-cloud }} CLI
  ...
  : 1. Чтобы выдать разрешения с помощью ACL для пользователя {{ yandex-cloud }}, сервисного аккаунта или системной группы, получите его идентификатор. Подробнее см. в инструкциях [{#T}](../../../iam/operations/users/get.md) и [{#T}](../../../iam/operations/sa/get-id.md).
    1. Выполните команду:
