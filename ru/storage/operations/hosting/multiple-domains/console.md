---
title: Поддержать несколько доменных имен для сайта с помощью консоли управления, CLI или API
...
# Поддержать несколько доменных имен с помощью консоли управления, CLI или API
...
1. [Настройте переадресацию для дополнительного домена](#extra).
...
1. Свяжите доменное имя `example.com` и соответствующий бакет.
    ...
    1. Создайте на [DNS-сервере](../../../../glossary/dns.md#dns-server) публичную зону DNS и ресурсную запись, которая связывает ваше доменное имя и бакет:
        ...
        - {{ dns-full-name }} {#dns}
          ...
          Использование сервиса {{ dns-name }} тарифицируется, подробнее на странице [{#T}](../../../../dns/pricing.md).
