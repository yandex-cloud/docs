---
title: Поддержать собственный домен
...
1. Чтобы сайт был доступен по протоколу HTTPS:
    ...
    1. {% include [create-cert.md](../../../_includes/storage/create-cert.md) %}
       ...
       Использование сервиса {{ certificate-manager-name }} не тарифицируется, подробнее на странице [{#T}](../../../certificate-manager/pricing.md).
