...
- AWS CLI
  ...
  * `<путь_к_локальному_файлу>` — путь к файлу на вашем устройстве, который нужно загрузить в бакет.
  * `<имя_бакета>` — имя вашего бакета.
  * `<ключ_объекта>` — [ключ](../../concepts/object.md#key), под которым объект будет храниться в бакете.  
...
Если в бакете включены [версионирование](../buckets/versioning.md) и [блокировки версии объектов](../buckets/configure-object-lock.md), вы можете указать настройки блокировки при загрузке объекта:
...
- AWS CLI
  ...
  * `body` — путь к файлу на вашем устройстве, который нужно загрузить в бакет.
  * `bucket` — имя вашего бакета.
  * `key` — [ключ](../../concepts/object.md#key), под которым объект будет храниться в бакете.
