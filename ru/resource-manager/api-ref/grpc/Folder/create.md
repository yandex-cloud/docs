---
editable: false
sourcePath: en/_api-ref-grpc/resourcemanager/v1/api-ref/grpc/Folder/create.md
---

# Resource Manager API, gRPC: FolderService.Create

Creates a folder in the specified cloud.

## gRPC request

**rpc Create ([CreateFolderRequest](#yandex.cloud.resourcemanager.v1.CreateFolderRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## CreateFolderRequest {#yandex.cloud.resourcemanager.v1.CreateFolderRequest}
