...
Поле | Описание
--- | ---
folders | **object**<br><p>Ресурс Folder. Подробнее см. <a href="/docs/resource-manager/concepts/resources-hierarchy#folder">Каталог как ресурс Яндекс.Облака</a>.</p> 
...
folders.<br>labels | **object**<br><p>Метки ресурса в формате <code>key:value</code>. Максимум 64 метки на ресурс.</p> 
folders.<br>status | **string**<br><p>Статус каталога.</p> <p>Статус каталога.</p> <ul> <li>STATUS_UNSPECIFIED: Статус неопределен.</li> <li>ACTIVE: Каталог активен.</li> <li>DELETING: Каталог удаляется.</li> </ul> 
