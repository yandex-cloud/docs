...
Ресурс Folder. Подробнее см. [Каталог как ресурс Яндекс.Облака](/docs/resource-manager/concepts/resources-hierarchy#folder).
...
status | **string**<br><p>Статус каталога.</p> <p>Статус каталога.</p> <ul> <li>STATUS_UNSPECIFIED: Статус неопределен.</li> <li>ACTIVE: Каталог активен.</li> <li>DELETING: Каталог удаляется.</li> </ul> 