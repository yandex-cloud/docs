...
accessBindingDeltas.<br>action | **string**<br><p>Обязательное поле. The action that is being performed on an access binding.</p> <ul> <li>ACCESS_BINDING_ACTION_UNSPECIFIED: Unspecified.</li> <li>ADD: Addition of an access binding.</li> <li>REMOVE: Removal of an access binding.</li> </ul> 
accessBindingDeltas.<br>accessBinding | **object**<br><p>Обязательное поле. Access binding. For more information, see <a href="/docs/resource-manager/concepts/resources-hierarchy">Access Bindings</a>.</p> 
