...
## HTTP-запрос
`POST /resource-manager/v1/folders/{resourceId}:updateAccessBindings`
...
accessBindingDeltas.<br>accessBinding.<br>roleId | **string**<br><p>Идентификатор ресурса <a href="/docs/iam/api-ref/Role#representation">Role</a> который назначен для субъекта, указанного в параметре subject.</p> <p>Максимальная длина — 50 символов.</p> 
