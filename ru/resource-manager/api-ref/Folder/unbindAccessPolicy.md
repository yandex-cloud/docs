...
editable: false
apiPlayground:
  - url: https://resource-manager.{{ api-host }}/resource-manager/v1/folders/{resourceId}:unbindAccessPolicy
    method: post
    path:
      type: object
      properties:
...
```
POST https://resource-manager.{{ api-host }}/resource-manager/v1/folders/{resourceId}:unbindAccessPolicy
```
