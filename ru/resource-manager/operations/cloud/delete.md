...
Чтобы удалить [облако](../../concepts/resources-hierarchy.md#cloud), у вас должна быть роль [{{ roles-resource-manager-editor }}](../../security/index.md#resource-manager-editor) или выше на это облако. Если вы не можете выполнить эту операцию, обратитесь к [владельцу облака](../../concepts/resources-hierarchy.md#owner).
...
Кроме того, если для облака или хотя бы одного из каталогов в облаке создана политика авторизации `resourceManager.denyFolderRemoval`, удалить такое облако не получится. Если политика `resourceManager.denyFolderRemoval` создана для организации, в этой организации не удастся удалить ни одно облако.
