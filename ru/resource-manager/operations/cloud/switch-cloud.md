...
- Старая навигация
  ...
  1. В [консоли управления]({{ link-console-main }}) нажмите на имя текущего каталога в правом верхнем углу.

      ![image](../../../_assets/resource-manager/switch-cloud.png)

  1. В выпадающем списке выберите нужное облако или каталог.
