...
- Консоль управления
  ...
  1. Откройте страницу [Уведомления сервисов]({{ link-cloud-notifications }}) для выбранного облака.{% if product == "yandex-cloud" %} Если необходимо, [переключитесь на другое облако](switch-cloud.md).{% endif %}
