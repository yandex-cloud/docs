...
- Консоль управления
  ...
  1. Выберите каталог на [стартовой странице]({{ link-console-cloud }}) консоли управления. На этой странице отображается информация о всех каталогах в выбранном облаке. Если необходимо, [переключитесь на другое облако](../cloud/switch-cloud.md).
