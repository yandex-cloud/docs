...
На некоторые ресурсы нельзя назначать роль непосредственно, для таких ресурсов роль назначается на каталог, облако или организацию. Например, на данный момент нельзя назначить роль на ВМ. Если пользователь попытается прочитать информацию о ВМ, {{ iam-name }} проверит права пользователя на каталог, которому принадлежит эта ВМ. Если права на каталог отсутствуют, {{ iam-name }} проверит права доступа на облако и организацию.
