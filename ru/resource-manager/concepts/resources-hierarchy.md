...
Чтобы сделать облако или ресурс публичным, необходимо назначить на него роль для [системной группы](../../iam/concepts/users/users.md#system) `[!KEYREF subjects-allAuthenticatedUsers]`.
