...
Чтобы сделать облако или ресурс публичным, необходимо назначить на него роль для одной из [системных групп](../../iam/concepts/users/users#system): `[!KEYREF subjects-allUsers]` или `[!KEYREF subjects-allAuthenticatedUsers]`.
