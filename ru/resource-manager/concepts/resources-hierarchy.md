...
Роль участника облака необходима пользователю с аккаунтом на Яндексе для выполнения операций с ресурсом в облаке, которое не принадлежит организации. Исключение — ресурсы с [публичным доступом](#public-access).
