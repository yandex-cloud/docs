...
При регистрации в Яндекс.Облаке для пользователя будет создано _облако_ — отдельное рабочее пространство, для которого он будет назначен владельцем. Владелец может создавать в этом облаке каталоги и ресурсы, а также управлять правами доступа к ним.
...
1. Создайте первый каталог в облаке:
