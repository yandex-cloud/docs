...
Если не перейти на платный тариф, то с 18 апреля состав организации в {{ ya-360 }} станет недоступным для редактирования: нельзя будет добавлять и удалять сотрудников. Ваши новые сотрудники не смогут использовать {{ forms-name }}.
