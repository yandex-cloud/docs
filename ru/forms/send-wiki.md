...
1. В поле **Текст** укажите, какие данные нужно добавлять на страницу. Вы можете оформить текст с помощью [вики-разметки]{% if audience == "external" %}(../wiki/static-markup.md){% else %}(../wiki/basic-markup.md){% endif %}. 
