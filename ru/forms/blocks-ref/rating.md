...
В разделе **{{ ui-key.forms.common.blocks_correct-answers.title }}** задайте шкалу оценки. Пользователю нужно будет выбрать один из заданных вариантов ответа для каждого критерия. Например, для оценки по пятибалльной шкале можно задать в качестве ответов числа от 1 до 5. Либо можно задать три уровня оценки: <q>хорошо</q>, <q>удовлетворительно</q>, <q>плохо</q>.
