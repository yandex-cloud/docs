...
1. Убедитесь, что у робота `robot-forms@` есть [доступ к таблице](../../wiki/page-managment/access-setup.md). Робот также имеет доступ к таблице, если установлен режим **Доступно всем сотрудникам**.
