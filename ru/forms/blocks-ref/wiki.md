---
title: Вики
description: В этом блоке пользователь может ввести варианты ответов, которые подгружаются из динамической таблицы {{ wiki-name }}. При вводе текста работает подсказка по допустимым вариантам ответов. Ответы, которых нет в таблице, не принимаются.
---
...
`{{ link-wiki }}users/<имя_пользователя>/<имя_таблицы>`


`/users/<имя_пользователя>/<имя_таблицы>`
