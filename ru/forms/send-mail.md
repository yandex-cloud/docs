...
{% if audience == "external" %} Если вы используете собственный почтовый сервер, добавьте в <q>белый список</q> адрес отправителя: `идентификатор_формы@forms-mailer.yaconnect.com`.{% endif %}
