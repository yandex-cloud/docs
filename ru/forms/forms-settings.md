...
По умолчанию редактировать форму может только автор. Чтобы открыть другим доступ к редактированию формы:{% endif %}
...
Формы можно копировать [из внутренней админки во внешнюю](new-form.md#instance) и наоборот с помощью функций экспорта и импорта.
...
1. Выберите форму и откройте ее.
   Чтобы отфильтровать список форм, введите в строку поиска часть названия формы или используйте поля над списком.

1. На верхней панели нажмите **Перейти в старую версию**. 

1. В старой версии админки в правом верхнем углу страницы нажмите **Экспорт формы**. 

1. Установите опции сохранения настроек формы и нажмите **Экспорт**. 

1. Укажите путь для сохранения файла JSON.

### Шаг 2. Импорт формы

1. Откройте админку, в которую нужно импортировать форму: [внутреннюю]({{ link-forms-admin-ya }}) или [внешнюю]({{ link-forms-ext-ya }}).

1. На верхней панели нажмите **Перейти в старую версию**. 

1. В старой версии админки на главной странице в правом верхнем углу нажмите **Импорт**. 

1. Выберите сохраненный ранее файл JSON и нажмите **Импортировать**.

Форма отобразится в списке, вы сможете продолжить работу с ней.
