...
## Идентификаторы ответов для вопросов <q>Оценки по шкале</q>, <q>Вики</q>, <q>Города и страны</q> {#sec_rating}
...
1. Найдите в коде значения идентификаторов: 
    ...
    * Для вопроса типа <q>Города и страны</q> или <q>Вики</q> сначала введите в поле интересующий вас вариант ответа, после этого идентификатор ответа появится в коде.
