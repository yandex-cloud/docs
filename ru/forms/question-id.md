...
Чтобы сделать предзаполнение серии вопросов:
...
Идентификатор ответа можно узнать в старой админке {{ forms-name }}:

1. На верхней панели нажмите кнопку **Перейти в старую версию**.

1. Выберите блок вопроса.

1. На панели слева в разделе **Ответы** нажмите ссылку **Показать параметры**.
...
Если идентификаторы ответов не отображаются в админке {{ forms-name }}, их можно узнать в браузере с помощью инструментов разработчика. Например, для вопроса [<q>Оценка по шкале</q>](blocks-ref/rating.md) идентификаторы критериев и вариантов ответа не отображаются ни в новой, ни в старой админке.
