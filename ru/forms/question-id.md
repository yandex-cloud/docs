...
1. Найдите в коде значения идентификаторов: 
    ...
    * Для вопроса типа <q>Города и страны</q> или <q>{{ ui-key.forms.common.blocks_integration-group.title-wiki }}</q> сначала введите в поле интересующий вас вариант ответа, после этого идентификатор ответа появится в коде.
