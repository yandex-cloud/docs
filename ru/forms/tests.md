...
1. Если нужно показывать или скрывать блок в зависимости от ответов пользователя на другие вопросы, [настройте условия показа блока](add-questions.md#section_q2t_zqz_sbb).
...
После завершения теста пользователь может нажать кнопку **Посмотреть правильные ответы**. Откроется страница, где будут показаны баллы и выделены правильные и неправильные ответы.
