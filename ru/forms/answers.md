...
## Скачать или просмотреть все ответы {#download}
  ...
  1. Выберите способ получения ответов:
       ...
       Нажмите кнопку **Загрузить на Я.Диск**. Чтобы сохранить на Диск вложения из ответов формы, выберите **Загрузить на Я.Диск вместе с прикрепленными файлами**.
       ...
       * Если в браузере заблокировано открытие новых вкладок, рядом с кнопкой **Загрузить на Я.Диск** появится ссылка на сохраненный файл.
...
1. Чтобы отправить ссылку другому пользователю, выберите один из ответов и нажмите кнопку **Поделиться**.
    Ответ по ссылке будет доступен любому пользователю без авторизации.
