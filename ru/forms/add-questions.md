...
1. Чтобы разбить форму на несколько страниц, в нижней части рабочей области нажмите кнопку **Добавить страницу**. Пользователи смогут переключаться между страницами формы с помощью кнопок **{{ ui-key.forms.common.blocks_survey.next-button-text }}** и **{{ ui-key.forms.common.blocks_survey.prev-button-text }}**.
...
- **{{ ui-key.forms.common.blocks_correct-answers.title }}** — параметры для блоков, в которых пользователю нужно выбрать ответы из нескольких вариантов. Вы можете задать список допустимых ответов или ограничить выбор вариантов (например, при выборе даты или города).
