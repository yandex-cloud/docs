...
1. Для добавления роли на уровне облака нажмите на ![](../_assets/plus-sign.svg) **Назначить роль** в блоке **Роли в облаке**.
Для добавления роли в каталоге, выберите каталог и нажмите ![](../_assets/plus-sign.svg) **Назначить роль** в блоке **Роли в каталогах**.
