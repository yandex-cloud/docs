1. [Сгенерируйте](../../compute/operations/vm-connect/ssh.md#creating-ssh-keys) пару ключей SSH для подключения к агенту по протоколу SSH.
1. Создайте агент:
    ...
    - Консоль управления
      ...
      1. На панели слева выберите ![image](../../_assets/load-testing/agent.svg) **Агенты**. Нажмите **Создать агент**.
