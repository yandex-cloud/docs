В результате в [логах](../../organization/concepts/ad-sync/sync-agent.md#logging) агента будут сохранены изменения, которые должны быть внесены в данные пользователей и групп {{ org-full-name }} в связи с изменениями, внесенными в конфигурацию агента.
