...
- Интерфейс {{ cloud-center }} {#cloud-center}
  ...
  1. (Опционально) В поле **Дата деактивации** укажите дату, при наступлении которой учетная запись будет автоматически заблокирована. Если дата не указана, срок действия аккаунта не ограничен. Вы можете изменить или удалить эту дату позже.
...
- CLI {#cli}
  ...
  1. Чтобы создать нового пользователя, выполните команду:
     ...
     yc organization-manager idp user create \
       ...
       --password <пароль> \
       --is-active <активация_пользователя>
     ```
     ...
     * `--is-active` — активация пользователя. Необязательный параметр. Активированные пользователи получают доступ к ресурсам организации.
...
- API {#api}
    ...
    Воспользуйтесь методом REST API [create](../../organization/idp/api-ref/User/create.md) для ресурса [User](../../organization/idp/api-ref/User/index.md) или вызовом gRPC API [UserService/Create](../../organization/idp/api-ref/grpc/User/create.md).
