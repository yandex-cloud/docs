...
* `use_windows_identity: true` — параметр, который устанавливает для агента синхронизации требование аутентифицироваться на стороне {{ microsoft-idp.ad-short }} от имени [аккаунта gMSA](*gmsa_account).
