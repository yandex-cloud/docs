- **Archive timeout**{#setting-archive-timeout} {{ tag-all }}
  ...
  Подробнее в описании настройки `archive_timeout` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-wal.html#GUC-ARCHIVE-TIMEOUT).
...
- **Auto explain log buffers**{#setting-auto-explain-log-buffers} {{ tag-all }}
  ...
  Подробнее в описании настройки `auto_explain.log_buffers` в [документации {{ PG }}](https://www.postgresql.org/docs/current/auto-explain.html).
...
- **Auto explain sample rate**{#setting-auto-explain-sample-rate} {{ tag-all }}
  ...
  Подробнее в описании настройки `auto_explain.sample_rate` в [документации {{ PG }}](https://www.postgresql.org/docs/current/auto-explain.html).
...
- **Autovacuum naptime**{#setting-autovacuum-naptime} {{ tag-all }}
  ...
  Подробнее в описании настройки `autovacuum_naptime` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-autovacuum.html#GUC-AUTOVACUUM-NAPTIME).
...
- **Autovacuum vacuum cost delay**{#setting-autovacuum-vacuum-cost-delay} {{ tag-all }}
  ...
  Подробнее в описании настройки `autovacuum_vacuum_cost_delay` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-autovacuum.html#GUC-AUTOVACUUM-VACUUM-COST-DELAY).
...
- **Autovacuum vacuum cost limit**{#setting-autovacuum-vacuum-cost-limit} {{ tag-all }}
  ...
  Подробнее в описании настройки `autovacuum_vacuum_cost_limit` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-autovacuum.html#GUC-AUTOVACUUM-VACUUM-COST-LIMIT).
...
- **Autovacuum vacuum insert scale factor**{#setting-autovacuum-vacuum-insert-scale-factor} {{ tag-all }}
  ...
  Подробнее в описании настройки `autovacuum_vacuum_insert_scale_factor` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-autovacuum.html#GUC-AUTOVACUUM-VACUUM-INSERT-SCALE-FACTOR).
...
- **Autovacuum vacuum insert threshold**{#setting-autovacuum-vacuum-insert-threshold} {{ tag-all }}
  ...
  Подробнее в описании настройки `autovacuum_vacuum_insert_threshold` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-autovacuum.html#GUC-AUTOVACUUM-VACUUM-INSERT-THRESHOLD).
...
- **Autovacuum work mem**{#setting-autovacuum-work-mem} {{ tag-all }}
  ...
  Подробнее в описании настройки `autovacuum_work_mem` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-AUTOVACUUM-WORK-MEM).
...
- **Backend flush after**{#setting-backend-flush-after} {{ tag-all }}
  ...
  Подробнее в описании настройки `backend_flush_after` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-BACKEND-FLUSH-AFTER).
...
- **Backslash quote**{#setting-backslash-quote} {{ tag-all }}
  ...
  Подробнее в описании настройки `backslash_quote` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-compatible.html#GUC-BACKSLASH-QUOTE).
...
- **Bgwriter flush after**{#setting-bgwriter-flush-after} {{ tag-all }}
  ...
  Подробнее в описании настройки `bgwriter_flush_after` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-BGWRITER-FLUSH-AFTER).
...
- **Bgwriter lru maxpages**{#setting-bgwriter-lru-maxpages} {{ tag-all }}
  ...
  Подробнее в описании настройки `bgwriter_lru_maxpages` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-BGWRITER-LRU-MAXPAGES).
...
- **Bgwriter lru multiplier**{#setting-bgwriter-lru-multiplier} {{ tag-all }}
  ...
  Подробнее в описании настройки `bgwriter_lru_multiplier` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-BGWRITER-LRU-MULTIPLIER).
...
- **Bytea output**{#setting-bytea-output} {{ tag-all }}
  ...
  Подробнее в [документации {{ PG }}](https://www.postgresql.org/docs/current/datatype-binary.html).
...
- **Checkpoint flush after**{#setting-checkpoint-flush-after} {{ tag-all }}
  ...
  Подробнее в описании настройки `checkpoint_flush_after` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-wal.html#GUC-CHECKPOINT-FLUSH-AFTER).
...
- **Client connection check interval**{#setting-client-connection-check-interval} {{ tag-all }}
  ...
  Подробнее в описании настройки `client_connection_check_interval` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-connection.html#GUC-CLIENT-CONNECTION-CHECK-INTERVAL).
...
- **Client min messages**{#setting-client-min-messages} {{ tag-all }}
  ...
  Подробнее в описании настройки `client_min_messages` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-client.html#GUC-CLIENT-MIN-MESSAGES).
...
- **Constraint exclusion**{#setting-constraint-exclusion} {{ tag-all }}
  ...
  Подробнее в описании настройки `constraint_exclusion` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-CONSTRAINT-EXCLUSION).
...
- **Deadlock timeout**{#setting-deadlock-timeout} {{ tag-all }}
  ...
  Подробнее в описании настройки `deadlock_timeout` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-locks.html#GUC-DEADLOCK-TIMEOUT).
...
- **Debug parallel query**{#setting-debug-parallel-query} {{ tag-all }}
  ...
  * `regress` (`DEBUG_PARALLEL_QUERY_REGRESS` для {{ TF }} и API) — аналогично значению `on`, но с некоторыми особенностями, которые облегчают автоматическое регрессионное тестирование. Например, скрываются узлы Gather в выводе команды `EXPLAIN`.
  ...
  Подробнее в описании настройки `debug_parallel_query` в [документации {{ PG }}]({{ pg.docs.org }}/current/runtime-config-developer.html#GUC-DEBUG-PARALLEL-QUERY).
...
- **Default statistics target**{#setting-default-statistics-target} {{ tag-all }}
  ...
  Подробнее в описании настройки `default_statistics_target` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-DEFAULT-STATISTICS-TARGET).
...
- **Default transaction isolation**{#setting-default-transaction-isolation} {{ tag-all }}
  ...
  Подробнее об уровнях изоляции читайте [в документации {{ PG }}](https://www.postgresql.org/docs/current/transaction-iso.html).
...
- **Default transaction read only**{#setting-default-transaction-read-only} {{ tag-all }}
  ...
  Подробнее в описании настройки `default_transaction_read_only` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-client.html#GUC-DEFAULT-TRANSACTION-READ-ONLY).
...
- **Default with oids**{#setting-default-with-oids} {{ tag-all }}
  ...
  Подробнее в описании настройки `default_with_oids` в [документации {{ PG }}](https://www.postgresql.org/docs/11/runtime-config-compatible.html#GUC-DEFAULT-WITH-OIDS).
...
- **Effective cache size**{#setting-effective-cache-size} {{ tag-all }}
  ...
  Подробнее в описании настройки `effective_cache_size` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-EFFECTIVE-CACHE-SIZE).
...
- **Enable async append**{#setting-enable-async-append} {{ tag-all }}
  ...
  Подробнее в описании настройки `enable_async_append` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-ENABLE-ASYNC-APPEND).
...
- **Enable gathermerge**{#setting-enable-gathermerge} {{ tag-all }}
  ...
  Подробнее в описании настройки `enable_gathermerge` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-ENABLE-GATHERMERGE).
...
- **Enable group by reordering**{#setting-enable-group-by-reordering} {{ tag-all }}
  ...
  Подробнее в описании настройки `enable_group_by_reordering` в [документации {{ PG }}]({{ pg.docs.org }}/current/runtime-config-query.html#GUC-ENABLE-GROUPBY-REORDERING).
...
- **Enable hashagg**{#setting-enable-hashagg} {{ tag-all }}
  ...
  Подробнее в описании настройки `enable_hashagg` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-ENABLE-HASHAGG).
...
- **Enable hashjoin**{#setting-enable-hashjoin} {{ tag-all }}
  ...
  Подробнее в описании настройки `enable_hashjoin` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-ENABLE-HASHJOIN).
...
- **Enable incremental sort**{#setting-enable-incremental-sort} {{ tag-all }}
  ...
  Подробнее в описании настройки `enable_incremental_sort` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-ENABLE-INCREMENTAL-SORT).
...
- **Enable indexonlyscan**{#setting-enable-indexonlyscan} {{ tag-all }}
  ...
  Подробнее в описании настройки `enable_indexonlyscan` в [документации {{ PG }}](https://www.postgresql.org/docs/current/indexes-index-only-scans.html).
...
- **Enable indexscan**{#setting-enable-indexscan} {{ tag-all }}
  ...
  Подробнее в описании настройки `enable_indexscan` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-ENABLE-INDEXSCAN).
...
- **Enable material**{#setting-enable-material} {{ tag-all }}
  ...
  Подробнее в описании настройки `enable_material` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-ENABLE-MATERIAL).
...
- **Enable memoize**{#setting-enable-memoize} {{ tag-all }}
  ...
  Подробнее в описании настройки `enable_memoize` в [документации {{ PG }}]({{ pg.docs.org }}/current/runtime-config-query.html#GUC-ENABLE-MEMOIZE).
...
- **Enable mergejoin**{#setting-enable-mergejoin} {{ tag-all }}
  ...
  Подробнее в описании настройки `enable_mergejoin` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-ENABLE-MERGEJOIN).
...
- **Enable nestloop**{#setting-enable-nestloop} {{ tag-all }}
  ...
  Подробнее в описании настройки `enable_nestloop` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-ENABLE-NESTLOOP).
...
- **Enable parallel append**{#setting-enable-parallel-append} {{ tag-all }}
  ...
  Подробнее в описании настройки `enable_parallel_append` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-ENABLE-PARALLEL-APPEND).
...
- **Enable parallel hash**{#setting-enable-parallel-hash} {{ tag-all }}
  ...
  Подробнее в описании настройки `enable_parallel_hash` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-ENABLE-PARALLEL-HASH).
...
- **Enable partition pruning**{#setting-enable-partition-pruning} {{ tag-all }}
  ...
  Подробнее в описании настройки `enable_partition_pruning` в [документации {{ PG }}](https://www.postgresql.org/docs/current/ddl-partitioning.html#DDL-PARTITION-PRUNING).
...
- **Enable partitionwise aggregate**{#setting-enable-partitionwise-aggregate} {{ tag-all }}
  ...
  Подробнее в описании настройки `enable_partitionwise_aggregate` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-ENABLE-PARTITIONWISE-AGGREGATE).
...
- **Enable partitionwise join**{#setting-enable-partition-join} {{ tag-all }}
  ...
  Подробнее в описании настройки `enable_partitionwise_join` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-ENABLE-PARTITIONWISE-JOIN).
...
- **Enable seqscan**{#setting-enable-seqscan} {{ tag-all }}
  ...
  Подробнее в описании настройки `enable_seqscan` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-query.html#RUNTIME-CONFIG-QUERY-ENABLE).
...
- **Enable sort**{#setting-enable-sort} {{ tag-all }}
  ...
  Подробнее в описании настройки `enable_sort` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-ENABLE-SORT).
...
- **Exit on error**{#setting-exit-on-error} {{ tag-all }}
  ...
  Подробнее в описании настройки `exit_on_error` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-error-handling.html).
...
- **Force parallel mode**{#setting-force-parallel-mode} {{ tag-all }}
  ...
  Подробнее в описании настройки `force_parallel_mode` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-developer.html).
...
- **Geqo threshold**{#setting-geqo-threshold} {{ tag-all }}
  ...
  Подробнее в описании настройки `geqo_threshold` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-GEQO-THRESHOLD).
...
- **Jit**{#setting-jit} {{ tag-all }}
  ...
  Подробнее в описании настройки `jit` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-JIT).
...
- **Lo compat privileges**{#setting-lo-compat-privileges} {{ tag-all }}
  ...
  Подробнее в описании настройки `lo_compat_privileges` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-compatible.html#GUC-LO-COMPAT-PRIVILEGES).
...
- **Log autovacuum min duration**{#setting-log-autovacuum-min-duration} {{ tag-all }}
  ...
  Подробнее в описании настройки `log_autovacuum_min_duration` в [документации {{ PG }}]({{ pg.docs.org }}/current/runtime-config-logging.html#GUC-LOG-AUTOVACUUM-MIN-DURATION).
...
- **Log min duration statement**{#setting-log-min-duration-statement} {{ tag-all }}
  ...
  Подробнее в описании настройки `log_min_duration_statement` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-logging.html#GUC-LOG-MIN-DURATION-STATEMENT).
...
- **Log parameter max length**{#setting-log-parameter-max-length} {{ tag-all }}
  ...
  Подробнее в описании настройки `log_parameter_max_length` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-logging.html#GUC-LOG-PARAMETER-MAX-LENGTH).
...
- **Log recovery conflict waits**{#setting-log-recovery-conflict-waits} {{ tag-all }}
  ...
  Подробнее в описании настройки `log_recovery_conflict_waits` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-logging.html#GUC-LOG-RECOVERY-CONFLICT-WAITS).
...
- **Log statement**{#setting-log-statement} {{ tag-all }}
  ...
  Подробнее в описании настройки `log_statement` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-logging.html).
...
- **Log transaction sample rate**{#setting-log-transaction-sample-rate} {{ tag-all }}
  ...
  Подробнее в описании настройки `log_transaction_sample_rate` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-logging.html#GUC-LOG-TRANSACTION-SAMPLE-RATE).
...
- **Logical decoding work mem**{#setting-logical-decoding-work-mem} {{ tag-all }}
  ...
  Подробнее в описании настройки `logical_decoding_work_mem` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-LOGICAL-DECODING-WORK-MEM).
...
- **Maintenance io concurrency**{#setting-maintenance-io-concurrency} {{ tag-all }}
  ...
  Подробнее в описании настройки `maintenance_io_concurrency` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAINTENANCE-IO-CONCURRENCY).
...
- **Max logical replication workers**{#setting-max-logical-replication-workers} {{ tag-all }}
  ...
  Подробнее в описании настройки `max_logical_replication_workers` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-replication.html#GUC-MAX-LOGICAL-REPLICATION-WORKERS).
...
- **Max parallel maintenance workers**{#setting-max-parallel-maintenance-workers} {{ tag-all }}
  ...
  Подробнее в описании настройки `max_parallel_maintenance_workers` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAX-PARALLEL-MAINTENANCE-WORKERS).
...
- **Max parallel workers**{#setting-max-parallel-workers} {{ tag-all }}
  ...
  Подробнее в описании настройки `max_parallel_workers` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAX-PARALLEL-WORKERS).
...
- **Max slot wal keep size**{#setting-max-slot-wal-keep-size} {{ tag-all }}
  ...
  Минимальное значение — `67108864` (64 МБ). Максимальное значение — 50% от размера [хранилища](../../../managed-postgresql/concepts/storage.md). Значение по умолчанию — 5% от размера хранилища. Значение должно быть кратно 1024.

  {% include [settings-version](../../../_includes/mdb/mpg/mpg-settings-v-13.md) %}

  Подробнее в описании настройки `max_slot_wal_keep_size` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-replication.html#GUC-MAX-SLOT-WAL-KEEP-SIZE).
...
- **Max wal senders**{#setting-max-wal-senders} {{ tag-all }}
  ...
  Подробнее в описании настройки `max_wal_senders` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-replication.html#GUC-MAX-WAL-SENDERS).
...
- **Max worker processes**{#setting-max-worker-processes} {{ tag-all }}
  ...
  Подробнее в описании настройки `max_worker_processes` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-MAX-WORKER-PROCESSES).
...
- **Operator precedence warning**{#setting-operator-precedence-warning} {{ tag-all }}
  ...
  Подробнее в описании настройки `operator_precedence_warning` в [документации {{ PG }}](https://www.postgresql.org/docs/13/runtime-config-compatible.html#GUC-OPERATOR-PRECEDENCE-WARNING).
...
- **Parallel leader participation**{#setting-parallel-leader-participation} {{ tag-all }}
  ...
  Подробнее в описании настройки `parallel_leader_participation` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-PARALLEL-LEADER-PARTICIPATION).
...
- **Pg trgm similarity threshold**{#setting-pg-trgm-similarity} {{ tag-all }}
  ...
  Подробнее в описании настройки `pg_trgm.similarity_threshold` в [документации {{ PG }}]({{ pg.docs.org }}/current/pgtrgm.html#GUC-PGTRGM-SIMILARITY-THRESHOLD).
...
- **Pg trgm strict word similarity threshold**{#setting-pg-trgm-strict-word-similarity-threshold} {{ tag-all }}
  ...
  Подробнее в описании настройки `pg_trgm.strict_word_similarity_threshold` в [документации {{ PG }}]({{ pg.docs.org }}/current/pgtrgm.html#GUC-PGTRGM-STRICT-WORD-SIMILARITY-THRESHOLD).
...
- **Quote all identifiers**{#setting-quote-identifiers} {{ tag-all }}
  ...
  Подробнее в описании настройки `quote_all_identifiers` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-compatible.html#GUC-QUOTE-ALL-IDENTIFIERS).
...
- **Row security**{#setting-row-security} {{ tag-all }}
  ...
  Подробнее в описании настройки `row_security` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-client.html#GUC-ROW-SECURITY).
...
- **Search path**{#setting-search-path} {{ tag-all }}
  ...
  Подробнее в описании настройки `search_path` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-client.html#GUC-SEARCH-PATH).
...
- **Statement timeout**{#setting-statement-timeout} {{ tag-all }}
  ...
  Подробнее в описании настройки `statement_timeout` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-client.html#GUC-STATEMENT-TIMEOUT).
...
- **Synchronize seqscans**{#setting-synchronize-seqscans} {{ tag-all }}
  ...
  Подробнее в описании настройки `synchronize_seqscans` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-compatible.html#GUC-SYNCHRONIZE-SEQSCANS).
...
- **Synchronous commit**{#setting-synchronous-commit} {{ tag-all }}
  ...
  Подробнее в описании настройки `synchronous_commit` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-wal.html#GUC-SYNCHRONOUS-COMMIT).
...
- **Temp file limit**{#setting-temp-file-limit} {{ tag-all }}
  ...
  Подробнее в описании настройки `temp_file_limit` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-TEMP-FILE-LIMIT).
...
- **Track activity query size**{#setting-track-activity-query-size} {{ tag-all }}
  ...
  Подробнее в описании настройки `track_activity_query_size` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-statistics.html#GUC-TRACK-ACTIVITY-QUERY-SIZE).
...
- **Track commit timestamp**{#setting-track-commit-timestamp} {{ tag-all }}
  ...
  Подробнее в описании настройки `track_commit_timestamp` в [документации {{ PG }}]({{ pg.docs.org }}/current/runtime-config-replication.html#GUC-TRACK-COMMIT-TIMESTAMP).
...
- **Transform null equals**{#setting-transform-null-equals} {{ tag-all }}
  ...
  Подробнее в описании настройки `transform_null_equals` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-compatible.html#GUC-TRANSFORM-NULL-EQUALS).
...
- **Vacuum cleanup index scale factor**{#setting-vacuum-index-scale-factor} {{ tag-all }}
  ...
  Подробнее в описании настройки `vacuum_cleanup_index_scale_factor` в [документации {{ PG }}](https://www.postgresql.org/docs/12/runtime-config-client.html#GUC-VACUUM-CLEANUP-INDEX-SCALE-FACTOR).
...
- **Vacuum cost delay**{#setting-vacuum-cost-delay} {{ tag-all }}
  ...
  Подробнее в описании настройки `vacuum_cost_delay` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-resource.html#RUNTIME-CONFIG-RESOURCE-VACUUM-COST).
...
- **Vacuum cost limit**{#setting-vacuum-cost-limit} {{ tag-all }}
  ...
  Подробнее в описании настройки `vacuum_cost_limit` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-VACUUM-COST-LIMIT).
...
- **Vacuum cost page dirty**{#setting-vacuum-cost-page-dirty} {{ tag-all }}
  ...
  Подробнее в описании настройки `vacuum_cost_page_dirty` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-VACUUM-COST-PAGE-DIRTY).
...
- **Vacuum cost page hit**{#setting-vacuum-cost-page-hit} {{ tag-all }}
  ...
  Подробнее в описании настройки `vacuum_cost_page_hit` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-VACUUM-COST-PAGE-HIT).
...
- **Work mem**{#setting-work-mem} {{ tag-all }}
  ...
  Подробнее в описании настройки `work_mem` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-resource.html#GUC-WORK-MEM).
...
- **Xmlbinary**{#setting-xmlbinary} {{ tag-all }}
  ...
  Подробнее в описании настройки `xmlbinary` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-client.html#GUC-XMLBINARY).
...
- **Xmloption**{#setting-xmloption} {{ tag-all }}
  ...
  Подробнее в описании настройки `xmloption` в [документации {{ PG }}](https://www.postgresql.org/docs/current/runtime-config-client.html#GUC-XMLOPTION).
