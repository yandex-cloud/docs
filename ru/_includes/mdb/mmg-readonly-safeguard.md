Если хотя бы один хост в кластере {{ mmg-name }} исчерпает все доступное ему дисковое пространство, то инстанс {{ MG }} на этом хосте аварийно завершит работу и станет неработоспособным. Если этот хост был с ролью PRIMARY, то эта роль перейдет на одну из SECONDARY-реплик. Возможна ситуация, когда в результате миграции роли PRIMARY с хоста на хост исчерпается дисковое пространство на всех хостах кластера, что приведет к неработоспособности кластера в целом.
