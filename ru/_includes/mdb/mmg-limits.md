...
| Количество хостов в одном кластере                                                                               | 1 или 3 хоста в зависимости от [типа хранилища](../../managed-mongodb/concepts/storage.md#storage-type-selection), кластер [создается](../../managed-mongodb/operations/cluster-create.md) нешардированным | 70 (10 шардов × 7 хостов)                        |
| Объем данных на хосте при использовании хранилища на сетевых HDD-дисках или на сетевых SSD-дисках                | 10 ГБ                                                                                      | 605 ГБ                                           |
| Объем данных на хосте при использовании хранилища на нереплицируемых SSD-дисках                                  | 93 ГБ                                                                                      | 558 ГБ                                           |
| Объем данных на хосте при использовании хранилища на локальных SSD-дисках<sup>*</sup>                            | 100 ГБ                                                                                     | 600 ГБ                                           |
