* Через интернет, если вы настроили публичный доступ для нужного хоста при [создании кластера](../../../storedoc/operations/cluster-create.md). К таким хостам подключиться можно только используя SSL-соединение.
