`--datatransfer-access` — разрешает доступ к кластеру из сервиса [{{ data-transfer-full-name }}](../../../data-transfer/index.yaml) в Serverless-режиме. Значение по умолчанию — `false`.
