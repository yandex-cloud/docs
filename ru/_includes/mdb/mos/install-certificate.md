...
- Windows (PowerShell) {#windows}
   ...
   Корпоративные политики и антивирус могут блокировать скачивание сертификата. Подробнее читайте в разделе [Вопросы и ответы](../../../managed-opensearch/qa/index.md#get-ssl-error).
