...
Для подключения из {{ websql-name }} в настройках кластера должна быть включена опция **{{ ui-key.yacloud.mdb.forms.additional-field-websql-service }}**. Опцию можно включить при [создании кластера](../../../managed-redis/operations/cluster-create.md) или [изменении кластера](../../../managed-redis/operations/update.md#change-additional-settings).
