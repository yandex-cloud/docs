...
| Объем данных на брокере при использовании локального хранилища (для платформ Intel Broadwell и Intel Cascade Lake) | 100 ГБ                                                                                                | 1500 ГБ                                          |  |  |  |
| Объем данных на брокере при использовании локального хранилища (для платформы Intel Ice Lake)                      | {{ local-ssd-v3-step }}                                                                               | {{ local-ssd-v3-max }}                           |  |  |  |
