...
Синхронизация ролей из ABC в IAM может занимать от 15 до 90 минут. Поэтому с момента выдачи роли до момента появления доступа может пройти до полутора часов.
