...
|:----------------------------------------------------------------------------------------------------------|:--------------------------------------|:--------------------------------------------------|
| Класс хоста                                                                                               | b1.nano (`burstable` с 2 ГБ RAM)      | hm3-c32-m512 (32 vCPU Intel Ice Lake, 512 ГБ RAM) |
| Количество хостов в нешардированном кластере                                                              | 1 или 3 в зависимости от [типа хранилища](../../managed-redis/concepts/storage.md#storage-type-selection)                              | 7                                                 |
| Количество шардов в шардированном кластере                                                                | 3                                     | 10                                                |
...
| Количество хостов в шардированном кластере                                                                | 3, 6 или 9 хостов в зависимости от [типа хранилища](../../managed-redis/concepts/storage.md#storage-type-selection)                 | 70 (10 шардов × 7 хостов)                         |
