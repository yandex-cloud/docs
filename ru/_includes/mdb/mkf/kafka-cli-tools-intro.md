В состав [архивов с бинарными файлами {{ KF }}](https://kafka.apache.org/community/downloads/) включен набор инструментов, который позволяет управлять кластером {{ KF }} и сущностями в нем. Подробнее об этих инструментах читайте в [документации вендора {{ KF }}](https://docs.confluent.io/kafka/operations-tools/kafka-tools.html).
