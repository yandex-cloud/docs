...
|:------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------|
| Класс хоста                                                                                                                   | b1.nano (2 × {% if audience != "internal" %}[5%](../../compute/concepts/performance-levels.md){% else %}5%{% endif %} vCPU Intel Broadwell, 2 ГБ RAM) | m3-c80-m640 (80 vCPU Intel Cascade Lake, 640 ГБ RAM) |
