...
Для подключения из {{ websql-name }} в настройках кластера должна быть включена опция **{{ ui-key.yacloud.mdb.forms.additional-field-websql-service }}**. Опцию можно включить при [создании](../../../managed-mysql/operations/cluster-create.md) или [изменении](../../../managed-mysql/operations/update.md#change-additional-settings) кластера.
...
- Консоль управления {#console}
  ...
  1. В [консоли управления]({{ link-console-main }}) выберите в каталог с нужным кластером.
