...
Вы можете создать группу виртуальных машин на базе образа [{{ coi }}](../../cos/concepts/index.md) с несколькими {% if lang == "ru" %}[Docker-контейнерами](/blog/posts/2022/03/docker-containers){% else %}Docker-контейнерами{% endif %} внутри.
...
1. [Подключитесь](../../compute/operations/vm-connect/ssh.md#vm-connect) к одной из созданных ВМ по {% if lang == "ru" and audience != internal %}[SSH](../../glossary/ssh-keygen.md){% else %}SSH{% endif %}:
