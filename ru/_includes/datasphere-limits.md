...
^1^ повышение квоты доступно при балансе платежного аккаунта более {% if region == "ru" %}500 ₽{% endif %}{% if region == "kz" %}3000 ₸{% endif %}{% if region == "int" %}10 ${% endif %} или по запросу в техническую поддержку.