...
^1^ повышение квоты доступно после пополнения баланса платежного аккаунта на сумму не менее {% if region == "ru" %}500 ₽{% endif %}{% if region == "kz" %}3000 ₸{% endif %}{% if region == "int" %}10 ${% endif %} или по запросу в техническую поддержку.
