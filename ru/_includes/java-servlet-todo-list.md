...
1. Создайте базу данных в [режиме Serverless](../ydb/concepts/serverless_and_dedicated#serverless):
...
- Консоль управления
  ...
  1. Добавьте переменные окружения:
      * `DATABASE` — значение поля **База данных** вашей базы данных (раздел YDB эндпоинт);
      * `ENDPOINT` — значение поля **Эндпоинт** вашей базы данных (раздел YDB эндпоинт).
