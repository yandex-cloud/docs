...
1. Создайте базу данных в [бессерверной](../ydb/concepts/serverless_and_dedicated#serverless-rezhim-raboty-ydb) конфигурации:
...
- Консоль управления
  ...
  1. Добавьте переменные окружения:
      - `DATABASE` — значение поля **База данных** вашей базы данных;
      - `ENDPOINT` — значение поля **Эндпоинт** вашей базы данных.
