...
* В процессе установки зависимостей:
    * суммарное время работы команды `npm ci` ограничено **5 минутами**, после чего сборка завершится с ошибкой;
    * на выполнение команды выделяется не более **1 ГБ** оперативной памяти.
