...
- Консоль управления
    ...
    1. Укажите [бессерверную](../../ydb/concepts/serverless_and_dedicated.md#serverless) базу данных {{ ydb-short-name }} или [создайте](../../ydb/quickstart/create-db.md) новую. Если вы создали новую базу данных, после ее создания нажмите кнопку **Обновить** для обновления списка баз.
