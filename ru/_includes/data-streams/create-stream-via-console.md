...
- Консоль управления
    ...
    1. Укажите [бессерверную][](../../managed-ydb/concepts/serverless-and-dedicated.md#serverless) базу данных {{ ydb-short-name }} или [создайте](../../managed-ydb/quickstart.md#create-db) новую. Если вы создали новую базу данных, после ее создания нажмите кнопку **Обновить** для обновления списка баз.
