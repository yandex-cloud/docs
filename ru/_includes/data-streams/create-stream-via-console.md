...
- Консоль управления
    ...
    1. Укажите [бессерверную]{% if audience == "external" %}[](../../managed-ydb/concepts/serverless-and-dedicated.md#serverless){% else %}(https://cloud.yandex.ru/docs/managed-ydb/concepts/serverless-and-dedicated#serverless){% endif %} базу данных {{ ydb-short-name }} или [создайте]{% if audience == "external" %}(../../managed-ydb/quickstart.md#create-db){% else %}(https://cloud.yandex.ru/docs/managed-ydb/quickstart#create-db){% endif %} новую. Если вы создали новую базу данных, после ее создания нажмите кнопку **Обновить** для обновления списка баз.
