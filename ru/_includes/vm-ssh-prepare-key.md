...
- Windows 7/8
  ...
  1. При создании виртуальной машины через консоль управления укажите публичный ключ. Для этого откройте файл `id_rsa.pub` с помощью Notepad и скопируйте значение ключа в поле **SSH-ключ**.
