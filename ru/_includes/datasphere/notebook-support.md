...
Следить за состоянием запроса можно {% if product == "yandex-cloud" %}через мобильное приложение {{ yandex-cloud }} для [iOS](https://apps.apple.com/ru/app/yandex-cloud/id1515465314) или [Android](https://play.google.com/store/apps/details?id=ru.yandex.cloud), а также {% endif %}в разделе [Поддержка]({{ link-console-support }}) в консоли управления.
