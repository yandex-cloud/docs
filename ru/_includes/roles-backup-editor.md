...
Роль `backup.admin` предназначена для управления ресурсами сервиса {{ backup-name }}. Пользователи с этой ролью могут:

* просматривать все ресурсы и их списки, как в роли `backup.viewer`;
