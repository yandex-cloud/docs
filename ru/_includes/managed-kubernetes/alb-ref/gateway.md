  ...
  * `allowedRoutes` (`AllowedRoutes`)
    ...
    * `namespaces` (`RouteNamespaces`)
      ...
      * `selector` (`LabelSelector`)
        ...
        Подробнее в [справочнике API {{ k8s }}](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.31/#labelselector-v1-meta).
