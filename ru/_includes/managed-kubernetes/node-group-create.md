...
1. В блоке **Дополнительно**:
   ...
   * Чтобы задать [taint-политики узлов](https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/), используйте кнопку **Добавить политику**. Укажите ключ, значение и эффект каждой taint-политики в отдельном наборе полей.
