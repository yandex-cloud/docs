...
1. (Опционально) В блоке **{{ ui-key.yacloud.k8s.node-groups.create.section_gpu-settings }}** укажите, если группа узлов должна быть без предустановленных драйверов NVIDIA и библиотек CUDA для [GPU-ускорения](../../compute/concepts/gpus.md).
