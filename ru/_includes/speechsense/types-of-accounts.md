* **Пользователи из организации**. Любой пользователь {{ yandex-cloud }} состоит как минимум в одной организации. В ней могут быть пользователи с любым типом [аккаунтов в {{ yandex-cloud }}](../../iam/concepts/index.md#accounts):
