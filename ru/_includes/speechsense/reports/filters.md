...
* **Фильтры** — для них используется такой же набор полей, что и для параметров. Помимо этого в фильтрах доступны [нейропараметры](../../../speechsense/concepts/reports/neuro-parameters.md).
