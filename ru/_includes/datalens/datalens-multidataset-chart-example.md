В качестве источника будет использована демонстрационная база данных ClickHouse с информацией о продажах товаров в сети московских магазинов. Пример, как создать подключение смотрите в [сценарии](../../solutions/datalens/data-from-ch-visualization.md#step1).
