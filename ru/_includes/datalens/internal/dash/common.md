...
Перечисленные в alias параметры синхронизируются по значению,
т.е. значение всегда будет одинаковое для всех и изменяться это значение будет одновременно.
