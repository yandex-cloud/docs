...
Заголовок страницы пишем h1 заголовком. Далее идёт раздел - h2. Потом уже по уровням вложенности. Важно! Нельзя пропускать вложенность заголовков.
...
Дефисы позволяют создавать для каждого столбца заголовок. Вертикальные черты разделяют столбцы. Чтобы таблица правильно отображалась, включите перед ней пустую строку.
