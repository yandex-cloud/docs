...
{% if product == "yandex-cloud" %}Максимальное количество строк [материализованных данных](../../datalens/concepts/dataset/settings.md#materialization)<br>в одном датасете | 100 000 000{% endif %}
