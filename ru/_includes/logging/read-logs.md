...
- CLI
    ...
    * `--until` — момент времени N и раньше.
    ...
    Если был указан только один флаг, отображается информация за один час до или после момента времени N в зависимости от указанного флага. При добавлении обоих флагов, используйте параметр `--limit` для предопределения лимита вывода.
