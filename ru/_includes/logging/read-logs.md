Максимальный срок хранения записей — 7 дней. Время в журнале указано по [UTC](https://ru.wikipedia.org/wiki/Всемирное_координированное_время).
...
- API
	...
	Посмотреть записи в лог-группе можно с помощью метода API [read](../../logging/api-ref/LogReading/read.md).
