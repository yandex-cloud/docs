...
Максимальное количество приемников у триггера ^2^ | 5
...
^2^ Лимит `Максимальное количество приемников у триггера` — общий для сервисов {{ api-gw-name }}, {{ sf-name }} и {{ serverless-containers-name }}.
