Чтобы настроить {{ GL }} и подготовить процесс непрерывной интеграции ({% if lang == "ru" %}[Continuous Integration](/blog/posts/2022/10/ci-cd){% else %}Continuous Integration{% endif %}, CI), создайте новый проект и введите параметры для авторизации в CI:
