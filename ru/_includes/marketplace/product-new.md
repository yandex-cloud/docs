...
1. Заполните форму сведениями о вашем продукте:
   ...
   * Укажите имя продукта на русском и английском языках. Это имя продукта будет отображаться в кабинете партнера Marketplace. Пользователи будут видеть имя продукта, указанное при создании версии.
