...
- Сервисный аккаунт
   ...
   Для работы с {{ yagpt-name }} сервисный аккаунт должен иметь роль `{{ roles-yagpt-user }}` или выше. {{ yagpt-name }} поддерживает два способа аутентификации с сервисным аккаунтом:
