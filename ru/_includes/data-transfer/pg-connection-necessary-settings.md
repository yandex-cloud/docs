...
* Пользовательская инсталляция
  ...
  * **PEM-сертификат** для шифрования передаваемых данных. Загрузите файл [PEM-сертификата](../../managed-postgresql/operations/connect.md#get-ssl-cert) или добавьте его содержимое в текстовом виде.
  * **Имя базы данных**.
