...
* **Кластер** — укажите имя кластера, в который будут передаваться данные. Если параметр не указан, данные будут размещены в кластере по умолчанию (макрос `{cluster}`).
