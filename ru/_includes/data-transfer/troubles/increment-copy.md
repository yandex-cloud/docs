...
При инкрементальном копировании возможны гонки транзакций — ситуации, когда транзакции завершаются не в том же порядке, в котором начались. При этом трансфер может не учесть более ранние транзакции. Подробнее читайте в разделе [Время ожидания завершения транзакций](../../../data-transfer/concepts/regular-incremental-copy.md#increment-delay).
