...
**Решение:** увеличьте лимит в [дополнительном параметре эндпоинта-источника](../../../../data-transfer/operations/endpoint/source/postgresql#additional-setting) **Максимальный размер WAL для слота репликации** и [активируйте](../../../../data-transfer/operations/transfer.md#activate) трансфер повторно.
