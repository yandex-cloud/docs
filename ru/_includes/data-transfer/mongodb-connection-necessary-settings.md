...
* Пользовательская инсталляция
    ...
    * **Порт**.
    * **PEM-сертификат** для шифрования передаваемых данных. Загрузите файл [PEM-сертификата](../../managed-mysql/operations/connect.md#get-ssl-cert) или добавьте его содержимое в текстовом виде.
