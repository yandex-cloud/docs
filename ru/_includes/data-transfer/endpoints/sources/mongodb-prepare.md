...
- {{ mmg-name }} (Managed Service for MongoDB)
    ...
    1. Оцените общее количество баз данных для трансфера и общую нагрузку на {{ mmg-name }}. Если нагрузка на базы выше 10 000 операций записи в секунду, создайте несколько эндпоинтов и трансферов. Подробнее читайте в разделе [{#T}](../../../../data-transfer/operations/endpoint/source/mongodb.md).
...
- {{ MG }}
    ...
    1. Оцените общее количество баз данных для трансфера и общую нагрузку на {{ MG }}. Если нагрузка на базы выше 10 000 операций записи в секунду, создайте несколько эндпоинтов и трансферов. Подробнее читайте в разделе [{#T}](../../../../data-transfer/operations/endpoint/source/mongodb.md).
