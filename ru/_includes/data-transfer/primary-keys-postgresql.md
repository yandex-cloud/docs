Для переноса таблиц без первичных ключей для типов трансфера _{{ dt-type-repl }}_ и _{{ dt-type-copy-repl }}_ необходимо добавить идентификатор реплики `REPLICA IDENTITY`:
