...
Вид ограничения | {{ yagpt-name }} | {{ yagpt-name }} Lite
----- | ----- | -----
Количество одновременно активных сессий | 0 | 1
Количество запросов в час, синхронный режим | 0 | 100
Количество запросов в секунду, асинхронный режим (запрос) | 10 | 10
