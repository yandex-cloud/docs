...
Количество выделенных серверов в одном облаке* | 0

\* Чтобы создать виртуальную машину с GPU или выделенный сервер, обратитесь в [техническую поддержку]({{ link-console-support }}).
