...
Количество выделенных хостов в одной группе выделенных хостов* | 0
Количество групп выделенных хостов в одном облаке| 0

\* Чтобы увеличить квоты на виртуальные машины с GPU или выделенные хосты, обратитесь в [техническую поддержку]({{ link-console-support }}).
