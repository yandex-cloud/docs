...
Для сервиса [{{ baremetal-full-name }}](../../baremetal/) действует отдельный [аттестат соответствия](https://{{ s3-storage-host }}/yc-compliance/certificates-2025/FZ-152/baremetal/conformance_ru_certificate-10-12-2025.pdf) требованиям 152‑ФЗ.
