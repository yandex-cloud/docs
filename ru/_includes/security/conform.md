...
{% endif %}
{% if product == "cloud-il" %}
Система управления информационной безопасностью (СУИБ) {{ yandex-cloud }} соответствует требованиям стандартов международной организации по стандартизации (ISO). Аудит СУИБ проводила международная команда аудиторов компании BSI. По результатам аудита получен сертификат соответствия стандарту ISO 27001.
