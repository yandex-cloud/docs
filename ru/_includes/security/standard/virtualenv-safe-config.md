...
В {{ objstorage-name }} реализовано несколько механизмов для управления доступом к ресурсам. Алгоритм взаимодействия этих механизмов смотрите в разделе [{#T}](../../../storage/security/overview.md).
...
Дополнительную информацию об отслеживании версий функций смотрите в разделе [{#T}](../../../functions/concepts/backup.md).
...
Подробнее о том какие роли действуют в сервисе {{ api-gw-name }} смотрите в разделе [{#T}](../../../api-gateway/security/index.md#roles-list).
...
Если API-шлюзу не требуется доступ к ресурсам из указанной облачной сети, удалите ее из настроек шлюза. Подробнее в статье [{#T}](../../../api-gateway/operations/api-gw-update.md).
...
Подробнее в статье [{#T}](../../../api-gateway/tutorials/api-gw-websocket.md).
...
Рекомендуется включать механизм логирования при создании API-шлюза. Подробнее в статье [{#T}](../../../api-gateway/operations/api-gw-logs-write.md).
