1. На странице с некорректным поведением нажмите сочетание клавиш **Ctrl** + **Shift** + **I** (**⌥** + **⌘** + **I** для macOS) или откройте меню ![image](../../_assets/support/yb-menu.png) → **Дополнительно** → **Дополнительные инструменты** → **Инструменты разработчика**.
