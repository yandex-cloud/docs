...
- CLI
    ...
    1. Создайте файл с телом запроса (например, `body.json`):
        ...
        * `targetLanguageCode` — язык, на который переводится текст, в формате [ISO 639-1]{% if lang == "ru" %}(https://ru.wikipedia.org/wiki/ISO_639-1){% endif %}{% if lang == "en" %}(https://en.wikipedia.org/wiki/ISO_639-1){% endif %}. Вы можете узнать код языка вместе со [списком поддерживаемых языков](../../translate/operations/list.md).
