...
- Консоль управления
  ...
  1. Если вы будете выполнять следующие шаги с помощью Terraform, скопируйте идентификаторы групп бэкендов `canary-bg-production` и `canary-bg-staging` со вкладки **Группы бэкендов**.
...
- Консоль управления
  ...
  1. В блоке **Размещение** выберите три подсети для узлов балансировщика — `canary-subnet-ru-central1-a`, `canary-subnet-ru-central1-b` и `canary-subnet-ru-central1-c` — и включите передачу трафика в эти подсети.
