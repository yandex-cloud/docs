...
* Правила профиля ARL с действиями `{{ ui-key.yacloud.smart-web-security.arl.label_rule-action-deny_3kenc }}` или `{{ ui-key.yacloud.smart-web-security.ArlRuleAction.label_rule-action-ban-period_2bxZV }}`.
