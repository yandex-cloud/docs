(опционально) В блоке **{{ ui-key.yacloud.smart-web-security.waf.section_analyze-request }}** настройте опцию **{{ ui-key.yacloud.smart-web-security.waf.field_analyze-request-body }}**:
