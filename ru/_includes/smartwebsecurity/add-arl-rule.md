...
1. (Опционально) Включите опцию **Включить dry run (только логирование)**, чтобы протестировать правило и оценить нагрузку на веб-сервис. В этом режиме действие правила к запросам не применяется.
