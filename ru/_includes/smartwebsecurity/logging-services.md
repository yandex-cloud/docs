...
В некоторых случаях сервис может блокировать трафик при атаках. В логах для таких блокировок будет указана отметка [сервисного правила](../../smartwebsecurity/concepts/rules.md#service-rule): `sws_service_rule`.
