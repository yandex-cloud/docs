...
* плата за каждую защищаемую ВМ (см. [описание продукта](https://cloud.yandex.ru/marketplace/products/hystax/hystax-acura-disaster-recovery-3-7) в {{ marketplace-name }}).
...
- CLI
   ...
   * `create-boot-disk` — создать для ВМ новый диск:
      ...
      * `image-id` — идентификатор образа диска.
        ...
        В данном случае используйте `image_id` из [описания продукта](https://cloud.yandex.ru/marketplace/products/hystax/hystax-acura-disaster-recovery-3-7) в {{ marketplace-name }}.
