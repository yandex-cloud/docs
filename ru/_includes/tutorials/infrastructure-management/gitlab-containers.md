...
* [{{ k8s }} CLI (kubectl)]{% if region == "int" %}(https://kubernetes.io/docs/tasks/tools/install-kubectl/){% else %}(https://kubernetes.io/ru/docs/tasks/tools/install-kubectl/){% endif %}.
* [Helm](https://helm.sh/).
