...
1. Убедитесь, что в выбранном каталоге есть сеть с подсетями в зонах доступности `ru-cental1-a`, `ru-central1-b` и `ru-cental1-с`. Для этого на странице каталога выберите сервис **{{ vpc-name }}**. Если нужной [сети](../../../vpc/operations/network-create.md) или [подсетей](../../../vpc/operations/subnet-create.md) нет, создайте их.
...
1. В блоке **Распределение** выберите три зоны доступности (`ru-cental1-a`, `ru-central1-b` и `ru-cental1-с`), чтобы обеспечить отказоустойчивость хостинга.
...
1. Откройте сервис **{{ alb-name }}** в каталоге, где создана группа ВМ.
...
1. Откройте сервис **{{ dns-name }}** в каталоге, где создана группа ВМ.
...
1. Откройте сервис **{{ alb-name }}**. В списке балансировщиков найдите IP-адрес ранее созданного балансировщика `alb-1`.
