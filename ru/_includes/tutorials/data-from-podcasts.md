...
1. Нажмите кнопку **Получить ключ**. Если вы в первый раз создаете подключение к подкастам Яндекс Музыки, предоставьте сервису необходимые разрешения (их можно [отозвать](../../datalens/qa/index.md#revoke-token) в любой момент).
...
1. Нажмите иконку ![image](../../_assets/datalens/solution-10/19-data-icon.png =20x20) поля **Дата прослушивания** в секции **X**.
