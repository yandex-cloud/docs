...
1. После создания подключения откроется папка с набором стандартных объектов, на основе которых построена ваша статистика:
    ...
    * ![image](../../_assets/datalens/solution-10/02-dashboard.png =20x20) Дашборд **Metrica Live Demo Dashbord** и **Дашборд по продажам** — примеры, которые могут открыться в вашем подключении. При необходимости их можно удалить.
