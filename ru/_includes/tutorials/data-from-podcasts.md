...
1. [Поделитесь аналитикой по подкасту с другими пользователями](#step-3).
...
1. [Сделайте публичным дашборд или чарт](#step4).
1. [Добавьте чарт или дашборд на свой сайт](#step5).
...
## Шаг 1. Настройте подключение {#step-1}
...
1. После создания подключения откроется папка с набором стандартных объектов, на основе которых построена ваша статистика:
    ...
    * ![image](../../_assets/datalens/solution-10/02-dashboard.png =20x20) Дашборд **Аналитика подкастов на Яндекс.Музыке** — основная страница для просмотра статистики, с набором всех виджетов (графиков, таблиц, фильтров).
...
## Шаг 2. Отредактируйте дашборд, чарт и создайте новые {#step-2}
...
## Шаг 3. Поделитесь аналитикой по подкасту {#step-3}
...
Права доступа можно настраивать для каждого объекта отдельно. Подробнее о [правах в DataLens](../../datalens/security/index.md#permissions).
...
## Шаг 4. Сделайте публичным дашборд или чарт {#step4}
...
## Шаг 5. Добавьте чарт или дашборд на свой сайт {#step5}
