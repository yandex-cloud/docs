...
1. В блоке **Образы из {{ marketplace-name }}** нажмите кнопку **Выбрать**. Выберите публичный образ [CentOS 7](https://cloud.yandex.ru/marketplace/products/f2esfplfav536pn90mdo).
...
1. На странице каталога в [консоли управления]({{ link-console-main }}) откройте сервис **Object Storage**.
...
3. Найдите нужный адрес, нажмите значок ![ellipsis](../../../_assets/options.svg) и выберите пункт **Удалить**.