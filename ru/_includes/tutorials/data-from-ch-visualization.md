...
1. Скопируйте чарт, получившийся на предыдущем шаге.
    ...
    1. В открывшемся окне введите название нового чарта **Продажи по брендам и категориям** и нажмите кнопку **Готово**.
...
1. Замените месяца на бренды на оси X. Из раздела **Измерения** перетащите поле **ProductBrand** в секцию **X** и наведите его над полем **OrderDate**, пока то не станет красным. 
