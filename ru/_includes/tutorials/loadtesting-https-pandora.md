      ...
      1. В блоке **Настройки генератора нагрузки**:
          ...
          * В меню **Автостоп** нажмите ![image](../../_assets/plus-sign.svg) **Автостоп** и введите описание:
            1. Тип автостопа: `QUANTILE`. Критерии автостопа: `75,100ms,10s`.
                ...
                Этот критерий остановит тест, если в течение 10 секунд 75% запросов будут обработаны более чем за 100 миллисекунд.
    ...
    - Конфиг
      ...
      1. В поле для ввода конфигурации введите настройки тестирующих потоков в формате `yaml`:
          ...
          autostop:                          # автостоп
            ...
            autostop:
              - quantile(75,100ms,10s)       # завершение теста, если в течение 10 секунд 75% запросов будут обработаны более чем за 100 миллисекунд
