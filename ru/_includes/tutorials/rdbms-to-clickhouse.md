...
Если трансфер перешел в статус **Реплицируется**, изменения данных на источнике переносятся на приемник {{ CH }} следующим образом:
...
* [Деактивируйте трансфер](../../data-transfer/operations/transfer.md#deactivate) и дождитесь его перехода в статус **Остановлен**.
