...
1. В правом верхнем углу графика нажмите кнопку меню и выберите **Получить ссылку и код**.
    ...
    Если получить ссылку не удалось (cм. [тикет](https://st.yandex-team.ru/CHARTS-2018)), в том же меню выберите **Открыть в новой вкладке** и скопируйте ссылку из адресной строки.
