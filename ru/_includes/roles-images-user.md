...
Роль `[!KEYREF roles-image-user]` действует только в отношении образов. Пользователь с ролью `[!KEYREF roles-image-user]` может использовать соответствующий образ при создании новых дисков, виртуальных машин и других образов.
