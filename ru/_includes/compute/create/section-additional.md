...
* (Опционально) Разрешите доступ к [серийной консоли](../../../compute/concepts/serial-console.md).
* (Опционально) Настройте [политику обслуживания](../../../compute/concepts/maintenance-policies.md). В консоли управления можно выбрать только тип политики. Чтобы настроить время ожидания перед обслуживанием, используйте CLI, {{ TF }} или API.
