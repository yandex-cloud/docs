...
1. (опционально) В блоке **Диски** нажмите **Добавить диск** и настройте загрузочный диск:
    ...
    * Нажмите кнопку **Добавить**.
        ...
        Если вы хотите создать виртуальную машину из существующего диска, [добавьте диск](../../../compute/operations/vm-create/create-from-disks.md).

1. (опционально) В блоке **Файловые хранилища** подключите [файловое хранилище](../../../compute/concepts/filesystem.md) и введите имя устройства.
