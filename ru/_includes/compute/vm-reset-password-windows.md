При первом [подключении к виртуальной машине по RDP](../../compute/operations/vm-connect/rdp.md) нужно сбросить пароль администратора, установленный по умолчанию, и сгенерировать новый.
...
- PowerShell {#powershell}
  ...
  1. Выполните команду:
      ...
      Если команда выполняется слишком долго, остановите ее с помощью сочетания клавиш **Ctrl** + **C**. После этого проверьте, что агент для сброса паролей установлен, и посмотрите логи его работы. Подробнее в разделе [{#T}](../../compute/operations/vm-guest-agent/check.md).
