...
- {{ TF }} {#tf}
  ...
  1. Откройте конфигурационный файл {{ TF }}, в котором описана ВМ, к которой вы хотите подключить сервисный аккаунт. Смотрите [пример конфигурационного файла ВМ](../../compute/operations/vm-create/create-linux-vm.md#tf).
