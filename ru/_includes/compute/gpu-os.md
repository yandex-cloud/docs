...
Для виртуальных машин на платформах {{ v100-broadwell }} и {{ v100-cascade-lake }} доступны специальные образы операционных систем  Ubuntu — [16.04 LTS GPU](/marketplace/products/yc/ubuntu-16-04-lts-gpu) (`ubuntu-1604-lts-gpu`) и [20.04 LTS GPU](/marketplace/products/yc/ubuntu-20-04-lts-gpu) (`ubuntu-2004-lts-gpu`), на которых установлены драйверы NVIDIA. 
...
Для виртуальных машин на платформе {{ a100-epyc }} доступны специальные образы операционных систем Linux:
