Изменять [метаданные](../../../compute/concepts/vm-metadata.md) можно только в каталоге [user-data](../../../compute/concepts/metadata/directories.md#dir-user). При изменении имеющийся набор метаданных полностью перезаписывается переданным обновленным набором.
