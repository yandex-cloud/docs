...
Чтобы включить программно-ускоренную сеть, [измените настройки](../../compute/operations/vm-control/vm-update-resources#enable-software-accelerated-network.md) существующей ВМ или выберите опцию **Программно-ускоренная сеть** при [создании новой ВМ](../../compute/operations/vm-create/create-linux-vm.md).