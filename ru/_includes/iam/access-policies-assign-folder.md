Чтобы создать для [каталога](../../resource-manager/concepts/resources-hierarchy.md#folder) политику авторизации на основе [шаблона без параметров](../../iam/concepts/access-control/access-policies.md#fixed):
...
- {{ TF }} {#tf}
  ...
  1. Добавьте в конфигурацию ресурс `yandex_resource_manager_folder_iam_policy_binding`:
      ...
      Подробнее см. в [документации провайдера]({{ tf-provider-resources-link }}/resource_manager_folder_iam_policy_binding).
