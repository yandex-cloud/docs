...
- AWS CLI {#cli}
  ...
  Вы можете сохранить эфемерный ключ в файл с учетными данные AWS сразу после выпуска ключа. Подробнее в руководстве [{#T}](../../tutorials/security/ephemeral-key-storage.md#prepare-script).      
