...
1. Назначьте роботу нужную роль через ABC:
...
1. Ответственному за робота нужно [получить OAuth-токен](https://oauth.yandex-team.ru/authorize?response_type=token&client_id=8cdb2f6a0dca48398c6880312ee2f78d), авторизовавшись под роботом, используя пароль из секретницы.
