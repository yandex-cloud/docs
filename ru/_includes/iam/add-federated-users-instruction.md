...
- Консоль управления
  ...
  1. В правом верхнем углу нажмите значок ![icon-users](../../_assets/horizontal-ellipsis.svg) и выберите **{{ ui-key.yacloud.common.resource-acl.button_add-federation-user }}**.
