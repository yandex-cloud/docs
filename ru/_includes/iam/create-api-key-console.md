...
1. В поле **{{ ui-key.yacloud.iam.folder.service-account.overview.field_key-scope }}** выберите одну или несколько [областей действия](../../iam/concepts/authorization/api-key.md#scoped-api-keys).
