...
1. (Опционально) Выберите **{{ ui-key.yacloud.iam.folder.service-account.overview.field_key-scope }}**. Подробнее про области действия см. в разделе [{#T}](../../iam/concepts/authorization/api-key.md#scoped-api-keys).
