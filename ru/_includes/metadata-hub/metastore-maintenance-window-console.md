...
Операции по техническому обслуживанию проводятся для включенных и выключенных кластеров. Они могут включать установку обновлений и исправлений компонента {{ metastore-name }}, а также другие сервисные работы.
