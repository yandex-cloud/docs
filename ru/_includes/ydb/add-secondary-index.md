Чтобы добавить [вторичный индекс](../../ydb/concepts/secondary-indexes.md) при создании таблицы, используйте конструкцию `INDEX IndexName GLOBAL ON (SomeKey1, ... SomeKeyN)`:
