...
Подробнее про настройки подключения кластера {{ k8s }} к сборкам GitLab читайте в 
[документации GitLab](https://docs.gitlab.com/ee/user/project/clusters/#add-existing-kubernetes-cluster).
