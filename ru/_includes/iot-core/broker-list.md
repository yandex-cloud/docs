...
- Консоль управления {#console}
  ...
  1. На панели слева выберите ![image](../../_assets/console-icons/gear-branches.svg) **{{ ui-key.yacloud.iot.label_brokers }}**. На вкладке **{{ ui-key.yacloud.common.overview }}** отобразится список брокеров.
