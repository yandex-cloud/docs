В открывшемся разделе **{{ ui-key.yacloud_org.security.workspaces.WorkspaceOnboardingForm.standartsTitle_cxvJ8 }}**:

1. В блоке **{{ ui-key.yacloud_org.security.workspaces.title_security-requirements_8r7hd }}** выберите [отраслевые стандарты и нормативные акты](../../security-deck/concepts/standard-compliance/index.md#security-rule-sets), на соответствие которым будут проверяться выбранные на предыдущем шаге ресурсы.
