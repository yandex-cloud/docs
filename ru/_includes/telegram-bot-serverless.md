...
- Консоль управления
  ...
  1. Очистите содержимое поля **Cпецификация** и вставьте в него следующий код. В поле `bucket` укажите имя бакета. В поле `service_account` укажите [идентификатор сервисного аккаунта](../iam/operations/sa/get-id.md).
