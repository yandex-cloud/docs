...
| ----- | ----- |
| Количество синхронных запросов через [API v1](../search-api/concepts/index.md#api-v1) в сутки | 100 000</br></br>Суточный лимит обновляется в 00:00:00 [GMT](https://ru.wikipedia.org/wiki/Среднее_время_по_Гринвичу) (00:03:00 [UTC+3](https://ru.wikipedia.org/wiki/UTC%2B3:00)) |
