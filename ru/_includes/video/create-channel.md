...
* Подробнее о каналах смотрите в разделе [{#T}](../../video/concepts/index.md#channels).
* Подробнее о том, как настроить показ рекламы, смотрите в разделе [{#T}](../../video/operations/channels/settings.md#ad-settings).
