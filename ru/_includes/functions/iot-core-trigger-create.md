...
О том, как создать триггер для {{ iot-name }}, который будет вызывать контейнер, читайте в [документации {{ serverless-containers-full-name }}](../../serverless-containers/operations/iot-core-trigger-create.md).
