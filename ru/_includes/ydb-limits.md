...
----- | -----
Суммарное количество ядер процессора для всех хостов баз данных в одном облаке | 24
Суммарный объем виртуальной памяти для всех хостов баз данных в одном облаке | 96 ГБ
...
\* Список операций, попадающих под ограничение: создание, изменение, удаление схем таблиц, получение описания таблицы, получение списка таблиц, создание и удаление директорий.

**Бессерверный режим работы**

Вид ограничения | Значение
----- | -----
Максимальное количество бессерверных баз данных | 4
