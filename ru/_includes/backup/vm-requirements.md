Минимальные характеристики [защищаемых ресурсов](../../backup/concepts/index.md#protected-resources), необходимые для установки и корректной работы [агента {{ backup-name }}](../../backup/concepts/agent.md):
...
* Объем памяти (RAM) — при резервном копировании требуется 1 ГБ RAM на каждый ТБ резервной копии. Объем используемой памяти зависит от объема и типа данных, обрабатываемых агентом {{ backup-name }}.
