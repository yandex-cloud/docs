...
Чтобы настроить TLS для коннекторов {{ CH }}, {{ PG }} или {{ MY }}, [создайте подключение](../../metadata-hub/operations/create-connection.md#on-premise-connection) к пользовательской инсталляции в {{ connection-manager-name }}. В настройках подключения включите использование TLS.
