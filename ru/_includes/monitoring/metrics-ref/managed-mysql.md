...
| `mysql.handler`<br/>`DGAUGE`, штуки | Количество обработчиков различных операций. Подробнее в [документации {{ MY }}](https://dev.mysql.com/doc/refman/8.0/en/server-status-variables.html). <br/>Дополнительная метка: `handler`. | 
