...
#### Метрики балансировщика DB Proxy {#managed-postgresql-dbproxy-metrics}

Специальные метки для метрик балансировщика:
* `fqdn` — FQDN хоста.
* `cid` — идентификатор кластера.

| Имя<br/>Тип, единицы измерения | Описание                                                                                                                  |
| ----- |---------------------------------------------------------------------------------------------------------------------------|
| `odyssey_balancer-bytes_received`<br/>`DGAUGE`, байты | Объем полученных балансировщиком данных.                                                                                  |
| `odyssey_balancer-bytes_sent`<br/>`DGAUGE`, байты | Объем отправленных балансировщиком данных.                                                                                |
| `odyssey_balancer-free_clients`<br/>`DGAUGE`, штуки | Количество оставшихся клиентских подключений в балансировщике.                                                            |
| `odyssey_balancer-free_servers`<br/>`DGAUGE`, штуки | Количество оставшихся серверных подключений в балансировщике.                                                             |
| `odyssey_balancer-is_alive`<br/>`DGAUGE`, 0/1 | Показатель работоспособности балансировщика. Принимает значение `1`, если балансировщик работает, `0` — если не работает. |
| `odyssey_balancer-is_available`<br/>`DGAUGE`, 0/1 | Показатель доступности балансировщика. Принимает значение `1`, если балансировщик доступен, `0` — если недоступен.        |
| `odyssey_balancer-login_clients`<br/>`DGAUGE`, штуки | Количество совершенных клиентских подключений.                                                                            |
| `odyssey_balancer-total_tcp_connections`<br/>`DGAUGE`, штуки | Количество TCP-подключений к балансировщику.                                                                              |
| `odyssey_balancer-used_clients`<br/>`DGAUGE`, штуки | Количество клиентских подключений в балансировщике.                                                                       |
| `odyssey_balancer-used_servers`<br/>`DGAUGE`, штуки | Количество серверных подключений в балансировщике.                                                                        |
