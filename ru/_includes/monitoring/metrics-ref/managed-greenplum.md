## Сервис {{ managed-greenplum-full-name }} {#managed-greenplum}

Общие метки для всех метрик сервиса {{ managed-greenplum-full-name }}: 
...
Подробнее о сервисе в документации [{{ managed-greenplum-full-name }}](../../managed-greenplum/).
