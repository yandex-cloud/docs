...
Суммарное количество CPU всех запущеных экземпляров контейнеров в каждой зоне доступности | 10
...
Максимальный размер HTTPS-запроса к контейнеру, включая HTTPS-заголовки и тело запроса | 3.5 МБ
Максимальный объем временных файлов | 512 МБ
Максимальное время обработки запроса контейнером до таймаута, включая начальную инициализацию при первом запуске | 10 минут
