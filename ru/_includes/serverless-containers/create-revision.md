...
{% else %}
Для создания ревизии сделайте Docker-образ публичным или передайте в команде идентификатор сервисного аккаунта, у которого есть права на скачивание образа.
{% endif %}
