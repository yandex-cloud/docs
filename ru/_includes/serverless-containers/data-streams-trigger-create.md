 Создайте триггер для [{{ yds-name }}](../../data-streams/), который будет вызывать [контейнер](../../serverless-containers/concepts/container.md) {{ serverless-containers-name }} при отправке данных в [поток](../../data-streams/concepts/glossary.md#stream-concepts). 
