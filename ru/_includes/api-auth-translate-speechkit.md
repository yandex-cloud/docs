...
Запросы к API могут выполнять пользователи от имени аккаунта на Яндексе, Яндекс.Коннекте или сервисного аккаунта.
...
1. Получите IAM-токен:
    * [Инструкция](../iam/operations/iam-token/create.md) для аккаунта на Яндексе и Яндекс.Коннекте.
