Запуск заданий с помощью CLI {{ yandex-cloud }} происходит посредством агента {{ dataproc-name }}, установленного на мастер-хосте кластера. Параметры заданий передаются агенту через [Data Proc API](../../data-proc/api-ref/Job/index.md).  
