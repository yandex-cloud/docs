...
[Включение сжатия контента](../operations/resources/enable-compression.md) также помогает избежать ситуации, когда сжатые файлы получают пользователи, которые не запрашивали сжатый контент. Подробнее в разделе [Решение проблем в {{ cdn-name }}](../troubleshooting.md#compressed-files).
