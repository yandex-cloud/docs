...
У провайдеров отличаются точки присутствия (POP). Подробнее см. [{#T}](points-of-presence.md).

При использовании EdgeCDN-провайдера действуют собственные [лимиты](limits.md#cdn-limits) и [ограничения](limits.md#other-restrictions).
