...
Настройка локационных правил доступна в [консоли управления]({{ link-console-main }}), а также с помощью [API](../api-ref/ResourceRules/index.md). Подробнее на странице [{#T}](../operations/resources/location-rules.md).
