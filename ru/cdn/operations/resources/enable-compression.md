...
Включение сжатия файлов также помогает избежать ситуации, когда сжатые файлы получают пользователи, которые не запрашивали сжатый контент. Подробнее в разделе [Решение проблем в {{ cdn-name }}](../../troubleshooting.md#compressed-files).
