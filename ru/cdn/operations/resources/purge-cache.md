...
После очистки кеша CDN-серверы повторно запрашивают удаленные файлы из источника по мере поступления пользовательских запросов. Полная очистка кеша может вызвать резкое увеличение нагрузки на источник и расходов на его работу. Если требуется обновить отдельные файлы, используйте выборочную очистку.
