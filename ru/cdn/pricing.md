...
В день включения [экранирования источников](concepts/origins-shielding.md), [выделенной IP-адресации](concepts/dedicated-ip-addressing.md), [выгрузки логов](concepts/logs.md) списывается плата за полный месяц. Также в день создания CDN-ресурса списывается плата за включенный пакет исходящего трафика. Далее плата взимается первого числа каждого следующего месяца.
