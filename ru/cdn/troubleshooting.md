---
title: Вопросы и ответы про {{ cdn-full-name }}
description: На странице представлены вопросы и ответы про {{ cdn-name }}.
---

# Общие вопросы про {{ cdn-full-name }}

Ниже перечислены распространенные вопросы и ответы про работу сервиса {{ cdn-name }}, а также часто возникающие проблемы и способы их решения.
...
Перейдите на вкладку **{{ ui-key.yacloud.cdn.label_resource-security }}** нужного CDN-ресурса и нажмите кнопку **{{ ui-key.yacloud.common.edit }}**.
