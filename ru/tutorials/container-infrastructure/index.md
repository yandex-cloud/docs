---
title: Сценарии использования контейнерной инфраструктуры в {{ yandex-cloud }}
description: Различные сценарии использования контейнерной инфраструктуры в {{ yandex-cloud }}.
---
