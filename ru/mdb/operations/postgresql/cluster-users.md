...
При добавлении пользователя [!KEYREF mdb-short-name] по умолчанию устанавливает для него ограничение в 50 подключений к [!KEYREF PG]-кластеру (настройка `connlimit`).
