...
Если хост является мастером в момент удаления, [!KEYREF mdb-short-name] автоматически назначит мастером следующую по приоритету реплику.
