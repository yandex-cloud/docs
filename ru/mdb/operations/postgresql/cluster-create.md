...
Максимально возможное количество подключений к каждому хосту [!KEYREF PG]-кластера рассчитывается так: `200 × <количество vCPU на каждом хосте>`. Таким образом, для кластера [класса s1.micro](../../concepts/instance-types.md) значение настройки `max_connections` не может быть выставлено больше 400.
