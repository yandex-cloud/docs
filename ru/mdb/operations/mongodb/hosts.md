...
Получить список хостов кластера можно с помощью метода [listHosts](../../api-ref/mongodb/Cluster/listHosts.md).
...
Добавить хост в кластер можно с помощью метода [addHosts](../../api-ref/mongodb/Cluster/addHosts.md).
...
Если хост является первичным в момент удаления, [!KEYREF mdb-short-name] автоматически выберет новую первичную реплику.
...
Удалить хост можно с помощью метода [deleteHosts](../../api-ref/mongodb/Cluster/deleteHosts.md).
