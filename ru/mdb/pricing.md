...
## Из чего складывается стоимость использования [!KEYREF mdb-short-name] {#rules}
...
## Цены до 1 декабря 2018 года {#prices-old}


### Хосты БД {#prices-host-old}
...
## Цены с 1 декабря 2018 года {#prices}
