...
Вы можете выбрать класс БД как для хостов [!KEYREF CH], так и для хостов ZooKeeper (в соответствии с ожидаемой нагрузкой реплицирования).

Например, вы создали кластер [!KEYREF CH] из 3 хостов, с классом БД `s1.micro`, и не указали класс для хостов ZooKeeper. [!KEYREF mdb-short-name] автоматически создаст 3 хоста ZooKeeper класса `s1.nano`.

Цена за час будет рассчитана так: `3 × [цена [!KEYREF CH] для s1.micro] + 3 × [цена ZooKeeper для s1.nano]`. 
...
s1.nano | 4,38 ₽ | 5,17 ₽
s1.micro | 8,55 ₽ | 10,09 ₽
s1.small | 16,89 ₽ | 19,93 ₽
s1.medium | 33,58 ₽ | 39,62 ₽
s1.large | 66,95 ₽ | 79,00 ₽
s1.xlarge | 133,70 ₽ | 157,77 ₽
