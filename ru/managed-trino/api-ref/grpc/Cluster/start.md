---
editable: false
sourcePath: en/_api-ref-grpc/trino/v1/api-ref/grpc/Cluster/start.md
---
...
**rpc Start ([StartClusterRequest](#yandex.cloud.trino.v1.StartClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## StartClusterRequest {#yandex.cloud.trino.v1.StartClusterRequest}
...
Required field. ID of the Trino cluster that is being started. ||
|#
...
|| metadata | **[StartClusterMetadata](#yandex.cloud.trino.v1.StartClusterMetadata)**
...
## StartClusterMetadata {#yandex.cloud.trino.v1.StartClusterMetadata}
