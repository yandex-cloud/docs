---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/managed-trino/cli-ref/catalog/create/tpcds/
---
...
`yc managed-trino catalog create tpcds <CATALOG-NAME> [Flags...] [Global Flags...]`
