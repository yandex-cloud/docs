...
Сервисное подключение для {{ mtr-name }} [создается](../../vpc/operations/private-endpoint-create.md) и настраивается в сервисе {{ vpc-full-name }}. При создании сервисного подключения в {{ vpc-short-name }} автоматически создаются следующие объекты:
