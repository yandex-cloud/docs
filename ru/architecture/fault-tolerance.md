...
Для оценки отказоустойчивости приложения (способности обрабатывать трафик при отказе одной из зон доступности) можно воспользоваться подготовленным для этого [Руководством по проведению учений по отказу зоны в облаке](../testing-zone-faiure). Для тестирования отказа зоны доступности подготовлен [сценарий развертывания инфраструктуры](https://github.com/yandex-cloud-examples/yc-deploy-ha-app-with-nlb?tab=readme-ov-file), на которой можно провести испытания.
