...
{% cut "**Пример 1**" %}
   ...
   **Ключевые слова:** не работает, подключение, ошибка сети, интернет, сбой соединения
   ...
   1. **Проверьте состояние сети на устройстве.**
...
{% cut "**Пример 2**" %}
   ...
   **Ключевые слова:** оплата, счет, платеж, возврат, списание, транзакция
   ...
   1. **Сохранить платежные документы.**
   ...
   1. **Оформить заявку на корректировку.**
   ...
   1. **Обратиться напрямую для срочных случаев.**
