...
- `meta_features` — Дополнительные метаданные контекста в свободном виде, зависит от бизнес-логики клиента. Подробнее см. раздел [Гибкая фильтрация по метаданным](#flexible-metadata-filtering) (опциональное).
...
**Примеры рекомендованной структуры базы знаний:**
