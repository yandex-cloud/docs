...
`yc cloud-registry artifact delete <ARTIFACT-ID>`
...
|| `--with-history` | Also removes artifact history. This allows rewriting artifacts in registries with enabled immutable artifact policy. ||
|| `--name` | `string`
