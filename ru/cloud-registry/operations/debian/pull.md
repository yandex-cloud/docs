---
title: Скачать Debian-пакет из реестра {{ cloud-registry-full-name }}
description: Следуя данной инструкции, вы скачаете Debian-пакет из реестра {{ cloud-registry-full-name }}.
---

# Скачать Debian-пакет из реестра

Инструкция описывает, как установить [Debian-пакет](../../concepts/artifacts/debian.md) из реестра {{ cloud-registry-full-name }} с помощью [менеджера пакетов `APT`](https://ru.wikipedia.org/wiki/APT) (Advanced Package Tool).
