...
Для скачивания [Docker-образа](../../concepts/docker.md) необходима [роль](../../security/index.md#cloud-registry-artifacts-puller) `cloud-registry.artifacts.puller` или выше.
