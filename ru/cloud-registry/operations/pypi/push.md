---
title: Загрузить Python-пакет в реестр {{ cloud-registry-name }}
description: Инструкция описывает, как загрузить локальный Python-пакет в реестр {{ cloud-registry-name }}.
---
...
- uv {#uv}
  ...
  1. Загрузите пакет: 
      ...
      Или создайте файл `uv.toml` в корне проекта:
