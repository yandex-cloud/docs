...
В {{ at-name }} поддерживается отслеживание событий уровня конфигурации (Control Plane) для {{ cloud-registry-full-name }}. Подробнее в [{#T}](../audit-trails/concepts/format.md).
