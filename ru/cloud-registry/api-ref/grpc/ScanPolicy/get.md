...
# Yandex Cloud Registry API, gRPC: ScanPolicyService.Get

Returns the specified scan policy.

## gRPC request

**rpc Get ([GetScanPolicyRequest](#yandex.cloud.cloudregistry.v1.GetScanPolicyRequest)) returns ([ScanPolicy](#yandex.cloud.cloudregistry.v1.ScanPolicy))**

## GetScanPolicyRequest {#yandex.cloud.cloudregistry.v1.GetScanPolicyRequest}
