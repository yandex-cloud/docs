...
editable: false
apiPlayground:
  - url: https://registry.{{ api-host }}/cloud-registry/v1/registries/{resourceId}:setAccessBindings
    method: post
    path:
      type: object
      properties:
...
```
POST https://registry.{{ api-host }}/cloud-registry/v1/registries/{resourceId}:setAccessBindings
```
