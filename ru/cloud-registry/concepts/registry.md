...
В каждом реестре может храниться набор версий пакетов, связанных с определенными ресурсами. Для получения и публикации пакетов воспользуйтесь инструментами [Maven CLI](https://maven.apache.org/ref/3-LATEST/maven-embedder/cli.html), [NPM](nodejs.md#npm-inf) или [NuGet CLI](https://learn.microsoft.com/ru-ru/nuget/reference/nuget-exe-cli-reference).
