...
В этой инструкции вы создадите свой первый [реестр](../concepts/registry.md) и попробуете управлять [Docker-образами](../concepts/docker.md).
...
* [Java-артефакт](../concepts/java.md)
* [Node.js-артефакт](../concepts/nodejs.md)
