...
Стоимость использования хостов БД вычисляется в соответствии с его классом. Точные характеристики классов приведены в разделе [{#T}](concepts/instance-types.md).
