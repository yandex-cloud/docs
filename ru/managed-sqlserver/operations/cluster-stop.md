...
- CLI
    ...
    Чтобы остановить кластер {{ MS }}, выполните команду:

    ```bash
    {{ yc-mdb-ms }} cluster stop <идентификатор или имя кластера>
    ```
...
- CLI
    ...
    Чтобы запустить кластера {{ MS }}, выполните команду:

    ```bash
    {{ yc-mdb-ms }} cluster start <идентификатор или имя кластера>
    ```
