...
Для назначения **роли** пользователю используйте консоль управления или [API](../../glossary/rest-api.md) {{ yandex-cloud }}: назначение роли запросом `GRANT` отменится при следующей операции с базой.
