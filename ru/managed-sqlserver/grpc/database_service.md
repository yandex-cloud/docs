...
Поле | Описание
--- | ---
databases[] | **[Database](../database.proto#Database1)**<br>Список баз данных SQL Server. 
...
database_spec | **[DatabaseSpec](../database.proto#DatabaseSpec)**<br>Обязательное поле. Configuration of the database to create. 
