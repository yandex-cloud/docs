...
> Например, если цена за 1 млн авторитетных запросов в месяц составляет 120 ₸, а за месяц к вашей публичной DNS-зоне было сделано 50 тыс. запросов, то стоимость за месяц составит:
> (50 000 / 1 000 000) × 120 ₸ = 0,05 × 120 ₸ = 6 ₸

> Например, если цена за 1 млн рекурсивных запросов в месяц составляет 120 ₸, а с 6 по 31 декабря 2021 с ваших ВМ было сделано 1,2 млн запросов внешних DNS-имен, стоимость за месяц составит:
