...
- Консоль управления {#console}
  ...
  1. Задайте настройки зоны:
     ...
     1. (Опционально) Добавьте описание и метки.
...
- {{ TF }} {#tf}
  ...
  1. Опишите в конфигурационном файле параметры ресурсов, которые необходимо создать:
     ...
     * `public` — видимость зоны: публичная или внутренняя. Необязательный параметр.
     ...
     Более подробно о параметрах ресурса `yandex_dns_zone` в [документации провайдера]({{ tf-provider-resources-link }}/dns_zone).
