...
Для запроса внешних доменных имен мы рекомендуем использовать кеширующие резолверы, например, unbound, dnsmasq, systemd-resolved. С их помощью можно снизить количество запросов и [расходы](../pricing.md) на использование сервиса.
