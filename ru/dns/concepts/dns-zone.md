...
Запросы к публичным DNS-зонам и запросы внешних DNS-имен с ваших виртуальных машин являются публичными DNS-запросами. Сервис {{ dns-name }} используется для публичных DNS-запросов, даже в том случае, если в вашем облаке нет никаких DNS-зон, кроме сервисных.
