...
Для запроса внешних доменных имен мы рекомендуем использовать [кеширующие резолверы](../tutorials/local-dns-cache.md), например, `systemd-resolved`, `dnsmasq`, `unbound`. С их помощью можно снизить количество запросов и [расходы](../pricing.md) на использование сервиса.
