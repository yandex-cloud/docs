...
Можно создавать зоны и подзоны в разных каталогах. Для этого назначьте пользователю или [сервисному аккаунту](../../iam/concepts/users/service-accounts.md) роль `editor` на каталог, в котором находится родительская зона. Подробнее в разделе [{#T}](../security/index.md).
...
### Зоны с нелатинскими символами {#zone-rf}
...
Можно [делегировать управление обратной зоной](../operations/zone-delegate.md).
