...
При создании TXT-записи {{ dns-name }} автоматически разбивает текстовые блоки длиннее 255 символов на части по 255 символов. Это связано с ограничением формата DNS. Порядок данных сохраняется, все части остаются в одной TXT-записи.
