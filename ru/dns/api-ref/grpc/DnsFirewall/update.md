...
To get the DNS firewall ID, make a [DnsFirewallService.List](/docs/dns/api-ref/grpc/DnsFirewall/list#List) request. ||
...
1. Get the current set of labels with a [DnsFirewallService.Get](/docs/dns/api-ref/grpc/DnsFirewall/get#Get) request.
