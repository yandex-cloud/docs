...
To get the list of all available DNS firewalls, make a [List](/docs/dns/api-ref/grpc/DnsFirewall/list#List) request.
...
To get a DNS firewall ID, make a [DnsFirewallService.List](/docs/dns/api-ref/grpc/DnsFirewall/list#List) request. ||
|#
