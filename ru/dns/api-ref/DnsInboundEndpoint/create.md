...
editable: false
apiPlayground:
  - url: https://dns.{{ api-host }}/dns/v1/inboundEndpoints
    method: post
    path: null
    query: null
    body:
...
```
POST https://dns.{{ api-host }}/dns/v1/inboundEndpoints
```

## Body parameters {#yandex.cloud.dns.v1.CreateDnsInboundEndpointRequest}
