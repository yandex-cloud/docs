...
To get the list of all available DNS inbound endpoints, make a [List](/docs/dns/api-ref/DnsInboundEndpoint/list#List) request.

## HTTP request

```
GET https://dns.{{ api-host }}/dns/v1/inboundEndpoints/{dnsInboundEndpointId}
```
