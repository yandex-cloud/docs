...
editable: false
apiPlayground:
  - url: https://dns.{{ api-host }}/dns/v1/inboundEndpoints/{dnsInboundEndpointId}
    method: patch
    path:
      type: object
      properties:
...
# Cloud DNS API, REST: DnsInboundEndpoint.Update
...
```
PATCH https://dns.{{ api-host }}/dns/v1/inboundEndpoints/{dnsInboundEndpointId}
```
...
## Body parameters {#yandex.cloud.dns.v1.UpdateDnsInboundEndpointRequest}
