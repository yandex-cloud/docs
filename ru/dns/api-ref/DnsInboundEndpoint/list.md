...
```
GET https://dns.{{ api-host }}/dns/v1/inboundEndpoints
```

## Query parameters {#yandex.cloud.dns.v1.ListDnsInboundEndpointsRequest}
...
## Response {#yandex.cloud.dns.v1.ListDnsInboundEndpointsResponse}
