...
--- | ---
dnsZoneId | <p>ID of the DNS zone which private networks will be updated</p> 
...
Field | Description
--- | ---
privateNetworkIdAdditions[] | **string**<br><p>Network IDs to remove</p> 
privateNetworkIdDeletions[] | **string**<br><p>Network IDs to add</p> 
