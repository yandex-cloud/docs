...
To get the list of all available DNS firewalls, make a [List](/docs/dns/api-ref/DnsFirewall/list#List) request.

## HTTP request

```
GET https://dns.{{ api-host }}/dns/v1/firewalls/{dnsFirewallId}
```
