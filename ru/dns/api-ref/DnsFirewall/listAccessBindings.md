...
editable: false
apiPlayground:
  - url: https://dns.{{ api-host }}/dns/v1/firewalls/{resourceId}:listAccessBindings
    method: get
    path:
      type: object
      properties:
...
# Cloud DNS API, REST: DnsFirewall.ListAccessBindings
...
```
GET https://dns.{{ api-host }}/dns/v1/firewalls/{resourceId}:listAccessBindings
```
