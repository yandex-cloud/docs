...
Подробнее о [квотах и лимитах в {{ mspqr-name }}](../../managed-spqr/concepts/limits.md).
...
Если вам нужно выполнять JOIN между шардами, рекомендуем использовать [{{ mgp-full-name }}](../../managed-greenplum/).
