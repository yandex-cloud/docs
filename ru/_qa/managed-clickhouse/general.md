...
{{ CH }} предназначен прежде всего для {% if lang == "ru" and audience != "internal" %}[аналитики](../../glossary/data-analytics.md){% else %}аналитики{% endif %} (OLAP) и поддерживает только добавление и чтение данных. Обновление данных возможно, но с [рядом оговорок](https://stackoverflow.com/questions/37901642/updating-data-in-clickhouse). Для других целей, скорее всего, удобнее использовать другие СУБД.
