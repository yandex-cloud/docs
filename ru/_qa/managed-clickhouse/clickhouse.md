...
* обеспечение [высокой доступности](../../managed-clickhouse/concepts/high-availability.md) кластеров БД;
...
Кластеры {{ mch-short-name }} используют репликацию с помощью {{ CK }} или {{ ZK }}. В обоих случаях для обеспечения репликации и [высокой доступности](../../managed-clickhouse/concepts/high-availability.md) в кластере создается минимум три хоста {{ CK }} или {{ ZK }}.
