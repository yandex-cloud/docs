...
Чтобы назначить права доступа всем вашим пользователям, используйте группу **Все**. {% if audience != "internal" %} Для федеративных пользователей вы можете предоставить доступ только на группу **Все**. {% endif %}
