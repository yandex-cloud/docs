...
Вы можете воспользоваться [геокодером](https://yandex.ru/dev/maps/geocoder) через API Яндекс Карт. Обратите внимание на [условия лицензирования](https://yandex.ru/dev/tariffs/doc/ru/geocoder/terms/) API.
