...
- [Класс хостов](../../storedoc/concepts/instance-types.md) (характеристики производительности — процессоры, память и т. п.).
- [Тип диска](../../storedoc/concepts/storage.md) и его объем (резервируется в полном объеме при создании кластера).
- Сеть, к которой будет подключен ваш кластер.
- Количество хостов для кластера и зона доступности для каждого из них.

Подробные инструкции см. в разделе [{#T}](../../storedoc/quickstart.md).


#### Сколько хостов БД может содержать кластер? {#how-many-hosts}

Минимальное количество хостов в кластере зависит от:
* выбранных [платформы и класса хостов](../../storedoc/concepts/instance-types.md);
* выбранного [типа диска](../../storedoc/concepts/storage.md).
...
Подробнее см. в разделе [Квоты и лимиты](../../storedoc/concepts/limits.md).
...
[Подробнее о подключении к кластерам](../../storedoc/operations/connect/index.md).


#### Сколько кластеров можно создать в рамках одного облака? {#db-limit}

Технические и организационные ограничения MDB приведены в разделе [Квоты и лимиты](../../storedoc/concepts/limits.md).
...
Подробнее см. в разделе [Техническое обслуживание](../../storedoc/concepts/maintenance.md).
...
При [создании](../../storedoc/operations/cluster-create.md) или [изменении](../../storedoc/operations/update.md#change-additional-settings) кластера можно задать срок хранения автоматических резервных копий.
...
[Создайте алерт](../../storedoc/operations/monitoring.md#monitoring-integration) с метрикой `disk.used_bytes` в сервисе {{ monitoring-full-name }}. Метрика показывает размер использованного дискового пространства в кластере {{ mmg-name }}.
