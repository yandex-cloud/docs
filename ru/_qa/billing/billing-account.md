...
Если ваш платежный аккаунт заблокирован из-за подозрительной активности, вам необходимо сделать верификационный платеж. [Пополните лицевой счет](../../billing/operations/pay-the-bill.md) на минимальную требуемую сумму в зависимости от валюты, в которой вы оплачиваете ресурсы {{ yandex-cloud }}.

Средства можно будет использовать для продолжения работы ваших облачных ресурсов после окончания срока действия [стартового гранта](../../billing/concepts/bonus-account.md#start). После активации аккаунта стартовый грант будет [расходоваться в приоритете перед средствами на лицевом счете](../../billing/payment/index.md), пока средства гранта не закончатся или не истечет срок его действия.

Оформить возврат положительного остатка в полном или частичном размере можно по запросу в [техническую поддержку]({{ link-console-support }}), указав желаемую сумму возврата.
...
Ошибка `PROHIBITED_BILLING_ACCOUNT_USAGE_STATUS` возникает, если вы пытаетесь перепривязать облако или сервис с платежного аккаунта на платном потреблении к аккаунту в пробном периоде. [Перейдите на платную версию](../../getting-started/free-trial/concepts/upgrade-to-paid.md) в целевом платежном аккаунте и повторите привязку.
