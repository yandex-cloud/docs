...
1. У вас нет [прав на работу с этим облаком](../../billing/operations/pin-cloud.md#bind-roles). Обратитесь к администратору вашей организации для [назначения необходимых ролей](../../billing/security/index.md#set-role). 
1. Ваш платежный аккаунт принадлежит одной [организации](../../billing/concepts/organization.md), а вы пытаетесь привязать облако из другой организации. 
