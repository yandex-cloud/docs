...
Обратитесь в [техническую поддержку]{% if lang == "ru" %}(https://console.cloud.yandex.ru/support?section=contact){% endif %}{% if lang == "en" %}(https://console.cloud.yandex.com/support?section=contact){% endif %}. С вами свяжется менеджер {{ yandex-cloud }} для обсуждения условий подписания. Подготовка документа займет примерно две недели: представитель компании подпишет его, и мы оформим почтовую отправку.