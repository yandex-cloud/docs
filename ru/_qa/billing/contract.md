...
Юридические лица могут заключить договор с двусторонним подписанием. Для этого необходимо отправить заявку через [форму](/#contact-form). С вами свяжется менеджер {{ yandex-cloud }} для обсуждения условий подписания. На это понадобится около двух недель.
...
Отправьте заявку через [форму](/#contact-form). С вами свяжется менеджер {{ yandex-cloud }} для обсуждения условий подписания. На это понадобится около двух недель.