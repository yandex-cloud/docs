...
Подробнее в разделе [Оплата ресурсов](../../billing/payment/index.md).
...
Подробнее в разделе [Пополнить лицевой счет](../../billing/operations/pay-the-bill.md).
...
Подробнее в разделе [Тарификация](../../billing/pricing.md).
...
#### Что делать, если задолженность погашена, но ничего не работает? {#paid-not-worked}

После внесения платежа убедитесь, что:

1. Платеж поступил на лицевой счет — проверьте [историю платежей](../../billing/operations/check-bill-history.md). 
   
   {% note info %}

   Оплата с карты или через СБП поступает на счет [в течение 15 минут](../../billing/operations/pay-the-bill.md#individuals). Сроки поступления оплаты со счета юридического лица [зависят от банка, проводящего платеж](../../billing/payment/payment-methods-business.md#limits).

   {% endnote %}

1. Платежный аккаунт [находится в статусе](../../billing/concepts/billing-account-statuses.md#list) `ACTIVE`.

1. [Ресурсы сервисов {{ yandex-cloud }}](../../resource-manager/concepts/resources-hierarchy.md) активны. 
   Когда платежный аккаунт переходит в статус `SUSPENDED` из-за задолженности, ресурсы автоматически останавливаются. После внесения оплаты и активации платежного аккаунта нужно вручную включить ресурсы. 
...
Специальных способов оплаты для самозанятых не существует. Способы оплаты для физических и юридических лиц описаны в разделе [{#T}](../../billing/payment/index.md)
