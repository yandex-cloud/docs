...
Подробную информацию см. в разделе [Пополнить лицевой счет](../../billing/operations/pay-the-bill.md).
...
Подробную информацию см. в разделе в разделе [Тарификация](../../billing/pricing.md).
