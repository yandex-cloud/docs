...
- [Класс хостов](../../managed-sqlserver/concepts/instance-types.md) (характеристики производительности — процессоры, память и т. п.).
...
Подробные инструкции см. в разделе [{#T}](../../managed-sqlserver/quickstart.md).

#### Сколько хостов БД может содержать кластер? {#how-many-hosts}

Минимальное количество хостов зависит от типа используемого [хранилища](../../managed-sqlserver/concepts/storage.md):
...
Подробнее см. в разделе [{#T}](../../managed-sqlserver/concepts/limits.md).
...
[Подробнее о подключении к кластерам](../../managed-sqlserver/operations/connect.md).


#### Сколько кластеров можно создать в рамках одного облака? {#db-limit}

Технические и организационные ограничения MDB приведены в разделе [{#T}](../../managed-sqlserver/concepts/limits.md).
...
Подробнее в разделе [{#T}](../../managed-sqlserver/concepts/maintenance.md).
...
- Объем резервных копий кластера БД. Объем резервных копий, равный объему хранилища, не тарифицируется. Хранение резервных копий сверх этого объема оплачивается по [тарифам](../../managed-sqlserver/pricing/index.md).
- Количество часов работы хоста БД. Неполные часы округляются до целого значения. Стоимость часа работы для каждого класса хостов приведена в разделе [{#T}](../../managed-sqlserver/pricing/index.md).
...
Существуют ограничения на управление кластером с помощью команд SQL. Подробнее см. в разделе [{#T}](../../managed-sqlserver/concepts/sql-limits.md).
