...
* `ERROR:  role "<имя пользователя источника>" does not exist`
* `ERROR:  must be member of role "<имя пользователя источника>"`
...
2. [Восстанавливайте логической дамп](../../managed-postgresql/tutorials/data-migration.md#restore) с помощью этого пользователя или [выдайте его привилегии](../../managed-postgresql/operations/grant.md#grant-privilege) пользователю, с помощью которого вы восстанавливаете логической дамп.
