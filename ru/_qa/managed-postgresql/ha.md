...
Дополнительные сведения в разделе [Высокая доступность](../../managed-postgresql/concepts/high-availability.md).
...
* во время операций [изменения кластера](../../managed-postgresql/operations/update.md);
* при выходе текущего хоста-мастера из строя;
* при восстановлении работоспособности кластера;
* при [техническом обслуживании](../../managed-postgresql/concepts/high-availability.md#maintenance-settings) кластера.
