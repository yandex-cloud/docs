...
Подробные инструкции читайте в разделе [{#T}](../../managed-postgresql/quickstart.md).
...
Подробнее в разделе [{#T}](../../managed-postgresql/concepts/limits.md).
...
[Подробнее о подключении к кластерам](../../managed-postgresql/operations/connect/index.md).
...
{{ mpg-short-name }} поддерживает {{ PG }} 14, 15, 16, 17, 18 и 19, а также {{ PG }} 14, 15, 16, 17, 18 и 19 для 1C. В консоли управления по умолчанию используется версия 17.
...
Подробнее об ограничениях {{ mpg-short-name }} смотрите раздел [{#T}](../../managed-postgresql/concepts/limits.md). В разделе [{#T}](../../managed-postgresql/concepts/instance-types.md) приведены характеристики кластеров, которые можно создать с помощью {{ mpg-short-name }}.
...
Нет, права суперпользователя недоступны пользователям {{ mpg-name }}. Все виды действий с кластером доступны пользователям с ролью [mdb_admin](../../managed-postgresql/concepts/roles.md#mdb-admin).
...
Да, вы можете как скопировать данные из таблицы в локальный файл, так и заполнить таблицу данными из локального файла. Подробнее в разделе [{#T}](../../managed-postgresql/operations/copy-write-data.md).
