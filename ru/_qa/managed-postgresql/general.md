...
{{ mpg-short-name }} поддерживает {{ PG }} 11, 12, 13, 14, 15 и 16, а также {{ PG }} 11, 12, 13, 14 и 15 для 1C.
...
Да, для этого [назначьте](../../managed-postgresql/operations/grant.md#grant-role) пользователю [роль](../../managed-postgresql/concepts/roles.md#mdb-superuser) `mdb_superuser`.
