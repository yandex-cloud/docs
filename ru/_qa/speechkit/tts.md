...
Чтобы поставить паузу в тексте, используйте [TTS-разметку](../../speechkit/tts/markup/tts-markup#markup-elements). В скобках укажите длительность паузы в миллисекундах. Пауза появится в тех местах, где вы поставите тег. Например: `Начало sil<[3000]> продолжение через 3 секунды`. Максимальное значение — 7 000.
