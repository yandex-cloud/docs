...
Назначьте сервисному аккаунту [роль](../security/) `editor` или выше на каталог, в котором он был создан.
...
1. Вы можете свободно использовать [демо-стенд]{% if lang == "ru" %}(https://cloud.yandex.ru/services/speechkit#demo){% endif %}{% if lang == "en" %}https://cloud.yandex.com/services/speechkit#demo){% endif %}. Обратите внимание, что он имеет ряд ограничений.
