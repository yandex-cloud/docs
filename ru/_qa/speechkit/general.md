...
Назначьте сервисному аккаунту [роль](../../{{ speechkit-slug }}/security/) `editor` или выше на каталог, в котором он был создан.
...
Воспользуйтесь инструкцией: [Перед началом работы](../../{{ speechkit-slug }}/quickstart/index.md#before-you-begin).
