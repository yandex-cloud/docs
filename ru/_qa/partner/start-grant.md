...
Стартовый грант выдается только при создании первого и основного биллинг-аккаунта клиента. На саб-аккаунт стартовый грант не выдается. При необходимости используйте [{#T}](../../partner/qa/additional-grants.md). 
