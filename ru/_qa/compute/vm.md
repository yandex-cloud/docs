...
Вы можете перенести существующую виртуальную машину в другую [зону доступности](../../overview/concepts/geo-scope.md). Также вы можете создать копию вашей ВМ в другой зоне доступности. Подробнее читайте в разделе [{#T}](../../compute/operations/vm-control/vm-change-zone.md).
