...
Если вам не хватает возможности скачивать или выгружать вручную образы ВМ и снимки дисков на внешние ресурсы или локальное устройство, [предложите](https://cloud.yandex.ru/features) эту идею или проголосуйте за похожую. Мы регулярно просматриваем все предложения и добавляем их в планы по разработке. Вы получите письмо, когда будет реализована идея, которую вы добавили или за которую проголосовали.
