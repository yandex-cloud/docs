...
Подробные инструкции см. в разделе [Начало работы](../../managed-mysql/quickstart.md).
...
Подробнее см. в разделе [Квоты и лимиты](../../managed-mysql/concepts/limits.md).
...
[Подробнее о подключении к кластерам](../../managed-mysql/operations/connect/index.md).


#### Сколько кластеров можно создать в рамках одного облака? {#db-limit}

Технические и организационные ограничения MDB приведены в разделе [Квоты и лимиты](../../managed-mysql/concepts/limits.md).
...
Подробнее см. в разделе [Техническое обслуживание](../../managed-mysql/concepts/maintenance.md).
...
При [создании](../../managed-mysql/operations/cluster-create.md) или [изменении](../../managed-mysql/operations/update.md#change-additional-settings) кластера можно задать срок хранения автоматических резервных копий.
