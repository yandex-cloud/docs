...
Существуют ограничения на управление кластером с помощью команд SQL. Подробнее в разделе [{#T}](../../managed-mysql/concepts/sql-limits.md).
...
**Решение:** дождитесь создания автоматической резервной копии или [создайте резервную копию вручную](../../managed-mysql/operations/cluster-backups.md#create-backup).
