...
Подробнее об ограничениях {{ mmy-short-name }} смотрите раздел [Квоты и лимиты](../../managed-mysql/concepts/limits.md). В разделе [Классы хостов](../../managed-mysql/concepts/instance-types.md) приведены характеристики кластеров, которые можно создать с помощью {{ mmy-short-name }}.
