...
Вы можете подключаться к базам данных {{ GP }} способами, стандартными для СУБД.

[Подробнее о подключении к кластерам](../../managed-greenplum/operations/connect/index.md).
