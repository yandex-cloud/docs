...
Подробнее читайте в разделе [Квоты и лимиты](../../managed-greenplum/concepts/limits.md).
...
Подробнее читайте в разделе [Техническое обслуживание](../../managed-greenplum/concepts/maintenance.md).
...
Ошибка возникает, если при количестве соединений, достигающем значения настройки [max_connections](../../managed-greenplum/concepts/settings-list.md#setting-max-connections), объем памяти на каждый процесс {{ mgp-name }} составляет меньше 20 МБ. Минимальный объем памяти на каждый процесс кластера рассчитывается по формуле:
...
Подробнее в разделе [{#T}](../../managed-greenplum/concepts/hybrid-storage.md#storage-vacuum).
