...
Кластер {{ GP }} состоит минимум из 4 хостов:
...
Ошибка возникает, если при количестве соединений, достигающем значения настройки [max_connections](../../managed-greenplum/concepts/settings-list.md#setting-max-connections), объем памяти на каждый процесс {{ GP }} составляет меньше 20 МБ. Минимальный объем памяти на каждый процесс кластера рассчитывается по формуле:
