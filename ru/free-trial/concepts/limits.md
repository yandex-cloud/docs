---
title: Free Trial. Ограничения пробного периода
description: Пробный период предназначен для тестирования и исследования возможностей облачной инфраструктуры. В рамках пробного периода вы можете использовать ресурсы {{ yandex-cloud }} с некоторыми ограничениями.
editable: false
---
...
Во время пробного периода недоступны следующие продукты:
