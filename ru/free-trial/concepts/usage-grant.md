...
* _Первая часть_ — 1000 ₽ от общего размера гранта. Может использоваться для оплаты услуг сервиса [{{ compute-full-name }}](https://cloud.yandex.ru/services/compute) (включая образы виртуальных машин).
