...
Переход на платную версию не происходит автоматически после завершения пробного периода. Чтобы перейти на платную версию, в сервисе [{{ billing-name }}]({{ link-console-billing }}) нажмите кнопку **Перейти на платную версию**.
