...
2 декабря 2024 года была отключена возможность создания кластеров с версией {{ MG }} 5.0 в связи с [прекращением поддержки](https://www.mongodb.com/support-policy) этой версии разработчиком. Начиная с 3 февраля 2025 года существующие кластеры с этой версией {{ MG }} будут [автоматически обновлены](qa/general.md#dbms-deprecated) до версии 6.0.
