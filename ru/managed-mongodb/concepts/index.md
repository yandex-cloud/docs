...
* Кластер из нескольких хостов автоматически отказоустойчив — хосты могут заменять друг друга в качестве [первичной реплики](replication.md).

* Кластер из одного хоста обходится дешевле, но отказоустойчивости не обеспечивает.
