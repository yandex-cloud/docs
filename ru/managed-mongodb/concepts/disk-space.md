...
- [Принудительно синхронизировть](../operations/hosts.md#resetup) данные между репликами. Это может помочь в тех случаях, когда из кластера был удален большой объем данных, но дисковое пространство не было освобождено (было помечено как доступное к переиспользованию).
