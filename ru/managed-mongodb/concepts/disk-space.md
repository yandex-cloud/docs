...
* [Увеличить объем хранилища на хосте](../operations/update.md#change-disk-size), чтобы выйти за пороговое значение. {{ yandex-cloud }} в таком случае снимет режим read-only автоматически.
