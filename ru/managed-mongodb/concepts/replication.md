...
Если хост-мастер выйдет из строя, то {{ MG }} автоматически выберет новый хост-мастер из доступных хостов.

Повлиять на выбор мастера в кластере {{ MG }} можно с помощью [настройки приоритетов](../operations/hosts.md#update) для хостов кластера. Новым мастером станет хост с наибольшим приоритетом.
