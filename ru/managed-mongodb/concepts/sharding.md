...
Шардирование в Managed Service for MongoDB доступно для кластеров с версией MongoDB не ниже 4.0.
...
Более подробно шардирование баз MongoDB рассмотрено в [документации MongoDB](https://docs.mongodb.com/v4.0/sharding/#sharded-cluster).
