...
#### Что такое Managed Service for MongoDB? {#what-is}
...
#### Какую часть работы по управлению и сопровождению баз данных берет на себя Managed Service for MongoDB? {#services}
...
#### Для каких задач стоит использовать Managed Service for MongoDB, а для каких виртуальные машины с базами данных? {#mdb-advantage}
...
#### Как начать работу с Managed Service for MongoDB? {#quickstart}

Managed Service for MongoDB доступен всем зарегистрированным пользователям Яндекс.Облака.
...
Для хранилища на NVMe-дисках количество хостов ограничено при создании: для MongoDB-кластеров можно создать не меньше 3 хостов.
...
#### Какую версию MongoDB использует Managed Service for MongoDB? {#dbms-version}

Managed Service for MongoDB поддерживает MongoDB версий 3.6 и 4.0.
