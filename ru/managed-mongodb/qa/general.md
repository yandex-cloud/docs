...
Для хранилища на NVMe-дисках количество хостов ограничено при создании: для [!KEYREF MG]-кластеров можно создать не меньше 3 хостов.
...
#### Какую версию [!KEYREF MG] использует [!KEYREF mmg-short-name]? {#dbms-version}

[!KEYREF mmg-short-name] поддерживает [!KEYREF MG] версий 3.6 и 4.0.
