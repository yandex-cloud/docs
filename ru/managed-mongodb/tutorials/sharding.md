...
1. Перейдите на страницу нужного кластера Managed Service for MongoDB в [консоли управления](https://console.cloud.yandex.ru/).
...
1. Создайте необходимое количество шардов в [консоли управления](https://console.cloud.yandex.ru/).
