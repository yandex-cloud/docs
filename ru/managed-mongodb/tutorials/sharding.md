...
Шардирование кластера {{ mmg-name }} происходит с автоматическим созданием служебных хостов, которые [тарифицируются](../pricing.md) отдельно от основных хостов СУБД:
