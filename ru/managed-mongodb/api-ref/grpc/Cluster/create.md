---
editable: false
sourcePath: en/_api-ref-grpc/mdb/mongodb/v1/api-ref/grpc/Cluster/create.md
---

# Managed Service for MongoDB API, gRPC: ClusterService.Create {#Create}
...
|| metadata | **[CreateClusterMetadata](#yandex.cloud.mdb.mongodb.v1.CreateClusterMetadata)**
...
## CreateClusterMetadata {#yandex.cloud.mdb.mongodb.v1.CreateClusterMetadata}
