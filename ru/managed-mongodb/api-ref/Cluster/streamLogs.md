---
editable: false
sourcePath: en/_api-ref/mdb/mongodb/api-ref/Cluster/streamLogs.md
---
...
```
GET https://mdb.{{ api-host }}/managed-mongodb/v1/clusters/{clusterId}:stream_logs
```
