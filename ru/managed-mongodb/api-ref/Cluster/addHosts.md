...
```
POST https://mdb.api.cloud.yandex.net/managed-mongodb/v1/clusters/{clusterId}/hosts:batchCreate
```
...
--- | ---
clusterId | Required. ID of the MongoDB cluster to add hosts to. To get the MongoDB cluster ID use a [list](/docs/managed-mongodb/api-ref/Cluster/list) request.  The maximum string length in characters is 50.
