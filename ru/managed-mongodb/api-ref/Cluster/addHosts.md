---
editable: false
sourcePath: en/_api-ref/mdb/mongodb/api-ref/Cluster/addHosts.md
---
...
```
POST https://mdb.{{ api-host }}/managed-mongodb/v1/clusters/{clusterId}/hosts:batchCreate
```
...
--- | ---
clusterId | <p>Required. ID of the MongoDB cluster to add hosts to. To get the MongoDB cluster ID use a <a href="/docs/managed-mongodb/api-ref/Cluster/list">list</a> request.</p> <p>The maximum string length in characters is 50.</p> 
...
Field | Description
--- | ---
hostSpecs[] | **object**<br><p>Required. Configurations for MongoDB hosts that should be added to the cluster.</p> <p>Must contain at least one element.</p> 
