...
- API
  ...
  Чтобы посмотреть логи, воспользуйтесь методом API [listLogs](../api-ref/Cluster/listLogs.md): передайте значение идентификатора требуемого кластера в параметре `clusterId` запроса.
