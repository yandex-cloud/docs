...
Количество хостов в кластерах [!KEYREF mmg-short-name] ограничено квотами на количество CPU и объем памяти, которые доступны кластерам БД в вашем облаке. Чтобы проверить используемые ресурсы, откройте страницу [Квоты](https://{{console-link}}/?section=quotas) и найдите блок **[!KEYREF mmg-full-name]**.
