---
title: "Как подключиться к шардированному кластеру {{ MG }}"
description: "Из статьи вы узнаете, как подключиться к шардированному кластеру {{ MG }}."
---

# Подключение к шардированному кластеру {{ MG }}
