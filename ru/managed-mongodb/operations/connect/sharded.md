---
title: "Как подключиться к шардированному {{ MG }}-кластеру"
description: "Из статьи вы узнаете, подключиться к шардированному {{ MG }}-кластеру."
---

# Подключение к шардированному {{ MG }}-кластеру
