...
В апреле 2021 г. кластеры с версией {{ MG }} 3.6 будут [принудительно обновлены](../qa/general.md#dbms-deprecated) до версии 4.0 в связи с [прекращением поддержки](https://www.mongodb.com/support-policy) этой версии разработчиком. Рекомендуем заранее перейти на использование актуальных версий {{ MG }}.
...
1. Посмотрите историю изменений для версий [4.0](https://docs.mongodb.com/v4.0/release-notes/4.0/), [4.2](https://docs.mongodb.com/v4.2/release-notes/4.2/) или [4.4](https://docs.mongodb.com/v4.4/release-notes/4.4/) {{ MG }} и проверьте, не повлияют ли какие-то изменения на работу приложений.
