...
1. Посмотрите историю изменений для версий [4.0](https://docs.mongodb.com/v4.0/release-notes/4.0/) или [4.2](https://docs.mongodb.com/v4.2/release-notes/) {{ MG }} и проверьте, не повлияют ли какие-то изменения на работу приложений.
