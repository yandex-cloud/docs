...
В {{ marketplace-short-name }} можно размещать образы ВМ из публичных образов {{ yandex-cloud }} и пакеты для {{ managed-k8s-name }}.  Требования к образам и пакетам и рекомендации по их созданию описаны в разделах:
