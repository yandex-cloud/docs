...
Поле | Описание
--- | ---
name | **string**<br><p>Имя задачи.</p> <p>Значение должно соответствовать регулярному выражению <code>\|[a-z][-a-z0-9]{1,61}[a-z0-9]</code>.</p> 
...
sparkJob.<br>mainJarFileUri | **string**<br><p>URI HCFS JAR-файла, содержащего класс <code>main</code> для задачи.</p> 
