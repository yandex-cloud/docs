...
name | **string**<br><p>Новое имя подкластера. Имя должно быть уникальным в пределах кластера.</p> <p>Значение должно соответствовать регулярному выражению <code>\|[a-z][-a-z0-9]{1,61}[a-z0-9]</code>.</p> 
