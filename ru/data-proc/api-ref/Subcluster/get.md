...
--- | ---
clusterId | <p>Required. ID of the Data Proc cluster that the subcluster belongs to.</p> <p>The maximum string length in characters is 50.</p> 
subclusterId | <p>Required. ID of the subcluster to return.</p> <p>To get a subcluster ID make a <a href="/docs/data-proc/api-ref/Subcluster/list">list</a> request.</p> <p>The maximum string length in characters is 50.</p> 
