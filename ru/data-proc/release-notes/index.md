...
* Lightweight Spark стал доступен начиная с версии образа 2.0.39. Теперь можно создавать кластер без хостов типа `DATANODE`, так как сервисы YARN и SPARK больше не зависят от HDFS.
