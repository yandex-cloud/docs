...
* Добавлена библиотека PyYAML.
* Добавлены дополнительные метрики по `cpu/mem/diskio/net/processes/kernel` (по умолчанию собираются с мастера, можно включить для всех хостов, добавив свойство `monitoring:all_nodes = True`).
...
### 2.2.2—2.2.4 (бета) {#2-2-2}

* Внутренние изменения и исправления ошибок.

### 2.2.0—2.2.1 (бета) {#2-2-0}
