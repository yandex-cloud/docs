...
1. {% include [Создать бакеты и выдать SA права на них](../../_includes/data-proc/solutions/basic-before-buckets.md) %}
...
1. {% include [Скачать и загрузить файл с текстовыми данными](../../_includes/data-proc/solutions/sample-txt.md) %}

1. Скачайте и загрузите в бакет для исходных данных [jar-файл](https://storage.yandexcloud.net/examples/scala-spark/jar/spark-app_2.11-0.1.0-SNAPSHOT.jar), собранный из исходного текста программы анализа [word_count.scala](https://storage.yandexcloud.net/examples/scala-spark/word_count.scala) на языке Scala:
