...
1. {% include [Создать бакеты и выдать SA кластера права на них](../../_includes/data-proc/solutions/basic-before-buckets.md) %}
...
{% include [Удаление кластера, бакетов и сервисного аккаунта](../../_includes/data-proc/solutions/basic-clear-out.md) %}
