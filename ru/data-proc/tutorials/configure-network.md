...
* Вы можете контролировать весь исходящий трафик, и при необходимости развернуть не только NAT, но и [VPN между подсетью {{ yandex-cloud }} и нужными ресурсами](../../tutorials/routing/ipsec-vpn.md).
