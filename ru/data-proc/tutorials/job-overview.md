---
title: Руководства по работе с заданиями в {{ dataproc-full-name }}
description: На странице представлен список руководств по работе с заданиями в {{ dataproc-name }}.
---
