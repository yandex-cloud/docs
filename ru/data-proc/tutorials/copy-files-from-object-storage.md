...
Способ записи данных в бакет {{ objstorage-name }} определяется настройкой `core:fs.s3a.fast.upload`. Во всех версиях образов {{ dataproc-name }} она включена по умолчанию.
