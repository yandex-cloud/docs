...
* **{{ ui-key.yacloud.compute.groups.create.field_default-utilization-target }}** — масштабирование на основе метрики `yarn.cluster.containersPending`.
    ...
    Это внутренняя метрика YARN, которая показывает, сколько единиц аллокации ресурсов ожидают поставленные в очередь задания. Она подойдет, если в кластере есть много заданий, которые управляются Apache Hadoop® YARN. Такой способ масштабирования не требует дополнительной настройки.
