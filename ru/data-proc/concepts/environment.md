...
При создании кластера {{ dataproc-name }} вы можете выбрать версию образа (набор версий Hadoop и дополнительных компонентов). 

Ниже приведен состав [актуальных](#current-images) и [устаревших](#deprecated-images) образов {{ dataproc-name }}. В каждую версию образа входят [Conda](https://docs.conda.io/en/latest/) (менеджер Python-окружений) и набор инструментов машинного обучения.
