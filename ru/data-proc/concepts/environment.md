...
{{ dataproc-name }} не поддерживает автоматическое обновление ОС и ПО. Чтобы обеспечить стабильную и безопасную работу кластера, регулярно проверяйте и устанавливайте обновления в ручном режиме.
