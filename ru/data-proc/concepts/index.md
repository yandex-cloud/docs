...
Зона `{{ region-id }}-c` [выводится из эксплуатации](/blog/posts/2023/08/new-availability-zone). Если ваш кластер находится в этой зоне, создайте новый кластер и перенесите в него рабочую нагрузку.
