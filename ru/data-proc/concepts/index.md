...
* На _выделенных хостах_ {{ yandex-cloud }}.
    ...
    Подробнее о выделенных хостах в [документации {{ compute-full-name }}](../../compute/concepts/dedicated-host.md).


Подробнее о сетевой конфигурации и сетевом доступе к кластеру в разделе [{#T}](network.md).
