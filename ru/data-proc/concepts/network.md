...
На стадии Preview вы не можете назначить хосту кластера публичный IP-адрес. Чтобы подключиться к кластеру {{ dataproc-name }}, создайте виртуальную машину в той же облачной сети. [Подробнее о работе сети в Облаке](../../vpc/).
