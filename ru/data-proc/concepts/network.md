...
У хоста главного подкластера может быть задан публичный IP-адрес — в таком случае подключиться к кластеру можно через интернет. Подключение к хостам других подкластеров {{ dataproc-name }} производится только с виртуальных машин {{ yandex-cloud }}, расположенных в той же [облачной сети](../../vpc/concepts/network.md), что и кластер.
