...
У хостов кластера не может быть публичного IP-адреса. Подключиться к кластеру {{ dataproc-name }} можно только с виртуальных машин Яндекс.Облака, расположенных в той же [облачной сети](../../vpc/concepts/network.md), что и кластер.
