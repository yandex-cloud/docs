...
Синтез {{ speechkit-name }} имеет два API — [API v1](request.md) (REST) и [API v3](../tts-v3/api-ref/grpc/) (gRPC). На основе API v3 также реализован [Python SDK {{ speechkit-name }}](../sdk/python/index.md).
