...
Поддержка TTS-разметки доступна для русского языка{% if product == "yandex-cloud" %} при использовании [API v3](../tts-v3/api-ref/grpc/) и [API v1](request.md) для данных в формате `text`{% endif %}.
