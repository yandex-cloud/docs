...
Пример показывает, как с помощью [API v1](../request.md) синтезировать речь из текста, размеченного по правилам [SSML](../markup/ssml.md), в файл формата [OggOpus](../../formats.md).
