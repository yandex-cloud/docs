...
Считывание текстового файла выполняется с помощью утилиты [cat]{% if lang == "ru" %}(https://ru.wikipedia.org/wiki/Cat){% endif %}{% if lang == "en" %}(https://en.wikipedia.org/wiki/Cat_(Unix)){% endif %}.
