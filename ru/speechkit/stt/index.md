...
| Параметр | [Потоковое распознавание](streaming.md) | [Синхронное распознавание](request.md) | [Асинхронное распознавание](transcribation.md) |
|---|---|---|---|
...
| Поддерживаемые API | gRPC v1 </br> gRPC v3 | REST v1 | REST v1 |
...
Также на точность распознавания влияют параметры:
