...
* `alternatives[]` - список вариантов распознанного текста. Каждый вариант содержит поля:
    * `words[]` - список распознанных слов.
      ...
      * `condfidence` - достоверность определения. Это поле сейчас не поддерживается и всегда возвращает значение `1`.
    ...
    * `confidence` - достоверность определения. Это поле сейчас не поддерживается и всегда возвращает значение `1`.
