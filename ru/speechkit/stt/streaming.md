...
В каждом запросе приложение должно передавать [идентификатор каталога](../../resource-manager/operations/folder/get-id.md), на который у вас есть роль `editor` или выше. Подробнее о необходимых разрешениях см. в разделе [{#T}](../security/index.md).
