# Пример потокового распознавания речи c автоматическим определением языка

Пример показывает, как с помощью {{ speechkit-short-name }} [API v3](../../new-v3/api-ref/grpc/) в режиме реального времени распознать речь в формате LPCM с автоматическим определением языка (языков).
...
* [Справочник API v3](../../new-v3/api-ref/grpc/)
* [{#T}](../../concepts/auth.md)