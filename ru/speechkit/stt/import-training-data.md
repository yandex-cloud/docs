...
1. В одну ячейку ноутбука вставьте и запустите функцию проверки данных, в другой — вызовите функцию для ваших данных. Если проверка пройдет успешно, функция сформирует архив для загрузки в {{ speechkit-name }}.
