...
Добавлены новые [голоса](tts/voices.md). Для синтеза на казахском языке доступен женский голос `zhanar`. Для синтеза на узбекском языке добавлены женский голос `lola` и мужской `yulduz`.
