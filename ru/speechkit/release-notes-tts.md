...
1. В тестовом режиме для всех языков добавлена поддержка [пауз](tts/tts-markup.md#pause) при использовании TTS-разметки. Обо всех возникающих ошибках, связанных с расстановкой пауз, сообщайте команде через обращение в техническую поддержку. Ваши отзывы помогут улучшить работу в следующих релизах.
