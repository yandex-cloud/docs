...
* Частота дискретизации:
  ...
  * для API v1 [синтеза](tts/index.md) и API v2 [распознавания](stt/index.md) — 8, 16 или 48 кГц;
  * для API v3 [синтеза](tts-v3/api-ref/grpc/index.md) и [распознавания](stt-v3/api-ref/grpc/index.md) — в диапазоне 8–48 кГц.
