...
Используйте [демо-стенд сервиса]{% if lang == "ru" %}(https://cloud.yandex.ru/services/speechkit#demo){% endif %}{% if lang == "en" %}(https://cloud.yandex.com/en-ru/services/speechkit#demo){% endif %}.

#### Как настроить {{ speechkit-name }}?

Для настройки {{ speechkit-name }} вам понадобится [документация](../quickstart.md) и специалист с навыками программирования. {% if lang == "ru" %}Так же вы можете обратиться к нашим [партнерам-интеграторам](https://cloud.yandex.ru/partners/catalogue).{% endif %}
