...
Тарифицируется только [распознавание коротких аудиозаписей](stt/request.md) и [потоковое распознавание](stt/streaming.md).

[Распознавание длинных аудиозаписей](stt/transcribation.md) находится на [стадии Preview](../overview/concepts/launch-stages), поэтому не тарифицируется.

Услуга | Цена за один отрезок<br/>продолжительностью 15 сек,<br/>вкл. НДС
----- | -----
Распознавание речи | 0,1524 ₽
