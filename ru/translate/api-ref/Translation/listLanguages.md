...
languages[].<br>code | **string**<br><p>Код языка. Указывается в формате <a href="https://en.wikipedia.org/wiki/ISO_639-1">ISO 639-1</a> (например, <code>en</code>).</p> 
languages[].<br>name | **string**<br><p>Название языка (например, <code>English</code>).</p> 