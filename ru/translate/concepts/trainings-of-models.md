...
Яндекс.Облако не использует переданные данные для обучения собственных моделей. Полученная модель будет доступна только для каталога, указанного в заявке.
