# [!KEYREF translate-full-name]

Сервис [!KEYREF translate-name] необходим для интеграции алгоритмов [Яндекс.Переводчика](https://translate.yandex.ru) в пользовательские приложения или веб-проекты. Yandex Translate поддерживает более 90 языков и умеет переводить отдельные слова и целые тексты.
