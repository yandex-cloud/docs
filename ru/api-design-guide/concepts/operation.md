---
title: Объект Operation
description: Из статьи вы узнаете про объект Operation, ознакомитесь с его форматом, а также узнаете, как отследить статус операции, отменить операцию и просмотреть список операций.
---
