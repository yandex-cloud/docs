...
- Консоль управления
    ...
    1. Укажите в поле:
        ...
        * **{{ ui-key.yc-serverless-apigw.dynamic-forms.cloud_ymq_info }}** — каталог, в котором находится очередь сообщений, и имя очереди сообщений. Если в выбранном каталоге нет очереди сообщений, [создайте](../../../message-queue/operations/message-queue-new-queue.md) ее.
