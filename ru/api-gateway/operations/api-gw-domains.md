...
- Консоль управления
	...
	1. В списке сервисов выберите **Certificate Manager** и в нем:
		...
		1. Когда сертификат перейдет в статус `Issued`, [создайте](../../certificate-manager/operations/domain/domain-create.md) домен. В поле **Сертификат** выберите сертификат, который создали на Шаге 3.1.
	...
	1. В списке сервисов выберите **API Gateway** и в нем:
		...
		1. Нажмите **Подключить** и выберите домен.
