...
- {{ message-queue-name }}
   ...
   1. В [консоли управления]({{ link-console-main }}) [перейдите](../../../console/operations/select-service.md#select-service) в сервис **{{ ui-key.yacloud.iam.folder.dashboard.label_ymq }}**.
