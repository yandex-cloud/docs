...
Подробнее о подключении собственного домена к API-шлюзу в разделе [{#T}](../operations/api-gw-domains.md).

Подробнее о добавлении сертификатов в разделе [{#T}](../../certificate-manager/operations/managed/cert-create.md).
