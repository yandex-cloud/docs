...
Пример {% if lang == "ru" and audience != "internal" %}[REST API](../../../glossary/rest-api.md){% else %}REST API{% endif %} сервиса, который позволяет создавать, получать, обновлять и удалять сущности фильмов:
