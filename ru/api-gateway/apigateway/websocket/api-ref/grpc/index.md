---
sourcePath: en/_api-ref-grpc/functions/api-gateway/websocket/apigateway/websocket/api-ref/grpc/index.md
---
...
Service | Description
--- | ---
[ConnectionService](./connection_service.md) | A set of methods for managing API Gateway WebSocket connections.
