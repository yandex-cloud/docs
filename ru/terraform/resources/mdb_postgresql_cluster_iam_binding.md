...
# yandex_mdb_postgresql_cluster_iam_binding (Resource)
...
- `role` (**Required**)(String). The role that should be assigned. Only one yandex_mdb_postgresql_cluster_iam_binding can be used per role.
