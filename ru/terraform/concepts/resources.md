---
title: Ресурсы в {{ TF }}
description: Узнайте, что такое ресурсы в {{ TF }}, как они описывают облачную инфраструктуру и как зависимости между ними помогают управлять порядком создания и изменения ресурсов.
---
