...
- `performance_diagnostics` (*Read-Only*) (List Of Object). Cluster performance diagnostics settings. [YC Documentation](https://yandex.cloud/docs/managed-mysql/api-ref/grpc/cluster_service#PerformanceDiagnostics).
  - `enabled` . 
