...
1. Серверные приложения должны входить в перечень правомочных продуктов, который включает в себя: 
    ...
    * Remote Desktop Services
    ...
    Полные правила программы перемещения лицензий представлены в официальной документации [Microsoft](https://www.microsoft.com/ru-ru/licensing/product-licensing/products).
