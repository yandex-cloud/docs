...
1. [Создайте сервисный аккаунт](../../iam/operations/sa/create.md#create-sa) с ролями `dataproc.agent`, `dataproc.provisioner`, `{{ roles.metastore.integrationProvider }}` и `storage.editor`.
...
- Консоль управления {#console}
    ...
    1. Выберите нужную версию {{ metastore-name }}.
