---
title: Начало работы для управляющего метаданными
description: Работая с {{ data-catalog-full-name }} в роли управляющего метаданными, вы можете собирать и систематизировать метаданные об объектах {{ yandex-cloud }} и связях между ними.
---
