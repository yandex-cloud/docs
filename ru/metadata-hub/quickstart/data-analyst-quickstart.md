---
title: Начало работы для аналитика метаданных
description: Работая с {{ data-catalog-full-name }} в роли аналитика метаданных, вы можете анализировать и визуализировать метаданные об объектах {{ yandex-cloud }} и связях между ними.
---
