---
title: Получение списка доменов и поддоменов
description: Следуя данной инструкции, вы сможете получить список доменов и поддоменов в {{ data-catalog-full-name }}.
---
