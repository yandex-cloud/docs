---
title: Получение списка доменов и поддоменов в {{ data-catalog-full-name }}
description: Следуя данной инструкции, вы получите список доменов и поддоменов в {{ data-catalog-name }}.
---
