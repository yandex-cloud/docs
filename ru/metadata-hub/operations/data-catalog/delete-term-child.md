---
title: Удаление дочернего термина в {{ data-catalog-full-name }}
description: Следуя данной инструкции, вы удалите дочерний термин из глоссария {{ data-catalog-name }}.
---
