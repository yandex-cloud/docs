---
title: Анализ связей между метаданными
description: Следуя данной инструкции, вы сможете анализировать связи между таблицами из всех источников выбранного каталога метаданных.
---
