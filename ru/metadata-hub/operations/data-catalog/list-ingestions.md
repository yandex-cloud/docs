---
title: Как получить список загрузок данных в {{ data-catalog-full-name }}
description: Следуя данной инструкции, вы сможете получить список загрузок данных в {{ data-catalog-name }}.
---
