---
title: Как изменить загрузку данных в {{ data-catalog-full-name }}
description: Следуя данной инструкции, вы сможете изменить загрузку данных в {{ data-catalog-name }}.
---
