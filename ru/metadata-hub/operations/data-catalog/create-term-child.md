---
title: Создание дочернего термина в {{ data-catalog-full-name }}
description: Следуя данной инструкции, вы создадите дочерний термин в глоссарии {{ data-catalog-name }}.
---
