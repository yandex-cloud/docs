---
editable: false
sourcePath: en/_cli-ref/cli-ref/connection-manager/cli-ref/connection/create/greenplum.md
---

# yc connection-manager connection create greenplum

Create Greenplum connection

#### Command Usage

Syntax: 

`yc connection-manager connection create greenplum [<CONNECTION-NAME>] [Flags...] [Global Flags...]`
