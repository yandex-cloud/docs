---
editable: false
sourcePath: en/_cli-ref/cli-ref/connection-manager/cli-ref/connection/create/mysql.md
---
...
`yc connection-manager connection create mysql [<CONNECTION-NAME>] [Flags...] [Global Flags...]`
