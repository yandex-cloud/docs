---
editable: false
sourcePath: en/_cli-ref/cli-ref/connection-manager/cli-ref/connection/update/valkey.md
---

# yc connection-manager connection update valkey
...
`yc connection-manager connection update valkey [<CONNECTION-ID>] [Flags...] [Global Flags...]`
