---
editable: false
sourcePath: en/_cli-ref/cli-ref/connection-manager/cli-ref/connection/update/greenplum.md
---

# yc connection-manager connection update greenplum
...
`yc connection-manager connection update greenplum [<CONNECTION-ID>] [Flags...] [Global Flags...]`
