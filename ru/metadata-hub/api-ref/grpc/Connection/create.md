---
editable: false
sourcePath: en/_api-ref-grpc/connectionmanager/v1/api-ref/grpc/Connection/create.md
---

# Connection Manager API, gRPC: ConnectionService.Create

Creates connection.

## gRPC request

**rpc Create ([CreateConnectionRequest](#yandex.cloud.connectionmanager.v1.CreateConnectionRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## CreateConnectionRequest {#yandex.cloud.connectionmanager.v1.CreateConnectionRequest}
