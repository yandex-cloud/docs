...
editable: false
apiPlayground:
  - url: https://metastore.{{ api-host }}/managed-metastore/v1/clusters/{resourceId}:updateAccessBindings
    method: patch
    path:
      type: object
      properties:
...
# Managed Service for Hive Metastore™ API, REST: Cluster.UpdateAccessBindings
