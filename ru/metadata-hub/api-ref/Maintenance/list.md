...
editable: false
apiPlayground:
  - url: https://metastore.{{ api-host }}/managed-metastore/v1/maintenances
    method: get
    path: null
    query:
      type: object
...
# Managed Service for Hive Metastore™ API, REST: Maintenance.List
...
```
GET https://metastore.{{ api-host }}/managed-metastore/v1/maintenances
```
