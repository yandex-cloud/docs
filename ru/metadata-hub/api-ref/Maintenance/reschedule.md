...
editable: false
apiPlayground:
  - url: https://metastore.{{ api-host }}/managed-metastore/v1/maintenances/{maintenanceId}:reschedule
    method: post
    path:
      type: object
      properties:
...
```
POST https://metastore.{{ api-host }}/managed-metastore/v1/maintenances/{maintenanceId}:reschedule
```
