...
> &lceil; 250 ГБ &rceil; = 0.250 ТБ

В этом случае стоимость запроса составит:

> &lceil; 0.250 * 600 &rceil; = 150 ₽
...
Общий объем считанных данных составит:
> &lceil; 100 + 10 + 20 &rceil; = 0.130 ТБ

Стоимость запроса в этом случае составит:

> &lceil; 0.130 * 600 &rceil; = 78 ₽
...
Общий объем считанных данных составит:
> &lceil; max(1 МБ, 10 МБ) &rceil; = 10 МБ = 0.00001 ТБ

Стоимость запроса в этом случае составит:

> &lceil; 0.00001 * 600 &rceil; = 0.006 ₽
