...
{{ yq-full-name }} может выполнять [потоковую обработку](../concepts/stream-processing.md) данных на SQL-подобном языке — [YQL](https://ydb.tech/ru/docs/yql/reference/syntax/).
