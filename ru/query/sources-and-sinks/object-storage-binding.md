...
1. В блоке **Параметры привязки к данным**:
   ...
   1. Выберите режим партицирования и укажите список [колонок партиционирования](../concepts/partitioning.md) и их типы.

      При использовании режима **Расширенный** укажите колонки [расширенного партиционирования](../concepts/partition-projection.md).
