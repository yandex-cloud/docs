...
Этот формат предназначен для совместимого описания схем данных между различными системами. JSON-формат представляет собой набор записей с описанием полей и их типов, наличие всех полей считается необязательным в исходных данных.
