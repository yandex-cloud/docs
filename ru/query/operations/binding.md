...
[Привязки](../concepts/glossary.md#пbinding) содержат информацию о соединении, формате и схеме данных. В одном запросе можно использовать несколько разных привязок.
