---
title: Аналитическая обработка данных в {{ yq-full-name }}
description: Аналитическая обработка данных в {{ yq-name }}. Особенности работы с данными в {{ objstorage-full-name }} и примеры использования.
---
