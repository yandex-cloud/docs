...
Формат путей хранения, когда в имени каждого каталога явно указано название колонки, называется "[Hive](https://en.wikipedia.org/wiki/Apache_Hive)-Metastore форматом" или просто "Hive-форматом".
