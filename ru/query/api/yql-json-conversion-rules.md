...
| `Struct<Name:String,Age:Int32>`| объект {} | `{ "Name": "John", "Age": 128 }`  |
...
| `Variant<value:Int32,error:String>` со структурой | массив из 2-х элементов  [filled_member_name, Value] | Variant\<complete:Bool,error:Utf8><br/>Variant(false, "complete") - ["complete", false]  |
