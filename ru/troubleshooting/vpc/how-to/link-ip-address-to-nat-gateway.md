...
NAT-шлюз предоставляет [IP-адрес из отдельного диапазона публичных адресов](https://cloud.yandex.ru/docs/vpc/concepts/ips), так что привязать статический не получится. Если для вашего сценария необходим статический адрес, рекомендуем рассмотреть вариант с использованием [NAT-инстанса](https://cloud.yandex.ru/docs/solutions/routing/nat-instance).
