...
В этом случае необходимо создать [политику доступа к бакету](../../../storage/concepts/policy), в которой будут указаны диапазоны IP-адресов, которые используются сервисом Yandex Cloud CDN.
...
Примените политику из указанного ниже примера [по этой инструкции](../../../storage/operations/buckets/policy#apply-policy).
