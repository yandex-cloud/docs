...
А ещё вы можете получить новый грант, если станете участником контент-программы и поможете нам улучшить документацию Yandex Cloud. Мы будем рады и небольшим редакторским правкам, и практическим руководствам по решению масштабных и сложных задач. На страницах документации, над которыми вы работали, мы опубликуем ссылку на ваш профиль на GitHub. Грант начисляется в течение 7 дней после принятия запроса на изменение документации. Полученный грант можно потратить на любые сервисы Yandex Cloud. Более подробно с описанием условий участия в контент-программе вы можете ознакомиться [по этой ссылке](https://cloud.yandex.ru/content-program).
