...
- Банковский перевод
    ...
    1. Идентификатор платежного аккаунта, на который не поступают денежные средства после внесения оплаты (имеет вид `d2nXXXXXXXXXXXXXXXXX`). Этот идентификатор можно найти [на странице с данными по платежному аккаунту](https://console.cloud.yandex.ru/billing/accounts);
