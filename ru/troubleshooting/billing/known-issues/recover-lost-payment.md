...
Средства автоматически зачисляются на счет, как только {{ yandex-cloud }} получает подтверждение оплаты от банка.
...
2. Заполненное платежное поручение в формате PDF с отметкой банка об исполнении.
