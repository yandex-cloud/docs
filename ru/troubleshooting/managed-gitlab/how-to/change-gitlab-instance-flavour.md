...
В настоящий момент для изменения типа существующего инстанса Managed Service for GitLab понадобится [создать запрос в техническую поддержку](https://console.cloud.yandex.ru/support?section=contact).
