...
Если обновление ПО GitLab критически необходимо в силу определенныхх причин, [создайте запрос в техническую поддержку](https://console.cloud.yandex.ru/support?section=contact).
