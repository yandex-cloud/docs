...
Необходимо перенести содержимое бакета в другой бакет, расположенный:

* в том же каталоге;
* в другом каталоге того же облака;
* в другом каталоге другого облака той же организации.
...
Если в бакете включено [шифрование](../../../security/standard/encryption.md#storage-at-rest), все загруженные в него файлы будут зашифрованы KMS-ключом, указанным в настройках бакета.
