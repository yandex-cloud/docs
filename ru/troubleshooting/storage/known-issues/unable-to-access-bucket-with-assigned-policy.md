...
Убедитесь, что ваш платежный аккаунт подключен, находится в [статусе](../../billing/concepts/billing-account-statuses.md) `ACTIVE` или `TRIAL_ACTIVE`, а также [привязан](https://yandex.cloud/ru/docs/billing/operations/pin-cloud) к вашему облаку.
