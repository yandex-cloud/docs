...
Убедитесь, что ваш платежный аккаунт подключен, находится в [статусе](../../../billing/concepts/billing-account-statuses.md) `ACTIVE` или `TRIAL_ACTIVE`, и к нему [привязано](../../../billing/operations/pin-cloud) ваше облако.
