...
Убедитесь, что ваш платежный аккаунт находится в [статусе](../../../billing/concepts/billing-account-statuses.md) `ACTIVE` или `TRIAL_ACTIVE`, и [привязанное к нему облако](../../../billing/operations/pin-cloud) также находится в статусе `ACTIVE`.
