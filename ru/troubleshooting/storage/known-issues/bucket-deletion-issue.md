...
- Консоль управления
  ...
  Посмотреть и удалить незавершенные загрузки из [Консоли управления]({{ link-console-main }}) можно [по этой инструкции](../../../storage/operations/objects/deleting-multipart.md).
