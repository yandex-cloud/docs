...
Вариантом работы с логами будет выгрузка из API сервиса и загрузка, как пример, в сервис `Cloud Logging`, где можно [делать фильтрацию и просмотр](../../../logging/concepts/filter.md). 
