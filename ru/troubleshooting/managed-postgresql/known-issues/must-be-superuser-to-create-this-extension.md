...
Установка расширений возможна только через консоль облака, CLI или API. Полный список поддерживаемых расширений мы описали [в статье про управление расширениями](../../../managed-postgresql/operations/extensions/cluster-extensions.md).
