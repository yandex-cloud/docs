...
Чтобы новые узлы создались, нужно подать на кластер нагрузку, то есть нагрузить кластер работающими и потребляющими ресурсы деплойментами. После этого Cluster Autoscaler сможет создать новые ноды и поддерживать их количество в соответствии с изменёнными параметрами. Затем тестовую нагрузку можно снять.
