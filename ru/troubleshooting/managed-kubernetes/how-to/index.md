...
* [Как выяснить размер эфемерного хранилища узла {{ managed-k8s-name }}](finding-out-ephemeral-storage-size.md)
* [Как узнать внешний IP-адрес узла {{ managed-k8s-name }}](finding-out-node-external-ip.md)
* [Как изменить часовой пояс на узлах кластера {{ managed-k8s-name }}](setting-timezone-on-mk8s-worker-nodes.md)
* [Как использовать сертификаты из {{ certificate-manager-name }} в балансировщиках нагрузки или в {{ managed-k8s-name }}](uploading-cert-from-yc-certmgr-to-k8s.md)
