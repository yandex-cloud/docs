...
- Docker
  ...
  1. Откройте `http://<адрес>:6080` в браузере и авторизуйтесь c логином root и вашим паролем. Используйте левое меню для буфера обмена и нажатия дополнительных клавиш 
  (`Ctrl`, `Alt`, `Win`, `Tab`).
