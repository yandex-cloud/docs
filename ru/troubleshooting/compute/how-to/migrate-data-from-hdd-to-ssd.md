# Изменение типа загрузочного диска виртуальной машины на SSD

## Описание задачи {#case-description}
Необходимо изменить тип загрузочного диска существующей виртуальной машины Compute Cloud с HDD на SSD.

## Решение {#case-description}
Изменить тип диска с HDD на SSD можно с помощью пересоздания виртуальной машины из снимка диска или образа. 
