...
5. Для получения уведомлений от сервиса мониторинга учётная запись должна иметь минимальные права на просмотр метрик в сервисе Yandex Monitoring. Это роль `monitoring.viewer` на каталог, в котором настроен канал уведомлений. 
