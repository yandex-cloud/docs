...
* При попытке выпуска нового или обновления существующего сертификата от Let's Encrypt в интерфейсе {{ certificate-manager-name }} сертификат переходит в один из статусов:
