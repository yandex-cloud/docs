# Настройка отправки журналов работы сторонних приложений в Cloud Logging

## Описание задачи {#case-description}

Необходимо отправлять журналы работы сторонних приложений и сервисов в Cloud Logging.

## Решение {#case-resolution}

Для записи пользовательских логов вы можете воспользоваться примером для Cloud Functions.

{% cut "Пример облачной функции с уровнями логгирования" %}
...
* [Управление доступом в Cloud Functions](../../../functions/security/index.md#about-access-control)
...
Лимит выдачи журналов, возвращаемых этой командой – 1000 строк. Если строк журналов, хранимых в Cloud Logging за этот период окажется более 1000, самые ранние из них не войдут в эту выборку.

Рекомендуется выгружать журналы с указанием интервала в 15 минут, поскольку в них может содержаться большое количество событий.
