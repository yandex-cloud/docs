...
Если по истечении 72 часов ресурсные записи, созданные в публичной DNS-зоне в Yandex Cloud не резолвятся с помощью других публичных DNS-серверов в интернете, [создайте запрос в техническую поддержку](https://console.cloud.yandex.ru/support?section=contact).
