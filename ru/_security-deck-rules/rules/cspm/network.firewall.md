...
* [Балансировщиков нагрузки](https://yandex.cloud/ru/docs/application-load-balancer/concepts/application-load-balancer) Yandex Application Load Balancer
* [Кластеров](https://yandex.cloud/ru/docs/managed-kubernetes/concepts/#kubernetes-cluster) Yandex Managed Service for Kubernetes®
...
* Принцип [BYOI](https://en.wikipedia.org/wiki/Bring_your_own_operating_system), например [собственный образ](https://yandex.cloud/ru/docs/compute/operations/image-create/upload) диска
