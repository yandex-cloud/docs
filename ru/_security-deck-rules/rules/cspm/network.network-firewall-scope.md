...
* Удалите опасное правило в каждой группе безопасности или [отредактируйте](https://yandex.cloud/ru/docs/vpc/operations/security-group-create) его, указав доверенные IP-адреса.
