...
* [Создайте](https://yandex.cloud/ru/docs/organization/operations/mfa/create-policy) политику MFA в интерфейсе [Yandex Identity Hub](https://center.yandex.cloud/organization) в Cloud Center.
* [Добавьте](https://yandex.cloud/ru/docs/organization/operations/mfa/add-users) в целевые группы этой политики всех пользователей пула.
