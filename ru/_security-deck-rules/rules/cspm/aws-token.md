...
У обнаруженных ВМ в блоке `metadata_options` установите для параметра [`aws_v1_http_token`](https://yandex.cloud/ru/docs/compute/api-ref/grpc/Instance/update#yandex.cloud.compute.v1.MetadataOptions) значение `DISABLED`:
