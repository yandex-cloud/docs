...
В Yandex Cloud существует базовая и расширенная защита от DDoS атак, а также защита на прикладном уровне с помощью сервиса [Yandex Smart Web Security](https://yandex.cloud/ru/docs/smartwebsecurity/quickstart). Необходимо убедиться, что у вас используется как минимум базовая защита.
...
* [Инструкция по созданию профиля безопасности Smart Web Security](https://yandex.cloud/ru/docs/smartwebsecurity/operations/profile-create)
