...
* Добавлена возможность самостоятельной [настройки внешних источников PXF](operations/pxf/settings.md) для работы с внешними таблицами. Раньше за настройкой PXF пользователям приходилось обращаться в поддержку.
