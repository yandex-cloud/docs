...
{% if lang != en %}* Добавлен [калькулятор](https://cloud.yandex.ru/promo/dwh-calculator/index) для расчета рекомендуемой конфигурации и оценки стоимости кластера.{% endif %}
