...
* при использовании хранилища на нереплицируемых SSD-дисках (`ssd-network-nonreplicated`) или хранилища на локальных SSD-дисках (`local-ssd`) — не менее 3;
* при использовании хранилища на сетевых HDD-дисках (`network-hdd`) или хранилища на сетевых SSD-дисках (`network-ssd`) допускается создание кластера из одного хоста.
...
[Подробнее о подключении к кластерам](../operations/cluster-connect.md).
...
**TODO: Уточнить и исправить при необходимости**
