...
Выполните запрос от имени [пользователя-администратора с ролью MDB_ADMIN](../concepts/cluster-users.md):
...
Выполните запрос, который задает количество параллельных транзакций для [ресурсной группы](../concepts/resource-groups.md), от имени [пользователя-администратора с ролью MDB_ADMIN](../concepts/cluster-users.md):
