---
title: Параметры командного центра {{ mgp-name }}
description: Из статьи вы узнаете, какую информацию о сессиях и запросах можно получить в командном центре {{ mgp-name }}.
---
