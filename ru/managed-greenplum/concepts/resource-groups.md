...
Подробнее об управлении ролями см. в разделе [Пользователи и роли](./cluster-users.md) и в [документации {{ GP }}]({{ gp.docs.vmware }}/7/greenplum-database/admin_guide-roles_privs.html).
...
Подробнее о работе ресурсных групп см. в [документации {{ GP }}]({{ gp.docs.vmware }}/7/greenplum-database/admin_guide-workload_mgmt_resgroups.html).
