...
* {{ CB }} 2.x — основана на {{ GP }} версии 7, но использует более новое ядро {{ PG }} версии 14, а также поддерживает работу с динамическими таблицами и форматом [PAX](https://cloudberry.apache.org/docs/operate-with-data/pax-table-format/).
...
Подробнее о различиях {{ CB }} и {{ GP }} в [отдельном разделе](./cloudberry-vs-greenplum/why-cloudberry.md).
