...
{{ GP }} создавалась как open-source проект, но в 2024 году доступ к исходному коду закрыли. Несмотря на это, в сервисе {{ mgp-name }} по-прежнему поддерживается {{ GP }} версии 6.28 и выше на основе ее open-source [форка](https://github.com/orgs/open-gpdb/discussions/11).
