...
**TODO: сейчас классы хостов скопированы из PostgreSQL. Уточнить у консультантов актуальность списков для внешних и внутренних пользователей.**
...
Хосты в кластерах {{ mgp-name }} разворачиваются на базе виртуальных машин {{ compute-full-name }}. Эти виртуальные машины могут быть созданы на любой из платформ, которые поддерживает {{ compute-name }}. Подробное описание платформ приведено в разделе [{#T}](../../compute/concepts/vm-platforms.md).
