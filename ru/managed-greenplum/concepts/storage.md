...
description: Из статьи вы узнаете, какие типы дисков есть в {{ mgp-name }}, узнаете про особенности хранилища на локальных SSD-дисках.
---
...
В кластере {{ GP }} тип дисков у хостов-мастеров и хостов-сегментов может отличаться.
