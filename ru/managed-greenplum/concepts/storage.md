...
* Хранилище на стандартных локальных дисках (`local-hdd`) — использует более медленные, но вместительные диски. Доступен только для хостов с процессорами на платформах Ice Lake или Cascade Lake и имеющих не меньше восьми vCPU.
