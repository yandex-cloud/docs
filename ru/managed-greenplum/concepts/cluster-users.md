...
Вы можете управлять пользователями кластера с помощью пользователя-администратора. Имя и пароль пользователя-администратора задаются при [создании](../operations/cluster-create.md#create-cluster) кластера. Управление доступно только через SQL.
