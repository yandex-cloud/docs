...
* _Оптимизированное для добавления_ (append-optimized storage).
    ...
    Для таблиц AO и AOCO в кластерах {{ GP }} доступно [гибридное хранилище](./hybrid-storage.md): с помощью [расширения {{ YZ }}](../operations/extensions/yezzey.md) можно переместить часть таблиц из хранилища кластера в холодное хранилище и наоборот. Холодное хранилище удобно, если данные таблиц нужно хранить долго, а работать с ними планируется редко. Так хранение [будет дешевле](../pricing/index.md#rules-storage).
