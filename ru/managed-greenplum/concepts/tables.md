...
* _Оптимизированное для добавления_ (append-optimized storage).
    ...
    Для таблиц AO и AOCO в кластерах {{ mgp-name }} доступно [гибридное хранилище](./hybrid-storage.md): с помощью [расширения {{ YZ }}](../operations/extensions/yezzey.md) можно переместить часть таблиц из хранилища кластера в гибридное хранилище и наоборот. Гибридное хранилище удобно, если данные таблиц нужно хранить долго, а работать с ними планируется редко. Так хранение [будет дешевле](../pricing/index.md#rules-storage).
