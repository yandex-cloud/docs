...
* _Оптимизированное для добавления_ (append-optimized storage).
    ...
    Для таблиц AO и AOCO {{ yandex-cloud }} разработал расширение {{ YZ }}, которое позволяет выгрузить данные с дисков кластера {{ mgp-name }} в холодное хранилище {{ cloud-storage-full-name }}. Данные надежно хранятся в служебном бакете {{ objstorage-full-name }}. Подробнее о работе с хранилищем см. в руководстве [{#T}](../tutorials/yezzey.md).
