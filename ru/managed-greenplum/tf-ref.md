# Справочник ресурсов {{ mgp-full-name }} провайдера {{ TF }}
...
| --- | --- |
| [yandex_mdb_greenplum_cluster]({{ tf-provider-resources-link }}/mdb_greenplum_cluster) | [Кластер {{ GP }}](./concepts/index.md) |