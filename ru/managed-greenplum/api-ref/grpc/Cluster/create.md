...
This subnet should be a part of the cloud network the cluster belongs to (see [Cluster.network_id](/docs/managed-greenplum/api-ref/grpc/Cluster/get#yandex.cloud.mdb.greenplum.v1.Cluster)).
