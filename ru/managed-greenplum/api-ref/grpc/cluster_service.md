...
| [Backup](#Backup) | Creates a backup for the specified Greenplum cluster. |
...
backup_retain_period_days | **[google.protobuf.Int64Value](https://developers.google.com/protocol-buffers/docs/reference/csharp/class/google/protobuf/well-known-types/int64-value)**<br>Retention policy of automated backups. Acceptable values are 1 to 60, inclusive.
...
Field | Description
--- | ---
effective_config | **[GreenplumConfig6_17](#GreenplumConfig6_17)**<br>Required. Effective settings for a Greenplum® cluster (a combination of settings defined in `user_config` and `default_config`). 
...
Field | Description
--- | ---
effective_config | **[GreenplumConfig6_19](#GreenplumConfig6_19)**<br>Required. Effective settings for a Greenplum® cluster (a combination of settings defined in `user_config` and `default_config`). 
...
log_statement | enum **LogStatement**<br>Logged SQL statements. <br>`PREPARE` and `EXPLAIN ANALYZE` statements are also logged if their contained command belongs to an appropriate type. <br>More info in [Greenplum® documentation](https://docs.vmware.com/en/VMware-Greenplum/6/greenplum-database/ref_guide-config_params-guc-list.html#log_statement). <ul><li>`NONE`: None statements are logged.</li><li>`DDL`: Logs all data definition commands like `CREATE`, `ALTER`, and `DROP`. Default value.</li><li>`MOD`: Logs all `DDL` statements, plus `INSERT`, `UPDATE`, `DELETE`, `TRUNCATE`, and `COPY FROM`.</li><li>`ALL`: Logs all statements.</li></ul>


### GreenplumConfigSet6_21 {#GreenplumConfigSet6_21}

Field | Description
--- | ---
effective_config | **[GreenplumConfig6_21](#GreenplumConfig6_21)**<br>Required. Effective settings for a Greenplum®  cluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumConfig6_21](#GreenplumConfig6_21)**<br>User-defined settings for a Greenplum® cluster. 
default_config | **[GreenplumConfig6_21](#GreenplumConfig6_21)**<br>Default configuration for a Greenplum® cluster. 
...
### GreenplumConfigSet6_22 {#GreenplumConfigSet6_22}

Field | Description
--- | ---
effective_config | **[GreenplumConfig6_22](#GreenplumConfig6_22)**<br>Required. Effective settings for a Greenplum®  cluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumConfig6_22](#GreenplumConfig6_22)**<br>User-defined settings for a Greenplum® cluster. 
default_config | **[GreenplumConfig6_22](#GreenplumConfig6_22)**<br>Default configuration for a Greenplum® cluster. 
...
Field | Description
--- | ---
effective_config | **[GreenplumConfig6_17](#GreenplumConfig6_171)**<br>Required. Effective settings for a Greenplum® cluster (a combination of settings defined in `user_config` and `default_config`). 
...
Field | Description
--- | ---
effective_config | **[GreenplumConfig6_19](#GreenplumConfig6_191)**<br>Required. Effective settings for a Greenplum® cluster (a combination of settings defined in `user_config` and `default_config`). 
...
### GreenplumConfigSet6_21 {#GreenplumConfigSet6_211}

Field | Description
--- | ---
effective_config | **[GreenplumConfig6_21](#GreenplumConfig6_211)**<br>Required. Effective settings for a Greenplum®  cluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumConfig6_21](#GreenplumConfig6_211)**<br>User-defined settings for a Greenplum® cluster. 
default_config | **[GreenplumConfig6_21](#GreenplumConfig6_211)**<br>Default configuration for a Greenplum® cluster. 
...
### GreenplumConfigSet6_22 {#GreenplumConfigSet6_221}

Field | Description
--- | ---
effective_config | **[GreenplumConfig6_22](#GreenplumConfig6_221)**<br>Required. Effective settings for a Greenplum®  cluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumConfig6_22](#GreenplumConfig6_221)**<br>User-defined settings for a Greenplum® cluster. 
default_config | **[GreenplumConfig6_22](#GreenplumConfig6_221)**<br>Default configuration for a Greenplum® cluster. 
...
### GreenplumConfig6_21 {#GreenplumConfig6_212}
...
### GreenplumConfig6_22 {#GreenplumConfig6_222}
...
Field | Description
--- | ---
effective_config | **[GreenplumConfig6_17](#GreenplumConfig6_173)**<br>Required. Effective settings for a Greenplum® cluster (a combination of settings defined in `user_config` and `default_config`). 
...
Field | Description
--- | ---
effective_config | **[GreenplumConfig6_19](#GreenplumConfig6_193)**<br>Required. Effective settings for a Greenplum® cluster (a combination of settings defined in `user_config` and `default_config`). 
...
### GreenplumConfigSet6_21 {#GreenplumConfigSet6_212}

Field | Description
--- | ---
effective_config | **[GreenplumConfig6_21](#GreenplumConfig6_213)**<br>Required. Effective settings for a Greenplum®  cluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumConfig6_21](#GreenplumConfig6_213)**<br>User-defined settings for a Greenplum® cluster. 
default_config | **[GreenplumConfig6_21](#GreenplumConfig6_213)**<br>Default configuration for a Greenplum® cluster. 


### GreenplumConfigSet6_22 {#GreenplumConfigSet6_222}

Field | Description
--- | ---
effective_config | **[GreenplumConfig6_22](#GreenplumConfig6_223)**<br>Required. Effective settings for a Greenplum®  cluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumConfig6_22](#GreenplumConfig6_223)**<br>User-defined settings for a Greenplum® cluster. 
...
### GreenplumConfig6_21 {#GreenplumConfig6_213}
...
### GreenplumConfig6_22 {#GreenplumConfig6_223}
...
Field | Description
--- | ---
effective_config | **[GreenplumConfig6_17](#GreenplumConfig6_174)**<br>Required. Effective settings for a Greenplum® cluster (a combination of settings defined in `user_config` and `default_config`). 
...
Field | Description
--- | ---
effective_config | **[GreenplumConfig6_19](#GreenplumConfig6_194)**<br>Required. Effective settings for a Greenplum® cluster (a combination of settings defined in `user_config` and `default_config`). 
...
### GreenplumConfigSet6_21 {#GreenplumConfigSet6_213}

Field | Description
--- | ---
effective_config | **[GreenplumConfig6_21](#GreenplumConfig6_214)**<br>Required. Effective settings for a Greenplum®  cluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumConfig6_21](#GreenplumConfig6_214)**<br>User-defined settings for a Greenplum® cluster. 
default_config | **[GreenplumConfig6_21](#GreenplumConfig6_214)**<br>Default configuration for a Greenplum® cluster. 


### GreenplumConfigSet6_22 {#GreenplumConfigSet6_223}

Field | Description
--- | ---
effective_config | **[GreenplumConfig6_22](#GreenplumConfig6_224)**<br>Required. Effective settings for a Greenplum®  cluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumConfig6_22](#GreenplumConfig6_224)**<br>User-defined settings for a Greenplum® cluster. 
...
### GreenplumConfigSet6_21 {#GreenplumConfigSet6_214}
...
### GreenplumConfig6_21 {#GreenplumConfig6_214}
...
### GreenplumConfigSet6_22 {#GreenplumConfigSet6_224}
...
### GreenplumConfig6_22 {#GreenplumConfig6_224}
...
Field | Description
--- | ---
effective_config | **[GreenplumConfig6_17](#GreenplumConfig6_175)**<br>Required. Effective settings for a Greenplum® cluster (a combination of settings defined in `user_config` and `default_config`). 
...
Field | Description
--- | ---
effective_config | **[GreenplumConfig6_19](#GreenplumConfig6_195)**<br>Required. Effective settings for a Greenplum® cluster (a combination of settings defined in `user_config` and `default_config`). 
...
### GreenplumConfigSet6_21 {#GreenplumConfigSet6_215}

Field | Description
--- | ---
effective_config | **[GreenplumConfig6_21](#GreenplumConfig6_215)**<br>Required. Effective settings for a Greenplum®  cluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumConfig6_21](#GreenplumConfig6_215)**<br>User-defined settings for a Greenplum® cluster. 
default_config | **[GreenplumConfig6_21](#GreenplumConfig6_215)**<br>Default configuration for a Greenplum® cluster. 


### GreenplumConfig6_21 {#GreenplumConfig6_215}
...
### GreenplumConfigSet6_22 {#GreenplumConfigSet6_225}

Field | Description
--- | ---
effective_config | **[GreenplumConfig6_22](#GreenplumConfig6_225)**<br>Required. Effective settings for a Greenplum®  cluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumConfig6_22](#GreenplumConfig6_225)**<br>User-defined settings for a Greenplum® cluster. 
default_config | **[GreenplumConfig6_22](#GreenplumConfig6_225)**<br>Default configuration for a Greenplum® cluster. 


### GreenplumConfig6_22 {#GreenplumConfig6_225}
...
Field | Description
--- | ---
effective_config | **[GreenplumConfig6_17](#GreenplumConfig6_176)**<br>Required. Effective settings for a Greenplum® cluster (a combination of settings defined in `user_config` and `default_config`). 
...
Field | Description
--- | ---
effective_config | **[GreenplumConfig6_19](#GreenplumConfig6_196)**<br>Required. Effective settings for a Greenplum® cluster (a combination of settings defined in `user_config` and `default_config`). 
...
### GreenplumConfigSet6_21 {#GreenplumConfigSet6_216}

Field | Description
--- | ---
effective_config | **[GreenplumConfig6_21](#GreenplumConfig6_216)**<br>Required. Effective settings for a Greenplum®  cluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumConfig6_21](#GreenplumConfig6_216)**<br>User-defined settings for a Greenplum® cluster. 
default_config | **[GreenplumConfig6_21](#GreenplumConfig6_216)**<br>Default configuration for a Greenplum® cluster. 


### GreenplumConfig6_21 {#GreenplumConfig6_216}
...
### GreenplumConfigSet6_22 {#GreenplumConfigSet6_226}

Field | Description
--- | ---
effective_config | **[GreenplumConfig6_22](#GreenplumConfig6_226)**<br>Required. Effective settings for a Greenplum®  cluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumConfig6_22](#GreenplumConfig6_226)**<br>User-defined settings for a Greenplum® cluster. 
default_config | **[GreenplumConfig6_22](#GreenplumConfig6_226)**<br>Default configuration for a Greenplum® cluster. 


### GreenplumConfig6_22 {#GreenplumConfig6_226}
...
service_type | enum **ServiceType**<br>Type of the service to request logs about. <ul><li>`SERVICE_TYPE_UNSPECIFIED`: Type is not specified.</li><li>`GREENPLUM`: Greenplum® activity logs.</li><li>`GREENPLUM_POOLER`: Greenplum® pooler logs.</li><li>`GREENPLUM_PXF`: Greenplum® PXF service logs.</li></ul>
...
Field | Description
--- | ---
cluster_id | **string**<br>Required. ID of the Greenplum cluster to back up. To get the Greenplum cluster ID, use a [ClusterService.List](#List) request. The maximum string length in characters is 50.
...
Field | Description
--- | ---
cluster_id | **string**<br>ID of the Greenplum cluster to back up. 
backup_id | **string**<br> 
...
Field | Description
--- | ---
resources | **[Resources](#Resources9)**<br>Computational resources allocated to Greenplum® master subcluster hosts. 
...
Field | Description
--- | ---
effective_config | **[GreenplumConfig6_17](#GreenplumConfig6_177)**<br>Required. Effective settings for a Greenplum® cluster (a combination of settings defined in `user_config` and `default_config`). 
...
Field | Description
--- | ---
effective_config | **[GreenplumConfig6_19](#GreenplumConfig6_197)**<br>Required. Effective settings for a Greenplum® cluster (a combination of settings defined in `user_config` and `default_config`). 
...
### GreenplumConfigSet6_21 {#GreenplumConfigSet6_217}

Field | Description
--- | ---
effective_config | **[GreenplumConfig6_21](#GreenplumConfig6_217)**<br>Required. Effective settings for a Greenplum®  cluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumConfig6_21](#GreenplumConfig6_217)**<br>User-defined settings for a Greenplum® cluster. 
default_config | **[GreenplumConfig6_21](#GreenplumConfig6_217)**<br>Default configuration for a Greenplum® cluster. 


### GreenplumConfig6_21 {#GreenplumConfig6_217}
...
### GreenplumConfigSet6_22 {#GreenplumConfigSet6_227}

Field | Description
--- | ---
effective_config | **[GreenplumConfig6_22](#GreenplumConfig6_227)**<br>Required. Effective settings for a Greenplum®  cluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumConfig6_22](#GreenplumConfig6_227)**<br>User-defined settings for a Greenplum® cluster. 
default_config | **[GreenplumConfig6_22](#GreenplumConfig6_227)**<br>Default configuration for a Greenplum® cluster. 


### GreenplumConfig6_22 {#GreenplumConfig6_227}
...
description | **string**<br>Description of the Greenplum® cluster. The maximum string length in characters is 256.
labels | **map<string,string>**<br>Custom labels for the Greenplum® cluster as `key:value` pairs. For example, "project":"mvp" or "source":"dictionary". No more than 64 per resource. The maximum string length in characters for each value is 63. Each value must match the regular expression ` [-_0-9a-z]* `. The maximum string length in characters for each key is 63. Each key must match the regular expression ` [a-z][-_0-9a-z]* `.
environment | **[Cluster.Environment](#Cluster8)**<br>Required. Deployment environment of the Greenplum® cluster. 
config | **[GreenplumRestoreConfig](#GreenplumRestoreConfig)**<br>Greenplum® cluster config. 
master_resources | **[Resources](#Resources10)**<br>Resources of the Greenplum® master subcluster. 
segment_resources | **[Resources](#Resources10)**<br>Resources of the Greenplum® segment subcluster. 
network_id | **string**<br>Required. ID of the network to create the cluster in. The maximum string length in characters is 50.
security_group_ids[] | **string**<br>User security groups. 
deletion_protection | **bool**<br>Determines whether the cluster is protected from being deleted. 
...
created_at | **[google.protobuf.Timestamp](https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#timestamp)**<br>Time when the cluster was created. 
name | **string**<br>Required. Name of the Greenplum® cluster. The name is unique within the folder. The maximum string length in characters is 63.
config | **[GreenplumConfig](#GreenplumConfig8)**<br>Greenplum® cluster configuration. 
description | **string**<br>Description of the Greenplum® cluster. The maximum string length in characters is 256.
labels | **map<string,string>**<br>Custom labels for the Greenplum® cluster as `key:value` pairs. Maximum 64 labels per resource. 
environment | enum **Environment**<br>Deployment environment of the Greenplum® cluster. <ul><li>`PRODUCTION`: Stable environment with a conservative update policy: only hotfixes are applied during regular maintenance.</li><li>`PRESTABLE`: Environment with more aggressive update policy: new versions are rolled out irrespective of backward compatibility.</li></ul>
monitoring[] | **[Monitoring](#Monitoring8)**<br>Description of monitoring systems relevant to the Greenplum® cluster. 
master_config | **[MasterSubclusterConfig](#MasterSubclusterConfig8)**<br>Configuration of the Greenplum® master subcluster. 
segment_config | **[SegmentSubclusterConfig](#SegmentSubclusterConfig8)**<br>Configuration of the Greenplum® segment subcluster. 
master_host_count | **int64**<br>Number of hosts in the master subcluster. 
segment_host_count | **int64**<br>Number of hosts in the segment subcluster. 
segment_in_host | **int64**<br>Number of segments per host. 
network_id | **string**<br>ID of the cloud network that the cluster belongs to. 
health | enum **Health**<br>Aggregated cluster health. <ul><li>`HEALTH_UNKNOWN`: Health of the cluster is unknown ([Host.health](#Host2) for every host in the cluster is UNKNOWN).</li><li>`ALIVE`: Cluster is working normally ([Host.health](#Host2) for every host in the cluster is ALIVE).</li><li>`DEAD`: Cluster is inoperable ([Host.health](#Host2) for every host in the cluster is DEAD).</li><li>`DEGRADED`: Cluster is working below capacity ([Host.health](#Host2) for at least one host in the cluster is not ALIVE).</li><li>`UNBALANCED`: Cluster is working below capacity ([Host.health](#Host2) for at least one host in the cluster is UNBALANCED).</li></ul>
status | enum **Status**<br>Current state of the cluster. <ul><li>`STATUS_UNKNOWN`: Cluster state is unknown.</li><li>`CREATING`: Cluster is being created.</li><li>`RUNNING`: Cluster is running normally.</li><li>`ERROR`: Cluster has encountered a problem and cannot operate.</li><li>`UPDATING`: Cluster is being updated.</li><li>`STOPPING`: Cluster is stopping.</li><li>`STOPPED`: Cluster has stopped.</li><li>`STARTING`: Cluster is starting.</li></ul>
maintenance_window | **[MaintenanceWindow](#MaintenanceWindow9)**<br>A Greenplum® cluster maintenance window. Should be defined by either one of the two options. 
...
deletion_protection | **bool**<br>Determines whether the cluster is protected from being deleted. 
host_group_ids[] | **string**<br>Host groups hosting VMs of the cluster. 
cluster_config | **[ClusterConfigSet](#ClusterConfigSet8)**<br>Greenplum® and Odyssey® configuration. 
cloud_storage | **[CloudStorage](#CloudStorage8)**<br>Cloud storage settings 
...
### MasterSubclusterConfig {#MasterSubclusterConfig8}

Field | Description
--- | ---
resources | **[Resources](#Resources11)**<br>Computational resources allocated to Greenplum® master subcluster hosts. 


### SegmentSubclusterConfig {#SegmentSubclusterConfig8}
...
### ClusterConfigSet {#ClusterConfigSet8}

Field | Description
--- | ---
greenplum_config | **oneof:** `greenplum_config_set_6_17`, `greenplum_config_set_6_19`, `greenplum_config_set_6_21`, `greenplum_config_set_6_22` or `greenplum_config_set_6`<br>
&nbsp;&nbsp;greenplum_config_set_6_17 | **[GreenplumConfigSet6_17](#GreenplumConfigSet6_178)**<br> 
&nbsp;&nbsp;greenplum_config_set_6_19 | **[GreenplumConfigSet6_19](#GreenplumConfigSet6_198)**<br> 
&nbsp;&nbsp;greenplum_config_set_6_21 | **[GreenplumConfigSet6_21](#GreenplumConfigSet6_218)**<br> 
&nbsp;&nbsp;greenplum_config_set_6_22 | **[GreenplumConfigSet6_22](#GreenplumConfigSet6_228)**<br> 
&nbsp;&nbsp;greenplum_config_set_6 | **[GreenplumConfigSet6](#GreenplumConfigSet68)**<br> 
pool | **[ConnectionPoolerConfigSet](#ConnectionPoolerConfigSet8)**<br>Odyssey® pool settings. 
background_activities | **[BackgroundActivitiesConfig](#BackgroundActivitiesConfig8)**<br> 
pxf_config | **[PXFConfigSet](#PXFConfigSet8)**<br> 


### GreenplumConfigSet6_17 {#GreenplumConfigSet6_178}

Field | Description
--- | ---
effective_config | **[GreenplumConfig6_17](#GreenplumConfig6_178)**<br>Required. Effective settings for a Greenplum® cluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumConfig6_17](#GreenplumConfig6_178)**<br>User-defined settings for a Greenplum® cluster. 
default_config | **[GreenplumConfig6_17](#GreenplumConfig6_178)**<br>Default configuration for a Greenplum® cluster. 
...
### GreenplumConfigSet6_19 {#GreenplumConfigSet6_198}

Field | Description
--- | ---
effective_config | **[GreenplumConfig6_19](#GreenplumConfig6_198)**<br>Required. Effective settings for a Greenplum® cluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumConfig6_19](#GreenplumConfig6_198)**<br>User-defined settings for a Greenplum® cluster. 
default_config | **[GreenplumConfig6_19](#GreenplumConfig6_198)**<br>Default configuration for a Greenplum® cluster. 
...
### GreenplumConfigSet6_21 {#GreenplumConfigSet6_218}

Field | Description
--- | ---
effective_config | **[GreenplumConfig6_21](#GreenplumConfig6_218)**<br>Required. Effective settings for a Greenplum®  cluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumConfig6_21](#GreenplumConfig6_218)**<br>User-defined settings for a Greenplum® cluster. 
default_config | **[GreenplumConfig6_21](#GreenplumConfig6_218)**<br>Default configuration for a Greenplum® cluster. 


### GreenplumConfig6_21 {#GreenplumConfig6_218}
...
### GreenplumConfigSet6_22 {#GreenplumConfigSet6_228}

Field | Description
--- | ---
effective_config | **[GreenplumConfig6_22](#GreenplumConfig6_228)**<br>Required. Effective settings for a Greenplum®  cluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumConfig6_22](#GreenplumConfig6_228)**<br>User-defined settings for a Greenplum® cluster. 
default_config | **[GreenplumConfig6_22](#GreenplumConfig6_228)**<br>Default configuration for a Greenplum® cluster. 


### GreenplumConfig6_22 {#GreenplumConfig6_228}
...
### GreenplumConfigSet6 {#GreenplumConfigSet68}

Field | Description
--- | ---
effective_config | **[GreenplumConfig6](#GreenplumConfig68)**<br>Required. Effective settings for a Greenplum (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumConfig6](#GreenplumConfig68)**<br>User-defined settings for a Greenplum. 
default_config | **[GreenplumConfig6](#GreenplumConfig68)**<br>Default configuration for a Greenplum. 


### GreenplumConfig6 {#GreenplumConfig68}
...
### ConnectionPoolerConfigSet {#ConnectionPoolerConfigSet8}

Field | Description
--- | ---
effective_config | **[ConnectionPoolerConfig](#ConnectionPoolerConfig8)**<br>Required. Effective settings for an Odyssey® pooler (a combination of settings defined in [ConnectionPoolerConfigSet.user_config](#ConnectionPoolerConfigSet8) and [ConnectionPoolerConfigSet.default_config](#ConnectionPoolerConfigSet8)). 
user_config | **[ConnectionPoolerConfig](#ConnectionPoolerConfig8)**<br>User-defined settings for an Odyssey® pooler. 
default_config | **[ConnectionPoolerConfig](#ConnectionPoolerConfig8)**<br>Default configuration for an Odyssey® pooler. 
...
### BackgroundActivitiesConfig {#BackgroundActivitiesConfig8}

Field | Description
--- | ---
table_sizes | **[TableSizes](#TableSizes8)**<br> 
analyze_and_vacuum | **[AnalyzeAndVacuum](#AnalyzeAndVacuum8)**<br> 


### TableSizes {#TableSizes8}

Field | Description
--- | ---
starts[] | **[BackgroundActivityStartAt](#BackgroundActivityStartAt8)**<br> The maximum number of elements is 4.


### BackgroundActivityStartAt {#BackgroundActivityStartAt8}
...
### AnalyzeAndVacuum {#AnalyzeAndVacuum8}
