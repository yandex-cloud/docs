...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-greenplum/v1/clusters/{clusterId}:rescheduleMaintenance
    method: post
    path:
      type: object
      properties:
    ...
    body:
      ...
      additionalProperties: false
    definitions: null
sourcePath: en/_api-ref/mdb/greenplum/v1/api-ref/Cluster/rescheduleMaintenance.md
---

# Managed Service for Greenplum® API, REST: Cluster.RescheduleMaintenance
...
```
POST https://{{ api-host-mdb }}/managed-greenplum/v1/clusters/{clusterId}:rescheduleMaintenance
```
