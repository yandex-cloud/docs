...
clusters[].<br>id | **string**<br><p>ID of the Greenplum cluster. This ID is assigned by Managed Service for Greenplum® at creation time.</p> 
...
clusters[].<br>config | **object**<br><p>Greenplum® cluster configuration.</p> <p>Greenplum® cluster options.</p> 
...
clusters[].<br>config.<br>access.<br>dataLens | **boolean** (boolean)<br><p>Allow data export from the cluster to Yandex DataLens.</p> 
...
clusters[].<br>config.<br>subnetId | **string**<br><p>ID of the subnet that the host should belong to. This subnet should be a part of the network that the cluster belongs to. The ID of the network is set in the <a href="/docs/managed-greenplum/api-ref/Cluster#representation">Cluster.networkId</a> field.</p> <p>The maximum string length in characters is 50.</p> 
...
clusters[].<br>masterConfig.<br>resources | **object**<br><p>Resources allocated to Greenplum® master subcluster hosts.</p> <p>A set of hardware resources available to a host.</p> 
...
clusters[].<br>masterConfig.<br>resources.<br>diskSize | **string** (int64)<br><p>Volume of the storage available to a host, in bytes.</p> 
...
clusters[].<br>masterConfig.<br>config.<br>effectiveConfig.<br>pool | **object**<br><p>Odyssey connection pooler settings.</p> <p>Configuration of the connection pooler.</p> 
clusters[].<br>masterConfig.<br>config.<br>effectiveConfig.<br>pool.<br>mode | **string**<br><p>Odyssey route server pool mode.</p> <ul> <li>SESSION: Assign server connection to a client until it disconnects. Default value.</li> <li>TRANSACTION: Assign server connection to a client for a transaction processing.</li> </ul> 
clusters[].<br>masterConfig.<br>config.<br>effectiveConfig.<br>pool.<br>size | **integer** (int64)<br><p>The number of servers in the pool. Clients are put in a wait queue, when all servers are busy. Set to zero to disable the limit.</p> 
clusters[].<br>masterConfig.<br>config.<br>effectiveConfig.<br>pool.<br>clientIdleTimeout | **integer** (int64)<br><p>Server pool idle timeout, in seconds. A server connection closes after it has been idle for the specified duration. Set to zero to disable.</p> 
...
clusters[].<br>masterConfig.<br>config.<br>effectiveConfig.<br>logDuration | **boolean** (boolean)<br><p>Causes the duration of every completed statement which satisfies log_statement to be logged. For details, see Greenplum® <a href="https://docs.greenplum.org/6-5/ref_guide/config_params/guc-list.html#log_duration">documentation</a>.</p> 
...
clusters[].<br>masterConfig.<br>config.<br>userConfig.<br>pool | **object**<br><p>Odyssey connection pooler settings.</p> <p>Configuration of the connection pooler.</p> 
clusters[].<br>masterConfig.<br>config.<br>userConfig.<br>pool.<br>mode | **string**<br><p>Odyssey route server pool mode.</p> <ul> <li>SESSION: Assign server connection to a client until it disconnects. Default value.</li> <li>TRANSACTION: Assign server connection to a client for a transaction processing.</li> </ul> 
clusters[].<br>masterConfig.<br>config.<br>userConfig.<br>pool.<br>size | **integer** (int64)<br><p>The number of servers in the pool. Clients are put in a wait queue, when all servers are busy. Set to zero to disable the limit.</p> 
clusters[].<br>masterConfig.<br>config.<br>userConfig.<br>pool.<br>clientIdleTimeout | **integer** (int64)<br><p>Server pool idle timeout, in seconds. A server connection closes after it has been idle for the specified duration. Set to zero to disable.</p> 
...
clusters[].<br>masterConfig.<br>config.<br>userConfig.<br>logDuration | **boolean** (boolean)<br><p>Causes the duration of every completed statement which satisfies log_statement to be logged. For details, see Greenplum® <a href="https://docs.greenplum.org/6-5/ref_guide/config_params/guc-list.html#log_duration">documentation</a>.</p> 
...
clusters[].<br>masterConfig.<br>config.<br>defaultConfig.<br>pool | **object**<br><p>Odyssey connection pooler settings.</p> <p>Configuration of the connection pooler.</p> 
clusters[].<br>masterConfig.<br>config.<br>defaultConfig.<br>pool.<br>mode | **string**<br><p>Odyssey route server pool mode.</p> <ul> <li>SESSION: Assign server connection to a client until it disconnects. Default value.</li> <li>TRANSACTION: Assign server connection to a client for a transaction processing.</li> </ul> 
clusters[].<br>masterConfig.<br>config.<br>defaultConfig.<br>pool.<br>size | **integer** (int64)<br><p>The number of servers in the pool. Clients are put in a wait queue, when all servers are busy. Set to zero to disable the limit.</p> 
clusters[].<br>masterConfig.<br>config.<br>defaultConfig.<br>pool.<br>clientIdleTimeout | **integer** (int64)<br><p>Server pool idle timeout, in seconds. A server connection closes after it has been idle for the specified duration. Set to zero to disable.</p> 
...
clusters[].<br>masterConfig.<br>config.<br>defaultConfig.<br>logDuration | **boolean** (boolean)<br><p>Causes the duration of every completed statement which satisfies log_statement to be logged. For details, see Greenplum® <a href="https://docs.greenplum.org/6-5/ref_guide/config_params/guc-list.html#log_duration">documentation</a>.</p> 
...
clusters[].<br>segmentConfig.<br>resources | **object**<br><p>Resources allocated to Greenplum® segment subcluster hosts.</p> <p>A set of hardware resources available to a host.</p> 
...
clusters[].<br>segmentConfig.<br>resources.<br>diskSize | **string** (int64)<br><p>Volume of the storage available to a host, in bytes.</p> 
...
clusters[].<br>maintenanceWindow | **object**<br><p>Window of maintenance operations.</p> <p>A Greenplum® cluster maintenance window.</p> 
clusters[].<br>maintenanceWindow.<br>anytime | **object** <br>`clusters[].maintenanceWindow` includes only one of the fields `anytime`, `weeklyMaintenanceWindow`<br><br><p>A Greenplum® cluster any-time maintenance window.</p> 
clusters[].<br>maintenanceWindow.<br>weeklyMaintenanceWindow | **object** <br>`clusters[].maintenanceWindow` includes only one of the fields `anytime`, `weeklyMaintenanceWindow`<br><br><p>A Greenplum® cluster weekly maintenance window.</p> 
