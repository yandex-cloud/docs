        ...
        labels:
          description: |-
            **object** (map<**string**, **string**>)
            ...
            To add a label, request the current set with the [ClusterService.Get](/docs/managed-greenplum/api-ref/Cluster/get#Get) method, then send an [ClusterService.Update](#Update) request with the new label added to the set.
          ...
          subnetId:
            description: |-
              **string**
              ...
              This subnet should be a part of the cloud network the cluster belongs to (see [Cluster.networkId](/docs/managed-greenplum/api-ref/Cluster/get#yandex.cloud.mdb.greenplum.v1.Cluster)).
              The maximum string length in characters is 50.
            type: string
          assignPublicIp:
            description: |-
