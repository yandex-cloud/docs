...
parallel | **string** (int64)<br><p>Redistribute process parallelism, 0 - for automatic detection</p> 
closeCluster | **boolean** (boolean)<br><p>Deny all client connections during the expand operation</p> 
delayRedistribution | **boolean** (boolean)<br><p>Perform redistribution process by small chunks as background activity</p> 
