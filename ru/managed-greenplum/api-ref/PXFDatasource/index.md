...
hdfs.<br>kerberos.<br>realm | **string**<br><p>Kerberos realm for a Greenplum® DB.</p> <p>The maximum string length in characters is 1000.</p> 
...
hdfs.<br>userImpersonation | **boolean** (boolean)<br><p>Enables authentication on behalf of the Greenplum® user when connecting to the remote file storage or DBMS.</p> <p>The authentication is disabled by default.</p> 
hdfs.<br>username | **string**<br><p>Login username for the remote file storage or DBMS if authentication on behalf of the Greenplum® user is enabled.</p> <p>The maximum string length in characters is 128.</p> 
...
hive.<br>kerberos.<br>realm | **string**<br><p>Kerberos realm for a Greenplum® DB.</p> <p>The maximum string length in characters is 1000.</p> 
