...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-greenplum/v1/changeFreezeLimits
    method: get
    path: null
    query:
      type: object
...
# Managed Service for Greenplum® API, REST: ChangeFreeze.GetLimits
...
```
GET https://{{ api-host-mdb }}/managed-greenplum/v1/changeFreezeLimits
```
