...
Для обеспечения работоспособности кластера {{ mgp-name }} и сетевой связности между его хостами необходимо наличие хотя бы в одной из его групп безопасности правил, разрешающих любой входящий и исходящий трафик.
