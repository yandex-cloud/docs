...
* Обновление между минорными версиями {{ GP }} вручную, например с 6.29.1 до 6.29.2. Такие обновления выполняются автоматически в рамках технического обслуживания.
