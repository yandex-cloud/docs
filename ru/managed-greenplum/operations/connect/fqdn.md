---
title: Получение FQDN хостов {{ mgp-name }}
description: Следуя данной инструкции, вы сможете получить FQDN хостов для подключения к базе данных в кластере {{ mgp-name }}.
---
