---
title: Примеры кода для подключения к кластеру {{ mgp-full-name }}
description: Следуя этим примерам, вы сможете подключиться к базе данных в кластере {{ mgp-name }} из кода вашего приложения.
---
