...
Хосты-мастеры не хранят и не обрабатывают данные — они занимаются только обработкой подключений и координацией работы сегментов и менее требовательны к производительности.
