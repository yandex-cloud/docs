...
description: 'Следуя данной инструкции, вы сможете управлять клиентскими процессами и сессиями пользователей: получать список процессов, отменять сессию пользователя, завершать определенный процесс, завершать соединение с базой данных, управлять нагрузкой.'
---
