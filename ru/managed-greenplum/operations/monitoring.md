...
description: Следуя этой инструкции, вы сможете получить детальную информацию о состоянии кластера {{ GP }} и провести диагностику.
---
...
## Дашборд Cluster {#monitoring-cluster}
...
- Консоль управления {#console}
    ...
    1. Нажмите на имя нужного кластера и выберите вкладку ![monitoring.svg](../../_assets/console-icons/display-pulse.svg) **{{ ui-key.yacloud.common.monitoring }}**.
        ...
        На открывшейся странице будет отображен дашборд с графиками и сигналами работы кластера {{ GP }}.
...
- Консоль управления {#console}
  ...
  1. Для составных сигналов рекомендуется устанавливать алерты на переход в статус `Crit` (значение `0`) или `Warn` (значение `1`).
