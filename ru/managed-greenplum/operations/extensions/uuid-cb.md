...
## Установить расширение uuid-cb в кластер {{ mgp-name }} {#uuid-cb-install}

1. [Подключитесь к базе данных](../connect/index.md) от имени владельца или пользователя, имеющего в базе данных разрешение `CREATE`, и выполните команду:
