...
- Консоль управления 
    ...
    1. В открывшемся окне выберите зону доступности `{{ region-id }}-c`. Нажмите кнопку **Зарезервировать**.
...
- Консоль управления 
  ...
  1. В [консоли управления]({{ link-console-main }}) откройте сервис **{{ certificate-manager-name }}**.
