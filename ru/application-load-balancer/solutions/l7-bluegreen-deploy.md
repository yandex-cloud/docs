...
По этому сценарию вы с помощью {{ alb-name }} организуете переключение между версиями сервиса по схеме <q>[сине-зеленого развертывания](https://martinfowler.com/bliki/BlueGreenDeployment.html)</q> (blue-green development).
