...
Подробнее об установке и использовании контроллера см. сценарий [{#T}](../../managed-kubernetes/tutorials/alb-ingress-controller.md) в документации {{ managed-k8s-name }}.
