...
listeners[].<br>http | **object**<br>HTTP listener settings. <br>`listeners[]` includes only one of the fields `http`, `tls`<br><br><p>An HTTP listener resource.</p> 
...
listeners[].<br>tls | **object**<br>HTTPS (HTTP over TLS) listener settings. <br>`listeners[]` includes only one of the fields `http`, `tls`<br><br><p>An HTTPS (HTTP over TLS) listener resource.</p> 
...
listeners[].<br>tls.<br>defaultHandler.<br>httpHandler | **object**<br>HTTP handler.<br><p>An HTTP handler resource.</p> 
...
listeners[].<br>tls.<br>sniHandlers[].<br>handler.<br>httpHandler | **object**<br>HTTP handler.<br><p>An HTTP handler resource.</p> 
