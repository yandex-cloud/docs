...
listenerSpecs[].<br>tls.<br>defaultHandler.<br>httpHandler | **object**<br>HTTP handler.<br><p>An HTTP handler resource.</p> 
...
listenerSpecs[].<br>tls.<br>sniHandlers[].<br>handler.<br>httpHandler | **object**<br>HTTP handler.<br><p>An HTTP handler resource.</p> 
