...
--- | ---
httpRouterId | <p>Required. ID of the HTTP router to return.</p> <p>To get the HTTP router ID, make a <a href="/docs/application-load-balancer/api-ref/HttpRouter/list">list</a> request.</p> 
