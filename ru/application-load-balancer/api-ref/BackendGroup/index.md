...
stream | **object** <br> includes only one of the fields `http`, `grpc`, `stream`<br><br><p>A stream (TCP) backend group resource.</p> 
stream.<br>backends[] | **object**<br><p>A stream (TCP) backend resource.</p> 
