...
# Application Load Balancer API, REST: BackendGroup methods
...
http.<br>backends[] | **object**<br><p>List of HTTP backends.</p> 
...
grpc.<br>backends[] | **object**<br><p>List of gRPC backends.</p> 
...
stream.<br>backends[] | **object**<br><p>List of stream (TCP) backends.</p> 
