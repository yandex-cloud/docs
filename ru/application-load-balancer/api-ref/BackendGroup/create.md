...
stream | **object**<br>List of Stream backends that the backend group consists of. <br> includes only one of the fields `http`, `grpc`, `stream`<br><br><p>A Stream backend group resource.</p> 
