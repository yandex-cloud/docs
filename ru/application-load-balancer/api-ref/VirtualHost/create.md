...
--- | ---
httpRouterId | Required. ID of the HTTP router to create a virtual host in.  To get the HTTP router ID, make a [list](/docs/application-load-balancer/api-ref/HttpRouter/list) request.
