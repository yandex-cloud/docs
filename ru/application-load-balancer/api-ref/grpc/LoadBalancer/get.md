---
editable: false
sourcePath: en/_api-ref-grpc/apploadbalancer/v1/api-ref/grpc/LoadBalancer/get.md
---
...
To get the list of all available application load balancers, make a [List](/docs/application-load-balancer/api-ref/grpc/LoadBalancer/list#List) request.

## gRPC request

**rpc Get ([GetLoadBalancerRequest](#yandex.cloud.apploadbalancer.v1.GetLoadBalancerRequest)) returns ([LoadBalancer](#yandex.cloud.apploadbalancer.v1.LoadBalancer))**

## GetLoadBalancerRequest {#yandex.cloud.apploadbalancer.v1.GetLoadBalancerRequest}
