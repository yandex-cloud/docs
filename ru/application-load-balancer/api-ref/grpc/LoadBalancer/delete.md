---
editable: false
sourcePath: en/_api-ref-grpc/apploadbalancer/v1/api-ref/grpc/LoadBalancer/delete.md
---

# Application Load Balancer API, gRPC: LoadBalancerService.Delete {#Delete}
