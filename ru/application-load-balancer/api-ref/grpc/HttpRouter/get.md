---
editable: false
sourcePath: en/_api-ref-grpc/apploadbalancer/v1/api-ref/grpc/HttpRouter/get.md
---

# Application Load Balancer API, gRPC: HttpRouterService.Get {#Get}
...
**rpc Get ([GetHttpRouterRequest](#yandex.cloud.apploadbalancer.v1.GetHttpRouterRequest)) returns ([HttpRouter](#yandex.cloud.apploadbalancer.v1.HttpRouter))**

## GetHttpRouterRequest {#yandex.cloud.apploadbalancer.v1.GetHttpRouterRequest}
