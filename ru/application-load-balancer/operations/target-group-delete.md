...
- CLI {#cli}
  ...
  1. Посмотрите описание команды [CLI](../../cli/) для удаления целевой группы:
...
- {{ TF }} {#tf}
  ...
  1. Примените изменения:
     ...
     Проверить изменения целевой группы можно в [консоли управления]({{ link-console-main }}) или с помощью команды [CLI](../../cli/):
