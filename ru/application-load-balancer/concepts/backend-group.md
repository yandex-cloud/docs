...
В группе типа **{{ ui-key.yacloud.alb.label_proto-http }}** бэкенды могут быть двух типов:
...
В группах типов **{{ ui-key.yacloud.alb.label_proto-grpc }}** и **{{ ui-key.yacloud.alb.label_proto-stream }}** бэкендами могут быть только целевые группы и их наборы.
