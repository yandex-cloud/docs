...
Просмотр статистики описан в инструкции [{#T}](../operations/application-load-balancer-get-stats.md).
...
Просмотр логов описан в инструкции [{#T}](../operations/application-load-balancer-get-logs.md).
