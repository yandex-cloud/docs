---
editable: false
sourcePath: en/_cli-ref/cli-ref/application-load-balancer/cli-ref/load-balancer/enable-zones.md
---
...
|`--zones`|<b>`value[,value]`</b><br/>Zones of the load balancer where to enable traffic routing, --zones zone-id1,zone-id2|
