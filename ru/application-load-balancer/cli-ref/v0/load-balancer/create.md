---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/application-load-balancer/cli-ref/v0/load-balancer/create/
---

# yc application-load-balancer v0 load-balancer create
...
`yc application-load-balancer v0 load-balancer create <LOAD-BALANCER-NAME> [Flags...] [Global Flags...]`
