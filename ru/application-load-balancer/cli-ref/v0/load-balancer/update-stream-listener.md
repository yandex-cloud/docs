---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/application-load-balancer/cli-ref/v0/load-balancer/update-stream-listener/
---

# yc application-load-balancer v0 load-balancer update-stream-listener
...
`yc application-load-balancer v0 load-balancer update-stream-listener <LOAD-BALANCER-NAME>|<LOAD-BALANCER-ID> [Flags...] [Global Flags...]`
