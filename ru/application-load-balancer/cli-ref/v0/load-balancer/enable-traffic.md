...
`yc application-load-balancer v0 load-balancer enable-traffic <LOAD-BALANCER-NAME>|<LOAD-BALANCER-ID> [Flags...] [Global Flags...]`
...
Zone of the load balancer where to enable traffic, --zone zone-id1 --zone=zone-id2 ||
|#
