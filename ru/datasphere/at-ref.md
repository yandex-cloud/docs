...
В {{ at-name }} поддерживается отслеживание событий уровня конфигурации (Control Plane) для {{ ml-platform-full-name }}. Подробнее на странице [{#T}](../audit-trails/concepts/format.md).
