...
Специальные фоновые операции позволяют выполнять асинхронный запуск последовательности операций.
...
* Исполнение такой операции может быть прервано, если в системе наблюдается дефицит машин нужной конфигурации. Когда вычислительные ресурсы освободятся, исполнение будет продолжено с последнего сохраненного результата. 
