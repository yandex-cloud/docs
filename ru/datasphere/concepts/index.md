...
В {{ ml-platform-name }} доступны разные [конфигурации](configurations.md) вычислительных ресурсов. По умолчанию проект запускается с минимальной конфигурацией <q>S</q> (32 ГБ RAM и 4 vCPU).
