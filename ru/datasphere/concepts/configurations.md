...
**g1.1** (доступна по запросу в техническую поддержку или при остатке на счете не менее {% if region == "ru" %}500 ₽{% endif %}{% if region == "int" %}10 ${% endif %}{% if region == "kz" %}3&nbsp;000 ₸{% endif %}) | 8 | 1
...
Имя | Количество vCPU на<br>[платформе AMD EPYC™](../../compute/concepts/gpus.md) | Количество GPU <br> [NVIDIA® Ampere® A100]{% if lang == "ru" %}(https://www.nvidia.com/ru-ru/data-center/a100/){% endif %}{% if lang == "en" %}(https://www.nvidia.com/en-us/data-center/a100/){% endif %}
---- | ---- | ----
