...
Имя | Количество vCPU на<br>[платформе AMD EPYC™](../../compute/concepts/gpus.md) | Количество GPU <br> [NVIDIA® Ampere® A100]{% if region =="int" %}(https://www.nvidia.com/en-us/data-center/a100/){% else %}(https://www.nvidia.com/ru-ru/data-center/a100/){% endif %}
---- | ---- | ----
