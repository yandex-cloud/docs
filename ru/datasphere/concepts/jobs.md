...
Для запуска задания необходимо [установить](../../cli/quickstart.md) и сконфигурировать [интерфейс командной строки {{ yandex-cloud }}](../../cli/). С его помощью выполняется аутентификация в {{ yandex-cloud }}.
