...
По этой же причине поменять конфигурацию для нескольких ячеек не получится без перезагрузки всего ноутбука. 

Вы можете иметь несколько конфигураций ВМ, закрепленных за одним проектом. При первом запуске вычислений в ноутбуке выберите, на какой конфигурации будут проводиться вычисления.
