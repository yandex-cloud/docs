...
Для балансировки нагрузки инстансы объединяются в _ноды_ — изолированные в собственном контуре группы виртуальных машин. Для доступа к ноде используется [API](../../../glossary/rest-api.md).
