...
Для балансировки нагрузки инстансы объединяются в _ноды_ — изолированные в собственном контуре группы виртульных машин. Для доступа к ноде используется API. 
