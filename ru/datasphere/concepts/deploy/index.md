...
Отправлять запросы в ноду могут пользователи и [сервисные аккаунты](../../../iam/concepts/users/service-accounts.md) с минимальной ролью в проекте `{{ roles-datasphere-project-developer }}`. Сервисный аккаунт должен быть создан в каталоге, указанном при создании ноды.
...
* Пользователи с минимальной ролью `{{ roles-datasphere-project-developer }}` в проекте.
* Сервисные аккаунты с минимальной ролью `{{ roles-datasphere-project-developer }}` в проекте либо созданные в каталоге, который был указан при создании алиаса.
