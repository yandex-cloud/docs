...
Чтобы создавать ресурсы и запускать проекты в IDE, к сообществу необходимо привязать [платежный аккаунт](../../billing/concepts/billing-account.md) {{ yandex-cloud }}. Как это сделать, смотрите [{#T}](../operations/community/link-ba.md).
