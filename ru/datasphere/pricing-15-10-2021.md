...
# Правила тарификации для {{ ml-platform-name }} c 15 октября 2021 года 

{% note warning %}

Правила тарификации, описанные на этой странице, действуют с 15 октября 2021 года. До 15 октября 2021 года будут действовать правила, описанные в разделе [{#T}](pricing.md).
...
### Хранение данных внутри проекта {{ ml-platform-name }} {#prices-storage}

#### Хранение данных проекта

{% note warning %}

С 15 декабря 2021 года за все проекты объемом больше 10 ГБ будет взиматься плата. Чтобы изменить объем диска, обратитесь в [техническую поддержку](../../support/). Уменьшение возможно до фактически занятого объема, округленного до целых ГБ.
