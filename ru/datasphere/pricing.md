...
С 15 декабря 2021 года за все проекты объемом больше {{ ml-project-size }} будет взиматься плата. Чтобы изменить объем хранилища проекта, обратитесь в [техническую поддержку](../../support/). Уменьшение возможно до фактически занятого объема, округленного до целых ГБ.
