...
На стадии Preview сервис не тарифицируется. Приведенные ниже тарифы начнут действовать с 1 октября 2020 года после перехода сервиса в [общедоступную версию](../overview/concepts/launch-stages.md).
