---
editable: false
sourcePath: en/_api-ref-grpc/datasphere/v2/api-ref/grpc/dataset_service.md
---
...
| Call | Description |
| --- | --- |
| [Activate](#Activate) | Activates shared dataset for project |
| [Deactivate](#Deactivate) | Deactivates shared dataset for project |

## Calls DatasetService {#calls}
...
Field | Description
--- | ---
dataset_id | **string**<br>Required.  The maximum string length in characters is 50.
