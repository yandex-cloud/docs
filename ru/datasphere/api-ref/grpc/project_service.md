...
| [GetRestrictions](#GetRestrictions) | Get current project restrictions. |
| [SetRestrictions](#SetRestrictions) | Set project restrictions. |
...
**rpc GetRestrictions ([GetProjectRestrictionsRequest](#GetProjectRestrictionsRequest)) returns ([RestrictionsResponse](#RestrictionsResponse))**

### GetProjectRestrictionsRequest {#GetProjectRestrictionsRequest}
...
**rpc SetRestrictions ([SetProjectRestrictionsRequest](#SetProjectRestrictionsRequest)) returns ([operation.Operation](#Operation10))**

Response of Operation:<br>
	&nbsp;&nbsp;&nbsp;&nbsp;Operation.response:[RestrictionsResponse](#RestrictionsResponse1)<br>

### SetProjectRestrictionsRequest {#SetProjectRestrictionsRequest}
