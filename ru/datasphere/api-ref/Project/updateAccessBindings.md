...
editable: false
apiPlayground:
  - url: https://datasphere.{{ api-host }}/datasphere/v2/projects/{resourceId}:updateAccessBindings
    method: patch
    path:
      type: object
      properties:
...
```
PATCH https://datasphere.{{ api-host }}/datasphere/v2/projects/{resourceId}:updateAccessBindings
```
