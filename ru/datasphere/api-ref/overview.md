...
Для управления ресурсами в [API {{ yandex-cloud }}](https://github.com/yandex-cloud/cloudapi) определен набор методов [gRPC](grpc/index) и [REST](index). Особенности их реализации и взаимодействия см. в [Документации API {{ yandex-cloud }}](../../api-design-guide/concepts/standard-methods).
...
Подробную информацию о методах `ProjectService` см. в [API-документации](grpc/project_service).
...
**Пример**. Загрузка файла из проекта:
  ...
  ```
Подробную информацию о методах `ProjectDataService` см. в [API-документации](grpc/project_data_service).
...
* [Настроить ограничения вычислений для проекта](../operations/projects/custom-limits)
* [Настроить ограничения вычислений для каталога](../operations/projects/set-ds-budget)

Подробную информацию о методах см. в API-документации [ProjectService](grpc/project_service) и [FolderBudgetService](grpc/folder_budget_service).
