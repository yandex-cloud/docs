...
* Для сервисных аккаунтов необходима роль `{{ roles-datasphere-project-developer }}` в проекте либо сервисный аккаунт должен быть создан в каталоге, указанном при создании алиаса.
