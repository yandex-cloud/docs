...
1. Создайте ноду:
    ...
    1. В зависимости от типа ноды задайте прочие параметры:
        ...
        - Ячейка
          ...
          * В блоках **Входные переменные** и **Выходные переменные** определите имена и типы выходных и входных переменных, на основе которых будет автоматически сгенерирован {% if lang == "ru" and audience != "internal" %}[API](../../../glossary/rest-api.md){% else %}API{% endif %}. Вы можете добавить переменные, нажимая кнопку ![Add](../../../_assets/plus.svg) **Добавить**.
