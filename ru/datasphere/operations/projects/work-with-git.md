...
1. В новом окне введите имя пользователя, выберите секрет, содержащий токен доступа к GitHub, и нажмите **Submit**.
...
1. Сопоставьте локальный репозиторий с удаленным репозиторием GitHub.
   ...
   * `<персональный_токен_доступа>` — содержимое секрета с токеном для доступа на GitHub.
