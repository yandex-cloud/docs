...
description: Следуя данной инструкции, вы сможете использовать в своем проекте ресурс, доступный всему сообществу.
---
...
Чтобы поделиться ресурсом в сообществе, понадобятся роли `Editor` в проекте и `Developer` в сообществе. Подробнее о ролях, действующих в {{ ml-platform-name }}, читайте в разделе [{#T}](../../security/index.md).
