...
Необходимый суммарный объем SSD-дисков для разных конфигураций можно расчитать по формуле:

```
<количество хостов Data Proc> * 256 + 128
```

Тип кластера | Количество хостов | Объем SSD-дисков
------------ | :---------------: | ----------------
S-кластер | 4 | 1 152 ГБ
M-кластер | 8 | 2 176 ГБ
L-кластер | 16 | 4 224 ГБ
XL-кластер | 32 | 8 320 ГБ
