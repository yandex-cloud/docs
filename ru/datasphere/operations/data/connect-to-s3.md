...
Вы можете управлять подключением к объектному хранилищу {% if lang == "ru" and audience != "internal" %}[S3](../../../glossary/s3.md){% else %}S3{% endif %} в интерфейсе {{ ml-platform-name }} на странице проекта с помощью ресурса **Коннектор S3**.
