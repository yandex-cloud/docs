...
Обучение модели — ресурсоемкая операция, и для ее эффективного выполнения [конфигурация вычислительных ресурсов](../concepts/configurations.md) повышается до **M**.
