...
- REST API {#rest-api}
   ...
   Выполните HTTP-запрос, указав полученный ранее API-ключ или IAM-токен и [идентификатор каталога](../../resource-manager/operations/folder/get-id.md) вашего сервисного аккаунта:
