...
Параметры и примеры поисковых запросов с использованием [{{ ml-sdk-full-name }}](./index.md#sdk) см. в разделе [{#T}](../operations/search-images.md).

{% endnote %}

### Формат тела API-запроса {#request-body-format}
...
Параметры и примеры поисковых запросов с использованием [{{ ml-sdk-full-name }}](./index.md#sdk) см. в разделе [{#T}](../operations/search-images-by-pic.md).

{% endnote %}

### Формат тела API-запроса {#request-body-by-pic}
