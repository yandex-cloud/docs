...
{{ message-queue-full-name }} предоставляет HTTP {% if lang == "ru" and audience != "internal" %}[API](../../glossary/rest-api.md){% else %}API{% endif %}, частично совместимый с Amazon SQS API.
