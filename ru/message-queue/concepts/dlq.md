...
В настоящий момент настроить очередь DLQ можно только с помощью [API](../api-ref/index.md) и AWS CLI. Поддержка настройки DLQ будет добавлена в консоль управления позже.
