...
Чтобы настроить скрытие сообщений из очереди при отправке, задайте параметр <q>Задержка доставки</q> при [создании очереди](../operations/message-queue-new-queue.md) или измените его у существующей очереди. Максимальное время задержки доставки сообщений — 15 минут.
