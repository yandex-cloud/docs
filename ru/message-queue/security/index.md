---
title: Управление доступом в Yandex Message Queue
description: "Управление доступом в сервисе для обмена сообщениями между приложениями Yandex Message Queue. Чтобы разрешить доступ к ресурсам сервиса Yandex Message Queue, назначьте пользователю нужные роли из приведенного списка."
