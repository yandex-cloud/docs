...
* [эндпоинт-источник](#source);
* [эндпоинт-приемник](#destination);
* [трансфер](#transfer).

## Создать эндпоинт-источник {#source}
...
- Консоль управления
  ...
  1. Выберите тип базы данных **YDS**.
...
## Создать эндпоинт-приемник {#destination}
