...
На стадии [Preview](../overview/concepts/launch-stages.md) использование сервиса {{ yds-full-name }} не тарифицируется.

После перехода сервиса в общий доступ c **24 сентября 2021** потребление станет платным.

## Из чего складывается стоимость использования {{ yds-short-name }} {#rules}

В рамках сервиса {{ yds-short-name }} тарифицируется количество единиц записываемых данных и ресурсы, выделенные для обслуживания потоков данных.
...
Цена за 1 месяц использования выделенных ресурсов:
