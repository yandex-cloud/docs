...
- Python
  ...
  * Идентификатор существующей [бессерверной](../../../managed-ydb/pricing/serverless.md) базы данных {{ ydb-full-name }}, например `cc8028jgtuabcqutgtbv`. Как создать новую базу данных, читайте в [документации {{ ydb-short-name }}][](../../../managed-ydb/quickstart.md#create-db).
