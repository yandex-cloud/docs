...
![basic-design](../../_assets/data-streams/example-basic-design.png)
...
![basic-design](../../_assets/data-streams/example-yds-design.png)

## Если порядок обработки не важен {#not-order}

Для некоторых задач порядок обработки сообщений не критичен. Например, при [вводе данных в системы хранения](../solutions/data-ingestion.md) важно доставить данные, а упорядочение выполнит система хранения.
