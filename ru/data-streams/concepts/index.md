...
* Все компоненты являются полностью управляемыми, то есть не требуют администрирования или выделенных {% if lang == "ru" %}[DevOps](https://cloud.yandex.ru/blog/posts/2022/03/what-is-devops){% else %}DevOps{% endif %}-инженеров.