...
Данные, которые переносятся через шину, можно с помощью [{{ data-transfer-full-name }}](../../data-transfer/concepts/index.md) сохранять в принимающие системы – [S3](../../glossary/s3.md), {{ CH }} и другие. Настройка параметров переноса производится в консоли управления {{ yandex-cloud }} или через [API](../../glossary/rest-api.md).
...
* Все компоненты являются полностью управляемыми, то есть не требуют администрирования или выделенных [DevOps](/blog/posts/2022/03/what-is-devops)-инженеров.
