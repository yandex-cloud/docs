---
editable: false
sourcePath: en/_api-ref-grpc/lockbox/v1/api-ref/grpc/Secret/delete.md
---

# Lockbox API, gRPC: SecretService.Delete {#Delete}

Deletes the specified secret.

## gRPC request

**rpc Delete ([DeleteSecretRequest](#yandex.cloud.lockbox.v1.DeleteSecretRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## DeleteSecretRequest {#yandex.cloud.lockbox.v1.DeleteSecretRequest}
...
Required field. ID of the secret to be deleted. ||
|#
...
|| metadata | **[DeleteSecretMetadata](#yandex.cloud.lockbox.v1.DeleteSecretMetadata)**
...
## DeleteSecretMetadata {#yandex.cloud.lockbox.v1.DeleteSecretMetadata}
