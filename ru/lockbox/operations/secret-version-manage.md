...
- {{ TF }}
  ...
  1. Опишите в конфигурационном файле параметры ресурсов, которые необходимо создать:
     ...
     * `entries` — блок с параметрами секрета. Для каждого секрета необходимо создать отдельный блок `entries`. Может содержать следующие параметры:
      ...
      Более подробную информацию о параметрах ресурса `yandex_lockbox_secret_version` в Terraform, см. в [документации провайдера]({{ tf-provider-link }}/lockbox_secret_version).
