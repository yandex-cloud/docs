...
1. Откройте бакет в консоли управления и скопируйте ссылку на него из адресной строки. Ссылка на бакет имеет формат:
    ...
    ```
1. Отправьте на почту вашему менеджеру или [службе поддержки](https://console.cloud.yandex.ru/support/create-ticket) заявку на включение детализации биллинга по каталогам и укажите:
