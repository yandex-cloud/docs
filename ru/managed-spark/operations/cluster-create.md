...
- Консоль управления {#console}
    ...
    1. Задайте вычислительные ресурсы, на которых будут запускаться Spark-приложения:
       ...
       * Конфигурация драйвера — количество хостов для драйвера (driver). Может быть фиксированным или автомасштабируемым.
       * Конфигурация исполнителя — количество хостов для исполнителя (executor). Может быть фиксированным или автомасштабируемым.
       ...
       * `config` — конфигурация кластера:
           ...
           * `resource_pools` — конфигурация пулов ресурсов:
               ...
               * `driver` — конфигурация хостов для запуска драйверов {{ SPRK }}.
                   ...
                   * `resource_preset_id` — идентификатор ресурсов драйвера.
               ...
               * `executor` — конфигурация хостов для запуска исполнителей {{ SPRK }}.
                   ...
                   * `resource_preset_id` — идентификатор ресурсов исполнителя.
