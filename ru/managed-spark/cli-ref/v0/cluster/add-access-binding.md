---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/managed-spark/cli-ref/v0/cluster/add-access-binding
editable: false
---
...
`yc managed-spark cluster add-access-binding <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
