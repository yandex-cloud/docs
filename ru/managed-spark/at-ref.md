...
В {{ at-name }} поддерживается отслеживание событий уровня конфигурации (Control Plane) для {{ msp-full-name }}. Подробнее на странице [{#T}](../audit-trails/concepts/format.md).
