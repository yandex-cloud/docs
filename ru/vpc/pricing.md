...
Услуга предоставляется при наличии технической возможности. Цены на услугу Yandex Cloud Interconnect предоставляются по запросу и зависят от технических характеристик соединения с {{ yandex-cloud }}.

### Исходящий трафик {#prices-traffic}

Исходящий трафик от ресурсов {{ yandex-cloud }} тарифицируется в рамках соответствующих сервисов. Стоимость исходящего трафика одинакова для всех сервисов.
