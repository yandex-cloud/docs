...
При создании каталога в нем автоматически создается одна облачная сеть. Помимо облачной сети по умолчанию вы можете создавать дополнительные облачные сети.
