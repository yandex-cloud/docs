...
### Создание облачной сети в указанном каталоге {#create-network-with-folder-id}

---

**[!TAB CLI]**

Чтобы создать облачную сеть в выбранном каталоге, c помощью флага `--folder-id` укажите идентификатор нужного каталога:
