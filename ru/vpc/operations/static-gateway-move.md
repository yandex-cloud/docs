...
Облачные ресурсы можно переносить между каталогами.
...
- Консоль управления
  ...
  1. Нажмите значок ![image](../../_assets/options.svg) в строке NAT-шлюза, который требуется переместить, и выберите **Переместить**.
