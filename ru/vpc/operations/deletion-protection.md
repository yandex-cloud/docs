---
title: Настроить защиту от удаления в {{ vpc-full-name }}
description: Чтобы предотвратить случайное удаление статического публичного IP-адреса, включите для него защиту от удаления.
---
...
- Консоль управления {#console}
  ...
  1. В [консоли управления]({{ link-console-main }}) выберите каталог, в котором зарезервирован адрес.
...
- API {#api}
  ...
  * Идентификатор адреса, для которого нужно включить защиту, в параметре `addressId`.
