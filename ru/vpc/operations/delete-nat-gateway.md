---
title: Как удалить NAT-шлюз в {{ vpc-full-name }}
description: Следуя данной инструкции, вы сможете удалить NAT-шлюз.
---
...
- Консоль управления {#console}
  ...
  1. В открывшемся списке найдите таблицу маршрутизации, у которой в колонке **{{ ui-key.yacloud.vpc.route-tables.column_static-routes }}** указан нужный NAT-шлюз.
  1. В строке с нужной таблицей нажмите на значок ![image](../../_assets/console-icons/ellipsis.svg) и выберите **{{ ui-key.yacloud.common.edit }}**.
...
Перед удалением NAT-шлюза [отвяжите его](#unlink-nat-gateway) от всех таблиц маршрутизации, к которым он привязан.
...
- Консоль управления {#console}
  ...
  1. Нажмите на значок ![image](../../_assets/console-icons/ellipsis.svg) в строке с именем нужного NAT-шлюза и выберите **{{ ui-key.yacloud.common.delete }}**.
