...
* Приоритет 3. При получении анонса для маршрута по-умолчанию `0.0.0.0/0` из [Cloud Interconnect](../../interconnect/concepts/routing.md#cic-routing-default-as) такой маршрут будет считаться наименее приоритетным, относительно маршрутов с приоритетами 1 и 2.
