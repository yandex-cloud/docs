...
* любой входящий (`ingress`) сетевой трафик.

{% note warning %}

Группа безопасности по умолчанию разрешает весь входящий трафик с любых IPv4-адресов. Для рабочих ресурсов, особенно с публичными IP-адресами, [создайте](../operations/security-group-create.md) пользовательскую группу безопасности и разрешите в ней только необходимый трафик.
