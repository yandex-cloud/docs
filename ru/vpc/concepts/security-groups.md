...
Для работы [проверок состояния](../../load-balancer/concepts/health-check.md) ресурсов, подключенных к сетевому балансировщику, необходимо разрешить передачу трафика между диапазонами адресов `198.18.235.0/24` и `198.18.248.0/24` и целевыми ресурсами.
