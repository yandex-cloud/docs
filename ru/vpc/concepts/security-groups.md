...
* Назначается виртуальным машинам при подключении к подсетям новой сети, если у них нет ни одной группы безопасности. 
    ...
    При этом автоматически назначенная группа безопасности не отображается в явном виде в ответах API и CLI при запросе информации об интерфейсе виртуальной машины, кластере управляемой базы данных или Managed Service for Kubernetes.
