...
### Правила группы безопасности по умолчанию {#rules}

Группа безопасности по умолчанию создается со следующими правилами:
* Исходящий трафик:
  * Группа безопасности: `Разрешен любой исходящий трафик`.
* Входящий трафик: 
  * Группа безопасности: `Разрешен любой входящий трафик`.
  * CIDR: `0.0.0.0/0` и порт `22`. Для SSH-соединений.
  * CIDR: `0.0.0.0/0` и порт `3389`. Для RDP-соединений.
