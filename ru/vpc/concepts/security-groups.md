...
Подробнее о [создании групп безопасности](../operations/security-group-create.md).
...
Подробнее об [изменении правил групп безопасности](../operations/security-group-update.md).
