...
Публичные IP-адреса не резервируются: например, если виртуальная машина останавливается, то она теряет свой публичный IP-адрес. При повторном подключении виртуальная машина может получить другой публичный адрес.
