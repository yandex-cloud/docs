...
Чтобы публичный IP-адрес не сбрасывался и не менялся, его следует [сделать статическим](../operations/set-static-ip.md). Если вид адреса изменен на статический, то снова сделать его динамическим нельзя.
