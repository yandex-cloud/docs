...
Выше представлена общая схема того, как устроена взаимосвязь между сетями, подсетями и ресурсами {{ yandex-cloud }}. В консоли управления вы можете открыть [карту инфраструктуры](../../console/concepts/infrastructure-map.md), которая, по аналогии со схемой выше, отображает взаимосвязи ваших ресурсов в выбранном каталоге.
