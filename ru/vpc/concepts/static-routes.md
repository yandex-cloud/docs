...
1. Построение сетевого маршрута до нужной подсети через одну виртуальную машину. В качестве идентификатора виртуальной машины используется внутренний IP-адрес. Подробнее о построении маршрутов между сетью в {{ yandex-cloud }} и другими виртуальными или локальными сетями читайте в сценариях использования [{#T}](../../solutions/routing/nat-instance.md) и [{#T}](../../solutions/routing/ipsec-vpn.md).
