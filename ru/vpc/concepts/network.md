...
Яндекс.Облако может открыть порт 25 по запросу в поддержку, если вы соблюдаете [Правила допустимого использования](https://yandex.ru/legal/cloud_aup/). При этом Яндекс.Облако всегда может снова заблокировать исходящий трафик на порту 25, если вы нарушите Правила.
