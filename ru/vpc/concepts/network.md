...
Для виртуальных машин [!KEYREF compute-full-name] и хостов баз данных доступ из интернета и в интернет открыт через публичные IP-адреса. 

### Фильтрация исходящего трафика {#egress-traffic-filter}

В Яндекс.Облаке всегда блокируется исходящий трафик на порты 25 и 465:
