...
# Virtual Private Cloud API, gRPC: SecurityGroupService.ListOperations
...
results is larger than `page_size`, the service returns a [ListSecurityGroupOperationsResponse.next_page_token](#yandex.cloud.vpc.v1.ListSecurityGroupOperationsResponse)
that can be used to get the next page of results in subsequent list requests.
Default value: 100. ||
|| page_token | **string**

Page token. To get the next page of results, set `page_token` to the
[ListSecurityGroupOperationsResponse.next_page_token](#yandex.cloud.vpc.v1.ListSecurityGroupOperationsResponse) returned by a previous list request. ||
|#
