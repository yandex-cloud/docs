...
--- | ---
addressId | Required. ID of the address to update.  To get the address ID make a [list](/docs/vpc/api-ref/Address/list) request.  The maximum string length in characters is 50.
