        ...
        pageSize:
          description: |-
            **string** (int64)
            ...
            results is larger than `page_size`, the service returns a [ListAddressesResponse.nextPageToken](/docs/vpc/api-ref/Address/list#yandex.cloud.vpc.v1.ListAddressesResponse)
        ...
        pageToken:
          description: |-
            **string**
            ...
            [ListAddressesResponse.nextPageToken](/docs/vpc/api-ref/Address/list#yandex.cloud.vpc.v1.ListAddressesResponse) returned by a previous list request.
          type: string
        filter:
          description: |-
            **string**
            ...
            1. The field name. Currently you can use filtering only on [Address.name](/docs/vpc/api-ref/Address/get#yandex.cloud.vpc.v1.Address) field.
            2. An `=` operator.
