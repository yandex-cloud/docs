...
## HTTP-запрос
`DELETE /vpc/v1/subnets/{subnetId}`
 
## Path-параметры {#path_params}
 
Name | Description
--- | ---
subnetId | Обязательное поле. Идентификатор удаляемой подсети. Чтобы получить идентификатор подсети, используйте запрос [list](/docs/vpc/api-ref/Subnet/list).  Максимальная длина — 50 символов.
