...
--- | ---
subnetId | Required. ID of the Subnet resource to list operations for.  The maximum string length in characters is 50.
 
## Query parameters {#query_params}
 
Parameter | Description
--- | ---
pageSize | The maximum number of results per page that should be returned. If the number of available results is larger than [pageSize](/docs/vpc/api-ref/Subnet/listOperations#query_params), the service returns a [nextPageToken](/docs/vpc/api-ref/Subnet/listOperations#responses) that can be used to get the next page of results in subsequent list requests. Default value: 100.  The maximum value is 1000.
pageToken | Page token. To get the next page of results, set [pageToken](/docs/vpc/api-ref/Subnet/listOperations#query_params) to the [nextPageToken](/docs/vpc/api-ref/Subnet/listOperations#responses) returned by a previous list request.  The maximum string length in characters is 100.
