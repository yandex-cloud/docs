...
Поле | Описание
--- | ---
subnets | **object**<br><p>Ресурс Subnet. Подробнее см. <a href="/docs/vpc/concepts/subnets">Subnets</a>.</p> 
...
subnets.<br>labels | **object**<br><p>Метки ресурса в формате <code>ключ:значение</code>. Максимум 64 метки на ресурс.</p> 
