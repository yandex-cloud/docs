...
## HTTP-запрос
`PATCH /vpc/v1/subnets/{subnetId}`
 
## Path-параметры {#path_params}
 
Name | Description
--- | ---
subnetId | Обязательное поле. Идентификатор обновляемого ресурса Subnet.  Максимальная длина — 50 символов.
...
name | **string**<br><p>Имя подсети. Имя должно быть уникальным в каталоге.</p> <p>Значение должно быть длиной от 3 до 63 символов и соответствовать регулярному выражению <code>^[a-z][-a-z0-9]{1,61}[a-z0-9]$</code>.</p> 
description | **string**<br><p>Описание подсети.</p> <p>Максимальная длина — 256 символов.</p> 
