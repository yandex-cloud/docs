...
Поле | Описание
--- | ---
networks | **object**<br><p>Ресурс Network. Подробнее см. <a href="/docs/vpc/concepts/network">Networks</a>.</p> 
...
networks.<br>createdAt | **string** (date-time)<br><p>Время создания ресурса в формате в <a href="https://www.ietf.org/rfc/rfc3339.txt">RFC3339</a>.</p> 
