...
Зарезервированный статический публичный IP-адрес оплачивается, даже если он не привязан к ВМ. Подробнее в разделе [Правила тарификации для {{ vpc-name }}](pricing.md).
