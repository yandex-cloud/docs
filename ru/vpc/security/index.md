---
title: Управление доступом в Yandex Virtual Private Cloud (VPC)
description: "Управление доступом в сервисе облачных сетей (частного облака), а также связи облачных ресурсов между собой и с интернетом — Yandex Virtual Private Cloud (VPC). В разделе описано, на какие ресурсы можно назначить роль, какие роли действуют в сервисе, какие роли необходимы для того или иного действия."
---
