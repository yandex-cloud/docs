---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/vpc/cli-ref/v0/subnet/create/
---

# yc vpc v0 subnet create
...
`yc vpc v0 subnet create <SUBNET-NAME> [Flags...] [Global Flags...]`
