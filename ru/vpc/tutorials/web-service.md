...
- Консоль управления 
    ...
    1. В блоке **Образы из {{ marketplace-name }}** нажмите кнопку **Выбрать** и выберите образ [Drupal](/marketplace/products/f2e90bncf96u25a9cirp).
...
- Консоль управления 
    ...
    1. Выберите зону доступности `{{ region-id }}-a`.
    1. В блоке **Образы из {{ marketplace-name }}** нажмите кнопку **Выбрать** и выберите образ [IPSec-инстанс](/marketplace/products/f2e70ohdvsd0jgp2302j).
