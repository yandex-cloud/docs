...
Балансировщик Яндекс.Облака работает на 3-м уровне сетевой модели OSI и балансирует TCP трафик. Адресация трафика строится по принципу 5-tuple: учитывается адрес и порт отправителя, адрес и порт принимающего облачного ресурса и протокол передачи информации. 
