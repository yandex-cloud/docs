...
type | **[NetworkLoadBalancer.Type](../network_load_balancer.proto#NetworkLoadBalancer2)**<br>Обязательное поле. Тип балансировщика. В настоящее время доступны только внешние балансировщики. 
...
protocol | **[Listener.Protocol](../network_load_balancer.proto#Listener2)**<br>Обязательное поле. Сетевой протокол для входящего трафика. 
...
attached_target_group | **[AttachedTargetGroup](../network_load_balancer.proto#AttachedTargetGroup4)**<br>Обязательное поле. Идентификатор целевой группы для подключения к балансировщику. Чтобы получить идентификатор балансировщика, используйте запрос [NetworkLoadBalancerService.List](#List). 
...
Поле | Описание
--- | ---
target_states[] | **[TargetState](../network_load_balancer.proto#TargetState)**<br>Список состояний ресурсов в целевой группе, указанных в сообщении [GetTargetStatesRequest](#GetTargetStatesRequest) . 
