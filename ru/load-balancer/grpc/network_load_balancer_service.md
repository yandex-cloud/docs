...
attached_target_group | **[AttachedTargetGroup](#AttachedTargetGroup4)**<br>Обязательное поле. Идентификатор целевой группы для подключения к балансировщику. Чтобы получить идентификатор балансировщика, используйте запрос [NetworkLoadBalancerService.List](#List). 
...
listener_spec | **[ListenerSpec](#ListenerSpec2)**<br>Обязательное поле. Спецификация обработчика. 
