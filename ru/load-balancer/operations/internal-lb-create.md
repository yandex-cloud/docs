...
- API
  ...
  Создать внутренний балансировщик можно с помощью метода API [create](../api-ref/NetworkLoadBalancer/create.md).
...
### Создание внутреннего балансировщика без обработчика {#without-listener}
...
### Создание внутреннего балансировщика с обработчиком и подключенной целевой группой {#with-listener-and-target-group}
