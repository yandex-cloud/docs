...
Назначьте сервисному аккаунту роль `video.admin` или `video.editor` на организацию. Подробнее в разделе [{#T}](../security/index.md).
...
- Интерфейс {{ cloud-center }} {#cloud-center}
  ...
  1. Нажмите кнопку ![plus](../../_assets/console-icons/plus.svg) **{{ ui-key.yacloud_components.acl.button.add-role }}** и выберите роль `video.admin` или `video.editor`.
