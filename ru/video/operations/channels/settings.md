...
1. Отправьте запрос на добавление видеоресурса через [службу поддержки](https://yandex.ru/support2/partner/ru/support).
    ...
    Подробнее в документации Яндекса: [Новым партнерам](https://yandex.ru/support2/partner/ru/joining/) и [Создание видеоресурса](https://yandex.ru/support2/partner/ru/video/resource).
