---
title: Как отозвать доступ к трансляции в {{ video-full-name }}
description: Следуя данной инструкции, вы сможете отозвать доступ к трансляции в сервисе {{ video-full-name }}.
---
