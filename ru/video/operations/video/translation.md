---
title: Как управлять нейропереводом в {{ video-full-name }}
description: Следуя данной инструкции, вы сможете управлять нейропереводом в сервисе {{ video-full-name }}.
---
