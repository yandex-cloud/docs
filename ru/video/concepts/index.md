...
Также можно монетизировать свой видеоконтент с помощью [рекламной сети Яндекса](https://yandex.ru/support2/partner/ru/yan-rules/video). Монетизацию необходимо [включить](../operations/video/update.md) отдельно для каждого видео.
...
* [{#T}](../hosting.md)
* [{#T}](../streaming.md)
* [Как работать с видео без своей инфраструктуры: шесть сценариев {{ video-full-name }}](https://yandex.cloud/ru/blog/cloud-video-use-cases)
