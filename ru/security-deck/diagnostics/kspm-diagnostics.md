---
title: Какие ошибки возникают при работе с модулем Контроль {{ k8s }} ({{ kspm-name }}) в {{ sd-full-name }}
description: Из статьи вы узнаете, какие бывают ошибки в работе модуля Контроль {{ k8s }} ({{ kspm-name }}).
---
