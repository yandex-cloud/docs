---
title: Сервисные роли модуля {{ alerts-name }} в {{ sd-full-name }}
description: На данной странице приведен список сервисных ролей для управления доступом к модулю {{ alerts-name }} в сервисе {{ sd-full-name }}.
---
