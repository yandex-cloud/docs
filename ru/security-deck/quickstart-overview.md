...
Сканирование может запускаться автоматически при загрузке образа в реестр, по расписанию или при использовании образа в кластере {{ k8s }}. Модуль интегрирован с KSPM для определения запущенных образов и отображения информации о том, какие образы с уязвимостями используются в проверяемом окружении.
