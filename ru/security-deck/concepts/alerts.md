...
На странице алертов от модулей [{{ cspm-name }}](./cspm.md) и [{{ kspm-name }}](./kspm.md) вы можете [создать исключение](../operations/alerts/work.md#create-exception). Если алерт затрагивает несколько ресурсов, можно создать исключение сразу для нескольких ресурсов.
...
* Быстро находить алерты определенного типа или с определенной проблемой.
