---
title: Стандарт безопасности ИИ-систем в {{ yandex-cloud }}
description: В этом разделе приведен список правил контроля, которые входят в стандарт безопасности ИИ-систем в {{ yandex-cloud }}.
---
...
#|
|| Идентификатор требования | Требование [стандарта безопасности](../../../security/standard-ai/all.md) | Идентификатор проверки в [модуле {{ cspm-name }}](../cspm.md) ||
...
|| `AI-IAM4` | [Вызов {{ ai-studio-full-name }} использует документированный способ аутентификации](../../../security/standard-ai/all.md#ai-studio-call-uses-documented-auth)
|
