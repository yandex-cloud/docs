...
|| **7.2.1. Подпроцесс «Управление учетными записями и правами субъектов логического доступа»** {.cell-align-center} | > ||
...
|| **7.2.2. Подпроцесс «Идентификация, аутентификация, авторизация (разграничение доступа) при осуществлении логического доступа»** {.cell-align-center} | > ||
...
|| **7.2.4. Подпроцесс «Идентификация и учет ресурсов и объектов доступа»** {.cell-align-center} | > ||
...
|| РД.30–РД.31; ИУ.7–ИУ.8 | [cspm.access.bucket-access-policy](../../rules-reference/cspm.md#bucket-access-policy) ||
|| **7.3.1. Подпроцесс «Сегментация и межсетевое экранирование вычислительных сетей»** {.cell-align-center} | > ||
...
|| СМЭ.16–СМЭ.19; ИУ.7–ИУ.8 | [cspm.access.bucket-public-access](../../rules-reference/cspm.md#bucket-public-access) ||
|| **7.3.2. Подпроцесс «Выявление вторжений и сетевых атак»** {.cell-align-center} | > ||
...
|| **7.3.3. Подпроцесс «Защита информации, передаваемой по вычислительным сетям»** {.cell-align-center} | > ||
...
[cspm.appsec.cdn-https](../../rules-reference/cspm.md#cdn-https)
||
|| **7.4.2. Подпроцесс «Контроль уязвимостей»** {.cell-align-center} | > ||
...
|| **7.4.3. Подпроцесс «Организация и контроль размещения, хранения и обновления ПО»** {.cell-align-center} | > ||
|| ЦЗИ.16 | [cspm.db.db-deletion-protection](../../rules-reference/cspm.md#db-deletion-protection) ||
|| ЦЗИ.1–ЦЗИ.11; ЦЗИ.20–ЦЗИ.26 | [cspm.k8s.secure-configuration](../../rules-reference/cspm.md#secure-configuration) ||
|| ЦЗИ.1–ЦЗИ.11; ЦЗИ.20–ЦЗИ.26 | [cspm.o11y.gitlab-audited](../../rules-reference/cspm.md#gitlab-audited) ||
|| **7.4.4. Подпроцесс «Контроль состава и целостности ПО информационной инфраструктуры»** {.cell-align-center} | > ||
...
||
|| **7.5. Процесс 4 «Защита от вредоносного кода»** {.cell-align-center} | > ||
...
|| **7.7.1. Подпроцесс «Мониторинг и анализ событий защиты информации»** {.cell-align-center} | > ||
|| МАС.1–МАС.9 |
...
|| **6.12. Общие положения по применению СКЗИ** {.cell-align-center} | > ||
|| РЗИ.14 |
