...
В {{ sd-full-name }} проверка соответствия контролируемой инфраструктуры требованиям отраслевых стандартов и нормативных актов в сфере безопасности выполняется модулями [{{ cspm-name }}](./cspm.md) и [KSPM](./kspm.md), которые проверяют соответствие инфраструктуры определенным наборам требований безопасности. Каждому отраслевому стандарту безопасности и нормативному акту соответствует свой [набор требований](#security-rule-sets).
