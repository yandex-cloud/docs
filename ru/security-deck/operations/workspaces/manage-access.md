...
- Интерфейс {{ sd-name }} {#cloud-sd}
  ...
  1. Чтобы изменить права доступа к окружению для пользователя:
      ...
      1. В строке с нужным пользователем нажмите значок ![ellipsis](../../../_assets/console-icons/ellipsis.svg) и выберите ![pencil](../../../_assets/console-icons/pencil.svg) **{{ ui-key.yacloud.common.resource-acl.button_assign-binding }}**. В открывшемся окне:
