---
title: Изменение пользовательского набора правил в {{ sd-full-name }}
description: В данном разделе вы узнаете, как в {{ sd-full-name }} изменить пользовательский набор правил.
---

# Изменить пользовательский набор правил
