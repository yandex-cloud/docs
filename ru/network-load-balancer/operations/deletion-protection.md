---
title: Настроить защиту от удаления в {{ network-load-balancer-full-name }}
description: Чтобы предотвратить случайное удаление сетевого балансировщика, включите для него защиту от удаления.
---
