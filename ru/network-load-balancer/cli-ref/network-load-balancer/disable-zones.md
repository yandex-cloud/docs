---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/load-balancer/cli-ref/network-load-balancer/disable-zones/
---
...
Zones of the network load balancer to disable. ||
|| `--duration` | `duration`
