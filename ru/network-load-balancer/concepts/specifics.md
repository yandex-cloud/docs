...
Ниже на схеме представлен пример работы клиентского приложения из Интернет веб-сервисом в {{ yandex-cloud }}


![NLB](../../_assets/network-load-balancer/nlb-flows.svg)


Путь трафика от клиентского приложения к веб-сервису проходит следующий путь:
