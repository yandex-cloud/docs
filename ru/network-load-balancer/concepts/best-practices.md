...
В качестве L7-балансировщика можно использовать [Application Load Balancer](../../application-load-balancer/index.yaml)

В качестве L3-балансировщиков можно использовать [Network Load Balancer](../../network-load-balancer/index.yaml)
