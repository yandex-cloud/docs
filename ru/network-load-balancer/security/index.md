----
title: Управление доступом в Yandex Network Load Balancer
description: "Управление доступом в сервисе сетевого балансировщика Yandex Network Load Balancer. В разделе описано, на какие ресурсы можно назначить роль, какие роли действуют в сервисе, какие роли необходимы для того или иного действия."
----
