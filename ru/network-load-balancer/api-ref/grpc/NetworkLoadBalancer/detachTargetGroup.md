---
editable: false
sourcePath: en/_api-ref-grpc/loadbalancer/v1/api-ref/grpc/NetworkLoadBalancer/detachTargetGroup.md
---

# Network Load Balancer API, gRPC: NetworkLoadBalancerService.DetachTargetGroup {#DetachTargetGroup}

Detaches the target group from the specified network load balancer.

## gRPC request

**rpc DetachTargetGroup ([DetachNetworkLoadBalancerTargetGroupRequest](#yandex.cloud.loadbalancer.v1.DetachNetworkLoadBalancerTargetGroupRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## DetachNetworkLoadBalancerTargetGroupRequest {#yandex.cloud.loadbalancer.v1.DetachNetworkLoadBalancerTargetGroupRequest}
...
|| metadata | **[DetachNetworkLoadBalancerTargetGroupMetadata](#yandex.cloud.loadbalancer.v1.DetachNetworkLoadBalancerTargetGroupMetadata)**
...
## DetachNetworkLoadBalancerTargetGroupMetadata {#yandex.cloud.loadbalancer.v1.DetachNetworkLoadBalancerTargetGroupMetadata}
