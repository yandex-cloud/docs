...
RAM (за 1 ГБ) | {{ sku|KZT|compute.vm.ram.preemptible|string }}
**Intel Cascade Lake** |
1 GPU | {{ sku|KZT|compute.vm.gpu.gpu-standard.preemptible.v2|string }}
RAM (за 1 ГБ) | {{ sku|KZT|compute.vm.ram.preemptible.v2|string }}
**Intel Ice Lake** |
1 GPU | {{ sku|KZT|compute.vm.gpu.standard.v3-t4.preemptible|string }}
RAM (за 1 ГБ) | {{ sku|KZT|compute.vm.ram.preemptible.v3|string }}
**AMD EPYC™** |
1 GPU | {{ sku|KZT|compute.vm.gpu.gpu-standard.preemptible.v3|string }}
RAM (за 1 ГБ) | {{ sku|KZT|compute.vm.ram.gpu-standard.preemptible.v3|string }}
