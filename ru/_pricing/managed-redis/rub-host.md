...
| RAM (за 1 ГБ)                      | {{ sku|RUB|mdb.cluster.redis.v3.ram|string }}      | {{ sku|RUB|v1.commitment.y1.mdb.redis.ram.v3|string }} (-36%)                                                                                     | {{ sku|RUB|v1.commitment.y3.mdb.redis.ram.v3|string }} (-50%) |
