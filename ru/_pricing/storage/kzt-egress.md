...
| --- | --- |
| Исходящий трафик, до 100 ГБ в месяц | {{ sku|KZT|storage.api.network.inet.egress|string }} |
| Исходящий трафик, сверх 100 ГБ до 1 ТБ | {{ sku|KZT|storage.api.network.inet.egress|pricingRate.100|string }} |
