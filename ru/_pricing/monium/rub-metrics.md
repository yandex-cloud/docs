...
----- | -----
| Запись значений пользовательских метрик через API | 0,32 ₽ |
...
| Запись значений метрик через {{ prometheus-name }} Remote API<br/>(от 50 млн до 10 000 млн значений) | 2,3058 ₽ |
| Запись значений метрик через {{ prometheus-name }} Remote API<br/>(сверх 10 000 млн значений) | 0,6588 ₽ |
| Чтение значений метрик через {{ prometheus-name }} Remote API | Не тарифицируется |
| Запись значений метрик ресурсов {{ yandex-cloud }} | Не тарифицируется |