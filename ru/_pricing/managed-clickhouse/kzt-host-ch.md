...
| RAM (за 1 ГБ) | {{ sku|KZT|mdb.cluster.clickhouse.v3.ram|string }}      | {{ sku|KZT|v1.commitment.y1.mdb.ch.ram.v3|string }} (-36%)      | {{ sku|KZT|v1.commitment.y3.mdb.ch.ram.v3|string }} (-52%)      |
{% endif %}
