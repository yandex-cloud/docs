...
| RAM (за 1 ГБ) | {{ sku|ILS|mdb.cluster.clickhouse.v1.ram|string }}      | −                                                               | −                                                               |
| **Intel Cascade Lake**                                                                                                                                                                                      |
...
| RAM (за 1 ГБ) | {{ sku|ILS|mdb.cluster.clickhouse.v2.ram|string }}      | {{ sku|ILS|v1.commitment.y1.mdb.ch.ram.v2|string }} (-36%)      | {{ sku|ILS|v1.commitment.y3.mdb.ch.ram.v2|string }} (-52%)      |
{% endif %}
| **Intel Ice Lake**                                                                                                                                                                                          |
...
| RAM (за 1 ГБ) | {{ sku|ILS|mdb.cluster.clickhouse.v3.ram|string }}      | {{ sku|ILS|v1.commitment.y1.mdb.ch.ram.v3|string }} (-36%)      | {{ sku|ILS|v1.commitment.y3.mdb.ch.ram.v3|string }} (-52%)      |
...
| RAM (за 1 ГБ) | {{ sku|ILS|mdb.cluster.clickhouse.v2.ram|string }}      |
{% endif %}
| **Intel Ice Lake**                                                      | 
| 50% vCPU      | {{ sku|ILS|mdb.cluster.clickhouse.v3.cpu.c50|string }}  |
| 100% vCPU     | {{ sku|ILS|mdb.cluster.clickhouse.v3.cpu.c100|string }} |
| RAM (за 1 ГБ) | {{ sku|ILS|mdb.cluster.clickhouse.v3.ram|string }}      |
