...
--- | ---
**До 01.12.2022** | 
Исходящий трафик, первые 10 ГБ в месяц | {{ sku|RUB|network.egress.inet|string }}
Исходящий трафик, свыше 10 ГБ в месяц | {{ sku|RUB|network.egress.inet|pricingRate.10|string }}
**C 01.12.2022** | 
Исходящий трафик, первые 100 ГБ в месяц | {{ sku|RUB|network.egress.inet|string }}
Исходящий трафик, свыше 100 ГБ в месяц | {{ sku|RUB|network.egress.inet|pricingRate.10|string }}