...
| Исходящий трафик, до 10 ГБ | {{ sku|KZT|network.egress.inet|string }} | {{ sku|KZT|network.egress.inet|string }} |
| Исходящий трафик, сверх 10 ГБ | {{ sku|KZT|network.egress.inet|pricingRate.10|string }} | 7,65 ₸ |