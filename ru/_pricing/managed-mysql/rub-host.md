...
| RAM (за 1 ГБ) | {{ sku|RUB|mdb.cluster.mysql.v3.ram|string }}      | {{ sku|RUB|v1.commitment.y1.mdb.mysql.ram.v3|string }} (-34%)                                                                                     | {{ sku|RUB|v1.commitment.y3.mdb.mysql.ram.v3|string }} (-50%) |
