...
----- | ----- | -----
Стоимость подписки на месяц, вкл. НДС | бесплатно | {{ sku|KZT|datalens.sessions.subscription.v1|int|string }}
...
Стоимость одной дополнительной<br/> внешней сессии, вкл. НДС | - | {{ sku|KZT|datalens.sessions.additional.v1|string }}
