...
- Python
  ...
  * `-d` — полный путь базы данных.
  ...
  Далее вы можете ознакомиться с [комментариями к коду тестового приложения](example/example-python.md).
...
- Go
  ...
  Далее вы можете ознакомиться с [комментариями к коду тестового приложения](example/example-go.md).
...
- Node.js
  ...
  Далее вы можете ознакомиться с [комментариями к коду тестового приложения](example/example-nodejs.md).
...
- Java
  ...
  Далее вы можете ознакомиться с [комментариями к коду тестового приложения](example/example-java.md).
