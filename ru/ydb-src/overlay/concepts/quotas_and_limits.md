...
В случае исчерпания квоты на [группы хранения](databases.md#storage-groups) база данных продолжит работать и обрабатывать запросы на запись и чтение. Тем не менее пользователю следует следить за потреблением квоты на группы хранения и своевременно оставлять заявки на квоты в YDB и на расширение базы данных.
