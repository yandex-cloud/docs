...
В разделе [Загрузка больших объемов данных](../batch_upload.md) собраны рекомендации, которые позволят с наибольшей эффективностью использовать ресурсы базы YDB при загрузке данных из YT.
