...
Вы можете добавлять в {{ cloud-desktop-name }} собственные образы, созданные на основе одного из [рабочих столов](../operations/images/create-from-desktop.md) или [виртуальной машины {{ compute-name }}](../operations/images/create-from-compute.md).

Разверните и настройте нужное программное окружение на рабочем столе или виртуальной машине и тиражируйте его среди пользователей с помощью образов.
