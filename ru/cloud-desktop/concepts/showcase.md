...
Чтобы подключить пользователя к рабочему столу, отправьте ему ссылку на витрину и пароль. Получение пароля описано в инструкции [{#T}](../operations/desktops/password-reset.md).
