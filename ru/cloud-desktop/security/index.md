...
В {{ cloud-desktop-name }} управление доступом реализовано с помощью разграничения ролей {{ iam-full-name }} и [списков управления доступом (ACL)](../concepts/acl.md). [Пример использования механизмов доступа](../concepts/acl.md#example).
