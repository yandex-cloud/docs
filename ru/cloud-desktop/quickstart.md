...
- Консоль управления {#console}
  ...
  1. В списке групп рабочих столов выберите созданную ранее группу.
  ...
  1. В открывшемся окне **{{ ui-key.yacloud_components.acl.AclEditDialogNew.label_title }}** выберите группу пользователей, созданную ранее.
