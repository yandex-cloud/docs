...
* в сервисе [{{ monitoring-full-name }}](https://monitoring.cloud.yandex.ru/) с возможностью [настроить уведомления](../operations/monitoring.md#monitoring-integration) по заданным метрикам.
...
Воспользуйтесь сервисом [{{ monitoring-full-name }}](https://monitoring.cloud.yandex.ru/) и [настройте уведомления](../operations/monitoring.md#monitoring-integration) по критичным для вас параметрам.
