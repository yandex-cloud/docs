    ...
    query:
      ...
      properties:
        pageSize:
          description: |-
            **string** (int64)
            ...
            results is larger than `page_size`, the service returns a [ListUsersResponse.nextPageToken](/docs/managed-postgresql/api-ref/User/list#yandex.cloud.mdb.postgresql.v1.ListUsersResponse)
        ...
        pageToken:
          description: |-
            **string**
            Page token. To get the next page of results, set `page_token` to the [ListUsersResponse.nextPageToken](/docs/managed-postgresql/api-ref/User/list#yandex.cloud.mdb.postgresql.v1.ListUsersResponse)
