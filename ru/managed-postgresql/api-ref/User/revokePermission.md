...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-postgresql/v1/clusters/{clusterId}/users/{userName}:revokePermission
    method: post
    path:
      type: object
      properties:
...
## Body parameters {#yandex.cloud.mdb.postgresql.v1.RevokeUserPermissionRequest}
