...
userName | <p>Required. Name of the user to revoke a permission from. To get the name of the user, use a <a href="/docs/managed-postgresql/api-ref/User/list">list</a> request.</p> <p>The maximum string length in characters is 63. Value must match the regular expression ``[a-zA-Z0-9_-]*``.</p> 
...
Field | Description
--- | ---
databaseName | **string**<br><p>Required. Name of the database that the user should lose access to.</p> <p>The maximum string length in characters is 63. Value must match the regular expression ``[a-zA-Z0-9_-]*``.</p> 
