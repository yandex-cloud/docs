...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-postgresql/v1/changeFreezeLimits
    method: get
    path: null
    query:
      type: object
...
# Managed Service for PostgreSQL API, REST: ChangeFreeze.GetLimits
...
```
GET https://{{ api-host-mdb }}/managed-postgresql/v1/changeFreezeLimits
```
