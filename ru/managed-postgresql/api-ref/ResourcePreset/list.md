    ...
    query:
      ...
      properties:
        pageSize:
          description: |-
            **string** (int64)
            ...
            results is larger than `pageSize`, the service returns a [ListResourcePresetsResponse.nextPageToken](/docs/managed-postgresql/api-ref/ResourcePreset/list#yandex.cloud.mdb.postgresql.v1.ListResourcePresetsResponse)
        ...
        pageToken:
          description: |-
            **string**
            Page token. To get the next page of results, set `pageToken` to the [ListResourcePresetsResponse.nextPageToken](/docs/managed-postgresql/api-ref/ResourcePreset/list#yandex.cloud.mdb.postgresql.v1.ListResourcePresetsResponse)
