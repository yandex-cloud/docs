---
editable: false
sourcePath: en/_api-ref-grpc/mdb/postgresql/v1/api-ref/grpc/User/get.md
---

# Managed Service for PostgreSQL API, gRPC: UserService.Get {#Get}

Returns the specified PostgreSQL User resource.

To get the list of available PostgreSQL User resources, make a [List](/docs/managed-postgresql/api-ref/grpc/User/list#List) request.

## gRPC request

**rpc Get ([GetUserRequest](#yandex.cloud.mdb.postgresql.v1.GetUserRequest)) returns ([User](#yandex.cloud.mdb.postgresql.v1.User))**

## GetUserRequest {#yandex.cloud.mdb.postgresql.v1.GetUserRequest}
