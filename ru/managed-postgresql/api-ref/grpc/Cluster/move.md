---
editable: false
sourcePath: en/_api-ref-grpc/mdb/postgresql/v1/api-ref/grpc/Cluster/move.md
---

# Managed Service for PostgreSQL API, gRPC: ClusterService.Move {#Move}

Moves the specified PostgreSQL cluster to the specified folder.

## gRPC request

**rpc Move ([MoveClusterRequest](#yandex.cloud.mdb.postgresql.v1.MoveClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## MoveClusterRequest {#yandex.cloud.mdb.postgresql.v1.MoveClusterRequest}
