...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-postgresql/v1/clusters/{clusterId}:managedRepack_list_running
    method: get
    path:
      type: object
      properties:
...
```
GET https://{{ api-host-mdb }}/managed-postgresql/v1/clusters/{clusterId}:managedRepack_list_running
```
