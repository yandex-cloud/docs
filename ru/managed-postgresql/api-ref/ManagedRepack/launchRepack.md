...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-postgresql/v1/clusters/{clusterId}:managedRepack_launch
    method: post
    path:
      type: object
      properties:
...
```
POST https://{{ api-host-mdb }}/managed-postgresql/v1/clusters/{clusterId}:managedRepack_launch
```
