...
--- | ---
clusterId | <p>Required. ID of the PostgreSQL Cluster resource to return. To get the cluster ID use a <a href="/docs/managed-postgresql/api-ref/Cluster/list">list</a> request.</p> <p>The maximum string length in characters is 50.</p> 
...
config.<br>poolerConfig | **object**<br>Configuration of the connection pooler.
...
config.<br>resources | **object**<br>Resources allocated to PostgreSQL hosts.
...
config.<br>diskSizeAutoscaling | **object**<br>Disk size autoscaling
config.<br>diskSizeAutoscaling.<br>plannedUsageThreshold | **string** (int64)<br><p>Amount of used storage for automatic disk scaling in the maintenance window, 0 means disabled, in percent.</p> <p>Acceptable values are 0 to 100, inclusive.</p> 
config.<br>diskSizeAutoscaling.<br>emergencyUsageThreshold | **string** (int64)<br><p>Amount of used storage for immediately  automatic disk scaling, 0 means disabled, in percent.</p> <p>Acceptable values are 0 to 100, inclusive.</p> 
config.<br>diskSizeAutoscaling.<br>diskSizeLimit | **string** (int64)<br><p>Limit on how large the storage for database instances can automatically grow, in bytes.</p> 
config.<br>postgresqlConfig_9_6 | **object**<br>Configuration of a PostgreSQL 9.6 server. <br>`config` includes only one of the fields `postgresqlConfig_9_6`, `postgresqlConfig_10_1C`, `postgresqlConfig_10`, `postgresqlConfig_11`, `postgresqlConfig_11_1C`, `postgresqlConfig_12`, `postgresqlConfig_12_1C`, `postgresqlConfig_13`, `postgresqlConfig_13_1C`, `postgresqlConfig_14`, `postgresqlConfig_14_1C`, `postgresqlConfig_15`, `postgresqlConfig_15_1C`<br>
...
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>sharedBuffers | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>tempBuffers | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>maxPreparedTransactions | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>workMem | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>maintenanceWorkMem | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>autovacuumWorkMem | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>tempFileLimit | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>vacuumCostDelay | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>vacuumCostPageHit | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>vacuumCostPageMiss | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>vacuumCostPageDirty | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>vacuumCostLimit | **integer** (int64)
...
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>defaultStatisticsTarget | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>constraintExclusion | **string**
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>cursorTupleFraction | **number** (double)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>fromCollapseLimit | **integer** (int64)<br><p>Acceptable values are 1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>joinCollapseLimit | **integer** (int64)<br><p>Acceptable values are 1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>forceParallelMode | **string**
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>clientMinMessages | **string**
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>logMinMessages | **string**
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>logMinErrorStatement | **string**
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>logMinDurationStatement | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>logCheckpoints | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>logConnections | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>logDisconnections | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>logDuration | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>logErrorVerbosity | **string**
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>logLockWaits | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>logStatement | **string**
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>logTempFiles | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>searchPath | **string**
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>rowSecurity | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>defaultTransactionIsolation | **string**
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>statementTimeout | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>lockTimeout | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>idleInTransactionSessionTimeout | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>byteaOutput | **string**
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>xmlbinary | **string**
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>xmloption | **string**
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>ginPendingListLimit | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>deadlockTimeout | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>maxLocksPerTransaction | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>maxPredLocksPerTransaction | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>arrayNulls | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>backslashQuote | **string**
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>defaultWithOids | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>escapeStringWarning | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>loCompatPrivileges | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>quoteAllIdentifiers | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>standardConformingStrings | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>synchronizeSeqscans | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>transformNullEquals | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>exitOnError | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>seqPageCost | **number** (double)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>randomPageCost | **number** (double)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>autovacuumMaxWorkers | **integer** (int64)<br><p>Acceptable values are 1 to 32, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>autovacuumVacuumCostDelay | **integer** (int64)<br><p>Acceptable values are -1 to 100, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>autovacuumVacuumCostLimit | **integer** (int64)<br><p>Acceptable values are -1 to 10000, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>autovacuumNaptime | **integer** (int64)<br><p>Acceptable values are 1000 to 86400000, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>archiveTimeout | **integer** (int64)<br><p>Acceptable values are 10000 to 86400000, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>trackActivityQuerySize | **integer** (int64)<br><p>Acceptable values are 100 to 102400, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>onlineAnalyzeEnable | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>enableBitmapscan | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>enableHashagg | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>enableHashjoin | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>enableIndexscan | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>enableIndexonlyscan | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>enableMaterial | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>enableMergejoin | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>enableNestloop | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>enableSeqscan | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>enableSort | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>enableTidscan | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>maxWorkerProcesses | **integer** (int64)<br><p>Acceptable values are 0 to 1024, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>maxParallelWorkers | **integer** (int64)<br><p>Acceptable values are 0 to 1024, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>maxParallelWorkersPerGather | **integer** (int64)<br><p>Acceptable values are 0 to 1024, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>autovacuumVacuumScaleFactor | **number** (double)<br><p>Acceptable values are 0 to 1, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>autovacuumAnalyzeScaleFactor | **number** (double)<br><p>Acceptable values are 0 to 1, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>defaultTransactionReadOnly | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>timezone | **string**
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>enableParallelAppend | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>enableParallelHash | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>enablePartitionPruning | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>enablePartitionwiseAggregate | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>enablePartitionwiseJoin | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>jit | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>maxParallelMaintenanceWorkers | **integer** (int64)<br><p>The minimum value is 0.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>parallelLeaderParticipation | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>logTransactionSampleRate | **number** (double)<br><p>Acceptable values are 0 to 1, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>planCacheMode | **string**
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>effectiveIoConcurrency | **integer** (int64)<br><p>Acceptable values are 0 to 1000, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>effectiveCacheSize | **integer** (int64)<br><p>Acceptable values are 0 to 549755813888, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>sharedPreloadLibraries[] | **string**
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>autoExplainLogMinDuration | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>autoExplainLogAnalyze | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>autoExplainLogBuffers | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>autoExplainLogTiming | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>autoExplainLogTriggers | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>autoExplainLogVerbose | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>autoExplainLogNestedStatements | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>autoExplainSampleRate | **number** (double)<br><p>Acceptable values are 0 to 1, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>pgHintPlanEnableHint | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>pgHintPlanEnableHintTable | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>pgHintPlanDebugPrint | **string**
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>pgHintPlanMessageLevel | **string**
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>hashMemMultiplier | **number** (double)<br><p>Acceptable values are 0 to 1000, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>logicalDecodingWorkMem | **integer** (int64)<br><p>Acceptable values are 65536 to 1099511627776, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>maintenanceIoConcurrency | **integer** (int64)<br><p>Acceptable values are 0 to 1000, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>maxSlotWalKeepSize | **integer** (int64)<br><p>Acceptable values are -1 to 2251799812636672, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>walKeepSize | **integer** (int64)<br><p>Acceptable values are -1 to 2251799812636672, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>enableIncrementalSort | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>autovacuumVacuumInsertThreshold | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>autovacuumVacuumInsertScaleFactor | **number** (double)<br><p>Acceptable values are 0 to 100, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>logMinDurationSample | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>logStatementSampleRate | **number** (double)<br><p>Acceptable values are 0 to 1, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>logParameterMaxLength | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>logParameterMaxLengthOnError | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>clientConnectionCheckInterval | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>enableAsyncAppend | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>enableGathermerge | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>enableMemoize | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>logRecoveryConflictWaits | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>vacuumFailsafeAge | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>vacuumMultixactFailsafeAge | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>pgQualstatsEnabled | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>pgQualstatsTrackConstants | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>pgQualstatsMax | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>pgQualstatsResolveOids | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>pgQualstatsSampleRate | **number** (double)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>plantunerFixEmptyTable | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>geqo | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>geqoThreshold | **integer** (int64)<br><p>Acceptable values are 2 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>geqoEffort | **integer** (int64)<br><p>Acceptable values are 1 to 10, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>geqoPoolSize | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>geqoGenerations | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>geqoSelectionBias | **number** (double)<br><p>Acceptable values are 1.5 to 2, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>effectiveConfig.<br>geqoSeed | **number** (double)<br><p>Acceptable values are 0 to 1, inclusive.</p> 
...
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>tempBuffers | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>maxPreparedTransactions | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>workMem | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>maintenanceWorkMem | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>autovacuumWorkMem | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>tempFileLimit | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>vacuumCostDelay | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>vacuumCostPageHit | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>vacuumCostPageMiss | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>vacuumCostPageDirty | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>vacuumCostLimit | **integer** (int64)
...
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>defaultStatisticsTarget | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>constraintExclusion | **string**
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>cursorTupleFraction | **number** (double)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>fromCollapseLimit | **integer** (int64)<br><p>Acceptable values are 1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>joinCollapseLimit | **integer** (int64)<br><p>Acceptable values are 1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>forceParallelMode | **string**
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>clientMinMessages | **string**
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>logMinMessages | **string**
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>logMinErrorStatement | **string**
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>logMinDurationStatement | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>logCheckpoints | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>logConnections | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>logDisconnections | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>logDuration | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>logErrorVerbosity | **string**
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>logLockWaits | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>logStatement | **string**
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>logTempFiles | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>searchPath | **string**
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>rowSecurity | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>defaultTransactionIsolation | **string**
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>statementTimeout | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>lockTimeout | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>idleInTransactionSessionTimeout | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>byteaOutput | **string**
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>xmlbinary | **string**
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>xmloption | **string**
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>ginPendingListLimit | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>deadlockTimeout | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>maxLocksPerTransaction | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>maxPredLocksPerTransaction | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>arrayNulls | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>backslashQuote | **string**
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>defaultWithOids | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>escapeStringWarning | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>loCompatPrivileges | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>quoteAllIdentifiers | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>standardConformingStrings | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>synchronizeSeqscans | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>transformNullEquals | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>exitOnError | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>seqPageCost | **number** (double)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>randomPageCost | **number** (double)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>autovacuumMaxWorkers | **integer** (int64)<br><p>Acceptable values are 1 to 32, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>autovacuumVacuumCostDelay | **integer** (int64)<br><p>Acceptable values are -1 to 100, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>autovacuumVacuumCostLimit | **integer** (int64)<br><p>Acceptable values are -1 to 10000, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>autovacuumNaptime | **integer** (int64)<br><p>Acceptable values are 1000 to 86400000, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>archiveTimeout | **integer** (int64)<br><p>Acceptable values are 10000 to 86400000, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>trackActivityQuerySize | **integer** (int64)<br><p>Acceptable values are 100 to 102400, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>onlineAnalyzeEnable | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>enableBitmapscan | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>enableHashagg | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>enableHashjoin | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>enableIndexscan | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>enableIndexonlyscan | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>enableMaterial | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>enableMergejoin | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>enableNestloop | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>enableSeqscan | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>enableSort | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>enableTidscan | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>maxWorkerProcesses | **integer** (int64)<br><p>Acceptable values are 0 to 1024, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>maxParallelWorkers | **integer** (int64)<br><p>Acceptable values are 0 to 1024, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>maxParallelWorkersPerGather | **integer** (int64)<br><p>Acceptable values are 0 to 1024, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>autovacuumVacuumScaleFactor | **number** (double)<br><p>Acceptable values are 0 to 1, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>autovacuumAnalyzeScaleFactor | **number** (double)<br><p>Acceptable values are 0 to 1, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>defaultTransactionReadOnly | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>timezone | **string**
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>enableParallelAppend | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>enableParallelHash | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>enablePartitionPruning | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>enablePartitionwiseAggregate | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>enablePartitionwiseJoin | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>jit | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>maxParallelMaintenanceWorkers | **integer** (int64)<br><p>The minimum value is 0.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>parallelLeaderParticipation | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>logTransactionSampleRate | **number** (double)<br><p>Acceptable values are 0 to 1, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>planCacheMode | **string**
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>effectiveIoConcurrency | **integer** (int64)<br><p>Acceptable values are 0 to 1000, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>effectiveCacheSize | **integer** (int64)<br><p>Acceptable values are 0 to 549755813888, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>sharedPreloadLibraries[] | **string**
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>autoExplainLogMinDuration | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>autoExplainLogAnalyze | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>autoExplainLogBuffers | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>autoExplainLogTiming | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>autoExplainLogTriggers | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>autoExplainLogVerbose | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>autoExplainLogNestedStatements | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>autoExplainSampleRate | **number** (double)<br><p>Acceptable values are 0 to 1, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>pgHintPlanEnableHint | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>pgHintPlanEnableHintTable | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>pgHintPlanDebugPrint | **string**
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>pgHintPlanMessageLevel | **string**
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>hashMemMultiplier | **number** (double)<br><p>Acceptable values are 0 to 1000, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>logicalDecodingWorkMem | **integer** (int64)<br><p>Acceptable values are 65536 to 1099511627776, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>maintenanceIoConcurrency | **integer** (int64)<br><p>Acceptable values are 0 to 1000, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>maxSlotWalKeepSize | **integer** (int64)<br><p>Acceptable values are -1 to 2251799812636672, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>walKeepSize | **integer** (int64)<br><p>Acceptable values are -1 to 2251799812636672, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>enableIncrementalSort | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>autovacuumVacuumInsertThreshold | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>autovacuumVacuumInsertScaleFactor | **number** (double)<br><p>Acceptable values are 0 to 100, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>logMinDurationSample | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>logStatementSampleRate | **number** (double)<br><p>Acceptable values are 0 to 1, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>logParameterMaxLength | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>logParameterMaxLengthOnError | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>clientConnectionCheckInterval | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>enableAsyncAppend | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>enableGathermerge | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>enableMemoize | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>logRecoveryConflictWaits | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>vacuumFailsafeAge | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>vacuumMultixactFailsafeAge | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>pgQualstatsEnabled | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>pgQualstatsTrackConstants | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>pgQualstatsMax | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>pgQualstatsResolveOids | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>pgQualstatsSampleRate | **number** (double)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>plantunerFixEmptyTable | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>geqo | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>geqoThreshold | **integer** (int64)<br><p>Acceptable values are 2 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>geqoEffort | **integer** (int64)<br><p>Acceptable values are 1 to 10, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>geqoPoolSize | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>geqoGenerations | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>geqoSelectionBias | **number** (double)<br><p>Acceptable values are 1.5 to 2, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>userConfig.<br>geqoSeed | **number** (double)<br><p>Acceptable values are 0 to 1, inclusive.</p> 
...
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>tempBuffers | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>maxPreparedTransactions | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>workMem | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>maintenanceWorkMem | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>autovacuumWorkMem | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>tempFileLimit | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>vacuumCostDelay | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>vacuumCostPageHit | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>vacuumCostPageMiss | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>vacuumCostPageDirty | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>vacuumCostLimit | **integer** (int64)
...
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>defaultStatisticsTarget | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>constraintExclusion | **string**
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>cursorTupleFraction | **number** (double)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>fromCollapseLimit | **integer** (int64)<br><p>Acceptable values are 1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>joinCollapseLimit | **integer** (int64)<br><p>Acceptable values are 1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>forceParallelMode | **string**
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>clientMinMessages | **string**
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>logMinMessages | **string**
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>logMinErrorStatement | **string**
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>logMinDurationStatement | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>logCheckpoints | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>logConnections | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>logDisconnections | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>logDuration | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>logErrorVerbosity | **string**
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>logLockWaits | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>logStatement | **string**
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>logTempFiles | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>searchPath | **string**
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>rowSecurity | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>defaultTransactionIsolation | **string**
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>statementTimeout | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>lockTimeout | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>idleInTransactionSessionTimeout | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>byteaOutput | **string**
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>xmlbinary | **string**
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>xmloption | **string**
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>ginPendingListLimit | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>deadlockTimeout | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>maxLocksPerTransaction | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>maxPredLocksPerTransaction | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>arrayNulls | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>backslashQuote | **string**
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>defaultWithOids | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>escapeStringWarning | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>loCompatPrivileges | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>quoteAllIdentifiers | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>standardConformingStrings | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>synchronizeSeqscans | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>transformNullEquals | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>exitOnError | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>seqPageCost | **number** (double)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>randomPageCost | **number** (double)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>autovacuumMaxWorkers | **integer** (int64)<br><p>Acceptable values are 1 to 32, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>autovacuumVacuumCostDelay | **integer** (int64)<br><p>Acceptable values are -1 to 100, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>autovacuumVacuumCostLimit | **integer** (int64)<br><p>Acceptable values are -1 to 10000, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>autovacuumNaptime | **integer** (int64)<br><p>Acceptable values are 1000 to 86400000, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>archiveTimeout | **integer** (int64)<br><p>Acceptable values are 10000 to 86400000, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>trackActivityQuerySize | **integer** (int64)<br><p>Acceptable values are 100 to 102400, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>onlineAnalyzeEnable | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>enableBitmapscan | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>enableHashagg | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>enableHashjoin | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>enableIndexscan | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>enableIndexonlyscan | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>enableMaterial | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>enableMergejoin | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>enableNestloop | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>enableSeqscan | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>enableSort | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>enableTidscan | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>maxWorkerProcesses | **integer** (int64)<br><p>Acceptable values are 0 to 1024, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>maxParallelWorkers | **integer** (int64)<br><p>Acceptable values are 0 to 1024, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>maxParallelWorkersPerGather | **integer** (int64)<br><p>Acceptable values are 0 to 1024, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>autovacuumVacuumScaleFactor | **number** (double)<br><p>Acceptable values are 0 to 1, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>autovacuumAnalyzeScaleFactor | **number** (double)<br><p>Acceptable values are 0 to 1, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>defaultTransactionReadOnly | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>timezone | **string**
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>enableParallelAppend | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>enableParallelHash | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>enablePartitionPruning | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>enablePartitionwiseAggregate | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>enablePartitionwiseJoin | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>jit | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>maxParallelMaintenanceWorkers | **integer** (int64)<br><p>The minimum value is 0.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>parallelLeaderParticipation | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>logTransactionSampleRate | **number** (double)<br><p>Acceptable values are 0 to 1, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>planCacheMode | **string**
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>effectiveIoConcurrency | **integer** (int64)<br><p>Acceptable values are 0 to 1000, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>effectiveCacheSize | **integer** (int64)<br><p>Acceptable values are 0 to 549755813888, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>sharedPreloadLibraries[] | **string**
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>autoExplainLogMinDuration | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>autoExplainLogAnalyze | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>autoExplainLogBuffers | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>autoExplainLogTiming | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>autoExplainLogTriggers | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>autoExplainLogVerbose | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>autoExplainLogNestedStatements | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>autoExplainSampleRate | **number** (double)<br><p>Acceptable values are 0 to 1, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>pgHintPlanEnableHint | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>pgHintPlanEnableHintTable | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>pgHintPlanDebugPrint | **string**
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>pgHintPlanMessageLevel | **string**
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>hashMemMultiplier | **number** (double)<br><p>Acceptable values are 0 to 1000, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>logicalDecodingWorkMem | **integer** (int64)<br><p>Acceptable values are 65536 to 1099511627776, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>maintenanceIoConcurrency | **integer** (int64)<br><p>Acceptable values are 0 to 1000, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>maxSlotWalKeepSize | **integer** (int64)<br><p>Acceptable values are -1 to 2251799812636672, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>walKeepSize | **integer** (int64)<br><p>Acceptable values are -1 to 2251799812636672, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>enableIncrementalSort | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>autovacuumVacuumInsertThreshold | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>autovacuumVacuumInsertScaleFactor | **number** (double)<br><p>Acceptable values are 0 to 100, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>logMinDurationSample | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>logStatementSampleRate | **number** (double)<br><p>Acceptable values are 0 to 1, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>logParameterMaxLength | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>logParameterMaxLengthOnError | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>clientConnectionCheckInterval | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>enableAsyncAppend | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>enableGathermerge | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>enableMemoize | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>logRecoveryConflictWaits | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>vacuumFailsafeAge | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>vacuumMultixactFailsafeAge | **integer** (int64)<br><p>Acceptable values are -1 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>pgQualstatsEnabled | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>pgQualstatsTrackConstants | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>pgQualstatsMax | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>pgQualstatsResolveOids | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>pgQualstatsSampleRate | **number** (double)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>plantunerFixEmptyTable | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>geqo | **boolean** (boolean)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>geqoThreshold | **integer** (int64)<br><p>Acceptable values are 2 to 2147483647, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>geqoEffort | **integer** (int64)<br><p>Acceptable values are 1 to 10, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>geqoPoolSize | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>geqoGenerations | **integer** (int64)
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>geqoSelectionBias | **number** (double)<br><p>Acceptable values are 1.5 to 2, inclusive.</p> 
config.<br>postgresqlConfig_15_1C.<br>defaultConfig.<br>geqoSeed | **number** (double)<br><p>Acceptable values are 0 to 1, inclusive.</p> 
