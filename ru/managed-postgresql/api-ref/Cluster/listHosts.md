---
editable: false
sourcePath: en/_api-ref/mdb/postgresql/api-ref/Cluster/listHosts.md
---
...
```
GET https://mdb.{{ api-host }}/managed-postgresql/v1/clusters/{clusterId}/hosts
```
  ...
  "hosts": [
    {
      ...
      "config": {
        ...
        // `hosts[].config` includes only one of the fields `postgresqlConfig_9_6`, `postgresqlConfig_10_1C`, `postgresqlConfig_10`, `postgresqlConfig_11`, `postgresqlConfig_11_1C`, `postgresqlConfig_12`, `postgresqlConfig_12_1C`, `postgresqlConfig_13`, `postgresqlConfig_13_1C`, `postgresqlConfig_14`, `postgresqlConfig_14_1C`
