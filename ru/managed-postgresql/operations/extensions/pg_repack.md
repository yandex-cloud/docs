...
Для работы с расширением используется одноименный клиент. Клиент устанавливается на хост, с которого есть возможность [подключения к кластеру {{ PG }}](../connect/index.md).
