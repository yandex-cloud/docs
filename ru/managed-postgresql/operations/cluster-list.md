...
- CLI
  ...
  Чтобы запросить список PostgreSQL-кластеров в каталоге по умолчанию, выполните команду:
...
- CLI
  ...
  Чтобы получить информацию о PostgreSQL-кластере, выполните команду:
