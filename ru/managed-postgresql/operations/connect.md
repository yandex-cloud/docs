...
### С особым FQDN хоста-мастера {#using-fqdn-master}

Чтобы в строке подключения не перечислять все хосты кластера, используйте [особый FQDN хоста-мастера](#fqdn-master), как сделано [в примерах ниже](#connection-string).
