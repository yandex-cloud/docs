...
1. Чтобы просмотреть подробный план выполнения запроса в виде дерева, нажмите на кнопку ![full-screen](../../_assets/full-screen.svg). Для выхода из этого режима нажмите клавишу _ESC_.
