...
Вы можете обновить кластер {{ mpg-name }} до версии 17 или ниже.
...
Если с переходом на версию 17 возникнут проблемы, обратитесь в [техническую поддержку]({{ link-console-support }}).
