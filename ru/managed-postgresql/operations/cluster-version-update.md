...
Вы можете обновить версию {{ PG }} в кластере {{ mpg-name }} до версии `19` или ниже. При этом обновление мажорной версии возможно только последовательно, по одной версии за раз.
...
Подробнее об обновлении версии в разделе [Обновление мажорной версии {{ PG }} в {{ mpg-name }}](../concepts/upgrade.md).
...
- Консоль управления {#console}
    ...
    В [консоли управления]({{ link-console-main }}) откройте страницу [создания](cluster-create.md) или [изменения кластера](update.md) {{ mpg-name }}. Список доступен в поле **{{ ui-key.yacloud.mdb.forms.base_field_version }}**.
...
Если с переходом на версию 19 возникнут проблемы, обратитесь в [техническую поддержку]({{ link-console-support }}).
