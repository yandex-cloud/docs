...
- Консоль управления {#console}
  ...
  1. В открывшемся окне:
     ...
     * Чтобы разрешить проведение технического обслуживания раз в неделю в определенное время, выберите пункт **{{ ui-key.yacloud.mdb.forms.value_maintenance-type-weekly }}** и выберите день недели и интервал времени по UTC.
