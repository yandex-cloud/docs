...
Managed Service for PostgreSQL поддерживает многие стандартные расширения PostgreSQL и некоторые нестандартные. Полный список доступных расширений [приведен ниже](#postgresql).
...
## Поддерживаемые расширения PostgreSQL {#postgresql}
