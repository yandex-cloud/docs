...
> Это позволяет [!KEYREF PG] эффективнее выполнять запросы со строковыми типами данных, но может
> работать неочевидным образом, например, с кириллицей.
>
> Подробнее эти настройки освещены в [документации [!KEYREF PG]](https://www.postgresql.org/docs/current/collation.html).
 ...
 таблиц. Подробнее читайте в  [документации [!KEYREF PG]](https://www.postgresql.org/docs/current/sql-createtable.html).
...
1. Выполните команду создания БД:
   ...
   [!KEYREF mpg-short-name] запустит операцию создания базы данных.
