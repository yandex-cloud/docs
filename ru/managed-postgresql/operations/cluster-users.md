...
- Консоль управления
  ...
  1. Задайте [настройки СУБД](#dbms-settings) для пользователя.
  1. Нажмите кнопку **Добавить**.
...
- CLI
  ...
  Чтобы задать настройки СУБД для пользователя, воспользуйтесь параметрами, описанными в разделе [Настройки СУБД](#dbms-settings).
...
- Консоль управления
  ...
  1. Перейдите на страницу каталога и выберите сервис **{{ mpg-name }}**.
  1. Нажмите на имя нужного кластера и выберите вкладку **Пользователи**.
  1. Нажмите значок image и выберите пункт **Изменить пароль**.
...
- Консоль управления
  ...
  1. Измените [настройки {{ PG }}](#dbms-settings) для пользователя в разделе **Настройки СУБД**.
...
- CLI
  ...
  1. Чтобы изменить [настройки {{ PG }}](#dbms-settings) для пользователя, передайте параметры, отвечающие за требуемые настройки, в команде: 
...
## Дополнительные настройки {#dbms-settings}
