...
Чтобы назначить роль пользователю, [используйте](../operations/grant.md) CLI или API Яндекс.Облака: назначение роли запросом `GRANT` отменяется при следующей операции с базой.
