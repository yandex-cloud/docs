---
title: "Ограничения для команд SQL в {{ mpg-name }}"
...
* Нельзя управлять пользователями и назначать им роли. Однако можно [назначать пользователям привилегии](../operations/grant.md) на уровне отдельных объектов баз данных.
