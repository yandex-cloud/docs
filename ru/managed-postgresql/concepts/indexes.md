...
Подробнее о типах индексов в [документации {{ PG }}](https://www.postgresql.org/docs/current/indexes-types.html).
...
Расширение [pg_repack](https://github.com/reorg/pg_repack) обеспечивает реорганизацию таблиц и индексов без длительных блокировок. Инструкция по установке и запуску `pg_repack` в кластере {{ mpg-name }} находится в разделе [Использование pg_repack](../operations/extensions/pg_repack.md).
