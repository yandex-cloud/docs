...
Каждый кластер состоит из одного или нескольких _хостов БД_ — виртуальных машин с развернутыми серверами СУБД. Хосты кластера могут находиться в разных зонах доступности. {% if audience != "internal" %}[Подробнее о географии {{ yandex-cloud }}](../../overview/concepts/geo-scope.md).{% endif %}
...
* Минимальное количество хостов в кластере зависит от выбранного [типа хранилища](storage.md).
...
В архитектуру сервиса встроен _пулер Odyssey_ для управления соединениями и балансировки нагрузки на кластер. Подробнее см. в разделе [{#T}](pooling.md).
