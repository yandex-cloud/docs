...
Хосты в кластерах [!KEYREF mpg-name] разворачиваются на базе виртуальных машин [!KEYREF compute-full-name]. Эти виртуальные машины могут быть созданы на любой из платформ, которые поддерживает [!KEYREF compute-name]. Подробное описание платформ приведено в разделе [[!TITLE]](../../compute/concepts/vm-platforms.md).
