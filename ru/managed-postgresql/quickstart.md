...
1. В блоке **{{ ui-key.yacloud.mdb.forms.section_host }}** укажите [зоны доступности](../overview/concepts/geo-scope.md) и подсети для хостов, которые будут созданы вместе с кластером.
