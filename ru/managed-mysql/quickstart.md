...
[Запросите доступ](https://puncher.yandex-team.ru/) к макросу `_PGAASINTERNALNETS_`, чтобы подключаться к созданным кластерам. Для подключения к хостам MySQL нужен доступ к порту 3306.
