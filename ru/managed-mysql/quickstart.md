# Как начать работать с Managed Service for MySQL<sup>®</sup>
...
1. Когда кластер будет готов к работе, его статус на панели Managed Service for MySQL сменится на **RUNNING**.
