...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-mysql/v1/clusters/{clusterId}/retention_policies
    method: post
    path:
      type: object
      properties:
...
```
POST https://{{ api-host-mdb }}/managed-mysql/v1/clusters/{clusterId}/retention_policies
```
...
## Response {#yandex.cloud.mdb.mysql.v1.CreateBackupRetentionPolicyResponse}
