...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-mysql/v1/maintenances/{maintenanceId}:reschedule
    method: post
    path:
      type: object
      properties:
...
# Managed Service for MySQL API, REST: Maintenance.Reschedule
...
```
POST https://{{ api-host-mdb }}/managed-mysql/v1/maintenances/{maintenanceId}:reschedule
```
