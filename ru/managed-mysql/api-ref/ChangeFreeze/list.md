...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-mysql/v1/changeFreezes
    method: get
    path: null
    query:
      type: object
...
# Managed Service for MySQL API, REST: ChangeFreeze.List
...
```
GET https://{{ api-host-mdb }}/managed-mysql/v1/changeFreezes
```
