...
# Managed Service for MySQL API, gRPC: ClusterService.Backup

Creates a backup for a cluster.

To get information about a backup, make a [BackupService.Get](/docs/managed-mysql/api-ref/grpc/Backup/get#Get) request.

## gRPC request

**rpc Backup ([BackupClusterRequest](#yandex.cloud.mdb.mysql.v1.BackupClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## BackupClusterRequest {#yandex.cloud.mdb.mysql.v1.BackupClusterRequest}
...
Required field. ID of the cluster to back up.
...
|| metadata | **[BackupClusterMetadata](#yandex.cloud.mdb.mysql.v1.BackupClusterMetadata)**
...
## BackupClusterMetadata {#yandex.cloud.mdb.mysql.v1.BackupClusterMetadata}
