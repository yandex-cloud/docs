---
editable: false
sourcePath: en/_api-ref-grpc/mdb/mysql/v1/api-ref/grpc/Cluster/rescheduleMaintenance.md
---

# Managed Service for MySQL API, gRPC: ClusterService.RescheduleMaintenance {#RescheduleMaintenance}
