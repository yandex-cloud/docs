...
* [Настраивать серверы](#change-mysql-config) [!KEYREF MY] согласно [документации [!KEYREF MY]](https://dev.mysql.com/doc/refman/5.7/en/mysqld-server.html).
...
Изменить настройки СУБД для кластера можно с помощью метода API [update](../api-ref/Cluster/update.md): передайте в запросе нужные значения в параметре `configSpec.mysqlConfig_5_7.config`.
