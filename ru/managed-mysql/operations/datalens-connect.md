...
- Консоль управления {#console}
  ...
  1. Введите пароль пользователя. Смотрите также [{#T}](../../datalens/operations/connection/create-mysql.md) и [{#T}](../../datalens/dataset/create-dataset.md#access) в документации {{ datalens-name }}.
