---
title: Управление алиасами кластера {{ MY }}
...
```text
c-<имя_алиаса>-my-<идентификатор_каталога>.rw.{{ dns-zone }}
```
