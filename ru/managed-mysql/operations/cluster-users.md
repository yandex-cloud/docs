...
- Консоль управления
  ...
  1. Настройте [роли пользователя](../concepts/roles.md) для каждой из выбранных баз данных:
  ...
  1. Задайте настройки {{ MY }} для пользователя в разделе [Дополнительные настройки](#advanced-settings).
  1. Нажмите кнопку **Добавить**.
...
- Консоль управления
  ...
  1. Чтобы предоставить пользователю доступ к определенной базе данных:
      1. Нажмите кнопку **Добавить базу данных**.
      1. Выберите нужную базу данных из выпадающего списка.
  1. Чтобы отозвать доступ к определенной базе, наведите курсор на строку с именем базы и нажмите значок ![image](../../_assets/cross.svg) в конце строки.
  1. Настройте [роли пользователя](../concepts/roles.md) для каждой из выбранных баз данных:
      1. Нажмите значок ![image](../../_assets/plus-sign.svg) в столбце **Роли**.
      1. Выберите роль, которую вы хотите добавить пользователю из выпадающего списка.
      1. Повторите два предыдущих шага, пока не будут добавлены все требуемые роли.
...
- CLI
  ...
  Чтобы изменить список доступных пользователю баз данных, выполните команду:
