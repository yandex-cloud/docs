...
В {{ mmy-name }} доступен [балансировщик нагрузки {{ mdb-lb }}](../concepts/load-balancer.md), который автоматически распределяет запросы по хостам БД в зависимости от их роли и доступности.
