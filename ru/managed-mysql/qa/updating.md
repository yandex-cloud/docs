...
#### Изменение размера диска {#change-size}

Для изменения размера диска воспользуйтесь инструкцией в разделе [Изменение кластера](../operations/update.md#change-disk-size).
