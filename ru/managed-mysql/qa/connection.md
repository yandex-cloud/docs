...
#### Не могу подключиться из интернета {#from-internet}
...
#### Не могу подключиться из {{ yandex-cloud }} {#from-yc}

Проверьте, что вы подключаетесь с виртуальной машины {{ yandex-cloud }}, расположенной в той же [виртуальной сети](../../vpc/concepts/network.md), что и кластер {{ MY }}.
...
#### Не могу подключиться к многохостовому кластеру {#to-multi-host-cluster}
...
#### Превышен лимит соединений {#connection-limit}
