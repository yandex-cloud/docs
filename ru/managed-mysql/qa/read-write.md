...
#### Не работает запись в кластер {#write-failure}
...
#### Размер кластера значительно больше объема данных в нем {#cluster-greater-data}
...
#### Любая ошибка приложения {#application-error}
