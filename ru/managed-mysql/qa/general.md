...
Managed Service for MySQL доступен всем зарегистрированным пользователям Яндекс.Облака.
...
Для хранилища на NVMe-дисках количество хостов ограничено при создании: для MySQL-кластеров можно создать не меньше 3 хостов.
...
Managed Service for MySQL поддерживает MySQL 5.7.
