---
title: "Managed Service for MySQL. Ответы на вопросы"
...
Минимальное количество хостов зависит от типа используемого [хранилища](../concepts/storage.md){% if audience != "internal" %}:
