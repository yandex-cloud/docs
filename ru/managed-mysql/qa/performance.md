...
#### Снижение производительности в пики нагрузки {#degradation-at-peak}
...
#### Общее снижение производительности {#general-degradation}
...
#### Долгая загрузка ресурсов {#long-load}
...
#### Причина утилизации ресурса CPU {#high-cpu}
...
#### Причина утилизации ресурса IO {#high-io}
...
#### Причина утилизации ресурса сети {#high-network}
...
1. Для блокировок уровня таблиц выполните запрос:

   ```sql
   SELECT * FROM sys.schema_table_lock_waits
   ```

1. Для блокировок уровня отдельных строк выполните запрос:
...
#### Оптимизация проблемных запросов {#query-optimization}
