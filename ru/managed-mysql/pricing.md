...
Цены, указанные ниже, начнут действовать 16 ноября 2022 года, когда сервис {{ mmy-name }} [станет общедоступным](../overview/concepts/launch-stages.md). До этого использование сервиса не тарифицируется.
