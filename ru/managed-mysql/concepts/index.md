...
* Кластер из нескольких хостов автоматически является [высокодоступным](high-availability.md) — хосты могут заменять друг друга в качестве основной реплики кластера.

* Кластер из одного хоста обойдется дешевле, но не обеспечивает высокой доступности.
