...
* На _выделенных хостах_ {{ yandex-cloud }}.
    ...
    Подробнее в разделе [{#T}](../../compute/concepts/dedicated-host.md).
...
Созданный в каталоге кластер доступен по сети для всех виртуальных машин, подключенных к этой же облачной сети. Подробнее о работе сети смотрите в [документации {{ vpc-name }}](../../vpc/).
