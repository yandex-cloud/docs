...
description: Класс хостов определяет вычислительные мощности, которые выделяются для каждого хоста в кластере MySQL. Классы хостов {{ mmy-name }} до 20 июня 2023 года.
---
