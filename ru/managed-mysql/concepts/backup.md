...
* Резервные копии хранятся во внутреннем хранилище {{ yandex-cloud }} в виде бинарных файлов и шифруются с помощью [GPG]{% if lang == "ru" %}(https://ru.wikipedia.org/wiki/GnuPG){% endif %}{% if lang == "en" %}(https://en.wikipedia.org/wiki/GNU_Privacy_Guard){% endif %}. У каждого кластера свои ключи шифрования.
...
* {% include [using-storage](../../_includes/mdb/backups/storage.md) %}
    ...
    {% if audience != "internal" %}Подробнее см. в разделе [Правила тарификации для {{ mmy-name }}](../pricing.md#rules-storage).{% endif %}
