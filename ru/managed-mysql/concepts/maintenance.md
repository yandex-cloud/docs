...
Изменение версии СУБД не включено в техническое обслуживание. Подробнее о переходе между версиями смотрите в разделе [{#T}](../operations/cluster-version-update.md).
