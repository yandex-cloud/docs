...
Права, которые действуют на уровне всего кластера баз данных, задаются в [настройках {{ MY }} на уровне пользователя](settings-list.md#setting-administrative-privileges).
