...
При заполнении хранилища более чем на 95% {{ mmy-name }} переводит хост в режим `read-only`. При этом на хосте-мастере устанавливается системная переменная `read_only = 1`.
