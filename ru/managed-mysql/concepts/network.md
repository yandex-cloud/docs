---
title: "Сеть и кластеры в {{ mmy-name }}"
description: "При создании {{ MY }}-кластера вы можете задать сеть для самого кластера, подсети для каждого из хостов кластера и запросить публичный IP-адрес для доступа к кластеру извне {{ yandex-cloud }}."
---
...
При создании {{ MY }}-кластера вы можете:
