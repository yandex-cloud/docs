...
Здесь хост-мастер и две реплики размещены в разных [зонах доступности](../../overview/concepts/geo-scope.md). В этом случае:
...
Подробнее о процессе выбора мастера смотрите в подразделе [Выбор мастера при выходе из строя основного мастера](#master-failover).
