...
1. Создайте виртуальную машину на базе [Ubuntu Linux 20.04](/marketplace/products/f2eanb2gaki4us67hn9q) со следующими параметрами:

{% endif %}

    * **Диски{% if product == "yandex-cloud" %} и файловые хранилища{% endif %}** → **Размер** — достаточный для хранения распакованного и нераспакованого дампов.
