...
## Справочники API сервисов {{ yandex-cloud }}
- Infrastructure:
...
- Data storage & Analytics:
   ...
   - [{{ mkf-full-name }}](../managed-kafka/api-ref/) _Сервис находится на стадии [Preview](./concepts/launch-stages.md)._
   - [{{ mes-full-name }}](../managed-elasticsearch/api-ref/) _Сервис находится на стадии [Preview](./concepts/launch-stages.md)._
- Serverless:
