...
- API-ключи, которые служат для доступа к API {{ yandex-cloud }}. API-ключи используются в некоторых сервисах для упрощенной аутентификации. См. раздел [API-ключ](../../iam/concepts/authorization/api-key). 
