...
Сравнение библиотек представлено в разделе [{#T}](../../../kms/tutorials/encrypt/index.md) документации KMS.
...
Для хранения секретов с помощью Vault можно использовать виртуальную машину на основе [образа из Yandex Cloud Marketplace](https://cloud.yandex.ru/marketplace/products/yc/vault-yckms) с предустановленной сборкой HashiCorp Vault и поддержкой Auto Unseal. Инструкция по настройке Auto Unseal приведена в разделе [{#T}](../../../kms/tutorials/vault-secret.md) документации KMS.
