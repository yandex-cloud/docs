...
Однако если срок действия [гранта](../getting-started/free-trial/concepts/usage-grant.md) истек, доступ к вашим ресурсам будет заблокирован на 30 дней или до момента перехода на платное потребление. Подробнее о завершении пробного периода см. на странице [{#T}](../getting-started/free-trial/concepts/trial-ending.md).
