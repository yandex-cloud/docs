...
Однако если срок действия [гранта](../free-trial/concepts/usage-grant.md) истек, доступ к вашим ресурсам будет заблокирован на 30 дней или до момента перехода на платное потребление. Подробнее о завершении пробного периода см. на странице [{#T}](../free-trial/concepts/trial-ending.md).
