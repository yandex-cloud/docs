...
--- | --- | ---
Зоны доступности | `ru-central1-a`<br/>`ru-central1-b`<br/>`ru-central1-d`<br/>`ru-central1-e`<br/>`ru-central1-m` | `kz1-a`
...
Управляемая организация не отображается в списке организаций в консоли управления и недоступна для переключения: работа с ресурсами ведется через облака, [созданные](../../resource-manager/operations/cloud/create-in-another-region.md) в подключенном регионе.
