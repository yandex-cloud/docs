...
* `{{ region-id }}-d` (скоро откроется).

Во втором полугодии 2023 года в Калуге будет открыт новый дата-центр, и появится новая зона доступности `{{ region-id }}-d`. [Подробности в блоге](/blog/posts/2022/09/cloud-data-center-kaluga).
