...
| [{{ neurosupport-full-name }}](../../network-load-balancer/index.yaml) |{{ preview-stage }} Сервис на базе {{ yagpt-name }}, который помогает операторам контакт-центров отвечать на сообщения пользователей. | ![image](../../_assets/common/yes.svg) | ![image](../../_assets/common/no.svg) |
