...
| [{{ cloud-registry-full-name }}](../../cloud-registry/index.yaml)               | Сервис для хранения артефактов разработки и управления ими. | ![image](../../_assets/common/yes.svg) | ![image](../../_assets/common/no.svg) |
