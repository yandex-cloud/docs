...
|| [{{ ycdr-full-name }}](../../ycdr/index.yaml) | Сервис собирает данные с облачной инфраструктуры для выявления аномалий | ![image](../../_assets/common/yes.svg) | ![image](../../_assets/common/no.svg) ||
