...
| [{{ quota-manager-full-name }}](../../quota-manager/index.yaml)                 | Сервис для управления квотами ваших ресурсов в облаке. | ![image](../../_assets/common/yes.svg) | ![image](../../_assets/common/no.svg) |
...
| [{{ cr-full-name }}](../../cloud-router/index.yaml)               | Сервис для управления сетевыми топологиями гибридного облака в {{ yandex-cloud }}. | ![image](../../_assets/common/yes.svg) | ![image](../../_assets/common/yes.svg) |
| [{{ stackland-full-name }}](../../stackland/index.yaml)                         | {{ preview-stage }} Сервис для управления AI‑нагрузками и микросервисными решениями в закрытом контуре компании. | ![image](../../_assets/common/yes.svg) | ![image](../../_assets/common/no.svg) |
...
| [{{ sd-full-name }}](../../security-deck/index.yaml)                            | {{ preview-stage }} Сервис для управления безопасностью в облаке. | ![image](../../_assets/common/yes.svg) | ![image](../../_assets/common/yes.svg) |
