...
* [{{ at-full-name }}](../../audit-trails/) (Сервис сбора и выгрузки аудитных логов). _Сервис находится на стадии [Preview](./launch-stages.md)._
...
* [{{ cloud-desktop-full-name }}](../../cloud-desktop/) (Сервис для создания удаленных рабочих мест в облаке). _Сервис находится на стадии [Preview](./launch-stages.md)._
* [{{ dns-full-name }}](../../dns/) (Сервис администрирования ресурсных записей DNS и обслуживания DNS-запросов).
...
* [{{ cloud-logging-full-name }}](../../logging/) (Сервис для агрегации и чтения логов пользовательских приложений и ресурсов {{ yandex-cloud }}). _Сервис находится на стадии [Preview](./launch-stages.md)._
* [{{ org-full-name }}](../../organization) (Cервис для управления составом организации, настройки интеграции с каталогом сотрудников и разграничения доступа пользователей к облачным ресурсам организации).
* [{{ compute-full-name }}](../../compute/) (Сервис для создания и управления виртуальными машинами).
...
* [{{ yds-full-name }}](../../data-streams/) (Сервис для управления потоками данных
в режиме реального времени).
* [{{ data-transfer-full-name }}](../../data-transfer/) (Сервис для миграции баз данных).
* [{{ ydb-full-name }}](../../managed-ydb/) (Сервис управления для базы данных {{ ydb-full-name }}).
...
* [{{ iot-full-name }}](../../iot-core/) (Сервис интернета вещей для двустороннего обмена сообщениями между реестрами и устройствами по протоколу MQTT).
* [{{ kms-full-name }}](../../kms/) (Сервис для управления ключами шифрования).
* [{{ load-testing-full-name }}](../../load-testing/) (Сервис для проведения нагрузочного тестирования и анализа производительности). _Сервис находится на стадии [Preview](./launch-stages.md)._
* [{{ lockbox-name }}](../../lockbox) (Сервис для создания и хранения секретов в инфраструктуре {{ yandex-cloud }}). _Сервис находится на стадии [Preview](./launch-stages.md)._
...
* [{{ mgl-full-name }}](../../managed-gitlab/) (Сервис для управления DevOps-платформой {{ GL }}). _Сервис находится на стадии [Preview](./launch-stages.md)._
