...
{% if product == "yandex-cloud" %}* [{{ iot-full-name }}](../../iot-core/) (Сервис интернета вещей для двустороннего обмена сообщениями между реестрами и устройствами по протоколу MQTT).{% endif %}
...
{% if product == "yandex-cloud" %}* [{{ mgl-full-name }}](../../managed-gitlab/) (Сервис для управления DevOps-платформой {{ GL }}). _Сервис находится на стадии [Preview](./launch-stages.md)._{% endif %}
