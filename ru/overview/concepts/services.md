...
| [{{ foundation-models-full-name }}](../../ai-studio/index.yaml)         | Cервис больших генеративных моделей для бизнеса. | ![image](../../_assets/common/yes.svg) | ![image](../../_assets/common/no.svg) |
