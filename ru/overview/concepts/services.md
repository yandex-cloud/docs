...
| [{{ cns-full-name }}](../../notifications/index.yaml)                           | {{ preview-stage }} Сервис для мультиканальной отправки уведомлений пользователям. | ![image](../../_assets/common/yes.svg) | ![image](../../_assets/common/no.svg) |
