...
| [{{ marketplace-full-name }}](../../marketplace/index.yaml) | Магазин готовых инструментов для разработки и других задач. |
...
| [{{ sws-full-name }}](../../smartwebsecurity/index.yaml) | Сервис для защиты от DDoS-атак на прикладном уровне L7 модели OSI. |
