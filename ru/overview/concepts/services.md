...
| [{{ baremetal-full-name }}](../../baremetal/index.yaml)                         | {{ preview-stage }} Сервис аренды выделенного физического сервера. | ![image](../../_assets/common/yes.svg) | ![image](../../_assets/common/no.svg) |
