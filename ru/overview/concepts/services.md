...
| [{{ ca-full-name }}](../../code-assistant/index.md)                           | {{ preview-stage }} AI-ассистент разработчика с функцией автодополнения кода. | ![image](../../_assets/common/yes.svg) | ![image](../../_assets/common/no.svg) |
