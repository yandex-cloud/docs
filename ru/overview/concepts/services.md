...
| [{{ at-full-name }}](../../audit-trails/) | {% if product == "yandex-cloud" %}{{ preview-stage }}{% endif %} Сервис сбора и выгрузки аудитных логов. |
| [{{ certificate-manager-full-name }}](../../certificate-manager/) | Сервис для управления TLS-сертификатами. |
{% if product == "yandex-cloud" %}| [{{ cloud-apps-full-name }}](../../cloud-apps/) | {{ preview-stage }} Сервис для разворачивания приложений на базе стека serverless. |{% endif %}
{% if product == "yandex-cloud" %}| [{{ backup-full-name }}](../../backup/) | {{ preview-stage }} Сервис для резервного копирования ресурсов {{ yandex-cloud }}. |{% endif %}
{% if product == "yandex-cloud" %}| [{{ cdn-full-name }}](../../cdn/) | Сервис для организации сети распространения контента. |{% endif %}
{% if product == "yandex-cloud" %}| [{{ cloud-desktop-full-name }}](../../cloud-desktop/) | {{ preview-stage }} Сервис для создания удаленных рабочих мест в облаке. |{% endif %}
...
{% if product == "yandex-cloud" %}| [{{ cloud-logging-full-name }}](../../logging/) | Сервис для агрегации и чтения логов пользовательских приложений и ресурсов {{ yandex-cloud }}. |{% endif %}
...
{% if product == "yandex-cloud" %}| [{{ load-testing-full-name }}](../../load-testing/) | {{ preview-stage }} Сервис для проведения нагрузочного тестирования и анализа производительности. |{% endif %}
| [{{ lockbox-name }}](../../lockbox) | {% if product == "yandex-cloud" %}{{ preview-stage }}{% endif %} Сервис для создания и хранения секретов в инфраструктуре {{ yandex-cloud }}. |
...
{% if product == "yandex-cloud" %}| [{{ yq-full-name }}](../../query/) | {{ preview-stage }} Сервис выполнения запросов с помощью единого диалекта SQL. |{% endif %}
...
{% if product == "yandex-cloud" %}| [{{ captcha-full-name }}](../../smartcaptcha/) | Сервис для распознавания пользователей системы. |{% endif %}
