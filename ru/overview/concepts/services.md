...
| [{{ quota-manager-full-name }}](../../quota-manager/index.yaml)                 | {{ preview-stage }} Сервис отправки транзакционных почтовых сообщений. | ![image](../../_assets/common/yes.svg) | ![image](../../_assets/common/yes.svg) |
...
| [{{ myt-full-name }}](../../managed-ytsaurus/index.yaml)                                     | {{ preview-stage }} Сервис для создания и управления кластерами {{ ytsaurus-name }} | ![image](../../_assets/common/yes.svg) | ![image](../../_assets/common/no.svg) |
