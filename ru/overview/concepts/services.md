...
| [{{ foundation-models-full-name }}]({{ link-docs-ai }}ai-studio/index)         | Cервис больших генеративных моделей для бизнеса. | ![image](../../_assets/common/yes.svg) | ![image](../../_assets/common/no.svg) |
...
| [{{ search-api-full-name }}]({{ link-docs-ai }}search-api/index.yaml)                       | Сервис поисковых запросов. | ![image](../../_assets/common/yes.svg) | ![image](../../_assets/common/no.svg) |
...
| [{{ speechkit-full-name }}]({{ link-docs-ai }}{{ speechkit-slug }}/index)              | Сервис технологий распознавания и синтеза речи. | ![image](../../_assets/common/yes.svg) | ![image](../../_assets/common/yes.svg) |
...
| [{{ translate-full-name }}]({{ link-docs-ai }}translate/index)                         | Сервис машинного перевода. | ![image](../../_assets/common/yes.svg) | ![image](../../_assets/common/no.svg) |
...
| [{{ vision-full-name }}]({{ link-docs-ai }}vision/index)                               | Сервис компьютерного зрения для распознавания текста на изображениях и в файлах PDF. | ![image](../../_assets/common/yes.svg) | ![image](../../_assets/common/no.svg) |
