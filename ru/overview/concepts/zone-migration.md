...
В течение 2024 года зона `{{ region-id }}-с` будет [выведена из эксплуатации](./ru-central1-c-deprecation.md) (точные сроки будут объявлены в 1 квартале 2024 года). Ресурсы из нее можно переместить в новую зону доступности — `{{ region-id }}-d`.
...
Для миграции рабочего стола необходимо создать новый рабочий стол в другой зоне доступности и самостоятельно перенести туда данные. Специализированные инструменты для миграции рабочих столов не предусмотрены.