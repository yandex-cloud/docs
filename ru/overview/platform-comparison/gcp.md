...
| Cloud Search | [{{ search-api-full-name }}]({{ link-docs-ai }}search-api/) |
| Cloud Security Command Center | [{{ sd-full-name }}](../../security-deck/) |
| Cloud Spanner | [{{ ydb-full-name }}](../../ydb/) |
| Cloud Speech-to-Text,<br/>Cloud Text-to-Speech | [{{ speechkit-full-name }}]({{ link-docs-ai }}{{ speechkit-slug }}/) |
...
| Cloud Translation API | [{{ translate-full-name }}]({{ link-docs-ai }}translate/) |
| Cloud Vision | [{{ vision-full-name }}]({{ link-docs-ai }}vision/) |
...
| Образы GitLab для ВМ в Google Cloud Marketplace, Google Cloud Developer Tools | [{{ mgl-full-name }}](../../managed-gitlab/) |