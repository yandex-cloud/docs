...
Особенность архитектуры {{ yandex-cloud }} — единый пул унифицированных аппаратных ресурсов. В {{ yandex-cloud }} нет выделенных физических серверов управления, многие сервисы платформы развернуты на таких же [виртуальных машинах](../glossary/vm.md), как и у внешних пользователей. 
