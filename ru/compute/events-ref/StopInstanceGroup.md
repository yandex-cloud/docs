---
editable: false
sourcePath: en/_events-ref/audit/compute/events-ref/StopInstanceGroup.md
---

# Compute Audit Trails Events: StopInstanceGroup

## Event JSON schema {#yandex.cloud.audit.compute.instancegroup.StopInstanceGroup2-schema}
...
## Field description {#yandex.cloud.audit.compute.instancegroup.StopInstanceGroup2}
...
|| details | **[EventDetails](#yandex.cloud.audit.compute.instancegroup.StopInstanceGroup.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.compute.instancegroup.StopInstanceGroup.EventDetails}
