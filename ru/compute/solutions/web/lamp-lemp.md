...
Публичный IP-адрес можно сделать статическим. Подробнее читайте в разделе [[!TITLE]](../../operations/vm-control/vm-set-static-ip.md).
...
[!INCLUDE [upload-files](../../_includes_service/upload-web-site-files.md)]
