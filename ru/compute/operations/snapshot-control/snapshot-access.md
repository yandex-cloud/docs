---
title: "Настроить права доступа к снимку диска"
description: "Следуя данной инструкции, вы сможете настроить права доступа к снимку диска."
---

# Настроить права доступа к снимку диска

Чтобы предоставить пользователю, группе или [сервисному аккаунту](../../../iam/concepts/users/service-accounts.md) доступ к [снимку диска](../../concepts/snapshot.md), назначьте [роль](../../../iam/concepts/access-control/roles.md) на него.
...
- CLI {#cli}
  ...
  1. Посмотрите список ролей, которые уже назначены на ресурс:
     ...
     ```bash
     yc compute snapshot list-access-bindings <имя_или_идентификатор_снимка>
     ```
  ...
  1. Назначьте роль с помощью команды:
     ...
     * Пользователю:
       ...
       ```bash
       yc compute snapshot add-access-binding <имя_или_идентификатор_снимка> \
...
- CLI {#cli}
  ...
  1. Назначьте роли:
     ...
     ```bash
     yc compute snapshot set-access-bindings <имя_или_идентификатор_снимка> \
...
- CLI {#cli}
  ...
  1. Чтобы удалить привязку прав доступа, выполните команду:
      ...
      ```bash
      yc compute snapshot remove-access-binding <имя_или_идентификатор_снимка> \
