...
### Получение информации о виртуальной машине {#vm-info}
...
### Образы с предустановленным ПО {#images-with-pre-installed-software}
...
### Группы размещения виртуальных машин {#placement-groups-vm}
...
### Группы размещения дисков {#placement-groups-disks}
...
#### Обновление группы виртуальных машин {#ig-update}
...
## Прочие инструкции {#get-additional-info}
