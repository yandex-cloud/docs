...
Вы можете получить основную информацию о каждой созданной вами виртуальной машине в [консоли управления](https://console.cloud.yandex.ru), на странице виртуальной машины. Чтобы получить детальную информацию вместе с пользовательскими [метаданными](../../concepts/vm-metadata.md), воспользуйтесь CLI или API.
