...
- Консоль управления
  ...
  1. (опционально) В блоке **Диски** нажмите **Добавить диск**:
      * Введите имя диска.
      ...
      * В поле **Наполнение** выберите **Диск** и отметьте диск для подключения. Если диска нет, [создайте](../disk-create/empty.md) его.
