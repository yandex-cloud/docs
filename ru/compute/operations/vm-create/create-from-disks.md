...
Создать виртуальную машину можно из существующих дисков. Диски должны находится в одной из зон доступности и не быть добавлены к другим виртуальным машинам.
