...
Вы можете создать виртуальную машину с дисками, восстановленными из имеющихся в каталоге снимков. Как создать снимок диска, описано в разделе [{#T}](../disk-control/create-snapshot.md).
