...
Cоздайте [виртуальную машину](../../concepts/vm.md) DSVM с помощью сервиса {{ compute-name }} в консоли управления {{ yandex-cloud }} и подключитесь к ней по протоколу SSH.
