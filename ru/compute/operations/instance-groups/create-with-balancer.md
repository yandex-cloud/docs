...
- Консоль управления {#console}
  ...
  1. Укажите настройки целевой группы. Подробнее в разделе [{#T}](../../concepts/instance-groups/balancers.md#settings-nlb).
