...
- Консоль управления
  ...
  1. Задайте настройки проверок состояния:
      ...
      - Время ожидания ответа в секундах.
        ...
        Если вы [подключили группу к балансировщику](create-with-balancer.md), рекомендуем здесь выставить значение _меньше_, чем в балансировщике.
...
- CLI
  ...
  1. Добавьте в файл спецификацию проверок состояния, например для проверок по протоколу HTTP:
     ...
     ```
      ...
      `timeout` | Время ожидания ответа в секундах.<br>Если вы [подключили группу к балансировщику](create-with-balancer.md), рекомендуем здесь выставить значение _меньше_, чем в балансировщике.
