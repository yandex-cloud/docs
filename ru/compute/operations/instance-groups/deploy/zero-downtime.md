...
1. Задайте [политику развертывания](../../../concepts/instance-groups/policies.md#deploy-policy) с ненулевым значением `max_expansion` — максимальным количеством дополнительно создаваемых машин.
