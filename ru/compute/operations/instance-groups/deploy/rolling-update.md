...
1. Задайте [политику развертывания](../../../concepts/instance-groups/policies.md#deploy-policy) с ненулевым значением `max_unavailable` — максимальным количеством машин, одновременно выводимых из эксплуатации.
