...
- CLI {#cli}
  ...
  1. Измените конфигурацию ВМ:
      ...
      Значения параметров `--cores` (количество vCPU) и `--memory` (размер RAM в ГБ) зависят от платформы и количества GPU. Смотрите [список доступных конфигураций](../../concepts/gpus.md#config).
