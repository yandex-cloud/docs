...
1. Измените [конфигурацию](../../concepts/vm-types.md) виртуальной машины, в блоке **Вычислительные ресурсы**:
...
1. Получите текущую [конфигурацию](../../concepts/vm-types.md) виртуальной машины вместе с [метаданными](../../concepts/vm-metadata.md):
...
1. Измените конфигурацию виртуальной машины:
    ...
    * **Тип виртуальной машины** — на стандартный.
    * **vCPU** — на 4.
    * **RAM** — на 32 ГБ.
