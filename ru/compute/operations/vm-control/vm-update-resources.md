...
При изменении ресурсов ВМ возможна смена PCI топологии, что стоит учитывать в операционных системах чувствительных к таким изменениям (e.g. при сильно кастомных настройках сети Windows Server возможна потеря сетевой связанности и как следствие пропадание доступа до ВМ)
