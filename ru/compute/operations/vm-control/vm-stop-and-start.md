...
1. Чтобы остановить одну виртуальную машину, выберите машину → нажмите значок ![](../../../_assets/dots.svg) → выберите пункт **Остановить**.
...
1. В консоли управления выберите каталог, которому принадлежит виртуальная машина.
1. Нажмите плитку **Yandex Compute Cloud**.
1. Чтобы запустить одну виртуальную машину, выберите машину → нажмите значок ![](../../../_assets/dots.svg) → выберите пункт **Запустить**.
...
1. В консоли управления выберите каталог, которому принадлежит виртуальная машина.
1. Нажмите плитку **Yandex Compute Cloud**.
1. Чтобы перезапустить одну виртуальную машину, выберите машину → нажмите значок ![](../../../_assets/dots.svg) → выберите пункт **Перезапустить**.
