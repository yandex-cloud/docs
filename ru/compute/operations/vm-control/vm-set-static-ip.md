...
Публичные статические IP-адреса тарифицируются по отдельному тарифу. Подробнее читайте в разделе [#T](../../../vpc/pricing.md#prices-public-ip) документации сервиса Virtual Private Cloud.
...
- Консоль управления
  ...
  1. Сделайте публичный IP-адрес статическим. Подробнее читайте в разделе [#T](../../../vpc/operations/set-static-ip.md) документации сервиса Virtual Private Cloud.
