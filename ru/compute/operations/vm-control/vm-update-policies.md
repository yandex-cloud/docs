# Изменить политику обслуживания

Для изменения [политики обслуживания ВМ](../../concepts/vm-policies.md) необходимо выполнить следующие действия:

1. [Создать ВМ с настроенной политикой обслуживания](#create).
2. [Проверить обработку событий обслуживания](#check).
3. [Подключиться к ВМ по SSH](#ssh).
4. [Создать скрипт для отслеживания событий обслуживания ВМ](#script).
5. [Симулировать наступление события обслуживания ВМ](#simulate).
6. [Опционально. Изменить тип политики обслуживания для ВМ](#change-policy).
...
## Проверить обработку событий обслуживания {#check}
