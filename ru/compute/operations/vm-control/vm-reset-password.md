...
* [Агент для сброса паролей](../../concepts/guest-agent.md). Агент входит в состав стандартных образов Windows с xx ноября 2021 года. Если ваша ВМ создана раньше или вы пользуетесь собственным образом, для сброса паролей установите агент по [инструкции](../vm-guest-agent/install.md).
...
- PowerShell
  ...
  1. Выполните следующую команду:
     ...
     Если команда выполняется слишком долго, остановите ее с помощью клавиш **Ctrl + C**. После этого проверьте, что агент для сброса паролей установлен, и посмотрите логи его работы. Подробнее см. в разделе [{#T}](../vm-guest-agent/check.md).
