# Посмотреть операции с ресурсами сервиса {{ compute-name }}
...
- Консоль управления {#console}
  ...
  Чтобы посмотреть операции со всеми ресурсами сервиса, на панели слева выберите ![image](../../_assets/operations.svg) **{{ ui-key.yacloud.compute.operations_kRLeR }}**. В открывшемся списке также отображаются операции для ресурсов, которые были удалены.
