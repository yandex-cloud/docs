...
1. Если виртуальная машина запущена и работает ([статус](../../concepts/vm-statuses.md) `RUNNING`), [остановите ее](../vm-control/vm-stop-and-start.md).
1. Привяжите файловое хранилище к ВМ в {{ compute-name }}:
   ...
   - Консоль управления
     ...
     1. В консоли управления выберите каталог, в котором создано файловое хранилище.
