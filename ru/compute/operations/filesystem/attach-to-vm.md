...
1. Смонтируйте файловое хранилище к ВМ:
   ...
   1. Выполните команду:
      ...
      Если вы не указали или забыли имя устройства при привязывании файлового хранилища к ВМ, его можно получить с помощью команды [CLI](../../../cli/quickstart.md):
      ...
      В качестве имени устройства используйте значение поля `device_name` в блоке `filesystems`.
