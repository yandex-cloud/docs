...
Для виртуальных машин с системами, требующими развертывания, например, Drupal, GitLab, Joomla и WordPress, для первоначальной настройки используйте [веб-мастер установки](#web-setup).

## Настройка программного обеспечения через мастер установки {#web-setup}
