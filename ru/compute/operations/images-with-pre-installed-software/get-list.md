...
- Консоль управления
  ...
  1. В блоке **Выбор образа/загрузочного диска** перейдите на вкладку **{{ marketplace-name }}**.
  1. Нажмите кнопку **Посмотреть больше**. Отобразится список всех публичных образов.
