...
- Консоль управления
  ...
  1. (опционально) Если вы хотите добавить к виртуальной машине дополнительные диски, [выберите их](../vm-create/create-from-disks.md) в блоке **Дискии файловые хранилища** на вкладке **Диски**.
