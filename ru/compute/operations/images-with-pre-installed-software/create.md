...
1. В блоке **Вычислительные ресурсы**:
    ...
    Для создания виртуальной машины из образа [GitLab](https://cloud.yandex.ru/marketplace/products/f2eb5e8deq602ccak537) требуется не меньше 4 виртуальных ядер (100% vCPU) и 4 ГБ оперативной памяти.
