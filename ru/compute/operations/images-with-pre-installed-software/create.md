...
- Консоль управления
  ...
  1. (опционально) Если вы хотите добавить к виртуальной машине дополнительные диски, [выберите их](../vm-create/create-from-disks.md) в блоке **Диски{% if product == "yandex-cloud" %} и файловые хранилища{% endif %}** на вкладке **Диски**.
  ...
  1. В блоке **Вычислительные ресурсы**:
      ...
      * Укажите [гарантированную долю](../../concepts/performance-levels.md) и необходимое количество vCPU и объем RAM.
      ...
      Каждый публичный образ имеет свои минимальные системные требования к виртуальной машине. Например, для образа [GitLab](/marketplace/products/f2eb5e8deq602ccak537) требуется не меньше 4 виртуальных ядер и 8 ГБ оперативной памяти.
