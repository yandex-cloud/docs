...
Эта инструкция описывает, как подготовить образ диска, а также загрузить файл с образом в {{ objstorage-name }} и создать из него [образ](../../concepts/image.md) в сервисе {{ compute-name }}.
