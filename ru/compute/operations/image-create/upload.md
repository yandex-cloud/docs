...
1. [Получите](../../../storage/operations/objects/link-for-download.md) подписанную [ссылку](../../../storage/concepts/pre-signed-urls.md) на скачивание образа их бакета. Используйте эту ссылку при создании образа в {{ compute-name }}.
