...
Эта инструкция описывает, как загрузить файл с образом диска в {{ objstorage-name }} и создать из него [образ](../../concepts/image.md) в сервисе {{ compute-name }}. Поддерживаемые форматы образов: Qcow2, VMDK, VHD. На данный момент нельзя загрузить свой образ с операционной системой Windows.

## 1. Загрузите файл образа в {{ objstorage-name }}
...
## 2. Создайте образ в {{ compute-name }}
...
## 3. Удалите образ из {{ objstorage-name }}
