...
Эта инструкция описывает, как загрузить файл с образом диска в Яндекс.Облако и создать из него [образ](../../concepts/images.md) в сервисе [!KEYREF compute-name]. На данный момент нельзя загрузить свой образ с операционной системой Windows. Поддерживаемые форматы образов: Qcow2, VMDK, VHD.
