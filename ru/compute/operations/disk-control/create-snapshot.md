...
Во время создания снимка высокопроизводительного или нереплицируемого SSD все операции записи будут приостановлены, а диск будет доступен только для чтения. Все приостановленные операции записи (если они были запрошены от гостевой ОС) выполнятся после завершения создания снимка.
