...
description: "Удалить можно только не подключенный к виртуальной машине диск. Удаление диска — неотменяемая и необратимая операция, восстановить удаленный диск невозможно. Удаление диска не приводит к удалению снимков этого диска. Снимки нужно удалять отдельно. Чтобы удалить диск в консоли управления выберите каталог, которому принадлежит диск, выберите сервис Compute Cloud, на странице Виртуальные машины перейдите на вкладку Диски. В строке с нужным диском нажмите значок выбора и нажмите Удалить."
