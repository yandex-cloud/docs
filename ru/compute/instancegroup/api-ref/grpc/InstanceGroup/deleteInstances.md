---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/instancegroup/api-ref/grpc/InstanceGroup/deleteInstances.md
---

# Compute Cloud Instance Groups API, gRPC: InstanceGroupService.DeleteInstances {#DeleteInstances}
...
To get the ID of the instance group, use the [InstanceGroupService.List](/docs/compute/api-ref/grpc/InstanceGroup/list#List) request. ||
...
|| metadata | **[DeleteInstancesMetadata](#yandex.cloud.compute.v1.instancegroup.DeleteInstancesMetadata)**
...
## DeleteInstancesMetadata {#yandex.cloud.compute.v1.instancegroup.DeleteInstancesMetadata}
