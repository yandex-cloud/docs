---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/instancegroup/api-ref/grpc/InstanceGroup/start.md
---

# Compute Cloud Instance Groups API, gRPC: InstanceGroupService.Start {#Start}

Starts the specified instance group.

## gRPC request

**rpc Start ([StartInstanceGroupRequest](#yandex.cloud.compute.v1.instancegroup.StartInstanceGroupRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## StartInstanceGroupRequest {#yandex.cloud.compute.v1.instancegroup.StartInstanceGroupRequest}
