...
Поле | Описание
--- | ---
folderId | **string**<br><p>Идентификатор каталога, в котором создается группа размещения.</p> <p>Чтобы получить идентификатор каталога, используйте запрос <a href="/docs/resource-manager/api-ref/Folder/list">list</a>.</p> 
name | **string**<br><p>Имя группы размещения.</p> 
description | **string**<br><p>Описание группы размещения.</p> 
labels | **object**<br><p>Метки группы размещения в формате <code>key:value</code>.</p> 
