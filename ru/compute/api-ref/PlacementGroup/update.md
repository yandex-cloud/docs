...
Параметр | Описание
--- | ---
placementGroupId | Идентификатор обновляемой группы размещения.  Чтобы получить идентификатор группы размещения, используйте запрос [list](/docs/compute/api-ref/PlacementGroup/list).
