...
--- | ---
imageId | Required. ID of the Image resource to return. To get the image ID, use a [list](/docs/compute/api-ref/Image/list) request.  The maximum string length in characters is 50.
