...
images.<br>id | **string**<br><p>Только для вывода. Идентификатор образа.</p> 
images.<br>folderId | **string**<br><p>Идентификатор каталога, которому принадлежит образ.</p> 
images.<br>createdAt | **string** (date-time)<br><p>Только для вывода. Время создания ресурса в формате в <a href="https://www.ietf.org/rfc/rfc3339.txt">RFC3339</a>.</p> 
...
images.<br>storageSize | **string** (int64)<br><p>Только для вывода. Размер образа в байтах.</p> 
...
images.<br>status | **string**<br><p>Только для вывода. Текущий статус образа.</p> <ul> <li>CREATING: Образ создается.</li> <li>READY: Образ готов к использованию.</li> <li>ERROR: С образом произошла ошибка, блокирующая работу.</li> <li>DELETING: Образ удаляется.</li> </ul> 
