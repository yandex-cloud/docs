...
pageToken | Токен страницы. Установите значение [pageToken](/docs/compute/api-ref/Snapshot/list#query_params) равным значению поля [nextPageToken](/docs/compute/api-ref/Snapshot/list#responses) прошлого запроса, чтобы получить следующую страницу результатов.  Максимальная длина строки в символах — 100.
...
Поле | Описание
--- | ---
snapshots | **object**<br><p>Ресурс Snapshot. Подробнее см. <a href="/docs/compute/concepts/snapshot">Снимки дисков</a>.</p> 
