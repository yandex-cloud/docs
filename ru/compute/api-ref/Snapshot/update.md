...
Параметр | Описание
--- | ---
snapshotId | Обязательное поле. Идентификатор изменяемого ресурса Snapshot. Чтобы получить идентификатор снимка, используйте запрос [list](/docs/compute/api-ref/Snapshot/list).  Максимальная длина строки в символах — 50.
