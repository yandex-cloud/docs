...
Удаление снимка - необратимая операция, его данные удаляются
навсегда.
...
Name | Description
--- | ---
snapshotId | Обязательное поле. Идентификатор удаляемого снимка. Чтобы получить идентификатор снимка, используйте запрос [list](/docs/compute/api-ref/Snapshot/list).  Максимальная длина — 50 символов.
