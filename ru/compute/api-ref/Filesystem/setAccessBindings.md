...
editable: false
apiPlayground:
  - url: https://compute.{{ api-host }}/compute/v1/filesystems/{resourceId}:setAccessBindings
    method: post
    path:
      type: object
      properties:
...
```
POST https://compute.{{ api-host }}/compute/v1/filesystems/{resourceId}:setAccessBindings
```
