---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/api-ref/grpc/Filesystem/setAccessBindings.md
---

# Compute Cloud API, gRPC: FilesystemService.SetAccessBindings {#SetAccessBindings}
