---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/api-ref/grpc/Filesystem/listAccessBindings.md
---

# Compute Cloud API, gRPC: FilesystemService.ListAccessBindings {#ListAccessBindings}
