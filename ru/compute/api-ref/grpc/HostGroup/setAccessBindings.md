---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/api-ref/grpc/HostGroup/setAccessBindings.md
---

# Compute Cloud API, gRPC: HostGroupService.SetAccessBindings {#SetAccessBindings}
