---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/api-ref/grpc/HostGroup/listInstances.md
---

# Compute Cloud API, gRPC: HostGroupService.ListInstances {#ListInstances}

Lists instances that belongs to the specified host group.

## gRPC request

**rpc ListInstances ([ListHostGroupInstancesRequest](#yandex.cloud.compute.v1.ListHostGroupInstancesRequest)) returns ([ListHostGroupInstancesResponse](#yandex.cloud.compute.v1.ListHostGroupInstancesResponse))**

## ListHostGroupInstancesRequest {#yandex.cloud.compute.v1.ListHostGroupInstancesRequest}
...
Required field. ID of the host group to list instances for.
...
the service returns a [ListHostGroupInstancesResponse.nextPageToken](#yandex.cloud.compute.v1.ListHostGroupInstancesResponse)
that can be used to get the next page of results in subsequent list requests. ||
|| pageToken | **string**

Page token. To get the next page of results,
set `pageToken` to the [ListHostGroupInstancesResponse.nextPageToken](#yandex.cloud.compute.v1.ListHostGroupInstancesResponse)
...
Currently you can use filtering only on the [Host.id](/docs/compute/api-ref/grpc/HostGroup/listHosts#yandex.cloud.compute.v1.Host) field.
To get the host ID, use [HostGroupService.ListHosts](/docs/compute/api-ref/grpc/HostGroup/listHosts#ListHosts) request. ||
|#

## ListHostGroupInstancesResponse {#yandex.cloud.compute.v1.ListHostGroupInstancesResponse}
...
is more than [ListHostGroupInstancesRequest.pageSize](#yandex.cloud.compute.v1.ListHostGroupInstancesRequest), use
`nextPageToken` as the value
for the [ListHostGroupInstancesRequest.pageToken](#yandex.cloud.compute.v1.ListHostGroupInstancesRequest) query parameter
