---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/api-ref/grpc/Snapshot/setAccessBindings.md
---

# Compute Cloud API, gRPC: SnapshotService.SetAccessBindings {#SetAccessBindings}
