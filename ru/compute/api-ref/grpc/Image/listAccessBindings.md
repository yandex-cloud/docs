---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/api-ref/grpc/Image/listAccessBindings.md
---

# Compute Cloud API, gRPC: ImageService.ListAccessBindings {#ListAccessBindings}
