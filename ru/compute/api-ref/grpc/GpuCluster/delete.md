---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/api-ref/grpc/GpuCluster/delete.md
---

# Compute Cloud API, gRPC: GpuClusterService.Delete {#Delete}
...
**rpc Delete ([DeleteGpuClusterRequest](#yandex.cloud.compute.v1.DeleteGpuClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## DeleteGpuClusterRequest {#yandex.cloud.compute.v1.DeleteGpuClusterRequest}
