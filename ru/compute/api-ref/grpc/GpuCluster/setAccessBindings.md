---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/api-ref/grpc/GpuCluster/setAccessBindings.md
---

# Compute Cloud API, gRPC: GpuClusterService.SetAccessBindings {#SetAccessBindings}
