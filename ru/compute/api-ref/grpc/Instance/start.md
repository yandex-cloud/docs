---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/api-ref/grpc/Instance/start.md
---

# Compute Cloud API, gRPC: InstanceService.Start {#Start}

Starts the stopped instance.

## gRPC request

**rpc Start ([StartInstanceRequest](#yandex.cloud.compute.v1.StartInstanceRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## StartInstanceRequest {#yandex.cloud.compute.v1.StartInstanceRequest}
...
Required field. ID of the instance to start.
...
|| metadata | **[StartInstanceMetadata](#yandex.cloud.compute.v1.StartInstanceMetadata)**
...
## StartInstanceMetadata {#yandex.cloud.compute.v1.StartInstanceMetadata}
