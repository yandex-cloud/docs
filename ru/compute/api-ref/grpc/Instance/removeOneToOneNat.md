---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/api-ref/grpc/Instance/removeOneToOneNat.md
---

# Compute Cloud API, gRPC: InstanceService.RemoveOneToOneNat

Removes One-to-one NAT from the network interface.

## gRPC request

**rpc RemoveOneToOneNat ([RemoveInstanceOneToOneNatRequest](#yandex.cloud.compute.v1.RemoveInstanceOneToOneNatRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## RemoveInstanceOneToOneNatRequest {#yandex.cloud.compute.v1.RemoveInstanceOneToOneNatRequest}
