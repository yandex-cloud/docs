---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/api-ref/grpc/Instance/detachNetworkInterface.md
---

# Compute Cloud API, gRPC: InstanceService.DetachNetworkInterface {#DetachNetworkInterface}

Detaches the network-interface to the instance.

To Detach a network-interface, the instance must have a `STOPPED` status ([Instance.status](#yandex.cloud.compute.v1.Instance)).
...
**rpc DetachNetworkInterface ([DetachInstanceNetworkInterfaceRequest](#yandex.cloud.compute.v1.DetachInstanceNetworkInterfaceRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## DetachInstanceNetworkInterfaceRequest {#yandex.cloud.compute.v1.DetachInstanceNetworkInterfaceRequest}
...
|| metadata | **[DetachInstanceNetworkInterfaceMetadata](#yandex.cloud.compute.v1.DetachInstanceNetworkInterfaceMetadata)**
...
## DetachInstanceNetworkInterfaceMetadata {#yandex.cloud.compute.v1.DetachInstanceNetworkInterfaceMetadata}
