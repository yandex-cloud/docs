---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/api-ref/grpc/Instance/detachDisk.md
---
...
**rpc DetachDisk ([DetachInstanceDiskRequest](#yandex.cloud.compute.v1.DetachInstanceDiskRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## DetachInstanceDiskRequest {#yandex.cloud.compute.v1.DetachInstanceDiskRequest}

```json
{
  "instance_id": "string",
  // Includes only one of the fields `disk_id`, `device_name`
  "disk_id": "string",
  "device_name": "string"
...
|| metadata | **[DetachInstanceDiskMetadata](#yandex.cloud.compute.v1.DetachInstanceDiskMetadata)**
...
## DetachInstanceDiskMetadata {#yandex.cloud.compute.v1.DetachInstanceDiskMetadata}
