...
Ресурс Instance. Подробнее см. [Виртуальные машины](/docs/compute/concepts/vm).
...
bootDisk | **object**<br><p>Загрузочный диск, подключенный к виртуальной машине.</p> <p>Добавленные диски</p> 
...
secondaryDisks | **object**<br><p>Добавленные диски</p> 
...
networkInterfaces.<br>index | **string**<br><p>Порядковый номер сетевого интерфейса, генерируемый сервером, 0,1,2... и так далее. В настоящее время поддерживается только один сетевой интерфейс для виртуальной машины.</p> 
...
networkInterfaces.<br>primaryV4Address.<br>oneToOneNat.<br>address | **string**<br><p>Внешний IP-адрес, связанный с этой виртуальной машиной.</p> 
...
networkInterfaces.<br>primaryV6Address | **object**<br><p>Primary IPv6-адрес, который назначен виртуальной машине для данного сетевого интерфейса. IPv6 еще не доступен.</p> 
...
networkInterfaces.<br>primaryV6Address.<br>oneToOneNat.<br>address | **string**<br><p>Внешний IP-адрес, связанный с этой виртуальной машиной.</p> 
networkInterfaces.<br>primaryV6Address.<br>oneToOneNat.<br>ipVersion | **string**<br><p>Версия IP для внешнего IP-адреса.</p> <ul> <li>IPV4: IPv4-адрес, например 192.0.2.235.</li> <li>IPV6: IPv6-адрес, например, 2001:0db8:85a3:0000:0000:8a2e:0370:7334.</li> </ul> 
fqdn | **string**<br><p>Доменное имя виртуальной машины. FQDN определяется сервером в формате <code>&lt;hostname&gt;.&lt;region_id&gt;.internal</code> при создании виртуальной машины. Если доменное имя не было определено при создании виртуальной машины, FQDN будет <code>&lt;id&gt;.auto.internal</code>.</p> 