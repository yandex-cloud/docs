...
fqdn | **string**<br><p>Доменное имя виртуальной машины. Генерируется сервером при создании виртуальной машины из имени хоста в формате <code>&lt;hostname&gt;.&lt;region_id&gt;.internal</code>. Если имя хоста не было указано при создании, FQDN будет равен <code>&lt;id&gt;.auto.internal</code>.</p> 