...
instances.<br>id | **string**<br><p>Только для вывода. Идентификатор виртуальной машины.</p> 
instances.<br>folderId | **string**<br><p>Идентификатор каталога, которому принадлежит виртуальная машина.</p> 
instances.<br>createdAt | **string** (date-time)<br><p>Только для вывода. Время создания ресурса в формате в <a href="https://www.ietf.org/rfc/rfc3339.txt">RFC3339</a>.</p> 
...
instances.<br>networkInterfaces.<br>index | **string**<br><p>Только для вывода. Порядковый номер сетевого интерфейса, генерируемый сервером, 0,1,2... и так далее. В настоящее время поддерживается только один сетевой интерфейс для виртуальной машины.</p> 
instances.<br>networkInterfaces.<br>macAddress | **string**<br><p>Только для вывода. MAC-адрес, назначенный сетевому интерфейсу.</p> 
...
instances.<br>networkInterfaces.<br>primaryV4Address.<br>oneToOneNat.<br>address | **string**<br><p>Только для вывода. Внешний IP-адрес, связанный с этой виртуальной машиной.</p> 
...
instances.<br>fqdn | **string**<br><p>Только для вывода. Доменное имя виртуальной машины. Генерируется сервером при создании виртуальной машины из имени хоста в формате <code>&lt;hostname&gt;.&lt;region_id&gt;.internal</code>. Если имя хоста не было указано при создании, FQDN будет равен <code>&lt;id&gt;.auto.internal</code>.</p> 
