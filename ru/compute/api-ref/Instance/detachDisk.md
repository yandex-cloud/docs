...
Поле | Описание
--- | ---
diskId | **string** <br> включает только одно из полей `diskId`, `deviceName`<br><br><p>Идентификатор диска, который следует отсоединить.</p> <p>Максимальная длина строки в символах — 50.</p> 
