...
editable: false
apiPlayground:
  - url: https://compute.{{ api-host }}/compute/v1/instances/{instanceId}:move
    method: post
    path:
      type: object
      properties:
    ...
    body:
      ...
      properties:
        destinationFolderId:
          description: |-
            **string**
            Required field. ID of the folder to move the instance to.
...
The instance must be stopped before moving. To stop the instance, make a [Stop](/docs/compute/api-ref/Instance/stop#Stop) request.
...
## Body parameters {#yandex.cloud.compute.v1.MoveInstanceRequest}
...
|| metadata | **[MoveInstanceMetadata](#yandex.cloud.compute.v1.MoveInstanceMetadata)**
...
## MoveInstanceMetadata {#yandex.cloud.compute.v1.MoveInstanceMetadata}
