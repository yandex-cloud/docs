---
editable: false
sourcePath: en/_api-ref/compute/api-ref/DiskPlacementGroup/create.md
---
...
Field | Description
--- | ---
folderId | **string**<br><p>Required. ID of the folder to create a placement group in. To get the folder ID, use a <a href="/docs/resource-manager/api-ref/Folder/list">list</a> request.</p> <p>The maximum string length in characters is 50.</p> 
name | **string**<br><p>Name of the placement group.</p> <p>Value must match the regular expression ``\|[a-z]([-a-z0-9]{0,61}[a-z0-9])?``.</p> 
...
spreadPlacementStrategy | **object**<br>Distribute disks over distinct failure domains.<br>
