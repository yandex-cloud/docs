...
Одна из особенностей алгоритма развертывания — перед удалением и обновлением через вызов [`update`](https://cloud.yandex.ru/docs/compute/grpc/instance_service#Update) виртуальная машина всегда сначала останавливается отдельным вызовом [`stop`](https://cloud.yandex.ru/docs/compute/grpc/instance_service#Stop). Удаление или обновление выполняется следующей итерацией.
