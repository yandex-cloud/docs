...
В этом случае количество машин в зонах будет одинаковым, и [сетевой балансировщик нагрузки](../../../../load-balancer/concepts/index.md) (если он есть) будет равномерно распределять нагрузку между виртуальными машинами.
