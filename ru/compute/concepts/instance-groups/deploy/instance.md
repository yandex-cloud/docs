...
* пересоздание вирутальной машины — удаление и создание машины;
...
* Изменение спецификации целевой группы [балансировщика нагрузки](https://cloud.yandex.ru/docs/load-balancer/concepts/) (`load_balancer_spec`, `platform_l7_balancer_spec`) сейчас не поддерживается.
...
* `secondary_disk_specs` — дополнительные диски нельзя обновлять без пересоздания виртуальной машины.
