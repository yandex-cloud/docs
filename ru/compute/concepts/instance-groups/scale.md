...
Instance Groups позволяет создавать группы виртуальных машин фиксированного размера. Управлять размером такой группы можно только вручную — вы можете самостоятельно изменять размер группы, исходя из ваших текущих потребностей в вычислительных мощностях.
