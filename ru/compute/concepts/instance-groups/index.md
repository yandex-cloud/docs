...
Все операции в Instance Groups необходимо выполнять от имени сервисного аккаунта. Подробную информацию см. в разделе [#T](access.md).
...
- Интегрироваться с сервисом [Yandex Load Balancer](../../../load-balancer/concepts/index.md) и равномерно распределять нагрузку между виртуальными машинами.
