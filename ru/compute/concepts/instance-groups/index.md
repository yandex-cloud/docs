...
- Интегрироваться с сервисом [{{ network-load-balancer-full-name }}](../../../load-balancer/concepts/index.md) и равномерно распределять нагрузку между виртуальными машинами.
