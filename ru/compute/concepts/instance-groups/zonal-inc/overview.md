...
Зональный инцидент влияет на функциональность группы ВМ в проблемной зоне. Большинство функций в других зонах продолжает работать штатно. Подробнее на странице [{#T}](./multi-zonal.md).
