...
# Пулы резервов виртуальных машин в {{ compute-name }}
...
Управлять пулами резервов ВМ и привязкой к ним виртуальных машин вы можете с помощью [консоли управления]({{ link-console-main }}), [{{ yandex-cloud }} CLI](../cli-ref/reserved-instance-pool/index.md) и [API](../api-ref/ReservedInstancePool/index.md).

Пулы резервов ВМ можно использовать для [создания](../operations/instance-groups/create-group-with-pool.md) групп виртуальных машин.
