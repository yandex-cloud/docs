...
Вы можете создать образ из диска, снимка или другого образа. Если у вас есть файл образа, вы можете [импортировать](../operations/image-create/upload.md) его в {{ yandex-cloud }}.{% if product == "yandex-cloud" %} Для создания образов диска с ОС Windows воспользуйтесь [инструкцией](../../microsoft/prepare-image.md).{% endif %}
