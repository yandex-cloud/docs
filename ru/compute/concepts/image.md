...
Вы можете предоставить публичный доступ к вашему образу, назначив роль `compute.images.user` системной группе `allAuthenticatedUsers`. Тогда вашим образом смогут воспользоваться другие пользователи Яндекс.Облака для создания своих дисков и виртуальных машин. При этом роль `compute.images.user` не дает прав удалить или изменить ваш образ.
