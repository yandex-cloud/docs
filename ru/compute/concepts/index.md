# Взаимосвязь ресурсов в [!KEYREF compute-full-name]
...
Все ресурсы [!KEYREF compute-short-name] создаются внутри каталогов. Типы дисков и зоны доступности — публичные ресурсы, которые не относятся к каталогу. [Подробнее об иерархии ресурсов в Облаке](../../resource-manager/concepts/resources-hierarchy.md).
