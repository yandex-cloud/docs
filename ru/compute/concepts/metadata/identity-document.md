...
Подробнее о том, как получить идентификационный документ, читайте в инструкции [{#T}](../../operations/vm-metadata/get-identity-document.md).
...
Подробнее о том, как проверить целостность и подлинность идентификационного документа, читайте в инструкции [{#T}](../../operations/vm-metadata/get-identity-document.md#check-id-signature).
