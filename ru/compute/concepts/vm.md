...
При создании виртуальная машина находится в статусе `CREATING`. В это время с виртуальной машине выделяются ресурсы: виртуальные ядра и память, IP-адрес, создаются диски.
