...
Статус виртуальной машины влияет на то, какие операции вы можете с ней выполнять в данный момент. Например, статус `RUNNING` означает, что виртуальная машина запущена. Подробнее о статусах читайте в разделе [[!TITLE]](vm-statuses.md).
