...
Чтобы зарезервировать вычислительные ресурсы под необходимое вам количество виртуальных машин в определенной зоне доступности, вы можете создать [пул зарезервированных ВМ](./reserved-pools.md).
