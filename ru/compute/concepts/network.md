...
Если имя хоста не указать, то в качестве имени хоста будет использован ID виртуальной машины. Регион в этом случае не указывается, т.к. ID виртуальной машины уникален в рамках всего облака.
