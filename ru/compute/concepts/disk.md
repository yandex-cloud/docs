...
* Высокопроизводительный SSD-диск (`network-ssd-io-m3`) — обладает теми же характеристиками что и `network-ssd-nonreplicated` и обеспечивает избыточность. Высокопроизводительные SSD находятся на стадии [Preview](../../overview/concepts/launch-stages.md). Тарификация высокопроизводительных SSD начинается с 1 сентября 2023 года.
