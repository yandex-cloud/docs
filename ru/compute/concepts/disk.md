...
- Консоль управления {#console}
  ...
  * **Загрузочный диск**
    ...
    * При подключении существующего диска к ВМ автоудаление _выключено_.
    ...
    В [консоли управления]({{ link-console-main }}) не поддерживается изменение настроек автоудаления загрузочного диска. Используйте инструменты {{ yandex-cloud }} CLI, {{ TF }} или API. Примеры на странице [{#T}](../operations/vm-create/create-linux-vm.md).
...
Примеры изменения настройки автоудаления для каждого из интерфейсов приведены в инструкции [{#T}](../operations/vm-create/create-linux-vm.md).
...
Подробнее в разделе [{#T}](encryption.md).
