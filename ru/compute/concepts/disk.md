...
Диски предназначены для хранения данных и подключаются к виртуальным машинам для работы с ними. К виртуальной машине можно подключить неограниченное количество дисков. При отключении диска данные сохраняются.
