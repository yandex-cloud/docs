...
Диски не реплицируютсяна стороне {{ yandex-cloud }}, но пользователь может самостоятельно сделать диск реплицируемым с помощью [групп размещения](disk-placement-group.md).
