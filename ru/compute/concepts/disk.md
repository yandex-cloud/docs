...
* Высокопроизводительный SSD-диск (`network-ssd-io-m3`) — обладает теми же скоростными характеристиками что и `network-ssd-nonreplicated` и одновременно обеспечивает избыточность. Высокопроизводительные SSD находятся на стадии [Preview](../../overview/concepts/launch-stages.md).
