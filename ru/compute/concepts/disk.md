...
Вы можете создавать резервные копии дисков в виде [снимков](snapshot.md) — вручную или автоматически, [по расписанию](snapshot-schedule.md). Снимки реплицируются во всех зонах доступности, поэтому их также можно использовать, чтобы переносить диски между зонами доступности.
