...
Виртуальные машины делятся на два типа в зависимости от использования ядра: с частичным и полным использованием.
...
Виртуальные машины с частичным использованием vCPU предназначены для запуска приложений, не требующих высокой производительности. При этом они обойдутся дешевле машин с полным использованием vCPU.
