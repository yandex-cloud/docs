...
Виртуальные машины делятся на два типа: стандартные и легкие.
...
### Стандартные виртуальные машины {#standard-vms}
...
> Например, для стандартной виртуальной машины c 10 vCPU, можно выделить 10, 20, 30,..., 70 или 80&nbsp;ГБ памяти.

### Легкие виртуальные машины {#light-vms}
...
Легкие виртуальные машины предназначены для запуска приложений, не требующих высокой производительности. При этом такие машины обойдутся дешевле стантартных виртуальных машин.

> Например, у вас на виртуальной машине с одним ядром запущен скрипт, который отправляет HTTP-запросы несколько раз в секунду. При этом загрузка процессора не превышает 5%. Тогда вам не требуется выделять целое ядро на виртуальную машину. Вы можете создать легкую виртуальную, выделив ей необходимые 5% производительности ядра.
...
> Например, для легкой виртуальной машины c 2 vCPU, можно выделить 1, 2, 3 или 4&nbsp;ГБ памяти.
