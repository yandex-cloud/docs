...
Каждое файловое хранилище находится в одной из зон доступности `{{ region-id }}-a` или `{{ region-id }}-b` и реплицируется внутри нее (кроме нереплицируемых хранилищ), что обеспечивает сохранность данных. Между зонами файловые хранилища не реплицируются.
