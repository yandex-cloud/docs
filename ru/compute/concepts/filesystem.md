...
Место, занимаемое хранилищем, оплачивается в зависимости от его размера, указанного при создании. Подробнее см. в разделе [{#T}](../pricing.md). Максимальный размер хранилища — 8192 ГБ. 
