...
Сведения о виртуальных машинах хранятся на сервере метаданных. Вы можете запрашивать метаданные [изнутри](../operations/vm-info/vm-info.md#inside-instance) виртуальной машины или [снаружи](../operations/vm-info/vm-info.md#outside-instance) с помощью API или CLI.
