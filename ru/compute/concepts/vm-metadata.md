...
Вы задаете метаданные в виде пар `"ключ":"значение"` в поле `metadata`. Значение указывается в виде строки. Если в значении надо передать несколько строк, разделите их символом переноса строки `\n`.
