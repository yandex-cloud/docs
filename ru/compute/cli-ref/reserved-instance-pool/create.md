...
|`--boot-disk-spec`|<b>`PROPERTY=VALUE[,PROPERTY=VALUE...]`</b><br/>Boot disk spec for the instances of the reserved instance pool in. Used to determine product IDs used in the instances.<br/><br/>Possible property names:<br/><ul> <li><code>disk-name</code>:     Name of the disk used to determine product IDs used in instances of reserved instance pool.</li> <li><code>disk-id</code>:     ID of the disk used to determine product IDs used in instances of reserved instance pool.</li> <li><code>snapshot-name</code>:     Name of the source snapshot used to determine product IDs used in instances of reserved instance pool.</li> <li><code>snapshot-id</code>:     ID of the source snapshot used to determine product IDs used in instances of reserved instance pool.</li> <li><code>image-name</code>:     Source image used to determine product IDs used in instances of reserved instance pool.</li> <li><code>image-id</code>:     An ID of the source image used to determine product IDs used in instances of reserved instance pool.</li> <li><code>image-family</code>:     An image family that is used to determine product IDs used in instances of reserved instance pool.</li> <li><code>image-folder-id</code>:     The folder ID that is used to resolve references for image-name or image-family.</li> <li><code>product-ids</code>:     Product IDs used in instances of reserved instance pool.</li> </ul>|
