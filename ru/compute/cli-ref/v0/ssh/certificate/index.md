---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/compute/cli-ref/v0/ssh/certificate/
---

# yc compute v0 ssh certificate
...
- [yc compute v0 ssh certificate export](export.md) — Export certificate
