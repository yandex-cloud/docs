---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/compute/cli-ref/v0/disk-placement-group/remove-labels
editable: false
---

# yc compute v0 disk-placement-group remove-labels
