---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/compute/cli-ref/v0/instance/add-one-to-one-nat
editable: false
---
...
Index of interface to remove one-to-one NAT. ||
|| `--internal-address` | `string`

Internal address of interface to remove one-to-one NAT. ||
