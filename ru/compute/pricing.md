...
При создании виртуальной машины указывается количество ядер процессора (vCPU), базовый уровень производительности ядра и объем оперативной памяти (RAM) в ГБ. Подробнее читайте в разделе [[!TITLE]](concepts/performance-levels.md).
...
### Использование [!KEYREF ig-name] {#instance-groups}

Использование компонента [!KEYREF ig-name] не тарифицируется. Вы можете создавать группы виртуальных машин, пользоваться хранилищем и вычислительными ресурсами в рамках [доступных лимитов](concepts/limits.md).

Все остальные услуги Облака, например, создание виртуальных машин или выделение внешних IP-адресов, [тарифицируются обычным образом](../billing/pricing.md). Исходящий трафик [тарифицируется](#prices-traffic) аналогично другим сервисам.

## Цены до 1 мая 2019 года {#prices}
...
- Платформа Intel Cascade Lake:
    ...
    Вычислительные ресурсы | Цена за 1 час, без НДС | Цена за 1 час, вкл. НДС
    ----- | ----- | -----
    за 5% vCPU | 0,0850 ₽ | 0,1020 ₽
    за 20%+ vCPU | 0,2550 ₽ | 0,3060 ₽
    за 50%+ vCPU | 0,3740 ₽ | 0,4488 ₽
    за 100% vCPU | 0,6230 ₽ | 0,7476 ₽
    RAM (за 1 ГБ) | 0,1650 ₽ | 0,1980 ₽
...
- Платформа Intel Cascade Lake:
    ...
    Вычислительные ресурсы | Цена за 1 час, без НДС | Цена за 1 час, вкл. НДС
    ----- | ----- | -----
    за 5% vCPU | 0,0530 ₽ | 0,0636 ₽
    за 20%+ vCPU | 0,1590 ₽ | 0,1908 ₽
    за 50%+ vCPU | 0,2330 ₽ | 0,2796 ₽
    за 100% vCPU | 0,1700 ₽ | 0,2040 ₽
    RAM (за 1 ГБ) | 0,0410 ₽ | 0,0492 ₽
...
## Цены с 1 мая 2019 года {#prices-new}

### Вычислительные ресурсы ВМ {#prices-instance-resources-new}
...
### Вычислительные ресурсы прерываемых ВМ {#prices-preemptible-instance-resources-new}
...
- Платформа Intel Cascade Lake:
    ...
    ----- | ----- | -----
    за 5% vCPU | 0,0530 ₽ | 0,0636 ₽
    за 20%+ vCPU | 0,0833 ₽ | 0,1000 ₽
    за 50%+ vCPU | 0,1167 ₽ | 0,1400 ₽
    за 100% vCPU | 0,1700 ₽ | 0,2040 ₽
    RAM (за 1 ГБ) | 0,0410 ₽ | 0,0492 ₽

### Операционные системы {#prices-instance-os-new}
...
### Диски, снимки и образы {#prices-storage-new}
...
### Исходящий трафик {#prices-traffic-new}
