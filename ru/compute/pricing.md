...
- Расчет в рублях {#prices-rub}
  ...
  {% include [rub-snapshot](../_pricing_examples/compute/rub-snapshot.md) %}

- Расчет в тенге {#prices-kzt}

  {% include [kzt-snapshot](../_pricing_examples/compute/kzt-snapshot.md) %}
