...
- В рублях {#prices-rub}
  ...
  С 23 января 2026 года изменяются цены на ресурсы платформы **GPU PLATFORM V4**. В том числе повышается цена использования GPU для обычных и прерываемых ВМ и составит 1 016,90 ₽ за 1 час, вкл. НДС 22%.

  Стоимость ресурсов платформы **GPU PLATFORM V4** с 23 января 2026 года:

  {% include [rub-from-23-01-2026](../_pricing/compute/rub-from-23-01-2026.md) %}

- В тенге {#prices-kzt}

  С 23 января 2026 года изменяются цены на ресурсы платформы **GPU PLATFORM V4**. В том числе повышается цена использования GPU для обычных и прерываемых ВМ и составит {% calc [currency=KZT] round((1016,90 × 5,094) × 100) / 100 %} за 1 час, вкл. НДС 22%.
