...
[!KEYREF roles-admin]
:   На данный момент управлять правами доступа к ресурсам сервиса [!KEYREF compute-full-name] невозможно. Поэтому роль admin дает все те же возможности, что и роль `[!KEYREF roles-editor]`. Чтобы изменить права доступа к ресурсам в [!KEYREF compute-short-name] наcтройте права доступа к каталогу или облаку.
