...
Пользователь Яндекс.Облака может выполнять только те операции над ресурсами, которые разрешены назначенными ему ролями. Сразу после регистрации в Яндекс.Облаке у пользователя нет никаких ролей — практически никакие операции недоступны. Вне зависимости от ролей доступны только справочные списки зон доступности и типов дисков.
