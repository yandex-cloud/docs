...
Пользователь в Яндекс.Облаке может выполнять какую-либо операцию с ресурсом только, если ему выдано разрешение на выполнения именно этой операции. 

Вы можете управлять правами доступа к ресурсам сервиса [!KEYREF compute-name], назначая пользователям соответствующие роли.
