...
Чтобы выполнять операции с ресурсом, пользователь должен обладать ролью, которая это разрешает. Роль может быть назначена на сам ресурс, на каталог или на облако.
