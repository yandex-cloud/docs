...
У пользователей Яндекс.Облака по умолчанию нет доступа ни к каким облачным ресурсам. Пользователь может выполнять только те операции с облачными ресурсами, на выполнение которых ему выдано разрешение. Вы можете управлять правами доступа к ресурсам и разрешениями на выполнение операций через _назначение_ соответствующих ролей.
