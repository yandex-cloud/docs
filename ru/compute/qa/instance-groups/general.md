...
#### Что такое [!KEYREF ig-name]? {#what-is}

[!KEYREF ig-name] — это компонент, с помощью которого можно создавать, эксплуатировать и масштабировать группы однотипных виртуальных машин в инфраструктуре [!KEYREF compute-full-name].

С [!KEYREF ig-name] вы можете:
...
- Оцените, сколько потребуется вычислительных ресурсов для вашего сервиса, и посмотрите примеры расчетов и [правила тарификации](../../pricing.md) для [!KEYREF compute-full-name].
