...
Ограничения на диски приведены в разделе [[!TITLE]](../concepts/limits.md).
...
#### Что происходит с моими данными при удалении виртуальной машины? {#delete-vm}
