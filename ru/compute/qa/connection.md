...
#### Как подключиться к ВМ с Windows Server {#conn-vm-windows-server}

Воспользуйтесь инструкцией: [{#T}](../operations/vm-connect/rdp.md).
...
Для образов без [дополнительных лицензий Remote Desktop Services](../pricing.md#prices-os) доступно не более двух одновременных подключений по RDP.
...
#### Почему после перезагрузки может не работать ВМ {#why-fail-after-reboot}
