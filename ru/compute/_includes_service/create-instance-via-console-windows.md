...
1. (опционально) В блоке **Диски** нажмите **Добавить диск** и настройте загрузочный диск:
    * Введите имя диска.
...
1. (опционально) В блоке **Файловые хранилища** подключите [файловое хранилище](../concepts/filesystem.md) и введите имя устройства.
