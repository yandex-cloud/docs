...
Field | Description
--- | ---
folderId | **string**<br><p>Required. ID of the folder to create Workflow in.</p> 
name | **string**<br><p>Required. Name of Workflow. The name must be unique within the folder.</p> <p>Value must match the regular expression ``\|[a-z]([-a-z0-9]{0,61}[a-z0-9])?``.</p> 
description | **string**<br><p>Description of Workflow.</p> <p>The maximum string length in characters is 256.</p> 
...
specification | **object**<br><p>Required. Specification of Workflow</p> 
specification.<br>specYaml | **string**<br><p>Workflow specification in YAML format.</p> 
logOptions | **object**<br><p>Options for logging from Workflow.</p> 
