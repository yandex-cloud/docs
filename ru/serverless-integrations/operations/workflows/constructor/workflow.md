...
- Консоль управления {#console}
  ...
  1. Из секции **Интеграционные шаги** в левой части экрана перетащите элемент ![graph-node](../../../../_assets/console-icons/graph-node.svg) **{{ sw-name }}** в нужное место рабочего процесса в окне конструктора.
