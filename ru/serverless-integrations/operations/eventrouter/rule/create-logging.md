---
title: Как создать правило с приемником {{ cloud-logging-full-name }}
description: Следуя данной инструкции, вы сможете создать правило с приемником {{ cloud-logging-full-name }}.
---
