---
title: Как создать правило с приемником {{ sf-full-name }}
description: Следуя данной инструкции, вы сможете создать правило с приемником {{ sf-full-name }}.
---

# Создать правило с приемником {{ sf-full-name }}
...
- Консоль управления {#console}
  ...
  1. В блоке **{{ ui-key.yacloud.serverless-event-router.label_targets }}** нажмите **{{ ui-key.yacloud.common.add }}** и настройте приемник:
      ...
      1. Укажите тип приемника `{{ sf-full-name }}`.
...
- CLI {#cli}
  ...
  1. Создайте правило с приемником {{ sf-full-name }}:
...
- {{ TF }} {#tf}
  ...
  Чтобы создать [правило](../../../concepts/eventrouter/rule.md) с приемником {{ sf-full-name }}:
