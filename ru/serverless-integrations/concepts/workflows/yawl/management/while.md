...
`do` | [WhileDo](#WhileDo) | Да | Нет | Нет | Последовательность шагов, которая будет выполняться в цикле.
