...
--- | --- | --- | --- | --- | ---
`oauthToken` | `string` | Да | Нет | Да | [OAuth-токен]({{ link-yadisk-doc }}concepts/quickstart#oauth), который будет использоваться для аутентификации при обращении к Яндекс Диску.
