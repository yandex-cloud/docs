...
--- | --- | --- | --- | --- | ---
`errorList` | `WorkflowError[]` | Да | `[]` | — | Список ошибок, для которых будут сделаны повторные попытки выполнения шага. Подробнее в [{#T}](../execution.md#errors).
...
Имя поля | Тип | Обязательное | Значение по умолчанию | Предельное значение | Описание
--- | --- | --- | --- |---| ---
`errorList` | `WorkflowError[]` | Да | `[]` | — | Список ошибок, для которых применяется правило перехода. Подробнее в разделе [{#T}](../execution.md#errors).
