...
* включить опцию **{{ ui-key.yacloud.serverless-workflows.label_public-access }}**. Тогда рабочий процесс сможет запустить любой пользователь. Подробнее в [{#T}](execution.md).
