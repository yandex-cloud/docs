...
* С помощью консоли управления, CLI, API. Подробнее см. [{#T}](../../operations/workflows/execution/start.md).
* По таймеру. Расписание задается в формате [cron-выражения](../cron.md). Подробнее см. [{#T}](../../operations/workflows/execution/start-by-timer.md).
* По ссылке через HTTPS. Подробнее см. [{#T}](../../operations/workflows/execution/start-by-link.md).
* С помощью API-шлюза. Подробнее см. [{#T}](../../../api-gateway/operations/spec-constructor/workflows.md).
...
* публичный, его может запустить любой пользователь. Подробнее см. [{#T}](../../operations/workflows/workflow/make-public.md).
