---
title: Справочник метрик сервиса {{ si-full-name }} в {{ monitoring-full-name }}
description: На этой странице приведен справочник метрик сервиса {{ si-name }}, поставляемых в {{ monitoring-full-name }}.
---
