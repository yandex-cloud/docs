...
editable: false
apiPlayground:
  - url: https://serverless-eventrouter.{{ api-host }}/eventrouter/v1/rules/{resourceId}:setAccessBindings
    method: post
    path:
      type: object
      properties:
    ...
    definitions:
      ...
      AccessBinding:
        ...
        required:
          - roleId
          - subject
sourcePath: en/_api-ref/serverless/eventrouter/v1/eventrouter/api-ref/Rule/setAccessBindings.md
---

# EventRouter Service, REST: Rule.SetAccessBindings
...
```
POST https://serverless-eventrouter.{{ api-host }}/eventrouter/v1/rules/{resourceId}:setAccessBindings
```
