---
editable: false
sourcePath: en/_api-ref-grpc/serverless/eventrouter/v1/eventrouter/api-ref/grpc/Rule/listAccessBindings.md
---

# EventRouter Service, gRPC: RuleService.ListAccessBindings {#ListAccessBindings}
