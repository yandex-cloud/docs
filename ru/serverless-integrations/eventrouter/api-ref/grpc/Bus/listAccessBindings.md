---
editable: false
sourcePath: en/_api-ref-grpc/serverless/eventrouter/v1/eventrouter/api-ref/grpc/Bus/listAccessBindings.md
---

# EventRouter Service, gRPC: BusService.ListAccessBindings {#ListAccessBindings}
