...
# EventRouter Service, gRPC: BusService.ListOperations {#ListOperations}
...
[ListBusesResponse.nextPageToken](/docs/functions/eventrouter/api-ref/grpc/Bus/list#yandex.cloud.serverless.eventrouter.v1.ListBusesResponse) returned by a previous list request. ||
|| filter | **string**
