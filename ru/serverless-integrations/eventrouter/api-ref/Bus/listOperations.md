...
--- | ---
busId | <p>Required. ID of the bus to list operations for.</p> 
 
## Query parameters {#query_params}
 
Parameter | Description
--- | ---
pageSize | <p>Maximum number of operations to return.</p> <p>Acceptable values are 0 to 1000, inclusive.</p> 
pageToken | <p>Page token. To get the next page of results, set ``page_token`` to the <a href="/docs/functions/eventrouter/api-ref/Bus/list#responses">nextPageToken</a> returned by a previous list request.</p> <p>The maximum string length in characters is 100.</p> 
filter | <p>Supported attributes for filter: description created_at modified_at created_by done</p> <p>The maximum string length in characters is 1000.</p> 
...
Field | Description
--- | ---
operations[] | **object**<br><p>List of operations for the specified bus.</p> 
...
nextPageToken | **string**<br><p>Token for getting the next page of the list of operations.</p> 