...
environment | **[Cluster.Environment](#Cluster2)**<br>Обязательное поле. Среда развертывания кластера MongoDB. false
...
Поле | Описание
--- | ---
mongod | **[Mongod](#Mongod6)**<br>Конфигурация и выделенные ресурсы для хостов mongod 3.6. 
mongocfg | **[MongoCfg](#MongoCfg6)**<br>Конфигурация и выделенные ресурсы для хостов mongocfg 3.6. 
mongos | **[Mongos](#Mongos6)**<br>Конфигурация и выделенные ресурсы для хостов mongos 3.6. 
...
Поле | Описание
--- | ---
mongod | **[Mongod](#Mongod7)**<br>Конфигурация и выделенные ресурсы для хостов mongod 4.0. 
mongocfg | **[MongoCfg](#MongoCfg7)**<br>Конфигурация и выделенные ресурсы для хостов mongocfg 4.0. 
mongos | **[Mongos](#Mongos7)**<br>Конфигурация и выделенные ресурсы для хостов mongos 4.0. 
...
environment | **[Cluster.Environment](#Cluster8)**<br>Обязательное поле. Среда развертывания для нового кластера MongoDB. false
...
mongocfg | **[MongoCfg](#MongoCfg10)**<br>Обязательное поле. Спецификация mongocfg для шардирования. false
mongos | **[Mongos](#Mongos10)**<br>Обязательное поле. Спецификация mongos для шардирования. false
...
Поле | Описание
--- | ---
resources | **[Resources](#Resources1)**<br>Обязательное поле. Ресурсы для хостов mongocfg. false
...
Поле | Описание
--- | ---
resources | **[Resources](#Resources1)**<br>Обязательное поле. Ресурсы для хостов mongos. false
