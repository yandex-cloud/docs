...
&nbsp;&nbsp;text_detection | **[TextAnnotation](../text_detection.proto#TextAnnotation)**<br>Результат распознавания текста (OCR). 
&nbsp;&nbsp;classification | **[ClassAnnotation](../classification.proto#ClassAnnotation)**<br>Результат классификации. 
&nbsp;&nbsp;face_detection | **[FaceAnnotation](../face_detection.proto#FaceAnnotation)**<br>Результат обнаружения лиц. 
...
Поле | Описание
--- | ---
pages[] | **[Page](../text_detection.proto#Page)**<br>Страницы распознанного файла. <br>Для JPEG и PNG файлов содержит только 1 страницу. 
...
blocks[] | **[Block](../text_detection.proto#Block)**<br>Распознанные блоки текста на этой странице. 
...
Поле | Описание
--- | ---
bounding_box | **[Polygon](../primitives.proto#Polygon)**<br>Область на странице, где находится блок текста. 
lines[] | **[Line](../text_detection.proto#Line)**<br>Распознанные строки в этом блоке. 
...
Поле | Описание
--- | ---
vertices[] | **[Vertex](../primitives.proto#Vertex)**<br>Вершины обрамляющей фигуры. 
...
Поле | Описание
--- | ---
bounding_box | **[Polygon](../primitives.proto#Polygon1)**<br>Область на странице, где расположена строка. 
words[] | **[Word](../text_detection.proto#Word)**<br>Распознанные слова в этой строке. 
...
Поле | Описание
--- | ---
bounding_box | **[Polygon](../primitives.proto#Polygon2)**<br>Область на странице, где расположена строка. 
text | **string**<br>Распознанное слово. 
confidence | **double**<br>Достоверность результатов OCR для слова. Диапазон [0, 1]. 
languages[] | **[DetectedLanguage](../text_detection.proto#DetectedLanguage)**<br>Список распознанных языков и достоверность распознавания. 
...
Поле | Описание
--- | ---
properties[] | **[Property](../classification.proto#Property)**<br>Признаки, извлеченные указанной моделью. <br>Например, если вы попросите оценить качество изображения, сервис может вернуть такие признаки, как `good` и `bad`. 
...
Поле | Описание
--- | ---
faces[] | **[Face](../face_detection.proto#Face)**<br>Массив обнаруженных лиц для указанного изображения. 
