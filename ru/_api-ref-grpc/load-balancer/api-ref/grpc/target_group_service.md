...
targets[] | **[Target](#Target3)**<br>Новый список ресурсов для этой целевой группы. 
...
labels | **map<string,string>**<br>Метки ресурса в формате `` key:value ``. Максимум 64 метки на ресурс. 
region_id | **string**<br>Идентификатор региона, в котором находится целевая группа. 
targets[] | **[Target](#Target4)**<br>Список целевых ресурсов в целевой группе. 
...
targets[] | **[Target](#Target4)**<br>Список целевых объектов для добавления в целевую группу. Минимальное количество элементов — 1.
...
targets[] | **[Target](#Target5)**<br>Список ресурсов для удаления из целевой группы. Минимальное количество элементов — 1.
...
labels | **map<string,string>**<br>Метки ресурса в формате `` key:value ``. Максимум 64 метки на ресурс. 
region_id | **string**<br>Идентификатор региона, в котором находится целевая группа. 
targets[] | **[Target](#Target6)**<br>Список целевых ресурсов в целевой группе. 
