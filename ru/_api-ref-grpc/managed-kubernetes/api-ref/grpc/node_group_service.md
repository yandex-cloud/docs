...
node_template | **[NodeTemplate](../node_group.proto#NodeTemplate2)**<br>Обязательное поле. Шаблон узла для создания группы узлов. 
scale_policy | **[ScalePolicy](../node_group.proto#ScalePolicy2)**<br>Обязательное поле. Политика масштабирования группы узлов. 
