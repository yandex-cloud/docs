...
config_spec | **[ConfigSpec](#ConfigSpec3)**<br>Новая конфигурация Kafka и хостов кластера Apache Kafka®. <br>Используйте параметр `update_mask` чтобы предотвратить сброс настроек кластера, не перечисленных в `config_spec`, на значения по умолчанию. 
