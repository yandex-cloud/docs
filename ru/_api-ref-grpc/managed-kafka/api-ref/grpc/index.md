...
Сервис | Описание
--- | ---
[ClusterService](./cluster_service.md) | Набор методов для управления кластерами Apache Kafka.
[OperationService](./operation_service.md) | Набор методов для управления операциями — асинхронными запросами к API.
[ResourcePresetService](./resource_preset_service.md) | Методы для работы с шаблонами ресурсов.
[TopicService](./topic_service.md) | Набор методов для управления топиками Apache Kafka.
[UserService](./user_service.md) | Набор методов для управления пользователями Apache Kafka.
