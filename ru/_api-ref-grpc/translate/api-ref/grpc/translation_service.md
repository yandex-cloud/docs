...
target_language_code | **string**<br>Обязательное поле. Язык, на который переводится текст. Указывается в формате [ISO 639-1](https://en.wikipedia.org/wiki/ISO_639-1) (например, `` en ``). false Максимальная длина строки в символах — 3.
...
Поле | Описание
--- | ---
source_text | **string**<br>Обязательное поле. Текст на языке оригинала. false
translated_text | **string**<br>Обязательное поле. Текст на языке перевода. false
...
Поле | Описание
--- | ---
text | **string**<br>Обязательное поле. Текст, язык которого требуется определить. false Максимальная длина строки в символах — 1000.
