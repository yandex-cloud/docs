...
editable: false
apiPlayground:
  - url: https://baremetal.{{ api-host }}/baremetal/v2/configurations/{configurationId}:resolveDefaultStorage
    method: get
    path:
      type: object
      properties:
...
```
GET https://baremetal.{{ api-host }}/baremetal/v2/configurations/{configurationId}:resolveDefaultStorage
```
