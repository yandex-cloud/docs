...
editable: false
apiPlayground:
  - url: https://baremetal.{{ api-host }}/baremetal/v1alpha/configurationNetworkInterfaces
    method: get
    path: null
    query:
      type: object
...
```
GET https://baremetal.{{ api-host }}/baremetal/v1alpha/configurationNetworkInterfaces
```
