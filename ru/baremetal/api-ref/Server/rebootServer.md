...
editable: false
apiPlayground:
  - url: https://baremetal.{{ api-host }}/baremetal/v2/clouds/{cloudId}/folders/{folderId}/servers/{serverId}:reboot
    method: post
    path:
      type: object
      properties:
...
# BareMetal API, REST: Server.RebootServer
...
```
POST https://baremetal.{{ api-host }}/baremetal/v2/clouds/{cloudId}/folders/{folderId}/servers/{serverId}:reboot
```
...
## Body parameters {#yandex.cloud.baremetal.v2.RebootServerRequest}
