...
editable: false
apiPlayground:
  - url: https://baremetal.{{ api-host }}/baremetal/v2/clouds/{cloudId}/folders/{folderId}/servers
    method: get
    path:
      type: object
      properties:
...
# BareMetal API, REST: Server.ListServers
...
```
GET https://baremetal.{{ api-host }}/baremetal/v2/clouds/{cloudId}/folders/{folderId}/servers
```
...
## Query parameters {#yandex.cloud.baremetal.v2.ListServersRequest}
...
## Response {#yandex.cloud.baremetal.v2.ListServersResponse}
...
#|
||Field | Description ||
|| servers[] | **[Server](#yandex.cloud.baremetal.v2.Server)**
