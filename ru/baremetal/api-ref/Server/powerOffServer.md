...
editable: false
apiPlayground:
  - url: https://baremetal.{{ api-host }}/baremetal/v2/clouds/{cloudId}/folders/{folderId}/servers/{serverId}:powerOff
    method: post
    path:
      type: object
      properties:
...
# BareMetal API, REST: Server.PowerOffServer
...
```
POST https://baremetal.{{ api-host }}/baremetal/v2/clouds/{cloudId}/folders/{folderId}/servers/{serverId}:powerOff
```
