...
editable: false
apiPlayground:
  - url: https://baremetal.{{ api-host }}/baremetal/v2/clouds/{cloudId}/folders/{folderId}/servers:batchCreate
    method: post
    path:
      type: object
      properties:
...
```
POST https://baremetal.{{ api-host }}/baremetal/v2/clouds/{cloudId}/folders/{folderId}/servers:batchCreate
```
...
Required field. ID of the parent folder shared by all servers being created.
...
## Body parameters {#yandex.cloud.baremetal.v2.BatchCreateServersRequest}
