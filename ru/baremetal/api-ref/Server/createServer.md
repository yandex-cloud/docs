...
# BareMetal API, REST: Server.CreateServer
...
```
POST https://baremetal.{{ api-host }}/baremetal/v2/clouds/{cloudId}/folders/{folderId}/servers
```
...
## Body parameters {#yandex.cloud.baremetal.v2.CreateServerRequest}
