...
editable: false
apiPlayground:
  - url: https://baremetal.{{ api-host }}/baremetal/v1alpha/publicSubnets/{publicSubnetId}/operations
    method: get
    path:
      type: object
      properties:
        ...
        pageToken:
          description: |-
            **string**
            ...
            [ListPublicSubnetOperationsResponse.nextPageToken](#yandex.cloud.baremetal.v1alpha.ListPublicSubnetOperationsResponse) returned by a previous list request.
          type: string
      additionalProperties: false
    body: null
    definitions: null
...
```
GET https://baremetal.{{ api-host }}/baremetal/v1alpha/publicSubnets/{publicSubnetId}/operations
```
...
Required field. ID of the PublicSubnet resource to list operations for. ||
|#

## Query parameters {#yandex.cloud.baremetal.v1alpha.ListPublicSubnetOperationsRequest}
...
## Response {#yandex.cloud.baremetal.v1alpha.ListPublicSubnetOperationsResponse}
