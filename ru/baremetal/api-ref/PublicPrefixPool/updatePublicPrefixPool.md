...
editable: false
apiPlayground:
  - url: https://baremetal.{{ api-host }}/baremetal/v2/clouds/{public_prefix_pool.cloud_id}/folders/{public_prefix_pool.folder_id}/publicPrefixPools/{public_prefix_pool.public_prefix_pool_id}
    method: patch
    path: null
    query: null
    body:
      ...
      properties:
        publicPrefixPool:
          ...
          $ref: '#/definitions/PublicPrefixPool'
        updateMask:
          description: |-
            **string** (field-mask)
...
```
PATCH https://baremetal.{{ api-host }}/baremetal/v2/clouds/{public_prefix_pool.cloud_id}/folders/{public_prefix_pool.folder_id}/publicPrefixPools/{public_prefix_pool.public_prefix_pool_id}
```
