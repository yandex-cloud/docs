...
editable: false
apiPlayground:
  - url: https://baremetal.{{ api-host }}/baremetal/v2/clouds/{boot_image.cloud_id}/folders/{boot_image.folder_id}/bootImages/{boot_image.boot_image_id}
    method: patch
    path: null
    query: null
    body:
...
# BareMetal API, REST: BootImage.UpdateBootImage
...
```
PATCH https://baremetal.{{ api-host }}/baremetal/v2/clouds/{boot_image.cloud_id}/folders/{boot_image.folder_id}/bootImages/{boot_image.boot_image_id}
```

## Body parameters {#yandex.cloud.baremetal.v2.UpdateBootImageRequest}
