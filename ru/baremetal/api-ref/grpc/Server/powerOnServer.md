...
# BareMetal API, gRPC: ServerService.PowerOnServer
...
**rpc PowerOnServer ([PowerOnServerRequest](#yandex.cloud.baremetal.v2.PowerOnServerRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## PowerOnServerRequest {#yandex.cloud.baremetal.v2.PowerOnServerRequest}
