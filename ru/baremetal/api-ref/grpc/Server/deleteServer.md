...
# BareMetal API, gRPC: ServerService.DeleteServer
...
**rpc DeleteServer ([DeleteServerRequest](#yandex.cloud.baremetal.v2.DeleteServerRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## DeleteServerRequest {#yandex.cloud.baremetal.v2.DeleteServerRequest}
