...
# BareMetal API, gRPC: ServerService.RenewServerRental
...
**rpc RenewServerRental ([RenewServerRentalRequest](#yandex.cloud.baremetal.v2.RenewServerRentalRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## RenewServerRentalRequest {#yandex.cloud.baremetal.v2.RenewServerRentalRequest}
