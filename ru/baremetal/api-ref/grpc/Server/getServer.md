...
**rpc GetServer ([GetServerRequest](#yandex.cloud.baremetal.v2.GetServerRequest)) returns ([Server](#yandex.cloud.baremetal.v2.Server))**

## GetServerRequest {#yandex.cloud.baremetal.v2.GetServerRequest}
