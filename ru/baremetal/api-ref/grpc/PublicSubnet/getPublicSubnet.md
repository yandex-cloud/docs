...
# BareMetal API, gRPC: PublicSubnetService.GetPublicSubnet
...
**rpc GetPublicSubnet ([GetPublicSubnetRequest](#yandex.cloud.baremetal.v2.GetPublicSubnetRequest)) returns ([PublicSubnet](#yandex.cloud.baremetal.v2.PublicSubnet))**

## GetPublicSubnetRequest {#yandex.cloud.baremetal.v2.GetPublicSubnetRequest}
