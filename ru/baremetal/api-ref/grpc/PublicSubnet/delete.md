---
editable: false
sourcePath: en/_api-ref-grpc/baremetal/v1alpha/api-ref/grpc/PublicSubnet/delete.md
---

# BareMetal API, gRPC: PublicSubnetService.Delete
...
**rpc Delete ([DeletePublicSubnetRequest](#yandex.cloud.baremetal.v1alpha.DeletePublicSubnetRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## DeletePublicSubnetRequest {#yandex.cloud.baremetal.v1alpha.DeletePublicSubnetRequest}
