---
title: Как проанализировать состояние сервера {{ baremetal-name }}
description: Следуя данной инструкции, вы сможете использовать утилиту HWCheck, чтобы сформировать отчет о состоянии сервера, его дисков и периферийных устройств.
---
...
Чтобы сформировать отчет о состоянии системы с помощью утилиты [HWCheck](../../../baremetal/concepts/smart-disk-analysis.md#hwcheck):
...
1. Посмотрите содержимое файла с отчетом о нужном диске — идентификатор дискового устройства указан в имени файла:
    ...
    Вы можете самостоятельно [проанализировать](../../concepts/smart-disk-analysis.md#hwcheck) полученные результаты или [обратиться](#report-issue) за помощью в службу технической поддержки.
