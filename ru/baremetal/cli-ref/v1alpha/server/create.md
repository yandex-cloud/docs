---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/baremetal/cli-ref/v1alpha/server/create/
---
...
1. Generate template:
yc baremetal v1alpha server create --example-json > request.json
or
yc baremetal v1alpha server create --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal v1alpha server create -r request.json
or
yc baremetal v1alpha server create -r request.yaml ||
|#
