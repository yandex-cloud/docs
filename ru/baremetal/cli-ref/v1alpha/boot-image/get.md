---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/baremetal/cli-ref/v1alpha/boot-image/get/
---

# yc baremetal v1alpha boot-image get
...
`yc baremetal v1alpha boot-image get <IMAGE-ID>`
