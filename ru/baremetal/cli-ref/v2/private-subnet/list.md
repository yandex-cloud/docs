---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/baremetal/cli-ref/v2/private-subnet/list/
---

# yc baremetal v2 private-subnet list
...
`yc baremetal v2 private-subnet list <CLOUD-ID>`
...
The maximum number of results per page to return. If the number of available results is greater than 'page_size', the service returns a [ListPrivateSubnetsResponse.next_page_token] that can be used to get the next page of results in subsequent list requests. Default value is 20. ||
|| `--page-token` | `string`
