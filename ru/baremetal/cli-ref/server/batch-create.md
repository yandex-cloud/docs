---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/baremetal/cli-ref/server/batch-create/
---
...
`yc baremetal server batch-create <FOLDER-ID>`
...
1. Generate template:
yc baremetal server batch-create --example-json > request.json
or
yc baremetal server batch-create --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal server batch-create -r request.json
or
yc baremetal server batch-create -r request.yaml ||
|#
