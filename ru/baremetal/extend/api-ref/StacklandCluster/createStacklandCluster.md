    ...
    body:
      ...
      properties:
        cluster:
          ...
          $ref: '#/definitions/StacklandCluster'
      additionalProperties: false
    definitions:
      Node:
        type: object
      ...
      StacklandClusterSettings:
        ...
        properties:
          publicNetworkAccess:
            ...
            type: string
            enum:
              - PUBLIC_NETWORK_ACCESS_UNSPECIFIED
              - ENABLED
              - DISABLED
      StacklandCluster:
        type: object
        properties:
          ...
          hostRoles:
            ...
            $ref: '#/definitions/StacklandHostRoles'
          bastionNode:
            description: |-
              **[Node](#yandex.cloud.baremetal.v2.extend.Node)**
              Bastion node.
          ...
          settings:
            ...
            $ref: '#/definitions/StacklandClusterSettings'
---
...
```
POST https://baremetal.{{ api-host }}/v2/clouds/{cloudId}/folders/{folderId}/extend/stacklandClusters
```
