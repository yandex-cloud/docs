...
editable: false
apiPlayground:
  - url: https://baremetal.{{ api-host }}/v2/clouds/{cluster.cloud_id}/folders/{cluster.folder_id}/extend/stacklandClusters/{cluster.stackland_cluster_id}
    method: patch
    path: null
    query: null
    body:
...
```
PATCH https://baremetal.{{ api-host }}/v2/clouds/{cluster.cloud_id}/folders/{cluster.folder_id}/extend/stacklandClusters/{cluster.stackland_cluster_id}
```
