...
```
GET https://baremetal.{{ api-host }}/v2/clouds/{cloudId}/folders/{folderId}/extend/stacklandClusters/{stacklandClusterId}
```
...
## Response {#yandex.cloud.baremetal.v2.extend.StacklandCluster}
