...
1. Смонтируйте ISO-образ на виртуальный CD-дисковод сервера. Для серверов на поддерживаемых платформах это можно сделать через вкладку **KVM console** в [консоли управления]({{ link-console-main }}) с помощью кнопки **Mount Image** или через окно KVM-консоли. Подробнее об обоих способах — в инструкции [{#T}](../operations/servers/reinstall-os-from-own-image.md#boot-from-image).
