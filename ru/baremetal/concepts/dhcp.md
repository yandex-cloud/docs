---
title: Сервис DHCP в сети {{ baremetal-full-name }}
description: Узнайте, как DHCP передает IP-адреса, маршруты и DNS-настройки серверам {{ baremetal-name }} в публичных и приватных подсетях.
---
