...
Анализ информации о дисковых ошибках основывается на технологии самодиагностики дисков [SMART](https://ru.wikipedia.org/wiki/S.M.A.R.T.) и использует утилиту [HWCheck](../operations/servers/use-hwatcher.md) для сбора и обработки информации и формирования отчета. Использовать утилиту `HWCheck` можно только на серверах под управлением ОС [Linux](https://ru.wikipedia.org/wiki/Linux).
