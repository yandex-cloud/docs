...
description: "В этой инструкции вы научитесь создавать сертификаты X509 и настраивать обмен сообщениями между устройствами и реестрами с помощью сервиса {{ iot-full-name }}."
---
