...
- CLI
    ...
    - Подпишите устройство на сохраняемые команды для конкретного устройства (перманентный топик), используя сертификат: 
		...
		- Подпишите устройство на сохраняемые команды для конкретного устройства (перманентный топик), используя логин и пароль: 
...
- CLI
    ...
    - Подпишите устройство на команды, используя сертификат:     
        ...
        --qos 1
        ```
    - Подпишите устройство на сохраняемые команды (перманентный топик), используя сертификат:     
	...
	- Подпишите устройство на команды, используя логин и пароль:     
        ...
        --qos 1
        ```          
	- Подпишите устройство на сохраняемые команды (перманентный топик), используя логин и пароль:     
