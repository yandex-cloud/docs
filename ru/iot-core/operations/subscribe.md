...
- CLI
    ...
    - Подпишите реестр на устройство, используя сертификат:
        ...
        --qos 1
        ```
    - Подпишите реестр на устройство с сохранением последней записи (перманентный топик), используя сертификат:
	...
	- Подпишите реестр на устройство, используя логин и пароль:
        ...
        --qos 1
        ```
    - Подпишите реестр на устройство с сохранением последней записи (перманентный топик), используя логин и пароль:
...
- CLI
    ...
    - Подпишите реестр на все устройства, используя сертификат:
    ...
    - Подпишите реестр на все устройства с сохранением последней записи (перманентный топик), используя сертификат:
	...
	- Подпишите реестр на все устройства, используя логин и пароль: 
        ...
        --qos 1
        ```
    - Подпишите реестр на все устройства с сохранением последней записи (перманентный топик), используя логин и пароль: 
...
- CLI
    ...
    - Подпишите устройство на команды для конкретного устройства, используя сертификат: 
    ...
    - Подпишите устройство на команды для конкретного устройства с сохранением последней записи (перманентный топик), используя сертификат: 
	...
	- Подпишите устройство на команды для конкретного устройства, используя логин и пароль: 
    ...
    - Подпишите устройство на сохраняемые команды для конкретного устройства с сохранением последней записи (перманентный топик), используя логин и пароль: 
...
- CLI
    ...
    - Подпишите устройство на команды, используя сертификат:     
        ...
        --qos 1
        ```
    - Подпишите устройство на команды с сохранением последней записи (перманентный топик), используя сертификат:     
	...
	- Подпишите устройство на команды, используя логин и пароль:     
        ...
        --qos 1
        ```          
	- Подпишите устройство на команды с сохранением последней записи (перманентный топик), используя логин и пароль:     
