...
- CLI
    ...
    - Подпишите реестр на топик устройства, используя сертификат:
        ...
        --qos 1
        ```
    - Подпишите реестр на перманентный топик устройства, используя сертификат:
	...
	- Подпишите реестр на топик устройства, используя логин и пароль:
        ...
        --qos 1
        ```
    - Подпишите реестр на перманентный топик устройства, используя логин и пароль:
...
- CLI
    ...
    - Подпишите реестр на топики всех устройств, используя сертификат:
    ...
    - Подпишите реестр на перманентные топики всех устройств, используя сертификат:
	...
	- Подпишите реестр на топики всех устройств, используя логин и пароль: 
        ...
        --qos 1
        ```
    - Подпишите реестр на перманентные топики всех устройств, используя логин и пароль: 
...
- CLI
    ...
    - Подпишите устройство на топики — команды для конкретного устройства, используя сертификат: 
    ...
    - Подпишите устройство на перманентные топики — команды для конкретного устройства, используя сертификат: 
	...
	- Подпишите устройство на топики — команды для конкретного устройства, используя логин и пароль: 
    ...
    - Подпишите устройство на перманентные топики — команды для конкретного устройства, используя логин и пароль: 
...
- CLI
    ...
    - Подпишите устройство на топики — команды, используя сертификат:     
        ...
        --qos 1
        ```
    - Подпишите устройство на перманентные топики — команды, используя сертификат:     
	...
	- Подпишите устройство на топики — команды, используя логин и пароль:     
        ...
        --qos 1
        ```          
	- Подпишите устройство на перманентные топики — команды, используя логин и пароль:
