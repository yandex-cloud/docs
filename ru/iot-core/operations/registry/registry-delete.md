---
title: Как удалить реестр {{ iot-full-name }}
description: Следуя данной инструкции, вы сможете удалить реестр {{ iot-short-name }}.
---
...
- Консоль управления {#console}
   ...
   1. Справа от имени удаляемого реестра нажмите ![image](../../../_assets/console-icons/ellipsis.svg) → ![image](../../../_assets/console-icons/trash-bin.svg) **{{ ui-key.yacloud.common.delete }}**.
