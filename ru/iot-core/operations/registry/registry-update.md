...
- Консоль управления {#console}
   ...
   1. Справа от имени нужного реестра нажмите ![image](../../../_assets/console-icons/ellipsis.svg) → ![image](../../../_assets/console-icons/pencil.svg) **{{ ui-key.yacloud.common.edit }}**.
...
- {{ TF }} {#tf}
  ...
  1. Откройте файл конфигурации {{ TF }} и измените значение параметра `name` во фрагменте с описанием реестра.
      ...
      Подробнее о параметрах ресурса `yandex_iot_core_registry` в [документации провайдера]({{ tf-provider-resources-link }}/iot_core_registry).
...
- Консоль управления {#console}
   ...
   1. [Перейдите]({{ link-console-main }}/link/iot-core) в сервис **{{ ui-key.yacloud.iam.folder.dashboard.label_iot-core }}**.
   1. Справа от имени нужного реестра нажмите ![image](../../../_assets/console-icons/ellipsis.svg) → ![image](../../../_assets/console-icons/pencil.svg) **{{ ui-key.yacloud.common.edit }}**.
   1. В поле **{{ ui-key.yacloud.component.label-set.label_labels }}** введите ключ и значение [метки](../../../resource-manager/concepts/labels.md).
   1. Нажмите **{{ ui-key.yacloud.common.save }}**.
...
- Консоль управления {#console}
   ...
   1. [Перейдите]({{ link-console-main }}/link/iot-core) в сервис **{{ ui-key.yacloud.iam.folder.dashboard.label_iot-core }}**.
   1. Справа от имени нужного реестра нажмите ![image](../../../_assets/console-icons/ellipsis.svg) → ![image](../../../_assets/console-icons/pencil.svg) **{{ ui-key.yacloud.common.edit }}**.
   1. В поле **{{ ui-key.yacloud.component.label-set.label_labels }}** измените ключ и значение [метки](../../../resource-manager/concepts/labels.md).
   1. Нажмите **{{ ui-key.yacloud.common.save }}**.
