...
Если вы не знаете идентификатор или имя реестра, в котором находится ваше устройство, [посмотрите список существующих реестров](../registry/registry-list.md#registry-list).
