...
- {{ TF }} {#tf}
   ...
   1. Опишите в конфигурационном файле параметры ресурса, который необходимо создать:
      ...
      * `yandex_iot_core_device` — параметры устройства:
         ...
         * `aliases` — алиасы топиков. Подробнее в [Создание алиаса](../device/alias/alias-create.md).
      ...
      Подробнее о ресурсах, которые можно создать с помощью {{ TF }}, в [документации провайдера]({{ tf-provider-link }}).
