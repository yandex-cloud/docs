...
- CLI
    ...
    - Отправьте данные с устройства в топик устройства, используя сертификат: 
        ...
        --qos 1
        ```
    - Отправьте данные с устройства в перманентный топик устройства, используя сертификат: 
	...
	- Отправьте данные с устройства в топик устройства, используя логин и пароль: 
	...
	- Отправьте данные с устройства в перманентный топик устройства, используя логин и пароль: 
...
- CLI
    ...
    - Отправьте данные с устройства в топик реестра, используя сертификат: 
	...
	- Отправьте данные с устройства в перманентный топик реестра, используя сертификат: 
	...
	- Отправьте данные с устройства в топик реестра, используя логин и пароль:
	...
	- Отправьте данные с устройства в перманентный топик реестра, используя логин и пароль:
...
- CLI
    ...
    - Отправьте команду устройству, используя сертификат:
    ...
    - Отправьте команду устройству с сохранением последней записи (перманентный топик), используя сертификат:
	...
	- Отправьте команду устройству, используя логин и пароль: 
        ...
        --qos 1
        ```                      
	- Отправьте команду устройству с сохранением последней записи (перманентный топик), используя логин и пароль: 
...
- CLI
    ...
    - Отправьте команду всем устройствам, используя сертификат: 
    ...
    - Отправьте команду всем устройствам с сохранением последней записи (перманентный топик), используя сертификат: 
	...
	- Отправьте команду всем устройствам, используя логин и пароль:
	...
	- Отправьте команду всем устройствам с сохранением последней записи (перманентный топик), используя логин и пароль:
