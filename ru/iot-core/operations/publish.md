...
- CLI
    ...
    - Отправьте данные в топик устройства, используя сертификат: 
        ...
        --qos 1
        ```
    - Отправьте данные в перманентный топик устройства, используя сертификат: 
	...
	- Отправьте данные в топик устройства, используя логин и пароль: 
	...
	- Отправьте данные в перманентный топик устройства, используя логин и пароль: 
...
- CLI
    ...
    - Отправьте данные в топик реестра, используя сертификат: 
	...
	- Отправьте данные в перманентный топик реестра, используя сертификат: 
	...
	- Отправьте данные в топик реестра, используя логин и пароль:
	...
	- Отправьте данные в перманентный топик реестра, используя логин и пароль:
