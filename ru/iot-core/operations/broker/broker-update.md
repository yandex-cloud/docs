...
- Консоль управления {#console}
   ...
   1. Справа от имени нужного брокера нажмите ![image](../../../_assets/console-icons/ellipsis.svg) → ![image](../../../_assets/console-icons/pencil.svg) **{{ ui-key.yacloud.common.edit }}**.
...
- {{ TF }} {#tf}
  ...
  1. Откройте файл конфигурации {{ TF }} и измените значение параметра `name` во фрагменте с описанием брокера.
      ...
      Подробнее о параметрах ресурса `yandex_iot_core_broker` в [документации провайдера]({{ tf-provider-resources-link }}/iot_core_broker).
