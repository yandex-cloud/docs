...
- Консоль управления
   ...
   Чтобы посмотреть журнал подключений устройства:

   1. В [консоли управления](https://console.cloud.yandex.ru/) выберите каталог, в котором вы хотите посмотреть журнал подключений устройства.
   ...
   В окне **Логи** отобразится журнал подключений устройства.
...
- Консоль управления
   ...
   Чтобы посмотреть журнал подключений реестра:

   1. В [консоли управления](https://console.cloud.yandex.ru/) выберите каталог, в котором вы хотите посмотреть журнал подключений реестра.
   1. Выберите сервис **{{ iot-name }}**.
   1. Выберите в списке реестр с нужным устройством.
   1. В левой части окна выберите раздел **Логи**.

   В окне **Логи** отобразится журнал подключений реестра.
