...
Параметр | Описание
--- | ---
deviceId | Обязательное поле. Идентификатор устройства для удаления сертификата.  Для получения идентификатора устройства используйте запрос [list](/docs/iot-core/api-ref/Device/list).  Максимальная длина строки в символах — 50.
fingerprint | Обязательное поле. Цифровой отпечаток сертификата для удаления.  Максимальная длина строки в символах — 50.
