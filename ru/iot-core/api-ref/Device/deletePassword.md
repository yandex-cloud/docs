...
editable: false
apiPlayground:
  - url: https://iot-devices.{{ api-host }}/iot-devices/v1/devices/{deviceId}/passwords/{passwordId}
    method: delete
    path:
      type: object
      properties:
    ...
    body: null
    definitions: null
sourcePath: en/_api-ref/iot/devices/v1/api-ref/Device/deletePassword.md
---
