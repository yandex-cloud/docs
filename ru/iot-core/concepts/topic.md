...
Означает подстановку любых топиков: стандартных или дополненных произвольными сабтопиками. Всегда является последним символом в фильтре.
...
Означает подстановку одной части топика или сабтопика, указанной между символами `/` либо в конце после символа `/`.
