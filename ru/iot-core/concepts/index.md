...
Если вы  вашей инфраструктуре соединение между MQTT-клиентами и MQTT-брокером не постоянное и прерывается, вы не видите историю изменений топиков. Чтобы видеть текущее состояние топиков при возобновлении соединения, вы можете подписать клиент на [перманентные топики](#permanent).
