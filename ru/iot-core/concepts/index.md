...
Если в вашей инфраструктуре соединение между MQTT-клиентами и MQTT-брокером не постоянное и прерывается, вы не видите историю изменений топиков. Чтобы избежать этой проблемы, вы можете подписать клиент на [перманентные топики](#permanent), в которых сохраняется информация о предыдущих действиях устройства и реестра.
