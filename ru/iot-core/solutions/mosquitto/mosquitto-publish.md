...
- Отправлять данные с устройства в реестр с сохранением последней записи, используя перманентные топики `$devices/<ID устройства>/state` или `$registries/<ID реестра>/state`.
...
- Отправлять команды из реестра на устройство с сохранением последней записи, используя перманентные топики `$devices/<ID устройства>/config` или `$registries/<ID реестра>/config`.
...
- Mosquitto
    ...
    - Отправьте данные с устройства в перманентный топик устройства:
    ...
    - Отправьте данные с устройства в перманентный топик реестра:
...
- Mosquitto
    ...
    - Отправьте команду одному устройству с сохранением последней записи (перманентный топик):
    ...
    - Отправьте команду двум устройствам с сохранением последней записи (перманентный топик):
    ...
    - Отправьте команду всем устройствам, добавленным в реестр, с сохранением последней записи (перманентный топик):
