---
title: Управление доступом в Yandex IoT Core
description: "Управление доступом облачного MQTT-брокера Yandex IoT Core. В разделе описано, на какие ресурсы можно назначить роль, какие роли действуют в сервисе."
