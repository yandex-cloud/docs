...
В {{ yandex-cloud }} вы можете быстро [создать сайт на WordPress](wordpress.md) или перенести с другого хостинга. 
...
1. В блоке **Выбор образа/загрузочного диска** перейдите на вкладку **{{ marketplace-name }}** и выберите [LAMP](/marketplace/products/yc/lamp) — образ, который содержит необходимый набор компонентов: операционную систему семейства Linux, веб-сервер Apache, СУБД MySQL и интерпретатор PHP.
