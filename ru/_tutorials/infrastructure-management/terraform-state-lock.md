...
- AWS CLI
  ...
  1. Выполните команду:
     ...
     aws dynamodb create-table \
       ...
       --endpoint <document-api-endpoint БД>
     ```
...
Чтобы сохранить состояние {{ TF }} в {{ objstorage-name }} и активировать блокировку состояний, укажите настройки провайдера и бэкенда:
...
terraform {
  ...
  backend "s3" {
    ...
    dynamodb_endpoint = "<эндпоинт Document API БД>"
