...
- CLI
   ...
   * `create-boot-disk` — создать для ВМ новый диск:
      ...
      * `image-id` — идентификатор образа диска.
        ...
        В данном случае используйте `image_id` из [описания продукта]{% if lang == "ru" %}(https://cloud.yandex.ru/marketplace/products/hystax/hystax-acura-live-cloud-migration-3-7){% endif %}{% if lang == "en" %}(https://cloud.yandex.com/en/marketplace/products/hystax/hystax-acura-live-cloud-migration-3-7){% endif %} в {{ marketplace-name }}.
