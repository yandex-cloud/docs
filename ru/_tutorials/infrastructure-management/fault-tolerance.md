...
- Нагрузка генерируется приложением [Яндекс.Танк](/marketplace/products/f2eorddjcjobshekumlp) и подается на {{network-load-balancer-short-name}}. Сетевой балансировщик нагрузки распределяет трафик по виртуальным машинам.
