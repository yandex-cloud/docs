# Распознавание архива изображений в {{ vision-name }}
...
* Плата за использование динамического или статического внешнего IP-адреса (см. [тарифы {{ vpc-name }}](../vpc/pricing.md)).
...
- Консоль управления
  ...
  1. В блоке **Сетевые настройки** выберите сеть и подсеть, к которым нужно подключить ВМ. Если сети нет, создайте ее:
     ...
     1. Нажмите кнопку **Создать**.
        ...
        У каждой сети должна быть как минимум одна [подсеть](../vpc/concepts/network.md#subnet). Если подсети нет, создайте ее, выбрав пункт ![image](../_assets/console-icons/plus.svg) **Добавить подсеть**.
