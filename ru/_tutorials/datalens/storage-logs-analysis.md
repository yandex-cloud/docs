...
- Консоль управления
  ...
  1. Укажите настройки кластера {{ CH }}:
     ...
     1. В блоке **Хосты** нажмите на значок ![pencil](../../_assets/pencil.svg). Включите опцию **Публичный доступ** и нажмите кнопку **Сохранить**.
...
- Консоль управления
  ...
  1. Нажмите на значок ![image](../../_assets/horizontal-ellipsis.svg) и выберите **Настроить**.
...
1. Скопируйте чарт, получившийся на предыдущем шаге:
   ...
   1. В правом верхнем углу нажмите на значок галочки рядом с кнопкой **Сохранить**.
