...
В стоимость инфраструктуры для геокодинга и визуализации данных входит плата за сервис {{ ml-platform-name }}: использование вычислительных ресурсов ([тарифы {{ ml-platform-name }}](../../datasphere/pricing.md)).
