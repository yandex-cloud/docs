...
1. На вкладке **Params** задайте параметры, которые используются в чарте.
   ...
   * `row_limit` — лимит запрашиваемых строк.
   ...
   ^1^ Чтобы скопировать идентификатор поля, откройте датасет, перейдите на вкладку **Поля** и в строке с нужным полем нажмите ![image](../../_assets/console-icons/ellipsis.svg) → **Скопировать ID**. Идентификатор будет скопирован в буфер обмена.
