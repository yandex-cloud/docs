# Анализ продаж и локаций пиццерий на данных из БД {{ CH }} и {{ datalens-gallery }}
...
В качестве источника используется демонстрационная база данных {{ CH }} и демо-воркбук из работы [Организации: спрос и предложение]({{ link-datalens-main }}/gallery/euma77kb36nc0) в {{ datalens-gallery }}.
...
1. [Разверните демо-воркбук из {{ datalens-gallery }}](#create-template).
...
1. В {{ datalens-gallery }} откройте работу с названием [Организации: спрос и предложение]({{ link-datalens-main }}/gallery/euma77kb36nc0).
...
1. Выберите датасет `Организации`, [импортированный из {{ datalens-gallery }}](#create-template).
...
1. Добавить из {{ datalens-gallery }} работу [Аудитория: интересы и соцдем](https://datalens.ru/gallery/zf7wou4zyhtml), чтобы аналогично отобразить на карте данные по аудитории города.
