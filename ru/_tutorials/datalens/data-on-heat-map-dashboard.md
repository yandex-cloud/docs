...
Для предоставления пользователю доступа к дашборду **Тепловые карты**, менеджеру необходимо заполнить заявку на подключение через [форму](https://forms.yandex-team.ru/surveys/147089/).
