...
В этом руководстве будут [проанализированы открытые данные]({{ link-docs }}/glossary/data-analytics) о дорожно-транспортных происшествиях на дорогах РФ. Помимо выявления фактов статистики ДТП в России, в процессе анализа вы научитесь:
