...
## Шаг 1. Создайте подключение к {% if audience != "internal" %}CSV-{% endif %}файлу {#step1}
...
Подключение к {% if audience != "internal" %}CSV-{% endif %}файлу создано. Данные представлены в том же виде, что и в файле. Для дальнейшей работы с ними нужно создать датасет.
...
1. Просмотрите превью данных файла. Для параметра **Заголовок таблицы** установите значение **Есть**.
...
1. Перейдите на вкладку **Источники**.
   ...
   ![image](../../_assets/datalens/solution-07/61-choose-data-ext.png)
...
1. Выберите поля, которые будут связаны: **reg_name** и **Регион ДТП**. Затем нажмите **Применить**.
   ...
   ![image](../../_assets/datalens/solution-07/67-preview-ext.png)
