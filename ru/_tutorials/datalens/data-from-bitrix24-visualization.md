...
1. В правом верхнем углу графика нажмите значок ![image](../../_assets/datalens/horizontal-ellipsis.svg) и выберите **Редактировать**.
...
1. Сохраните чарт как новый объект:
   ...
   1. В правом верхнем углу страницы нажмите значок ![image](../../_assets/datalens/arrow-down.svg) и выберите **Сохранить как**.
...
1. Ознакомьтесь с содержимым каталога **Битрикс24**. Для этого вернитесь в каталог Битрикс24: нажмите ![folder](../../_assets/datalens/folder.svg) и в панели навигации выберите **Битрикс24**.
...
1. Перейдите в каталог **Лиды** и откройте датасет **Лиды**. 
   ...
   * **Источник поля** — обозначение поля в таблице источника или формула для [вычисления](../../datalens/concepts/calculations/index.md) (обозначены значком ![formula-dataset](../../_assets/datalens/formula-dataset.svg)).
...
1. В блоке **Подключения** нажмите кнопку ![image](../../_assets/plus-sign.svg)**Добавить** и выберите ранее созданное подключение к Битрикс24.
...
1. Создайте поле с количеством записей — `ID_COUNT`:
   ...
   1. Продублируйте поле `ID`: наведите курсор на строку с полем, в конце строки нажмите значок ![image](../../_assets/datalens/horizontal-ellipsis-black.svg) и выберите **Дублировать**.
...
1. Сохраните чарт:
   ...
   1. В правом верхнем углу страницы нажмите значок ![image](../../_assets/datalens/arrow-down.svg) и выберите **Сохранить**.
