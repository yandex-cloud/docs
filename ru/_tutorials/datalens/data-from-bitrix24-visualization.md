...
1. Выберите тип подключения [**Битрикс24**]{% if audience == "external" %}({{ link-datalens-main }}/connections/new/bitrix24){% else %}(https://datalens.yandex-team.ru/connections/new/bitrix24){% endif %}.
