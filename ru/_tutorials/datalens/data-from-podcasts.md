...
Аналитика подкастов позволяет получать статистику и [анализировать данные]({{ link-docs }}/glossary/data-analytics) по прослушиваниям и подписчикам подкастов в Яндекс Музыке. Для работы с аналитикой подкастов у вас должен быть доступ к одному или более подкастам.
...
Подробнее о [правилах тарификации](../../datalens/pricing.md) для {{ datalens-short-name }}.
...
1. Убедитесь, что у нового пользователя есть права доступа к дашборду со статистикой по подкастам в зависимости от размещения:
   ...
   - Воркбук {#workbook}
     ...
     1. Нажмите кнопку **Сохранить**. Пользователю или группе будут назначены права на данный объект.
        ...
        Подробнее о [ролях в {{ datalens-short-name }}](../../datalens/security/roles.md).
   ...
   - Папка {#folder}
     ...
     1. Включите опцию **Связанные объекты**, чтобы предоставить права на другие объекты, связанные с дашбордом (подключение, датасеты и чарты).
        ...
        Права доступа можно настраивать для каждого [объекта](../../datalens/security/manage-access.md) отдельно.
