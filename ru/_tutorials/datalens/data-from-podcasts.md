...
Аналитика подкастов позволяет получать статистику и {% if lang == "ru" and audience != "internal" %}[анализировать данные](../../glossary/data-analytics.md){% else %}анализировать данные{% endif %} по прослушиваниям и подписчикам подкастов в Яндекс Музыке. Для работы с аналитикой подкастов у вас должен быть доступ к одному или более подкастам.
