# Визуализация данных из Яндекс.Форм

Воспользуйтесь готовыми решениями этого сценария, чтобы использовать данные из сервиса [Яндекс.Формы](https://forms.yandex.ru/) для визуализации в {{ datalens-short-name }}.
...
В YT не хранятся логины сотрудников, ответивших на форму. Вместо них хранятся идентификаторы (UID). Чтобы определить, кто именно заполнил форму, добавьте в датасет [таблицу](https://yt.yandex-team.ru/hahn/navigation?path=//home/hr-stat/charts/staff/employees) с данными сотрудников из Стаффа.
...
1. Укажите путь к таблице с данными из Стаффа — `//home/hr-stat/charts/staff/employees`.
