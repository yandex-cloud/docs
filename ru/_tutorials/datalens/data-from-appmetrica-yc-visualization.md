...
1. Перейдите в [консоль управления]({{ link-console-main }}).
1. [Перейдите](../../console/operations/select-service.md#select-service) в сервис **{{ ml-platform-name }}**.
...
1. Откройте [главную страницу]({{ link-datalens-main-skip-promo }}) {{ datalens-short-name }} и в меню слева выберите **Подключения**.
