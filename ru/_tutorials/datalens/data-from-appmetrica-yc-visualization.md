...
* Обработаете данные с помощью скриптов на языке Python, описанных в Jupyter ноутбуках в {{ ml-platform-full-name }}.
...
Для решения ваших рабочих задач рекомендуем напрямую [экспортировать данные](https://appmetrica.yandex.ru/docs/cloud/index.html) из AppMetrica в {{ CH }}.
...
1. [Customer journey. Создайте SQL-чарт и диаграмму Sankey](#customer-journey)
    1. [Создайте SQL-чарт в {{ datalens-short-name }}](#creating-sql-chart)
...
Для настройки подключения и выгрузки данных из своего приложения воспользуйтесь инструкцией [Экспорт данных в Яндекс.Облако](https://appmetrica.yandex.ru/docs/cloud/index.html).
...
### 4.3. Cоздайте датасет на базе подключения {#creating-dataset-based-on-connection}
...
## 6. Customer journey. Создайте SQL-чарт и диаграмму Sankey {#customer-journey}

### 6.1. Создайте SQL-чарт в {{ datalens-short-name }} {#creating-sql-chart}

С помощью SQL-чартов вы можете изучать последовательности событий и экспериментировать в {{ datalens-short-name }}.
...
1. Справа вверху нажмите **Создать SQL-чарт**.
1. Введите запрос:
...
1. Добавьте SQL-чарт на дашборд.
