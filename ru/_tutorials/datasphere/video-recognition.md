...
- Консоль управления
   ...
   1. На странице создания бакета:
      1. Введите имя бакета в соответствии с [правилами именования](../../storage/concepts/bucket.md#naming), например `bucketwithvideo`.
...
1. В первой ячейке измените значение переменной `bucket_name` на название созданного вами бакета. По умолчанию бакет называется `bucketwithvideo`.
...
1. Запустите первые три ячейки. В этих ячейках:
   ...
   1. Определяется имя бакета, в котором хранятся изображения. По умолчанию бакет называется `bucketwithvideo`.
