...
1. Загрузите [дистрибутив Exchange Server]{% if lang == "ru" %}(https://www.microsoft.com/ru-ru/download/confirmation.aspx?id=58395){% endif %}{% if lang == "en" %}(https://www.microsoft.com/en-us/download/confirmation.aspx?id=58395){% endif %} и необходимые зависимости:
