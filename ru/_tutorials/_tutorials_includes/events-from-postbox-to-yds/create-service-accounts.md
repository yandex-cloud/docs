1. Создайте сервисный аккаунт `yds-functions`:
    ...
    - Консоль управления {#console}
      ...
      1. [Перейдите](../../../console/operations/select-service.md#select-service) в сервис **{{ ui-key.yacloud.iam.folder.dashboard.label_iam }}** и нажмите кнопку **{{ ui-key.yacloud.iam.folder.service-accounts.button_add }}**.
