...
- Консоль управления {#console}
  ...
  1. Укажите существующую [бессерверную](../../ydb/concepts/serverless-and-dedicated.md#serverless) базу данных {{ ydb-short-name }} или [создайте](../../ydb/quickstart.md#serverless) новую. Если вы создали новую БД, нажмите кнопку ![refresh-button](../../_assets/console-icons/arrow-rotate-right.svg), чтобы обновить список БД.
  1. Введите **{{ ui-key.yacloud.common.name }}** потока данных, например `logs-stream`.
