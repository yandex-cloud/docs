...
В сценарии рассматривается настройка IPSec-инстанса для передачи трафика от виртуальных машин {{ yandex-cloud }} в туннель IPSec {% if lang == "ru" and audience != "internal" %}[VPN](../../glossary/vpn.md){% else %}VPN{% endif %} с использованием демона [strongSwan](https://www.strongswan.org/). 
...
1. Подключитесь к виртуальной машине по {% if lang == "ru" and audience != "internal" %}[SSH](../../glossary/ssh-keygen.md){% else %}SSH{% endif %}:
