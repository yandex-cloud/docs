...
В сценарии рассматривается настройка IPSec-инстанса для передачи трафика от виртуальных машин {{ yandex-cloud }} в туннель IPSec [VPN](../../glossary/vpn.md) с использованием демона [strongSwan](https://www.strongswan.org/). 
...
1. Задайте следующие параметры тестового соединения: 
   ...
   * `<внутренний_ip-адрес_IPSec-инстанса>` — внутренний IP-адрес ВМ с IPSec-инстансом.
   ...
   IPSec-инстанс будет доступен для диагностики и отвечать по протоколу [ICMP](https://ru.wikipedia.org/wiki/ICMP).
