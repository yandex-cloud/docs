...
* Вручную
    ...
    1. В сети `network-dataproc` [создайте виртуальную машину](../../compute/operations/vm-create/create-linux-vm.md) на основе образа [NAT-инстанс](https://cloud.yandex.ru/marketplace/products/f2etqeet87jshce7o7j8) с публичным IP-адресом. Укажите настроенные ранее группы безопасности.
