...
1. [Настройте NAT-шлюз](../../vpc/operations/create-nat-gateway.md).
...
- Вручную
    ...
    1. В группе безопасности NAT-инстанса [создайте правила](../../vpc/operations/security-group-add-rule.md):
        ...
        * Правило, разрешающее [SSH-подключение](../../glossary/ssh-keygen.md) к NAT-инстансу через интернет:
...
1. [Подключитесь](../../compute/operations/vm-connect/ssh.md) к NAT-инстансу по [SSH](../../glossary/ssh-keygen.md).
