...
- Консоль управления {#console}
  ...
  1. В блоке **{{ ui-key.yacloud.baremetal.title_section-server-config }}** нажмите фильтр `{{ ui-key.yacloud.baremetal.servers.Filters.poolFilter_tVgg5 }}` и выберите пул серверов `{{ region-id }}-m3`.
