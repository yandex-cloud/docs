...
1. Задайте секретный ключ:
   ...
   Где:
   * `<секретный_ключ>` — ключ шифрования, длинной не менее 16 символов, например `MySecretKey12345`. Используйте один ключ на обеих ВМ.
