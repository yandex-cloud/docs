...
В этом руководстве вы воспользуетесь возможностями [моделей генерации текста](../../foundation-models/concepts/yandexgpt/models.md) {{ foundation-models-full-name }} для реализации сценария автоматического ревью предлагаемых изменений в программном коде на [GitHub](https://github.com/).

Предлагаемое решение при добавлении [коммита](https://docs.github.com/en/get-started/learning-about-github/github-glossary#commit) в [пул-реквест](https://docs.github.com/en/get-started/learning-about-github/github-glossary#pull-request) на GitHub использует сценарий [GitHub Actions](https://docs.github.com/en/actions/get-started/understand-github-actions) для обращения к [рабочему процессу](../../serverless-integrations/concepts/workflows/workflow.md) {{ sw-full-name }}. При поступлении запроса от GitHub Actions рабочий процесс {{ sw-name }} запрашивает на GitHub информацию о предлагаемых в пул-реквесте изменениях. Затем рабочий процесс обращается к модели {{ foundation-models-name }}, которая формирует подробное [ревью](https://docs.github.com/en/get-started/learning-about-github/github-glossary#review) предлагаемых изменений с комментариями и собственными предложениями по улучшению кода. Получив сгенерированное моделью ревью, рабочий процесс {{ sw-name }} публикует его в пул-реквесте на GitHub.

Для доступа к репозиторию рабочий процесс использует [токен доступа](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens#about-personal-access-tokens), предварительно созданный пользователем на GitHub и безопасно сохраняемый в [секрете](../../lockbox/concepts/secret.md) {{ lockbox-full-name }}. Сценарий GitHub Actions аутентифицируется в API {{ yandex-cloud }} от имени [сервисного аккаунта](../../iam/concepts/users/service-accounts.md) с использованием короткоживущего [IAM-токена](../../iam/concepts/authorization/iam-token.md). Сценарий GitHub Actions получает IAM-токен с помощью [авторизованного ключа](../../iam/concepts/authorization/key.md) сервисного аккаунта, сохраненного в [секрете](https://docs.github.com/en/actions/how-tos/write-workflows/choose-what-workflows-do/use-secrets) репозитория на GitHub.
