...
* [Установите](https://www.terraform.io/downloads) {{ TF }}. Установка описана в разделе [{#T}](../../tutorials/infrastructure-management/terraform-quickstart.md).
...
1. Внесите изменения в файл описания Pipeline для Jenkins `Jenkinsfile`, расположенный в корневой директории репозитория. Документация Pipeline на [сайте](https://jenkins.io/doc/book/pipeline/syntax/) разработчика.
...
1. Заполните поля файла требуемыми значениями. Смотрите также документацию [{{ TF }}](https://www.terraform.io/language#about-the-terraform-language) и [провайдера {{ yandex-cloud }}]({{ tf-provider-link }}).
