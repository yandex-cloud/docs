...
* плата за операции с данными и за объем хранимых данных ([тарифы {{ ydb-full-name }}](../../ydb/pricing/serverless.md));
* плата за использование потока данных ([тарифы {{ yds-full-name }}](../../data-streams/pricing.md));
* плата за хранение секрета ([тарифы {{ lockbox-full-name }}](../../lockbox/pricing.md));
* плата за хранение данных и операции с данными ([тарифы {{ objstorage-full-name }}](../../storage/pricing.md));
* плата за запросы к созданным API-шлюзам и исходящий трафик ([тарифы {{ api-gw-full-name }}](../../api-gateway/pricing.md));
* плата за запросы к очередям и исходящий трафик ([тарифы {{ message-queue-full-name }}](../../message-queue/pricing.md));
