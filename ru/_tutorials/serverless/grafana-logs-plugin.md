...
В стоимость ресурсов входит плата за запись и хранение логов в лог-группе ([тарифы {{ cloud-logging-full-name }}](../../logging/pricing.md)).
...
- Консоль управления {#console}
  ...
  1. В открывшемся окне введите **{{ ui-key.yacloud.iam.folder.service-account.popup-robot_field_name }}** сервисного аккаунта: `grafana-plugin`.
...
- Консоль управления {#console}
  ...
  1. Выберите **{{ ui-key.yacloud.iam.folder.service-account.overview.field_key-algorithm }}**.
  1. Задайте **{{ ui-key.yacloud.iam.folder.service-account.overview.field_key-description }}** ключа, чтобы потом было проще найти его в консоли управления.
...
- Консоль управления {#console}
  ...
  1. В [консоли управления]({{ link-console-main }}) выберите каталог, в котором создали сервисный аккаунт `grafana-plugin`.
