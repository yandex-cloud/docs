...
- Консоль управления {#console}
  ...
  1. В [консоли управления]({{ link-console-main }}) выберите каталог, в котором находится [рабочий процесс](../../serverless-integrations/concepts/workflows/workflow.md).
  1. [Перейдите]({{ link-console-main }}/link/serverless-integrations) в сервис **{{ ui-key.yacloud.iam.folder.dashboard.label_serverless-integrations }}**.
  1. На панели слева нажмите ![image](../../_assets/console-icons/graph-node.svg) **{{ ui-key.yacloud.serverless-workflows.label_service }}**.
...
Также вы можете:
* Добавить текст или файлы в качестве источников информации для агента. Подробнее в разделе [Текстовые агенты в {{ ai-studio-name }}]({{ link-docs-ai }}ai-studio/concepts/agents/text-agents).
* Настроить управление контекстом диалога. Подробнее в разделе [Управление контекстом диалога]({{ link-docs-ai }}ai-studio/operations/agents/manage-context).
