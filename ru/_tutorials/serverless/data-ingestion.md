...
Перед тем как настраивать ввод данных, нужно зарегистрироваться в {{ yandex-cloud }} и создать платежный аккаунт:

{% include [prepare-register-billing](../_common/prepare-register-billing.md) %}

Если у вас есть активный платежный аккаунт, вы можете создать или выбрать каталог, в котором будет развернута ваша инфраструктура, на [странице облака](https://console.cloud.yandex.ru/cloud).
...
1. Укажите существующую [бессерверную](../../ydb/concepts/serverless_and_dedicated.md#serverless) базу данных {{ ydb-short-name }} или [создайте](../../ydb/getting_started/create_db#control-panel.md) новую. Если вы создали новую базу данных, после ее создания нажмите кнопку ![refresh-button](../../_assets/data-streams/refresh-button.svg) **Обновить** для обновления списка баз.
...
1. Создайте эндпоинт-источник:
    ...
    1. В списке **Тип базы данных** выберите `Yandex Data Stream`.
