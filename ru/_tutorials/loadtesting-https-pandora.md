...
1. В зависимости от выбранного способа задайте параметры теста:
    ...
    - Форма
      ...
      1. В меню **Профиль нагрузки** нажмите ![image](../_assets/plus-sign.svg) **Профиль нагрузки** и введите описание:

          * **Профиль 1** — выберите `step`.

          * **От** — укажите `1000`.
          * **До** — укажите `5000`.
          * **Шаг** — укажите `1000`.
          * **Длительность** — укажите `120s`.
      ...
      1. В меню **Автостоп** нажмите ![image](../_assets/plus-sign.svg) **Автостоп** и введите описание:
          * **Тип автостопа 1** — выберите `QUANTILE`.
          * **Квантиль** — укажите `75`.
          * **Лимит времени ответов** — укажите `100ms`.
          * **Размер окна** — укажите `10s`.
      ...
      1. Укажите еще один автостоп:
          * **Тип автостопа 2** — выберите`INSTANCES`.
          * **Предел** — укажите `90%`.
