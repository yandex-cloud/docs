...
* Сервис {{ cloud-logging-name }}: объем записываемых данных и время их хранения ([тарифы {{ cloud-logging-name }}](../../logging/pricing.md)).
...
- С помощью Helm {#helm}
    ...
    1. Для установки [Helm-чарта](https://helm.sh/docs/topics/charts/) с Fluent Bit выполните команду:
        ...
        Актуальная версия Helm-чарта на [странице {{ marketplace-full-name }}](/marketplace/products/yc/fluent-bit).
