В этом руководстве вы развернете [Docker-образ](../../cloud-registry/concepts/docker.md) из [реестра](../../cloud-registry/concepts/registry.md) {{ cloud-registry-full-name }} и запустите контейнер на [виртуальной машине](../../compute/concepts/vm.md) {{ compute-full-name }}.
...
1. Удалите [Docker-образ](../../cloud-registry/concepts/docker.md) из реестра.
