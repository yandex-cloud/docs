...
Разверните [SFTP](https://ru.wikipedia.org/wiki/SFTP)-сервер в инфраструктуре {{ yandex-cloud }} и выполняйте резервное копирование конфигурационных файлов с SFTP-клиента на SFTP-сервер по расписанию.
