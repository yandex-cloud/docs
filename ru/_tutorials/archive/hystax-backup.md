...
1. [Сгенерируйте](../../compute/operations/vm-connect/ssh#creating-ssh-keys) пару {% if lang == "ru" and audience != "internal" %}[SSH-ключей](../../glossary/ssh-keygen.md){% else %}SSH-ключей{% endif %}. Они понадобятся при создании ВМ.
