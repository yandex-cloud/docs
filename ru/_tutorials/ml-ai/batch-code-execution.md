...
Если вы хотите развернуть сервис, который будет возвращать результаты по API, обратитесь к руководству [{#T}](../../datasphere/tutorials/node-from-docker-fast-api.md).
