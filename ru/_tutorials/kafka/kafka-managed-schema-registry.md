...
1. В той же сети, что и кластер {{ mkf-name }}, {% if audience != "internal" %}[создайте виртуальную машину](../../compute/operations/vm-create/create-linux-vm.md){% else %}создайте виртуальную машину{% endif %} с Ubuntu 20.04 и публичным IP-адресом.
...
1. {% if audience != "internal" %}[Подключитесь](../../compute/operations/vm-connect/ssh.md){% else %}Подключитесь{% endif %} к виртуальной машине по {% if lang == "ru" and audience != "internal" %}[SSH](../../glossary/ssh-keygen.md){% else %}SSH{% endif %}.
