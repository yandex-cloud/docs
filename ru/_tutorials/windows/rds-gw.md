...
1. Создайте подсеть в сети `rdgw-network`.
   ...
   {% list tabs group=instructions %}
    ...
    - Консоль управления {#console}
      ...
      1. [Перейдите](../../console/operations/select-service.md#select-service) в сервис **{{ ui-key.yacloud.iam.folder.dashboard.label_vpc }}** в каталоге, где требуется создать подсеть.
...
- Консоль управления {#console}
   ...
   1. [Перейдите](../../console/operations/select-service.md#select-service) в сервис **{{ ui-key.yacloud.iam.folder.dashboard.label_vpc }}** в каталоге, где требуется создать группу безопасности.
