...
* Виртуальная машина: использование вычислительных ресурсов, хранилища, публичного IP-адреса и операционной системы, если DNS-сервер развернут на ВМ ([тарифы {{ compute-name }}](../../compute/pricing.md)).
