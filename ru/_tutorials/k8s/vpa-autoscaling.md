...
{{ managed-k8s-name }} поддерживает несколько видов автоматического масштабирования. Из этой статьи вы узнаете, как настроить автоматическое управление ресурсами [пода](../../managed-kubernetes/concepts/index.md#pod) с помощью [{{ k8s-vpa }}](../../managed-kubernetes/concepts/autoscale.md#vpa):
