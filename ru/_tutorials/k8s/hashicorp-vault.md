...
Настройте хранение и доступ к секретам внутри кластера {{ managed-k8s-full-name }} с помощью продукта {{ marketplace-full-name }} [HashiCorp Vault с поддержкой {{ kms-full-name }}](/marketplace/products/yc/vault-yckms-k8s).
