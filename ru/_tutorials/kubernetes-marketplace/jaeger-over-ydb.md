...
1. [Установите kubectl]{% if lang == "ru" %}(https://kubernetes.io/ru/docs/tasks/tools/install-kubectl){% endif %}{% if lang == "en" %}(https://kubernetes.io/docs/tasks/tools/install-kubectl){% endif %} и [настройте его на работу с созданным кластером](../../managed-kubernetes/operations/kubernetes-cluster/kubernetes-cluster-get-credetials.md).

## Установите и настройте Jaeger {#jaeger-install}

1. [Установите продукт Jaeger over YDB](../../managed-kubernetes/operations/applications/jaeger.md#marketplace-install) из каталога приложений {{ marketplace-full-name }}. При установке приложения выберите [пространство имен](../../managed-kubernetes/concepts/index.md#namespace) по умолчанию (`default`).
...
1. [Удалите базу данных {{ ydb-name }}](../../ydb/db/cloud_console/create_manage_database.md#delete-db).
