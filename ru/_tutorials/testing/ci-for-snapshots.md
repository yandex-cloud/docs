...
Чтобы настроить непрерывную интеграцию ({% if lang == "ru" %}[Continuous Integration](/blog/posts/2022/10/ci-cd){% else %}Continuous Integration{% endif %}, CI) для [снимков дисков](../../compute/concepts/snapshot.md) ВМ:
