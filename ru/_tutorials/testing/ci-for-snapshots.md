...
Чтобы настроить непрерывную интеграцию ([Continuous Integration](https://cloud.yandex.ru/blog/posts/2022/10/ci-cd), CI) для [снимков дисков](../../compute/concepts/snapshot.md) ВМ:
...
1. [Подключитесь](../../compute/operations/vm-connect/ssh.md#vm-connect) к ВМ c {{ GL }} по SSH:
