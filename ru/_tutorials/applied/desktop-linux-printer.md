...
* Плата за использование вычислительных ресурсов, дисков и исходящий трафик рабочего стола ([тарифы {{ cloud-desktop-full-name }}](../../cloud-desktop/pricing.md)).
* Плата за время использования [NAT-шлюза](../../vpc/concepts/gateways.md) и исходящий через него трафик ([тарифы {{ vpc-full-name }}](../../vpc/pricing.md)).
