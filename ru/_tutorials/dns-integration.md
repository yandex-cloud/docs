...
1. Облачная сеть {{ yandex-cloud }} также состоит из двух подсетей:
   ...
   * `172.16.4.0/24`: subnet4, зона доступности `ru-central1-c`
...
1. Для установки ПО из интернета в подсетях `subnet3` и `subnet4` [включите NAT в интернет](../vpc/operations/enable-nat.md).
