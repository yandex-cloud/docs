...
Для выполнения нагрузочного тестирования можно воспользоваться сервисом [{{ load-testing-name }}](../../load-testing/). Подробнее о настройке нагрузки по протоколу HTTP смотрите в разделе [{#T}](../../load-testing/tutorials/loadtesting-https-phantom.md).
