...
В стоимость поддержки инфраструктуры входит плата за вычислительные ресурсы, операционную систему, хранилище, объем исходящего трафика и публичный IP-адрес ВМ ([тарифы {{ compute-full-name }}](../../compute/pricing.md)).
...
Подробные инструкции для пользователей по первому входу и работе с аккаунтом смотрите в разделе [{#T}](../../organization/operations/user-account/index.md).
...
Подробнее о первом входе для разных типов пользователей смотрите в инструкции [{#T}](../../organization/operations/user-account/first-login.md).
