...
* Плата за вычислительные ресурсы, диски и образы ВМ ([тарифы {{ compute-full-name }}](../../compute/pricing.md)).
* Плата за хранение данных в бакете и операции с ними ([тарифы {{ objstorage-full-name }}](../../storage/pricing.md)).
* Плата за публичный IP-адрес и исходящий трафик ([тарифы {{ vpc-full-name }}](../../vpc/pricing.md)).
