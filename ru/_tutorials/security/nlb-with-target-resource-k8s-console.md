...
1. Перейдите в L7-балансировщик:
    ...
    1. Перейдите на вкладку **{{ ui-key.yacloud.k8s.cluster.switch_network }}**, а затем — на вкладку **{{ ui-key.yacloud.k8s.network.label_ingress }}**. Для вашего `Ingress`-ресурса в столбце **Балансировщик** перейдите по ссылке на L7-балансировщик.
