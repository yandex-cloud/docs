...
При переносе данных с использованием {{ data-transfer-name }} оплачиваются следующие ресурсы:
...
При переносе данных при помощи дампа базы оплачиваются следующие ресурсы:
