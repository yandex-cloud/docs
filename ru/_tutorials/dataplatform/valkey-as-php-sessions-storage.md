...
* Кластер-приемник {{ mrd-name }}: использование выделенных хостам вычислительных ресурсов, объем хранилища и резервных копий ([тарифы {{ VLK }}](../../managed-valkey/pricing.md)).
