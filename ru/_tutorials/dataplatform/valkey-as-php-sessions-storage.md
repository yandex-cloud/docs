...
* Кластер-приемник {{ mrd-name }}: использование выделенных хостам вычислительных ресурсов, объем хранилища и резервных копий (см. [тарифы {{ VLK }}](../../managed-valkey/pricing.md)).
