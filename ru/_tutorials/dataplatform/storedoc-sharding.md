...
Оплачивается использование кластера {{ mmg-name }}: выделенные хостам вычислительные ресурсы, включая ресурсы дополнительных служебных хостов, а также объем хранилища и резервных копий (см. [тарифы {{ mmg-name }}](../../storedoc/pricing.md)).
