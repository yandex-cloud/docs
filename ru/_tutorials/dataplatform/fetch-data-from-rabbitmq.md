...
- С помощью {{ TF }}
    ...
    1. Укажите в файле `clickhouse-cluster-and-vm-for-rabbitmq.tf`:
        ...
        * Идентификатор публичного [образа](../../compute/operations/images-with-pre-installed-software/get-list.md) с Ubuntu без GPU для виртуальной машины. Например, `fd879gb88170to70d38a` для Ubuntu 20.04 LTS.
