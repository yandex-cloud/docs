...
* обойтись без создания промежуточной {% if lang == "ru" and audience != "internal" %}[виртуальной машины](../../glossary/vm.md){% else %}виртуальной машины{% endif %} или разрешения доступа к вашему кластеру-приемнику {{ mkf-name }} из интернета.
