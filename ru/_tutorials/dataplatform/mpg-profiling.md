...
Рекомендации по устранению проблем приведены в {% if audience != "internal" %}разделах [{#T}](../../managed-postgresql/concepts/storage.md#read-only-solutions) и [{#T}](../../managed-postgresql/concepts/storage.md#read-only-monitor){% else %}разделе [{#T}](../../managed-postgresql/concepts/storage.md#read-only-solutions){% endif %}.
