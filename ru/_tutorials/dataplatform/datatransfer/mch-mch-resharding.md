...
- {{ TF }} {#tf}
    ...
    1. Удалите конфигурационный файл `data-transfer-mch-mch-resharding.tf`.
    1. Проверьте корректность файлов конфигурации {{ TF }} с помощью команды:
    ...
    1. Подтвердите изменение ресурсов.
        ...
        Все ресурсы, которые были описаны в конфигурационном файле `data-transfer-mch-mch-resharding.tf`, будут удалены.
