...
Вы можете перенести продуктивную нагруженную базу данных, развернутую в кластере {{ mpg-name }}, в кластер со старшей версией. В этом руководстве рассматривается пример переноса с версии 14 сразу на версию 17, без последовательного переноса между несколькими версиями (14 → 15 → 16 → 17).
