...
1. Выберите созданный ранее трейл для загрузки аудитных логов облака в бакет и нажмите кнопку ![cube](../../_assets/console-icons/cube.svg) **{{ ui-key.yacloud.audit-trails.button_process-in-yq }}**.
