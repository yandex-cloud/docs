...
1. [Установите плагин](../../managed-opensearch/operations/plugins.md#update) `repository-s3` в кластер-приемник.
...
1. Убедитесь, что все нужные данные перенесены в кластер-приемник {{ mos-name }}.
    ...
    Это можно сделать, например, с помощью [{{ OS }} Dashboards](../../managed-opensearch/operations/connect.md#dashboards).
