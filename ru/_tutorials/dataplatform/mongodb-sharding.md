...
При [шардировании](../../glossary/sharding.md) кластера {{ mmg-name }} автоматически создаются служебные хосты, которые [тарифицируются](../../managed-mongodb/pricing.md) отдельно от основных хостов СУБД:
...
В стоимость поддержки описываемого решения входит плата за дополнительные служебные хосты кластера {{ mmg-name }} (см. [тарифы {{ MG }}](../../managed-mongodb/pricing.md)).
