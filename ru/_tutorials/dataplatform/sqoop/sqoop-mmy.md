...
* Плата за кластер {{ mmy-name }}: использование вычислительных ресурсов, выделенных хостам, и дискового пространства (см. [тарифы {{ MY }}](../../../managed-mysql/pricing.md)).
...
* Плата за публичные IP-адреса, если для ВМ или хостов кластера включен публичный доступ (см. [тарифы {{ vpc-name }}](../../../vpc/pricing.md)).
