...
Вы можете отслеживать изменения данных в _кластере-источнике_ {{ mpg-full-name }} и отправлять их в _кластер-приемник_ {{ mkf-full-name }} с помощью технологии Change Data Capture (CDC).
