...
Оба способа подойдут в том числе для [миграции кластера](../../managed-kafka/operations/host-migration.md#one-host) {{ mkf-name }} с одним хостом в другую [зону доступности](../../overview/concepts/geo-scope.md).
