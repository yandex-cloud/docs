...
1. Восстановите резервные копии баз данных в стороннем кластере {{ MS }}, воспользовавшись [документацией {{ MS }}]({{ ms.docs }}/sql/relational-databases/backup-restore/quickstart-backup-restore-database?view=sql-server-ver16#restore-a-backup).
