...
Подробнее о Kafka Connect смотрите в документации [{{ KF }}](https://kafka.apache.org/42/kafka-connect/overview/).
...
* Плата за ВМ: использование вычислительных ресурсов, хранилища и публичного IP-адреса ([тарифы {{ compute-name }}](../../compute/pricing.md)).
