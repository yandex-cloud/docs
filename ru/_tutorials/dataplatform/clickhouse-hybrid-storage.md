...
* Плата за использование публичных IP-адресов, если для хостов кластера включен публичный доступ ([тарифы {{ vpc-name }}](../../vpc/pricing.md)).
...
Подробнее о настройке TTL смотрите в [документации {{ CH }}]({{ ch.docs }}{{ lang }}/engines/table-engines/mergetree-family/mergetree#table_engine-mergetree-ttl).
...
Подробнее в [документации {{ CH }}]({{ ch.docs }}{{ lang }}/getting-started/example-datasets/star-schema#import-data).
