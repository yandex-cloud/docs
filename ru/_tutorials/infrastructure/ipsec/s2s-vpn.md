...
* Плата за использование статического внешнего IP-адреса ([тарифы {{ vpc-full-name }}](../../../vpc/pricing.md)).
* Плата за исходящий трафик ([тарифы {{ vpc-full-name }}](../../../vpc/pricing.md))
