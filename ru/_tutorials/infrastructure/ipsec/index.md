...
* Таблица маршрутизации со статическими маршрутами `cloud-net-rt` обеспечивает передачу трафика в направлении подсети `subnet-1` удаленной пплощадки через основной IPsec-шлюз.
