...
- Консоль управления {#console}
  ...
  1. В [консоли управления]({{ link-console-main }}) выберите каталог, в котором нужно создать группу.
...
1. В меню слева откройте раздел **Сеть** ⟶ **Интерфейсы**.
...
1. Откройте вкладку **Назначение** и отключите зону `Untrusted`.
