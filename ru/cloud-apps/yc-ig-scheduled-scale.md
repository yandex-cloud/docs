...
1. Укажите:
    ...
    * Расписание в формате [cron-выражения](../functions/concepts/trigger/timer.md#cron-expression), по которому размер группы ВМ будет меняться на базовый.
    * Базовый размер группы ВМ.
    * Расписание в формате [cron-выражения](../functions/concepts/trigger/timer.md#cron-expression), по которому размер группы ВМ будет меняться на увеличенный.
