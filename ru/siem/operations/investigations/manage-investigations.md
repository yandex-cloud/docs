---
title: Управление расследованиями в {{ yandex-siem-full-name }}
description: Следуя данной инструкции, вы научитесь создавать, изменять, копировать и удалять расследования в {{ yandex-siem-full-name }}.
---
