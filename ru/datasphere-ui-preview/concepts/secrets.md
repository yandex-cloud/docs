...
После создания секрет доступен для проекта. Администратор сообщества может [поделиться](../operations/data/secret.md#share) секретом с другими проектами сообщества, открыв к нему доступ на вкладке **Доступ** на странице просмотра секрета. Секрет, доступный для сообщества, появится на странице сообщества в разделе **Ресурсы**.

#### Что дальше? {#what-is-next}

* [Как создать, изменить, копировать и удалить секрет](../operations/data/secret.md).