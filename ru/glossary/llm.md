...
Чтобы подробнее ознакомиться с примерами использования LLM, см. [Библиотека промптов {{ yagpt-name }}](../ai-studio/prompts/yandexgpt/index.md).
...
Для продвинутой работы с запросами к большим языковым моделям вы также можете изучить [Руководство по проектированию промптов](../ai-studio/gpt-prompting-guide/about.md).
