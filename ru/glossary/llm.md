...
Чтобы подробнее ознакомиться с примерами использования LLM, смотрите [Библиотека промптов {{ yagpt-name }}]({{ link-docs-ai }}ai-studio/concepts/generation/index#yandex).
...
* [{{ ml-platform-full-name }}](/services/datasphere/) — сервис, позволяющий создавать новые модели, а также дообучать фундаментальные, чтобы они точнее отвечали на ваши запросы. Подробнее в [документации](../datasphere/).
