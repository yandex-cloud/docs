...
В сервисе [{{ speechkit-full-name }}](../speechkit/overview.md) используется технология транскрибации, которая позволяет преобразовать аудиоинформацию в текст.
...
Сервис [{{ speechkit-full-name }}](../speechkit/overview.md) предоставляет доступ к потоковому, синхронному и асинхронному [распознаванию речи](../speechkit/stt/index.md) высокой точности.
