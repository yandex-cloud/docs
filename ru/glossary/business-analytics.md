...
Одним из таких инструментов, которым активно пользуется бизнес, является сервис [{{ datalens-full-name }}]({{ link-datalens-main-promo }}). С его помощью можно подключаться к различным источникам данных, строить графики и диаграммы, создавать дашборды и делиться полученными результатами.
...
Подробнее в [документации](../datalens/).
