...
Одним из таких инструментов, которым активно пользуется бизнес, является сервис [{{ datalens-full-name }}](https://datalens.yandex.ru/). С его помощью можно подключаться к различным источникам данных, строить графики и диаграммы, создавать дашборды и делиться полученными результатами.
...
[Зарегистрируйтесь](https://console.cloud.yandex.ru/) в {{ yandex-cloud }} и начните пользоваться {{ datalens-name }} уже сегодня.
