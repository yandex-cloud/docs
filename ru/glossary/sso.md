...
* Поставщик удостоверений (Identity Provider) — {{ org-full-name }} предоставляет доступ к внешним сервисам через [SAML-приложения](../organization/concepts/applications.md#saml) и [OIDC-приложения](../organization/concepts/applications.md#oidc).

Подробнее см. в [документации {{ org-full-name }}](../organization/concepts/add-federation.md).
