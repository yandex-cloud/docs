...
* Поставщик удостоверений (Identity Provider) — {{ org-full-name }} предоставляет доступ к внешним сервисам через [SAML-приложения](../organization/concepts/applications/saml.md) и [OIDC-приложения](../organization/concepts/applications/oidc.md).
