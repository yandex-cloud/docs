---
title: "Протокол MQTT и MQTT-сервер: особенности коммуникации"
description: "MQTT — это протокол обмена данными между издателями и подписчиками, который разработали в 1999 году специально для интернета вещей. В основе MQTT лежит идея пересылки небольших сообщений, например показаний датчиков, между устройствами."
---
