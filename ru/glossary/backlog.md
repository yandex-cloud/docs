...
Разработка бэклога в контексте [Agile-проекта](../tracker/manager/agile) делится на две популярные [методологии — _Scrum_ и _Kanban_](https://cloud.yandex.ru/blog/posts/2023/02/scrum-or-kanban). У каждой из них есть свои особенности, поэтому при выборе надо учитывать потребности проекта и предпочтения команды.
