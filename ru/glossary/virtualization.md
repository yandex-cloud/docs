...
[Зарегистрируйтесь](https://console.cloud.yandex.ru/) на платформе {{ yandex-cloud }} и начните пользоваться ее возможностями уже сегодня.

Полезные ресурсы {{ yandex-cloud }}:
* [Обзор платформы](../overview)
* [Блог](https://cloud.yandex.ru/blog)
* [Документация](../)
