...
* [{{ foundation-models-full-name }}](/services/ai-studio/) предоставляет возможность подключать к своим корпоративным системам внешние MCP-серверы или создавать собственные, чтобы переложить на AI-агента часть бизнес-процессов и рабочих сценариев. Подробнее см. в [документации]({{ link-docs-ai }}ai-studio/).
