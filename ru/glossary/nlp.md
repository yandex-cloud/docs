...
* [{{ translate-full-name }}](/services/translate/) — сервис для интеграции алгоритмов Яндекс Переводчика в пользовательские приложения или веб-проекты. Подробнее в [документации]({{ link-docs-ai }}translate/concepts/).
* [{{ ml-platform-full-name }}](/services/datasphere/) — полноценный инструмент для разработки и эксплуатации собственных моделей, а также дообучения фундаментальных моделей. Подробнее в [документации](../datasphere/).
