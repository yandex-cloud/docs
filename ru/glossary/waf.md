...
1. [WAF в {{ sws-full-name }}](/services/smartwebsecurity/) — межсетевой экран, предоставляющий набор базовых правил [OWASP Core Rule Set](https://coreruleset.org/) для защиты веб-приложений. Подробнее в [документации](../smartwebsecurity/concepts/waf.md).
