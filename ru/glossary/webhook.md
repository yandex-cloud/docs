...
* [{{ src-full-name }}](/services/sourcecraft/) — платформа от Яндекса для разработки IT-продуктов в режиме непрерывной интеграции. Подробнее см. в [документации](../sourcecraft/).
* [{{ sf-full-name }}](/services/serverless-functions/) — сервис для создания и управления функциями, которые можно использовать в качестве вебхуков. Подробнее см. в [документации](../functions).
