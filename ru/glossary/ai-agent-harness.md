---
title: 'AI Agent Harness: программная обвязка для ИИ-агентов'
description: 'AI Agent Harness — программная обвязка, которая организует работу ИИ-агента: передает модели инструкции и контекст, выполняет вызовы инструментов, управляет состоянием и обеспечивает безопасность выполнения задач.'
keywords:
  - AI Agent Harness
  - Agent Harness
  - Scaffolding
  - Инфраструктура для агентов ИИ
  - Инфраструктура для агентов AI
  - Обвязка ИИ-агента
  - Программная обвязка агента
---
...
[{{ src-full-name }}]({{ link-src-main }}) — платформа для разработки со встроенным [ИИ-ассистентом]({{ link-src-docs }}/sourcecraft/code-assistant/overview). {{ ca-short-name }} использует принципы agent harness для помощи разработчикам: анализирует код, предлагает исправления, генерирует документацию и выполняет другие задачи, взаимодействуя с репозиторием через контролируемый интерфейс.

{{ ca-full-name }} доступен в двух вариантах:

* {{ src-name }} CLI — интерфейс командной строки для работы с платформой SourceCraft, включающий harness OpenCode с настроенным доступом к моделям {{ ca-short-name }} и инструментам платформы.
...
Подробнее в [документации]({{ link-src-docs }}).

### {{ ai-studio-full-name }}

[{{ ai-studio-full-name }}](/services/ai-studio/) — платформа для работы с генеративным ИИ. Предоставляет средства для создания собственных агентов:

* [{{ agents-atelier-name }}]({{ link-docs-ai }}ai-studio/concepts/agents/) — позволяет создавать, тестировать и публиковать текстовых ИИ-агентов в интерфейсе {{ ai-studio-name }}.
* [{{ responses-api }}]({{ link-docs-ai }}ai-studio/api/Responses/) — API для управления многошаговыми диалогами и сессиями.
* [MCP Hub]({{ link-docs-ai }}ai-studio/concepts/mcp-hub/) — функциональность для создания и управления [MCP](mcp.md)-серверами.

Подробнее в [документации]({{ link-docs-ai }}).
...
* [Документация {{ ca-full-name }}]({{ link-src-docs }}/sourcecraft/code-assistant/)
