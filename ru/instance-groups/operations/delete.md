...
1. Удалите группу виртуальных машин:
    ...
    [!KEYREF instance-groups-name] запустит операцию удаления группы виртуальных машин.

**[!TAB API]**

Воспользуйтесь методом API [delete](../../instance-groups/api-ref/InstanceGroup/delete.md).
