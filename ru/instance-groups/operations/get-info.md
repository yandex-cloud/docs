...
Пользовательские [метаданные](../../compute/concepts/vm-metadata.md), которые были переданы при создании или изменении группы, можно получить только с помощью CLI или API.
...
Воспользуйтесь методом API [get](../../instance-groups/api-ref/InstanceGroup/get.md).
