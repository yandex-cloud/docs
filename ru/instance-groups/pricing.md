...
Использование компонента [!KEYREF instance-groups-name] не тарифицируется. Вы можете создавать группы виртуальных машин, пользоваться хранилищем и вычислительными ресурсами в рамках [доступных лимитов](concepts/limits.md).
