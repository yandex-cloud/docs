...
|`--certificates`|<b>`shorthand/json`</b><br/>Broker certificates.<br/><br/>Example:<br/>--certificates [{certificate-data=value}]<br/><br/>Shorthand Syntax:<br/>[{certificate-data=str},...]<br/>Fields:<br/>certificate-data  string  — Public part of the broker certificate.<br/>|
|`--description`|<b>`string`</b><br/>Description of the broker.|
|`--folder-id`|<b>`string`</b><br/>ID of the folder to create a broker in.<br/><br/>To get a folder ID, make a [yandex.cloud.resourcemanager.v1.FolderService.List] request.|
...
|`--password`|<b>`string`</b><br/>Broker passwords.<br/><br/>The password must contain at least three character categories among the following: upper case latin, lower case latin, numbers and special symbols.|
