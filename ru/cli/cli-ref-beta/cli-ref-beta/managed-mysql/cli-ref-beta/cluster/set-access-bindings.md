...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-mysql/cli-ref-beta/cluster/set-access-bindings.md
---

# yc beta managed-mysql cluster set-access-bindings
...
`yc beta managed-mysql cluster set-access-bindings <RESOURCE-ID>`
