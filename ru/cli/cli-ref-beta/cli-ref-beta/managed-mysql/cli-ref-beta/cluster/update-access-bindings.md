...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-mysql/cli-ref-beta/cluster/update-access-bindings.md
---

# yc beta managed-mysql cluster update-access-bindings
...
`yc beta managed-mysql cluster update-access-bindings <RESOURCE-ID>`
