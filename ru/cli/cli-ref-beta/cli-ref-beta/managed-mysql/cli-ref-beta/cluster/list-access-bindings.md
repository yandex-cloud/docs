...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-mysql/cli-ref-beta/cluster/list-access-bindings.md
---

# yc beta managed-mysql cluster list-access-bindings
...
`yc beta managed-mysql cluster list-access-bindings <RESOURCE-ID>`
