...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-mysql/cli-ref-beta/cluster/update.md
---

# yc beta managed-mysql cluster update
...
`yc beta managed-mysql cluster update <CLUSTER-ID>`
