...
|`--cluster-id`|<b>`string`</b><br/>ID of the cluster to grant permission to the user in.<br/><br/>To get this ID, make a [ClusterService.List] request.|
...
|`--user-name`|<b>`string`</b><br/>Name of the user to grant permission to.<br/><br/>To get this name, make a [UserService.List] request.|
