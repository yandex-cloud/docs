...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/storage/cli-ref-beta/s3api/list-parts.md
---

# yc beta storage s3api list-parts
...
`yc beta storage s3api list-parts [Flags...] [Global Flags...]`
