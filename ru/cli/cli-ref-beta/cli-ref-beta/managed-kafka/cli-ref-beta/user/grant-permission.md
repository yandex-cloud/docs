...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-kafka/cli-ref-beta/user/grant-permission.md
---
...
|`--user-name`|<b>`string`</b><br/>Name of the user to grant the permission to.<br/><br/>To get the name of the user, make a [UserService.List] request.|
