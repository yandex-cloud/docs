...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-kafka/cli-ref-beta/user/update.md
---

# yc beta managed-kafka user update
...
`yc beta managed-kafka user update <CLUSTER-ID>`
