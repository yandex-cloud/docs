...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/logging/cli-ref-beta/export/set-access-bindings.md
---

# yc beta logging export set-access-bindings
...
`yc beta logging export set-access-bindings <RESOURCE-ID>`
