...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/logging/cli-ref-beta/export/list-access-bindings.md
---

# yc beta logging export list-access-bindings
...
`yc beta logging export list-access-bindings <RESOURCE-ID>`
