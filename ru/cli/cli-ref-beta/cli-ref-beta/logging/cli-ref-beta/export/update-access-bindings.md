...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/logging/cli-ref-beta/export/update-access-bindings.md
---

# yc beta logging export update-access-bindings
...
`yc beta logging export update-access-bindings <RESOURCE-ID>`
