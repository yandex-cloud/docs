...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/logging/cli-ref-beta/sink/set-access-bindings.md
---

# yc beta logging sink set-access-bindings
...
`yc beta logging sink set-access-bindings <RESOURCE-ID>`
