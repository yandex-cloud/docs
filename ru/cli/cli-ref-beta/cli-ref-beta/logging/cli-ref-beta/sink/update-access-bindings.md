...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/logging/cli-ref-beta/sink/update-access-bindings.md
---

# yc beta logging sink update-access-bindings
...
`yc beta logging sink update-access-bindings <RESOURCE-ID>`
