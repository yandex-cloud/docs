...
| Flag | Description |
|----|----|
|`--folder-id`|<b>`string`</b><br/>ID of the folder that the captcha belongs to.<br/>Currently page_size, page_token, filter and order_by are not supported and List method will return all captchas in the folder.|
