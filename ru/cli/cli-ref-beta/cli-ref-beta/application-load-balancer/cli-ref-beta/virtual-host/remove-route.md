...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/application-load-balancer/cli-ref-beta/virtual-host/remove-route.md
---

# yc beta application-load-balancer virtual-host remove-route
...
`yc beta application-load-balancer virtual-host remove-route <HTTP-ROUTER-ID>`
