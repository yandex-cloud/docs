...
|`--policy-ids`|<b>`strings`</b><br/>policy_ids param accepts policy ids or policy names<br/>to apply after instance registration in backup service<br/>this param is used only in internal registration script|
