...
|`--cluster-id`|<b>`string`</b><br/>ID of the MongoDB cluster to add hosts to.<br/>To get the MongoDB cluster ID use a [ClusterService.List] request.|
|`--host-specs`|<b>`shorthand/json`</b><br/>Configurations for MongoDB hosts that should be added to the cluster.<br/><br/>Example:|
