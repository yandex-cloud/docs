...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-mongodb/cli-ref-beta/cluster/list-operations.md
---

# yc beta managed-mongodb cluster list-operations
...
`yc beta managed-mongodb cluster list-operations <CLUSTER-ID>`
