...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-mongodb/cli-ref-beta/cluster/set-access-bindings.md
---

# yc beta managed-mongodb cluster set-access-bindings
...
`yc beta managed-mongodb cluster set-access-bindings <RESOURCE-ID>`
