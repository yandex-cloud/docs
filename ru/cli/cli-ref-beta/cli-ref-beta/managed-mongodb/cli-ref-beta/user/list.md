...
| Flag | Description |
|----|----|
|`--cluster-id`|<b>`string`</b><br/>ID of the cluster to list MongoDB users in.<br/>To get the cluster ID, use a [ClusterService.List] request.|
...
|`--page-token`|<b>`string`</b><br/>Page token. To get the next page of results, set [page_token] to the<br/>[ListUsersResponse.next_page_token] returned by the previous list request.|
