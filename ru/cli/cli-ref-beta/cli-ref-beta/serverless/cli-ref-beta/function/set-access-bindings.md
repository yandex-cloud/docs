...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/function/set-access-bindings.md
---

# yc beta serverless function set-access-bindings
...
`yc beta serverless function set-access-bindings <RESOURCE-ID>`
