...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/workflow/set-access-bindings.md
---

# yc beta serverless workflow set-access-bindings
...
`yc beta serverless workflow set-access-bindings <RESOURCE-ID>`
