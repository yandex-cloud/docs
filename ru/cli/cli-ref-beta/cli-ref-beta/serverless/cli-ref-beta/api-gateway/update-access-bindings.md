...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/api-gateway/update-access-bindings.md
---

# yc beta serverless api-gateway update-access-bindings
...
`yc beta serverless api-gateway update-access-bindings <RESOURCE-ID>`
