...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/mcp-gateway/list.md
---

# yc beta serverless mcp-gateway list
...
`yc beta serverless mcp-gateway list <FOLDER-ID>`
