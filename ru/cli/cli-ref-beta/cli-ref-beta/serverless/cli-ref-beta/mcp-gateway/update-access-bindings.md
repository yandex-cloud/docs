...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/mcp-gateway/update-access-bindings.md
---

# yc beta serverless mcp-gateway update-access-bindings
...
`yc beta serverless mcp-gateway update-access-bindings <RESOURCE-ID>`
