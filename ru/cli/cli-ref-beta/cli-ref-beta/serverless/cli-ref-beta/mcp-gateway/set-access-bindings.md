...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/mcp-gateway/set-access-bindings.md
---

# yc beta serverless mcp-gateway set-access-bindings
...
`yc beta serverless mcp-gateway set-access-bindings <RESOURCE-ID>`
