...
|`--log-options`|<b>`shorthand/json`</b><br/>Updated logging options for the MCP Gateway.<br/><br/>Example:|
...
|`--tools`|<b>`shorthand/json`</b><br/>Updated list of MCP tools associated with the gateway.<br/><br/>Example:|
