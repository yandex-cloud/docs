...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/eventrouter/connector/update-access-bindings.md
---

# yc beta serverless eventrouter connector update-access-bindings
...
`yc beta serverless eventrouter connector update-access-bindings <RESOURCE-ID>`
