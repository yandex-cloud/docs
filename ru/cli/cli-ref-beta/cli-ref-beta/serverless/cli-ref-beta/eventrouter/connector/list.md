...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/eventrouter/connector/list.md
---
...
|`--bus-id`|<b>`string`</b><br/>ID of the bus to list connectors in.|
|`--folder-id`|<b>`string`</b><br/>ID of the folder to list connectors in.|
