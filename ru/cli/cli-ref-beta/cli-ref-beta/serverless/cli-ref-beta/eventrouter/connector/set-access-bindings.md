...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/eventrouter/connector/set-access-bindings.md
---

# yc beta serverless eventrouter connector set-access-bindings
...
`yc beta serverless eventrouter connector set-access-bindings <RESOURCE-ID>`
