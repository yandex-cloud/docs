...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/eventrouter/rule/update-access-bindings.md
---

# yc beta serverless eventrouter rule update-access-bindings
...
`yc beta serverless eventrouter rule update-access-bindings <RESOURCE-ID>`
