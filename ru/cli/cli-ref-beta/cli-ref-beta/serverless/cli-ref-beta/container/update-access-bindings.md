...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/container/update-access-bindings.md
---

# yc beta serverless container update-access-bindings
...
`yc beta serverless container update-access-bindings <RESOURCE-ID>`
