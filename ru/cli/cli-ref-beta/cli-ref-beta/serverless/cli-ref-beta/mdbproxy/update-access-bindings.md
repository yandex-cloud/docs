...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/mdbproxy/update-access-bindings.md
---

# yc beta serverless mdbproxy update-access-bindings
...
`yc beta serverless mdbproxy update-access-bindings <RESOURCE-ID>`
