...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-greenplum/cli-ref-beta/cluster/expand.md
---

# yc beta managed-greenplum cluster expand
...
`yc beta managed-greenplum cluster expand <CLUSTER-ID>`
...
|`--segment-host-count`|<b>`int`</b><br/>Number of hosts for add to the segment subcluster|
