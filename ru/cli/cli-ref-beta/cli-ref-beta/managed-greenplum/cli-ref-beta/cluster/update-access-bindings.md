...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-greenplum/cli-ref-beta/cluster/update-access-bindings.md
---

# yc beta managed-greenplum cluster update-access-bindings
...
`yc beta managed-greenplum cluster update-access-bindings <RESOURCE-ID>`
