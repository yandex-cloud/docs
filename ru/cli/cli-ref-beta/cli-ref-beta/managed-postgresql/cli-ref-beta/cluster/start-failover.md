...
`yc beta managed-postgresql cluster start-failover <CLUSTER-ID>`
...
|`--cluster-id`|<b>`string`</b><br/>ID of PostgreSQL cluster.|
|`--host-name`|<b>`string`</b><br/>New master host. Switch to the most up-to-date replica if not provided.|
