...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-postgresql/cli-ref-beta/cluster/set-access-bindings.md
---

# yc beta managed-postgresql cluster set-access-bindings
...
`yc beta managed-postgresql cluster set-access-bindings <RESOURCE-ID>`
