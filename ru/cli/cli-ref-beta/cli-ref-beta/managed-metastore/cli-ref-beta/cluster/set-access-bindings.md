...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-metastore/cli-ref-beta/cluster/set-access-bindings.md
---

# yc beta managed-metastore cluster set-access-bindings
...
`yc beta managed-metastore cluster set-access-bindings <RESOURCE-ID>`
