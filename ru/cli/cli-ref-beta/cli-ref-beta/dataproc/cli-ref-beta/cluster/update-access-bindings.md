...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/dataproc/cli-ref-beta/cluster/update-access-bindings.md
---

# yc beta dataproc cluster update-access-bindings
...
`yc beta dataproc cluster update-access-bindings <RESOURCE-ID>`
