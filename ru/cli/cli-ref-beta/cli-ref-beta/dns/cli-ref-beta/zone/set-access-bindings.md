...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/dns/cli-ref-beta/zone/set-access-bindings.md
---

# yc beta dns zone set-access-bindings
...
`yc beta dns zone set-access-bindings <RESOURCE-ID>`
