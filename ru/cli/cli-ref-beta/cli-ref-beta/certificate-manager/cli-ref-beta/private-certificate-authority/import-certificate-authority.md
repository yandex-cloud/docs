...
PEM-encoded certificate content for the Certificate Authority. ||
...
PEM-encoded key pair content for the CA (private key). ||
|| `--name` | `string`

The name of the imported Certificate Authority. ||
|| `--passphrase` | `string`
