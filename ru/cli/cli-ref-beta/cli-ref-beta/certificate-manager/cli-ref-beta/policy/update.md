...
|`--san-policy`|<b>`shorthand/json`</b><br/>New policy for the subject alternative name (SAN) field of the certificate.<br/><br/>Example:|
...
|`--subject-policy`|<b>`shorthand/json`</b><br/>New policy for the subject field of the certificate.<br/><br/>Example:|
