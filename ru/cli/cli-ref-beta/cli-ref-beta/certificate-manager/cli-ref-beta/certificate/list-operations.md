...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/certificate-manager/cli-ref-beta/certificate/list-operations.md
---

# yc beta certificate-manager certificate list-operations
...
`yc beta certificate-manager certificate list-operations <CERTIFICATE-ID>`
