...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/certificate-manager/cli-ref-beta/certificate/update-access-bindings.md
---

# yc beta certificate-manager certificate update-access-bindings
...
`yc beta certificate-manager certificate update-access-bindings <RESOURCE-ID>`
