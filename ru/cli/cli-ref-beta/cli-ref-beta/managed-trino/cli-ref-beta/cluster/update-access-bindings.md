...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-trino/cli-ref-beta/cluster/update-access-bindings.md
---

# yc beta managed-trino cluster update-access-bindings
...
`yc beta managed-trino cluster update-access-bindings <RESOURCE-ID>`
