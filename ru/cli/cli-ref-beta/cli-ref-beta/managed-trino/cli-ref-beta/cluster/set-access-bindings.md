...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-trino/cli-ref-beta/cluster/set-access-bindings.md
---

# yc beta managed-trino cluster set-access-bindings
...
`yc beta managed-trino cluster set-access-bindings <RESOURCE-ID>`
