...
|`--filtering-policy`|<b>`shorthand/json`</b><br/>Event filtering policy of the trail<br/><br/>Example:|
...
|`--labels`|<b>`stringToString`</b><br/>Custom labels for the secret as 'key:value' pairs. Maximum 64 per key.<br/>For example, '"type": "critical"' or '"source": "dictionary"'.|
