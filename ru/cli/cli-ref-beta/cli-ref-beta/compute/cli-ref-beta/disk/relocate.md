...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/disk/relocate.md
---

# yc beta compute disk relocate
...
`yc beta compute disk relocate <DISK-ID>`
...
ID of the availability zone to move the disk to. To get the zone ID, make a [ZoneService.List] request. ||
|| `--disk-id` | `string`

ID of the disk to move. To get the disk ID, make a [DiskService.List] request. ||
