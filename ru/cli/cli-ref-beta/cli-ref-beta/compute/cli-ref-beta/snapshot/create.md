...
|`--disk-id`|<b>`string`</b><br/>ID of the disk to create the snapshot from.<br/>To get the disk ID use a [yandex.cloud.compute.v1.DiskService.List] request.|
|`--folder-id`|<b>`string`</b><br/>ID of the folder to create a snapshot in.<br/>To get the folder ID use a [yandex.cloud.resourcemanager.v1.FolderService.List] request.|
