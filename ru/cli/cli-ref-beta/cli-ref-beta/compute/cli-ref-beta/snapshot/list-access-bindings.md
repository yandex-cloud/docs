...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/snapshot/list-access-bindings.md
---

# yc beta compute snapshot list-access-bindings
...
`yc beta compute snapshot list-access-bindings <RESOURCE-ID>`
