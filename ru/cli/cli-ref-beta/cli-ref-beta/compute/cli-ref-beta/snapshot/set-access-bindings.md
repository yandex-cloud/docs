...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/snapshot/set-access-bindings.md
---

# yc beta compute snapshot set-access-bindings
...
`yc beta compute snapshot set-access-bindings <RESOURCE-ID>`
