...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/image/update-access-bindings.md
---

# yc beta compute image update-access-bindings
...
`yc beta compute image update-access-bindings <RESOURCE-ID>`
