...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/image/set-access-bindings.md
---

# yc beta compute image set-access-bindings
...
`yc beta compute image set-access-bindings <RESOURCE-ID>`
