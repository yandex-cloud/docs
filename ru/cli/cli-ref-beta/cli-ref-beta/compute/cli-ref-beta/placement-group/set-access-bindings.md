...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/placement-group/set-access-bindings.md
---

# yc beta compute placement-group set-access-bindings
...
`yc beta compute placement-group set-access-bindings <RESOURCE-ID>`
