...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/gpu-cluster/list.md
---

# yc beta compute gpu-cluster list
...
`yc beta compute gpu-cluster list <FOLDER-ID>`
...
A sorting expression that sorts GPU clusters listed in the response. The expression must specify the field name from [GpuCluster] and 'asc'ending or 'desc'ending order, e.g. 'createdAt desc'. Default value: 'id asc'. ||
|| `--page-size` | `int`
