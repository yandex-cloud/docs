...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/gpu-cluster/set-access-bindings.md
---

# yc beta compute gpu-cluster set-access-bindings
...
`yc beta compute gpu-cluster set-access-bindings <RESOURCE-ID>`
