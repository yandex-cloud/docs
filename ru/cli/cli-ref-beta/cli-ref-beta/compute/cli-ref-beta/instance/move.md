...
`yc beta compute instance move <INSTANCE-ID>`
...
ID of the folder to move the instance to. To get the folder ID, make a [yandex.cloud.resourcemanager.v1.FolderService.List] request. ||
|| `--instance-id` | `string`
