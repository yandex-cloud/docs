...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/instance/update-access-bindings.md
---

# yc beta compute instance update-access-bindings
...
`yc beta compute instance update-access-bindings <RESOURCE-ID>`
