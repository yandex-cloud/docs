...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/iam/cli-ref-beta/service-account/set-access-bindings.md
---

# yc beta iam service-account set-access-bindings
...
`yc beta iam service-account set-access-bindings <RESOURCE-ID>`
