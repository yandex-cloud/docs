...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/iam/cli-ref-beta/service-account/list-access-bindings.md
---

# yc beta iam service-account list-access-bindings
...
`yc beta iam service-account list-access-bindings <RESOURCE-ID>`
