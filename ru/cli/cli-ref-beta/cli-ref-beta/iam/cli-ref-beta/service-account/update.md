...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/iam/cli-ref-beta/service-account/update.md
---

# yc beta iam service-account update
...
`yc beta iam service-account update <SERVICE-ACCOUNT-ID>`
