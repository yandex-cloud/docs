...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/iam/cli-ref-beta/key/create.md
---

# yc beta iam key create
...
`yc beta iam key create <SERVICE-ACCOUNT-ID>`
...
An algorithm used to generate a key pair of the Key resource. Possible Values: 'rsa-2048', 'rsa-4096' ||
