...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/iam/cli-ref-beta/workload-identity/oidc/federation/set-access-bindings.md
---

# yc beta iam workload-identity oidc federation set-access-bindings
...
`yc beta iam workload-identity oidc federation set-access-bindings <RESOURCE-ID>`
