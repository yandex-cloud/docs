...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/iam/cli-ref-beta/workload-identity/oidc/federation/update-access-bindings.md
---

# yc beta iam workload-identity oidc federation update-access-bindings
...
`yc beta iam workload-identity oidc federation update-access-bindings <RESOURCE-ID>`
