...
|`--resource`|<b>`shorthand/json`</b><br/>Resource container to disable a service in.<br/><br/>It is supported only resource-manager.cloud resource container now.<br/><br/>Example:|
