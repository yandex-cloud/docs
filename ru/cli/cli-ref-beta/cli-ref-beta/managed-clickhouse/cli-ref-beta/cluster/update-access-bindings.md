...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-clickhouse/cli-ref-beta/cluster/update-access-bindings.md
---

# yc beta managed-clickhouse cluster update-access-bindings
...
`yc beta managed-clickhouse cluster update-access-bindings <RESOURCE-ID>`
