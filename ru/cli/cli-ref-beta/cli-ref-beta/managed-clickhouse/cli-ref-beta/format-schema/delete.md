...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-clickhouse/cli-ref-beta/format-schema/delete.md
---

# yc beta managed-clickhouse format-schema delete
...
`yc beta managed-clickhouse format-schema delete <CLUSTER-ID>`
