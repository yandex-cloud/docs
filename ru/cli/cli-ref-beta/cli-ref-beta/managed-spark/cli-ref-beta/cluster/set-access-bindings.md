...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-spark/cli-ref-beta/cluster/set-access-bindings.md
---

# yc beta managed-spark cluster set-access-bindings
...
`yc beta managed-spark cluster set-access-bindings <RESOURCE-ID>`
