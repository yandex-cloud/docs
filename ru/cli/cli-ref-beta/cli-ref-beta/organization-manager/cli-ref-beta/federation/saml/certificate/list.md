...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/organization-manager/cli-ref-beta/federation/saml/certificate/list.md
---

# yc beta organization-manager federation saml certificate list
...
`yc beta organization-manager federation saml certificate list <FEDERATION-ID>`
