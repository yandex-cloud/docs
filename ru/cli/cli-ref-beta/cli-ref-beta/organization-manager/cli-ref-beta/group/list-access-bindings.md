...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/organization-manager/cli-ref-beta/group/list-access-bindings.md
---

# yc beta organization-manager group list-access-bindings
...
`yc beta organization-manager group list-access-bindings <RESOURCE-ID>`
