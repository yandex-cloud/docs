...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/organization-manager/cli-ref-beta/group/update-access-bindings.md
---

# yc beta organization-manager group update-access-bindings
...
`yc beta organization-manager group update-access-bindings <RESOURCE-ID>`
