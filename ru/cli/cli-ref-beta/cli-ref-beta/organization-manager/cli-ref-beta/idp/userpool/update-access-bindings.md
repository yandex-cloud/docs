...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/organization-manager/cli-ref-beta/idp/userpool/update-access-bindings.md
---

# yc beta organization-manager idp userpool update-access-bindings
...
`yc beta organization-manager idp userpool update-access-bindings <RESOURCE-ID>`
