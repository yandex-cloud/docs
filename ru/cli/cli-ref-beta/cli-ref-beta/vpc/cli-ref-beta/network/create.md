...
|`--folder-id`|<b>`string`</b><br/>ID of the folder for this request to create a network in.<br/>To get the folder ID, use a [yandex.cloud.resourcemanager.v1.FolderService.List] request.|
