...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/vpc/cli-ref-beta/route-table/create.md
---

# yc beta vpc route-table create
...
`yc beta vpc route-table create <FOLDER-ID>`
...
|`--network-id`|<b>`string`</b><br/>ID of the network the route table belongs to.|
