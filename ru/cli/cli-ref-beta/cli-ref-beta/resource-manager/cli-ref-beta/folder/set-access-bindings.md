...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/resource-manager/cli-ref-beta/folder/set-access-bindings.md
---

# yc beta resource-manager folder set-access-bindings
...
`yc beta resource-manager folder set-access-bindings <RESOURCE-ID>`
