...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/resource-manager/cli-ref-beta/cloud/delete.md
---

# yc beta resource-manager cloud delete
...
`yc beta resource-manager cloud delete <CLOUD-ID>`
