...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/resource-manager/cli-ref-beta/cloud/update-access-bindings.md
---

# yc beta resource-manager cloud update-access-bindings
...
`yc beta resource-manager cloud update-access-bindings <RESOURCE-ID>`
