...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-opensearch/cli-ref-beta/cluster/set-access-bindings.md
---

# yc beta managed-opensearch cluster set-access-bindings
...
`yc beta managed-opensearch cluster set-access-bindings <RESOURCE-ID>`
