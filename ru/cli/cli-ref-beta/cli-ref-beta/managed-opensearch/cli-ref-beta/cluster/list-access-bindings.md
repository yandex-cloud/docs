...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-opensearch/cli-ref-beta/cluster/list-access-bindings.md
---

# yc beta managed-opensearch cluster list-access-bindings
...
`yc beta managed-opensearch cluster list-access-bindings <RESOURCE-ID>`
