...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-opensearch/cli-ref-beta/cluster/update-dashboards-node-group.md
---

# yc beta managed-opensearch cluster update-dashboards-node-group
...
`yc beta managed-opensearch cluster update-dashboards-node-group <CLUSTER-ID>`
