...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-kubernetes/cli-ref-beta/cluster/update-access-bindings.md
---

# yc beta managed-kubernetes cluster update-access-bindings
...
`yc beta managed-kubernetes cluster update-access-bindings <RESOURCE-ID>`
