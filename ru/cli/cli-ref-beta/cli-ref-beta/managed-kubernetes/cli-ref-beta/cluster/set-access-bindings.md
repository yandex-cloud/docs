...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-kubernetes/cli-ref-beta/cluster/set-access-bindings.md
---

# yc beta managed-kubernetes cluster set-access-bindings
...
`yc beta managed-kubernetes cluster set-access-bindings <RESOURCE-ID>`
