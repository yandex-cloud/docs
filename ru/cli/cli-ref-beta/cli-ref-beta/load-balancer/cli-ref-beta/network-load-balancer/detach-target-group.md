...
# yc beta load-balancer network-load-balancer detach-target-group
...
`yc beta load-balancer network-load-balancer detach-target-group <NETWORK-LOAD-BALANCER-ID>`
