...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/cdn/cli-ref-beta/origin-group/create.md
---

# yc beta cdn origin-group create
...
`yc beta cdn origin-group create <FOLDER-ID>`
...
|`--name`|<b>`string`</b><br/>Name of the origin group.|
...
|`--provider-type`|<b>`string`</b><br/>Set up origin group provider<br/><br/>It has two possible values:<br/><br/>ourcdn - Based on Yandex technologies<br/>gcore - Based on an external partner infrastructure<br/><br/>Default value: ourcdn|
|`--use-next`|This option have two possible conditions:<br/>true - The option is active. In case the origin responds with 4XX or 5XX codes,<br/>use the next origin from the list.<br/>false - The option is disabled.<br/><br/>default value is true|
