...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/desktops/cli-ref-beta/group/update-access-bindings.md
---

# yc beta desktops group update-access-bindings
...
`yc beta desktops group update-access-bindings <RESOURCE-ID>`
