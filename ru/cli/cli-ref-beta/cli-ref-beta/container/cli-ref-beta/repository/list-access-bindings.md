...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/container/cli-ref-beta/repository/list-access-bindings.md
---

# yc beta container repository list-access-bindings
...
`yc beta container repository list-access-bindings <RESOURCE-ID>`
