...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/container/cli-ref-beta/repository/list.md
---

# yc beta container repository list
...
`yc beta container repository list <FOLDER-ID>`
