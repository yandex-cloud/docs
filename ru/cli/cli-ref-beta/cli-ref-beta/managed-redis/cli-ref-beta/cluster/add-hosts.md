...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-redis/cli-ref-beta/cluster/add-hosts.md
---

# yc beta managed-redis cluster add-hosts
...
`yc beta managed-redis cluster add-hosts <CLUSTER-ID>`
