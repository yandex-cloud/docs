...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-redis/cli-ref-beta/cluster/list-logs.md
---

# yc beta managed-redis cluster list-logs
...
`yc beta managed-redis cluster list-logs <CLUSTER-ID>`

#### Flags

| Flag | Description |
|----|----|
|`--cluster-id`|<b>`string`</b><br/>ID of the Redis cluster to request logs for.<br/>To get the Redis cluster ID use a [ClusterService.List] request.|
...
|`--service-type`|<b>`enum`</b><br/>Possible Values: 'redis'|
