...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-redis/cli-ref-beta/cluster/list-access-bindings.md
---

# yc beta managed-redis cluster list-access-bindings
...
`yc beta managed-redis cluster list-access-bindings <RESOURCE-ID>`
