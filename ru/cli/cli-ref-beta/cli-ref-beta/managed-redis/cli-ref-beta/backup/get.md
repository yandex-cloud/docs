...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-redis/cli-ref-beta/backup/get.md
---

# yc beta managed-redis backup get
...
`yc beta managed-redis backup get <BACKUP-ID>`
