...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-redis/cli-ref-beta/user/delete.md
---

# yc beta managed-redis user delete
...
`yc beta managed-redis user delete <CLUSTER-ID>`
