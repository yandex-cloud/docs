...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-redis/cli-ref-beta/user/list.md
---

# yc beta managed-redis user list
...
`yc beta managed-redis user list <CLUSTER-ID>`
...
ID of the cluster to list Redis users in. To get the cluster ID, use a [ClusterService.List] request. ||
|| `--page-size` | `int`
