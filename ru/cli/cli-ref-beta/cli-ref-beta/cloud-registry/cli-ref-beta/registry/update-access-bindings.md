...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/cloud-registry/cli-ref-beta/registry/update-access-bindings.md
---

# yc beta cloud-registry registry update-access-bindings
...
`yc beta cloud-registry registry update-access-bindings <RESOURCE-ID>`
