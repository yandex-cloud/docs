...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/cloud-registry/cli-ref-beta/artifact/list-access-bindings.md
---

# yc beta cloud-registry artifact list-access-bindings
...
`yc beta cloud-registry artifact list-access-bindings <RESOURCE-ID>`
