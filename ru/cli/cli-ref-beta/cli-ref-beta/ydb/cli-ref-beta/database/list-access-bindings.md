...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/ydb/cli-ref-beta/database/list-access-bindings.md
---

# yc beta ydb database list-access-bindings
...
`yc beta ydb database list-access-bindings <RESOURCE-ID>`
