...
Ниже описана последовательность действий для создания:
  * облачной сети с одной подсетью;
  * виртуальной машины, подключенной к определенной подсети.
...
1. Подключитесь к виртуальной машине по SHH:
   1. Посмотрите подробную информацию о вашей виртуальной машине:
      ```
