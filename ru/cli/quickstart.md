...
Также вы можете самостоятельно загрузить и установить исполняемый файл с последней стабильной версией CLI. Подробнее в разделе [{#T}](./operations/install-cli.md#bin).
