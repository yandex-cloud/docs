---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/dns/cli-ref/v0/inbound-endpoint/add-access-binding/
---

# yc dns v0 inbound-endpoint add-access-binding
...
`yc dns inbound-endpoint add-access-binding <DNS-INBOUND-ENDPOINT-NAME>|<DNS-INBOUND-ENDPOINT-ID> [Flags...] [Global Flags...]`
