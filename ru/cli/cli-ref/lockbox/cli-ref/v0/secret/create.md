---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/lockbox/cli-ref/v0/secret/create/
---
...
KMS key ID will be used to encrypt the secret payload. ||
|| `--version-description` | `string`

Description of the first version. ||
|| `--payload` | `string`

YAML or JSON array defining the entries of the secret payload.
...
For instance, the following payload JSON defines a payload containing two text value entries:
