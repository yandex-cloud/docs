---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/smartwebsecurity/cli-ref/v1/load-balancer/domain/create/
---
...
1. Generate template:
yc smartwebsecurity v1 load-balancer domain create --example-json > request.json
or
yc smartwebsecurity v1 load-balancer domain create --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc smartwebsecurity v1 load-balancer domain create -r request.json
or
yc smartwebsecurity v1 load-balancer domain create -r request.yaml ||
|#
