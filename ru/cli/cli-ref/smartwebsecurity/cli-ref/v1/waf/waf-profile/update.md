---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/smartwebsecurity/cli-ref/v1/waf/waf-profile/update
editable: false
---

# yc smartwebsecurity v1 waf waf-profile update
...
`yc smartwebsecurity v1 waf waf-profile update <WAF-PROFILE-ID>`
...
1. Generate template:
yc smartwebsecurity v1 waf waf-profile update --example-json > request.json
or
yc smartwebsecurity v1 waf waf-profile update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc smartwebsecurity v1 waf waf-profile update -r request.json
or
yc smartwebsecurity v1 waf waf-profile update -r request.yaml ||
|#
