---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/kms/cli-ref/v0/asymmetric-encryption-key/add-access-binding/
---

# yc kms v0 asymmetric-encryption-key add-access-binding
