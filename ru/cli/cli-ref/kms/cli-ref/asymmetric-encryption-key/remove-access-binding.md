---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/kms/cli-ref/asymmetric-encryption-key/remove-access-binding/
---

# yc kms asymmetric-encryption-key remove-access-binding

Remove access binding for the specified asymmetric encryption key

#### Command Usage

Syntax:

`yc kms asymmetric-encryption-key remove-access-binding <ASYMMETRIC-ENCRYPTION-KEY> [Flags...] [Global Flags...]`
