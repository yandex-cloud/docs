...
# yc managed-clickhouse v0 cluster remove-access-binding

Remove access binding for the specified ClickHouse cluster

#### Command Usage

Syntax:

`yc managed-clickhouse cluster remove-access-binding <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
