---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/cic/cli-ref/v1/trunk-connection/delete
editable: false
---

# yc cic v1 trunk-connection delete
...
`yc cic v1 trunk-connection delete <TRUNK-CONNECTION-ID>`
