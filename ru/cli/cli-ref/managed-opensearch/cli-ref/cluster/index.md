---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/managed-opensearch/cli-ref/cluster/
---
...
- [yc managed-opensearch cluster move](move.md) — Move a managed OpenSearch cluster into a new folder
