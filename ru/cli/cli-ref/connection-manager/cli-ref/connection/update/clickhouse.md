---
editable: false
sourcePath: en/_cli-ref/cli-ref/connection-manager/cli-ref/connection/update/clickhouse.md
---

# yc connection-manager connection update clickhouse
...
`yc connection-manager connection update clickhouse [<CONNECTION-ID>] [Flags...] [Global Flags...]`
