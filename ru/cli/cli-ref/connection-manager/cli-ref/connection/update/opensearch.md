---
editable: false
sourcePath: en/_cli-ref/cli-ref/connection-manager/cli-ref/connection/update/opensearch.md
---

# yc connection-manager connection update opensearch
...
`yc connection-manager connection update opensearch [<CONNECTION-ID>] [Flags...] [Global Flags...]`
