---
editable: false
sourcePath: en/_cli-ref/cli-ref/connection-manager/cli-ref/connection/update/trino.md
---

# yc connection-manager connection update trino
...
`yc connection-manager connection update trino [<CONNECTION-ID>] [Flags...] [Global Flags...]`
