---
editable: false
sourcePath: en/_cli-ref/cli-ref/managed-services/managed-kafka/connector-s3-sink/create.md
---
...
|`--file-compression-type`|<b>`string`</b><br/>Compression type of files, that will be placed in bucket of s3-compatible storage. This setting cannot be updated after cluster will be created.|
