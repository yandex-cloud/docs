...
`yc application-load-balancer backend-group delete-http-backend <BACKEND_GROUP-NAME>|<BACKEND_GROUP-ID> [Flags...] [Global Flags...]`
...
|`--name`|<b>`string`</b><br/>A name of the HTTP backend within backend group to delete.|
