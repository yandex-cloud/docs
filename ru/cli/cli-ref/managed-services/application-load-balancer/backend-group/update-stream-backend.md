---
sourcePath: ru/_cli-ref/cli-ref/managed-services/application-load-balancer/backend-group/update-stream-backend.md
---
...
|`--name`|<b>`string`</b><br/> A name of the Stream backend to update.|
