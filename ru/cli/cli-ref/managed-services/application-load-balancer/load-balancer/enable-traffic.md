...
|`--async`|Display information about the operation in progress, without waiting for the operation to complete. --zone value[,value]   Zone of the load balancer where to enable traffic, --zone zone-id1 --zone=zone-id2|
