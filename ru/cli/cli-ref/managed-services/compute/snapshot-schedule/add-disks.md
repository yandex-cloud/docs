---
editable: false
sourcePath: en/_cli-ref/cli-ref/managed-services/compute/snapshot-schedule/add-disks.md
---
...
|`--disk-id`|<b>`value[,value]`</b><br/>Disk ids to add to the specified snapshot schedule, --disk-id id1 --disk-id=id2|
