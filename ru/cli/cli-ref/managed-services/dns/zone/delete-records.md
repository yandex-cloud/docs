...
|`--record`|<b>`"<NAME> [TTL] <TYPE> <DATA>"`</b><br/>record to delete in format "\<NAME\> [TTL] \<TYPE\> \<DATA\>". If no record with specified name and type is present no error will be shown.|
