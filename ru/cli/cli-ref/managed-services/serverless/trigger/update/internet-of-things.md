---
editable: false
sourcePath: en/_cli-ref/cli-ref/managed-services/serverless/trigger/update/internet-of-things.md
---
...
|`--new-registry-id`|<b>`string`</b><br/>Internet of Things registry ID.|
|`--new-device-id`|<b>`string`</b><br/>Internet of Things device ID.|
|`--new-mqtt-topic`|<b>`string`</b><br/>Internet of Things MQTT topic.|
