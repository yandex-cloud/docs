---
editable: false
sourcePath: en/_cli-ref/cli-ref/managed-services/serverless/eventrouter/rule/create.md
---
...
| Flag | Description |
|----|----|
|`--bus-id`|<b>`string`</b><br/>Rule bus id.|
...
|`--filter`|<b>`string`</b><br/>JQ filter for matching events.|
