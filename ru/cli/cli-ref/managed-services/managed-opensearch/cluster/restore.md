---
editable: false
sourcePath: en/_cli-ref/cli-ref/managed-services/managed-opensearch/cluster/restore.md
---
...
|`--keystore-settings`|<b>`key=value[,key=value...]`</b><br/>A comma-separated list of keystore settings given as key=value pairs.|
