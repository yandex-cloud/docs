---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/billing/cli-ref/consumption-core/get-folder-usage-report/
---
...
`yc billing consumption-core get-folder-usage-report <BILLING-ACCOUNT-ID>`
