---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/managed-sharded-postgresql/cli-ref/cluster/reschedule-maintenance/
---

# yc managed-sharded-postgresql cluster reschedule-maintenance
