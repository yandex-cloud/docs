---
editable: false
sourcePath: en/_cli-ref/cli-ref/organization-manager/cli-ref/idp/application/saml/application/remove-access-bindings.md
---
...
| Flag | Description |
|----|----|
|`--id`|<b>`string`</b><br/>SAML application id.|
