---
editable: false
sourcePath: en/_cli-ref/cli-ref/managed-trino/cli-ref/catalog/create/mysql.md
---
...
`yc managed-trino catalog create mysql <CATALOG-NAME> [Flags...] [Global Flags...]`
...
|`--connection-manager-connection-properties`|<b>`key=value[,key=value...]`</b><br/>ConnectionManager connection properties.|
