...
|`--cookie-affinity`|<b>`PROPERTY=VALUE[,PROPERTY=VALUE...]`</b><br/>Cookie affinity type for backend-group.<br/><br/>Possible property names:<br/><ul> <li><code>name</code>:     Name of the cookie.</li> <li><code>ttl</code>:     TTL of the cookie.</li> <li><code>path</code>:     Path of cookie.</li> </ul>|
