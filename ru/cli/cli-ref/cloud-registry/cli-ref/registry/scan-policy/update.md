---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/cloud-registry/cli-ref/registry/scan-policy/update/
---
...
`yc cloud-registry registry scan-policy update <SCAN-POLICY-ID>`
...
1. Generate template:
yc cloud-registry registry scan-policy update --example-json > request.json
or
yc cloud-registry registry scan-policy update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc cloud-registry registry scan-policy update -r request.json
or
yc cloud-registry registry scan-policy update -r request.yaml ||
|#
