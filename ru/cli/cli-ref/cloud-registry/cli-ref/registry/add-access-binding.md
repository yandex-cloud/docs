---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/cloud-registry/cli-ref/registry/add-access-binding/
---

# yc cloud-registry registry add-access-binding
...
`yc cloud-registry registry add-access-binding <REGISTRY-NAME>|<REGISTRY-ID>`
...
1. Generate template:
yc cloud-registry registry add-access-binding --example-json > request.json
or
yc cloud-registry registry add-access-binding --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc cloud-registry registry add-access-binding -r request.json
or
yc cloud-registry registry add-access-binding -r request.yaml ||
|#
