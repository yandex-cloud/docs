---
editable: false
sourcePath: en/_cli-ref/cli-ref/managed-sqlserver/cli-ref/database/restore.md
---
...
ID of the backup to create a database from. ||
|| `--time` | `timestamp`

Timestamp in RFC3339 of the moment to which the SQLServer database should be restored. ||
