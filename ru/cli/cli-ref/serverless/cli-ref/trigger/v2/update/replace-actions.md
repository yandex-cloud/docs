---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/serverless/cli-ref/trigger/v2/update/replace-actions/
---

# yc serverless trigger v2 update replace-actions
...
`yc serverless trigger v2 update replace-actions <TRIGGER-NAME>|<TRIGGER-ID> [Flags...] [Global Flags...]`
