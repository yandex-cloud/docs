---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/serverless/cli-ref/trigger/v2/create/telegram/
---

# yc serverless trigger v2 create telegram
...
`yc serverless trigger v2 create telegram <TRIGGER-NAME> [Flags...] [Global Flags...]`
