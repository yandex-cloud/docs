---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/serverless/cli-ref/v0/trigger/v1/create/mail/
---

# yc serverless v0 trigger v1 create mail
...
`yc serverless trigger v1 create mail <TRIGGER-NAME> [Flags...] [Global Flags...]`
