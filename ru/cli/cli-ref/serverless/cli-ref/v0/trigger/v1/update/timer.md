---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/serverless/cli-ref/v0/trigger/v1/update/timer/
---

# yc serverless v0 trigger v1 update timer
...
`yc serverless trigger v1 update timer <TRIGGER-NAME> [Flags...] [Global Flags...]`
...
Workflow to be started on each Timer event. ||
