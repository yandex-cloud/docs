---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/serverless/cli-ref/v0/trigger/v1/update/iot-broker/
---

# yc serverless v0 trigger v1 update iot-broker
...
`yc serverless trigger v1 update iot-broker <TRIGGER-NAME> [Flags...] [Global Flags...]`
