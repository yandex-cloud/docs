---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/serverless/cli-ref/v0/trigger/update/internet-of-things/
---

# yc serverless v0 trigger update internet-of-things
