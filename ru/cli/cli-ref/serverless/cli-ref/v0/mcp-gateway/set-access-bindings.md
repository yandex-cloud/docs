---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/serverless/cli-ref/v0/mcp-gateway/set-access-bindings/
---

# yc serverless v0 mcp-gateway set-access-bindings

Set access bindings for the specified MCP Gateway and delete all existing access bindings if there were any

#### Command Usage

Syntax:

`yc serverless mcp-gateway set-access-bindings <MCP-GATEWAY-NAME>|<MCP-GATEWAY-ID> [Flags...] [Global Flags...]`
