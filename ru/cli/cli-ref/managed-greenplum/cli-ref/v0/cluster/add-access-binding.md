---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/managed-greenplum/cli-ref/v0/cluster/add-access-binding/
---

# yc managed-greenplum v0 cluster add-access-binding
...
`yc managed-greenplum cluster add-access-binding <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
