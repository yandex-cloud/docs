---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/dataproc/cli-ref/v0/cluster/add-access-binding
editable: false
---

# yc dataproc v0 cluster add-access-binding

Add access binding for the specified cluster

#### Command Usage

Syntax:

`yc dataproc cluster add-access-binding <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
