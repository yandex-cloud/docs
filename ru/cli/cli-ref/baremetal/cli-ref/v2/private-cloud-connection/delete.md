---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/baremetal/cli-ref/v2/private-cloud-connection/delete/
---

# yc baremetal v2 private-cloud-connection delete
...
`yc baremetal v2 private-cloud-connection delete <PRIVATE-CLOUD-CONNECTION-ID>`
