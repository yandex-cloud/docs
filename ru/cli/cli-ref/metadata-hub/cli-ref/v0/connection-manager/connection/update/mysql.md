---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/metadata-hub/cli-ref/v0/connection-manager/connection/update/mysql/
---

# yc metadata-hub v0 connection-manager connection update mysql
