---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/metadata-hub/cli-ref/v0/connection-manager/connection/create/kafka/
---

# yc metadata-hub v0 connection-manager connection create kafka
...
`yc metadata-hub v0 connection-manager connection create kafka [<CONNECTION-NAME>] [Flags...] [Global Flags...]`
...
|| `--supported-mechanisms` | List of Kafka authentication supported mechanisms, possible mechanisms are: SCRAM_SHA256, SCRAM_SHA512 and PLAIN. ||
|| `--user` | `string`
...
List of Kafka hosts in format 'host:port'. ||
|| `--tls-disabled` | Disable TLS for Kafka connection. ||
