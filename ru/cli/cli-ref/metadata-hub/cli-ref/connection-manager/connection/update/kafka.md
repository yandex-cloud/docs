---
editable: false
sourcePath: en/_cli-ref/cli-ref/metadata-hub/cli-ref/connection-manager/connection/update/kafka.md
---

# yc metadata-hub connection-manager connection update kafka
...
`yc metadata-hub connection-manager connection update kafka [<CONNECTION-ID>] [Flags...] [Global Flags...]`
...
|`--hosts`|<b>`value[,value]`</b><br/>List of Kafka hosts in format 'host:port'.|
