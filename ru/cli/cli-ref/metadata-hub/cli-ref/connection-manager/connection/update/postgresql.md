---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/metadata-hub/cli-ref/connection-manager/connection/update/postgresql
editable: false
---
...
`yc metadata-hub connection-manager connection update postgresql [<CONNECTION-ID>] [Flags...] [Global Flags...]`
