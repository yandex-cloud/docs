---
editable: false
sourcePath: en/_cli-ref/cli-ref/metadata-hub/cli-ref/connection-manager/connection/update/trino.md
---
...
|`--coordinator`|<b>`string`</b><br/>Trino coordinator parameters in format 'host:port'|
