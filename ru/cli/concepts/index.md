...
- Глобальных параметров — они определяют свойства только на один раз при вызове команды. Глобальные параметры доступны для любой команды на любом уровне вложенности.
