...
| — | `service-account-key`| Авторизованный ключ {% if audience != "internal" %}[сервисного аккаунта](../../iam/concepts/users/service-accounts.md){% else %}сервисного аккаунта{% endif %} в {{ yandex-cloud }}. Устанавливается из файла, в котором хранится ключ. |
