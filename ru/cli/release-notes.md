...
- **{{ mch-name }}.** Добавлена возможность добавлять хосты ZooKeeper командой `$ yc managed-clickhouse cluster add-zookeeper <имя кластера>`.

- **{{ mch-name }}.** Изменена логика создания шардов.
