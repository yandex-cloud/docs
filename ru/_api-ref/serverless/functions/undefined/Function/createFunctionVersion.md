...
```
POST undefined/functions/v1alpha/versions
```
...
Поле | Описание
--- | ---
functionId | **string**<br><p>Обязательное поле.</p> 
runtime | **string**<br><p>Обязательное поле.</p> 
description | **string**<br>
entrypoint | **string**<br><p>Обязательное поле.</p> 
resources | **object**<br>Обязательное поле.<br>
resources.<br>memory | **string** (int64)<br><p>Допустимые значения — от 33554432 до 1073741824 включительно.</p> 
executionTimeout | **string**<br><p>Обязательное поле.</p> 
package | **object**<br>
package.<br>bucketName | **string**<br><p>Обязательное поле.</p> 
package.<br>objectName | **string**<br><p>Обязательное поле.</p> 
