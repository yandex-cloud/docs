...
```
POST undefined/functions/v1alpha/versions/{functionVersionId}:removeTag
```
...
Поле | Описание
--- | ---
tag | **string**<br><p>Значение должно соответствовать регулярному выражению <code>[a-z][-_0-9a-z]*</code>.</p> 
