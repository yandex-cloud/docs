...
accessBindings[].<br>roleId | **string**<br><p>Идентификатор ресурса <a href="/docs/iam/api-ref/Role#representation">Role</a> который назначен для субъекта, указанного в параметре <code>subject</code>.</p> <p>Максимальная длина строки в символах — 50.</p> 
