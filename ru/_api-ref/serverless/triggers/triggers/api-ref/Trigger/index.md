...
rule.<br>timer | **object** <br>`rule` включает только одно из полей `timer`, `messageQueue`, `iotMessage`<br><br><p>Правило активации для таймера.</p> 
...
rule.<br>messageQueue | **object** <br>`rule` включает только одно из полей `timer`, `messageQueue`, `iotMessage`<br><br><p>Правило для активации триггера очереди сообщений.</p> 
...
rule.<br>iotMessage | **object** <br>`rule` включает только одно из полей `timer`, `messageQueue`, `iotMessage`<br><br><p>Правило для активации триггера Yandex IoT Core.</p> 
