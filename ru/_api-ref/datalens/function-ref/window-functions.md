...
1. Оконные функции могут иметь в качестве аргументов только измерения или агрегации (или более сложные выражения, зависящие от тех и других).
...
- `AMONG dim1, dim2, ...`  : записи групируются по всем измерениям из запроса, кроме перечисленных. Например, если измерения `dim1`, `dim2`, `dim3`, `dim4` присутствуют в запросе данных, то записи группируются по `dim3`, `dim4`.
