...
См. также [LEAST](../LEAST/overview.md).
...
**Типы аргументов:**
- `value_1` — `Логический | Дата | Дата со временем | Число | Строка`
- `value_2` — `Логический | Дата | Дата со временем | Число | Строка`
- `value_3` — `Логический | Дата | Дата со временем | Число | Строка`
