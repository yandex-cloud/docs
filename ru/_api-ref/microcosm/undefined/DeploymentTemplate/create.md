...
```json 
{
  ...
  //  включает только одно из полей `deploymentSpec`, `deploymentYaml`
  "deploymentSpec": {
    "resources": [
      {
        "name": "string",
...
Поле | Описание
--- | ---
infrastructureTemplateId | **string**<br><p>Обязательное поле. Максимальная длина строки в символах — 50.</p> 
version | **string**<br><p>Обязательное поле. Максимальная длина строки в символах — 32.</p> 
tags[] | **string**<br><p>Максимальное количество элементов — 32. Максимальная длина строки в символах для каждого значения — 32.</p> 
upgradableFrom[] | **string**<br><p>Максимальное количество элементов — 32. Максимальная длина строки в символах для каждого значения — 32.</p> 
deploymentSpec | **object** <br> включает только одно из полей `deploymentSpec`, `deploymentYaml`<br><br>
...
deploymentYaml | **string** <br> включает только одно из полей `deploymentSpec`, `deploymentYaml`<br><br>
