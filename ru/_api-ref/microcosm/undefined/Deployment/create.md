...
```json 
{
  ...
  //  включает только одно из полей `deploymentSpec`, `deploymentYaml`, `deploymentTemplateId`, `deploymentTemplateTag`
  "deploymentSpec": {
    "resources": [
      {
        "name": "string",
...
Поле | Описание
--- | ---
infrastructureId | **string**<br><p>Обязательное поле. Максимальная длина строки в символах — 50.</p> 
deploymentSpec | **object** <br> включает только одно из полей `deploymentSpec`, `deploymentYaml`, `deploymentTemplateId`, `deploymentTemplateTag`<br><br>
...
deploymentYaml | **string** <br> включает только одно из полей `deploymentSpec`, `deploymentYaml`, `deploymentTemplateId`, `deploymentTemplateTag`<br><br><p>Максимальная длина строки в символах — 262144.</p> 
deploymentTemplateId | **string** <br> включает только одно из полей `deploymentSpec`, `deploymentYaml`, `deploymentTemplateId`, `deploymentTemplateTag`<br><br><p>Максимальная длина строки в символах — 50.</p> 
deploymentTemplateTag | **string** <br> включает только одно из полей `deploymentSpec`, `deploymentYaml`, `deploymentTemplateId`, `deploymentTemplateTag`<br><br><p>Максимальная длина строки в символах — 32.</p> 
