...
Параметр | Описание
--- | ---
secretId | Обязательное поле. Идентификатор секрета для обновления.  Максимальная длина строки в символах — 50.
