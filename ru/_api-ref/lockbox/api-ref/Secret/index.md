...
labels | **object**<br><p>Пользовательские метки для секрета в виде пар <code>key:value</code>. Максимум 64 на ключ.</p> 
