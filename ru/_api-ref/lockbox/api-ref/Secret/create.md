...
versionPayloadEntries[].<br>key | **string**<br><p>Обязательное поле. Неконфиденциальный ключ содержимого версии.</p> <p>Максимальная длина строки в символах — 256. Значение должно соответствовать регулярному выражению ``[-_./\\@0-9a-zA-Z]+``.</p> 
