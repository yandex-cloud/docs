...
```
GET https://mdb.api.cloud.yandex.net/mdb/redis/v1alpha/backups/{backupId}
```
...
```
Описание резервной копии Redis. Подробнее смотрите в [documentation](/docs/managed-redis/concepts/backup) Managed
Service for Redis.
