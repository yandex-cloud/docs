...
userSpecs[].<br>login | **boolean** (boolean)<br><p>Этот флаг определяет, может ли пользователь войти в базу данных PostgreSQL.</p> <p>Значение по умолчанию: <code>true</code> (вход разрешен).</p> 
