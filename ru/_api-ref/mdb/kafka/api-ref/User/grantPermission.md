...
userName | Обязательное поле. Name of the user to grant the permission to.  To get the name of the user, make a [list](/docs/managed-kafka/api-ref/User/list) request.  Длина строки в символах должна быть от 1 до 63. Значение должно соответствовать регулярному выражению `` [a-zA-Z0-9_]* ``.
...
Поле | Описание
--- | ---
permission | **object**<br><p>Обязательное поле. Permission that should be granted to the specified user.</p> 
