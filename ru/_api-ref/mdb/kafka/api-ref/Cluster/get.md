...
```
Кластер Apache Kafka. Подробнее читайте в разделе [Concepts](/docs/managed-kafka/concepts) документации.
...
config.<br>kafka.<br>resources | **object**<br>Ресурсы, выделенные брокерам Kafka.<br><p>Вычислительные ресурсы.</p> 
