...
```
Кластер Apache Kafka. Подробнее читайте в разделе [Концепции](/docs/managed-kafka/concepts).
...
config.<br>kafka.<br>resources | **object**<br>Вычислительные ресурсы, выделенные брокерам Kafka.<br>
