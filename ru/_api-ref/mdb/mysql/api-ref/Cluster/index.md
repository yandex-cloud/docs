...
[listLogs](listLogs.md) | Получает логи для указанного кластера MySQL. Дополнительные сведения о логах см. в разделе [Логи](/docs/managed-mysql/concepts/logs) документации.
