...
Поле | Описание
--- | ---
clusters[] | **object**<br><p>Кластер MySQL. Подробнее см. в разделе <a href="/docs/managed-mysql/concepts">documentation</a>.</p> 
...
clusters[].<br>config.<br>mysqlConfig_5_7.<br>effectiveConfig | **object**<br><p>Действующие параметры для кластера MySQL 5.7 (сочетание параметров, определенных в userConfig и [default_config]).</p> <p>Поля и структура <code>MysqlConfig5_7</code> отражает параметры конфигурации MySQL 5.7.</p> 
