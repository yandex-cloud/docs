...
# Метод listLogs
Получает логи для указанного кластера MySQL. Дополнительные сведения о логах см. в
разделе [Logs](/docs/managed-mysql/concepts/logs) документации.
...
serviceType | Тип сервиса, для которого следует запросить логи.<ul> <li>MYSQL: Логи работы MySQL.</li> </ul> 
