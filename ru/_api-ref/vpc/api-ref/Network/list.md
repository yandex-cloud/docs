...
Поле | Описание
--- | ---
networks[] | **object**<br><p>Ресурс Network. Подробнее см. <a href="/vpc/concepts/network">Networks</a>.</p> 
...
networks[].<br>labels | **object**<br><p>Метки ресурса в формате <code>ключ:значение</code>. Максимум 64 метки на ресурс.</p> 
