...
Параметр | Описание
--- | ---
hostGroupId | Обязательное поле. Идентификатор обновляемой группы выделенных хостов. Для получения идентификатора группы выделенных хостов используйте запрос [list](/docs/compute/api-ref/HostGroup/list).  Максимальная длина строки в символах — 50.
