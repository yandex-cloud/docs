...
Параметр | Описание
--- | ---
imageId | Обязательное поле. Идентификатор возвращаемого ресурса Image. Чтобы получить идентификатор образа, используйте [list](/docs/compute/api-ref/Image/list) запрос.  Максимальная длина строки в символах — 50.
