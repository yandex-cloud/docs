...
Удаление образа — необратимая операция, восстановить
удаленный образ невозможно.
...
Параметр | Описание
--- | ---
imageId | Обязательное поле. Идентификатор удаляемого образа. Чтобы получить идентификатор образа, используйте [list](/docs/compute/api-ref/Image/list) запрос.  Максимальная длина строки в символах — 50.
