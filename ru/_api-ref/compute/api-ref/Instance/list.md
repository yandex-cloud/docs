...
instances[].<br>resources.<br>gpus | **string** (int64)<br><p>Количество GPU, доступных виртуальной машине.</p> 
...
instances[].<br>schedulingPolicy | **object**<br><p>Политика планирования.</p> 
...
instances[].<br>serviceAccountId | **string**<br><p>ID сервисного аккаунта для <a href="/docs/compute/operations/vm-connect/auth-inside-vm">аутентификации изнутри виртуальной машины</a>. Чтобы получить ID сервисного аккаунта, используйте метод <a href="/docs/iam/api-ref/ServiceAccount/list">list</a>.</p> 
