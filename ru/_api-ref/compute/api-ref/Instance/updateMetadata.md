...
Параметр | Описание
--- | ---
instanceId | Идентификатор изменяемой виртуальной машины.
...
Поле | Описание
--- | ---
delete[] | **string**<br><p>Список ключей для удаления.</p> 
upsert | **object**<br><p>Метаданные в формате пар <code>ключ:значение</code> , которые будут добавлены или обновлены для данной виртуальной машины.</p> 
