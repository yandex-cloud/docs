...
# Метод listVersions
Возвращает список версий, принадлежащих указанному симметричному ключу.
...
Параметр | Описание
--- | ---
keyId | Обязательное поле. Идентификатор симметричного ключа, для которого нужно вернуть список версий.  Максимальная длина строки в символах — 50.
...
Поле | Описание
--- | ---
keyVersions[] | **object**<br><p>Версия ключа KMS: метаданные криптографического материала.</p>
keyVersions[].<br>id | **string**<br><p>Идентификатор версии ключа.</p>
keyVersions[].<br>keyId | **string**<br><p>Идентификатор ключа KMS, которому принадлежит версия.</p>
