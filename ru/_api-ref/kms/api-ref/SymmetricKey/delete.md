...
могут быть восстановлены в течение 72 часов запросом в службу технической поддержки.
...
Параметр | Описание
--- | ---
keyId | Обязательное поле. Идентификатор ключа, который следует удалить.  Максимальная длина строки в символах — 50.
