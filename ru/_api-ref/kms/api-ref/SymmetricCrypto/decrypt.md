...
Параметр | Описание
--- | ---
keyId | Обязательное поле. Идентификатор симметричного ключа, который следует использовать для дешифрования.  Максимальная длина строки в символах — 50.
...
plaintext | **string** (byte)<br><p>Расшифрованный открытый текст. Должен быть в кодировке base64.</p> 
