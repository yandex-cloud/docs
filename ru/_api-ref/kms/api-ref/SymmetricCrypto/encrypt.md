...
Поле | Описание
--- | ---
keyId | **string**<br><p>Обязательное поле. Идентификатор симметричного ключа, который использовался для шифрования.</p> <p>Максимальная длина строки в символах — 50.</p> 
...
ciphertext | **string** (byte)<br><p>Полученный шифртекст. Должен быть в кодировке base64.</p> 