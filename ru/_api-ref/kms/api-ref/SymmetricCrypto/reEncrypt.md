...
# Метод reEncrypt
Расшифрует и заново шифрует заданный зашифрованный текст с указанным ключом KMS.
...
ciphertext | **string** (byte)<br><p>Заново зашифрованный шифртекст. Должен быть в кодировке base64.</p> 