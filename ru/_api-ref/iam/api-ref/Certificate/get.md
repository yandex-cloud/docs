...
name | **string**<br><p>Имя сертификата.</p> <p>Значение должно соответствовать регулярному выражению <code>\|[a-z][-a-z0-9]{1,61}[a-z0-9]</code>.</p> 
...
data | **string**<br><p>Обязательное поле. Содержимое сертификата в формате PEM.</p> <p>Максимальная длина строки в символах — 32000.</p> 