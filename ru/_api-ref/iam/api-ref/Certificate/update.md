...
Параметр | Описание
--- | ---
certificateId | Идентификатор изменяемого сертификата.  Максимальная длина строки в символах — 50.
