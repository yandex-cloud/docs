...
# Метод create
Создает сертификат для указанной федерации.
...
Поле | Описание
--- | ---
federationId | **string**<br><p>Идентификатор ресурса федерации, для которой добавляется сертификат.</p> <p>Максимальная длина строки в символах — 50.</p> 
