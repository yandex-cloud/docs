...
Добавляет пользователей федерации.
...
Параметр | Описание
--- | ---
federationId | Идентификатор ресурса федерации, для которой добавляются пользователи.  Максимальная длина строки в символах — 50.
...
Поле | Описание
--- | ---
nameIds[] | **string**<br><p>Список идентификаторов имён пользователей.</p> <p>Максимальная длина строки в символах для каждого значения — 1000.</p> 
