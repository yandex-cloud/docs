...
Параметр | Описание
--- | ---
federationId | Идентификатор удаляемого ресурса федерации. Чтобы получить идентификатор ресурса федерации, используйте запрос [list](/docs/iam/api-ref/Federation/list).  Максимальная длина строки в символах — 50.
