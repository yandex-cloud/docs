...
Поле | Описание
--- | ---
federationId | **string**<br><p>Идентификатор федерации для добавления нового сертификата. Чтобы получить идентификатор федерации, используйте запрос [yandex.cloud.iam.v1.FederationService.List].</p> <p>Максимальная длина строки в символах — 50.</p> 
