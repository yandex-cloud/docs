...
```
Ресурс NetworkLoadBalancer. Подробнее см. в разделе [Сетевой балансировщик нагрузки](/docs/load-balancer/concepts).
...
sessionAffinity | **string**<br><p>Тип адресации. В настоящее время доступна только адресация по принципу 5-tuple.</p> <p>Тип адресации. В настоящее время доступна только адресация по принципу 5-tuple. Подробнее см. в разделе <a href="/docs/load-balancer/concepts/">Основные понятия</a>.</p> <ul> <li>CLIENT_IP_PORT_PROTO: Адресация 5-tuple.</li> </ul> 
listeners[] | **object**<br><p>Ресурс Listener. Дополнительные сведения см. в разделе <a href="/docs/load-balancer/concepts/listener">Обработчик</a></p> 
listeners[].<br>name | **string**<br><p>Имя обработчика. У обработчиков одного балансировщика должны быть уникальные имена. Длина 3-63 символов.</p> <p>Значение должно соответствовать регулярному выражению <code>\|[a-z][-a-z0-9]{1,61}[a-z0-9]</code>.</p> 
...
attachedTargetGroups[].<br>healthChecks[].<br>name | **string**<br><p>Название проверки состояния. Имя должно быть уникальным в каталоге. Длина имени должна быть от 3 до 63 символов.</p> <p>Значение должно соответствовать регулярному выражению <code>\|[a-z][-a-z0-9]{1,61}[a-z0-9]</code>.</p> 
