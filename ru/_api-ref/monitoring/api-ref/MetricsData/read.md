...
vector[].<br>labels | **object**<br><p>Список меток метрики в формате <code>ключ:значение</code>.</p> 
vector[].<br>timestamps[] | **string** (int64)<br><p>Список временных точек метрики в формате <code>timestamp</code>.</p> 
