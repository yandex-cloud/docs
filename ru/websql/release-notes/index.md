...
1. В {{ websql-name }} появились вкладки: теперь страницы подключений и редактора запросов можно открывать на вкладках и переключаться между ними, сохраняя рабочий контекст.

### Улучшения {#improvements-december-2025}

1. Добавлено отображение патриций {{ PG }} в дереве подключений.

### Решенные проблемы {#fixes-december-2025}

1. Исправлена сортировка индексируемых колонок в разделе **Индексы**, в дереве подключений.
