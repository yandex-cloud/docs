...
На панели **Диспетчер подключений** (![image](../../_assets/websql/connections.svg)) вы можете добавлять соединения с базами данных или кластерами баз данных, проверять настройки подключения, переподключать ранее созданные соединения и удалять соединения, которые вам больше не нужны. 

## Подключиться к базе данных {#connect-db}

{% include notitle [connect-to-db](../../_includes/websql/connect-to-db.md) %}

## Подключиться к кластеру баз данных {#connect-cluster}
