...
Просмотр информации о подключениях {{ MG }} | `{{ roles.mmg.viewer }}` на организацию, облако или каталог
Просмотр информации о подключениях {{ mtr-full-name }} (сервис находится на стадии [Preview](../../overview/concepts/launch-stages.md)) | `managed-trino.viewer` на организацию, облако или каталог
...
Выполнение запросов {{ mtr-full-name }} | `managed-trino.user` на организацию, облако или каталог
