...
* обойтись без создания промежуточной {% if lang == "ru" and audience != "internal" %}[виртуальной машины](../../glossary/vm.md){% else %}виртуальной машины{% endif %} или разрешения доступа к вашему кластеру-приемнику {{ mch-name }} из интернета.
...
{% if audience != "internal" %}* [Разрешите подключение к кластеру-источнику из интернета](../concepts/network.md#source-external).{% endif %}
