...
- Консоль управления
    ...
    1. Выберите эндпоинт для источника или [создайте](source-endpoint.md#create-endpoint) новый.
    1. Выберите эндпоинт для приемника или [создайте](target-endpoint.md#create-endpoint) новый.
