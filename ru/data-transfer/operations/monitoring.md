...
Данные о состоянии трансфера доступны в консоли управления. Их можно посмотреть на вкладке **Мониторинг** страницы управления трансфером {% if audience != "internal" %} или в сервисе [{{ monitoring-full-name }}](../../monitoring/concepts/index.md){% endif %}.
