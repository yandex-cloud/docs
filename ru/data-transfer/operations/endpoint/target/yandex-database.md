# Параметры эндпоинта-приемника {{ ydb-name }}
...
* Консоль управления
    ...
    * **Поддиректория куда разместить таблицы** — укажите {% if audience != "internal" %}[поддиректорию](../../../../ydb/concepts/databases.md#directory){% else %}поддиректорию{% endif %} для размещения таблиц.
