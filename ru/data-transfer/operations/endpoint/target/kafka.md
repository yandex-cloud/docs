---
title: "Инструкция по настройке эндпоинта-приемника {{ KF }} в {{ data-transfer-full-name }}"
...
- Консоль управления
    ...
    * **Сохранять порядок транзакций** — не разбивать поток событий на независимые очереди по таблицам. Эта настройка совместима только с настройкой **Полное имя топика**.
