---
title: Как настроить эндпоинт-приемник {{ IBRG }} в {{ data-transfer-full-name }}
description: Из статьи вы узнаете, как задать настройки при создании или изменении эндпоинта-приемника {{ IBRG }} в {{ data-transfer-full-name }}.
---
...
Чтобы настроить эндпоинт-приемник {{ IBRG }} используйте кластер {{ metastore-name }} версии 4.2.0 или выше. Версии ниже 4.2.0 не поддерживают REST-протокол для работы с таблицами {{ IBRG }}. Подробнее о протоколах подключения читайте в разделе [Кластеры {{ metastore-full-name }}](../../../../metadata-hub/concepts/metastore.md#connection-protocols).
