...
- Консоль управления {#console}
    ...
    * (Опционально) укажите временной интервал, для которого надо произвести выгрузку данных. Эта возможность поддержана для трансферов типа {{ dt-type-copy }}. Интервал не может быть больше года. Конечная дата должна быть позже начальной даты на семь дней.
