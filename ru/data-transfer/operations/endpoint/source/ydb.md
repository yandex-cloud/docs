...
- Консоль управления
  ...
  * **Список включенных путей** — добавьте пути к таблицам или директориям {{ ydb-name }}, которые необходимо перенести. Если ни одного пути не указано, будут перенесены все таблицы.
