---
title: Передача данных из эндпоинта-источника AWS CloudTrail
description: Следуя данной инструкции, вы сможете настроить передачу данных из эндпоинта-источника AWS CloudTrail.
---
