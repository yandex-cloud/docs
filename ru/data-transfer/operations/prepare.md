...
* {{ mmg-name }}
    ...
    1. Оцените общее количество баз данных для трансфера и общую нагрузку на {{ mmg-name }}. Если нагрузка на базы выше 10000 транзакций на запись в секунду, cоздайте несколько эндпойнтов и трансферов. Подробнее см. в разделе [Подготовка источника {{ MG }}](../../data-transfer/operations/source-endpoint.md#settings-mongodb).
    1. [Создайте пользователя](../../managed-mongodb/operations/cluster-users.md#adduser) с ролью `readWrite` на базу источник.

* {{ MG }}

    1. Оцените общее количество баз данных для трансфера и общую нагрузку на {{ MG }}. Если нагрузка на базы выше 10000 транзакций на запись в секунду, cоздайте несколько эндпойнтов и трансферов. Подробнее см. в разделе [Подготовка источника {{ MG }}](../../data-transfer/operations/source-endpoint.md#settings-mongodb).
