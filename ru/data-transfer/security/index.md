...
* в интерфейсе [IDM](https://docs.yandex-team.ru/idm), нажать кнопку **Запросить роль**, в поле **Запрашиваемая роль** последовательно указать **ABC** → **Роли в сервисах** → _Путь к вашему сервису_ → **Роли сервиса** → **Пользователь Data Transfer**, выбрать нужного сотрудника и создать запрос.
