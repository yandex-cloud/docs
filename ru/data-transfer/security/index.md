...
Чтобы пользоваться сервисом, необходима [роль](../../iam/concepts/access-control/roles.md) `editor` или выше на каталог, в котором создаются [трансферы](../concepts/index.md#transfer) и [эндпоинты](../concepts/index.md#endpoint). Роль `viewer` позволит только просматривать список существующих трансферов и эндпоинтов.
