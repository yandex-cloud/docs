...
Если вам нужно перенести данные между вашим облаком {{ yandex-cloud }} и другим облаком (в том числе другим облаком {{ yandex-cloud }}) или между вашим облаком {{ yandex-cloud }} и кластером пользовательской инсталляции на вашей площадке, разрешите подключения к базе данных в стороннем облаке или на вашей площадке из интернета с [IP-адресов, используемых сервисом {{ data-transfer-name }}]({{ dt-white-ip-list-uri }}).
