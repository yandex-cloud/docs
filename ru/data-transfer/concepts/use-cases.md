...
Сервис {{ data-transfer-name }} позволяет перенести ваши данные из сторонних сервисов в {{ yandex-cloud }}. Подробнее о совместимости источников и приемников читайте в разделе [{#T}](./index.md#connectivity-matrix).
