...
Сервис {{ data-transfer-name }} позволяет протестировать работу с сервисами [{{ mmy-full-name }}](../../managed-mysql/), [{{ mpg-full-name }}](../../managed-postgresql/) и [{{ mmg-full-name }}](../../managed-mongodb/) на реальных данных.
