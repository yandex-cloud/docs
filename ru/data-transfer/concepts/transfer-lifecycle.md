...
Переход между статусами для трансферов типа <q>{{ dt-copy }}</q> показан на схеме:
...
Переход между статусами для трансферов типа <q>{{ dt-repl }}</q> показан на схеме:
...
Переход между статусами для трансферов типа <q>{{ dt-copy-repl }}</q> показан на схеме:
