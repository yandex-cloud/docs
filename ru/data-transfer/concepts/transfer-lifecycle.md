...
Доступные действия с трансфером определяются его текущим статусом. Подробнее читайте в разделе [{#T}](../operations/transfer.md).
