...
Тестируйте работу с сервисами {{ mmy-full-name }} и {{ mpg-full-name }} на ваших реальных данных. С помощью {{ data-transfer-name }} вы можете легко перенести свои данные в эти сервисы и ознакомится с их возможностями.

Вы так же можете запустить свое приложение и подключить к нему БД из сервисов {{ mmy-short-name }} или {{ mpg-short-name }}.
