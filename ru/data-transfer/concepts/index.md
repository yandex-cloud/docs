...
| Источник \ Приемник | {{ KF }}      | {{ CH }}                      | {{ MG }}                      | {{ MY }}                | {{ PG }}                      | {{ ydb-name }}                | {{ objstorage-name }} |
|:-------------------:|:-------------:|:-----------------------------:|:-----------------------------:|:-----------------------:|:-----------------------------:|:-----------------------------:|:---------------------:|
| {{ KF }}            | -             | Репликация^1^                 | -                             | -                       | -                             | Репликация^1^                 | Репликация^1^         |
| AWS CloudTrail      | -             | Копирование                   | Копирование                   | Копирование             | Копирование                   | Копирование                   | -                     |
| BigQuery            | -             | Копирование                   | Копирование                   | Копирование             | Копирование                   | Копирование                   | -                     |
| {{ CH }}            | -             | Копирование^1^                | -                             | -                       | -                             | -                             | -                     |
| {{ GP }}            | -             | Копирование^2^                | -                             | -                       | Копирование^2^                | -                             | -                     |
| {{ MG }}            | -             | -                             | Копирование^1^, репликация^1^ | -                       | -                             | -                             | Копирование^1^        |
| {{ MY }}            | -             | Копирование^1^, репликация^1^ | -                             | Копирование, репликация | -                             | Копирование^1^, репликация^1^ | Копирование^1^        |
| Oracle              | -             | Копирование^1^, репликация^1^ | -                             | -                       | Копирование^1^, репликация^1^ | -                             | -                     |
| {{ PG }}            | Репликация^1^ | Копирование^1^, репликация^1^ | -                             | -                       | Копирование, репликация       | Копирование^1^, репликация^1^ | Копирование^1^        |
| S3                  | -             | Копирование                   | Копирование                   | Копирование             | Копирование                   | Копирование                   | -                     |
| {{ yds-full-name }} | -             | Копирование^1^, репликация^1^ | -                             | -                       | -                             | Репликация^1^                 | Репликация^1^         |

{% endif %}

{% if product == "cloud-il" %}

| Источник \ Приемник | {{ KF }}      | {{ PG }}                      | {{ MY }}                | {{ MG }}                      | {{ CH }}                      | {{ objstorage-name }} |
|:-------------------:|:-------------:|:-----------------------------:|:-----------------------:|:-----------------------------:|:-----------------------------:|:---------------------:|
| {{ PG }}            | Репликация^1^ | Копирование, репликация       | -                       | -                             | Копирование^1^, репликация^1^ | Копирование^1^        |
| {{ MY }}            | -             | -                             | Копирование, репликация | -                             | Копирование^1^, репликация^1^ | Копирование^1^        |
| {{ MG }}            | -             | -                             | -                       | Копирование^1^, репликация^1^ | -                             | Копирование^1^        |
| Oracle              | -             | Копирование^1^, репликация^1^ | -                       | -                             | Копирование^1^, репликация^1^ | -                     |
| {{ CH }}            | -             | -                             | -                       | -                             | Копирование^1^                | -                     |
| {{ GP }}            | -             | Копирование^2^                | -                       | -                             | Копирование^2^                |
| {{ KF }}            | -             | -                             | -                       | -                             | Репликация^1^                 | Репликация^1^         |
