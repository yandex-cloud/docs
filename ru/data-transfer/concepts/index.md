...
1. Работа с ограничениями (`CONSTRAINT`).
    ...
    * На уровне трансфера доступно отключение `CONSTRAINT`, которое может помочь решить проблему производительности. Но в зависимости от подсистема хранения данных низкого уровня поведение может получиться различным: в отличие от [MyISAM](https://ru.wikipedia.org/wiki/MyISAM), для [InnoDB](https://ru.wikipedia.org/wiki/InnoDB) каскадное удаление работает без гарантий.
