...
Например, разработчики, тестировщики или аналитики вашего продукта используют инфраструктуру {{ yandex-cloud }} для своих задач. Вы можете быстро организовать окружение для нового участника, а за наличие в них актуальной копии данных из продуктового окружения будет отвечать сервис {{ data-transfer-name }}. 
