...
В качестве источника и приемникм могут выступать разные СУБД. Доступные комбинации источников и приемников:

| Источник \ Приемник | {{ KF }}      | {{ PG }}                      | {{ MY }}                | {{ MG }}                      | {{ ydb-name }}                | {{ CH }}                      | {{ objstorage-name }} | {{ yds-full-name }} |
|:-------------------:|:-------------:|:-----------------------------:|:-----------------------:|:-----------------------------:|:-----------------------------:|:-----------------------------:|:---------------------:|:-------------------:|
| {{ PG }}            | Репликация^1^ | Копирование, репликация       | -                       | -                             | Копирование^1^, репликация^1^ | Копирование^1^, репликация^1^ | Копирование^1^        | Репликация^1^       |
