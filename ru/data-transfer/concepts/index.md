...
| Источник \ Приемник | {{ PG }}                      | {{ MY }}                | {{ MG }}                      | {{ ydb-name }}                | {{ CH }}                      | {{ GP }}       | {{ objstorage-name }} |
|:-------------------:|:-----------------------------:|:-----------------------:|:-----------------------------:|:-----------------------------:|:-----------------------------:|:--------------:|:---------------------:|
| {{ PG }}            | Копирование, репликация      | -                       | -                             | Копирование^1^, репликация^1^ | Копирование^1^, репликация^1^ | Копирование^1^ | Копирование^1^        |
...
| {{ CH }}            | -                             | -                       | -                             | -                             | Копирование^1^                | -              | -                     |
| {{ GP }}            | Копирование^2^                | -                       | -                             | -                             | Копирование^2^                | Копирование^1^ | -                     |
