...
Сервис {{ data-transfer-name }} может задействовать более одного потока исполнения для выполнения трансфера. Функция параллельного копирования позволяет существенно увеличить пропускную способность трансфера, позволяя использовать для трансфера больший объём ресурсов.
