---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/datatransfer/cli-ref/v0/endpoint/create/clickhouse-source
editable: false
---

# yc datatransfer v0 endpoint create clickhouse-source
