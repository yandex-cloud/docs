...
Она обусловлена ограничением облачной квоты на количество операций с {{ ydb-name }}.

Чтобы устранить проблему:

1. Увеличьте в [квотах {{ ydb-name }}](https://cloud.yandex.ru/docs/ydb/concepts/limits.md) на облако с нужной базой данных значение характеристики **Количество схемных операций в минуту**.
