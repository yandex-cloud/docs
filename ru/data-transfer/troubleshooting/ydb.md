...
1. Увеличьте в {% if audience != "internal" %}[квотах {{ ydb-name }}][](../../managed-ydb/concepts/limits.md){% else %}квотах {{ ydb-name }}{% endif %} на облако с нужной базой данных значение характеристики **Количество схемных операций в минуту**.
