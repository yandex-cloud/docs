...
# SmartCaptcha API, gRPC: CaptchaService.Create {#Create}

Creates a captcha in the specified folder using the data specified in the request.

## gRPC request

**rpc Create ([CreateCaptchaRequest](#yandex.cloud.smartcaptcha.v1.CreateCaptchaRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## CreateCaptchaRequest {#yandex.cloud.smartcaptcha.v1.CreateCaptchaRequest}
