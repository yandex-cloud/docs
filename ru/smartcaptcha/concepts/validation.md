...
{{ captcha-name }}, проверив запрос, присваивает ему идентификатор — токен. По этому токену вы можете запросить у сервиса результат проверки запроса пользователя. Токен живет 5 минут. По истечении 5 минут, капча сбрасывается и пользователю необходимо снова ее пройти.
