...
Javascript Interface — объект, который передается ОС Android в **WebView**. В дальнейшем фронтенд будет обращаться к нему, чтобы отправлять сообщения с помощью функции обратного вызова на Android.
