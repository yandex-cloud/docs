...
Возвращает список [адресов](../../concepts/glossary.md#address) в каталоге. Нужный каталог определяется по сервисному аккаунту, от имени которого выполняется запрос.
