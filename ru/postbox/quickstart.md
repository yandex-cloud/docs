...
Обязательным условием использования SMTP для отправки писем является поддержка вашим почтовым клиентом расширения SMTP протокола STARTTLS для шифрования передаваемых писем.
