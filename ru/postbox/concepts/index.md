...
description: '{{ postbox-full-name }} — облачный сервис для упрощенной и экономичной отправки электронной почты.'
---

# Обзор сервиса {{ postbox-full-name }}

{{ postbox-full-name }} — это сервис электронной почты, который предоставляет простой и экономичный способ отправки писем с пользовательских [адресов](glossary.md#address) и позволяет гибко настроить [уведомления](notification.md) о доставке писем.
