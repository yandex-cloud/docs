...
1. Пройдите процедуру проверки прав на домены.
    ...
    Если сертификат используется в [статическом веб-сайте в {{ objstorage-name }}](../../tutorials/web/static.md) и не содержит [доменов с маской](https://en.wikipedia.org/wiki/Wildcard_certificate),
