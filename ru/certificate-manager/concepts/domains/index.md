...
Домен — уникальное доменное имя, которое можно использовать в [различных сервисах Облака](services.md), которым требуется подтверждение прав пользователя на домен. 
