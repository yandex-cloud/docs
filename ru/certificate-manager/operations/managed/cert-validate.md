...
description: Следуя этой инструкции, вы сможете проверить права на домены.
---
...
- API {#api}
  ...
  Для получения информации, необходимой для прохождения процедуры проверки прав на домены, воспользуйтесь методом REST API [get](../../api-ref/Certificate/get.md) для ресурса [Certificate](../../api-ref/Certificate/) или вызовом gRPC API [CertificateService/Get](../../api-ref/grpc/Certificate/get.md) с параметром `view=FULL`.
