---
title: Как обновить пользовательский сертификат в {{ certificate-manager-full-name }}
description: Следуя этой инструкции, вы сможете обновить пользовательский сертификат.
---
