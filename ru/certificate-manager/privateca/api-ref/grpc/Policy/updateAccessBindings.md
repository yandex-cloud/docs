---
editable: false
sourcePath: en/_api-ref-grpc/certificatemanager/v1/privateca/api-ref/grpc/Policy/updateAccessBindings.md
---

# Certificate Manager Private CA API, gRPC: PolicyService.UpdateAccessBindings
