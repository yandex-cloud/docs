---
editable: false
sourcePath: en/_api-ref-grpc/certificatemanager/v1/privateca/api-ref/grpc/PrivateCa/delete.md
---
...
Request to delete an existing Certificate Authority.
...
The ID of the Certificate Authority that was deleted. ||
|#