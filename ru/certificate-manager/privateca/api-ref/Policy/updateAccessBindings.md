...
editable: false
apiPlayground:
  - url: https://private-ca.certificate-manager.{{ api-host }}/privateca/v1/policies/{resourceId}:updateAccessBindings
    method: patch
    path:
      type: object
      properties:
    ...
    definitions:
      ...
      AccessBindingDelta:
        ...
        required:
          - action
          - accessBinding
sourcePath: en/_api-ref/certificatemanager/v1/privateca/api-ref/Policy/updateAccessBindings.md
---

# Certificate Manager Private CA API, REST: Policy.UpdateAccessBindings

Updates access bindings for the policy.
