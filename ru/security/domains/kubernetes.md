...
Примеры универсальных бесплатных решений для сканирование уязвимостей ОС узлов {{ k8s }} указаны в разделе [Сканирование уязвимостей](../standard/vulnerabilities.md#vulnerability-scanning).
