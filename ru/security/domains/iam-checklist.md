...
&#x2713; **Настройте SSO для внешних систем**: используйте [приложения в {{ org-full-name }}](../../organization/concepts/applications/index.md), если {{ yandex-cloud }} должен выступать как поставщик удостоверений (IdP) для внешних сервисов.
