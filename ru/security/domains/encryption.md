...
- Шифрование бакета Object Storage с помощью ключей KMS (server-side encryption) – рекомендуемый подход. Такое шифрование защищает от случайного или намеренного опубликования содержимого бакета в интернете. См. инструкцию в разделе [{#T}](../../storage/operations/buckets/encrypt.md) документации Object Storage.
