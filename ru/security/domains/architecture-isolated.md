...
* Через подключения {{ interconnect-name }} возможна организация логических соединений как в [облачные сети](../../interconnect/concepts/priv-con.md) клиента, так и к [сервисам](../../interconnect/concepts/pub-con.md) {{ yandex-cloud }} (например, [{{ objstorage-name }}](../../storage)).
