...
Дополнительно возможен {% if lang == "ru" and audience != "internal" %}[анализ](../../glossary/data-analytics.md){% else %}анализ{% endif %} логов {{ objstorage-short-name }} при помощи {{ datalens-short-name }}.
