...
## Шаг 6. Установка {{ k8s }} {#step-6}

1. Выполните команду на первом из списка master-хостов {{ k8s }}:
...
Выполните шаг на первом master-хосте {{ k8s }}.
...
## Шаг 9. Установка {{ objstorage-onprem-name }} {#step-9}
...
На [этапе конфигурации](setup-install-params.md) {{ objstorage-name }} были заданы несколько доменов и IP-адресов. Добавьте соответствующие DNS-записи для разрешения имен:
