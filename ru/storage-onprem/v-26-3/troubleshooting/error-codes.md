...
## Database Driver Error Codes ({{ PG }} SQLSTATE) {#database-driver-error-codes}
...
### {{ PG }} SQLSTATE коды {#postgresql-sqlstate-codes}
...
| `XX000` | ErrInternalError | internal_error | Внутренняя ошибка {{ PG }} | Исследуйте логи приложения |
