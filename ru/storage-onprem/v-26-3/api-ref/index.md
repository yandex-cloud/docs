...
Это руководство описывает, как использовать gRPC API для работы с S3-хранилищем в системе {{ objstorage-onprem-name }}. Основное внимание уделено процессу авторизации.
