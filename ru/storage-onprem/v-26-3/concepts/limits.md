...
В {{ objstorage-onprem-name }} действуют _лимиты_ — технические ограничения, обусловленные особенностями архитектуры. Изменение некоторых лимитов может быть ограничено архитектурой продукта.
