...
{{ objstorage-name }} может быть развернут в одном дата-центре.
...
Клиенты из других дата-центров могут обращаться к {{ objstorage-name }}, если между дата-центрами настроено межсетевое соединение (интерконнект).
