...
description: Партнерский портал — главный инструмент партнера, который позволяет управлять клиентами, отслеживать их потребление, регистрировать сделки и просматривать партнерскую премию.
---
