...
Если вы соответствуете [требованиям](https://yandex.ru/legal/cloud_partnership_requirements/) к партнеру, то после выполнения описанных выше шагов вы станете участником партнерской программы {{ yandex-cloud }} и сможете работать на [Партнёрском портале]({{ link-cloud-partners }}).

Подробнее о работе на портале в [{#T}](portal.md).
...
* Узнайте о [статусах партнера](./specializations/index.md).