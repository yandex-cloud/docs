...
- Партнёрский портал {#partner}
  ...
  1. Войдите на [Партнёрский портал]({{ link-cloud-partners }}) с Яндекс ID, к которому привязан платежный аккаунт партнера в {{ yandex-cloud }}. Если у вас нет доступа, это означает, что учетной записи, с которой вы входите, не присвоен партнерский статус.
...
- Партнёрский портал {#partner}
  ...
  1. Войдите на [Партнёрский портал]({{ link-cloud-partners }}) с Яндекс ID, к которому привязан платежный аккаунт партнера в {{ yandex-cloud }}.
