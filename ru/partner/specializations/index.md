...
Рибейт начисляется за каждый квартал, в течение которого партнер имел действующую специализацию. Начисленные рибейты отображаются в разделе **Баланс начислений** на [Партнёрском портале]({{ link-cloud-partners }}).
