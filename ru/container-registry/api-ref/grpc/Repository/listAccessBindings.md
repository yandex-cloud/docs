---
editable: false
sourcePath: en/_api-ref-grpc/containerregistry/v1/api-ref/grpc/Repository/listAccessBindings.md
---

# Container Registry API, gRPC: RepositoryService.ListAccessBindings {#ListAccessBindings}
