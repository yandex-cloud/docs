...
editable: false
apiPlayground:
  - url: https://container-registry.{{ api-host }}/container-registry/v1/repositories/{resourceId}:updateAccessBindings
    method: post
    path:
      type: object
      properties:
    ...
    definitions:
      ...
      AccessBindingDelta:
        ...
        required:
          - action
          - accessBinding
sourcePath: en/_api-ref/containerregistry/v1/api-ref/Repository/updateAccessBindings.md
---
