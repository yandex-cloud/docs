---
editable: false
sourcePath: en/_api-ref/containerregistry/api-ref/ScanPolicy/getByRegistry.md
---
...
--- | ---
registryId | <p>Required. ID of the registry with scan policy.</p> <p>The maximum string length in characters is 50.</p> 
