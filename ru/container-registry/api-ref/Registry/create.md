...
name | **string**<br><p>Название реестра.</p> <p>Может быть только один реестр в каталоге.</p> <p>Значение должно соответствовать регулярному выражению ``\|[a-z][-a-z0-9]{1,61}[a-z0-9]``.</p> 
