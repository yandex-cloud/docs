...
editable: false
apiPlayground:
  - url: https://container-registry.{{ api-host }}/container-registry/v1/registries/{resourceId}:setAccessBindings
    method: post
    path:
      type: object
      properties:
    ...
    definitions:
      ...
      AccessBinding:
        ...
        required:
          - roleId
          - subject
sourcePath: en/_api-ref/containerregistry/v1/api-ref/Registry/setAccessBindings.md
---

# Container Registry API, REST: Registry.SetAccessBindings
...
```
POST https://container-registry.{{ api-host }}/container-registry/v1/registries/{resourceId}:setAccessBindings
```
