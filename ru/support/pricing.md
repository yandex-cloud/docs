  ...
  - type: card-layout-block
    ...
    children:
      - type: basic-card
        ...
        url: https://yandex.cloud/ru/prices?state=dbf6e8c0da0a#calculator
        size: s
        border: shadow
        centered: true
        indent:
      ...
      - type: basic-card
        ...
        urlTitle: Прайс-лист
        url: https://yandex.cloud/ru/price-list?services=dn2m1lagd9bf5oopu2r0
        size: s
        border: shadow
        centered: true
        indent:
...
При расчете тарифа поддержки в 5% от стоимости потребляемых ресурсов включаются корректировки, подписки и зарезервированное потребление ресурсов платежного аккаунта, привязанного к организации и оплачивающего поддержку. Из расчета тарифа поддержки в 5% от стоимости потребляемых ресурсов исключается стоимость продуктов {{ marketplace-name }}, как показано в [примере расчета](#business-example-one-ba-cvos).
