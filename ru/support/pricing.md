...
- Цены в рублях {#prices-rub}
  ...
  С 1 мая 2026 года фиксированная часть стоимости технической поддержки увеличится до 5 000,00 ₽.
...
- Цены в тенге {#prices-kzt}
  ...
  С 1 мая 2026 года фиксированная часть стоимости технической поддержки увеличится до 25 470,00 ₸.
...
Стоимость складывается из фиксированной и процентной частей. Процентная часть рассчитывается несколько раз в день из учета объема потребленных ресурсов. Сведения о потреблении ресурсов и начислениях доступны в [детализации](../billing/operations/check-charges.md) сервиса {{ billing-name }}.

Цена вычисляется из фиксированной части и из учета потребления ресурсов за текущий отчетный период (календарный месяц). Чтобы рассчитать стоимость фиксированной части, воспользуйтесь [нашим калькулятором](/prices#calculator) или ознакомьтесь со способами расчета в разделах ниже.
...
При расчете тарифа поддержки в 5% от стоимости потребляемых ресурсов включаются корректировки, подписки и зарезервированное потребление ресурсов платежного аккаунта, привязанного к организации и оплачивающего поддержку. Из расчета тарифа поддержки в 5% от стоимости потребляемых ресурсов исключается стоимость продуктов {{ marketplace-name }}. См. [пример расчета](#business-example-one-ba-cvos).
