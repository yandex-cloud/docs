...
Стоимость поддержки по тарифному плану складывается из фиксированной суммы 6 000 ₽ в месяц и дополнительной суммы, которая рассчитывается как доля от стоимости потребленных ресурсов за текущий месяц, если эта стоимость превышает 60 000 ₽.
...
* Если сумма потребления больше 200 000 ₽, дополнительная стоимость складывается из суммы 9 800 ₽ и 5% от разницы между суммой потребления и 200 000 ₽.
...
Цены округлены до второго знака после запятой.
