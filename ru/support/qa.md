...
- БД, созданные в сервисах [Yandex Managed Service for PostgreSQL](../managed-postgresql/), [Yandex Managed Service for ClickHouse](../managed-clickhouse/), [Yandex Managed Service for MongoDB](../managed-mongodb/).
