...
Изменить тарифный план технической поддержки можно в консоли управления {{ yandex-cloud }} в разделе [Поддержка](https://console.cloud.yandex.ru/support?section=plan).
