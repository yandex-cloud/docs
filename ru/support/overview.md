...
- Премиум
  ...
  Тарифом <q>Премиум</q> станет доступен 1 марта 2020 года.
  ...
  * По телефону.
  ...
  С тарифом <q>Премиум</q> помимо технической поддержки Яндекс.Облако выделяет для вас инженера, который может решать более сложные архитектурные и интеграционные задачи. Если запрос слишком сложен, чтобы обработать его силами технической поддержки, задача перейдет к выделенному инженеру.
...
- Базовый
  ...
  Тариф <q>Базовый</q> станет доступен 1 марта 2020 года, когда тариф <q>Стандарт</q> станет платным.
