...
Служба технической поддержки поможет со следующими вопросами:
  ...
  * Консультации по часто возникающим вопросам (в том числе по общим вида <q>Как это работает?</q> и <q>Что это такое?</q>) о  сервисах и функциональных возможностях {{ yandex-cloud }}.
...
* {{ ydb-full-name }} — чат [YDB for {{ yandex-cloud }} (NDA)](https://t.me/joinchat/DmVJUQy61Ehm9ZwPOpVK5Q) (дежурный — `/duty ydb`).
