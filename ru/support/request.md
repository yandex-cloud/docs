...
Чтобы сделать любой из этих запросов, обратитесь в техническую поддержку{% if product == "yandex-cloud" %} через [форму в консоли управления]({{ link-console-support }}) или{% endif %} по электронному адресу [{{ link-support-mail }}](mailto:{{ link-support-mail }}).
