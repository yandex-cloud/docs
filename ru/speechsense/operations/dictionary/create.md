...
Создайте [словарь](../../concepts/dictionaries.md), чтобы поддерживать набор фраз-триггеров в одном месте и переиспользовать этот набор в нескольких [тегах](../../concepts/tags.md). Если в {{ speechsense-name }} были загружены диалоги с фразами-триггерами из словаря, тег с таким словарем будет назначен на диалог.
...
Теперь [добавьте словарь](add.md) в уже существующие теги или укажите его при [создании нового тега](../project/tag/create.md#new-tag).
