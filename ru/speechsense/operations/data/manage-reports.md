...
1. Если нужно, укажите еще параметры оценки с помощью кнопки ![image](../../../_assets/console-icons/plus.svg) **{{ ui-key.yc-ui-talkanalytics.reports.add-parameter }}**.
...
## Использовать смысловые теги для оценки диалога {#use-sense-tags-for-dialog-evaluation}

Вы можете использовать смысловые теги, чтобы оценить качество работы оператора и особенности поведения клиента, например был ли вежливым оператор, хамил ли клиент и т. д. Для этого:
