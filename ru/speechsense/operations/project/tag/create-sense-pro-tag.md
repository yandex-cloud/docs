...
Смысловые Pro-теги — сложный экспертный инструмент {{ speechsense-name }}. Качество его работы зависит от правильности составления промптов. Рекомендуем обязательно пройти курс [Техники работы с промптами](../../../training.md).
