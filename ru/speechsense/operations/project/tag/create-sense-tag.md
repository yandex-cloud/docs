...
Смысловые теги — сложный экспертный инструмент {{ speechsense-name }}. Качество его работы зависит от правильности составления промтов. Рекомендуем обязательно пройти курс [Техники работы с промтами](../../../training.md).
