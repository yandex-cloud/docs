...
Чтобы создавать эффективные поисковые запросы, которые будут использоваться для назначения смысловых Pro-тегов, ознакомьтесь с [Руководством по проектированию промптов](../../ai-studio/gpt-prompting-guide/about.md).
