...
Подписи к параметрам оценки на графике и названия столбцов в таблице и XLSX-файле соответствуют значению поля **{{ ui-key.yc-ui-talkanalytics.reports.parameter.description }}**.
