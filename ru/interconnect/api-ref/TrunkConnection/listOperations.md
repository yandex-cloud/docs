...
is larger than [ListTrunkConnectionOperationsRequest.pageSize](#yandex.cloud.cic.v1.ListTrunkConnectionOperationsRequest), use
the `nextPageToken` as the value
for the [ListTrunkConnectionOperationsRequest.pageToken](#yandex.cloud.cic.v1.ListTrunkConnectionOperationsRequest) query parameter
