...
`light_level_from_cloud_min_dbm` | дБм | float | Минимально возможный для уровень исходящего оптического сигнала от порта на оборудования {{ yandex-cloud }}.
`light_level_from_cloud_max_dbm` | дБм | float | Максимально возможный для уровень исходящего оптического сигнала от порта на оборудования {{ yandex-cloud }}.
