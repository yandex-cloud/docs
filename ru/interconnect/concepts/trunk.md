...
* [Подключение через партнёра](#partner-link) - у вас нет собственного оборудования в ТП и вы используете услуги компании партнёра {{ yandex-cloud }}, который организует для вас подключение к оборудованию {{ yandex-cloud }}.
...
### Партнёрское транковое подключение {#partner-link}

Использование **партнёрского транкового подключения** упрощает подключение к {{ yandex-cloud }} за счёт:
* Сокращения времени подключения услуги CIC.
* Снижения эксплуатационных затрат на организацию кроссировок.

Через партнёрские транковые подключения можно организовывать как [приватные](./priv-con.md), так и [публичные](./pub-con.md) соединения.

{% note info "Инструкция" %}

* Для организации **приватного соединения** через партнёрское транковое подключение необходимо следовать [инструкции](../operations/partner-trunk-priv-add.md).
* Для организации **публичного соединения** через партнёрское транковое подключение необходимо следовать [инструкции](../operations/partner-trunk-pub-add.md).
