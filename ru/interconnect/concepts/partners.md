...
Партнер | ТП | Макс. ёмкость, Мбит/с | Примечания
--- | --- | --- | ---
...
* `Макс. ёмкость` — ёмкость максимального [пакета трафика](./capacity.md) в мегабитах в секунду (`mbps`), который партнер может предоставить клиенту при организации партнерского транкового подключения.
