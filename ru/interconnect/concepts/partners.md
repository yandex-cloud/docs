...
* `Макс. емкость` — максимальная емкость [подключения](../pricing.md) в мегабитах в секунду (`mbps`), который партнер может предоставить клиенту при организации партнерского транкового подключения.
