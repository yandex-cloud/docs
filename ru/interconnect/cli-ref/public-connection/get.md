---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/cic/cli-ref/public-connection/get
editable: false
---
...
`yc cic public-connection get <PUBLIC-CONNECTION-ID>`
...
ID of the PublicConnection resource to return. To get the publicConnection ID use a [PublicConnectionService.List] request. ||
|| `--name` | `string`
