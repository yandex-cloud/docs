...
editable: false
apiPlayground:
  - url: https://cloudrouter.{{ api-host }}/cloudrouter/v1/routingInstances/getByCicPrivateConnectionId/{cicPrivateConnectionId}
    method: get
    path:
      type: object
      properties:
...
```
GET https://cloudrouter.{{ api-host }}/cloudrouter/v1/routingInstances/getByCicPrivateConnectionId/{cicPrivateConnectionId}
```
