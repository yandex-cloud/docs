...
Новые подсети, которые будут созданы в виртуальной сети позднее, не будут анонсироваться в виртуальном маршрутизаторе автоматически.

Для добавления новой подсети в существующий виртуальный маршрутизатор необходимо воспользоваться одним из [доступных способов](../operations/cr-cic-ops.md#ri).

{% note warning %}

Если к виртуальному маршрутизатору подключена виртуальная сеть, в которой используются балансировщики нагрузки [{{ network-load-balancer-short-name }}](../../network-load-balancer/) или [{{ alb-name }}](../../application-load-balancer/), адреса их обработчиков анонсируются в виде IPv4-префиксов с длиной `/32`, независимо от диапазонов анонсируемых IP-префиксов подсетей этой сети.
