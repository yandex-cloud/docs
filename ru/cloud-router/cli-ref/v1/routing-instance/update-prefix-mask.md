---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/cloudrouter/cli-ref/v1/routing-instance/update-prefix-mask
editable: false
---

# yc cloudrouter v1 routing-instance update-prefix-mask
...
`yc cloudrouter v1 routing-instance update-prefix-mask <ROUTING-INSTANCE-ID>`
