...
Резервируемое подключение On-Prem через два [приватных соединения](../../interconnect/concepts/priv-con.md) {{ interconnect-name }} к одному виртуальному маршрутизатору с одной [облачной сетью](../../vpc/concepts/network.md).
