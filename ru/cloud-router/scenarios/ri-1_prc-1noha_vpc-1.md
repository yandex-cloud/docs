...
Нерезервируемое подключение On-Prem через одно [приватное соединение](../../interconnect/concepts/priv-con.md) {{ interconnect-name }} к одному виртуальному маршрутизатору с одной [облачной сетью VPC](../../vpc/concepts/network.md).
...
* [Приватное соединение](../../interconnect/concepts/priv-con.md) `prc-m9`, организованное через [точку присутствия](../../interconnect/concepts/pops.md) `M9`, подключается к виртуальному маршрутизатору в {{ yandex-cloud }}.
