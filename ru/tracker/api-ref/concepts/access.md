...
Протокол OAuth 2.0 позволяет приложениям работать с сервисами Яндекса от имени пользователя. С базовыми принципами OAuth, а также с особенностями реализации протокола в Яндексе вы можете ознакомиться в [документе]({{ link-OAuth-dev-guide }}) "OAuth-авторизация. Руководство Разработчика".
...
1. В запросах к {{ api-short-name }} указывайте заголовки:
