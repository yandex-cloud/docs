...
Параметры задачи
:   Параметры задачи — это такие атрибуты, как <q>Исполнитель</q>, <q>Дедлайн</q>, <q>Статус</q> и так далее. Параметры можно [изменить на странице задачи](user/edit-ticket.md#edit-fields). 
