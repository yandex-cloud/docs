---
sourcePath: ru/tracker/api-ref/concepts/entities/checklists/add-checklist.md
---
# Создать чеклист или добавить в него пункты

Запрос позволяет создать [чеклист](../../../user/checklist.md) и добавить в него новые пункты. Новые пункты добавляются в конец списка.
