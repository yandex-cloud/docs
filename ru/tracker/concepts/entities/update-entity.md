...
Запрос представляет унифицированный метод обновления информации о проектах и портфелях, расширяющий возможности API [обновления информации о проектах](../projects/update-project.md).
...
Параметр | Описание | Тип данных
-------- | -------- | ----------
summary | Новое название сущности. | Строка
