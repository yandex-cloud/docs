...
Запрос позволяет получить список доступных очередей. Если количество очередей в ответе более 50, необходимо использовать механизм [постраничного отображения](#view-pages).
...
## Постраничное отображение результатов {#view-pages}
