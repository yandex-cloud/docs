...
Вы также можете использовать новый, более гибкий и функциональный API [обновления информации о сущности](../entities/update-entity.md), представляющий унифицированный метод обновления информации о проектах и портфелях.
