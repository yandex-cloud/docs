...
Вы также можете использовать новый, более гибкий и функциональный API [создания сущности](../entities/create-entity.md), представляющий унифицированный метод создания проектов и портфелей.
