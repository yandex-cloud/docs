...
Вы также можете использовать новый расширенный API [получения информации о сущности](../entities/get-entity.md), представляющий унифицированный метод получения информации о проектах и портфелях.
