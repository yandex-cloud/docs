...
- Запрос выполнен успешно
  ...
  В случае успешного выполнения запроса API возвращает ответ с кодом `200 OK`. Тело ответа содержит JSON-объект с параметрами задачи, из которой был удален чеклист.
