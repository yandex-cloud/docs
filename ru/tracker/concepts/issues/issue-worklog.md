...
- Запрос выполнен успешно
    ...
    В случае успешного выполнения запроса API возвращает ответ с кодом 200. Тело ответа содержит JSON-массив с записями о времени, затраченном на выполнение задачи.
