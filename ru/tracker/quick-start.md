...
1. На панели слева нажмите ![](../_assets/tracker/svg/boards.svg) **Доски задач** → **Создать доску**.
...
Новая доска доступна в меню ![](../_assets/tracker/svg/boards.svg) **Доски задач** на панели слева.
...
1. Выберите форму для создания задачи: по умолчанию **Без формы**.
...
1. На панели справа настройте список нужных вам полей задачи, например **Тип**, **Исполнитель** и **Дедлайн**.
