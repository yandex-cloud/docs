...
* Вкладка **О проекте**. Описание проекта, статус, сроки работы над проектом, автор и ответственный за проект, список участников команды, комментарии, заказчики, [вехи](milestones.md), [связи](./create-project.md#links) с другими проектами и портфелями, а также теги.
...
* Вкладка **Доска задач**. Виртуальная доска с карточками, на которой удобно отслеживать статусы задач проекта. Подробнее читайте в разделе [{#T}](./boards-project.md).
  ...
  Также доска проекта отображается в разделе ![](../../_assets/tracker/svg/boards.svg)&nbsp;**Доски задач** на панели слева. По умолчанию такая доска имеет название «Доска проекта `<название_проекта>`».
