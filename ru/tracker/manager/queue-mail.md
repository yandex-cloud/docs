...
Настроить почтовый адрес очереди можно, только если к вашей организации в Почте 360 для бизнеса [подключен почтовый домен]({{ support-business-domain }}). Если у вас уже настроен почтовый домен в другом сервисе, вы можете создать для него поддомен и [подключить в Почте 360 для бизнеса]({{ support-business-domain }}).
...
1. Нажмите кнопку **Добавить адрес**.
    Если добавление адреса очереди недоступно, значит у вашей организации нет домена. Домен нужен для создания почтовых ящиков и рассылок, в том числе чтобы создать адрес очереди. Домен можно бесплатно [подключить в Почте 360 для бизнеса]({{ support-business-domain }}).
...
Почтовый адрес очереди используется только для создания задач, комментариев и в качестве обратного адреса при [отправке писем](../user/comments.md#section_zpd_ph5_wdb) внешним пользователям. В него нельзя войти как в обычный почтовый ящик, просмотреть или отправить письма.
...
Чтобы со страницы задачи можно было [отправлять письма](../user/comments.md#section_zpd_ph5_wdb) на почтовые адреса внешних пользователей, включите эту функцию в настройках очереди:
