...
Настроить почтовый адрес очереди можно, только если к вашей организации в Яндекс.Коннекте [подключен почтовый домен]({{ support-connect-domain }}).
...
1. Нажмите кнопку **Добавить адрес**.
    Если добавление адреса очереди недоступно, значит у вашей организации нет домена. Домен нужен для создания почтовых ящиков и рассылок, в том числе чтобы создать адрес очереди. Домен можно бесплатно [подключить в Яндекс.Коннекте]({{ support-connect-domain }}).
