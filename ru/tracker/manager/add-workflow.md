...
Воркфлоу задает допустимые статусы задач и их последовательность. Чтобы добавить в очередь новый воркфлоу, скопируйте уже существующий и отредактируйте [допустимые статусы задач](workflow-status-edit.md) и [правила перехода между статусами](workflow-action-edit.md).
