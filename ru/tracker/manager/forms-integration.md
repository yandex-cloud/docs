...
Опубликованную форму можно [встроить в вики-страницу](../../forms/publish.md#section_xvx_g2c_tbb), [разместить на сайте]{% if audience == "external" %}(../../forms/publish.md#section_c21_gdb_42b){% else %}(../../forms/publish.md#section_c21_gdb_42b) или [добавить на страницу создания задачи](../manager/attach-form.md) в интерфейсе {{ tracker-name }}{% endif %}.
