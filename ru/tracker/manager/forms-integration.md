...
Опубликованную форму можно [встроить в вики-страницу]({{ support-forms-wiki }}), [разместить на сайте]({{ support-forms-embed }}) или [добавить на страницу создания задачи](../manager/attach-form.md) в интерфейсе {{ tracker-name }}.
