...
Создавать новые статусы задач может только администратор организации. Созданный статус нельзя удалить или отредактировать.
...
1. Заполните поля:
   ...
   По умолчанию в {{ tracker-name }} доступны наиболее популярные статусы. Если нужного вам статуса среди них нет, администратор организации может [создать его](#create-status).
