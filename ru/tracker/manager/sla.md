...
1. С помощью фильтров можно выбрать задачи, к которым будет применено правило. По умолчанию включен фильтр «{{ ui-key.startrek-backend.defaults.sla.default.filter.name }}».
...
1. Настройте таймер:
   ...
   * **Стоп** — Задача переведена в статус «В работе».
