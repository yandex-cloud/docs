...
1. Правило может применяться ко всем задачам очереди или к отдельным группам задач. Чтобы добавить новую группу, нажмите кнопку **Создать новый фильтр** и задайте критерии, по которым будут отбираться задачи.

   Чтобы изменить существующую группу, нажмите на значок ![](../../_assets/tracker/icon-edit.png).
...
>
> 3\. Настройте оповещение о срыве срока:
>
>   - **Способ** — Письмо.
>
