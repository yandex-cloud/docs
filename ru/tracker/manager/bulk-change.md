...
1. Нажмите кнопку **Изменить статус** под списком задач и выберите статус. 
...
1. Нажмите кнопку **Переместить** под списком задач.
...
1. Нажмите кнопку **Добавить связь** под списком задач, выберите [тип связи](../user/links.md) и создайте связь:
...
1. Нажмите кнопку ![](../../_assets/horizontal-ellipsis.svg) под списком задач и выберите **Редактировать параметры**.

1. Выберите нужные параметры. Если нужных полей нет в списке, добавьте их с помощью кнопки **Изменить список параметров**.

1. Задайте значения.
   
   Некоторые поля могут содержать список значений (например, поля <q>Наблюдатели</q>, <q>Рассылки</q> или <q>Теги</q>). По умолчанию новые значения дописываются в конец списка. Чтобы перезаписать поле, включите опцию **Удалить значения**.
