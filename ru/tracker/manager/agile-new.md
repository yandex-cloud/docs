...
* На новой доске доступны инструменты для {% if lang == "ru" %}[гибкой разработки]({{ link-wiki-agile }}){% else %}[гибкой разработки]({{ link-wiki-agile-en }}){% endif %}: [бэклог задач](backlog.md), [спринты](create-agile-sprint.md) и [покер планирования](./planning-poker.md).
