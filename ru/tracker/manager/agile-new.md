...
* На новой доске пока недоступны инструменты для [гибкой разработки](agile.md): бэклог задач, спринты, покер планирования и диаграмма сгорания. 
...
* [создайте простую доску задач](agile-new-create.md), включив опцию  **Попробовать новые доски**; 
