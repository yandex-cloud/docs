...
1. Добавьте сотрудников или группы в [список **Права доступа**](#section_bvq_dc3_3z).
...
- Если вы владелец очереди, вы можете увидеть внештатных сотрудников в [настройках доступа очереди](#section_bvq_dc3_3z).
