...
1. Откройте страницу очереди, к которой будет относится проект. Если вы планируете добавить в проект задачи из нескольких очередей, вы сможете сделать это позже.
