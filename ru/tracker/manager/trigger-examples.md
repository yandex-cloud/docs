...
1. Перейдите в сервис [Яндекс.Формы]({{ link-forms }}) и создайте форму. {% if audience == "internal" %}В какой админке создавать форму, [читайте в документации](../../forms/new-form.md##create-form).{% endif %}
