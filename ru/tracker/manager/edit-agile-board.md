...
1. Настройте основные параметры доски:
    ...
    **Параметры фильтра** | Настройки фильтра, с помощью которого на доску автоматически добавляются задачи с заданными параметрами. Фильтр можно задать одним из способов:<br/><ul><li>На вкладке **Условие** задайте параметры отбора.</li><li>На вкладке **Запрос** задайте условия при помощи языка запросов.</li></ul>
