...
1. Чтобы отправить письмо с помощью макроса, переключитесь на вкладку **Письмо** и [настройте его параметры](../user/comments.md#section_zpd_ph5_wdb).
...
1. Нажмите кнопку **Отправить**. Задача будет переведана на вторую линию поддержки.