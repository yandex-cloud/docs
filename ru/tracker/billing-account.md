...
Если вы привязали платежный аккаунт с действующим пробным периодом или создали новый, для вашего аккаунта будет автоматически активирована платная версия — это значит, что с аккаунта можно будет списывать деньги для оплаты сервисов {{ yandex-cloud }}. Если вы еще не использовали стартовый грант, вы сможете использовать его после перехода на платную версию. Подробнее о стартовом гранте читайте в документе [Начало работы в {{ yandex-cloud }}](../getting-started/).
