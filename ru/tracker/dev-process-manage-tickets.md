...
В очереди можно использовать несколько [типов задач](manager/add-ticket-type.md) с разными рабочими процессами. Например, в шаблоне очереди «Базовая разработка» по умолчанию заданы типы «Задача», «Улучшение», «Ошибка», «Релиз» и [«Веха»](manager/milestones.md).
