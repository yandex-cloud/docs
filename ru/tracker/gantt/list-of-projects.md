...
1. Перейдите на [страницу проектов]({{ link-tracker }}pages/projects) или на [панели слева]({{ link-tracker }}) выберите ![](../../_assets/tracker/svg/project.svg)&nbsp;**{{ ui-key.startrek.blocks-desktop_b-queues-info.projects }}** и выберите, какой из списков открыть: **Полный список моих проектов** или **{{ ui-key.startrek.ui_components_NavigationBar_ProjectsPanel.all-projects-link }}**.
