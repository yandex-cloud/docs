...
Отправляйте вашим сотрудникам приглашения в {{ tracker-name }} с помощью виджета. Для входа им потребуется аккаунт на Яндексе. Приглашенные сотрудники могут бесплатно использовать {{ tracker-name }} в режиме [<q>Только чтение</q>](../enable-tracker.md#readonly).
