...
* Если задача была добавлена вручную, очистите значение поля **Доски** на странице задачи.

* Если задача была добавлена на доску автоматически с помощью фильтра, уточните параметры фильтра в [настройках доски](../manager/edit-agile-board.md#board-settings) и затем очистите значение поля **Доски** на странице задачи. 
