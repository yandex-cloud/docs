...
Вы можете настроить вашу [начальную страницу](startpage.md) так, чтобы на ней отображался любой [фильтр](create-filter.md), [дашборд](dashboard.md) или [доска задач](../manager/create-agile-board.md):
