...
В старом интерфейсе вы можете настроить [стартовую страницу](startpage.md) так, чтобы на ней отображался любой [фильтр](create-filter.md), [дашборд](dashboard.md), [доска задач](../manager/create-agile-board.md) или [**Моя страница**](startpage.md#my-page):

1. {% include [open-personal-settings](../../_includes/tracker/open-personal-settings.md) %}

1. В блоке **Стартовая страница** укажите какой фильтр, дашборд или доску задач вы хотите видеть на главной странице. Чтобы сделать стартовой **Мою страницу**, выберите в списке ее.
