...
{% if audience == "internal" %}1. Чтобы отправить письмо с помощью макроса, переключитесь на вкладку **Письмо** и [настройте его параметры](../user/comments.md#section_zpd_ph5_wdb).{% endif %}
