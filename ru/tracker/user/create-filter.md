...
- **Фильтрация по параметрам**
    ...
    Используйте кнопки управления фильтрами по параметрам, которые расположены над списком задач. Чтобы отфильтровать задачи по [резолюции](../manager/create-resolution.md), нажмите кнопку **Резолюция** и выберите нужные значения из списка.
