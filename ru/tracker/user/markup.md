...
Чтобы форматировать текст в описании задачи и в комментариях, используйте визуальный редактор или синтаксис {{ yfm }}.
...
1. Чтобы использовать [разметку {{ yfm }}]({{ yfm-link }}) для оформления текста, нажмите ![](../../_assets/tracker/text-edit/set.svg) и выберите режим **Разметка**.
...
1. Если вы хотите вставить ссылку на файл с устройства, загрузите его на файловый хостинг{% if audience == "internal" %}, например, [Jing](https://jing.yandex-team.ru/){% endif %}.
