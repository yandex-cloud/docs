...
Удалить дашборд может его владелец, администратор организации или пользователь, для которого в настройках дашборда установлено [разрешение](share-dashboard.md#section_k2z_1nk_pz) на **Запись**. 
