...
- Веб-интерфейс
    ...
    * Для поиска задач в списке используйте строку поиска **Поиск по названию задачи** или [добавьте условия поиска](#add-condition).
      ...
      {% if audience == "old" %}  * Чтобы отобразить или скрыть параметры задач, справа над списком нажмите **Настроить столбцы**, выберите параметры и нажмите кнопку **Сохранить**.{% endif %}
    ...
    * Чтобы сгруппировать задачи по определенному параметру, справа от строки поиска нажмите ![](../../_assets/tracker/svg/group.svg) **Без группировки** и выберите параметр.
      ...
      {% if audience == "old" %}  * Чтобы построить для списка задач [диаграмму Ганта](../manager/gantt.md), в правом верхнем углу страницы нажмите значок ![](../../_assets/tracker/gantt-ico.png).{% endif %}
