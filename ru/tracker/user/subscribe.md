...
## Подписаться на цель {#section_as4_ny4_xgb}

Чтобы отслеживать задачи, связанные с определенной целью, подпишитесь на нее:

1. Откройте [страницу очереди](queue.md).

1. Перейдите на вкладку **Цели**.

1. Нажмите на значок ![](../../_assets/tracker/subscribtion.png) в строке с целью.
