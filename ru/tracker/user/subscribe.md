...
Для ваших уведомлений и подписок вы можете [настроить содержимое](notification-settings.md#section_iqn_y55_xgb), чтобы получать письма только об интересующих вас событиях.
...
1. Нажмите на значок ![](../../_assets/tracker/subscribtion.png) строке с целью.
