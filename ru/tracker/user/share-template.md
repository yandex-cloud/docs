...
1. [Настройте общий доступ к шаблону](share-template.md#section_nmn_prs_zz). Вы можете настроить доступ для отдельных пользователей{% if audience == "internal" %}, команд, отделов{% endif %} или всей организации.
