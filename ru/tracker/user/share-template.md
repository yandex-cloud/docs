...
1. [Настройте общий доступ к шаблону](share-template.md#section_nmn_prs_zz). Вы можете настроить доступ для отдельных пользователей, команд{% if audience == "external" %}, отделов или всей организации{% else %} или отделов{% endif %}.
