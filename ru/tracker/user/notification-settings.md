...
1. На верхней панели {{ tracker-name }} нажмите ваш портрет и выберите **Персональные настройки**, затем нажмите кнопку **Настройки уведомлений**.

    {% note info %}

    Вы также можете перейти по ссылке [https://st.yandex-team.ru/subscriptions/roles]({{ link-sub-roles-ya }}).
...
1. Перейдите на вкладку **Подписки**.
    ...
    Вы также можете перейти по ссылке [https://st.yandex-team.ru/subscriptions/manage]({{ link-sub-manage-ya }}).
