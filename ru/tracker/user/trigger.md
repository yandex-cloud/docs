...
С помощью триггера можно автоматически [назначать исполнителей для задач](../manager/trigger-examples.md#assign_ticket){% if audience == "internal" %}, [отправлять письма о создании задач по обращениям пользователей](../manager/trigger-examples.md#notify_mail){% endif %} или [отправлять уведомления из {{ tracker-name }} в мессенджер](../messenger.md).
