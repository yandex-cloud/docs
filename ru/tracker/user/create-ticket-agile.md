...
Если вы пользуетесь досками задач, вам может быть удобно создавать задачи сразу на нужной доске. Задачу можно создать определенном в спринте или поместить ее в беклог. Для задачи нужно указать только ее название и тип — остальные поля вы сможете заполнить позже.
