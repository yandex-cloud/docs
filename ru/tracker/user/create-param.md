...
Если нужного вам параметра среди них нет, вы можете [создать новое поле в вашей очереди](create-param.md#section_local_field). Если нужно добавить поле, которые будет доступно во всех очередях {{ tracker-name }}, администратор организации может [создать глобальное поле](create-param.md#section_global_field).
