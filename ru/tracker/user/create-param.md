...
{% if audience == "internal" %}Рассылки | Команды и отделы, подписанные на задачу.<br/><br/>По умолчанию участники таких команд имеют доступ к задаче на чтение и редактирование и получают уведомления о любых ее изменениях.<br/><br/>Правила доступа к задачам зависят от [настроек очереди](../manager/queue-access.md), уточняйте их у ее владельца.{% endif %}
