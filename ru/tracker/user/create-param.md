...
Чтобы добавить новое глобальное поле задачи, закажите его через [форму](https://forms.yandex-team.ru/surveys/14549/). Обращения обрабатываются в течение 2-3 рабочих дней. Если задача срочная, поднимите ее приоритет до <q>критичного</q> и напишите в комментариях, почему это срочно.
