...
1. Нажмите кнопку **{{ ui-key.startrek.blocks-desktop_issue-reminder.save-btn }}**. На странице задачи появится иконка ![](../../_assets/tracker/svg/reminder.svg) со счетчиком уведомлений.
...
1. Введите информацию о событии в календаре, при необходимости добавьте участников встречи и нажмите **{{ ui-key.startrek.blocks-desktop_b-form-new-component.button-create }}**.
