...
1. В правом верхнем углу выберите **Действия** → **Добавить напоминание**.
...
1. В правом верхнем углу выберите **Действия** → **Создать событие в календаре**{% if audience == "external" %} → **Зарезервировать время для работы над задачей**.{% else %} и выберите вариант:
   * Чтобы создать запись о работе над задачей, выберите **Зарезервировать время для работы над задачей**.
   * Чтобы пригласить на встречу автора и исполнителя, нажмите **Встреча с автором и исполнителем**.
   * Чтобы пригласить на встречу также и наблюдателей, нажмите **Встреча со всеми участниками задачи**.
   {% endif %}
