...
Также информацию об API можно найти:

- [В документации на Вики.](https://wiki.yandex-team.ru/tracker/api/)
- [В автоматически сгенерированной документации.](https://st-api.yandex-team.ru/docs/)
