...
Задачи будут создаваться в очереди, в которой настроено автообновление. Автором задачи будет {% if audience == "external" %}Робот сервиса Tracker{% else %}робот Яндекс Трекер{% endif %}.
