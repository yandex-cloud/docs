...
1. Чтобы найти задачи, для которых вы являетесь автором, исполнителем или наблюдателем, выберите фильтр **Все мои задачи**.
...
* Чтобы использовать [дополнительные параметры поиска](./default-filters.md#add-condition), нажмите кнопку ![](../../_assets/tracker/svg/add-filter.svg) **Добавить поле для фильтрации** и выберите поле.
...
1. В поле **Найти задачу по названию** введите текст для поиска.

Поиск задачи по названию осуществляется с учетом указанных фильтров.
