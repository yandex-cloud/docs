...
Чтобы найти задачи, над которыми вы работаете, на верхней панели {{ tracker-name }} выберите **Задачи** → **Все задачи**. Откроется [страница фильтра](default-filters.md) со списком задач, для которых вы являетесь автором, исполнителем или наблюдателем.
