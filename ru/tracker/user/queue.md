...
По умолчанию на странице очереди отображаются только активные задачи (опция **Резолюция: Без значения**). Вы можете настроить отображение задач с помощью кнопок [быстрых фильтров](../manager/quick-filters.md) над списком задач.
...
{% if audience == "old" %}
## Сохранить список на {{ wiki-full-name }} {#save-list}
