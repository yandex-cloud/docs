...
- Веб-интерфейс
    ...
    1. Заполните поле **Описание**. Для форматирования текста используйте [разметку YFM](markup.md).
...
- Мобильное приложение
    ...
    1. [Отредактируйте](edit-ticket.md) информацию о задаче:
        ...
        - На вкладке **Параметры** укажите [дополнительные параметры](create-param.md#section_ymd_ycj_1gb) задачи.
