...
- Мобильное приложение
    ...
    1. [Отредактируйте](edit-ticket.md) информацию о задаче:
        ...
        - На вкладке **Описание** укажите основные параметры: добавьте описание, выберите тип и приоритет задачи, укажите исполнителя и установите дедлайн. Для форматирования текста используйте [вики-разметку](wiki-markup.md).
