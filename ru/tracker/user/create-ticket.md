...
1. Если ваша задача связана с другими задачами, перечислите их в поле **Связи**.

1. При необходимости задайте [дополнительные параметры](create-param.md#section_ymd_ycj_1gb). Для этого добавьте поля с помощью кнопки ![](../../_assets/tracker/task-params-btn.png) и заполните их.
...
1. Нажмите на кнопку **Получить ссылку на заполненную форму** внизу страницы создания задачи.
