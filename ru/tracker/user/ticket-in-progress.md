...
Приступая к задаче, переведите ее в новый статус (обычно это статус «В работе»). Статус показывает состояние задачи и помогает пользователям {{ tracker-name }} отслеживать ее выполнение. Текущий статус отображается на панели справа.
