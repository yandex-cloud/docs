...
По умолчанию список ваших задач доступен [на стартовой странице](startpage.md) или в меню **Задачи** → **Все мои задачи**. Чтобы начать работать с задачей, перейдите на ее страницу.
