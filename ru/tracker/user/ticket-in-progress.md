...
> Задачу, над которой вы работаете, решили отменить. Чтобы зафиксировать это в {{ tracker-name }}, переведите задачу в статус <q>Закрыт</q> и укажите резолюцию <q>Отменен</q>.
