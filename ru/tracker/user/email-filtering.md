...
X-Startrek-Changed | Измененные поля. Присутствует только в том случае, если поля менялись, при клонировании и создании задачи отсутствует. | Followers,Type,Queue,Key,Tags
...
X-Startrek-FingerPrint | Хэш MAC-адреса бекенда | 2b953364
