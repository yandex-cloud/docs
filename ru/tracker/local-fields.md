...
Чтобы получить или изменить значение локального поля в задаче через [API {{ tracker-name }}](about-api.md), в теле запроса укажите его идентификатор вида `603fb94c38bbe658d04da2e6--<ключ поля>`.
