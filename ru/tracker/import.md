...
1. Создайте технический аккаунт для доступа к {{ api-name }}:
   ...
   1. Перейдите в сервис [Яндекс 360 для бизнеса]({{ link-ya-360 }}) и дайте созданному аккаунту права администратора организации. Подробнее читайте в [Справке Яндекс 360]({{ support-business-admin }}).
...
1. Напишите в [техническую поддержку]({{ link-tracker-support}}) запрос на миграцию из Jira в {{ tracker-name }}. В запросе укажите:
   ...
   * учетные данные технического аккаунта с правами администратора организации.
