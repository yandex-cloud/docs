...
Организации, которые подключили {{ tracker-full-name }} с {{ release-date }} до {{ promo-end-date }} 2021 года, смогут бесплатно использовать сервис в течение первого месяца.
