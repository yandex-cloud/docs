...
|| **Количество организаций у одного пользователя** | Доменные пользователи могут состоять только в одной организации. | Пользователь может состоять во множестве организаций. ||
|| **Подключение домена** | Можно [создать](https://yandex.ru/support/business/domains/add-domain.html) домен для организации. | Создание домена недоступно. ||
...
|| **Права администратора организации** | Администратор {{ ya-360 }} становится администратором {{ tracker-name }}. | Чтобы администратор {{ org-full-name }} стал администратором {{ tracker-name }}, надо выдать ему дополнительную роль. ||
