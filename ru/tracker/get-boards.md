...
## Формат запроса {#section_ong_my2_nfb}
...
## Формат ответа {#section_psx_llf_nfb}

{% list tabs %}

- Запрос выполнен успешно

    В случае успешного выполнения запроса API возвращает ответ с кодом 200. Тело ответа содержит JSON-массив с параметрами всех досок, созданных пользователями организации.
