...
1. В блоке **Яндекс 360 для бизнеса** нажмите **Подключить**. Откроется окно с вашими организациями. Вы можете создать новую организацию или перейти в существующую.
