...
Чтобы получить параметры всех макросов очереди, используйте HTTP-запрос с методом
 `GET`:
...
- Запрос выполнен успешно
    ...
    В случае успешного выполнения запроса API возвращает ответ с кодом 200. Тело ответа содержит JSON-массив с параметрами всех макросов очереди.
