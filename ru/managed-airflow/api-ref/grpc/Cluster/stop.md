---
editable: false
sourcePath: en/_api-ref-grpc/airflow/v1/api-ref/grpc/Cluster/stop.md
---

# Managed Service for Apache Airflow™ API, gRPC: ClusterService.Stop {#Stop}

Stops the specified Apache Airflow cluster.

## gRPC request

**rpc Stop ([StopClusterRequest](#yandex.cloud.airflow.v1.StopClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## StopClusterRequest {#yandex.cloud.airflow.v1.StopClusterRequest}
...
|| metadata | **[StopClusterMetadata](#yandex.cloud.airflow.v1.StopClusterMetadata)**
...
## StopClusterMetadata {#yandex.cloud.airflow.v1.StopClusterMetadata}
