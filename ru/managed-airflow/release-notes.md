...
* Добавлена возможность совершать операции над кластером {{ AF }} с помощью [CLI {{ yandex-cloud }}](../cli/cli-ref/managed-services/managed-airflow/index.md), [{{ TF }}](tf-ref.md) и [API](api-ref/authentication.md).
