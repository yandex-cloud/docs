...
В {{ at-name }} поддерживается отслеживание событий уровня конфигурации (Control Plane) для {{ maf-full-name }}. Подробнее на странице [{#T}](../audit-trails/concepts/format.md).
