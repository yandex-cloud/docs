...
На стадии тестирования альфа-версии использование сервиса [!KEYREF mrd-name] не тарифицируется. Вы можете создавать кластеры баз данных, пользоваться хранилищем и резервными копиями в рамках [квот и лимитов](concepts/limits.md).
