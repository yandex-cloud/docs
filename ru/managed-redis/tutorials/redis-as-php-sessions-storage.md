...
1. Настройте группу безопасности {{ vpc-name }}. Добавьте разрешения для протокола TCP в группу безопасности:
...
{% if audience != "internal" %}Подробнее см. [{#T}](../../vpc/concepts/security-groups.md).

    1. [Создайте виртуальную машину с LAMP/LEMP](../../solutions/web/lamp-lemp.md#create-vm) в {{ compute-full-name }} любой подходящей вам конфигурации.
...
{% else %}
    ...
    1. Создайте виртуальную машину с LAMP/LEMP в {{ compute-full-name }} любой подходящей вам конфигурации.
