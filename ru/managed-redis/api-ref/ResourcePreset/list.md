...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-redis/v1/resourcePresets
    method: get
    path: null
    query:
      type: object
      properties:
        pageSize:
          description: |-
            **string** (int64)
            ...
            results is larger than `pageSize`, the service returns a [ListResourcePresetsResponse.nextPageToken](/docs/managed-redis/api-ref/ResourcePreset/list#yandex.cloud.mdb.redis.v1.ListResourcePresetsResponse)
        ...
        pageToken:
          description: |-
            **string**
            Page token. To get the next page of results, set `pageToken` to the [ListResourcePresetsResponse.nextPageToken](/docs/managed-redis/api-ref/ResourcePreset/list#yandex.cloud.mdb.redis.v1.ListResourcePresetsResponse)
