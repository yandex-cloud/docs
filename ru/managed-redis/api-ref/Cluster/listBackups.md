    ...
    query:
      ...
      properties:
        pageSize:
          description: |-
            **string** (int64)
            ...
            results is larger than `pageSize`, the service returns a [ListClusterBackupsResponse.nextPageToken](/docs/managed-redis/api-ref/Cluster/listBackups#yandex.cloud.mdb.redis.v1.ListClusterBackupsResponse)
        ...
        pageToken:
          description: |-
            **string**
            Page token.  To get the next page of results, set `pageToken` to the [ListClusterBackupsResponse.nextPageToken](/docs/managed-redis/api-ref/Cluster/listBackups#yandex.cloud.mdb.redis.v1.ListClusterBackupsResponse)
