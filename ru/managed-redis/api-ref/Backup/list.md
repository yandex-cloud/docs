    ...
    query:
      ...
      properties:
        ...
        pageSize:
          description: |-
            **string** (int64)
            ...
            results is larger than `pageSize`, the service returns a [ListBackupsResponse.nextPageToken](/docs/managed-redis/api-ref/Backup/list#yandex.cloud.mdb.redis.v1.ListBackupsResponse)
        ...
        pageToken:
          description: |-
            **string**
            Page token. To get the next page of results, set `pageToken` to the [ListBackupsResponse.nextPageToken](/docs/managed-redis/api-ref/Backup/list#yandex.cloud.mdb.redis.v1.ListBackupsResponse)
