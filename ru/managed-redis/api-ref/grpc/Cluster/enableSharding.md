---
editable: false
sourcePath: en/_api-ref-grpc/mdb/redis/v1/api-ref/grpc/Cluster/enableSharding.md
---

# Managed Service for Redis API, gRPC: ClusterService.EnableSharding {#EnableSharding}

Enable Sharding on non sharded cluster

## gRPC request

**rpc EnableSharding ([EnableShardingClusterRequest](#yandex.cloud.mdb.redis.v1.EnableShardingClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## EnableShardingClusterRequest {#yandex.cloud.mdb.redis.v1.EnableShardingClusterRequest}
