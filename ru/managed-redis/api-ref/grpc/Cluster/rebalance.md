---
editable: false
sourcePath: en/_api-ref-grpc/mdb/redis/v1/api-ref/grpc/Cluster/rebalance.md
---

# Managed Service for Redis API, gRPC: ClusterService.Rebalance {#Rebalance}

Rebalances the cluster. Evenly distributes all the hash slots between the shards.

## gRPC request

**rpc Rebalance ([RebalanceClusterRequest](#yandex.cloud.mdb.redis.v1.RebalanceClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## RebalanceClusterRequest {#yandex.cloud.mdb.redis.v1.RebalanceClusterRequest}
