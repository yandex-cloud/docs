...
Поле | Описание
--- | ---
backup_id | **string**<br>Обязательное поле. Идентификатор резервной копии Redis, информацию о которой нужно запросить. Чтобы получить идентификатор резервной копии, используйте запрос [ClusterService.ListBackups](./cluster_service#ListBackups). false
...
Поле | Описание
--- | ---
backups[] | **[Backup](../backup.proto#Backup1)**<br>Запрошенный список резервных копий. 
