---
title: Миграция хостов кластера {{ VLK }} в другую зону доступности
description: Следуя данной инструкции, вы сможете переместить хосты кластера {{ VLK }} в другую зону доступности.
---

# Миграция хостов кластера {{ VLK }} в другую зону доступности
