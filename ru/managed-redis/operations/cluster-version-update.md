...
С 1 июня 2022 года прекращена поддержка {{ RD }} версии 5.0. Создать кластер с этой версией невозможно. Рекомендуется самостоятельно обновить кластер до более новой версии {{ RD }}. Если у вас возникли трудности при обновлении с версии 5.0 на 6.0, обратитесь в [техническую поддержку]({{ link-console-support }}).
