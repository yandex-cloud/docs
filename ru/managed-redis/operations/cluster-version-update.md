...
Каждая версия {{ RD }}, поддержка которой была включена в {{ mrd-name }}, остается доступной, пока она поддерживаются производителем. Как правило это 24 месяца с даты выпуска версии. Подробнее см. в [документации {{ RD }}](https://redis.io/docs/about/releases/).

С 1 июня 2022 года поддержка {{ RD }} версии 5.0 прекращается. Создать кластер с этой версией будет невозможно. Рекомендуется самостоятельно обновить кластер до более новой версии {{ RD }}. Если у вас возникли трудности при обновлении с версии 5.0 на 6.0, обратитесь в [техническую поддержку]({{ link-console-support }}).

В момент релиза версии 7.0 пользователям кластеров {{ mrd-name }}, использующих версию 5.0, будет отправлено уведомление с предложением обновиться до минимальной поддерживаемой версии — 6.0. Через месяц после этой даты кластеры {{ RD }} версии 5.0 будут автоматически обновлены до версии 6.0.
