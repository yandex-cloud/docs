---
title: Как подключиться к нешардированному кластеру {{ RD }} в {{ mrd-full-name }}
description: Следуя данной инструкции, вы сможете подключиться к нешардированному кластеру {{ RD }}.
---

# Подключение к нешардированному кластеру {{ RD }}

К нешардированному кластеру {{ RD }} можно подключиться:

* С помощью {{ RD }} Sentinel.
    ...
    Подробнее о Sentinel см. в разделе [{#T}](../../concepts/replication.md) и [документации {{ RD }}](https://valkey.io/topics/sentinel).
...
- DBeaver {#dbeaver}
    ...
    Поддержка подключения к кластеру {{ RD }} доступна только в [коммерческих редакциях DBeaver](https://dbeaver.com/buy/).
