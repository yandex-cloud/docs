# Подключение к шардированному кластеру {{ RD }}

Для подключения к [шардированному](../../concepts/sharding.md) кластеру {{ RD }} в строках подключения укажите FQDN хостов-мастеров в каждом шарде.
