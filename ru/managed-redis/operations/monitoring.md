---
title: Мониторинг состояния кластера {{ RD }} и хостов
...
- Консоль управления {#console}
  ...
  * **Inner memory limit** — объем оперативной памяти, доступной для использования процессами {{ RD }} (в байтах):
      ...
      * **used_memory** — фактическое использованием памяти на хосте.
      ...
      Значение параметра **maxmemory** для хостов {{ RD }} устанавливается в размере {{ mrd-memory-used }} от объема доступной памяти. Подробнее см. в разделе [Управление памятью](../concepts/memory-management.md).
