...
- Консоль управления
  ...
  1. Укажите параметры хоста:
      ...
      * подсеть (если нужной подсети в списке нет, [создайте ее](../../vpc/operations/subnet-create.md)).
      ...
      {% if audience == "internal" %} * если вы добавляете хост в шардированный кластер, выберите шард. {% endif %}
...
- CLI
  ...
  1. Выполните команду добавления хоста:
     ...
     {% if audience == "internal" %} Если вы добавляете хост в шардированный кластер, укажите в параметре `shard-name` имя шарда, куда следует добавить хост.{% endif %}
