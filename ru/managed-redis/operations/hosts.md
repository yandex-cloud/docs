...
Вы можете добавлять, изменять и удалять хосты кластера, а также запрашивать список хостов в выбранном кластере.
...
Публичный доступ доступен только для кластеров, в которых включена поддержка TLS. Включить поддержку TLS можно только при создании кластера.
