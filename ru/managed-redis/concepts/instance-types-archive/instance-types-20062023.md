---
title: Классы хостов Managed Service for Redis до 20 июня 2023 года
...
Размер доступного хосту хранилища должен как минимум в два раза превышать выбранный объем памяти. Технические и организационные ограничения Managed Service for Redis приведены в разделе [Квоты и лимиты](../limits.md).
