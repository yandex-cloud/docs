...
Sentinel применяется только для кластеров с {{ RD }} версии 6.2. Для отказоустойчивости кластеров с {{ RD }} 7.0 [используется агент](switchover.md) `rdsync`.
