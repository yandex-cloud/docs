...
Redis — высокопроизводительная СУБД для данных типа «ключ-значение», работающая в оперативной памяти. Сервис Managed Service for Redis позволяет легко создавать кластеры хостов Redis с высокой отказоустойчивостью.

Основная сущность, которой оперирует сервис Managed Service for Redis, — _кластер баз данных_.
