...
* В кластере без шардирования используется {{ RD }} Sentinel: сервисы Sentinel выполняют мониторинг состояния мастера и реплик, уведомляют о нарушениях в работе хостов, управляют выбором нового мастера и реконфигурацией реплик.
