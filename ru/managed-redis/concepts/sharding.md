...
{{ mrd-name }} позволяет создать от 3 до 10 шардов, каждый из которых может включать в себя разное количество хостов. Минимальное количество хостов в шарде зависит от [выбранного типа хранилища](./storage.md#storage-type-selection).
