...
{{ mrd-name }} позволяет создать от 3 до 10 шардов, каждый из которых может включать в себя:

- от 1 до 7 хостов при использовании сетевого хранилища;

- от 2 до 7 хостов при использовании локального хранилища.
