...
[Шардирование](../../glossary/sharding.md) в {{ mrd-name }} реализовано с помощью [{{ RD }} Cluster](https://valkey.io/topics/cluster-tutorial).
...
Более подробно шардирование баз {{ RD }} рассмотрено в [документации {{ RD }}](https://valkey.io/topics/cluster-spec/).
