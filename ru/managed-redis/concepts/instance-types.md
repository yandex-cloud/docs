...
* Для небольших объемов данных и невысокой нагрузки можно создавать кластеры с низкой гарантией производительности (`burstable`) аналогично виртуальным машинам c [частичным использованием ядра](../../compute/concepts/performance-levels.md).
