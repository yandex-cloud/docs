...
Для Managed Service for Redis классы хостов определяются уровнем производительности процессора и объемом оперативной памяти:
...
Размер доступного хосту жесткого диска должен как минимум в два раза превышать выбранный объем памяти. Технические и организационные ограничения Managed Service for Redis приведены в разделе [#T](limits.md).
