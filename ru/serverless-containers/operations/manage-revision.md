...
Для сохранения целостности связей изменение и удаление ревизий контейнера не предусмотрено. При создании новой ревизии контейнера предыдущая ревизия становится устаревшей и больше недоступна для вызова.
