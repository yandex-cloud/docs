---
title: "Просмотр журнала выполнения в Yandex Serverless Containers"
description: "Вы можете посмотреть график мониторинга в Yandex Serverless Containers с помощтю консоли управления. Для этого выберите сервис Serverless Containers, нажмите на контейнер, журнал выполнения которого вы хотите посмотреть. В открывшемся окне перейдите в раздел Логи и укажите период. По умолчанию задан период за 1 час. Логи выполнения контейнера хранятся 14 дней. Время в журнале указано по UTC."
---
