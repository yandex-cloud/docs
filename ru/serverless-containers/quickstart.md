...
2. Загрузите ревизию контейнера:

	{% note info %}

	Для загрузки ревизии сделайте образ публичным или передайте в команде [идентификатор сервисного аккаунта](../iam/operations/sa/get-id.md), у которого есть права на скачивание образа.
