---
editable: false
sourcePath: en/_api-ref-grpc/serverless/containers/v1/containers/api-ref/grpc/Container/updateAccessBindings.md
---

# Serverless Containers Service, gRPC: ContainerService.UpdateAccessBindings {#UpdateAccessBindings}
