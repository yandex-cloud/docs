...
В {{ at-name }} поддерживается отслеживание событий уровня конфигурации (Control Plane) для {{ serverless-containers-full-name }}. Подробнее в [{#T}](../audit-trails/concepts/format.md).
