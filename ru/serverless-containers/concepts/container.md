...
Можно [изменить](../operations/manage-revision.md##create) максимальное количество одновременных вызовов одного экземпляра контейнера и [указать](../operations/scale.md) количество подготовленных экземпляров контейнера.
...
* [Добавить настройки масштабирования.](../operations/scale.md#add)
