...
## Особенности вызова контейнера триггером {#invoke}  <!--проверь адекватность этого раздела-->

Триггеры вызывают контейнер c учетом установленных [квот и лимитов](../limits.md).
