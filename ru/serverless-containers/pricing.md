...
На стадии [Preview](../overview/concepts/launch-stages.md) использование сервиса {{ serverless-containers-name }} не тарифицируется.

После перехода сервиса в общий доступ начнется учет потребляемых ресурсов, но до **23 сентября 2021** включительно потребление ресурсов {{ serverless-containers-name }} не будет тарифицироваться. С **24 сентября 2021** потребление станет платным.
