---
title: Поставка данных из {{ forms-full-name }} в {{ datalens-full-name }} с использованием {{ sf-full-name }} и {{ yq-full-name }} при помощи {{ TF }}
description: Настройте автоматическую поставку данных из {{ forms-name }} в {{ datalens-name }} с использованием {{ sf-name }} и {{ yq-name }} при помощи {{ TF }}.
