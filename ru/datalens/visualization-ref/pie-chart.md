...
Диаграмма показывает отношение между категориями в виде сегментов (секторов) круга. Площадь всего круга — это сумма всех категорий, равна 100%. Площадь каждого сегмента — доля категории в общей сумме. 

Круговые диаграммы подходят для показа пропорций небольшого количества сегментов.
...
{% cut "Несколько мелких секторов, которые относятся к более крупной категории, можно выделить одним цветом" %}
...
* **Сегементы.** Объединяйте мелкие сегменты в более крупные группы:
