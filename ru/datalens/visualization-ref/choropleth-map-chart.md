...
Чтобы показать полигоны на карте, добавьте в датасет поле с типом данных [Геополигон](../../concepts/data-types#geopolygon):
...
----- | ----
Полигоны (Геополигоны) | Измерение с типом [Геополигон](../../concepts/data-types#geopolygon).
