...
{% if product == "yandex-cloud" %}* Если у вас в данных есть поле с названием городов, регионов или стран, используйте [справочник геоточек/геополигонов](https://geointellect.com/files/geo_for_datalens.zip) нашего партнера Геоинтеллект.{% endif %}

По [ссылке](https://{{ s3-storage-host }}/doc-files/Regions.csv) можно скачать пример CSV-файла с полигонами регионов РФ.
