...
### Добавление подсказки к строке таблицы {#hint-column}
...
Когда опция включена, в чарте и на дашборде рядом с названием строки появляется значок ![image](../../_assets/console-icons/circle-question.svg). При наведении курсора на значок отображается всплывающая подсказка.
