...
* В строке **Итого** пока не работают расчеты с помощью [LOD-выражений](../concepts/lod-aggregation), [оконных функций](../function-ref/window-functions.md) и [функций для работы с временными рядами](../function-ref/time-series-functions.md). 
