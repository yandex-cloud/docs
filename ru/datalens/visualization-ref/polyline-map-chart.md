...
* Координаты точек линий — с типом данных [Геоточка](../concepts/data-types#geopoint). Каждая точка каждой полилинии должна храниться в датасете отдельной строкой.
