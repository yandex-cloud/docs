...
Таблицы подходят для детальной [аналитики]({{ link-docs }}/glossary/data-analytics) (глубокого погружения в цифры), помогают найти проблемы.
...
{% cut "Настройка выравнивания столбцов" %}

1. В правом верхнем углу секции **Столбцы** нажмите значок ![image](../../_assets/console-icons/gear.svg) (значок появляется при наведении указателя на секцию).
1. В открывшемся окне выберите выравнивание для каждого столбца:

   * `Авто` — автоматическое выравнивание столбца;
   * ![image](../../_assets/console-icons/text-align-left.svg) — выравнивание по левому краю;
   * ![image](../../_assets/console-icons/text-align-center.svg) — выравнивание по центру;
   * ![image](../../_assets/console-icons/text-align-right.svg) — выравнивание по правому краю.

1. Нажмите кнопку **Применить**.

   {% cut "Пример настроек выравнивания столбцов" %}
...
Закрепить можно несколько столбцов в левой части таблицы:

1. В правом верхнем углу секции **Столбцы** нажмите значок ![image](../../_assets/console-icons/gear.svg) (значок появляется при наведении указателя на секцию).
1. В открывшемся окне напротив названия крайнего правого столбца для закрепления нажмите ![image](../../_assets/console-icons/pin.svg). Этот столбец и все столбцы слева от него будут оставаться на месте при горизонтальной прокрутке.
1. Нажмите кнопку **Применить**.
...
1. Укажите **Тип заливки**:
   ...
   * Заливка не поддерживается для строки **Итого**.
