...
Подробнее в [стилизации](index.md#stilizaciya).
* `ChartKit.setSettings` разделен на  `ChartKit.setGeneralSettings` и `ChartKit.setDataProviderSettings`.
Подробнее в [общих настройках](index.md#obshie-nastrojki) и [настройках провайдера данных Charts](index.md#nastrojki-provajdera-dannyh-charts).
* Новые настройки в `props`.
Подробнее в [доступных свойствах](index.md#dostupnye-svojstva).
