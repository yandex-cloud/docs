...
Для чартов и дашбордов, опубликованных в {{ datalens-public }}, действует дополнительное кеширование, поэтому для них время жизни кеша составляет не менее 5 минут.
