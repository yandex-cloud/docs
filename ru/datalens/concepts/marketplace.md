...
* **Геослои** — датасеты с привязкой к геоданным (регионы, города, районы и более детальные локации города). На их основе вы можете создавать различные [карты](chart.md#map-chart) и добавлять их на дашборды.
