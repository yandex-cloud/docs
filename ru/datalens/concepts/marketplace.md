...
{{ datalens-short-name }} {{ marketplace-short-name }} доступен на [специальной странице в {{ datalens-short-name }}](https://datalens.yandex.ru/marketplace/) и на странице [Yandex {{ marketplace-name }}](https://cloud.yandex.ru/marketplace?type=datalens) во вкладке **Анализ данных**.
...
*  Датасеты, Геослои или Темплейты — на главной странице [{{ marketplace-short-name }}](https://cloud.yandex.ru/marketplace) нажмите кнопку **Предложить продукт** и заполните заявку.
