...
{{ datalens-short-name }} {{ marketplace-short-name }} доступен на [специальной странице в {{ datalens-short-name }}](https://datalens.yandex.ru/marketplace/) и на странице [Yandex {{ marketplace-name }}](/marketplace?tab=datalens) во вкладке **Анализ данных**.
...
*  Датасеты, Геослои или Темплейты — на главной странице [{{ marketplace-short-name }}](/marketplace) нажмите кнопку **Предложить продукт** и заполните заявку.
