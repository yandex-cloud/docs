...
Вы можете разместить поясняющий текст, ссылки, таблицу или выделить значимые моменты с помощью форматирования.
...
будет отобраться как фрагмент кода на языке Kotlin с подсветкой:
