...
Передать значение параметра в визардный чарт можно с помощью guid поля ([см. инструкцию](../operations/chart/add-guid.md)).
...
* текст SQL-запроса, который был отправлен в источник (если источник сообщил такую информацию).
