...
[!KEYREF datalens-full-name] содержит следующие типы виджетов:
...
Вы можете настроить права доступа к дашбоду. Подробнее в разделе [[!TITLE]](../security/index.md).
