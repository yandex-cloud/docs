...
Связь определяет влияние селектора на один или несколько чартов. По умолчанию селекторы влияют на чарты, которые созданы в рамках одного датасета. Селекторы и чарты, которые созданы на базе разных датасетов, также могут быть связаны вручную.
