...
{{ datalens-short-name }} состоит из нескольких объектов, которые позволяют осуществлять полный цикл работы с данными.

![image](../../_assets/datalens/concepts/datalens.svg)

{{ datalens-short-name }} состоит из следующих объектов:
