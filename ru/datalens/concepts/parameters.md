...
Вы можете изменять значение параметра на дашбордах с помощью селекторов с ручным вводом. При этом в большинстве случаев не рекомендуется:

* Использовать опцию **Множественный выбор**.
* Выбирать операцию в селекторе (оставить прочерк в поле выбора из выпадающего списка **Операция**).
