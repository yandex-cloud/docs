...
Чарты создаются в визарде на основе данных из одного датасета или нескольких датасетов (см. [мультидасетные чарты](multi-dataset-charts)).
 ...
 * **Географическая карта**:
   - [Карта](#map-chart)
     ...
     - [Фоновая карта](#vchoropleth-map-chart)
...
* [Тепловая карта](#choropleth-map-chart)
...
## Мультидасетные чарты {#multi-dataset-charts}

Мультидасетные чарты — чарты, которые отображают данные из разных датасетов.
