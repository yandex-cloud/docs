---
title: Рекомендации по оптимизации в {{ datalens-full-name }}
description: В данной статье описано, как в {{ datalens-full-name }} оптимизировать работу с данными, чтобы запросы и отрисовка полученных данных выполнялись быстрее.
---

# Рекомендации по оптимизации в {{ datalens-full-name }}
...
1. Поработайте над структурой данных в источнике:
   ...
   * При построении [витрин]({{ link-docs }}/glossary/datamart) с большим количеством строк разделяйте агрегированные данные и детальную информацию по разным таблицам и датасетам. Это позволит снизить нагрузку на источник при запросе данных.
