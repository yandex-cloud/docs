...
description: В данной статье описано, как в {{ datalens-name }} оптимизировать работу с данными, чтобы запросы и отрисовка полученных данных выполнялись быстрее.
---
