---
title: Типы данных Yandex DataLens
...
При загрузке CSV-файла в качестве [источника данных]{% if audience == "internal" %}(../operations/connection/create-file.md){% else %}(../operations/connection/create-csv.md){% endif %}, {{ datalens-short-name }} пытается автоматически определить тип данных полей.  
