...
Точка координат, которая состоит из значений широты и долготы. В {{ datalens-short-name }} задается с помощью функции [GEOPOINT](../../_api-ref/datalens/function-ref/GEOPOINT.md).
...
Несколько точек координат, которые описывают полигон на карте. В {{ datalens-short-name }} задается с помощью функции [GEOPOLYGON](../../_api-ref/datalens/function-ref/GEOPOLYGON.md).
...
Вы можете привести исходный тип данных в тип `Дата` с помощью функций [DATE](../../_api-ref/datalens/function-ref/DATE/overview.md) и [DATE_PARSE](../../_api-ref/datalens/function-ref/DATE_PARSE/overview.md).
...
Вы можете привести исходный тип данных в тип `Дата и время` с помощью функций [DATETIME](../../_api-ref/datalens/function-ref/DATETIME/overview.md) и [DATETIME_PARSE](../../_api-ref/datalens/function-ref/DATETIME_PARSE/overview.md).
...
Вы можете привести исходный тип данных в тип `Дробное число` с помощью функции [FLOAT](../../_api-ref/datalens/function-ref/FLOAT/overview.md).
...
Логический типа, который принимает только одно из двух значений — `TRUE` или `FALSE`.

Вы можете привести исходный тип данных в тип `Логический` с помощью функции [BOOL](../../_api-ref/datalens/function-ref/BOOL/overview.md).
...
Вы можете привести исходный тип данных в тип `Строка` с помощью функции [STR](../../_api-ref/datalens/function-ref/STR/overview.md).
...
Вы можете привести исходный тип данных в тип `Целое число` с помощью функции [INT](../../_api-ref/datalens/function-ref/INT/overview.md).
