...
description: В данной статье описано, как LOD-выражения в {{ datalens-name }} позволяют добавлять или исключать измерения из группировки, а также использовать вложенные агрегации.
---
