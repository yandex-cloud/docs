...
В [мультидатасетных чартах](chart.md#multi-dataset-charts) вычисляемые поля над полями из нескольких датасетов неприменимы.
...
[City] + " " + "city"
```
Производит конкатенацию трех строковых значений: значение поля `[City]`, пробела и текста `city`. Для конкатенации вы можете также использовать строковую функцию [CONCAT](../function-ref/CONCAT.md).

Полное описание [оператора сложения (+)](../function-ref/OP_PLUS.md).
...
Полное описание функции округления даты [DATETRUNC](../function-ref/DATETRUNC.md).
...
Полное описание функции преобразования [FLOAT](../function-ref/FLOAT.md).
