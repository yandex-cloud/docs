...
В [Editor](../../charts/editor/index.md) в списке версий при наведении покажется кнопка, по нажатию на которую откроется диалог со списком изменений по каждой вкладке.
