...
* [Чарты в Editor](../../charts/editor/index.md) — визуализации и селекторы создаются с помощью кода на JavaScript.

В {{ datalens-short-name }} поддерживаются различные типы визуализаций: диаграммы, таблицы, географические карты и другие средства. Подробнее в [Справочнике визуализаций](../../visualization-ref/index.md).
