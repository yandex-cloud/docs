...
Настройка доступна только для [линейной](../../visualization-ref/line-chart.md) (в том числе в составе [комбинированной](../../visualization-ref/combined-chart.md)) и [точечной](../../visualization-ref/scatter-chart.md) диаграмм в [визарде](../chart/dataset-based-charts.md) и в [QL-чартах](../chart/ql-charts.md).
