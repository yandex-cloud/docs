...
Любой пользователь с правами доступа к чарту может экспортировать из него данные, однако можно [отключить возможность экспорта данных](#data-export-disable).
...
1. Откройте окно экспорта данных одним из способов:
   ...
   * Откройте чарт, из которого требуется экспортировать данные, и в правом верхнем углу чарта нажмите ![image](../../../_assets/console-icons/ellipsis.svg) → ![icon](../../../_assets/console-icons/arrow-down-to-line.svg) **Сохранить как** → **CSV** или **XLSX**.
   * На дашборде у чарта, из которого требуется экспортировать данные, вверху справа нажмите ![image](../../../_assets/console-icons/ellipsis.svg) → ![icon](../../../_assets/console-icons/arrow-down-to-line.svg) **Сохранить как** → **CSV** или **XLSX**.
...
* На панели слева выберите ![sliders](../../../_assets/console-icons/sliders.svg) **Настройки сервиса**, перейдите на вкладку **Безопасность** и в разделе **Экспорт данных** нажмите кнопку **Фоновый экспорт данных**.
...
При прокручивании на странице происходит подгрузка данных экспорта.
