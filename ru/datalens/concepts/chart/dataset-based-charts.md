...
Визард — это конструктор, в котором можно создавать чарты на основе данных из одного или нескольких датасетов (подробнее в [{#T}](./multidataset-chart.md)). Вы можете создать неограниченное количество чартов на базе одного датасета.
