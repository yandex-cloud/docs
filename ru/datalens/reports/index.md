...
1. Основные элементы управления:
   ...
   * ![icon](../../_assets/console-icons/hand-stop.svg) — перемещает страницу отчета относительно экрана. После повторного нажатия возвращает в режим перемещения виджетов.
