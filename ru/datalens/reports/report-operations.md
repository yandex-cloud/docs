...
* [Добавить описание](#report-add-description)
...
Чтобы добавить описание к отчету:
...
1. Введите описание и нажмите **Сохранить**.
   ...
   {% cut "Добавить описание к отчету" %}
...
Теперь в правом верхнем углу отчета для всех пользователей появится значок ![image](../../_assets/console-icons/circle-info.svg). При нажатии на него откроется окно **Информация об отчёте** с описанием.

{% cut "Посмотреть описание к отчету" %}

![description](../../_assets/datalens/report/report-description.png)

{% endcut %}

Чтобы удалить описание к отчету, сохраните пустое описание в окне **Информация об отчёте**. После этого у всех пользователей значок ![image](../../_assets/console-icons/circle-info.svg) отображаться не будет.
