...
* [Настроить рассылку](#report-maillist)
...
1. Выберите виджет: [Чарт](../concepts/chart/index.md), [Текст](../dashboard/widget.md#text), [Заголовок](../dashboard/widget.md#title), Изображение или [Инсайт](../dashboard/widget.md#ai). Чтобы сразу разместить виджет в нужном месте на странице, перетащите его с зажатой левой кнопкой мыши.
1. Настройте виджет:
   ...
   - Текст {#text}
     ...
     * Введите текст ссылки, поясняющей надписи и т.д. Виджет поддерживает язык разметки [Markdown](../dashboard/markdown.md).
       ...
       В тексте вы можете создать ссылку:
       ...
       * абсолютную ссылку — для перехода на страницу в интернете.
       ...
       Созданные ссылки работают в отчетах в режиме [предпросмотра](#report-preview) или в [экспортированном](#report-export) PDF-файле.
   ...
   - Инсайт {#ai}
     ...
     Укажите основные настройки виджета:
     
     * **Чарт для анализа**. Нажмите кнопку ![image](../../_assets/console-icons/chart-column.svg) **Выбрать чарт** и выберите чарт, для которого Нейроаналитик подготовит инсайт.
     ...
     * **Действия с инсайтом**. Опция задает отображение внизу инсайта панели действий:
       ...
       * ![image](../../_assets/console-icons/thumbs-down.svg) **Плохой ответ**. Отрицательно оценивает ответ инсайта.
       ...
       Действия доступны в режиме [предпросмотра](#report-preview).
     ...
     * **Скругление**. Задает скругление виджета.
     ...
     После сохранения настройки Нейроаналитик проанализирует указанный чарт и сформирует выводы на основе данных и пользовательского промпта. Результат в **Инсайте** будет обновляться каждый раз при открытии отчета. Если в чарте, с которым связан виджет **Инсайт**, изменятся данные, в верхней части виджета появится кнопка ![image](../../_assets/console-icons/arrow-rotate-left.svg) **Обновить**.

     Вы также можете скопировать содержимое инсайта или обновить его ответ через меню в верхнем правом углу виджета. Для этого наведите курсор на виджет, нажмите на ![image](../../_assets/console-icons/ellipsis.svg) и выберите:

     * ![image](../../_assets/console-icons/copy.svg) **Копировать инсайт** — чтобы скопировать содержимое инсайта в буфер обмена.
     * ![image](../../_assets/console-icons/arrow-rotate-left.svg) **Перегенерировать** — чтобы обновить ответ инсайта.
...
### Настроить скругление виджета {#widget-rounding}

Чтобы настроить скругление виджета:

1. Выберите страницу отчета, на которой расположен виджет.
1. Нажмите значок ![image](../../_assets/console-icons/gear.svg) у виджета.
1. В поле **Скругление** — задайте скругление виджета от `0` до `24` с шагом `2`. Значение по умолчанию — `12`.
...
1. Настройте внешний вид:
   ...
   * **Скругление**  — задайте скругление виджетов отчета от `0` до `24` с шагом `2`. Значение по умолчанию — `12`.
   * **Формат** — выберите формат: `A4`, `A3`, `16:9 (Full HD)`, `16:9 (2K)` или `16:9 (4K)`.
...
1. Прочие настройки:
   ...
   * (опционально) Включите опцию **Нейроаналитик**, чтобы включить возможность использовать [Нейроаналитика в отчетах](./insights.md).
...
1. Вверху справа нажмите ![icon](../../_assets/console-icons/gear.svg) и в окне справа включите нужные настройки:
...
Подробнее в разделе [{#T}](./add-selector.md).
...
Все ссылки, созданные в виджетах [текст](#text) на страницах отчета, будут активны в экспортированном файле.



## Настроить рассылку {#report-maillist}

Вы можете настроить [рассылку для отчета](./add-report-maillists.md) по электронной почте. В письме адресаты получат файл формата `.pdf` или `.pptx` с теми страницами отчета, которые задаются в настройках рассылки. Можно настроить расписание и получателей рассылки.
