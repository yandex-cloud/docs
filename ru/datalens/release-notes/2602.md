...
* В отчетах исправили работу ссылок на [заголовки](../reports/report-operations.md#header) при [предпросмотре отчета](../reports/report-operations.md#report-preview) в режиме **Презентация**.
