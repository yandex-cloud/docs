...
### Настройка промта для AI {#ai-promt-setting}

Добавили возможность настройки пользовательского промта для AI. Чтобы его настроить:
...
1. Введите промт в текстовое поле и нажмите кнопку **Сохранить**. Длина текста — до 2 000 символов.
...
{% cut "Примеры пользовательского промта для AI" %}
