...
1. Добавьте данные из источника:
   ...
   - SQL-запрос
     ...
     * Чтобы использовать подзапросы в качестве источника, включите опцию **Уровень доступа SQL-запросов** → **Только подзапросы** при создании или редактировании [подключения](../concepts/connection/index.md).
