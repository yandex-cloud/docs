...
Версия чарта или дашборда несовместима с инсталляцией {{ datalens-short-name }}, в которую производится импорт. Например, экспорт выполнен из новой облачной версии {{ datalens-short-name }}, а импорт осуществляется в устаревшую версию open source {{ datalens-short-name }}.
...
Некоторые типы объектов недоступны для импорта и экспорта. Подробнее в разделе [Ограничения](./export-and-import.md#restrictions).
...
#### Операция прервана из-за неизвестной ошибки {#import-critical-error}
