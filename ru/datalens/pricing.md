...
Для пользователей, у которых был создан экземпляр {{ datalens-short-name }} до 1 февраля 2021, переход на новые тарифы произойдет с началом нового расчетного периода в феврале.

> Например, 15 декабря 2020 пользователь активировал {{ datalens-short-name }}. 
> С 15 января 2021 начнется новый расчетный период и продлится до 14 февраля 2021 по [старым тарифам](#prices-before-1-2021).
> С 15 февраля 2021 начнется новый расчетный период по [новым тарифам](#prices-after-1-2021).

Уточнить расчетный период своего экземпляра {{ datalens-short-name }} можно в вашем [платежном аккаунте](https://datalens.yandex.ru/billing).
