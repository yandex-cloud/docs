...
## Правила тарификации с 27 сентября по 27 октября 2021 года

С 27 октября 2021 года сервис {{ datalens-short-name }} будет предоставляться для всех пользователей бесплатно.
...
Если вы используете [функции геокодирования](concepts/limits.md), добавьте геоключ в разделе [Настройки сервиса](https://datalens.yandex.ru/settings) до конца вашего расчетного периода за тариф **Стандарт**.

Во время действия платного тарифа подключать функции геокодирования на странице сервиса необязательно.

## Правила тарификации до 27 сентября 2021 года
