...
C 27 сентября для пользователей с тарифом **Бесплатный** и новых пользователей сервис {{ datalens-full-name }} предоставляется бесплатно.

Для пользователей с тарифом **Стандарт** установлен [переходный период](#interim-period) на бесплатное использование {{ datalens-full-name }}.

С 27 октября {{ datalens-full-name }} будет бесплатным для всех пользователей.

## Правила тарификации с 27 сентября по 27 октября 2021 года {#interim-period}

Если вы оформили тариф **Стандарт** до 27 сентября, то этот тариф будет действовать до конца расчетного периода.

> Например, 26 сентября вы оплатили тариф **Стандарт**.
>
> Ваш расчетный период будет завершен 26 октября, и ваш аккаунт будет переведен в режим бесплатного {{ datalens-short-name }}.

Если вы используете [функции геокодирования](concepts/limits.md), добавьте геоключ в разделе [Настройки сервиса]({{ link-datalens-settings }}) до конца вашего расчетного периода за тариф **Стандарт**.

Во время действия платного тарифа подключать функции геокодирования на странице сервиса необязательно.

## Правила тарификации до 27 сентября 2021 года {#old-princing}
