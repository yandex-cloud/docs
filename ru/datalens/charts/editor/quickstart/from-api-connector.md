...
1. Укажите параметры подключения:
   ...
   * **URL путь** — `datalens-public-demo-assets/data/`.
   ...
   Остальные параметры оставьте без изменений. Нажмите **Создать подключение**.
...
В результате получаем простую таблицу, которая выводит данные, получаемые из JSON API.
