...
При этом, чтобы оперировать в чарте значениями параметров, которые были получены извне (например, из селектора на дашборде), необходимо прописать дефолтные значения параметров в виджетах на дашборде/отчете.
