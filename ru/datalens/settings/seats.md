...
_Рабочее место_ необходимо каждому пользователю {{ datalens-full-name }}: оно позволяет авторизоваться и работать в сервисе. Количество рабочих мест в экземпляре {{ datalens-name }} влияет на [стоимость использования сервиса](../pricing.md).
