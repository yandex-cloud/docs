...
* Если [удалить пользователя из организации]({{ link-docs }}/organization/operations/edit-account) или [отозвать](#revoke) у него рабочее место, число рабочих мест не сократится автоматически. Рабочее место, отозванное у пользователя, становится свободным и доступным для назначения другому пользователю.
