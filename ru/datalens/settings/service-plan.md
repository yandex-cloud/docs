...
1. Нажмите кнопку **Подтвердить**. Для вас будет запланирован переход на выбранный тариф.

{% note info %}

Переход на другой тарифный план происходит с начала следующего месяца. До этого запланированный переход можно [отменить](#cancel-change-service-plan).
