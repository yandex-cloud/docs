...
Чтобы идентифицировать себя или свое приложение, необходимо использовать заголовок `User-Agent`, который будет включать в себя:

* имя приложения или ваш логин
* ссылка на ваше приложение или email-адрес

Мы используем эту информацию, чтобы связаться с вами, если вы что-то делаете не так, предупредить вас об этом.

Примеры правильного заголовка `User-Agent`:
