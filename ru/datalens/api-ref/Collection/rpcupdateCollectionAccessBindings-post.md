...
# Update collection access bindings

<!-- markdownlint-disable-file -->

Updates access bindings for the specified collection.
...
```text translate=no
https://api.datalens.tech/rpc/updateCollectionAccessBindings
```
...
ID of the collection whose access bindings to update.
