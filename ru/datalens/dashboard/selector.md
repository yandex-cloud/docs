...
Значения селекторов сохраняются при переключении вкладок: если выбрать значение в селекторе и переключиться на другую вкладку, а затем вернуться, в селекторе сохранится выбранное значение.
