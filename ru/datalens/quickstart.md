...
В этой инструкции вы создадите свой первый [датасет](concepts/dataset/index.md), для визуализации данных построите несколько [чартов](concepts/chart.md) и разместите их на [дашборде](concepts/dashboard.md).
...
1. В созданном на предыдущем шаге чарте выберите тип визуализации **Диаграмма с областями**.
...
1. Перейдите на главную страницу [{{ datalens-short-name }}](https://datalens.yandex.ru).
...
1. Аналогичным способом добавьте чарты **Продажи по подкатегориям** и **Количество заказов по категориям**.
...
* Узнайте подробнее о [сценариях использования](solutions/index.md).
