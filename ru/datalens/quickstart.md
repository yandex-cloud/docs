...
1. [Добавьте](./security/add-new-user.md) в {{ datalens-short-name }} пользователей с аккаунтами на Яндексе:
   ...
   1. Выберите вкладку **{{ ui-key.datalens.main.service-settings.view.branding-tabs-user-title }}**.
   1. В разделе **{{ ui-key.datalens.main.user-management.view.button_invite-user }}**:
...
1. [Настройте права доступа](./workbooks-collections/workbooks-operations.md#security) на воркбук:
   ...
   1. Нажмите кнопку **{{ ui-key.datalens.component.iam-access-dialog.action_add-user }}**.

      ![wb-access](../_assets/datalens/quickstart/access.png)

   1. В открывшемся окне выберите пользователя или группу, укажите право доступа и нажмите кнопку **{{ ui-key.datalens.component.iam-access-dialog.action_save }}**. Пользователю или группе будут назначены права на данный объект.
