...
* Права выдаются только для ABC-групп. Не согласуются права доступа для отдельных пользователей и Вики-групп. О правилах заказа сетевого доступа через ABC см. в [документации](https://wiki.yandex-team.ru/security/dostup/get_network_access/#abcrol).
...
О возможных причинах отсутствия доступа читайте в разделе [{#T}](../faq.md#access-denied).
