...
* Ограничить создание QL-чартов. Пользователь с правом `{{ permission-execute }}` не может создавать QL-чарты поверх вашего подключения.
...
{% cut "В каких случаях DataLens предоставляет доступ на объекты?" %}
