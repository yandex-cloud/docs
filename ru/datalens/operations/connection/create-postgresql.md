...
1. Выберите тип подключения:
   ...
   {% list tabs %}
    ...
    - Выбрать в Облаке
      ...
      - **Кластер**. Укажите кластер из списка доступных кластеров {{ PG }}. Если у вас нет доступного кластера, нажмите кнопку **Создать новый**.
      ...
      - **Имя хоста**. Выберите имя хоста из списка доступных в кластере {{ PG }}.  
    ...
    - Указать вручную
      ...
      - **Имя хоста**. Укажите путь до хоста или IP-адрес хоста {{ PG }}.  
      - **Порт**. Укажите порт подключения к {{ PG }}. Порт по умолчанию — 6432.
      - **Имя базы данных**. Укажите имя подключаемой базы данных.
      - **Имя пользователя**. Укажите имя пользователя для подключения к {{ PG }}.                   
      - **Пароль**. Укажите пароль для пользователя.  
