---
title: Особенности JOIN
description: Из статьи вы узнаете об особенностях использования оператора JOIN, а также ознакомитесь с видами запросов с JOIN в {{ CH }}.
---
