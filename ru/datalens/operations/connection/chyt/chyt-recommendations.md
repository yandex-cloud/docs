---
title: Рекомендации по созданию подключения к CHYT в {{ datalens-full-name }}
description: Из статьи вы узнаете, как оптимизировать работу с подключением к CHYT в {{ datalens-full-name }}.
---


# Рекомендации по созданию подключения к CHYT в {{ datalens-full-name }}
...
* Используйте максимально возможную предагрегацию данных. Например, если данные в миллисекундах, а аналитику нужно строить по дням, то нужно предагрегировать данные до дня.
