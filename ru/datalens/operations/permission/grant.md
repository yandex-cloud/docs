...
Назначить права доступа к объекту или папке может только пользователь с правом доступа `Администрирование`: он может сделать это самостоятельно или подтвердить запрос. По умолчанию объекты наследуют права родительской папки.

## Назначить самостоятельно {#grant}
