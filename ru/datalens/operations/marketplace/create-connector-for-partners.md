...
На главной странице [{{ marketplace-short-name }}](https://cloud.yandex.ru/marketplace) нажмите кнопку **Предложить продукт** и заполните заявку.
...
* Название на русском и английском языкаx.
* Описание на русском и английском языкаx
* Примеры использования на русском и английском языкаx.
* Инструкцию для пользователей на русском и английском языкаx. 
* Иконку (вектор, SVG).
...
1. Создайте [кластер {{ CH }}](../../../managed-clickhouse/operations/cluster-create.md) в облаке. 
   1. В кластере добавьте пользователя БД `datalens` с параметром [readonly = 2](https://clickhouse.com/docs/ru/operations/settings/permissions-for-queries/#settings_readonly).
...
1. Переходит на страницу [подключений {{ datalens-short-name }}](https://datalens.yandex.ru/connections/new) и выбирает активированный коннектор из списка.
