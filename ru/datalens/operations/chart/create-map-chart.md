...
1. Выберите тип чарта **Карта**:
   ...
   {% list tabs %}
     ...
     - Точечная карта
       ...
       1. Закрасьте точки на карте. Перенесите показатель или измерение в секцию **Цвет**.
     ...
     - Фоновая карта
       ...
       1. Закрасьте полигоны на карте. Перенесите показатель или измерение в секцию **Цвет**.
       1. Добавьте тултипы из значений измерения и показателя, которые отображаются при наведении на полигон.
       
     - Тепловая карта
            
       1. Перетащите измерение c типом [`Геоточка`](../../concepts/data-types#geopoint) из датасета в секцию с выбором типа слоя. 
       1. Измените вес точек на тепловой карте. Для этого перенесите показатель в секцию **Цвет**.
