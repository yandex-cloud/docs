...
* Создание параметров [на уровне датасета](../../dataset/create-dataset.md#add-parameters).
* Создание и использование параметров в [QL-чарте](./create-sql-chart.md#selector-parameters).
