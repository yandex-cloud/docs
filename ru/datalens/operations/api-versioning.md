...
Интерфейс {{ datalens-name }} работает только с последней версией схем, поэтому при редактировании объектов в интерфейсе они будут автоматически сохранены под последней версией.
