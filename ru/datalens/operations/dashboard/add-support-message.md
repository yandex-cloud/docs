...
Теперь после нажатия на значок{% if audience == "internal" %} ![image](../../../_assets/datalens/bug.svg) в левом нижнем углу экрана{% else %} ![image](../../../_assets/datalens/question.svg) в левом нижнем углу экрана и выбора **Создать обращение**{% endif %} пользователь увидит в окне **Информация** дополнительное сообщение.
