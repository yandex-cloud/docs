...
description: Следуя данной инструкции, вы сможете настроить фильтрацию чартов другими чартами на дашборде в {{ datalens-full-name }}.
---

# Настройка фильтрации чартами в {{ datalens-full-name }}
