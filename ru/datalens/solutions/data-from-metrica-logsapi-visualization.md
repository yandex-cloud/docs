...
- [Шаг 1. Создайте подключение и стандартный дашборд](data-from-metrica-logsapi-visualization#step1)
- [Шаг 2. Измените стандартный дашборд](data-from-metrica-logsapi-visualization#step2)
- [Шаг 3. Измените чарт](data-from-metrica-logsapi-visualization#step3)
...
1. Заполните параметры загрузки и реквизиты доступа к целевой базе данных.
    ...
    {% note important %}
    Подключение Metrica Logs API работает только с базами данных ClickHouse развернутыми в Яндекс.Облаке.
    {% endnote %}
...
Вы можете изменять стандартный [дашборд](../concepts/dashboard.md), так как вам удобно, например, удалить ненужный чарт.
...
1. Нажмите значок ![image](../../_assets/datalens/horizontal-ellipsis-black.svg) в верхнем правом углу чарта **Визиты по типам устройств и ОС**.
