...
1. Для полей **Площадь**, **Население** и **Площадь жилфонда** укажите тип агрегации **Сумма**.
    ...
    Поля с опеределенными функциями агрегации становятся показателями и меняют свой цвет на голубой.
...
1. Добавьте на карту полигоны районов. Из раздела **Измерения** перетащите поле **Координаты** в секцию **Геополигоны**.

    ![image](../../_assets/datalens/solution-05/14-use-coordinates.png)

1. Измените цвета районов относительно показателя населения. Из раздела **Показатели** перетащите поле **Население** в секцию **Цвета**.
...
1. Подтвердите публикацию чарта и связанным с ним данных.
