...
В этом сценарии с помощью {{ datalens-short-name }} будут визуализированы показатель населения на карте районов Москвы и опубликован в DataLens Public.
...
Чтобы визуализировать и опубликовать данные, необходимо пройти следущие шаги:

- [Шаг 1. Создайте подключение](data-from-csv-visualization.md#step1)
- [Шаг 2. Создайте датасет](data-from-csv-visualization.md#step2)
- [Шаг 3. Создайте чарт с картой районов Москвы](data-from-csv-visualization.md#step3)
- [Шаг 4. Опубликуйте чарт в DataLens Public](data-from-csv-visualization.md#step4)

## Шаг 1. Создайте подключение и датасет {#step1}

Создайте датасет на основе [подключения](../concepts/connection.md) к CSV-файлу.
...
1. Для полей **Площадь**, **Население** и **Площадь жилфонда** укажите тип агрегации **Сумма**.
    ...
    Поля с опеределнными функциями агрегации становятся показателями и меняют свой цвет на голубой.

    ![image](../../_assets/datalens/solution-05/09-measures.png)
    
1. Для поля **Коодинаты района** измените тип данных на **Геополигон**.
...
1. Выберите тип визуализации **Фоновая карта**.

    ![image](../../_assets/datalens/solution-05/13-choose-map.png)

1. Добавьте на карту полигоны районов. Для из раздела **Измерения** перетащите поле **Координаты** в секцию **Геополигоны**.

    ![image](../../_assets/datalens/solution-05/14-use-coordinates.png)

1. Измените цвета районов относительно показателя населения. Для из раздела **Показатели** перетащите поле **Население** в секцию **Цвета**.
...
1. Потвердите публикацию чарта и связанным с ним данных.

1. Скопируте уникальный URL чарта. Нажмите **Применить**.

    ![image](../../_assets/datalens/solution-05/18-share2.png)

1. Откройте новую вкладу в браузере и перейдите по скопированной ссылке.

    ![image](../../_assets/datalens/solution-05/19-public.png)

Этой ссылкой можно поделиться с коллегам, партнерами или друзьями. DataLens Public не требует авторизации и аутентификации при переходе по ссылке чарта. 
