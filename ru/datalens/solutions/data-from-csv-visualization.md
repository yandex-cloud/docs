...
Чтобы визуализировать и исследовать данные, необходимо пройти следущие шаги:
...
- [Шаг 3. Создайте первый чарт](data-from-csv-visualization.md#step3)
- [Шаг 4. Создайте второй чарт](data-from-csv-visualization.md#step4)
- [Шаг 5. Создайте дашборд](data-from-csv-visualization.md#step5)
- [Шаг 6. Добавьте чарты на дашборд](data-from-csv-visualization.md#step6)
- [Шаг 7. Добавьте селекторы на дашборд](data-from-csv-visualization.md#step7)
- [Шаг 8. Настройте отображение виджетов и приступите к исследованию зависимостей](data-from-csv-visualization.md#step8)
- [Шаг 9. Продолжите исследования данных о супергероях](data-from-csv-visualization.md#step9)
