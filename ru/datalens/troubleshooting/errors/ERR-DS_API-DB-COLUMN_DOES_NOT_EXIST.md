---
title: Ошибка {{ datalens-full-name }} ERR.DS_API.DB.COLUMN_DOES_NOT_EXIST
description: На странице приведено описание ошибки {{ datalens-full-name }} Requested database column does not exist.
---
