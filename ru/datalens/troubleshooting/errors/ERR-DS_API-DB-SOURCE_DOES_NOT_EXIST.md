---
title: Ошибка {{ datalens-full-name }} ERR.DS_API.DB.SOURCE_DOES_NOT_EXIST
description: На странице приведено описание ошибки {{ datalens-full-name }} Data source (table) does not exist.
---
