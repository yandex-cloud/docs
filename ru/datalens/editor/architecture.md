...
Эти табы отвечают за настройку виджета. Возможное содержимое зависит от конкретного вида виджета, см. справочные страницы для конкретных типов (например, [для графика](/docs/editor/widgets/chart/)).
