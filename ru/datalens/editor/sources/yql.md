...
* За один запрос не более 1000 записей и 100 кб данных (если нужно больше - делайте несколько запросов или рассмотрите вариант складывать данные в YT и получать их через [ClickHouse over YT](https://wiki.yandex-team.ru/DataLens/UserGuide/#chytclickhouseoveryt))
