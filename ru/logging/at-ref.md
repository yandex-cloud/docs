...
В {{ at-name }} поддерживается отслеживание событий уровня конфигурации (Control Plane) для {{ cloud-logging-full-name }}. Подробнее в разделе [{#T}](../audit-trails/concepts/format.md).
