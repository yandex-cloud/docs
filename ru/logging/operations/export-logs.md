...
Выгрузить логи в {{ objstorage-name }} можно только в течение срока хранения, который задан для лог-группы. По истечении этого срока логи удаляются из лог-группы и выгрузить их не получится.
