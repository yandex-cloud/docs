---
editable: false
sourcePath: en/_api-ref/logging/api-ref/LogGroup/update.md
---
...
dataStream | **string**<br><p>If specified, log records will be written to this data stream</p> <p>The maximum string length in characters is 512.</p> 
