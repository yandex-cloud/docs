---
editable: false
sourcePath: en/_api-ref-grpc/logging/v1/api-ref/grpc/LogGroup/listAccessBindings.md
---

# Cloud Logging Service, gRPC: LogGroupService.ListAccessBindings {#ListAccessBindings}
