---
editable: false
sourcePath: en/_api-ref-grpc/logging/v1/api-ref/grpc/Sink/setAccessBindings.md
---

# Cloud Logging Service, gRPC: SinkService.SetAccessBindings {#SetAccessBindings}
