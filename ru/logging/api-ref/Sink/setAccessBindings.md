---
editable: false
sourcePath: en/_api-ref/logging/v1/api-ref/Sink/setAccessBindings.md
---

# Cloud Logging Service, REST: Sink.setAccessBindings
...
```
POST https://logging.{{ api-host }}/logging/v1/sinks/{resourceId}:setAccessBindings
```
