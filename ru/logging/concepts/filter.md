...
>   ```
>* Записи, отправленные после 8 июня 2023 года:
>   ```
...
`timestamp` | ```параметр <операция сравнения> "значение"``` | Поиск записей, отправленных в заданный промежуток времени. | ```timestamp >= "2023-06-08T00:00:00Z"```
