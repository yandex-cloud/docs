...
* 720 × {{ sku|RUB|lockbox.storage.v1.active_secrets|string }} — цена за хранение одной версии секрета в месяц, вкл. НДС. Цена за месяц формируется из расчета 720 часов в месяц.
