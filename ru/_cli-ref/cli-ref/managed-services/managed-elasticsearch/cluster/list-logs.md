...
|`--service-type`|<b>`string`</b><br/>Type of the service to request logs from. Values: 'elasticsearch', 'kibana' --columns value[,value]   Columns from the logs table to request.|
