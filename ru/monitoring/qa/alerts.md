...
Проверьте [настройки](https://console.cloud.yandex.ru/settings) консоли управления. В разделах **Настройки номера телефона** и **Настройки почтового ящика** должна быть включена опция `Мониторинг`.