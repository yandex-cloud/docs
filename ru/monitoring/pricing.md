...
Таким образом, стоимость пользования сервисом за 30 дней составит `0,864 млн значений * 9,8 ₽ = 8,4672 ₽`. После округления: `8,47 ₽`
...
В таком случае стоимость пользования сервисом за 30 дней составит `50 млн значений * 9,8 ₽ + (51,84 - 50) млн значений * 5,6 ₽ = 500,304 ₽`. После округления: `500,3 ₽`
...
В таком случае стоимость пользования сервисом за 30 дней составит `17,28 млн значений * 7 ₽ = 120,96 ₽`.
