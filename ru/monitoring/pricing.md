...
* {% if region == "ru" %}9,80 ₽{% endif %}{% if region == "kz" %}49,00 ₸{% endif %}{% if region == "int" %}0,0784 ${% endif %} — стоимость записи 1 млн значений (до 50 млн значений).
...
* {% if region == "ru" %}9,80 ₽{% endif %}{% if region == "kz" %}49,00 ₸{% endif %}{% if region == "int" %}0,0784 ${% endif %} — стоимость записи 1 млн значений (до 50 млн значений).
* {% if region == "ru" %}5,60 ₽{% endif %}{% if region == "kz" %}28,00 ₸{% endif %}{% if region == "int" %}0,0448 ${% endif %} — стоимость записи 1 млн значений (сверх 50 млн значений).
