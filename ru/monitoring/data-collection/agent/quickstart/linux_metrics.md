...
Поставка системных метрик виртуальных машин, работающих на Windows запланирована в будущих релизах {{unified-agent-full-name}}. TODO: добавить идею в сообществе и поставить ссылку

{% endnote %}

1. Установите {{unified-agent-short-name}} в свою виртуальную машину, выполнив в домашнем каталоге следующую команду

    {% include [auth](../../../_includes/ua-docker-install.md) %}
