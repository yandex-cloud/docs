...
* 500 запросов/с и 20 МБ/с на запись в формате [Remote Write](https://prometheus.io/docs/prometheus/latest/configuration/configuration/#remote_write).
...
* 10 миллионов уникальных метрик.
