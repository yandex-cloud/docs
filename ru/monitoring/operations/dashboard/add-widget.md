...
1. Настройте новый график, указав запросы и настроив отображение метрик. Подробннее о создании графиков в разделах [[!TITLE]](../chart/create-query.md) и [[!TITLE]](../chart/create.md).
...
1. Заполните параметры виджета. Обратите внимание на следующие поля:
    ...
    - **Виджет**. Задает добавляемый виджет. Нажмите **Выберите файл** и укажите нужный график в окне с файловой навигацией или нажмите **Укзать ссылку** и вставтье ссылку на график.
