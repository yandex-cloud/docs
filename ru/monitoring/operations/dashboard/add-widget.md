...
1. Настройте новый график, указав запросы и настроив отображение метрик. Подробнее о создании графиков в разделах [[!TITLE]](../chart/create-query.md) и [[!TITLE]](../chart/create.md).
