...
- Консоль управления {#console}
  ...
  1. В [консоли управления]({{ link-console-main }}) выберите каталог, в котором находятся ресурсы, наблюдаемые в {{ monitoring-name }}.
...
Пример вызова функции описан в разделе [{#T}](alert-call-function.md).
