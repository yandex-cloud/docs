----
title: Управление доступом в Yandex Monitoring
description: "Управление доступом в сервисе мониторинга, который позволяет собирать и хранить метрики, а также отображать их в виде графиков на дашбордах — Yandex Monitoring. Чтобы разрешить доступ к ресурсам сервиса Yandex Monitoring, назначьте пользователю нужные роли из приведенного списка."
----
