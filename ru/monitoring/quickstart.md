...
3. В параметр **Заголовок** ввидете имя виджета, например, "CPU on all hosts". 
...
1. В параметр **Заголовок** ввидете имя виджета, например, "Free space on ClickHouse hosts". 
