...
На [стадии Preview](../../../docs/overview/concepts/launch-stages) доступ к {{ monitoring-full-name }} выдается только командой Яндекс.Облака.
...
## Добавьте виджет сервиса {{ compute-full-name }}
...
## Добавьте виджет сервиса {{ managed-clickhouse-full-name }}
