...
{{ monitoring-full-name }} позволяет отображать на графиках метрики сервисов Яндекс.Облака и пользовательские метрики, загруженные с помощью API.

#### Типы графиков {#chart-types}
Доступны следующие типы графиков:

- ![image](../../../_assets/monitoring/chart-lines.svg) Линейный график.
- ![image](../../../_assets/monitoring/chart-area.svg) График с областью.
- ![image](../../../_assets/monitoring/chart-columns.svg) Столбчатый график.
