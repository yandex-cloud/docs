...
> Например, в вашем каталоге существует {% if lang == "ru" and audience != "internal" %}[виртуальная машина](../../glossary/vm.md){% else %}виртуальная машина{% endif %}. Если удалить эту виртуальную машину `1 августа 2020`, то ее метрики будут доступны в {{monitoring-full-name}} до `31 августа 2020`.
