...
Данные в сервисе [!KEYREF monitoring-full-name] хранятся в виде [временных рядов](https://en.wikipedia.org/wiki/Time_series).
...
### Типы метрик
В сервисе [!KEYREF monitoring-full-name] есть следующие типы метрик:
...
В сервисе [!KEYREF monitoring-full-name] доступны следующие шаблоны:
...
Пример запроса метрики можно увидеть в разделе [[!TITLE]](../operations/chart/create-query.md).
 
#### См. также
- [[!TITLE]](visualization/index.md)
