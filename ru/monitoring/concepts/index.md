...
Сервис Yandex Monitoring позволяет собирать и хранить метрики, а также отображать их в виде графиков на
дашбордах.

Yandex Monitoring автоматически собирает данные о состоянии ваших ресурсов в Яндекс.Облаке
 и отображает их на сервисных дашбордах. Для загрузки пользовательских метрик доступен API.

С помощью сервиса Yandex Monitoring вы можете:
...
Сервис Yandex Monitoring собирает и хранит метрики в виде [временных рядов](https://ru.wikipedia.org/wiki/Временной_ряд).
...
Yandex Monitoring отображает метрики на графиках. Множество связанных между собой графиков можно собрать на дашбордах. Графики и дашборды доступны в общей файловой навигации. Подробнее в разделе [#T](visualization/index.md).
