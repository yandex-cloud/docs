...
[!KEYREF monitoring-full-name] автоматически собирает данные о состоянии ваших ресурсов в Яндекс.Облаке
 и отображает их на сервисных дашбордах. Для загрузки пользовательских метрик доступно API.

С помощью сервиса [!KEYREF monitoring-full-name] вы можете:

- Отслеживать состояние ваших сервисов в Яндекс.Облаке на сервисных дашбодах. Это позволяет контролировать текущую 
...
- Создавать собственные дашборды и графики, чтобы визуализровать метрики наиболее удобным для вас способом.
