...
- запущена виртуальная машина, работающая на Linux-совместимой операционной системе (например, Ubuntu 20.04);

- (опционально) на виртуальной машине установлен [Docker](https://docs.docker.com/install/);
  - виртуальная машина или хост имеют публичный IPv4-адрес (рекомендуется при использовании Docker);
