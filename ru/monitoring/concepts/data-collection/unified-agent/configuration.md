...
Данный раздел описывает настройку {{unified-agent-full-name}}. Перед настройкой рекомендуется ознакомиться с [основными понятиями](../../index.md), использующимися в конфигурации агента.
