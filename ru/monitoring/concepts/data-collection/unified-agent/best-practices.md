...
См. также: Конфигурирование входа [{#T}](configuration.md#agent_metrics_input).

## Использование хранилища { #storage }

Для надежной доставки метрик в {{ monitoring-full-name }} при помощи {{unified-agent-short-name}} используйте хранилище. Оно позволит временно хранить сообщения, проходящие по [цепочке преобразований](index.md#pipes) перед отправкой их в выход канала.
...
См. также: Подробнее конфигурирование хранилища описано в разделе [{#T}](configuration.md#storages).
