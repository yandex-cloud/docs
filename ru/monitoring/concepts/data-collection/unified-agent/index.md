...
Для поставки пользовательских метрик в {{monitoring-full-name}} предоставляется {{unified-agent-full-name}} — агент для поставки метрик виртуальных машин и пользовательских приложений.
