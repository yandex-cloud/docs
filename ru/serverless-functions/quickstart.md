...
Создайте и выполните [функции](concepts/function.md), которые приветствуют пользователя. Используйте для этого языки программирования Python и Node.js.
...
- Консоль управления
  ...
  1. Откройте **Serverless Functions** в каталоге, где требуется создать [версию](concepts/function.md#version) функции.
...
- CLI
  ...
  --runtime python37 \ # Среда выполенения.
...
- HTTP
    ...
    Вы можете посмотреть ссылку для вызова функции в параметре `http_invoke_url` при [создании функции](operations/function-create.md).
