---
description: Face detection или обнаружение лиц - это инструмент, который позволяет находить лица людей на изображении. Например, чтобы отметить людей на фотографии или найти все фото с портретами. Сервис ищет лица людей на изображении и выделяет их прямоугольниками. Поддерживаемые форматы файлов JPEG, PNG, PDF.
keywords:
  - face detection
  - обнаружение лиц
---
