...
{% if audience == "draft" %}
В визуальном редакторе нельзя загрузить изображение или объекты из внешних источников на страницу. Вы можете добавить рисунок или объект, скопировав его адрес с другой вики-страницы или внешнего ресурса. Чтобы пользователь увидел такой объект на вашей странице, он должен иметь доступ к странице с оригиналом.
{% endif %}
...
1. Загрузите изображение на [вики-страницу](add-image.md) или на файловый хостинг{% if audience == "internal" %}, например, [Jing](https://jing.yandex-team.ru/){% endif %}.
