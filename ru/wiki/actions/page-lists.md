...
Вы можете вставить на вики-страницу списки:
...
`show_redirects` | Отображение редиректов в дереве:<br>`true` — редиректы включены в дерево;<br>`false` — редиректы не отображаются в дереве.
