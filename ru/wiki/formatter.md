...
На {{ wiki-name }} можно оформить текст в виде блока, который будет отображаться на странице в заданном формате. Например, с помощью блочного форматирования можно оформить исходный код с [подсветкой синтаксиса](static-markup/highlight.md), вставить на страницу фрагмент текста в рамке, настроить [ширину и положение](static-markup/wrappers.md) блока на странице.

Также {{ wiki-name }} поддерживает верстку [математических формул](formulas.md) и специализированные языки для визуализации [диаграмм](diagram.md).

Чтобы добавить на страницу блок со специальным форматированием, используйте следующую разметку: 
...
`math`| [Математическая формула в текстовой разметке](formulas.md)
Тип диаграммы:<ul><li>`graphviz`</li><li>`blockdiag`</li><li>`seqdiag`</li></ul> | [Диаграмма в текстовой разметке](diagram.md)
