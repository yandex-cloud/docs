...
Настройки может редактировать {% if audience == "external" %}[автор страницы](edit-owner.md) или администратор [организации](../overview.md#access).{% else %}только [автор страницы](edit-owner.md). Если автор страницы больше не работает в Яндексе, напишите на рассылку [tools@](mailto:tools@yandex-team.ru). Запрос обработают сотрудники группы поддержки внутренних сервисов.{% endif %}
