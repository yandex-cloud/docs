...
2. Чтобы уточнить результаты поиска, используйте фильтры на панели справа:
   ...
   - **Раздел**. Адрес [раздела](structure.md#section_wdq_z4d_sy) относительно главной страницы `{{ wiki-host-name }}`. Например, чтобы найти текст на подстраницах раздела `{{ wiki-username }}`, введите `users/имяПользователя`.
