...
- [Создавайте вики-страницы](quick-guide.md), состоящие из текста, изображений, таблиц и ссылок. 
  {% if audience == "external" %}Максимальное количество страниц для одной организации — 10 000.{% endif %}   

- [Прикрепляйте файлы](attach-file.md) к вики-странице.
  {% if audience == "external" %}Максимальный общий размер всех файлов для одной организации — 5 Гбайт.{% endif %}   
