...
{{ wiki-full-name }} можно подключить к существующей организации или создать новую. Подробнее об организациях читайте в [документации {{ org-full-name }}](../organization/index.yaml).

## Активировать {{ wiki-name }} в существующей организации {#current-org}

Если у вас уже есть есть организация в {{ org-full-name}}, сервис {{ wiki-full-name }} будет автоматически активирован при первом входе любого пользователя организации:
...
1. Если ваш аккаунт зарегистрирован в нескольких организациях, выберите ту, в которой вы хотите активировать {{ wiki-full-name }}. Затем нажмите кнопку **Продолжить**.
...
1. Примите условия использования {{ yandex-cloud }} и нажмите кнопку **Войти**. 

   Для вас будет автоматически создана новая организация и активирован сервис {{ wiki-full-name }}.

1. В сервисе {{ org-full-name}} добавьте в вашу организацию пользователей или настройте федерацию удостоверений, чтобы сотрудники могли использовать свои рабочие аккаунты для доступа к сервисам {{ yandex-cloud }}. Подробнее читайте в [документации {{ org-full-name}}](../organization/manage-users.md).
