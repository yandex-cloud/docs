...
## Внуренние сервисы {#services}

Для перехода к внутренним сервисам и просмотра уведомлений используйте кнопки на панели слева:

* Чтобы открыть каталог внутренних сервисов, нажмите ![](../_assets/wiki/svg/dots.svg) **Все сервисы**.

{% endif %}

* Чтобы просмотреть уведомления от {% if audience == "internal" %}внутренних сервисов{% else %}сервисов {{ yandex-cloud }}{% endif %}, нажмите ![](../_assets/wiki/svg/notifications.svg) **Уведомления**.
...
* Чтобы открыть страницу управления аккаунтом {% if audience == "external" %}и список доступных организаций{% endif %}, нажмите на иконку с вашим фото **Учётная запись**.
