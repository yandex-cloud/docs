...
С помощью динамического блока на страницу, созданную в [старом редакторе](pages-types.md#page) можно вставить фрагмент, содержимое которого формируется автоматически на основе данных о странице или информации из внешнего источника.
