...
1. Войдите в аккаунт, который вы используете для работы в организации:
   ...
   - Чтобы войти с помощью почтового адреса на Яндексе или на домене организации, нажмите кнопку **Войти в аккаунт на Яндексе** и укажите ваш логин вида `{{ example-account }}` или `login@example.com`.
...
1. Если вы зарегистрированы в нескольких организациях, выберите организацию, в которой вы хотите работать с {{ wiki-full-name }}. Для этого нажмите портрет вашего профиля в верхнем правом углу страницы и выберите организацию.