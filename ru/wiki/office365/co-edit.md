...
В Office 365 есть возможность совместного редактирования документов Word, Excel и PowerPoint: несколько пользователей могут одновременно вносить в документ изменения и сохранять их. Эта возможность работает и для облачных документов, встроенных на {{wiki-name}}: при редактировании облачный документ открывается в приложении Office 365, и вы можете редактировать его одновременно с другими пользователями.

## Редактировать документ, встроенный на {{wiki-name}} {#edit-button}

Чтобы редактировать документ Office, встроенный на вики-страницу, в правом верхнем углу нажмите кнопку **Редактировать в облаке**. Документ откроется в приложении Office в новой вкладке.
...
* Если у вас уже есть документы Office, которые вы редактируете вместе с коллегами, вы можете продолжить работу на {{wiki-name}}. Для этого создайте страницу типа **Word, Excel, PowerPoint** и [импортируйте ваш файл](create-ms-office.md#import-doc).
