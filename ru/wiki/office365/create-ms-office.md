...
1. Чтобы наполнить документ содержанием, на вики-странице нажмите кнопку [**Редактировать в облаке**](co-edit.md#edit-button). Документ откроется в приложении Office в новой вкладке браузера.

1. Чтобы управлять доступом к документу, измените [настройки доступа к вики-странице](../page-managment/access-setup.md). По умолчанию для новой страницы действует опция **Как у родительской страницы**. Подробнее см. [Настроить доступ к документам](doc-access.md).
...
Если у вас есть документы, которые вы храните в корпоративном облаке Office 365, вы можете встраивать эти документы в вики-страницы. Документы, предназначенные для широкой аудитории, рекомендуется хранить на [общем сайте Sharepoint]({{link-sharepoint-common}}) в папке вашего проекта или отдела. 

{% note alert %} 

Если ваши документы хранятся в личной папке OneDrive, перед встраиванием на {{wiki-name}} [перенесите их на общий сайт](doc-access.md#move-doc). Иначе в случае увольнения или отзыва лицензии Office 365 все файлы в личной папке будут удалены.
...
1. Найдите файл на [портале Sharepoint]({{link-sharepoint-common}}) или в [личной папке OneDrive]({{link-sharepoint-personal}}) и убедитесь, что доступ к файлу открыт для пользователей, с которыми вы хотите поделиться файлом на {{wiki-name}}. 
   Если файл хранится на общем сайте Sharepoint, по умолчанию он доступен всем штатным и внештатным сотрудникам. Подробнее см. [Настроить доступ к документам](doc-access.md).
...
1. Так же, как при создании обычной вики-страницы, задайте название и выберите, в каком разделе  будет находиться страница.
