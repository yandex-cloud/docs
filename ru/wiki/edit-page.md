...
1. Откройте страницу и в правом верхнем углу нажмите кнопку **{{ ui-key.beta-wiki.blocks_common_desktop.blocks_w-comment.edit }}**.
...
1. Внесите изменения в текст страницы:
   ...
   * Чтобы открыть предварительный просмотр страницы на всю ширину окна, в правом верхнем углу нажмите кнопку **{{ ui-key.beta-wiki.blocks_common_desktop.blocks_page-editor.page_view }}**.
   ...
   * В правом верхнем углу нажмите ![](../_assets/wiki/svg/actions-icon.svg) **Действия**, выберите ![](../_assets/wiki/svg/attachments.svg) **{{ ui-key.beta-wiki.blocks_common_desktop.blocks_b-sidebar.icon-files }}** и загрузите на страницу изображения или другие файлы. Например, чтобы [вставить изображение в текст страницы](add-image.md).
