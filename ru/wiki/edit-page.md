...
На странице вы можете редактировать текст, добавлять заголовки и списки, вставлять на страницу ссылки, изображения и таблицы.

Вы можете изменить любую вики-страницу, к которой у вас есть [доступ на редактирование](page-managment/read-only.md):
...
1. Внесите изменения в текст страницы:
   ...
   * Вы можете добавить на страницу [динамические блоки](actions.md), например [оглавление документа](add-toc.md) или список вложенных страниц.
    
   **Прикрепить к странице файлы**
   * Вы можете [загрузить на страницу изображения или другие файлы](attach-file.md). Например, чтобы [вставить изображение в текст страницы](add-image.md).
   
   **Добавить таблицу**
   * Вы можете вставить на страницу [динамическую таблицу](add-grid.md). Такие таблицы можно сортировать по столбцам и редактировать в режиме просмотра страницы.
