...
![](../../_assets/wiki/formatter-wrapper-box-result.png)
...
**Цвета** |
`red`{% if locale == "ru" %} | Красный{% endif %}.
`green`{% if locale == "ru" %} | Зеленый{% endif %}.
`blue`{% if locale == "ru" %} | Синий{% endif %}.
`grey`{% if locale == "ru" %} | Серый{% endif %}.
`yellow`{% if locale == "ru" %} | Желтый{% endif %}.
