...
Подробнее читайте в разделе [{#T}](../actions/objects.md#anchor).
...
Чтобы получить несколько пустых строк между блоками текста, в начало каждой строки вставьте обратный слэш `\` .
