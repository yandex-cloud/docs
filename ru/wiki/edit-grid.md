# Как отредактировать динамическую таблицу

Чтобы изменить таблицу, откройте ее и в правом нижнем углу нажмите кнопку **Редактировать**.
...
Чтобы сохранить изменения, нажмите кнопку **Завершить**. Каждый раз, когда вы сохраняете таблицу, ее копия помещается в [историю изменений](history.md). С помощью истории вы всегда сможете просмотреть все прежние версии таблицы, сравнить их друг с другом или вернуться к любой из них.
...
Переименовывать таблицу можно и не переходя в режим редактирования.
...
1. В заголовке столбца нажмите значок ![](../_assets/wiki/sort-column.png).

1. Нажмите значок еще раз, чтобы отсортировать строки в обратном порядке.
...
1. Скопируйте код и вставьте на страницу в {{ wiki-name }}.
