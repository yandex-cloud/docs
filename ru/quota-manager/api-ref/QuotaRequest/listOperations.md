...
is larger than [ListQuotaRequestOperationsRequest.pageSize](#yandex.cloud.quotamanager.v1.ListQuotaRequestOperationsRequest), use the `nextPageToken` as the value
for the [ListQuotaRequestOperationsRequest.pageToken](#yandex.cloud.quotamanager.v1.ListQuotaRequestOperationsRequest) query parameter in the next list request.
