...
В данном сценарии вы подготовите дашборд по выбору помещений для открытия новых пиццерий Додо. 
...
1. Перейдите в [Marketplace](https://datalens.yandex.ru/marketplace) {{ datalens-short-name }}.
...
1. В открывшемся окне будет представлен набор объектов {{ datalens-short-name }}: [подключение](../../datalens/concepts/connection.md), [датасет](../../datalens/concepts/dataset/index.md), [чарт](../../datalens/concepts/chart.md) и [дашборд](../../datalens/concepts/dashboard.md). Нажмите желтую иконку дашборда в конце списка.
...
1.	Добавить из Marketplace продукт [Аудитория: интересы и соцдем](https://datalens.yandex.ru/marketplace/f2eemc2dui59rn72h0ck), чтобы аналогично отобразить на карте данные по аудитории города.
1.	На примере Воронежа можно изучить бесплатные [геослои от компании Геоинтеллект](https://datalens.yandex.ru/marketplace/f2eu3edujf1jdmaihu7u). Демонабор содержит посчитанные индексы бизнес-потенциала локации для фастфуда.
