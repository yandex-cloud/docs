...
Вы можете защитить ваш сервис от  Яндекс.Облако с помощью Hystax Acura. Для аварийного восстановления, в вашем облаке нужно создать ВМ с Hystax Acura, под управлением которой будет настраиваться и осуществляться сценарий аварийного восстановления. Сам процесс восстановления будет выполнять служебная ВМ с Hystax Acura Cloud Agent, которая восстановит ваши ВМ в Яндекс.Облако. После запуска процедуры аварийного восстановления будут созданы реплики ВМ, которые будут использованы в процессе аварийного восстановления для развертывания инфраструктуры. Чтобы запустить сценарий аварийного восстановления:
