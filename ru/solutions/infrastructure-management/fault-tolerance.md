...
- Нагрузка генерируется приложением [Яндекс.Танк](https://cloud.yandex.ru/marketplace/products/f2ec3euo68vni32pl7aj) и подается на {{load-balancer-short-name}}. Балансировщик нагрузки распределяет трафик по виртуальным машинам.
