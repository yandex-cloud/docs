# Использование «1С:Предприятия» с сервером баз данных MS SQL Server

Чтобы настроить работу «1С:Предприятия» в Яндекс.Облаке, нужно создать рабочий сервер, сервер лицензий и сервер баз данных. Серверы 1С будут работать под управлением Windows Server Datacenter 2019, а сервер баз данных — MS SQL Server 2016.
...
4. В блоке **Публичные образы** нажмите кнопку **Выбрать**. Выберите публичный образ **Windows 2016 Datacenter**.
...
6. В блоке **Сетевые настройки** выберите сеть и подсеть, к которым нужно подключить виртуальные машины. Обе ВМ должны находится в одной подсети. Если нужной сети или подсети еще нет, вы можете создать их прямо на странице создания ВМ.
...
4. В блоке **Публичные образы** нажмите кнопку **Выбрать**. Выберите публичный образ **SQL Server 2016 Standard**.
