...
* плата диски и постоянно запущенные виртуальные машины (см. [тарифы {{ compute-full-name }}](../../compute/pricing.md));
...
1. Задайте настройки подключения к Яндекс.Облаку:
...
Агенты устанавливаются на виртуальные машины, которые предстоит мигрировать в Яндекс.Облако. Чтобы получить и установить агент:
