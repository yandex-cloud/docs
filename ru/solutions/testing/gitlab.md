...
1. Нажмите кнопку в блоке **Sign-up restrictions** нажмите кнопку **Expand**.
...
1. Добавьте файл проекта.
   ...
   1. Назовите файл `test.cpp`. Добавьте в него код программы, которая выводит `Hello World`, если выполняется проверка, что результат умножения 2 × 2 равен 4:
