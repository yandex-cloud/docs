...
1. [Проверьте работу VPN-туннеля](#test-vpn). 
...
1. В блоке **Образы из {{ marketplace-name }}** нажмите кнопку **Выбрать** и выберите образ **IPSec-инстанс**.
...
## 3. Настройте статическую маршрутизацию {#configure-static-route}
...
## 4. Настройте IPSec на другом шлюзе {#configure-another-gateway}
...
## 5. Проверьте работу IPSec-туннеля {#test-vpn}
