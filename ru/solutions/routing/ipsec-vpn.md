...
В сценарии рассматривается настройка IPSec-инстанса для передачи трафика от виртуальных машин Яндекс.Облака в туннель IPSec VPN с использованием демона [strongSwan](https://www.strongswan.org/). 
...
## Создайте сети и подсети {#before-begin}
...
1. В блоке **Публичные образы** нажмите кнопку **Выбрать** и выберите образ **IPSec-инстанс**.
