...
1. В блоке **Образы из {{ marketplace-name }}** нажмите кнопку **Выбрать** и выберите образ [Cisco CSR]{% if lang == "ru" %}(https://cloud.yandex.ru/marketplace/products/f2ekdh4u43pemrn7ig3q){% endif %}{% if lang == "en" %}(https://cloud.yandex.com/en-ru/marketplace/products/f2ekdh4u43pemrn7ig3q){% endif %}.
...
1. Откройте раздел **Серийная консоль** имя нажмите кнопку **Подключиться**.
