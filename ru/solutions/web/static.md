...
1. В поле **Имя** введите имя бакета, например, `example.com`. Имя бакета будет использоваться в доменном имени сайта: `https://example.com.[!KEYREF s3-web-host]`.
...
1. На вкладке **Объекты** на странице вашего бакета нажмите кнопку **Загрузить**. В открывшемся окне выберите необходимые файлы и нажмите кнопку подтверждения.
