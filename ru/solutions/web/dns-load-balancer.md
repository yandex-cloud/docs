...
* [Создайте в разных зонах доступности две виртуальные машины с предустановленным веб-сервером](#create-web-server-vm)
* [Загрузите файлы веб-сайта](#upload-files)
* [Создайте в разных зонах доступности две виртуальные машины для DNS-балансировщиков](#create-dns-balancer-vm)
