...
streamId | **string** <br> includes only one of the fields `streamId`, `lineId`<br><br><p>ID of the stream.</p> 
lineId | **string** <br> includes only one of the fields `streamId`, `lineId`<br><br><p>ID of the line.</p> 
