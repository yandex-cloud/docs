...
editable: false
apiPlayground:
  - url: https://video.{{ api-host }}/video/v1/channels:batchDelete
    method: post
    path: null
    query: null
    body:
...
```
POST https://video.{{ api-host }}/video/v1/channels:batchDelete
```

## Body parameters {#yandex.cloud.video.v1.BatchDeleteChannelsRequest}
