...
- API {#api}
  ...
  Use the [create](../../api-ref/StreamLine/create.md) REST API method for the [StreamLine](../../api-ref/StreamLine/index.md) resource or the [StreamLineService/Create](../../api-ref/grpc/StreamLine/create.md) gRPC API call.
