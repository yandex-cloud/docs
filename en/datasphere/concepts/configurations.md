...
Name | Number of vCPUs on the<br>[AMD EPYC™ platform](../../compute/concepts/gpus.md) | Number of GPUs on the <br> [NVIDIA® Ampere®](https://www.nvidia.com/en-us/data-center/ampere-architecture/)
---- | ---- | ----
