...
See the full description of TensorBoard features on the [TensorFlow website](https://www.tensorflow.org/tensorboard?hl=en).
...
2. From the **Commands** tab on the left panel. Open this tab and select **Create a new TensorBoard**. In the window that opens, specify the path to the desired directory with logs. This starts a new instance.
...
1. Specify a test model, for example:
