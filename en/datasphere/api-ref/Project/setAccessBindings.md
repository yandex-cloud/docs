...
editable: false
apiPlayground:
  - url: https://datasphere.{{ api-host }}/datasphere/v2/projects/{resourceId}:setAccessBindings
    method: post
    path:
      type: object
      properties:
    ...
    definitions:
      ...
      AccessBinding:
        ...
        required:
          - roleId
          - subject
sourcePath: en/_api-ref/datasphere/v2/api-ref/Project/setAccessBindings.md
---

# DataSphere API v2, REST: Project.SetAccessBindings
...
|| metadata | **[SetProjectAccessBindingsMetadata](#yandex.cloud.datasphere.v2.SetProjectAccessBindingsMetadata)**
...
## SetProjectAccessBindingsMetadata {#yandex.cloud.datasphere.v2.SetProjectAccessBindingsMetadata}
