...
editable: false
apiPlayground:
  - url: https://datasphere.{{ api-host }}/datasphere/v2/projects/{resourceId}:removeResource
    method: post
    path:
      type: object
      properties:
...
## Body parameters {#yandex.cloud.datasphere.v2.RemoveResourceFromProjectRequest}
