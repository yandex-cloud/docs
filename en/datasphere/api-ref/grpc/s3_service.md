---
editable: false
sourcePath: en/_api-ref-grpc/datasphere/v2/api-ref/grpc/s3_service.md
---
...
| Call | Description |
| --- | --- |
| [Activate](#Activate) | Activates shared s3 for project |
| [Deactivate](#Deactivate) | Deactivates shared s3 for project |

## Calls S3Service {#calls}
...
Field | Description
--- | ---
s3_id | **string**<br>Required.  The maximum string length in characters is 50.
