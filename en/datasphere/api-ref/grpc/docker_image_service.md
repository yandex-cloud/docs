---
editable: false
sourcePath: en/_api-ref-grpc/datasphere/v2/api-ref/grpc/docker_image_service.md
---
...
| Call | Description |
| --- | --- |
| [Activate](#Activate) | Activates shared docker image in project |

## Calls DockerImageService {#calls}
...
docker_id | **string**<br>Required.  The maximum string length in characters is 50.
