...
--- | ---
ruleId | <p>ID of the requested resource rule.</p> <p>Value must be greater than 0.</p> 
...
Field | Description
--- | ---
id | **string** (int64)<br><p>Rule ID.</p> <p>Value must be greater than 0.</p> 
name | **string**<br><p>Required. Rule name.</p> <p>The maximum string length in characters is 50.</p> 
rulePattern | **string**<br><p>Required. Rule pattern. Must be a valid regular expression.</p> <p>The maximum string length in characters is 100.</p> 
