---
editable: false
sourcePath: en/_api-ref-grpc/cdn/v1/api-ref/grpc/ResourceRules/create.md
---

# Cloud CDN API, gRPC: ResourceRulesService.Create {#Create}

Create new resource rule with specified unique name and rule patter.

## gRPC request

**rpc Create ([CreateResourceRuleRequest](#yandex.cloud.cdn.v1.CreateResourceRuleRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## CreateResourceRuleRequest {#yandex.cloud.cdn.v1.CreateResourceRuleRequest}
