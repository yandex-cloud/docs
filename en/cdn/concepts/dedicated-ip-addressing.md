...
The dedicated IP address is associated with a folder. This means, within a single folder, dedicated IP addressing will apply to all CDN resources by default, and they will all have the same IP address. If you select to pay **per individual CDN resource**, you will be charged for all CDN resources in the folder. If you need dedicated IP addresses only for some of the resources, we recommend creating additional folders for them.
