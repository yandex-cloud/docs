        ...
        pageToken:
          description: |-
            **string**
            ...
            [ListExportsResponse.nextPageToken](/docs/logging/api-ref/Export/list#yandex.cloud.logging.v1.ListExportsResponse) returned by a previous list request.
          type: string
        filter:
          description: |-
            **string**
            ...
            1. The field name. Currently filtering can only be applied to the [Export.name](/docs/logging/api-ref/Export/get#yandex.cloud.logging.v1.Export) field.
            2. An `=` operator.
