...
--- | ---
sinkId | <p>Required. ID of the sink to update.</p> <p>To get a sink ID make a <a href="/docs/logging/api-ref/Sink/list">list</a> request.</p> <p>The maximum string length in characters is 64.</p> 
...
Field | Description
--- | ---
updateMask | **string**<br>Field mask that specifies which attributes of the function should be updated.
