---
editable: false
sourcePath: en/_api-ref-grpc/logging/v1/api-ref/grpc/Export/updateAccessBindings.md
---

# Cloud Logging Service, gRPC: ExportService.UpdateAccessBindings {#UpdateAccessBindings}
