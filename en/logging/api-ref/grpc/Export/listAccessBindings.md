---
editable: false
sourcePath: en/_api-ref-grpc/logging/v1/api-ref/grpc/Export/listAccessBindings.md
---

# Cloud Logging Service, gRPC: ExportService.ListAccessBindings {#ListAccessBindings}
