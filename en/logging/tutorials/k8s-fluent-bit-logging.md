...
You can send {{ managed-k8s-name }} cluster logs to {{ cloud-logging-name }}:

* Use the `master logging` setting when [creating](../../managed-kubernetes/operations/kubernetes-cluster/kubernetes-cluster-create.md) or [updating](../../managed-kubernetes/operations/kubernetes-cluster/kubernetes-cluster-update.md) a cluster to send {{ managed-k8s-name }} [master](../../managed-kubernetes/concepts/index.md#master) logs. The setting is only available in the CLI, {{ TF }}, and API.
* To send [pod](../../managed-kubernetes/concepts/index.md#pod) and [service](../../managed-kubernetes/concepts/index.md#service) logs, use the [Fluent Bit application with the Cloud Logging plugin](/marketplace/products/yc/fluent-bit) in the {{ managed-k8s-name }} cluster.
...
- Using {{ TF }}
  ...
  1. Download the [k8s-cluster-with-master-logging.tf](https://github.com/yandex-cloud/examples/tree/master/tutorials/terraform/managed-kubernetes/k8s-cluster-with-master-logging.tf) cluster configuration file to the same working directory.
...
- Manually
  ...
  1. If you reserved a static {{ managed-k8s-name }} public IP address [for your](../../vpc/concepts/address.md#public-addresses) cluster, release and [delete it](../../vpc/operations/address-delete.md).
...
{% include notitle [Setting up Managed K8S Fluent Bit](../../_tutorials/k8s-fluent-bit-logging.md) %}
