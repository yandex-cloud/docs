...
Create a {% if product == "yandex-cloud" %}[function](../../functions/concepts/function.md){% endif %}{% if product == "cloud-il" %}function{% endif %} for each servlet:
