...
* `yds-functions` to call the [function](../../functions/concepts/function.md) in {{ sf-name }} and write events to [{{ yds-short-name }}](../../data-streams/concepts/glossary.md#stream-concepts).
