...
- Management console
   ...
   1. Under **Access**, specify the information required to access the VM:
      ...
      * In the **SSH key** field, paste your public SSH key. You need to create a key pair for the {% if lang == "ru" and audience != "internal" %}[SSH](../../glossary/ssh-keygen.md){% else %}SSH{% endif %} connection [yourself](../../compute/operations/vm-connect/ssh.md).
