...
- Management console
   ...
   1. Enter the VM access information:
      ...
      * In the **SSH key** field, paste the contents of the public key file.
         ...
         You will need to create a key pair for the {% if lang == "ru" and audience != "internal" %}[SSH](../../glossary/ssh-keygen.md){% else %}SSH{% endif %} connection yourself. For details, see [{#T}](../../compute/operations/vm-connect/ssh.md).
