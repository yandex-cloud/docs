...
You can also access {{ TF }} from your {% if product == "yandex-cloud" %}[Yandex account](../iam/concepts/index.md#passport),{% endif %}{% if product == "cloud-il" %}[Google account](../iam/concepts/index.md#passport){% endif %}, or a [federated account](../iam/concepts/index.md#saml-federation), but this method is less secure. For more information, see the end of this section.
