...
You'll learn to use [Samba](https://www.samba.org/) and [NFS]{% if lang == "ru" %}(https://docs.microsoft.com/ru-ru/windows-server/storage/nfs/nfs-overview){% endif %}{% if lang == "en" %}(https://docs.microsoft.com/en-us/windows-server/storage/nfs/nfs-overview){% endif %} to create a single-node file server, as well as connect to it from computers running Linux, macOS, and Windows.
...
- Management console
   ...
   1. Specify data required for accessing the VM:
      ...
      * In the **SSH key** field, paste the contents of the public key file. You will need to create a key pair for the {% if lang == "ru" and audience != "internal" %}[SSH](../../glossary/ssh-keygen.md){% else %}SSH{% endif %} connection [yourself](../../compute/operations/images-with-pre-installed-software/operate.md#creating-ssh-keys).
