...
Configure the network traffic permissions in the [default security group](../../vpc/concepts/security-groups.md#default-security-group). If a security group is unavailable, this will allow any inbound or outbound VM traffic.
...
- Management console {#console}
  ...
  1. Under **{{ ui-key.yacloud.compute.instances.create.section_image }}**:
      ...
      * From the public image list, select [Hystax Acura Disaster Recovery to {{ yandex-cloud }}](/marketplace/products/hystax/hystax-acura-disaster-recovery) and click **{{ ui-key.yacloud.marketplace-v2.button_use }}**.
  ...
  1. Under **{{ ui-key.yacloud.compute.instances.create.section_network }}**: 
      ...
      * If a list of **{{ ui-key.yacloud.component.compute.network-select.field_security-groups }}** is available, select the [security group](../../vpc/concepts/security-groups.md#default-security-group) whose network traffic permissions you previously configured. If this list is not there, all inbound and outbound traffic will be allowed for the VM.
...
1. Enter the `hystax-acura-vm` VM public IP address in your browser. This will open the initial Hystax Acura setup screen.
...
1. Set up a replication schedule and snapshot retention period using the **Edit replication schedule** and **Edit retention policies** options. For more information, see this [Hystax article](https://xn--q1ach.xn--p1ai/documentation/disaster-recovery-and-cloud-backup/dr_overview.html#edit-retention-policies).
...
For more details, see [this {{ vpc-name }} step-by-step guide](../../vpc/operations/subnet-create.md).
...
1. Tick the disaster recovery plans you need in the list. Expand and edit the plans, if required.
1. Click **Next**.
