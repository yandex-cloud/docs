...
To ensure a safe connection to the {{ dataproc-name }} cluster hosts, you'll need {% if lang == "ru" and audience != "internal" %}[SSH keys](../../glossary/ssh-keygen.md){% else %}SSH keys{% endif %}. If you generated SSH keys previously, you can skip this step.
