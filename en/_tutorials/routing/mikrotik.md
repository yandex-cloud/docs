...
1. Under **Images from {{ marketplace-name }}**, click **Select** and select the [Cloud Hosted Router]{% if lang == "ru" %}(https://cloud.yandex.ru/marketplace/products/f2etgh9qd7e7h47jrvr4){% endif %}{% if lang == "en" %}(https://cloud.yandex.com/en-ru/marketplace/products/f2etgh9qd7e7h47jrvr4){% endif %} image.
