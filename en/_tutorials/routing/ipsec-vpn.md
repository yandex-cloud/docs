...
1. In the **Images from {{ marketplace-name }}** section, click **Select** and choose the [IPSec instance](https://cloud.yandex.com/en-ru/marketplace/products/f2e70ohdvsd0jgp2302j) image.
