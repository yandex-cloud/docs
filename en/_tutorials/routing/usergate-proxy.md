...
[UserGate]{% if lang == "ru" %}(https://www.usergate.com/ru/products/enterprise-firewall){% else %}(https://www.usergate.com/products/enterprise-firewall){% endif %} is a next-generation firewall created by a Russia-based company Usergate.
   ...
   1. Under **Computing resources**:
      ...
      * Specify the number of vCPUs and amount of RAM:
         ...
         * **RAM**: 8 GB.
         ...
         These parameters are good for functional testing of the gateway. To calculate the parameters for the production workload, read the [official recommendations]{% if lang == "ru" %}(https://www.usergate.com/ru/products/usergate-vm){% else %}(https://www.usergate.com/products/usergate-vm){% endif %} from UserGate.
