...
1. Make sure the NAT instances are running and accessible from the internal network:
   ...
   - Management console {#console}
      ...
      1. [Navigate]({{ link-console-main }}/link/network-load-balancer) to **{{ ui-key.yacloud.iam.folder.dashboard.label_load-balancer }}** and select the page of the network load balancer named `route-switcher-lb-...`.
