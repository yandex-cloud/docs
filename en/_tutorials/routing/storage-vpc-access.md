...
* If you see a high `CPU steal time` value as the {{ objstorage-name }} workload increases, enable a [software-accelerated network](../../vpc/concepts/software-accelerated-network.md) for this NAT instance.
