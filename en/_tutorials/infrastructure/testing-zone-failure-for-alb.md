...
1. To get the resource blocking state info for an individual load balancer:
    ...
    - Management console {#console}
      ...
      1. [Navigate]({{ link-console-main }}/link/application-load-balancer) to **{{ ui-key.yacloud.iam.folder.dashboard.label_application-load-balancer }}** and select the load balancer.
