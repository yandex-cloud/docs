...
1. Create a VM:
    ...
    - Management console {#console}
      ...
      1. Under **{{ ui-key.yacloud.compute.instances.create.section_image }}**, go to the `{{ ui-key.yacloud.compute.instances.create.image_value_custom_new }}` tab and select the **Windows Server** image. For more on how to upload an image of your own for Microsoft products, see [Importing an image](../../microsoft/byol.md#how-to-import).
