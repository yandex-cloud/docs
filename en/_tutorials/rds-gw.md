...
- Management console
   ...
   1. Open the **{{ vpc-name }}** section of the folder where you want to create a security group.
...
1. Set the required roles and [snap-ins](https://docs.microsoft.com/en-us/troubleshoot/windows-server/system-management-components/what-is-microsoft-management-console#more-information):
