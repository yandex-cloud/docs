...
1. Set up security groups so that you can connect to clusters from the internet and created VM, and connect to this VM over {% if lang == "ru" %}[SSH](../../glossary/ssh-keygen.md){% else %}SSH{% endif %} from the internet:
