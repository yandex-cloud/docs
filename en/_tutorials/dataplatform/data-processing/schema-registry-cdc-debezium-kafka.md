...
- Management console {#console}
  ...
  1. [Navigate to](../../../console/operations/select-service.md#select-service) the **{{ metadata-hub-full-name }}** service.
  ...
  1. [Navigate to](../../../console/operations/select-service.md#select-service) the **{{ data-transfer-full-name }}** service. 
