...
To execute a Hive job:

1. [Set up your infrastructure](#infra).
1. [Create a Hive job](#create-job).
...
1. [Create a Hive job](../../../data-proc/operations/jobs-hive#create) with the following parameters:
...
1. [Open the job logs](../../../data-proc/operations/jobs-hive#get-logs) and view the processing results:
