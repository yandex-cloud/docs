...
1. {% if audience != "internal" %}[Connect to the VM](../../compute/operations/vm-connect/ssh.md){% else %}Connect to the VM{% endif %}.
...
* Manually created resources
   ...
   1. If you created an intermediate virtual machine, {% if audience != "internal" %}[delete it](../../compute/operations/vm-control/vm-delete.md){% else %}delete it{% endif %}.
   1. If you reserved public static IP addresses, release and {% if audience != "internal" %}[delete them](../../vpc/operations/address-delete.md){% else %}delete them{% endif %}.
