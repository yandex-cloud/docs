...
[Create a {{ mmg-name }}](../../managed-mongodb/operations/cluster-create.md) target cluster with the computing capacity and storage size appropriate for the environment where the migrated database is deployed.
...
For other migration methods, see the [{{ mmg-full-name }}](../../managed-mongodb/tutorials/data-migration.md) documentation.
