...
1. Make sure that the data from the topic in the source {{ ydb-name }} cluster is being moved to the {{ mkf-name }} database:
   ...
   1. Make sure that the data from the source {{ mkf-name }} cluster has been moved to the {{ ydb-name }} database:
