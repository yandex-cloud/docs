...
- Manually
   ...
   1. [Create an intermediate Linux virtual machine](../../compute/operations/vm-create/create-linux-vm.md) in {{ compute-full-name }} on the same network as the {{ mrd-name }} cluster using the following configuration:
...
- Using Terraform
   ...
   1. If you don't have {{ TF }}, [install it](../../tutorials/infrastructure-management/terraform-quickstart.md#install-terraform).
      ...
      1. Specify the following in the configuration file:
         ...
         * Login and path to the [public SSH key](../../compute/operations/vm-connect/ssh.md#creating-ssh-keys) to use for accessing the virtual machine.
...
1. [Connect to the intermediate VM via SSH](../../compute/operations/vm-connect/ssh.md) and start an interactive `screen` session:
