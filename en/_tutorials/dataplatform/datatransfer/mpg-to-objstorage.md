...
- Manually {#manual}
    ...
    1. If you are using [security groups](../../../managed-postgresql/operations/connect/index.md#configuring-security-groups) in a cluster, make sure they are configured correctly and allow connections to it.
