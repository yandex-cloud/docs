...
* {{ mos-name }} cluster fee: Covers the use of computational resources allocated to hosts (including hosts with the `MANAGER` role) and disk storage (see [{{ mos-name }} pricing](../../../managed-opensearch/pricing.md)).
