...
- Management console {#console}
  ...
  1. In the **{{ ui-key.yacloud.lockbox.SecretVersionsList.label_key }}** field, enter a non-secret ID, e.g., `test-secret`.
  1. In the **{{ ui-key.yacloud.lockbox.SecretVersionsList.label_value }}** field, enter the confidential data you want to store, e.g., `hello-world`.
  1. Click **{{ ui-key.yacloud.common.create }}**.
  1. Save the secret ID, as you will need it later.
