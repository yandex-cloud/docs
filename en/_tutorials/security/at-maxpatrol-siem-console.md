...
- {{ cloud-center }} UI {#console}
  ...
  1. Click ![plus](../../_assets/console-icons/plus.svg) **{{ ui-key.yacloud_components.acl.button.add-role }}** and select [`audit-trails.viewer`](../../audit-trails/security/index.md#at-viewer).
