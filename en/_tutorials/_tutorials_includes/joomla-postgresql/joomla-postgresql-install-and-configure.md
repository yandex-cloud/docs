...
1. Export the `joomla-cert` TLS certificate to your local computer:
    ...
    - Management console {#console}
        ...
        1. [Navigate]({{ link-console-main }}/link/certificate-manager) to **{{ ui-key.yacloud.iam.folder.dashboard.label_certificate-manager }}** and select the `joomla-cert` certificate.
