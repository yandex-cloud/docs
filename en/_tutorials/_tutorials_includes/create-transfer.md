...
- Management console {#console}
  ...
  1. Create a source [endpoint](../../data-transfer/concepts/index.md#endpoint):
     1. In the left-hand panel, select ![endpoint](../../_assets/console-icons/aperture.svg) **{{ ui-key.yacloud.data-transfer.label_endpoints }}**.
     ...
     1. Enter the endpoint **{{ ui-key.yacloud.common.name }}**, e.g., `logs-source`.
  ...
  1. Create a target endpoint:
     ...
     1. Enter a **{{ ui-key.yacloud.common.name }}** for the endpoint, e.g., `logs-receiver`.
  ...
  1. Create a transfer:
     ...
     1. Enter a **{{ ui-key.yacloud.common.name }}** for the transfer, e.g., `logs-transfer`.
     ...
     1. Click **{{ ui-key.yacloud.common.create }}**.
  1. To the right of your new transfer, click ![ellipsis](../../_assets/console-icons/ellipsis.svg) → ![image](../../_assets/console-icons/play.svg) **{{ ui-key.yacloud.data-transfer.label_connector-operation-ACTIVATE }}**.
