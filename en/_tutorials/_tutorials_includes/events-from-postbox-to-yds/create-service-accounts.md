1. Create a service account named `yds-functions`:
    ...
    - Management console {#console}
      ...
      1. [Go](../../../console/operations/select-service.md#select-service) to **{{ ui-key.yacloud.iam.folder.dashboard.label_iam }}** and click **{{ ui-key.yacloud.iam.folder.service-accounts.button_add }}**.
