1. Create a service account named `yds-functions`:
    ...
    - Management console {#console}
      ...
      1. [Navigate]({{ link-console-main }}/link/iam) to **{{ ui-key.yacloud.iam.folder.dashboard.label_iam }}** and click **{{ ui-key.yacloud.iam.folder.service-accounts.button_add }}**.
