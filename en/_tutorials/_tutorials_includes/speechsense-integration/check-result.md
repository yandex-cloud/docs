...
- {{ speechsense-name }} UI {#speechsense}
  ...
  1. Select the project you created [earlier](#create-project).
      ...
      On the project panel, you will see the imported calls and transcripts. After that, you will be able to [configure reports]({{ link-docs-ai }}speechsense/operations/data/manage-reports).
