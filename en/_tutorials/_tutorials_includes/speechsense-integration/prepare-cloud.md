...
1. Navigate to the [management console]({{ link-console-main }}) and log in to {{ yandex-cloud }}, or sign up if you have not already. For information, see [Getting started with {{ yandex-cloud }}](../../../getting-started/).
