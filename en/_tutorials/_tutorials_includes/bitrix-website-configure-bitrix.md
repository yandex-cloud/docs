...
1. Open the 1C-Bitrix: Website Management. Do it by going to `http://<VM_public_IP_address>/` in your browser. This should open a page prompting you to install 1C-Bitrix.
1. Click **Next**.
...
1. Configure the database:
   1. In the **Server** field, enter the fully qualified domain name (FQDN) of the DB you created. To find out this name:
      1. In the [management console]({{ link-console-main }}), select the folder page in a new browser tab.
