...
1. Under **Images from {{ marketplace-name }}**, select an image of the [Ubuntu 18.04 lts](https://cloud.yandex.com/en-ru/marketplace/products/f2e9qa7i4fmugh14tjnc) operating system.
