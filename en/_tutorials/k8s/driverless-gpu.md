...
1. Install GPU Operator:
    ...
    GPU Operator will be installed with default parameters. Learn more about parameters in these [official guides](https://docs.nvidia.com/datacenter/cloud-native/gpu-operator/latest/getting-started.html#common-chart-customization-options).
