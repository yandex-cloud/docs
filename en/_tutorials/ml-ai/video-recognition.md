...
* Fee for using a bucket (see [{{ objstorage-full-name }} pricing](../../storage/pricing.md)).
* Fee for using computing resources (see [{{ ml-platform-full-name }} pricing](../../datasphere/pricing.md)).
...
## Install the dependencies {#satisfy-dependencies}
