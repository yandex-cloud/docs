...
1. Click **Create**.
1. To generate a dataframe, create and run a paragraph with code. The paragraph text depends on whether there is public access to the {{ mch-full-name }} cluster hosts.
...
## Importing data to {{ mch-full-name }} {#import-to-mch}

### Preparing source data {#prepare-source-data}
