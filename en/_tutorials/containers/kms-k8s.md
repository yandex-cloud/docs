...
- CLI {#cli}
  ...
  You can specify a key when [creating](../../managed-kubernetes/operations/kubernetes-cluster/kubernetes-cluster-create.md) your {{ managed-k8s-name }} cluster in the following ways:
...
- {{ TF }} {#tf}
  ...
  Specify a key when [creating your {{ managed-k8s-name }} cluster](../../managed-kubernetes/operations/kubernetes-cluster/kubernetes-cluster-create.md):
