...
- Manually
   ...
   1. [Create service accounts](../../iam/operations/sa/create.md):
      * [Service account](../../iam/concepts/users/service-accounts.md) for {{ k8s }} resources with the [](../../iam/concepts/access-control/roles.md)[ {{ roles-editor }}role](../../iam/concepts/access-control/roles.md#editor) for the [folder](../../resource-manager/concepts/resources-hierarchy.md#folder) where the {{ managed-k8s-name }} cluster is created.
