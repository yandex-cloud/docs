...
* Manually
   ...
   1. {% if product == "yandex-cloud" %}[Create a source {{ mgp-full-name }} cluster](../managed-greenplum/operations/cluster-create.md#create-cluster){% else %}Create a source {{ mgp-full-name }} cluster{% endif %} of any suitable configuration.
