...
1. Connect to the created VM via {% if lang == "ru" and audience != "internal" %}[SSH](../../glossary/ssh-keygen.md){% else %}SSH{% endif %}. The connection address is specified in the `terraform apply` command result.
