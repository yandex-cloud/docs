...
* [Helm]{% if lang == "ru" %}(https://helm.sh/ru/docs/){% endif %}{% if lang == "en" %}(https://helm.sh/docs/){% endif %} 3.9.0.
...
1. [Generate](../../compute/operations/vm-connect/ssh.md#creating-ssh-keys) an {% if lang == "ru" and audience != "internal" %}[SSH key](../../glossary/ssh-keygen.md){% else %}SSH key{% endif %} pair. You'll need them to create a VM and connect to it.
