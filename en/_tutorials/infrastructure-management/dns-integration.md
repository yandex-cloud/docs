...
1. [Read the integration example](#network-desc).
...
1. The {{ yandex-cloud }} cloud network also consists of two subnets:
   ...
   * `172.16.4.0/24`: subnet4, in the `{{ region-id }}-b` availability zone.
   ...
   {{ yandex-cloud }} DNS servers, `172.16.3.2` and `172.16.4.2`, are hosted in these subnets.

   These servers serve [private DNS zones](../../dns/concepts/dns-zone.md#private-zones) in the cloud network.
...
* [Delete](../../vpc/operations/address-delete) the static public IP addresses if you reserved them specifically for your VMs.
