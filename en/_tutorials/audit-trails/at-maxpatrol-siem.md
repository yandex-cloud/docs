...
[MaxPatrol SIEM](https://www.ptsecurity.com/ru-ru/products/mpsiem/) is able to read {{ yandex-cloud }} [audit logs](../../audit-trails/concepts/events.md) from a [{{ yds-full-name }}](../../data-streams/index.yaml) data stream. To go through the entire tutorial, you must have access to an instance of MaxPatrol SIEM.
