---
title: Working with the investigation list in {{ yandex-siem-full-name }}
description: Follow this guide to learn how to filter, search, and sort investigations in {{ yandex-siem-full-name }}.
---
