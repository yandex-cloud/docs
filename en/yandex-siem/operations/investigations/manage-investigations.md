---
title: Investigation management in {{ yandex-siem-full-name }}
description: Follow this guide to learn how to create, update, copy, and delete investigations in {{ yandex-siem-full-name }}.
---
