---
title: Managing queries in {{ yandex-siem-full-name }}
description: Follow this guide to learn how to create, edit, run, and delete queries in {{ yandex-siem-full-name }}.
---
