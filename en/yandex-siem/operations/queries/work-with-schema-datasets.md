---
title: Working with a database schema and datasets in {{ yandex-siem-full-name }}
description: Follow this guide to learn how to work with a database schema and datasets in {{ yandex-siem-full-name }}.
---
