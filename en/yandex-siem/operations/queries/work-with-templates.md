---
title: Working with query templates in {{ yandex-siem-full-name }}
description: Follow this guide to learn how to work with query templates in {{ yandex-siem-full-name }}.
---
