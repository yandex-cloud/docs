---
title: Investigations in {{ yandex-siem-full-name }}
description: Use investigations in {{ yandex-siem-full-name }} to analyze security events with the help of KQL queries, templates, and datasets.
---
