---
title: Queries in {{ yandex-siem-full-name }}
description: Queries in {{ yandex-siem-full-name }} use KQL to find and analyze security events.
---
...
To search for events, {{ yandex-siem-full-name }} uses a subset of the [Kusto Query Language (KQL)](../kql-reference.md). KQL enables you to filter, aggregate, and analyze security events for the past 90 days.
