...
```
POST undefined/microcosm/v1/deploymentTemplates
```
...
```json 
{
  ...
  //  includes only one of the fields `deploymentSpec`, `deploymentYaml`
  "deploymentSpec": {
    "resources": [
      {
        "name": "string",
...
Field | Description
--- | ---
infrastructureTemplateId | **string**<br><p>Required. The maximum string length in characters is 50.</p> 
version | **string**<br><p>Required. The maximum string length in characters is 32.</p> 
tags[] | **string**<br><p>The maximum number of elements is 32. The maximum string length in characters for each value is 32.</p> 
upgradableFrom[] | **string**<br><p>The maximum number of elements is 32. The maximum string length in characters for each value is 32.</p> 
deploymentSpec | **object** <br> includes only one of the fields `deploymentSpec`, `deploymentYaml`<br><br>
...
deploymentYaml | **string** <br> includes only one of the fields `deploymentSpec`, `deploymentYaml`<br><br>
