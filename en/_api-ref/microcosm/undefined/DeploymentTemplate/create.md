...
deploymentSpec | **object** <br> includes only one of the fields `deploymentSpec`, `deploymentYaml`<br>
...
deploymentYaml | **string** <br> includes only one of the fields `deploymentSpec`, `deploymentYaml`<br>
