...
```
POST undefined/microcosm/v1/deploymentTemplates/tags
```
...
Field | Description
--- | ---
deploymentTemplateId | **string**<br><p>Required. The maximum string length in characters is 50.</p> 
tag | **string**<br><p>Required.</p> 
