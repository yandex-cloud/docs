...
--- | ---
targetGroupId | <p>Required. ID of the TargetGroup resource to add targets to. To get the target group ID, use a <a href="/docs/network-load-balancer/api-ref/TargetGroup/list">list</a> request.</p> <p>The maximum string length in characters is 50.</p> 
...
Field | Description
--- | ---
targets[] | **object**<br><p>Required. List of targets to add to the target group.</p> <p>The minimum number of elements is 1.</p> 
