...
# Monitoring API, REST: Channel.create
Creates a channel.
...
Field | Description
--- | ---
folderId | **string**<br><p>Required. ID of the folder to create channel in.</p> <p>The maximum string length in characters is 50.</p> 
