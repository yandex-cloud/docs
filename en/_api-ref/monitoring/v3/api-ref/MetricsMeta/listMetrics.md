...
```
GET https://monitoring.api.cloud.yandex.net/monitoring/v3/metrics
```
...
pageToken | Page token. To get the next page of results, set [pageToken](/docs/monitoring/api-ref/MetricsMeta/listMetrics#query_params) to the [nextPageToken](/docs/monitoring/api-ref/MetricsMeta/listMetrics#responses) returned by a previous list request. (Pagination works in concrete zone ID and concrete shard)
