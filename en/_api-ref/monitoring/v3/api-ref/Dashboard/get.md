...
```
GET https://monitoring.api.cloud.yandex.net/monitoring/v3/dashboards/{dashboardId}
```
...
Field | Description
--- | ---
id | **string**<br><p>Dashboard ID.</p> 
createdAt | **string** (date-time)<br><p>Creation timestamp.</p> <p>String in <a href="https://www.ietf.org/rfc/rfc3339.txt">RFC3339</a> text format.</p> 
modifiedAt | **string** (date-time)<br><p>Modification timestamp.</p> <p>String in <a href="https://www.ietf.org/rfc/rfc3339.txt">RFC3339</a> text format.</p> 
createdBy | **string**<br><p>ID of the user who created the dashboard.</p> 
modifiedBy | **string**<br><p>ID of the user who modified the dashboard.</p> 
name | **string**<br><p>Dashboard name.</p> 
description | **string**<br><p>Dashboard description.</p> 
...
widgets[].<br>text | **object**<br>Text widget. <br>`widgets[]` includes only one of the fields `text`, `title`, `chart`<br><br><p>Text widget.</p> 
widgets[].<br>text.<br>text | **string** <br>`widgets[]` includes only one of the fields `text`, `title`, `chart`<br><br><p>Text.</p> 
widgets[].<br>title | **object**<br>Title widget. <br>`widgets[]` includes only one of the fields `text`, `title`, `chart`<br><br><p>Title widget.</p> 
...
widgets[].<br>chart | **object**<br>Chart widget. <br>`widgets[]` includes only one of the fields `text`, `title`, `chart`<br><br><p>Chart widget.</p> 
...
widgets[].<br>chart.<br>queries.<br>targets[] | **object**<br><p>Query target.</p> 
...
widgets[].<br>chart.<br>visualizationSettings.<br>interpolate | **string**<br><p>Interpolate.</p> <ul> <li>INTERPOLATE_UNSPECIFIED: Not specified (linear by default).</li> <li>INTERPOLATE_LINEAR: Linear.</li> <li>INTERPOLATE_LEFT: Left.</li> <li>INTERPOLATE_RIGHT: Right.</li> </ul> 
widgets[].<br>chart.<br>visualizationSettings.<br>aggregation | **string**<br><p>Aggregation.</p> <ul> <li>SERIES_AGGREGATION_UNSPECIFIED: Not specified (avg by default).</li> <li>SERIES_AGGREGATION_AVG: Average.</li> <li>SERIES_AGGREGATION_MIN: Minimum.</li> <li>SERIES_AGGREGATION_MAX: Maximum.</li> <li>SERIES_AGGREGATION_LAST: Last non-NaN value.</li> <li>SERIES_AGGREGATION_SUM: Sum.</li> </ul> 
widgets[].<br>chart.<br>visualizationSettings.<br>colorSchemeSettings | **object**<br><p>Color scheme settings.</p> 
widgets[].<br>chart.<br>visualizationSettings.<br>colorSchemeSettings.<br>automatic | **object**<br>Automatic color scheme. <br>`widgets[].chart.visualizationSettings.colorSchemeSettings` includes only one of the fields `automatic`, `standard`, `gradient`<br><br>
widgets[].<br>chart.<br>visualizationSettings.<br>colorSchemeSettings.<br>standard | **object**<br>Standard color scheme. <br>`widgets[].chart.visualizationSettings.colorSchemeSettings` includes only one of the fields `automatic`, `standard`, `gradient`<br><br>
widgets[].<br>chart.<br>visualizationSettings.<br>colorSchemeSettings.<br>gradient | **object**<br>Gradient color scheme. <br>`widgets[].chart.visualizationSettings.colorSchemeSettings` includes only one of the fields `automatic`, `standard`, `gradient`<br><br>
...
widgets[].<br>chart.<br>visualizationSettings.<br>yaxisSettings.<br>left.<br>type | **string**<br><p>Type.</p> <p>Y axis type. N.B. _TYPE prefix is necessary to expect name clash with Interpolate LINEAR value.</p> <ul> <li>YAXIS_TYPE_UNSPECIFIED: Not specified (linear by default).</li> <li>YAXIS_TYPE_LINEAR: Linear.</li> <li>YAXIS_TYPE_LOGARITHMIC: Logarithmic.</li> </ul> 
...
widgets[].<br>chart.<br>visualizationSettings.<br>yaxisSettings.<br>right.<br>type | **string**<br><p>Type.</p> <p>Y axis type. N.B. _TYPE prefix is necessary to expect name clash with Interpolate LINEAR value.</p> <ul> <li>YAXIS_TYPE_UNSPECIFIED: Not specified (linear by default).</li> <li>YAXIS_TYPE_LINEAR: Linear.</li> <li>YAXIS_TYPE_LOGARITHMIC: Logarithmic.</li> </ul> 
...
widgets[].<br>chart.<br>seriesOverrides[] | **object**<br><p>Series override settings.</p> 
widgets[].<br>chart.<br>seriesOverrides[].<br>settings | **object**<br>Required. Override settings.<br>
...
widgets[].<br>chart.<br>seriesOverrides[].<br>settings.<br>yaxisPosition | **string**<br><p>Yaxis position.</p> <ul> <li>YAXIS_POSITION_UNSPECIFIED: Not specified (left by default).</li> <li>YAXIS_POSITION_LEFT: Left.</li> <li>YAXIS_POSITION_RIGHT: Right.</li> </ul> 
...
parametrization | **object**<br>Dashboard parametrization.<br><p>Parametrization.</p> 
...
parametrization.<br>parameters[].<br>labelValues | **object**<br>Label values parameter. <br>`parametrization.parameters[]` includes only one of the fields `labelValues`, `custom`, `text`, `integerParameter`, `doubleParameter`, `textValues`<br><br><p>Label values parameter.</p> 
...
parametrization.<br>parameters[].<br>custom | **object**<br>Custom parameter. <br>`parametrization.parameters[]` includes only one of the fields `labelValues`, `custom`, `text`, `integerParameter`, `doubleParameter`, `textValues`<br><br><p>Custom parameter.</p> 
...
parametrization.<br>parameters[].<br>text | **object**<br>Text parameter. <br>`parametrization.parameters[]` includes only one of the fields `labelValues`, `custom`, `text`, `integerParameter`, `doubleParameter`, `textValues`<br><br><p>Text parameter.</p> 
parametrization.<br>parameters[].<br>text.<br>defaultValue | **string**<br><p>Default value.</p> 
parametrization.<br>parameters[].<br>integerParameter | **object**<br>Integer parameter. <br>`parametrization.parameters[]` includes only one of the fields `labelValues`, `custom`, `text`, `integerParameter`, `doubleParameter`, `textValues`<br><br><p>Integer parameter.</p> 
...
parametrization.<br>parameters[].<br>doubleParameter | **object**<br>Double parameter. <br>`parametrization.parameters[]` includes only one of the fields `labelValues`, `custom`, `text`, `integerParameter`, `doubleParameter`, `textValues`<br><br><p>Double parameter.</p> 
...
parametrization.<br>parameters[].<br>textValues | **object**<br>Integer parameter. <br>`parametrization.parameters[]` includes only one of the fields `labelValues`, `custom`, `text`, `integerParameter`, `doubleParameter`, `textValues`<br><br><p>Text multiple values parameter.</p> 
...
etag | **string**<br><p>Dashboard etag.</p> 
