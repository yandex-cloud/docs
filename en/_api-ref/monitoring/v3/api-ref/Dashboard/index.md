...
parametrization.<br>parameters[].<br>labelValues | **object** <br>`parametrization.parameters[]` includes only one of the fields `labelValues`, `custom`, `text`<br><br><p>Label values parameter.</p> 
...
parametrization.<br>parameters[].<br>custom | **object** <br>`parametrization.parameters[]` includes only one of the fields `labelValues`, `custom`, `text`<br><br><p>Custom parameter.</p> 
...
parametrization.<br>parameters[].<br>text | **object** <br>`parametrization.parameters[]` includes only one of the fields `labelValues`, `custom`, `text`<br><br><p>Text parameter.</p> 
