...
# Monitoring API, REST: Dashboard methods
...
widgets[].<br>position | **object**<br><p>Layout item for widget item positioning.</p> 
...
widgets[].<br>text | **object** <br>`widgets[]` includes only one of the fields `text`, `title`, `chart`<br><br><p>Text widget.</p> 
widgets[].<br>text.<br>text | **string** <br>`widgets[]` includes only one of the fields `text`, `title`, `chart`<br><br><p>Text.</p> 
widgets[].<br>title | **object** <br>`widgets[]` includes only one of the fields `text`, `title`, `chart`<br><br><p>Title widget.</p> 
...
widgets[].<br>chart | **object** <br>`widgets[]` includes only one of the fields `text`, `title`, `chart`<br><br><p>Chart widget.</p> 
...
widgets[].<br>chart.<br>visualizationSettings.<br>colorSchemeSettings.<br>automatic | **object** <br>`widgets[].chart.visualizationSettings.colorSchemeSettings` includes only one of the fields `automatic`, `standard`, `gradient`<br>
widgets[].<br>chart.<br>visualizationSettings.<br>colorSchemeSettings.<br>standard | **object** <br>`widgets[].chart.visualizationSettings.colorSchemeSettings` includes only one of the fields `automatic`, `standard`, `gradient`<br>
widgets[].<br>chart.<br>visualizationSettings.<br>colorSchemeSettings.<br>gradient | **object** <br>`widgets[].chart.visualizationSettings.colorSchemeSettings` includes only one of the fields `automatic`, `standard`, `gradient`<br>
...
widgets[].<br>chart.<br>seriesOverrides[].<br>settings | **object**
...
parametrization | **object**<br><p>Parametrization.</p> 
...
parametrization.<br>parameters[].<br>labelValues | **object** <br>`parametrization.parameters[]` includes only one of the fields `labelValues`, `custom`, `text`, `integerParameter`, `doubleParameter`, `textValues`<br><br><p>Label values parameter.</p> 
...
parametrization.<br>parameters[].<br>custom | **object** <br>`parametrization.parameters[]` includes only one of the fields `labelValues`, `custom`, `text`, `integerParameter`, `doubleParameter`, `textValues`<br><br><p>Custom parameter.</p> 
...
parametrization.<br>parameters[].<br>text | **object** <br>`parametrization.parameters[]` includes only one of the fields `labelValues`, `custom`, `text`, `integerParameter`, `doubleParameter`, `textValues`<br><br><p>Text parameter.</p> 
parametrization.<br>parameters[].<br>text.<br>defaultValue | **string**<br><p>Default value.</p> 
parametrization.<br>parameters[].<br>integerParameter | **object** <br>`parametrization.parameters[]` includes only one of the fields `labelValues`, `custom`, `text`, `integerParameter`, `doubleParameter`, `textValues`<br><br><p>Integer parameter.</p> 
...
parametrization.<br>parameters[].<br>doubleParameter | **object** <br>`parametrization.parameters[]` includes only one of the fields `labelValues`, `custom`, `text`, `integerParameter`, `doubleParameter`, `textValues`<br><br><p>Double parameter.</p> 
...
parametrization.<br>parameters[].<br>textValues | **object** <br>`parametrization.parameters[]` includes only one of the fields `labelValues`, `custom`, `text`, `integerParameter`, `doubleParameter`, `textValues`<br><br><p>Text multiple values parameter.</p> 
...
Method | Description
--- | ---
[create](create.md) | Creates a new dashboard in the specified folder.
[delete](delete.md) | Deletes the specified dashboard.
[get](get.md) | Returns the specified dashboard.
[list](list.md) | Retrieves the list of dashboards in the specified folder.
[listOperations](listOperations.md) | Lists operations for the specified dashboard.
[update](update.md) | Updates the specified dashboard.