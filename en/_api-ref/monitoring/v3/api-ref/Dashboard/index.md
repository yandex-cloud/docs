...
widgets[].<br>chart.<br>visualizationSettings.<br>colorSchemeSettings.<br>automatic | **object** <br>`widgets[].chart.visualizationSettings.colorSchemeSettings` includes only one of the fields `automatic`, `standard`, `gradient`<br><br>
widgets[].<br>chart.<br>visualizationSettings.<br>colorSchemeSettings.<br>standard | **object** <br>`widgets[].chart.visualizationSettings.colorSchemeSettings` includes only one of the fields `automatic`, `standard`, `gradient`<br><br>
widgets[].<br>chart.<br>visualizationSettings.<br>colorSchemeSettings.<br>gradient | **object** <br>`widgets[].chart.visualizationSettings.colorSchemeSettings` includes only one of the fields `automatic`, `standard`, `gradient`<br><br>
...
widgets[].<br>chart.<br>seriesOverrides[].<br>settings | **object**<br>
