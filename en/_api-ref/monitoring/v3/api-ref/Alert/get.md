...
# Monitoring API, REST: Alert.get
Returns the specified Alert resource.
 
To get the list of available Alert resources, make a [list](/docs/monitoring/api-ref/Alert/list) request.
...
--- | ---
alertId | <p>Required. ID of the Alert resource to return.</p> <p>The maximum string length in characters is 50.</p> 
