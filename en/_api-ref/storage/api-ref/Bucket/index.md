...
name | **string**<br><p>Name of the bucket.</p> <p>The name is unique within Yandex.Cloud. For naming limitations and rules, see <a href="/docs/storage/concepts/bucket#naming">documentation</a>.</p> 
