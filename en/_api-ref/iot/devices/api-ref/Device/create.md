...
name | **string**<br><p>Required. Name of the device. The name must be unique within the registry.</p> <p>The maximum string length in characters is 50. Value must match the regular expression <code>[a-zA-Z0-9_-]*</code>.</p> 
