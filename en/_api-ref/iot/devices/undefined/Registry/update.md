...
```
PATCH undefined/iot-devices/v1/registries/{registryId}
```
...
name | **string**<br><p>The maximum string length in characters is 50. Value must match the regular expression <code>[a-zA-Z0-9_-]*</code>.</p> 
