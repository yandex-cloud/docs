...
--- | ---
brokerId | Required. ID of the broker to add a password for.  To get a broker ID make a [list](/docs/iot-core/broker/api-ref/Broker/list) request.  The maximum string length in characters is 50.
