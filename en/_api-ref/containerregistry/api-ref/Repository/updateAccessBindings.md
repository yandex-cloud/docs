...
# Container Registry API, REST: Repository.updateAccessBindings
...
```
POST https://container-registry.{{ api-host }}/container-registry/v1/repositories/{resourceId}:updateAccessBindings
```
