  ...
  "backups": [
    {
      ...
      "backupSettings": {
        ...
        "backupSchedule": {
          ...
          // `backups[].backupSettings.backupSchedule` includes only one of the fields `dailyBackupSchedule`, `weeklyBackupSchedule`
          "dailyBackupSchedule": {
            "executeTime": {
              "hours": "integer",
              "minutes": "integer",
...
backups[].<br>backupSettings.<br>backupSchedule.<br>dailyBackupSchedule | **object** <br>`backups[].backupSettings.backupSchedule` includes only one of the fields `dailyBackupSchedule`, `weeklyBackupSchedule`<br><br>
...
backups[].<br>backupSettings.<br>backupSchedule.<br>weeklyBackupSchedule | **object** <br>`backups[].backupSettings.backupSchedule` includes only one of the fields `dailyBackupSchedule`, `weeklyBackupSchedule`<br><br>
