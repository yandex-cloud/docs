...
Field | Description
--- | ---
desktopGroupId | **string**<br><p>Required. ID of the desktop group.</p> <p>The maximum string length in characters is 50.</p> 
users[] | **object**<br><p>Required. List of users.</p> <p>Must contain at least one element.</p> 
