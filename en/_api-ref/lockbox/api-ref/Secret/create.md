...
versionPayloadEntries[].<br>key | **string**<br><p>Required. Non-confidential key of the entry.</p> <p>The maximum string length in characters is 256. Value must match the regular expression <code>[.-_0-9a-zA-Z]+</code>.</p> 
