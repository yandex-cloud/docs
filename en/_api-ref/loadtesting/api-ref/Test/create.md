...
```
POST https://loadtesting.{{ api-host }}/loadtesting/v2/tests
```
...
loggingLogGroupId | **string**
payloadStorageObject | **object**
payloadStorageObject.<br>objectStorageBucket | **string**
payloadStorageObject.<br>objectStorageFilename | **string**
