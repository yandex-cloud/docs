...
rule.<br>timer | **object** <br>`rule` includes only one of the fields `timer`, `messageQueue`, `iotMessage`, `objectStorage`<br><br><p>Rule for activating a timed trigger.</p> 
...
rule.<br>messageQueue | **object** <br>`rule` includes only one of the fields `timer`, `messageQueue`, `iotMessage`, `objectStorage`<br><br><p>Rule for activating a message queue trigger.</p> 
...
rule.<br>iotMessage | **object** <br>`rule` includes only one of the fields `timer`, `messageQueue`, `iotMessage`, `objectStorage`<br><br><p>Rule for activating a Yandex IoT Core trigger.</p> 
