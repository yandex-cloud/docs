...
rule.<br>timer | **object** <br>`rule` includes only one of the fields `timer`, `messageQueue`, `iotMessage`, `objectStorage`, `containerRegistry`<br><br><p>Rule for activating a timed trigger.</p> 
...
rule.<br>timer.<br>invokeFunctionWithRetry.<br>functionTag | **string**<br><p>Tag of the function version to execute.</p> 
...
rule.<br>messageQueue | **object** <br>`rule` includes only one of the fields `timer`, `messageQueue`, `iotMessage`, `objectStorage`, `containerRegistry`<br><br><p>Rule for activating a message queue trigger.</p> 
...
rule.<br>iotMessage | **object** <br>`rule` includes only one of the fields `timer`, `messageQueue`, `iotMessage`, `objectStorage`, `containerRegistry`<br><br><p>Rule for activating a Yandex IoT Core trigger.</p> 
...
rule.<br>objectStorage.<br>invokeFunction.<br>functionTag | **string**<br><p>Tag of the function version to execute.</p> 
...
rule.<br>containerRegistry.<br>tag | **string**<br>
...
rule.<br>containerRegistry.<br>invokeFunction.<br>functionTag | **string**<br><p>Tag of the function version to execute.</p> 
