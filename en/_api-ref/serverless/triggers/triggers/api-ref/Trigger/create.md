...
name | **string**<br><p>Name of the trigger. The name must be unique within the folder.</p> <p>Value must match the regular expression <code>\|[a-z][-a-z0-9]{1,61}[a-z0-9]</code>.</p> 
...
rule.<br>timer | **object**<br>Rule for a timed trigger. <br>`rule` includes only one of the fields `timer`, `messageQueue`, `iotMessage`, `objectStorage`<br><br><p>Rule for activating a timed trigger.</p> 
...
rule.<br>messageQueue | **object**<br>Rule for a message queue trigger. <br>`rule` includes only one of the fields `timer`, `messageQueue`, `iotMessage`, `objectStorage`<br><br><p>Rule for activating a message queue trigger.</p> 
...
rule.<br>iotMessage | **object**<br>Rule for a Yandex IoT Core trigger. <br>`rule` includes only one of the fields `timer`, `messageQueue`, `iotMessage`, `objectStorage`<br><br><p>Rule for activating a Yandex IoT Core trigger.</p> 
