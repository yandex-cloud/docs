...
Field | Description
--- | ---
folderId | **string**<br><p>Required. ID of the folder to create a proxy in.</p> <p>To get a folder ID make a <a href="/docs/resource-manager/api-ref/Folder/list">list</a> request.</p> 
name | **string**<br><p>Name of the proxy. The name must be unique within the folder.</p> <p>Value must match the regular expression ``\|[a-z][-a-z0-9]{1,61}[a-z0-9]``.</p> 
description | **string**<br><p>Description of the proxy.</p> <p>The maximum string length in characters is 256.</p> 
...
target | **object**<br><p>Required. Proxy target.</p> 
target.<br>clickhouse | **object**<br>Clickhouse settings for proxy. <br>`target` includes only one of the fields `clickhouse`, `postgresql`<br><br>
...
target.<br>postgresql | **object**<br>PostgreSQL settings for proxy. <br>`target` includes only one of the fields `clickhouse`, `postgresql`<br><br>
