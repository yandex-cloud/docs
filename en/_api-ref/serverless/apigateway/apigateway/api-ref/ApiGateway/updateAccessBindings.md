...
accessBindingDeltas[].<br>accessBinding.<br>roleId | **string**<br><p>Required. ID of the <a href="/docs/iam/api-ref/Role#representation">Role</a> that is assigned to the <code>subject</code>.</p> <p>The maximum string length in characters is 50.</p> 
