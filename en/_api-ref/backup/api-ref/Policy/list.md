...
computeInstanceId | <p>if specified, returns policies applicable to specified compute instance.</p> 
...
--- | ---
policies[] | **object**
policies[].<br>id | **string**<br><p>Required. The maximum string length in characters is 50.</p> 
policies[].<br>name | **string**<br><p>Required. The maximum string length in characters is 50.</p> 
...
policies[].<br>settings.<br>scheduling.<br>backupSets[].<br>time.<br>weekdays[] | **string**
policies[].<br>settings.<br>scheduling.<br>backupSets[].<br>time.<br>repeatAt[] | **object**
policies[].<br>settings.<br>scheduling.<br>backupSets[].<br>time.<br>repeatAt[].<br>hour | **string** (int64)
policies[].<br>settings.<br>scheduling.<br>backupSets[].<br>time.<br>repeatAt[].<br>minute | **string** (int64)
policies[].<br>settings.<br>scheduling.<br>backupSets[].<br>time.<br>repeatEvery | **object**
...
policies[].<br>settings.<br>scheduling.<br>backupSets[].<br>time.<br>timeFrom | **object**
policies[].<br>settings.<br>scheduling.<br>backupSets[].<br>time.<br>timeFrom.<br>hour | **string** (int64)
policies[].<br>settings.<br>scheduling.<br>backupSets[].<br>time.<br>timeFrom.<br>minute | **string** (int64)
policies[].<br>settings.<br>scheduling.<br>backupSets[].<br>time.<br>timeTo | **object**
policies[].<br>settings.<br>scheduling.<br>backupSets[].<br>time.<br>timeTo.<br>hour | **string** (int64)
policies[].<br>settings.<br>scheduling.<br>backupSets[].<br>time.<br>timeTo.<br>minute | **string** (int64)
policies[].<br>settings.<br>scheduling.<br>backupSets[].<br>time.<br>monthdays[] | **string** (int64)<br><p>1-31 Monthdays are days in month. Allowed values are from 1 to 31.</p> 
...
policies[].<br>settings.<br>scheduling.<br>backupSets[].<br>time.<br>type | **string**<br><p>Required.</p> 
...
policies[].<br>settings.<br>scheduling.<br>backupSets[].<br>sinceLastExecTime.<br>delay | **object**<br><p>Required.</p> 
