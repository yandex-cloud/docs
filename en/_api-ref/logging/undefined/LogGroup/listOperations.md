...
```
GET undefined/logging/v1/logGroups/{logGroupId}/operations
```
...
filter | supported attributes: description created_at modified_at created_by done  The maximum string length in characters is 1000.
