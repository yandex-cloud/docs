...
accepted[].<br>uuid | **string**<br><p>Unique identitifier of the usage record (UUID format)</p> 
rejected[] | **object**<br><p>List of rejected product usage records (with reason)</p> 
rejected[].<br>uuid | **string**<br><p>Unique identitifier of the usage record (UUID format)</p> 
