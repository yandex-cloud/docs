...
instanceGroups[].<br>instanceTemplate.<br>bootDiskSpec.<br>diskSpec.<br>typeId | **string**<br><p>Required. ID of the disk type.</p> <p>Value must match the regular expression <code>network-nvme\|network-hdd</code>.</p> 
...
instanceGroups[].<br>instanceTemplate.<br>secondaryDiskSpecs[].<br>diskSpec.<br>typeId | **string**<br><p>Required. ID of the disk type.</p> <p>Value must match the regular expression <code>network-nvme\|network-hdd</code>.</p> 
