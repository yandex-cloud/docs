...
instanceGroups[].<br>deletionProtection | **boolean** (boolean)<br><p>Flag prohibiting deletion of the instance group.</p> <p>Allowed values:</br>- <code>false</code>: The instance group can be deleted.</br>- <code>true</code>: The instance group cannot be deleted.</p> <p>The default is <code>false</code>.</p> 
