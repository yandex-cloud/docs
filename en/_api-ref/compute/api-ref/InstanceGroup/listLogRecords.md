...
--- | ---
instanceGroupId | Required. ID of the InstanceGroup resource to list logs for. To get the instance group ID, use an [list](/docs/compute/api-ref/InstanceGroup/list) request.
