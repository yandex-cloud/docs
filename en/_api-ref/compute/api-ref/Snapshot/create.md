...
Field | Description
--- | ---
folderId | **string**<br><p>Required. ID of the folder to create a snapshot in. To get the folder ID use a <a href="/docs/resource-manager/api-ref/Folder/list">list</a> request.</p> <p>The maximum string length in characters is 50.</p> 
diskId | **string**<br><p>Required. ID of the disk to create the snapshot from. To get the disk ID use a <a href="/docs/compute/api-ref/Disk/list">list</a> request.</p> <p>The maximum string length in characters is 50.</p> 
