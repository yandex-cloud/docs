...
spreadPlacementStrategy | **object**<br><p>Anti-affinity placement strategy (<code>spread</code>). Instances are distributed over distinct failure domains.</p> <p>This is an empty structure that must be passed to explicitly specify the required placement strategy.</p> 
