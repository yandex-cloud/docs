...
Method | Description
--- | ---
[create](create.md) | Creates a new virtual host in the specified HTTP Router.
[delete](delete.md) | Deletes the specified virtual host.
[get](get.md) | Returns the specified VirtualHost resource.
[list](list.md) | Retrieves the list of virtual hosts in the specified HTTP Router.
[removeRoute](removeRoute.md) | 
[update](update.md) | Updates an existing VirtualHost in the specified HTTP Router.
[updateRoute](updateRoute.md) | 