...
Field | Description
--- | ---
name | **string**<br><p>Configuration of the virtual host to create.</p> <p>Value must match the regular expression `` \|<a href="%5B-a-z0-9%5D%7B0,61%7D%5Ba-z0-9%5D">a-z</a>? ``.</p> 
authority[] | **string**<br>
routes[] | **object**<br>
