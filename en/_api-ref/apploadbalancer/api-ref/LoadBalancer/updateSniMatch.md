...
handler.<br>streamHandler | **object**<br>Stream (TCP) handler. <br>`handler` includes only one of the fields `httpHandler`, `streamHandler`<br><br><p>A stream (TCP) handler resource.</p> 
