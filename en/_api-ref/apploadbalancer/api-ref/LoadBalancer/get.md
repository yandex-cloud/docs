...
listeners[].<br>http.<br>handler.<br>http2Options | **object**<br>If set, will enable HTTP2 protocol for the handler. <br>`listeners[].http.handler` includes only one of the fields `http2Options`, `allowHttp10`<br><br>
