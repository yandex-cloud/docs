...
listeners[].<br>http | **object**<br>HTTP listener settings. <br>`listeners[]` includes only one of the fields `http`, `tls`, `stream`<br><br><p>An HTTP listener resource.</p> 
...
listeners[].<br>tls | **object**<br>HTTPS (HTTP over TLS) listener settings. <br>`listeners[]` includes only one of the fields `http`, `tls`, `stream`<br><br><p>An HTTPS (HTTP over TLS) listener resource.</p> 
...
listeners[].<br>stream | **object**<br>Stream listener settings. <br>`listeners[]` includes only one of the fields `http`, `tls`, `stream`<br><br><p>A Stream listener resource.</p> 
