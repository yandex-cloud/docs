...
Field | Description
--- | ---
http | **object**<br>HTTP backend to add to the backend group. <br> includes only one of the fields `http`, `grpc`, `stream`<br>
...
grpc | **object**<br>gRPC backend to add to the backend group. <br> includes only one of the fields `http`, `grpc`, `stream`<br>
...
stream | **object**<br>New settings for the Stream backend. <br> includes only one of the fields `http`, `grpc`, `stream`<br>
