...
backendGroups[].<br>http.<br>backends[] | **object**<br>HTTP backend to add to the backend group.<br><p>List of HTTP backends.</p> 
...
backendGroups[].<br>grpc.<br>backends[] | **object**<br>gRPC backend to add to the backend group.<br><p>List of gRPC backends.</p> 
...
backendGroups[].<br>stream.<br>backends[] | **object**<br>New settings for the Stream backend.<br><p>List of stream (TCP) backends.</p> 
