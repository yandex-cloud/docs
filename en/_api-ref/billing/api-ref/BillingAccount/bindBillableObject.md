...
Field | Description
--- | ---
billableObject | **object**<br><p>``BillableObject`` to bind with billing account.</p> <p>Represents a link to an object in other service. This object is being billed in the scope of a billing account.</p> 
billableObject.<br>id | **string**<br><p>ID of the object in other service.</p> 
billableObject.<br>type | **string**<br><p>Billable object type. Can be one of the following:</p> <ul> <li>``cloud``</li> </ul> 
