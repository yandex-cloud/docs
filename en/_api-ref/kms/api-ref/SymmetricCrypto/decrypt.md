...
Field | Description
--- | ---
aadContext | **string** (byte)<br><p>Additional authenticated data, must be the same as was provided in the corresponding <code>SymmetricEncryptRequest</code>. Should be encoded with base64.</p> <p>The maximum string length in characters is 8192.</p> 
