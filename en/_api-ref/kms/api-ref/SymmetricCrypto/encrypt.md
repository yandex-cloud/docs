...
aadContext | **string** (byte)<br><p>Additional authenticated data (AAD context), optional. If specified, this data will be required for decryption with the <code>SymmetricDecryptRequest</code>. Should be encoded with base64.</p> <p>The maximum string length in characters is 8192.</p> 
