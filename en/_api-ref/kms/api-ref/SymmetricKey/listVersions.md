...
# Method listVersions
Returns the list of versions that belong to the specified symmetric key.
...
--- | ---
keyId | Required. ID of the symmetric key to list versions for.  The maximum string length in characters is 50.
...
Field | Description
--- | ---
keyVersions[] | **object**<br><p>KMS key version: metadata about actual cryptographic data.</p>
keyVersions[].<br>id | **string**<br><p>ID of the key version.</p>
keyVersions[].<br>keyId | **string**<br><p>ID of the KMS key that the version belongs to.</p>
...
keyVersions[].<br>algorithm | **string**<br><p>Encryption algorithm used to generate the cryptographic data for the key version.</p> <p>Supported symmetric encryption algorithms.</p> <ul> <li>AES_128: AES algorithm with 128-bit keys.</li> <li>AES_192: AES algorithm with 192-bit keys.</li> <li>AES_256: AES algorithm with 256-bit keys.</li> </ul>
...
keyVersions[].<br>destroyAt | **string** (date-time)<br><p>Time when the key version is going to be destroyed. Empty unless the status is <code>SCHEDULED_FOR_DESTRUCTION</code>.</p> <p>String in <a href="https://www.ietf.org/rfc/rfc3339.txt">RFC3339</a> text format.</p>
