...
To get the list of available federation resources, use a [list](/docs/iam/api-ref/Federation/list) request.
...
--- | ---
federationId | ID of the federation resource to return. To get the federation resource ID, use a [list](/docs/iam/api-ref/Federation/list) request.  The maximum string length in characters is 50.
