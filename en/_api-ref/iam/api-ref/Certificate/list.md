...
--- | ---
federationId | Required. ID of the federation to list certificates in. To get the federation ID make a [yandex.cloud.iam.v1.FederationService.List] request.  The maximum string length in characters is 50.
...
certificates[].<br>name | **string**<br><p>Name of the certificate.</p> <p>Value must match the regular expression <code>\|[a-z][-a-z0-9]{1,61}[a-z0-9]</code>.</p> 
