...
```
POST https://mdb.{{ api-host }}/managed-clickhouse/v1/clusters/{clusterId}/hosts:batchCreate
```
...
--- | ---
clusterId | <p>Required. ID of the ClickHouse cluster to add hosts to. To get the ClickHouse cluster ID, use a <a href="/docs/managed-clickhouse/api-ref/Cluster/list">list</a> request.</p> <p>The maximum string length in characters is 50.</p> 
...
copySchema | **boolean** (boolean)<br><p>Whether to copy schema to new ClickHouse hosts from replicas.</p> 
