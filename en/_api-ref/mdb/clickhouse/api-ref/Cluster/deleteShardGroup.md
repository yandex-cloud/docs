...
# Managed Service for ClickHouse API, REST: Cluster.deleteShardGroup
...
```
DELETE https://{{ api-host-mdb }}/managed-clickhouse/v1/clusters/{clusterId}/shardGroups/{shardGroupName}
```
