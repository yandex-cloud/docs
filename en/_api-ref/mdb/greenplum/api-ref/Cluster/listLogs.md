...
```
GET https://mdb.api.cloud.yandex.net/mdb/managed-greenplum/v1/clusters/{clusterId}:logs
```
...
serviceType | Type of the service to request logs about.<ul> <li>GREENPLUM: Logs of Greenplum activity.</li> </ul> 
