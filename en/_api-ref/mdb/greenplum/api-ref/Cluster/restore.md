...
Field | Description
--- | ---
backupId | **string**<br><p>Required. ID of the backup to create a cluster from. To get the backup ID, use a <a href="/docs/managed-greenplum/api-ref/Cluster/listBackups">listBackups</a> request.</p> 
...
masterResources | **object**<br><p>Resources of the Greenplum® master subcluster.</p> <p>A list of computational resources allocated to a host.</p> 
masterResources.<br>resourcePresetId | **string**<br><p>ID of the preset for computational resources allocated to a host. Available presets are listed in the <a href="/docs/managed-greenplum/concepts/instance-types">documentation</a>.</p> 
...
segmentResources | **object**<br><p>Resources of the Greenplum® segment subcluster.</p> <p>A list of computational resources allocated to a host.</p> 
segmentResources.<br>resourcePresetId | **string**<br><p>ID of the preset for computational resources allocated to a host. Available presets are listed in the <a href="/docs/managed-greenplum/concepts/instance-types">documentation</a>.</p> 
...
placementGroupId | **string**<br><p>ID of placement group</p> 
