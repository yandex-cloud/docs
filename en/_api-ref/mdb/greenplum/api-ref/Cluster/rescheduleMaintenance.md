...
```
POST https://mdb.api.cloud.yandex.net/mdb/managed-greenplum/v1/clusters/{clusterId}:rescheduleMaintenance
```
...
--- | ---
clusterId | Required. Required. ID of the Greenplum cluster to maintenance reschedule.  The maximum string length in characters is 50.
