...
```
POST https://mdb.{{ api-host }}/managed-mysql/v1/clusters/{clusterId}:startFailover
```
...
--- | ---
clusterId | <p>Required. ID of the cluster to start failover for.</p> <p>To get this ID, make a <a href="/docs/managed-mysql/api-ref/Cluster/list">list</a> request.</p> <p>The maximum string length in characters is 50.</p> 
