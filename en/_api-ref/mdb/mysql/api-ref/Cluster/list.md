...
clusters[].<br>config.<br>mysqlConfig_5_7.<br>effectiveConfig | **object**<br><p>Effective settings for a MySQL 5.7 cluster (a combination of settings defined in userConfig and [default_config]).</p> <p>Options and structure of <code>MysqlConfig5_7</code> reflects MySQL 5.7 configuration file</p> 
...
clusters[].<br>config.<br>mysqlConfig_8_0.<br>effectiveConfig | **object**<br><p>Effective settings for a MySQL 8.0 cluster (a combination of settings defined in userConfig and [default_config]).</p> <p>Options and structure of <code>MysqlConfig8_0</code> reflects MySQL 8.0 configuration file</p> 
