...
name | **string**<br><p>Required. Name of the new MySQL cluster. The name must be unique within the folder.</p> <p>Value must match the regular expression ``[a-zA-Z0-9_-]*``.</p> 
