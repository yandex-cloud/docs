...
nextPageToken | **string**<br><p>The token that can be used to get the next page of results.</p> <p>If the number of results is larger than <a href="/docs/managed-mysql/api-ref/Cluster/listOperations#query_params">pageSize</a>, use the <a href="/docs/managed-mysql/api-ref/Cluster/listOperations#responses">nextPageToken</a> as the value for the <a href="/docs/managed-mysql/api-ref/Cluster/listOperations#query_params">pageToken</a> in the subsequent <a href="/docs/managed-mysql/api-ref/Cluster/listOperations">listOperations</a> request to iterate through multiple pages of results.</p> <p>Each of the subsequent <a href="/docs/managed-mysql/api-ref/Cluster/listOperations">listOperations</a> requests should use the <a href="/docs/managed-mysql/api-ref/Cluster/listOperations#responses">nextPageToken</a> value returned by the previous request to continue paging through the results.</p> 