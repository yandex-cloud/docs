  ...
  "hostSpecs": [
    {
      ...
      "configSpec": {
        ...
        // `hostSpecs[].configSpec` includes only one of the fields `postgresqlConfig_9_6`, `postgresqlConfig_10_1C`, `postgresqlConfig_10`, `postgresqlConfig_11`
        "postgresqlConfig_9_6": {
...
userSpecs[].<br>settings | **object**<br><p>Postgresql settings for this user</p> <p>Postgresql user settings config</p> 
userSpecs[].<br>settings.<br>defaultTransactionIsolation | **string**<br>
userSpecs[].<br>settings.<br>lockTimeout | **integer** (int64)<br><p>in milliseconds.</p> 
