...
userSpec.<br>settings | **object**<br><p>Postgresql settings for this user</p> <p>Postgresql user settings config</p> 
userSpec.<br>settings.<br>defaultTransactionIsolation | **string**<br>
userSpec.<br>settings.<br>lockTimeout | **integer** (int64)<br><p>in milliseconds.</p> 
