...
--- | ---
clusterId | Required. ID of the Apache Kafka cluster to delete. To get the Apache Kafka cluster ID, use a [list](/docs/managed-kafka/api-ref/Cluster/list) request.  The maximum string length in characters is 50.
