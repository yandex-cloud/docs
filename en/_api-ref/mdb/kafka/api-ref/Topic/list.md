  ...
  "topics": [
    {
      ...
      // `topics[]` includes only one of the fields `topicConfig_2_1`, `topicConfig_2_6`, `topicConfig_2_8`
      "topicConfig_2_1": {
...
topics[].<br>topicConfig_2_1 | **object** <br>`topics[]` includes only one of the fields `topicConfig_2_1`, `topicConfig_2_6`, `topicConfig_2_8`<br><br><p>A topic settings for 2.1.</p> 
