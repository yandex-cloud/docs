...
--- | ---
clusterId | Required. ID of the Apache Kafka® cluster to create a topic in.  To get the cluster ID, make a [list](/docs/managed-kafka/api-ref/Cluster/list) request.  The maximum string length in characters is 50.
