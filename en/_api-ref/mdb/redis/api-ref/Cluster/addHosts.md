...
```
POST https://mdb.{{ api-host }}/managed-redis/v1/clusters/{clusterId}/hosts:batchCreate
```
...
--- | ---
clusterId | <p>Required. ID of the Redis cluster to add hosts to. To get the Redis cluster ID, use a <a href="/docs/managed-redis/api-ref/Cluster/list">list</a> request.</p> <p>The maximum string length in characters is 50.</p> 
