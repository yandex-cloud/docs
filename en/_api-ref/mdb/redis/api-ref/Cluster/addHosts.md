...
--- | ---
clusterId | Required. ID of the Redis cluster to add hosts to. To get the Redis cluster ID, use a [list](/docs/managed-redis/api-ref/Cluster/list) request.  The maximum string length in characters is 50.
