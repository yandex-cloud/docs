...
```
GET https://mdb.{{ api-host }}/managed-redis/v1/clusters/{clusterId}:stream_logs
```
...
--- | ---
clusterId | <p>Required. Required. ID of the Redis cluster.</p> <p>The maximum string length in characters is 50.</p> 
