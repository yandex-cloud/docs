...
--- | ---
clusterId | <p>Required. ID of the MongoDB cluster to create a user in. To get the cluster ID, use a <a href="/docs/managed-mongodb/api-ref/Cluster/list">list</a> request.</p> <p>The maximum string length in characters is 50.</p> 
...
Field | Description
--- | ---
userSpec | **object**<br><p>Properties of the user to be created.</p> 
userSpec.<br>name | **string**<br><p>Required. Name of the MongoDB user.</p> <p>The maximum string length in characters is 63. Value must match the regular expression ``[a-zA-Z0-9_]*``.</p> 
