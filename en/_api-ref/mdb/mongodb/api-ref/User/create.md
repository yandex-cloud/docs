...
--- | ---
clusterId | Required. ID of the MongoDB cluster to create a user in. To get the cluster ID, use a [list](/docs/managed-mongodb/api-ref/Cluster/list) request.  The maximum string length in characters is 50.
...
userSpec.<br>name | **string**<br><p>Required. Name of the MongoDB user.</p> <p>The maximum string length in characters is 63. Value must match the regular expression <code>[a-zA-Z0-9_]*</code>.</p> 
