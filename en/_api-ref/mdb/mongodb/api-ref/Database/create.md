...
databaseSpec.<br>name | **string**<br><p>Required. Name of the MongoDB database. 1-63 characters long.</p> <p>The maximum string length in characters is 63. Value must match the regular expression <code>[a-zA-Z0-9_-]{1,63}</code>.</p> 
