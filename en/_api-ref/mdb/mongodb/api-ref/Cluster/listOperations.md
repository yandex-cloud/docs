...
--- | ---
clusterId | Required. ID of the MongoDB Cluster resource to list operations for.  The maximum string length in characters is 50.
...
pageToken | Page token. To get the next page of results, set [pageToken](/docs/managed-mongodb/api-ref/Cluster/listOperations#query_params) to the [nextPageToken](/docs/managed-mongodb/api-ref/Cluster/listOperations#responses) returned by a previous list request.  The maximum string length in characters is 100.
