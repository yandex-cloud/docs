...
```
POST https://mdb.{{ api-host }}/managed-mongodb/v1/clusters/{clusterId}:move
```
...
--- | ---
clusterId | <p>Required. ID of the MongoDB cluster to move.</p> <p>The maximum string length in characters is 50.</p> 
