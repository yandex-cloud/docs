...
--- | ---
clusterId | <p>Required. ID of the MongoDB cluster to add a shard to. To get the cluster ID, use a <a href="/docs/managed-mongodb/api-ref/Cluster/list">list</a> request.</p> <p>The maximum string length in characters is 50.</p> 
...
Field | Description
--- | ---
shardName | **string**<br><p>Required. Name of the MongoDB shard to create.</p> <p>The maximum string length in characters is 63. Value must match the regular expression ``[a-zA-Z0-9_-]*``.</p> 
hostSpecs[] | **object**<br><p>Required. Configurations for mongod hosts to be created with the shard.</p> <p>Must contain at least one element.</p> 
