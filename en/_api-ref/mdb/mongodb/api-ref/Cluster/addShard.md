...
--- | ---
clusterId | Required. ID of the MongoDB cluster to add a shard to. To get the cluster ID, use a [list](/docs/managed-mongodb/api-ref/Cluster/list) request.  The maximum string length in characters is 50.
...
Field | Description
--- | ---
shardName | **string**<br><p>Required. Name of the MongoDB shard to create.</p> <p>The maximum string length in characters is 63. Value must match the regular expression <code>[a-zA-Z0-9_-]*</code>.</p> 
