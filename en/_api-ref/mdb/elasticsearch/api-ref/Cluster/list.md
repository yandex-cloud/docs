...
clusters[].<br>config.<br>elasticsearch.<br>dataNode.<br>elasticsearchConfigSet_7_6 | **object**<br>Elasticsearch 7.6 data node configuration.<br><p>Elasticsearch 7.6 data node configuration.</p> 
