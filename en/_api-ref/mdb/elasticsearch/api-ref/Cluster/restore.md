...
Field | Description
--- | ---
backupId | **string**<br><p>Required. Required. ID of the backup to restore from.</p> 
name | **string**<br><p>Required. Required. Name of the new ElasticSearch cluster. The name must be unique within the folder. The name must be 1-63 characters long and match the regular expression <code>^[a-zA-Z0-9_-]+$</code>.</p> <p>The maximum string length in characters is 63. Value must match the regular expression <code>[a-zA-Z0-9_-]*</code>.</p> 
description | **string**<br><p>Description of the new ElasticSearch cluster. 0-256 characters long.</p> <p>The maximum string length in characters is 256.</p> 
...
environment | **string**<br><p>Required. Deployment environment of the new ElasticSearch cluster.</p> <ul> <li>PRODUCTION: Stable environment with a conservative update policy: only hotfixes are applied during regular maintenance.</li> <li>PRESTABLE: Environment with more aggressive update policy: new versions are rolled out irrespective of backward compatibility.</li> </ul> 
configSpec | **object**<br><p>Required.</p> 
...
networkId | **string**<br><p>Required. The maximum string length in characters is 50.</p> 
