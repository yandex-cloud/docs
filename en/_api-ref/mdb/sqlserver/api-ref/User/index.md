...
Method | Description
--- | ---
[create](create.md) | Creates a SQLServer user in the specified cluster.
[delete](delete.md) | Deletes the specified SQLServer user.
[get](get.md) | Returns the specified SQLServer user.
[grantPermission](grantPermission.md) | Grants a permission to the specified SQLServer user.
[list](list.md) | Retrieves a list of SQLServer users in the specified cluster.
[revokePermission](revokePermission.md) | Revokes a permission from the specified SQLServer user.
[update](update.md) | Modifies the specified SQLServer user.