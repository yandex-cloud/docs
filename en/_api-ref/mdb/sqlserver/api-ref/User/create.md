...
--- | ---
clusterId | Required. Required. ID of the SQLServer cluster to create a user for. To get the cluster ID, use a [list](/docs/managed-sqlserver/api-ref/Cluster/list) request.  The maximum string length in characters is 50.
...
userSpec.<br>name | **string**<br><p>Required. Name of the sqlserver user.</p> <p>The maximum string length in characters is 32. Value must match the regular expression <code>[a-zA-Z0-9_]*</code>.</p> 
userSpec.<br>password | **string**<br><p>Required. Password of the sqlserver user.</p> <p>The string length in characters must be 8-128.</p> 
