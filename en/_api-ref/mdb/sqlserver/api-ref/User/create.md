...
userSpec.<br>name | **string**<br><p>Required. Name of the SQL Server user.</p> <p>The maximum string length in characters is 32. Value must match the regular expression <code>[a-zA-Z0-9_]*</code>.</p> 
