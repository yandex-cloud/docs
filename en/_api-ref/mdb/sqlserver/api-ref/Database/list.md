...
pageToken | Page token. To get the next page of results, set [pageToken](/docs/managed-sqlserver/api-ref/Database/list#query_params) to the [nextPageToken](/docs/managed-sqlserver/api-ref/Database/list#responses) returned by the previous list request.  The maximum string length in characters is 100.
...
Field | Description
--- | ---
databases[] | **object**<br><p>An SQL Server database.</p> <p>For more information, see the <a href="/docs/managed-sqlserver/concepts">Concepts</a> section of the documentation.</p> 
