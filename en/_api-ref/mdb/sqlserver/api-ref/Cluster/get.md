...
To get the list of available sqlserver clusters, make a [list](/docs/managed-sqlserver/api-ref/Cluster/list) request.
...
--- | ---
clusterId | Required. ID of the sqlserver cluster to return. To get the cluster ID use a [list](/docs/managed-sqlserver/api-ref/Cluster/list) request.  The maximum string length in characters is 50.
...
config.<br>resources | **object**<br>Resources allocated to sqlserver hosts.<br>
...
config.<br>sqlserverConfig_2016Sp2 | **object**<br>Configuration of a sqlserver 2016sp2 server.<br>
