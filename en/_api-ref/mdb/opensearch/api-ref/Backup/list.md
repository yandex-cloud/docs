...
backups[].<br>sourceClusterId | **string**<br><p>ID of the associated OpenSearch cluster.</p> 
...
backups[].<br>opensearchVersion | **string**<br><p>OpenSearch version used to create the snapshot</p> 
