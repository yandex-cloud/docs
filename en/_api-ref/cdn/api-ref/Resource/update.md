...
--- | ---
resourceId | Required. The maximum string length in characters is 50.
...
Field | Description
--- | ---
originGroupId | **integer** (int64)<br>
secondaryHostnames | **object**<br><p>List of secondary (alternative) CNAMEs.</p> 
