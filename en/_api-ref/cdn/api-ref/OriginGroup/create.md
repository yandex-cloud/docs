...
Field | Description
--- | ---
folderId | **string**<br><p>Required. Origin group owner's Folder ID.</p> <p>The maximum string length in characters is 50.</p> 
name | **string**<br><p>Origin Group Name.</p> 
useNext | **boolean** (boolean)<br><p><a href="/docs/cdn/api-ref/OriginGroup/create#body_params">useNext</a> This option have two possible conditions: true - The option is active. In case the origin responds with 4XX or 5XX codes, use the next origin from the list. false - The option is disabled.</p> <p>default value is true</p> 
origins[] | **object**<br><p>Origin manipulation definition.</p> 
