...
name | **string**<br><p>Name of the project.</p> <p>The maximum string length in characters is 63. Value must match the regular expression `` <a href="%5B-a-z0-9%5D%7B0,61%7D%5Ba-z0-9%5D">a-z</a>? ``.</p> 
