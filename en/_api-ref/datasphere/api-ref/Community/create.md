...
Field | Description
--- | ---
name | **string**<br><p>Name of the community.</p> <p>The maximum string length in characters is 63. Value must match the regular expression ``[a-zA-Z0-9ЁёА-я]\S{1,61}[a-zA-Z0-9ЁёА-я]``.</p> 
