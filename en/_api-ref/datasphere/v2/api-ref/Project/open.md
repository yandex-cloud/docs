...
--- | ---
projectId | <p>Required. ID of the Project resource to open. To get the project ID use a <a href="/docs/datasphere/v2/api-ref/Project/list">list</a> request.</p> <p>The maximum string length in characters is 50.</p> 
