...
description: In this tutorial, you will learn how to top up your account and set up payments for your organization's resources as a business.
---
...
If you fail to top up your account on time and run into arrears, your use of {{ yandex-cloud }} services may be suspended. For more information, see [Billing cycle](../../billing/payment/billing-cycle-business.md).
...
1. Select a payment method:
  ...
  - Credit or debit card {#card}
    ...
    Enter the payment amount and click **{{ ui-key.yacloud_billing.billing.account.dashboard-overview.popup-refill_button_individual-action }}**. Then enter your card details and click **Pay**.
