...
description: In this tutorial, you will learn how to delete a backup policy in {{ backup-full-name }}.
---
...
- CLI {#cli}
  ...
  1. Delete the backup policy by specifying its ID:
     ...
     For more information about this command, see the [CLI reference](../../../cli/cli-ref/backup/cli-ref/policy/delete.md).
