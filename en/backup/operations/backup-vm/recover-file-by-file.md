...
- Management console {#console}
  ...
  1. Navigate to the **{{ ui-key.yacloud.common.objects }}** tab. In the file manager that opens, select the files and directories you want to recover.
  ...
  You can check the progress of file recovery under ![operations](../../../_assets/console-icons/list-check.svg) **{{ ui-key.yacloud.common.operations-key-value }}**, in the **{{ ui-key.yacloud.common.operations.column_status }}** column.
