...
- Management console {#console}
  ...
  1. In the line with the backup to restore the VM or {{ baremetal-name }} server from, click ![image](../../../_assets/console-icons/ellipsis.svg) and select **{{ ui-key.yacloud.backup.action_recovery }}** or **{{ ui-key.yacloud.backup.action_bms-recovery }}** accordingly.
...
- CLI {#cli}
  ...
  1. Restore your VM or {{ baremetal-name }} server from backup:
