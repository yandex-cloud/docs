...
## Managing {{ compute-full-name }} VMs in {{ backup-name }} {#connect-vm}
...
## Managing external VMs and servers in {{ backup-name }} {#connect-external}
...
## Other operations {#get-additional-info}
