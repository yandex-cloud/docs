...
- Management console {#console}
  ...
  1. In the left-hand panel, select ![image](../../_assets/console-icons/server.svg) **{{ ui-key.yacloud.backup.label_connected-resources }}** and go to the **{{ ui-key.yacloud_billing.backup.label_instances }}** tab.
