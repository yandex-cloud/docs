...
{{ backup-name }} is a service for creating backups and restoring [resources](../concepts/index.md#protected-resources) and their data.
...
For more information on the minimum required VM characteristics and supported operating systems, see [{#T}](../concepts/vm-connection/index.md#requirements).
