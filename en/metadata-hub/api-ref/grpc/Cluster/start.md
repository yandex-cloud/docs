---
editable: false
sourcePath: en/_api-ref-grpc/metastore/v1/api-ref/grpc/Cluster/start.md
---

# Managed Service for Hive Metastore™ API, gRPC: ClusterService.Start

Starts the specified Metastore Cluster.

## gRPC request

**rpc Start ([StartClusterRequest](#yandex.cloud.metastore.v1.StartClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## StartClusterRequest {#yandex.cloud.metastore.v1.StartClusterRequest}
...
Required field. ID of the Metastore Cluster to start. ||
|#
...
|| metadata | **[StartClusterMetadata](#yandex.cloud.metastore.v1.StartClusterMetadata)**
...
## StartClusterMetadata {#yandex.cloud.metastore.v1.StartClusterMetadata}
