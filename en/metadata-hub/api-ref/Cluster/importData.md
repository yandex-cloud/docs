...
editable: false
apiPlayground:
  - url: https://metastore.{{ api-host }}/managed-metastore/v1/clusters/{clusterId}:import
    method: post
    path:
      type: object
      properties:
    ...
    body:
      ...
      additionalProperties: false
    definitions: null
sourcePath: en/_api-ref/metastore/v1/api-ref/Cluster/importData.md
---
...
```
POST https://metastore.{{ api-host }}/managed-metastore/v1/clusters/{clusterId}:import
```
...
## Body parameters {#yandex.cloud.metastore.v1.ImportDataRequest}
