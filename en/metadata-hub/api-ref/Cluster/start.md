...
editable: false
apiPlayground:
  - url: https://metastore.{{ api-host }}/managed-metastore/v1/clusters/{clusterId}:start
    method: post
    path:
      type: object
      properties:
    ...
    body: null
    definitions: null
sourcePath: en/_api-ref/metastore/v1/api-ref/Cluster/start.md
---

# Managed Service for Hive Metastore™ API, REST: Cluster.Start
