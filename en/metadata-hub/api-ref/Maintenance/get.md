...
editable: false
apiPlayground:
  - url: https://metastore.{{ api-host }}/managed-metastore/v1/maintenances/{maintenanceId}
    method: get
    path:
      type: object
      properties:
...
# Managed Service for Hive Metastore™ API, REST: Maintenance.Get
...
```
GET https://metastore.{{ api-host }}/managed-metastore/v1/maintenances/{maintenanceId}
```
