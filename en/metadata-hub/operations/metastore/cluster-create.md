...
- {{ TF }} {#tf}
    ...
    1. In the configuration file, describe the resources you are creating:
        ...
        * {{ metastore-name }} cluster: Cluster description.
        ...
        * `security_group_ids`: List of [security group](../../../metadata-hub/operations/metastore/configure-security-group.md) IDs.
        ...
        * `logging`: Logging parameters:
            ...
            * `enable`: Enables logging. Logs generated by {{ metastore-name }} components will be sent to {{ cloud-logging-full-name }}. The possible values are `true` or `false`.
