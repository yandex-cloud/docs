---
title: Deleting a tag for metadata
...
- Management console {#console}
  ...
  1. Navigate to the **{{ ui-key.yacloud.data-catalog.label_tags-and-classification }}** tab and select the classification you want to delete a tag in.
