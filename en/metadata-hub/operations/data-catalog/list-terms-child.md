---
title: Getting a list of child terms in {{ data-catalog-full-name }}
description: Follow this guide to get a list of child terms in {{ data-catalog-name }}.
---
...
- Management console {#console}
  ...
  1. In the left-hand panel, select ![image](../../../_assets/console-icons/book.svg) **{{ ui-key.yacloud.data-catalog.label_terms-and-glossaries }}** and select the glossary the terms were created in.
