...
To sort classifications by name, click the **{{ ui-key.yacloud.common.name }}** column header. This will sort the classifications in alphabetical order. A second click on the same header reverses the sorting order. A third click cancels the sorting.
