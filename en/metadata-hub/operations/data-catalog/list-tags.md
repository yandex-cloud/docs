...
- Management console {#console}
  ...
  1. Go to the ![image](../../../_assets/console-icons/tag.svg) **Tags and classifications** tab and select the classification the tags were created in.
...
To sort tags by name, click the **{{ ui-key.yacloud.common.name }}** column header. This will sort the tags in alphabetical order. A second click on the same header reverses the sorting order. A third click cancels the sorting.
