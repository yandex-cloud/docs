...
editable: false
apiPlayground:
  - url: https://datacatalog.{{ api-host }}/v1/catalog/{catalog.id}
    method: patch
    path: null
    query: null
    body:
      ...
      Catalog:
        ...
        properties:
          ...
          aiMarkupRules:
            ...
            $ref: '#/definitions/CatalogAIMarkupRules'
          autoIngestionParams:
            description: |-
            ...
            $ref: '#/definitions/CatalogAutoIngestionConfig'
          createdAt:
            description: |-
              **string** (date-time)
...
```
PATCH https://datacatalog.{{ api-host }}/v1/catalog/{catalog.id}
```
