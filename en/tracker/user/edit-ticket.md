...
To edit an issue, go to the issue page. If you don't have edit rights to an issue, [request permissions](../faq.md#section_xgr_zng_4bb) from the queue owner {% if audience == "external" %} or your organization's [admin](../role-model.md){% endif %}.
