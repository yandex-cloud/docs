...
- **Queue/version/component subscriber**: You are subscribed to notifications for the queue, version, or component that the issue belongs to.
...
<!--{% if audience == "external" %}- [Send notifications to mailboxes in your domain](../manager/mail-notifications.md){% endif %}-->
