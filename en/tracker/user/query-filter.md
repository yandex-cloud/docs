...
| {% if audience == "internal" %}```"Maillists" ``` | Department or team names | Search for issues that are followed by specific departments or teams.<br/>For example:<br/>```"Maillists": "Helpdesk" ```{% endif %} |
