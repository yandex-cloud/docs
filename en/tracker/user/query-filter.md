...
If the basic filters do not give you enough options, use the query language to define a filter.
...
- `OR`: If you use the logical operator **OR**, at least one of the conditions must be fulfilled.
    ...
    This query outputs the issues that have at least one of the conditions met: `parameter1` is set to `value1` **or** `parameter2` set to `value2`.
...
For example, to get a list of issues that user Alice Little switched to the <q>In progress</q> status over the last week, use a [function](#query-functions) in your request:
...
----- | ----- | -----
```"Access"``` | Logins and usernames | Searching for issues with certain users specified in the **Access** field.<br/>For example:<br/>```"Access": user3370@, "Alice Little" ```
...
```"Assignee"``` | Logins and usernames | Searching for issues with specific assignees.<br/>For example:<br/>```"Assignee": user3370@, "Alice Little" ```
```"Author"``` | Logins and usernames | Searching for issues with specific reporters.<br/>For example:<br/>```"Author": user3370@, "Alice Little" ```
...
```"Comment Author"``` | Logins and usernames | Searching for issues with comments made by specific users.<br/>For example:<br/>```"Comment Author": user3370@, "Alice Little" ```
```"Component Owner" ``` | Logins and usernames | Searching for issues that include components managed by specific users.<br/>For example:<br/>```"Component Owner": user3370@, "Alice Little" ```
...
```"Depends On" ``` | Issue keys | Searching for issues dependent on (blocked by) specific issues.<br/>For example:<br/>``` "Depends On": "TASK-123", "TASK-321" ```
...
```"Followers" ``` | Logins and usernames | Searching for issues with specific followers.<br/>For example:<br/>```"Followers": user3370@, "Alice Little" ```
{% if audience == "internal" %}```"Goals" ``` | Goal name | Searching for issues related to a specific goal.<br/>For example:<br/>```"Goals": "Catch up and get ahead" ```{% endif %} |
...
{% if audience == "internal" %}```"Issue Weight" ``` | Issue weight | Searching for issues with the specified weight.<br/>For example:<br/>```"Issue Weight": >"medium" ```{% endif %}
...
{% if audience == "internal" %}```"Maillists" ``` | Names of departments or teams | Search for issues that are followed by specific departments or teams.<br/>For example:<br/>```"Maillists": "Helpdesk" ```{% endif %}
```"Modifier" ``` | Logins and usernames | Searching for issues recently updated by specific users.<br/>For example:<br/>```"Modifier": user3370@, "Alice Little" ```
...
{% if audience == "internal" %}```"OTRS Ticket" ``` | OTRS ticket | Searching for issues related to a specific OTRS ticket.<br/>For example:<br/>```"OTRS Ticket": "1232514555443" ```{% endif %}
...
```"Pending Reply From" ``` | Logins and usernames | Searching for issues with a pending reply from a specific user (the user has been [invited to comment](comments.md#call-comment)).<br/>Let's say you need to find issues pending a reply from a user with the username `user3370` or a user with the first and last name Alice Little:<br/>```"Pending Reply From": user3370@, "Alice Little" ```
...
```"Queue Owner" ``` | Logins and usernames | Searching for issues from queues with specific owners.<br/>For example:<br/>```"Queue Owner": user3370@, "Alice Little" ```
```"Related" ``` | Logins and usernames | Searching for issues with specific reporters, assignees, or followers.<br/>For example:<br/>```"Related": user3370@, "Alice Little" ```
...
```"Resolver" ``` | Logins and usernames | Searching for issues that were closed (resolved) by a specific users.<br/>For example:<br/>```"Resolver": user3370@, "Alice Little" ```
...
```"Voted by" ``` | Logins and usernames | Searching for issues that have been voted for by specific users.<br/>For example:<br/>```"Voted By": user3370@, "Alice Little" ```
