...
In addition to setting up workflows, you can also use queues to configure [access rights to issues](manager/queue-access.md), [automated issue processing](./automation.md), integration with  [Yandex.Forms](manager/forms-integration.md), and so on. These features will allow you to tailor queues to the needs of your team.
