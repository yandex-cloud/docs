...
1. Set up your macro parameters:
    - **Macro name**.
    - **Message**: Message body (comment{% if audience == "internal" %} or email{% endif %}) created when executing a macro. If you don't want your macro to leave any messages, leave this field empty.
...
### Close an issue and notify the user {#macro_example_close_task}
...
### Transfer an issue to the second support line {#macro_example_shift_line}
