...
1. In the upper-right page, click ![](../../_assets/tracker/queue-filter.png).

1. In the left pane, select options for filtering issues in the queue. If the settings you need are not in the list, add them by clicking **![](../../_assets/tracker/task-params-btn.png) Select fields**.
