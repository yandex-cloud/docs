...
To open the issue actions menu in the list of project issues, click ![](../../_assets/tracker/svg/actions.svg) **{{ ui-key.startrek.ui_components_IssueTable2.row-actions }}** at the end of the line with an issue description.
