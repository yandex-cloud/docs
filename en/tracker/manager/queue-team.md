...
## Change the queue owner {#section_aft_bts_qbb}

The owner manages the queue:

- Edits the [basic settings](edit-queue-general.md).
...
1. Click ![](../../_assets/tracker/icon-edit.png) next to the owner's name.

1. Enter the login or name of the new owner.

1. If you want all new issues to be automatically assigned to the owner, enable the option **Assign issues to queue owner**.

1. Click **Save**.

## Change the queue team {#section_dgx_cts_qbb}
...
1. To add a participant, enter the login or name of the user in **Queue team**.
