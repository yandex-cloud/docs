...
| [{{ cloud-logging-full-name }}](../../logging/index.yaml)                       |  {{ cloud-logging-name }} enables aggregating and reading the logs of user apps and {{ yandex-cloud }} resources. | ![image](../../_assets/common/yes.svg) | ![image](../../_assets/common/yes.svg) |
...
| [{{ msp-full-name }}](../../managed-spark/index.yaml)                           | {{ preview-stage }} Service for creating and managing {{ SPRK }} clusters | ![image](../../_assets/common/yes.svg) | ![image](../../_assets/common/no.svg) |
