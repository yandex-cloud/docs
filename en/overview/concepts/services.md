...
| [{{ cloud-apps-full-name }}](../../cloud-apps/index.yaml)                       | Service for deploying applications based on {{ yandex-cloud }} | ![image](../../_assets/common/yes.svg) | ![image](../../_assets/common/no.svg) |
