...
- Data platform:
   ...
   - [{{ mes-full-name }}](../managed-elasticsearch/api-ref/)
...
- Security:
   ...
   - [{{ lockbox-name }}](../lockbox/api-ref/) _is at the [Preview](./concepts/launch-stages.md) stage._

- Resources and management:
   - [{{ cloud-logging-full-name }}](../logging/api-ref/) _is at the [Preview](./concepts/launch-stages.md) stage._
