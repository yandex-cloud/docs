...
* [{{ baremetal-full-name }}](../baremetal/release-notes.md)
...
* [{{ cr-full-name }}](../cloud-router/release-notes.md)
* [{{ stackland-full-name }}](../stackland/release-notes.md)
* [{{ video-full-name }}](../video/release-notes.md)
* [{{ compute-full-name }}](../compute/release-notes.md)
* [{{ network-load-balancer-full-name }}](../network-load-balancer/release-notes.md)
...
* [{{ mspqr-full-name }}](../managed-spqr/release-notes.md)
...
* [{{ mmg-full-name }}](../storedoc/release-notes.md)
...
* {{ speechkit-full-name }}: [Speech recognition]({{ link-docs-ai }}speechkit/release-notes-stt) and [synthesis]({{ link-docs-ai }}speechkit/release-notes-tts)
* [{{ speechsense-full-name }}]({{ link-docs-ai }}speechsense/release-notes/)
...
* [{{ monium-full-name }}](../monium/release-notes.md)
...
## Resource management {#resources-operations}

* [{{ billing-name }}](../billing/release-notes.md)
* [{{ quota-manager-full-name }}](../quota-manager/release-notes.md)
