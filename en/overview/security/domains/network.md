...
{% if lang == "ru" %}For more information about how to configure your network infrastructure, watch our webinar [How a network works in Yandex.Cloud](https://www.youtube.com/watch?v=g3cZ0o50qH0). {% endif %}
