---
title: Versioning policies in {{ mos-full-name }}
...
* For clusters with a deprecated {{ OS }} version, there is no option to create new hosts or restore from backups.
* Clusters running on an deprecated {{ OS }} version will be automatically updated according to the [update policy](#update-policy).
