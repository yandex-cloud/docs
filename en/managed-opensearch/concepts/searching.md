...
{{ OS }} is used as a tool for searching and {% if lang == "ru" and audience != "internal" %}[analyzing data](../../glossary/data-analytics.md){% else %}analyzing data{% endif %} in documents using:
