...
* Full-text queries: to find a certain string in the documents and sort the results by relevance. These queries also allow you to use additional search functions, including autocomplete and search for phrases and similar strings. Learn more about full-text search in [this {{ OS }} guide]({{ os.docs }}/search-plugins/sql/full-text/).
...
For more information about search features, see [this {{ OS }} guide]({{ os.docs }}/opensearch/search/index/).
