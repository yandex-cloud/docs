...
* [{{ foundation-models-full-name }}](../foundation-models/pricing.md)
    * [Text generation in {{ gpt-lite }} or {{ gpt-pro }}](../foundation-models/pricing.md#pricing-generating)
    * [Text vectorization in {{ foundation-models-full-name }}](../foundation-models/pricing.md#pricing-embedding)
