...
Companies and individual entrepreneurs can sign a bilateral contract. To do this, submit a request using the  [form]{% if lang == "ru" %}(https://cloud.yandex.ru/docs/billing/concepts/contract#contact-form){% endif %}{% if lang == "en" %}(https://cloud.yandex.com/docs/billing/concepts/contract#contact-form){% endif %}. A {{ yandex-cloud }} manager will contact you to discuss the terms and conditions of signing the agreement.
