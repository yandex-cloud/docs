...
<br/>See also the [Report](act.md) section.

Budget
:   Method of controlling resource spending using notifications.
<br/>See also the [Budget](budget.md) section.
...
<br/>See also the [Grant](bonus-account.md) section.

Usage details
:   Table with detailed information on cloud resource usage.
<br/>See also the [Viewing service usage details](../operations/check-charges.md) section for details.
...
<br/>See also the [Customer agreement](contract.md) section.
...
<br/>See also [Billing threshold](billing-threshold.md).

Personal account
:   Unique customer ID in the {{ billing-name }} service used to pay for resources during the entire term of the agreement.
<br/>See also the [Personal account](personal-account.md) section for details.
...
<br/>See also the [Reporting period](reporting-period.md) section for details.
...
<br/>See also the [Billing account](billing-account.md) section for details.
...
<br/>See also the [Promo code](promo-code.md) section for details.

Payment invoice
:   Document issued for you to pay for the resources consumed in the previous month.
<br/>See also the [Payment invoice](bill.md) section.

Tax invoice
:   Tax document delivered to a customer at the end of a reporting period.
<br/>See also the [Tax invoice](invoice.md) section.
