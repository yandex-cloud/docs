...
For more information, see [Report](act.md).

#### Budget {#budget}

Method of monitoring resource usage costs with notifications.

For more information, see [Budget](budget.md).
...
For more information, see [Grant](bonus-account.md).

#### Usage details {#details}

Table with detailed information on cloud resource usage.

For more information, see [View usage details](../operations/check-charges.md).
...
For more information, see [Agreement](contract.md).
...
For more information, see [Offers](../operations/get-offers.md).

#### Personal account {#personal-account}

Unique {{ billing-name }} customer ID used to effect payments for resources throughout the term of the agreement.

For more information, see [Personal account](personal-account.md).
...
For more information, see  [this{{ org-full-name }} guide](../../organization/).
...
For more information, see [Reporting period](reporting-period.md).
...
For more information, see [Billing account](billing-account.md).
...
For more information, see [Billing threshold](billing-threshold.md).
