...
* Advance invoice (signatory's authority domain 6, status 1) in invoice format (format 5.03) as per the Federal Tax Service Order No. 1032 dated November 15, 2024, which revises the format approved by the Federal Tax Service Order No. 970 dated December 19, 2023. It is generated as an invoice exchange file with additional information (seller information) comprising data stipulated for tax invoices by Article 169 of the Russian Tax Code and Resolution No. 1137, signed by an authorized invoice signatory.
