...
Reports are generated at the end of the reporting period for the amount actually used from the [billing account](../concepts/personal-account.md).

Statements are then used as a basis for generating [invoices](../concepts/invoice.md).
