...
Under one Yandex account, all payers must be either residents of Russia, residents of Kazakhstan, or non-residents. Learn more about [billing accounts](../concepts/billing-account.md).
...
- Individual
   ...
   1. Log in to your Yandex ID or Yandex.Connect account. If you don't have an account yet, sign up.
      * Your phone number must be linked to this account. For detailed instructions, see Help for [Yandex ID](https://yandex.com/support/passport/authorization/registration.html) and [Yandex.Connect](https://yandex.com/support/connect/personal.html#personal__section_aq5_hcq_23b).
...
- Legal entity, individual entrepreneur, or non-resident of Russia and Kazakhstan
   ...
   1. Click **Activate**.
      ...
      If you select the **Bank transfer** payment method or if the payer is a non-resident of Russia or Kazakhstan, you will receive an email with further instructions at the email address specified in your Yandex or Yandex.Connect account. In this case, it may take up to three business days to activate your billing account.
