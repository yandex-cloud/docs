...
editable: false
apiPlayground:
  - url: https://billing.{{ api-host }}/billing/v1/billingAccounts/{resourceId}:updateAccessBindings
    method: patch
    path:
      type: object
      properties:
    ...
    definitions:
      ...
      AccessBindingDelta:
        ...
        required:
          - action
          - accessBinding
sourcePath: en/_api-ref/billing/v1/api-ref/BillingAccount/updateAccessBindings.md
---
