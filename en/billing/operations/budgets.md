...
{% if product == "yandex-cloud" %}* _Account balance_: A notification goes out when a personal account balance falls below an established threshold.{% endif %}
...
1. Go to the **Budgets** page and click **Create budget**.
   ...
   1. Specify the **Budget amount**: {% if product == "cloud-il" %}set a spending limit.{% endif %}
      {% if product == "yandex-cloud" %}
