...
Your billing account status has been changed to `SUSPENDED` in accordance with [terms and conditions of the agreement (clause 6.11.4.)](https://yandex.ru/legal/cloud_oferta/).
...
Most likely, the service does not support your bank card's payment system.
