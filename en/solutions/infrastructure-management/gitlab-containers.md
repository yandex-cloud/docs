...
## Create a registry {{ container-registry-name }} {#cr-create}
...
1. If you don't have a network yet, [create one](../../vpc/operations/network-create.md).

1. If you don't have any subnets yet, [create them](../../vpc/operations/subnet-create.md) in the availability zones where the {{ k8s }} cluster and node group will be created.
...
It may take several minutes to create the {{ k8s }} cluster. When the status of the cluster changes to `RUNNING`, you can start creating a node group in this cluster.
...
## Configure building and deploying a Docker image from CI {#ci}
