...
1. Add polygons of districts to the map. To do this, drag the **Coordinates** field from the **Dimensions** section to the **Geopolygons** section.
...
1. Confirm that you want to publish the chart and relevant data.
