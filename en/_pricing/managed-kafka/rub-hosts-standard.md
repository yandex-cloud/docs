...
| RAM (for 1 GB) | {{ sku|RUB|mdb.cluster.kafka.v3.ram|string }} |
...
| RAM (for 1 GB) | ₽0.2520                                            | {{ sku|RUB|v1.commitment.y1.mdb.kafka.ram.v3|string }} (-36%)      | {{ sku|RUB|v1.commitment.y3.mdb.kafka.ram.v3|string }} (-50%) |
