...
| RAM (for 1 GB)                     | {{ sku|KZT|mdb.cluster.redis.v2.ram|string }}      |
| **Intel Ice Lake** |
| 50% vCPU                           | {{ sku|KZT|mdb.cluster.redis.v3.cpu.c50|string }}  |
| 100% vCPU                          | {{ sku|KZT|mdb.cluster.redis.v3.cpu.c100|string }} |
| RAM (for 1 GB)                     | {{ sku|KZT|mdb.cluster.redis.v3.ram|string }}      |
...
| RAM (for 1 GB)                     | {{ sku|KZT|mdb.cluster.redis.v3.ram|string }}      | {{ sku|KZT|v1.commitment.y1.mdb.redis.ram.v3|string }} (-36%)                                                                                     | {{ sku|KZT|v1.commitment.y3.mdb.redis.ram.v3|string }} (-50%) |
