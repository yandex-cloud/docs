...
| **Intel Ice Lake** |
| 50% vCPU                           | {{ sku|USD|mdb.cluster.redis.v3.cpu.c50|string }}  | —                                                                                                                                                 | — |
| 100% vCPU                          | {{ sku|USD|mdb.cluster.redis.v3.cpu.c100|string }} | {{ sku|USD|v1.commitment.y1.mdb.redis.cpu.c100.v3|string }} (-30%)                                                                                | {{ sku|USD|v1.commitment.y3.mdb.redis.cpu.c100.v3|string }} ({{ sku|USD|v1.commitment.y3.mdb.redis.cpu.c100.v3|cud.y3|discount|percent|string }}) |
| RAM (for 1 GB)                     | {{ sku|USD|mdb.cluster.redis.v3.ram|string }}      | {{ sku|USD|v1.commitment.y1.mdb.redis.ram.v3|string }} (-36%)                                                                                     | {{ sku|USD|v1.commitment.y3.mdb.redis.ram.v3|string }} ({{ sku|USD|v1.commitment.y3.mdb.redis.ram.v3|cud.y3|discount|percent|string }}) |
