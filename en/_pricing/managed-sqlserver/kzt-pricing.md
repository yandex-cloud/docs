...
| Microsoft SQL Server Standard | ₸65202 | ₸54335 |
| Microsoft SQL Server Enterprise | ₸222978 | ₸185815 |
...
| RAM (for 1 GB) | {{ sku|KZT|mdb.cluster.mssql.v2.ram|string }}      | ₸2.5500 |
| **Intel Ice Lake**                                                  | |
| 100% vCPU      | {{ sku|KZT|mdb.cluster.mssql.v3.cpu.c100|string }} | ₸8.6000 |
| RAM (for 1 GB) | {{ sku|KZT|mdb.cluster.mssql.v3.ram|string }}      | ₸2.3000 |
