| Chat transcript analysis, thousands of characters per month | Text dialog analytics,<br>without VAT |
|---|---|
...
| Over 2,500,000              | {{ sku|USD|speechsense.analysis.text.v2|pricingRate.2500000|string }} |