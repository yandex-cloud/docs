...
Data operations with a 1-month commitment                  | ₸13.3200 per hour per 100 RU/s
...
Making on-demand backups                                   | ₸2.0400 per 1 GB
Restoring data from backups                                | ₸38.4000 per 1 GB
Storage of on-demand backups in {{ objstorage-full-name }} | ₸7.5660 per 1 GB per month
