...
| **Intel Ice Lake** |
| 50% vCPU       | {{ sku|USD|mdb.cluster.pg.v3.cpu.c50|string }}  | —                                                                                                                                           | —                |
| 100% vCPU      | {{ sku|USD|mdb.cluster.pg.v3.cpu.c100|string }} | {{ sku|USD|v1.commitment.y1.mdb.pg.cpu.c100.v3|string }} ({{ sku|USD|v1.commitment.y1.mdb.pg.cpu.c100.v3|cud.y1|discount|percent|string }}) | {{ sku|USD|v1.commitment.y3.mdb.pg.cpu.c100.v3|string }} ({{ sku|USD|v1.commitment.y3.mdb.pg.cpu.c100.v3|cud.y3|discount|percent|string }}) |
| RAM (for 1 GB) | {{ sku|USD|mdb.cluster.pg.v3.ram|string }}      | {{ sku|USD|v1.commitment.y1.mdb.pg.ram.v3|string }} ({{ sku|USD|v1.commitment.y1.mdb.pg.ram.v3|cud.y1|discount|percent|string }})           | {{ sku|USD|v1.commitment.y3.mdb.pg.ram.v3|string }} (-52%) |
