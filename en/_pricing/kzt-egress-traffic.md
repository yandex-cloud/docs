...
| Outgoing traffic, <10 GB | {{ sku|KZT|network.egress.inet|number }} | {{ sku|KZT|network.egress.inet|number }} |
| Outgoing traffic, >10 GB | {{ sku|KZT|network.egress.inet|pricingRate.10|string }} | ₸7.65 |