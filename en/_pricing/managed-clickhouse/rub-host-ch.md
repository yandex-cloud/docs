...
| RAM (for 1 GB) | {{ sku|RUB|mdb.cluster.clickhouse.v2.ram|string }}      |
| **Intel Ice Lake**                                                       |
| 50% vCPU       | {{ sku|RUB|mdb.cluster.clickhouse.v3.cpu.c50|string }}  |
| 100% vCPU      | {{ sku|RUB|mdb.cluster.clickhouse.v3.cpu.c100|string }} |
| RAM (for 1 GB) | {{ sku|RUB|mdb.cluster.clickhouse.v3.ram|string }}      |
...
| RAM (for 1 GB) | {{ sku|RUB|mdb.cluster.clickhouse.v3.ram|string }}      | {{ sku|RUB|v1.commitment.y1.mdb.ch.ram.v3|string }} (-36%)      | {{ sku|RUB|v1.commitment.y3.mdb.ch.ram.v3|string }} (-52%)      |
