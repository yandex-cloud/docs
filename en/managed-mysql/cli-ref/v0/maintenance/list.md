---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/managed-mysql/cli-ref/v0/maintenance/list/
---

# yc managed-mysql v0 maintenance list
...
`yc managed-mysql maintenance list [Flags...] [Global Flags...]`
