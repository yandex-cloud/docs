---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/managed-mysql/cli-ref/v0/cluster/list-logs/
---
...
`yc managed-mysql cluster list-logs <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
...
Type of the service to request logs about. Values: 'mysql-error', 'mysql-general', 'mysql-slow-query', 'mysql-audit' ||
|| `--columns` | `value[,value]`
