...
1. When the cluster is ready to operate, its status on the [!KEYREF mmy-short-name] dashboard will change to **RUNNING**.
...
1. You can connect to the database using the `mysql` command (for more information, see [[!TITLE]](operations/connect.md)):
