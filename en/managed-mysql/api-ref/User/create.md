---
editable: false
sourcePath: en/_api-ref/mdb/mysql/api-ref/User/create.md
---
...
```
POST https://mdb.{{ api-host }}/managed-mysql/v1/clusters/{clusterId}/users
```
...
--- | ---
clusterId | <p>Required. ID of the cluster to create the user in.</p> <p>To get this ID, make a <a href="/docs/managed-mysql/api-ref/Cluster/list">list</a> request.</p> <p>The maximum string length in characters is 50.</p> 
