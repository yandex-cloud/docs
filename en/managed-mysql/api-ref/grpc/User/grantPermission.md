---
editable: false
sourcePath: en/_api-ref-grpc/mdb/mysql/v1/api-ref/grpc/User/grantPermission.md
---

# Managed Service for MySQL API, gRPC: UserService.GrantPermission {#GrantPermission}
