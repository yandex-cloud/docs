...
# Managed Service for MySQL API, REST: Cluster.RescheduleMaintenance {#RescheduleMaintenance}
...
```
POST https://{{ api-host-mdb }}/managed-mysql/v1/clusters/{clusterId}:rescheduleMaintenance
```
...
## Body parameters {#yandex.cloud.mdb.mysql.v1.RescheduleMaintenanceRequest}
...
|| metadata | **[RescheduleMaintenanceMetadata](#yandex.cloud.mdb.mysql.v1.RescheduleMaintenanceMetadata)**
...
## RescheduleMaintenanceMetadata {#yandex.cloud.mdb.mysql.v1.RescheduleMaintenanceMetadata}
