...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-mysql/v1/clusters/{resourceId}:listAccessBindings
    method: get
    path:
      type: object
      properties:
...
# Managed Service for MySQL API, REST: Cluster.ListAccessBindings
...
```
GET https://{{ api-host-mdb }}/managed-mysql/v1/clusters/{resourceId}:listAccessBindings
```
