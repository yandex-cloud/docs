        ...
        clusterId:
          description: |-
            **string**
            ...
            To get the cluster ID use a [ClusterService.List](/docs/managed-mysql/api-ref/Cluster/list#List) request.
        ...
        databaseName:
          description: |-
            **string**
            ...
            To get the name of the database use a [DatabaseService.List](/docs/managed-mysql/api-ref/Database/list#List) request.
...
# Managed Service for MySQL API, REST: Database.Update
...
## Body parameters {#yandex.cloud.mdb.mysql.v1.UpdateDatabaseRequest}
