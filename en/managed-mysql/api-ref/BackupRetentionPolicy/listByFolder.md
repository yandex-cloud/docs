...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-mysql/v1/folders/{folderId}/retention_policies
    method: get
    path:
      type: object
      properties:
...
```
GET https://{{ api-host-mdb }}/managed-mysql/v1/folders/{folderId}/retention_policies
```
...
is larger than [ListBackupRetentionPoliciesRequest.pageSize](/docs/managed-mysql/api-ref/BackupRetentionPolicy/list#yandex.cloud.mdb.mysql.v1.ListBackupRetentionPoliciesRequest), use the `nextPageToken` as the value
for the [ListBackupRetentionPoliciesRequest.pageToken](/docs/managed-mysql/api-ref/BackupRetentionPolicy/list#yandex.cloud.mdb.mysql.v1.ListBackupRetentionPoliciesRequest) query parameter in the next list request.
