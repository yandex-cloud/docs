...
{{ mmy-short-name }} generates a name for each cluster host when they're created. This name will be the host's fully qualified domain name (FQDN). The hostname and, consequently, the FQDN cannot be changed.
