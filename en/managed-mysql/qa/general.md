...
- Size of the database cluster backups. The backup size in the amount of the storage space is free of charge. Storage of backups in excess of this size is charged at special [rates](../pricing.md).
