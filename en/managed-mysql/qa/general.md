...
- Size of the database cluster backups. Backup space in the amount of the reserved storage space is free of charge. Backup storage that exceeds this size is charged at special [rates](../pricing.md).
