...
* If there are no active replicas in a cluster, you cannot connect to this FQDN, as the respective {% if lang == "ru" and audience != "internal" %}[DNS](../../glossary/dns.md){% else %}DNS{% endif %} CNAME record will point to a `null` object.
