...
- Management console {#console}
  ...
  1. Click the name of your cluster and open the **{{ ui-key.yacloud.mysql.cluster.switch_datalens }}** tab.
...
- Management console {#console}
  ...
  1. Navigate to the [folder dashboard]({{ link-console-main }}) and select **Managed Service for MySQL**.
