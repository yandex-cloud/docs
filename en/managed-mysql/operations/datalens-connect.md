...
- Management console
   ...
   1. Enter the password for the user. See [{#T}](../../datalens/operations/connection/create-mysql.md){% if product == "yandex-cloud" %} and [{#T}](../../datalens/concepts/dataset/settings.md#access-management){% endif %} in the {{ datalens-name }} documentation.
