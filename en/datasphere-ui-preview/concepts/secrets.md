...
* Unique resource ID.
* Resource creator.
* Date when the resource was created and last modified, in [UTC]{% if lang == "ru" %}(https://ru.wikipedia.org/wiki/Всемирное_координированное_время){% endif %}{% if lang == "en" %}(https://en.wikipedia.org/wiki/Coordinated_Universal_Time){% endif %} format, such as `July 18, 2022, 14:23`.
