...
apiPlayground:
  - url: https://private-ca.certificate-manager.{{ api-host }}/privateca/v1/policies/{id}
    ...
    body: null
    definitions: null
sourcePath: en/_api-ref/certificatemanager/v1/privateca/api-ref/Policy/delete.md
---

# Certificate Manager Private CA API, REST: Policy.Delete
...
Request message for deleting a policy.
...
ID of the policy being deleted. ||
|#
