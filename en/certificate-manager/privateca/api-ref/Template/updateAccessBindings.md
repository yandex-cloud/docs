...
editable: false
apiPlayground:
  - url: https://private-ca.certificate-manager.{{ api-host }}/privateca/v1/templates/{resourceId}:updateAccessBindings
    method: patch
    path:
      type: object
      properties:
    ...
    definitions:
      ...
      AccessBindingDelta:
        ...
        required:
          - action
          - accessBinding
sourcePath: en/_api-ref/certificatemanager/v1/privateca/api-ref/Template/updateAccessBindings.md
---
