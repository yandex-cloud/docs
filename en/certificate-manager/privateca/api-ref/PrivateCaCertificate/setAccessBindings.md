...
editable: false
apiPlayground:
  - url: https://private-ca.certificate-manager.{{ api-host }}/privateca/v1/privateCertificates/{resourceId}:setAccessBindings
    method: post
    path:
      type: object
      properties:
    ...
    definitions:
      ...
      AccessBinding:
        ...
        required:
          - roleId
          - subject
sourcePath: en/_api-ref/certificatemanager/v1/privateca/api-ref/PrivateCaCertificate/setAccessBindings.md
---

# Certificate Manager Private CA API, REST: PrivateCaCertificate.SetAccessBindings
