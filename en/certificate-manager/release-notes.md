...
description: This section contains the {{ certificate-manager-name }} release notes.
---
...
* Added the `GetCertificateContent` event to collect [{{ at-name }}](../audit-trails/concepts/events-data-plane.md#certificate-manager) audit logs based on the _Getting SSL certificate contents_ event.