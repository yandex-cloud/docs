---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/managed-greenplum/cli-ref/cluster/index
editable: false
---
...
- [yc managed-greenplum cluster add-access-binding](add-access-binding.md) — Add access binding for the specified Greenplum cluster
...
- [yc managed-greenplum cluster list-access-bindings](list-access-bindings.md) — List access bindings for the specified Greenplum cluster
...
- [yc managed-greenplum cluster remove-access-binding](remove-access-binding.md) — Remove access binding for the specified Greenplum cluster
...
- [yc managed-greenplum cluster set-access-bindings](set-access-bindings.md) — Set access bindings for the specified Greenplum cluster and delete all existing access bindings if there were any
