...
* Added support for the [postgis]({{ gp.docs.vmware }}/5/greenplum-database/GUID-ref_guide-extensions-postGIS.html) extension.
...
* Added support for the [pgcrypto]({{ gp.docs.pivotal }}/6-9/ref_guide/modules/pgcrypto.html) extension.
...
* Added the [diskquota]({{ gp.docs.pivotal }}/6-19/ref_guide/modules/diskquota.html) module that enables you to limit the amount of disk space used by schemas in a database.
* Implemented automatic switchover to a standby master host using the [gpactivatestandby]({{ gp.docs.pivotal }}/6-3/utility_guide/ref/gpactivatestandby.html) utility.
...
{% if lang == "ru" and product == "yandex-cloud" %}* Added a [calculator](/promo/dwh-calculator/index) to calculate a recommended cluster configuration and estimate its cost.{% endif %}
