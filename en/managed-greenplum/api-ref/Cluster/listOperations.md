...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-greenplum/v1/clusters/{clusterId}/operations
    method: get
    path:
      type: object
      properties:
        ...
        pageSize:
          description: |-
            **string** (int64)
            ...
            If the number of available results is larger than `pageSize`, the service returns a [ListClusterOperationsResponse.nextPageToken](/docs/managed-greenplum/api-ref/Cluster/listOperations#yandex.cloud.mdb.greenplum.v1.ListClusterOperationsResponse) that can be used to get the next page of results in subsequent list requests.
          type: string
          format: int64
        pageToken:
          description: |-
            **string**
            Page token. To get the next page of results, set `pageToken` to the [ListClusterOperationsResponse.nextPageToken](/docs/managed-greenplum/api-ref/Cluster/listOperations#yandex.cloud.mdb.greenplum.v1.ListClusterOperationsResponse) returned by the previous list request.
          type: string
      additionalProperties: false
    body: null
    definitions: null
...
## Query parameters {#yandex.cloud.mdb.greenplum.v1.ListClusterOperationsRequest}
...
## Response {#yandex.cloud.mdb.greenplum.v1.ListClusterOperationsResponse}
