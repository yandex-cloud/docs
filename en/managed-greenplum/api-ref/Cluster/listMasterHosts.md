...
hosts[].<br>type | **string**<br><p>Type of the host. If the field has default value, it is not returned in the response.</p> <ul> <li>TYPE_UNSPECIFIED: Host type is not specified. Default value. - MASTER: A Greenplum® master host.</li> <li>REPLICA: A Greenplum® master replica host.</li> <li>SEGMENT: A Greenplum® segment host.</li> </ul> 
