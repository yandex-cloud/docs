        ...
        clusterId:
          description: |-
            **string**
            ...
            To get the cluster ID, use a [ClusterService.List](/docs/managed-greenplum/api-ref/Cluster/list#List) request.
          type: string
      required:
        - clusterId
...
To get the list of all available Greenplum® clusters, make a [List](/docs/managed-greenplum/api-ref/Cluster/list#List) request.
...
## Response {#yandex.cloud.mdb.greenplum.v1.Cluster}
