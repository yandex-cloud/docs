...
```
GET https://{{ api-host-mdb }}/managed-greenplum/v1/versions
```

## Query parameters {#yandex.cloud.mdb.greenplum.v1.ListVersionsRequest}
...
## Response {#yandex.cloud.mdb.greenplum.v1.ListVersionsResponse}
