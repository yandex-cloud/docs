...
The maximum number of elements is 50. The maximum string length in characters for each value is 256. Each value must match the regular expression ` [a-zA-Z0-9\*_]*(\/[a-zA-Z0-9\*_]*){0,2} `. ||
...
The ID of the network is set in the field [Cluster.network_id](#yandex.cloud.mdb.greenplum.v1.Cluster).
...
|| metadata | **[RestoreClusterMetadata](#yandex.cloud.mdb.greenplum.v1.RestoreClusterMetadata)**
...
## RestoreClusterMetadata {#yandex.cloud.mdb.greenplum.v1.RestoreClusterMetadata}
