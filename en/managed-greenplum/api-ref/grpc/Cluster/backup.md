---
editable: false
sourcePath: en/_api-ref-grpc/mdb/greenplum/v1/api-ref/grpc/Cluster/backup.md
---

# Managed Service for Greenplum® API, gRPC: ClusterService.Backup

Creates a backup for the specified Greenplum cluster.

## gRPC request

**rpc Backup ([BackupClusterRequest](#yandex.cloud.mdb.greenplum.v1.BackupClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## BackupClusterRequest {#yandex.cloud.mdb.greenplum.v1.BackupClusterRequest}
