---
editable: false
sourcePath: en/_api-ref-grpc/mdb/greenplum/v1/api-ref/grpc/Cluster/expand.md
---

# Managed Service for Greenplum® API, gRPC: ClusterService.Expand {#Expand}

Expands the specified Greenplum® cluster.

## gRPC request

**rpc Expand ([ExpandRequest](#yandex.cloud.mdb.greenplum.v1.ExpandRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## ExpandRequest {#yandex.cloud.mdb.greenplum.v1.ExpandRequest}
