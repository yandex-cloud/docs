...
# Pricing policy for {{ mgp-name }} at the General Availability stage

{% note info %}

The indicated prices shall be effective from March 14, 2022. For information about the pricing policy until March 13, 2022, see [Current pricing policy](../pricing/).
