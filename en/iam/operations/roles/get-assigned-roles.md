...
- CLI
   ...
   1. {% include [include](../../../_includes/iam/list-access-bindings-via-cli.md) %}
      ...
      In the server response, find all the rows where the subject contains the account ID and the [system groups](../../concepts/access-control/system-group.md) `allUsers` and `allAuthenticatedUsers` as subjects.
