...
editable: false
apiPlayground:
  - url: https://iam.{{ api-host }}/iam/v1/subjects:batchGet
    method: post
    path: null
    query: null
    body:
...
```
POST https://iam.{{ api-host }}/iam/v1/subjects:batchGet
```

## Body parameters {#yandex.cloud.iam.v1.BatchGetSubjectsRequest}
...
## Response {#yandex.cloud.iam.v1.BatchGetSubjectsResponse}
