...
Field | Description
--- | ---
serviceAccountId | **string**<br><p>ID of the service account to create an access key for. To get the service account ID, use a <a href="/docs/iam/api-ref/ServiceAccount/list">list</a> request. If <a href="/docs/iam/api-ref/AccessKey/create#body_params">serviceAccountId</a> is not specified, it defaults to the subject that made the request.</p> <p>The maximum string length in characters is 50.</p> 
...
Field | Description
--- | ---
accessKey | **object**<br><p>AccessKey resource.</p> <p>An AccessKey resource. For more information, see <a href="/docs/iam/concepts/users/service-accounts#access-keys">Access Keys</a>.</p> 
...
accessKey.<br>createdAt | **string** (date-time)<br><p>Creation timestamp in <a href="https://www.ietf.org/rfc/rfc3339.txt">RFC3339</a> text format.</p> 
