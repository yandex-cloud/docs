...
Field | Description
--- | ---
accessKeys | **object**<br><p>An AccessKey resource. For more information, see <a href="/docs/iam/concepts/users/service-accounts#access-keys">Access Keys</a>.</p> 
...
accessKeys.<br>createdAt | **string** (date-time)<br><p>Creation timestamp in <a href="https://www.ietf.org/rfc/rfc3339.txt">RFC3339</a> text format.</p> 
