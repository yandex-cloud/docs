---
editable: false
sourcePath: en/_api-ref-grpc/iam/v1/api-ref/grpc/ServiceAccount/listAccessBindings.md
---

# Identity and Access Management API, gRPC: ServiceAccountService.ListAccessBindings {#ListAccessBindings}
