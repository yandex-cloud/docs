...
* `group`: A group of users. This type represents the [yandex.cloud.organizationmanager.v1.Group](/docs/organization/api-ref/grpc/Group/get#yandex.cloud.organizationmanager.v1.Group) resource.
* `userAccount`: An account on Yandex ID. This type represents the [yandex.cloud.iam.v1.UserAccount](/docs/iam/api-ref/grpc/UserAccount/get#yandex.cloud.iam.v1.UserAccount) resource.
