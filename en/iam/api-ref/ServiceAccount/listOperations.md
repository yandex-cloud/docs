...
--- | ---
serviceAccountId | <p>Required. ID of the ServiceAccount resource to list operations for.</p> <p>The maximum string length in characters is 50.</p> 
 
## Query parameters {#query_params}
 
Parameter | Description
--- | ---
pageSize | <p>The maximum number of results per page to return. If the number of available results is larger than <a href="/docs/iam/api-ref/ServiceAccount/listOperations#query_params">pageSize</a>, the service returns a <a href="/docs/iam/api-ref/ServiceAccount/listOperations#responses">nextPageToken</a> that can be used to get the next page of results in subsequent list requests. Default value: 100.</p> <p>The maximum value is 1000.</p> 
pageToken | <p>Page token. To get the next page of results, set <a href="/docs/iam/api-ref/ServiceAccount/listOperations#query_params">pageToken</a> to the <a href="/docs/iam/api-ref/ServiceAccount/listOperations#responses">nextPageToken</a> returned by a previous list request.</p> <p>The maximum string length in characters is 2000.</p> 
...
Field | Description
--- | ---
operations[] | **object**<br><p>List of operations for the specified service account.</p> 
