        ...
        pageSize:
          description: |-
            **string** (int64)
            ...
            the service returns a [ListServiceAccountsResponse.nextPageToken](/docs/iam/api-ref/ServiceAccount/list#yandex.cloud.iam.v1.ListServiceAccountsResponse)
        ...
        pageToken:
          description: |-
            **string**
            ...
            to the [ListServiceAccountsResponse.nextPageToken](/docs/iam/api-ref/ServiceAccount/list#yandex.cloud.iam.v1.ListServiceAccountsResponse)
        ...
        filter:
          description: |-
            **string**
            ...
            1. The field name. Currently you can use filtering only on the [ServiceAccount.name](/docs/iam/api-ref/ServiceAccount/get#yandex.cloud.iam.v1.ServiceAccount) field.
            2. An `=` operator.
