...
Field | Description
--- | ---
federationId | **string**<br><p>ID of the federation to add new certificate. To get the federation ID make a <a href="/docs/iam/api-ref/Federation/list">list</a> request.</p> <p>The maximum string length in characters is 50.</p> 
