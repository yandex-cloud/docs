...
3. If you have no one to add to the cloud, you can {% if product == "yandex-cloud" %}[create a new Yandex account](https://passport.yandex.com/registration){% endif %}{% if product == "cloud-il" %}[create a new Google account](https://support.google.com/accounts/answer/27441){% endif %} and grant access to the cloud to this account.
{% endif %}
{% if product == "cloud-il" %}
Log in to the [management console]({{ link-console-main }}). If you aren't registered, go to the management console and follow the instructions.
{% endif %}

## Add a new user to the cloud {#add-user}
{% if product == "yandex-cloud" %}

To grant access to resources for a user with a {% if product == "yandex-cloud" %}Yandex{% endif %}{% if product == "cloud-il" %}Google{% endif %} account:
...
1. Click **Add user**.
1. Enter the user's {% if product == "yandex-cloud" %}Yandex{% endif %}{% if product == "cloud-il" %}Google{% endif %} email.
1. Click **Add**.
...
You can add a user by using [{{ org-full-name }}](./operations/users/create.md#passport-user).
