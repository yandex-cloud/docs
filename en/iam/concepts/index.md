...
_A Yandex.Passport account_ is your Yandex or [Yandex.Connect]({{ link-yandex-connect }}) account. You need a Yandex.Passport account for managing resources via the [management console]({{ link-console-main }}).
