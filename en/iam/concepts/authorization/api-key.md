...
If the key is lost or damaged, you can't restore it. In this case, you can {% if product == "yandex-cloud" %}[reissue](../../operations/compromised-credentials.md#api-key-reissue){% else %}reissue{% endif %} the key or create a new one.
