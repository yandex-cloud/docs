---
editable: false
sourcePath: en/_api-ref/iam/v1/saml/api-ref/Federation/addUserAccounts.md
---

# Identity and Access Management SAML API, REST: Federation.AddUserAccounts {#AddUserAccounts}
...
## Body parameters {#yandex.cloud.iam.v1.saml.AddFederatedUserAccountsRequest}
