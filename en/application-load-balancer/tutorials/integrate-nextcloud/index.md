...
* [Manual Nextcloud deployment on a {{ compute-name }} VM or VM group](./fault-tolerant.md) is a way to deploy Nextcloud in your {{ yandex-cloud }} infrastructure manually in either the [basic](./fault-tolerant.md#the-basic-variant) or [fault-tolerant](./fault-tolerant.md#the-redundant-variant) configuration.
