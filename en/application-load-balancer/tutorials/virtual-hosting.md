...
- Management console
   ...
   1. Under **Integration with Application Load Balancer**, select **Create target group** and specify `vhosting-tg-a` as the group name. [Read more about target groups](../concepts/target-group.md).
   1. Click **Create**.
