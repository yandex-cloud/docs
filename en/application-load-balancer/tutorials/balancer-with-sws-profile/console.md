...
description: Follow this guide to use the management console to create a test web server, deploy an L7 {{ alb-name }} to distribute traffic to the test web server, and protect this new infrastructure with a {{ sws-name }} security profile.
