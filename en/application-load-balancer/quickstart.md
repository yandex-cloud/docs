...
- CLI
  ...
  1. Create a load balancer with a node in the same subnet:
      ...
      --location subnet-name=<subnet name in the ru-central1-a zone>,zone=ru-central1-a \
      --location subnet-name=<subnet name in the ru-central1-b zone>,zone=ru-central1-b \
      --location subnet-name=<subnet name in the ru-central1-c zone>,zone=ru-central1-c 
      ```
