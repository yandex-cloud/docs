...
* As a chart using the [Helm](https://helm.sh/) package manager, version {{ alb-ingress-helm-version }} or higher with [OCI support enabled](https://helm.sh/docs/topics/registries/). You can download and install the chart using the commands below:
