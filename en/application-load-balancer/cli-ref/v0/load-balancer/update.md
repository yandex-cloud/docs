---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/application-load-balancer/cli-ref/v0/load-balancer/update/
---

# yc application-load-balancer v0 load-balancer update
...
`yc application-load-balancer v0 load-balancer update <LOAD-BALANCER-NAME>|<LOAD-BALANCER-ID> [Flags...] [Global Flags...]`
...
A new name of the application load balancer. ||
|| `--description` | `string`
