...
**rpc Update ([UpdateBackendGroupRequest](#yandex.cloud.apploadbalancer.v1.UpdateBackendGroupRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## UpdateBackendGroupRequest {#yandex.cloud.apploadbalancer.v1.UpdateBackendGroupRequest}
...
1. Get the current set of labels with a [BackendGroupService.Get](/docs/application-load-balancer/api-ref/grpc/BackendGroup/get#Get) request.
...
a target, make a [BackendGroupService.AddBackend](/docs/application-load-balancer/api-ref/grpc/BackendGroup/addBackend#AddBackend) request or a [BackendGroupService.RemoveBackend](/docs/application-load-balancer/api-ref/grpc/BackendGroup/removeBackend#RemoveBackend) request. ||
