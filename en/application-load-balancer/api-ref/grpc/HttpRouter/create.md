...
Required field. ID of the folder to create an HTTP router in.
...
|| metadata | **[CreateHttpRouterMetadata](#yandex.cloud.apploadbalancer.v1.CreateHttpRouterMetadata)**
...
## CreateHttpRouterMetadata {#yandex.cloud.apploadbalancer.v1.CreateHttpRouterMetadata}
