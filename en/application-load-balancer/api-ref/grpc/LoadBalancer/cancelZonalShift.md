---
editable: false
sourcePath: en/_api-ref-grpc/apploadbalancer/v1/api-ref/grpc/LoadBalancer/cancelZonalShift.md
---

# Application Load Balancer API, gRPC: LoadBalancerService.CancelZonalShift

Cancel ZonalShift for the specified load balancer.

## gRPC request

**rpc CancelZonalShift ([CancelZonalShiftRequest](#yandex.cloud.apploadbalancer.v1.CancelZonalShiftRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## CancelZonalShiftRequest {#yandex.cloud.apploadbalancer.v1.CancelZonalShiftRequest}
