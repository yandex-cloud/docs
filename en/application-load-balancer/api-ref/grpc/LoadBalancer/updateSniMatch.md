...
# Application Load Balancer API, gRPC: LoadBalancerService.UpdateSniMatch {#UpdateSniMatch}

Updates the specified SNI handler of the specified listener.

This request does not allow to update [TlsListener.defaultHandler](/docs/application-load-balancer/api-ref/grpc/LoadBalancer/get#yandex.cloud.apploadbalancer.v1.TlsListener). Make an [UpdateListener](/docs/application-load-balancer/api-ref/grpc/LoadBalancer/updateListener#UpdateListener) request instead.
