...
```
DELETE https://alb.{{ api-host }}/apploadbalancer/v1/loadBalancers/{loadBalancerId}
```
...
|| metadata | **[DeleteLoadBalancerMetadata](#yandex.cloud.apploadbalancer.v1.DeleteLoadBalancerMetadata)**
...
## DeleteLoadBalancerMetadata {#yandex.cloud.apploadbalancer.v1.DeleteLoadBalancerMetadata}
