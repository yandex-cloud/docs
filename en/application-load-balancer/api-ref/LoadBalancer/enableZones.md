...
editable: false
apiPlayground:
  - url: https://alb.{{ api-host }}/apploadbalancer/v1/loadBalancers/{loadBalancerId}:enableZones
    method: post
    path:
      type: object
      properties:
    ...
    body:
      ...
      additionalProperties: false
    definitions: null
sourcePath: en/_api-ref/apploadbalancer/v1/api-ref/LoadBalancer/enableZones.md
---
...
## Body parameters {#yandex.cloud.apploadbalancer.v1.EnableZonesRequest}
...
|| metadata | **[EnableZonesMetadata](#yandex.cloud.apploadbalancer.v1.EnableZonesMetadata)**
...
## EnableZonesMetadata {#yandex.cloud.apploadbalancer.v1.EnableZonesMetadata}
