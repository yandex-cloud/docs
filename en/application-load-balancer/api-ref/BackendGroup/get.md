...
http | **object**<br>List of HTTP backends that the backend group consists of. <br> includes only one of the fields `http`, `grpc`, `stream`<br><br><p>An HTTP backend group resource.</p> 
