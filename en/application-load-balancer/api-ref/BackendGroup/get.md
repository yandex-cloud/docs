...
To get the list of all available backend groups, make a [List](/docs/application-load-balancer/api-ref/BackendGroup/list#List) request.
...
## Response {#yandex.cloud.apploadbalancer.v1.BackendGroup}
