...
backendGroups[].<br>http.<br>backends[].<br>loadBalancingConfig.<br>mode | **string**<br><p>Specifies algorithm the load balancer uses for target selection in particular backend.</p> <ul> <li>LEAST_REQUEST: Using power of two choices.</li> <li>MAGLEV_HASH: MAGLEV_HASH allows session affinity for that backend.</li> </ul> 
...
backendGroups[].<br>http.<br>connection | **object** <br>`backendGroups[].http` includes only one of the fields `connection`, `header`, `cookie`<br><br>
backendGroups[].<br>http.<br>connection.<br>sourceIp | **boolean** (boolean)<br>
backendGroups[].<br>http.<br>header | **object** <br>`backendGroups[].http` includes only one of the fields `connection`, `header`, `cookie`<br><br>
backendGroups[].<br>http.<br>header.<br>headerName | **string**<br><p>The string length in characters must be 1-256.</p> 
backendGroups[].<br>http.<br>cookie | **object** <br>`backendGroups[].http` includes only one of the fields `connection`, `header`, `cookie`<br><br>
backendGroups[].<br>http.<br>cookie.<br>name | **string**<br><p>The string length in characters must be 1-256.</p> 
backendGroups[].<br>http.<br>cookie.<br>ttl | **string**<br><p>If not set, session cookie will be used (not persisted between browser restarts).</p> 
...
backendGroups[].<br>grpc.<br>backends[].<br>loadBalancingConfig.<br>mode | **string**<br><p>Specifies algorithm the load balancer uses for target selection in particular backend.</p> <ul> <li>LEAST_REQUEST: Using power of two choices.</li> <li>MAGLEV_HASH: MAGLEV_HASH allows session affinity for that backend.</li> </ul> 
...
backendGroups[].<br>grpc.<br>connection | **object** <br>`backendGroups[].grpc` includes only one of the fields `connection`, `header`, `cookie`<br><br>
backendGroups[].<br>grpc.<br>connection.<br>sourceIp | **boolean** (boolean)<br>
backendGroups[].<br>grpc.<br>header | **object** <br>`backendGroups[].grpc` includes only one of the fields `connection`, `header`, `cookie`<br><br>
backendGroups[].<br>grpc.<br>header.<br>headerName | **string**<br><p>The string length in characters must be 1-256.</p> 
backendGroups[].<br>grpc.<br>cookie | **object** <br>`backendGroups[].grpc` includes only one of the fields `connection`, `header`, `cookie`<br><br>
backendGroups[].<br>grpc.<br>cookie.<br>name | **string**<br><p>The string length in characters must be 1-256.</p> 
backendGroups[].<br>grpc.<br>cookie.<br>ttl | **string**<br><p>If not set, session cookie will be used (not persisted between browser restarts).</p> 
