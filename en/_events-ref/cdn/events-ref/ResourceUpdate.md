...
# Cloud CDN Audit Trails Events: ResourceUpdate

## Event JSON schema {#yandex.cloud.audit.cdn.gcore.ResourceUpdate2-schema}
...
## Field description {#yandex.cloud.audit.cdn.gcore.ResourceUpdate2}
...
|| details | **[EventDetails](#yandex.cloud.audit.cdn.gcore.ResourceUpdate.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.cdn.gcore.ResourceUpdate.EventDetails}
...
Use cname as name for asset search scenario ||
|| options | **string** ||
|| active | **boolean** ||
