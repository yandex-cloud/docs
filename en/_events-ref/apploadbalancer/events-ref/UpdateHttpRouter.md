...
# Application Load Balancer Audit Trails Events: UpdateHttpRouter

## Event JSON schema {#yandex.cloud.audit.apploadbalancer.UpdateHttpRouter2-schema}
...
## Field description {#yandex.cloud.audit.apploadbalancer.UpdateHttpRouter2}
...
|| details | **[EventDetails](#yandex.cloud.audit.apploadbalancer.UpdateHttpRouter.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.apploadbalancer.UpdateHttpRouter.EventDetails}
