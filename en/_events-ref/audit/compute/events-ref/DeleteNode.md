...
# Compute Audit Trails Events: DeleteNode

## Event JSON schema {#yandex.cloud.audit.compute.DeleteNode2-schema}
...
## Field description {#yandex.cloud.audit.compute.DeleteNode2}
