...
# Compute Audit Trails Events: UpdateInstanceUnderlayInterface

## Event JSON schema {#yandex.cloud.audit.compute.UpdateInstanceUnderlayInterface2-schema}
...
## Field description {#yandex.cloud.audit.compute.UpdateInstanceUnderlayInterface2}
...
There should be actually Sync.SynchronousEventStatus, but it now breaks the generated compute-api code
...
|| details | **[EventDetails](#yandex.cloud.audit.compute.UpdateInstanceUnderlayInterface.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.compute.UpdateInstanceUnderlayInterface.EventDetails}
...
|| macAddress | **string** ||
|| ipv4Address | **string** ||
|| ipv4DnsRecords[] | **[DnsRecord](#yandex.cloud.compute.v1.DnsRecord)** ||
|| ipv6Address | **string** ||
