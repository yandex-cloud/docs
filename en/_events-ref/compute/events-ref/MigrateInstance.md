...
Masking value due to https://st.yandex-team.ru/CLOUD-233088 ||
...
only if instance is in a dedicated host group ||
|| targetDedicatedHostId | **string**

only if instance is in a dedicated host group ||
|| simulation | **boolean**

triggered by "simulate-maintenance-event" request, not a real migration ||
|#