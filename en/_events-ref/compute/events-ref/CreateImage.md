...
# Compute Audit Trails Events: CreateImage

## Event JSON schema {#yandex.cloud.audit.compute.CreateImage2-schema}
...
## Field description {#yandex.cloud.audit.compute.CreateImage2}
...
|| details | **[EventDetails](#yandex.cloud.audit.compute.CreateImage.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.compute.CreateImage.EventDetails}
