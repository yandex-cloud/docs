...
# Compute Audit Trails Events: DeleteInstanceGroup

## Event JSON schema {#yandex.cloud.audit.compute.instancegroup.DeleteInstanceGroup2-schema}
...
## Field description {#yandex.cloud.audit.compute.instancegroup.DeleteInstanceGroup2}
...
|| details | **[EventDetails](#yandex.cloud.audit.compute.instancegroup.DeleteInstanceGroup.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.compute.instancegroup.DeleteInstanceGroup.EventDetails}
