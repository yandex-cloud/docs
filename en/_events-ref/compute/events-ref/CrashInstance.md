...
# Compute Audit Trails Events: CrashInstance

## Event JSON schema {#yandex.cloud.audit.compute.CrashInstance2-schema}
...
## Field description {#yandex.cloud.audit.compute.CrashInstance2}
...
|| details | **[EventDetails](#yandex.cloud.audit.compute.CrashInstance.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.compute.CrashInstance.EventDetails}
