...
# Compute Audit Trails Events: DeleteHostGroup

## Event JSON schema {#yandex.cloud.audit.compute.DeleteHostGroup2-schema}
...
## Field description {#yandex.cloud.audit.compute.DeleteHostGroup2}
...
|| details | **[EventDetails](#yandex.cloud.audit.compute.DeleteHostGroup.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.compute.DeleteHostGroup.EventDetails}
