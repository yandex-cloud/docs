...
Egress NAT can only be enabled for subnets if the alpha flag is selected for egress NAT on {{ yandex-cloud }}. To request it, {% if region == "int" %}[contact support](https://console.cloud.yandex.com/support/create-ticket){% else %}[contact support](https://console.cloud.yandex.ru/support/create-ticket){% endif %}.
