...
- CLI
  ...
  Create a specification for a {% if lang == "ru" %}[Docker container](https://cloud.yandex.ru/blog/posts/2022/03/docker-containers){% endif %}{% if lang == "en" %}Docker container{% endif %} as a file named `container-spec-ports.yaml` and populate it with the following data:
