...
- Management console {#console}
  ...
  1. In the left-hand panel, select ![image](../../_assets/console-icons/gear-branches.svg) **{{ ui-key.yacloud.iot.label_brokers }}**. The **{{ ui-key.yacloud.common.overview }}** tab will display a list of brokers.
...
- CLI {#cli}
  ...
  1. See the description of the CLI command for getting a list of brokers:
