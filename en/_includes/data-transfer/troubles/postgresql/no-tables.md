...
* Check user permissions. For more information about the required permissions and how to assign them, see [{#T}](../../../../data-transfer/operations/endpoint/source/postgresql.md#prepare).
