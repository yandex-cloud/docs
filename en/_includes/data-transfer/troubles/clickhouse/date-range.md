...
* For the `DateTime64` type fields: 1900-01-01 to 2299-12-31. For more information, see [this {{ CH }} guide]({{ ch.docs }}{{ lang }}/sql-reference/data-types/datetime64).
* For the `DateTime` type fields: 1970-01-01 to 2106-02-07. For more information, see [this {{ CH }} guide]({{ ch.docs }}{{ lang }}/sql-reference/data-types/datetime).
