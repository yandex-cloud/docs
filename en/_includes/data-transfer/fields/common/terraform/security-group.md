...
Security group rules apply to a transfer. They allow opening network access from the transfer VM to the database VM. For more information, see [{#T}](../../../../../data-transfer/concepts/network.md).
