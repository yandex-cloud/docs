...
* {{ mch-name }}
    ...
    1. Make sure the tables you are transferring use the `MergeTree` family engines. Only these tables and [materialized views]({{ ch.docs }}{{ lang }}/materialized-views) (MaterializedView) will be transferred.
