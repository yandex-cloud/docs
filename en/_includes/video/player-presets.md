...
* Add a video logo, i.e., an image to display over the video. The supported formats are JPG, PNG, and SVG. The maximum size is 10 MB. You can add a clickable link to the logo.
* Enable progress saving: the player will resume playback from where the user last stopped watching.
