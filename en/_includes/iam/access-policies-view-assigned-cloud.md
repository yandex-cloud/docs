To view a list of access policies created for a [cloud](../../resource-manager/concepts/resources-hierarchy.md#cloud):
...
- CLI {#cli}
  ...
  Run the following command, specifying the name or [ID](../../resource-manager/operations/cloud/get-id.md) of the cloud for which you want to view the created policies:
