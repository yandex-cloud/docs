...
- {{ TF }}
   ...
   1. In the configuration file, describe the parameters of resources that you want to create:
      ...
      * `members`: List of users or service account the role is being assigned to. Указывается в виде `userAccount:<user ID>` или `serviceAccount:<service account ID>`. Required parameter.
