...
1. In the organization security settings, [enable the two-factor authentication requirement](../../organization/operations/enable-2fa-access.md). This way, only users with two-factor authentication enabled will be able to access your organization resources.