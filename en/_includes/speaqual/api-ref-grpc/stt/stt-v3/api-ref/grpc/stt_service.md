...
# {{ speechkit-name }} Recognition gRPC API: Recognizer
...
&nbsp;&nbsp;default_classifier | **[DefaultEouClassifier](#DefaultEouClassifier)**<br>EOU classifier provided by {{ speechkit-name }}. Default. 
