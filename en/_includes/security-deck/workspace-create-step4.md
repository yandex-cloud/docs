Optionally, in the **{{ ui-key.yacloud_org.security.workspaces.WorkspaceOnboardingForm.accessRightsTitle }}** section that opens, add users who will have access to the workspace being created and assign them roles in this workspace:
