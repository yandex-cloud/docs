...
|| Number of [{{ speechsense-name }} instances]({{ link-docs-ai }}speechsense/quickstart) linked to a single billing account 
...
|| Number of [{{ src-full-name }} instances]({{ link-src-docs }}) linked to a single billing account
