...
1. In the window that opens, confirm activation.

{% note info %}

If a local user was automatically deactivated when the specified deactivation date arrived, you can unblock them by changing or deleting that date.
