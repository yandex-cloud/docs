...
1. In the **{{ ui-key.yacloud_org.form.users.federated.add.field.federation }}** field, select the identity federation you want to add users from.

1. In the **{{ ui-key.yacloud_org.form.users.federated.add.field.users }}** field, list the name IDs of users, separating them with spaces or line breaks.
