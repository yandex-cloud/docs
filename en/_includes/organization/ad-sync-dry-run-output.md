As a result, the agent [logs](../../organization/concepts/ad-sync/sync-agent.md#logging) will record changes that must be made to {{ org-full-name }} user and group data to align with the agent configuration updates.
