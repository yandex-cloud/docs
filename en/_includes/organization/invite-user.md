...
- Cloud Organization
   ...
   1. Click ![icon-users](../../_assets/organization/horizontal-ellipsis.svg) in the relevant line of the invitation and select **Delete invitation**.
   ...
   1. Under [Users]({{ link-org-users }}) ![icon-users](../../_assets/organization/icon-users.svg), go to **Invitations** → **Active**.
   1. Click ![icon-users](../../_assets/organization/horizontal-ellipsis.svg) in the relevant line of the invitation and select **Resend**.
