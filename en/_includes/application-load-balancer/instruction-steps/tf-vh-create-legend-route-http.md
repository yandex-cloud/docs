* `http_route`: Route description for HTTP traffic:
    ...
    * `http_route_action`: Action applied to HTTP traffic.
        ...
        * `backend_group_id`: ID of the [backend group](../../../application-load-balancer/concepts/backend-group.md) located in the same folder as the [HTTP router](../../../application-load-balancer/concepts/http-router.md) and virtual host of the new route.
