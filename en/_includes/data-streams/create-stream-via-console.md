...
- Management console
    ...
    1. Specify a [serverless](../../ydb/concepts/serverless_and_dedicated.md#serverless) {{ ydb-short-name }} database or [create](../../ydb/quickstart/create-db.md) a new one. If you chose to create a new database, click **Update** after creating it to update the list of databases.
