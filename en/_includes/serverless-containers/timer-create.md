Create a [timer](../../serverless-containers/concepts/trigger/timer.md) — a trigger that calls a [{{ serverless-containers-name }} container](../../serverless-containers/concepts/container.md) on a schedule.

For more information about creating a timer that calls a function, see the [{{ sf-name }} documentation](../../functions/operations/trigger/timer-create.md).
...
- Management console
   ...
   1. Under **Timer settings**, specify the container invocation schedule in a [cron expression](../../functions/concepts/trigger/timer.md#cron-expression).
