* Over the internet, if you [configured](../../../managed-clickhouse/operations/hosts.md#update) public access for the appropriate host. You can only connect to these hosts over an SSL connection.
