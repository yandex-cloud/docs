...
* **Access from Yandex.Metrica and AppMetrica**: Enable this option to be able to [import AppMetrica data]{% if region == "ru" %}(https://appmetrica.yandex.ru/docs/cloud/index.html){% else %}(https://appmetrica.yandex.com/docs/cloud/index.html){% endif %} into the cluster.
