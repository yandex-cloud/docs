...
|| Amount of data per host when using a network HDD or SSD storage (for Intel Broadwell and Intel Cascade Lake) | 10 GB | 4096 GB ||
...
|| Amount of data per host when using a local SSD storage (for Intel Broadwell) | 10 GB | 4096 GB ||
|| Amount of data per host when using a local SSD storage (for Intel Cascade Lake and Intel Ice Lake) | 10 GB | 6,144 GB ||
