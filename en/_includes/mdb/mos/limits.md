...
| Number of hosts in a group of the `OPENSEARCH` type when using HDD network or SSD network storage | 1 | 10 |
| Number of hosts in a group of the `OPENSEARCH` type when storing data on non-replicated or local SSDs | 3 | 10 |
