* Over the internet if you configured public access for the appropriate host when [creating your cluster](../../../storedoc/operations/cluster-create.md). You can only connect to these hosts over an SSL connection.
