...
- Windows (PowerShell) {#windows}
   ...
   Your corporate security policies and antivirus software may block the certificate download. For more information, see [FAQ](../../../storedoc/qa/storedoc.md#get-ssl-error).
