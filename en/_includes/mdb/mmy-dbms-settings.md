...
- **Binlog transaction dependency tracking**{#setting-binlog-transaction-dependency-tracking} {{ tag-con }} {{ tag-cli }} {{ tag-api }}
   ...
   For more information, see the [{{ MY }} documentation](https://dev.mysql.com/doc/refman/8.0/en/replication-options-binary-log.html#sysvar_binlog_transaction_dependency_tracking).
...
- **Innodb compression level**{#setting-innodb-compression-level} {{ tag-con }} {{ tag-cli }} {{ tag-api }}
   ...
   For more information, see the [{{ MY }} documentation](https://dev.mysql.com/doc/refman/8.0/en/innodb-parameters.html#sysvar_innodb_compression_level).
...
- **Innodb ft max token size**{#setting-ft-max-token-size} {{ tag-all }}
   ...
   For more information, see the [{{ MY }} documentation](https://dev.mysql.com/doc/refman/8.0/en/innodb-parameters.html#sysvar_innodb_ft_max_token_size).
...
- **Innodb ft min token size**{#setting-ft-min-token-size} {{ tag-all }}
   ...
   For more information, see the [{{ MY }} documentation](https://dev.mysql.com/doc/refman/8.0/en/innodb-parameters.html#sysvar_innodb_ft_min_token_size).
...
- **Innodb online alter log max size**{#setting-online-alter-log-max-size} {{ tag-all }}
   ...
   The size of temporary InnoDB log files (in bytes) received during [online DDL queries](https://dev.mysql.com/doc/refman/8.0/en/glossary.html#glos_online_ddl). The greater value means more [DML operations](https://dev.mysql.com/doc/refman/8.0/en/glossary.html#glos_dml) during DDL queries but a longer period after a DDL query during which a table is locked because log data is applied.

   The minimum value is `65536` (64 KB) and the maximum value is `107374182400` (100 GB). Defaults to `134217728` (128 MB).

   For more information, see the [{{ MY }} documentation](https://dev.mysql.com/doc/refman/8.0/en/innodb-parameters.html#sysvar_innodb_online_alter_log_max_size).
...
- **Innodb page size**{#setting-innodb-page-size} {{ tag-all }}
   ...
   For more information, see the [{{ MY }} documentation](https://dev.mysql.com/doc/refman/8.0/en/innodb-parameters.html#sysvar_innodb_page_size).
...
- **Innodb status output**{#setting-innodb-status-output} {{ tag-con }}
   ...
   Manages output of the standard [InnoDB](https://dev.mysql.com/doc/refman/8.0/en/innodb-enabling-monitors.html) monitor.

   By default, the standard monitor is disabled.

   For more information, see the [{{ MY }} documentation](https://dev.mysql.com/doc/refman/8.0/en/innodb-parameters.html#sysvar_innodb_status_output).

- **Innodb strict mode**{#setting-strict-mode} {{ tag-con }}

   Manages InnoDB [strict mode](https://dev.mysql.com/doc/refman/8.0/en/glossary.html#glos_strict_mode). When enabled, specific conditions that are normally treated as warnings are considered errors.

   By default, InnoDB strict mode is enabled.

   For more information, see the [{{ MY }} documentation](https://dev.mysql.com/doc/refman/8.0/en/innodb-parameters.html#sysvar_innodb_strict_mode).
...
- **Interactive timeout**{#setting-interactive-timeout} {{ tag-all }}
   ...
   For more information, see the [{{ MY }} documentation](https://dev.mysql.com/doc/refman/8.0/en/server-system-variables.html#sysvar_interactive_timeout).
...
- **Log error verbosity**{#setting-log-error-verbosity} {{ tag-con }}
   ...
   For more information, see the [{{ MY }} documentation](https://dev.mysql.com/doc/refman/8.0/en/server-system-variables.html#sysvar_log_error_verbosity).
...
- **Lower case table names**{#setting-lower-case-table-names} {{ tag-all }}
   ...
   - `1`: Table names are saved in lowercase. Comparisons aren't case-sensitive.

   You cannot edit this setting after you create a cluster.

   For more information, see the [{{ MY }} documentation](https://dev.mysql.com/doc/refman/8.0/en/server-system-variables.html#sysvar_lower_case_table_names).
...
- **Max connections**{#setting-max-connections} {{ tag-all }}
   ...
   - The default value is `<amount of RAM in MB on one host> / 32`, but not less than `100`.
...
- **Max digest length**{#setting-max-digest-length} {{ tag-con }}
   ...
   The amount of memory (in bytes) allocated for the calculation of [normalized statement digests](https://dev.mysql.com/doc/refman/8.0/en/performance-schema-statement-digests.html).

   The minimum value is `1024` (1 KB) and the maximum value is `8192` (8 KB). Defaults to `1024` (1 KB).

   For more information, see the [{{ MY }} documentation](https://dev.mysql.com/doc/refman/8.0/en/server-system-variables.html#sysvar_max_digest_length).
...
- **Max sp recursion depth**{#setting-max-sp-recursion-depth} {{ tag-con }} {{ tag-cli }} {{ tag-api }}
   ...
   For more information, see the [{{ MY }} documentation](https://dev.mysql.com/doc/refman/8.0/en/server-system-variables.html#sysvar_max_sp_recursion_depth).
...
- **Range optimizer max mem size**{#setting-range-optimizer-max-mem-size} {{ tag-all }}
   ...
   For more information, see the [{{ MY }} documentation](https://dev.mysql.com/doc/refman/8.0/en/server-system-variables.html#sysvar_range_optimizer_max_mem_size).
...
- **Wait timeout**{#setting-wait-timeout} {{ tag-all }}
   ...
   For more information, see the [{{ MY }} documentation](https://dev.mysql.com/doc/refman/8.0/en/server-system-variables.html#sysvar_wait_timeout).
