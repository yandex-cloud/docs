...
- **Bytea output**{#setting-bytea-output} {{ tag-all }}
  ...
  For more information, see [this {{ PG }} article](https://www.postgresql.org/docs/current/datatype-binary.html).
...
- **Plan cache mode**{#setting-plan-cache-mode} {{ tag-con }} {{ tag-api }} {{ tag-tf }}
  ...
  For more information, see [this {{ PG }} article](https://www.postgresql.org/docs/current/runtime-config-query.html#GUC-PLAN-CACHE_MODE).
