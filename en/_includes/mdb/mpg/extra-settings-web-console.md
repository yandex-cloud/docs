...
- **{{ ui-key.yacloud.mdb.forms.backup-retain-period }}**: Retention period for automatic backups. Backups are automatically deleted once their retention period expires. The default retention period is {{ mpg-backup-retention }} days. For more information, see [Backups](../../../managed-postgresql/concepts/backup.md).
