...
Alternatively, you can use [special FQDNs](../../../managed-postgresql/operations/connect/fqdn.md#special-fqdns) pointing to the read-write master host and the most up-to-date replica.
