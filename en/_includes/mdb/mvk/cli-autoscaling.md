* `planned-usage-threshold`: Storage utilization percentage to trigger a storage increase during the next [maintenance window](../../../managed-valkey/concepts/maintenance.md#maintenance-window).
