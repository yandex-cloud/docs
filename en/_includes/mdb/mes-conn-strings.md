...
- Kibana
  ...
  1. The interface of your Kibana instance is available at the link `https://c-<{{ ES }} cluster ID>.rw.{{ dns-zone }}`. You can get the cluster ID [with a list of clusters in a folder](../../managed-elasticsearch/operations/cluster-list#list-clusters).
