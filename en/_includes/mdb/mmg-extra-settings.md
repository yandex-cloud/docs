...
- **Collect statistics**: Enable this option to use [{#T}](../../managed-mongodb/operations/performance-diagnostics.md) in the cluster. This feature is at the [Preview](../../overview/concepts/launch-stages.md) stage.
