...
| :------------------------------------------------------------------------------------------------------------------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------ | :----------------------------------------------------- |
| Host class | b1.nano ({% if audience != "internal" %}[5%](../../compute/concepts/performance-levels.md){% else %}5%{% endif %} × 2 vCPU Intel Broadwell, 2 GM RAM) | m3-c80-m640 (80 vCPU Intel Cascade Lake, 640 GB RAM) |
