...
|| Total number of CPU cores across all database hosts per cloud 
`mdb.cpu.count` | 64 ||
|| Total virtual memory across all database hosts per cloud 
`mdb.memory.size` | 512 GB ||
|| Total storage capacity across all clusters per cloud 
...
| Amount of data per host with either non-replicated SSD storage or ultra high-speed SSD network storage with three replicas | 93 GB                                                                                              | 8,184 GB                                              |
| Amount of data per host with SSD local storage (for Intel Broadwell and Intel Cascade Lake) | 100 GB                                                                                             | 1,500 GB                                              |
| Amount of data per host with SSD local storage (for Intel Ice Lake)                      | {{ local-ssd-v3-step }}                                                                            | {{ local-ssd-v3-max }}                               |
