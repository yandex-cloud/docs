...
- **DISTINCT overflow mode**{#setting-distinct-overflow-mode} {{ tag-con }} {{ tag-cli }} {{ tag-api }} {{ tag-sql }}
  ...
  Determines the {{ CH }} behavior when running the `SELECT DISTINCT` [query exceeds the limits]{% if lang == "ru" %}(https://clickhouse.tech/docs/ru/operations/settings/query-complexity/#ogranicheniia-na-slozhnost-zaprosa){% endif %}{% if lang == "en" %}(https://clickhouse.tech/docs/en/operations/settings/query-complexity/#ogranicheniia-na-slozhnost-zaprosa){% endif %}: `throw` (abort the query execution and return an error) or `break` (return a partial result).
...
- **Input format values interpret expressions**{#setting-input-format-values-interpret-expressions} {{ tag-con }} {{ tag-cli }} {{ tag-api }} {{ tag-sql }}
  ...
  This option is only used when inserting data of the [Values]{% if lang == "ru" %}(https://clickhouse.tech/docs/ru/interfaces/formats/#data-format-values){% endif %}{% if lang == "en" %}(https://clickhouse.tech/docs/en/interfaces/formats/#data-format-values){% endif %} format.
...
- **Join use nulls**{#setting-join-use-nulls} {{ tag-con }} {{ tag-cli }} {{ tag-sql }}
  ...
  To learn more, see the [{{ CH }} documentation]{% if lang == "ru" %}(https://clickhouse.tech/docs/ru/operations/settings/settings/#join_use_nulls){% endif %}{% if lang == "en" %}(https://clickhouse.tech/docs/en/operations/settings/settings/#join_use_nulls){% endif %}.
...
- **Max AST depth**{#setting-max-ast-depth} {{ tag-con }} {{ tag-cli }} {{ tag-api }} {{ tag-sql }}
  ...
  For more information, see the [{{ CH }} documentation]{% if lang == "ru" %}(https://clickhouse.tech/docs/ru/operations/settings/query-complexity/#max-ast-depth){% endif %}{% if lang == "en" %}(https://clickhouse.tech/docs/en/operations/settings/query-complexity/#max-ast-depth){% endif %}.
...
- **Max AST elements**{#setting-max-ast-elements} {{ tag-con }} {{ tag-cli }} {{ tag-api }} {{ tag-sql }}
  ...
  For more information, see the [{{ CH }} documentation]{% if lang == "ru" %}(https://clickhouse.tech/docs/ru/operations/settings/query-complexity/#max-ast-elements){% endif %}{% if lang == "en" %}(https://clickhouse.tech/docs/en/operations/settings/query-complexity/#max-ast-elements){% endif %}.
...
- **Max block size**{#setting-max-block-size} {{ tag-con }} {{ tag-cli }} {{ tag-api }} {{ tag-sql }}
  ...
  For more information, see the [{{ CH }} documentation]{% if lang == "ru" %}(https://clickhouse.tech/docs/ru/operations/settings/settings/#setting-max_block_size){% endif %}{% if lang == "en" %}(https://clickhouse.tech/docs/en/operations/settings/settings/#setting-max_block_size){% endif %}.
...
- **Max memory usage**{#setting-max-memory-usage} {{ tag-con }} {{ tag-cli }} {{ tag-api }} {{ tag-sql }}
  ...
  For more information, see the [{{ CH }} documentation]{% if lang == "ru" %}(https://clickhouse.tech/docs/ru/operations/settings/query-complexity/#settings_max_memory_usage){% endif %}{% if lang == "en" %}(https://clickhouse.tech/docs/en/operations/settings/query-complexity/#settings_max_memory_usage){% endif %}.
...
- **Max query size**{#setting-max-query-size} {{ tag-con }} {{ tag-cli }} {{ tag-api }} {{ tag-sql }}
  ...
  For more information, see the [{{ CH }} documentation]{% if lang == "ru" %}(https://clickhouse.tech/docs/ru/operations/settings/settings/#settings-max_query_size){% endif %}{% if lang == "en" %}(https://clickhouse.tech/docs/en/operations/settings/settings/#settings-max_query_size){% endif %}.
...
- **Max replica delay for distributed queries**{#setting-max-replica-delay-for-distributed-queries} {{ tag-con }} {{ tag-cli }} {{ tag-api }} {{ tag-sql }}
  ...
  For more information, see the [{{ CH }} documentation]{% if lang == "ru" %}(https://clickhouse.tech/docs/ru/operations/settings/settings/#settings-max_replica_delay_for_distributed_queries){% endif %}{% if lang == "en" %}(https://clickhouse.tech/docs/en/operations/settings/settings/#settings-max_replica_delay_for_distributed_queries){% endif %}.
...
- **Max rows to read**{#setting-max-rows-to-read} {{ tag-con }} {{ tag-cli }} {{ tag-api }} {{ tag-sql }}
  ...
  For more information, see the [{{ CH }} documentation]{% if lang == "ru" %}(https://clickhouse.tech/docs/ru/operations/settings/query-complexity/#max-rows-to-read){% endif %}{% if lang == "en" %}(https://clickhouse.tech/docs/en/operations/settings/query-complexity/#max-rows-to-read){% endif %}.
...
- **Min count to compile**{#setting-min-count-to-compile} {{ tag-con }} {{ tag-cli }} {{ tag-api }} {{ tag-sql }}
  ...
  For more information, see the [{{ CH }} documentation]{% if lang == "ru" %}(https://clickhouse.tech/docs/ru/operations/settings/settings/#min-count-to-compile){% endif %}{% if lang == "en" %}(https://clickhouse.tech/docs/en/operations/settings/settings/#min-count-to-compile){% endif %}.
...
- **Read overflow mode**{#setting-read-overflow-mode} {{ tag-con }} {{ tag-cli }} {{ tag-api }} {{ tag-sql }}
  ...
  Determines the {{ CH }} behavior when the amount of data read [exceeds one of the limits]{% if lang == "ru" %}(https://clickhouse.tech/docs/ru/operations/settings/query-complexity/#ogranicheniia-na-slozhnost-zaprosa){% endif %}{% if lang == "en" %}(https://clickhouse.tech/docs/en/operations/settings/query-complexity/#ogranicheniia-na-slozhnost-zaprosa){% endif %}. Either `throw` (abort execution and return an error) or `break` (return a partial result).
...
- **Readonly**{#setting-readonly} {{ tag-con }} {{ tag-cli }} {{ tag-api }} {{ tag-sql }}
  ...
  For more information, see the [{{ CH }} documentation]{% if lang == "ru" %}(https://clickhouse.tech/docs/ru/operations/settings/permissions-for-queries/#settings_readonly){% endif %}{% if lang == "en" %}(https://clickhouse.tech/docs/en/operations/settings/permissions-for-queries/#settings_readonly){% endif %}.
...
- **Skip unavailable shards**{#setting-skip-unavailable-shards} {{ tag-con }} {{ tag-cli }} {{ tag-api }} {{ tag-sql }}
  ...
  For more information, see the [{{ CH }} documentation]{% if lang == "ru" %}(https://clickhouse.tech/docs/ru/operations/settings/settings/#settings-skip_unavailable_shards){% endif %}{% if lang == "en" %}(https://clickhouse.tech/docs/en/operations/settings/settings/#settings-skip_unavailable_shards){% endif %}.

- **Sort overflow mode**{#setting-sort-overflow-mode} {{ tag-con }} {{ tag-cli }} {{ tag-api }} {{ tag-sql }}

  Determines the {{ CH }} behavior when the amount of rows received before sorting [exceeds one of the limits]{% if lang == "ru" %}(https://clickhouse.tech/doc/ru/operations/settings/query-complexity/#ogranicheniia-na-slozhnost-zaprosa){% endif %}{% if lang == "en" %}(https://clickhouse.tech/doc/en/operations/settings/query-complexity/#ogranicheniia-na-slozhnost-zaprosa){% endif %}. Either `throw` (abort execution and return an error) or `break` (return a partial result).
...
- **Transfer overflow mode**{#setting-transfer-overflow-mode} {{ tag-con }} {{ tag-cli }} {{ tag-api }} {{ tag-sql }}
  ...
  Determines the {{ CH }} behavior when the amount of data to transfer to another server [exceeds one of the limits]{% if lang == "ru" %}(https://clickhouse.tech/docs/ru/operations/settings/query-complexity/#ogranicheniia-na-slozhnost-zaprosa){% endif %}{% if lang == "en" %}(https://clickhouse.tech/docs/en/operations/settings/query-complexity/#ogranicheniia-na-slozhnost-zaprosa){% endif %}. Either `throw` (abort execution and return an error) or `break` (return a partial result).
...
- **Transform null in**{#setting-transform-null-in} {{ tag-con }} {{ tag-cli }} {{ tag-sql }}
  ...
  To learn more, see the [{{ CH }} documentation]{% if lang == "ru" %}(https://clickhouse.tech/docs/ru/operations/settings/settings/#transform_null_in){% endif %}{% if lang == "en" %}(https://clickhouse.tech/docs/en/operations/settings/settings/#transform_null_in){% endif %}.
