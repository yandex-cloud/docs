- **Backup start (UTC)**: The time in UTC when you want to start creating a [backup](../../managed-mysql/operations/cluster-backups.md) of a cluster (in 24-hour format). If the time is not set, the backup will start at 22:00 UTC.
