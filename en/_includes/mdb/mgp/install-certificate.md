...
- Windows (PowerShell) {#windows}
   ...
   Your corporate security policies and antivirus software may block the certificate download. For more information, see [FAQ](../../../managed-greenplum/qa/connection.md#get-ssl-error).
