...
* Via the internet, if you [configured](../../../managed-mysql/operations/hosts.md#update) public access for the host. You can connect over the internet in the following ways:
