[Archives with {{ KF }} binary files](https://kafka.apache.org/community/downloads/) include tools that allow managing the {{ KF }} cluster and its entities. For more information about these tools, see [this {{ KF }} vendor guide](https://docs.confluent.io/kafka/operations-tools/kafka-tools.html).
