...
| Name<br/>Type, units | Description |
| ----- | ----- |
| `pxf_availability.signal`<br/>`DGAUGE` | A comprehensive PXF service availability signal for the last 5 minutes: `2`, all PXF instances are available; `0`, some instances are unavailable. |
...
| `pxf.process_cpu_usage`<br/>`DGAUGE`, share | Current CPU load generated by the PXF process as a share of one core (`1` corresponds to full one core load) | 
