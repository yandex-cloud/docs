...
## Disk I/O metrics {#managed-elasticsearch-diskio-metrics}
| Name<br/>Type, units | Description |
| ----- | ----- |
...
These are metrics collected using the [API](https://www.elastic.co/guide/en/elasticsearch/reference/master/cluster-nodes-stats.html#cluster-nodes-stats-api-response-body).

| Name<br/>Type, units | 
| ----- | 
| `elasticsearch_discovered_cluster_manager`<br/>`DGAUGE`, 0/1 | 
| `elasticsearch_discovered_master`<br/>`DGAUGE`, 0/1 | 
| `elasticsearch_fs_io_stats_total_io_time_in_millis`<br/>`DGAUGE`, milliseconds | 
| `elasticsearch_fs_io_stats_total_operations`<br/>`DGAUGE`, count | 
| `elasticsearch_fs_io_stats_total_read_kilobytes`<br/>`DGAUGE`, kilobytes | 
| `elasticsearch_fs_io_stats_total_read_operations`<br/>`DGAUGE`, count | 
| `elasticsearch_fs_io_stats_total_write_kilobytes`<br/>`DGAUGE`, kilobytes | 
| `elasticsearch_fs_io_stats_total_write_operations`<br/>`DGAUGE`, count | 
...
| `elasticsearch_fs_total_used_percent`<br/>`DGAUGE`, count | 
| `elasticsearch_http_current_open`<br/>`DGAUGE`, count |
| `elasticsearch_http_total_opened`<br/>`DGAUGE`, count |
| `elasticsearch_indices_completion_size_in_bytes`<br/>`DGAUGE`, bytes | 
| `elasticsearch_indices_docs_count`<br/>`DGAUGE`, count | 
| `elasticsearch_indices_docs_deleted`<br/>`DGAUGE`, count | 
| `elasticsearch_indices_fielddata_evictions`<br/>`DGAUGE`, count | 
| `elasticsearch_indices_fielddata_memory_size_in_bytes`<br/>`DGAUGE`, bytes | 
| `elasticsearch_indices_flush_periodic`<br/>`DGAUGE`, count | 
| `elasticsearch_indices_flush_total`<br/>`DGAUGE`, count | 
| `elasticsearch_indices_flush_total_time_in_millis`<br/>`DGAUGE`, milliseconds | 
| `elasticsearch_indices_get_current`<br/>`DGAUGE`, count | 
| `elasticsearch_indices_get_exists_time_in_millis`<br/>`DGAUGE`, milliseconds | 
| `elasticsearch_indices_get_exists_total`<br/>`DGAUGE`, count | 
| `elasticsearch_indices_get_missing_time_in_millis`<br/>`DGAUGE`, milliseconds | 
| `elasticsearch_indices_get_missing_total`<br/>`DGAUGE`, count | 
| `elasticsearch_indices_get_time_in_millis`<br/>`DGAUGE`, milliseconds | 
| `elasticsearch_indices_get_total`<br/>`DGAUGE`, count |
| `elasticsearch_indices_indexing_delete_current`<br/>`DGAUGE`, count |
| `elasticsearch_indices_indexing_delete_time_in_millis`<br/>`DGAUGE`, milliseconds | 
| `elasticsearch_indices_indexing_delete_total`<br/>`DGAUGE`, count | 
| `elasticsearch_indices_indexing_index_current`<br/>`DGAUGE`, count | 
...
| `elasticsearch_indices_search_fetch_total`<br/>`DGAUGE`, count | 
