...
1. In the window that opens, go to the ![image](../../../_assets/console-icons/briefcase.svg) **In organization** tab and configure access to the workbook containing the chart or dashboard:
   ...
   1. In the window that opens, select a user or user group and specify an access permission. For more information, see the description of workbook [roles](../../../datalens/security/roles.md#workbook-roles).
