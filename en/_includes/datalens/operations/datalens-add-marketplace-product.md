Any user of an {{ datalens-short-name }} instance can add a free product. Only a user with the [datalens.instances.admin](../../../datalens/security/index.md#users-roles) role can add a subscription product.
