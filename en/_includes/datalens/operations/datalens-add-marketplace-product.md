Any user of an {{ datalens-short-name }} instance can add a free product. Only a user with the role [datalens.instances.admin](../../../datalens/security/index.md#users-roles) can add a subscription-based product.
