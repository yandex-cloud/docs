...
{% if product == "yandex-cloud" %}| The maximum number of rows of [materialized data](../../datalens/concepts/dataset/settings.md#materialization) <br>per dataset | 100,000,000 |{% endif %}
