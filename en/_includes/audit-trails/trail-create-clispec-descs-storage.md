...
* `destination.object_storage`: Structure describing the target bucket.
   * `bucket_id`: [Name of the bucket](../../storage/concepts/bucket.md#naming) to upload audit logs to.
