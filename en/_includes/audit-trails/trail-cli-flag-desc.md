...
* `--destination-eventrouter-connector-id`: [Connector](../../serverless-integrations/concepts/eventrouter/connector.md) ID of the {{ er-name }} bus with the `{{ at-name }}` source type to upload audit logs to.
