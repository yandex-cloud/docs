...
1. Set the rule priority. The rule will have higher priority than preconfigured rules.

   {% include [preconfigured-rules-priority](preconfigured-rules-priority.md) %}

1. (optional) Enable the **Dry run** option if you want to log data about the traffic matching the specified conditions, without applying any action to it.
