...
- CLI
   ...
   1. Create a file with the request body (for example, `body.json`).
      ...
      * `targetLanguageCode`: Target language in [ISO 639-1]{% if lang == "ru" %}(https://ru.wikipedia.org/wiki/ISO_639-1){% endif %}{% if lang == "en" %}(https://en.wikipedia.org/wiki/ISO_639-1){% endif %} format. You can get the language code with a [list of supported languages](../../translate/operations/list.md).
