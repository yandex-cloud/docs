...
^1^ quotas can be increased at the account balance of {% if region == "ru" %}₽500{% endif %}{% if region == "kz" %}₸3000{% endif %}{% if region == "int" %}$10{% endif %} (or higher) or upon request to the support team.
