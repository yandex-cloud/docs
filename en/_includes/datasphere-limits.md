...
^1^ quotas can be increased after you deposit at least {% if region == "ru" %}₽500{% endif %}{% if region == "kz" %}₸3000{% endif %}{% if region == "int" %}$10{% endif %} to your billing account or upon request to the support team.
