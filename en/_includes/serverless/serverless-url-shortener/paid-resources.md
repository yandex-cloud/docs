...
* Fee for the number of [function](../../../functions/concepts/function.md) calls, computing resources allocated for the function, and outgoing traffic (see [{{ sf-name }} pricing](../../../functions/pricing.md)).
