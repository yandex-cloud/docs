...
- Third-party DNS provider {#third-party-dns-server}
  ...
  1. Under **{{ ui-key.yacloud.certificate-manager.overview.section_challenges }}**, in the `CNAME` record section, check the record value for the domain in the **{{ ui-key.yacloud.certificate-manager.overview.challenge_label_value }}** field.
