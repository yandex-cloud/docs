You can save a [certificate](../../certificate-manager/concepts/index.md) chain and a private key to use for your own purposes, e.g., when configuring a web server on a [VM](../../compute/concepts/vm.md).
