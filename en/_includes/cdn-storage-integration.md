...
- Terraform
   ...
   1. In the configuration file, describe the parameters of `example-network` and its subnets: `example-subnet-ru-central1-a`, `example-subnet-ru-central1-b`, and `example-subnet-ru-central1-c`:
      ...
      Learn more in the description of the [yandex_vpc_network](https://registry.terraform.io/providers/yandex-cloud/yandex/latest/docs/resources/vpc_network) and [yandex_vpc_subnet](https://registry.terraform.io/providers/yandex-cloud/yandex/latest/docs/resources/vpc_subnet) resources in the Terraform provider documentation.
...
- API
   ...
   1. Create the `example-subnet-ru-central1-a`, `example-subnet-ru-central1-b`, and `example-subnet-ru-central1-c` subnets in the three availability zones by calling the gRPC API [SubnetService/Create](../vpc/api-ref/grpc/subnet_service.md#Create) or the REST API [create](../vpc/api-ref/Subnet/create.md) method.
...
- Terraform
   ...
   1. Add parameters of the `example-router` HTTP router, its virtual hosts and routes, to the configuration file:
      ...
      Learn more in the description of the [yandex_alb_http_router](https://registry.terraform.io/providers/yandex-cloud/yandex/latest/docs/resources/alb_http_router) and [yandex_alb_virtual_host](https://registry.terraform.io/providers/yandex-cloud/yandex/latest/docs/resources/alb_virtual_host) resources in the Terraform provider documentation.
...
- Management console
   ...
   1. Under **Allocation**, select three subnets for the load balancer nodes: `example-subnet-ru-central1-a`, `example-subnet-ru-central1-b`, and `example-subnet-ru-central1-c`, then enable traffic to these subnets.
...
- CLI
   ...
   1. Create a load balancer named `example-balancer`:
      ...
      yc alb load-balancer create example-balancer \
        ...
        --location zone=ru-central1-a,subnet-id=<ID of example-subnet-ru-central1-a subnet> \
        --location zone=ru-central1-b,subnet-id=<ID of example-subnet-ru-central1-b subnet> \
        --location zone=ru-central1-c,subnet-id=<ID of example-subnet-ru-central1-c subnet>
      ```
...
- Terraform
   ...
   1. Add parameters of CDN resources to the configuration file:
      ...
      Learn more in the description of the [yandex_cdn_origin_group](https://registry.terraform.io/providers/yandex-cloud/yandex/latest/docs/resources/cdn_origin_group) and [yandex_cdn_resource](https://registry.terraform.io/providers/yandex-cloud/yandex/latest/docs/resources/cdn_resource) resources in the Terraform provider documentation.
...
1. Create or edit a CNAME record for `cdn.yandexcloud.example` to link them to the copied domain name:
   ...
   - Terraform
      ...
      1. Add the parameters of the `example-dns-zone` DNS zone and its CNAME records to the configuration file:
         ...
         Learn more in the description of the [yandex_dns_zone](https://registry.terraform.io/providers/yandex-cloud/yandex/latest/docs/resources/dns_zone) and [yandex_dns_recordset](https://registry.terraform.io/providers/yandex-cloud/yandex/latest/docs/resources/dns_recordset) resources in the Terraform provider documentation.
   ...
   - API
      ...
      1. Add the `cdn` CNAME record to the zone, copying the `cl-....gcdn.co` value with the gRPC API [DnsZoneService/UpdateRecordSets](../dns/api-ref/grpc/dns_zone_service.md#UpdateRecordSets) call or the [updateRecordSets](../dns/api-ref/DnsZone/updateRecordSets.md) REST API method.
...
1. [Delete](../vpc/operations/subnet-delete.md) the `example-subnet-ru-central1-a`, `example-subnet-ru-central1-b`, and `example-subnet-ru-central1-c` subnets.
