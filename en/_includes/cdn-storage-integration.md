...
1. {% if audience != "internal" %}[Delete](../vpc/operations/subnet-delete.md){% else %}Delete{% endif %} the `example-subnet-ru-central1-a`, `example-subnet-ru-central1-b`, and `example-subnet-ru-central1-c` subnets.
