...
- CLI
    ...
    * `--name`: Timer name.
    * `--bucket-id`: Bucket ID.
    * `--prefix`: [Prefix](../../functions/concepts/trigger/os-trigger.md#filter) of the bucket object key. Used for filtering.
    * `--suffix`: [Suffix](../../functions/concepts/trigger/os-trigger.md#filter) of the bucket object key. Used for filtering.
