...
* To create a trigger, you need:
    * Permission for the service account used by the trigger to run the operation. This permission comes with the [iam.serviceAccounts.user](../../iam/security/index.md#iam-serviceAccounts-user) and [{{ roles-editor }}](../../iam/roles-reference.md#editor) roles or higher.
...
Learn more about access management [here](../../functions/security/index.md).
