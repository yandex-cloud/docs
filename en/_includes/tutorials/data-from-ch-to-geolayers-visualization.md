...
1. Add a **Pizzerias** dimension to section **Y**. Delete **OpenDate** from section **Y**.
1. Add a **Revenue** measure to section **X**. Delete the dimension **The number of pizzerias** from section **X**.
