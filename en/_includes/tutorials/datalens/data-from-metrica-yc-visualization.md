...
1. [Funnels](#funnels)
    ...
    1. [{{ datalens-short-name }}. Funnels by browser. Configure a dashboard](#setting-browser-funnels-chart-on-dashboard)
1. [Cohorts](#cohorts)
...
1. Insert the password of the logged-in user into the **.chpass.txt** file. Save and close the file.
...
1. In the upper-right corner, click ![save-button](../../../_assets/datalens/solution-09/29-save-button.png) → **Save as**.
...
1. To color the table, add the **Visits** field to the **Colors** section and click the gear icon. In the window that opens, configure the colors:
    1. Select **Gradient type**: Three point.
    1. Select **Color**: Orange-Violet-Blue.
    1. Enable **Set threshold values** and specify the values of 100, 1000, and 5000.
    1. Click **Apply**.
1. Click **Save**.
