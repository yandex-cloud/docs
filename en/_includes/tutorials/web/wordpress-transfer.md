...
1. Under **Image/boot disk selection**, go to the **Cloud Marketplace** tab and click **Show more**. Select [LAMP]( https://cloud.yandex.com/en-ru/marketplace/products/yc/lamp) — an image with a set of necessary components: Linux OS, Apache web server, MySQL DBMS, and a PHP interpreter.
