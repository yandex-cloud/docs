...
- The load is generated by the [Yandex.Tank](https://cloud.yandex.com/marketplace/products/f2eorddjcjobshekumlp) app and goes to {{network-load-balancer-short-name}}. The load balancer distributes traffic across VMs.
