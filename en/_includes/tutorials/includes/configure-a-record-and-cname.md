...
1. Log in to the control panel of the external DNS service. Go to the [list of your domains]{% if lang == "ru" %}(https://www.reg.ru/user/domain_list){% endif %}{% if lang == "en" %}(https://www.reg.com/user/domain_list){% endif %} and click on the required domain name.
