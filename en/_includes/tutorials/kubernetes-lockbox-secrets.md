[External Secrets Operator](https://external-secrets.io/provider-yandex-lockbox/) lets you set up the synchronization of [{{ lockbox-name }}](../../lockbox/) secrets with {{ managed-k8s-name }} cluster secrets.
