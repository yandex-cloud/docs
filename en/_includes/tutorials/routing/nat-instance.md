...
1. Under **Images from {{ marketplace-name }}**, click **Select** and choose the [NAT instance](https://cloud.yandex.com/en-ru/marketplace/products/f2etqeet87jshce7o7j8) image.
