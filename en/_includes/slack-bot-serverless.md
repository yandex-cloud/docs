...
1. [Create](../functions/operations/function/version-manage.md#version-create) a function version:
   ...
   1. Indicate the following:
      ...
      * Specify the entry point: `index.handler`.
      * Timeout: 5 seconds.
      * The service account.
...
1. [Create](../ydb/quickstart/create-db.md#control-plane) a database named `for-slack-bot` in Serverless mode.
...
* For getting the bot's reaction in response to a simple command.
...
1. [Create](../functions/operations/function/version-manage.md#version-create) a function version:
   ...
   1. Indicate the following:
      ...
      * Timeout: 5 seconds.
      * The service account.
   1. Add the following [environment variables](#env):
      * `SLACK_BOT_TOKEN`
...
1. [Create](../functions/operations/function/version-manage.md#version-create) a function version:
   ...
   1. Add the variables to work with {{ ydb-name }}:
      * `DATABASE`: The value of the **Database** field  from the **Overview** section in the `for-slack-bot` database properties. For example: `/ru-central1/a1bcd23mbaomkfvsleds/etn456khb7jn1ddedfht`
