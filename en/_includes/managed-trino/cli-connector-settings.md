* `--cluster-id`: ID of the cluster where you are creating your {{ TR }} catalog. You can get the cluster ID with the [list of clusters](../../managed-trino/operations/cluster-list.md#list-clusters).
