* `{{ ui-key.yacloud.baremetal.label_public-ip-from-dedicated-subnet }}`: To assign an IP address from the range of addresses of a [dedicated public subnet](../../../baremetal/concepts/public-network.md#public-subnet).
