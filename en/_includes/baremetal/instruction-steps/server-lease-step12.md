Under **{{ ui-key.yacloud.baremetal.title_section-server-info }}**:

  1. Specify the server name in the **{{ ui-key.yacloud.baremetal.field_name }}** field. Follow these naming requirements:
