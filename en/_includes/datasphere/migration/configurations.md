...
Since projects run on different {{ yandex-cloud }} platforms with different computing resources, {{ ml-platform-name }} does not guarantee that RAM will be 100% available. If you need a configuration with a fixed amount of RAM, choose a platform that indicates a specific value.
