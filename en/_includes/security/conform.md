...
* [Statement of compliance of the Personal Data Protection System with the Requirements of Federal Law No. 152 "On Personal Data"]{% if lang == "ru" %}(https://{{ s3-storage-host }}/yc-compliance/conformance_ru_pdp.pdf){% endif %}{% if lang == "en" %}(https://{{ s3-storage-host }}/yc-compliance/conformance_en_pdp.pdf){% endif %}.
...
* [Customer actions to protect personal data]{% if lang == "ru" %}(https://{{ s3-storage-host }}/yc-compliance/recomendations/FZ-152-RU.pdf){% endif %}{% if lang == "en" %}(https://{{ s3-storage-host }}/yc-compliance/recomendations/FZ-152-EN.pdf){% endif %}.
...
[ISO 27001 certificate](https://{{ s3-storage-host }}/cloudil-compliance/ISO%20certificates/%D7%A7%D7%9C%D7%90%D7%95%D7%93.%20%D7%90%D7%99%D7%99%20%D7%90%D7%9C%20%D7%A1%D7%99%D7%A1%D7%98%D7%9E%D7%A1-1.pdf).
...
* [PCI DSS certificate for {{ yandex-cloud }}]{% if lang == "ru" %}(https://{{ s3-storage-host }}/yc-compliance/certificates/PCI_DSS_Yandex_Cloud_RU.pdf){% endif %}{% if lang == "en" %}(https://{{ s3-storage-host }}/yc-compliance/certificates/PCI_DSS_Yandex_Cloud_EN.pdf){% endif %}.
