...
1. In the **Basic parameters** section:
    ...
    - Enter a name and description of the VM.
...
1. Select one of the GPU-oriented images and the OS version under **Public images** .
...
1. In the **Access** section, specify the data required to access the VM:
    ...
    - Enter the username in the **Login** field.
      ...
      Do not use login `root`, or other names reserved by the operating system. To perform operations that require superuser permissions, use the command `sudo`.
