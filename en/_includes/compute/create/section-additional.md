...
* Optionally, under **Backup**, enable **Connect** and select or create a [backup policy](../../../backup/concepts/policy.md) to automatically back up your VMs using [{{ backup-name }}](../../../backup/index.yaml).
