...
* Optionally, under **Backup**, enable **Connect** and select or create a [backup policy](../../../backup/concepts/policy.md) to make automatic backups of your VMs using [{{ backup-name }}](../../../backup/index.yaml).
