...
- {{ TF }} {#tf}
  ...
  For more information about the properties of the `yandex_compute_instance` resource, see [this provider guide]({{ tf-provider-datasources-link }}/compute_instance).
