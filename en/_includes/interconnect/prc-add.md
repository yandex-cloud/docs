...
All private connection attribute values in the support request text below are used for indicative purposes only. Each customer should have their own attribute values.
