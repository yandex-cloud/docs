...
## Version 0.70.0 (22.12.20) {#latest-release}
...
The {{ api-gw-full-name }} service is at the Preview stage. Read more about the service in the [documentation](../api-gateway/).
