---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/managed-kubernetes/cli-ref/v0/cluster/add-access-binding/
---

# yc managed-kubernetes v0 cluster add-access-binding
...
`yc managed-kubernetes cluster add-access-binding <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
