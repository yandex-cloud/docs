---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/compute/cli-ref/v0/placement-group/add-access-binding
editable: false
---

# yc compute v0 placement-group add-access-binding

Add access binding for the specified placement group

#### Command Usage

Syntax:

`yc compute placement-group add-access-binding <PLACEMENT-GROUP-NAME>|<PLACEMENT-GROUP-ID> [Flags...] [Global Flags...]`
