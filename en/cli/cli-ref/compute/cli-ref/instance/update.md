...
|`--memory`|<b>`byteSize`</b><br/>Specifies how much memory instance should have in GB. You can also use M and T suffixes to specify smaller or greater size respectively.|
