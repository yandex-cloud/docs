---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/kms/cli-ref/symmetric-key/remove-access-binding
editable: false
---
...
`yc kms symmetric-key remove-access-binding <SYMMETRIC-KEY> [Flags...] [Global Flags...]`
