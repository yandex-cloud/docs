---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/baremetal/cli-ref/private-subnet/create/
---
...
`yc baremetal private-subnet create <HARDWARE-POOL-ID>`
...
1. Generate template:
yc baremetal private-subnet create --example-json > request.json
or
yc baremetal private-subnet create --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal private-subnet create -r request.json
or
yc baremetal private-subnet create -r request.yaml ||
|#
