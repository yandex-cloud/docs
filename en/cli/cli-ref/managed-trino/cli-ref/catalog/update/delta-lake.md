---
editable: false
sourcePath: en/_cli-ref/cli-ref/managed-trino/cli-ref/catalog/update/delta-lake.md
---

# yc managed-trino catalog update delta-lake

Update Delta Lake catalog

#### Command Usage

Syntax: 

`yc managed-trino catalog update delta-lake <CATALOG-NAME> [Flags...] [Global Flags...]`
