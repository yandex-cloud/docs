---
editable: false
sourcePath: en/_cli-ref/cli-ref/managed-trino/cli-ref/catalog/update/tpcds.md
---

# yc managed-trino catalog update tpcds

Update TPC-DS catalog

#### Command Usage

Syntax: 

`yc managed-trino catalog update tpcds <CATALOG-NAME> [Flags...] [Global Flags...]`
