---
editable: false
sourcePath: en/_cli-ref/cli-ref/connection-manager/cli-ref/connection/update/mysql.md
---

# yc connection-manager connection update mysql
...
`yc connection-manager connection update mysql [<CONNECTION-ID>] [Flags...] [Global Flags...]`
...
|`--hosts`|<b>`value[,value]`</b><br/>List of MySQL hosts in format 'host:port'.|
