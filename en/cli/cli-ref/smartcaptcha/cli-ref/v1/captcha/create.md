---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/smartcaptcha/cli-ref/v1/captcha/create/
---
...
`yc smartcaptcha v1 captcha create <FOLDER-ID>`
...
1. Generate template:
yc smartcaptcha v1 captcha create --example-json > request.json
or
yc smartcaptcha v1 captcha create --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc smartcaptcha v1 captcha create -r request.json
or
yc smartcaptcha v1 captcha create -r request.yaml ||
|#
