---
editable: false
sourcePath: en/_cli-ref/cli-ref/managed-services/compute/snapshot/set-access-bindings.md
---

# yc compute snapshot set-access-bindings

Set access bindings for the specified snapshot and delete all existing access bindings if there were any

#### Command Usage

Syntax: 

`yc compute snapshot set-access-bindings <SNAPSHOT-NAME>|<SNAPSHOT-ID> [Flags...] [Global Flags...]`
