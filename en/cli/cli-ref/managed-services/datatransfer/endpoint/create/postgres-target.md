---
sourcePath: en/_cli-ref/cli-ref/managed-services/datatransfer/endpoint/create/postgres-target.md
---
...
|`--cluster-id`|<b>`string`</b><br/>Yandex.Cloud Managed PostgreSQL cluster ID|
