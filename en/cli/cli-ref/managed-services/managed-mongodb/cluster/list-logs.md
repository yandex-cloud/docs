...
|`--service-type`|<b>`string`</b><br/>Type of the service to request logs from. Values: 'mongod', 'mongos', 'mongocfg' --columns value[,value]   Columns from logs table to request.|
