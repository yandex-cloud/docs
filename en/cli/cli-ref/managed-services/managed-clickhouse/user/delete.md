---
sourcePath: en/_cli-ref/cli-ref/managed-services/managed-clickhouse/user/delete.md
---
...
`yc managed-clickhouse user delete <USER-NAME> [<USER-NAME>...] [Flags...] [Global Flags...]`
