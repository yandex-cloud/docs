---
editable: false
sourcePath: en/_cli-ref/cli-ref/managed-services/serverless/trigger/update/container-registry.md
---

# yc serverless trigger update container-registry
...
`yc serverless trigger update container-registry <TRIGGER-NAME> [Flags...] [Global Flags...]`
...
|`--new-registry-id`|<b>`string`</b><br/>Container registry ID.|
|`--new-registry-name`|<b>`string`</b><br/>Container registry name.|
|`--new-image-name`|<b>`string`</b><br/>Container image name filter.|
|`--new-tag`|<b>`string`</b><br/>Container image tag filter.|
|`--new-events`|<b>`value[,value]`</b><br/>List of container registry events to subscribe. A list can be specified by listing events separated by commas as well as passing this flag multiple times.<br/>Available events are: 'create-image' , 'delete-image', 'create-image-tag', 'delete-image-tag'.<br/>|
|`--new-batch-size`|<b>`int`</b><br/>Batch size, 1 - 10. Default: 1|
|`--new-batch-cutoff`|<b>`duration`</b><br/>Batch cutoff. 1 - 60s. Default: 1s.|
|`--new-invoke-function-id`|<b>`string`</b><br/>Function to be invoked by worker on the data from Container Registry.|
|`--new-invoke-function-name`|<b>`string`</b><br/>Function to be invoked by worker on the data from Container Registry.|
...
|`--new-invoke-container-id`|<b>`string`</b><br/>Container to be invoked by worker on the data from Container Registry.|
|`--new-invoke-container-name`|<b>`string`</b><br/>Container to be invoked by worker on the data from Container Registry.|
...
|`--new-gateway-id`|<b>`string`</b><br/>Gateway to which worker will broadcast the data from Container Registry.|
|`--new-gateway-name`|<b>`string`</b><br/>Gateway to which worker will broadcast the data from Container Registry.|
