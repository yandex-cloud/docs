---
editable: false
sourcePath: en/_cli-ref/cli-ref/managed-services/serverless/eventrouter/connector/remove-access-binding.md
---

# yc serverless eventrouter connector remove-access-binding
