---
editable: false
sourcePath: en/_cli-ref/cli-ref/managed-services/backup/agent/install.md
---
...
|`--policy-ids`|<b>`value[,value]`</b><br/>Policy ids to attach to specified instance after agent installation. Note: policy attachment on new instance is async operation and it may take few minutes.|
