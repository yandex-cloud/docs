---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/serverless/cli-ref/v0/eventrouter/bus/remove-access-binding/
---

# yc serverless v0 eventrouter bus remove-access-binding

Remove access binding for the specified bus

#### Command Usage

Syntax:

`yc serverless eventrouter bus remove-access-binding <BUS-NAME>|<BUS-ID> [Flags...] [Global Flags...]`
