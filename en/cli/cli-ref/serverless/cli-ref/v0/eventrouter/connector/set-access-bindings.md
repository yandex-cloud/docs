---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/serverless/cli-ref/v0/eventrouter/connector/set-access-bindings/
---

# yc serverless v0 eventrouter connector set-access-bindings
