---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/serverless/cli-ref/v0/trigger/v1/update/message-queue/
---

# yc serverless v0 trigger v1 update message-queue
