---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/serverless/cli-ref/v0/trigger/v1/create/message-queue/
---

# yc serverless v0 trigger v1 create message-queue
...
`yc serverless trigger v1 create message-queue <TRIGGER-NAME> [Flags...] [Global Flags...]`
