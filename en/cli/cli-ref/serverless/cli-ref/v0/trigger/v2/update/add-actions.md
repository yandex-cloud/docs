---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/serverless/cli-ref/v0/trigger/v2/update/add-actions/
---

# yc serverless v0 trigger v2 update add-actions
...
`yc serverless trigger v2 update add-actions <TRIGGER-NAME>|<TRIGGER-ID> [Flags...] [Global Flags...]`
