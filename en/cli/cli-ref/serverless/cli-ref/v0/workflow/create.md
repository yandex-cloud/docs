---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/serverless/cli-ref/v0/workflow/create/
---

# yc serverless v0 workflow create
...
Workflow specification file name. ||
|| `--network-id` | `string`
