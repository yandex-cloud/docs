---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/serverless/cli-ref/v0/api-gateway/add-access-binding
editable: false
---

# yc serverless v0 api-gateway add-access-binding
...
`yc serverless api-gateway add-access-binding <API-GATEWAY-NAME>|<API-GATEWAY-ID> [Flags...] [Global Flags...]`
