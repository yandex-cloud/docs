---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/serverless/cli-ref/trigger/v2/create/iot-broker/
---

# yc serverless trigger v2 create iot-broker
...
`yc serverless trigger v2 create iot-broker <TRIGGER-NAME> [Flags...] [Global Flags...]`
