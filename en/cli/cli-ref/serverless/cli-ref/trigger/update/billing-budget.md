---
editable: false
sourcePath: en/_cli-ref/cli-ref/serverless/cli-ref/trigger/update/billing-budget.md
---
...
|`--new-gateway-id`|<b>`string`</b><br/>Gateway to which worker will broadcast the data from billing.|
|`--new-gateway-name`|<b>`string`</b><br/>Gateway to which worker will broadcast the data from billing.|
