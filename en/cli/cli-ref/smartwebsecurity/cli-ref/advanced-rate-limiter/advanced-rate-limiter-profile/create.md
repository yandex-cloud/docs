---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/smartwebsecurity/cli-ref/advanced-rate-limiter/advanced-rate-limiter-profile/create/
---
...
`yc smartwebsecurity advanced-rate-limiter advanced-rate-limiter-profile create <FOLDER-ID>`
...
1. Generate template:
yc smartwebsecurity advanced-rate-limiter advanced-rate-limiter-profile create --example-json > request.json
or
yc smartwebsecurity advanced-rate-limiter advanced-rate-limiter-profile create --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc smartwebsecurity advanced-rate-limiter advanced-rate-limiter-profile create -r request.json
or
yc smartwebsecurity advanced-rate-limiter advanced-rate-limiter-profile create -r request.yaml ||
|#
