---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/smartwebsecurity/cli-ref/security-profile/update/
---
...
`yc smartwebsecurity security-profile update <SECURITY-PROFILE-ID>`
...
1. Generate template:
yc smartwebsecurity security-profile update --example-json > request.json
or
yc smartwebsecurity security-profile update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc smartwebsecurity security-profile update -r request.json
or
yc smartwebsecurity security-profile update -r request.yaml ||
|#
