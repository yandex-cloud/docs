---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/container/cli-ref/v0/cluster/add-access-binding
editable: false
---

# yc container v0 cluster add-access-binding
...
`yc container cluster add-access-binding <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
