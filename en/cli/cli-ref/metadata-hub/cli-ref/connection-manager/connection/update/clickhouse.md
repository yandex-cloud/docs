---
editable: false
sourcePath: en/_cli-ref/cli-ref/metadata-hub/cli-ref/connection-manager/connection/update/clickhouse.md
---

# yc metadata-hub connection-manager connection update clickhouse
...
`yc metadata-hub connection-manager connection update clickhouse [<CONNECTION-ID>] [Flags...] [Global Flags...]`
...
|`--hosts`|<b>`value[,value]`</b><br/>List of ClickHouse hosts in format 'host:http_port:tcp_port:shard_name'.|
|`--shard-groups`|<b>`value[,value]`</b><br/>List of ClickHouse shard groups in format 'group_name:shard1:shard2'.|
