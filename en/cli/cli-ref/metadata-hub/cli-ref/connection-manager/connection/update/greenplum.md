---
editable: false
sourcePath: en/_cli-ref/cli-ref/metadata-hub/cli-ref/connection-manager/connection/update/greenplum.md
---
...
|`--hosts`|<b>`value[,value]`</b><br/>List of Greenplum hosts in format 'host:port'.|
