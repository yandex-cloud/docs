---
editable: false
sourcePath: en/_cli-ref/cli-ref/metadata-hub/cli-ref/connection-manager/connection/create/mongodb.md
---
...
|`--auth-source`|<b>`string`</b><br/>If this field is left blank, the database from the connection will be used as the authentication source.|
|`--hosts`|<b>`value[,value]`</b><br/>List of MongoDB hosts in format 'host:port'.|
