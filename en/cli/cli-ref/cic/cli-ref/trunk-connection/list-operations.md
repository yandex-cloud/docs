---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/cic/cli-ref/trunk-connection/list-operations
editable: false
---
...
`yc cic trunk-connection list-operations <TRUNK-CONNECTION-ID>`
