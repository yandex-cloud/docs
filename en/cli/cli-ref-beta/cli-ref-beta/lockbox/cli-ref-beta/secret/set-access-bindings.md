...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/lockbox/cli-ref-beta/secret/set-access-bindings.md
---

# yc beta lockbox secret set-access-bindings
...
`yc beta lockbox secret set-access-bindings <RESOURCE-ID>`
