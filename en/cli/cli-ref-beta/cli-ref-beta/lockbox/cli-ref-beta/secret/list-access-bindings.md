...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/lockbox/cli-ref-beta/secret/list-access-bindings.md
---

# yc beta lockbox secret list-access-bindings
...
`yc beta lockbox secret list-access-bindings <RESOURCE-ID>`
