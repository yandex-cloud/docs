...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/lockbox/cli-ref-beta/secret/update-access-bindings.md
---

# yc beta lockbox secret update-access-bindings
...
`yc beta lockbox secret update-access-bindings <RESOURCE-ID>`
