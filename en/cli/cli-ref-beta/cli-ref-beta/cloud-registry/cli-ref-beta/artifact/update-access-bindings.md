...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/cloud-registry/cli-ref-beta/artifact/update-access-bindings.md
---

# yc beta cloud-registry artifact update-access-bindings
...
`yc beta cloud-registry artifact update-access-bindings <RESOURCE-ID>`
