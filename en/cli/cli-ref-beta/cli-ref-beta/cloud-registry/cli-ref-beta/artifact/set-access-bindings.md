...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/cloud-registry/cli-ref-beta/artifact/set-access-bindings.md
---

# yc beta cloud-registry artifact set-access-bindings
...
`yc beta cloud-registry artifact set-access-bindings <RESOURCE-ID>`
