...
Encryption algorithm to be used with a new key version, generated with the next rotation. Possible Values: 'aes-128', 'aes-192', 'aes-256', 'aes-256-hsm', 'gost-r-3412-2015-k' ||
...
Interval between automatic rotations. To disable automatic rotation, don't include this field in the creation request. (duration, e.g. 30s, 5m10s) ||
