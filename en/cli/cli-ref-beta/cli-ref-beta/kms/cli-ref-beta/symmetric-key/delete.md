...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/kms/cli-ref-beta/symmetric-key/delete.md
---

# yc beta kms symmetric-key delete
...
`yc beta kms symmetric-key delete <KEY-ID>`
