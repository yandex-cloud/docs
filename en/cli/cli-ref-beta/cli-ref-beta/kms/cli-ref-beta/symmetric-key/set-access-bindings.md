...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/kms/cli-ref-beta/symmetric-key/set-access-bindings.md
---

# yc beta kms symmetric-key set-access-bindings
...
`yc beta kms symmetric-key set-access-bindings <RESOURCE-ID>`
