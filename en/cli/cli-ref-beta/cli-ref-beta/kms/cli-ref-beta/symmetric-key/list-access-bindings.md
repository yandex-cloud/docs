...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/kms/cli-ref-beta/symmetric-key/list-access-bindings.md
---

# yc beta kms symmetric-key list-access-bindings
...
`yc beta kms symmetric-key list-access-bindings <RESOURCE-ID>`
