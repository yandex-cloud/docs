...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/kms/cli-ref-beta/asymmetric-encryption-key/update-access-bindings.md
---

# yc beta kms asymmetric-encryption-key update-access-bindings
...
`yc beta kms asymmetric-encryption-key update-access-bindings <RESOURCE-ID>`
