...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/kms/cli-ref-beta/asymmetric-signature-key/get.md
---

# yc beta kms asymmetric-signature-key get
...
`yc beta kms asymmetric-signature-key get <KEY-ID>`
