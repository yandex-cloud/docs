...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-redis/cli-ref-beta/cluster/list-hosts.md
---

# yc beta managed-redis cluster list-hosts
...
`yc beta managed-redis cluster list-hosts <CLUSTER-ID>`
