...
|`--cluster-id`|<b>`string`</b><br/>ID of the Redis cluster to add hosts to.<br/>To get the Redis cluster ID, use a [ClusterService.List] request.|
|`--host-specs`|<b>`shorthand/json`</b><br/>Configurations for Redis hosts that should be added to the cluster.<br/><br/>Example:|
