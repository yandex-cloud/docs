...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-greenplum/cli-ref-beta/cluster/set-access-bindings.md
---

# yc beta managed-greenplum cluster set-access-bindings
...
`yc beta managed-greenplum cluster set-access-bindings <RESOURCE-ID>`
