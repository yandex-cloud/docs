...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/ydb/cli-ref-beta/database/set-access-bindings.md
---

# yc beta ydb database set-access-bindings
...
`yc beta ydb database set-access-bindings <RESOURCE-ID>`
