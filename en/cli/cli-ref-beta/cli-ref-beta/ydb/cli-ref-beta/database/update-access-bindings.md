...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/ydb/cli-ref-beta/database/update-access-bindings.md
---

# yc beta ydb database update-access-bindings
...
`yc beta ydb database update-access-bindings <RESOURCE-ID>`
