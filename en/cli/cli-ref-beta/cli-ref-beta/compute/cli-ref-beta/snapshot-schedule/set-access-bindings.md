...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/snapshot-schedule/set-access-bindings.md
---

# yc beta compute snapshot-schedule set-access-bindings
...
`yc beta compute snapshot-schedule set-access-bindings <RESOURCE-ID>`
