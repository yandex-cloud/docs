...
|`--snapshot-schedule-id`|<b>`string`</b><br/>ID of the snapshot schedule to list created snapshots for. To get a snapshot schedule ID, make a [SnapshotScheduleService.List] request.|
