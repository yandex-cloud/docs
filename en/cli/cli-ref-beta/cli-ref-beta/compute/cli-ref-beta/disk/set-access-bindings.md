...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/disk/set-access-bindings.md
---

# yc beta compute disk set-access-bindings
...
`yc beta compute disk set-access-bindings <RESOURCE-ID>`
