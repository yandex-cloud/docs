...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/instance/set-access-bindings.md
---

# yc beta compute instance set-access-bindings
...
`yc beta compute instance set-access-bindings <RESOURCE-ID>`
