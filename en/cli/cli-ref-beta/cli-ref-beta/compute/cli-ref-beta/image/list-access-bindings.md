...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/image/list-access-bindings.md
---

# yc beta compute image list-access-bindings
...
`yc beta compute image list-access-bindings <RESOURCE-ID>`
