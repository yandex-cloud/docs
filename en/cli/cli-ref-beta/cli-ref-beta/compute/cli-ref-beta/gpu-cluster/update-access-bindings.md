...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/gpu-cluster/update-access-bindings.md
---

# yc beta compute gpu-cluster update-access-bindings
...
`yc beta compute gpu-cluster update-access-bindings <RESOURCE-ID>`
