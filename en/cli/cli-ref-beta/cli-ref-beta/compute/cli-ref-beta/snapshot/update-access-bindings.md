...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/snapshot/update-access-bindings.md
---

# yc beta compute snapshot update-access-bindings
...
`yc beta compute snapshot update-access-bindings <RESOURCE-ID>`
