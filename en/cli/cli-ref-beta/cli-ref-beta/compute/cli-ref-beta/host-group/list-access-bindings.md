...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/host-group/list-access-bindings.md
---

# yc beta compute host-group list-access-bindings
...
`yc beta compute host-group list-access-bindings <RESOURCE-ID>`
