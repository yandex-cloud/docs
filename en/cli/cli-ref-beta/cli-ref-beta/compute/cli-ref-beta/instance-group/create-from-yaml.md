...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/instance-group/create-from-yaml.md
---

# yc beta compute instance-group create-from-yaml
...
`yc beta compute instance-group create-from-yaml <FOLDER-ID>`
...
|`--instance-group-yaml`|<b>`string`</b><br/>[InstanceGroupService.Create] request in YAML format.|
