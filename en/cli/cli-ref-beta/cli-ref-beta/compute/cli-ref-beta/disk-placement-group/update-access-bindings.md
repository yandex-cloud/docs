...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/disk-placement-group/update-access-bindings.md
---

# yc beta compute disk-placement-group update-access-bindings
...
`yc beta compute disk-placement-group update-access-bindings <RESOURCE-ID>`
