...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/disk-placement-group/list-disks.md
---

# yc beta compute disk-placement-group list-disks
...
`yc beta compute disk-placement-group list-disks <DISK-PLACEMENT-GROUP-ID>`
