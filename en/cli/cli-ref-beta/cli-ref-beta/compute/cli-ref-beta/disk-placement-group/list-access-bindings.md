...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/disk-placement-group/list-access-bindings.md
---

# yc beta compute disk-placement-group list-access-bindings
...
`yc beta compute disk-placement-group list-access-bindings <RESOURCE-ID>`
