...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/filesystem/update-access-bindings.md
---

# yc beta compute filesystem update-access-bindings
...
`yc beta compute filesystem update-access-bindings <RESOURCE-ID>`
