...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/compute/cli-ref-beta/filesystem/set-access-bindings.md
---

# yc beta compute filesystem set-access-bindings
...
`yc beta compute filesystem set-access-bindings <RESOURCE-ID>`
