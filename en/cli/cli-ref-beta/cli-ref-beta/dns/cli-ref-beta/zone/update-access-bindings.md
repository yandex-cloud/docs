...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/dns/cli-ref-beta/zone/update-access-bindings.md
---

# yc beta dns zone update-access-bindings
...
`yc beta dns zone update-access-bindings <RESOURCE-ID>`
