...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/function/update-access-bindings.md
---

# yc beta serverless function update-access-bindings
...
`yc beta serverless function update-access-bindings <RESOURCE-ID>`
