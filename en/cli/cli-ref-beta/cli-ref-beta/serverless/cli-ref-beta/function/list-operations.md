...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/function/list-operations.md
---

# yc beta serverless function list-operations
...
`yc beta serverless function list-operations <FUNCTION-ID>`
...
|`--function-id`|<b>`string`</b><br/>ID of the function to list operations for.|
