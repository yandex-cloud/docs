...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/function/set-scaling-policy.md
---

# yc beta serverless function set-scaling-policy
...
`yc beta serverless function set-scaling-policy <FUNCTION-ID>`
...
|| `--provisioned-instances-count` | `int`
