...
|`--specification`|<b>`shorthand/json`</b><br/>Specification of Workflow<br/>Shorthand Syntax:<br/>{<br/>spec = spec-yaml=str<br/>}<br/>JSON Syntax:<br/>"{<br/>"spec": {<br/>"spec-yaml": "str"<br/>}<br/>}"<br/>Fields:<br/>spec -> (oneof\<spec-yaml\>)<br/>Oneof spec field<br/>spec-yaml -> (string)<br/>Workflow specification in YAML format.|
