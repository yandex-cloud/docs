...
|`--log-options`|<b>`shorthand/json`</b><br/>Options for logging from the Workflow.<br/><br/>Example:|
...
|`--specification`|<b>`shorthand/json`</b><br/>Specification of the Workflow.<br/><br/>Example:<br/>--specification spec={spec-yaml=value}<br/><br/>Shorthand Syntax:<br/>{spec={spec-yaml=str}}<br/>Fields:<br/>spec  oneof\<spec-yaml\>  — Oneof spec field<br/>spec-yaml  string  — Workflow specification in YAML format.<br/>|
