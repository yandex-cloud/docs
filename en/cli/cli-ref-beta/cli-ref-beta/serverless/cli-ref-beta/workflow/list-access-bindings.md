...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/workflow/list-access-bindings.md
---

# yc beta serverless workflow list-access-bindings
...
`yc beta serverless workflow list-access-bindings <RESOURCE-ID>`
