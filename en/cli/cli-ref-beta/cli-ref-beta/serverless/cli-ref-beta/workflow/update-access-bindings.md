...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/workflow/update-access-bindings.md
---

# yc beta serverless workflow update-access-bindings
...
`yc beta serverless workflow update-access-bindings <RESOURCE-ID>`
