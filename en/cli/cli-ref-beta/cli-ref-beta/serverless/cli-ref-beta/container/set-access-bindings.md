...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/container/set-access-bindings.md
---

# yc beta serverless container set-access-bindings
...
`yc beta serverless container set-access-bindings <RESOURCE-ID>`
