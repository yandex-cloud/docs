...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/eventrouter/bus/list.md
---

# yc beta serverless eventrouter bus list
...
`yc beta serverless eventrouter bus list <FOLDER-ID>`
