...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/eventrouter/bus/list-access-bindings.md
---

# yc beta serverless eventrouter bus list-access-bindings
...
`yc beta serverless eventrouter bus list-access-bindings <RESOURCE-ID>`
