...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/eventrouter/rule/list-operations.md
---

# yc beta serverless eventrouter rule list-operations
...
`yc beta serverless eventrouter rule list-operations <RULE-ID>`
