...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/mdbproxy/set-access-bindings.md
---

# yc beta serverless mdbproxy set-access-bindings
...
`yc beta serverless mdbproxy set-access-bindings <RESOURCE-ID>`
