...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/api-gateway/add-domain.md
---

# yc beta serverless api-gateway add-domain
...
`yc beta serverless api-gateway add-domain <API-GATEWAY-ID>`
