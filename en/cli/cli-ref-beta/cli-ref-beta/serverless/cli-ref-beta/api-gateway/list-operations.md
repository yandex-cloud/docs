...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/serverless/cli-ref-beta/api-gateway/list-operations.md
---

# yc beta serverless api-gateway list-operations
...
`yc beta serverless api-gateway list-operations <API-GATEWAY-ID>`

#### Flags

| Flag | Description |
|----|----|
|`--api-gateway-id`|<b>`string`</b><br/>ID of the API gateway to list operations for.|
