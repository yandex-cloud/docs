...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-mongodb/cli-ref-beta/cluster/list-access-bindings.md
---

# yc beta managed-mongodb cluster list-access-bindings
...
`yc beta managed-mongodb cluster list-access-bindings <RESOURCE-ID>`
