...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/dataproc/cli-ref-beta/cluster/list-access-bindings.md
---

# yc beta dataproc cluster list-access-bindings
...
`yc beta dataproc cluster list-access-bindings <RESOURCE-ID>`
