...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/dataproc/cli-ref-beta/cluster/set-access-bindings.md
---

# yc beta dataproc cluster set-access-bindings
...
`yc beta dataproc cluster set-access-bindings <RESOURCE-ID>`
