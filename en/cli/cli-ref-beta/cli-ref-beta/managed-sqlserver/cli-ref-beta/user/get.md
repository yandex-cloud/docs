...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-sqlserver/cli-ref-beta/user/get.md
---

# yc beta managed-sqlserver user get
...
`yc beta managed-sqlserver user get <CLUSTER-ID>`
