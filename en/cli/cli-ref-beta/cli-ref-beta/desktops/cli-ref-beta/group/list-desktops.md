...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/desktops/cli-ref-beta/group/list-desktops.md
---

# yc beta desktops group list-desktops
...
`yc beta desktops group list-desktops <DESKTOP-GROUP-ID>`
