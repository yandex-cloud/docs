...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/desktops/cli-ref-beta/group/set-access-bindings.md
---

# yc beta desktops group set-access-bindings
...
`yc beta desktops group set-access-bindings <RESOURCE-ID>`
