...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/organization-manager/cli-ref-beta/idp/userpool/list-access-bindings.md
---

# yc beta organization-manager idp userpool list-access-bindings
...
`yc beta organization-manager idp userpool list-access-bindings <RESOURCE-ID>`
