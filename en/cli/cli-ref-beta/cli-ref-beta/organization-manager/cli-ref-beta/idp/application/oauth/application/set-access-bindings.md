...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/organization-manager/cli-ref-beta/idp/application/oauth/application/set-access-bindings.md
---

# yc beta organization-manager idp application oauth application set-access-bindings
...
`yc beta organization-manager idp application oauth application set-access-bindings <RESOURCE-ID>`
