...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/organization-manager/cli-ref-beta/organization/list-access-bindings.md
---

# yc beta organization-manager organization list-access-bindings
...
`yc beta organization-manager organization list-access-bindings <RESOURCE-ID>`
