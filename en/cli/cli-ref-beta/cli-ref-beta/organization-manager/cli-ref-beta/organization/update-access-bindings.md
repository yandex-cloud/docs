...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/organization-manager/cli-ref-beta/organization/update-access-bindings.md
---

# yc beta organization-manager organization update-access-bindings
...
`yc beta organization-manager organization update-access-bindings <RESOURCE-ID>`
