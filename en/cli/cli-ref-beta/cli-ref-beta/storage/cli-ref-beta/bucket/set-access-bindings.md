...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/storage/cli-ref-beta/bucket/set-access-bindings.md
---

# yc beta storage bucket set-access-bindings
...
`yc beta storage bucket set-access-bindings <RESOURCE-ID>`
