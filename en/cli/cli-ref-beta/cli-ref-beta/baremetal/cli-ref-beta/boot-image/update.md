...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/baremetal/cli-ref-beta/boot-image/update.md
---

# yc beta baremetal boot-image update
...
`yc beta baremetal boot-image update <IMAGE-ID>`
