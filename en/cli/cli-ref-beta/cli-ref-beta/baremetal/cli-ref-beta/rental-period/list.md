...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/baremetal/cli-ref-beta/rental-period/list.md
---

# yc beta baremetal rental-period list
...
`yc beta baremetal rental-period list <CONFIGURATION-ID>`
