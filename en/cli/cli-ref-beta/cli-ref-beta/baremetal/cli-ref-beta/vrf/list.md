...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/baremetal/cli-ref-beta/vrf/list.md
---

# yc beta baremetal vrf list
...
`yc beta baremetal vrf list <FOLDER-ID>`
...
|`--folder-id`|<b>`string`</b><br/>ID of the folder to list VRFs in.<br/><br/>To get the folder ID, use a [yandex.cloud.resourcemanager.v1.FolderService.List] request.|
