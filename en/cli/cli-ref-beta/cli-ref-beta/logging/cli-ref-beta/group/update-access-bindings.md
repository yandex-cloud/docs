...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/logging/cli-ref-beta/group/update-access-bindings.md
---

# yc beta logging group update-access-bindings
...
`yc beta logging group update-access-bindings <RESOURCE-ID>`
