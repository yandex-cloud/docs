...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/logging/cli-ref-beta/group/set-access-bindings.md
---

# yc beta logging group set-access-bindings
...
`yc beta logging group set-access-bindings <RESOURCE-ID>`
