...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/logging/cli-ref-beta/group/list-access-bindings.md
---

# yc beta logging group list-access-bindings
...
`yc beta logging group list-access-bindings <RESOURCE-ID>`
