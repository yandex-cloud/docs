...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-mysql/cli-ref-beta/database/get.md
---

# yc beta managed-mysql database get
...
`yc beta managed-mysql database get <CLUSTER-ID>`
