...
|`--cluster-id`|<b>`string`</b><br/>ID of the cluster to update the user in.<br/><br/>To get this ID, make a [ClusterService.List] request.|
|`--connection-limits`|<b>`shorthand/json`</b><br/>Set of changed user connection limits.<br/><br/>Example:|
|`--connection-limits`|<b>`max-connections-per-hour=42,`</b><br/>max-questions-per-hour=42, max-updates-per-hour=42, max-user-connections=42<br/><br/>Shorthand Syntax:<br/>{max-connections-per-hour=int, max-questions-per-hour=int, max-updates-per-hour=int, max-user-connections=int}<br/>Fields:<br/>max-connections-per-hour  int  — The maximum permitted number of simultaneous client connections per hour.<br/>max-questions-per-hour    int  — The maximum permitted number of user questions per hour.<br/>max-updates-per-hour      int  — The maximum permitted number of user updates per hour.<br/>max-user-connections      int  — The maximum number of simultaneous connections permitted to any given MySQL user account.<br/>|
...
|`--permissions`|<b>`shorthand/json`</b><br/>A new set of permissions that should be granted to the user.<br/><br/>Example:|
...
|`--user-name`|<b>`string`</b><br/>Name of the user to update.<br/><br/>To get this name, make a [UserService.List] request.|
