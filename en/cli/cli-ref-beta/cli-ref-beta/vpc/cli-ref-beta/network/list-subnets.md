...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/vpc/cli-ref-beta/network/list-subnets.md
---

# yc beta vpc network list-subnets
...
`yc beta vpc network list-subnets <NETWORK-ID>`
