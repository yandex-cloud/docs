...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-clickhouse/cli-ref-beta/user/list.md
---

# yc beta managed-clickhouse user list
...
`yc beta managed-clickhouse user list <CLUSTER-ID>`
...
ID of the cluster to list ClickHouse users in. To get the cluster ID, use a [ClusterService.List] request. ||
|| `--page-size` | `int`
