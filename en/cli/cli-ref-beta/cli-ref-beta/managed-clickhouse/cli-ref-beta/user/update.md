...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-clickhouse/cli-ref-beta/user/update.md
---

# yc beta managed-clickhouse user update
...
`yc beta managed-clickhouse user update <CLUSTER-ID>`
...
ID of the ClickHouse cluster the user belongs to. To get the cluster ID, use a [ClusterService.List] request. ||
