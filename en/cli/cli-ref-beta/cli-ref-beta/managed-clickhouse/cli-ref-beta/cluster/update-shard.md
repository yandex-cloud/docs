...
# yc beta managed-clickhouse cluster update-shard
...
`yc beta managed-clickhouse cluster update-shard <CLUSTER-ID>`
...
ID of the ClickHouse cluster the shard belongs to. To get the cluster ID, use a [ClusterService.List] request. ||
...
Name of the shard to be updated. To get the name of a shard, use a [ClusterService.ListShards] request. ||
