...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-clickhouse/cli-ref-beta/cluster/set-access-bindings.md
---

# yc beta managed-clickhouse cluster set-access-bindings
...
`yc beta managed-clickhouse cluster set-access-bindings <RESOURCE-ID>`
