...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-metastore/cli-ref-beta/cluster/update-access-bindings.md
---

# yc beta managed-metastore cluster update-access-bindings
...
`yc beta managed-metastore cluster update-access-bindings <RESOURCE-ID>`
