...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-airflow/cli-ref-beta/cluster/update-access-bindings.md
---

# yc beta managed-airflow cluster update-access-bindings
...
`yc beta managed-airflow cluster update-access-bindings <RESOURCE-ID>`
