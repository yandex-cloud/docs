...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-airflow/cli-ref-beta/cluster/set-access-bindings.md
---

# yc beta managed-airflow cluster set-access-bindings
...
`yc beta managed-airflow cluster set-access-bindings <RESOURCE-ID>`
