...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-spark/cli-ref-beta/cluster/update-access-bindings.md
---

# yc beta managed-spark cluster update-access-bindings
...
`yc beta managed-spark cluster update-access-bindings <RESOURCE-ID>`
