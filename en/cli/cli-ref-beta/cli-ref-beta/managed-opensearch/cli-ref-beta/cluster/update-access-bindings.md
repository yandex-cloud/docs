...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-opensearch/cli-ref-beta/cluster/update-access-bindings.md
---

# yc beta managed-opensearch cluster update-access-bindings
...
`yc beta managed-opensearch cluster update-access-bindings <RESOURCE-ID>`
