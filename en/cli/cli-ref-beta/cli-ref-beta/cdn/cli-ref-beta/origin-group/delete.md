...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/cdn/cli-ref-beta/origin-group/delete.md
---

# yc beta cdn origin-group delete
...
`yc beta cdn origin-group delete <FOLDER-ID>`
