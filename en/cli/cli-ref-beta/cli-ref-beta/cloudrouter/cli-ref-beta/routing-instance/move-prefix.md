...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/cloudrouter/cli-ref-beta/routing-instance/move-prefix.md
---

# yc beta cloudrouter routing-instance move-prefix
...
`yc beta cloudrouter routing-instance move-prefix <ROUTING-INSTANCE-ID>`
