...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/cloudrouter/cli-ref-beta/routing-instance/remove-prefixes.md
---

# yc beta cloudrouter routing-instance remove-prefixes

Removes specified prefixes from a RoutingInstance resource.  Method starts an asynchronous operation that can be cancelled while it is in progress.

#### Command Usage

Syntax: 

`yc beta cloudrouter routing-instance remove-prefixes <ROUTING-INSTANCE-ID>`
