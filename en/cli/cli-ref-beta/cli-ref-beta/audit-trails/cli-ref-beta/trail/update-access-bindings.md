...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/audit-trails/cli-ref-beta/trail/update-access-bindings.md
---

# yc beta audit-trails trail update-access-bindings
...
`yc beta audit-trails trail update-access-bindings <RESOURCE-ID>`
