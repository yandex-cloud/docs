...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/certificate-manager/cli-ref-beta/private-certificate/set-access-bindings.md
---

# yc beta certificate-manager private-certificate set-access-bindings
...
`yc beta certificate-manager private-certificate set-access-bindings <RESOURCE-ID>`
