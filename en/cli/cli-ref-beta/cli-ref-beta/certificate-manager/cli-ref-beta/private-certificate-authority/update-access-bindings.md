...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/certificate-manager/cli-ref-beta/private-certificate-authority/update-access-bindings.md
---

# yc beta certificate-manager private-certificate-authority update-access-bindings
...
`yc beta certificate-manager private-certificate-authority update-access-bindings <RESOURCE-ID>`
