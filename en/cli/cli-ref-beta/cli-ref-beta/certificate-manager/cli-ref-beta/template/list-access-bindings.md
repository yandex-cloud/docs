...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/certificate-manager/cli-ref-beta/template/list-access-bindings.md
---

# yc beta certificate-manager template list-access-bindings

Lists access bindings for a specific certificate template to see current permissions.

#### Command Usage

Syntax: 

`yc beta certificate-manager template list-access-bindings <RESOURCE-ID>`
