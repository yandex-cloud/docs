...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/certificate-manager/cli-ref-beta/template/set-access-bindings.md
---

# yc beta certificate-manager template set-access-bindings
...
`yc beta certificate-manager template set-access-bindings <RESOURCE-ID>`
