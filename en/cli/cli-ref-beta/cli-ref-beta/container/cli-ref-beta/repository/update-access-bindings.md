...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/container/cli-ref-beta/repository/update-access-bindings.md
---

# yc beta container repository update-access-bindings
...
`yc beta container repository update-access-bindings <RESOURCE-ID>`
