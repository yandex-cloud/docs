...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/container/cli-ref-beta/lifecycle-policy/create.md
---

# yc beta container lifecycle-policy create
...
`yc beta container lifecycle-policy create <REPOSITORY-ID>`
