...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-postgresql/cli-ref-beta/database/get.md
---

# yc beta managed-postgresql database get
...
`yc beta managed-postgresql database get <CLUSTER-ID>`
