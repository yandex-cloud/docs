...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-postgresql/cli-ref-beta/user/list.md
---

# yc beta managed-postgresql user list
...
`yc beta managed-postgresql user list <CLUSTER-ID>`

#### Flags

| Flag | Description |
|----|----|
|`--cluster-id`|<b>`string`</b><br/>ID of the cluster to list PostgreSQL users in. To get the cluster ID, use a [ClusterService.List] request.|
