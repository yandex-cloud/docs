...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-postgresql/cli-ref-beta/cluster/list-operations.md
---

# yc beta managed-postgresql cluster list-operations
...
`yc beta managed-postgresql cluster list-operations <CLUSTER-ID>`

#### Flags

| Flag | Description |
|----|----|
|`--cluster-id`|<b>`string`</b><br/>ID of the PostgreSQL Cluster resource to list operations for.|
