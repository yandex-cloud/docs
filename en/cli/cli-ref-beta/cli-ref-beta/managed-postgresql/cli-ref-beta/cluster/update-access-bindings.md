...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-postgresql/cli-ref-beta/cluster/update-access-bindings.md
---

# yc beta managed-postgresql cluster update-access-bindings
...
`yc beta managed-postgresql cluster update-access-bindings <RESOURCE-ID>`
