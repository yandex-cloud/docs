...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/managed-postgresql/cli-ref-beta/cluster/list-access-bindings.md
---

# yc beta managed-postgresql cluster list-access-bindings
...
`yc beta managed-postgresql cluster list-access-bindings <RESOURCE-ID>`
