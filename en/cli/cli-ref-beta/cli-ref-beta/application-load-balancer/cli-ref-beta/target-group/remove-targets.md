...
|`--target-group-id`|<b>`string`</b><br/>ID of the target group to remove targets from.<br/><br/>To get the target group ID, make a [TargetGroupService.List] request.|
|`--targets`|<b>`shorthand/json`</b><br/>List of targets to remove from the target group.<br/><br/>Example:|
