...
|`--folder-id`|<b>`string`</b><br/>ID of the folder to create a target group in.<br/><br/>To get the folder ID, make a [yandex.cloud.resourcemanager.v1.FolderService.List] request.|
|`--labels`|<b>`stringToString`</b><br/>Target group labels as 'key:value' pairs.<br/>For details about the concept, see [documentation](/docs/overview/concepts/services#labels).|
|`--name`|<b>`string`</b><br/>Name of the target group.<br/>The name must be unique within the folder.|
|`--targets`|<b>`shorthand/json`</b><br/>List of targets in the target group.<br/><br/>Example:|
