...
# yc beta application-load-balancer virtual-host create
...
`yc beta application-load-balancer virtual-host create <HTTP-ROUTER-ID>`
...
ID of the HTTP router to create a virtual host in. To get the HTTP router ID, make a [HttpRouterService.List] request. ||
