...
Deletes a TrunkConnection resource.  Method starts an asynchronous operation that can be cancelled while it is in progress.

#### Command Usage

Syntax: 

`yc beta cic trunk-connection delete <TRUNK-CONNECTION-ID>`
