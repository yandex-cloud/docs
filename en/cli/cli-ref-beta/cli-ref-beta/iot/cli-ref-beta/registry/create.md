...
|`--certificates`|<b>`shorthand/json`</b><br/>Registry certificates.<br/>Shorthand Syntax:<br/>[<br/>{<br/>certificate-data = str<br/>}, ...<br/>]<br/>JSON Syntax:<br/>"[<br/>{<br/>"certificate-data": "str"<br/>}, ...<br/>]"<br/>Fields:<br/>certificate-data -> (string)<br/>Public part of the registry certificate.|
|`--description`|<b>`string`</b><br/>Description of the registry.|
|`--folder-id`|<b>`string`</b><br/>ID of the folder to create a registry in. To get a folder ID, make a [yandex.cloud.resourcemanager.v1.FolderService.List] request.|
...
|`--password`|<b>`string`</b><br/>Registry passwords. The password must contain at least three character categories among the following: upper case latin, lower case latin, numbers and special symbols.|
