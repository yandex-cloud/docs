...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/resource-manager/cli-ref-beta/folder/update-access-bindings.md
---

# yc beta resource-manager folder update-access-bindings
...
`yc beta resource-manager folder update-access-bindings <RESOURCE-ID>`
