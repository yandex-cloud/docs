...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/resource-manager/cli-ref-beta/cloud/list-access-bindings.md
---

# yc beta resource-manager cloud list-access-bindings
...
`yc beta resource-manager cloud list-access-bindings <RESOURCE-ID>`
