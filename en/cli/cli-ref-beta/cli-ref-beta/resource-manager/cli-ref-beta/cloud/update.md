...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/resource-manager/cli-ref-beta/cloud/update.md
---

# yc beta resource-manager cloud update
...
`yc beta resource-manager cloud update <CLOUD-ID>`
