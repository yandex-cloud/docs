...
editable: false
noIndex: true
sourcePath: en/_cli-ref-beta/cli-ref-beta/resource-manager/cli-ref-beta/cloud/set-access-bindings.md
---

# yc beta resource-manager cloud set-access-bindings
...
`yc beta resource-manager cloud set-access-bindings <RESOURCE-ID>`
