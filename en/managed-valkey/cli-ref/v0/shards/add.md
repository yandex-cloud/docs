---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/managed-redis/cli-ref/v0/shards/add
editable: false
---

# yc managed-redis v0 shards add
...
Configurations for redis hosts that should be added to the shard.
