---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/managed-redis/cli-ref/v0/cluster/remove-access-binding
editable: false
---

# yc managed-redis v0 cluster remove-access-binding

Remove access binding for the specified Redis cluster

#### Command Usage

Syntax:

`yc managed-redis cluster remove-access-binding <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
