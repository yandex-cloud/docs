...
To get the list of available Redis clusters, make a [List](/docs/managed-redis/api-ref/Cluster/list#List) request.
...
## Response {#yandex.cloud.mdb.redis.v1.Cluster}
