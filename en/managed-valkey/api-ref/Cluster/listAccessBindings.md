...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-redis/v1/clusters/{resourceId}:listAccessBindings
    method: get
    path:
      type: object
      properties:
    ...
    body: null
    definitions: null
sourcePath: en/_api-ref/mdb/redis/v1/api-ref/Cluster/listAccessBindings.md
---

# Managed Service for Redis API, REST: Cluster.ListAccessBindings
...
```
GET https://{{ api-host-mdb }}/managed-redis/v1/clusters/{resourceId}:listAccessBindings
```
