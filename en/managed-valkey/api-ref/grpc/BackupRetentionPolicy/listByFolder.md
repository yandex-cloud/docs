...
# Managed Service for Redis API, gRPC: BackupRetentionPolicyService.ListByFolder

List all retention policies for all clusters in a folder.

## gRPC request

**rpc ListByFolder ([ListBackupRetentionPoliciesByFolderRequest](#yandex.cloud.mdb.redis.v1.ListBackupRetentionPoliciesByFolderRequest)) returns ([ListBackupRetentionPoliciesResponse](#yandex.cloud.mdb.redis.v1.ListBackupRetentionPoliciesResponse))**

## ListBackupRetentionPoliciesByFolderRequest {#yandex.cloud.mdb.redis.v1.ListBackupRetentionPoliciesByFolderRequest}
...
is larger than [ListBackupRetentionPoliciesRequest.page_size](/docs/managed-redis/api-ref/grpc/BackupRetentionPolicy/list#yandex.cloud.mdb.redis.v1.ListBackupRetentionPoliciesRequest), use the `next_page_token` as the value
for the [ListBackupRetentionPoliciesRequest.page_token](/docs/managed-redis/api-ref/grpc/BackupRetentionPolicy/list#yandex.cloud.mdb.redis.v1.ListBackupRetentionPoliciesRequest) query parameter in the next list request.
