...
# Managed Service for Redis API, gRPC: BackupRetentionPolicyService.Get

Get a retention policy by ID.

## gRPC request

**rpc Get ([GetBackupRetentionPolicyRequest](#yandex.cloud.mdb.redis.v1.GetBackupRetentionPolicyRequest)) returns ([yandex.cloud.mdb.v1.BackupRetentionPolicy](#yandex.cloud.mdb.v1.BackupRetentionPolicy))**

## GetBackupRetentionPolicyRequest {#yandex.cloud.mdb.redis.v1.GetBackupRetentionPolicyRequest}
