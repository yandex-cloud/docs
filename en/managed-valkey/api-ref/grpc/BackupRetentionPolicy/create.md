...
# Managed Service for Redis API, gRPC: BackupRetentionPolicyService.Create

Add a new retention policy.

## gRPC request

**rpc Create ([CreateBackupRetentionPolicyRequest](#yandex.cloud.mdb.redis.v1.CreateBackupRetentionPolicyRequest)) returns ([CreateBackupRetentionPolicyResponse](#yandex.cloud.mdb.redis.v1.CreateBackupRetentionPolicyResponse))**

## CreateBackupRetentionPolicyRequest {#yandex.cloud.mdb.redis.v1.CreateBackupRetentionPolicyRequest}
...
## CreateBackupRetentionPolicyResponse {#yandex.cloud.mdb.redis.v1.CreateBackupRetentionPolicyResponse}
