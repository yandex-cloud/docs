...
- Management console {#console}
  ...
  1. In the [management console]({{ link-console-main }}), click ![image](../../_assets/console-icons/layout-side-content-left.svg) or ![image](../../_assets/console-icons/chevron-down.svg) in the top panel and select the folder containing the VM.
  1. [Navigate]({{ link-console-main }}/link/resource-manager) to **{{ ui-key.yacloud.iam.folder.dashboard.label_compute }}**.
