...
folders.<br>createdAt | **string** (date-time)<br><p>Creation timestamp in <a href="https://www.ietf.org/rfc/rfc3339.txt">RFC3339</a> text format.</p> 
...
folders.<br>labels | **object**<br><p>Resource labels as <code>key:value</code> pairs. Мaximum of 64 per resource.</p> 
folders.<br>status | **string**<br><p>Status of the folder.</p> <p>Status of the folder.</p> <ul> <li>STATUS_UNSPECIFIED: Unspecified.</li> <li>ACTIVE: The folder is active.</li> <li>DELETING: The folder is being deleted.</li> </ul> 
