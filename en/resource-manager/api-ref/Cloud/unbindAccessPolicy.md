...
editable: false
apiPlayground:
  - url: https://resource-manager.{{ api-host }}/resource-manager/v1/clouds/{resourceId}:unbindAccessPolicy
    method: post
    path:
      type: object
      properties:
    ...
    body:
      ...
      additionalProperties: false
    definitions: null
sourcePath: en/_api-ref/resourcemanager/v1/api-ref/Cloud/unbindAccessPolicy.md
---
...
```
POST https://resource-manager.{{ api-host }}/resource-manager/v1/clouds/{resourceId}:unbindAccessPolicy
```
