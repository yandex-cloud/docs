...
editable: false
apiPlayground:
  - url: https://resource-manager.{{ api-host }}/resource-manager/v1/clouds/{resourceId}:updateAccessPolicyBindingParameters
    method: patch
    path:
      type: object
      properties:
...
```
PATCH https://resource-manager.{{ api-host }}/resource-manager/v1/clouds/{resourceId}:updateAccessPolicyBindingParameters
```
