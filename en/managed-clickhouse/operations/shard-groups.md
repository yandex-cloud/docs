...
- CLI
  ...
  $ {{ yc-mdb-ch }} shard-groups create
       --cluster-name=<cluster name>
       --name=<name of shard group>
       --description=<description of shard group>
       --shards=<names of shards that you want to include in the group>
  ```
...
{% list tabs %}
  ...
  - Management console
    1. Go to the folder page and select **{{ mch-name }}**.
    1. Click on the name of the cluster and open the **Shard groups** tab.
    1. Click ![image](../../_assets/dots.svg) for the required shard group and select **Edit**.
...
- CLI
  ...
  $ {{ yc-mdb-ch }} shard-groups update
       ...
       --shards=<new list of names of shards you want to include in the group>
  ```
...
{% list tabs %}
  ...
  - Management console
    1. Go to the folder page and select **{{ mch-name }}**.
    1. Click on the name of the cluster and open the **Shard groups** tab.
    1. Click ![image](../../_assets/dots.svg) for the required shard group and select **Delete**.
...
- API
  ...
  To delete a shard group in a cluster, use the [deleteShardGroup](../api-ref/Cluster/deleteShardGroup.md) API method and pass the following in the request:
