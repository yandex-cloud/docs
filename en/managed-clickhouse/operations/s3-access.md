...
- Process data that is stored in object storage if this data is represented in any of the [supported {{ CH }} formats]{% if region =="int" %}(https://clickhouse.tech/docs/en/interfaces/formats/){% else %}(https://clickhouse.tech/docs/ru/interfaces/formats/){% endif %}.
