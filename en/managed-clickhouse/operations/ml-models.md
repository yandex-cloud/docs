...
1. Upload the trained model file to {{ objstorage-name }}.

1. Set up public read access to the model file.

1. Get a public link to the model.
...
1. Upload the file with the current model to {{ objstorage-name }}.
1. Get a public link to this file.
1. Change the parameters of the model connected to {{ mch-name }} by passing a new link to the model file.
...
After disabling a model, the corresponding object is kept in the {{ objstorage-name }} bucket. If you no longer need this model object, you can delete it.
