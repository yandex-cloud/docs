...
You can connect to a cluster both with encryption, via ports `9440` for [clickhouse-client]{% if lang == "ru" %}(https://{{ ch-domain }}/docs/ru/interfaces/cli/){% endif %}{% if lang == "en" %}(https://{{ ch-domain }}/docs/en/interfaces/cli/){% endif %} and `8443` for the [HTTP interface]{% if lang == "ru" %}(https://{{ ch-domain }}/docs/ru/interfaces/http/){% endif %}{% if lang == "en" %}(https://{{ ch-domain }}/docs/en/interfaces/http/){% endif %}, and without encryption, via ports `9000` and `8123`, respectively.
