...
To learn more about operating distributed tables, see the [documentation for {{ CH }}](https://{{ ch-domain }}/docs/en/engines/table-engines/special/distributed/).
