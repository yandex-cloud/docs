...
The name of each host in the cluster [!KEYREF mch-short-name] is generated when it is being created. This name will be the host's fully qualified domain name (FQDN).
