...
For more information about {{ CK }}, see [документации {{ CH }}]({% if lang == "ru" %}https://clickhouse.com/docs/ru/operations/clickhouse-keeper/{% endif %}{% if lang == "en" %}https://clickhouse.com/docs/en/operations/clickhouse-keeper/{% endif %}).
