...
- If you use non-replicated network storage (`ssd-network-nonreplicated`), the minimum number of hosts is 3.
- With fast local storage (`local-ssd`), at least 2 hosts are required.
