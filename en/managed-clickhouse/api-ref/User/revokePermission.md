...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-clickhouse/v1/clusters/{clusterId}/users/{userName}:revokePermission
    method: post
    path:
      type: object
      properties:
...
## Body parameters {#yandex.cloud.mdb.clickhouse.v1.RevokeUserPermissionRequest}
