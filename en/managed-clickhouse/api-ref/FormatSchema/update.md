---
editable: false
sourcePath: en/_api-ref/mdb/clickhouse/api-ref/FormatSchema/update.md
---
...
```
PATCH https://mdb.{{ api-host }}/managed-clickhouse/v1/clusters/{clusterId}/formatSchemas/{formatSchemaName}
```
