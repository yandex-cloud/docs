---
editable: false
sourcePath: en/_api-ref-grpc/managed-clickhouse/api-ref/grpc/backup_service.md
---
...
| [Delete](#Delete) | Deletes the specified ClickHouse Backup. |
...
Field | Description
--- | ---
backup_id | **string**<br>Required. ID of the ClickHouse backup that is currently being deleted. 
cluster_id | **string**<br>ID of the ClickHouse backup that is being deleted. 
