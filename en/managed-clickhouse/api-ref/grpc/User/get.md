---
editable: false
sourcePath: en/_api-ref-grpc/mdb/clickhouse/v1/api-ref/grpc/User/get.md
---

# Managed Service for ClickHouse API, gRPC: UserService.Get {#Get}

Returns the specified ClickHouse User resource.

To get the list of available ClickHouse User resources, make a [List](/docs/managed-clickhouse/api-ref/grpc/User/list#List) request.
