---
editable: false
sourcePath: en/_api-ref-grpc/mdb/clickhouse/v1/api-ref/grpc/Cluster/updateExternalDictionary.md
---

# Managed Service for ClickHouse API, gRPC: ClusterService.UpdateExternalDictionary {#UpdateExternalDictionary}
