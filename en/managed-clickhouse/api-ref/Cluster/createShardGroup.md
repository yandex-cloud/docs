...
Field | Description
--- | ---
shardGroupName | **string**<br><p>Required. Name for the new shard group.</p> <p>The maximum string length in characters is 63. Value must match the regular expression <code>[a-zA-Z0-9_-]*</code>.</p> 
