---
editable: false
sourcePath: en/_api-ref/mdb/clickhouse/api-ref/Cluster/rescheduleMaintenance.md
---
...
--- | ---
clusterId | Required. ID of the ClickHouse cluster to reschedule the maintenance operation for.  The maximum string length in characters is 50.
