...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-clickhouse/v1/clusters/{clusterId}:rescheduleMaintenance
    method: post
    path:
      type: object
      properties:
        clusterId:
          description: |-
            **string**
            Required field. ID of the ClickHouse cluster to reschedule the maintenance operation for.
          type: string
      required:
        - clusterId
    ...
    body:
      ...
      additionalProperties: false
    definitions: null
sourcePath: en/_api-ref/mdb/clickhouse/v1/api-ref/Cluster/rescheduleMaintenance.md
---
...
```
POST https://{{ api-host-mdb }}/managed-clickhouse/v1/clusters/{clusterId}:rescheduleMaintenance
```
...
## Body parameters {#yandex.cloud.mdb.clickhouse.v1.RescheduleMaintenanceRequest}
...
|| metadata | **[RescheduleMaintenanceMetadata](#yandex.cloud.mdb.clickhouse.v1.RescheduleMaintenanceMetadata)**
...
## RescheduleMaintenanceMetadata {#yandex.cloud.mdb.clickhouse.v1.RescheduleMaintenanceMetadata}
