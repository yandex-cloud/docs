...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-clickhouse/v1/clusters/{resourceId}:setAccessBindings
    method: post
    path:
      type: object
      properties:
    ...
    definitions:
      ...
      AccessBinding:
        ...
        required:
          - roleId
          - subject
sourcePath: en/_api-ref/mdb/clickhouse/v1/api-ref/Cluster/setAccessBindings.md
---

# Managed Service for ClickHouse API, REST: Cluster.SetAccessBindings
