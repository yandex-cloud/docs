...
# Managed Service for ClickHouse API, REST: Cluster.CreateExternalDictionary {#CreateExternalDictionary}
...
## Body parameters {#yandex.cloud.mdb.clickhouse.v1.CreateClusterExternalDictionaryRequest}
