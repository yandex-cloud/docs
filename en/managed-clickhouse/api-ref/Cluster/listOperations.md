    ...
    query:
      ...
      properties:
        pageSize:
          description: |-
            **string** (int64)
            ...
            results is larger than `pageSize`, the service returns a [ListClusterOperationsResponse.nextPageToken](/docs/managed-clickhouse/api-ref/Cluster/listOperations#yandex.cloud.mdb.clickhouse.v1.ListClusterOperationsResponse)
        ...
        pageToken:
          description: |-
            **string**
            Page token.  To get the next page of results, set `pageToken` to the [ListClusterOperationsResponse.nextPageToken](/docs/managed-clickhouse/api-ref/Cluster/listOperations#yandex.cloud.mdb.clickhouse.v1.ListClusterOperationsResponse)
