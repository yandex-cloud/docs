...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-clickhouse/v1/clusters/{resourceId}:updateAccessBindings
    method: patch
    path:
      type: object
      properties:
...
# Managed Service for ClickHouse API, REST: Cluster.UpdateAccessBindings
...
```
PATCH https://{{ api-host-mdb }}/managed-clickhouse/v1/clusters/{resourceId}:updateAccessBindings
```
