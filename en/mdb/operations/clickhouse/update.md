...
To view or change cluster settings, go to the folder page and click on the tile **Managed Service for ClickHouse**. Then click on the name of the cluster you need.
You can:
