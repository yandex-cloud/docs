...
--- | ---
clusterId | Required. ID of the ClickHouse cluster the user belongs to. To get the cluster ID, use a [list](/docs/mdb/api-ref/clickhouse/Cluster/list) request.
userName | Required. Name of the user to delete. To get the name of the user, use a [list](/docs/mdb/api-ref/clickhouse/User/list) request.
