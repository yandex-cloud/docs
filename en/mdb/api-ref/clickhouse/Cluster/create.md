...
databaseSpecs.<br>name | **string**<br><p>Required. Name of the ClickHouse database. 1-63 characters long.</p> <p>The string length in characters must be 1-63. Value must match the regular expression <code>[a-zA-Z0-9_]+</code>.</p> 
...
userSpecs.<br>name | **string**<br><p>Required. Name of the ClickHouse user.</p> <p>The string length in characters must be 1-63. Value must match the regular expression <code>[a-zA-Z0-9_]+</code>.</p> 
