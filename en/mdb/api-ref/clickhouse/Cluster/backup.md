...
--- | ---
clusterId | Required. ID of the ClickHouse cluster to back up. To get the ClickHouse cluster ID use a [list](/docs/mdb/api-ref/clickhouse/Cluster/list) request.  The maximum string length in characters is 50.
