...
--- | ---
clusterId | Required. ID of the ClickHouse cluster to add hosts to. To get the ClickHouse cluster ID, use a [list](/docs/mdb/api-ref/clickhouse/Cluster/list) request.  The maximum string length in characters is 50.
...
Field | Description
--- | ---
hostSpecs | **object**<br><p>Required. Configurations for ClickHouse hosts that should be added to the cluster.</p> <p>Must contain at least one element.</p> 
