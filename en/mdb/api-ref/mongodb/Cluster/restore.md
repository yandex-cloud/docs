...
Field | Description
--- | ---
backupId | **string**<br><p>Required. ID of the backup to create a cluster from. To get the backup ID, use a <a href="/docs/mdb/api-ref/mongodb/Cluster/listBackups">listBackups</a> request.</p> 
...
description | **string**<br><p>Description of the new MongoDB cluster. 0-256 characters long.</p> <p>The maximum string length in characters is 256.</p> 
...
networkId | **string**<br><p>Required. Required. ID of the network to create the MongoDB cluster in.</p> <p>The maximum string length in characters is 50.</p> 
