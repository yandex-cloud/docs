...
--- | ---
clusterId | Required. Required. ID of the MongoDB cluster to remove hosts from. To get the MongoDB cluster ID, use a [list](/docs/mdb/api-ref/mongodb/Cluster/list) request.  The maximum string length in characters is 50.
