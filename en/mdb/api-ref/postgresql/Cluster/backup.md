...
--- | ---
clusterId | Required. ID of the PostgreSQL cluster to back up. To get the PostgreSQL cluster ID, use a [list](/docs/mdb/api-ref/postgresql/Cluster/list) request.  The maximum string length in characters is 50.
