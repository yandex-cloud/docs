...
A function is run in the [runtime environment](runtime/index.md) that corresponds to its programming language. At the Preview stage, runtime environments are available for Node.js and Python.
