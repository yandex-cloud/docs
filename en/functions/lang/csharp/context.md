...
_Invocation context_ is an object that is optionally accepted by the [request handler](handler.md) if the [YcFunction interface model](model/yc-function.md) is used. It is a `Yandex.Cloud.Functions.Context` type object providing properties you can use to get more information about the C# function version:
