---
editable: false
sourcePath: en/_api-ref-grpc/serverless/functions/v1/functions/api-ref/grpc/Function/getFunctionVersionByTag.md
---

# Cloud Functions Service, gRPC: FunctionService.GetFunctionVersionByTag {#GetFunctionVersionByTag}

Deprecated. Use [GetVersionByTag](/docs/functions/functions/api-ref/grpc/Function/getVersionByTag#GetVersionByTag).

## gRPC request

**rpc GetFunctionVersionByTag ([GetFunctionVersionByTagRequest](#yandex.cloud.serverless.functions.v1.GetFunctionVersionByTagRequest)) returns ([Version](#yandex.cloud.serverless.functions.v1.Version))**
