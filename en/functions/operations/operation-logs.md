...
The system logs all actions with {{ sf-name }} resources as a list of operations. Each operation gets its own unique ID.
...
- CLI {#cli}
  ...
  To get the list of operations for the {{ sf-name }} resource, run this command:
