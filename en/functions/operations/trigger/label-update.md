...
- CLI {#cli}
    ...
    To update a trigger label, run this command:
...
- {{ TF }} {#tf}
  ...
  To update a trigger label:

  1. Open the {{ TF }} configuration file and edit the `labels` section in the trigger description:
