---
title: Connecting to a {{ ydb-full-name }} database from a Node.js function in {{ sf-name }}
...
# Connecting to a {{ ydb-full-name }} database from a Node.js function in {{ sf-name }}
