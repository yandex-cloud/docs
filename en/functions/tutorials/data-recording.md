...
In this tutorial, you will write data from a device into a database. In our example, we will use a [{{ mpg-full-name }} cluster](../../managed-postgresql/concepts/index.md). To connect your device to [{{ iot-full-name }}](../../iot-core/index.yaml), you will need an MQTT broker. All the following steps are performed in the [management console]({{ link-console-main }}).
