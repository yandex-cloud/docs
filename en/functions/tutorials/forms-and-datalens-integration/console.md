...
description: Setting up integration between {{ forms-name }} and {{ datalens-name }} via the management console using {{ sf-name }} and {{ yq-name }} for automated data processing.
