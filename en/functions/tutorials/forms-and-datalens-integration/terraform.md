---
noIndex: true
title: Delivering data from {{ forms-full-name }} to {{ datalens-full-name }} using {{ sf-full-name }} and {{ yq-full-name }} via {{ TF }}
description: Setting up integration between {{ forms-name }} and {{ datalens-name }} via {{ TF }} using {{ sf-name }} and {{ yq-name }} for automated data processing.
