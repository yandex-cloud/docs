---
title: Delivering data from {{ forms-full-name }} to {{ datalens-full-name }} using {{ sf-full-name }} and {{ yq-full-name }}
description: In this tutorial, you will learn how to easily display aggregate data from {{ forms-full-name }}.
canonical: '{{ link-docs }}/tutorials/serverless/forms-and-datalens-integration/'
---

# Delivering data from {{ forms-full-name }} to {{ datalens-full-name }} using {{ sf-full-name }} and {{ yq-full-name }}
