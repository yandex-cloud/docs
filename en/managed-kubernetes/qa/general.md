...
We recommend using the latest official version of [kubectl](https://kubernetes.io/docs/tasks/tools/#kubectl).
...
{{ yandex-cloud }} services, images and master configuration initially undergo [various security tests and checks for standard compliance](https://cloud.yandex.com/en/security).
