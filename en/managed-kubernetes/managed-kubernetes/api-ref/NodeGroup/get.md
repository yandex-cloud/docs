...
To get the list of available node group, make a [list](/docs/managed-kubernetes/managed-kubernetes/api-ref/NodeGroup/list) request.
...
--- | ---
nodeGroupId | <p>Required. ID of the node group to return. To get the node group ID use a <a href="/docs/managed-kubernetes/managed-kubernetes/api-ref/NodeGroup/list">list</a> request.</p> 
