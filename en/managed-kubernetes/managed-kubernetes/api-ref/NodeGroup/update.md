...
--- | ---
nodeGroupId | <p>Required. ID of the node group to update. To get the node group ID use a <a href="/docs/managed-kubernetes/managed-kubernetes/api-ref/NodeGroup/list">list</a> request.</p> 
