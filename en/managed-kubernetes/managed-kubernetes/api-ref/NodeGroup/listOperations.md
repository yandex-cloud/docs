...
pageToken | <p>Page token. To get the next page of results, set ``page_token`` to the <a href="/docs/managed-kubernetes/managed-kubernetes/api-ref/NodeGroup/listOperations#responses">nextPageToken</a> returned by a previous list request.</p> <p>The maximum string length in characters is 100.</p> 
filter | <p>A filter expression that filters resources listed in the response. Currently you can use filtering only on <a href="/docs/managed-kubernetes/managed-kubernetes/api-ref/NodeGroup#representation">NodeGroup.name</a> field.</p> <p>The maximum string length in characters is 1000.</p> 
