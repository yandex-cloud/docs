...
1. [Create](../../../compute/operations/reserved-pools/create-reserved-pool.md) reserved instance pools in three availability zones, using a configuration you want to use for {{ managed-k8s-name }} cluster nodes.
