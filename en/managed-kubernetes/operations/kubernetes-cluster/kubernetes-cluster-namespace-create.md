...
Creating a [namespace](../../concepts/index.md#namespace) in a {{ k8s }} cluster using the management console is in the [Preview](../../../overview/concepts/launch-stages.md) stage.
