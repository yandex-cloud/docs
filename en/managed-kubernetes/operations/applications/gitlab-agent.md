...
{{ GL }} Agent does not execute {% if lang == "ru" %}[CI/CD](/blog/posts/2022/10/ci-cd){% else %}CI/CD{% endif %} pipelines. To do this, install [{{ GL }} Runner](/marketplace/products/yc/gitlab-runner).
