...
1. [Install kubectl](https://kubernetes.io/docs/tasks/tools/install-kubectl) and [configure](../kubernetes-cluster/kubernetes-cluster-get-credetials.md) it to work with your [{{ k8s }} cluster](../../concepts/index.md#kubernetes-cluster).
...
1. [Install kubectl](https://kubernetes.io/docs/tasks/tools/install-kubectl) and [configure](../kubernetes-cluster/kubernetes-cluster-get-credetials.md) it to work with your {{ k8s }} cluster.
