---
title: Installing Fluent Bit with the plugin for {{ cloud-logging-full-name }}
description: Follow this guide to install Fluent Bit with the plugin for {{ cloud-logging-name }}.
---
