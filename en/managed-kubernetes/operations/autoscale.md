...
1. Install the [{{ k8s }} CLI (kubectl)]{% if lang == "ru" %}(https://kubernetes.io/ru/docs/tasks/tools/install-kubectl/){% endif %}{% if lang == "en" %}(https://kubernetes.io/docs/tasks/tools/install-kubectl/){% endif %}. And [сonfigure](kubernetes-cluster/kubernetes-cluster-get-credetials.md) it to work with your cluster.
