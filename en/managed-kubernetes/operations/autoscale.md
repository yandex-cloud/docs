...
1. Install the [{{ k8s }} CLI (kubectl)](https://kubernetes.io/docs/tasks/tools/install-kubectl/). And [сonfigure](kubernetes-cluster/kubernetes-cluster-get-credetials.md) it to work with your cluster.
