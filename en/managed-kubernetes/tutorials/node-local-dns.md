...
1. Create a {{ k8s }} cluster and a group of nodes.
   ...
   You can use an existing {{ k8s }} cluster or node group or create new ones. {% if product == "cloud-il" %}Make sure that the **{{ k8s }} version** field is set to version 1.18 or higher.{% endif %}
