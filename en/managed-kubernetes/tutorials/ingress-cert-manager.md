...
To use [{{ k8s }}]{% if lang == "ru" %}(https://kubernetes.io/ru/){% endif %}{% if lang == "en" %}(https://kubernetes.io){% endif %} to create an [NGINX Ingress controller](https://kubernetes.github.io/ingress-nginx/) and protect it with a [Let's Encrypt®]{% if lang == "ru" %}(https://letsencrypt.org/ru/){% endif %}{% if lang == "en" %}(https://letsencrypt.org/){% endif %} certificate, follow these steps:
...
1. [Install the {{ k8s }} Helm package manager]{% if lang == "ru" %}(https://helm.sh/ru/docs/intro/install){% endif %}{% if lang == "en" %}(https://helm.sh/docs/intro/install){% endif %}.
