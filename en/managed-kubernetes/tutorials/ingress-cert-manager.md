...
To create [NGINX Ingress Controller](https://kubernetes.github.io/ingress-nginx/) using [{{ k8s }}](https://kubernetes.io) and protect it with a [Let's Encrypt®](https://letsencrypt.org/) certificate, follow these steps.
