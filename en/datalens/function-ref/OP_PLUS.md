...
**Argument types:**
- `value_1` — `Date | Datetime | Fractional number | Integer | Markup | String`
- `value_2` — `Date | Datetime | Fractional number | Integer | Markup | String`
...
`Materialized Dataset`, `ClickHouse 19.13`, `Yandex.Metrica`, `Microsoft SQL Server 2017 (14.0)`, `MySQL 5.6`, `Oracle Database 12c (12.1)`, `PostgreSQL 9.3`.
