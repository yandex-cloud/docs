...
Moves the specified workbook to a new collection.
...
```text translate=no
https://api.datalens.tech/rpc/moveWorkbook
```
...
ID of the collection to move the workbook to.
