...
_collectionIds_{.json-schema-reset .json-schema-property .json-schema-required}
{.table-cell}|
**Type**: string[]

IDs of the collections to move.
...
ID of the parent collection to move the collections to.
