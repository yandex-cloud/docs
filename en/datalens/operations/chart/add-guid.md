...
1. Paste the ID into the chart URL as a request parameter. The resulting link should look like `https://datalens.yandex.ru/wizard/yfn1k6yxud7yr-example-chart?17ecb9a1-c8a5-4811-b53e-c8229f88fcba=<value>`, where:
