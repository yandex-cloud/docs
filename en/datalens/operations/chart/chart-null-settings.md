...
1. Add a row with this date and `null` for the value to the source.
1. In the chart section settings for the relevant measure, select **Display as 0** for the **Null values** option.
