...
1. Click the **Tabs** field or the ![image](../../../_assets/console-icons/sliders-vertical.svg) icon to its right.


1. In the window that opens, to the right of the tab name, click ![image](../../../_assets/console-icons/ellipsis.svg) → **Widget order**.
