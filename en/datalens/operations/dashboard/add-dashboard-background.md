---
title: How to set up a dashboard background in {{ datalens-full-name }}
description: Follow this guide to set up a dashboard background in {{ datalens-full-name }}.
---
...
1. Set a background for the dashboard. Do it by clicking the **Widget background** input field and selecting one of the presets or specifying the color in hexadecimal format.
