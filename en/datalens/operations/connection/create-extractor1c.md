...
# Creating a 1C Extractor connection

Before creating a connection, [install and configure](https://docs.denvic.tech/extractor_docs/extractor_docs/ustanovka-2/ustanovka-installyatorom) the Extractor extension in your 1C version.

To create a connection to [1C Extractor](https://bi.denvic.ru/):
