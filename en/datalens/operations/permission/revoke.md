...
Only a user with the `Administration` access can delete permissions for an object or folder: either by revoking a permission directly or by denying a request.

## Revoking permissions directly {#revoke}

To revoke folder or object permissions:

1. On the [navigation page]({{ link-datalens-main }}/navigation), find the folder or object of interest.
...
1. Optionally, write a comment for the user requesting access.
