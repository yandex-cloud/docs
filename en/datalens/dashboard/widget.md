...
Widget that displays an insight by Neuroanalyst. You can specify up to five charts from the current dashboard tab in one insight. Using Neuroanalyst, you can discover relationships in data that are not visible in individual charts.
...
* ![image](../../_assets/console-icons/copy.svg) **Copy insight**. Copies insight content to the clipboard.
