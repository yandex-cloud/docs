...
1. [Create a connection and standard dashboard](data-from-appmetrica-visualization.md#step1).
1. [Change the standard dashboard](data-from-appmetrica-visualization.md#step2).

## Create a connection and a standard dashboard {#step1}

{% note warning %}

This step is available to users who have an app in AppMetrica. If you don't have any apps, open the standard **AppMetrica dashboard** and go to the [next step](data-from-appmetrica-visualization.md#step2).
...
## Edit the standard dashboard {#step2}
...
You can change the standard [dashboard](../concepts/dashboard.md) however you want. For example, you can delete a chart, change its size, or change the visualization type.
