...
- [Step 1. Define the data source for the dataset](data-from-ch-visualization.md#step1)
- [Step 2. Configure the dataset fields](data-from-ch-visualization.md#step2)
- [Step 3. Create a line chart](data-from-ch-visualization.md#step3)
- [Step 4. Create a bar chart](data-from-ch-visualization.md#step4)
- [Step 5. Create a pivot table chart](data-from-ch-visualization.md#step5)
- [Step 6. Create a heat map chart](data-from-ch-visualization.md#step6)
- [Step 7. Create a dashboard](data-from-ch-visualization.md#step7)
- [Step 8. Add the charts to the dashboard](data-from-ch-visualization.md#step8)
- [Step 9. Add selectors to the dashboard](data-from-ch-visualization.md#step9)
...
To visualize sales dynamics by month, create a [line chart](../concepts/chart.md).
...
To visualize sales by brand and product categories, create a [column chart](../concepts/chart.md).
...
To visualize sales in terms of products and time, create [pivot table](../concepts/chart.md).
...
To visualize the density of orders on the Moscow map, create a [heat map](../concepts/chart.md).
...
Create a [dashboard](../concepts/dashboard.md) to add these charts to.
...
Add [selectors](..concepts/dashboard.md#selector) to filter your charts by date, Moscow districts, products, and customer statuses.
