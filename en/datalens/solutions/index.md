---
title: Сценарии использования Yandex DataLens
description: 'В разделе описаны сценарии использования сервиса Yandex DataLens. Визуализация данных из CSV-файла, создание и публикация диаграммы с картой Москвы из CSV-файла, анализ продаж сети магазинов из БД ClickHouse, анализ открытых данных ДТП на дорогах России'
---
# Yandex DataLens use cases
