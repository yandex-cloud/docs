...
You can view a list of tags available at https://metrika.yandex.ru/list
...
- [Step 1. Create a connection and a standard dashboard](data-from-metrica-logsapi-visualization#step1)
- [Step 2. Edit the standard dashboard](data-from-metrica-logsapi-visualization#step2)
- [Step 3. Edit the chart](data-from-metrica-logsapi-visualization#step3)
...
You can change the standard [dashboard](../concepts/dashboard.md) however you want, such as by deleting a chart.
