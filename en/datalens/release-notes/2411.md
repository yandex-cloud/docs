...
Added the **Use previous** [setting](../concepts/chart/settings.md#section-settings) on the Y axis for the [stacked chart](../visualization-ref/area-chart.md). When enabled, replaces null values with the value of the preceding point on the axis.
...
Now [private objects are embedded](../security/private-embedded-objects.md) through [UI customization](../settings/appearance.md#ui-customization) of the {{ datalens-short-name }} instance they were created in.

### Configuring exporting data for private embedding {#private-embed-data-export}

Added the **Allow data export** setting for [private embedding](../security/private-embedded-objects.md#how-to-private-embed), which enables export of chart data in these formats: XSLX, CSV, and Markown.
