...
* In the dialog box for [configuring access permissions to workbooks and collections](../workbooks-collections/workbooks-operations.md#security), fixed scrolling display and added display of the full user name or group name when hovering over a permission subject.
