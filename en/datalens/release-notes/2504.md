...
Hid some [{{ datalens-full-name }} settings](../settings/index.md) for users without the `datalens.admin` [role](../security/roles.md#datalens.admin):

* Changing your [service plan](../settings/service-plan.md).
* [Customization settings](../settings/appearance.md#ui-customization).
* Adding and editing color palettes.
* [Disabling navigation through directories](../settings/navigation.md#disable-folder-navigation).
