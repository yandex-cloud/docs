...
Fixed the error where [table](../visualization-ref/table-chart.md) cells with empty (`null`) values were not color-filled.
...
Fixed the color selection error for `null` values in a [column chart](../visualization-ref/column-chart.md).
