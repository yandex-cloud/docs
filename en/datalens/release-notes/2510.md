...
* New dashboards available in [{{ datalens-gallery }}]({{ link-datalens-main }}/gallery). For more information, see the [{{ datalens-short-name }}](https://t.me/YandexDataLens/28631/140855) Telegram chat.
...
* Fixed the display of totals in the Waterfall chart tooltip ([Gravity UI Charts](../charts/editor/widgets/gravity-ui.md)).
...
{% cut "Examples of custom prompts for the AI" %}
