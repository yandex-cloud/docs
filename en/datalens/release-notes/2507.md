...
description: Check out {{ datalens-full-name }} release notes for July 2025.
---
...
* New dashboards available in [{{ datalens-gallery }}]({{ link-datalens-main }}/gallery). For more information, see the [{{ datalens-short-name }}](https://t.me/YandexDataLens/28631/136577) Telegram chat.
...
* Fixed the table structure change when switching to [pivot table](../visualization-ref/pivot-table-chart.md) format.
