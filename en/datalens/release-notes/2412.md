...
description: Check out the {{ datalens-full-name }} release notes for December 2024.
---
...
* Added the **Stacking** [setting](../concepts/chart/settings.md#common-settings). It enables stacked or isolated data display for each category in the area chart. Available values:
...
* Added contrast mode to the [report settings](../reports/report-operations.md#report-settings). Available values: `Standard` or `High`.
