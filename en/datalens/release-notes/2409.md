...
1. In the window that opens:
   ...
   * (Optional) If you set up an [identity federation]({{ link-docs }}/organization/concepts/add-federation), save the federation to share your link with the federation users.
...
Now {{ datalens-short-name }} support [reports](../reports/index.md), i.e., multi-page documents that you can export to PDF and print. You can add charts, text blocks, headers, and images to the pages of the report.
