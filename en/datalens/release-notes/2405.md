...
You can now specify a link to a dataset when [adding](../operations/dashboard/add-selector.md) a dataset-based selector to a dashboard. Follow these steps:
...
You can now reset a customized UI to {{ datalens-short-name }} system defaults. Follow these steps:
