...
When creating a formula, you can use any dataset field, including the calculated fields that you created earlier. {% if audience == "internal" %}In a formula, you can also use parameters created at the dataset level.{% endif %}
...
When creating a formula, you can use any dataset field, including the calculated fields that you created earlier. {% if audience == "internal" %}In a formula, you can also use the parameters of the chart or dataset based on which the chart is created.{% endif %}
...
- Wizard
   ...
   1. Open the [wizard]{% if product == "yandex-cloud" %}(https://datalens.yandex.ru/wizard/){% endif %}{% if product == "cloud-il" %}(https://datalens.cloudil.co.il/wizard){% endif %}.
