...
{% if audience != "internal" %} You can create the entity objects yourself or use ready-made solutions from the [{{ datalens-short-name }} Marketplace](marketplace.md). {% endif %}
