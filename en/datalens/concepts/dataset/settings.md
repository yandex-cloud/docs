...
Materialization mode is not available for Metrica API and AppMetrica API sources.
...
#### Connecting via the Logs API for Metrica and AppMetrica sources {#metrica-appmetrica-logs-api}
