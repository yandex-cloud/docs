---
title: '{{ datalens-full-name }} error ERR.DS_API.INVALID_GROUP_BY_CONFIGURATION'
description: This page describes the Invalid grouping configuration {{ datalens-full-name }} error.
---
