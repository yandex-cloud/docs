...
If {{ CH }} is your data source, find queries from {{ datalens-short-name }} in [system.query_log](https://clickhouse.tech/docs/en/operations/system-tables/query_log/).

If {{ PG }} MBD is your data source, review the [performance analysis](../../../managed-postgresql/solutions/profiling.md).
