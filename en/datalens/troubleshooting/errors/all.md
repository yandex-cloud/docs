...
description: This page presents {{ datalens-full-name }} error codes and their descriptions.
---

# All {{ datalens-full-name }} errors
...
[ERR.CLIENT.POPUP_BLOCKED](ERR-CLIENT-POPUP_BLOCKED.md) | Pop-up blocking error |
...
[ERR.DS_API.PREVIEW_SOURCE_MODIFICATION_NOT_ALLOWED](ERR-DS_API-PREVIEW_SOURCE_MODIFICATION_NOT_ALLOWED.md) | Data source modification is not allowed |
...
[ERR.DS_API.REFERENCED_ENTRY_NOT_FOUND](ERR-DS_API-REFERENCED_ENTRY_NOT_FOUND.md) | Accessing a non-existent object |
...
[ERR.DS_API.TYPE_CAST.FAILED](ERR-DS_API-TYPE_CAST-FAILED.md) | Data type cast error |
...
[ERR.FILE.INVALID_LINK.YADOCS_INVALID_PUBLIC_LINK_PREFIX](ERR-FILE-INVALID_LINK-YADOCS_INVALID_PUBLIC_LINK_PREFIX.md) | Invalid Yandex Documents link format |
