...
{% if audience == "internal" %}[ERR.DS_API.DB.CHYT.CLIQUE.ACCESS_DENIED](ERR-DS_API-DB-CHYT-CLIQUE-ACCESS_DENIED.md) | Access to clique &lt;clique name> for user &lt;username> was denied |{% endif %}
...
{% if audience == "internal" %}[ERR.DS_API.DB.CHYT.CLIQUE.NOT_RUNNING](ERR-DS_API-DB-CHYT-CLIQUE-NOT_RUNNING.md) | Clique &lt;clique name> is not running |{% endif %}
{% if audience == "internal" %}[ERR.DS_API.DB.CHYT.CLIQUE.SUSPENDED](ERR-DS_API-DB-CHYT-CLIQUE-SUSPENDED.md) | Clique &lt;clique name> is suspended |{% endif %}
