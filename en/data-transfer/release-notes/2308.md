...
1. Extended endpoint connectivity: you can now transfer data from {{ PG }} to {{ MY }} and from {{ MY }} to {{ PG }}. For details, see the [matrix of available transfers](../transfer-matrix.md).
