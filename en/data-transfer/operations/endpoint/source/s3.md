...
{{ data-transfer-full-name }} enables you to migrate data from S3 storage to {{ yandex-cloud }} managed databases and implement various data processing and transformation scenarios. To set up a transfer:
...
Read more about settings [this {{ AB }} guide](https://docs.airbyte.com/integrations/sources/s3).
