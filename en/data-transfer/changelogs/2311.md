# {{ data-transfer-name }} revision history for November 2023
...
1. You can now convert data using a Confluent Schema Registry parser. For more information, see the [{{ KF }}](../operations/endpoint/source/kafka.md) and [{{ DS }}](../operations/endpoint/source/data-streams.md) setting description.
