...
Serializing the type to a human-readable string. This helps at debugging and will also be used in the next examples of this section. [Format documentation](../misc/type_string.md).

## ParseType {#parsetype}

Building a type from a string with description. [Format documentation](../misc/type_string.md).
...
## ListType and StreamType {#listtype-streamtype}
...
## GenericType, UnitType and VoidType {#generictype-unittype-voidtype}
...
## OptionalItemType, ListItemType and StreamItemType {#optionalitemtype-listitemtype-streamitemtype}
...
## DictKeyType and DictPayloadType {#dictkeytype-dictpayloadtype}
...
## CallableResultType and CallableArgumentType {#callableresulttype-callableargumenttype}
