...
The _Error type_ column shows the status that the query ends with if an error occurs. For more information about statuses, see [Error handling in the API](error_handling.md).

<small>Table 1: Schema object limits</small>
...
<small>Table 2: Size limits for stored data</small>
...
<small>Table 3: Limits that apply when executing queries</small>
