...
* [{{ ydb-short-name }} SDK]{% if lang == "ru" %}(https://ydb.tech/en/docs/reference/ydb-sdk/){% endif %}{% if lang == "en" %}(https://ydb.tech/en/docs/reference/ydb-sdk/){% endif %}.
* [{{ ydb-short-name }} CLI]{% if lang == "ru" %}(https://ydb.tech/en/docs/reference/ydb-cli/){% endif %}{% if lang == "en" %}(https://ydb.tech/en/docs/reference/ydb-cli/){% endif %}.
...
- {{ ydb-short-name }} CLI
  ...
  1. {% include [cli-install](../_includes/cli-install.md) %}
  1. To manage your databases from the command line, [install]{% if lang == "en" %}(https://ydb.tech/en/docs/reference/ydb-cli/install){% endif %}{% if lang == "ru" %}(https://ydb.tech/ru/docs/reference/ydb-cli/install){% endif %} the {{ ydb-short-name }} CLI.
...
* Learn more about the [YQL]{% if lang == "ru" %}(https://ydb.tech/ru/docs/yql/reference/){% endif %}{% if lang == "en" %}(https://ydb.tech/en/docs/yql/reference/){% endif %} query language.