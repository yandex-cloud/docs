...
* [AWS CLI]{% if lang == "en" %}(https://aws.amazon.com/cli/){% endif %}{% if lang == "ru" %}(https://aws.amazon.com/ru/cli/){% endif %} is the AWS command line interface.
* [AWS SDK]{% if lang == "en" %}(https://aws.amazon.com/tools/#sdk){% endif %}{% if lang == "ru" %}(https://aws.amazon.com/ru/tools/#sdk){% endif %} includes development tools.
