---
title: '{{ ydb-full-name }} HTTP API methods'
...
[DescribeTimeToLive](actions/describeTimeToLive.md) | Returns the time-to-live (TTL) status for a specific table.
...
[PutItem](actions/putItem.md) | Overwrites table items.
