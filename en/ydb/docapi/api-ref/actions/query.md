...
`ScanIndexForward` | Sets the order of index traversal.<ul><li>`true` (default): In ascending order<li>`false`: In descending order</ul><br/>**Type**: Boolean<br/>**Required**: None
