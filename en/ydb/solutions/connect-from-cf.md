...
1. On the [billing console]({{ link-console-billing }}), make sure you have activated a [billing account](../../billing/concepts/billing-account.md), and it has the `ACTIVE` or `TRIAL_ACTIVE` status. If you don't have a billing account, [create one](../../billing/quickstart/index.md).

1. On the [cloud page](https://console.cloud.yandex.ru/cloud), create or select a folder for your function and database to run in.
...
* A fee for making queries to the database (see [{{ ydb-full-name }} pricing](../pricing/serverless.md)).
