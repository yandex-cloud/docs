...
description: In this tutorial, you will learn how to use the Java Servlet API and serverless technology to create a simple web application for managing a to-do list.
