...
- {{ ydb-short-name }} table
   ...
   1. Set up [secondary indexes]{% if lang == "ru" %}(https://ydb.tech/ru/docs/concepts/secondary_indexes){% endif %}{% if lang == "en" %}(https://ydb.tech/en/docs/concepts/secondary_indexes){% endif %} if needed.
   ...
   1. Set up the [partitioning]{% if lang == "ru" %}(https://ydb.tech/ru/docs/concepts/datamodel){% endif %}{% if lang == "en" %}(https://ydb.tech/en/docs/concepts/datamodel){% endif %} policy.
...
To alter {{ ydb-short-name }} tables, you can also use the [`ALTER TABLE`]{% if lang == "ru" %}(https://ydb.tech/ru/docs/yql/reference/syntax/alter_table){% endif %}{% if lang == "en" %}(https://ydb.tech/en/docs/yql/reference/syntax/alter_table){% endif %} command from the [YQL]{% if lang == "ru" %}(https://ydb.tech/ru/docs/yql/reference/){% endif %}{% if lang == "en" %}(https://ydb.tech/en/docs/yql/reference/){% endif %} query language.
