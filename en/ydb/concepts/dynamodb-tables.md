...
To work with document tables, [use the Document API](../docapi/tools/aws-setup.md). You can only use the [YDB API]((https://ydb.tech/en/docs/reference/ydb-sdk/) in read mode.
