---
editable: false
sourcePath: en/_api-ref-grpc/ydb/v1/api-ref/grpc/Backup/setAccessBindings.md
---

# Managed Service for YDB API, gRPC: BackupService.SetAccessBindings {#SetAccessBindings}
