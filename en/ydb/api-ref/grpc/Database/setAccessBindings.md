---
editable: false
sourcePath: en/_api-ref-grpc/ydb/v1/api-ref/grpc/Database/setAccessBindings.md
---

# Managed Service for YDB API, gRPC: DatabaseService.SetAccessBindings {#SetAccessBindings}
