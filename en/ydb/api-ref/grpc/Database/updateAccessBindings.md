---
editable: false
sourcePath: en/_api-ref-grpc/ydb/v1/api-ref/grpc/Database/updateAccessBindings.md
---

# Managed Service for YDB API, gRPC: DatabaseService.UpdateAccessBindings {#UpdateAccessBindings}
