...
<!---
Create a {{ ydb-short-name }} database in the {{ yandex-cloud }} management console and read the rules for writing YQL queries. You can also run a test app to learn how to work with the {{ ydb-short-name }} SDK for [Python](https://github.com/yandex-cloud/ydb-python-sdk), [Go](https://github.com/yandex-cloud/ydb-go-sdk), or [Java](https://github.com/yandex-cloud/ydb-java-sdk).-->
