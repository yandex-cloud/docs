...
- Node.js
  ...
  1. Create the `SeriesItemOps03.js` file, for example, using the nano editor:
      ...
      The `ReturnValues` parameter prescribes to {{ ydb-short-name }} to return only updated `UPDATED_NEW` attributes.
...
- Ruby
  ...
  1. Create the `SeriesItemOps03.rb` file, for example, using the nano editor:
      ...
      The `return_values` parameter prescribes to {{ ydb-short-name }} to return only updated `UPDATED_NEW` attributes.
...
- Java
  ...
  1. In the folder `src/main/java/ru/yandex/cloud/samples/`, create the `SeriesItemOps05.java` file, for example, using the nano editor:
