...
---
title: Yandex Database Access Control
description: "Access control in the database creation and management service in Yandex Database. To allow access to YDB resources (databases and their users), assign users the relevant roles from the list."
---
