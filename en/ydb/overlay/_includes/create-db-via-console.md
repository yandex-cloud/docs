...
- Serverless
   ...
   1. You will be suggested default values for parameters of the database created. You can leave the parameters as they are: they've been selected to get you started in the most efficient way. Afterwards you can review them and [change](../concepts/serverless_and_dedicated.md) if needed.
   1. Click **Create database**.
