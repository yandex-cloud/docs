...
| `ReturnConsumedCapacity` | Indicates whether to return information about consumed capacity.<ul><li>`TOTAL` — Return.<li>`NONE` — Do not return.</ul><br/>**Type**: Line<br/>**Possible values**: `TOTAL` \| `NONE`<br/>**Required**: No
