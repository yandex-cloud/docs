---
title: Estimating the cost of YQL queries to {{ ydb-full-name }}
description: This article contains the rules for estimating the cost of YQL queries to {{ ydb-name }}.
editable: false
---
