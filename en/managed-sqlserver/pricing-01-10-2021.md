...
# Pricing for {{ mms-name }} from October 01, 2021

{% note warning %}

The billing rules described on this page come into effect on October 01, 2021. Until then the billing rules described in [{#T}](pricing.md) section apply.
