---
editable: false
sourcePath: en/_api-ref/mdb/sqlserver/api-ref/User/revokePermission.md
---
...
userName | Required. Name of the user to revoke a permission from.  To get the name of the user, use a [list](/docs/managed-sqlserver/api-ref/User/list) request.  The maximum string length in characters is 63. Value must match the regular expression `` [a-zA-Z0-9_]* ``.
