...
- SQL Server Management Studio
  ...
  For more information about the connection, see the developer's [documentation]{% if lang == "ru" %}(https://docs.microsoft.com/ru-ru/sql/linux/sql-server-linux-manage-ssms?view=sql-server-ver15#connect-to-sql-server-on-linux){% endif %}{% if lang == "en" %}(https://docs.microsoft.com/en-us/sql/linux/sql-server-linux-manage-ssms?view=sql-server-ver15#connect-to-sql-server-on-linux){% endif %}.
