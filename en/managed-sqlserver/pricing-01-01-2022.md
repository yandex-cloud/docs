...
# Pricing for {{ mms-name }} from January 01, 2022

{% note warning %}

The billing rules described on this page come into effect on January 01, 2022. Until then the billing rules described in [{#T}](pricing.md) section apply.
