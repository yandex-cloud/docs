...
{% if audience != "internal" %} A database cluster created in a folder can be accessed by all VM instances connected to the same cloud network. [Learn more about networking](../../vpc/). {% endif %}
