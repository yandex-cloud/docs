---
title: "Relationships between {{ mms-name }} resources"
description: "The main entity used in {{ mms-name }} is a database cluster. Each cluster consists of one or more database hosts, which are virtual machines with DBMS servers deployed on them. Cluster hosts may reside in different availability zones."
---
...
* {{ MS }} _version_. A {{ mms-name }} cluster supports the following versions:
   ...
   * Enterprise Edition.
   ...
   For more information about editions, see the [documentation for {{ MS }}]({{ ms.docs }}/sql/sql-server/editions-and-components-of-sql-server-2016?view=sql-server-ver15).
