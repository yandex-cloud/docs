...
# Pricing for {{ mms-name }} from March 22, 2022

{% note info %}

The indicated prices shall be effective from March 22, 2022. For information about the pricing policy until March 21, 2022, see [Current pricing policy](index.md).
...
{% include [rub-pricing.md](../../_pricing/managed-sqlserver/rub-pricing-22032022.md) %}

{% endif %}

{% if region == "kz"%}

{% include [kzt-pricing.md](../../_pricing/managed-sqlserver/kzt-pricing-22032022.md) %}

{% endif %}

{% if region == "int"%}

{% include [usd-pricing.md](../../_pricing/managed-sqlserver/usd-pricing-22032022.md) %}
