...
editable: false
---
# Pricing policy for {{ mms-name }} applicable as of January 1, 2022

{% note info %}

The specified rates will be in effect from January 1, 2022. For the rates applicable through December 31, 2021, see [{#T}](index.md).
