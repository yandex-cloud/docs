...
In this scenario, you'll learn how to connect to {{ iot-full-name }} using the [Paho](https://www.eclipse.org/paho/clients/dotnet/) library written in С\#. It assumes that you know how to develop apps on .NET in C\#.

{% note info %}

The source code used in this scenario is available on [GitHub](https://github.com/yandex-cloud/examples/tree/master/iot/c%23). Interactions with {{ iot-full-name }} are encapsulated in the [YaClient](https://github.com/yandex-cloud/examples/blob/master/iot/c%23/YaClient.cs) class that you can use in your projects.
