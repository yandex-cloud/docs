...
If you have devices with sensor readings that you need to quickly respond to and you may face network communication problems and a broken connection between your devices and the {% if lang == "ru" and audience != "internal" %}[MQTT server](../../../glossary/mqtt-server.md){% else %}MQTT server{% endif %}, you can subscribe your devices and registries to permanent topics.
