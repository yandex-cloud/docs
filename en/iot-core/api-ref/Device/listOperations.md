        ...
        pageSize:
          description: |-
            **string** (int64)
            ...
            results is larger than `page_size`, the service returns a [ListDeviceOperationsResponse.nextPageToken](/docs/iot-core/api-ref/Device/listOperations#yandex.cloud.iot.devices.v1.ListDeviceOperationsResponse)
        ...
        pageToken:
          description: |-
            **string**
            ...
            [ListDeviceOperationsResponse.nextPageToken](/docs/iot-core/api-ref/Device/listOperations#yandex.cloud.iot.devices.v1.ListDeviceOperationsResponse) returned by a previous list request.
          type: string
        filter:
          description: |-
            **string**
