...
editable: false
apiPlayground:
  - url: https://iot-devices.{{ api-host }}/iot-devices/v1/registries/{registryId}/operations
    method: get
    path:
      type: object
      properties:
        ...
        filter:
          description: |-
            **string**
            ...
            Currently you can use filtering only on [Registry.name](/docs/iot-core/api-ref/Registry/get#yandex.cloud.iot.devices.v1.Registry) field.
          type: string
      additionalProperties: false
    body: null
    definitions: null
...
## Query parameters {#yandex.cloud.iot.devices.v1.ListRegistryOperationsRequest}
...
## Response {#yandex.cloud.iot.devices.v1.ListRegistryOperationsResponse}
