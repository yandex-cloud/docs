...
- Management console {#console}
   ...
   1. [Navigate]({{ link-console-main }}/link/iot-core) to **{{ ui-key.yacloud.iam.folder.dashboard.label_iot-core }}** and select a registry with the device.
   ...
   1. In the **{{ ui-key.yacloud.common.password }}** field, enter the password you will use to access the device.
...
- Management console {#console}
   ...
   1. [Navigate]({{ link-console-main }}/link/iot-core) to **{{ ui-key.yacloud.iam.folder.dashboard.label_iot-core }}** and select a registry with the device.
   1. Navigate to the **{{ ui-key.yacloud.iot.label_devices }}** tab and select the device.
   1. On the **{{ ui-key.yacloud.common.overview }}** tab, go to the **{{ ui-key.yacloud.iot.label_passwords }}** section to see the list of passwords for the device.
