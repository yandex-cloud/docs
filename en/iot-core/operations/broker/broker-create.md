...
- Management console {#console}
  ...
  1. Under **{{ ui-key.yacloud.common.section-base }}**, specify the following:
      ...
      * Optionally, to assign a [label](../../../resource-manager/concepts/labels.md) to the broker, fill out the **{{ ui-key.yacloud.component.key-values-input.label_key }}** and **{{ ui-key.yacloud.component.key-values-input.label_value }}** fields and click **{{ ui-key.yacloud.component.label-set.button_add-label }}**.
