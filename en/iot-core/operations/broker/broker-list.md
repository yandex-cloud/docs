...
To find out the ID or name of a [broker](../../concepts/index.md#broker), get a list of brokers in the folder.
...
To access a broker, use the broker ID or name from the [previous](#broker-list) step.
