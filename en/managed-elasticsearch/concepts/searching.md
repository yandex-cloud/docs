...
{{ ES }} acts as both document storage and a tool for searching and {% if lang == "ru" and audience != "internal" %}[analyzing data](../../glossary/data-analytics.md){% else %}analyzing data{% endif %} in the documents using:
