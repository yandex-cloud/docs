---
editable: false
sourcePath: en/_api-ref-grpc/mdb/elasticsearch/v1/api-ref/grpc/Cluster/backup.md
---

# Managed Service for Elasticsearch API, gRPC: ClusterService.Backup {#Backup}

Create a backup for the specified ElasticSearch cluster.

## gRPC request

**rpc Backup ([BackupClusterRequest](#yandex.cloud.mdb.elasticsearch.v1.BackupClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## BackupClusterRequest {#yandex.cloud.mdb.elasticsearch.v1.BackupClusterRequest}
