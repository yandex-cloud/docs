...
cores | **int64**<br>Number of CPU cores for an Elasticsearch node created with the preset. 
memory | **int64**<br>RAM volume for an Elasticsearch node created with the preset, in bytes. 
