---
editable: false
sourcePath: en/_api-ref/mdb/elasticsearch/api-ref/Auth/deleteProviders.md
---


# Method deleteProviders
...
```
DELETE https://mdb.api.cloud.yandex.net/managed-elasticsearch/v1/clusters/{clusterId}/auth/providers
```
