...
```
POST https://mdb.api.cloud.yandex.net/managed-elasticsearch/v1/clusters/{clusterId}/hosts:batchCreate
```
...
Поле | Описание
--- | ---
hostSpecs[] | **object**<br><p>Обязательное поле. Одна или несколько конфигураций хостов, добавляемых в кластер Elasticsearch.</p> <p>Должен содержать хотя бы один элемент.</p> 
