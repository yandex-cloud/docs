...
# Managed Service for Elasticsearch API, REST: Cluster.Restore {#Restore}
...
```
POST https://{{ api-host-mdb }}/managed-elasticsearch/v1/clusters:restore
```

## Body parameters {#yandex.cloud.mdb.elasticsearch.v1.RestoreClusterRequest}
