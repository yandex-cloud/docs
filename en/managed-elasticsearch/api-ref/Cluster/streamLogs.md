...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-elasticsearch/v1/clusters/{clusterId}:stream_logs
    method: get
    path:
      type: object
      properties:
      ...
      properties:
        ...
        recordToken:
          description: |-
            **string**
            Record token.
            Set `record_token` to the [StreamLogRecord.nextRecordToken](/docs/managed-elasticsearch/api-ref/Cluster/streamLogs#yandex.cloud.mdb.elasticsearch.v1.StreamLogRecord) returned by a previous [ClusterService.StreamLogs](#StreamLogs) request to start streaming from next log record.
          type: string
        filter:
          description: |-
            **string**
