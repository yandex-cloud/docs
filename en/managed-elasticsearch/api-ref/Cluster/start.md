...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-elasticsearch/v1/clusters/{clusterId}:start
    method: post
    path:
      type: object
      properties:
    ...
    body: null
    definitions: null
sourcePath: en/_api-ref/mdb/elasticsearch/v1/api-ref/Cluster/start.md
---

# Managed Service for Elasticsearch API, REST: Cluster.Start
