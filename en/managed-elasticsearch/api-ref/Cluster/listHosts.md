...
hosts[].<br>type | **string**<br><p>Host type.</p> <ul> <li>TYPE_UNSPECIFIED: Host type is unspecified. Default value. - DATA_NODE: The host is an Elasticsearch data node.</li> <li>MASTER_NODE: The host is an Elasticsearch master node.</li> </ul> 
...
hosts[].<br>services[].<br>health | **string**<br><p>Service health data. If the field has default value, it is not returned in the response.</p> <ul> <li>UNKNOWN: Health of the service is unknown.</li> <li>ALIVE: The service is working normally.</li> <li>DEAD: The service is dead or unresponsive.</li> </ul> 
