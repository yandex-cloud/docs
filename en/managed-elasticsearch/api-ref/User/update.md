---
editable: false
sourcePath: en/_api-ref/mdb/elasticsearch/v1/api-ref/User/update.md
---

# Managed Service for Elasticsearch API, REST: User.Update {#Update}
...
## Body parameters {#yandex.cloud.mdb.elasticsearch.v1.UpdateUserRequest}
