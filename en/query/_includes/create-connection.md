...
1. In the **{{ ui-key.yql.yq-connection-form.service-account.input-label }}** field, select the service account to use for data reads or create a new one by granting it the [`yds.editor`](../../data-streams/security/index.md#yds-editor) permissions.
