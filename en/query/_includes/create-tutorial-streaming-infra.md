1. Create a connection:
    ...
    1. Navigate to **{{ ui-key.yql.yq-tutorial.tutorial-type-toggle.option-streaming }}**.
    ...
    1. In the window that opens, under **{{ ui-key.yql.yq-connection-form.connection-type-parameters.section-title }}**, select the database and service account you created earlier.
...
1. Create a [data binding](../concepts/glossary.md):
    ...
    1. Under **{{ ui-key.yql.yq-binding-form.binding-parameters.title }}**, select the `yellow-taxi` stream you created earlier.
    1. Click **{{ ui-key.yql.yq-binding-form.binding-create.button-text }}**.
