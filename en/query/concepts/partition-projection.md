...
{% if yq_version>"0.1"%}
|`projection.<field_name>.unit`|No, defaults to `DAYS`|Interval units. Acceptable values: YEARS, MONTHS, WEEKS, DAYS, HOURS, MINUTES, SECONDS, MILLISECONDS|SECONDS<br/>YEARS|
{% else %}
