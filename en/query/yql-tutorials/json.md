...
* [JSON_EXISTS](https://ydb.tech/docs/en/yql/reference/builtins/json#json_exists).
* [JSON_VALUE](https://ydb.tech/docs/en/yql/reference/builtins/json#json_value).
* [JSON_QUERY](https://ydb.tech/docs/en/yql/reference/builtins/json#json_query).
* [Functions for JSON](https://ydb.tech/docs/en/yql/reference/builtins/json).
