...
Yandex.Connect has two REST API interfaces for accessing Connect services via HTTP requests: the Directory API and the Tracker API.

Use these interfaces to integrate Yandex.Connect features into your web services and applications. This way, you'll automate workflows, and your users will be able to administer the organization and work with Tracker tasks through third-party applications.

## Directory API {#directpry-api}

The Directory API is an interface for managing an organization in Yandex.Connect. You can use the Directory API to:
