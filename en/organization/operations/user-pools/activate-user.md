---
title: How to activate a user in a {{ org-full-name }} pool
...
- {{ cloud-center }} UI {#cloud-center}
  ...
  1. In the left-hand panel, click ![userpool](../../../_assets/organization/userpool.svg) **{{ ui-key.yacloud_org.pages.userpools }}** and select the [user pool](../../concepts/user-pools.md) you need.
