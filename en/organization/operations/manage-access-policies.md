...
description: In this tutorial, you will learn how to view {{ iam-full-name }} access policies assigned for an organization, and how to assign and revoke such policies.
---
...
## Assigning an access policy for an organization {#assign}

{% include [access-policies-assign-org](../../_includes/iam/access-policies-assign-org.md) %}

## Viewing the list of access policies assigned for an organization {#view-assigned}

{% include [access-policies-view-assigned-org](../../_includes/iam/access-policies-view-assigned-org.md) %}

## Revoking an access policy assigned for an organization {#revoke}
