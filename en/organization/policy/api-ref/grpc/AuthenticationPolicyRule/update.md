...
- `ALLOW_WITH_OBLIGATIONS`: Allow authentication provided the obligations in [AuthenticationPolicyRule.obligations](/docs/organization/policy/api-ref/grpc/AuthenticationPolicyRule/get#yandex.cloud.organizationmanager.v1.policy.AuthenticationPolicyRule) are satisfied.
