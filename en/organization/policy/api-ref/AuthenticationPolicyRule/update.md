...
editable: false
apiPlayground:
  - url: https://organization-manager.{{ api-host }}/organization-manager/v1/policy/authenticationPolicyRules/{ruleId}
    method: patch
    path:
      type: object
      properties:
...
```
PATCH https://organization-manager.{{ api-host }}/organization-manager/v1/policy/authenticationPolicyRules/{ruleId}
```
...
## Body parameters {#yandex.cloud.organizationmanager.v1.policy.UpdateRuleRequest}
