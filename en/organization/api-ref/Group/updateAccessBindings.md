...
editable: false
apiPlayground:
  - url: https://organization-manager.{{ api-host }}/organization-manager/v1/groups/{resourceId}:updateAccessBindings
    method: post
    path:
      type: object
      properties:
...
# Identity Hub API, REST: Group.UpdateAccessBindings
...
```
POST https://organization-manager.{{ api-host }}/organization-manager/v1/groups/{resourceId}:updateAccessBindings
```
