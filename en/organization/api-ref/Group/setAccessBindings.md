...
editable: false
apiPlayground:
  - url: https://organization-manager.{{ api-host }}/organization-manager/v1/groups/{resourceId}:setAccessBindings
    method: post
    path:
      type: object
      properties:
...
# Identity Hub API, REST: Group.SetAccessBindings
...
```
POST https://organization-manager.{{ api-host }}/organization-manager/v1/groups/{resourceId}:setAccessBindings
```
