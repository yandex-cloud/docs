    ...
    body:
      ...
      properties:
        ...
        ldapSettings:
          ...
          $ref: '#/definitions/UpdateLdapSettingsRequest'
      additionalProperties: false
    definitions:
      ...
      UpdateLdapSettingsRequest:
        ...
        properties:
          ...
          deltaSyncMode:
            ...
            type: string
            enum:
              - LDAP_DELTA_SYNC_MODE_UNSPECIFIED
              - LDAP_DELTA_SYNC_MODE_FULL_SYNC
          useRecursiveMembershipFilter:
            description: |-
              **boolean**
...
# Identity Provider API, REST: Synchronization.UpdateSynchronizationSettings
...
## Body parameters {#yandex.cloud.organizationmanager.v1.idp.UpdateSynchronizationSettingsRequest}
