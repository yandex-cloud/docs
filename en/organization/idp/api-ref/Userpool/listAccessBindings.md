...
editable: false
apiPlayground:
  - url: https://organization-manager.{{ api-host }}/organization-manager/v1/idp/userpools/{resourceId}:listAccessBindings
    method: get
    path:
      type: object
      properties:
...
```
GET https://organization-manager.{{ api-host }}/organization-manager/v1/idp/userpools/{resourceId}:listAccessBindings
```
