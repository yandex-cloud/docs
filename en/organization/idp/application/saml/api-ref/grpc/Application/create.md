---
editable: false
sourcePath: en/_api-ref-grpc/organizationmanager/v1/idp/application/saml/api-ref/grpc/Application/create.md
---

# SAML Application API, gRPC: ApplicationService.Create

Creates a SAML application in the specified organization.

## gRPC request

**rpc Create ([CreateApplicationRequest](#yandex.cloud.organizationmanager.v1.idp.application.saml.CreateApplicationRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## CreateApplicationRequest {#yandex.cloud.organizationmanager.v1.idp.application.saml.CreateApplicationRequest}
...
|| security_settings | **[SecuritySettingsSpec](#yandex.cloud.organizationmanager.v1.idp.application.saml.SecuritySettingsSpec)**
