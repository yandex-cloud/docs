---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/organization-manager/cli-ref/v0/group/update
editable: false
---

# yc organization-manager v0 group update
