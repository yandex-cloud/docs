...
editable: false
apiPlayground:
  - url: https://organization-manager.{{ api-host }}/organization-manager/v1/saml/federations/{federationId}:reactivateUserAccounts
    method: post
    path:
      type: object
      properties:
    ...
    body:
      ...
      additionalProperties: false
    definitions: null
sourcePath: en/_api-ref/organizationmanager/v1/saml/api-ref/Federation/reactivateUserAccounts.md
---

# SAML Federation API, REST: Federation.ReactivateUserAccounts
...
```
POST https://organization-manager.{{ api-host }}/organization-manager/v1/saml/federations/{federationId}:reactivateUserAccounts
```
