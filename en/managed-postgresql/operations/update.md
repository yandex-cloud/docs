...
- CLI
   ...
   1. Specify the required storage in the {% if audience != "internal" %} cluster update command (it must be at least as large as `disk_size` in the cluster properties){% endif %}:
