...
- CLI {#cli}
  ...
  To change additional cluster settings:
    ...
    * `--serverless-access`: Enables access to the cluster from [{{ sf-full-name }}](../../functions/concepts/index.md). The default value is `false`. For details on setting up access, see [this {{ sf-name }} guide](../../functions/operations/database-connection.md).
...
- REST API {#api}
  ...
  1. Create a file named `body.json` and paste the following code into it:
     ...
     * `maintenanceWindow`: [Maintenance window](../concepts/maintenance.md) settings, including those for stopped clusters. In `maintenanceWindow`, provide one of the following values:
...
- gRPC API {#grpc-api}
  ...
  1. Create a file named `body.json` and paste the following code into it:
     ...
     * `maintenance_window`: [Maintenance window](../concepts/maintenance.md) settings, including those for stopped clusters. In `maintenance_window`, provide one of the following values:
...
- {{ TF }} {#tf}
    ...
    1. In the {{ mpg-name }} cluster description, edit the `folder_id` value. If the argument does not exist, add it:
