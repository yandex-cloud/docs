...
#|
|| **Extension** \ **{{ PG }} version** | **14** | **15** | **16** | **17** | **18** ||
...
|| <p>[hypopg](https://hypopg.readthedocs.io/en/rel1_stable/)</p><p>Contains virtual indexes. Virtual indexes provide a low-cost way to determine whether {{ PG }} will use real indexes for [problematic queries](../../tutorials/profiling.md#solving-inefficient-queries).</p> | 1.3.1 | 1.3.1 | 1.4.0 | 1.4.1 | 1.4.2 ||
...
|| <p>[pg_stat_statements]({{ pg-docs }}/pgstatstatements.html)</p><p>Enables you to track the scheduling and collect execution statistics of all SQL queries running in a cluster.</p><p>To use this extension, you need the [`mdb_monitor`](../../concepts/roles.md#mdb-monitor) role.</p> | 1.9 | 1.10 | 1.10 | 1.11 | - ||
