  ...
  - type: card-layout-block
    ...
    children:
      - type: basic-card
        ...
        url: https://yandex.cloud/en/prices?state=850e64f52876#calculator
        size: s
        border: shadow
        centered: true
        indent:
...
This section describes the {{ mpg-name }} pricing [policy](#rules) and [current prices](#prices) for its resources.
