...
To calculate the cost of using the service, use the [calculator](https://yandex.cloud/en/prices?state=f5aab780ba9a#calculator) on the {{ yandex-cloud }} website or see the pricing in this section.
