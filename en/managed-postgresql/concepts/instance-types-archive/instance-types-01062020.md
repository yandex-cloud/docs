# {{ PG }} host classes prior to June 1, 2020

A host class in {{ mpg-name }} determines the computing power allocated for each host in the cluster. When you change the host class for a cluster, all existing hosts change accordingly.
