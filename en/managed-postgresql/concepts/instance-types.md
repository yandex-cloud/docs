...
Hosts in Managed Service for PostgreSQL clusters are deployed on Yandex Compute Cloud virtual machines. These virtual machines can be created on any of the platforms that support Compute Cloud. For a detailed description of the platforms, see [#T](../../compute/concepts/vm-platforms.md).
