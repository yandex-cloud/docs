...
Hosts in {{ mpg-name }} clusters are deployed on {{ compute-full-name }} virtual machines. These virtual machines can be created on any of the platforms that support {{ compute-name }}. For a detailed description of the platforms, see [#T](../../compute/concepts/vm-platforms.md).
