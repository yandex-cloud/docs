...
All the clusters are created within the `_PGAASINTERNALNETS_` network macro. To connect to the created database, request access in [Puncher](https://puncher.yandex-team.ru/). To connect to {{ MY }}, specify port 3306 in your request.
