---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/managed-postgresql/cli-ref/v0/cluster/reschedule-maintenance/
---

# yc managed-postgresql v0 cluster reschedule-maintenance
