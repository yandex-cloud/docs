---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/managed-postgresql/cli-ref/cluster/add-access-binding/
---

# yc managed-postgresql cluster add-access-binding

Add access binding for the specified PostgreSQL cluster

#### Command Usage

Syntax:

`yc managed-postgresql cluster add-access-binding <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
