...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-postgresql/v1/maintenances
    method: get
    path: null
    query:
      type: object
...
# Managed Service for PostgreSQL API, REST: Maintenance.List
...
```
GET https://{{ api-host-mdb }}/managed-postgresql/v1/maintenances
```
