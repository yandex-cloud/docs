    ...
    path:
      ...
      properties:
        clusterId:
          description: |-
            **string**
            Required field. ID of the PostgreSQL cluster to delete a database in.
...
|| metadata | **[DeleteDatabaseMetadata](#yandex.cloud.mdb.postgresql.v1.DeleteDatabaseMetadata)**
...
## DeleteDatabaseMetadata {#yandex.cloud.mdb.postgresql.v1.DeleteDatabaseMetadata}
