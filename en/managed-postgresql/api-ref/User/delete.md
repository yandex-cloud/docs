---
editable: false
sourcePath: en/_api-ref/mdb/postgresql/api-ref/User/delete.md
---
...
userName | Required. Name of the user to delete. To get the name of the user, use a [list](/docs/managed-postgresql/api-ref/User/list) request.  The maximum string length in characters is 63. Value must match the regular expression `` [a-zA-Z0-9_]* ``.
