...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-postgresql/v1/clusters/{clusterId}:stop
    method: post
    path:
      type: object
      properties:
...
# Managed Service for PostgreSQL API, REST: Cluster.Stop
...
|| metadata | **[StopClusterMetadata](#yandex.cloud.mdb.postgresql.v1.StopClusterMetadata)**
...
## StopClusterMetadata {#yandex.cloud.mdb.postgresql.v1.StopClusterMetadata}
