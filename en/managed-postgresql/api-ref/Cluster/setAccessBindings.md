...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-postgresql/v1/clusters/{resourceId}:setAccessBindings
    method: post
    path:
      type: object
      properties:
    ...
    definitions:
      ...
      AccessBinding:
        ...
        required:
          - roleId
          - subject
sourcePath: en/_api-ref/mdb/postgresql/v1/api-ref/Cluster/setAccessBindings.md
---
...
```
POST https://{{ api-host-mdb }}/managed-postgresql/v1/clusters/{resourceId}:setAccessBindings
```
