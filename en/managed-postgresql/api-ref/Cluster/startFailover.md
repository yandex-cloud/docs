...
```
POST https://{{ api-host-mdb }}/managed-postgresql/v1/clusters/{clusterId}:startFailover
```
...
## Body parameters {#yandex.cloud.mdb.postgresql.v1.StartClusterFailoverRequest}
