...
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_9_6.<br>idleInTransactionSessionTimeout | **integer** (int64)<br><p>Acceptable values are 0 to 2147483647, inclusive.</p> 
...
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_10_1C.<br>idleInTransactionSessionTimeout | **integer** (int64)<br><p>Acceptable values are 0 to 2147483647, inclusive.</p> 
...
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_10.<br>idleInTransactionSessionTimeout | **integer** (int64)<br><p>Acceptable values are 0 to 2147483647, inclusive.</p> 
...
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_11.<br>idleInTransactionSessionTimeout | **integer** (int64)<br><p>Acceptable values are 0 to 2147483647, inclusive.</p> 
...
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_11_1C.<br>idleInTransactionSessionTimeout | **integer** (int64)<br><p>Acceptable values are 0 to 2147483647, inclusive.</p> 
...
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_12.<br>idleInTransactionSessionTimeout | **integer** (int64)<br><p>Acceptable values are 0 to 2147483647, inclusive.</p> 
...
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_12_1C.<br>idleInTransactionSessionTimeout | **integer** (int64)<br><p>Acceptable values are 0 to 2147483647, inclusive.</p> 
...
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_13.<br>idleInTransactionSessionTimeout | **integer** (int64)<br><p>Acceptable values are 0 to 2147483647, inclusive.</p> 
...
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_13_1C.<br>idleInTransactionSessionTimeout | **integer** (int64)<br><p>Acceptable values are 0 to 2147483647, inclusive.</p> 
...
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_14.<br>idleInTransactionSessionTimeout | **integer** (int64)<br><p>Acceptable values are 0 to 2147483647, inclusive.</p> 
...
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_14_1C.<br>idleInTransactionSessionTimeout | **integer** (int64)<br><p>Acceptable values are 0 to 2147483647, inclusive.</p> 
...
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_15.<br>idleInTransactionSessionTimeout | **integer** (int64)<br><p>Acceptable values are 0 to 2147483647, inclusive.</p> 
...
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_15_1C.<br>idleInTransactionSessionTimeout | **integer** (int64)<br><p>Acceptable values are 0 to 2147483647, inclusive.</p> 
...
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16 | **object**<br>Configuration for a host with PostgreSQL 16 server deployed. <br>`updateHostSpecs[].configSpec` includes only one of the fields `postgresqlConfig_9_6`, `postgresqlConfig_10_1C`, `postgresqlConfig_10`, `postgresqlConfig_11`, `postgresqlConfig_11_1C`, `postgresqlConfig_12`, `postgresqlConfig_12_1C`, `postgresqlConfig_13`, `postgresqlConfig_13_1C`, `postgresqlConfig_14`, `postgresqlConfig_14_1C`, `postgresqlConfig_15`, `postgresqlConfig_15_1C`, `postgresqlConfig_16`, `postgresqlConfig_16_1C`<br>
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>recoveryMinApplyDelay | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>sharedBuffers | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>tempBuffers | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>workMem | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>tempFileLimit | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>backendFlushAfter | **integer** (int64)<br><p>Acceptable values are 0 to 2048, inclusive.</p> 
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>oldSnapshotThreshold | **integer** (int64)<br><p>Acceptable values are -1 to 86400, inclusive.</p> 
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>maxStandbyStreamingDelay | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>constraintExclusion | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>cursorTupleFraction | **number** (double)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>fromCollapseLimit | **integer** (int64)<br><p>Acceptable values are 1 to 2147483647, inclusive.</p> 
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>joinCollapseLimit | **integer** (int64)<br><p>Acceptable values are 1 to 2147483647, inclusive.</p> 
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>debugParallelQuery | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>clientMinMessages | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>logMinMessages | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>logMinErrorStatement | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>logMinDurationStatement | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>logCheckpoints | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>logConnections | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>logDisconnections | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>logDuration | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>logErrorVerbosity | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>logLockWaits | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>logStatement | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>logTempFiles | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>searchPath | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>rowSecurity | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>defaultTransactionIsolation | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>statementTimeout | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>lockTimeout | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>idleInTransactionSessionTimeout | **integer** (int64)<br><p>Acceptable values are 0 to 2147483647, inclusive.</p> 
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>byteaOutput | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>xmlbinary | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>xmloption | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>ginPendingListLimit | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>deadlockTimeout | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>maxLocksPerTransaction | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>maxPredLocksPerTransaction | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>arrayNulls | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>backslashQuote | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>defaultWithOids | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>escapeStringWarning | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>loCompatPrivileges | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>quoteAllIdentifiers | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>standardConformingStrings | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>synchronizeSeqscans | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>transformNullEquals | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>exitOnError | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>seqPageCost | **number** (double)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>randomPageCost | **number** (double)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>enableBitmapscan | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>enableHashagg | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>enableHashjoin | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>enableIndexscan | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>enableIndexonlyscan | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>enableMaterial | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>enableMergejoin | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>enableNestloop | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>enableSeqscan | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>enableSort | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>enableTidscan | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>maxParallelWorkers | **integer** (int64)<br><p>Acceptable values are 0 to 1024, inclusive.</p> 
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>maxParallelWorkersPerGather | **integer** (int64)<br><p>Acceptable values are 0 to 1024, inclusive.</p> 
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>timezone | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>effectiveIoConcurrency | **integer** (int64)<br><p>Acceptable values are 0 to 1000, inclusive.</p> 
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16.<br>effectiveCacheSize | **integer** (int64)<br><p>Acceptable values are 0 to 549755813888, inclusive.</p> 
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C | **object**<br>Configuration for a host with PostgreSQL 16 1C server deployed. <br>`updateHostSpecs[].configSpec` includes only one of the fields `postgresqlConfig_9_6`, `postgresqlConfig_10_1C`, `postgresqlConfig_10`, `postgresqlConfig_11`, `postgresqlConfig_11_1C`, `postgresqlConfig_12`, `postgresqlConfig_12_1C`, `postgresqlConfig_13`, `postgresqlConfig_13_1C`, `postgresqlConfig_14`, `postgresqlConfig_14_1C`, `postgresqlConfig_15`, `postgresqlConfig_15_1C`, `postgresqlConfig_16`, `postgresqlConfig_16_1C`<br>
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>recoveryMinApplyDelay | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>sharedBuffers | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>tempBuffers | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>workMem | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>tempFileLimit | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>backendFlushAfter | **integer** (int64)<br><p>Acceptable values are 0 to 2048, inclusive.</p> 
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>oldSnapshotThreshold | **integer** (int64)<br><p>Acceptable values are -1 to 86400, inclusive.</p> 
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>maxStandbyStreamingDelay | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>constraintExclusion | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>cursorTupleFraction | **number** (double)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>fromCollapseLimit | **integer** (int64)<br><p>Acceptable values are 1 to 2147483647, inclusive.</p> 
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>joinCollapseLimit | **integer** (int64)<br><p>Acceptable values are 1 to 2147483647, inclusive.</p> 
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>debugParallelQuery | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>clientMinMessages | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>logMinMessages | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>logMinErrorStatement | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>logMinDurationStatement | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>logCheckpoints | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>logConnections | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>logDisconnections | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>logDuration | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>logErrorVerbosity | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>logLockWaits | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>logStatement | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>logTempFiles | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>searchPath | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>rowSecurity | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>defaultTransactionIsolation | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>statementTimeout | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>lockTimeout | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>idleInTransactionSessionTimeout | **integer** (int64)<br><p>Acceptable values are 0 to 2147483647, inclusive.</p> 
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>byteaOutput | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>xmlbinary | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>xmloption | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>ginPendingListLimit | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>deadlockTimeout | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>maxLocksPerTransaction | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>maxPredLocksPerTransaction | **integer** (int64)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>arrayNulls | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>backslashQuote | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>defaultWithOids | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>escapeStringWarning | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>loCompatPrivileges | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>quoteAllIdentifiers | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>standardConformingStrings | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>synchronizeSeqscans | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>transformNullEquals | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>exitOnError | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>seqPageCost | **number** (double)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>randomPageCost | **number** (double)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>enableBitmapscan | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>enableHashagg | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>enableHashjoin | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>enableIndexscan | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>enableIndexonlyscan | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>enableMaterial | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>enableMergejoin | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>enableNestloop | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>enableSeqscan | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>enableSort | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>enableTidscan | **boolean** (boolean)
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>maxParallelWorkers | **integer** (int64)<br><p>Acceptable values are 0 to 1024, inclusive.</p> 
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>maxParallelWorkersPerGather | **integer** (int64)<br><p>Acceptable values are 0 to 1024, inclusive.</p> 
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>timezone | **string**
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>effectiveIoConcurrency | **integer** (int64)<br><p>Acceptable values are 0 to 1000, inclusive.</p> 
updateHostSpecs[].<br>configSpec.<br>postgresqlConfig_16_1C.<br>effectiveCacheSize | **integer** (int64)<br><p>Acceptable values are 0 to 549755813888, inclusive.</p> 
