        ...
        pageSize:
          description: |-
            **string** (int64)
            ...
            results is larger than `pageSize`, the service returns a [ListClusterLogsResponse.nextPageToken](/docs/managed-postgresql/api-ref/Cluster/listLogs#yandex.cloud.mdb.postgresql.v1.ListClusterLogsResponse)
        ...
        pageToken:
          description: |-
            **string**
            ...
            [ListClusterLogsResponse.nextPageToken](/docs/managed-postgresql/api-ref/Cluster/listLogs#yandex.cloud.mdb.postgresql.v1.ListClusterLogsResponse) returned by the previous list request.
          type: string
        alwaysNextPageToken:
          description: |-
            **boolean**
