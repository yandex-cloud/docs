...
* In the [{{ monitoring-full-name }}](https://monitoring.cloud.yandex.com/) service, which enables you to [configure notifications](../operations/monitoring.md#monitoring-integration) for specified metrics.
...
Use [{{ monitoring-full-name }}](https://monitoring.cloud.yandex.com/) and [set up notifications](../operations/monitoring.md#monitoring-integration) for those parameters that are critical for you.
