...
* In [{{ monitoring-full-name }}](https://monitoring.cloud.yandex.com/) that lets you [set up notifications](../operations/monitoring.md#monitoring-integration) for specified metrics.
