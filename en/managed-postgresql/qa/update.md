...
You can. To do this, [restore the cluster from a backup](../operations/cluster-backups.md#restore) and specify the desired storage type when configuring the new cluster.
