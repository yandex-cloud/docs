...
For more information, see the [service documentation](../operations/connect.md).
...
For more information about obtaining a certificate and connecting to a database, see the [service documentation](../operations/connect.md).
