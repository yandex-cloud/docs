...
To migrate data between cloud networks, follow the [migration instructions](../tutorials/replication-overview.md).
...
You cannot use the service to make a local backup from {{ yandex-cloud }} but you can use the [pg_dump utility](https://www.postgresql.org/docs/9.6/app-pgdump.html).
