...
- [Search API domain](search_api.md)
  - [**SearchAPIDomain**](search_api.md#yandex_ai_studio_sdk._search_api.domain.SearchAPIDomain)
    ...
    - [**SearchAPIDomain.wordstat**](search_api.md#yandex_ai_studio_sdk._search_api.domain.SearchAPIDomain.wordstat)
  ...
  - [Wordstat](search_api.md#id7)
    - [**WordstatFunction**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.function.WordstatFunction)
      - [**WordstatFunction.\_\_call\_\_()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.function.WordstatFunction.__call__i)
    - [**Wordstat**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat)
      - [**Wordstat.get\_regions\_tree()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.get_regions_tree)
      - [**Wordstat.get\_top()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.get_top)
      - [**Wordstat.get\_dynamics()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.get_dynamics)
      - [**Wordstat.get\_regions\_distribution()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.get_regions_distribution)
      - [**Wordstat.DeviceType**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.DeviceType)
        - [**Wordstat.DeviceType.Unknown()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.DeviceType.Unknown)
        - [**Wordstat.DeviceType.\_\_new\_\_()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.DeviceType.__new__i)
        - [**Wordstat.DeviceType.conjugate()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.DeviceType.conjugate)
        - [**Wordstat.DeviceType.bit\_length()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.DeviceType.bit_length)
        - [**Wordstat.DeviceType.bit\_count()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.DeviceType.bit_count)
        - [**Wordstat.DeviceType.as\_integer\_ratio()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.DeviceType.as_integer_ratio)
        - [**Wordstat.DeviceType.is\_integer()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.DeviceType.is_integer)
        - [**Wordstat.DeviceType.real**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.DeviceType.real)
        - [**Wordstat.DeviceType.imag**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.DeviceType.imag)
        - [**Wordstat.DeviceType.numerator**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.DeviceType.numerator)
        - [**Wordstat.DeviceType.denominator**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.DeviceType.denominator)
        - [**Wordstat.DeviceType.ALL**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.DeviceType.ALL)
        - [**Wordstat.DeviceType.DESKTOP**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.DeviceType.DESKTOP)
        - [**Wordstat.DeviceType.PHONE**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.DeviceType.PHONE)
        - [**Wordstat.DeviceType.TABLET**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.DeviceType.TABLET)
        - [**Wordstat.DeviceType.\_\_init\_\_()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.DeviceType.__init__i)
      - [**Wordstat.PeriodType**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.PeriodType)
        - [**Wordstat.PeriodType.Unknown()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.PeriodType.Unknown)
        - [**Wordstat.PeriodType.\_\_new\_\_()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.PeriodType.__new__i)
        - [**Wordstat.PeriodType.conjugate()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.PeriodType.conjugate)
        - [**Wordstat.PeriodType.bit\_length()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.PeriodType.bit_length)
        - [**Wordstat.PeriodType.bit\_count()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.PeriodType.bit_count)
        - [**Wordstat.PeriodType.as\_integer\_ratio()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.PeriodType.as_integer_ratio)
        - [**Wordstat.PeriodType.is\_integer()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.PeriodType.is_integer)
        - [**Wordstat.PeriodType.real**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.PeriodType.real)
        - [**Wordstat.PeriodType.imag**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.PeriodType.imag)
        - [**Wordstat.PeriodType.numerator**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.PeriodType.numerator)
        - [**Wordstat.PeriodType.denominator**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.PeriodType.denominator)
        - [**Wordstat.PeriodType.MONTHLY**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.PeriodType.MONTHLY)
        - [**Wordstat.PeriodType.WEEKLY**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.PeriodType.WEEKLY)
        - [**Wordstat.PeriodType.DAILY**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.PeriodType.DAILY)
        - [**Wordstat.PeriodType.\_\_init\_\_()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.PeriodType.__init__i)
      - [**Wordstat.RegionsDistributionType**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.RegionsDistributionType)
        - [**Wordstat.RegionsDistributionType.Unknown()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.RegionsDistributionType.Unknown)
        - [**Wordstat.RegionsDistributionType.\_\_new\_\_()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.RegionsDistributionType.__new__i)
        - [**Wordstat.RegionsDistributionType.conjugate()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.RegionsDistributionType.conjugate)
        - [**Wordstat.RegionsDistributionType.bit\_length()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.RegionsDistributionType.bit_length)
        - [**Wordstat.RegionsDistributionType.bit\_count()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.RegionsDistributionType.bit_count)
        - [**Wordstat.RegionsDistributionType.as\_integer\_ratio()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.RegionsDistributionType.as_integer_ratio)
        - [**Wordstat.RegionsDistributionType.is\_integer()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.RegionsDistributionType.is_integer)
        - [**Wordstat.RegionsDistributionType.real**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.RegionsDistributionType.real)
        - [**Wordstat.RegionsDistributionType.imag**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.RegionsDistributionType.imag)
        - [**Wordstat.RegionsDistributionType.numerator**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.RegionsDistributionType.numerator)
        - [**Wordstat.RegionsDistributionType.denominator**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.RegionsDistributionType.denominator)
        - [**Wordstat.RegionsDistributionType.ALL**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.RegionsDistributionType.ALL)
        - [**Wordstat.RegionsDistributionType.CITIES**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.RegionsDistributionType.CITIES)
        - [**Wordstat.RegionsDistributionType.REGIONS**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.RegionsDistributionType.REGIONS)
        - [**Wordstat.RegionsDistributionType.\_\_init\_\_()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.RegionsDistributionType.__init__i)
      - [**Wordstat.\_\_init\_\_()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.__init__i)
      - [**Wordstat.config**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.config)
      - [**Wordstat.configure()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.configure)
      - [**Wordstat.fine\_tuned**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.fine_tuned)
      - [**Wordstat.name**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.name)
      - [**Wordstat.owner**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.owner)
      - [**Wordstat.uri**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.uri)
      - [**Wordstat.version**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.Wordstat.version)
- [SpheechKit domain](speechkit/domain.md)
  - [**SpeechKitDomain**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.SpeechKitDomain)
    ...
    - [**SpeechKitDomain.speech\_to\_text**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.SpeechKitDomain.speech_to_text)
    - [**SpeechKitDomain.stt**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.SpeechKitDomain.stt)
    - [**SpeechKitDomain.AudioFormat**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.SpeechKitDomain.AudioFormat)
      - [**SpeechKitDomain.AudioFormat.Unknown()**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.SpeechKitDomain.AudioFormat.Unknown)
      - [**SpeechKitDomain.AudioFormat.\_\_new\_\_()**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.SpeechKitDomain.AudioFormat.__new__i)
      - [**SpeechKitDomain.AudioFormat.conjugate()**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.SpeechKitDomain.AudioFormat.conjugate)
      - [**SpeechKitDomain.AudioFormat.bit\_length()**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.SpeechKitDomain.AudioFormat.bit_length)
      - [**SpeechKitDomain.AudioFormat.bit\_count()**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.SpeechKitDomain.AudioFormat.bit_count)
      - [**SpeechKitDomain.AudioFormat.as\_integer\_ratio()**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.SpeechKitDomain.AudioFormat.as_integer_ratio)
      - [**SpeechKitDomain.AudioFormat.is\_integer()**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.SpeechKitDomain.AudioFormat.is_integer)
      - [**SpeechKitDomain.AudioFormat.real**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.SpeechKitDomain.AudioFormat.real)
      - [**SpeechKitDomain.AudioFormat.imag**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.SpeechKitDomain.AudioFormat.imag)
      - [**SpeechKitDomain.AudioFormat.numerator**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.SpeechKitDomain.AudioFormat.numerator)
      - [**SpeechKitDomain.AudioFormat.denominator**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.SpeechKitDomain.AudioFormat.denominator)
      - [**SpeechKitDomain.AudioFormat.PCM16()**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.SpeechKitDomain.AudioFormat.PCM16)
      - [**SpeechKitDomain.AudioFormat.MP3**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.SpeechKitDomain.AudioFormat.MP3)
      - [**SpeechKitDomain.AudioFormat.WAV**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.SpeechKitDomain.AudioFormat.WAV)
