...
**vision**\: *[AsyncVisionDomain](vision/domain.md#yandex_ai_studio_sdk._vision.domain.AsyncVisionDomain)*{#yandex_ai_studio_sdk.AsyncAIStudio.vision}
...
- [Yandex Search API domain](search_api.md)
  - [**AsyncSearchAPIDomain**](search_api.md#yandex_ai_studio_sdk._search_api.domain.AsyncSearchAPIDomain)
    ...
    - [**AsyncSearchAPIDomain.wordstat**](search_api.md#yandex_ai_studio_sdk._search_api.domain.AsyncSearchAPIDomain.wordstat)
  ...
  - [Wordstat](search_api.md#id7)
    - [**AsyncWordstatFunction**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.function.AsyncWordstatFunction)
      - [**AsyncWordstatFunction.\_\_call\_\_()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.function.AsyncWordstatFunction.__call__i)
    - [**AsyncWordstat**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat)
      - [**AsyncWordstat.get\_regions\_tree()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.get_regions_tree)
      - [**AsyncWordstat.get\_top()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.get_top)
      - [**AsyncWordstat.get\_dynamics()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.get_dynamics)
      - [**AsyncWordstat.get\_regions\_distribution()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.get_regions_distribution)
      - [**AsyncWordstat.DeviceType**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.DeviceType)
        - [**AsyncWordstat.DeviceType.Unknown()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.DeviceType.Unknown)
        - [**AsyncWordstat.DeviceType.\_\_new\_\_()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.DeviceType.__new__i)
        - [**AsyncWordstat.DeviceType.conjugate()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.DeviceType.conjugate)
        - [**AsyncWordstat.DeviceType.bit\_length()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.DeviceType.bit_length)
        - [**AsyncWordstat.DeviceType.bit\_count()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.DeviceType.bit_count)
        - [**AsyncWordstat.DeviceType.as\_integer\_ratio()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.DeviceType.as_integer_ratio)
        - [**AsyncWordstat.DeviceType.is\_integer()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.DeviceType.is_integer)
        - [**AsyncWordstat.DeviceType.real**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.DeviceType.real)
        - [**AsyncWordstat.DeviceType.imag**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.DeviceType.imag)
        - [**AsyncWordstat.DeviceType.numerator**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.DeviceType.numerator)
        - [**AsyncWordstat.DeviceType.denominator**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.DeviceType.denominator)
        - [**AsyncWordstat.DeviceType.ALL**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.DeviceType.ALL)
        - [**AsyncWordstat.DeviceType.DESKTOP**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.DeviceType.DESKTOP)
        - [**AsyncWordstat.DeviceType.PHONE**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.DeviceType.PHONE)
        - [**AsyncWordstat.DeviceType.TABLET**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.DeviceType.TABLET)
        - [**AsyncWordstat.DeviceType.\_\_init\_\_()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.DeviceType.__init__i)
      - [**AsyncWordstat.PeriodType**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.PeriodType)
        - [**AsyncWordstat.PeriodType.Unknown()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.PeriodType.Unknown)
        - [**AsyncWordstat.PeriodType.\_\_new\_\_()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.PeriodType.__new__i)
        - [**AsyncWordstat.PeriodType.conjugate()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.PeriodType.conjugate)
        - [**AsyncWordstat.PeriodType.bit\_length()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.PeriodType.bit_length)
        - [**AsyncWordstat.PeriodType.bit\_count()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.PeriodType.bit_count)
        - [**AsyncWordstat.PeriodType.as\_integer\_ratio()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.PeriodType.as_integer_ratio)
        - [**AsyncWordstat.PeriodType.is\_integer()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.PeriodType.is_integer)
        - [**AsyncWordstat.PeriodType.real**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.PeriodType.real)
        - [**AsyncWordstat.PeriodType.imag**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.PeriodType.imag)
        - [**AsyncWordstat.PeriodType.numerator**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.PeriodType.numerator)
        - [**AsyncWordstat.PeriodType.denominator**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.PeriodType.denominator)
        - [**AsyncWordstat.PeriodType.MONTHLY**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.PeriodType.MONTHLY)
        - [**AsyncWordstat.PeriodType.WEEKLY**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.PeriodType.WEEKLY)
        - [**AsyncWordstat.PeriodType.DAILY**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.PeriodType.DAILY)
        - [**AsyncWordstat.PeriodType.\_\_init\_\_()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.PeriodType.__init__i)
      - [**AsyncWordstat.RegionsDistributionType**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.RegionsDistributionType)
        - [**AsyncWordstat.RegionsDistributionType.Unknown()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.RegionsDistributionType.Unknown)
        - [**AsyncWordstat.RegionsDistributionType.\_\_new\_\_()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.RegionsDistributionType.__new__i)
        - [**AsyncWordstat.RegionsDistributionType.conjugate()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.RegionsDistributionType.conjugate)
        - [**AsyncWordstat.RegionsDistributionType.bit\_length()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.RegionsDistributionType.bit_length)
        - [**AsyncWordstat.RegionsDistributionType.bit\_count()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.RegionsDistributionType.bit_count)
        - [**AsyncWordstat.RegionsDistributionType.as\_integer\_ratio()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.RegionsDistributionType.as_integer_ratio)
        - [**AsyncWordstat.RegionsDistributionType.is\_integer()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.RegionsDistributionType.is_integer)
        - [**AsyncWordstat.RegionsDistributionType.real**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.RegionsDistributionType.real)
        - [**AsyncWordstat.RegionsDistributionType.imag**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.RegionsDistributionType.imag)
        - [**AsyncWordstat.RegionsDistributionType.numerator**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.RegionsDistributionType.numerator)
        - [**AsyncWordstat.RegionsDistributionType.denominator**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.RegionsDistributionType.denominator)
        - [**AsyncWordstat.RegionsDistributionType.ALL**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.RegionsDistributionType.ALL)
        - [**AsyncWordstat.RegionsDistributionType.CITIES**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.RegionsDistributionType.CITIES)
        - [**AsyncWordstat.RegionsDistributionType.REGIONS**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.RegionsDistributionType.REGIONS)
        - [**AsyncWordstat.RegionsDistributionType.\_\_init\_\_()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.RegionsDistributionType.__init__i)
      - [**AsyncWordstat.\_\_init\_\_()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.__init__i)
      - [**AsyncWordstat.config**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.config)
      - [**AsyncWordstat.configure()**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.configure)
      - [**AsyncWordstat.fine\_tuned**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.fine_tuned)
      - [**AsyncWordstat.name**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.name)
      - [**AsyncWordstat.owner**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.owner)
      - [**AsyncWordstat.uri**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.uri)
      - [**AsyncWordstat.version**](search_api.md#yandex_ai_studio_sdk._search_api.wordstat.wordstat.AsyncWordstat.version)
- [SpheechKit domain](speechkit/domain.md)
  - [**AsyncSpeechKitDomain**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.AsyncSpeechKitDomain)
    ...
    - [**AsyncSpeechKitDomain.speech\_to\_text**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.AsyncSpeechKitDomain.speech_to_text)
    - [**AsyncSpeechKitDomain.stt**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.AsyncSpeechKitDomain.stt)
    - [**AsyncSpeechKitDomain.AudioFormat**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.AsyncSpeechKitDomain.AudioFormat)
      - [**AsyncSpeechKitDomain.AudioFormat.Unknown()**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.AsyncSpeechKitDomain.AudioFormat.Unknown)
      - [**AsyncSpeechKitDomain.AudioFormat.\_\_new\_\_()**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.AsyncSpeechKitDomain.AudioFormat.__new__i)
      - [**AsyncSpeechKitDomain.AudioFormat.conjugate()**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.AsyncSpeechKitDomain.AudioFormat.conjugate)
      - [**AsyncSpeechKitDomain.AudioFormat.bit\_length()**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.AsyncSpeechKitDomain.AudioFormat.bit_length)
      - [**AsyncSpeechKitDomain.AudioFormat.bit\_count()**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.AsyncSpeechKitDomain.AudioFormat.bit_count)
      - [**AsyncSpeechKitDomain.AudioFormat.as\_integer\_ratio()**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.AsyncSpeechKitDomain.AudioFormat.as_integer_ratio)
      - [**AsyncSpeechKitDomain.AudioFormat.is\_integer()**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.AsyncSpeechKitDomain.AudioFormat.is_integer)
      - [**AsyncSpeechKitDomain.AudioFormat.real**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.AsyncSpeechKitDomain.AudioFormat.real)
      - [**AsyncSpeechKitDomain.AudioFormat.imag**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.AsyncSpeechKitDomain.AudioFormat.imag)
      - [**AsyncSpeechKitDomain.AudioFormat.numerator**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.AsyncSpeechKitDomain.AudioFormat.numerator)
      - [**AsyncSpeechKitDomain.AudioFormat.denominator**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.AsyncSpeechKitDomain.AudioFormat.denominator)
      - [**AsyncSpeechKitDomain.AudioFormat.PCM16()**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.AsyncSpeechKitDomain.AudioFormat.PCM16)
      - [**AsyncSpeechKitDomain.AudioFormat.MP3**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.AsyncSpeechKitDomain.AudioFormat.MP3)
      - [**AsyncSpeechKitDomain.AudioFormat.WAV**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.AsyncSpeechKitDomain.AudioFormat.WAV)
      - [**AsyncSpeechKitDomain.AudioFormat.OGG\_OPUS**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.AsyncSpeechKitDomain.AudioFormat.OGG_OPUS)
      - [**AsyncSpeechKitDomain.AudioFormat.\_\_init\_\_()**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.AsyncSpeechKitDomain.AudioFormat.__init__i)
    - [**AsyncSpeechKitDomain.\_\_init\_\_()**](speechkit/domain.md#yandex_ai_studio_sdk._speechkit.domain.AsyncSpeechKitDomain.__init__i)
- [Vision domain](vision/domain.md)
  - [**AsyncVisionDomain**](vision/domain.md#yandex_ai_studio_sdk._vision.domain.AsyncVisionDomain)
    - [**AsyncVisionDomain.ocr**](vision/domain.md#yandex_ai_studio_sdk._vision.domain.AsyncVisionDomain.ocr)
