...
To enable [health checks](../../load-balancer/concepts/health-check.md) for resources connected to a network load balancer, allow traffic to be transferred between the `198.18.235.0/24` and `198.18.248.0/24` address ranges and target resources.
