...
* Not designed to protect against DDoS attacks. {% if product == "yandex-cloud" %}To filter out large volumes of unwanted traffic, use [DDoS protection](../ddos-protection/index.md).{% endif %}
