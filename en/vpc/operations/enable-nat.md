...
The function is obsolete. If you disable NAT to the internet in a subnet, you can't enable it again and have to use a [NAT gateway](../concepts/gateways.md#nat-gateway) instead.
