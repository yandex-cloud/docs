...
- Management console {#console}
  ...
  1. In the [management console]({{ link-console-main }}), select the folder the address is reserved in.
...
- API {#api}
  ...
  * ID of the address you want to enable protection for in the `addressId` parameter.
