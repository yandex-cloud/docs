...
1. Specify the subnet CIDR: its IP address and mask, e.g., `10.10.0.0/24`. For more information about IP address ranges, see [Cloud networks and subnets](concepts/network.md).
