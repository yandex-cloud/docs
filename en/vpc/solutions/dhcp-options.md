...
To run this scenario, make sure you have a corporate DNS server deployed that is available for the VMs in the cloud. You can also [deploy Active Directory](../../solutions/windows/active-directory.md) to create an infrastructure with a DNS server:
...
To pass this scenario in full, [deploy Active Directory](../../solutions/windows/active-directory.md). If you use your own DNS servers that are available for cloud VMs, specify your own DNS suffix and IP address values in the scenario.
