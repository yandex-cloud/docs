...
**rpc Delete ([DeleteAddressRequest](#yandex.cloud.vpc.v1.DeleteAddressRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## DeleteAddressRequest {#yandex.cloud.vpc.v1.DeleteAddressRequest}
