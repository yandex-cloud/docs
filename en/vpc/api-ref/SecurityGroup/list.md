        ...
        pageSize:
          description: |-
            **string** (int64)
            ...
            the service returns a [ListSecurityGroupsResponse.nextPageToken](/docs/vpc/api-ref/SecurityGroup/list#yandex.cloud.vpc.v1.ListSecurityGroupsResponse)
        ...
        pageToken:
          description: |-
            **string**
            ...
            [ListSecurityGroupsResponse.nextPageToken](/docs/vpc/api-ref/SecurityGroup/list#yandex.cloud.vpc.v1.ListSecurityGroupsResponse) returned by a previous list request.
          type: string
        filter:
          description: |-
            **string**
            ...
            1. The field name. Currently you can use filtering only on the [SecurityGroup.name](/docs/vpc/api-ref/Network/listSecurityGroups#yandex.cloud.vpc.v1.SecurityGroup) field.
            2. An `=` operator.
