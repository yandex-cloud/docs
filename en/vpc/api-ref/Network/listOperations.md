        ...
        pageSize:
          description: |-
            **string** (int64)
            ...
            results is larger than `pageSize`, the service returns a [ListNetworkOperationsResponse.nextPageToken](/docs/vpc/api-ref/Network/listOperations#yandex.cloud.vpc.v1.ListNetworkOperationsResponse)
        ...
        pageToken:
          description: |-
            **string**
            ...
            [ListNetworkOperationsResponse.nextPageToken](/docs/vpc/api-ref/Network/listOperations#yandex.cloud.vpc.v1.ListNetworkOperationsResponse) returned by a previous list request.
          type: string
      additionalProperties: false
    body: null
    definitions: null
