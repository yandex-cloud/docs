        ...
        pageSize:
          description: |-
            **string** (int64)
            ...
            the service returns a [ListRouteTablesResponse.nextPageToken](/docs/vpc/api-ref/RouteTable/list#yandex.cloud.vpc.v1.ListRouteTablesResponse)
        ...
        pageToken:
          description: |-
            **string**
            ...
            [ListRouteTablesResponse.nextPageToken](/docs/vpc/api-ref/RouteTable/list#yandex.cloud.vpc.v1.ListRouteTablesResponse) returned by a previous list request.
          type: string
        filter:
          description: |-
            **string**
            ...
            1. The field name. Currently you can use filtering only on [RouteTable.name](/docs/vpc/api-ref/Network/listRouteTables#yandex.cloud.vpc.v1.RouteTable) field.
            2. An `=` operator.
