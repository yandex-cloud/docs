...
The prices listed below will take effect on November 14, 2022, when {{ container-registry-name }} [becomes public](../overview/concepts/launch-stages.md). Until then, the service can be used free of charge.
