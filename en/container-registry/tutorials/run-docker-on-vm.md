   ...
   - Management console
      ...
      1. Under **Network settings**:
         ...
         * In the **Public IP** field, choose a method for assigning an IP address:
         ...
         {% if product == "yandex-cloud" %}* (optional) Enable [DDoS protection](../../vpc/ddos-protection/).{% endif %}
...
1. Log in to the registry under your username:
   ...
   {% if product == "yandex-cloud" %}- With an OAuth token
   ...
   - Using an IAM token
      ...
      1. [Get]{% if product == "yandex-cloud" %}(../../iam/operations/iam-token/create.md){% endif %}{% if product == "cloud-il" %}(../../iam/operations/iam-token/create-for-federation.md){% endif %} an IAM token.
      1. Run the command:
