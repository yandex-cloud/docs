...
1. Create a VM with a public IP address and link the service account you created to it:
   ...
   - CLI
     ...
     1. Select one of the [public images](../../compute/operations/images-with-pre-installed-software/get-list.md) with a Linux OS (for example, [CentOS 7]{% if lang == "ru" %}(https://cloud.yandex.ru/marketplace/products/f2esfplfav536pn90mdo){% endif %}{% if lang == "en" %}(https://cloud.yandex.com/en-ru/marketplace/products/f2esfplfav536pn90mdo){% endif %}).
