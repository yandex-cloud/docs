---
editable: false
sourcePath: en/_api-ref-grpc/containerregistry/v1/api-ref/grpc/Registry/updateAccessBindings.md
---

# Container Registry API, gRPC: RegistryService.UpdateAccessBindings
