        ...
        filter:
          description: |-
            **string**
            ...
            1. The field name. Currently you can use filtering only on [Registry.name](/docs/container-registry/api-ref/Registry/get#yandex.cloud.containerregistry.v1.Registry) field.
            2. An `=` operator.
