...
editable: false
apiPlayground:
  - url: https://cic.{{ api-host }}/cic/v1/publicConnections
    method: get
    path: null
    query:
      type: object
        ...
        pageSize:
          description: |-
            **string** (int64)
            ...
            the service returns a [ListPublicConnectionsResponse.nextPageToken](/docs/interconnect/api-ref/PublicConnection/list#yandex.cloud.cic.v1.ListPublicConnectionsResponse)
        ...
        pageToken:
          description: |-
            **string**
            ...
            [ListPublicConnectionsResponse.nextPageToken](/docs/interconnect/api-ref/PublicConnection/list#yandex.cloud.cic.v1.ListPublicConnectionsResponse) returned by a previous list request.
          type: string
        filter:
          description: |-
            **string**
