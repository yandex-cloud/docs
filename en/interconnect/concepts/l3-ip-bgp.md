...
Layer 3 of the [OSI model](https://en.wikipedia.org/wiki/OSI_model) determines IP connections inside the VLAN. IP connections are divided into [private](#private-connection) or [public](#public-connection) ones depending on the type of used IP addresses (private or public).
...
For a public connection, use the [NAT](https://en.wikipedia.org/wiki/Network_address_translation) technology on the client side. Options for implementing NAT:
