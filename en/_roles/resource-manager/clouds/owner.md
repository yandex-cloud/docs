...
It also allows you to manage linking the cloud to a [billing account](../../../billing/concepts/billing-account.md) (for that purpose, you also need permissions for that billing account). For more information on managing access to a billing account, see the [{{ billing-name }} documentation](../../../billing/security/index.md#billing-account).
