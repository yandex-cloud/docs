...
The `managed-postgresql.admin` role enables managing {{ PG }} clusters and access to them.

Users with this role can:
* View info on [access permissions](../../iam/concepts/access-control/index.md) granted for [{{ PG }} clusters](../../managed-postgresql/concepts/index.md) and modify such permissions.
* View info on {{ PG }} clusters, as well as create, use, modify, delete, run, and stop them.
