...
The `managed-metastore.admin` role allows you to manage {{ metastore-name }} clusters, as well as view their runtime logs and information on service quotas of {{ yandex-cloud }} managed DBs.
