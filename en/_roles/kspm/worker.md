The `kspm.worker` role allows the user to view info on {{ managed-k8s-name }} [clusters](../../managed-kubernetes/concepts/index.md#kubernetes-cluster) and install [{{ kspm-name }}](../../security-deck/concepts/kspm.md) components in them.
