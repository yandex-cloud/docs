...
The `cloud-router.prefixEditor` role enables managing cloud subnet IP prefixes in routing instances, as well as viewing info on {{ cr-name }} resources.
