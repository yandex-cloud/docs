...
The `cloud-registry.artifacts.puller` role enables pulling artifacts, as well as viewing info on artifacts and registries, on access permissions granted for registries, as well as on {{ cloud-registry-name }} quotas.
...
* View info on registry [lifecycle policies](../../../cloud-registry/concepts/lifecycle-policy.md).
