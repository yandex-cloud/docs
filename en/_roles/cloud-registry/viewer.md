...
The`cloud-registry.viewer` role enables pulling artifacts, as well as viewing info on artifacts and registries, on the access permissions granted to registries, and on the {{ cloud-registry-name }} quotas.
