...
The `cloud-registry.editor` role enables managing artifacts and registries, as well as viewing info on the access permissions granted to registries and {{ cloud-registry-name }} quotas.
