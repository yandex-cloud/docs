...
The `cloud-registry.auditor` role enables viewing the artifact metadata, the info on registries and access permissions granted to them, as well as on the {{ cloud-registry-name }} quotas.
