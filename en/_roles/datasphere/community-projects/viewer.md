...
In the {{ ml-platform-name }} interface, users with the `datasphere.community-projects.viewer` role have the `Viewer` role in the **Members** tab on the community page.
