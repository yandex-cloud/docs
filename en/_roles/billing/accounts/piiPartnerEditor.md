...
* [View](../../../partner/operations/get-client-stat.md) details on partner consumption, including partner [subaccounts](../../../partner/terms.md#sub-account).
* View the list of [partner bonuses](../../../partner/terms.md#partner-award).
...
In {{ billing-name }}, users with this role can [execute API queries](../../../billing/operations/get-charges-via-api.md) to get usage details.
