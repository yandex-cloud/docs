...
The `managed-spark.admin` role enables managing {{ SPRK }} clusters and access to them.

Users with this role can:
* View info on [access permissions](../../iam/concepts/access-control/index.md) granted for [{{ SPRK }} clusters](../../managed-spark/concepts/index.md) and modify such permissions.
* View info on {{ SPRK }} clusters, as well as create, modify, run, stop, and delete them.
