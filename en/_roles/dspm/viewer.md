The `dspm.viewer` role enables viewing info on {{ dspm-name }} resources, as well as on scan jobs and the number of detected security threats. With this role, you cannot view masked and unprocessed data.
