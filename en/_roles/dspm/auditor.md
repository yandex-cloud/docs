The `dspm.auditor` role enables viewing info on {{ dspm-name }} resources, as well as on scan jobs and the number of detected security threats. This role does not enable viewing masked and unprocessed data.
