...
The `backup.admin` role enables managing backup policies and access to them, managing the connection of target resources to {{ backup-name }}, taking backups, and restoring resources from the existing backups.
