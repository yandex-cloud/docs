...
* View info on virtual machines and {{ baremetal-name }} servers [connected](../../backup/concepts/vm-connection/index.md) to {{ backup-name }}, as well as connect and disconnect VMs and {{ baremetal-name }} servers to and from it.
