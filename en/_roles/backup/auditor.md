...
The `backup.auditor` role enables viewing information on target resources connected to {{ backup-name }}, on backup policies and service quotas, as well as on the relevant cloud and folder.
