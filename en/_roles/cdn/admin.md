...
The `cdn.admin` role enables managing {{ cdn-name }} resources, as well as viewing the info on quotas and the relevant folder.
...
* View information on {{ cdn-name }} [quotas](../../cdn/concepts/limits.md#cdn-quotas).
