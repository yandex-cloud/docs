...
The `managed-mongodb.admin` role enables managing {{ SD }} clusters and access to them.

Users with this role can:
* View info on [access permissions](../../iam/concepts/access-control/index.md) granted for [{{ SD }} clusters](../../storedoc/concepts/index.md) and modify such permissions.
* Create, use, modify, delete, run and stop {{ SD }} clusters and view info on them.
