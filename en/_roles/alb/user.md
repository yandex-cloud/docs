...
The `alb.user` role enables using L7 balancers, HTTP routers, backend groups, and target groups, as well as viewing info on the {{ alb-name }} resources.
...
* View info on the {{ alb-name }} [quotas](../../application-load-balancer/concepts/limits.md#quotas).
