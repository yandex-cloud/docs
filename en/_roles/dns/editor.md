...
The `dns.editor` role enables managing DNS zones and resource records, as well as viewing info on the relevant folder and {{ dns-name }} quotas.
...
* View information on {{ dns-name }} [quotas](../../dns/concepts/limits.md#cloud-dns-quotas).
