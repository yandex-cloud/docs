...
The `dns.admin` role enables managing DNS zones and access to them, and resource records, as well as viewing info on the relevant folder and {{ dns-name }} quotas.
