...
The `dataproc.user` role grants access to the {{ dataproc-name }} component web interfaces and enables creating jobs and viewing info on {{ yandex-cloud }} managed DB clusters.

{% cut "Users with this role can:" %}

* View info on {{ dataproc-name }} [clusters](../../data-proc/concepts/index.md#resources) and [jobs](../../data-proc/concepts/jobs.md), as well as create jobs.
