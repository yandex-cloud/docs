...
The `dataproc.admin` role allows you to manage {{ dataproc-name }} clusters, run jobs, and view information on them. It also grants access to the Data Processing component web interfaces.
