...
The `certificate-manager.editor` role enables managing certificates and viewing info on them, as well as on access permissions assigned to them, and on the {{ certificate-manager-name }} quotas.
