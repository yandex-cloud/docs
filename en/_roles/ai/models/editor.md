The `ai.models.editor` role enables managing the fine-tuning of {{ ai-studio-full-name }} models as well as using {{ translate-full-name }}, {{ vision-full-name }}, {{ speechkit-full-name }}, and {{ ai-studio-full-name }}.
...
* Use {{ translate-full-name }} to [translate texts]({{ link-docs-ai }}translate/concepts/).
