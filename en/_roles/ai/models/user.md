The `ai.models.user` role enables using AI agents, text and image generation models, text embedding models, and classifier models in {{ ai-studio-full-name }}, as well as employing {{ translate-full-name }}, {{ vision-full-name }}, and {{ speechkit-full-name }}.
