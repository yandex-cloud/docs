The `ai.models.admin` role enables managing the fine-tuning of Yandex AI Studio models as well as using Yandex Translate, Yandex Vision OCR, Yandex SpeechKit, and Yandex AI Studio.
