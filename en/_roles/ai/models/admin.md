The `ai.models.admin` role enables managing the fine-tuning of {{ ai-studio-full-name }} models as well as using {{ translate-full-name }}, {{ vision-full-name }}, {{ speechkit-full-name }}, and {{ ai-studio-full-name }}.
