The `ai.assistants.editor` role enables managing AI-driven assistants, their users and threads, as well as files with additional information and search indexes of those files.
