The `ai.admin` role enables using {{ translate-full-name }}, {{ vision-full-name }}, {{ speechkit-full-name }}, and {{ ai-studio-full-name }}.
...
* View info on [{{ translate-full-name }}]({{ link-docs-ai }}ai-studio/concepts/limits#yandexgpt-quotas), [{{ vision-full-name }}]({{ link-docs-ai }}ai-studio/concepts/limits#yandexgpt-quotas), [{{ speechkit-full-name }}]({{ link-docs-ai }}speechkit/concepts/limits#speechkit-quotas), and [{{ ai-studio-full-name }}]({{ link-docs-ai }}ai-studio/concepts/limits#yandexgpt-quotas) quotas.
