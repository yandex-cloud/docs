...
Field | Description
--- | ---
resource_preset_id | **string**<br>Required. Required. ID of the resource preset to return. To get the resource preset ID, use a [ResourcePresetService.List](#List) request. false
...
cores | **int64**<br>Number of CPU cores for a SQLServer host created with the preset. 
memory | **int64**<br>RAM volume for a SQLServer host created with the preset, in bytes. 
