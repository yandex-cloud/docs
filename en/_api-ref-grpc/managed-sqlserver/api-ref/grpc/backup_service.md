...
A set of methods for managing SQLServer backups.

| Call | Description |
| --- | --- |
| [Get](#Get) | Returns the specified SQLServer backup. |
| [List](#List) | Retrieves the list of SQLServer backups available for the specified folder. |

## Calls BackupService {#calls}

## Get {#Get}

Returns the specified SQLServer backup. <br>To get the list of available SQLServer backups, make a [List](#List) request.
...
source_cluster_id | **string**<br>ID of the SQLServer cluster that the backup was created for. 
...
Field | Description
--- | ---
folder_id | **string**<br>Required. ID of the folder to list backups in. To get the folder ID, use a [yandex.cloud.resourcemanager.v1alpha.FolderService.List] request. false The maximum string length in characters is 50.
...
Field | Description
--- | ---
backups[] | **[Backup](../backup.proto#Backup1)**<br>List of SQLServer backups. 
