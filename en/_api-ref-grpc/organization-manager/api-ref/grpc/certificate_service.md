...
Field | Description
--- | ---
federation_id | **string**<br>Required. ID of the federation to list certificates in. To get the federation ID make a [yandex.cloud.organizationmanager.v1.saml.FederationService.List](/docs/organization-manager/grpc/federation_service#List) request. The maximum string length in characters is 50.
...
Field | Description
--- | ---
federation_id | **string**<br>ID of the federation to add new certificate. To get the federation ID make a [yandex.cloud.organizationmanager.v1.saml.FederationService.List](/docs/organization-manager/grpc/federation_service#List) request. The maximum string length in characters is 50.
