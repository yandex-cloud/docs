...
permissions[] | **[Permission](../user.proto#Permission)**<br>Set of permissions granted to this user. 
...
Field | Description
--- | ---
users[] | **[User](../user.proto#User1)**<br>List of Kafka users. 
...
name | **string**<br>Name of the Kafka user. 
cluster_id | **string**<br>ID of the Apache Kafka® cluster the user belongs to. <br>To get the Apache Kafka® cluster ID, make a [ClusterService.List](./cluster_service#List) request. 
permissions[] | **[Permission](../user.proto#Permission1)**<br>Set of permissions granted to this user. 
...
user_spec | **[UserSpec](../user.proto#UserSpec)**<br>Required. Configuration of the user to create. false
...
permissions[] | **[Permission](../user.proto#Permission2)**<br>Set of permissions granted to the user. 
...
name | **string**<br>Name of the Kafka user. 
cluster_id | **string**<br>ID of the Apache Kafka® cluster the user belongs to. <br>To get the Apache Kafka® cluster ID, make a [ClusterService.List](./cluster_service#List) request. 
permissions[] | **[Permission](../user.proto#Permission3)**<br>Set of permissions granted to this user. 
...
name | **string**<br>Name of the Kafka user. 
cluster_id | **string**<br>ID of the Apache Kafka® cluster the user belongs to. <br>To get the Apache Kafka® cluster ID, make a [ClusterService.List](./cluster_service#List) request. 
permissions[] | **[Permission](../user.proto#Permission4)**<br>Set of permissions granted to this user. 
...
name | **string**<br>Name of the Kafka user. 
cluster_id | **string**<br>ID of the Apache Kafka® cluster the user belongs to. <br>To get the Apache Kafka® cluster ID, make a [ClusterService.List](./cluster_service#List) request. 
permissions[] | **[Permission](../user.proto#Permission5)**<br>Set of permissions granted to this user. 
...
name | **string**<br>Name of the Kafka user. 
cluster_id | **string**<br>ID of the Apache Kafka® cluster the user belongs to. <br>To get the Apache Kafka® cluster ID, make a [ClusterService.List](./cluster_service#List) request. 
permissions[] | **[Permission](../user.proto#Permission6)**<br>Set of permissions granted to this user. 
