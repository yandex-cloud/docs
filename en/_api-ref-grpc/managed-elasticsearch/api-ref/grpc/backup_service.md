...
A set of methods for managing ElasticSearch Backup resources.

| Call | Description |
| --- | --- |
| [Get](#Get) | Returns the specified ElasticSearch Backup resource. |
...
Returns the specified ElasticSearch Backup resource. <br>To get the list of available ElasticSearch Backup resources, make a [List](#List) request.
...
source_cluster_id | **string**<br>ID of the ElasticSearch cluster that the backup was created for. 
