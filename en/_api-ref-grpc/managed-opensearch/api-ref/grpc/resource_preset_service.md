...
zone_ids[] | **string**<br>IDs of the availability zones where the resource preset is available. 
cores | **int64**<br>Number of the CPU cores for an OpenSearch host created with the preset. 
memory | **int64**<br>RAM volume for an OpenSearch host created with the preset, in bytes. 
