...
static_routes[] | **[StaticRoute](../route_table.proto#StaticRoute)**<br>List of static routes. 
...
&nbsp;&nbsp;response | **[google.protobuf.Any](https://developers.google.com/protocol-buffers/docs/proto3#any)<[RouteTable](../route_table.proto#RouteTable2)>**<br>if operation finished successfully. 
...
result | **oneof:** `error` or `response`<br>The operation result. If `done == false` and there was no failure detected, neither `error` nor `response` is set. If `done == false` and there was a failure detected, `error` is set. If `done == true`, exactly one of `error` or `response` is set.
&nbsp;&nbsp;error | **[google.rpc.Status](https://cloud.google.com/tasks/docs/reference/rpc/google.rpc#status)**<br>The error result of the operation in case of failure or cancellation. 
&nbsp;&nbsp;response | **[google.protobuf.Any](https://developers.google.com/protocol-buffers/docs/proto3#any)<[RouteTable](../route_table.proto#RouteTable3)>**<br>if operation finished successfully. 
...
labels | **map<string,string>**<br>Resource labels as `` key:value `` pairs. Мaximum of 64 per resource. 
network_id | **string**<br>ID of the network the route table belongs to. 
static_routes[] | **[StaticRoute](../route_table.proto#StaticRoute4)**<br>List of static routes. 
...
Metadata and response of Operation:<br>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;Operation.response:[RouteTable](../route_table.proto#RouteTable4)<br>
...
result | **oneof:** `error` or `response`<br>The operation result. If `done == false` and there was no failure detected, neither `error` nor `response` is set. If `done == false` and there was a failure detected, `error` is set. If `done == true`, exactly one of `error` or `response` is set.
&nbsp;&nbsp;error | **[google.rpc.Status](https://cloud.google.com/tasks/docs/reference/rpc/google.rpc#status)**<br>The error result of the operation in case of failure or cancellation. 
&nbsp;&nbsp;response | **[google.protobuf.Any](https://developers.google.com/protocol-buffers/docs/proto3#any)<[RouteTable](../route_table.proto#RouteTable4)>**<br>if operation finished successfully. 
