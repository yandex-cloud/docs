...
| [Move](#Move) | Moves a Greenplum cluster to the specified folder. |
...
segment_host_count | **int64**<br>Number of hosts of the segment subcluster 
user_name | **string**<br>Owner user name 
user_password | **string**<br>Owner user password 
network_id | **string**<br>Required. ID of the network to create the cluster in. The maximum string length in characters is 50.
...
created_at | **[google.protobuf.Timestamp](https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#timestamp)**<br>Creation timestamp in [RFC3339](https://www.ietf.org/rfc/rfc3339.txt) text format. 
name | **string**<br>Required. Name of the Greenplum cluster. The name is unique within the folder. 1-63 characters long. The maximum string length in characters is 63.
config | **[GreenplumConfig](#GreenplumConfig6)**<br>Green plum cluster config 
description | **string**<br>Description of the Greenplum cluster. 0-256 characters long. 
labels | **map<string,string>**<br>Custom labels for the Greenplum cluster as `key:value` pairs. Maximum 64 per resource. 
environment | enum **Environment**<br>Deployment environment of the Greenplum cluster. <ul><li>`PRODUCTION`: Stable environment with a conservative update policy: only hotfixes are applied during regular maintenance.</li><li>`PRESTABLE`: Environment with more aggressive update policy: new versions are rolled out irrespective of backward compatibility.</li><ul/>
...
created_at | **[google.protobuf.Timestamp](https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#timestamp)**<br>Creation timestamp in [RFC3339](https://www.ietf.org/rfc/rfc3339.txt) text format. 
name | **string**<br>Required. Name of the Greenplum cluster. The name is unique within the folder. 1-63 characters long. The maximum string length in characters is 63.
config | **[GreenplumConfig](#GreenplumConfig7)**<br>Green plum cluster config 
description | **string**<br>Description of the Greenplum cluster. 0-256 characters long. 
labels | **map<string,string>**<br>Custom labels for the Greenplum cluster as `key:value` pairs. Maximum 64 per resource. 
environment | enum **Environment**<br>Deployment environment of the Greenplum cluster. <ul><li>`PRODUCTION`: Stable environment with a conservative update policy: only hotfixes are applied during regular maintenance.</li><li>`PRESTABLE`: Environment with more aggressive update policy: new versions are rolled out irrespective of backward compatibility.</li><ul/>
...
Field | Description
--- | ---
cluster_id | **string**<br>Required. ID of the Greenplum cluster to move. The maximum string length in characters is 50.
...
Field | Description
--- | ---
cluster_id | **string**<br>ID of the Greenplum cluster being moved. 
...
created_at | **[google.protobuf.Timestamp](https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#timestamp)**<br>Creation timestamp in [RFC3339](https://www.ietf.org/rfc/rfc3339.txt) text format. 
name | **string**<br>Required. Name of the Greenplum cluster. The name is unique within the folder. 1-63 characters long. The maximum string length in characters is 63.
config | **[GreenplumConfig](#GreenplumConfig8)**<br>Green plum cluster config 
description | **string**<br>Description of the Greenplum cluster. 0-256 characters long. 
labels | **map<string,string>**<br>Custom labels for the Greenplum cluster as `key:value` pairs. Maximum 64 per resource. 
environment | enum **Environment**<br>Deployment environment of the Greenplum cluster. <ul><li>`PRODUCTION`: Stable environment with a conservative update policy: only hotfixes are applied during regular maintenance.</li><li>`PRESTABLE`: Environment with more aggressive update policy: new versions are rolled out irrespective of backward compatibility.</li><ul/>
...
Field | Description
--- | ---
resources | **[Resources](#Resources16)**<br>Resources allocated to Greenplum master subcluster hosts. 
config | **[GreenplumMasterConfigSet](#GreenplumMasterConfigSet6)**<br>Configuration settings of a Greenplum master server. 
...
### GreenplumMasterConfigSet {#GreenplumMasterConfigSet6}

Field | Description
--- | ---
effective_config | **[GreenplumMasterConfig](#GreenplumMasterConfig8)**<br>Required. Effective settings for a Greenplum master subcluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumMasterConfig](#GreenplumMasterConfig8)**<br>User-defined settings for a Greenplum master subcluster. 
default_config | **[GreenplumMasterConfig](#GreenplumMasterConfig8)**<br>Default configuration for a Greenplum master subcluster. 


### GreenplumMasterConfig {#GreenplumMasterConfig8}
...
Field | Description
--- | ---
resources | **[Resources](#Resources17)**<br>Resources allocated to Greenplum segment subcluster hosts. 
config | **[GreenplumSegmentConfigSet](#GreenplumSegmentConfigSet6)**<br>Configuration settings of a Greenplum segment server. 
...
### GreenplumSegmentConfigSet {#GreenplumSegmentConfigSet6}

Field | Description
--- | ---
effective_config | **[GreenplumSegmentConfig](#GreenplumSegmentConfig8)**<br>Required. Effective settings for a Greenplum segment subcluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumSegmentConfig](#GreenplumSegmentConfig8)**<br>User-defined settings for a Greenplum segment subcluster. 
default_config | **[GreenplumSegmentConfig](#GreenplumSegmentConfig8)**<br>Default configuration for a Greenplum segment subcluster. 


### GreenplumSegmentConfig {#GreenplumSegmentConfig8}
...
Field | Description
--- | ---
cluster_id | **string**<br>Required. Required. ID of the Greenplum cluster to maintenance reschedule. The maximum string length in characters is 50.
...
Field | Description
--- | ---
cluster_id | **string**<br>Required. ID of the Greenplum cluster. 
...
created_at | **[google.protobuf.Timestamp](https://developers.google.com/protocol-buffers/docs/reference/google.protobuf#timestamp)**<br>Creation timestamp in [RFC3339](https://www.ietf.org/rfc/rfc3339.txt) text format. 
name | **string**<br>Required. Name of the Greenplum cluster. The name is unique within the folder. 1-63 characters long. The maximum string length in characters is 63.
config | **[GreenplumConfig](#GreenplumConfig9)**<br>Green plum cluster config 
description | **string**<br>Description of the Greenplum cluster. 0-256 characters long. 
labels | **map<string,string>**<br>Custom labels for the Greenplum cluster as `key:value` pairs. Maximum 64 per resource. 
environment | enum **Environment**<br>Deployment environment of the Greenplum cluster. <ul><li>`PRODUCTION`: Stable environment with a conservative update policy: only hotfixes are applied during regular maintenance.</li><li>`PRESTABLE`: Environment with more aggressive update policy: new versions are rolled out irrespective of backward compatibility.</li><ul/>
...
Field | Description
--- | ---
resources | **[Resources](#Resources18)**<br>Resources allocated to Greenplum master subcluster hosts. 
config | **[GreenplumMasterConfigSet](#GreenplumMasterConfigSet7)**<br>Configuration settings of a Greenplum master server. 
...
### GreenplumMasterConfigSet {#GreenplumMasterConfigSet7}

Field | Description
--- | ---
effective_config | **[GreenplumMasterConfig](#GreenplumMasterConfig9)**<br>Required. Effective settings for a Greenplum master subcluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumMasterConfig](#GreenplumMasterConfig9)**<br>User-defined settings for a Greenplum master subcluster. 
default_config | **[GreenplumMasterConfig](#GreenplumMasterConfig9)**<br>Default configuration for a Greenplum master subcluster. 


### GreenplumMasterConfig {#GreenplumMasterConfig9}
...
Field | Description
--- | ---
resources | **[Resources](#Resources19)**<br>Resources allocated to Greenplum segment subcluster hosts. 
config | **[GreenplumSegmentConfigSet](#GreenplumSegmentConfigSet7)**<br>Configuration settings of a Greenplum segment server. 
...
### GreenplumSegmentConfigSet {#GreenplumSegmentConfigSet7}

Field | Description
--- | ---
effective_config | **[GreenplumSegmentConfig](#GreenplumSegmentConfig9)**<br>Required. Effective settings for a Greenplum segment subcluster (a combination of settings defined in `user_config` and `default_config`). 
user_config | **[GreenplumSegmentConfig](#GreenplumSegmentConfig9)**<br>User-defined settings for a Greenplum segment subcluster. 
default_config | **[GreenplumSegmentConfig](#GreenplumSegmentConfig9)**<br>Default configuration for a Greenplum segment subcluster. 


### GreenplumSegmentConfig {#GreenplumSegmentConfig9}
...
Field | Description
--- | ---
cluster_id | **string**<br>Required. Required. ID of the Greenplum cluster. The maximum string length in characters is 50.
column_filter[] | **string**<br>Columns from logs table to get in the response. 
service_type | enum **ServiceType**<br> <ul><li>`GREENPLUM`: Logs of Greenplum activity.</li><ul/>
...
Field | Description
--- | ---
operations[] | **[operation.Operation](#Operation7)**<br>List of Operation resources for the specified Greenplum cluster. 
...
resources | **[Resources](#Resources20)**<br>Resources allocated to the Greenplum host. 
...
zone_id | **string**<br>ID of the availability zone where the Greenplum host resides. 
type | enum **Type**<br>Type of the host. <ul><li>`MASTER`: Greenplum master host.</li><li>`REPLICA`: Greenplum master host.</li><li>`SEGMENT`: Greenplum segment host.</li><ul/>
resources | **[Resources](#Resources21)**<br>Resources allocated to the Greenplum host. 
health | enum **Health**<br>Status code of the aggregated health of the host. <ul><li>`UNKNOWN`: Health of the host is unknown.</li><li>`ALIVE`: The host is performing all its functions normally.</li><li>`DEAD`: The host is inoperable, and cannot perform any of its essential functions.</li><li>`DEGRADED`: The host is working below capacity or not fully functional.</li><ul/>
subnet_id | **string**<br>ID of the subnet that the host belongs to. 
assign_public_ip | **bool**<br>Flag showing public IP assignment status to this host. 
