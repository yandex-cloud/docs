...
name | **string**<br>Name of the disk. Value must match the regular expression ` |[a-z][-a-z0-9]{1,61}[a-z0-9] `.
...
size | **int64**<br>Required. Size of the disk, specified in bytes. If the disk was created from a image, this value should be more than the `yandex.cloud.compute.v1.Image.min_disk_size` value.  Acceptable values are 4194304 to 4398046511104, inclusive.
