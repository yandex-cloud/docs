...
`yc serverless api-gateway add-domain <API-GATEWAY-NAME>|<API-GATEWAY-ID> {--domain-id <DOMAIN-ID> | --domain <DOMAIN> --certificate-id <CERTIFICATE-ID>} [Flags...] [Global Flags...]`
...
|`--domain-id`|<b>`string`</b><br/>Id of attaching domain. Deprecated: use domain and certificate-id instead.|
