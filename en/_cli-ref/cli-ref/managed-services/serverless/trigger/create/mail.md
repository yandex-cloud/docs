...
|`--gateway-id`|<b>`string`</b><br/>Gateway to which worker will broadcast on receiving email.|
|`--gateway-name`|<b>`string`</b><br/>Gateway to which worker will broadcast on receiving email.|
