...
|`--invoke-container-id`|<b>`string`</b><br/>Container to be invoked by worker on each Timer event.|
|`--invoke-container-name`|<b>`string`</b><br/>Container to be invoked by worker on each Timer event.|
...
|`--gateway-id`|<b>`string`</b><br/>Gateway to which worker will broadcast on each Timer event.|
|`--gateway-name`|<b>`string`</b><br/>Gateway to which worker will broadcast on each Timer event.|
