...
|`--gateway-id`|<b>`string`</b><br/>Gateway to which worker will broadcast on the data from Logging.|
|`--gateway-name`|<b>`string`</b><br/>Gateway to which worker will broadcast on the data from Logging.|
