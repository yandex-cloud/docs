...
|`--main-jar-file-uri`|<b>`string`</b><br/>Mai JAR file URI --jar-file-uris value[,value]   JAR file URIs --file-uris value[,value]       File URIs --archive-uris value[,value]    Archive URIs|
