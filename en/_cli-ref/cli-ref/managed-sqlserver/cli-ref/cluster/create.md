...
Descriptions of database users to be created in the SQLServer cluster.

Possible property names:

- `name`: Name of the SQLServer user.

- `password`: Password of the SQLServer user. ||
...
- `name`: Name of the SQLServer database. ||
