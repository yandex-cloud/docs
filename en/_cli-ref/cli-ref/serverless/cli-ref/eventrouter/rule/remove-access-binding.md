...
# yc serverless eventrouter rule remove-access-binding

Remove access binding for the specified rule

#### Command Usage

Syntax: 

`yc serverless eventrouter rule remove-access-binding <RULE-NAME>|<RULE-ID> [Flags...] [Global Flags...]`
