...
> 
> Total: {% calc [currency=USD] (1500 + 700 - 1000) / 1000 × {{ sku|USD|cns.notification_events.push_event.v2|pricingRate.1|number }} %}, i.e., cost of sending 2,200 push notifications per month.
...
* {{ sku|USD|cns.notification_events.push_event.v2|pricingRate.1|string }}: Cost of processing 1,000 {{ cns-short-name }} push notification events, from 1,000 to 500,000 notifications per month.