...
* 1,024 × 1,024 × 10: Amount of data to recover, in KB.
...
>
> Total: {% calc [currency=USD] (5242880 - 1000000) / 1000000 × {{ sku|USD|ydb.v1.serverless.requests|pricingRate.1|number }} %}, cost of recovering 10 GB of data from a backup.
