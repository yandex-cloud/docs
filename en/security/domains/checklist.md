...
- **OS-level protection**: Install antivirus solutions from [{{ marketplace-full-name }}](/marketplace?categories=security) on VMs.
...
- **Network-level protection**: Use NGFW/IDS/IPS available in [{{ marketplace-full-name }}](/marketplace?categories=security) (some of them have built-in sandboxes).
