---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/kms/cli-ref/asymmetric-encryption-key/update/
---
...
New name of an asymmetric encryption key. ||
|| `--description` | `string`

New description of an asymmetric encryption key. ||
|| `--status` | `string`

New status of a asymmetric encryption key. Values: 'creating', 'active', 'inactive' ||
