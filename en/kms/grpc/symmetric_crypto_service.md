...
Field | Description
--- | ---
key_id | **string**<br>Required. ID of the symmetric KMS key to use for encryption. false The maximum string length in characters is 50.
...
plaintext | **bytes**<br>Required. Plaintext to be encrypted. Should be encoded with base64. false The maximum string length in characters is 32768.
...
Field | Description
--- | ---
key_id | **string**<br>Required. ID of the symmetric KMS key that was used for encryption. false The maximum string length in characters is 50.
...
Field | Description
--- | ---
key_id | **string**<br>Required. ID of the symmetric KMS key to use for decryption. false The maximum string length in characters is 50.
aad_context | **bytes**<br>Additional authenticated data, must be the same as was provided in the corresponding [SymmetricEncryptRequest](#SymmetricEncryptRequest1). Should be encoded with base64. The maximum string length in characters is 8192.
ciphertext | **bytes**<br>Required. Ciphertext to be decrypted. Should be encoded with base64. false
...
Field | Description
--- | ---
key_id | **string**<br>Required. ID of the new key to be used for encryption. false The maximum string length in characters is 50.
...
source_key_id | **string**<br>Required. ID of the key that the ciphertext is currently encrypted with. May be the same as for the new key. false The maximum string length in characters is 50.
...
ciphertext | **bytes**<br>Required. Ciphertext to re-encrypt. Should be encoded with base64. false
...
Field | Description
--- | ---
key_id | **string**<br>Required. ID of the symmetric KMS key that the generated data key should be encrypted with. false The maximum string length in characters is 50.
...
aad_context | **bytes**<br>Additional authenticated data (AAD context), optional. If specified, this data will be required for decryption with the [SymmetricDecryptRequest](#SymmetricDecryptRequest1). Should be encoded with base64. The maximum string length in characters is 8192.
...
data_key_plaintext | **bytes**<br>Generated data key as plaintext. The field is empty, if the [GenerateDataKeyRequest.skip_plaintext](#GenerateDataKeyRequest1) parameter was set to `true`. 
