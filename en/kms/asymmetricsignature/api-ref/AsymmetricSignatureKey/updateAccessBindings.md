...
editable: false
apiPlayground:
  - url: https://{{ api-host-kms }}/kms/v1/asymmetricSignatureKeys/{resourceId}:updateAccessBindings
    method: post
    path:
      type: object
      properties:
...
```
POST https://{{ api-host-kms }}/kms/v1/asymmetricSignatureKeys/{resourceId}:updateAccessBindings
```
