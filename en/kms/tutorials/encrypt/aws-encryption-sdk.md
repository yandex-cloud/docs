...
Create a {% if product == "yandex-cloud" %}{{ yandex-cloud }} {% endif %}provider for the AWS Encryption SDK and use the methods of the [AwsCrypto](https://aws.github.io/aws-encryption-sdk-java/com/amazonaws/encryptionsdk/AwsCrypto.html) class to encrypt and decrypt data.
...
* [The {% if product == "yandex-cloud" %}{{ yandex-cloud }} {% endif %}provider for the AWS Encryption SDK](https://github.com/yandex-cloud/kms-clients-java/tree/master/kms-provider-awsCrypto).
