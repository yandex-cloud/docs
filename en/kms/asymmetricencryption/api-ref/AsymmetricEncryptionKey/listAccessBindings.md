...
editable: false
apiPlayground:
  - url: https://{{ api-host-kms }}/kms/v1/asymmetricEncryptionKeys/{resourceId}:listAccessBindings
    method: get
    path:
      type: object
      properties:
...
```
GET https://{{ api-host-kms }}/kms/v1/asymmetricEncryptionKeys/{resourceId}:listAccessBindings
```
