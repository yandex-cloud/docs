...
editable: false
apiPlayground:
  - url: https://{{ api-host-kms }}/kms/v1/asymmetricEncryptionKeys/{resourceId}:setAccessBindings
    method: post
    path:
      type: object
      properties:
...
```
POST https://{{ api-host-kms }}/kms/v1/asymmetricEncryptionKeys/{resourceId}:setAccessBindings
```
