...
The key and its versions appear absent in [SymmetricKeyService.Get](/docs/kms/api-ref/SymmetricKey/get#Get) and [SymmetricKeyService.List](/docs/kms/api-ref/SymmetricKey/list#List)
