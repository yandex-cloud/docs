...
editable: false
apiPlayground:
  - url: https://{{ api-host-kms }}/kms/v1/keys/{keyId}:setPrimaryVersion
    method: post
    path:
      type: object
      properties:
        keyId:
          description: |-
            **string**
            Required field. ID of the key to set a primary version for.
          type: string
      required:
        - keyId
    ...
    body:
      ...
      properties:
        versionId:
          description: |-
            **string**
            Required field. ID of the version that should become primary for the specified key.
          type: string
      required:
        - versionId
      additionalProperties: false
...
## Body parameters {#yandex.cloud.kms.v1.SetPrimarySymmetricKeyVersionRequest}
...
|| metadata | **[SetPrimarySymmetricKeyVersionMetadata](#yandex.cloud.kms.v1.SetPrimarySymmetricKeyVersionMetadata)**
...
## SetPrimarySymmetricKeyVersionMetadata {#yandex.cloud.kms.v1.SetPrimarySymmetricKeyVersionMetadata}
