---
editable: false
sourcePath: en/_api-ref-grpc/kms/v1/api-ref/grpc/SymmetricKey/delete.md
---
...
The key and its versions appear absent in [SymmetricKeyService.Get](/docs/kms/api-ref/grpc/SymmetricKey/get#Get) and [SymmetricKeyService.List](/docs/kms/api-ref/grpc/SymmetricKey/list#List)
requests, but can be restored within 72 hours with a request to tech support.

## gRPC request

**rpc Delete ([DeleteSymmetricKeyRequest](#yandex.cloud.kms.v1.DeleteSymmetricKeyRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## DeleteSymmetricKeyRequest {#yandex.cloud.kms.v1.DeleteSymmetricKeyRequest}
...
|| metadata | **[DeleteSymmetricKeyMetadata](#yandex.cloud.kms.v1.DeleteSymmetricKeyMetadata)**
...
## DeleteSymmetricKeyMetadata {#yandex.cloud.kms.v1.DeleteSymmetricKeyMetadata}
