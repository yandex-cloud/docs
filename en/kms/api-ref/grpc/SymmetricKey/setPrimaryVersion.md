---
editable: false
sourcePath: en/_api-ref-grpc/kms/v1/api-ref/grpc/SymmetricKey/setPrimaryVersion.md
---

# Key Management Service API, gRPC: SymmetricKeyService.SetPrimaryVersion {#SetPrimaryVersion}
