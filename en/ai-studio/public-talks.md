...
* How to apply AI agents to specific business tasks. Click [here](https://www.youtube.com/watch?v=VJKQjFYR2b4) to watch the video.
* Workshop: How to create a multi-agent system in {{ ai-studio-full-name }}. Click [here](https://www.youtube.com/watch?v=Iyf17k0Hf2M) to watch the video.
* How to {{ ai-studio-full-name }}:
	* Platform overview. Click [here](https://www.youtube.com/watch?v=tkGHcxDWbSA) to watch the video.
	* How to create a simple text agent. Click [here](https://www.youtube.com/watch?v=KY4fd3HaUNM) to watch the video.
    * How to create a simple voice agent. Click [here](https://www.youtube.com/watch?v=bCwuFFHTKME) to watch the video.
* {{ ai-studio-name }} Series:  
    * Introduction to agents and multi-agent systems. Click [here](https://www.youtube.com/watch?v=lq8dSaF5CaQ) to watch the video.
    * How to build an agent in Workflows for document processing with OCR and VLM. Click [here](https://www.youtube.com/watch?v=f0jBqF7_Ev0) to watch the video.
    * How to create and deploy an AI agent: from scratch to production. Click [here](https://www.youtube.com/watch?v=_MU5wK_FgZg) to watch the video.
    * How to create a voice agent. Click [here](https://www.youtube.com/watch?v=JAcaGNmgG2U) to watch the video.
...
* From a small workshop to an ML factory: how we rebuilt {{ ai-studio-full-name }}. Read [our article](https://habr.com/ru/companies/yandex/articles/949884/).
