...
1. Added the generation of images based on a text description. The {{ yandexart-name }} model works in asynchronous mode and is available in the management console in [AI Playground]({{ link-console-main }}/link//ml/ai-studio/playground) and via the [API](../image-generation/api-ref/index.md). 
