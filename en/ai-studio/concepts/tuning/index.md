...
description: With {{ foundation-models-full-name }}, you can tune the {{ gpt-lite }} text generation model and {{ gpt-lite }}-based classifiers using the {{ lora }} method.
---

# Model tuning

With {{ foundation-models-full-name }}, you can tune the {{ gpt-lite }} text generation model, {{ gpt-lite }}-based [classifiers](../classifier/index.md), and the [embedding](../embeddings.md) model using the [{{ lora }}](https://arxiv.org/abs/2106.09685) (_Low-Rank Adaptation of Large Language Models_) method.
