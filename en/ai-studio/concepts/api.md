...
| [Realtime API](./agents/realtime.md) | WebSocket | Low-latency streaming generation of text and audio for voice-input scenarios |
...
| [Vector Store API](../vectorStores/index.md) | REST | Data indexing and extraction for RAG |
...
{{ yandex-cloud }} APIs are based on gRPC. The API methods and data structures are described using Protocol Buffers (proto 3).
...
| API | Technology | Description |
|---|---|---|
| Text Generation API     | [gRPC](../text-generation/api-ref/grpc/index.md)</br>[REST](../text-generation/api-ref/index.md) | Prompt-based text generation, function calling, structured response |
...
| Tuning API | [gRPC](../tuning/api-ref/grpc/index.md) | Domain-based model fine-tuning |
