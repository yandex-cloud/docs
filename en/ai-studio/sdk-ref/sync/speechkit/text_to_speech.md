...
## *class* yandex\_cloud\_ml\_sdk.\_speechkit.text\_to\_speech.function.**TextToSpeechFunction**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.function.TextToSpeechFunction}

Text to Speech function for creating synthesis object which provides methods for invoking voice synthesizing.

**\_\_call\_\_**(*<span title="Keyword-only parameters separator (PEP 3102)">\*</span>*, *loudness\_normalization=Undefined*, *audio\_format=Undefined*, *model=Undefined*, *voice=Undefined*, *role=Undefined*, *speed=Undefined*, *volume=Undefined*, *pitch\_shift=Undefined*, *duration\_ms=Undefined*, *duration\_min\_ms=Undefined*, *duration\_max\_ms=Undefined*, *single\_chunk\_mode=Undefined*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.function.TextToSpeechFunction.__call__i}
...
## *class* yandex\_cloud\_ml\_sdk.\_speechkit.text\_to\_speech.tts.**TextToSpeech**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech}
...
**run**(*input*, *<span title="Keyword-only parameters separator (PEP 3102)">\*</span>*, *timeout=60*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.run}
...
**run\_stream**(*input*, *<span title="Keyword-only parameters separator (PEP 3102)">\*</span>*, *timeout=60*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.run_stream}
...
- **input** ([*str*](https://docs.python.org/3/library/stdtypes.html#str)) ||
|| Returns | synthesis result; joined in case of >1 chunks in synthesis response. ||
|| Return type | [*Iterator*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Iterator)[[*TextToSpeechResult*](../../types/speechkit.md#yandex_cloud_ml_sdk._speechkit.text_to_speech.result.TextToSpeechResult)] ||
|#

#### *class* **AudioFormat**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.AudioFormat}

*classmethod* **Unknown**(*name*, *value*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.AudioFormat.Unknown}
...
**\_\_new\_\_**(*value*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.AudioFormat.__new__i}

**conjugate**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.AudioFormat.conjugate}

Returns self, the complex conjugate of any int.

**bit\_length**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.AudioFormat.bit_length}
...
**bit\_count**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.AudioFormat.bit_count}
...
**as\_integer\_ratio**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.AudioFormat.as_integer_ratio}
...
**is\_integer**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.AudioFormat.is_integer}

Returns True. Exists for duck type compatibility with float.is\_integer.

**real**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.AudioFormat.real}

the real part of a complex number

**imag**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.AudioFormat.imag}

the imaginary part of a complex number

**numerator**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.AudioFormat.numerator}

the numerator of a rational number in lowest terms

**denominator**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.AudioFormat.denominator}

the denominator of a rational number in lowest terms

*classmethod* **PCM16**(*sample\_rate\_hertz*, *channels=1*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.AudioFormat.PCM16}
...
**MP3** = *3*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.AudioFormat.MP3}

Data is encoded using MPEG-1/2 Layer III and compressed using the MP3 container format

**WAV** = *1*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.AudioFormat.WAV}

Audio bit depth 16-bit signed little-endian (Linear PCM) paked into WAV container format

**OGG\_OPUS** = *2*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.AudioFormat.OGG_OPUS}

Data is encoded using the OPUS audio codec and compressed using the OGG container format

**\_\_init\_\_**(*\*args*, *\*\*kwds*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.AudioFormat.__init__i}

#### *class* **LoudnessNormalization**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.LoudnessNormalization}

*classmethod* **Unknown**(*name*, *value*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.LoudnessNormalization.Unknown}
...
**\_\_new\_\_**(*value*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.LoudnessNormalization.__new__i}

**conjugate**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.LoudnessNormalization.conjugate}

Returns self, the complex conjugate of any int.

**bit\_length**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.LoudnessNormalization.bit_length}
...
**bit\_count**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.LoudnessNormalization.bit_count}
...
**as\_integer\_ratio**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.LoudnessNormalization.as_integer_ratio}
...
**is\_integer**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.LoudnessNormalization.is_integer}

Returns True. Exists for duck type compatibility with float.is\_integer.

**real**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.LoudnessNormalization.real}

the real part of a complex number

**imag**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.LoudnessNormalization.imag}

the imaginary part of a complex number

**numerator**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.LoudnessNormalization.numerator}

the numerator of a rational number in lowest terms

**denominator**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.LoudnessNormalization.denominator}

the denominator of a rational number in lowest terms

**MAX\_PEAK** = *1*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.LoudnessNormalization.MAX_PEAK}
...
**LUFS** = *2*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.LoudnessNormalization.LUFS}

The type of normalization based on EBU R 128 recommendation

**\_\_init\_\_**(*\*args*, *\*\*kwds*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.LoudnessNormalization.__init__i}

**\_\_init\_\_**(*<span title="Keyword-only parameters separator (PEP 3102)">\*</span>*, *sdk*, *uri*, *config=None*, *owner=None*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.__init__i}
...
*property* **config**\: *[ConfigTypeT](../../types/other.md#yandex_cloud_ml_sdk._types.model_config.ConfigTypeT)*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.config}

**configure**(*<span title="Keyword-only parameters separator (PEP 3102)">\*</span>*, *loudness\_normalization=Undefined*, *audio\_format=Undefined*, *model=Undefined*, *voice=Undefined*, *role=Undefined*, *speed=Undefined*, *volume=Undefined*, *pitch\_shift=Undefined*, *duration\_ms=Undefined*, *duration\_min\_ms=Undefined*, *duration\_max\_ms=Undefined*, *single\_chunk\_mode=Undefined*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.configure}
...
**create\_bistream**(*<span title="Keyword-only parameters separator (PEP 3102)">\*</span>*, *timeout=600*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.create_bistream}
...
*property* **fine\_tuned**\: *[bool](https://docs.python.org/3/library/functions.html#bool) | [None](https://docs.python.org/3/library/constants.html#None)*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.fine_tuned}

*property* **name**\: *[str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.name}

*property* **owner**\: *[str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.owner}

*property* **uri**\: *[str](https://docs.python.org/3/library/stdtypes.html#str)*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.uri}

*property* **version**\: *[str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.TextToSpeech.version}

## *class* yandex\_cloud\_ml\_sdk.\_speechkit.text\_to\_speech.bistream.**TTSBidirectionalStream**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.bistream.TTSBidirectionalStream}

Bidirectional SpeechKit TTS API which allows to write requests and read synthesized result in realtime

**write**(*input*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.bistream.TTSBidirectionalStream.write}
...
**read**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.bistream.TTSBidirectionalStream.read}
...
**gen**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.bistream.TTSBidirectionalStream.gen}

Returns generator over all synthesized result parts.

#|
|| Return type | [*Generator*](https://docs.python.org/3/library/collections.abc.html#collections.abc.Generator)[[*TextToSpeechResult*](../../types/speechkit.md#yandex_cloud_ml_sdk._speechkit.text_to_speech.result.TextToSpeechResult)] ||
|#

**done\_writing**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.bistream.TTSBidirectionalStream.done_writing}
...
**flush**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.bistream.TTSBidirectionalStream.flush}
