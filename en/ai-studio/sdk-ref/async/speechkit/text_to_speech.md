---
sourcePath: en/_sdk-ref/sdk-ref/async/speechkit/text_to_speech.md
---
# Domain

## *class* yandex\_cloud\_ml\_sdk.\_speechkit.text\_to\_speech.function.**AsyncTextToSpeechFunction**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.function.AsyncTextToSpeechFunction}

Text to Speech function for creating synthesis object which provides methods for invoking voice synthesizing.

**\_\_call\_\_**(*<span title="Keyword-only parameters separator (PEP 3102)">\*</span>*, *loudness\_normalization=Undefined*, *audio\_format=Undefined*, *model=Undefined*, *voice=Undefined*, *role=Undefined*, *speed=Undefined*, *volume=Undefined*, *pitch\_shift=Undefined*, *duration\_ms=Undefined*, *duration\_min\_ms=Undefined*, *duration\_max\_ms=Undefined*, *single\_chunk\_mode=Undefined*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.function.AsyncTextToSpeechFunction.__call__i}
...
## *class* yandex\_cloud\_ml\_sdk.\_speechkit.text\_to\_speech.tts.**AsyncTextToSpeech**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech}

*async* **run**(*input*, *<span title="Keyword-only parameters separator (PEP 3102)">\*</span>*, *timeout=60*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.run}
...
|| Return type | [*TextToSpeechResult*](../../types/speechkit.md#yandex_cloud_ml_sdk._speechkit.text_to_speech.result.TextToSpeechResult) ||
|#

*async* **run\_stream**(*input*, *<span title="Keyword-only parameters separator (PEP 3102)">\*</span>*, *timeout=60*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.run_stream}
...
|| Return type | [*AsyncIterator*](https://docs.python.org/3/library/collections.abc.html#collections.abc.AsyncIterator)[[*TextToSpeechResult*](../../types/speechkit.md#yandex_cloud_ml_sdk._speechkit.text_to_speech.result.TextToSpeechResult)] ||
|#

#### *class* **AudioFormat**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.AudioFormat}

*classmethod* **Unknown**(*name*, *value*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.AudioFormat.Unknown}
...
**\_\_new\_\_**(*value*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.AudioFormat.__new__i}

**conjugate**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.AudioFormat.conjugate}

Returns self, the complex conjugate of any int.

**bit\_length**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.AudioFormat.bit_length}
...
**bit\_count**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.AudioFormat.bit_count}
...
**as\_integer\_ratio**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.AudioFormat.as_integer_ratio}
...
**is\_integer**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.AudioFormat.is_integer}

Returns True. Exists for duck type compatibility with float.is\_integer.

**real**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.AudioFormat.real}

the real part of a complex number

**imag**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.AudioFormat.imag}

the imaginary part of a complex number

**numerator**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.AudioFormat.numerator}

the numerator of a rational number in lowest terms

**denominator**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.AudioFormat.denominator}

the denominator of a rational number in lowest terms

*classmethod* **PCM16**(*sample\_rate\_hertz*, *channels=1*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.AudioFormat.PCM16}
...
**MP3** = *3*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.AudioFormat.MP3}

Data is encoded using MPEG-1/2 Layer III and compressed using the MP3 container format

**WAV** = *1*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.AudioFormat.WAV}

Audio bit depth 16-bit signed little-endian (Linear PCM) paked into WAV container format

**OGG\_OPUS** = *2*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.AudioFormat.OGG_OPUS}

Data is encoded using the OPUS audio codec and compressed using the OGG container format

**\_\_init\_\_**(*\*args*, *\*\*kwds*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.AudioFormat.__init__i}

#### *class* **LoudnessNormalization**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.LoudnessNormalization}

*classmethod* **Unknown**(*name*, *value*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.LoudnessNormalization.Unknown}
...
**\_\_new\_\_**(*value*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.LoudnessNormalization.__new__i}

**conjugate**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.LoudnessNormalization.conjugate}

Returns self, the complex conjugate of any int.

**bit\_length**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.LoudnessNormalization.bit_length}
...
**bit\_count**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.LoudnessNormalization.bit_count}
...
**as\_integer\_ratio**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.LoudnessNormalization.as_integer_ratio}
...
**is\_integer**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.LoudnessNormalization.is_integer}

Returns True. Exists for duck type compatibility with float.is\_integer.

**real**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.LoudnessNormalization.real}

the real part of a complex number

**imag**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.LoudnessNormalization.imag}

the imaginary part of a complex number

**numerator**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.LoudnessNormalization.numerator}

the numerator of a rational number in lowest terms

**denominator**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.LoudnessNormalization.denominator}

the denominator of a rational number in lowest terms

**MAX\_PEAK** = *1*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.LoudnessNormalization.MAX_PEAK}
...
**LUFS** = *2*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.LoudnessNormalization.LUFS}

The type of normalization based on EBU R 128 recommendation

**\_\_init\_\_**(*\*args*, *\*\*kwds*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.LoudnessNormalization.__init__i}

**\_\_init\_\_**(*<span title="Keyword-only parameters separator (PEP 3102)">\*</span>*, *sdk*, *uri*, *config=None*, *owner=None*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.__init__i}

#|
|| Parameters | 

- **sdk** ([*yandex\_cloud\_ml\_sdk.\_sdk.BaseSDK*](../../internals/bases.md#yandex_cloud_ml_sdk._sdk.BaseSDK))
...
*property* **config**\: *[ConfigTypeT](../../types/other.md#yandex_cloud_ml_sdk._types.model_config.ConfigTypeT)*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.config}

**configure**(*<span title="Keyword-only parameters separator (PEP 3102)">\*</span>*, *loudness\_normalization=Undefined*, *audio\_format=Undefined*, *model=Undefined*, *voice=Undefined*, *role=Undefined*, *speed=Undefined*, *volume=Undefined*, *pitch\_shift=Undefined*, *duration\_ms=Undefined*, *duration\_min\_ms=Undefined*, *duration\_max\_ms=Undefined*, *single\_chunk\_mode=Undefined*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.configure}
...
**create\_bistream**(*<span title="Keyword-only parameters separator (PEP 3102)">\*</span>*, *timeout=600*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.create_bistream}
...
*property* **fine\_tuned**\: *[bool](https://docs.python.org/3/library/functions.html#bool) | [None](https://docs.python.org/3/library/constants.html#None)*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.fine_tuned}

*property* **name**\: *[str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.name}

*property* **owner**\: *[str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.owner}

*property* **uri**\: *[str](https://docs.python.org/3/library/stdtypes.html#str)*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.uri}

*property* **version**\: *[str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)*{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTextToSpeech.version}

## *class* yandex\_cloud\_ml\_sdk.\_speechkit.text\_to\_speech.tts.**AsyncTTSBidirectionalStream**{#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTTSBidirectionalStream}

Bidirectional SpeechKit TTS API which allows to write requests and read synthesized result in realtime

*async* **write**(*input*){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTTSBidirectionalStream.write}
...
*async* **read**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTTSBidirectionalStream.read}
...
#|
|| Return type | [*TextToSpeechResult*](../../types/speechkit.md#yandex_cloud_ml_sdk._speechkit.text_to_speech.result.TextToSpeechResult) \| None ||
|#

*async* **gen**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTTSBidirectionalStream.gen}

Returns generator over all synthesized result parts.

#|
|| Return type | [*AsyncGenerator*](https://docs.python.org/3/library/collections.abc.html#collections.abc.AsyncGenerator)[[*TextToSpeechResult*](../../types/speechkit.md#yandex_cloud_ml_sdk._speechkit.text_to_speech.result.TextToSpeechResult)] ||
|#

*async* **done\_writing**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTTSBidirectionalStream.done_writing}
...
*async* **flush**(){#yandex_cloud_ml_sdk._speechkit.text_to_speech.tts.AsyncTTSBidirectionalStream.flush}
