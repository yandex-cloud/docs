...
*async* **run**(*text*, *<span title="Keyword-only parameters separator (PEP 3102)">\*</span>*, *timeout=60*, *dimensions=Undefined*){#yandex_cloud_ml_sdk._models.text_embeddings.model.AsyncTextEmbeddingsModel.run}
...
- **dimensions** ([*int*](https://docs.python.org/3/library/functions.html#int) *\|* [*Undefined*](../../types/other.md#yandex_cloud_ml_sdk._types.misc.Undefined)) – the dimensions of output vector ||
...
*property* **config**\: *[ConfigTypeT](../../types/other.md#yandex_cloud_ml_sdk._types.model_config.ConfigTypeT)*{#yandex_cloud_ml_sdk._models.text_embeddings.model.AsyncTextEmbeddingsModel.config}

**configure**(*<span title="Keyword-only parameters separator (PEP 3102)">\*</span>*, *dimensions=Undefined*){#yandex_cloud_ml_sdk._models.text_embeddings.model.AsyncTextEmbeddingsModel.configure}

This method calls the parent class’s configure method and returns the configured model instance.

#|
|| Parameters | **dimensions** ([*int*](https://docs.python.org/3/library/functions.html#int) *\|* [*Undefined*](../../types/other.md#yandex_cloud_ml_sdk._types.misc.Undefined)) – the dimensions of output vector ||
|| Return type | [*Self*](https://docs.python.org/3/library/typing.html#typing.Self) ||
|#

*property* **fine\_tuned**\: *[bool](https://docs.python.org/3/library/functions.html#bool) | [None](https://docs.python.org/3/library/constants.html#None)*{#yandex_cloud_ml_sdk._models.text_embeddings.model.AsyncTextEmbeddingsModel.fine_tuned}

*property* **name**\: *[str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)*{#yandex_cloud_ml_sdk._models.text_embeddings.model.AsyncTextEmbeddingsModel.name}

*property* **owner**\: *[str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)*{#yandex_cloud_ml_sdk._models.text_embeddings.model.AsyncTextEmbeddingsModel.owner}
...
*property* **version**\: *[str](https://docs.python.org/3/library/stdtypes.html#str) | [None](https://docs.python.org/3/library/constants.html#None)*{#yandex_cloud_ml_sdk._models.text_embeddings.model.AsyncTextEmbeddingsModel.version}