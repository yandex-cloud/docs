...
Setting up a backup connection from {{ yandex-cloud }} to the customer's infrastructure involves deploying an IPsec VPN gateway in the `{{ region-id }}-b` [availability zone](../../overview/concepts/geo-scope.md) and configuring static routing within the VPC.
