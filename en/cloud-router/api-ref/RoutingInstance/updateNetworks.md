...
editable: false
apiPlayground:
  - url: https://cloudrouter.{{ api-host }}/cloudrouter/v1/routingInstances/{routingInstanceId}:updateNetworks
    method: post
    path:
      type: object
      properties:
...
# Cloud Router API, REST: RoutingInstance.UpdateNetworks
...
```
POST https://cloudrouter.{{ api-host }}/cloudrouter/v1/routingInstances/{routingInstanceId}:updateNetworks
```
...
## Body parameters {#yandex.cloud.cloudrouter.v1.UpdateNetworksRequest}
...
#|
||Field | Description ||
|| addedVpcNetworks[] | **[VpcInfo](#yandex.cloud.cloudrouter.v1.VpcInfo)**

Lists information about the VPC networks that are added to the routing instance.

The maximum number of elements is 10000. ||
|| updatedVpcNetworks[] | **[VpcInfo](#yandex.cloud.cloudrouter.v1.VpcInfo)**
...
The maximum string length in characters is 50. ||
|| vpcAzInfoPrefixes[] | **[VpcAzInfoPrefixes](#yandex.cloud.cloudrouter.v1.VpcAzInfoPrefixes)**
