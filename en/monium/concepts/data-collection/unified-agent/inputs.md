...
* To avoid high CPU usage and performance degradation, we recommend enabling the `keep_open_file` option or setting `max_lines_in_record` to a value proportional to the size of each frame.
