...
editable: false
apiPlayground:
  - url: https://logging.{{ api-host }}/logging/v1/exports/{exportId}/operations
    method: get
    path:
      type: object
      properties:
...
## Query parameters {#yandex.cloud.logging.v1.ListExportOperationsRequest}
...
## Response {#yandex.cloud.logging.v1.ListExportOperationsResponse}
