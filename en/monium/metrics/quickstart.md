...
- {{ monium-name }} UI {#console}
  ...
  1. Return to the dashboard editing page by clicking the dashboard title, the one you specified earlier, at the top.
...
- {{ monium-name }} UI {#console}
  ...
  1. Next to the section name, click **Settings** and enter the section title, e.g., `Virtual machines`.
  1. Click **{{ ui-key.yacloud_monitoring.actions.common.save }}**.
