...
# Yandex Cloud Registry API, gRPC: LifecyclePolicyService.GetDryRunResult

Returns one dry run result by its ID.

## gRPC request

**rpc GetDryRunResult ([GetDryRunLifecyclePolicyResultRequest](#yandex.cloud.cloudregistry.v1.GetDryRunLifecyclePolicyResultRequest)) returns ([DryRunLifecyclePolicyResponse](#yandex.cloud.cloudregistry.v1.DryRunLifecyclePolicyResponse))**

## GetDryRunLifecyclePolicyResultRequest {#yandex.cloud.cloudregistry.v1.GetDryRunLifecyclePolicyResultRequest}
