...
editable: false
apiPlayground:
  - url: https://registry.{{ api-host }}/cloud-registry/v1/registries/{resourceId}:listAccessBindings
    method: get
    path:
      type: object
      properties:
    ...
    body: null
    definitions: null
sourcePath: en/_api-ref/cloudregistry/v1/api-ref/Registry/listAccessBindings.md
---

# Yandex Cloud Registry API, REST: Registry.ListAccessBindings
