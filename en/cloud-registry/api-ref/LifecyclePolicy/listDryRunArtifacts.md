...
editable: false
apiPlayground:
  - url: https://registry.{{ api-host }}/cloud-registry/v1/lifecyclePolicyDryRunResults/{dryRunId}:artifacts
    method: get
    path:
      type: object
      properties:
...
```
GET https://registry.{{ api-host }}/cloud-registry/v1/lifecyclePolicyDryRunResults/{dryRunId}:artifacts
```
