---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/cloud-registry/cli-ref/v1/registry/update/
---

# yc cloud-registry v1 registry update
...
`yc cloud-registry v1 registry update <REGISTRY-ID>`
...
1. Generate template:
yc cloud-registry v1 registry update --example-json > request.json
or
yc cloud-registry v1 registry update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc cloud-registry v1 registry update -r request.json
or
yc cloud-registry v1 registry update -r request.yaml ||
|#
