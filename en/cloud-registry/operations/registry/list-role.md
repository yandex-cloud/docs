...
- Management console {#console}
  ...
  1. Find the user, group, or [service account](../../../iam/concepts/users/service-accounts.md) in the list. Assigned roles are specified in the **{{ ui-key.yacloud_components.acl.resource-acl.label_bindings }}** column.
