...
| Basis for Compensation calculating in Reporting Period | Compensation, % of Service Fee for Service in Reporting Period |
| --- | --- |
...
*Previous version of the document: <https://nebius.com/il/docs/legal/archive/sla-levels/compute-20230220>*
