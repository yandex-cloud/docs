---
title: Nebius Services Agreement. Expired on June 6, 2023
noIndex: true
---
...
*This is an old version of the document, which expired on June 6, 2023. The current version is available at: <https://nebius.com/il/docs/legal/agreement>.*
...
8.5.	Customer pays the Outstanding Fees as invoiced by Nebius, except for when using Linked Card. Linked Card may be debited to pay the Outstanding Fees on any day after the end of the respective Reporting period.
...
8.8.5.	The data of Linked Card is used for purposes of entering into and executing the Agreement for the duration of this Agreement and one Reporting Period thereafter. Nebius transfers and receives only the data of Linked Card that is necessary for the specified purpose.
...
* Account name: NEBIUS ISRAEL LTD
