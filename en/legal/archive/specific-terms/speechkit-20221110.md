---
title: Terms of Use of SpeechKit. Expired on February 20, 2023
noIndex: true
---

# Terms of Use of SpeechKit

*This is an old version of the document, which expired on February 20, 2023. The current version is available at: <https://nebius.com/il/docs/legal/specific-terms/speaqual>.*

This document contains specific Terms of Use of SpeechKit ("the Service") and is an integral part of CloudIL Services Agreement ("Agreement") and Service Terms set forth at [https://cloudil.co.il/docs/legal/service-terms](https://nebius.com/il/docs/legal/service-terms). Capitalized terms used herein but not defined herein shall have the meanings set forth in Agreement and Linked Documents.
...
3.1. Service Requests can be performed by End Users having a registered CloudIL ID account.
...
3.4. CloudIL and its affiliates use the information contained in Requests solely for the purpose of providing the Service. No Customer information transmitted to the Service is stored on servers, used for training CloudIL software models or for any other purpose than the aforesaid one.

3.4.1. Customer may provide its consent for the using by CloudIL and its affiliates of the information contained in Request by specifying in the request body a special parameter described in the technical documentation of the Service.

Customer may provide CloudIL with text and audio recordings via the user interface of the Service. The specified information will never be processed by CloudIL without receiving appropriate instructions from the client.
...
3.4.3. Customer represents and warrants that it has obtained all necessary consents and has all necessary rights to transfer information specified in clause 3.4.1. of these Terms to CloudIL and its affiliates.
...
Web address: [https://cloudil.co.il/docs/legal/specific-terms/speechkit](https://nebius.com/il/docs/legal/specific-terms/speaqual)
