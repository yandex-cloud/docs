---
title: Service Level for Managed Service for Kubernetes. Expired on February 20, 2023
noIndex: true
---

# Service Level for Managed Service for Kubernetes

*This is an old version of the document, which expired on February 20, 2023. The current version is available at: <https://nebius.com/il/docs/legal/sla-levels/managed-kubernetes>.*

This document defines Service Level of Managed Service for Kubernetes ("Service") and is an integral part of CloudIL Services Agreement ("Agreement") and SLA available at: [https://cloudil.co.il/docs/legal/sla](https://nebius.com/il/docs/legal/sla). Capitalized terms used herein but not defined herein shall have the meanings set forth in Agreement and Linked Documents.
...
Web address: [https://cloudil.co.il/docs/legal/sla-levels/managed-kubernetes](https://nebius.com/il/docs/legal/sla-levels/managed-kubernetes)
