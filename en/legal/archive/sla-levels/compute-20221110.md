---
title: Service Level for Compute Cloud. Expired on February 20, 2023
noIndex: true
---
...
A failed Disk state means that the Disk goes to the "ERROR" state (the disk state is displayed in the Console or via the [https://cloudil.co.il/docs/cli/quickstart](https://nebius.com/il/docs/cli/quickstart)).
