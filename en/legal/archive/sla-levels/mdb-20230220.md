---
title: Service Level for Managed Databases. Expired on March 6, 2023
noIndex: true
---

# Service Level for Managed Databases

*This is an old version of the document, which expired on March 6, 2023. The current version is available at: <https://nebius.com/il/docs/legal/sla-levels/mdb>.*

This document defines Service Levels for Managed Service for PostgreSQL, Nebius Managed Service for ClickHouse, Nebius Managed Service for MySQL (collectively, "Service") and is an integral part of Nebius Services Agreement ("Agreement") and SLA available at: <https://nebius.com/il/docs/legal/sla>. Capitalized terms used herein but not defined herein shall have the meanings set forth in Agreement and Linked Documents.
...
Unavailability of Nebius Managed Service for PostgreSQL and Nebius Managed Service for MySQL shall be defined as two or more DB Hosts placed in different Availability Zones for reading or writing via supported clients.

Unavailability of Nebius Managed Service for ClickHouse shall be defined as follows:
