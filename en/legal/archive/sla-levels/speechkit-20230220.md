---
title: Service Level for SpeechKit. Expired on March 6, 2023
noIndex: true
---

# Service Level for SpeechKit

*This is an old version of the document, which expired on March 6, 2023. The current version is available at: <https://nebius.com/il/docs/legal/sla-levels/speaqual>.*

This document defines Service Level of SpeechKit ("Service") and is an integral part of Nebius Services Agreement ("Agreement") and SLA available at: <https://nebius.com/il/docs/legal/sla>. Capitalized terms used herein but not defined herein shall have the meanings set forth in Agreement and Linked Documents.
