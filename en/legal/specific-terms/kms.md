# Terms of Use of Key Management Service

This document constitutes the Terms of Use of Key Management Service ("the Service") and is an integral part of Nebius Services Agreement ("Agreement") and Service Terms set forth at <https://nebius.com/il/docs/legal/service-terms>. Capitalized terms used herein but not defined herein shall have the meanings set forth in Agreement and Linked Documents.

## 1. Functional Features of the Service {#features}

1.1. The Service helps the Customer create and manage different types of Encryption Keys to protect the Customer's Content posted on or off the Platform. A full description of the functional features of the Service is contained in Documentation of the Service posted on Site.

1.2. The Customer is provided with the following options as part of the Service:

* Create Encryption Keys;

* Encrypt and decrypt the Customer's Content (encrypted via the Service), as well as the Customer's off-platform data;

* Manage access rights to the Encryption Keys;

* Change Versions;

* Obtain encryption key use data;
...
Encryption Key means a set of Versions used within the Service to encrypt or decrypt the Customer's Content or other data.

Version means a unit of cryptographic material (data) used for encryption or decryption.

Active Version means a version that is in "Active" or "Scheduled For Destruction" status in the Management Console.
