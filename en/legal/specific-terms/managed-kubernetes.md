# Terms of Use of Managed Service for Kubernetes

This document contains specific Terms of Use of Managed Service for Kubernetes ("Service") and is an integral part of Nebius Services Agreement ("Agreement") and Service Terms set forth at <https://nebius.com/il/docs/legal/service-terms>. Capitalized terms used herein but not defined herein shall have the meanings set forth in Agreement and Linked Documents.
...
1.2.4. other functional features of the Service that Nebius makes available to the Customer as it thinks fit. The full list of functional features is available to Customer on Site and / or in Management Console.
...
2.2. Service Fee for the Service is determined according to the rates and billing units specified on the Site. Nebius may change the rates as provided by the Contract.
...
2.5. Nebius may from time to time provide the Customer with additional functional features of the Service for an additional fee.
...
Master means a software suite launched by Nebius on the Platform to keep the Kubernetes® Cluster operational.

________________________________________

**Nebius Israel Ltd**

Web address: <https://nebius.com/il/docs/legal/specific-terms/managed-kubernetes>

Publication date: 20.02.2023

*Previous version of the document: <https://nebius.com/il/docs/legal/archive/specific-terms/managed-kubernetes-20221110>*