# Terms of Use of Managed Service for PostgreSQL

This document contains specific Terms of Use of Managed Service for PostgreSQL ("the Service") and is an integral part of Nebius Services Agreement ("Agreement") and Service Terms set forth at <https://nebius.com/il/docs/legal/service-terms>. Capitalized terms used herein but not defined herein shall have the meanings set forth in Agreement and Linked Documents.

## 1. Functional Features of the Service {#features}

1.1. Nebius provides Customer with the Service that allows Customer to remotely create, operate, manage, and scale databases on cloud resources of Platform using DBMS PostgreSQL.
...
Web address: <https://nebius.com/il/docs/legal/specific-terms/managed-postgresql>

Publication date: 20.02.2023

*Previous version of the document: <https://nebius.com/il/docs/legal/archive/specific-terms/managed-postgresql-20221110>*