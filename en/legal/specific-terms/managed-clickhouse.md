# Terms of Use of Managed Service for ClickHouse

This document contains specific Terms of Use of Managed Service for ClickHouse ("the Service") and is an integral part of Nebius Services Agreement ("Agreement") and Service Terms set forth at <https://nebius.com/il/docs/legal/service-terms>. Capitalized terms used herein but not defined herein shall have the meanings set forth in Agreement and Linked Documents.

## 1. Functional Features of the Service {#features}

1.1. Nebius provides Customer with the Service that allows Customer to remotely create, operate, manage, and scale databases on cloud resources of Platform using DBMS ClickHouse.
...
1.2.6. other functional features of the Service, which Nebius makes available to Customer. Functional features of the Service are described in Documentation on Site.
...
"DBMS ClickHouse" means a database management system ClickHouse.

________________________________________

**Nebius Israel Ltd**

Web address: <https://nebius.com/il/docs/legal/specific-terms/managed-clickhouse>

Publication date: 20.02.2023

*Previous version of the document: <https://nebius.com/il/docs/legal/archive/specific-terms/managed-clickhouse-20221110>*