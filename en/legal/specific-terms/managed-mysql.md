# Terms of Use of Managed Service for MySQL

This document contains specific Terms of Use of Managed Service for MySQL ("the Service") and is an integral part of Nebius Services Agreement ("Agreement") and Service Terms set forth at <https://nebius.com/il/docs/legal/service-terms>. Capitalized terms used herein but not defined herein shall have the meanings set forth in Agreement and Linked Documents.

## 1. Functional Features of the Service {#features}

1.1. Nebius provides Customer with the Service that allows Customer to remotely create, operate, manage, and scale databases on cloud resources of Platform using DBMS MySQL.
...
2.2. Service Fee for the Service is determined as per Service Rate and billing units specified on Site. Nebius may change Service Rates as prescribed by Agreement.
...
Web address: <https://nebius.com/il/docs/legal/specific-terms/managed-mysql>

Publication date: 20.02.2023

*Previous version of the document: <https://nebius.com/il/docs/legal/archive/specific-terms/managed-mysql-20221110>*
