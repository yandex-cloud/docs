...
1.3 other functional features of the Service, which Nebius makes available to Customer. Functional features of the Service are described in Documentation on Site and/or in the Management Console.
...
2.2. Service Fee for the Service is determined according to the rates and billing units specified on the Site. Nebius may change Service Rates as prescribed by Agreement.
...
"Own resources" are Customer's own software and hardware resources such as: software, applications, and so on, not belonging to Nebius Platform.

________________________________________

**Nebius Israel Ltd**

Web address: <https://nebius.com/il/docs/legal/specific-terms/monitoring>

Publication date: 20.02.2023

*Previous version of the document: <https://nebius.com/il/docs/legal/archive/specific-terms/monitoring-20221110>*