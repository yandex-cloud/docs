...
By entering into this Agreement on behalf of Customer, whether by ticking the button "Create" and/or by accessing/using Nebius's Platform and/or Services in any way, you represent and warrant that: (i) You have full legal authority to enter into this Agreement and if You are acting on behalf of Customer that You have legal authority to bind Customer to this Agreement; (ii) You read, understand and will oblige the terms of this Agreement and Linked Documents; (iii) You agree to the terms of this Agreement and Linked Documents; (iv) You are a Resident of Territory.
...
"Committed Volume of Services" means the ability to use Services in the volume and quantity requested by Customer for a certain period and provided by Nebius;

"Consumer" as defined under Section 1 to the Israeli Consumer Protection Law – 1981; 
...
"Debts" means Outstanding Fees that have not been paid by the Customer within the period specified under clause 8.5 to this Agreement;
...
"Linked Card" means any bank card (as defined under the Israeli Debit Cards Law-1986); attached to Customer's Personal Account, as an entity, by a representative of Customer for the purpose of payment for Services; or in case the Customer is a Consumer, any bank card issued under the Consumer's name, which is attached to Customer's Personal Account, for the purpose of payment for Services;
...
"Management Console" means the closed section of the Platform, access to which is provided by Nebius to Customer for administering Services, including but not limited to order and manage Services; containing Statistics on Services used, information on the status of Customer's Personal Account, Customer login details, Quotas, and Grants of Customer; providing means for parties to exchange notices and messages; performing other actions required to make use of options of the Platform;

"Outstanding Fees" means the outstanding Service Fees owed by the Customer to Nebius in accordance to the Customer's Personal Account and this Agreement, which have not been paid yet; 
...
"Reporting period" means a calendar month. The first Reporting period is defined as the period from the effective date of this Agreement to the last day of the month (time zone determining the start and end of a calendar day: GMT +2);
...
"Site" means a website available online at <https://nebius.com>, as may be updated by Nebius from time to time;
...
3.1. the person executing this Agreement has the right, power and authority to execute documents and to contractually bind it;

3.2.	pay for Services in due time;

3.3.	shall comply with all applicable laws and regulations; Customer's engagement with Nebius is not and/or will not be in breach of any of Customer's undertakings toward any of his other engagements, independently make backup copies of Customer's Content;

3.4.	immediately inform Nebius in case of any technical problems with Services;

3.5.	ensure safe storage and prevent the login details Customer uses to access Services from being compromised;

3.6.	obtain and maintain any required consents, permits, registrations, privacy notices, etc. necessary to permit the processing of Customer's Content under this Agreement;

3.7.	inform Nebius of changes in the Customer's details no later than seven (7) calendar days from the date of such changes;
...
3.9.	not transfer his or her rights and obligations under this Agreement to third parties without written consent from Nebius;
...
3.11.	not decompile, disassemble, or evade technical constraints of Services and software products of Nebius, unless permitted under mandatory applicable law (e.g. interoperability or information security) and even then, only if it is necessary for the use of the Platform and within the original purposes of the Services and subject to applicable law;
...
6.7.	Suspension. Nebius may suspend or limit Customer's access to use of Services in the following cases without any prior notice:
...
g) if Nebius suspects that Customer's personal account could be fraudulent;
...
8.1.	Customer shall pay Service Fees based on Customer's usage of Services and in accordance with Service Rates, unless any other payment terms are established under Service Terms. Notwithstanding anything to the contrary under this Agreement, non-Residents Services Fees are paid in U.S. Dollars ($) in an amount equivalent to the one specified in New Israeli Shekels under the Service Fees. The U.S. Dollar's exchange rate for non-Residents shall be determined solely by Nebius, which is entitled to change the exchange rate from time to time at its sole discretion.

8.2.	Nebius will no later than five (5) calendar days after the end of Reporting period provide Customer with an invoice based on the amount of Services ordered and used by Customer in Reporting period. Statistics of usage of Services in Reporting period is available in Management Console.

8.3.	If Customer does not provide any written objections to the invoice within thirteen (13) calendar days following the Reporting period, Customer waives any and all claims relating to Statistics and Service Fees in such Reporting period (except claims provided according to SLA).

8.4.	Customer shall pay the Outstanding Fees within thirty (30) calendar days following the end of respective Reporting period.

8.5.	Customer pays the Outstanding Fees as invoiced by Nebius, except for when using Linked Card. Linked Card may be debited to pay the Outstanding Fees on any day after the end of the respective Reporting period. If Nebius suspects that Customer's personal account is fraudulent or at risk of non-payment, we may choose to bill you more frequently for the accrued fees.

8.6.	Customer is solely responsible for the correctness of payments. When making payments via wire transfer, Customer shall indicate the number of Agreement and number of Personal Account.

8.7.	Customer shall pay all applicable Service Fees and charges for usage of Services using one of the payment methods Nebius supports. All bank's and/or credit card issuer's charges and commissions connected with payment for Services shall be paid by Customer. Customer's obligation to pay all Service Fees is non-cancellable. All amounts payable by Customer under this Agreement may not be withheld or deducted by setting off with counterclaims.

8.8.	Usage of Linked Card. When entering into Agreement, Customer may activate Linked Card payment method in the respective section of Management Console.

8.8.1.	By activating Linked Card as payment method Customer expresses full consent and authorizes Nebius:

8.8.1.1.	to initiate one or more debits for the total amount of purchase from these cards;

8.8.1.2.	to process and to store the following data: Customer's name, card expiry date, which has been specified by Customer by linking Linked Card;

8.8.1.3.	to transfer the data of Linked Card to an authorized payment processor, an electronic money operator, or other parties to settlements and information technology interaction.

Payment with Linked Card options is made with Nebius involving an authorized payment processor, an electronic money operator, or other parties to settlements and information technology interaction. Nebius does not warrant the error and failure free operation of the said parties to settlements and information technology interaction.

8.8.2.	When indicating details of Linked Card and further using of Linked Card, Customer confirms and warrants that Customer indicated reliable and full information on the Linked Card and complies with rules of international payment systems and requirements of the bank or credit card issuer that issued Linked Card, inter alia, in relation to the procedure of wire transfer payments. The following details in relation to this Agreement shall be included in the transaction confirmation: card number, transaction amount, surcharges (if applicable), transaction currency, transaction date, authorization code, Nebius's location.

8.8.3.	Customer represents and warrants not to cancel the activated Linked Card or to act in anyway which may prevent Nebius from debiting the Linked Card, during the duration of the of this Agreement and one Reporting Period thereafter. In case the Customer is required by the bank or credit card issuer that issued the specific Linked Card to cancel the said card, or in case the Linked Card has been accidently destroyed, lost or stolen, Customer shall immediately notify Nebius in writing on the matter and provide Nebius with an alternative Linked Card in accordance with the provisions of this Agreement. In case Customer wishes to replace its current activated Linked Card with an alternative one, it shall be subject to Nebius's prior written consent, at its sole discretion.

8.8.4.	Failure to debit Linked Card for any reason does not release Customer from obligation to pay for Services used on the due dates set by this Agreement.

8.8.5.	The data of Linked Card is used for purposes of entering into and executing the Agreement for the duration of this Agreement. Nebius transfers and receives only the data of Linked Card that is necessary for the specified purpose.

8.8.6.	Customer may contact via [support@nebius-israel.com](mailto:support@nebius-israel.com) if any questions arise in respect of the cancellation and/or refund.

8.9.	Debts are subject to an interest rate of 1.5% per month (or the highest rate permitted by law, if less) from the payment due date until paid in full. Customer will be responsible for all reasonable expenses (including attorneys' fees) incurred by Nebius in collecting such outstanding amounts. Nebius may suspend Customer's right to access to Services for any Debt and Nebius may cancel special pricing offerings (including, but not limited, Grants, discounts (bonuses) and etc.) provided to the Customer with prior written notice which will come into force next day from the day of sending of the notice.
...
9.2.1.	set and change Limits for usage of Services; set Quotas; change Quotas upon Customer's request. Limits, Quotas and other limitations of the usage of Services may vary for different categories of Customers;
...
9.2.9.	refuse to transfer resources to another contract if there are Outstanding Fees on the Customer's Personal Account.
...
11.1.	Customer will defend, hold harmless and indemnify Nebius, its affiliates, agents, subcontractors, partners, licensors and each of their respective employees, officers, directors, immediately upon their demand, from any and all damages, expenditures, losses and/or claims borne by Nebius or brought against it, respectively, which directly or indirectly arise out or relate to: (a) any Customer's Content and/or third party's intellectual property and/or rights; (b) Customer usage of Services (including any activities under Customer account and use by Customer employees and personnel); (c) breach of this Agreement and any Linked Documents or violation of applicable law by Customer (including by any person/entity under Customer's account and/or Customer's employees and personnel). Customer will reimburse Nebius for reasonable attorneys' fees and legal expenses.
...
The obligation under this Section will not apply to the extent the underlying allegation arises from: (a) Customer breach of this Agreement or violation of applicable law; (b) modifications to Nebius technology or Services by anyone other than Nebius.
...
12.2.	Nebius makes no express or implied representations and/or warranties, including any implied or express warranties relating with Services and/or their suitability for specific purposes of Customer.
...
14.2.3.	In any case aggregate liability under this agreement will not exceed the amount Customer actually paid Nebius under this Agreement during the 3 months before the liability event arose.
...
15.2.	Termination. Customer may terminate this Agreement by written notice sent to Nebius at least ten (10) calendar days before the expected date of termination subject to clauses 14.2.1, 14.2.2 hereof. If You are a Consumer and the Agreement was accepted by You remotely, You may terminate this Agreement as further specified herein, within 14 days from entering this Agreement or from the receipt of the transaction details document, whichever is later. In case You are a Consumer as well as a disabled person, a senior citizen and/or a new immigrant to Israel, all as defined under the Israeli Consumer Protection Law – 1981, You may terminate this Agreement, as further specified herein, within 4 months from entering this Agreement or from the receipt of the transaction details document, whichever is later, provided that entering this agreement included a conversation between Nebius and You, including via electronic means.
...
15.2.2.	In case You are a Consumer, you may terminate this Agreement, subject to the Israeli Consumers Protection Law – 1981, in any of the following ways:

- Orally, i.e - directly at Nebius's office - 94 Yigal Alon St., Tel Aviv-Jaffa, Israel;
- By registered mail to the address stated above;
- By e-mail: [support@nebius-israel.com](mailto:support@nebius-israel.com).

Consumer's termination notice should include at least the name and the I.D. number of the Consumer, and if such termination notice is delivered orally, Nebius shall have the right to request an additional identification detail.

15.2.3.	At any point during the effective period of the Committed Volume of Services, Customer may unilaterally terminate this Agreement and/or Committed Volume of Services, and Customer shall pay Nebius a fee in the amount of 30% the cost of the Committed Volume of Services for the unused reserved period (the "Termination Fee"). Notwithstanding the abovementioned, in case You are a Consumer, and You terminated the Agreement in accordance with the Consumer's termination provisions specified above, You shall be charged with a Termination Fee in the sum of NIS 100 (one hundred) or 5% (five percent) of the value of the transaction, whichever is lower.

Parties agree and acknowledge that the early termination of the Agreement and/or Committed Volume of Services during the effective period of the Committed Volume of Services by Customer is deemed inappropriate and causes damages and losses to Nebius. Termination Fee shall be payable as liquidated damages to compensate Nebius for the damages and losses that Nebius suffers upon the termination of this Agreement and/or Committed Volume of Services under the conditions set forth in clause 15.2.3 Customer acknowledges that Termination Fee represents liquidated damages calculated based on Nebius's expectation for the term of this Agreement and is not a penalty.
...
a)	Customer repeatedly (more than twice) violates payment terms of this Agreement;

b)	in case Customer fails to remedy a breach of the Agreement within seven (7) calendar days, from the moment: (i) Nebius notified him on the matter; and\or (ii) suspended his use of the Services;

c)	Customer fails to comply with AUP, which caused the violations of third-party rights or applicable law;

d)	Nebius previously terminated the agreement with this Customer due his or her breach of this Agreement, except in case when Nebius entered an Agreement with Customer, which specifies that Nebius explicitly agrees entering this Agreement despite previous termination due to Customer's breach of former agreement;
...
g)	Customer becomes: (i) the subject of any sanctions imposed by the U.S., the EU, the UN or Israel; (ii) the subject of any other applicable sanctions;
...
15.5.2.	Nebius may terminate this Agreement with Services being immediately disabled and with no expenses or damages reimbursed without notice: (i) if Nebius's relationship with subcontractors or partners who provides software or other technology Nebius uses to provide Services expires, terminates or requires Nebius to change the way Nebius provides Services; and/or (ii) in order to comply with applicable law or requests of governmental entities; and/or (iii) in case the Customer enters into bankruptcy or insolvency procedures and\or a trustee is appointed to him\her.
15.5.3.	Nebius may terminate this Agreement in full or in part at any time in respect of Services rendered free of charge.
...
17.4.	Subject to the provisions under Sections 11 and 14 above, if confidential information is disclosed in breach of this Section 16, party at fault undertakes to indemnify for losses caused by such disclosure, if the affected party requests so.
...
19.4.	Assignment. Agreement provides no assignment of any rights or no license granted by Nebius to Customer for any parts of Platform and Services, unless otherwise expressly stipulated in Agreement and the documents referred to in Agreement. For avoidance of doubt, Nebius is authorized to assign its rights and obligations under this agreement to third parties without requiring the Customer's consent.
...
*Previous version of the document: <https://nebius.com/il/docs/legal/archive/agreement-20230626>*

*Previous version of the document: <https://nebius.com/il/docs/legal/archive/agreement-20230606>*

*Previous version of the document: <https://nebius.com/il/docs/legal/archive/agreement-20230313>*

*Previous version of the document: <https://nebius.com/il/docs/legal/archive/agreement-20230220>*
