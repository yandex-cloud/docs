...
- PowerShell
  ...
  1. To update, use the client key [KMS Client ProductKey's](https://docs.microsoft.com/en-us/windows-server/get-started/kmsclientkeys) corresponding to the edition installed:
