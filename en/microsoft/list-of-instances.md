...
All the images available in the {{ marketplace-name }} have [Windows Server 2019 Datacenter]{% if lang == "ru" %}(https://cloud.yandex.ru/marketplace/products/f2evussurs3m1v2turq6){% endif %}{% if lang == "en" %}(https://cloud.yandex.com/en-ru/marketplace/products/f2evussurs3m1v2turq6){% endif %} pre-installed with the Remote Desktop Licensing Server role pre-activated and a custom license package. You can choose from RDS license packages of 5, 10, 25, 50, 100, 250, or 500 licenses.
