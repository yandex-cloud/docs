...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-spqr/v1/clusters/{clusterId}/hosts:batchUpdate
    method: post
    path:
      type: object
      properties:
          ...
          hostName:
            description: |-
              **string**
              ...
              To get the SPQR host name, use a [ClusterService.ListHosts](/docs/managed-spqr/api-ref/Cluster/listHosts#ListHosts) request.
            type: string
          updateMask:
            description: |-
              **string** (field-mask)
...
```
POST https://{{ api-host-mdb }}/managed-spqr/v1/clusters/{clusterId}/hosts:batchUpdate
```
