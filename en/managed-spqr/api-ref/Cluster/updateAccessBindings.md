...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-spqr/v1/clusters/{resourceId}:updateAccessBindings
    method: patch
    path:
      type: object
      properties:
...
```
PATCH https://{{ api-host-mdb }}/managed-spqr/v1/clusters/{resourceId}:updateAccessBindings
```
