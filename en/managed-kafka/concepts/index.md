...
Each {{ mkf-name }} cluster consists of one or more [broker hosts](brokers.md) that host [topics](topics.md) and their partitions. Cluster hosts may reside in different [availability zones](../../overview/concepts/geo-scope.md). You can learn more about the {{ yandex-cloud }} availability zones in the [Platform overview](../../overview/concepts/geo-scope.md).
