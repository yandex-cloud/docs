---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/managed-kafka/cli-ref/v0/connector-mirrormaker/create
editable: false
---

# yc managed-kafka v0 connector-mirrormaker create
