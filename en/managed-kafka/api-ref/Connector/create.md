...
--- | ---
clusterId | Required. ID of the Apache Kafka® cluster to create the connector in.  To get this ID, make a [list](/docs/managed-kafka/api-ref/Cluster/list) request.  The maximum string length in characters is 50.
