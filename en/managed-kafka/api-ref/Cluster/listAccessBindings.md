...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-kafka/v1/clusters/{resourceId}:listAccessBindings
    method: get
    path:
      type: object
      properties:
...
```
GET https://{{ api-host-mdb }}/managed-kafka/v1/clusters/{resourceId}:listAccessBindings
```
