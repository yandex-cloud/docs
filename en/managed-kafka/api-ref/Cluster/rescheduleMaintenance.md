...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-kafka/v1/clusters/{clusterId}:rescheduleMaintenance
    method: post
    path:
      type: object
      properties:
...
## Body parameters {#yandex.cloud.mdb.kafka.v1.RescheduleMaintenanceRequest}
