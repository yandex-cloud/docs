---
editable: false
sourcePath: en/_api-ref-grpc/mdb/kafka/v1/api-ref/grpc/User/grantPermission.md
---

# Managed Service for Apache Kafka® API, gRPC: UserService.GrantPermission {#GrantPermission}

Grants permission to the specified Kafka user.

## gRPC request

**rpc GrantPermission ([GrantUserPermissionRequest](#yandex.cloud.mdb.kafka.v1.GrantUserPermissionRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## GrantUserPermissionRequest {#yandex.cloud.mdb.kafka.v1.GrantUserPermissionRequest}
