---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/managed-airflow/cli-ref/v0/cluster/set-access-bindings
editable: false
---

# yc managed-airflow v0 cluster set-access-bindings

Set access bindings for the specified Airflow cluster and delete all existing access bindings if there were any

#### Command Usage

Syntax:

`yc managed-airflow cluster set-access-bindings <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
