...
- REST API {#api}
    ...
    1. Create a file named `body.json` and add the following contents to it:
        ...
        * `config`: Cluster configuration:
            ...
            * `webserver`, `scheduler`, `triggerer`, and `worker`: {{ maf-name }} [component](../concepts/index.md#components) configuration:
            ...
            * `dependencies`: Lists of packages enabling you to install additional libraries and applications into the cluster to run DAG files:
        ...
        * `logging`: Logging parameters:
            ...
            * `enabled`: Enables logging. Logs generated by {{ AF }} will be sent to {{ cloud-logging-full-name }}. Possible values: `true` or `false`.
