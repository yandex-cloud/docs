---
editable: false
sourcePath: en/_api-ref-grpc/airflow/v1/api-ref/grpc/Cluster/setAccessBindings.md
---

# Managed Service for Apache Airflow™ API, gRPC: ClusterService.SetAccessBindings
