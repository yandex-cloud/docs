...
[Create a {{ mmg-name }} target cluster](../operations/cluster-create.md) with the computing capacity and storage size appropriate for the environment where the migrated database is deployed.
...
{% include notitle [MongoDB migration with Data Transfer](../../_tutorials/datatransfer/managed-mongodb.md) %}
