...
Hosts in the cluster Managed Service for MongoDB are deployed on virtual machines in Yandex Compute Cloud. These virtual machines can be created on any of the platforms that are supported by Compute Cloud. Platforms are described in detail in the section [#T](../../compute/concepts/vm-platforms.md).
