...
# Managed Service for MongoDB API, gRPC: ClusterService.Backup {#Backup}

Creates a backup for the specified MongoDB cluster.

## gRPC request

**rpc Backup ([BackupClusterRequest](#yandex.cloud.mdb.mongodb.v1.BackupClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## BackupClusterRequest {#yandex.cloud.mdb.mongodb.v1.BackupClusterRequest}
...
|| metadata | **[BackupClusterMetadata](#yandex.cloud.mdb.mongodb.v1.BackupClusterMetadata)**
...
## BackupClusterMetadata {#yandex.cloud.mdb.mongodb.v1.BackupClusterMetadata}
