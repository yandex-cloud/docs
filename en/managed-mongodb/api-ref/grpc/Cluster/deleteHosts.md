---
editable: false
sourcePath: en/_api-ref-grpc/mdb/mongodb/v1/api-ref/grpc/Cluster/deleteHosts.md
---

# Managed Service for MongoDB API, gRPC: ClusterService.DeleteHosts {#DeleteHosts}

Deletes the specified hosts for a cluster.

## gRPC request

**rpc DeleteHosts ([DeleteClusterHostsRequest](#yandex.cloud.mdb.mongodb.v1.DeleteClusterHostsRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## DeleteClusterHostsRequest {#yandex.cloud.mdb.mongodb.v1.DeleteClusterHostsRequest}
