...
environment | **string**<br><p>Deployment environment of the MongoDB cluster.</p> <ul> <li>PRODUCTION: Stable environment with a conservative update policy: only hotfixes are applied during regular maintenance.</li> <li>PRESTABLE: Environment with more aggressive update policy: new versions are rolled out irrespective of backward compatibility.</li> </ul> 
...
config.<br>version | **string**<br><p>Version of MongoDB server software. Possible values: ``3.6``, ``4.0``, ``4.2``, ``4.4``, ``4.4-enterprise``, ``5.0``, ``5.0-enterprise``, ``6.0``, ``6.0-enterprise``, ``7.0``, ``7.0-enterprise``.</p> 
...
config.<br>mongodbConfig | **object**<br>Configuration and resource allocation for a MongoDB Enterprise cluster.
config.<br>mongodbConfig.<br>mongod | **object**<br><p>Configuration and resource allocation for mongod in a MongoDB cluster.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config | **object**<br><p>Configuration for mongod hosts.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig | **object**<br><p>Effective mongod settings for a MongoDB cluster (a combination of settings defined in ``userConfig`` and ``defaultConfig``).</p> <p>Configuration of a mongod daemon. Supported options are a limited subset of all options described in <a href="https://docs.mongodb.com/v7.0/reference/configuration-options/">MongoDB documentation</a>.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>storage | **object**<br><p>``storage`` section of mongod configuration.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>storage.<br>wiredTiger | **object**<br><p>Configuration of the WiredTiger storage engine.</p> <p>Configuration of WiredTiger storage engine.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>storage.<br>wiredTiger.<br>engineConfig | **object**<br><p>Engine configuration for WiredTiger.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>storage.<br>wiredTiger.<br>engineConfig.<br>cacheSizeGb | **number** (double)<br><p>The maximum size of the internal cache that WiredTiger will use for all data.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>storage.<br>wiredTiger.<br>collectionConfig | **object**<br><p>Collection configuration for WiredTiger.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>storage.<br>wiredTiger.<br>collectionConfig.<br>blockCompressor | **string**<br><p>Default type of compression to use for collection data.</p> <ul> <li>NONE: No compression.</li> <li>SNAPPY: The <a href="https://docs.mongodb.com/v7.0/reference/glossary/#std-term-snappy">Snappy</a> compression.</li> <li>ZLIB: The <a href="https://docs.mongodb.com/v7.0/reference/glossary/#std-term-zlib">zlib</a> compression.</li> <li>ZSTD: The <a href="https://docs.mongodb.com/v7.0/reference/glossary/#std-term-zstd">zstd</a> compression.</li> </ul> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>storage.<br>wiredTiger.<br>indexConfig | **object**<br><p>Index configuration for WiredTiger</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>storage.<br>wiredTiger.<br>indexConfig.<br>prefixCompression | **boolean** (boolean)<br><p>Enables or disables <a href="https://www.mongodb.com/docs/manual/reference/glossary/#std-term-prefix-compression">prefix compression</a></p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>storage.<br>journal | **object**<br><p>Configuration of the MongoDB <a href="https://docs.mongodb.com/v7.0/reference/glossary/#std-term-journal">journal</a>.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>storage.<br>journal.<br>commitInterval | **integer** (int64)<br><p>Commit interval between journal operations, in milliseconds. Default: 100.</p> <p>Acceptable values are 1 to 500, inclusive.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>operationProfiling | **object**<br><p>``operationProfiling`` section of mongod configuration.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>operationProfiling.<br>mode | **string**<br><p>Mode which specifies operations that should be profiled.</p> <ul> <li>OFF: The profiler is off and does not collect any data.</li> <li>SLOW_OP: The profiler collects data for operations that take longer than the value of ``slowOpThreshold``.</li> <li>ALL: The profiler collects data for all operations.</li> </ul> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>operationProfiling.<br>slowOpThreshold | **integer** (int64)<br><p>The slow operation time threshold, in milliseconds. Operations that run for longer than this threshold are considered slow, and are processed by the profiler running in the SLOW_OP mode.</p> <p>Value must be greater than 0.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>operationProfiling.<br>slowOpSampleRate | **number** (double)<br><p>The fraction of slow operations that should be profiled or logged. operationProfiling.slowOpSampleRate accepts values between 0 and 1, inclusive.</p> <p>Acceptable values are 0 to 1, inclusive.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>net | **object**<br><p>``net`` section of mongod configuration.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>net.<br>maxIncomingConnections | **integer** (int64)<br><p>The maximum number of simultaneous connections that mongod will accept.</p> <p>Acceptable values are 10 to 16384, inclusive.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>net.<br>compression | **object**<br><p>Compression settings</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>net.<br>compression.<br>compressors[] | **string**<br><p>Required. Specifies the default compressor(s) to use for communication between this mongod or mongos instance and:</p> <ul> <li>other members of the deployment if the instance is part of a replica set or a sharded cluster</li> <li>mongosh</li> <li>drivers that support the OP_COMPRESSED message format. MongoDB supports the following compressors:</li> </ul> <p>The number of elements must be in the range 1-3.</p> <ul> <li>SNAPPY: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-snappy">Snappy</a> compression.</li> <li>ZLIB: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-zlib">zlib</a> compression.</li> <li>ZSTD: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-zstd">zstd</a> compression.</li> <li>DISABLED: No compression</li> </ul> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>security | **object**<br><p>``security`` section of mongod configuration.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>security.<br>enableEncryption | **boolean** (boolean)<br><p>If encryption at rest should be enabled or not</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>security.<br>kmip | **object**<br><p>``kmip`` section of mongod security config</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>security.<br>kmip.<br>serverName | **string**<br><p>KMIP server name</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>security.<br>kmip.<br>port | **integer** (int64)<br><p>KMIP server port</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>security.<br>kmip.<br>serverCa | **string**<br><p>KMIP Server CA</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>security.<br>kmip.<br>clientCertificate | **string**<br><p>KMIP client certificate + private key (unencrypted)</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>security.<br>kmip.<br>keyIdentifier | **string**<br><p>KMIP Key identifier (if any)</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>auditLog | **object**<br><p>``AuditLog`` section of mongod configuration.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>auditLog.<br>filter | **string**<br><p>Audit filter</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>auditLog.<br>runtimeConfiguration | **boolean** (boolean)<br><p>Allows runtime configuration of audit filter and auditAuthorizationSuccess</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>setParameter | **object**<br><p>``SetParameter`` section of mongod configuration.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>setParameter.<br>auditAuthorizationSuccess | **boolean** (boolean)<br><p>Enables the auditing of authorization successes</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>setParameter.<br>enableFlowControl | **boolean** (boolean)<br><p>Enables or disables the mechanism that controls the rate at which the primary applies its writes with the goal of keeping the secondary members <a href="https://www.mongodb.com/docs/v7.0/reference/command/replSetGetStatus/#replSetGetStatus.optimes.lastCommittedOpTime">majority committed</a> lag under a configurable maximum value.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>effectiveConfig.<br>setParameter.<br>minSnapshotHistoryWindowInSeconds | **integer** (int64)<br><p>The minimum time window in seconds for which the storage engine keeps the snapshot history.</p> <p>The minimum value is 0.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig | **object**<br><p>User-defined mongod settings for a MongoDB cluster.</p> <p>Configuration of a mongod daemon. Supported options are a limited subset of all options described in <a href="https://docs.mongodb.com/v7.0/reference/configuration-options/">MongoDB documentation</a>.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>storage | **object**<br><p>``storage`` section of mongod configuration.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>storage.<br>wiredTiger | **object**<br><p>Configuration of the WiredTiger storage engine.</p> <p>Configuration of WiredTiger storage engine.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>storage.<br>wiredTiger.<br>engineConfig | **object**<br><p>Engine configuration for WiredTiger.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>storage.<br>wiredTiger.<br>engineConfig.<br>cacheSizeGb | **number** (double)<br><p>The maximum size of the internal cache that WiredTiger will use for all data.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>storage.<br>wiredTiger.<br>collectionConfig | **object**<br><p>Collection configuration for WiredTiger.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>storage.<br>wiredTiger.<br>collectionConfig.<br>blockCompressor | **string**<br><p>Default type of compression to use for collection data.</p> <ul> <li>NONE: No compression.</li> <li>SNAPPY: The <a href="https://docs.mongodb.com/v7.0/reference/glossary/#std-term-snappy">Snappy</a> compression.</li> <li>ZLIB: The <a href="https://docs.mongodb.com/v7.0/reference/glossary/#std-term-zlib">zlib</a> compression.</li> <li>ZSTD: The <a href="https://docs.mongodb.com/v7.0/reference/glossary/#std-term-zstd">zstd</a> compression.</li> </ul> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>storage.<br>wiredTiger.<br>indexConfig | **object**<br><p>Index configuration for WiredTiger</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>storage.<br>wiredTiger.<br>indexConfig.<br>prefixCompression | **boolean** (boolean)<br><p>Enables or disables <a href="https://www.mongodb.com/docs/manual/reference/glossary/#std-term-prefix-compression">prefix compression</a></p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>storage.<br>journal | **object**<br><p>Configuration of the MongoDB <a href="https://docs.mongodb.com/v7.0/reference/glossary/#std-term-journal">journal</a>.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>storage.<br>journal.<br>commitInterval | **integer** (int64)<br><p>Commit interval between journal operations, in milliseconds. Default: 100.</p> <p>Acceptable values are 1 to 500, inclusive.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>operationProfiling | **object**<br><p>``operationProfiling`` section of mongod configuration.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>operationProfiling.<br>mode | **string**<br><p>Mode which specifies operations that should be profiled.</p> <ul> <li>OFF: The profiler is off and does not collect any data.</li> <li>SLOW_OP: The profiler collects data for operations that take longer than the value of ``slowOpThreshold``.</li> <li>ALL: The profiler collects data for all operations.</li> </ul> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>operationProfiling.<br>slowOpThreshold | **integer** (int64)<br><p>The slow operation time threshold, in milliseconds. Operations that run for longer than this threshold are considered slow, and are processed by the profiler running in the SLOW_OP mode.</p> <p>Value must be greater than 0.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>operationProfiling.<br>slowOpSampleRate | **number** (double)<br><p>The fraction of slow operations that should be profiled or logged. operationProfiling.slowOpSampleRate accepts values between 0 and 1, inclusive.</p> <p>Acceptable values are 0 to 1, inclusive.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>net | **object**<br><p>``net`` section of mongod configuration.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>net.<br>maxIncomingConnections | **integer** (int64)<br><p>The maximum number of simultaneous connections that mongod will accept.</p> <p>Acceptable values are 10 to 16384, inclusive.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>net.<br>compression | **object**<br><p>Compression settings</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>net.<br>compression.<br>compressors[] | **string**<br><p>Required. Specifies the default compressor(s) to use for communication between this mongod or mongos instance and:</p> <ul> <li>other members of the deployment if the instance is part of a replica set or a sharded cluster</li> <li>mongosh</li> <li>drivers that support the OP_COMPRESSED message format. MongoDB supports the following compressors:</li> </ul> <p>The number of elements must be in the range 1-3.</p> <ul> <li>SNAPPY: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-snappy">Snappy</a> compression.</li> <li>ZLIB: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-zlib">zlib</a> compression.</li> <li>ZSTD: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-zstd">zstd</a> compression.</li> <li>DISABLED: No compression</li> </ul> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>security | **object**<br><p>``security`` section of mongod configuration.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>security.<br>enableEncryption | **boolean** (boolean)<br><p>If encryption at rest should be enabled or not</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>security.<br>kmip | **object**<br><p>``kmip`` section of mongod security config</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>security.<br>kmip.<br>serverName | **string**<br><p>KMIP server name</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>security.<br>kmip.<br>port | **integer** (int64)<br><p>KMIP server port</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>security.<br>kmip.<br>serverCa | **string**<br><p>KMIP Server CA</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>security.<br>kmip.<br>clientCertificate | **string**<br><p>KMIP client certificate + private key (unencrypted)</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>security.<br>kmip.<br>keyIdentifier | **string**<br><p>KMIP Key identifier (if any)</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>auditLog | **object**<br><p>``AuditLog`` section of mongod configuration.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>auditLog.<br>filter | **string**<br><p>Audit filter</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>auditLog.<br>runtimeConfiguration | **boolean** (boolean)<br><p>Allows runtime configuration of audit filter and auditAuthorizationSuccess</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>setParameter | **object**<br><p>``SetParameter`` section of mongod configuration.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>setParameter.<br>auditAuthorizationSuccess | **boolean** (boolean)<br><p>Enables the auditing of authorization successes</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>setParameter.<br>enableFlowControl | **boolean** (boolean)<br><p>Enables or disables the mechanism that controls the rate at which the primary applies its writes with the goal of keeping the secondary members <a href="https://www.mongodb.com/docs/v7.0/reference/command/replSetGetStatus/#replSetGetStatus.optimes.lastCommittedOpTime">majority committed</a> lag under a configurable maximum value.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>userConfig.<br>setParameter.<br>minSnapshotHistoryWindowInSeconds | **integer** (int64)<br><p>The minimum time window in seconds for which the storage engine keeps the snapshot history.</p> <p>The minimum value is 0.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig | **object**<br><p>Default mongod configuration for a MongoDB cluster.</p> <p>Configuration of a mongod daemon. Supported options are a limited subset of all options described in <a href="https://docs.mongodb.com/v7.0/reference/configuration-options/">MongoDB documentation</a>.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>storage | **object**<br><p>``storage`` section of mongod configuration.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>storage.<br>wiredTiger | **object**<br><p>Configuration of the WiredTiger storage engine.</p> <p>Configuration of WiredTiger storage engine.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>storage.<br>wiredTiger.<br>engineConfig | **object**<br><p>Engine configuration for WiredTiger.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>storage.<br>wiredTiger.<br>engineConfig.<br>cacheSizeGb | **number** (double)<br><p>The maximum size of the internal cache that WiredTiger will use for all data.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>storage.<br>wiredTiger.<br>collectionConfig | **object**<br><p>Collection configuration for WiredTiger.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>storage.<br>wiredTiger.<br>collectionConfig.<br>blockCompressor | **string**<br><p>Default type of compression to use for collection data.</p> <ul> <li>NONE: No compression.</li> <li>SNAPPY: The <a href="https://docs.mongodb.com/v7.0/reference/glossary/#std-term-snappy">Snappy</a> compression.</li> <li>ZLIB: The <a href="https://docs.mongodb.com/v7.0/reference/glossary/#std-term-zlib">zlib</a> compression.</li> <li>ZSTD: The <a href="https://docs.mongodb.com/v7.0/reference/glossary/#std-term-zstd">zstd</a> compression.</li> </ul> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>storage.<br>wiredTiger.<br>indexConfig | **object**<br><p>Index configuration for WiredTiger</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>storage.<br>wiredTiger.<br>indexConfig.<br>prefixCompression | **boolean** (boolean)<br><p>Enables or disables <a href="https://www.mongodb.com/docs/manual/reference/glossary/#std-term-prefix-compression">prefix compression</a></p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>storage.<br>journal | **object**<br><p>Configuration of the MongoDB <a href="https://docs.mongodb.com/v7.0/reference/glossary/#std-term-journal">journal</a>.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>storage.<br>journal.<br>commitInterval | **integer** (int64)<br><p>Commit interval between journal operations, in milliseconds. Default: 100.</p> <p>Acceptable values are 1 to 500, inclusive.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>operationProfiling | **object**<br><p>``operationProfiling`` section of mongod configuration.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>operationProfiling.<br>mode | **string**<br><p>Mode which specifies operations that should be profiled.</p> <ul> <li>OFF: The profiler is off and does not collect any data.</li> <li>SLOW_OP: The profiler collects data for operations that take longer than the value of ``slowOpThreshold``.</li> <li>ALL: The profiler collects data for all operations.</li> </ul> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>operationProfiling.<br>slowOpThreshold | **integer** (int64)<br><p>The slow operation time threshold, in milliseconds. Operations that run for longer than this threshold are considered slow, and are processed by the profiler running in the SLOW_OP mode.</p> <p>Value must be greater than 0.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>operationProfiling.<br>slowOpSampleRate | **number** (double)<br><p>The fraction of slow operations that should be profiled or logged. operationProfiling.slowOpSampleRate accepts values between 0 and 1, inclusive.</p> <p>Acceptable values are 0 to 1, inclusive.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>net | **object**<br><p>``net`` section of mongod configuration.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>net.<br>maxIncomingConnections | **integer** (int64)<br><p>The maximum number of simultaneous connections that mongod will accept.</p> <p>Acceptable values are 10 to 16384, inclusive.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>net.<br>compression | **object**<br><p>Compression settings</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>net.<br>compression.<br>compressors[] | **string**<br><p>Required. Specifies the default compressor(s) to use for communication between this mongod or mongos instance and:</p> <ul> <li>other members of the deployment if the instance is part of a replica set or a sharded cluster</li> <li>mongosh</li> <li>drivers that support the OP_COMPRESSED message format. MongoDB supports the following compressors:</li> </ul> <p>The number of elements must be in the range 1-3.</p> <ul> <li>SNAPPY: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-snappy">Snappy</a> compression.</li> <li>ZLIB: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-zlib">zlib</a> compression.</li> <li>ZSTD: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-zstd">zstd</a> compression.</li> <li>DISABLED: No compression</li> </ul> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>security | **object**<br><p>``security`` section of mongod configuration.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>security.<br>enableEncryption | **boolean** (boolean)<br><p>If encryption at rest should be enabled or not</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>security.<br>kmip | **object**<br><p>``kmip`` section of mongod security config</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>security.<br>kmip.<br>serverName | **string**<br><p>KMIP server name</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>security.<br>kmip.<br>port | **integer** (int64)<br><p>KMIP server port</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>security.<br>kmip.<br>serverCa | **string**<br><p>KMIP Server CA</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>security.<br>kmip.<br>clientCertificate | **string**<br><p>KMIP client certificate + private key (unencrypted)</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>security.<br>kmip.<br>keyIdentifier | **string**<br><p>KMIP Key identifier (if any)</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>auditLog | **object**<br><p>``AuditLog`` section of mongod configuration.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>auditLog.<br>filter | **string**<br><p>Audit filter</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>auditLog.<br>runtimeConfiguration | **boolean** (boolean)<br><p>Allows runtime configuration of audit filter and auditAuthorizationSuccess</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>setParameter | **object**<br><p>``SetParameter`` section of mongod configuration.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>setParameter.<br>auditAuthorizationSuccess | **boolean** (boolean)<br><p>Enables the auditing of authorization successes</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>setParameter.<br>enableFlowControl | **boolean** (boolean)<br><p>Enables or disables the mechanism that controls the rate at which the primary applies its writes with the goal of keeping the secondary members <a href="https://www.mongodb.com/docs/v7.0/reference/command/replSetGetStatus/#replSetGetStatus.optimes.lastCommittedOpTime">majority committed</a> lag under a configurable maximum value.</p> 
config.<br>mongodbConfig.<br>mongod.<br>config.<br>defaultConfig.<br>setParameter.<br>minSnapshotHistoryWindowInSeconds | **integer** (int64)<br><p>The minimum time window in seconds for which the storage engine keeps the snapshot history.</p> <p>The minimum value is 0.</p> 
config.<br>mongodbConfig.<br>mongod.<br>resources | **object**<br><p>Resources allocated to mongod hosts.</p> 
config.<br>mongodbConfig.<br>mongod.<br>resources.<br>resourcePresetId | **string**<br><p>ID of the preset for computational resources available to a host (CPU, memory etc.). All available presets are listed in the <a href="/docs/managed-mongodb/concepts/instance-types">documentation</a>.</p> 
config.<br>mongodbConfig.<br>mongod.<br>resources.<br>diskSize | **string** (int64)<br><p>Volume of the storage available to a host, in bytes.</p> 
config.<br>mongodbConfig.<br>mongod.<br>resources.<br>diskTypeId | **string**<br><p>Type of the storage environment for the host. Possible values:</p> <ul> <li>network-hdd - network HDD drive,</li> <li>network-ssd - network SSD drive,</li> <li>local-ssd - local SSD storage.</li> </ul> 
config.<br>mongodbConfig.<br>mongod.<br>diskSizeAutoscaling | **object**<br><p>Disk size autoscaling settings</p> 
config.<br>mongodbConfig.<br>mongod.<br>diskSizeAutoscaling.<br>plannedUsageThreshold | **integer** (int64)<br><p>Amount of used storage for automatic disk scaling in the maintenance window, 0 means disabled, in percent.</p> <p>Acceptable values are 0 to 100, inclusive.</p> 
config.<br>mongodbConfig.<br>mongod.<br>diskSizeAutoscaling.<br>emergencyUsageThreshold | **integer** (int64)<br><p>Amount of used storage for immediately  automatic disk scaling, 0 means disabled, in percent.</p> <p>Acceptable values are 0 to 100, inclusive.</p> 
config.<br>mongodbConfig.<br>mongod.<br>diskSizeAutoscaling.<br>diskSizeLimit | **integer** (int64)<br><p>Limit on how large the storage for database instances can automatically grow, in bytes.</p> 
config.<br>mongodbConfig.<br>mongocfg | **object**<br><p>Configuration and resource allocation for mongocfg in a MongoDB cluster.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config | **object**<br><p>Configuration for mongocfg hosts.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>effectiveConfig | **object**<br><p>Effective mongocfg settings for a MongoDB cluster (a combination of settings defined in ``userConfig`` and ``defaultConfig``).</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>effectiveConfig.<br>storage | **object**<br><p>``storage`` section of mongocfg configuration.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>effectiveConfig.<br>storage.<br>wiredTiger | **object**<br><p>Configuration of the WiredTiger storage engine.</p> <p>Configuration of WiredTiger storage engine.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>effectiveConfig.<br>storage.<br>wiredTiger.<br>engineConfig | **object**<br><p>Engine configuration for WiredTiger.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>effectiveConfig.<br>storage.<br>wiredTiger.<br>engineConfig.<br>cacheSizeGb | **number** (double)<br><p>The maximum size of the internal cache that WiredTiger will use for all data.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>effectiveConfig.<br>operationProfiling | **object**<br><p>``operationProfiling`` section of mongocfg configuration.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>effectiveConfig.<br>operationProfiling.<br>mode | **string**<br><p>Mode which specifies operations that should be profiled.</p> <ul> <li>OFF: The profiler is off and does not collect any data.</li> <li>SLOW_OP: The profiler collects data for operations that take longer than the value of ``slowOpThreshold``.</li> <li>ALL: The profiler collects data for all operations.</li> </ul> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>effectiveConfig.<br>operationProfiling.<br>slowOpThreshold | **integer** (int64)<br><p>The slow operation time threshold, in milliseconds. Operations that run for longer than this threshold are considered slow, and are processed by the profiler running in the SLOW_OP mode. For details see <a href="https://www.mongodb.com/docs/v7.0/reference/configuration-options/#mongodb-setting-operationProfiling.slowOpThresholdMs">MongoDB documentation</a>.</p> <p>Value must be greater than 0.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>effectiveConfig.<br>net | **object**<br><p>``net`` section of mongocfg configuration.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>effectiveConfig.<br>net.<br>maxIncomingConnections | **integer** (int64)<br><p>The maximum number of simultaneous connections that mongocfg will accept.</p> <p>Acceptable values are 10 to 16384, inclusive.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>userConfig | **object**<br><p>User-defined mongocfg settings for a MongoDB cluster.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>userConfig.<br>storage | **object**<br><p>``storage`` section of mongocfg configuration.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>userConfig.<br>storage.<br>wiredTiger | **object**<br><p>Configuration of the WiredTiger storage engine.</p> <p>Configuration of WiredTiger storage engine.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>userConfig.<br>storage.<br>wiredTiger.<br>engineConfig | **object**<br><p>Engine configuration for WiredTiger.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>userConfig.<br>storage.<br>wiredTiger.<br>engineConfig.<br>cacheSizeGb | **number** (double)<br><p>The maximum size of the internal cache that WiredTiger will use for all data.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>userConfig.<br>operationProfiling | **object**<br><p>``operationProfiling`` section of mongocfg configuration.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>userConfig.<br>operationProfiling.<br>mode | **string**<br><p>Mode which specifies operations that should be profiled.</p> <ul> <li>OFF: The profiler is off and does not collect any data.</li> <li>SLOW_OP: The profiler collects data for operations that take longer than the value of ``slowOpThreshold``.</li> <li>ALL: The profiler collects data for all operations.</li> </ul> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>userConfig.<br>operationProfiling.<br>slowOpThreshold | **integer** (int64)<br><p>The slow operation time threshold, in milliseconds. Operations that run for longer than this threshold are considered slow, and are processed by the profiler running in the SLOW_OP mode. For details see <a href="https://www.mongodb.com/docs/v7.0/reference/configuration-options/#mongodb-setting-operationProfiling.slowOpThresholdMs">MongoDB documentation</a>.</p> <p>Value must be greater than 0.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>userConfig.<br>net | **object**<br><p>``net`` section of mongocfg configuration.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>userConfig.<br>net.<br>maxIncomingConnections | **integer** (int64)<br><p>The maximum number of simultaneous connections that mongocfg will accept.</p> <p>Acceptable values are 10 to 16384, inclusive.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>defaultConfig | **object**<br><p>Default mongocfg configuration for a MongoDB cluster.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>defaultConfig.<br>storage | **object**<br><p>``storage`` section of mongocfg configuration.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>defaultConfig.<br>storage.<br>wiredTiger | **object**<br><p>Configuration of the WiredTiger storage engine.</p> <p>Configuration of WiredTiger storage engine.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>defaultConfig.<br>storage.<br>wiredTiger.<br>engineConfig | **object**<br><p>Engine configuration for WiredTiger.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>defaultConfig.<br>storage.<br>wiredTiger.<br>engineConfig.<br>cacheSizeGb | **number** (double)<br><p>The maximum size of the internal cache that WiredTiger will use for all data.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>defaultConfig.<br>operationProfiling | **object**<br><p>``operationProfiling`` section of mongocfg configuration.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>defaultConfig.<br>operationProfiling.<br>mode | **string**<br><p>Mode which specifies operations that should be profiled.</p> <ul> <li>OFF: The profiler is off and does not collect any data.</li> <li>SLOW_OP: The profiler collects data for operations that take longer than the value of ``slowOpThreshold``.</li> <li>ALL: The profiler collects data for all operations.</li> </ul> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>defaultConfig.<br>operationProfiling.<br>slowOpThreshold | **integer** (int64)<br><p>The slow operation time threshold, in milliseconds. Operations that run for longer than this threshold are considered slow, and are processed by the profiler running in the SLOW_OP mode. For details see <a href="https://www.mongodb.com/docs/v7.0/reference/configuration-options/#mongodb-setting-operationProfiling.slowOpThresholdMs">MongoDB documentation</a>.</p> <p>Value must be greater than 0.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>defaultConfig.<br>net | **object**<br><p>``net`` section of mongocfg configuration.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>config.<br>defaultConfig.<br>net.<br>maxIncomingConnections | **integer** (int64)<br><p>The maximum number of simultaneous connections that mongocfg will accept.</p> <p>Acceptable values are 10 to 16384, inclusive.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>resources | **object**<br><p>Resources allocated to mongocfg hosts.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>resources.<br>resourcePresetId | **string**<br><p>ID of the preset for computational resources available to a host (CPU, memory etc.). All available presets are listed in the <a href="/docs/managed-mongodb/concepts/instance-types">documentation</a>.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>resources.<br>diskSize | **string** (int64)<br><p>Volume of the storage available to a host, in bytes.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>resources.<br>diskTypeId | **string**<br><p>Type of the storage environment for the host. Possible values:</p> <ul> <li>network-hdd - network HDD drive,</li> <li>network-ssd - network SSD drive,</li> <li>local-ssd - local SSD storage.</li> </ul> 
config.<br>mongodbConfig.<br>mongocfg.<br>diskSizeAutoscaling | **object**<br><p>Disk size autoscaling settings</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>diskSizeAutoscaling.<br>plannedUsageThreshold | **integer** (int64)<br><p>Amount of used storage for automatic disk scaling in the maintenance window, 0 means disabled, in percent.</p> <p>Acceptable values are 0 to 100, inclusive.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>diskSizeAutoscaling.<br>emergencyUsageThreshold | **integer** (int64)<br><p>Amount of used storage for immediately  automatic disk scaling, 0 means disabled, in percent.</p> <p>Acceptable values are 0 to 100, inclusive.</p> 
config.<br>mongodbConfig.<br>mongocfg.<br>diskSizeAutoscaling.<br>diskSizeLimit | **integer** (int64)<br><p>Limit on how large the storage for database instances can automatically grow, in bytes.</p> 
config.<br>mongodbConfig.<br>mongos | **object**<br><p>Configuration and resource allocation for mongos in a MongoDB cluster.</p> 
config.<br>mongodbConfig.<br>mongos.<br>config | **object**<br><p>Configuration for mongos hosts.</p> 
config.<br>mongodbConfig.<br>mongos.<br>config.<br>effectiveConfig | **object**<br><p>Effective mongos settings for a MongoDB cluster (a combination of settings defined in ``userConfig`` and ``defaultConfig``).</p> 
config.<br>mongodbConfig.<br>mongos.<br>config.<br>effectiveConfig.<br>net | **object**<br><p>Network settings for mongos.</p> 
config.<br>mongodbConfig.<br>mongos.<br>config.<br>effectiveConfig.<br>net.<br>maxIncomingConnections | **integer** (int64)<br><p>The maximum number of simultaneous connections that mongos will accept.</p> <p>Acceptable values are 10 to 16384, inclusive.</p> 
config.<br>mongodbConfig.<br>mongos.<br>config.<br>effectiveConfig.<br>net.<br>compression | **object**<br><p>Compression settings</p> 
config.<br>mongodbConfig.<br>mongos.<br>config.<br>effectiveConfig.<br>net.<br>compression.<br>compressors[] | **string**<br><p>Required. Specifies the default compressor(s) to use for communication between this mongod or mongos instance and:</p> <ul> <li>other members of the deployment if the instance is part of a replica set or a sharded cluster</li> <li>mongosh</li> <li>drivers that support the OP_COMPRESSED message format. MongoDB supports the following compressors:</li> </ul> <p>The number of elements must be in the range 1-3.</p> <ul> <li>SNAPPY: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-snappy">Snappy</a> compression.</li> <li>ZLIB: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-zlib">zlib</a> compression.</li> <li>ZSTD: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-zstd">zstd</a> compression.</li> <li>DISABLED: No compression</li> </ul> 
config.<br>mongodbConfig.<br>mongos.<br>config.<br>userConfig | **object**<br><p>User-defined mongos settings for a MongoDB cluster.</p> 
config.<br>mongodbConfig.<br>mongos.<br>config.<br>userConfig.<br>net | **object**<br><p>Network settings for mongos.</p> 
config.<br>mongodbConfig.<br>mongos.<br>config.<br>userConfig.<br>net.<br>maxIncomingConnections | **integer** (int64)<br><p>The maximum number of simultaneous connections that mongos will accept.</p> <p>Acceptable values are 10 to 16384, inclusive.</p> 
config.<br>mongodbConfig.<br>mongos.<br>config.<br>userConfig.<br>net.<br>compression | **object**<br><p>Compression settings</p> 
config.<br>mongodbConfig.<br>mongos.<br>config.<br>userConfig.<br>net.<br>compression.<br>compressors[] | **string**<br><p>Required. Specifies the default compressor(s) to use for communication between this mongod or mongos instance and:</p> <ul> <li>other members of the deployment if the instance is part of a replica set or a sharded cluster</li> <li>mongosh</li> <li>drivers that support the OP_COMPRESSED message format. MongoDB supports the following compressors:</li> </ul> <p>The number of elements must be in the range 1-3.</p> <ul> <li>SNAPPY: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-snappy">Snappy</a> compression.</li> <li>ZLIB: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-zlib">zlib</a> compression.</li> <li>ZSTD: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-zstd">zstd</a> compression.</li> <li>DISABLED: No compression</li> </ul> 
config.<br>mongodbConfig.<br>mongos.<br>config.<br>defaultConfig | **object**<br><p>Default mongos configuration for a MongoDB cluster.</p> 
config.<br>mongodbConfig.<br>mongos.<br>config.<br>defaultConfig.<br>net | **object**<br><p>Network settings for mongos.</p> 
config.<br>mongodbConfig.<br>mongos.<br>config.<br>defaultConfig.<br>net.<br>maxIncomingConnections | **integer** (int64)<br><p>The maximum number of simultaneous connections that mongos will accept.</p> <p>Acceptable values are 10 to 16384, inclusive.</p> 
config.<br>mongodbConfig.<br>mongos.<br>config.<br>defaultConfig.<br>net.<br>compression | **object**<br><p>Compression settings</p> 
config.<br>mongodbConfig.<br>mongos.<br>config.<br>defaultConfig.<br>net.<br>compression.<br>compressors[] | **string**<br><p>Required. Specifies the default compressor(s) to use for communication between this mongod or mongos instance and:</p> <ul> <li>other members of the deployment if the instance is part of a replica set or a sharded cluster</li> <li>mongosh</li> <li>drivers that support the OP_COMPRESSED message format. MongoDB supports the following compressors:</li> </ul> <p>The number of elements must be in the range 1-3.</p> <ul> <li>SNAPPY: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-snappy">Snappy</a> compression.</li> <li>ZLIB: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-zlib">zlib</a> compression.</li> <li>ZSTD: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-zstd">zstd</a> compression.</li> <li>DISABLED: No compression</li> </ul> 
config.<br>mongodbConfig.<br>mongos.<br>resources | **object**<br><p>Resources allocated to mongos hosts.</p> 
config.<br>mongodbConfig.<br>mongos.<br>resources.<br>resourcePresetId | **string**<br><p>ID of the preset for computational resources available to a host (CPU, memory etc.). All available presets are listed in the <a href="/docs/managed-mongodb/concepts/instance-types">documentation</a>.</p> 
config.<br>mongodbConfig.<br>mongos.<br>resources.<br>diskSize | **string** (int64)<br><p>Volume of the storage available to a host, in bytes.</p> 
config.<br>mongodbConfig.<br>mongos.<br>resources.<br>diskTypeId | **string**<br><p>Type of the storage environment for the host. Possible values:</p> <ul> <li>network-hdd - network HDD drive,</li> <li>network-ssd - network SSD drive,</li> <li>local-ssd - local SSD storage.</li> </ul> 
config.<br>mongodbConfig.<br>mongos.<br>diskSizeAutoscaling | **object**<br><p>Disk size autoscaling settings</p> 
config.<br>mongodbConfig.<br>mongos.<br>diskSizeAutoscaling.<br>plannedUsageThreshold | **integer** (int64)<br><p>Amount of used storage for automatic disk scaling in the maintenance window, 0 means disabled, in percent.</p> <p>Acceptable values are 0 to 100, inclusive.</p> 
config.<br>mongodbConfig.<br>mongos.<br>diskSizeAutoscaling.<br>emergencyUsageThreshold | **integer** (int64)<br><p>Amount of used storage for immediately  automatic disk scaling, 0 means disabled, in percent.</p> <p>Acceptable values are 0 to 100, inclusive.</p> 
config.<br>mongodbConfig.<br>mongos.<br>diskSizeAutoscaling.<br>diskSizeLimit | **integer** (int64)<br><p>Limit on how large the storage for database instances can automatically grow, in bytes.</p> 
config.<br>mongodbConfig.<br>mongoinfra | **object**<br><p>Configuration and resource allocation for mongoinfra (mongos+mongocfg) in a MongoDB cluster.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongos | **object**
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongos.<br>effectiveConfig | **object**<br><p>Effective mongos settings for a MongoDB cluster (a combination of settings defined in ``userConfig`` and ``defaultConfig``).</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongos.<br>effectiveConfig.<br>net | **object**<br><p>Network settings for mongos.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongos.<br>effectiveConfig.<br>net.<br>maxIncomingConnections | **integer** (int64)<br><p>The maximum number of simultaneous connections that mongos will accept.</p> <p>Acceptable values are 10 to 16384, inclusive.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongos.<br>effectiveConfig.<br>net.<br>compression | **object**<br><p>Compression settings</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongos.<br>effectiveConfig.<br>net.<br>compression.<br>compressors[] | **string**<br><p>Required. Specifies the default compressor(s) to use for communication between this mongod or mongos instance and:</p> <ul> <li>other members of the deployment if the instance is part of a replica set or a sharded cluster</li> <li>mongosh</li> <li>drivers that support the OP_COMPRESSED message format. MongoDB supports the following compressors:</li> </ul> <p>The number of elements must be in the range 1-3.</p> <ul> <li>SNAPPY: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-snappy">Snappy</a> compression.</li> <li>ZLIB: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-zlib">zlib</a> compression.</li> <li>ZSTD: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-zstd">zstd</a> compression.</li> <li>DISABLED: No compression</li> </ul> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongos.<br>userConfig | **object**<br><p>User-defined mongos settings for a MongoDB cluster.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongos.<br>userConfig.<br>net | **object**<br><p>Network settings for mongos.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongos.<br>userConfig.<br>net.<br>maxIncomingConnections | **integer** (int64)<br><p>The maximum number of simultaneous connections that mongos will accept.</p> <p>Acceptable values are 10 to 16384, inclusive.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongos.<br>userConfig.<br>net.<br>compression | **object**<br><p>Compression settings</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongos.<br>userConfig.<br>net.<br>compression.<br>compressors[] | **string**<br><p>Required. Specifies the default compressor(s) to use for communication between this mongod or mongos instance and:</p> <ul> <li>other members of the deployment if the instance is part of a replica set or a sharded cluster</li> <li>mongosh</li> <li>drivers that support the OP_COMPRESSED message format. MongoDB supports the following compressors:</li> </ul> <p>The number of elements must be in the range 1-3.</p> <ul> <li>SNAPPY: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-snappy">Snappy</a> compression.</li> <li>ZLIB: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-zlib">zlib</a> compression.</li> <li>ZSTD: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-zstd">zstd</a> compression.</li> <li>DISABLED: No compression</li> </ul> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongos.<br>defaultConfig | **object**<br><p>Default mongos configuration for a MongoDB cluster.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongos.<br>defaultConfig.<br>net | **object**<br><p>Network settings for mongos.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongos.<br>defaultConfig.<br>net.<br>maxIncomingConnections | **integer** (int64)<br><p>The maximum number of simultaneous connections that mongos will accept.</p> <p>Acceptable values are 10 to 16384, inclusive.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongos.<br>defaultConfig.<br>net.<br>compression | **object**<br><p>Compression settings</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongos.<br>defaultConfig.<br>net.<br>compression.<br>compressors[] | **string**<br><p>Required. Specifies the default compressor(s) to use for communication between this mongod or mongos instance and:</p> <ul> <li>other members of the deployment if the instance is part of a replica set or a sharded cluster</li> <li>mongosh</li> <li>drivers that support the OP_COMPRESSED message format. MongoDB supports the following compressors:</li> </ul> <p>The number of elements must be in the range 1-3.</p> <ul> <li>SNAPPY: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-snappy">Snappy</a> compression.</li> <li>ZLIB: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-zlib">zlib</a> compression.</li> <li>ZSTD: The <a href="https://docs.mongodb.com/v4.2/reference/glossary/#term-zstd">zstd</a> compression.</li> <li>DISABLED: No compression</li> </ul> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg | **object**
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>effectiveConfig | **object**<br><p>Effective mongocfg settings for a MongoDB cluster (a combination of settings defined in ``userConfig`` and ``defaultConfig``).</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>effectiveConfig.<br>storage | **object**<br><p>``storage`` section of mongocfg configuration.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>effectiveConfig.<br>storage.<br>wiredTiger | **object**<br><p>Configuration of the WiredTiger storage engine.</p> <p>Configuration of WiredTiger storage engine.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>effectiveConfig.<br>storage.<br>wiredTiger.<br>engineConfig | **object**<br><p>Engine configuration for WiredTiger.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>effectiveConfig.<br>storage.<br>wiredTiger.<br>engineConfig.<br>cacheSizeGb | **number** (double)<br><p>The maximum size of the internal cache that WiredTiger will use for all data.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>effectiveConfig.<br>operationProfiling | **object**<br><p>``operationProfiling`` section of mongocfg configuration.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>effectiveConfig.<br>operationProfiling.<br>mode | **string**<br><p>Mode which specifies operations that should be profiled.</p> <ul> <li>OFF: The profiler is off and does not collect any data.</li> <li>SLOW_OP: The profiler collects data for operations that take longer than the value of ``slowOpThreshold``.</li> <li>ALL: The profiler collects data for all operations.</li> </ul> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>effectiveConfig.<br>operationProfiling.<br>slowOpThreshold | **integer** (int64)<br><p>The slow operation time threshold, in milliseconds. Operations that run for longer than this threshold are considered slow, and are processed by the profiler running in the SLOW_OP mode. For details see <a href="https://www.mongodb.com/docs/v7.0/reference/configuration-options/#mongodb-setting-operationProfiling.slowOpThresholdMs">MongoDB documentation</a>.</p> <p>Value must be greater than 0.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>effectiveConfig.<br>net | **object**<br><p>``net`` section of mongocfg configuration.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>effectiveConfig.<br>net.<br>maxIncomingConnections | **integer** (int64)<br><p>The maximum number of simultaneous connections that mongocfg will accept.</p> <p>Acceptable values are 10 to 16384, inclusive.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>userConfig | **object**<br><p>User-defined mongocfg settings for a MongoDB cluster.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>userConfig.<br>storage | **object**<br><p>``storage`` section of mongocfg configuration.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>userConfig.<br>storage.<br>wiredTiger | **object**<br><p>Configuration of the WiredTiger storage engine.</p> <p>Configuration of WiredTiger storage engine.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>userConfig.<br>storage.<br>wiredTiger.<br>engineConfig | **object**<br><p>Engine configuration for WiredTiger.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>userConfig.<br>storage.<br>wiredTiger.<br>engineConfig.<br>cacheSizeGb | **number** (double)<br><p>The maximum size of the internal cache that WiredTiger will use for all data.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>userConfig.<br>operationProfiling | **object**<br><p>``operationProfiling`` section of mongocfg configuration.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>userConfig.<br>operationProfiling.<br>mode | **string**<br><p>Mode which specifies operations that should be profiled.</p> <ul> <li>OFF: The profiler is off and does not collect any data.</li> <li>SLOW_OP: The profiler collects data for operations that take longer than the value of ``slowOpThreshold``.</li> <li>ALL: The profiler collects data for all operations.</li> </ul> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>userConfig.<br>operationProfiling.<br>slowOpThreshold | **integer** (int64)<br><p>The slow operation time threshold, in milliseconds. Operations that run for longer than this threshold are considered slow, and are processed by the profiler running in the SLOW_OP mode. For details see <a href="https://www.mongodb.com/docs/v7.0/reference/configuration-options/#mongodb-setting-operationProfiling.slowOpThresholdMs">MongoDB documentation</a>.</p> <p>Value must be greater than 0.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>userConfig.<br>net | **object**<br><p>``net`` section of mongocfg configuration.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>userConfig.<br>net.<br>maxIncomingConnections | **integer** (int64)<br><p>The maximum number of simultaneous connections that mongocfg will accept.</p> <p>Acceptable values are 10 to 16384, inclusive.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>defaultConfig | **object**<br><p>Default mongocfg configuration for a MongoDB cluster.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>defaultConfig.<br>storage | **object**<br><p>``storage`` section of mongocfg configuration.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>defaultConfig.<br>storage.<br>wiredTiger | **object**<br><p>Configuration of the WiredTiger storage engine.</p> <p>Configuration of WiredTiger storage engine.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>defaultConfig.<br>storage.<br>wiredTiger.<br>engineConfig | **object**<br><p>Engine configuration for WiredTiger.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>defaultConfig.<br>storage.<br>wiredTiger.<br>engineConfig.<br>cacheSizeGb | **number** (double)<br><p>The maximum size of the internal cache that WiredTiger will use for all data.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>defaultConfig.<br>operationProfiling | **object**<br><p>``operationProfiling`` section of mongocfg configuration.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>defaultConfig.<br>operationProfiling.<br>mode | **string**<br><p>Mode which specifies operations that should be profiled.</p> <ul> <li>OFF: The profiler is off and does not collect any data.</li> <li>SLOW_OP: The profiler collects data for operations that take longer than the value of ``slowOpThreshold``.</li> <li>ALL: The profiler collects data for all operations.</li> </ul> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>defaultConfig.<br>operationProfiling.<br>slowOpThreshold | **integer** (int64)<br><p>The slow operation time threshold, in milliseconds. Operations that run for longer than this threshold are considered slow, and are processed by the profiler running in the SLOW_OP mode. For details see <a href="https://www.mongodb.com/docs/v7.0/reference/configuration-options/#mongodb-setting-operationProfiling.slowOpThresholdMs">MongoDB documentation</a>.</p> <p>Value must be greater than 0.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>defaultConfig.<br>net | **object**<br><p>``net`` section of mongocfg configuration.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>configMongocfg.<br>defaultConfig.<br>net.<br>maxIncomingConnections | **integer** (int64)<br><p>The maximum number of simultaneous connections that mongocfg will accept.</p> <p>Acceptable values are 10 to 16384, inclusive.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>resources | **object**<br><p>Resources allocated to mongoinfra (mongos+mongocfg) hosts.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>resources.<br>resourcePresetId | **string**<br><p>ID of the preset for computational resources available to a host (CPU, memory etc.). All available presets are listed in the <a href="/docs/managed-mongodb/concepts/instance-types">documentation</a>.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>resources.<br>diskSize | **string** (int64)<br><p>Volume of the storage available to a host, in bytes.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>resources.<br>diskTypeId | **string**<br><p>Type of the storage environment for the host. Possible values:</p> <ul> <li>network-hdd - network HDD drive,</li> <li>network-ssd - network SSD drive,</li> <li>local-ssd - local SSD storage.</li> </ul> 
config.<br>mongodbConfig.<br>mongoinfra.<br>diskSizeAutoscaling | **object**<br><p>Disk size autoscaling settings</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>diskSizeAutoscaling.<br>plannedUsageThreshold | **integer** (int64)<br><p>Amount of used storage for automatic disk scaling in the maintenance window, 0 means disabled, in percent.</p> <p>Acceptable values are 0 to 100, inclusive.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>diskSizeAutoscaling.<br>emergencyUsageThreshold | **integer** (int64)<br><p>Amount of used storage for immediately  automatic disk scaling, 0 means disabled, in percent.</p> <p>Acceptable values are 0 to 100, inclusive.</p> 
config.<br>mongodbConfig.<br>mongoinfra.<br>diskSizeAutoscaling.<br>diskSizeLimit | **integer** (int64)<br><p>Limit on how large the storage for database instances can automatically grow, in bytes.</p> 
...
config.<br>mongodb_5_0.<br>mongod.<br>config.<br>effectiveConfig.<br>setParameter.<br>minSnapshotHistoryWindowInSeconds | **integer** (int64)<br><p>The minimum time window in seconds for which the storage engine keeps the snapshot history.</p> <p>The minimum value is 0.</p> 
...
config.<br>mongodb_5_0.<br>mongod.<br>config.<br>userConfig.<br>setParameter.<br>minSnapshotHistoryWindowInSeconds | **integer** (int64)<br><p>The minimum time window in seconds for which the storage engine keeps the snapshot history.</p> <p>The minimum value is 0.</p> 
...
config.<br>mongodb_5_0.<br>mongod.<br>config.<br>defaultConfig.<br>setParameter.<br>minSnapshotHistoryWindowInSeconds | **integer** (int64)<br><p>The minimum time window in seconds for which the storage engine keeps the snapshot history.</p> <p>The minimum value is 0.</p> 
...
config.<br>mongodb_6_0.<br>mongod.<br>config.<br>effectiveConfig.<br>setParameter.<br>minSnapshotHistoryWindowInSeconds | **integer** (int64)<br><p>The minimum time window in seconds for which the storage engine keeps the snapshot history.</p> <p>The minimum value is 0.</p> 
...
config.<br>mongodb_6_0.<br>mongod.<br>config.<br>userConfig.<br>setParameter.<br>minSnapshotHistoryWindowInSeconds | **integer** (int64)<br><p>The minimum time window in seconds for which the storage engine keeps the snapshot history.</p> <p>The minimum value is 0.</p> 
...
config.<br>mongodb_6_0.<br>mongod.<br>config.<br>defaultConfig.<br>setParameter.<br>minSnapshotHistoryWindowInSeconds | **integer** (int64)<br><p>The minimum time window in seconds for which the storage engine keeps the snapshot history.</p> <p>The minimum value is 0.</p> 
...
config.<br>mongodb_5_0Enterprise.<br>mongod.<br>config.<br>effectiveConfig.<br>setParameter.<br>minSnapshotHistoryWindowInSeconds | **integer** (int64)<br><p>The minimum time window in seconds for which the storage engine keeps the snapshot history.</p> <p>The minimum value is 0.</p> 
...
config.<br>mongodb_5_0Enterprise.<br>mongod.<br>config.<br>userConfig.<br>setParameter.<br>minSnapshotHistoryWindowInSeconds | **integer** (int64)<br><p>The minimum time window in seconds for which the storage engine keeps the snapshot history.</p> <p>The minimum value is 0.</p> 
...
config.<br>mongodb_5_0Enterprise.<br>mongod.<br>config.<br>defaultConfig.<br>setParameter.<br>minSnapshotHistoryWindowInSeconds | **integer** (int64)<br><p>The minimum time window in seconds for which the storage engine keeps the snapshot history.</p> <p>The minimum value is 0.</p> 
...
config.<br>mongodb_6_0Enterprise.<br>mongod.<br>config.<br>effectiveConfig.<br>setParameter.<br>minSnapshotHistoryWindowInSeconds | **integer** (int64)<br><p>The minimum time window in seconds for which the storage engine keeps the snapshot history.</p> <p>The minimum value is 0.</p> 
...
config.<br>mongodb_6_0Enterprise.<br>mongod.<br>config.<br>userConfig.<br>setParameter.<br>minSnapshotHistoryWindowInSeconds | **integer** (int64)<br><p>The minimum time window in seconds for which the storage engine keeps the snapshot history.</p> <p>The minimum value is 0.</p> 
...
config.<br>mongodb_6_0Enterprise.<br>mongod.<br>config.<br>defaultConfig.<br>setParameter.<br>minSnapshotHistoryWindowInSeconds | **integer** (int64)<br><p>The minimum time window in seconds for which the storage engine keeps the snapshot history.</p> <p>The minimum value is 0.</p> 
