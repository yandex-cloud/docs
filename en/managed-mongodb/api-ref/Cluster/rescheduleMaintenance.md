---
editable: false
sourcePath: en/_api-ref/mdb/mongodb/api-ref/Cluster/rescheduleMaintenance.md
---
...
```
POST https://mdb.{{ api-host }}/managed-mongodb/v1/clusters/{clusterId}:rescheduleMaintenance
```
...
--- | ---
clusterId | <p>Required. ID of the MongoDB cluster to reschedule the maintenance operation for.</p> <p>The maximum string length in characters is 50.</p> 
