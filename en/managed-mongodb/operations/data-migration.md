...
1. In the management console, [create a new virtual machine](../../compute/operations/vm-create/create-linux-vm.md) from the [Ubuntu 18.04](https://cloud.yandex.com/en-ru/marketplace/products/f2e9qa7i4fmugh14tjnc) image. The required amount of RAM and processor cores depends on the amount of data to migrate and the required migration speed.
