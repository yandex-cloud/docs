...
In January 2022, clusters running {{ MG }} 4.0 will be [forcibly upgraded](../qa/general.md#dbms-deprecated) to version 4.2, as version 4.0 [will be discontinued](https://www.mongodb.com/support-policy). We recommend that you upgrade to the latest {{ MG }} versions in advance.
