...
- Management console
   ...
   To request access to [Point-in-Time-Recovery](../concepts/backup.md) (PITR) in the Preview mode, click **Request access** in the **Point-in-time recovery** line and fill out the form.
