...
- API
   ...
   To {% if audience != "internal" %}increase{% else %}modify{% endif %} your cluster's storage size, use the API [update](../api-ref/Cluster/update.md) method and pass the requisite values in in the call using the `configSpec.mongodbSpec_4_2.mongod.resources.diskSize` parameter.
