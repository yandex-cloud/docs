...
To use the service, you need the `{{ roles.mmg.editor }}` [role](../../iam/concepts/access-control/roles.md) or higher to the folder where a cluster is created. The `{{ roles.mmg.viewer }}` role only enables you to view the cluster list.
