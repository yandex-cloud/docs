...
Сервис | Описание
--- | ---
[BackupService](./backup_service.md) | Набор методов для управления ресурсами Backup для MongoDB.
[ClusterService](./cluster_service.md) | Набор методов для управления ресурсами Cluster для MongoDB.
[DatabaseService](./database_service.md) | Набор методов для управления ресурсами Database для MongoDB.
[ResourcePresetService](./resource_preset_service.md) | Набор методов для управления ресурсами ResourcePreset.
[UserService](./user_service.md) | Набор методов для управления ресурсами User для MongoDB.
