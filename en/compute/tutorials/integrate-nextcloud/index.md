...
* [Nextcloud deployment on a {{ compute-name }} VM using a {{ coi }}](./coi-based.md) is a way to quickly deploy the basic Nextcloud functionality in your {{ yandex-cloud }} infrastructure.
