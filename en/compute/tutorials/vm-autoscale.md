...
1. Create a network load balancer named `group-balancer` and connect it to the instance group you created:
   ...
   - Management console
     ...
     1. Enter the **Name** `group-balancer`.
...
1. Delete the subnets:
   ...
   - Management console
     ...
     1. In the [management console]({{ link-console-main }}), select the folder where you created your subnets.
     1. Open the **{{ vpc-name }}** section.
     1. Click the name of the subnets' network.
     1. Click ![image](../../_assets/options.svg) in the row of the subnet you wish to delete.
     1. In the menu that opens, click **Delete**.
   ...
   - CLI
     ...
     1. Delete the subnet in the `ru-central1-b` zone:
     ...
     1. Delete the subnet in the `ru-central1-c` zone:
   ...
   - API
     ...
     Use the method [delete](../../vpc/api-ref/Subnet/delete.md) for the `Subnet` resource.
...
1. Delete the network:
   ...
   - Management console
     ...
     1. In the [management console]({{ link-console-main }}), select the folder where you created your network.
     1. Open the **{{ vpc-name }}** section.
     1. Click ![image](../../_assets/options.svg) in the row of the network you wish to delete.
     1. In the menu that opens, click **Delete**.
     1. In the window that opens, click **Delete**.
   ...
   - API
     ...
     Use the method [delete](../../vpc/api-ref/Network/delete.md) for the `Network` resource.
...
1. Delete the service account:
   ...
   - API
     ...
     Use the method [delete](../../iam/api-ref/ServiceAccount/delete.md) for the `ServiceAccount` resource.
