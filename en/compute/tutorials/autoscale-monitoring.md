...
1. Open dashboards in {{ monitoring-full-name }}:
   ...
   - Management console
     ...
     1. Open the dashboard with information about the instance group:
        1. In [{{ monitoring-name }}](https://monitoring.cloud.yandex.com), select the **Compute — Instance Groups** service dashboard.
        1. In the **Instance Group ID** field, select `queue-autoscale-ig`.

     1. Open the dashboard with queue information:
        1. In [{{ monitoring-name }}](https://monitoring.cloud.yandex.com), select the **Message Queue** service dashboard.
