...
To be able to create, update, and delete VMs in the group, as well as integrate the group with an {{ alb-name }} L7 load balancer, [assign](../../../iam/operations/sa/assign-role-for-sa.md) the [compute.editor](../../security/index.md#compute-editor) and [alb.editor](../../../application-load-balancer/security/index.md#alb-editor) roles to the service account.
...
- Management console {#console}
  ...
  1. Under **{{ ui-key.yacloud.compute.groups.create.section_base }}**:
     ...
     * Select the [service account](../../../iam/concepts/users/service-accounts.md) from the list or create a new one. To be able to create, update, and delete VMs in the group, as well as integrate the group with an {{ alb-name }} L7 load balancer, [assign](../../../iam/operations/sa/assign-role-for-sa.md) the [compute.editor](../../security/index.md#compute-editor) and [alb.editor](../../../application-load-balancer/security/index.md#alb-editor) roles to the service account. By default, all instance group operations are performed on behalf of the service account.
...
- CLI {#cli}
  ...
  1. Define the following in the file you created:
     ...
     * {{ alb-full-name }} [target group](../../../application-load-balancer/concepts/target-group.md):
       ...
       * `name`: Name for the {{ alb-name }} target group. The name must be unique within the folder. It may contain lowercase Latin letters, numbers, and hyphens. The first character must be a letter. The last character cannot be a hyphen. The name may be up to 63 characters long.
