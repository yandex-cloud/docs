...
- Management console
  ...
  1. Under **Integration with {{ alb-name }}**, toggle the switch to the right of the **Create target group** field.
...
- CLI
  ...
  After that you can add the target group `first-target-group` to a [new](../../../application-load-balancer/operations/backend-group-create.md) or an [existing backend group](../../../application-load-balancer/operations/backend-group-update.md) in {{ alb-name }}, and add the group of backends to a [new](../../../application-load-balancer/operations/http-router-create.md) or [existing HTTP router](../../../application-load-balancer/operations/http-router-update.md), and add the router to a [new](../../../application-load-balancer/operations/application-load-balancer-create.md) or [existing L7 load balancer](../../../application-load-balancer/operations/application-load-balancer-update.md).
...
- Terraform
  ...
  1. In the configuration file, describe the parameters of resources that you want to create:
     ...
     * `yandex_resourcemanager_folder_iam_binding`: Description of access rights to the folder that the service account belongs to. To be able to create, update, and delete group instances, assign to the service account the [role](../../../iam/concepts/access-control/roles.md) `editor` role.
