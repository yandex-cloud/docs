...
- CLI {#cli}
  ...
  1. In the created file, indicate the following:
     ...
     * [Policies](../../concepts/instance-groups/policies/index.md):
       ...
       * `allocation_policy`: [Allocation policy](../../concepts/instance-groups/policies/allocation-policy.md) of instances across [availability zones](../../../overview/concepts/geo-scope.md).
     * {{ alb-full-name }} [target group](../../../application-load-balancer/concepts/target-group.md):
       ...
       * `name`: Name for the {{ alb-name }} target group. The name must be unique within the folder. The name may contain lowercase Latin letters, numbers, and hyphens. The first character must be a letter. The last character cannot be a hyphen. The name may be up to 63 characters long.
