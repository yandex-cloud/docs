   ...
   1. In the configuration file, describe the parameters of the resources you want to create:
      ...
      * `yandex_compute_instance_group`: Description of an [instance group](../../concepts/index.md):
         ...
         * [The instance template](../../concepts/instance-groups/instance-template.md):
            ...
            | `metadata` | In metadata, provide the public key for accessing the VM {% if lang == "ru" and audience != internal %}[via SSH](../../../glossary/ssh-keygen.md){% else %}via SSH{% endif %}. For more information, see [{#T}](../../concepts/vm-metadata.md). |
