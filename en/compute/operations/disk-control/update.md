...
* [Change its name and description](#change-disk-name).
...
- Management console
  1. In the [management console]({{ link-console-main }}), select the folder to update the disk in.
...
- API
  ...
  You can change the name and description of the disk using the [update](../../api-ref/Disk/update.md) API method for the [Disk](../../api-ref/Disk/) resource.
...
- API
  ...
  You can change the disk size using the [update](../../api-ref/Disk/update.md) API method for the [Disk](../../api-ref/Disk/) resource.
