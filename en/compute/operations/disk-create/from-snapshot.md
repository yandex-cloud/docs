...
- Management console
   ...
   1. If necessary, select a [schedule](../../concepts/snapshot-schedule.md) for automatic snapshot creation, or set up a new schedule. For more information about setting up schedules, see the [instructions](../snapshot-control/create-schedule.md).
   ...
   1. Under **Content**, select the **Snapshot** mode and click an appropriate snapshot in the list below. Use the filter to find the snapshot.
   1. Click **Create disk**.
...
{% if product == "yandex-cloud" %}* [{#T}](../../../backup/concepts/index.md){% endif %}
