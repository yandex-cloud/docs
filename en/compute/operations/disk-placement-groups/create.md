...
- Management console {#console}
  ...
  1. Click **{{ ui-key.yacloud.compute.placement-groups.button_create }}** and select **{{ ui-key.yacloud.compute.placement-groups.button_menu-create-disk-placement-group }}**.
