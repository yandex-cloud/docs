...
- Windows
  ...
  1. Assign a letter to the attached disk. To learn how to do this, see [Microsoft documentation](https://docs.microsoft.com/en-us/windows-server/storage/disk-management/change-a-drive-letter).
...
- Linux
  ...
  1. Format the disk for the appropriate file system. For example, you can use the [mkfs](https://manpages.ubuntu.com/manpages/xenial/en/man8/mkfs.8.html) utility. Enter the following command to format your partition with the ext4 file system:
...
- Windows
  ...
  1. Select [partition style](https://docs.microsoft.com/en-us/windows-server/storage/disk-management/initialize-new-disks#about-partition-styles---gpt-and-mbr) and click **OK**.

  1. Create partitions on the disk. To do this, right-click on the empty disk and select **New Simple Volume**.

  1. Use the **New Simple Volume Wizard** to set the size of the partition, [assign a drive letter](https://docs.microsoft.com/en-us/windows-server/storage/disk-management/change-a-drive-letter), disk, and specify the file system.
