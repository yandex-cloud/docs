...
The `{{ region-id }}-d` zone does not support VM instances running on Intel Broadwell [platform](../../concepts/vm-platforms.md). To move such an instance to the `{{ region-id }}-d` zone, you can do one of the following:
