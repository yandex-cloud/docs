...
- Management console
   ...
   1. In the window that opens:
      * In the **Public IP** field, choose **Auto** assignment of IP addresses or choose a reserved address from a **List**
         {% if product == "yandex-cloud" %}* (option) If you selected **Auto** under **Public IP**, enable the **DDoS protection** option. For more information, see [{#T}](../../../vpc/ddos-protection/index.md).{% endif %}
