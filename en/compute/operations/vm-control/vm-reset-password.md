...
* The [password reset agent](../../concepts/guest-agent.md), which can be installed by following the [instructions](../vm-guest-agent/install.md). In June 2022, the agent will be included in standard Windows images.
