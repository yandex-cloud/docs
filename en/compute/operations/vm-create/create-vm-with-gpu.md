...
- CLI
  ...
  1. Create a VM in the default folder. Specify the following parameters:
      ...
      - [Image](../images-with-pre-installed-software/get-list.md) of the OS. `ubuntu-1604-lts-gpu`: [Ubuntu 16.04.6 LTS]{% if lang == "ru" %}(https://cloud.yandex.ru/marketplace/products/f2e0e2jmj38nmqe3cagl){% endif %}{% if lang == "en" %}(https://cloud.yandex.com/en-ru/marketplace/products/f2e0e2jmj38nmqe3cagl){% endif %} with CUDA drivers.
