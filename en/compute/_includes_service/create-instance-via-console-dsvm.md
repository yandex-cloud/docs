To create a virtual machine from a public [DSVM]{% if lang == "ru" %}(https://cloud.yandex.ru/marketplace/products/f2e4v304qn35mhilnsbc){% endif %}{% if lang == "en" %}(https://cloud.yandex.com/en-ru/marketplace/products/f2e4v304qn35mhilnsbc){% endif %} image:
