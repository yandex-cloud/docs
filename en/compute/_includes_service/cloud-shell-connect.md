1. On the left-hand panel in the [management console]({{ link-console-main }}), click ![image](../../_assets/console-icons/dots-9.svg) **{{ ui-key.yacloud.dashboard.DashboardPage.ServicesSection.title_ur39b }}** and select **{{ ui-key.yacloud.iam.folder.dashboard.label_compute }}**, or find it using the search bar on the dashboard.
