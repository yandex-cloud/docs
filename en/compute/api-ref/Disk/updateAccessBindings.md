...
editable: false
apiPlayground:
  - url: https://compute.{{ api-host }}/compute/v1/disks/{resourceId}:updateAccessBindings
    method: post
    path:
      type: object
      properties:
    ...
    definitions:
      ...
      AccessBindingDelta:
        ...
        required:
          - action
          - accessBinding
sourcePath: en/_api-ref/compute/v1/api-ref/Disk/updateAccessBindings.md
---

# Compute Cloud API, REST: Disk.UpdateAccessBindings
...
```
POST https://compute.{{ api-host }}/compute/v1/disks/{resourceId}:updateAccessBindings
```
