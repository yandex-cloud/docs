...
disks.<br>createdAt | **string** (date-time)<br><p>Creation timestamp in <a href="https://www.ietf.org/rfc/rfc3339.txt">RFC3339</a> text format.</p> 
...
disks.<br>status | **string**<br><ul> <li>CREATING: Disk is being created.</li> <li>READY: Disk is ready to use.</li> <li>ERROR: Disk encountered a problem and cannot operate.</li> <li>DELETING: Disk is being deleted.</li> </ul> 
