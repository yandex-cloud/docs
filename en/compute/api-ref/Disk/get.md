...
status | **string**<br><ul> <li>CREATING: Disk is being created.</li> <li>READY: Disk is ready to use.</li> <li>ERROR: Disk encountered a problem and cannot operate.</li> <li>DELETING: Disk is being deleted.</li> </ul> 
