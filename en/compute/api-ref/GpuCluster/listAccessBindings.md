...
editable: false
apiPlayground:
  - url: https://compute.{{ api-host }}/compute/v1/gpuClusters/{resourceId}:listAccessBindings
    method: get
    path:
      type: object
      properties:
    ...
    body: null
    definitions: null
sourcePath: en/_api-ref/compute/v1/api-ref/GpuCluster/listAccessBindings.md
---

# Compute Cloud API, REST: GpuCluster.ListAccessBindings
...
```
GET https://compute.{{ api-host }}/compute/v1/gpuClusters/{resourceId}:listAccessBindings
```
