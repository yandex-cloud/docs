...
editable: false
apiPlayground:
  - url: https://compute.{{ api-host }}/compute/v1/gpuClusters/{resourceId}:updateAccessBindings
    method: post
    path:
      type: object
      properties:
...
# Compute Cloud API, REST: GpuCluster.UpdateAccessBindings
...
```
POST https://compute.{{ api-host }}/compute/v1/gpuClusters/{resourceId}:updateAccessBindings
```
