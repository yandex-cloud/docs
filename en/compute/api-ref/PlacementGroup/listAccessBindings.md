...
editable: false
apiPlayground:
  - url: https://compute.{{ api-host }}/compute/v1/placementGroups/{resourceId}:listAccessBindings
    method: get
    path:
      type: object
      properties:
...
```
GET https://compute.{{ api-host }}/compute/v1/placementGroups/{resourceId}:listAccessBindings
```
