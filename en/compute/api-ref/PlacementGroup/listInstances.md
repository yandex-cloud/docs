        ...
        pageSize:
          description: |-
            **string** (int64)
            ...
            the service returns a [ListPlacementGroupInstancesResponse.nextPageToken](/docs/compute/api-ref/PlacementGroup/listInstances#yandex.cloud.compute.v1.ListPlacementGroupInstancesResponse)
        ...
        pageToken:
          description: |-
            **string**
            ...
            set `pageToken` to the [ListPlacementGroupInstancesResponse.nextPageToken](/docs/compute/api-ref/PlacementGroup/listInstances#yandex.cloud.compute.v1.ListPlacementGroupInstancesResponse)
