...
editable: false
apiPlayground:
  - url: https://compute.{{ api-host }}/compute/v1/placementGroups/{placementGroupId}/operations
    method: get
    path:
      type: object
      properties:
        ...
        pageSize:
          description: |-
            **string** (int64)
            ...
            results is larger than `pageSize`, the service returns a [ListPlacementGroupOperationsResponse.nextPageToken](/docs/compute/api-ref/PlacementGroup/listOperations#yandex.cloud.compute.v1.ListPlacementGroupOperationsResponse)
        ...
        pageToken:
          description: |-
            **string**
            ...
            [ListPlacementGroupOperationsResponse.nextPageToken](/docs/compute/api-ref/PlacementGroup/listOperations#yandex.cloud.compute.v1.ListPlacementGroupOperationsResponse) returned by a previous list request.
          type: string
      additionalProperties: false
    body: null
    definitions: null
...
## Query parameters {#yandex.cloud.compute.v1.ListPlacementGroupOperationsRequest}
...
## Response {#yandex.cloud.compute.v1.ListPlacementGroupOperationsResponse}
