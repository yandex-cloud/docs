...
The [SnapshotSchedule.status](/docs/compute/api-ref/SnapshotSchedule/get#yandex.cloud.compute.v1.SnapshotSchedule) is changed to `ACTIVE`: new disk snapshots will be created, old ones deleted
