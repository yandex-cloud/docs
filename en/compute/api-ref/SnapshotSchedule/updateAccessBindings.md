...
editable: false
apiPlayground:
  - url: https://compute.{{ api-host }}/compute/v1/snapshotSchedules/{resourceId}:updateAccessBindings
    method: post
    path:
      type: object
      properties:
    ...
    definitions:
      ...
      AccessBindingDelta:
        ...
        required:
          - action
          - accessBinding
sourcePath: en/_api-ref/compute/v1/api-ref/SnapshotSchedule/updateAccessBindings.md
---
...
```
POST https://compute.{{ api-host }}/compute/v1/snapshotSchedules/{resourceId}:updateAccessBindings
```
