---
editable: false
sourcePath: en/_api-ref/compute/api-ref/Snapshot/get.md
---
...
--- | ---
snapshotId | <p>Required. ID of the Snapshot resource to return. To get the snapshot ID, use a <a href="/docs/compute/api-ref/Snapshot/list">list</a> request.</p> <p>The maximum string length in characters is 50.</p> 
