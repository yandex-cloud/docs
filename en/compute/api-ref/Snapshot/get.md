...
--- | ---
snapshotId | Required. ID of the Snapshot resource to return. To get the snapshot ID, use a [list](/docs/compute/api-ref/Snapshot/list) request.  The maximum string length in characters is 50.
