...
editable: false
apiPlayground:
  - url: https://compute.{{ api-host }}/compute/v1/snapshots/{resourceId}:setAccessBindings
    method: post
    path:
      type: object
      properties:
    ...
    definitions:
      ...
      AccessBinding:
        ...
        required:
          - roleId
          - subject
sourcePath: en/_api-ref/compute/v1/api-ref/Snapshot/setAccessBindings.md
---

# Compute Cloud API, REST: Snapshot.SetAccessBindings
...
```
POST https://compute.{{ api-host }}/compute/v1/snapshots/{resourceId}:setAccessBindings
```
