---
editable: false
sourcePath: en/_api-ref/compute/v1/api-ref/HostGroup/updateAccessBindings.md
---
...
```
POST https://compute.{{ api-host }}/compute/v1/hostGroups/{resourceId}:updateAccessBindings
```
