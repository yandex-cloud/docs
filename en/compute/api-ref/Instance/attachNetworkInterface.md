...
editable: false
apiPlayground:
  - url: https://compute.{{ api-host }}/compute/v1/instances/{instanceId}:attachNetworkInterface
    method: post
    path:
      type: object
      properties:
...
To attach a network-interface, the instance must have a `STOPPED` status ([Instance.status](/docs/compute/api-ref/GpuCluster/listInstances#yandex.cloud.compute.v1.Instance)).
...
## Body parameters {#yandex.cloud.compute.v1.AttachInstanceNetworkInterfaceRequest}
