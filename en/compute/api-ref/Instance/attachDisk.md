...
attachedDiskSpec.<br>mode | **string**<br><ul> <li>READ_ONLY: Read-only access.</li> <li>READ_WRITE: Read/Write access. Default value.</li> </ul> 
...
attachedDiskSpec.<br>diskSpec | **object** <br>`attachedDiskSpec` includes only one of the fields `diskSpec`, `diskId`<br><br>
