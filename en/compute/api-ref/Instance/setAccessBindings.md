...
editable: false
apiPlayground:
  - url: https://compute.{{ api-host }}/compute/v1/instances/{resourceId}:setAccessBindings
    method: post
    path:
      type: object
      properties:
...
```
POST https://compute.{{ api-host }}/compute/v1/instances/{resourceId}:setAccessBindings
```
