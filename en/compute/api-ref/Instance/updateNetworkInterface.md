...
editable: false
apiPlayground:
  - url: https://compute.{{ api-host }}/compute/v1/instances/{instanceId}/updateNetworkInterface
    method: patch
    path:
      type: object
      properties:
...
## Body parameters {#yandex.cloud.compute.v1.UpdateInstanceNetworkInterfaceRequest}
