---
editable: false
sourcePath: en/_api-ref/compute/api-ref/Instance/detachDisk.md
---
...
--- | ---
instanceId | <p>Required. ID of the instance to detach the disk from. To get the instance ID, use a <a href="/docs/compute/api-ref/Instance/list">list</a> request.</p> <p>The maximum string length in characters is 50.</p> 
