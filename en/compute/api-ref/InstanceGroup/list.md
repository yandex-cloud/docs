...
instanceGroups[].<br>scalePolicy.<br>testAutoScale | **object**<br>Test spec for [automatic scaling policy](/docs/compute/concepts/instance-groups/scale#auto-scale) of the instance group.
...
instanceGroups[].<br>scalePolicy.<br>autoScale | **object**<br>[Automatic scaling policy](/docs/compute/concepts/instance-groups/scale#auto-scale) of the instance group. <br>`instanceGroups[].scalePolicy` includes only one of the fields `fixedScale`, `autoScale`<br>
