---
editable: false
sourcePath: en/_api-ref/compute/v1/api-ref/InstanceGroup/listInstances.md
---
...
instances[].<br>networkInterfaces[].<br>index | **string**<br><p>The index of the network interface, generated by the server, 0,1,2... etc.</p> 
