...
scalePolicy.<br>testAutoScale | **object**<br>
...
healthChecksSpec.<br>healthCheckSpecs[].<br>tcpOptions | **object** <br>`healthChecksSpec.healthCheckSpecs[]` includes only one of the fields `tcpOptions`, `httpOptions`<br><br>
...
healthChecksSpec.<br>healthCheckSpecs[].<br>httpOptions | **object** <br>`healthChecksSpec.healthCheckSpecs[]` includes only one of the fields `tcpOptions`, `httpOptions`<br><br>
...
Method | Description
--- | ---
[create](create.md) | Creates an instance group in the specified folder. This method starts an operation that can be cancelled by another operation.
[createFromYaml](createFromYaml.md) | Creates an instance group in the specified folder from a YAML file. This method starts an operation that can be cancelled by another operation.
