---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/api-ref/grpc/SnapshotSchedule/setAccessBindings.md
---

# Compute Cloud API, gRPC: SnapshotScheduleService.SetAccessBindings {#SetAccessBindings}
