...
# Compute Cloud API, gRPC: PlacementGroupService.ListInstances {#ListInstances}
...
## ListPlacementGroupInstancesResponse {#yandex.cloud.compute.v1.ListPlacementGroupInstancesResponse}
