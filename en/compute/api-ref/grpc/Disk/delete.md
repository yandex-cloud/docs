---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/api-ref/grpc/Disk/delete.md
---

# Compute Cloud API, gRPC: DiskService.Delete {#Delete}
...
**rpc Delete ([DeleteDiskRequest](#yandex.cloud.compute.v1.DeleteDiskRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## DeleteDiskRequest {#yandex.cloud.compute.v1.DeleteDiskRequest}
...
|| metadata | **[DeleteDiskMetadata](#yandex.cloud.compute.v1.DeleteDiskMetadata)**
...
## DeleteDiskMetadata {#yandex.cloud.compute.v1.DeleteDiskMetadata}
