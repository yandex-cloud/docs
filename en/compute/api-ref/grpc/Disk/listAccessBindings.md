---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/api-ref/grpc/Disk/listAccessBindings.md
---

# Compute Cloud API, gRPC: DiskService.ListAccessBindings {#ListAccessBindings}
