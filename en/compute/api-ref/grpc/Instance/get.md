---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/api-ref/grpc/Instance/get.md
---

# Compute Cloud API, gRPC: InstanceService.Get {#Get}

Returns the specified Instance resource.

To get the list of available Instance resources, make a [List](/docs/compute/api-ref/grpc/Instance/list#List) request.
