---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/api-ref/grpc/Instance/move.md
---

# Compute Cloud API, gRPC: InstanceService.Move {#Move}

Moves the specified instance to another folder of the same cloud.

The instance must be stopped before moving. To stop the instance, make a [Stop](/docs/compute/api-ref/grpc/Instance/stop#Stop) request.
...
**rpc Move ([MoveInstanceRequest](#yandex.cloud.compute.v1.MoveInstanceRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## MoveInstanceRequest {#yandex.cloud.compute.v1.MoveInstanceRequest}
