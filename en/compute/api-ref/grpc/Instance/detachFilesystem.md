---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/api-ref/grpc/Instance/detachFilesystem.md
---

# Compute Cloud API, gRPC: InstanceService.DetachFilesystem

Detaches the filesystem from the instance.

## gRPC request

**rpc DetachFilesystem ([DetachInstanceFilesystemRequest](#yandex.cloud.compute.v1.DetachInstanceFilesystemRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## DetachInstanceFilesystemRequest {#yandex.cloud.compute.v1.DetachInstanceFilesystemRequest}

```json
{
  "instance_id": "string",
  // Includes only one of the fields `filesystem_id`, `device_name`
...
|| metadata | **[DetachInstanceFilesystemMetadata](#yandex.cloud.compute.v1.DetachInstanceFilesystemMetadata)**
...
## DetachInstanceFilesystemMetadata {#yandex.cloud.compute.v1.DetachInstanceFilesystemMetadata}
