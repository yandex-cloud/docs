---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/api-ref/grpc/Instance/listAccessBindings.md
---

# Compute Cloud API, gRPC: InstanceService.ListAccessBindings {#ListAccessBindings}
