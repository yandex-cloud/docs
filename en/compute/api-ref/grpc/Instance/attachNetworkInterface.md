...
To attach a network-interface, the instance must have a `STOPPED` status ([Instance.status](/docs/compute/api-ref/grpc/GpuCluster/listInstances#yandex.cloud.compute.v1.Instance)).
