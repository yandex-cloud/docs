...
editable: false
---
# Pricing policy for [!KEYREF compute-full-name] before January 1, 2019
...
When creating a VM, you specify the number of vCPUs, the basic level of core performance, and the amount of RAM in GB. For more information, see the section [[!TITLE]](../concepts/performance-levels.md).
