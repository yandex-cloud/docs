---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/compute/cli-ref/v0/filesystem/set-access-bindings
editable: false
---

# yc compute v0 filesystem set-access-bindings

Set access bindings for the specified filesystem and delete all existing access bindings if there were any

#### Command Usage

Syntax:

`yc compute filesystem set-access-bindings <FILESYSTEM-NAME>|<FILESYSTEM-ID> [Flags...] [Global Flags...]`
