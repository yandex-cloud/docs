---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/compute/cli-ref/v0/host-group/add-access-binding/
---

# yc compute v0 host-group add-access-binding

Add access binding for the specified host group

#### Command Usage

Syntax:

`yc compute host-group add-access-binding <HOST-GROUP-NAME>|<HOST-GROUP-ID> [Flags...] [Global Flags...]`
