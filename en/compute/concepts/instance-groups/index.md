...
An instance group created in a folder can be accessed by all VMs connected to the same cloud network. For more information about how the network works, see [this {{ vpc-name }} guide](../../../vpc/).
