...
You can create or edit an instance group based on the specification in the [YAML]{% if lang == "ru" %}(https://ru.wikipedia.org/wiki/YAML){% endif %}{% if lang == "en" %}(https://en.wikipedia.org/wiki/YAML){% endif %} format. The specification describes:
...
The list, structure, and {% if lang == "ru" %} English {% endif %} descriptions of specification fields are provided:

* In the specification of the [CreateInstanceGroupRequest](https://github.com/yandex-cloud/cloudapi/blob/master/yandex/cloud/compute/v1/instancegroup/instance_group_service.proto#L219) structure and other [structures used in it](https://github.com/yandex-cloud/cloudapi/blob/master/yandex/cloud/compute/v1/instancegroup/instance_group.proto), in the API repository on GitHub ([Protobuf]{% if lang == "ru" %}(https://ru.wikipedia.org/wiki/Protocol_Buffers){% endif %}{% if lang == "en" %}(https://en.wikipedia.org/wiki/Protocol_Buffers){% endif %} format).
* In the description of the method [Create](../../api-ref/InstanceGroup/create) of the `InstanceGroup` resource in the REST API ([JSON]{% if lang == "ru" %}(https://ru.wikipedia.org/wiki/JSON){% endif %}{% if lang == "en" %}(https://en.wikipedia.org/wiki/JSON){% endif %} format).
...
Some first-level fields and their nested fields are also described {% if lang == "ru" %} in Russian {% endif %} in the following documentation sections:
