...
* [NVIDIA® Tesla® T4]{% if region =="int" %}(https://www.nvidia.com/en-us/data-center/tesla-t4/){% else %}(https://www.nvidia.com/ru-ru/data-center/tesla-t4/){% endif %} with 16 GB of GDDR6 memory.
...
* A license for [NVIDIA® RTX vWS]{% if lang == "ru" %}(https://www.nvidia.com/ru-ru/design-visualization/virtual-workstation/){% endif %}{% if lang == "en" %}(https://www.nvidia.com/en-us/design-visualization/virtual-workstation/){% endif %} to use the [NVIDIA® vGPU](https://www.nvidia.com/content/dam/en-zz/Solutions/design-visualization/solutions/resources/documents1/Virtual-GPU-Packaging-and-Licensing-Guide.pdf) technology.
