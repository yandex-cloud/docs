...
#### How do I connect to a VM with Windows Server {#conn-vm-windows-server}
...
#### How do I connect to a VM with Linux {#conn-vm-linux}
...
#### How do I use root on a VM with Linux {#use-root-linux}
...
If you have problems connecting to a VM over a network, you can use the serial console. For more information, see [{#T}](../operations/serial-console/index.md).
