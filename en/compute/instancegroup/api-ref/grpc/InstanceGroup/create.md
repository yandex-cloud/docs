...
# Compute Cloud Instance Groups API, gRPC: InstanceGroupService.Create
...
**rpc Create ([CreateInstanceGroupRequest](#yandex.cloud.compute.v1.instancegroup.CreateInstanceGroupRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## CreateInstanceGroupRequest {#yandex.cloud.compute.v1.instancegroup.CreateInstanceGroupRequest}
...
Required field. Specification of the target group that the instance group will be added to. For more information, see [Target groups and resources](/docs/network-load-balancer/concepts/target-resources). ||
