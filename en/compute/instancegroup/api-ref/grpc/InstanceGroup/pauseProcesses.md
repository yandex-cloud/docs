...
The instance group must have an `ACTIVE` status ([InstanceGroup.status](/docs/compute/instancegroup/api-ref/grpc/InstanceGroup/get#yandex.cloud.compute.v1.instancegroup.InstanceGroup)).
