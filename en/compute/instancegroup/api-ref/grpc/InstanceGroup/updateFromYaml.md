...
# Compute Cloud Instance Groups API, gRPC: InstanceGroupService.UpdateFromYaml {#UpdateFromYaml}
...
Required field. [InstanceGroupService.Update](/docs/compute/api-ref/grpc/InstanceGroup/update#Update) request in YAML format. ||
|#
