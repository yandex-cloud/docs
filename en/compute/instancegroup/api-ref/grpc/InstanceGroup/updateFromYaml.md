---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/instancegroup/api-ref/grpc/InstanceGroup/updateFromYaml.md
---
...
**rpc UpdateFromYaml ([UpdateInstanceGroupFromYamlRequest](#yandex.cloud.compute.v1.instancegroup.UpdateInstanceGroupFromYamlRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## UpdateInstanceGroupFromYamlRequest {#yandex.cloud.compute.v1.instancegroup.UpdateInstanceGroupFromYamlRequest}
...
Required field. [InstanceGroupService.Update](/docs/compute/instancegroup/api-ref/grpc/InstanceGroup/update#Update) request in YAML format.
