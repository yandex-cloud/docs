---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/instancegroup/api-ref/grpc/InstanceGroup/stopInstances.md
---

# Compute Cloud Instance Groups API, gRPC: InstanceGroupService.StopInstances

Stop instances from the instance group.

## gRPC request

**rpc StopInstances ([StopInstancesRequest](#yandex.cloud.compute.v1.instancegroup.StopInstancesRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## StopInstancesRequest {#yandex.cloud.compute.v1.instancegroup.StopInstancesRequest}
