---
editable: false
sourcePath: en/_api-ref-grpc/compute/v1/instancegroup/api-ref/grpc/InstanceGroup/rollingRestart.md
---
...
**rpc RollingRestart ([RollingRestartRequest](#yandex.cloud.compute.v1.instancegroup.RollingRestartRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## RollingRestartRequest {#yandex.cloud.compute.v1.instancegroup.RollingRestartRequest}
...
Required field. ID of the instance group to restart instances in.
...
To get instance IDs, use a [InstanceGroupService.ListInstances](/docs/compute/instancegroup/api-ref/grpc/InstanceGroup/listInstances#ListInstances) request. ||
|#
...
|| metadata | **[RollingRestartMetadata](#yandex.cloud.compute.v1.instancegroup.RollingRestartMetadata)**
...
## RollingRestartMetadata {#yandex.cloud.compute.v1.instancegroup.RollingRestartMetadata}
