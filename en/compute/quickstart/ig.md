...
1. Under **Integration with Load Balancer**:
    ...
    - (optional) Click the **Create target group** toggle. [Target groups](../../load-balancer/concepts/target-resources.md) are necessary for the [load balancer](../../load-balancer/concepts/index.md) to distribute loads.
