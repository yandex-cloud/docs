...
- Management console
    ...
    1. Specify the following:
        ...
        * **{{ ui-key.yc-serverless-apigw.dynamic-forms.cloud_ymq_info }}**: Folder containing the message queue and message queue name. If the folder does not have a message queue, [create](../../../message-queue/operations/message-queue-new-queue.md) one.
