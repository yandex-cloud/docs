...
- Management console
    ...
    1. In the **{{ ui-key.yacloud.serverless-functions.gateways.form.field_spec }}** field, click ![swagger](../../../_assets/api-gateway/spec-constructor/swagger.svg). In the window that opens:
