...
- Management console {#console}
  ...
  1. In the line of the load balancer you need to stop, click ![image](../../_assets/console-icons/ellipsis.svg) and select ![stop](../../_assets/console-icons/stop.svg) **{{ ui-key.yacloud.common.stop }}**.
...
- Management console {#console}
  ...
  1. [Navigate]({{ link-console-main }}/link/network-load-balancer/) to **{{ ui-key.yacloud.iam.folder.dashboard.label_load-balancer }}**.
  1. In the line of the load balancer you need to start, click ![image](../../_assets/console-icons/ellipsis.svg) and select ![play](../../_assets/console-icons/play.svg) **{{ ui-key.yacloud.common.start }}**.
