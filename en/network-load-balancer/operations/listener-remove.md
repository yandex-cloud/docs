...
- Management console {#console}
  ...
  1. Under **{{ ui-key.yacloud.load-balancer.network-load-balancer.section_listeners }}**, click ![image](../../_assets/console-icons/ellipsis.svg) next to the listener you want to delete.
  1. In the menu that opens, click ![trash-bin](../../_assets/console-icons/trash-bin.svg) **{{ ui-key.yacloud.load-balancer.network-load-balancer.label_delete-listener }}**.
