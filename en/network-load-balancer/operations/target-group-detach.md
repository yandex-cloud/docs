...
- Management console {#console}
  ...
  1. Under **{{ ui-key.yacloud.load-balancer.network-load-balancer.section_attached-target-groups }}**, click ![image](../../_assets/console-icons/ellipsis.svg) next to the target group in question and select **{{ ui-key.yacloud.load-balancer.network-load-balancer.label_detach-action }}**.
