...
- Management console {#console}
  ...
  1. Next to the load balancer to which you want to attach a target group, click ![image](../../_assets/console-icons/ellipsis.svg) and select ![target](../../_assets/console-icons/target.svg) **{{ ui-key.yacloud.load-balancer.network-load-balancer.button_attach-tg }}**.
