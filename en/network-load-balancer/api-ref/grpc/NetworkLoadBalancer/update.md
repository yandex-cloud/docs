---
editable: false
sourcePath: en/_api-ref-grpc/loadbalancer/v1/api-ref/grpc/NetworkLoadBalancer/update.md
---

# Network Load Balancer API, gRPC: NetworkLoadBalancerService.Update {#Update}

Updates the specified network load balancer.

## gRPC request

**rpc Update ([UpdateNetworkLoadBalancerRequest](#yandex.cloud.loadbalancer.v1.UpdateNetworkLoadBalancerRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## UpdateNetworkLoadBalancerRequest {#yandex.cloud.loadbalancer.v1.UpdateNetworkLoadBalancerRequest}
