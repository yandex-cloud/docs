...
- SRV
  ...
  1. Copy all of the characters after `SRV` from the value of a Yandex 360 SRV record. For example, if the value is `86400 IN SRV 0 5 5060 _sip._tcp.example.com.`, only copy `0 5 5060 _sip._tcp.example.com.`.
