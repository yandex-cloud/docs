---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/dns/cli-ref/v0/firewall/add-access-binding/
---

# yc dns v0 firewall add-access-binding

Add an access binding to the specified dns firewall.

#### Command Usage

Syntax:

`yc dns v0 firewall add-access-binding <DNS-FIREWALL-NAME>|<DNS-FIREWALL-ID> [Flags...] [Global Flags...]`
