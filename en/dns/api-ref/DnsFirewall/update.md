        ...
        dnsFirewallId:
          description: |-
            **string**
            ...
            To get the DNS firewall ID, make a [DnsFirewallService.List](/docs/dns/api-ref/DnsFirewall/list#List) request.
          type: string
      required:
        - dnsFirewallId
        ...
        labels:
          description: |-
            **object** (map<**string**, **string**>)
            ...
            1. Get the current set of labels with a [DnsFirewallService.Get](/docs/dns/api-ref/DnsFirewall/get#Get) request.
...
```
PATCH https://dns.{{ api-host }}/dns/v1/firewalls/{dnsFirewallId}
```
...
## Body parameters {#yandex.cloud.dns.v1.UpdateDnsFirewallRequest}
