...
editable: false
apiPlayground:
  - url: https://dns.{{ api-host }}/dns/v1/firewalls/{resourceId}:setAccessBindings
    method: post
    path:
      type: object
      properties:
...
# Cloud DNS API, REST: DnsFirewall.SetAccessBindings
...
```
POST https://dns.{{ api-host }}/dns/v1/firewalls/{resourceId}:setAccessBindings
```
