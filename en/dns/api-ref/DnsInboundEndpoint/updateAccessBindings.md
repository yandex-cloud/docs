...
editable: false
apiPlayground:
  - url: https://dns.{{ api-host }}/dns/v1/inboundEndpoints/{resourceId}:updateAccessBindings
    method: post
    path:
      type: object
      properties:
...
```
POST https://dns.{{ api-host }}/dns/v1/inboundEndpoints/{resourceId}:updateAccessBindings
```
