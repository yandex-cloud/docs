...
editable: false
apiPlayground:
  - url: https://dns.{{ api-host }}/dns/v1/inboundEndpoints/{resourceId}:listAccessBindings
    method: get
    path:
      type: object
      properties:
...
# Cloud DNS API, REST: DnsInboundEndpoint.ListAccessBindings
...
```
GET https://dns.{{ api-host }}/dns/v1/inboundEndpoints/{resourceId}:listAccessBindings
```
