...
editable: false
apiPlayground:
  - url: https://dns.{{ api-host }}/dns/v1/inboundEndpoints/{resourceId}:setAccessBindings
    method: post
    path:
      type: object
      properties:
...
# Cloud DNS API, REST: DnsInboundEndpoint.SetAccessBindings
...
```
POST https://dns.{{ api-host }}/dns/v1/inboundEndpoints/{resourceId}:setAccessBindings
```
