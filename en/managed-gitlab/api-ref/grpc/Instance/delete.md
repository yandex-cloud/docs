---
editable: false
sourcePath: en/_api-ref-grpc/gitlab/v1/api-ref/grpc/Instance/delete.md
---

# Managed Service for Gitlab API, gRPC: InstanceService.Delete

Deletes the specified GitLab instance.

## gRPC request

**rpc Delete ([DeleteInstanceRequest](#yandex.cloud.gitlab.v1.DeleteInstanceRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## DeleteInstanceRequest {#yandex.cloud.gitlab.v1.DeleteInstanceRequest}
