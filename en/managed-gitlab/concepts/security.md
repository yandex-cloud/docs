...
* For secure integration, use [Gitlab Agent for {{ k8s }}](https://docs.gitlab.com/ee/user/clusters/agent/).
...
### Secure configuration of {{ GL }} Runners {#configuring-runners}
...
* To restrict network access to {{ GL }} Runners, use [security groups](../../vpc/concepts/security-groups.md).
