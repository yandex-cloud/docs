...
# Setting up security groups and access restrictions for a {{ mgl-name }} instance 
...
1. [Add](../../vpc/operations/security-group-add-rule.md) rules for [incoming](#ingress-rules) and [outgoing](#egress-rules) traffic to an existing security group or [create](../../vpc/operations/security-group-create.md) a new group with such rules.
