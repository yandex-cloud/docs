...
1. Follow the link you received in your administrator mailbox after creating the instance.
   ...
   If you cannot access the {{ GL }} web UI via the link, create a separate security group and [configure it](../configure-security-group.md) so that its rules allow incoming traffic from the required ports and IP addresses.

1. Change the administrator password.
1. Log in using the administrator username and password.

Further on, to open the {{ GL }} web UI, [get detailed information about your instance](instance-list.md#get) and follow the link in the **{{ ui-key.yacloud.gitlab.field_domain }}** field.
