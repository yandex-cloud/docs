...
1. Make sure the `robot-forms@` robot has [access to the table](../../wiki/page-management/access-setup.md). The robot also has access to the table if **Available to all employees** mode is set.
