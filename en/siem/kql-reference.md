---
title: KQL reference for {{ yandex-siem-full-name }}
description: Reference of KQL functions and operators in {{ yandex-siem-full-name }}.
---
...
This section provides a reference for the [Kusto Query Language (KQL)](https://learn.microsoft.com/en-us/kusto/) subset used in {{ yandex-siem-full-name }}.

## System tables {#system-tables}

{{ yandex-siem-full-name }} supports the following system tables:
