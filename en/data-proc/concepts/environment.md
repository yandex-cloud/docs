...
Below is a list of {% if product == "yandex-cloud" %} [current](#current-images) and [deprecated](#deprecated-images){% endif %}{% if product == "cloud-il" %} current {% endif %} {{ dataproc-name }} images. Each image version includes [conda](https://docs.conda.io/en/latest/), [pip](https://pip.pypa.io/en/stable/installation/) (Python environment managers), and a collection of pre-installed libraries.
...
| Components | Image 2.0 | Image 2.1 (beta) |
| ------------ | --------- | --------------------- |
| **Component versions** |
| Hadoop | 3.2.2 | 3.3.2 |
| Tez | 0.10.0 | 0.10.1 |
