...
- Management console {#console}
   ...
   1. Click ![horizontal-ellipsis](../../_assets/console-icons/ellipsis.svg) for the appropriate subcluster and select **{{ ui-key.yacloud.mdb.clusters.button_action-edit }}**.
