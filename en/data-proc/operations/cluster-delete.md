...
description: 'You can delete a {{ dataproc-name }} cluster along with all its stored data. Note that data backups are not created automatically: if you want to save data for cluster recovery or future use, you can do that using {{ objstorage-full-name }}.'
---
...
To delete a {{ dataproc-name }} cluster, you must have the `dataproc.editor` role [assigned](../../iam/operations/roles/grant.md). For more information, see the [role descriptions](../security/index.md#roles-list).
...
- Management console {#console}
  ...
  1. Next to the cluster in question, click ![image](../../_assets/console-icons/ellipsis.svg) and select **{{ ui-key.yacloud.mdb.clusters.button_action-delete }}**.
