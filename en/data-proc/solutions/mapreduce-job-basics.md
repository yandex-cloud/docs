...
1. {% include [basic-before-buckets](../../_includes/data-proc/solutions/basic-before-buckets.md) %}
...
{% include [basic-clear-out](../../_includes/data-proc/solutions/basic-clear-out.md) %}
