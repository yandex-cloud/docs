...
In this article, a simple example demonstrates how Hive is used in {{ dataproc-name }} for data analysis. In the example below, we use Hive to analyze the population of Russia's largest cities.

## Before you start {#before-you-begin}

1. [Create a service account](../../iam/operations/sa/create.md) with the `mdb.dataproc.agent` role.

1. {% include [solutions-basic-before-buckets](../../_includes/data-proc/solutions/basic-before-buckets.md) %}
...
1. Create and upload the `cities.sql` file with SQL queries to the input data bucket:
...
1. [Open the task logs](../operations/jobs-hive#get-logs) and view the processing output:
...
{% include [solutions-basic-clear-out.md](../../_includes/data-proc/solutions/basic-clear-out.md) %}
