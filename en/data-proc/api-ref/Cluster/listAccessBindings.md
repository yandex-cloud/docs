...
editable: false
apiPlayground:
  - url: https://dataproc.{{ api-host }}/dataproc/v1/clusters/{resourceId}:listAccessBindings
    method: get
    path:
      type: object
      properties:
    ...
    body: null
    definitions: null
sourcePath: en/_api-ref/dataproc/v1/api-ref/Cluster/listAccessBindings.md
---

# Yandex Data Processing API, REST: Cluster.ListAccessBindings
