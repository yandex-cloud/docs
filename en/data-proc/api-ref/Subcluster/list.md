        ...
        pageSize:
          description: |-
            **string** (int64)
            ...
            results is larger than `pageSize`, the service returns a [ListSubclustersResponse.nextPageToken](/docs/data-proc/api-ref/Subcluster/list#yandex.cloud.dataproc.v1.ListSubclustersResponse)
        ...
        pageToken:
          description: |-
            **string**
            ...
            [ListSubclustersResponse.nextPageToken](/docs/data-proc/api-ref/Subcluster/list#yandex.cloud.dataproc.v1.ListSubclustersResponse) returned by a previous list request.
          type: string
        filter:
          description: |-
            **string**
            ...
            1. The field name. Currently you can use filtering only on [Subcluster.name](/docs/data-proc/api-ref/Subcluster/get#yandex.cloud.dataproc.v1.Subcluster) field.
            2. An `=` operator.
