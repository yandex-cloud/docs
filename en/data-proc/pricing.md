...
The storage capacity allocated to each host in the cluster is billed as part of {{ compute-name }} according to the [disk space pricing](../compute/pricing.md#prices-storage).
