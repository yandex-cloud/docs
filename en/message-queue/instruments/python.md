...
To work with {{ message-queue-full-name }} from Python, use [boto3]{% if lang == "ru" %}(https://aws.amazon.com/ru/sdk-for-python/){% endif %}{% if lang == "en" %}(https://aws.amazon.com/sdk-for-python/){% endif %}, an SDK designed for Python.
