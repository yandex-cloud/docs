...
In response to an API request, [!KEYREF message-queue-name] returns an XML structure containing the request result.
...
| `Code` | Error ID.<br/><br/>For a list of common errors, see the section [[!TITLE]](common-errors.md). |
