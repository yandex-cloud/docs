## Solutions for known {{ objstorage-name }} issues {#known-issues-resolving}
...
* [Fixing the certificate error](wrong-certificate.md)
* [Fixing the `GATEWAY_REQUEST_ERROR` error](error-gateway-request.md)
* [Fixing issues with incorrect MIME types of objects when uploading them to {{ objstorage-name }}](incorrect-mime-type.md)
* [Fixing issues with uploading new objects to a bucket](objects-uploading-issue.md)