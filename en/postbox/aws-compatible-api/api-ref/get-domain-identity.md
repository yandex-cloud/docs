...
This method returns information on an [address](../../concepts/glossary.md#address) in a folder. The folder is selected based on the service account the request originates from.
