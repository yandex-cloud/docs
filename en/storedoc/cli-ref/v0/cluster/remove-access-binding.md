---
canonical: https://yandex.cloud/en/docs/cli/cli-ref/managed-mongodb/cli-ref/v0/cluster/remove-access-binding
editable: false
---

# yc managed-mongodb v0 cluster remove-access-binding

Remove access binding for the specified MongoDB cluster

#### Command Usage

Syntax:

`yc managed-mongodb cluster remove-access-binding <CLUSTER-NAME>|<CLUSTER-ID> [Flags...] [Global Flags...]`
