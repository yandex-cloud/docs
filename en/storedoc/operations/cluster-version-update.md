...
- Management console {#console}
    ...
    In the [management console]({{ link-console-main }}), open the {{ mmg-name }} cluster [create](cluster-create.md) or [update](update.md) page. You can view the list in the **{{ ui-key.yacloud.mdb.forms.base_field_version }}** field.
...
- gRPC API {#grpc-api}
    ...
    1. Check the [server response](../api-ref/grpc/Versions/list.md#yandex.cloud.mdb.mongodb.v1.ListVersionsResponse) to make sure your request was successful.
