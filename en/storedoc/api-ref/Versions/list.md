...
```
GET https://{{ api-host-mdb }}/managed-mongodb/v1/versions
```

## Query parameters {#yandex.cloud.mdb.mongodb.v1.ListVersionsRequest}
...
## Response {#yandex.cloud.mdb.mongodb.v1.ListVersionsResponse}
