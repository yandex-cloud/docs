...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-mongodb/v1/maintenances/{maintenanceId}
    method: get
    path:
      type: object
      properties:
...
# Managed Service for MongoDB API, REST: Maintenance.Get
...
```
GET https://{{ api-host-mdb }}/managed-mongodb/v1/maintenances/{maintenanceId}
```
