...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-mongodb/v1/changeFreezeLimits
    method: get
    path: null
    query:
      type: object
...
# Managed Service for MongoDB API, REST: ChangeFreeze.GetLimits
...
```
GET https://{{ api-host-mdb }}/managed-mongodb/v1/changeFreezeLimits
```
