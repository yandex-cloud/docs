...
editable: false
apiPlayground:
  - url: https://{{ api-host-mdb }}/managed-mongodb/v1/clusters/{clusterId}/retention_policies
    method: post
    path:
      type: object
      properties:
...
```
POST https://{{ api-host-mdb }}/managed-mongodb/v1/clusters/{clusterId}/retention_policies
```
...
## Body parameters {#yandex.cloud.mdb.mongodb.v1.CreateBackupRetentionPolicyRequest}
...
## Response {#yandex.cloud.mdb.mongodb.v1.CreateBackupRetentionPolicyResponse}
