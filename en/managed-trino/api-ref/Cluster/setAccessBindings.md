...
editable: false
apiPlayground:
  - url: https://trino.{{ api-host }}/managed-trino/v1/clusters/{resourceId}:setAccessBindings
    method: post
    path:
      type: object
      properties:
    ...
    definitions:
      ...
      AccessBinding:
        ...
        required:
          - roleId
          - subject
sourcePath: en/_api-ref/trino/v1/api-ref/Cluster/setAccessBindings.md
---
...
```
POST https://trino.{{ api-host }}/managed-trino/v1/clusters/{resourceId}:setAccessBindings
```
