...
editable: false
apiPlayground:
  - url: https://trino.{{ api-host }}/managed-trino/v1/clusters/{clusterId}:stop
    method: post
    path:
      type: object
      properties:
    ...
    body: null
    definitions: null
sourcePath: en/_api-ref/trino/v1/api-ref/Cluster/stop.md
---

# Managed Service for Trino API, REST: Cluster.Stop
