...
editable: false
apiPlayground:
  - url: https://trino.{{ api-host }}/managed-trino/v1/maintenances/{maintenanceId}:reschedule
    method: post
    path:
      type: object
      properties:
...
```
POST https://trino.{{ api-host }}/managed-trino/v1/maintenances/{maintenanceId}:reschedule
```
