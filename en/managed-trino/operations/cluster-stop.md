...
If necessary, you can stop and restart a {{ TR }} cluster. When stopped, a cluster retains all its data. The data will be available again as soon as you restart the cluster.
