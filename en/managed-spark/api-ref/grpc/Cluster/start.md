---
editable: false
sourcePath: en/_api-ref-grpc/spark/v1/api-ref/grpc/Cluster/start.md
---
...
**rpc Start ([StartClusterRequest](#yandex.cloud.spark.v1.StartClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## StartClusterRequest {#yandex.cloud.spark.v1.StartClusterRequest}
...
Required field. ID of the Spark cluster that is being started.
...
|| metadata | **[StartClusterMetadata](#yandex.cloud.spark.v1.StartClusterMetadata)**
...
## StartClusterMetadata {#yandex.cloud.spark.v1.StartClusterMetadata}
