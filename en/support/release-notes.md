...
1. Expanded the table of available request types for the Business and Premium service plans.
   * Business and Premium: 
      * Assistance in service recovery for critical requests.
      * General tips on building a fault-tolerant cloud infrastructure.
      * RCA preparation for **Critical** requests.
   * Premium:
      * Conducting HA/DR tests.
...
1. Updated support restrictions. Added sections on services and features:
   ...
   * Yandex {{ tracker-short-name }}, Yandex {{ forms-short-name }}, and Yandex {{ wiki-short-name }}.
   * Operations with the MDB services within the {{ yandex-cloud }} customer control zone.