...
The initial grant is provided when the first billing account is activated. You can't get the initial grant for any previously activated accounts. If necessary, use [{#T}](../../partner/qa/additional-grants.md).

#### How do I activate the initial grant for new partner accounts? {#new-accounts}

When you create your first billing account as a partner, the initial grant is given automatically. You can't get the initial grant for additional billing accounts. If necessary, use [{#T}](../../partner/qa/additional-grants.md).
...
The initial grant is only provided when the customer's first and main billing account is created. It is not available for sub-accounts. If required, you can use [{#T}](../../partner/qa/additional-grants.md).
