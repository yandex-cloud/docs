...
On {{ yandex-cloud }}, you can run server software available under the [License Mobility through Software Assurance](https://www.microsoft.com/en-us/licensing/licensing-programs/software-assurance-license-mobility) program.
...
As of January 24, 2022, to use Microsoft products, you need to specify user names, names and tax IDs of legal entities, and addresses of individuals and legal entities. These are the requirements of the Microsoft licensing policy. The data **might be reported to Microsoft**. If the data isn't provided, you can't run Microsoft products.
