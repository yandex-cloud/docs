...
In {{ yandex-cloud }}, each service has its own SLA. You can learn more about SLAs in the section [Legal documents]{% if product == "yandex-cloud" %}{% if lang == "ru" %}(https://yandex.ru/legal/cloud_sla/?lang=ru){% endif %}{% if lang == "en" %}(https://yandex.ru/legal/cloud_sla/?lang=en){% endif %}{% endif %}{% if product == "cloud-il" %}(/docs/legal/sla){% endif %}.
