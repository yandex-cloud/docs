### {{ datalens-short-name }} used to support connection to Yandex Metrica and AppMetrica with prior data export to {{ CH }} via LogsAPI. Is this still possible? {#uploading-data-logs-api}
