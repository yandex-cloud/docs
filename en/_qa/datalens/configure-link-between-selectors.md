...
Before creating a link, make sure the field used by the selector as a filter is included in the dataset the chart is built on. For more information, see [{#T}](../../datalens/concepts/data-join.md).
