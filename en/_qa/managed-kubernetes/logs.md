...
[Get cluster statistics](../../managed-kubernetes/operations/kubernetes-cluster/kubernetes-cluster-get-stats.md). You can find the description of the available cluster metrics in [this reference](../../managed-kubernetes/metrics.md).
