...
1. In the `secrets` folder:
   ...
   * If you're going to use SFTP, create a file named `authorized_keys` with a public {% if lang == "ru" and audience != internal %}[SSH key](../../glossary/ssh-keygen.md){% else %}SSH key{% endif %}:
