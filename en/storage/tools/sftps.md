...
1. In the `secrets` folder:
   * Create the `credentials` file:
     ...
     Where:
     * `aws_access_key_id`: [Previously obtained](#before-you-begin) static access key ID.
     * `aws_secret_access_key`: [Previously obtained](#before-you-begin) static access key contents.
