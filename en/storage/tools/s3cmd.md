---
title: S3cmd
description: In this article, you will learn about S3cmd, how to install and configure it, explore some of its features and examples of operations.
---
...
- {% include [aws-tools-prepare](../../_includes/aws-tools/s3cmd-versioning-info.md) %}
- By default, S3cmd uploads objects to a standard storage. To specify the [storage class](../concepts/storage-class.md) when uploading an object, use the `--storage-class` key.
