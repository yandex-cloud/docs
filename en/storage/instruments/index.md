...
{{ objstorage-name }} supports some of the Amazon S3 HTTP API methods. This allows you to use not only Yandex.Cloud tools when working with {{ objstorage-name }} , but also popular tools designed for Amazon S3.
