...
| Concept | Description |
--------|----------
| [Bucket](bucket.md) | Logical entity that handles storing objects. |
...
| [Pre-signed URLs](pre-signed-urls.md) | Method to grant anonymous users access to storage operations. |
| [Multipart upload](multipart.md) | Method to upload large objects. |
...
| [Uploading data via HTML form](presigned-post-forms.md) | Method to upload objects to storage from a browser. Allows anonymous users to upload objects to buckets. |
