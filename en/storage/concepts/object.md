...
For buckets with restricted access, signed links are generated by the service and let you temporarily download an object even from a bucket with restricted access. [Read more about pre-signed urls](pre-signed-urls.md).
