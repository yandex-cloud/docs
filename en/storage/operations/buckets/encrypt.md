...
- Terraform
  ...
  1. In the configuration file, describe the parameters of resources that you want to create:
     ...
     * `default_algorithm`: Encryption algorithm to be used with a new [key version](../../../kms/concepts/version.md), generated at the next key rotation. Default value: `AES_128`.
     * `rotation_period`: Key [rotation period](../../../kms/concepts/version.md#rotate-key). To disable automatic rotation, omit this parameter.
