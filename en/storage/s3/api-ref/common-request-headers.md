...
| `Content-Type` | Data type in a request. For example, `text/html`. For details on data types, see [MIME](https://en.wikipedia.org/wiki/MIME).<br/><br/>The default value is `binary/octet-stream`. |
