...
Aborts an upload and deletes from [!KEYREF objstorage-name] all object parts that have been saved. If the abort upload request was received during the upload of any part, no result is guaranteed.
