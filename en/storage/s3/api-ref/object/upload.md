...
| `x-amz-storage-class` | Object storage class.<br/><br/>Possible values:<br/>- `COLD` for uploading an object to the cold storage.<br/>- `STANDARD` for uploading an object to the standard storage.<br/><br/>If no header is specified, the object is saved to the standard storage. |
