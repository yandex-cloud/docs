...
editable: false
apiPlayground:
  - url: https://smartwebsecurity.{{ api-host }}/smartwebsecurity/v1/loadBalancers/{loadBalancerId}/domains/{domainName}
    method: get
    path:
      type: object
      properties:
...
```
GET https://smartwebsecurity.{{ api-host }}/smartwebsecurity/v1/loadBalancers/{loadBalancerId}/domains/{domainName}
```
