...
To create an [L7 load balancer in {{ alb-name }} with a {{ sws-name }} profile {{ sws-name }}](index.md) from the {{ yandex-cloud }} management console:
...
* `test-load-balancer` [L7 load balancer](../../../application-load-balancer/concepts/application-load-balancer.md)
