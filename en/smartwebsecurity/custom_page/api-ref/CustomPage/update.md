...
editable: false
apiPlayground:
  - url: https://smartwebsecurity.{{ api-host }}/smartwebsecurity/v1/customPages/{customPageId}
    method: patch
    path:
      type: object
      properties:
...
```
PATCH https://smartwebsecurity.{{ api-host }}/smartwebsecurity/v1/customPages/{customPageId}
```
