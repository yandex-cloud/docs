...
- Management console {#console}
  ...
  1. Click ![options](../../_assets/console-icons/ellipsis.svg) → ![pencil](../../_assets/console-icons/pencil.svg) **{{ ui-key.yacloud.common.edit }}** next to the rule. In the window that opens:
