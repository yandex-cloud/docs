...
- Management console {#console}
  ...
  1. Select the ARL profile.
  1. Click the link in the **{{ ui-key.yacloud.smart-web-security.arl.label_connected-security-profiles }}** field.
  1. On the connected profile page, click ![pencil](../../_assets/console-icons/pencil.svg) **{{ ui-key.yacloud.smart-web-security.overview.action_edit-profile }}**. In the window that opens:

      1. In the **{{ ui-key.yacloud.smart-web-security.form.label_arl-profile }}** field, select either a different ARL profile or `{{ ui-key.yacloud.common.not-selected }}`:
  ...
  1. In the top panel, click ![recycle-bin](../../_assets/console-icons/trash-bin.svg) **{{ ui-key.yacloud.common.delete }}** and confirm the deletion.
