...
For more information about how replication works in Redis, read the [DBMS documentation](https://redis.io/topics/replication).
...
The owners of Managed Service for Redis clusters cannot configure the Sentinel services, but they can read information that the services provide. Read more about Sentinel in the [DBMS documentation](https://redis.io/topics/sentinel).
