...
* Using Redis Sentinel.
    ...
    {{ RD }} Sentinel is a {{ RD }} host management system that provides monitoring, notification of host states, [automatic failover](./../failover.md), and reporting of up-to-date host addresses to the clients.
    ...
    For more information about Sentinel, see [{#T}](../../concepts/replication.md) and the [documentation {{ RD }}](https://redis.io/topics/sentinel).
...
{{ mrd-name }} provides special FQDNs that can be used instead of the usual [FQDNs of hosts](./../hosts.md#list) to connect to a non-sharded cluster.

### Current master {#fqdn-master}

An FQDN like `c-<cluster ID>.rw.{{ dns-zone }}` in a non-sharded cluster always points to the current master host. The cluster ID can be requested with a [list of clusters in the folder](../cluster-list.md#list-clusters).
