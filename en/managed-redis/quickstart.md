# Getting started with [!KEYREF mrd-short-name]
...
1. Select the **[!KEYREF mrd-full-name]** service.
1. Click **Create cluster**.
1. Set the cluster parameters and click **Create cluster**.
1. When the cluster is ready to operate, its status on the [!KEYREF mrd-short-name] dashboard will change to **RUNNING**.
