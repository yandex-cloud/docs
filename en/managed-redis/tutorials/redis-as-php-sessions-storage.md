...
1. [Set up a security group in {{ vpc-name }}](../../vpc/operations/security-group-update.md#add-rule). Add TCP settings to the security group to allow the following:
      * Incoming traffic through port `22` from any IP address for SSH.
