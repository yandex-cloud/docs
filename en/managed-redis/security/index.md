...
To use the service, you need the `{{ roles.mrd.editor }}` [role](../../iam/concepts/access-control/roles.md) or higher for the folder where the cluster is created. The `{{ roles.mrd.viewer }}` role enables you only to view the list of clusters.
