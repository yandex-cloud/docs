...
config.<br>redisConfig_5_0 | **object**<br>Configuration of a Redis 5.0 server. <br>`config` includes only one of the fields `redisConfig_5_0`, `redisConfig_6_0`, `redisConfig_6_2`<br><br>
...
config.<br>redisConfig_6_0 | **object**<br>Configuration of a Redis 6.0 server. <br>`config` includes only one of the fields `redisConfig_5_0`, `redisConfig_6_0`, `redisConfig_6_2`<br><br>
...
config.<br>redisConfig_6_2 | **object**<br>Configuration of a Redis 6.2 server. <br>`config` includes only one of the fields `redisConfig_5_0`, `redisConfig_6_0`, `redisConfig_6_2`<br><br>
