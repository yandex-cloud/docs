...
# Managed Service for Redis API, gRPC: ClusterService.Start {#Start}

Start the specified Redis cluster.

## gRPC request

**rpc Start ([StartClusterRequest](#yandex.cloud.mdb.redis.v1.StartClusterRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## StartClusterRequest {#yandex.cloud.mdb.redis.v1.StartClusterRequest}
...
|| metadata | **[StartClusterMetadata](#yandex.cloud.mdb.redis.v1.StartClusterMetadata)**
...
## StartClusterMetadata {#yandex.cloud.mdb.redis.v1.StartClusterMetadata}
