...
editable: false
apiPlayground:
  - url: https://marketplace.{{ api-host }}/marketplace/license-manager/saas/v1/locks:getByResourceID
    method: get
    path: null
    query:
      type: object
...
```
GET https://marketplace.{{ api-host }}/marketplace/license-manager/saas/v1/locks:getByResourceID
```
