...
apiPlayground:
  - url: https://operation.{{ api-host }}/operations/{operationId}
    ...
    body: null
    definitions: null
sourcePath: en/_api-ref/marketplace/pim/v1/saas/pim/saas/api-ref/Operation/get.md
---

# Yandex Cloud Marketplace Product Instance Management API, REST: Operation.Get
