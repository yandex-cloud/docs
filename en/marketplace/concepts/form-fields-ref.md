...
|| Editor | Providing a code in the specified language | **Language**: String, highlight language for code entered by the user.<br/>**Font size**: Code font size.<br/>For other settings, see [{#T}](#parameters). ||
...
|| Text Content | Adding a note for a user | **Text**: Text of the note that will be shown to the user.<br/>**Subject**: Note type.<br/>**Icon**: Icon to appear before the text.<br/>**Icon color**: Color of the icon to appear before the text.<br/>For other settings, see [{#T}](#parameters). ||
