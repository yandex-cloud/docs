...
* Products for {{ compute-full-name }}: Upload an image based on [Linux](create-image.md#create){% if product == "cloud-il" %} or [Windows Server](create-image-ms.md) in {{ yandex-cloud }} {% endif %}.
