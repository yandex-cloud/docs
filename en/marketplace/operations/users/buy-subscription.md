...
description: In this guide, you will learn about several ways to buy a subscription in {{ marketplace-full-name }}.
---

# Buying a subscription

To buy a subscription, you need the `{{ roles-license-manager-user }}` [role](../../security/index.md#license-manager-user) for the folder.
...
- {{ compute-name }} {#compute}
  ...
  1. Under **{{ ui-key.yacloud_components.marketplace.label_subscriptions }}**, select the relevant option and click **{{ ui-key.yacloud.marketplace-v2.action_purchase-license }}**. In the window that opens:
  
     1. Specify the required number of subscriptions and the folder they will be operate in.
     1. Click **{{ ui-key.yacloud.marketplace-v2.action_to-pay-license }}**.
...
- {{ managed-k8s-name }} {#managed-k8s}
  ...
  1. Under **{{ ui-key.yacloud.marketplace-v2.section_tariff-section }}**, select the subscription. If you do not have a subscription, click **{{ ui-key.yacloud.marketplace-v2.action_purchase-license }}**. In the window that opens:
...
- {{ compute-name }} {#compute}
  ...
  1. Under **{{ ui-key.yacloud_components.marketplace.label_subscriptions }}**, select the relevant option and click **Purchase subscription**. In the window that opens:
  ...
  You can also click **Create VM** and purchase a subscription [on the resource creation page](#with-resource).
...
- {{ compute-name }} {#compute}
  ...
  1. In the [management console]({{ link-console-main }}), select the [folder](../../../resource-manager/concepts/resources-hierarchy.md#folder) you want to subscribe.
  ...
  1. Under **{{ ui-key.yacloud_components.marketplace.label_subscriptions }}**, select the relevant option and click **{{ ui-key.yacloud.marketplace-v2.action_purchase-license }}**. In the window that opens:
     ...
     1. Specify the required number of subscriptions.
     1. Click **{{ ui-key.yacloud.marketplace-v2.action_to-pay-license }}**.
  ...
  You can also click **{{ ui-key.yacloud.marketplace-v2.button_use }}** and purchase a subscription [on the resource creation page](#with-resource).
...
- {{ managed-k8s-name }} {#managed-k8s}
  ...
  1. Click **{{ ui-key.yacloud.marketplace-v2.button_k8s-product-use }}**.
  ...
  1. Under **{{ ui-key.yacloud.marketplace-v2.section_tariff-section }}**, select the subscription.
      ...
      If you do not have a subscription, click **{{ ui-key.yacloud.marketplace-v2.action_purchase-license }}**. Then specify the required number of subscriptions and click **{{ ui-key.yacloud.marketplace-v2.action_purchase-license }}**.
