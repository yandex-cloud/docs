...
- {{ compute-name }} {#compute}
  ...
  1. In the line with the subscription, click ![image](../../../_assets/console-icons/ellipsis.svg) and select **{{ ui-key.yacloud.marketplace-v2.action_specify-vm }}**.
...
- SaaS {#saas}
  ...
  1. At the top of the screen, click ![image](../../../_assets/console-icons/shopping-cart.svg) **{{ ui-key.yacloud.marketplace-v2.label_service-name }}**.
  1. In the left-hand panel, select ![image](../../../_assets/console-icons/file-ruble.svg) **{{ ui-key.yacloud.marketplace-v2.label_licenses }}**.
  1. In the line with the subscription, click ![image](../../../_assets/console-icons/ellipsis.svg) and select **{{ ui-key.yacloud.marketplace-v2.action_goto-partner-url }}**.
