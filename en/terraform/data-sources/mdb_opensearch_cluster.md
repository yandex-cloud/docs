...
For details, see None.
  ...
  - `access` [Block]. Enable access to the Yandex Cloud services.
    - `data_transfer` (*Read-Only*) (Bool). Enable access to the [Data Transfer](https://yandex.cloud/docs/data-transfer) service.
...
For details, see [OpenSearch documentation](https://docs.opensearch.org/latest/install-and-configure/configuring-opensearch/search-settings).
    ...
    - `node_groups` [Block]. A set of named OpenSearch node group configurations.
      ...
      - `disk_size_autoscaling` [Block]. Node group disk size autoscaling settings.
        - `disk_size_gb_limit` (*Read-Only*) (Number). The overall maximum for disk size in gibibytes (GiB) that limit all autoscaling iterations. See the [documentation](https://yandex.cloud/en/docs/managed-opensearch/concepts/storage#auto-rescale) for details.
        - `disk_size_limit` (*Read-Only*) (Number). The overall maximum for disk size that limit all autoscaling iterations. See the [documentation](https://yandex.cloud/en/docs/managed-opensearch/concepts/storage#auto-rescale) for details.
