...
- `group_claims_settings` [Block]. Group claims settings for the SAML application.
  - `group_attribute_name` (*Read-Only*) (String). Name of the SAML attribute that contains group information.
  - `group_attribute_value` (*Read-Only*) (String). Source of the group value provided to the application.
  - `group_distribution_type` (*Read-Only*) (String). Distribution type for group claims.
...
- `security_settings` [Block]. Security settings for the SAML application.
  - `signature_certificate_id` (*Read-Only*) (String). ID of the signature certificate to use.
  - `signature_mode` (*Read-Only*) (String). Signature mode for SAML messages.
- `service_provider` [Block]. Service provider configuration for the SAML application.
  ...
  - `entity_id` (*Read-Only*) (String). Service provider entity ID.
  - `slo_urls` [Block]. Single Logout Service URLs.
    - `protocol_binding` (*Read-Only*) (String). Protocol binding supported by the logout endpoint.
    - `response_url` (*Read-Only*) (String). Optional separate URL for logout responses.
