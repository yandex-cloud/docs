...
All information posted in {{ wiki-name }} is subject to the NDA and intended for internal use only. It is prohibited to distribute it outside Yandex.
...
- [Create Wiki pages](quick-guide.md) with text, images, tables, and links.
   {% if audience == "external" %}The maximum number of pages per organization is 10000.{% endif %}
