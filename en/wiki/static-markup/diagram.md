...
{{ wiki-name }} supports integration with [draw.io](https://drawio.yandex-team.ru/). You can create a chart in a convenient graphical editor and [transfer it to your page](../actions/drawio.md) using an `iframe`.
