...
* **Employee**. The employee's first and last name{% if audience == "internal" %}, as well as a link to their profile on Staff{% endif %}.

* **Multiple employees.** First and last names for a list of employees{% if audience == "internal" %}, as well as links to their profiles on Staff{% endif %}.
