...
The {% if audience == "external" %}organization's administrator{% endif %} and author or owner of the page can [set up rights](./page-management/access-setup.md) for these users:
