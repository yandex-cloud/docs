...
[{{ forms-full-name }}]({{ link-forms-b2b }}) is a service where you can conduct surveys, collect feedback, and accept requests. Read more about the service features in the [{{ forms-full-name }} documentation](../../forms/).
