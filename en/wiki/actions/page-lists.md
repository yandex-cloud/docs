...
| {% if audience == "draft" %}`show_redirects` | Displaying redirects in the tree:<br>`true`: Redirects are included in the tree.<br>`false`: Redirects are not displayed in the tree.{% endif %} |
