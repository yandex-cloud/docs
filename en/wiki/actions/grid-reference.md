...
{% if audience == "draft" %}
By default, this table can be edited directly on the page. Any changes are automatically applied to the main table and all its occurrences in other pages.
{% endif %}
