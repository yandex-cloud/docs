...
To add a diagram to your Wiki page:

1. Create a diagram in draw.io.
1. In the **File** menu, select **Embed** → **Yandex Wiki**.
1. Configure the diagram's parameters, then click **Create**.
1. Copy the code.

Paste the resulting `iframe` in your page:
...
To learn more about the `iframe` block parameters, see [{#T}](iframe.md).

{% note info %}

To edit your diagram, go back to draw.io, generate a new code, and paste it in the page. Otherwise, the diagram won't update in {{ wiki-name }}.

If you edit a diagram on your Wiki page, a copy will also be created in draw.io. The original diagram won't change, however.
