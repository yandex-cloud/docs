...
{% if audience == "draft" %}
The visual editor doesn't let you upload images or objects from external sources to a page. You can add an image or object by copying its URL from another Wiki page or an external resource. Users can see this object on your page if they have access to the original page.
{% endif %}
...
1. Upload an image to a [Wiki page](add-image.md) or a file hosting service{% if audience == "internal" %} such as [Jing](https://jing.yandex-team.ru/){% endif %}.
