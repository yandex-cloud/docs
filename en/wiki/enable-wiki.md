...
1. If your account is registered in several organizations, select the one where you want to use {{ wiki-full-name }}. Then click **Log in**.
...
1. Log in to your [Yandex account]({{ link-passport }}). If you don't have an account yet, [create]({{ support-passport-create }}) one.
