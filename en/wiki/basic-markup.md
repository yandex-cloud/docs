...
| Color text.<br/><br/>The following colors are supported:<br/><br/><ul><li>`red`{% if locale == "ru" %}/`red`/`red`{% endif %}</li><li>`green`{% if locale == "ru" %}/`gre`/`green`{% endif %}</li><li>`blue`{% if locale == "ru" %}/`blu`/`blue`{% endif %}</li><li>`grey`/`gray`{% if locale == "ru" %}/`gra`/`gray`{% endif %}</li><li>`yellow`{% if locale == "ru" %}/`yel`/`yellow`{% endif %}</li><li>`cyan`{% if locale == "ru" %}/`cya`/`cyan`{% endif %}</li><li>`orang`{% if locale == "ru" %}/`orange`/`orange`{% endif %}</li><li>`violet`{% if locale == "ru" %}/`vio`/`violet`{% endif %}</li></ul> | `!!(blu)Blue text!!` | ![](../_assets/wiki/colored.png) |
