...
You can do a text search or search for [keywords](add-key-words.md) in Wiki pages. To do this, use the search bar that appears at the top right of each page{% if audience == "internal" %}. Enter your query and click ![](../_assets/wiki/search-icon.png) or press **Enter**.{% else %}.
