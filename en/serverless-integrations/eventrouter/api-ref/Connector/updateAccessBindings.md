...
editable: false
apiPlayground:
  - url: https://serverless-eventrouter.{{ api-host }}/eventrouter/v1/connectors/{resourceId}:updateAccessBindings
    method: patch
    path:
      type: object
      properties:
...
```
PATCH https://serverless-eventrouter.{{ api-host }}/eventrouter/v1/connectors/{resourceId}:updateAccessBindings
```
