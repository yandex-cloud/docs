---
editable: false
sourcePath: en/_api-ref-grpc/serverless/eventrouter/v1/eventrouter/api-ref/grpc/Bus/setAccessBindings.md
---

# EventRouter Service, gRPC: BusService.SetAccessBindings {#SetAccessBindings}
