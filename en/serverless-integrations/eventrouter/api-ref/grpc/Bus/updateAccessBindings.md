---
editable: false
sourcePath: en/_api-ref-grpc/serverless/eventrouter/v1/eventrouter/api-ref/grpc/Bus/updateAccessBindings.md
---

# EventRouter Service, gRPC: BusService.UpdateAccessBindings {#UpdateAccessBindings}
