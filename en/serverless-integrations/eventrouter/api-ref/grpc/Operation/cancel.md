---
editable: false
sourcePath: en/_api-ref-grpc/serverless/eventrouter/v1/eventrouter/api-ref/grpc/Operation/cancel.md
---

# EventRouter Service, gRPC: OperationService.Cancel {#Cancel}
