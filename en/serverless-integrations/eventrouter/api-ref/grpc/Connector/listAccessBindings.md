---
editable: false
sourcePath: en/_api-ref-grpc/serverless/eventrouter/v1/eventrouter/api-ref/grpc/Connector/listAccessBindings.md
---

# EventRouter Service, gRPC: ConnectorService.ListAccessBindings {#ListAccessBindings}
