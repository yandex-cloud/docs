...
* Via the management console, CLI, or API. For more information, see [{#T}](../../operations/workflows/execution/start.md).
* On a timer. The schedule is set in [cron expression](../cron.md) format. For more information, see [{#T}](../../operations/workflows/execution/start-by-timer.md).
* Via a link over HTTPS. For more information, see [{#T}](../../operations/workflows/execution/start-by-link.md).
* Using an API gateway. For more information, see [{#T}](../../../api-gateway/operations/spec-constructor/workflows.md).
...
* Public, any user can run it. For more information, see [{#T}](../../operations/workflows/workflow/make-public.md).
