...
editable: false
apiPlayground:
  - url: https://serverless-workflows.{{ api-host }}/workflows/v1/workflow/{resourceId}:listAccessBindings
    method: get
    path:
      type: object
      properties:
...
```
GET https://serverless-workflows.{{ api-host }}/workflows/v1/workflow/{resourceId}:listAccessBindings
```
