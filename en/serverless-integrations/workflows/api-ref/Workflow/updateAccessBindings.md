...
editable: false
apiPlayground:
  - url: https://serverless-workflows.{{ api-host }}/workflows/v1/workflow/{resourceId}:updateAccessBindings
    method: post
    path:
      type: object
      properties:
...
```
POST https://serverless-workflows.{{ api-host }}/workflows/v1/workflow/{resourceId}:updateAccessBindings
```
