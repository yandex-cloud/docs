...
- Management console {#console}
  ...
  1. From the **Integration steps** section on the left side of the screen, drag the ![yadisk-icon](../../../../_assets/yadisk-icon.svg) **{{ ui-key.yc-serverless-workflows.dynamic-forms.disk_integration_title }}** element to the relevant workflow location in the constructor window.
