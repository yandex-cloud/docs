...
- Management console {#console}
  ...
  1. From the **Integration steps** section on the left side of the screen, drag the ![serverless-container-icon](../../../../_assets/serverless-container-icon.svg) **{{ serverless-containers-short-name }}** element to the relevant workflow location in the constructor window.
