...
- Management console {#console}
  ...
  1. From the **Integration steps** section on the left side of the screen, drag the ![graph-node](../../../../_assets/console-icons/graph-node.svg) **{{ sw-name }}** element to the relevant workflow location in the constructor window.
