...
- Management console {#console}
  ...
  1. In the **Integration steps** section on the left side of the screen, drag the ![ymq-icon](../../../../_assets/ymq-icon.svg) **{{ ui-key.yc-serverless-workflows.dynamic-forms.ymq_integration_title }}** element to the relevant workflow location in the constructor window.
