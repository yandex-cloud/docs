...
- Management console {#console}
  ...
  1. From the **Integration steps** section on the left side of the screen, drag the ![yds-icon](../../../../_assets/yds-icon.svg) **{{ ui-key.yc-serverless-workflows.dynamic-forms.yds_integration_title }}** element to the relevant workflow location in the constructor window.
