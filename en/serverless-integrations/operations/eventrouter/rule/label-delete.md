---
title: Deleting a rule label
description: Follow this tutorial to delete a rule label.
---

# Deleting a rule label
...
- CLI {#cli}
  ...
  To delete a label of a [rule](../../../concepts/eventrouter/rule.md), update its current labels by removing those you do not need. Run this command:
  ...
  To delete all the rule labels, provide an empty value:
...
- {{ TF }} {#tf}
  ...
  To delete a [rule](../../../concepts/eventrouter/rule.md) label:
