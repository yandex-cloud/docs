---
title: How to add a target
description: Follow this guide to add a target.
---
...
- CLI {#cli}
  ...
  To add a [target](../../../concepts/eventrouter/rule.md#target) to a [rule](../../../concepts/eventrouter/rule.md), run the following command, specifying the rule name or ID and a list of targets with their parameters:
...
- {{ TF }} {#tf}
  ...
  To add a [target](../../../concepts/eventrouter/rule.md#target) to a [rule](../../../concepts/eventrouter/rule.md), follow these steps:

  1. Open the {{ TF }} configuration file and add the sections describing your targets:
