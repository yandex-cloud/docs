...
- CLI {#cli}
  ...
  1. Create a bus:
      ...
      * `--description`: Bus description. This is an optional setting.
      ...
      * `--deletion-protection`: Bus deletion protection. By default, protection is disabled. You cannot delete a bus with this option enabled. To disable deletion protection, specify `--no-deletion-protection`. This is an optional setting.
