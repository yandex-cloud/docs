# Viewing operations with {{ er-name }} resources

All actions with {{ er-name }} resources are logged as a list of operations. Each operation gets its own unique ID.
...
- CLI {#cli}
  ...
  To get a list of operations for a {{ er-name }} resource, run this command:
...
1. [Get a list of operations](#get-operations) for your bus.
...
1. Get detailed information about the operation:
    ...
    - API {#api}
      ...
      Use the [OperationService/Get](../../../serverless-integrations/eventrouter/api-ref/grpc/Operation/get.md) gRPC API call.
