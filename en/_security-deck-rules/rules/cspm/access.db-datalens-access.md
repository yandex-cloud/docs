...
1. In the [management console](https://console.yandex.cloud/), select the cloud or folder where you want to disable access from DataLens. 2. In the list of services, select the service(s) where the managed databases are located. 3. In the object settings, go to the **Additional settings** tab. 4. In the object's parameters, disable the **Access from DataLens** option.
