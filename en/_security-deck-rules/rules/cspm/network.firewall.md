...
* Yandex Application Load Balancer [L7 load balancers](https://yandex.cloud/en/docs/application-load-balancer/concepts/application-load-balancer)
* Yandex Managed Service for Kubernetes [clusters](https://yandex.cloud/en/docs/managed-kubernetes/concepts/#kubernetes-cluster)
...
* [BYOI](https://en.wikipedia.org/wiki/Bring_your_own_operating_system) principle, e.g., [your own disk image](https://yandex.cloud/en/docs/compute/operations/image-create/upload).
...
* To apply security groups through Terraform, [set up](https://github.com/yandex-cloud/yc-solution-library-for-security/tree/master/network-sec/segmentation) security groups (dev/stage/prod) using Terraform.
