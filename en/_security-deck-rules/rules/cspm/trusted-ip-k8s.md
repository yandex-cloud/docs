...
**How this rule works:** this rule displays a list of all [security groups](https://yandex.cloud/en/docs/vpc/concepts/security-groups) containing broad rules that allow access through control ports:
