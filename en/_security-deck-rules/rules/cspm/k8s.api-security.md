...
* Use an [Ingress](https://kubernetes.io/docs/concepts/services-networking/ingress/) resource to enable incoming network access to your workloads via HTTP/HTTPS. There are at least two controller options that you can use in Yandex Cloud:

    * [Yandex Cloud Gwin Controller](https://yandex.cloud/en/docs/managed-kubernetes/alb-ref/gwin-index).
