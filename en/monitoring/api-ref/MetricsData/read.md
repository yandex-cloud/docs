...
| metrics[].<br>timeseries.<br>timestamps[] | **string** (int64)<br><p>List of time points in the format of Unix milliseconds.</p> |
| metrics[].<br>timeseries.<br>doubleValues[] | **number** (double)<br><p>List of fractional metric values.</p> |
| metrics[].<br>timeseries.<br>int64Values[] | **string** (int64)<br><p>List of integer metric values. Only available for metrics of the <code>IGAUGE</code> type.</p> |
