...
* {% if product == "yandex-cloud" %}{% if region == "ru" %}₽9.80{% endif %}{% if region == "kz" %}₸49.00{% endif %}{% if region == "int" %}$0.0784{% endif %}{% endif %}{% if product == "cloud-il" %}₪0.4976{% endif %} is the cost of writing 1 million values (up to 50 million values).
...
* {% if product == "yandex-cloud" %}{% if region == "ru" %}₽9.80{% endif %}{% if region == "kz" %}₸49.00{% endif %}{% if region == "int" %}$0.0784{% endif %}{% endif %}{% if product == "cloud-il" %}₪0.4976{% endif %} is the cost of writing 1 million values (up to 50 million values).
* {% if product == "yandex-cloud" %}{% if region == "ru" %}₽5.60{% endif %}{% if region == "kz" %}₸28.00{% endif %}{% if region == "int" %}$0.0448{% endif %}{% endif %}{% if product == "cloud-il" %}₪0.2844{% endif %} is the cost of writing 1 million values (over 50 million values).
