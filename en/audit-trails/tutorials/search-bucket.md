...
1. Install and set up [s3fs](../../storage/tools/s3fs.md) or [goofys](../../storage/tools/goofys.md) to mount buckets {{ objstorage-name }} using [FUSE](https://en.wikipedia.org/wiki/Filesystem_in_Userspace).
