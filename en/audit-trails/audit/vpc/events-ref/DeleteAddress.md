...
# Virtual Private Cloud Audit Trails Events: DeleteAddress

## Event JSON schema {#yandex.cloud.audit.network.DeleteAddress2-schema}
...
## Field description {#yandex.cloud.audit.network.DeleteAddress2}
...
|| details | **[EventDetails](#yandex.cloud.audit.network.DeleteAddress.EventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## EventDetails {#yandex.cloud.audit.network.DeleteAddress.EventDetails}
