...
# Managed Service for Trino Audit Trails Events: RescheduleMaintenance

## Event JSON schema {#yandex.cloud.audit.trino.RescheduleMaintenance2-schema}
...
## Field description {#yandex.cloud.audit.trino.RescheduleMaintenance2}
