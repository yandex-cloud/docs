...
# Managed Service for Trino Audit Trails Events: CreateCatalog

## Event JSON schema {#yandex.cloud.audit.trino.CreateCatalog2-schema}
...
## Field description {#yandex.cloud.audit.trino.CreateCatalog2}
