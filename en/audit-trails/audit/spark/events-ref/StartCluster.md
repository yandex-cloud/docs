...
# Managed Spark Audit Trails Events: StartCluster

## Event JSON schema {#yandex.cloud.audit.spark.StartCluster2-schema}
...
## Field description {#yandex.cloud.audit.spark.StartCluster2}
