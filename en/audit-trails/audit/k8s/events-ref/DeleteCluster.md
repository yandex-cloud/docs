...
# Managed Services for Kubernetes Audit Trails Events: DeleteCluster

## Event JSON schema {#yandex.cloud.audit.k8s.DeleteCluster2-schema}
...
## Field description {#yandex.cloud.audit.k8s.DeleteCluster2}
