...
# Managed Service for MongoDB Audit Trails Events: MoveCluster

## Event JSON schema {#yandex.cloud.audit.mdb.mongodb.MoveCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.mongodb.MoveCluster2}
