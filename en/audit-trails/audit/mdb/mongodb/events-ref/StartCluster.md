...
# Managed Service for MongoDB Audit Trails Events: StartCluster

## Event JSON schema {#yandex.cloud.audit.mdb.mongodb.StartCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.mongodb.StartCluster2}
