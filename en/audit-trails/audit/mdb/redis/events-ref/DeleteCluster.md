...
# Managed Service for ValKey Audit Trails Events: DeleteCluster

## Event JSON schema {#yandex.cloud.audit.mdb.redis.DeleteCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.redis.DeleteCluster2}
