...
# Managed Service for ValKey Audit Trails Events: StartCluster

## Event JSON schema {#yandex.cloud.audit.mdb.redis.StartCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.redis.StartCluster2}
