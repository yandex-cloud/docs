...
# Managed Service for ClickHouse Audit Trails Events: CreateCluster

## Event JSON schema {#yandex.cloud.audit.mdb.clickhouse.CreateCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.clickhouse.CreateCluster2}
...
|| details | **[ClusterCreateEventDetails](#yandex.cloud.audit.mdb.clickhouse.ClusterCreateEventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## ClusterCreateEventDetails {#yandex.cloud.audit.mdb.clickhouse.ClusterCreateEventDetails}
