...
# Managed Service for ClickHouse Audit Trails Events: BackupCluster

## Event JSON schema {#yandex.cloud.audit.mdb.clickhouse.BackupCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.clickhouse.BackupCluster2}
