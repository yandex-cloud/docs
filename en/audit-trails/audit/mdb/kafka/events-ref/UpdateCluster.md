...
# Managed Service for Apache Kafka® Audit Trails Events: UpdateCluster

## Event JSON schema {#yandex.cloud.audit.mdb.kafka.UpdateCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.kafka.UpdateCluster2}
