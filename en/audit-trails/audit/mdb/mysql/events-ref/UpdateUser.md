...
# Managed Service for MySQL Audit Trails Events: UpdateUser

## Event JSON schema {#yandex.cloud.audit.mdb.mysql.UpdateUser2-schema}
...
## Field description {#yandex.cloud.audit.mdb.mysql.UpdateUser2}
