...
# Managed Service for MySQL Audit Trails Events: RescheduleMaintenance

## Event JSON schema {#yandex.cloud.audit.mdb.mysql.RescheduleMaintenance2-schema}
...
## Field description {#yandex.cloud.audit.mdb.mysql.RescheduleMaintenance2}
