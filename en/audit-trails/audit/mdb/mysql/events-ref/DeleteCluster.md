...
# Managed Service for MySQL Audit Trails Events: DeleteCluster

## Event JSON schema {#yandex.cloud.audit.mdb.mysql.DeleteCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.mysql.DeleteCluster2}
