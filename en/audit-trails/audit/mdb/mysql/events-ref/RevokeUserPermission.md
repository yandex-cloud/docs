...
# Managed Service for MySQL Audit Trails Events: RevokeUserPermission

## Event JSON schema {#yandex.cloud.audit.mdb.mysql.RevokeUserPermission2-schema}
...
## Field description {#yandex.cloud.audit.mdb.mysql.RevokeUserPermission2}
...
|| details | **[UserEventDetails](#yandex.cloud.audit.mdb.mysql.UserEventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## UserEventDetails {#yandex.cloud.audit.mdb.mysql.UserEventDetails}
...
|| userName | **string** ||
|| clusterName | **string** ||
|| user | **[User](#yandex.cloud.mdb.mysql.v1.User)** ||
|#
