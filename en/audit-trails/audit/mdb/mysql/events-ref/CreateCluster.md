...
# Managed Service for MySQL Audit Trails Events: CreateCluster

## Event JSON schema {#yandex.cloud.audit.mdb.mysql.CreateCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.mysql.CreateCluster2}
...
|| details | **[ClusterCreateEventDetails](#yandex.cloud.audit.mdb.mysql.ClusterCreateEventDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## ClusterCreateEventDetails {#yandex.cloud.audit.mdb.mysql.ClusterCreateEventDetails}
...
|| hosts[] | **[HostDetails](#yandex.cloud.audit.mdb.mysql.HostDetails)** ||
...
## HostDetails {#yandex.cloud.audit.mdb.mysql.HostDetails}
