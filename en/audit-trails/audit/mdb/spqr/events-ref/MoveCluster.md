...
# Managed Service for SPQR Audit Trails Events: MoveCluster

## Event JSON schema {#yandex.cloud.audit.mdb.spqr.MoveCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.spqr.MoveCluster2}
