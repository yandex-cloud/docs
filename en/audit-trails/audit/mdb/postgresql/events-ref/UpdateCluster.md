...
# Managed Service for PostgreSQL Audit Trails Events: UpdateCluster

## Event JSON schema {#yandex.cloud.audit.mdb.postgresql.UpdateCluster2-schema}
...
## Field description {#yandex.cloud.audit.mdb.postgresql.UpdateCluster2}
