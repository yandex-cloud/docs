...
# Managed Service for PostgreSQL Audit Trails Events: DeleteClusterHosts

## Event JSON schema {#yandex.cloud.audit.mdb.postgresql.DeleteClusterHosts2-schema}
...
## Field description {#yandex.cloud.audit.mdb.postgresql.DeleteClusterHosts2}
