...
# Managed Service for Apache Airflow™ Audit Trails Events: StopCluster

## Event JSON schema {#yandex.cloud.audit.airflow.StopCluster2-schema}
...
## Field description {#yandex.cloud.audit.airflow.StopCluster2}
