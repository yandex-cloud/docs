...
# Smart Web Security Audit Trails Events: DeleteSecurityProfile

## Event JSON schema {#yandex.cloud.audit.smartwebsecurity.DeleteSecurityProfile2-schema}
...
## Field description {#yandex.cloud.audit.smartwebsecurity.DeleteSecurityProfile2}
...
|| details | **[SecurityProfileDetails](#yandex.cloud.audit.smartwebsecurity.SecurityProfileDetails)** ||
|| requestParameters | **object** ||
|| response | **object** ||
|#
...
## SecurityProfileDetails {#yandex.cloud.audit.smartwebsecurity.SecurityProfileDetails}
...
- `ALLOW`
- `DENY` ||
|| securityRules[] | **[SecurityRule](#yandex.cloud.audit.smartwebsecurity.SecurityRule)** ||
|| captchaId | **string** ||
|| advancedRateLimiterProfileId | **string** ||
|| disallowDataProcessing | **boolean** ||
|| analyzeRequestBody | **[AnalyzeRequestBody](#yandex.cloud.audit.smartwebsecurity.SecurityProfileDetails.AnalyzeRequestBody)** ||
|| logOptions | **[LogOptions](#yandex.cloud.audit.smartwebsecurity.SecurityProfileDetails.LogOptions)** ||
|| headersUpstream | **[HeadersUpstream](#yandex.cloud.audit.smartwebsecurity.SecurityProfileDetails.HeadersUpstream)** ||
|| labels | **object** (map<**string**, **string**>) ||
|| description | **string** ||
|| customPageId | **string** ||
|#

## SecurityRule {#yandex.cloud.audit.smartwebsecurity.SecurityRule}
...
|| dryRun | **boolean** ||
|| ruleCondition | **[RuleCondition](#yandex.cloud.audit.smartwebsecurity.SecurityRule.RuleCondition)**

Includes only one of the fields `ruleCondition`, `smartProtection`, `waf`. ||
|| smartProtection | **[SmartProtection](#yandex.cloud.audit.smartwebsecurity.SecurityRule.SmartProtection)**

Includes only one of the fields `ruleCondition`, `smartProtection`, `waf`. ||
|| waf | **[Waf](#yandex.cloud.audit.smartwebsecurity.SecurityRule.Waf)**
...
## RuleCondition {#yandex.cloud.audit.smartwebsecurity.SecurityRule.RuleCondition}
...
## SmartProtection {#yandex.cloud.audit.smartwebsecurity.SecurityRule.SmartProtection}
...
## Waf {#yandex.cloud.audit.smartwebsecurity.SecurityRule.Waf}
...
## AnalyzeRequestBody {#yandex.cloud.audit.smartwebsecurity.SecurityProfileDetails.AnalyzeRequestBody}
...
## LogOptions {#yandex.cloud.audit.smartwebsecurity.SecurityProfileDetails.LogOptions}
...
#|
||Field | Description ||
|| ja3 | **[HeaderUpstreamInfo](#yandex.cloud.audit.smartwebsecurity.SecurityProfileDetails.HeadersUpstream.HeaderUpstreamInfo)** ||
|| tlsHash | **[HeaderUpstreamInfo](#yandex.cloud.audit.smartwebsecurity.SecurityProfileDetails.HeadersUpstream.HeaderUpstreamInfo)** ||
|| ja4 | **[HeaderUpstreamInfo](#yandex.cloud.audit.smartwebsecurity.SecurityProfileDetails.HeadersUpstream.HeaderUpstreamInfo)** ||
|| botScore | **[HeaderUpstreamInfo](#yandex.cloud.audit.smartwebsecurity.SecurityProfileDetails.HeadersUpstream.HeaderUpstreamInfo)** ||
|| isVerifiedBot | **[HeaderUpstreamInfo](#yandex.cloud.audit.smartwebsecurity.SecurityProfileDetails.HeadersUpstream.HeaderUpstreamInfo)** ||
|| botName | **[HeaderUpstreamInfo](#yandex.cloud.audit.smartwebsecurity.SecurityProfileDetails.HeadersUpstream.HeaderUpstreamInfo)** ||
|| botCategory | **[HeaderUpstreamInfo](#yandex.cloud.audit.smartwebsecurity.SecurityProfileDetails.HeadersUpstream.HeaderUpstreamInfo)** ||
|#

## HeaderUpstreamInfo {#yandex.cloud.audit.smartwebsecurity.SecurityProfileDetails.HeadersUpstream.HeaderUpstreamInfo}
