...
# Cloud Backup Audit Trails Events: UpdatePolicy

## Event JSON schema {#yandex.cloud.audit.backup.UpdatePolicy2-schema}
...
## Field description {#yandex.cloud.audit.backup.UpdatePolicy2}
