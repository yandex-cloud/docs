...
# Cloud Functions Audit Trails Events: PauseTrigger

## Event JSON schema {#yandex.cloud.audit.serverless.triggers.PauseTrigger2-schema}
...
## Field description {#yandex.cloud.audit.serverless.triggers.PauseTrigger2}
