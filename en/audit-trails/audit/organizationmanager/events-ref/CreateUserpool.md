...
## Event JSON schema {#yandex.cloud.audit.organizationmanager.idp.CreateUserpool2-schema}
...
## Field description {#yandex.cloud.audit.organizationmanager.idp.CreateUserpool2}
