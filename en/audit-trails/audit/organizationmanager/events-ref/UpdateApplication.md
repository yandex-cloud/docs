...
## Event JSON schema {#yandex.cloud.audit.organizationmanager.application.saml.UpdateApplication2-schema}
...
## Field description {#yandex.cloud.audit.organizationmanager.application.saml.UpdateApplication2}
