...
# Identity Hub Audit Trails Events: UpdateUserpool

## Event JSON schema {#yandex.cloud.audit.organizationmanager.idp.UpdateUserpool2-schema}
...
## Field description {#yandex.cloud.audit.organizationmanager.idp.UpdateUserpool2}
