...
{{ at-name }} collects [audit logs](./concepts/format.md) from {{ yandex-cloud }} resources and uploads them to an {{ objstorage-name }} bucket{% if product == "yandex-cloud" %}, a {{ cloud-logging-name }} log group, or a {{ yds-name }} data stream{% endif %}.
