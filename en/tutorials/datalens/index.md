...
* [Visualizing data from a file](data-from-csv-visualization.md)
...
* [Analyzing sales and locations of pizzerias based on data from {{ CH }} and {{ marketplace-full-name }} databases](data-from-ch-to-geolayers-visualization.md)
