...
* [Locking {{ TF }} states using {{ ydb-full-name }}](terraform-state-lock.md)
...
* [Creating a cluster of 1C:Enterprise Linux servers with a {{ mpg-full-name }} cluster](1c-postgresql-linux.md)
