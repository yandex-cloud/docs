...
description: In this tutorial, you will create a single-node NFS file server using the Samba software suite and the {{ vpc-full-name }} network infrastructure via the {{ yandex-cloud }} management console.
---
