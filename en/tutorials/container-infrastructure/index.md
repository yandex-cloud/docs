---
title: Container infrastructure use cases in {{ yandex-cloud }}
...
* [{#T}](gateway-api.md)
* [Installing an NGINX Ingress controller with a {{ certificate-manager-name }} certificate](nginx-ingress-certificate-manager.md)
