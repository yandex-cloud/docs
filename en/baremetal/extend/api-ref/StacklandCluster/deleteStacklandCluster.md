...
editable: false
apiPlayground:
  - url: https://baremetal.{{ api-host }}/v2/clouds/{cloudId}/folders/{folderId}/extend/stacklandClusters/{stacklandClusterId}
    method: delete
    path:
      type: object
      properties:
...
```
DELETE https://baremetal.{{ api-host }}/v2/clouds/{cloudId}/folders/{folderId}/extend/stacklandClusters/{stacklandClusterId}
```
