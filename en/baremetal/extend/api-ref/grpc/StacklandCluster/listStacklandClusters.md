...
# Extend API, gRPC: StacklandClusterService.ListStacklandClusters
...
**rpc ListStacklandClusters ([ListStacklandClustersRequest](#yandex.cloud.baremetal.v2.extend.ListStacklandClustersRequest)) returns ([ListStacklandClustersResponse](#yandex.cloud.baremetal.v2.extend.ListStacklandClustersResponse))**

## ListStacklandClustersRequest {#yandex.cloud.baremetal.v2.extend.ListStacklandClustersRequest}
...
the service returns a [ListStacklandClustersResponse.next_page_token](#yandex.cloud.baremetal.v2.extend.ListStacklandClustersResponse)
...
[ListStacklandClustersResponse.next_page_token](#yandex.cloud.baremetal.v2.extend.ListStacklandClustersResponse) returned by a previous list request. ||
|| order_by | **string**
...
## ListStacklandClustersResponse {#yandex.cloud.baremetal.v2.extend.ListStacklandClustersResponse}
...
[ListStacklandClustersRequest.page_size](#yandex.cloud.baremetal.v2.extend.ListStacklandClustersRequest), use `next_page_token` as the value
for the [ListStacklandClustersRequest.page_token](#yandex.cloud.baremetal.v2.extend.ListStacklandClustersRequest) parameter in the next list request.
