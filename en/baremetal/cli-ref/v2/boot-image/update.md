---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/baremetal/cli-ref/v2/boot-image/update/
---

# yc baremetal v2 boot-image update
...
`yc baremetal v2 boot-image update <BOOT-IMAGE-ID>`
...
1. Generate template:
yc baremetal v2 boot-image update --example-json > request.json
or
yc baremetal v2 boot-image update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal v2 boot-image update -r request.json
or
yc baremetal v2 boot-image update -r request.yaml ||
|#
