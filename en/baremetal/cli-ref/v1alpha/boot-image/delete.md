---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/baremetal/cli-ref/v1alpha/boot-image/delete/
---

# yc baremetal v1alpha boot-image delete
...
`yc baremetal v1alpha boot-image delete <IMAGE-ID>`
