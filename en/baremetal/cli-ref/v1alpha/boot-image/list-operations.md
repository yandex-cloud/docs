---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/baremetal/cli-ref/v1alpha/boot-image/list-operations/
---

# yc baremetal v1alpha boot-image list-operations
...
`yc baremetal v1alpha boot-image list-operations <IMAGE-ID>`
...
Page token. To get the next page of results, set 'page_token' to the [ListImageOperationsResponse.next_page_token] returned by a previous list request. ||
|| `--name` | `string`
