---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/baremetal/cli-ref/v1alpha/public-prefix-pool/update/
---
...
`yc baremetal v1alpha public-prefix-pool update <PUBLIC-PREFIX-POOL-ID>`
...
1. Generate template:
yc baremetal v1alpha public-prefix-pool update --example-json > request.json
or
yc baremetal v1alpha public-prefix-pool update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal v1alpha public-prefix-pool update -r request.json
or
yc baremetal v1alpha public-prefix-pool update -r request.yaml ||
|#
