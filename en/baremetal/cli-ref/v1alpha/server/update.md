---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/baremetal/cli-ref/v1alpha/server/update/
---

# yc baremetal v1alpha server update
...
`yc baremetal v1alpha server update <SERVER-ID>`
...
1. Generate template:
yc baremetal v1alpha server update --example-json > request.json
or
yc baremetal v1alpha server update --example-yaml > request.yaml

2. Edit the template file

3. Run with template:
yc baremetal v1alpha server update -r request.json
or
yc baremetal v1alpha server update -r request.yaml ||
|#
