...
Use the management console to select components and order your configuration. For more information on how to rent a custom configuration server, see [{#T}](../operations/servers/custom-server-lease.md).
