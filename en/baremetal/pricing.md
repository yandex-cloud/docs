...
<MDX>
  <PriceList
    ...
    skuIds={[
      ...
      '{{ pc|baremetal.server.ba-i312-s-1_10g.1-day }}',
      '{{ pc|baremetal.server.ba-i312-s-1_10g.1-month }}',
      '{{ pc|baremetal.server.ba-i312-s-1_10g.3-month }}',
      '{{ pc|baremetal.server.ba-i312-s-1_10g.6-month }}',
      '{{ pc|baremetal.server.ba-i312-s-1_10g.12-month }}',
...
<MDX>
  <PriceList
    ...
    skuIds={[
      ...
      '{{ pc|baremetal.server.bms-r162-body.1-month }}',
      '{{ pc|baremetal.server.bms-r162-body.3-month }}',
      '{{ pc|baremetal.server.bms-r162-body.6-month }}',
      '{{ pc|baremetal.server.bms-r162-body.12-month }}',
      '{{ pc|baremetal.server.bms-r163-body.1-month }}',
      '{{ pc|baremetal.server.bms-r163-body.3-month }}',
      '{{ pc|baremetal.server.bms-r163-body.6-month }}',
      '{{ pc|baremetal.server.bms-r163-body.12-month }}',
