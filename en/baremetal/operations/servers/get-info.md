...
- Management console {#console}
  ...
  1. [Go](../../../console/operations/select-service.md#select-service) to **{{ ui-key.yacloud.iam.folder.dashboard.label_baremetal }}** and, in the list of servers that opens, select the one you need.
      ...
      * Under **{{ ui-key.yacloud.baremetal.title_section-network-interfaces }}**, information about the server's [public network](../../concepts/public-network.md), including the ID, type, and CIDR of the public subnet, default gateway address, and [MAC address](https://en.wikipedia.org/wiki/MAC_address) of the network interface in the public network.
      * Under **{{ ui-key.yacloud.baremetal.title_section-network-interfaces }}**:
          * Under **Interface 1**, information about the server's [public network](../../concepts/public-network.md), including the public subnet ID, type, and CIDR, default gateway address, and [MAC address](https://en.wikipedia.org/wiki/MAC_address) of the network interface in the public network.
          * Under **Interface 2**, information about the server's [private network](../../concepts/private-network.md), including the [private subnet](../../concepts/private-network.md#private-subnet), as well as the private IP and MAC address of the network interface in the private network.
