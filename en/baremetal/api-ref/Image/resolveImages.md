...
editable: false
apiPlayground:
  - url: https://baremetal.{{ api-host }}/baremetal/v2/folders/{folderId}/images:resolveImages
    method: get
    path:
      type: object
      properties:
        ...
        pageSize:
          description: |-
            **string** (int64)
            ...
            the service returns a [ResolveImagesResponse.nextPageToken](#yandex.cloud.baremetal.v2.ResolveImagesResponse)
        ...
        pageToken:
          description: |-
            **string**
            ...
            [ResolveImagesResponse.nextPageToken](#yandex.cloud.baremetal.v2.ResolveImagesResponse) returned by a previous resolve request.
          type: string
        orderBy:
          description: |-
            **string**
...
# BareMetal API, REST: Image.ResolveImages
...
```
GET https://baremetal.{{ api-host }}/baremetal/v2/folders/{folderId}/images:resolveImages
```
...
## Query parameters {#yandex.cloud.baremetal.v2.ResolveImagesRequest}
...
## Response {#yandex.cloud.baremetal.v2.ResolveImagesResponse}
...
[ResolveImagesRequest.pageSize](#yandex.cloud.baremetal.v2.ResolveImagesRequest), use `next_page_token` as the value
for the [ResolveImagesRequest.pageToken](#yandex.cloud.baremetal.v2.ResolveImagesRequest) parameter in the next resolve request.
