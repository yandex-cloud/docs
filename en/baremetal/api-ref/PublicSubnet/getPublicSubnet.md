...
editable: false
apiPlayground:
  - url: https://baremetal.{{ api-host }}/baremetal/v2/clouds/{cloudId}/folders/{folderId}/publicSubnets/{publicSubnetId}
    method: get
    path:
      type: object
      properties:
...
# BareMetal API, REST: PublicSubnet.GetPublicSubnet
...
```
GET https://baremetal.{{ api-host }}/baremetal/v2/clouds/{cloudId}/folders/{folderId}/publicSubnets/{publicSubnetId}
```
...
## Response {#yandex.cloud.baremetal.v2.PublicSubnet}
