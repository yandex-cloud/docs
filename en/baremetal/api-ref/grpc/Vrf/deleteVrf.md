...
# BareMetal API, gRPC: VrfService.DeleteVrf
...
**rpc DeleteVrf ([DeleteVrfRequest](#yandex.cloud.baremetal.v2.DeleteVrfRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## DeleteVrfRequest {#yandex.cloud.baremetal.v2.DeleteVrfRequest}
