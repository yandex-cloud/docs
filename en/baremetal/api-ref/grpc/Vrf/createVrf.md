...
# BareMetal API, gRPC: VrfService.CreateVrf
...
**rpc CreateVrf ([CreateVrfRequest](#yandex.cloud.baremetal.v2.CreateVrfRequest)) returns ([operation.Operation](#yandex.cloud.operation.Operation))**

## CreateVrfRequest {#yandex.cloud.baremetal.v2.CreateVrfRequest}
