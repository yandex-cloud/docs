        ...
        publicPrefixPoolId:
          description: |-
            **string**
            ...
            To get the public prefix pool ID, use a [PublicPrefixPoolService.List](/docs/baremetal/api-ref/PublicPrefixPool/list#List) request.
...
```
PATCH https://baremetal.{{ api-host }}/baremetal/v1alpha/publicPrefixPools/{publicPrefixPoolId}
```
