...
editable: false
apiPlayground:
  - url: https://baremetal.{{ api-host }}/baremetal/v1alpha/servers/{serverId}:startProlongation
    method: post
    path:
      type: object
      properties:
    ...
    body: null
    definitions: null
sourcePath: en/_api-ref/baremetal/v1alpha/api-ref/Server/startProlongation.md
---
...
Required field. ID of the server that is being prolonged. ||
|#
