---
editable: false
canonical: https://yandex.cloud/en/docs/cli/cli-ref/desktops/cli-ref/v0/group/create/
---

# yc desktops v0 group create
...
`yc desktops v0 group create [Flags...] [Global Flags...]`
