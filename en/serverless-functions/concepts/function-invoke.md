...
- 401 Unauthorized: Failed to authorize in the service that the Serverless Functions service depends on.
...
- 503 Service Unavailable: The service that the Serverless Functions service depends on isn't available.
