...
- Management console
  1. Open **Serverless Functions** in the folder where you want to create the function [version](concepts/function.md#version).
...
- Management console
  1. Open **Serverless Functions** in the folder where you want to create the function version.
  1. Select the function to create the version for.
  1. Under **Latest version**, click **Create in editor**.
  1. Set the version parameters:
