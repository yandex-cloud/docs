### Risk of reduced performance {#postgresql_cpu_idle}

**Description**

The host continuously uses all CPU resources, which may cause delays in query processing. Check the [load](../../managed-postgresql/operations/performance-diagnostics.md) and optimize your queries, including those sent via the {{ websql-name }} [AI assistant](../../websql/operations/ai-assistant.md), or increase the computing resources allocated to your cluster.
