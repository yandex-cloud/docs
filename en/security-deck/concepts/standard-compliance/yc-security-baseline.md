...
|| **Authentication and access management** (IAM) {.cell-align-center} | > | > ||
...
|| **Network security** (NET) {.cell-align-center} | > | > ||
...
|| **Secure virtual environment configuration** (ENV) {.cell-align-center} | > | > ||
...
|| **Data encryption and key management** (CRYPT) {.cell-align-center} | > | > ||
...
|| **Collecting, monitoring, and analyzing audit logs** (AUDIT) {.cell-align-center} | > | > ||
...
|| **Application security** (APPSEC) {.cell-align-center} | > | > ||
...
|| **{{ k8s }} security** (K8S) {.cell-align-center} | > | > ||
