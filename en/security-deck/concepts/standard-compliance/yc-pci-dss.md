...
|| **1. Installing and maintaining network security controls** {align="center"} | > | > ||
...
[cspm.network.db-security-group](../../rules-reference/cspm.md#db-security-group)
||
|| **2. Applying secure configurations to all system components** {align="center"} | > | > ||
...
||
|| **5. Protecting all systems and networks against malware** {align="center"} | > | > ||
...
||
|| **7. Restricting access to system components and cardholder data based on need to know** {align="center"} | > | > ||
...
||
|| **11. Regular testing of system and network security** {align="center"} | > | > ||
|| 11.3 | Regular detection, prioritization, and elimination of external and internal vulnerabilities |
[cspm.appsec.secure-registry](../../rules-reference/cspm.md#secure-registry)
||
|| **12. Maintaining information security with organizational policies and programs** {align="center"} | > | > ||
