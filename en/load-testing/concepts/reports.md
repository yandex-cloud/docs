...
A report on the results of load testing should contain information about any issues encountered during testing. {{ load-testing-name }} provides a centralized test repository linked to the {{ yandex-cloud }} role model. When performing load testing, the load generator collects statistics, then aggregates and transmits them to Yandex.Tank storage.
