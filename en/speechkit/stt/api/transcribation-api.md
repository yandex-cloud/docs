...
| config.<br>specification.<br>audioChannelCount | **integer** (int64)<br>The number of channels in [LPCM](../formats.md#lpcm) files. By default, `1`.<br>Do not use this field for [OggOpus](../formats.md#oggopus) formats. |
