...
The example uses the default settings: data in the audio file is saved in [LPCM](https://en.wikipedia.org/wiki/Pulse-code_modulation) format with a sampling rate of 22050 Hz and depth of 16 bit. Data is then packaged into a [WAV](https://en.wikipedia.org/wiki/WAV) container.
