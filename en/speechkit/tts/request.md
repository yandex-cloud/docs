...
| emotion | **string**<br>The emotional tone of the voice. Recommended only for [voices that support emotions](voices.md).<br/>Acceptable values:<ul><li>`good`: Cheerful and friendly.</li><li>`evil`: Irritated.</li><li>`neutral` (default): Emotionless.</li></ul> |
