...
**В настоящий момент документация Yandex Managed Service for YDB активно перерабатывается. PR в нее рассматриваются дольше заявленных сроков и принимаются вручную.**
