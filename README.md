...
Документация разработана с использованием [GitHub Flavored Markdown](https://github.github.com/gfm/) с некоторыми расширениями. Подробнее про синтаксис читайте [тут](markdown-and-extensions.md).
